...
public class DepartmentLocationEnquiryFB extends ActionForm {
	...
	public void reset(ActionMapping mapping, HttpServletRequest request) {
		...
		this.setHgnum_location_code("");
		this.setHgstr_building("");
		this.setHgstr_block("");
		this.setHgstr_floor("");
		this.setHgstr_room("");
		this.setHgstr_description("");		
		this.setHgstr_landmark("");
		this.setHmode("");
