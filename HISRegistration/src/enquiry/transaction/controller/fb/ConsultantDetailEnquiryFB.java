...
public class ConsultantDetailEnquiryFB extends ActionForm {
	...
	public void reset(ActionMapping mapping, HttpServletRequest request) {
		...
		this.setNum_cur_country_id("");
		this.setGnum_location_code("");
		//this.setGnum_state_code("");
		this.setNum_cur_state_id("");
		this.setGstr_city_loc_name("");
		this.setGstr_countryname("");
		this.setGstr_statename("");
		this.setHmode("");
		this.setPatfathername("");
		this.setPatgenderage("");
		this.setPsrnum_pincode("");
		/*this.setPsrstr_add1("");
		this.setPsrstr_city("");
		this.setPsrstr_district("");
		this.setPsrstr_fname("");
		this.setPsrstr_lname("");
		this.setPsrstr_mname("");*/
		this.setStr_first_name("");
		this.setStr_middle_name("");
		this.setStr_last_name("");
		this.setNum_cur_city_id("");
		this.setNum_cur_dist_id("");
	}
}
