...
public class RescheduleCancelAppointmentVO extends ValueObject{
	...
	private String sNo;
	//By Mukund on 13.10.2016
	private String prevApptDate;
	private String prevApptTime;
	private String departmentUnit;	//By Mukund on 08.03.2017	
	private String testProcName; //By Mukund on 25.01.2019	
	...
	public String getPrevApptDate()	{
		return prevApptDate;
	}
	public void setPrevApptDate(String prevApptDate) {
		this.prevApptDate = prevApptDate;
	}
	public String getPrevApptTime() {
		return prevApptTime;
	}
	public void setPrevApptTime(String prevApptTime) {
		this.prevApptTime = prevApptTime;
	}
	//End: Mukund
