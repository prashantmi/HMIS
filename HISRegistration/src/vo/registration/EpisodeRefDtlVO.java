...
public class EpisodeRefDtlVO extends ValueObject
{
	...
	private String toDepartmentUnitType;
	
	private String isOldDeptVisitFlag;//Added by Vasu on 29.May.2018
	
	
	public String getToDepartmentUnitType() {
		return toDepartmentUnitType;
	}

	public void setToDepartmentUnitType(String toDepartmentUnitType) {
		this.toDepartmentUnitType = toDepartmentUnitType;
	}
	...
	public String getIsOldDeptVisitFlag() {
		return isOldDeptVisitFlag;
	}

	public void setIsOldDeptVisitFlag(String isOldDeptVisitFlag) {
		this.isOldDeptVisitFlag = isOldDeptVisitFlag;
	}
