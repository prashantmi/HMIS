 ...
 * @author AHIS
 */
public class PatientVO extends ValueObject
{
	private AddressVO patAddress = new AddressVO();
	private RenewalConfigVO renewalConfig = new RenewalConfigVO();
	...
	private String patPrimaryCatValidUpto;
	...
	private String patSecUHID;
	private String asNewPatient;
	...
	protected String strEmployeePatCatGroup;
	private String doctorName;
	private String unitConsultant[];
	
	private String patMergedMainCrNO;
	protected String searchUsingMobile;
	protected String patRefNo;
	protected String callerName;
	private String oldhosPrimaryCatCode;
	private String patStaffDetails;
	private String patStaffNo;
	private String patStaffName;
	private String patStaffDeptName;
	private String patStaffRelationName;
	private String findRow;
	private String oldCreditLetterRefNo;//by Mukund on 09.05.2017
	private String oldAgsNo;//by Mukund on 12.12.2017
	
	protected String letterType;
	protected String creditLimit;
	protected String isAadharConsentGiven;
	private byte[] verificationDocumentFile;
	private String matchCriteria;
	private String matchCriteriaStr;
	...
	private String isPatFromAppointList;
	private String unitRosterType;
	protected String catBoundFlag;// Added By Raj Kumar on 19.12.2018
	protected String catCodeBound;// Added By Raj Kumar on 19.12.2018
	
	public String getCatBoundFlag() {
		return catBoundFlag;
	}
	public void setCatBoundFlag(String catBoundFlag) {
		this.catBoundFlag = catBoundFlag;
	}
	public String getCatCodeBound() {
		return catCodeBound;
	}
	public void setCatCodeBound(String catCodeBound) {
		this.catCodeBound = catCodeBound;
	}

	
	public String getUnitRosterType() {
		return unitRosterType;
	}

	public void setUnitRosterType(String unitRosterType) {
		this.unitRosterType = unitRosterType;
	}
	
	public String getIsPatFromAppointList() {
		return isPatFromAppointList;
	}

	public void setIsPatFromAppointList(String isPatFromAppointList) {
		this.isPatFromAppointList = isPatFromAppointList;
	}
	...
	public String getEpisodeMLCFlag() {
		return episodeMLCFlag;
	}

	public void setEpisodeMLCFlag(String episodeMLCFlag) {
		this.episodeMLCFlag = episodeMLCFlag;
	}
	...
	public String getPatPrimaryCatValidUpto() {
		return patPrimaryCatValidUpto;
	}

	public void setPatPrimaryCatValidUpto(String patPrimaryCatValidUpto) {
		this.patPrimaryCatValidUpto = patPrimaryCatValidUpto;
	}
	...
	public RenewalConfigVO getRenewalConfig() {
		return renewalConfig;
	}
	public void setRenewalConfig(RenewalConfigVO renewalConfig) {
	...
	public String getPatSecUHID() {
		return patSecUHID;
	}

	public void setPatSecUHID(String patSecUHID) {
		this.patSecUHID = patSecUHID;
	}
	...
	public String getStrEmployeePatCatGroup() {
		return strEmployeePatCatGroup;
	}

	public void setStrEmployeePatCatGroup(String strEmployeePatCatGroup) {
		this.strEmployeePatCatGroup = strEmployeePatCatGroup;
	}
	...
	public String getPatMergedMainCrNO() {
		return patMergedMainCrNO;
	}

	public void setPatMergedMainCrNO(String patMergedMainCrNO) {
		this.patMergedMainCrNO = patMergedMainCrNO;
	}
	public String getSearchUsingMobile() {
		return searchUsingMobile;
	}

	public void setSearchUsingMobile(String searchUsingMobile) {
		this.searchUsingMobile = searchUsingMobile;
	}
	
	public String getpatRefNo() {
		return patRefNo;
	}

	public void setpatRefNo(String patRefNo) {
		this.patRefNo = patRefNo;
	}
	...
	public String getPatStaffDetails() {
		return patStaffDetails;
	}

	public void setPatStaffDetails(String patStaffDetails) {
		this.patStaffDetails = patStaffDetails;
	}
	...
	public void setFindRow(String findRow) {
		this.findRow = findRow;
	}
	public String getOldCreditLetterRefNo() {
		return oldCreditLetterRefNo;
	}

	public void setOldCreditLetterRefNo(String oldCreditLetterRefNo) {
		this.oldCreditLetterRefNo = oldCreditLetterRefNo;
	}
	public String getOldAgsNo() {
		return oldAgsNo;
	}

	public void setOldAgsNo(String oldAgsNo) {
		this.oldAgsNo = oldAgsNo;
	}
	...
	public byte[] getVerificationDocumentFile() {
		return verificationDocumentFile;
	}

	public void setVerificationDocumentFile(byte[] verificationDocumentFile) {
		this.verificationDocumentFile = verificationDocumentFile;
	}
	...
	public String getMatchCriteriaStr() {
		return matchCriteriaStr;
	}

	public void setMatchCriteriaStr(String matchCriteriaStr) {
		this.matchCriteriaStr = matchCriteriaStr;
	}
