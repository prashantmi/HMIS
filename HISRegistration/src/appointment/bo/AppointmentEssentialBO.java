...
//			objRescheduleCancelAppointmentVO_p.setPatAddTypeCode(RegistrationConfig.PATIENT_ADD_TYPE_CURRENT);
	...
	//by Mukund for IPD OPD booked slots count
	public WebRowSet getIpdOpdBookedApptSlotsCount(UserVO objUserVO_p,AppointmentParameterVO appParaVO)
	{
		WebRowSet ws=null;
		try
		{
			ws=AppointmentEssentialDAO.getIpdOpdBookedApptSlotsCount(objUserVO_p, appParaVO);			
		}		
		catch (Exception e)
		{
			System.out.println("inside  BO HisApplicationExecutionException");
