...
import appointment.reports.controller.util.AptStatisticsReportUTIL;

public class AptStatisticsReportACTION extends AptStatisticsVo
{
	...
	public String init()
	{
		WebUTIL.refreshTransState(super.getRequest(),"AptStatisticsReportACTION");	
		this.reset();
		AptStatisticsReportUTIL.getEssentials(super.getRequest());
	...
	public void showReport() {
		...
		AptStatisticsReportUTIL.showReport(this, request, response);
	}
