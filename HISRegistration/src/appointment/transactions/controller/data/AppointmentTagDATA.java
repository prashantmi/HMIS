...
public class AppointmentTagDATA extends ControllerDATA {
	...
	//By Mukund for OPD IPD booked slots count
	public static WebRowSet  getIpdOpdBookedApptSlotsCount(UserVO userVO,	AppointmentParameterVO appParaVO) {
		AppointmentEssentialBO  essentialBO=new AppointmentEssentialBO();
		WebRowSet ws=essentialBO.getIpdOpdBookedApptSlotsCount(userVO,appParaVO); 
		return ws;		
	}
