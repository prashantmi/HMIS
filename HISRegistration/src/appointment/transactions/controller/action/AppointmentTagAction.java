...
public class AppointmentTagAction extends AppointmentGlobalSUP 
{
	...
	//replica of MakeTimeSlotTagHTML
	public void makeTimeSlotTagHTML_withCapping()
	 {
		...
		String apptType =objRequest.getParameter("apptType");
		String isProcessReschedule =  objRequest.getParameter("isProcessReschedule");
		if(isProcessReschedule==null || isProcessReschedule.equals(""))//in case if calls comes from New Appointment Process
			isProcessReschedule="0";
		AppointmentTagUTIL.MakeTimeSlotTag_withCapping(objRequest,objResponse,crNo, aptId, _paraId[0], _paraId[1],_paraId[2],_paraId[3],_paraId[4],_paraId[5],_paraId[6],"1","",tagView,aptDate, apptType, isProcessReschedule);
