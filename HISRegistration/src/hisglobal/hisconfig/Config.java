...
public interface Config {
	...
	String CR_NO_FORMAT_SIZE_FIFTEEN = "15"; // value for size 15
	...
	String IPD_PATIENT_OREDRE_BY_CONSULTANT_NAME = "9";
	...
	String PRIMARY_CATEGORY_SENIOR_CITIZEN = "14,20";
	String SENIOR_CITIZEN_AGE = "60";
	String PRIMARY_CATEGORY_STAFF_CODE = "15";
	String PRIMARY_CATEGORY_STUDENT_CODE = "33";
	
	// -- HIS Resource Bundle
 String RESOURCE_BUNDLE_PROPERTY_FILE_PATH = "hisglobal.hisconfig.hisResourceBundle";
 
 String PATIENT_IMAGE_FILE_STORAGE_PATH = "C:/NIMS/AHIMSG5/PatientImages";
	String PATIENT_IMAGE_FILE_STORAGE_PATH_LINUX = "/opt/NIMS/AHIMSG5/PatientImages";
...
/*
	...
	String CLIENT_SMS = "2";
	String CLIENT = CLIENT_GNCTD;

	// -- Hospital Code Configuration
	String HOSPITAL_CODE_VALUE = "100";
	...
	String FILE_NO_GENERATION_FLAG = FILE_NO_GENRATION_FALSE;
	...
	// **** Storage Paths ************************************************
	//String PATH_APPLICATION_SERVER_FILE_STORAGE_WINDOWS = "C:/HISRegistration";
//	String PATH_APPLICATION_SERVER_FILE_STORAGE_LINUX = "/HISRegistration";

	// Registration
	// Patient Images Storage
	String PATIENT_IMAGE_FILE_STORAGE_PATH = "C:/HISRegistration/PatientImages";
	String PATIENT_IMAGE_FILE_STORAGE_PATH_LINUX = "/HISRegistration/PatientImages";
//	String TARGET_FOLDER_PATIENT_IMAGE = "/PatientImages";
	...
	// MLC Document
	String MLC_DOC_IMAGE_FILE_STORAGE_PATH = "c:/HISRegistration/MlcDocImages";
	String MLC_DOC_IMAGE_FILE_STORAGE_PATH_LINUX = "/HISRegistration/MlcDocImages";
	...
	String IMAGE_EDITOR_EXAMINATION_PATIENTS_IMAGES_PATH_WINDOWS = "C:/HISRegistration/PatientExaminationEditorImageDIR";
	String IMAGE_EDITOR_EXAMINATION_PATIENTS_IMAGES_PATH_LINUX = "/HISRegistration/PatientExaminationEditorImageDIR";
	String IMAGE_EDITOR_EXAMINATION_FILENAME_STARTSWITH = "I"; // concatenated with Par CrNo +
	String IMAGE_EDITOR_EXAMINATION_FILENAME_CONNECTOR = "$"; // concatenated with Serial No +
	String IMAGE_EDITOR_EXAMINATION_FILENAME_EXTENSION = ".png";

	// Document Upload
	String OPD_DOCUMENT_FILE_STORAGE_PATH_WINDOWS = "C:/HISRegistration/PatDocumentUploadFiles";
	String OPD_DOCUMENT_FILE_STORAGE_PATH_LINUX = "/HISRegistration/PatDocumentUploadFiles";

	// Image Editor
	String IMAGE_EXAMINATION_IMAGE_PATH_WINDOWS = "C:/HISRegistration/ImageExaminationFiles";
	String IMAGE_EXAMINATION_IMAGE_PATH_LINUX = "/HISRegistration/ImageExaminationFiles";
	...
	String OPD_AUDIO_VIDEO_STORAGE_PATH_WINDOWS = "C:/HISRegistration/AudioVideoPlayerFiles";
	String OPD_AUDIO_VIDEO_STORAGE_PATH_LINUX = "/HISRegistration/AudioVideoPlayerFiles";

	*/
	// Generic Template
	String GENERIC_TEMPLATE_HTML_DOCUMENT_FILE_STORAGE_PATH_WINDOWS = "C:/NIMS/AHIMSG5/GenericTemplateDIR";
	String GENERIC_TEMPLATE_HTML_DOCUMENT_FILE_STORAGE_PATH_LINUX = "/opt/NIMS/AHIMSG5/GenericTemplateDIR";

	String GENERIC_TEMPLATE_HTML_DOCUMENT_FILE_STORAGE_NAME = "GenericTemplate_"; // concatenated with TemplateId int
	String GENERIC_TEMPLATE_HTML_DOCUMENT_FILE_STORAGE_EXT = ".htm"; // concatenated with Generic Temp Name
	String GENERIC_TEMPLATE_IMAGE_VIEW_FILE_STORAGE_NAME = "IMG_"; // concatenated with TemplateId int +"_"+ row_col

	/*// Generic Patient Profile
	String PATIENT_PROFILE_STORAGE_PATH_WINDOWS = "C:/HISRegistration/PatientProfileDIR";
	String PATIENT_PROFILE_STORAGE_PATH_LINUX = "/HISRegistration/PatientProfileDIR";
	String TARGET_FOLDER_PATIENT_PROFILE = "/PatientProfileDIR";
	String PATIENT_PROFILE_FILE_STORAGE_EXT = ".htm"; // concatenated with Patient Profile Id

	// /Mortuary Patient Image
	String MORTUARY_PATIENT_IMAGE_PATH_WINDOWS = "C:/HISRegistration/Mortuary";
	String MORTUARY_PATIENT_IMAGE_PATH_LINUX = "/HISRegistration/Mortuary";

	// ////////Disaster Plan Storage Path
	String DISASTER_PLAN_STORAGE_PATH_WINDOW = "C:/HISRegistration/DisasterPlan";
	String DISASTER_PLAN_STORAGE_PATH_LINUX = "/HISRegistration/DisasterPlan";


	
	// -- Registration Renewal Configuration
	String RENEWAL_TYPE = "0";
	...
	String REGISTRATION_BILLING_GROUPING_FLAG = "0";
	...
	String FILE_NUMBER_PRINT_REQUIRED = PRINT_REQUIRED_FALSE;
	...
	String CARD_PRINTING_REQUIRED_FOR_RENEWAL = PRINT_REQUIRED_FALSE;
	...
	String OLD = "1";
	String NEW = "2";
	String CHOICE_OPD_CARD="OC";
	String CHOICE_SCANNED_CARD="SC";
	...
	String IS_LOCATION_COMBO_REQ = "1";// 1-Combo Required YES, 0-Combo Required
										// NO
...
/*
	...
	String TIME_BOUND_REGISTRATION_REQUIRED = TIME_BOUND_REGISTRATION_REQUIRED_YES;
	...
	////////////WaterMarking PDF Flag ///////////////////
	String WATER_MARKING_PDF_REQUIRED_YES = "1";
	String WATER_MARKING_PDF_REQUIRED_NO = "0";
	String WATER_MARKING_PDF_REQUIRED = WATER_MARKING_PDF_REQUIRED_NO;
	
	String HGNUM_TEMPLATE_CATEGORY ="31";
	
	String UPLOADED_FILE_AS_ARRAY_MB="uploadFileAsArrayMedicalBoard";
	// **** Storage Paths ************************************************
	String PATH_APPLICATION_SERVER_FILE_STORAGE_WINDOWS = "C:/HISRegistration";
	String PATH_APPLICATION_SERVER_FILE_STORAGE_LINUX = "/HISRegistration";
	...
	String TARGET_FOLDER_PATIENT_IMAGE = "/PatientImages";
*/
	String PAYMENT_MODE_OPTION_LIST = "paymentModeList";//By warish
}
