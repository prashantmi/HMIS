...
//	rajmsdg-rmsc$cdac@2013$RAJSMS
	...
	static String username = "aiims_patna"; //"ehmstel.sms";
	static String password = "aiimsp@1234";//"Zq%236bT%252a";//"Ty@%23n123";
	static String senderid = "HEALTH";
	static String message = "Test SMS from EHMS-TELANGANA, Sorry for Inconvenience!";
	...
	static final  String nic_sms_url= "https://msdgweb.mgov.gov.in/esms/sendsmsrequest";//"https://smsgw.sms.gov.in/failsafe/HttpLink?";
	...
	{
		sendTextSMSThroughNICSMSGateway("","","","","9891102810","Hi");
		
		try 
		{
			String baseURL ="https://smsgw.sms.gov.in/failsafe/HttpLink?username=ehmstel.sms&pin=Zq%236bT%252a&";
			String replyTo = "HEALTH";
			String recipient = "919891102810";
	...
	public static void sendTextSMSThroughNICSMSGateway(String username,String password, String senderId,String sms_URL,String mobileNo, String message)
	{
		...
		try 
		{
			...
			URI.append("&mnumber=" + mobileNo);
			URI.append("&message=" + URLEncoder.encode(message, "UTF-8"));
			String result = "";
	...
	public static void sendTextSMSThroughNICSMSGatewayWithoutCertificate(String username,String password, String senderId,String sms_URL,String mobileNo, String message) 
	{
		try 
		{
