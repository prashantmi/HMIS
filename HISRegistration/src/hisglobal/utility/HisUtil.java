...
*/
	...
	*/
	...
	/**
	 * This method will convert the Number(Int) to Text(String) Added by Singaravelan on 21-May-2014
	 * Support upto 1 lakh
	 * 
	 * @param number
	 */
	public static String ConvertNumberToText(int number){
        ...
        if(number < 1000){  
            HelperConvertNumberToText(number, tempString);
            result[0] += tempString[0];
        }
        else{
            thousands = number / 1000;
            temp = number - thousands * 1000;
