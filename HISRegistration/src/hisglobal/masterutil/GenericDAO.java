	...
	*/
	...
	public static void deleteRecords(String query[], String[] tempChk, int no_of_primary, GenericVO vo) {
	     ...
	     try {	             	    			    
		    ...
		    if((tempChk[no_of_primary-1].indexOf("|")) > -1)
		    	isExtraInfo = 1;
		    dao=new HisDAO("Master Template","GenericHLP");
	...
	/*public static void insertReportConfig(GenericVO _genericVO) {
		...
		try {
			...
			strDeleteQuery="DELETE FROM GBLT_MASTER_REPORT_CONFIG WHERE GSTR_MASTER_NAME='"+_genericVO.getStrMasterName().split("#")[0]+"' AND GNUM_HOSPITAL_CODE=101";
			...
			dao.setQryValue(nQueryIndex,11,"101");  
...
/*	public static void fetchReportConfig(GenericVO _genericVO) {
		...
		try{
			...
			strQuery.append("' AND G.GNUM_HOSPITAL_CODE= 101"); 
