...
public interface PrConfig {
	...
	String EMPLOYEEREGISTRATION_DEFAULT_EMPLOYEE_LAST_EMPLOYMENt_TYPE = "1";
	String EMPLOYEEREGISTRATION_DEFAULT_EMPLOYEE_NATURE_OF_JOB = "1";
