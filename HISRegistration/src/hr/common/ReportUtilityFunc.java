...
public class ReportUtilityFunc {
...
//	private String path = "";
	...
	//	HashMap contextMap = null;
		...
		try {
			...
			HospitalMstVO hospitalVObj=ControllerUTIL.getHospitalVO(request);
...
*/
		...
		System.out.println(strReportFormat);
			...
			if (params == null || params.isEmpty()) {
				...
				params.put("jndi_ds_conn", this.getPath());
				params.put("h_code", hospitalVObj.getHospitalCode());
				//params.put("report_Header", this.getStoragePath("REPORT_HEADER"));
				params.put("report_Header", hospitalVObj.getHospitalName());
				//params.put("report_Address", this.getStoragePath("REPORT_ADDRESS"));
				params.put("report_Address", ((hospitalVObj.getAddress1()==""||hospitalVObj.getAddress1()==null)?" ":(hospitalVObj.getAddress1()+","))+((hospitalVObj.getAddress2()==""||hospitalVObj.getAddress2()==null)?" ":(hospitalVObj.getAddress2()+","))+ ((hospitalVObj.getCity()==""||hospitalVObj.getCity()==null)?" ":(hospitalVObj.getCity()+","))+((hospitalVObj.getPinCode()==""||hospitalVObj.getPinCode()==null)?" ":(hospitalVObj.getPinCode()))+"");
				params.put("report_Address1", ((hospitalVObj.getAddress1()==""||hospitalVObj.getAddress1()==null)?" ":(hospitalVObj.getAddress1()+",")));
				params.put("report_Address2", ((hospitalVObj.getAddress2()==""||hospitalVObj.getAddress2()==null)?" ":(hospitalVObj.getAddress2()+",")));
				//params.put("report_Address3", ((hospitalVObj.getCity()==""||hospitalVObj.getCity()==null)?" ":(hospitalVObj.getCity()+", "))+((hospitalVObj.getDistrictName()==""||hospitalVObj.getDistrictName()==null)?" ":(hospitalVObj.getDistrictName()+", "))+((hospitalVObj.getStateName()==""||hospitalVObj.getStateName()==null)?" ":(hospitalVObj.getStateName()+" "))+((hospitalVObj.getPinCode()==""||hospitalVObj.getPinCode()==null)?" ":(" ("+hospitalVObj.getPinCode()+")"))+"");
				//params.put("report_Address3", ((hospitalVObj.getCity()==""||hospitalVObj.getCity()==null)?" ":(hospitalVObj.getCity()+", "))+((hospitalVObj.getStateName()==""||hospitalVObj.getStateName()==null)?" ":(hospitalVObj.getStateName()+" "))+((hospitalVObj.getPinCode()==""||hospitalVObj.getPinCode()==null)?" ":(" ("+hospitalVObj.getPinCode()+")"))+"");
				params.put("report_Address3", ((hospitalVObj.getDistrictName()==""||hospitalVObj.getDistrictName()==null)?" ":(hospitalVObj.getDistrictName()+", "))+((hospitalVObj.getStateName()==""||hospitalVObj.getStateName()==null)?" ":(hospitalVObj.getStateName()+" "))+((hospitalVObj.getPinCode()==""||hospitalVObj.getPinCode()==null)?" ":(" ("+hospitalVObj.getPinCode()+")"))+"");
				//params.put("report_Contact", this.getStoragePath("REPORT_CONTACT"));
