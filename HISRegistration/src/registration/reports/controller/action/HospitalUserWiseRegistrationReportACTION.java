...
import registration.reports.controller.util.HospitalUserWiseRegistrationReportUTIL;
import vo.registration.AgeWiseRegistrationReportVO;


public class HospitalUserWiseRegistrationReportACTION extends AgeWiseRegistrationReportVO
{
	...
	WebUTIL.refreshTransState(super.getRequest(),"HospitalUserWiseRegistrationReportACTION");	
	this.reset();
	HospitalUserWiseRegistrationReportUTIL.getEssentials(super.getRequest());
    ...
    public void getUnit() {
		...
		HospitalUserWiseRegistrationReportUTIL.getUnit_AJAX(request,response);
	}
    public void showReport() {
		   
		System.out.println("AgeWiseRegistration Report :: showReport()");
		message = "Inside showReport() method";			
		HospitalUserWiseRegistrationReportUTIL.showReport(this, request, response);
	}
