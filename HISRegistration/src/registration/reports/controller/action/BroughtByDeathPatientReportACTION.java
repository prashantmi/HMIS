...
import registration.reports.controller.util.BroughtByDeathPatientReportUTIL;
import registration.transactions.controller.util.NewRegistrationUTIL;
import vo.registration.BroughtByDeathPatientReportVO;


public class BroughtByDeathPatientReportACTION extends  BroughtByDeathPatientReportVO{
...
public String init(){
	WebUTIL.refreshTransState(super.getRequest(),"BroughtByDeathPatientReportACTION");	
	this.reset();
	BroughtByDeathPatientReportUTIL.getEssentials(super.getRequest());
...
public void showReport() {
	...
	System.out.println("BroughtByDeathPatient Report :: showReport()");
	message = "Inside showReport() method";			
	BroughtByDeathPatientReportUTIL.showReport(this, request, response);
}	
