...
import registration.reports.controller.util.CrMergeReportUTIL;
import registration.transactions.controller.util.NewRegistrationUTIL;
import vo.registration.CrMergeReportVO;

public class CrMergeReportACTION extends CrMergeReportVO
...
public String init(){
	...
	WebUTIL.refreshTransState(super.getRequest(),"CrMergeReportACTION");	
	this.reset();
	CrMergeReportUTIL.getEssentials(super.getRequest());
...
public void showReport() {
	...
	System.out.println("CrMerge Report :: showReport()");
	message = "Inside showReport() method";			
	CrMergeReportUTIL.showReport(this, request, response);
}	
