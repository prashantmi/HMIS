...
import registration.reports.controller.util.UnknownPatientReportUTIL;
import registration.transactions.controller.util.NewRegistrationUTIL;
import vo.registration.UnknownPatientReportVO;

public class UnknownPatientReportACTION extends UnknownPatientReportVO
{
...
public String init(){
	WebUTIL.refreshTransState(super.getRequest(),"UnknownPatientReportACTION");	
	this.reset();
	UnknownPatientReportUTIL.getEssentials(super.getRequest());
...
public void showReport() {
	...
	System.out.println("UnknownPatient Report :: showReport()");
	message = "Inside showReport() method";			
	UnknownPatientReportUTIL.showReport(this, request, response);
}	
