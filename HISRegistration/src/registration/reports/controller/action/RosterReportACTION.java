...
import registration.reports.controller.util.RosterReportUTIL;
...
* 
*/
public class RosterReportACTION extends RosterReportVO
{
	...
	public String init(){
		...
		WebUTIL.refreshTransState(super.getRequest(),"RosterReportACTION");	
		this.reset();
	...
	public void showReport() {
		...
		RosterReportUTIL.showReport(this, request, response);
	}	
