...
import registration.reports.controller.util.DeptCensusAgeWiseStatReportUTIL;
...
* 
*/
public class DeptCensusAgeWiseStatReportACTION extends StatisticsReportVO
{
	...
	public String init(){
		...
		WebUTIL.refreshTransState(super.getRequest(),"DeptCensusAgeWiseStatReportACTION");	
		this.reset();
	...
	public void showReport() {
		...
		System.out.println("DeptCensusAgeWiseStatistics Report :: showReport()");
		message = "Inside showReport() method";			
		DeptCensusAgeWiseStatReportUTIL.showReport(this, request, response);
	}	
