...
import registration.reports.controller.util.DeptwiseOPDStatReportUTIL;
...
* 
*/
public class DeptwiseOPDStatReportACTION extends StatisticsReportVO
{
	...
	public String init(){
		...
		WebUTIL.refreshTransState(super.getRequest(),"DeptwiseOPDStatReportACTION");	
		this.reset();
	...
	public void showReport() {
		...
		DeptwiseOPDStatReportUTIL.showReport(this, request, response);
	}	
