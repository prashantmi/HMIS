 ...
 *
 */
public class CasteMstUTIL implements MasterInterface 
{
	...
	{
		String[] columnHdr = { "Caste Name","Caste Short Name"};
		return columnHdr;
	}
	...
	{		
		String strMasterName = "Caste Master";
	...
	{		
		String strOrderBy[] = { "1", "UPPER(GSTR_CASTE_NAME)","2", " UPPER(GSTR_CASTE_CODE) "};
		return strOrderBy;
	}
	...
	{		
		String strSearchField[] = { "1", " UPPER(GSTR_CASTE_NAME) ", "2", " UPPER(GSTR_CASTE_CODE) " };
	...
	public List<String> getViewHeader()
	{
		...
		viewHdr.add("Caste Name");
		viewHdr.add("D");
		viewHdr.add("Caste Short Name");
		viewHdr.add("D");
		return viewHdr;
	}
