 ...
 *
 */
public class VerificationDocMstUTIL implements MasterInterface 
{
	...
	{
		String[] columnHdr = { "Document Name","Alternate ID"};
		return columnHdr;
	}
	...
	{		
		String strMasterName = "Verifiction Document Master";
	...
	{		
		String strOrderBy[] = { "1", "UPPER(GSTR_DOCUMENT_NAME)","2", "UPPER(GNUM_IS_ALTERNATEID)"};
		return strOrderBy;
	}
	...
	{		
		String strSearchField[] = { "1", " UPPER(GSTR_DOCUMENT_NAME) ","2", " UPPER(DECODE(GNUM_IS_ALTERNATEID,'0','No','1','Yes'))" };
	...
	public List<String> getViewHeader() 
	{
		...
		viewHdr.add("Document");
		viewHdr.add("D");
		viewHdr.add("Is Alternate");
		viewHdr.add("D");
		viewHdr.add("ID Size");
		viewHdr.add("D");
		viewHdr.add("Validation Type");
		viewHdr.add("D");
		viewHdr.add("Issuing Authority");
		viewHdr.add("D");
		return viewHdr;
	}
