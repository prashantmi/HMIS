 ...
 *
 */
public class DesignationMstUTIL implements MasterInterface 
{
	...
	{		
		String[] strComboHdr = { "1", "Is Active"  };
		return strComboHdr;
	}
	...
	{		
		String strMasterName = "Designation Master";
		return strMasterName;
	}

	public String[] getOrderBy() 
	{		
		String strOrderBy[] = { "1", "UPPER(GSTR_DESIG_NAME)"};
		return strOrderBy;
	}
	...
	{		
		String strSearchField[] = { "1", " UPPER(GSTR_DESIG_NAME) " };
