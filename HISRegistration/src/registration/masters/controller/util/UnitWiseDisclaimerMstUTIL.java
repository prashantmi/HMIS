 ...
 *
 */
public class UnitWiseDisclaimerMstUTIL implements MasterInterface {
	...
	{
		String[] columnHdr = { "Unit","Disclaimer1","Disclaimer2","Disclaimer3"};
		return columnHdr;
	}
	...
	{		
		String strMasterName = "Unit Disclaimer Master";
		return strMasterName;
	}

	public String[] getOrderBy()
	{		
		String strOrderBy[] = { "1", "UPPER(HGSTR_UNITNAME)","2", "UPPER(HGSTR_DISCLAIMER_DESC1)","3", "UPPER(HGSTR_DISCLAIMER_DESC2)","4", "UPPER(HGSTR_DISCLAIMER_DESC3)"};
		return strOrderBy;
	}
	...
	{		
		String strSearchField[] = { "1", "UPPER(HGSTR_UNITNAME)","2", "UPPER(HGSTR_DISCLAIMER_DESC1)","3", "UPPER(HGSTR_DISCLAIMER_DESC2)","4", "UPPER(HGSTR_DISCLAIMER_DESC3)"};
