 ...
 *
 */
public class DepartmentMstUTIL implements MasterInterface {
	...
	public List<String> getViewHeader() 
	{
		...
		viewHdr.add("Global Department :");
		viewHdr.add("D");
		viewHdr.add("Department Name :");
		viewHdr.add("D");
		viewHdr.add("Department Type :");
		viewHdr.add("D");
		viewHdr.add("Department Loaction :");
		viewHdr.add("D");
		viewHdr.add("Head Of Department :");
		viewHdr.add("D");
