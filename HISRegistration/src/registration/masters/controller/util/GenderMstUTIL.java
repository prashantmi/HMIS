 ...
 *
 */
public class GenderMstUTIL implements MasterInterface
{
	...
	{
		String[] columnHdr = { "Gender Name","Gender Short Name"};
		return columnHdr;
	}
	...
	{		
		String strMasterName = "Gender Master";
	...
	{		
		String strOrderBy[] = { "1", "UPPER(GSTR_GENDER_NAME)","2", "UPPER(GSTR_GENDER_CODE)"};
		return strOrderBy;
	}
	...
	{		
		String strSearchField[] = { "1", " UPPER(GSTR_GENDER_NAME) ","2", "UPPER(GSTR_GENDER_CODE)" };
	...
	public List<String> getViewHeader()
	{
		...
		viewHdr.add("Gender Name");
		viewHdr.add("D");
		viewHdr.add("Gender Short Name");
		viewHdr.add("D");
		return viewHdr;
	}
