 ...
 *
 */
public class EmgMlcCaseTypeMstUTIL implements MasterInterface 
{
	...
	{		
		String strMasterName = "Mlc Case Type Master";
		return strMasterName;
	}

	public String[] getOrderBy() 
	{		
		String strOrderBy[] = { "1", "UPPER(HRGSTR_MLC_CASE_TYPE)"};
		return strOrderBy;
	}
	...
	{		
		String strSearchField[] = { "1", "UPPER(HRGSTR_MLC_CASE_TYPE)"};
