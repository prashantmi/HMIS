 ...
 *
 */
public class PoliceStationMstUTIL implements MasterInterface 
{
	...
	{		
		String strMasterName = "Police Station Master";
		return strMasterName;
	}

	public String[] getOrderBy() 
	{		
		String strOrderBy[] = { "1", "UPPER(HGSTR_PS_FULLNAME)"};
		return strOrderBy;
	}
	...
	{		
		String strSearchField[] = { "1", "UPPER(HGSTR_PS_FULLNAME)"};
	...
	public List<String> getViewHeader() 
	{
		...
		viewHdr.add("PS Full Name :");
		viewHdr.add("D");
		viewHdr.add("PS Short Name :");
		viewHdr.add("D");
		viewHdr.add("Address Line1 :");
		viewHdr.add("D");
		viewHdr.add("Sub Locality1 :");
		viewHdr.add("D");
		viewHdr.add("Sub Locality2 :");
		viewHdr.add("D");
		viewHdr.add("City :");
		viewHdr.add("D");
		...
		viewHdr.add("D");
		viewHdr.add("Incharge Name :");
		viewHdr.add("D");
		viewHdr.add("Incharge Designation :");
		viewHdr.add("D");
		viewHdr.add("Incharge Badge No. :");
		viewHdr.add("D");
