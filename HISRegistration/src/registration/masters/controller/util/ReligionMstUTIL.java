 ...
 *
 */
public class ReligionMstUTIL implements MasterInterface {
	...
	{
		String[] columnHdr = { "Religion Name","Minority"};
		return columnHdr;
	}
	...
	public String getMasterName() {		
		String strMasterName = "Religion Master";
	...
	{		
		String strOrderBy[] = { "1", "UPPER(GSTR_RELIGION_NAME)","2", "UPPER(GNUM_MINORITY_COMMUNITY)"};
		return strOrderBy;
	}
	...
	{		
		String strSearchField[] = { "1", " UPPER(GSTR_RELIGION_NAME) ","2", " UPPER(DECODE(GNUM_MINORITY_COMMUNITY,'1','Yes','0','No')) " };
	...
	public List<String> getViewHeader() 
	{
		...
		viewHdr.add("Religion Name");
		viewHdr.add("D");
		viewHdr.add("Minority");
		viewHdr.add("D");
		return viewHdr;
	}
