 ...
 *
 */
public class CountryMstUTIL implements MasterInterface 
{
	...
	{
		String[] columnHdr = { "Country Name","Country Short Name"};
		return columnHdr;
	}
	...
	{		
		String strMasterName = "Country Master";
		return strMasterName;
	}

	public String[] getOrderBy()
	{		
		String strOrderBy[] = { "1", "UPPER(GSTR_COUNTRY_NAME)","2", "UPPER(GSTR_COUNTRY_CODE)"};
		return strOrderBy;
	}
	...
	{		
		String strSearchField[] = { "1", " UPPER(GSTR_COUNTRY_NAME) ","2", "UPPER(GSTR_COUNTRY_CODE)" };
