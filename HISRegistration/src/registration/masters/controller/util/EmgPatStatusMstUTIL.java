 ...
 *
 */
public class EmgPatStatusMstUTIL implements MasterInterface 
{
	...
	{
		String[] columnHdr = { "Patient Status"};
		return columnHdr;
	}
	...
	{		
		String strMasterName = "Patient Status Master";
		return strMasterName;
	}

	public String[] getOrderBy() 
	{		
		String strOrderBy[] = { "1", "UPPER(HRGSTR_STATUS)"};
		return strOrderBy;
	}
	...
	{		
		String strSearchField[] = { "1", "UPPER(HRGSTR_STATUS)"};
