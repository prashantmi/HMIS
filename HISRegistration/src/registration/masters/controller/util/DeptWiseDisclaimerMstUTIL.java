 ...
 *
 */
public class DeptWiseDisclaimerMstUTIL implements MasterInterface {
	...
	{
		String[] columnHdr = { "Department","Disclaimer1","Disclaimer2","Disclaimer3"};
		return columnHdr;
	}
	...
	{		
		String strMasterName = "Department Disclaimer Master";
		return strMasterName;
	}

	public String[] getOrderBy()
	{		
		String strOrderBy[] = { "1", "UPPER(GSTR_DEPT_NAME)","2", "UPPER(HGSTR_DISCLAIMER_DESC1)","3", "UPPER(HGSTR_DISCLAIMER_DESC2)","4", "UPPER(HGSTR_DISCLAIMER_DESC3)"};
		return strOrderBy;
	}
	...
	{		
		String strSearchField[] = { "1", "UPPER(GSTR_DEPT_NAME)","2", "UPPER(HGSTR_DISCLAIMER_DESC1)","3", "UPPER(HGSTR_DISCLAIMER_DESC2)","4", "UPPER(HGSTR_DISCLAIMER_DESC3)"};
