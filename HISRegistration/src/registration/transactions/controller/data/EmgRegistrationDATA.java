...
public class EmgRegistrationDATA extends ControllerDATA {


	public static Map getEmgRegistrationFormInitialEssentials(UserVO _UserVO)
	{
		RegEssentialBO  essentialBO=new RegEssentialBO();
		Map mp=essentialBO.getEmgRegistrationFormInitialEssentials(_UserVO);
		
		return mp;		
	}
/**
 * gets Emg Registration Essentials
 * calls getEmgPatientRegEssential from EssentialDelegate
 * @param _UserVO Provides User details.
 * @return map containing new patient registration essentials
 */
	/*public static Map getAllEmgRegistrationEssentials(UserVO _UserVO, String strStateCode)
	{
		RegEssentialBO  essentialBO=new RegEssentialBO();
	...
	{
		RegEssentialBO  essentialBO=new RegEssentialBO();
		Map mp=essentialBO.getEmgRegistrationFormEssentials_AJAX(_UserVO,strStateCode,objRequest_p);
	 ...
	 */
	public static EpisodeVO[] registerEmgPatient(PatientVO objPatVO_p, EpisodeVO[] objEpisodeVO_p,UserVO objUserVO_p, HttpServletRequest  objRequest_p,PatientBroughtByDtlVO PatientBroughtByDtlVO_p) {
		PatientBO objPatientBO = new PatientBO(); 
		return objPatientBO.newEmgRegistration(objEpisodeVO_p, objPatVO_p,objUserVO_p, objRequest_p,  PatientBroughtByDtlVO_p);
	}
