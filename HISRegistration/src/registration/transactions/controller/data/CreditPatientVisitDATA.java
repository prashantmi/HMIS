...
public class CreditPatientVisitDATA  {
...
//	}
	...
	public static BeneficiaryPatientVO[] getCreditBenDtl(String strCrNo_p, UserVO objUserVO_p, String strMode_p){
		PatientBO objPatientBO = new PatientBO();
		BeneficiaryPatientVO[] _beneficiaryPatientVO =objPatientBO.getCreditBenDtl(strCrNo_p, objUserVO_p, "1");
	...
	public static Map 	savePatientVisit(PatientVO objPatVO_p, EpisodeVO[] _episodeVO, UserVO objUserVO_p,EpisodeRefDtlVO episodeRefDtlVO, EpisodeVO[] _episodeNewDeptVO){
		PatientBO objPatientBO = new PatientBO();		
		return objPatientBO.savePatientVisit(_episodeVO, objPatVO_p, objUserVO_p,episodeRefDtlVO,_episodeNewDeptVO);  
	}
