...
public class NewRegistrationDATA extends ControllerDATA {
 ...
 */
	...
	public static List getPatDtlOnPatMobile(UserVO userVO_p,String searchId, String searchValue,String strMode_p) {
		System.out.println("NewRegistrationDATA :: getPatDtlOnPatCatId");
		RegEssentialBO  essentialBO=new RegEssentialBO();
		return essentialBO.getPatDtlOnPatMobile(userVO_p,searchId,searchValue,strMode_p);
	}
	 ...
	 */
	public static EpisodeVO[] registerNewPatient(PatientVO objPatVO_p, EpisodeVO[] objEpisodeVO_p,UserVO objUserVO_p, HttpServletRequest  objRequest_p) {
		PatientBO objPatientBO = new PatientBO(); 
		return objPatientBO.newPatRegistration(objEpisodeVO_p, objPatVO_p,objUserVO_p, objRequest_p);
	}
	...
	public static String checkBeneficiaryIdDuplicy(UserVO objUserVO_p, CreditAvailDetailVO objcreditAvailDtlVO_p) {
		RegEssentialBO  essentialBO=new RegEssentialBO();
		return essentialBO.checkBeneficiaryIdDuplicy(objUserVO_p, objcreditAvailDtlVO_p);
	}
	...
	Date:03-July-15
	*/
	public static String checkAarogyashriIdDuplicy(UserVO objUserVO_p, BeneficiaryPatientVO objPatBenlDtlVO_p) {
		RegEssentialBO  essentialBO=new RegEssentialBO();
		return essentialBO.checkAarogyashriIdDuplicy(objUserVO_p, objPatBenlDtlVO_p);
	}
	//End
	/**
	...
	*//**
	...
	public static String getAadhaarDecrypted(String uuid, String crno){		
		PatientBO objPatientBO = new PatientBO(); 
		return objPatientBO.getAadhaarDecrypted(uuid, crno);	
	}
	public static void CreateQREntry(PatientVO objPatientVO, String _QRDataString, String hospitalCode)
	{
		PatientBO objPatientBO = new PatientBO();
		//objPatientBO.CreateQREntry(objPatientVO, _QRDataString, hospitalCode);
	}
}