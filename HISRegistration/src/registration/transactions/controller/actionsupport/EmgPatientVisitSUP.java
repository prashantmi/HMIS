...
public class EmgPatientVisitSUP extends ActionSupport implements Preparable,ServletRequestAware, ServletResponseAware, SessionAware, ServletContextAware
{
	...
	protected String emgRenewalRequired;
	...
	protected String mlcFlag;
	protected String[] arrMlcFlag;
	protected String isMlcWithin24hrs;
	...
	//Added by Vasu on 08.May.18 for brought by details
	...
	public String[] getArrMlcFlag() {
		return arrMlcFlag;
	}
	public void setArrMlcFlag(String[] arrMlcFlag) {
		this.arrMlcFlag = arrMlcFlag;
	}
	...
	public String getIsMLCFlag() {
		return isMLCFlag;
	}
	public void setIsMLCFlag(String isMLCFlag) {
		this.isMLCFlag = isMLCFlag;
	}
