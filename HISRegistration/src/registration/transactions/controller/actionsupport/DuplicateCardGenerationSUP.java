...
public abstract class DuplicateCardGenerationSUP extends CRNoSUP implements ServletRequestAware, ServletResponseAware, SessionAware, ServletContextAware
{
	...
	public DuplicateCardGenerationSUP()
	{
		valid="";
		errorMessage="";
	}
