...
public class PatientVisitSUP extends ActionSupport implements Preparable,ServletRequestAware, ServletResponseAware, SessionAware, ServletContextAware
{
	...
	private String episodeExpiryDateInCaseOfReffer="";//by Mukund on 02.05.2017
	private String oldCreditLetterRefNo;//by Mukund on 09.05.2017
	private String fourteenDayRenewal;
	...
	private String isDuplicateRegistered;
	private String selectedDuplicatePatCrNo;
	private String slNoHashUhidForDupCont;
	protected String isPatFromAppointList; //Added by Vasu on 28.05.18 for online Appointment
	protected String patNewDeptVisitAmountSpl; //Added by Garima on 28.05.18 for Unit Wise Visit
	protected String snomdPTVisitReason;//Added by Garima on 28.05.18 for Unit Wise Visit
	protected String snomdCIdVisitReason;//Added by Garima on 28.05.18 for Unit Wise Visit
	...
	public String getPatNewDeptVisitAmountSpl() {
		return patNewDeptVisitAmountSpl;
	}
	public void setPatNewDeptVisitAmountSpl(String patNewDeptVisitAmountSpl) {
		this.patNewDeptVisitAmountSpl = patNewDeptVisitAmountSpl;
	}
	...
	public void reset(){
		...
		this.setEpisodeExpiryDateInCaseOfReffer("");
	...
	public void setPatStaffRelationName(String patStaffRelationName) {
		...
		//End
	/*Start : Surabhi
	 * Reason : to get the details of the externally referred patients
	 * date : 7th oct 2016 */
	...
	// end
	public String getEpisodeExpiryDateInCaseOfReffer() {
		return episodeExpiryDateInCaseOfReffer;
	}
	public void setEpisodeExpiryDateInCaseOfReffer(
			String episodeExpiryDateInCaseOfReffer) {
		this.episodeExpiryDateInCaseOfReffer = episodeExpiryDateInCaseOfReffer;
	}
	...
	public String getFourteenDayRenewal() {
		return fourteenDayRenewal;
	}
	public void setFourteenDayRenewal(String fourteenDayRenewal) {
		this.fourteenDayRenewal = fourteenDayRenewal;
	}
	public String getIsDuplicateRegistered() {
		return isDuplicateRegistered;
	}
	public void setIsDuplicateRegistered(String isDuplicateRegistered) {
		this.isDuplicateRegistered = isDuplicateRegistered;
	}
	public String getSelectedDuplicatePatCrNo() {
		return selectedDuplicatePatCrNo;
	}
	public void setSelectedDuplicatePatCrNo(String selectedDuplicatePatCrNo) {
		this.selectedDuplicatePatCrNo = selectedDuplicatePatCrNo;
	}
	public String getSlNoHashUhidForDupCont() {
		return slNoHashUhidForDupCont;
	}
	public void setSlNoHashUhidForDupCont(String slNoHashUhidForDupCont) {
		this.slNoHashUhidForDupCont = slNoHashUhidForDupCont;
	}
