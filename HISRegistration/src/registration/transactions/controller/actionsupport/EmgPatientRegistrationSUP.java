...
public abstract class EmgPatientRegistrationSUP extends ActionSupport implements Preparable,ServletRequestAware, ServletResponseAware, SessionAware, ServletContextAware
{
	...
	// brought by vehicle detaiils
	protected String broughtByVehicleCode="";
	protected String vehicleHosCode ="";
	protected String patVehicleNo ="";
	...
	protected String memSlNo;
	protected String strEmployeePatCatGroup;
	
	protected String adhaarRegisteredFlag;
	
	protected String patMemRelationCode;
	protected String patMemRelationName;
	protected String policeStation;
	//added by Mukund Vinayak On 22.07.2016
		protected String letterType;
		protected String creditLimit;
		protected String agsCreditLimit;
	protected String isAadharConsentGiven;
	
	//Added by Vasu on 02.May.18
	   protected String isAmbulatory;
	   protected String isAmbulatoryCheckUncheck;
	   protected String isTrauma;//Added by Vasu on 05.June.2018
	   
protected String isDuplicateRegistered;
protected String selectedDuplicatePatCrNo;
protected String patEmgCntNo;
	

protected String broughtByConsultant;
protected String paymentModeRefId;
protected String paymentModeCode;
protected String snomdPTVisitReason;
protected String snomdCIdVisitReason;
	...
	public String getPatMemRelationCode() {
		return patMemRelationCode;
	}

	public void setPatMemRelationCode(String patMemRelationCode) {
		this.patMemRelationCode = patMemRelationCode;
	}
	...
	protected String  patMemDeptName;
	...
	public String getBroughtByVehicleCode() {
		return broughtByVehicleCode;
	}

	public void setBroughtByVehicleCode(String broughtByVehicleCode) {
		this.broughtByVehicleCode = broughtByVehicleCode;
	}

	public String getVehicleHosCode() {
		return vehicleHosCode;
	}

	public void setVehicleHosCode(String vehicleHosCode) {
		this.vehicleHosCode = vehicleHosCode;
	}
	...
	public EmgPatientRegistrationSUP()
	{
		patPrimaryCat="";
		patPrimaryCatCode="";
	    patSecondaryCat="";
...
public String getIsAmbulatoryCheckUncheck() {
	return isAmbulatoryCheckUncheck;
}

public void setIsAmbulatoryCheckUncheck(String isAmbulatoryCheckUncheck) {
	this.isAmbulatoryCheckUncheck = isAmbulatoryCheckUncheck;
}
...
public void setBroughtByDeclared(String broughtByConsultant) {
