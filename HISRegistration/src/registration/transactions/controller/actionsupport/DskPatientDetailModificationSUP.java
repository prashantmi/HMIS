...
public abstract class DskPatientDetailModificationSUP extends CRNoSUP implements ServletRequestAware, ServletResponseAware, SessionAware, ServletContextAware
{
...
public void setAfterGo(String afterGo) {
	...
	public DskPatientDetailModificationSUP()
	{
		patPrimaryCat="";
		patPrimaryCatCode="";
	    patSecondaryCat="";
