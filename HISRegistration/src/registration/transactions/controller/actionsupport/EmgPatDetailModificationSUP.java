...
public abstract class EmgPatDetailModificationSUP extends CRNoSUP implements ServletRequestAware, ServletResponseAware, SessionAware, ServletContextAware
{
	...
	protected String defaultPatAge;
    protected String defaultPatAgeUnit;
    protected String defaultPatDOB;
	...
	protected String isImageStoredFTP;
...
public void setAfterGo(String afterGo) {
	...
	public EmgPatDetailModificationSUP()
	{
		patPrimaryCat="";
		patPrimaryCatCode="";
	    patSecondaryCat="";
	...
	public void clear()
	{
	    ...
	    patMiddleName="";
	    patLastName="";
	    patFirstNameInMultiLang="";
	    patMiddleNameInMultiLang="";
	    patLastNameInMultiLang="";
	    referringInst="";
	    patMomName="";
	    patGender="";
		patGenderCode="";
	...
	public String getDefaultPatAge() {
		return defaultPatAge;
	}

	public void setDefaultPatAge(String defaultPatAge) {
		this.defaultPatAge = defaultPatAge;
	}

	public String getDefaultPatAgeUnit() {
		return defaultPatAgeUnit;
	}

	public void setDefaultPatAgeUnit(String defaultPatAgeUnit) {
		this.defaultPatAgeUnit = defaultPatAgeUnit;
	}

	public String getDefaultPatDOB() {
		return defaultPatDOB;
	}

	public void setDefaultPatDOB(String defaultPatDOB) {
		this.defaultPatDOB = defaultPatDOB;
	}
