...
public abstract class PatientDetailModificationSUP extends CRNoSUP implements ServletRequestAware, ServletResponseAware, SessionAware, ServletContextAware
{
...
public void setPatDocTypeName(String patDocTypeName) {
	...
	protected String isLocationComboReq;
...
public void setAfterGo(String afterGo) {
	...
	public PatientDetailModificationSUP()
	{
		patPrimaryCat="";
		patPrimaryCatCode="";
	    patSecondaryCat="";
