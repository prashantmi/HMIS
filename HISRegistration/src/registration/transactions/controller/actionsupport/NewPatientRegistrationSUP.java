...
public abstract class NewPatientRegistrationSUP extends ActionSupport implements Preparable,ServletRequestAware, ServletResponseAware, SessionAware, ServletContextAware
{
	...
	protected String isSnomedServiceOn;//setIsSnomedServiceOn
	...
	public NewPatientRegistrationSUP()
	{
		patPrimaryCat="";
		patPrimaryCatCode="";
	    patSecondaryCat="";
