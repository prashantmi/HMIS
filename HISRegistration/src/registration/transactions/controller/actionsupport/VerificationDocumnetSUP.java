...
public abstract class VerificationDocumnetSUP extends CRNoSUP implements ServletRequestAware, ServletResponseAware, SessionAware, ServletContextAware
{
...
public void setAfterGo(String afterGo) {
	...
	public VerificationDocumnetSUP()
	{
		patPrimaryCat="";
		patPrimaryCatCode="";
	    patSecondaryCat="";
