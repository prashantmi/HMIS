...
public class PatientVisitACT extends PatientVisitSUP 
{
	public String execute() throws Exception
	 {
		...
		/***/
		/*String isDuplicateRegistered = (String)objRequest.getSession().getAttribute("isDuplicateRegistered");
		String selectedDuplicatePatCrNo = (String)objRequest.getSession().getAttribute("patCrNo");
		
		String paramValue = objRequest.getParameter("selectedDuplicatePatCrNo");
		
		if(isDuplicateRegistered!=null && !isDuplicateRegistered.equals("") && isDuplicateRegistered.equals("1"))
			this.setIsDuplicateRegistered(isDuplicateRegistered);
		if(selectedDuplicatePatCrNo!=null && !selectedDuplicatePatCrNo.equals("") )
			this.setPatCrNo(selectedDuplicatePatCrNo);*/
		/***/
		return NEW();
	 }
	 /**
		...
		public String NEW()
		{
			...
			PatientVisitUTL.getMapOfRenewalConfigDtlOnKeyPatCat(this,objRequest);
		 	this.setAfterGo("0");
		 	...
		 	if(RegistrationConfig.REGISTRATION_ONLINE_OFFLINE_TYPE.equals(RegistrationConfig.REGISTRATION_ONLINE_OFFLINE_BOTH) || RegistrationConfig.REGISTRATION_ONLINE_OFFLINE_TYPE.equals(RegistrationConfig.REGISTRATION_ONLINE))
		 	{
				...
				{
			 		strMode="NEWPATIENT";
			 		PatientVisitUTL.getOldPatReferDtl(this, objRequest);
			 		PatientVisitUTL.getExtReferPatient(this, objRequest,"5");
				}
				else if(this.getModeCase().equals("1"))
				{
					strMode="NEWPATIENT";
					//PatientVisitUTL.getReferPatient(this,objRequest,"2");
					//PatientVisitUTL.getExtReferPatient(this, objRequest,"5");
					//PatientVisitUTL.getAppointedPatient(this,objRequest,"2");//added by Vasu on 25.May.18 for Online Appointment
				
					PatientVisitUTL.getOldPatReferDtl(this, objRequest);
			 		PatientVisitUTL.getReferPatient(this,objRequest,"2");
					PatientVisitUTL.getExtReferPatient(this, objRequest,"5"); 
					PatientVisitUTL.getAppointedPatient(this,objRequest,"6");
				}
				else 
				{
					strMode="NEWPATIENT";
					PatientVisitUTL.getOldPatReferDtl(this, objRequest);
			 		PatientVisitUTL.getReferPatient(this,objRequest,"2");
					PatientVisitUTL.getExtReferPatient(this, objRequest,"5"); 
					PatientVisitUTL.getAppointedPatient(this,objRequest,"6");//added by Vasu on 25.May.18 for Online Appointment
				}
		 	}	
		 	return "NEW";
		}
	 ...
	 /**
		...
		public String GETPATDTL()
		{
			...
			else if(this.getModeCase().equals("2"))
			{
				...
				//By Vasu :28/05/2018 for Appointment details
			...
			PatientVisitUTL.setPatientDtlByCrno(this,objRequest);
			PatientVisitUTL.getInitEssentials(this, objRequest, objResponse);
		...
		* @param mapping -object of ActionMapping
		...
		public void getRefDept()
		 {
			 ...
			 PatientVisitUTL.getRefDept_AJAX(objRequest, objResponse);
		 }
		...
		/*Start : Surabhi
		 * Reason : Changes done to accept the externally referred patients
		 * date : 7th oct 2016 */
		public String SAVE(){
			...
			//try{
			if(this.otherHospitalFlag.equals("1"))
				this.setIsRefferInOut(RegistrationConfig.IS_REFERRED_IN_OUT_ACCEPT_EXTERNAL);
				...
				{
					renewStatus=PatientVisitUTL.saveOldPatientVisit(objRequest,this,"SAVE");
				...
				else if(this.getOldDepartmentVisit().equals("")  && this.getNewDepartmentVisit().equalsIgnoreCase("On"))
				{
					...
					if(this.getOtherHospitalFlag().equals("0"))
					{
						PatientVisitUTL.savePatientNewDepartmentVisit(objRequest, this);
					}
					else
						PatientVisitUTL.saveExtPatientNewDepartmentVisit(objRequest, this);
				}
				else if(this.getNewDepartmentVisit().equalsIgnoreCase("On") && this.getOldDepartmentVisit().equalsIgnoreCase("On"))
				{
					...
					PatientVisitUTL.savePatientVisitStamp(objRequest,this);
		...
		public String EPISODEDTL(){
			...
			PatientVisitUTL.getOpenEpisodeDtl(objRequest,this);
			return "SAMENEWPATIENT";
		}
		...
		public String RENEWAL(){
			...
			if(this.getModeCase().equals("0"))
			{
				renewStatus=PatientVisitUTL.saveOldPatientVisit(objRequest,this,"RENEWAL");
			}
		...
		public String PRINT(){
			...
			PatientVisitUTL.printLastOpdCard(this,objRequest);
		...
		*/
		 ...
		 public String CASHCOLLECTIONPOPUP() {
				...
				PatientVisitUTL.getCashCollectionDetail(objRequest,objResponse, this);
