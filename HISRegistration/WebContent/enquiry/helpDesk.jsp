...
<his:javascript src="/enquiry/js/helpDesk.js" />
...
<html>
	...
	%>
		<html:form action="/hisHelpDesk">
			...
			<html:hidden name="HelpDeskFB" property="mode" />
			<html:hidden name="HelpDeskFB" property="deskMenuId" />
		</html:form>
	</body>
</html>