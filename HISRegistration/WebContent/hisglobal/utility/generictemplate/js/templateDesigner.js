...
Resizer.prototype.create = function(_parent)
{
	...
	img.src = "/AHIMS/hisglobal/images/Pl_Green_Sqr.png";
	...
	img.src = "/AHIMS/hisglobal/images/Mi_Green_Sqr.png";
...
ColorControl.prototype.create=function(_parent)
{
	...
	var img = TemplateDesigner.createElement("img",td);
	img.src = "/AHIMS/hisglobal/images/select_arrow.gif";
...
ColorControl.evtColorImageMouseOver = function(evnt)
{
	try
	{
		var objColor = ColorControl.getObject();
		if(objColor)
			objColor.elemPickerImage.src = "/AHIMS/hisglobal/images/select_arrow_over.gif";
	}
	catch(e)
	{
		alert("Error Message -> "+e.message);
...
ColorControl.evtColorImageMouseOut = function(evnt)
{
	try
	{
		var objColor = ColorControl.getObject();
		if(objColor)
			objColor.elemPickerImage.src = "/AHIMS/hisglobal/images/select_arrow.gif";
	}
	catch(e)
	{
		alert("Error Message -> "+e.message);
...
ImageUploadControl.prototype.create = function(_parent)
{
	...
	var img = TemplateDesigner.createElement("img",td);
	img.src = "/AHIMS/hisglobal/images/nodeClose.gif";
	img.border = 0;
