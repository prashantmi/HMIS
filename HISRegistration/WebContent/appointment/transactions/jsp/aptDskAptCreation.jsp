...
<s:form action="newAptCreationNewAppointmentAptDskCalendar">
				...
				<div class="div-table-col width100 ">
					<div class="div-table">
						...
						<div class="div-table-row">
							...
							<div class="div-table-col control" style="width: 25%;">
								<input name="patMiddleName" id="patMiddleName" tabindex="2" maxlength="33" type="text">
							</div>
							<div class="div-table-col control" style="width: 25%;">
								<input name="patLastName" id="patLastName" tabindex="2"  maxlength="33" type="text">
							</div>
						</div>
						<div class="div-table-row">
				    		<div class="div-table-col label" style="width: 25%" ><font color="red">*</font><s:text name="age"/></div>
							<div class="div-table-col control" style="width: 25%">
							       <input id="patAge" name="patAge" id="patAge" type="text"  tabindex="1"  size="3" maxlength="3" onblur="showDivAge();" >
							       <s:if test="%{#session.LSTAGETYPE}">
										<s:select list="%{#session.LSTAGETYPE}" listKey="value" listValue="label" name="patAgeUnit" id="patAgeUnit" cssStyle="width :75px"  > </s:select>
									</s:if>
									<s:else>
							...
							<div class="div-table-col control" style="width: 25%;">
								<s:if test="%{#session.LSTGENDER}">
									<s:select 	list="%{#session.LSTGENDER}"  tabindex="1"  listKey="value" listValue="label" name="patGenderCode" id="patGenderCode" cssStyle="width:75px;" > </s:select>
								</s:if>
								<s:else >
						...
						<div class="div-table-row">
							...
							<div class="div-table-col control" style="width: 25%;">
							   <input name="patHusbandName" id="patHusbandName" tabindex="2" maxlength="60" type="text">
							</div>	
						</div>	
						<div class="div-table-row ">
