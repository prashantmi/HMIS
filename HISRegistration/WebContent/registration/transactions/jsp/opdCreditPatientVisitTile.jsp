...
<body>
		<s:form action="PatientCreditVisit">
...
<%-- 					</s:action> --%>
				...
				<%-- <s:include value="/registration/transactions/jsp/patientDetailsTile.jsp"/> --%>
					...
					<div id="divCatGroupBeneficiaryId"><div class="div-table">	<div class="div-table-row width100"><div class="div-table-col title width80 ">
					<s:text name="beneficiary"/>&nbsp;<s:text name="global.detail"/></div>
					<div class="div-table-col title width20 " > <s:text name="Add Beneficiary Detail"/> 
						<!-- <img class='button' src='/HIS/hisglobal/images/avai/plus.png' id='addBenDtlId'	style='cursor: pointer;' onclick="enableBenDtl();" > -->
					<input type="checkbox" name="addBenDtl" id="addBenDtlId" tabindex="1" onclick="enableBenDtl();"/>
												<%-- <s:hidden name="episodeCode" value="%{epCode}"></s:hidden> --%>
											</div>
											</div></div>
						<s:set name="voArrCreditBenDtl" value="#session[@registration.config.RegistrationConfig@ARR_BENEFICIARY_PAT_VO]"></s:set>
										<s:if test="%{#voArrCreditBenDtl!= null && #voArrCreditBenDtl.length != 0}">
										<div class="div-table-listing rounded" >
									<div class="div-table-row listHeader" >
										<div class="div-table-col alignCenter" style="width: 5%"><s:text name="select"/></div>
										<div class="div-table-col alignCenter" style="width: 30%"><s:text name="Credit Reference No."/> </div>
										 <div class="div-table-col alignCenter" style="width: 30%"><s:text name="Validity"/></div> 
										  <div class="div-table-col alignCenter" style="width: 30%"><s:text name="Credit Limit"/></div> 
									</div>
									<s:iterator id="voArrCreditBenDtlId"  value="voArrCreditBenDtl" status="key">
										<s:set name="referenceNo" value="creditLetterRefNo"></s:set>
										 <s:set name="cardValidityDate" value="cardvalidityDate"></s:set>
										  <s:set name="creditLimit" value="creditLimit"></s:set>
										   <s:set name="keyValue" value='<s:property value="#key.index"/>'></s:set>
										...
										<div class="div-table-row listData">
											<div class="div-table-col alignCenter" style="width: 5%;">
												<input type="radio" name="creditBen" id="creditBenId" title='<s:property value="#key.index"/>' value='<s:property value="referenceNo"/>#<s:property value="cardValidityDate"/>#<s:property value="creditLimit"/>'>
												<%-- <s:hidden name="episodeCode" value="%{epCode}"></s:hidden> --%>
											</div>
										 <div class="div-table-col alignCenter" style="width: 30%">
											...
											<div class="div-table-col alignCenter" style="width: 30%">
												<s:property value="cardValidityDate"/>
												<%-- <s:hidden name="frmDepUnitCode" value="%{frmDepUnitCode}"></s:hidden> --%>
											</div> 
												<div class="div-table-col alignCenter" style="width: 30%">
												<s:property value="creditLimit"/>
												<%-- <s:hidden name="frmDepUnitCode" value="%{frmDepUnitCode}"></s:hidden> --%>
											</div> 
									...
									<div id="AddBenDtlDiv" style="display: none;">
										<div class="div-table">	
										<%--  <div class="div-table-col alignCenter" style="width: 30%">
												<input type="text" name="referenceNotxt" id="referenceNotxtId" maxlength="15" size="10" disabled="disabled">
												<s:hidden name="frmDepCode" value="%{frmDepCode}"></s:hidden>
											</div>
												
											<div class="div-table-col alignCenter" style="width: 30%">
												<input type="text" name="cardValidityDatetxt" id="cardValidityDatetxtId" maxlength="15" size="10" disabled="disabled">
												<s:hidden name="frmDepUnitCode" value="%{frmDepUnitCode}"></s:hidden>
											</div> 
												<div class="div-table-col alignCenter" style="width: 30%">
												<input type="text" name="creditLimittxt" id="creditLimittxtId" maxlength="15" size="10" disabled="disabled">
												<s:hidden name="frmDepUnitCode" value="%{frmDepUnitCode}"></s:hidden>
											</div> --%>
											 <div class="div-table-row">
				...
				<div class="div-table-row width100">
					...
					<div class="div-table-col width16 control" id="divClient">
						<select name="clientCode"  tabindex="1" id="clientCodeId" onchange="setCompany();"  style="height: 19px;width:160px;">
							<option value="-1">Select Value</option>
						</select>
					</div>
				...
				<div class="div-table-row" >
					...
					<div class="div-table-col width16 control" >
						<input type="text" name="creditLimit" id="creditLimitId" class="input60prcnt numberinput" maxlength="11">
								...
								<%-- <div class="div-table">   commented by sheel
									<div class="div-table-row">
					...
					<div class="div-table">
						...
						<div class="div-table-row" >
							...
							<div class="div-table-col width16 control" >
								<input type="text" name="agsNo" id="agsNoId" value="<s:property value="agsNo" />" maxlength="15" size="10">
							</div>
									...
									<input type="hidden" name="creditBillFlag" id="creditBillFlagId" value="1">
									 <div class="div-table-col <s:property value="#newDeptVisitWidth"/> label">
										...
										<div class="div-table-col <s:property value="#newDeptVisitWidth"/> control" >
											...
											<input id="creditLetterDateId" tabindex="1" type="text" name="creditLetterDate" value="<s:property value="creditLetterDate" />" onblur="dateNotInRange(this);" class="input45prcnt">&nbsp;
										</div> 
		...
		<script type="text/javascript"
			src="./../../registration/transactions/js/opdCreditPatientVisit.js" /></script>
</body>
</html>