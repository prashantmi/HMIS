...
<script language="JavaScript" type="text/javascript" src="../js/verhoeffValidator.js" /></script>
...
function load1(elmtId,semantictag){
	...
	//alert(state_IN);
	//selectSNOMEDCTmulti('ACTIVE',semantictag,'SYNONYMS','10','null',elmtId,callbck_index);
	//selectSNOMEDCTmulti(state_IN,semantictag,'SYNONYMS','10','null',elmtId,callbck_index);
    ...
    <div class="wrapper rounded" id="nonprintableDiv1">
		...
		<div class="div-table">
			<div class="div-table-row title ">
				...
				<div class="div-table-col" style="display:none; width: 15%;">
					<a id="cashCollection" style="cursor: pointer;color: white" onclick="openDependentPopup('/HISRegistration/registration/transactions/CASHCOLLECTIONPOPUPNewRegistration.action',event,250,600);" 
				...
				<div id="divAlreadyRegisteredId" class="div-table-col label" style="width: 15%;display: none;" >
				 ...
				 <%-- <div id="divaadhaarRegisteredId" class="div-table-col label" style="width: 15%;display: none;" >
							<s:text name="aadharSrch"/>
							 ...
							 <div  id="divMobileSearchId" class="div-table-col label" style="width: 15%;display: none;" >
			...
			<div class="div-table-row ">
				...
				<div class="div-table-col width control" style="width: 52%">
					<select name="departmentCode" tabindex="1" class="select100prcnt" onchange='opdregistration.setDepartmentDependents(this)' id="deptId">
		...
		<div class="div-table">
			...
			<div class="div-table-col" style="width: 50%">
				...
				<div class="div-table-col width label" style="width: 25%"><%--By warish/monika for 27457--%>
				...
				<input name="patCatBoundToDeptCode" type="hidden" />
			...
			<!--Modify Date				: 28th Nov'14
				...
				<div class="div-table-col control" id="divFeeVal2" style="width:20%;display: none;">
					<select name="paymentModeCode" id="paymentModeCodeId" tabindex="1" class="select100prcnt" onchange=' paymentModeCodeOnChangeValidate(this)'>
						<option value=""></option>
					</select>
				</div>
...
<!-- 			<div id="divCatGroupBeneficiaryId" style="display: none;" class="ui-dialog ui-widget ui-widget-content ui-corner-all ui-front ui-dialog-buttons ui-draggable">			 -->
			...
			<div class="div-table">
			    ...
			    <div class="div-table-row">
					...
					<div class="div-table-col width16 control" >
						<input type="text" name="creditLetterDate" id="creditLetterDateId" class="input60prcnt" tabindex="1">
					</div>
				</div>
			...
			<%--Modified By: Mukund Vinayak On 08.06.2016 for showing Aadhar card line above the patient name fields  --%>
			
			<div class="div-table-row">
				<div class="div-table-col label" style="width: 16%;"><s:text name="adhar"/></div>
				<div class="div-table-col control" style="width: 16%;">
					<input name="patNationalId"  tabindex="2" maxlength="12" type="text" class="input75prcnt numberinput">
					
				 <span id="divaadhaarRegisteredId" style="display:none"><!-- <img id="aadhaarRegisteredFlagId" name="aadhaarRegisteredFlag#opdregistration" src="/HISRegistration/hisglobal/images/search_icon1.gif"/> --></span>
				</div>
			...
			<div class="div-table-row">
				...
				<div class="div-table-col control" style="width: 16%;">
				<input name="patLastName" tabindex="2" maxlength="33" type="text" onclick="changeTabIndex()"
			...
			<div class="div-table-row">
			    <div class="div-table-col label" style="width: 16%;"><font color="red">*</font>
			    	<input type="radio" name="isActualDob" value="0" tabindex="0" onclick="showDivAgeDob();setMotherValidRule();" checked="checked"/><s:text name="age"/> &nbsp;
			    	<input type="radio" name="isActualDob" value="1" tabindex="0" onclick="showDivAgeDob();setMotherValidRule();"/><s:text name="bob"/>&nbsp;
			    </div>
				...
				<div class="div-table-col control" style="width: 16%;">
						<select name="patCasteCode" tabindex="2" onclick="changeTabIndex()" id="patCasteCodeId" class="select77prcnt">
							<option value="-1">Select Value</option>
						</select>
	...
	<div class="div-table-row">
			...
			<div class="div-table-row">
				...
				<div class="div-table-col control"  style="width: 16%;">
				<!-- Start:Sheeldarshi
					Reason:Bug 10042 - Spouse field should be disable as per the marital status field. -->
				...
				<div class="div-table-col control" style="width: 16%;">
						<select name="patReligionCode"  tabindex="2" onclick="changeTabIndex()" id="patReligionCodeId" class="select77prcnt" >
							<option value="-1">Select Value</option>
						</select>
				...
				<div class="div-table-col control" style="width: 16%;">
					<input name="patBirthPlace" tabindex="2" onclick="changeTabIndex()"  maxlength="50" type="text" class="input75prcnt">
				</div>
		    </div>
			    
			<%--Commented by mukund on 08.06.2016  --%>			
			<%--<div class="div-table-row">
				<div class="div-table-col label" style="width: 16%;"><s:text name="adhar"/></div>
				<div class="div-table-col control" style="width: 16%;">
					<input name="patNationalId"  tabindex="2" maxlength="12" type="text" class="input75prcnt numberinput">
			...
			<div class="div-table-row">
				...
				<div class="div-table-col control" style="width: 16%;">
					<input name="patMonthlyIncome"  tabindex="2" onclick="changeTabIndex()" maxlength="11" type="text" class="input75prcnt">
				</div>
		...
		<div class="div-table">
			...
			<div class="div-table-row">
				...
				<div class="div-table-col control" style="width: 16%;">
					<input name="patAddHNo" tabindex="2" maxlength="60" type="text" class="input75prcnt" onclick="changeTabIndex()">
				</div>
				<div class="div-table-col label" style="width: 16%;"><s:text name="street"/> 
				</div>
				<div class="div-table-col control" style="width: 16%;">
					<input name="patAddStreet" tabindex="2" onclick="changeTabIndex()" maxlength="60" type="text" class="input75prcnt">
				</div>
				<div class="div-table-col label" style="width: 16%;"><s:text name="location"/> 
				</div>
				<div class="div-table-col control" style="width: 16%;">
					<input name="patAddCityLoc" tabindex="2" onclick="changeTabIndex()"  maxlength="60" type="text" class="input75prcnt">
				</div>
			...
			<div class="div-table-row">
				...
				<div class="div-table-col control" style="width: 16%;">
					<input name="patAddCity" maxlength="60" type="text" class="input75prcnt" onclick="changeTabIndex()"  tabindex="2" >
				</div>
				<div class="div-table-col label" style="width: 16%;"><!-- <font color="red">*</font> --><s:text name="pin"/>
				</div>
				<div class="div-table-col control" style="width: 16%;">
					<input name="patAddPIN" maxlength="6" type="text" onclick="changeTabIndex()" class="input75prcnt"  tabindex="2" >
			...
			<div class="div-table-row" >
				...
				<div class="div-table-col control" style="width: 16%;">
					<input name="patAddLandMarks" maxlength="60" type="text" onclick="changeTabIndex()" class="input75prcnt"  tabindex="2" >
				</div>
				
				<div class="div-table-col label" style="width: 16%;"> <s:text name="areaCategory"/>	 </div>
				<div class="div-table-col control" style="width: 16%;">
					<select name="patIsUrban" class="select77prcnt"  tabindex="2" onclick="changeTabIndex()">
						<option value="-1">Select Value</option>
					</select>
				</div>
				...
				<div class="div-table-col control" style="width: 16%;">
					<input name="patAddEmailId" maxlength="70" type="text" onclick="changeTabIndex()" class="input75prcnt"  tabindex="2" >
				</div>
			...
			<div class="div-table-row">
				...
				<div class="div-table-col control" style="width: 16%;">
					<input name="patAddPhoneNo" id="patAddPhoneNo" maxlength="15" onclick="changeTabIndex()" tabindex="2"  type="text" class="input75prcnt">
				</div>
				
				<div class="div-table-col label" style="width: 16%;"> <s:text name="global.phone"/>&nbsp;<s:text name="owner"/></div>
				<div class="div-table-col control" style="width: 16%;">
					<select name="patAddPhoneOwner" class="select77prcnt" onclick="changeTabIndex()" tabindex="2" >
						<option value="-1">Select Value</option>
				...
				<div id="divRefHosname" class="div-table-col" style="width: 50%; display: none;" >
					<div class="div-table" style="width: 100%;">
						<div class="div-table-row">
							...
							<div class="div-table-col control" style="width: 43%;">
		...
		<div class="div-table" id="divReferred" style="display: none;">
			...
			<div class="div-table-row">
				...
				<div class="div-table-col control" style="width: 25%;">
				 <div class="div-table-col control" style="width: 80%;">
		...
		<div class="div-table-button">
			...
			<div class="div-table-row" align="center" id="buttonBarId">
				<a  tabindex="1" href="#" class="button" id="submitId" onclick="freeText();"><span class="save"><s:text name="save"/></span></a>
