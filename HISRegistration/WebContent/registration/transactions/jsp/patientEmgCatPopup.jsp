...
function go(){
	...
	var action 	= "/HISRegistration/registration/transactions/getPatDtlOnPatCatIdEmgRegistration.action?"+
    ...
    <div class="wrapper rounded">
		...
		<div class="div-table">
			...
			<div class="div-table-row ">
				...
				<div class="div-table-col label width20" >
					<%-- 	<s:text name="global.id"/><s:text name="slash"/><s:text name="patCardNo"/> --%>
						<s:text name="Employee"/>&nbsp;<s:text name="global.id"/>
				</div>
				<div class="div-table-col Control width20" >
...
<script type="text/javascript" src="./../../registration/transactions/js/emgPatientRegistration.js" /></script>
</center>
</body>
</html>