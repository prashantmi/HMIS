...
function callOpenerFetchPatDtlBasedOnAadhaarId(patIndexId){
	...
	if(typeof(window.parent.opdregistration) == "undefined")
		window.parent.fetchPatDtlBasedOnPatCatWhiteCardNo(arrPatGlobalJsonObj[patIndexId.value]);
	else
	window.parent.opdregistration.fetchPatDtlBasedOnPatCatWhiteCardNo(arrPatGlobalJsonObj[patIndexId.value]);
...
<s:form action="NewRegistration">
    ...
    <div class="wrapper rounded">
		...
		<div class="div-table">
			...
			<input type="text" name="CardId"  tabindex="1" size="25" maxlength="20" onkeypress="return validateAlphaNumericOnly(event,this)" placeholder="Card No.">
			</div>
