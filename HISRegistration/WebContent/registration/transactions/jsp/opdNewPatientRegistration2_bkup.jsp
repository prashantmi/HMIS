    ...
    <div class="wrapper rounded" id="nonprintableDiv1">
		...
		<div class="div-table">
			<div class="div-table-row ">
				<div class="div-table-col title width100 "><s:text name="new"/>&nbsp;<s:text name="global.patient"/>&nbsp;<s:text name="registration"/>
				</div>
			</div>
			<div class="div-table-row ">
		...
		<div class="div-table">
			...
			<div class="div-table-row">
					...
					<div  class="div-table" >
						<div class="div-table-row">
							...
							<div class="div-table-col control" style="width: 50%">
								<input id="shownPatIdNoId" tabindex="1" name="patIdNo"  type="text" class="input75prcnt" />
							</div>
						</div>
					</div>
				</div>
				...
				<div id="divAlreadyRegisteredId" class="div-table-col" style="width: 32%; display: none;">
					<div  class="div-table" >
						<div class="div-table-row">
							<div  class="div-table-col label" style="width: 50%;" align="right"><s:text name="already"/>&nbsp;<s:text name="registered"/></div>
							<div  class="div-table-col control" style="width: 50%;">
...
<!-- 			<div id="divCatGroupBeneficiaryId" style="display: none;" class="ui-dialog ui-widget ui-widget-content ui-corner-all ui-front ui-dialog-buttons ui-draggable">			 -->
			...
			<div class="div-table-row">
				...
				<div class="div-table-col control" style="width: 16%;">
					<input name="patFirstName"  tabindex="1" maxlength="33" type="text" class="input75prcnt" class="input75prcnt"
						onkeyup="multilingualConversion(this,document.getElementById('patFirstNameInMultiLangId'));">
				</div>
				<div class="div-table-col control" style="width: 16%;">
					<input name="patMiddleName" tabindex="2" maxlength="33" type="text" class="input75prcnt" class="input75prcnt"
			...
			<div class="div-table-row">
				...
				<div class="div-table-col label" style="width: 16%;"><font color="red">*</font><s:text name="amountCollected"/> 
				</div>
				<div class="div-table-col control" style="width: 16%;">
			<!--Modify Date				: 28th Nov'14
	  			Reason	(CR/PRS)		: Bug Id 7608
	 		    Modify By               : Sheeldarshi -->
					<input name="patAmountCollected" id="patAmountCollectedId" tabindex="3"  type="text" class="input75prcnt" readonly="readonly">
				<!-- End:Sheeldarshi-->
				</div>
			</div>
			...
			<div class="div-table-row">
				...
				<div class="div-table-col control" style="width: 16%;">
					<textarea id="textArea"  tabindex="2"  maxlength="99" name="patVisitReason" class="textarea75prcnt"></textarea>
				</div>
		...
		<div class="div-table">
			...
			<div class="div-table-row">
				...
				<div class="div-table-col label" style="width: 16%;"><s:text name="mobileNo"/></div>
				<div class="div-table-col control" style="width: 16%;">
		...
		<div class="div-table" >
				<div class="div-table-row title">
					...
					<div class="div-table-col label" style="width: 20%">
							<s:text name="isreferred"/><input type="checkbox" name="isReferred" value="0" onclick="Isreferred(this)"  tabindex="2" >
					</div>
				</div>
		</div>
				...
				<div id="divRefHosCode" class="div-table-col" style="width: 50%;">
					<div class="div-table" style="width: 100%;">
						<div class="div-table-row" >
							...
							<div class="div-table-col control" style="width: 50%;">
								<select id="patRefGnctdHospitalCodeId" name="patRefGnctdHospitalCode" class="select61prcnt"  tabindex="1" >
									<option value="-1">Select Value</option>
								</select>
							</div>
						</div>
				...
				<div id="divRefHosname" class="div-table-col" style="width: 50%; display: none;" >
					<div class="div-table" style="width: 100%;">
						<div class="div-table-row">
							...
							<div class="div-table-col control" style="width: 50%;">
								<input name="patRefHospitalName" maxlength="100" type="text" class="input61prcnt" size="20"  tabindex="1" >
							</div>
						</div>
					</div>
				</div>
		...
		<div class="div-table" id="divReferred" style="display: none;">
			<div class="div-table-row">
				...
				<div class="div-table-col control" style="width: 25%;">
					<input type	  ="text" 	name="patRefGnctdHospitalCrno" 
						maxlength ="18"   tabindex="2" class="input60prcnt">
				</div>
			...
			<div class="div-table-row">
				...
				<div class="div-table-col control" style="width: 25%;">
					<select id="patRefGnctdHospitalDeptId" name="patRefGnctdHospitalDept"  tabindex="2"  class="select61prcnt">
						<option value="-1">Select Value</option>
				...
				<div id="divRefHospitalDeptOtherId" class="div-table-col" style="width: 50%; display: none;">
					<div class="div-table">
						<div class="div-table-row">
							...
							<div class="div-table-col control" style="width: 50%;">
								<input name="patRefHospitalDeptOther" maxlength="50" type="text" class="input60prcnt" size="20"  tabindex="1" >
							</div>
						</div>
