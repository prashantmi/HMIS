...
<script language="JavaScript" src="/AHIMS/registration/js/registration.js"></script>
<script language="JavaScript" src="/AHIMS/registration/js/validationCalls.js"></script>
<script language="JavaScript" src="/AHIMS/registration/js/validationCommon.js"></script>
<script language="JavaScript" src="/AHIMS/registration/js/stateChangeAjax.js"></script>
<script language="JavaScript" src="/AHIMS/registration/js/cityLocationAjax.js"></script>
<script language="JavaScript" src="/AHIMS/registration/js/commonFunctions.js"></script>


<script language="JavaScript" src="/AHIMS/hisglobal/js/utilityFunctions.js"></script>
<script language="JavaScript" src="/AHIMS/hisglobal/utility/generictemplate/js/validationFunctions.js"></script>
<script language="JavaScript" src="/AHIMS/hisglobal/utility/generictemplate/js/date_validator.js"></script>

<script language="JavaScript" src="/AHIMS/registration/js/patientModification.js"></script>
			...
			<table width="100%">
				<tr>
					<td width='45%' align='right'>
						<div id="saveButton">
							<img class="button" style='cursor: pointer' src='<his:path src="/hisglobal/images/btn-sv.png"/>'
					...
					<td width='55%' align='left'>
						<img class="button" src='<his:path src="/hisglobal/images/btn-clr.png"/>' style="cursor: pointer"
							onclick="clearForm()" onkeypress="if(event.keyCode==13) clearForm();" tabindex="1"> 
						<img class="button" src='<his:path src="/hisglobal/images/btn-ccl.png"/>' style="cursor: pointer"
