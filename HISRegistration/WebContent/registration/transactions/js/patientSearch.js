...
function createPatientEmpRow(arrStrPatJsonObj)
{
	...
	for (i in arrPatJsonObj)
	{
		...
		empDtlRow +=	"<div class='div-table-listing rounded width100'><div class='div-table-col width100  alignCenter'><img id='imgNoDataId' align='center' src='../../hisglobal/images/NoData.png' /></div></div>";
...
{
	//alert(obj.value);
	window.opener.$('[name="patCrNo"]')[0].value=obj.value;
	window.opener.submitForm('GETPATDTL');
	window.close();
}
