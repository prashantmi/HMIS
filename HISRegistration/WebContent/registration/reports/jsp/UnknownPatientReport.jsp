...
<s:form action="UnknownPatientReport">
<div class="wrapper rounded">
<div class="div-table">
      <div class="div-table-row ">
      <div class="div-table-col title width80 ">
      <s:text name="unknown"/>&nbsp;<s:text name="global.patient"/>&nbsp;<s:text name="Report"/>
      </div>
      ...
      onchange="report.showTimeTile();"></s:radio>
			...
			<div class="div-table-row " id="dateRow" style="display: none">
				...
				<div class="div-table-col control" id="divFromDate" style="width: 25%;display: none;">
					       <input id="patFromDateId" tabindex="1" type="text" readonly="readonly" name="fromDate" class="input25prcnt" onblur="unknownpatReport.checkFromDateValid();">&nbsp;
				</div>	
				...
				<div class="div-table-col control" id="divToDate" style="width: 25%;display: none;">
					       <input id="patToDateId" tabindex="1" type="text" readonly="readonly" name="toDate" class="input25prcnt" onblur="unknownpatReport.checkToDateValid();">&nbsp;
				</div>	
			</div>
			...
			<div class="div-table-row" align="center">
				<a href="#" class="button" onclick="unknownpatReport.showReport();"><span class="generate"><s:text name="generate"/></span></a>
				<a href="#" class="button" onclick="unknownpatReport.clearTile();"><span class="clear"><s:text name="clear"/></span></a>
...
<s:hidden name="title" value=" Unknown Patient Report"></s:hidden>
...
var unknownpatReport={
		 clearTile:function(){
			  document.forms[0].action="cancelemgunknownpatReport.action";
			  document.forms[0].submit();
		  },
		  showReport:function(){
			  if($('#UnknownPatientReport').form('validate')){
				  document.forms[0].action="showReportemgunknownpatReport.action";
			  	  document.forms[0].submit();
			  }
			  else{
				  return true;
