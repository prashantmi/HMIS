...
<body >
<s:form action="CategoryWiseCashCollectionReport">
<div class="wrapper rounded">
<div class="div-table">
            <div class="div-table-row ">
				<div class="div-table-col title width100 ">
						<s:text name="Category Wise Cash Collection"/>
				</div>
				</div>
				...
				<div class="div-table-col control" id="divFromDate" style="width: 25%">
					       <input id="patFromDateId" tabindex="1" type="text" readonly="readonly" name="fromDate" class="input25prcnt" onblur="CashcollectionReport.checkFromDateValid();">&nbsp;
				</div>	
				...
				<div class="div-table-col control" id="divToDate" style="width: 25%;">
					       <input id="patToDateId" tabindex="1" type="text" readonly="readonly" name="toDate" class="input25prcnt" onblur="CashcollectionReport.checkToDateValid();">&nbsp;
				</div>	
			</div>
				<div class="div-table-row ">
			...
			<div class="div-table-row" align="center">
				<a href="#" class="button" onclick="CashcollectionReport.showReport();"><span class="generate"><s:text name="generate"/></span></a>
				<a href="#" class="button" onclick="CashcollectionReport.clearTile();"><span class="clear"><s:text name="clear"/></span></a>
...
<s:hidden name="title" value="Category Wise Cash Collection Report"></s:hidden>
</s:form>
...
var CashcollectionReport={
clearTile:function(){
			  document.forms[0].action="cancelcategorywisecashcollection.action";
			  document.forms[0].submit();
		  },
		  showReport:function(){
			  if($('#CategoryWiseCashCollectionReport').form('validate')){
				  document.forms[0].action="showReportcategorywisecashcollection.action";
			  	  document.forms[0].submit();
			  }
			  else{
				  return true;
