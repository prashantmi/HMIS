...
<s:form action="hospitaluserwiseregReport">
<div class="wrapper rounded">
<div class="div-table">
              <div class="div-table-row ">
				<div class="div-table-col title width60 ">
						<s:text name="Hospital User Wise Registration "/>&nbsp;<s:text name="Report"/>
				</div>
				...
				<s:radio name="strChoice" list="#{'T':'Today','D':'DateWise','M':'MonthWise','Y':'YearWise'}" value="%{strChoice}" 
  																		onchange="hospitaluserwiseregReport.showTimeTile();"></s:radio>		  
				</div>
			</div>
			...
			<div class="div-table-row " id="timeRow" style="display: none">
				...
				<s:textfield name="fromHour" cssStyle="width:5%;min-width: 30px;" maxlength="2" onchange="hospitaluserwiseregReport.showTimeTile();"></s:textfield>            
	   				<b>:</b>
	   			<s:textfield name="fromMin" cssStyle="width:5%;min-width: 30px;" maxlength="2" onchange="hospitaluserwiseregReport.showTimeTile();"></s:textfield>(HH:MM 24 Hrs)	            
				</div>		
				
			
    	 		<div class="div-table-col label" style="width: 20%;"><font color="#FF0000">*</font>&nbsp;<s:text name="to"/></div>
    	 		<div class="div-table-col control" style="width: 25%;">	
    	 		<s:textfield name="toHour" cssStyle="width:5%;min-width: 30px;" maxlength="2" onchange="hospitaluserwiseregReport.showTimeTile();"></s:textfield>            
	   				<b>:</b>
	   			<s:textfield name="toMin" cssStyle="width:5%;min-width: 30px;" maxlength="2" onchange="hospitaluserwiseregReport.showTimeTile();"></s:textfield>(HH:MM 24 Hrs)	
	   			</div>
			</div>
				...
				<div class="div-table-col control" style="width: 25%;">				
					<s:select cssStyle="width: 25%" key="fromMonth" value="%{fromMonth}" 
	   				...
	   				<s:select cssStyle="width: 25%" key="fromMonthYear" value="%{fromMonthYear}" id="fromMonthYear"
				 				list="#{'2010':'2010','2011':'2011','2012':'2012','2013':'2013','2014':'2014','2015':'2015','2016':'2016','2017':'2017','2018':'2018','2019':'2019','2020':'2020','2021':'2021'}" name="fromMonthYear" onchange="hospitaluserwiseregReport.showTimeTile();"> </s:select>	
	   			</div>		
    	 		...
    	 		<div class="div-table-col control" style="width: 25%;">	
					<s:select cssStyle="width: 25%" key="toMonth" value="%{toMonth}" 
	   				...
	   				<s:select cssStyle="width: 25%" key="toMonthYear" value="%{toMonthYear}" id="toMonthYear"
				 				list="#{'2010':'2010','2011':'2011','2012':'2012','2013':'2013','2014':'2014','2015':'2015','2016':'2016','2017':'2017','2018':'2018','2019':'2019','2020':'2020','2021':'2021'}" name="toMonthYear" onchange="hospitaluserwiseregReport.showTimeTile();"> </s:select>	
	   			</div>
			</div>
			<div class="div-table-row " id="yearRow" style="display: none">
				...
				<span style="font-size: 10pt" id="divCalenderYearFrom">1-JAN</span>		
					...
					<s:select cssStyle="width: 25%" key="fromYear" value="%{fromYear}" id="fromYear"
				 				list="#{'2010':'2010','2011':'2011','2012':'2012','2013':'2013','2014':'2014','2015':'2015','2016':'2016','2017':'2017','2018':'2018','2019':'2019','2020':'2020','2021':'2021'}" name="fromYear" onchange="hospitaluserwiseregReport.showTimeTile();"> </s:select>	
	   			</div>		
    	 		...
    	 		<span id="divCalenderYearTo" style="font-size: 10pt">31-DEC</span>
	   				...
	   				<s:select cssStyle="width: 25%" key="toYear" value="%{toYear}" id="toYear"
				 				list="#{'2010':'2010','2011':'2011','2012':'2012','2013':'2013','2014':'2014','2015':'2015','2016':'2016','2017':'2017','2018':'2018','2019':'2019','2020':'2020','2021':'2021'}" name="toYear" onchange="hospitaluserwiseregReport.showTimeTile();"> </s:select>	
	   			</div>
			</div>
			<%-- <div class="div-table-row ">
				...
				<div class="div-table-col" style="width: 25%;"><s:select cssStyle="width: 75%" key="strDeptCode" value="%{strDeptCode}" headerKey="-1" headerValue="Select Value" 
				 				list="%{#session.departmentList}"  listKey="value" listValue="label" name="strDeptCode" onchange="hospitaluserwiseregReport.onchange_strDeptCode();"> </s:select>			
				</div>
			 ...
			 <div class="div-table-row ">  
			 	<div class="div-table-col label" style="width: 25%;"><font color="#FF0000">*</font>&nbsp;<s:text name="global.patient"/></div>
				 <div class="div-table-col" style="width: 25%;"><s:select cssStyle="width: 75%" key="strPatVisit" value="%{strPatVisit}" headerKey="%" headerValue="Both" 
				 				list="#{'1':'New','2':'Old'}" name="strPatVisit"> </s:select>			
				</div>
			...
			<div class="div-table-row" align="center">
				<a href="#" class="button" onclick="hospitaluserwiseregReport.showReport();"><span class="generate"><s:text name="generate"/></span></a>
				<a href="#" class="button" onclick="hospitaluserwiseregReport.clearTile();"><span class="clear"><s:text name="clear"/></span></a>
...
<s:hidden name="title" value="Hospital User wise registration Report"></s:hidden>
...
var hospitaluserwiseregReport={
		
		  clearTile:function(){
			  document.forms[0].action="cancelhospitaluserwiseregistrationReport.action";
		  ...
		  showReport:function(){
			  ...
			  if($('#hospitaluserwiseregReport').form('validate')){
				  document.forms[0].action="showReporthospitaluserwiseregistrationReport.action";
			  	  document.forms[0].submit();
			  }
			  else{
				  return true;
