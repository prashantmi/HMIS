...
<div class="div-table">
            <div class="div-table-row ">
				...
				<s:radio name="strChoice" list="#{'0':'Consolidated','1':'Detailed'}" value=""></s:radio>		 
				</div>
				</div>
			...
			<div class="div-table-row" align="center">
				<a href="#" class="button" onclick="consolidatedCollectionReport.showReport();"><span class="generate"><s:text name="generate"/></span></a>
...
clearTile:function(){
		  ...
		  showReport:function(){
			  ...
			  if($('[name="strChoice"]')[0].checked)
				  $('[name="strChoice"]').val('0');
			  if($('[name="strChoice"]')[1].checked)
				  $('[name="strChoice"]').val('1');
			  
			  if($('#ConsolidatedCollectionReport').form('validate')){
				  document.forms[0].action="showReportconsolidatedCollectionReport.action";
			  	  document.forms[0].submit();
			  }
			  else{
				  return true;
