...
<s:form action="UnitwiseOPDStatsReport">
<div class="wrapper rounded">
<div class="div-table">
			<div class="div-table-row ">
				<div class="div-table-col title width60 ">
						<s:text name="Unit wise OPD Patient Statistics"/>&nbsp;<s:text name="Report"/>
				</div>
				...
				<s:radio name="strChoice" list="#{'T':'Today','D':'DateWise','M':'MonthWise','Y':'YearWise'}" value="%{strChoice}" 
  																		onchange="unitwiseOpdStatsReport.showTimeTile();"></s:radio>		  
				</div>
			</div>
...
<!--End on 18.Jan.19  for Monthwise Validation-->		
			...
			<div class="div-table-row " id="timeRow" style="display: none">
				...
				<s:textfield name="fromHour" cssStyle="width:5%;min-width: 30px;" maxlength="2" onchange="unitwiseOpdStatsReport.showTimeTile();"></s:textfield>            
	   				<b>:</b>
	   			<s:textfield name="fromMin" cssStyle="width:5%;min-width: 30px;" maxlength="2" onchange="unitwiseOpdStatsReport.showTimeTile();"></s:textfield>(HH:MM 24 Hrs)	            
				</div>		
				
			
    	 		<div class="div-table-col label" style="width: 20%;"><font color="#FF0000">*</font>&nbsp;<s:text name="to"/></div>
    	 		<div class="div-table-col control" style="width: 25%;">	
    	 		<s:textfield name="toHour" cssStyle="width:5%;min-width: 30px;" maxlength="2" onchange="unitwiseOpdStatsReport.showTimeTile();"></s:textfield>            
	   				<b>:</b>
	   			<s:textfield name="toMin" cssStyle="width:5%;min-width: 30px;" maxlength="2" onchange="unitwiseOpdStatsReport.showTimeTile();"></s:textfield>(HH:MM 24 Hrs)	
	   			</div>
			</div>
    	 		...
    	 		<div class="div-table-col control" style="width: 25%;">	
					<s:select cssStyle="width: 25%" key="toMonth" value="%{toMonth}" 
	   				...
	   				<s:select cssStyle="width: 25%" key="toMonthYear" value="%{toMonthYear}" id="toMonthYear"
				 				list="#{'2018':'2018','2019':'2019','2020':'2020','2021':'2021','2022':'2022','2023':'2023','2024':'2024','2025':'2025','2026':'2026','2027':'2027','2028':'2028','2029':'2029'}" name="toMonthYear" onchange="unitwiseOpdStatsReport.showTimeTile();"> </s:select>	
	   			</div>
			</div>
...
<%-- 					<s:text name="1-JAN"></s:text>&nbsp;		 --%>
					<s:select cssStyle="width: 25%" key="fromYear" value="%{fromYear}" id="fromYear"
				 				list="#{'2018':'2018','2019':'2019','2020':'2020','2021':'2021','2022':'2022','2023':'2023','2024':'2024','2025':'2025','2026':'2026','2027':'2027','2028':'2028','2029':'2029'}" name="fromYear" onchange="unitwiseOpdStatsReport.showTimeTile();"> </s:select>	
	   			</div>		
...
<%-- 					<s:text name="31-DEC"></s:text>&nbsp;		 --%>
	   				<s:select cssStyle="width: 25%" key="toYear" value="%{toYear}" id="toYear"
				 				list="#{'2018':'2018','2019':'2019','2020':'2020','2021':'2021','2022':'2022','2023':'2023','2024':'2024','2025':'2025','2026':'2026','2027':'2027','2028':'2028','2029':'2029'}" name="toYear" onchange="unitwiseOpdStatsReport.showTimeTile();"> </s:select>	
	   			</div>
			</div>
			...
			<div class="div-table-row ">
				...
				<div class="div-table-col" style="width: 25%;"><s:select cssStyle="width: 75%" key="strDeptCode" value="%{strDeptCode}" headerKey="-1" headerValue="Select Value" 
				 				list="%{#session.departmentList}"  listKey="value" listValue="label" name="strDeptCode" onchange="unitwiseOpdStatsReport.onchange_strDeptCode();"> </s:select>			
				</div>
			...
			<div class="div-table-row ">
				...
				<div class="div-table-col label" style="width: 20%;"><font color="#FF0000">*</font>&nbsp;<s:text name="Service"/>&nbsp;<s:text name="Type"/></div>
...
<!-- 				</div> -->
			...
			<div class="div-table-row" align="center">
				<a href="#" class="button" onclick="unitwiseOpdStatsReport.showReport();"><span class="generate"><s:text name="generate"/></span></a>
				<a href="#" class="button" onclick="unitwiseOpdStatsReport.clearTile();"><span class="clear"><s:text name="clear"/></span></a>
...
<s:hidden name="title" value="Unit-wise OPD Statistics Report"></s:hidden>
		...
		onchange_strDeptCode:function()
		  {
			...
			var action 		= "/HISRegistration/registration/reports/getUnitunitwiseOPDStatReport.action?deptCode="+deptCode;
		  ...
		  clearTile:function(){
			  document.forms[0].action="cancelunitwiseOPDStatReport.action";
		  ...
		  showReport:function(){
			  ...
			  if($('#UnitwiseOPDStatsReport').form('validate')){
				  document.forms[0].action="showReportunitwiseOPDStatReport.action";
			  	  document.forms[0].submit();
			  }
			  else{
				  return true;
