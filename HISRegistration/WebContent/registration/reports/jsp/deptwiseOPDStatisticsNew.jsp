...
<s:form action="DeptwiseOPDStatsReport">
<div class="wrapper rounded">
<div class="div-table">
			<div class="div-table-row ">
				<div class="div-table-col title width60 ">
						<s:text name="Department wise OPD Patient Statistics"/>&nbsp;<s:text name="Report"/>
				</div>
				...
				<s:radio name="strChoice" list="#{'T':'Today','D':'DateWise','M':'MonthWise','Y':'YearWise'}" value="%{strChoice}" 
  																		onchange="deptwiseOpdStatsReport.showTimeTile();"></s:radio>		  
				</div>
			</div>
...
<!--End on 18.Jan.19  for Monthwise Validation-->		
			...
			<div class="div-table-row " id="dateRow" style="display: none">
				...
				<div class="div-table-col control" id="divFromDate" style="width: 25%;display: none;">
					       <input id="patFromDateId" tabindex="1" type="text" readonly="readonly" name="fromDate" class="input25prcnt" onblur="deptwiseOpdStatsReport.checkFromDateValid()"; >&nbsp;
				...
				<div class="div-table-col control" id="divToDate" style="width: 25%;display: none;">
					       <input id="patToDateId" tabindex="1" type="text" readonly="readonly" name="toDate" class="input25prcnt" onblur="deptwiseOpdStatsReport.checkToDateValid();" >&nbsp;
			...
			<div class="div-table-row " id="timeRow" style="display: none">
				...
				<s:textfield name="fromHour" cssStyle="width:5%;min-width: 30px;" maxlength="2" onchange="deptwiseOpdStatsReport.showTimeTile();"></s:textfield>            
	   			 <b>:</b>
	   			<s:textfield name="fromMin" cssStyle="width:5%;min-width: 30px;" maxlength="2" onchange="deptwiseOpdStatsReport.showTimeTile();"></s:textfield>(HH:MM 24 Hrs)	            
				</div>		
				
			
    	 		<div class="div-table-col label" style="width: 20%;"><font color="#FF0000">*</font>&nbsp;<s:text name="to"/></div>
    	 		<div class="div-table-col control" style="width: 25%;">	
    	 		<s:textfield name="toHour" cssStyle="width:5%;min-width: 30px;" maxlength="2" onchange="deptwiseOpdStatsReport.showTimeTile();"></s:textfield>            
	   				<b>:</b>
	   			<s:textfield name="toMin" cssStyle="width:5%;min-width: 30px;" maxlength="2" onchange="deptwiseOpdStatsReport.showTimeTile();"></s:textfield>(HH:MM 24 Hrs)	
	   			</div>
			</div>
				...
				<div class="div-table-col control" style="width: 25%;">				
					<s:select cssStyle="width: 25%" key="fromMonth" value="%{fromMonth}" 
	   				...
	   				<s:select cssStyle="width: 25%" key="fromMonthYear" value="%{fromMonthYear}" id="fromMonthYear"
				 				list="#{'2018':'2018','2019':'2019','2020':'2020','2021':'2021','2022':'2022','2023':'2023','2024':'2024','2025':'2025','2026':'2026','2027':'2027','2028':'2028','2029':'2029'}" name="fromMonthYear" onchange="deptwiseOpdStatsReport.showTimeTile();"> </s:select>	
	   			</div>		
    	 		...
    	 		<div class="div-table-col control" style="width: 25%;">	
					<s:select cssStyle="width: 25%" key="toMonth" value="%{toMonth}" 
	   				...
	   				<s:select cssStyle="width: 25%" key="toMonthYear" value="%{toMonthYear}" id="toMonthYear"
				 				list="#{'2018':'2018','2019':'2019','2020':'2020','2021':'2021','2022':'2022','2023':'2023','2024':'2024','2025':'2025','2026':'2026','2027':'2027','2028':'2028','2029':'2029'}" name="toMonthYear" onchange="deptwiseOpdStatsReport.showTimeTile();"> </s:select>	
	   			</div>
			</div>
			...
			<div class="div-table-row " id="yearRow" style="display: none">
				...
				<div class="div-table-col control" style="width: 25%;">				
					...
					<s:select cssStyle="width: 25%" key="fromYear" value="%{fromYear}" id="fromYear"
				 				list="#{'2018':'2018','2019':'2019','2020':'2020','2021':'2021','2022':'2022','2023':'2023','2024':'2024','2025':'2025','2026':'2026','2027':'2027','2028':'2028','2029':'2029'}" name="fromYear" onchange="deptwiseOpdStatsReport.showTimeTile();"> </s:select>	
	   			</div>		
    	 		...
    	 		<div class="div-table-col control" style="width: 25%;">	
					<s:text name="31-DEC"></s:text>&nbsp;		
	   				<s:select cssStyle="width: 25%" key="toYear" value="%{toYear}" id="toYear"
				 				list="#{'2018':'2018','2019':'2019','2020':'2020','2021':'2021','2022':'2022','2023':'2023','2024':'2024','2025':'2025','2026':'2026','2027':'2027','2028':'2028','2029':'2029'}" name="toYear" onchange="deptwiseOpdStatsReport.showTimeTile();"> </s:select>	
	   			</div>
			</div>
			...
			<div class="div-table-row ">
				...
				<div class="div-table-col label" style="width: 20%;"><font color="#FF0000">*</font>&nbsp;<s:text name="global.patient"/>&nbsp;<s:text name="global.category"/></div>
	...
	<div class="div-table-button">
			...
			<div class="div-table-row" align="center">
				<a href="#" class="button" onclick="deptwiseOpdStatsReport.showReport();"><span class="generate"><s:text name="generate"/></span></a>
				<a href="#" class="button" onclick="deptwiseOpdStatsReport.clearTile();"><span class="clear"><s:text name="clear"/></span></a>
...
<s:hidden name="title" value="Department-wise OPD Statistics Report"></s:hidden>
...
var deptwiseOpdStatsReport={
		onchange_strDeptCode:function()
		  {
			var objDept  =document.getElementsByName("strDeptCode")[0];
			var deptCode = objDept.options[objDept.selectedIndex].value;
			var action 		= "/HISRegistration/registration/reports/getUnitdeptwiseOPDStatNewReport.action?deptCode="+deptCode;
		  ...
		  clearTile:function(){
			  document.forms[0].action="canceldeptwiseOPDStatNewReport.action";
		  ...
		  showReport:function(){
			  ...
			  if($('#DeptwiseOPDStatsReport').form('validate')){
				  document.forms[0].action="showReportdeptwiseOPDStatNewReport.action";
			  	  document.forms[0].submit();
			  }
			  else{
				  return true;
