...
<s:form action="MlcPatientReport">
<div class="wrapper rounded">
<div class="div-table">
      <div class="div-table-row ">
      <div class="div-table-col title width80 ">
      <s:text name="mlc"/>&nbsp;<s:text name="global.patient"/>&nbsp;<s:text name="list"/>&nbsp;<s:text name="Report"/>
      </div>
      ...
      onchange="report.showTimeTile();"></s:radio>
			...
			<div class="div-table-row " id="dateRow" style="display: none">
				...
				<div class="div-table-col control" id="divFromDate" style="width: 25%;display: none;">
				 			    <input id="patFromDateId" tabindex="1" type="text" readonly="readonly" name="fromDate" class="input25prcnt" >&nbsp;
<!-- 					       <input id="patFromDateId" tabindex="1" type="text" readonly="readonly" name="fromDate" style="width: 85px;" onblur=" mlcpatReport.checkFromDateValid();">&nbsp; -->
				</div>	
				...
				<div class="div-table-col control" id="divToDate" style="width: 25%;display: none;">
					       <input id="patToDateId" tabindex="1" type="text" readonly="readonly" name="toDate" class="input25prcnt" >&nbsp;
<!-- 					       <input id="patToDateId" tabindex="1" type="text" readonly="readonly" name="toDate" style="width: 85px;" onblur=" mlcpatReport.checkToDateValid();">&nbsp; -->
				</div>	
			</div>
			...
			<div class="div-table-row" align="center">
				<a href="#" class="button" onclick=" mlcpatReport.showReport();"><span class="generate"><s:text name="generate"/></span></a>
				<a href="#" class="button" onclick=" mlcpatReport.clearTile();"><span class="clear"><s:text name="clear"/></span></a>
...
<s:hidden name="title" value=" Mlc Patient List Report"></s:hidden>
...
var mlcpatReport={
		 clearTile:function(){
			  document.forms[0].action="cancelmlcpatReport.action";
			  document.forms[0].submit();
		  },
		  showReport:function(){
			  if($('#MlcPatientReport').form('validate')){
				  document.forms[0].action="showReportmlcpatReport.action";
			  	  document.forms[0].submit();
			  }
			  else{
				  return true;
