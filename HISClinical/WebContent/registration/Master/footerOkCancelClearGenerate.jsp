...
<his:ButtonToolBarTag>
          ...
          <img class="button" src='<his:path src="/../HIS/hisglobal/images/buttons/btn-clr.png"/>'  style=cursor:pointer tabindex="1" onclick ="clearForm()" onkeypress="if(event.keyCode==13) clearForm();">
		   <img class="button" src='<his:path src="/../HIS/hisglobal/images/buttons/btn-generate.png"/>'  style=cursor:pointer tabindex="1" onclick ="confirmEcecuteRoster()" onkeypress="if(event.keyCode==13) confirmEcecuteRoster();">
