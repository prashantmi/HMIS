...
<%@page import="hisglobal.vo.EmployeeMasterVO"%>
<html>
<head>
...
<body>
<html:form action="/master/modifyEmployeeMaster">
<his:TransactionContainer>

<%@ page import ="java.util.*,registration.*,hisglobal.presentation.*" %>

<%
	EmployeeMasterVO _empVo=new EmployeeMasterVO();
	String sysDate=WebUTIL.getCustomisedSysDate((Date)session.getAttribute(RegistrationConfig.SYSADATEOBJECT), "dd-MMM-yyyy");
	String birthDate="";
%>
<logic:equal name="chkFlag" value="1">
<%
    _empVo=(EmployeeMasterVO)session.getAttribute(RegistrationConfig.EMPLOYEE_MST_EMPLOYEEVO);
	if(_empVo.getBirthDate()!=null&&_empVo.getBirthDate()!="")
	birthDate=WebUTIL.getCustomisedSysDate(WebUTIL.getDateFromString(_empVo.getBirthDate(), "dd-mon-yy"),"dd-MMM-yyyy");
%>

</logic:equal>
<logic:notEqual name="chkFlag" value="1">
<%
    _empVo=(EmployeeMasterVO)session.getAttribute(RegistrationConfig.EMPLOYEE_MST_EMPLOYEEVO);
	if(_empVo.getBirthDate()!=null&&_empVo.getBirthDate()!="")
	birthDate=WebUTIL.getCustomisedSysDate(WebUTIL.getDateFromString(_empVo.getBirthDate(), "yyyy-mm-dd HH:mm:ss"),"dd-MMM-yyyy");
%>
</logic:notEqual>
<his:TitleTag name="Personal Details >>Modify">
</his:TitleTag>
...
<his:ContentTag>
  ...
  <tr>
				...
				<tr>
					...
					<html:select name="EmployeeMasterFB" tabindex="1" property="salutationId" styleClass="regCbo" disabled="true">
					<html:option value="-1">Select Value</html:option>
					<html:options collection="<%=RegistrationConfig.ESSENTIALBO_OPTION_SALUTATION%>" property="value" labelProperty="label" />
					</html:select>
					</logic:equal>
					...
					<html:text
						...
						onkeypress="return validateAlphabetsWithDotsAndForwardSlashWithHypen(event,this)" readonly="false"/>
					</logic:equal>
					<logic:equal name="<%=RegistrationConfig.VIEWORMODIFY%>" value="view">					
					<html:text
						name="EmployeeMasterFB" property="firstName"
						styleClass="textbox" tabindex="1" maxlength="30"
						onchange="isAlpha(this,'First Name')"
						onkeypress="return validateAlphabetsWithDotsAndForwardSlashWithHypen(event,this)" readonly="true"/>
					</logic:equal></td>
					<td width="17%" class="tdfont">
					<logic:equal name="<%=RegistrationConfig.VIEWORMODIFY%>" value="modify">					
					<html:text
						...
						style="display:block;" readonly="false"/>
					</logic:equal>
					<logic:equal name="<%=RegistrationConfig.VIEWORMODIFY%>" value="view">					
					<html:text
						name="EmployeeMasterFB" property="middleName"
					...
					<td width="17%" class="tdfont" align="left">
					<logic:equal name="<%=RegistrationConfig.VIEWORMODIFY%>" value="modify">			
					<html:text
						...
						onkeypress="return validateAlphabetsWithDotsOnly(event,this)" readonly="false"/>
					</logic:equal>
					<logic:equal name="<%=RegistrationConfig.VIEWORMODIFY%>" value="view">			
					<html:text
						name="EmployeeMasterFB" property="lastName"
						tabindex="2" styleClass="textbox" tabindex="1" maxlength="30"
						onchange="isAlpha(this,'Last Name')"
						onkeypress="return validateAlphabetsWithDotsOnly(event,this)" readonly="true"/>
					</logic:equal>
					</td>
				...
				<tr>
					...
					<td class="tdfont" width="17%">
					<logic:equal name="<%=RegistrationConfig.VIEWORMODIFY%>" value="modify">					
					<html:select name="EmployeeMasterFB" tabindex="1" property="genderCode" styleClass="regCbo" disabled="false">
					<html:option value="-1">Select Value</html:option>										
					<html:options collection="<%=RegistrationConfig.ESSENTIALBO_OPTION_GENDER%>" property="value" labelProperty="label"/>
					</html:select>
					</logic:equal>
					<logic:equal name="<%=RegistrationConfig.VIEWORMODIFY%>" value="view">					
					<html:select name="EmployeeMasterFB" tabindex="1" property="genderCode" styleClass="regCbo" disabled="true">
					<html:option value="-1">Select Value</html:option>										
					<html:options collection="<%=RegistrationConfig.ESSENTIALBO_OPTION_GENDER%>" property="value" labelProperty="label"/>
					</html:select>
					</logic:equal>
					...
					<td width="17%" class="tdfont">
					<his:date name='<%="birthDate"%>' dateFormate="%d-%b-%Y" value='<%=birthDate %>'/>					
					</td>
					<td width="17%" class="LABEL">
					<bean:message key="mandatory1" /><bean:message key="designation" /></td>
					<td width="15%" class="tdfont">
					<logic:equal name="<%=RegistrationConfig.VIEWORMODIFY%>" value="modify">							
					<html:select name="EmployeeMasterFB" tabindex="1" property="designationCode" styleClass="regCbo" disabled="false">
					<html:option value="-1">Select Value</html:option>										
					<html:options collection="<%=RegistrationConfig.ESSENTIALBO_OPTION_DESIGNATION%>" property="value" labelProperty="label" />
					</html:select>
					</logic:equal>
					<logic:equal name="<%=RegistrationConfig.VIEWORMODIFY%>" value="view">							
					<html:select name="EmployeeMasterFB" tabindex="1" property="designationCode" styleClass="regCbo" disabled="true">
					<html:option value="-1">Select Value</html:option>										
					<html:options collection="<%=RegistrationConfig.ESSENTIALBO_OPTION_DESIGNATION%>" property="value" labelProperty="label" />
					</html:select>
					</logic:equal>	
				...
				<tr>
					<td width="17%" class="LABEL"><bean:message key="department" />	</td>
					<td width="17%" class="tdfont">
					<logic:equal name="<%=RegistrationConfig.VIEWORMODIFY%>" value="modify">								
					<html:select name="EmployeeMasterFB" tabindex="1" property="deptCode" styleClass="regCbo" disabled="false">
					<html:option value="-1">Select Value</html:option>										
					<html:options collection="<%=RegistrationConfig.ESSENTIALBO_OPTION_ALL_DEPARTMENT%>" property="value" labelProperty="label" />
					</html:select>
					</logic:equal>
					<logic:equal name="<%=RegistrationConfig.VIEWORMODIFY%>" value="view">								
					<html:select name="EmployeeMasterFB" tabindex="1" property="deptCode" styleClass="regCbo" disabled="true">
					<html:option value="-1">Select Value</html:option>										
					<html:options collection="<%=RegistrationConfig.ESSENTIALBO_OPTION_ALL_DEPARTMENT%>" property="value" labelProperty="label" />
					</html:select>
					</logic:equal></td>
					...
					<td class="tdfont" width="17%">
					<logic:equal name="<%=RegistrationConfig.VIEWORMODIFY%>" value="modify">								
					<html:text name="EmployeeMasterFB"  maxlength="21" styleClass="textbox" property="contactNo" onkeypress="return validateNumericWithCommaOnly(event)" readonly="false"/>	     
					</logic:equal>
					<logic:equal name="<%=RegistrationConfig.VIEWORMODIFY%>" value="view">								
					<html:text name="EmployeeMasterFB"  maxlength="21" styleClass="textbox" property="contactNo" onkeypress="return validateNumericWithCommaOnly(event)" readonly="true"/>	     
					</logic:equal>
					</td>
...
<html:hidden name="EmployeeMasterFB" property="countryCode" />
<html:hidden name="EmployeeMasterFB" property="transactionMode" />
<html:hidden name="EmployeeMasterFB" property="<%=RegistrationConfig.VIEWORMODIFY%>" />		
<html:hidden name="EmployeeMasterFB" property="chk" />
