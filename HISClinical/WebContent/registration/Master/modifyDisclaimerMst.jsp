...
<%
  ...
  String  currentDate="";
    ...
    System.out.println("transactionMode-----"+request.getParameter("transactionMode"));
...
<%!boolean readonly;%>
<% this.readonly=false;%>
<logic:equal name="AddDisclaimerFB" property="transactionMode" value="VIEW">
<% this.readonly=true;%>
</logic:equal>


<his:TitleTag name="Default Disclaimer Modify">			
...
<table width="100%" border="0" cellspacing="1" cellpadding="0">   
  ...
  <tr>
	  ...
	  <font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
	 	...
	 	<html:radio name="AddDisclaimerFB" property="isHeader" value="1" disabled="<%=this.readonly%>"></html:radio>
	 	<b><bean:message key="footer"/></b>
	 	<html:radio name="AddDisclaimerFB" property="isHeader" value="0" disabled="<%=this.readonly%>"></html:radio>
	  </font>
	  </div>
      </td>  <td width="30%" class="tdfont">
	  <div align="center">	           
		  <html:select name="AddDisclaimerFB" tabindex="1" property="alignment" styleClass="regCbo" disabled="<%=this.readonly%>">
  	  ...
  	  <td width="30%" class="tdfont">
	  <div align="center">	           
	  	<html:select name="AddDisclaimerFB" tabindex="1" property="isValid" styleClass="regCbo" disabled="<%=this.readonly%>">
...
<logic:equal value="VIEW" name="AddDisclaimerFB" property="transactionMode">
 ...
 <his:SubTitleTag name="Normal Card Disclaimer">
  ...
  <tr>
	  ...
	  <div align="left">
	   	<html:text name="AddDisclaimerFB"  maxlength="100" size="130" property="generalDisclaimerDesc1" tabindex="1" readonly="true"/>  
  ...
  <tr>
      ...
      <td width="20%" class="tdfont">	  
	  <div align="left">
	   	<html:text name="AddDisclaimerFB"  maxlength="100" size="130" property="generalDisclaimerDesc2" tabindex="1" readonly="true"/>  
  ...
  <tr>
      ...
      <td width="20%" class="tdfont">	  
	  <div align="left">
	   	<html:text name="AddDisclaimerFB"  maxlength="100" size="130" property="generalDisclaimerDesc3" tabindex="1" readonly="true"/>  
...
<table width="100%" border="0" cellspacing="1" cellpadding="0"> 
   ...
   <tr>
      ...
      <td width="20%" class="tdfont">	  
	  <div align="left">
	   	<html:text name="AddDisclaimerFB"  maxlength="100" size="130" property="specialDisclaimerDesc1" tabindex="1" readonly="true" />  
  ...
  <tr>
      ...
      <td width="20%" class="tdfont">	  
	  <div align="left">
	   	<html:text name="AddDisclaimerFB"  maxlength="100" size="130" property="specialDisclaimerDesc2" tabindex="1" readonly="true"/>  
  ...
  <tr>
      ...
      <td width="20%" class="tdfont">	  
	  <div align="left">
	   	<html:text name="AddDisclaimerFB"  maxlength="100" size="130" property="specialDisclaimerDesc3" tabindex="1" readonly="true" />  
  ...
  <tr>
      ...
      <td width="20%" class="tdfont">	  
	  <div align="left">
	   	<html:text name="AddDisclaimerFB"  maxlength="100" size="130"  property="casualityDisclaimerDesc1" tabindex="1" readonly="true" />  
  ...
  <tr>
      ...
      <td width="20%" class="tdfont">	  
	  <div align="left">
	   	<html:text name="AddDisclaimerFB"  maxlength="100" size="130"  property="casualityDisclaimerDesc2" tabindex="1" readonly="true"/>  
  ...
  <tr>
      ...
      <td width="20%" class="tdfont">	  
	  <div align="left">
	   		<html:text name="AddDisclaimerFB"  maxlength="100" size="130"  property="casualityDisclaimerDesc3" tabindex="1" readonly="true"/>  
...
<logic:equal value="EDIT" name="AddDisclaimerFB" property="transactionMode">
...
<logic:equal value="VIEW" name="AddDisclaimerFB" property="transactionMode">
    <img class="button" src='<his:path src="/../HIS/hisglobal/images/buttons/btn-ccl.png"/>' style=cursor:pointer tabindex="1" onclick ="submitForm('CANCEL_MODIFY')" onkeypress="if(event.keyCode==13) submitForm('CANCEL_MODIFY')">
   	
</logic:equal>

<logic:equal value="EDIT" name="AddDisclaimerFB" property="transactionMode">
	<img class="button" src='<his:path src="/../HIS/hisglobal/images/buttons/btn-sv.png"/>' style=cursor:pointer tabindex="1" onclick ="submitForm('UPDATE')" onkeypress="if(event.keyCode==13)submitForm('UPDATE')">
    <img class="button" src='<his:path src="/../HIS/hisglobal/images/buttons/btn-ccl.png"/>' style=cursor:pointer tabindex="1" onclick ="submitForm('CANCEL_MODIFY')" onkeypress="if(event.keyCode==13) submitForm('CANCEL_MODIFY')">
