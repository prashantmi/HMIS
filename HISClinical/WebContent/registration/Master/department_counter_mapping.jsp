...
function MoveToSelected()
{
	...
	// Unselect Remaining 
	if(document.forms[0].selectedDept)
	{	
		for(var i=0;i<document.forms[0].dept.options.length;i++)
			document.forms[0].dept.options[i].selected=false;
	}
}
...
function clearForm(){
	...
	document.getElementsByName('dept')[0].length=0;
	document.getElementsByName('selectedDept')[0].length=0;
}
 
function getFetchedList(){

	var fetchedList=document.forms[0].selectedDept;
...
function getDept(obj){
	...
	if(processTypeCode=="-1"){
		...
		document.getElementsByName("hmode")[0].value="GETDEPT"
		document.forms[0].submit()
	}	
}
...
<body>
<html:form action="master/departmentCounterMapping" > 
    <html:hidden name="departmentCounterFB" property="hmode"/>
    <html:hidden name="departmentCounterFB" property="chk"/>
    
     <his:ContentTag>

  	  	 <his:TitleTag name="Department Counter Mapping">
			</his:TitleTag>
		...
		<table width="100%" border="0" cellspacing="2" cellpadding="0">
		   	<tr>
				...
				<td width="50%" class="tdfont">
					<div align="left">
						&nbsp;<html:select name="departmentCounterFB" property="counter" tabindex="1" styleClass="regcbo" onchange="getDept(this)">
		   	...
		   	<table width="100%" border="0"  cellspacing="1" cellpadding="0">
				<tr>
						...
						<td width="20%"  class="tdfonthead">Dept
						</td>
						<td width="40%"  class="tdfonthead">
						</td>
					</tr>
					<tr>
						<td width="40%"  class="tdfont">
							<div align="right">
								<html:select name="departmentCounterFB" property="dept" tabindex="1" multiple="true" size="6">
									<logic:notEqual name="departmentCounterFB" property="hmode"  value="NEW">
										<logic:present name="<%=RegistrationConfig.DEPT_NOT_ADDED_TO_COUNTER_DEPT_LIST%>">
										<html:options  collection="<%=RegistrationConfig.DEPT_NOT_ADDED_TO_COUNTER_DEPT_LIST%>" property="value" labelProperty="label" />
										</logic:present>
									</logic:notEqual>
								</html:select>		
							</div>
						...
						<td width="40%"  class="tdfont">
							<div align="left">
								<html:select name="departmentCounterFB" property="selectedDept" tabindex="1" multiple="true" size="6">
									<logic:notEqual name="departmentCounterFB" property="hmode"  value="NEW">
										<logic:present name="<%=RegistrationConfig.DEPT_ADDED_TO_COUNTER_DEPT_LIST%>">
										<html:options  collection="<%=RegistrationConfig.DEPT_ADDED_TO_COUNTER_DEPT_LIST%>" property="value" labelProperty="label" />
										</logic:present>
									</logic:notEqual>
								</html:select>
