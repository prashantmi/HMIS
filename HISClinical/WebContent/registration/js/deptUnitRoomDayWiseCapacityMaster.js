...
return valid;
	...
	function clearForm(){
		...
		var roomCapacityFor1stWeek=document.getElementsByName("roomCapacityFor1stWeek")
		var roomCapacityFor2ndWeek=document.getElementsByName("roomCapacityFor2ndWeek")
		var roomCapacityFor3rdWeek=document.getElementsByName("roomCapacityFor3rdWeek")
		var roomCapacityFor4thWeek=document.getElementsByName("roomCapacityFor4thWeek")
		var roomCapacityFor5thWeek=document.getElementsByName("roomCapacityFor5thWeek")
		
		
		for(var i=0; i < roomCapacityFor1stWeek.length; i++)
			{
			roomCapacityFor1stWeek[i].value="";
			}
		
		for(var i=0; i < roomCapacityFor2ndWeek.length; i++)
			{
			roomCapacityFor2ndWeek[i].value="";
			}
		
		for(var i=0; i < roomCapacityFor3rdWeek.length; i++)
			{
			roomCapacityFor3rdWeek[i].value="";
			}
		
		for(var i=0; i < roomCapacityFor4thWeek.length; i++)
			{
			roomCapacityFor4thWeek[i].value="";
			}
		
		
		for(var i=0; i < roomCapacityFor5thWeek.length; i++)
			{
			roomCapacityFor5thWeek[i].value="";
			}
...
function validateCapacity(){
		...
		for(var i=0; i < roomCapacityFor1stWeek.length; i++)
			{
			if(roomCapacityFor1stWeek[i].value==""){
					alert("Please Enter Capacity");
					roomCapacityFor1stWeek[i].focus();
					return false;
				}
			}
		...
		for(var i=0; i < roomCapacityFor2ndWeek.length; i++)
			...
			if(roomCapacityFor2ndWeek[i].value==""){
					alert("Please Enter Capacity");
					roomCapacityFor2ndWeek[i].focus();
					return false;
				}
		...
		for(var i=0; i < roomCapacityFor3rdWeek.length; i++)
			...
			if(roomCapacityFor3rdWeek[i].value==""){
					alert("Please Enter Capacity");
					roomCapacityFor3rdWeek[i].focus();
					return false;
				}
		...
		for(var i=0; i < roomCapacityFor4thWeek.length; i++)
			...
			if(roomCapacityFor4thWeek[i].value==""){
					alert("Please Enter Capacity");
					roomCapacityFor4thWeek[i].focus();
					return false;
				}
			}
		...
		for(var i=0; i < roomCapacityFor5thWeek.length; i++)
			...
			if(roomCapacityFor5thWeek[i].value==""){
					alert("Please Enter Capacity");
					roomCapacityFor5thWeek[i].focus();
					return false;
				}
