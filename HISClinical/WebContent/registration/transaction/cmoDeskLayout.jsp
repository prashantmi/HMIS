...
<his:javascript src="/registration/js/cmo_desk.js" />
...
<html>
	...
	%>
		<html:form action="/cmoDesk">
			...
			<html:hidden name="CMODeskFB" property="mode" />
			<html:hidden name="CMODeskFB" property="deskMenuId" />
			<html:hidden name="CMODeskFB" property="patCrNo" />
			<html:hidden name="CMODeskFB" property="crNoSelected" />
		</html:form>
	</body>
</html>