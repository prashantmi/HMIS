...
function ValidateDepartmentOldDeptVisit() {
	...
	var isVisited=false;
		...
		if(isVisited==false)
		{
			alert("Please Select Atleast One Department To Visit");
			return false;
		}
	}
	else
...
%>
<his:TitleTag name="Emergency Patient Visit">
...
<his:statusNew>
 ...
 <his:InputCrNoTag name="EmergencyPatientVisitFB"></his:InputCrNoTag>
<bean:define id="crNo" name="EmergencyPatientVisitFB" property="patCrNo"
				...
				<logic:iterate id="ARR_EPISODE_REFER_PAT_VO" indexId="index"
					...
					<tr>
						...
						<logic:equal name="ARR_EPISODE_REFER_PAT_VO" property="deptUnitIsClosed" value="<%=RegistrationConfig.DEPT_UNIT_IS_CLOSED_FALSE %>">
							...
							<html:radio
								name="EmergencyPatientVisitFB" property="selectedReffereCrNo"
								value='<%=index.toString()+"$"+ARR_EPISODE_REFER_PAT_VO.getPatCrNo()%>'
...
<logic:equal name="EmergencyPatientVisitFB" property="modeCase"  value="1">
<td class="tdfonthead" nowrap="nowrap" width="25%">
				<div align="right">
				<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">New Emergency Visit</font></div></td>
<td class="tdfont" width="25%"><b>

				<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
					<logic:equal value="On" name="EmergencyPatientVisitFB" property="newDepartmentVisit">
					<input type="checkbox" name="newDepartmentVisit" onclick="checkuncheckNewDepartment(this)" checked="checked"/>
					</logic:equal>
					<logic:notEqual value="On" name="EmergencyPatientVisitFB" property="newDepartmentVisit">
...
<td class="tdfonthead" nowrap="nowrap" width="25%">
				<div align="right">
				<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">Old Emergency Visit</font></div></td><td class="tdfont" width="25%"><b>
...
<logic:equal name="EmergencyPatientVisitFB" property="modeCase"  value="0">
<td class="tdfonthead" nowrap="nowrap" width="25%">
				<div align="right">
				<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">New Emergency Visit</font></div></td>
<td class="tdfont" width="25%"><b>
...
<td class="tdfonthead" nowrap="nowrap" width="25%">
				<div align="right">
				<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">Old Emergency Visit</font></div></td>
<td class="tdfont" width="25%"><b>

				<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
				<logic:equal value="On" name="EmergencyPatientVisitFB" property="oldDepartmentVisit">
					<input type="checkbox" name="oldDepartmentVisit" onclick="checkuncheckOldDepartment(this)" checked="checked"/>
					</logic:equal>
					<logic:notEqual value="On" name="EmergencyPatientVisitFB" property="oldDepartmentVisit">
...
<logic:equal name="EmergencyPatientVisitFB" property="modeCase"  value="2">
<td class="tdfonthead" nowrap="nowrap" width="25%">
				<div align="right">
				<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">New Emergency Visit</font></div></td>
<td class="tdfont" width="25%"><b>
	...
	<his:ContentTag>
		...
		<table width="100%" colspacing="1" colpadding="0">
			<tr>
				...
				<div align="left"><html:text name="EmergencyPatientVisitFB" property="amount"
...
<his:statusTransactionInProcess>
	...
	<%varStatus = "InProcess";%>
	<his:SubTitleTag name="Emergency Visit Details">
<td width="70%" >
             		  <div align="right">
             ...
             <td>        
             		<div align="left">              
                     <html:checkbox tabindex="1" name="EmergencyPatientVisitFB" property="isMLC" value="<%=RegistrationConfig.IS_MLC_TRUE%>" />
                    </div>                     
             </td>
	</his:SubTitleTag>
...
<logic:equal value="On" name="EmergencyPatientVisitFB" property="newDepartmentVisit">
	<%String labelDepartment2 = "";
						...
						%>
	<logic:equal name="EmergencyPatientVisitFB" property="isPatReferByList"
	...
	<%System.out.println("client name================================= "+fileId); %>
		...
		<his:ContentTag>
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%"
				bgcolor="#EBEBEB">
				<bean:define id="isRefer" name="EmergencyPatientVisitFB"
				...
				<tr>
					...
					<div id="labelDepartment1" style="<%=labelDepartment12%>"
						align="left">
						<html:select name="EmergencyPatientVisitFB"
						property="departmentUnitCode" onchange="getBillAmountForGrouping('','')" styleClass="regcbo" tabindex="1">
						<html:option value="-1">Select Value</html:option>
						<logic:present name="unitsColl">
					...
					<div id="controlDepartment1" style="<%=controlDepartment12%>" align="left">
						<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
							<bean:write name="EmergencyPatientVisitFB" property="toDepartment" />
						</font>	
					</div>
					<html:hidden name="EmergencyPatientVisitFB" property="toDepartmentCode"/>
					</td>
			<logic:equal name="fileId"
				value="<%=Config.FILE_NO_GENRATION_MANNUAL_TRUE%>">		
					...
					<div align="left"  ><font
						...
						name="EmergencyPatientVisitFB" tabindex="1" property="fileNo"
					...
					<td width="16%" class="tdfont"><html:text name="EmergencyPatientVisitFB"
	  ...
	  <his:ContentTag>
  			<% if(EPISODEVO.length!=0) {System.out.println("length in jsp......................"+EPISODEVO.length); %><%varStatus="InProcess";%>
					...
					<table  width="100%" border="0" cellspacing="1" cellpadding="0">
						...
						%>
							<tr <%=backgroundColor %>>
									...
									<logic:equal name="episode" property="deptUnitIsOnDuty" value="<%=RegistrationConfig.DEPT_UNIT_IS_ON_DUTY_FALSE%>">
										...
										<logic:equal name="episode" property="isGeneral" value="<%=RegistrationConfig.UNIT_TYPE_GENERAL%>">
											...
											<logic:notEqual name="episode" property="isOtherUnitWorking" value="<%=RegistrationConfig.NO_DEPT_UNIT_WORKING_TRUE%>">
													<html:hidden name="EmergencyPatientVisitFB" property="hiddenEpisode" />
													<div align="center">
								...
								<td <%=tdFontColor %>>
									...
									<%}else{ %>
										<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
										<bean:write name="episode" property="departmentUnit"/>										</font>
										<%} %>
									</div>
								</td>								
						...
						<logic:equal name="episode" property="renewalRequired" value="<%=RegistrationConfig.RENEWAL_REQUIRED_TRUE%>">
						<tr>
						<td class="tdfonthead" colspan="5"><div align="right" ><b>GRAND TOTAL:</b></div></td>
						<td class="tdfont" colspan="1"><div align="center"><input type="text" name="grandTotal" value="0"></div> </td>
						</tr>
						</logic:equal>
						<html:hidden name="EmergencyPatientVisitFB" property="hcode" />						
					</table>
...
<logic:notEqual name="EmergencyPatientVisitFB" property="isPatReferByList" value="1" >	
	  ...
	  <tr>
		<td width="95%" >
			<div align="right"><font color="#ffffff" size="2"
						face="Verdana, Arial, Helvetica, sans-serif"><b><bean:message key="isreferred" /></b></font></div>
		</td>
		<td width="5%">
			<div align="left">
			<html:checkbox name="EmergencyPatientVisitFB" property="isReferred" onclick="checkIsReferred(this)"
			...
			<table width="100%" cellspacing="1" cellpadding="0">
				<tr>
					...
					<div id="checkReferral" style="display:none"><font color="#FF0000"
						...
						color="#000000" size="2"
						face="Verdana, Arial, Helvetica, sans-serif"> <bean:message
						key="referInternal" /> </font> <html:radio name="EmergencyPatientVisitFB"
						property="isRefferInOut" tabindex="1" value="I"
						onclick="showInternal(this)" /> <font color="#000000" size="2"
						face="Verdana, Arial, Helvetica, sans-serif"> <bean:message
						key="referExternal" /> </font> <html:radio name="EmergencyPatientVisitFB"
					...
					<div id="externalRefer" style="display:none"><font color="#FF0000"
						...
						color="#000000" size="2"
						face="Verdana, Arial, Helvetica, sans-serif"> <bean:message
						key="gnctd" /> </font> <html:radio name="EmergencyPatientVisitFB"
						property="referringInstType" tabindex="1" value="G"
						onclick="showAssociated(this)" /> <font color="#000000" size="2"
						face="Verdana, Arial, Helvetica, sans-serif"> <bean:message
						key="other" /> </font> <html:radio name="EmergencyPatientVisitFB"
						property="referringInstType" value="O" tabindex="1"
						onclick="showOthers(this)" /> <html:hidden name="EmergencyPatientVisitFB"
		...
		<div id="commonRefer" style="display:none"><his:ContentTag>
			...
			<table width="100%" cellspacing="1" cellpadding="1">
				<tr>
					...
					<td width="25%" class="tdfont"><html:text name="EmergencyPatientVisitFB"
					...
					<div id="commonReferExternal_associated" style="display:none"><html:select
						name="EmergencyPatientVisitFB" tabindex="1"
						property="patRefGnctdHospitalCode" styleClass="regcbo">
						<html:option value="-1">Select Value</html:option>
						<logic:notEmpty name="<%=RegistrationConfig.ESSENTIALBO_OPTION_REF_HOSPITAL %>">
						<html:options
					...
					<div id="commonReferExternal_other" style="display:none"><html:text
						name="EmergencyPatientVisitFB" tabindex="1" property="patRefHospitalName"
					...
					<td width="25%" class="tdfont">
						<html:select name="EmergencyPatientVisitFB" property="patRefGnctdHospitalDept" tabindex="1" styleClass="regCbo" onchange="checkReferDepartment(this)">
					...
					<td width="25%" class="tdfont">
					<html:text name="EmergencyPatientVisitFB"  property="patRefHospitalDeptOther" maxlength="20"  tabindex="1" styleClass="textbox" disabled="true" onkeypress="return validateAlphabetsOnly(event,this)"/>
					</td>
					...
					<logic:iterate id="ARR_OPD_OPEN_EPISODE_VO"
						...
						<tr>
							...
							<div align="center"><input type="radio"
								...
								onclick="getBillAmountForGrouping('<%=strFrmDepCode%>','<%=String.valueOf(index.intValue())%>');" value="<%=hh %>" /></div>
							</td>
							
							<html:hidden name="EmergencyPatientVisitFB"
								property="episodeCode" value="<%=hh%>" />
							
							<td width="30%" class="tdfont">
							<div align="center"><bean:write name="ARR_OPD_OPEN_EPISODE_VO"
								property="fromDepartment" /> <html:hidden name="EmergencyPatientVisitFB"
							...
							<div align="center"><bean:write name="ARR_OPD_OPEN_EPISODE_VO"
								...
								name="EmergencyPatientVisitFB" property="fromDepartment"
		...
		<table cellpadding="0" cellspacing="0" width="100%">
			<tbody>
				...
				<tr>
					...
					%>
				<div align="center">
				 <img class="button" src="/../HIS/hisglobal/images/buttons/btn-sv.png" tabindex="1"  style=cursor:pointer onclick="submitForm('RENEWAL');" onkeypress="if (event.keyCode==13) submitForm'RENEWAL');">
				...
				<logic:equal  name="EmergencyPatientVisitFB"  property="newDepartmentVisit" value="On">
					<logic:equal  name="EmergencyPatientVisitFB"  property="oldDepartmentVisit" value="">
				...
				<logic:equal  name="EmergencyPatientVisitFB"  property="oldDepartmentVisit" value="On">
				<logic:equal  name="EmergencyPatientVisitFB"  property="newDepartmentVisit" value="">
				...
				<img class="button" src="/../HIS/hisglobal/images/buttons/btn-sv.png" tabindex="1"  style=cursor:pointer onkeypress="if(event.keyCode==13) submitFormOnValidate(ValidateDepartmentOldDeptVisit(),'CHECKMANDATORY');" onclick="submitFormOnValidate(ValidateDepartmentNewDeptVisit(document.getElementsByName('departmentsToVisitStamp')[0]),'CHECKMANDATORY');">
				 ...
				 <logic:equal  name="EmergencyPatientVisitFB"  property="newDepartmentVisit" value="On">
				<img class="button" src='../hisglobal/images/btn-reprint.png' tabindex="1" style="cursor: pointer; display: none;" onclick="document.forms[0].hmode.value='PRINT';document.forms[0].submit();" onkeypress="if(event.keyCode==13) document.forms[0].hmode.value='PRINT';document.forms[0].submit();">
				</logic:equal>
				</div>
...
<html:hidden name="EmergencyPatientVisitFB" property="departmentdiv" />

<input type="hidden" name="crNo" />
<html:hidden name="EmergencyPatientVisitFB" property="hmode" value="unspecified"/>
<html:hidden name="EmergencyPatientVisitFB" property="patFirstName" />
<html:hidden name="EmergencyPatientVisitFB" property="patMiddleName" />
<html:hidden name="EmergencyPatientVisitFB" property="patLastName" />
<html:hidden name="EmergencyPatientVisitFB" property="patGender" />           
<html:hidden name="EmergencyPatientVisitFB" property="patAge" />
<html:hidden name="EmergencyPatientVisitFB" property="patPrimaryCatCode" />
<html:hidden name="EmergencyPatientVisitFB" property="patGuardianName" />
<html:hidden name="EmergencyPatientVisitFB" property="patAmountCollected" />
<html:hidden name="EmergencyPatientVisitFB" property="isPatReferByList" />
<html:hidden name="EmergencyPatientVisitFB" property="selectedFromDept" />
<html:hidden name="EmergencyPatientVisitFB" property="patBillAmountWithoutGrouping" />
<html:hidden name="EmergencyPatientVisitFB" property="patCrNo" />
<html:hidden name="EmergencyPatientVisitFB" property="referInternalExternal" />
<html:hidden name="EmergencyPatientVisitFB" property="referingRowIndex" />
<html:hidden name="EmergencyPatientVisitFB" property="onlineReferedIndex"/>
<html:hidden name="EmergencyPatientVisitFB" property="errorMessage"/>
<html:hidden name="EmergencyPatientVisitFB" property="entryDate"/>
<html:hidden name="EmergencyPatientVisitFB" property="episodeVisitNo"/>

<html:hidden name="EmergencyPatientVisitFB" property="captureMandatoryField"/>
<html:hidden name="EmergencyPatientVisitFB" property="modeCase" />
<html:hidden name="EmergencyPatientVisitFB" property="selectedCheckBox" />
<html:hidden name="EmergencyPatientVisitFB" property="print" />
