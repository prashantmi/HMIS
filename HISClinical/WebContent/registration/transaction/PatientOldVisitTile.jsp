...
<his:InputCrNoTag name="PatientVisitFB">
	
	</his:InputCrNoTag>
<bean:define id="crNo" name="PatientVisitFB" property="patCrNo" type="java.lang.String"/>
<his:statusList>
				...
				<logic:iterate id="ARR_EPISODE_OLD_PAT_REFER_VO" name="<%=RegistrationConfig.ARR_EPISODE_OLD_PAT_REFER_VO %>" type="hisglobal.vo.EpisodeRefDtlVO" indexId="index">
					<tr>
						<td width="4%" class="tdfont">
							<div align="center">
								<font size="2">
									<html:radio name="PatientVisitFB" property="selectedRefCrNo" value='<%=index.toString()+"$"+ARR_EPISODE_OLD_PAT_REFER_VO.getPatCrNo() %>' onclick="showDetail(this)"></html:radio>
...
<td class="tdfont" width="25%"><b>
				...
				<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif"><input type="checkbox" name="newDepartmentVisit" onclick="submitForm('NEWDEPARTMENTVISITDTL')" checked="checked"/></font></b></td>
<td class="tdfonthead" nowrap="nowrap" width="25%">
				<div align="right">
	  ...
	  <his:ContentTag>
  			<% if(EPISODEVO.length!=0) {System.out.println("length in jsp......................"+EPISODEVO.length); %><%varStatus="InProcess";%>
					...
					<table  width="100%" border="0" cellspacing="1" cellpadding="0">
						...
						<logic:equal name="episode" property="renewalRequired" value="<%=RegistrationConfig.RENEWAL_REQUIRED_TRUE%>">
						<tr>
						<td class="tdfonthead" colspan="6"><div align="right" ><b>GRAND TOTAL:</b></div></td>
						<td class="tdfont" colspan="1"><div align="left"><input type="text" name="grandTotal"></div> </td>
						</tr>
						</logic:equal>
...
<%if(! (renewalStatus.equals("renew"))){ %>	
	...
	<table width="100%" cellspacing="1" cellpadding="0">
	  <tr>
		...
		<td width="5%">
			<div align="left">
			<html:checkbox name="PatientVisitFB" property="isReferred" value="1"  onclick="getEpisodeRefDtl('EPISODEDTL',this)" onkeypress="if(event.keyCode==13) getEpisodeRefDtl('EPISODEDTL',this);" tabindex="1"/>
			</div>
		</td>
		</tr>
	 </table>	
	</his:SubTitleTag>
		<bean:define name="PatientVisitFB" property="isReferred" id="isref" type="java.lang.String"/>            
 ...
 <table width="100%" cellspacing="1" cellpadding="0">
		...
		<div id="checkReferral" style="display:<%=divisrefdisplay%>">
			...
			<html:radio name="PatientVisitFB" property="isRefferInOut" tabindex="1" value="I" onclick="showInternal(this)" />
		
			<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
			<bean:message key="referExternal" />
			</font>
			<html:radio name="PatientVisitFB" property="isRefferInOut" tabindex="1" value="E" onclick="showExternal(this)" />
		</div>
		</td>
		<td width="40%">
			<div id="externalRefer" style="display:<%=externalReferdisplay%>">
				...
				<html:radio name="PatientVisitFB" property="referringInstType" tabindex="1" value="G" onclick="showAssociated(this)" />
				<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
				<bean:message key="other" />
				</font>
				<html:radio name="PatientVisitFB" property="referringInstType" value="O" tabindex="1" onclick="showOthers(this)" />
				<html:hidden name="PatientVisitFB" property="isAssociated" />
				</div>
		</td>
		</tr>
	</table>
	...
	<his:ContentTag>
		...
		<table width="100%" cellspacing="1" cellpadding="1">
			<tr>
				...
				<html:text name="PatientVisitFB" styleClass="textbox" maxlength="100" property="patRefDoctor" onblur="isAlpha(this,'Referred By Doctor')" tabindex="1" onkeypress="return validateAlphabetsOnly(event,this)" />
				</td>
				<td width="25%"  class="tdfonthead">
				...
				<html:select name="PatientVisitFB" tabindex="1" property="patRefGnctdHospitalCode" styleClass="regcbo">
				...
				<html:text  name="PatientVisitFB" tabindex="1" property="patRefHospitalName" onkeypress="return validateAlphabetsOnly(event)" maxlength="100" styleClass="textbox" size="20"/>
				</div>
				</td>
			</tr>
			 ...
			 <tr>
				...
				<td width="25%" class="tdfonthead" >
					...
					<td width="25%" class="tdfont">
					<html:text name="PatientVisitFB"  property="patRefHospitalDeptOther" maxlength="20"  tabindex="1" styleClass="textbox" disabled="true"/>
					</td>
				</tr>
		...
		<table width="100%" cellspacing="1" cellpadding="1">
			<tr>
				...
				<td width="25%" %  class="tdfont">
				<html:text name="PatientVisitFB" tabindex="1" property="patRefGnctdHospitalCrno" maxlength="12" tabindex="1" onkeydown="setPrevValue(this, event);" onkeyup="moveToRight(this, event);" onkeypress="return validateNumeric(event)" styleClass="textbox" />
				</td>
			    <td width="25%" class="tdfonthead">
				<div align="right">
				<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
				...
				<td width="25%"  class="tdfont">
				<html:text name="PatientVisitFB" property="patRefGnctdHospitalDeptUnit" tabindex="1" maxlength="15" styleClass="textbox" />
				</td>
			</tr>
...
<div id="internalRefer" style="display:<%=internalReferdisplay%>">
			<!--- ReferInternal -------  Details of all open episodes-->
				...
				<his:ContentTag>
				<logic:notEmpty name="<%=RegistrationConfig.ARR_OPD_OPEN_EPISODE_VO%>" >
...
<%String strFrmDepUnitCode=(String)frmDepUnitCode; %>
							<tr>
								...
								<html:hidden
									name="PatientVisitFB" property="episodeCode"
									value="<%=hh%>"/>
		...
		<table cellpadding="0" cellspacing="0" width="100%">
			<tbody>
				...
				<%if(varStatus.equals("InProcess")){%>
								...
								<div align="center">
				        	    	<img class="button" src='<his:path src="/../HIS/hisglobal/images/buttons/btn-sv.png"/>' style=cursor:pointer tabindex="1" onclick = "submitFormOnValidate(validateOldPatientVisit() && ValidateDepartmentNewDeptVisit(),'RENEWAL');" onkeypress="if (event.keyCode==13) submitFormOnValidate(validateOldPatientVisit() && ValidateDepartmentNewDeptVisit(),'RENEWAL');" >
