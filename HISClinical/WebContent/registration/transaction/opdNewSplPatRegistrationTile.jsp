...
<%@page import="registration.controller.fb.newSplRegFB"%>
...
function callThisOnload(){	
	...
	if(document.getElementsByName("isDuplicatePatientPopup")[0].value=="1"){
		...
		var path="/HISClinical/registration/newSplRegDesk.cnt?hmode=POPUP";;
		openPopup(path);
	}
...
function openBPLPopup(e)
{
		...
		var url = "/HISClinical/registration/newSplRegDesk.cnt?hmode="+hmode+"&bplCardNo="+bplCardNo;
		ajaxFunction(url,"3");
}
	...
	//alert("Inside send Data");
	 ...
	 if(patientPriCatCode==patEmployeeCode)
 	 ...
 	 else
 	 {
		...
		var url = "/HISClinical/registration/newSplRegDesk.cnt?hmode="+hmode+"&tariffId="+tariffIdValue+"&patientCat="+patientPriCatCode;
		ajaxFunction(url,"1");
	}
	...
	if(stateCode!="" && stateCode!='-1')
	{
		if(stateCode==defaltStateCode)
		{
	 	...
	 	else
	 	{
			...
			var url = "/HISClinical/registration/newSplRegDesk.cnt?hmode="+hmode+"&patAddStateCode="+stateCode;
			ajaxFunction(url,"2");
...
function getAjaxResponse(res,mode)
{
		...
		if(mode == '3')
		{
			if(res>0)
			{
				var path="/HISClinical/registration/newSplRegDesk.cnt?hmode=BPLPOPUP&bplCardNo="+document.forms[0].patBPLCardNo.value;
				openPopup(path);
			}
		}
}   
...
<his:statusTransactionInProcess>
	...
	<his:statusTransactionInProcess>
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="0">
				<tr>
					...
					<td width="19%" class="tdfont"><font color="#000000" size="1"
						...
						name="newSplRegFB" property="patPrimaryCatCode"
					...
					<html:text name="newSplRegFB" onkeypress="return validateAlphaNumericOnly(event,this);"
				...
				<tr style="display: none;" id="bplFamilyTrId">
					...
					<table width='100%'cellspacing='1px' cellpadding='0'>
						...
						<td width='19%' class='tdfont'>
						<html:select name="newSplRegFB" property='bplRelationCode'  
						styleClass='regcbo'>
						<html:option value='-1'>Select Value</html:option>
						<html:options
				...
				<tr>
					...
					<td width="19%" class="tdfont"><html:text
						name="newSplRegFB" property="patFirstName"
					...
					<td width="14%" class="tdfont" align="left"><html:text
						name="newSplRegFB" property="patMiddleName"
					...
					<td width="17%" class="tdfont"><html:text
						name="newSplRegFB" property="patLastName"
					...
					<td class="tdfont" width="17%"><html:select
						name="newSplRegFB" property="patCasteCode"
						tabindex="2" styleClass="regcbo">
						<html:option value="-1">Select Value</html:option>
						<html:options
				...
				<tr>
					...
					<td width="17%" class="tdfont" nowrap="nowrap"><html:select
						name="newSplRegFB" property="patGenderCode"
				...
				<tr>
					<td width="17%" class="LABEL"><bean:message key="mandatory1" /><bean:message
						key="fathersName" /></td>
					<td width="17%" class="tdfont"><html:text
						name="newSplRegFB" property="patGuardianName"
					...
					<td width="17%" class="tdfont"><html:text
						name="newSplRegFB" property="patHusbandName"
					...
					<td width="17%" class="tdfont"><html:text
						name="newSplRegFB" property="patMotherName"
						styleClass="textbox" tabindex="2" maxlength="60"
						onchange="isAlpha(this,'Guardian Name')"
						onkeypress="return validateAlphabetsWithDotsOnly(event,this)" /></td>
				</tr>
				<tr>
					...
					<div id="patCountryCombo"><html:select
						name="newSplRegFB" property="patNationalityCode"
						tabindex="1" styleClass="regcbo">
						<html:option value="-1">Select Value</html:option>
						<html:options
					...
					<td width="17%" class="tdfont"><html:text
						name="newSplRegFB" property="patBirthPlace"
						styleClass="textbox" tabindex="2" maxlength="60"
						onchange="isAlpha(this,'Guardian Name')"
						onkeypress="return validateAlphabetsWithDotsOnly(event,this)" /></td>
				</tr>
				<tr>
					...
					<td width="17%" class="tdfont"><html:select
						name="newSplRegFB" property="patOccupation"
						tabindex="2" styleClass="regcbo">
						<html:option value="-1">Select Value</html:option>
						<html:options
					...
					<td width="17%" class="tdfont"><html:text
						name="newSplRegFB" property="patMonthlyIncome"
					...
					<td width="17%" class="tdfont"><html:text
						...
						<bean:define name="newSplRegFB" property="patAmountCollected" id="patAmountCollectedId" />
				...
				<tr>
					...
					<td width="17%" class="tdfont"><html:text
						name="newSplRegFB" property="patCardNo" disabled="true"
		...
		<his:SubTitleTagBroad name="Address Detail">
			<table width="100%">
				<tr>
					<td><bean:message key="mandatory1" /> <font color="#000000"
						size="2" face="Verdana, Arial, Helvetica, sans-serif"> <bean:message
						key="country" /></font></td>
					<td><html:select name="newSplRegFB"
		...
		<his:ContentTag>
			<table width="100%" cellpadding="0">
				<tr>
					...
					<td class="tdfont" width="17%"><html:text
						name="newSplRegFB" property="patAddStreet"
						onkeypress="return validateAlphaNumericWithDotsOnly(event,this);"
					...
					<div id="divpatAddCityLocation"><html:text
						name="newSplRegFB" tabindex="2" maxlength="50"
						onkeypress="return validateAlphaNumericWithDotsOnly(event,this);"
				...
				<tr>
					...
					<div id="districtCombo"><html:select
						name="newSplRegFB" tabindex="2" styleClass="regcbo"
             ...
             id="mandatoryAreaCat" style="display: none;">
					...
					<td width="18%" class="tdfont"><html:select
						name="newSplRegFB" property="patIsUrban"
						tabindex="2" styleClass="regcbo">
						<html:option value="">Select Value</html:option>
						<html:options
		...
		<bean:define name="newSplRegFB" property="isReferred"
			...
			<table width="100%" cellspacing="1" id="divRefDtlId" cellpadding="1"
				...
				<tr>
					...
					&nbsp;&nbsp;&nbsp; <bean:message key="gnctd" /> </font> <html:radio
						name="newSplRegFB" property="referringInstType"
