...
/*function onLoadSetMultilingual(){
	var LOCAL_LANGUAGE = "<%= RegistrationConfig.LOCAL_LANGUAGE %>";
...
<html:form action="/patientModification">
	...
	<his:ContentTag>
		...
		<table width="100%" border="0" cellspacing="1" cellpadding="0">
			<logic:notEmpty name="<%=RegistrationConfig.ALL_PATIENT_VO_LIST%>">
				<logic:iterate id="PATIENT_VO"
					name="<%=RegistrationConfig.ALL_PATIENT_VO_LIST%>">
...
<!--					</td>-->
					...
					<td width="17%" class="tdfont">
						<div style="display: none" id="familyHeadTextDiv">
							<html:text name="PatientModificationFB" property="patNickName" tabindex="2" styleClass="textbox" maxlength="30" 
				...
				<tr>
					...
					<td width="19%" class="tdfonthead">
						<div align="left"><font color="#FF0000" size="1" face="Verdana, Arial, Helvetica, sans-serif">*</font><font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
				...
				<tr>
					...
					<td class="tdfont">
						<html:select name="PatientModificationFB" property="patCasteCode" tabindex="2" styleClass="regcbo">
				...
				<tr style="display: none">
					<td width="14%" class="tdfonthead">&nbsp;</td>
					<td width="17%" class="tdfont">
						<input type="text" name="patFirstNameInMultiLang" value="${PatientModificationFB.patFirstNameInMultiLang}" class="textbox" tabindex="1"
					...
					<td width="18%" class="tdfonthead">
						<div align="left">
							<input type="text" name="patMiddleNameInMultiLang" value="${PatientModificationFB.patMiddleNameInMultiLang}" tabindex="1" class="textbox"
							onblur="callOnBlur();" onfocus="callOnClick();"
					...
					<td class="tdfont">
						<input type="text" name="patLastNameInMultiLang" value="${PatientModificationFB.patLastNameInMultiLang}" tabindex="1" class="textbox"
						onblur="callOnBlur();" onfocus="callOnClick();"
				...
				<tr>
					...
					<td class="tdfont" width="17%">
						<html:text name="PatientModificationFB" property="patHusbandName" tabindex="2" styleClass="textbox"
					...
					<td class="tdfont" width="17%">
						<html:text name="PatientModificationFB" property="patMotherName" tabindex="2" styleClass="textbox"
				...
				<tr>
					...
					<td width="17%" class="tdfont">
						<html:select name="PatientModificationFB" property="patReligionCode" tabindex="2" styleClass="regcbo">
							<html:option value="">Select Value</html:option>
					...
					<td width="17%" class="tdfonthead">
					<div align="right">
							<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif"><bean:message key="birplace" />
							</font></div>
					</td>
				...
				<tr>
					...
					<td width="17%" class="tdfont">
						<html:text name="PatientModificationFB" property="patNationalId" styleClass="textbox" maxlength="16"
							tabindex="2" onkeypress="return validateAlphaNumericWithSpecialCharacterOnly(this,event)" styleClass="textbox" />
					</td>
					<td width="17%" class="tdfonthead">
					<div align="right">
							<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif"><bean:message key="otherId" /></font></div></td>
					<td width="17%" class="tdfont"><html:select
					...
					<td width="17%" class="tdfonthead">
					<div align="right">
							<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif"><bean:message key="patCardNo" /></font></div></td>
					<td width="17%" class="tdfont"><html:text
				...
				<tr>
					<td width="17%" class="tdfonthead">
					<div align="right">
							<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif"><bean:message key="patOccupation" /></font></div></td>
					<td width="17%" class="tdfont"><html:select
					...
					<div align="right">
							<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif"><bean:message key="monthlyIncome" /></font></div>
					</td>
					<td width="17%" class="tdfont"><html:text
		...
		<table width="100%" cellspacing="0" cellpadding="0" bgcolor="#EBEBEB" class="applicationBackgroundColor" style="display:none; clear: both; border-left: 1px solid #003366;">
			<tr>
					...
					<td width='45%' align='right'>
						<div id="saveButton">
							<img class="button" style='cursor: pointer' src='<his:path src="/../HIS/hisglobal/images/buttons/btn-sv.png"/>'
								onkeypress="if(event.keyCode==13) submitFormOnValidate(ValidatePatientDtlModificationDesk(),'SAVE');" tabindex="1"
								onclick="submitFormOnValidate(ValidatePatientDtlModificationDesk(),'SAVE');">
						</div>
					</td>
...
<!--		</his:statusDone>-->
	...
	<html:hidden name="PatientModificationFB" property="hmode" value="unspecified" />
		<html:hidden name="PatientModificationFB" property="deskmode" />
		<html:hidden name="PatientModificationFB" property="deskModFlag" />
	...
	<html:hidden name="PatientModificationFB" property="patFBAddTypeCode"/>
	<html:hidden name="PatientModificationFB" property="patDocType"/>
	<html:hidden name="PatientModificationFB" property="patCardNo"/>
