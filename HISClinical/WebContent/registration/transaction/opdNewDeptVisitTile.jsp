...
//		alert("inside IF") 
	...
	else
	{
    	if(validateAgeForDeptToVisit('<%=RegistrationConfig.MAX_AGE_TO_REGISTER_IN_CHILD_DEPT%>','<%=RegistrationConfig.CHILD_DEPT_CODE%>')
   			<his:referMandatory property="departmentCode" /> 
    		){
    		isValid=true;
    	}
    	else{
...
<his:statusNew>
 ...
 <his:InputCrNoTag name="NewDeptVisitFB"></his:InputCrNoTag>
<bean:define id="crNo" name="NewDeptVisitFB" property="patCrNo"
				...
				<logic:iterate id="ARR_EPISODE_REFER_PAT_VO" indexId="index"
					...
					<tr>
						...
						<logic:equal name="ARR_EPISODE_REFER_PAT_VO" property="deptUnitIsClosed" value="<%=RegistrationConfig.DEPT_UNIT_IS_CLOSED_FALSE %>">
							...
							<html:radio
								name="NewDeptVisitFB" property="selectedReffereCrNo"
	...
	<his:ContentTag>
		...
		<table width="100%" colspacing="1" colpadding="0">
			<tr>
				...
				<div align="left"><html:text name="NewDeptVisitFB" property="amount"
...
<his:statusTransactionInProcess>
	...
	<%String labelDepartment2 = "";
						...
						%>
	<logic:equal name="NewDeptVisitFB" property="isPatReferByList"
	...
	<%System.out.println("client name================================= "+fileId); %>
		...
		<his:ContentTag>
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%"
				bgcolor="#EBEBEB">
				<bean:define id="isRefer" name="NewDeptVisitFB"
				...
				<tr>
					...
					<div id="labelDepartment1" style="<%=labelDepartment12%>"
						align="left"><html:select name="NewDeptVisitFB"
						property="departmentCode" onchange="getBillAmountForGrouping('','')" styleClass="regcbo" tabindex="1">
					...
					<div id="controlDepartment1" style="<%=controlDepartment12%>" align="left">
						<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
							<bean:write name="NewDeptVisitFB" property="toDepartment" />
						</font>	
					</div>
					<html:hidden name="NewDeptVisitFB" property="toDepartmentCode"/>
					</td>
			<logic:equal name="fileId"
				value="<%=Config.FILE_NO_GENRATION_MANNUAL_TRUE%>">		
					...
					<div align="left"  ><font
						...
						name="NewDeptVisitFB" tabindex="1" property="fileNo"
					...
					<td width="16%" class="tdfont"><html:text name="NewDeptVisitFB"
...
<logic:notEqual name="NewDeptVisitFB" property="isPatReferByList" value="1" >	
...
<his:SubTitleTag name="Refer Details">
	<table width="100%" cellspacing="1" cellpadding="0">
	  <tr>
		...
		<td width="5%">
			<div align="left">
			<html:checkbox name="NewDeptVisitFB" property="isReferred" onclick="checkIsReferred(this)"
			...
			<table width="100%" cellspacing="1" cellpadding="0">
				<tr>
					...
					<div id="checkReferral" style="display:none"><font color="#FF0000"
						...
						color="#000000" size="2"
						face="Verdana, Arial, Helvetica, sans-serif"> <bean:message
						key="referInternal" /> </font> <html:radio name="NewDeptVisitFB"
						property="isRefferInOut" tabindex="1" value="I"
						onclick="showInternal(this)" /> <font color="#000000" size="2"
						face="Verdana, Arial, Helvetica, sans-serif"> <bean:message
						key="referExternal" /> </font> <html:radio name="NewDeptVisitFB"
					...
					<div id="externalRefer" style="display:none"><font color="#FF0000"
						...
						color="#000000" size="2"
						face="Verdana, Arial, Helvetica, sans-serif"> <bean:message
						key="gnctd" /> </font> <html:radio name="NewDeptVisitFB"
						property="referringInstType" tabindex="1" value="G"
						onclick="showAssociated(this)" /> <font color="#000000" size="2"
						face="Verdana, Arial, Helvetica, sans-serif"> <bean:message
						key="other" /> </font> <html:radio name="NewDeptVisitFB"
						property="referringInstType" value="O" tabindex="1"
						onclick="showOthers(this)" /> <html:hidden name="NewDeptVisitFB"
		...
		<div id="commonRefer" style="display:none"><his:ContentTag>
			...
			<table width="100%" cellspacing="1" cellpadding="1">
				<tr>
					...
					<td width="25%" class="tdfont"><html:text name="NewDeptVisitFB"
					...
					<div id="commonReferExternal_associated" style="display:none"><html:select
						name="NewDeptVisitFB" tabindex="1"
					...
					<div id="commonReferExternal_other" style="display:none"><html:text
						name="NewDeptVisitFB" tabindex="1" property="patRefHospitalName"
					...
					<td width="25%" class="tdfont">
						<html:select name="NewDeptVisitFB" property="patRefGnctdHospitalDept" tabindex="1" styleClass="regCbo" onchange="checkReferDepartment(this)">
					...
					<td width="25%" class="tdfont">
					<html:text name="NewDeptVisitFB"  property="patRefHospitalDeptOther" maxlength="20"  tabindex="1" styleClass="textbox" disabled="true" onkeypress="return validateAlphabetsOnly(event,this)"/>
					</td>
					...
					<logic:iterate id="ARR_OPD_OPEN_EPISODE_VO"
						...
						<tr>
							...
							<div align="center"><bean:write name="ARR_OPD_OPEN_EPISODE_VO"
								...
								name="NewDeptVisitFB" property="fromDepartment"
...
<html:hidden name="NewDeptVisitFB" property="departmentdiv" />

<input type="hidden" name="crNo" />
<html:hidden name="NewDeptVisitFB" property="hmode" value="unspecified"/>
<html:hidden name="NewDeptVisitFB" property="patFirstName" />
<html:hidden name="NewDeptVisitFB" property="patMiddleName" />
<html:hidden name="NewDeptVisitFB" property="patLastName" />
<html:hidden name="NewDeptVisitFB" property="patGender" />           
<html:hidden name="NewDeptVisitFB" property="patAge" />
<html:hidden name="NewDeptVisitFB" property="patPrimaryCatCode" />
<html:hidden name="NewDeptVisitFB" property="patGuardianName" />
<html:hidden name="NewDeptVisitFB" property="patAmountCollected" />
<html:hidden name="NewDeptVisitFB" property="isPatReferByList" />
<html:hidden name="NewDeptVisitFB" property="selectedFromDept" />
<html:hidden name="NewDeptVisitFB" property="patBillAmountWithoutGrouping" />
<html:hidden name="NewDeptVisitFB" property="patCrNo" />
<html:hidden name="NewDeptVisitFB" property="referInternalExternal" />
<html:hidden name="NewDeptVisitFB" property="referingRowIndex" />
<html:hidden name="NewDeptVisitFB" property="onlineReferedIndex"/>
<html:hidden name="NewDeptVisitFB" property="errorMessage"/>
<html:hidden name="NewDeptVisitFB" property="entryDate"/>
<html:hidden name="NewDeptVisitFB" property="episodeVisitNo"/>

<html:hidden name="NewDeptVisitFB" property="captureMandatoryField"/>
