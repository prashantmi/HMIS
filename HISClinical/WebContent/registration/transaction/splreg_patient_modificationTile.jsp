...
<%@page import="registration.controller.fb.SplPatientModificationFB"%>
...
var isAddressDelhi = '<bean:write name="SplPatientModificationFB" property="isAddressDelhi"/>';
...
<!--<html:form action="/patientModification">-->
	...
	<his:InputCrNoTag name="SplPatientModificationFB">
	</his:InputCrNoTag>
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="0">
				<tr style="display:none">
					...
					<td width="17%" class="tdfont">
						<div align="left">
							<html:text name="SplPatientModificationFB" property="patPrimaryCat" tabindex="1" styleClass="regcbo" readonly="true"></html:text>
						</div>
					</td>
...
<!--							<html:text name="SplPatientModificationFB" property="patCardNo" styleClass="textbox" maxlength="30" tabindex="1" onkeypress="return validateAlphaNumericWithDotsOnly(event,this)" />-->
<!--							</div>-->
<!--					</td>-->
					...
					<td width="17%" class="tdfont">
						<div style="display: none" id="familyHeadTextDiv">
							<html:text name="SplPatientModificationFB" property="patNickName" tabindex="1" styleClass="textbox" maxlength="30" 
					...
					<td width="17%" class="tdfont" nowrap="nowrap">
						<div id="relationComboDiv" style="display: none;">
							<html:select name="SplPatientModificationFB" tabindex="2" property="patHusbandOccupation" styleClass="regcbo">
				...
				<tr>
					...
					<td width="17%" class="tdfont">
						<html:text name="SplPatientModificationFB" property="patFirstName" styleClass="textbox" tabindex="1"
						maxlength="30" onblur="(this,'First Name')" onkeypress="return validateAlphabetsWithDotsAndForwardSlashWithHypen(event,this)" />
					</td>
					<td width="18%" class="tdfonthead">
						<div align="left">
							<html:text name="SplPatientModificationFB" property="patMiddleName" tabindex="1" styleClass="textbox"
							onblur="isAlpha(this,'Middle Name')" maxlength="20" onkeypress="return validateAlphabetsWithDotsOnly(event,this)" 
							style="display:block" />
						</div>
					</td>
					<td class="tdfont">
						<html:text name="SplPatientModificationFB" property="patLastName" tabindex="1" styleClass="textbox"
					...
					<td class="tdfont">
						<html:select name="SplPatientModificationFB" property="patCasteCode" tabindex="1" styleClass="regcbo">
				...
				<tr>
					<td width="17%" nowrap class="tdfonthead">
						<div align="center">
							...
							<html:radio name="SplPatientModificationFB" property="isActualDob" tabindex="1" value="0" onclick="ageModificationSelection()" />
							<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
								<bean:message key="dob" />
							</font>
							<html:radio name="SplPatientModificationFB" property="isActualDob" tabindex="1" value="1" onclick="ageModificationSelection()" />
						</div>
					</td>
					
					<logic:empty name="SplPatientModificationFB" property="isActualDob">
						<%
								strdivage = "none";
								strdivdob = "none";
						%>
					</logic:empty>
					<logic:equal name="SplPatientModificationFB" property="isActualDob" value="1">
						<%
								strdivage = "none";
								strdivdob = "block";
						%>
					</logic:equal>
					<logic:equal name="SplPatientModificationFB" property="isActualDob" value="0">
						<%
								strdivage = "block";
								strdivdob = "none";
						%>
					...
					<td width="18%" nowrap="nowrap" class="tdfont">
						<div id="divAge" style='display: <%=strdivage%>'>
							<html:text name="SplPatientModificationFB" size="4" tabindex="1" property="patAge" maxlength="3" onkeypress="return validateNumeric(event)" />
							<html:select name="SplPatientModificationFB" property="patAgeUnit" tabindex="1" styleClass="smallcombo">
								<html:option value="-1">Select Value</html:option>
						...
						<div id="divDob" style='display: <%=strdivdob%>'>
							<bean:define name="SplPatientModificationFB" property="patDOB" id="dob" type="java.lang.String" />
					...
					<td width="17%" class="tdfont">
						<html:select name="SplPatientModificationFB" property="patGenderCode" tabindex="1" styleClass="regcbo">
							<html:option value="-1">Select Value</html:option>
					...
					<td width="17%" class="tdfont"><html:select
						name="SplPatientModificationFB" property="patMaritalStatusCode" 
				...
				<tr>
					...
					<td width="17%" class="tdfont">
						<html:text name="SplPatientModificationFB" property="patGuardianName" styleClass="textbox" tabindex="1"
					...
					<td class="tdfont" width="17%">
						<html:text name="SplPatientModificationFB" property="patHusbandName" tabindex="1" styleClass="textbox"
					...
					<td class="tdfont" width="17%">
						<html:text name="SplPatientModificationFB" property="patMotherName" tabindex="1" styleClass="textbox"
				...
				<tr>
					...
					<td class="tdfont" width="17%">
						<div id="patCountryCombo"><html:select name="SplPatientModificationFB" property="patNationalityCode" tabindex="1" styleClass="regcbo">
							<html:option value="-1">Select Value</html:option>
					...
					<td width="17%" class="tdfont">
						<html:select name="SplPatientModificationFB" property="patReligionCode" tabindex="1" styleClass="regcbo">
							<html:option value="">Select Value</html:option>
					...
					<td width="17%" class="tdfont"><html:text
						name="SplPatientModificationFB" property="patBirthPlace"
				...
				<tr>
					...
					<td width="17%" class="tdfont">
						<html:text name="SplPatientModificationFB" property="patNationalId" styleClass="textbox" maxlength="16"
					...
					<td width="17%" class="tdfont"><html:select
						name="SplPatientModificationFB" property="patDocType"
					...
					<td width="17%" class="tdfont"><html:text
						name="SplPatientModificationFB" property="patCardNo" styleClass="textbox" maxlength="11" onkeypress="return validateAlphaNumericWithSpecialCharacterOnly(this,event)"/></td>
				</tr>
				<tr>
					<td width="17%" class="LABEL"><bean:message key="patOccupation" /></td>
					<td width="17%" class="tdfont"><html:select
						name="SplPatientModificationFB" property="patOccupation"
					...
					<td width="17%" class="tdfont"><html:text
						name="SplPatientModificationFB" property="patMonthlyIncome"
					...
					<logic:iterate id="address" name="<%=RegistrationConfig.REGDESK_ADDRESSVO_ARR%>" type="hisglobal.vo.AddressVO">
						<tr>
							<td width="15%" Class="tdfonthead">
								<div align="left">
									<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
										<html:radio name="SplPatientModificationFB" property='patFBAddTypeCode' 
		...
		<logic:notEmpty name="SplPatientModificationFB" property="addModify">
		
			<bean:define name="SplPatientModificationFB" property="patFBAddTypeCode" id="typeCode" />
			<bean:define name="SplPatientModificationFB" property="hmode" id="hmode" />
			...
			<his:ContentTag>
				<table width="100%" cellpadding="0" cellspacing="1" border="0">
					<logic:equal name="SplPatientModificationFB" property="isAddressDelhi" value="0">
						<%
								divdisplay = "none";
								divnddisplay = "";
					...
					<logic:equal name="SplPatientModificationFB" property="isAddressDelhi" value="1">
						<%
								divdisplay = "";
								divnddisplay = "none";
					...
					<tr>
						...
						<td id="addTypeCombo" class="tdfont">
							<html:select tabindex="1" name="SplPatientModificationFB" property="patAddTypeCode" styleClass="regcbo">
								<html:option value="-1">Select Value</html:option>
						...
						<td id="addTypeText" class="tdfont">
							<html:text tabindex="1" name="SplPatientModificationFB" property="patAddTypeLable" maxlength="50" readonly="true" styleClass="textbox" />
						</td>
						...
						<td width="25%" class="tdfont">
							<html:text name="SplPatientModificationFB" tabindex="1" property="strPatAddressTehsil" maxlength="30"
					...
					<tr>
						...
						<td class="tdfont" width="25%">
							<div id="patCountryCombo">
								<html:select tabindex="1" name="SplPatientModificationFB" property="patAddCountryCode" onchange="showState();" styleClass="regcbo">
									<html:option value="-1">Select Value</html:option>
						...
						<td class="tdfont" width="25%">
							<div id="divpatAddStateCodeCombo" align="left">
								<html:select tabindex="1" name="SplPatientModificationFB" property="patAddStateCode"
							...
							<div id="divpatAddStateCodeText" style="" align="left">
								<html:text name="SplPatientModificationFB" tabindex="1" property="patAddStateName"
					...
					<tr>
						...
						<td class="tdfont">
							<div id="divpatAddCityLocCode">
								<html:select tabindex="1" name="SplPatientModificationFB" property="patAddCityLocCode" styleClass="regcbo"
							...
							<div id="divpatAddCityLocation">
								<html:text tabindex="2" name="SplPatientModificationFB" property="patAddCityLoc"
						...
						<td class="tdfont">
							<html:text tabindex="1" onkeypress="return validateAlphaNumericWithDotsOnly(event,this);" maxlength="15"
								name="SplPatientModificationFB" property="patAddHNo" styleClass="textbox" />
						</td>
					</tr>
					...
					<tr>
						...
						<td class="tdfont">
							<html:text tabindex="1" name="SplPatientModificationFB" property="patAddStreet"
						...
						<td class="tdfont">
							<div id="districtCombo" style='display: <%=divdisplay%>'>
								<html:select tabindex="1" name="SplPatientModificationFB" property="patAddDistrictCode" styleClass="regcbo">
									<html:option value="-1">Select Value</html:option>
							...
							<div id="districtTextBox" style='display: <%=divnddisplay%>'>
								<html:text tabindex="1" name="SplPatientModificationFB" property="patAddDistrict"
					...
					<tr>
						...
						<td class="tdfont">
							<html:text tabindex="1" name="SplPatientModificationFB" property="patAddCity" onblur="isAlpha(this,'City');"
								onkeypress="return validateAlphabetsWithDotsOnly(event,this);" maxlength="30" styleClass="textbox" />
						</td>
						<td class="tdfonthead">
							<div align="right"><font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
						...
						<td class="tdfont">
							<html:text tabindex="1" name="SplPatientModificationFB" property="patAddPIN" maxlength="6" styleClass="textbox"
					...
					<tr>
						...
						<td class="tdfont">
							<html:select tabindex="1" name="SplPatientModificationFB" property="patIsUrban" styleClass="regcbo">
								<html:option value="-1">Select Value</html:option>
						...
						<td class="tdfont">
							<html:text tabindex="1" name="SplPatientModificationFB" property="patAddContactNo" onkeypress="return validateNumeric(event);"
					...
					<tr>
						...
						<td class="tdfont">
							<html:text tabindex="1" name="SplPatientModificationFB" property="patAddMobileNo" onkeypress="return validateNumeric(event);"
						...
						<td class="tdfont">
							<html:text tabindex="1" name="SplPatientModificationFB" property="patAddFaxNo" onkeypress="return validateNumeric(event);"
								maxlength="30" styleClass="textbox" />
						</td>
					</tr>
					<tr>
						...
						<td class="tdfont">
							<html:text tabindex="1" name="SplPatientModificationFB" property="patAddEmailId" maxlength="50" styleClass="textbox"
		...
		<bean:define name="SplPatientModificationFB" property="arrSelectedVerifyDocs" id="arrVerificationDocs" type="java.lang.String[]" />

		<table width="100%" cellspacing="0" cellpadding="0" bgcolor="#EBEBEB" class="applicationBackgroundColor" style="clear: both; border-left: 1px solid #003366;">
			<tr>
				...
				<td width="70%" nowrap="nowrap" class="ShadedSubTitleTagImageBroad">
					<div align="left" class="TitleTagFontStyle" id="hiddenDivVerification">
						...
						<%	} else {	%>
							<logic:iterate name="SplPatientModificationFB" property="arrSelectedVerifyDocs" id="selectedVerifyDocs" type="java.lang.String">
		...
		<his:ContentTag>
			<table width="100%" cellspacing="1" cellpadding="0">
				<tr>
					...
					<td width="25%" class="tdfont">
						<div align="left">
							<html:select name="SplPatientModificationFB" property="requestBy" styleClass="regcbo" onchange="enableRelation()" tabindex="1">
								<html:option value="-1">Select Value</html:option>
								...
								<%
									String mlcNo = ((SplPatientModificationFB) pageContext .findAttribute("SplPatientModificationFB")) .getMlcNo();
					...
					<td width="25%" class="tdfont">
						<html:select name="SplPatientModificationFB" property="requestRelation" tabindex="1" styleClass="regcbo" tabindex="1">
							<html:option value="-1">Select Value</html:option>
			...
			<div id="requesterDIV">
				<table width="100%" cellspacing="1" cellpadding="0">
					<tr>
						...
						<td width="25%" class="tdfont">
							<!-- 18 -->
							<html:text name="SplPatientModificationFB" tabindex="1" property="requestByName" tabindex="1"
						...
						<td width="25%" class="tdfont">
							<!-- 3 -->
							<html:textarea name="SplPatientModificationFB" property="requestByAddress" tabindex="1"
			...
			<div id="policeDetailDiv">
				<table width="100%" cellspacing="1" cellpadding="0">
					<tr>
						...
						<td width="25%" class="tdfont">
							<html:text name="SplPatientModificationFB" property="constableDesig" styleClass="textbox" tabindex="1"
						...
						<td width="25%" class="tdfont">
							<html:text name="SplPatientModificationFB" property="constableBadgeNo" styleClass="textbox" tabindex="1"
								maxlength="50" onkeypress="return validateAlphaNumericWithDotsOnly(event,this)"></html:text>
						</td>
					</tr>
				</table>
	...
	<html:hidden name="SplPatientModificationFB" property="hmode" value="unspecified" />
	<html:hidden name="SplPatientModificationFB" property="patCrNo" />
	<html:hidden name="SplPatientModificationFB" property="addModify" />
	<html:hidden name="SplPatientModificationFB" property="patAddTypeCode" />
	<html:hidden name="SplPatientModificationFB" property="patPrimaryCatCode" />
	<html:hidden name="SplPatientModificationFB" property="isMLC" />
	<html:hidden name="SplPatientModificationFB" property="mlcNo" />
	<html:hidden name="SplPatientModificationFB" property="verificationDocumentAdded" />
	<html:hidden name="SplPatientModificationFB" property="patStatusCode" />
	<html:hidden name="SplPatientModificationFB" property="isNewImageUploaded"/>
	<html:hidden name="SplPatientModificationFB" property="sysDate" value="<%=currentDate%>" />
	<html:hidden name="SplPatientModificationFB" property="beforeModificationAge"/>
