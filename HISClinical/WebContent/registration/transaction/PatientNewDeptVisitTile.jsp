...
%>
<his:TitleTag name="New Department Visit">
...
<his:statusNew>
 ...
 <his:InputCrNoTag name="PatientVisitFB"></his:InputCrNoTag>
<bean:define id="crNo" name="PatientVisitFB" property="patCrNo"
				...
				<logic:iterate id="ARR_EPISODE_REFER_PAT_VO" indexId="index"
					...
					<tr>
						...
						<logic:equal name="ARR_EPISODE_REFER_PAT_VO" property="deptUnitIsClosed" value="<%=RegistrationConfig.DEPT_UNIT_IS_CLOSED_FALSE %>">
							...
							<html:radio
								name="PatientVisitFB" property="selectedReffereCrNo"
...
<logic:equal name="PatientVisitFB" property="modeCase"  value="1">
...
<td class="tdfont" width="25%"><b>
				...
				<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
					<logic:equal value="NEWDEPARTMENT" name="PatientVisitFB" property="selectedCheckBox">
					<input type="checkbox" name="newDepartmentVisit" onclick="document.getElementsByName('selectedCheckBox')[0].value='NEWDEPARTMENT';submitForm('NEWDEPARTMENTVISITDTL')" checked="checked"/>
					</logic:equal>
					<logic:notEqual value="NEWDEPARTMENT" name="PatientVisitFB" property="selectedCheckBox">
					<input type="checkbox" name="newDepartmentVisit" onclick="document.getElementsByName('selectedCheckBox')[0].value='NEWDEPARTMENT';submitForm('NEWDEPARTMENTVISITDTL')"/>
					</logic:notEqual>
...
<logic:equal name="PatientVisitFB" property="modeCase"  value="0">
<td class="tdfonthead" nowrap="nowrap" width="25%">
				<div align="right">
				<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">New Department Visit</font></div></td>
<td class="tdfont" width="25%"><b>
...
<td class="tdfont" width="25%"><b>
				...
				<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif"><input type="checkbox" name="oldDepartmentVisit" onclick="submitForm('OLDDEPARTMENTVISITDTL')" checked="checked"/></font></b></td>


</logic:equal>
<logic:equal name="PatientVisitFB" property="modeCase"  value="2">
<td class="tdfonthead" nowrap="nowrap" width="25%">
				<div align="right">
				<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">New Department Visit</font></div></td>
<td class="tdfont" width="25%"><b>
...
<td class="tdfont" width="25%"><b>				
				<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
				<logic:equal value="OLDDEPARTMENT" name="PatientVisitFB" property="selectedCheckBox">
				<input type="checkbox" name="oldDepartmentVisit" onclick="document.getElementsByName('selectedCheckBox')[0].value='OLDDEPARTMENT';submitForm('OLDDEPARTMENTVISITDTL')" checked="checked"/>
				</logic:equal>
				<logic:notEqual value="OLDDEPARTMENT" name="PatientVisitFB" property="selectedCheckBox">
				<input type="checkbox" name="oldDepartmentVisit" onclick="document.getElementsByName('selectedCheckBox')[0].value='OLDDEPARTMENT';submitForm('OLDDEPARTMENTVISITDTL')"/>
				</logic:notEqual>				
				</font></b></td>
	...
	<his:ContentTag>
		...
		<table width="100%" colspacing="1" colpadding="0">
			<tr>
				...
				<div align="left"><html:text name="PatientVisitFB" property="amount"
...
<his:statusTransactionInProcess>
	...
	<%String labelDepartment2 = "";
						...
						%>
	<logic:equal name="PatientVisitFB" property="isPatReferByList"
	...
	<%System.out.println("client name================================= "+fileId); %>
		...
		<his:ContentTag>
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%"
				bgcolor="#EBEBEB">
				<bean:define id="isRefer" name="PatientVisitFB"
				...
				<tr>
					...
					<div id="labelDepartment1" style="<%=labelDepartment12%>"
						align="left"><html:select name="PatientVisitFB"
					...
					<div id="controlDepartment1" style="<%=controlDepartment12%>" align="left">
						<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
							<bean:write name="PatientVisitFB" property="toDepartment" />
						</font>	
					</div>
					<html:hidden name="PatientVisitFB" property="toDepartmentCode"/>
					</td>
			<logic:equal name="fileId"
				value="<%=Config.FILE_NO_GENRATION_MANNUAL_TRUE%>">		
					...
					<div align="left"  ><font
						...
						name="PatientVisitFB" tabindex="1" property="fileNo"
					...
					<td width="16%" class="tdfont"><html:text name="PatientVisitFB"
...
<logic:notEqual name="PatientVisitFB" property="isPatReferByList" value="1" >	
...
<his:SubTitleTag name="Refer Details">
	<table width="100%" cellspacing="1" cellpadding="0">
	  <tr>
		...
		<td width="5%">
			<div align="left">
			<html:checkbox name="PatientVisitFB" property="isReferred" onclick="checkIsReferred(this)"
			...
			<table width="100%" cellspacing="1" cellpadding="0">
				<tr>
					...
					<div id="checkReferral" style="display:none"><font color="#FF0000"
						...
						color="#000000" size="2"
						face="Verdana, Arial, Helvetica, sans-serif"> <bean:message
						key="referInternal" /> </font> <html:radio name="PatientVisitFB"
						property="isRefferInOut" tabindex="1" value="I"
						onclick="showInternal(this)" /> <font color="#000000" size="2"
						face="Verdana, Arial, Helvetica, sans-serif"> <bean:message
						key="referExternal" /> </font> <html:radio name="PatientVisitFB"
					...
					<div id="externalRefer" style="display:none"><font color="#FF0000"
						...
						color="#000000" size="2"
						face="Verdana, Arial, Helvetica, sans-serif"> <bean:message
						key="gnctd" /> </font> <html:radio name="PatientVisitFB"
						property="referringInstType" tabindex="1" value="G"
						onclick="showAssociated(this)" /> <font color="#000000" size="2"
						face="Verdana, Arial, Helvetica, sans-serif"> <bean:message
						key="other" /> </font> <html:radio name="PatientVisitFB"
						property="referringInstType" value="O" tabindex="1"
						onclick="showOthers(this)" /> <html:hidden name="PatientVisitFB"
		...
		<div id="commonRefer" style="display:none"><his:ContentTag>
			...
			<table width="100%" cellspacing="1" cellpadding="1">
				<tr>
					...
					<td width="25%" class="tdfont"><html:text name="PatientVisitFB"
					...
					<div id="commonReferExternal_associated" style="display:none"><html:select
						name="PatientVisitFB" tabindex="1"
					...
					<div id="commonReferExternal_other" style="display:none"><html:text
						name="PatientVisitFB" tabindex="1" property="patRefHospitalName"
					...
					<td width="25%" class="tdfont">
						<html:select name="PatientVisitFB" property="patRefGnctdHospitalDept" tabindex="1" styleClass="regCbo" onchange="checkReferDepartment(this)">
					...
					<td width="25%" class="tdfont">
					<html:text name="PatientVisitFB"  property="patRefHospitalDeptOther" maxlength="20"  tabindex="1" styleClass="textbox" disabled="true" onkeypress="return validateAlphabetsOnly(event,this)"/>
					</td>
					...
					<logic:iterate id="ARR_OPD_OPEN_EPISODE_VO"
						...
						<tr>
							...
							<div align="center"><bean:write name="ARR_OPD_OPEN_EPISODE_VO"
								...
								name="PatientVisitFB" property="fromDepartment"
...
<!------button Toolbar Started---------------------------------- -->
		<table cellpadding="0" cellspacing="0" width="100%">
			<tbody>
				...
				<img class="button" src="/../HIS/hisglobal/images/buttons/btn-sv.png" tabindex="1"  style=cursor:pointer onkeypress="if(event.keyCode==13) submitFormOnValidate(if(document.getElementsByNam('')[0].value=='1'){ValidateDepartmentNewDeptVisit(document.getElementsByName('departmentsToVisitStamp')[0]);}else{ValidateDepartmentNewDeptVisit();},'CHECKMANDATORY');" onclick="submitFormOnValidate(if(document.getElementsByNam('')[0].value=='1'){ValidateDepartmentNewDeptVisit(document.getElementsByName('departmentsToVisitStamp')[0]);}else{ValidateDepartmentNewDeptVisit();},'CHECKMANDATORY');">
				 <img class="button" src="/../HIS/hisglobal/images/buttons/btn-ccl.png" tabindex="1"  style=cursor:pointer onkeypress="if(event.keyCode==13) submitPage('CANCEL');" tabindex="1" onclick ="submitPage('CANCEL');">
				 <img class="button" src="/../HIS/hisglobal/images/buttons/btn-clr.png" style=cursor:pointer tabindex="1"  onclick ="submitForm('NEW')" onkeypress="if(event.keyCode==13) submitForm('NEW');">
...
<html:hidden name="PatientVisitFB" property="departmentdiv" />

<input type="hidden" name="crNo" />
<html:hidden name="PatientVisitFB" property="hmode" value="unspecified"/>
<html:hidden name="PatientVisitFB" property="patFirstName" />
<html:hidden name="PatientVisitFB" property="patMiddleName" />
<html:hidden name="PatientVisitFB" property="patLastName" />
<html:hidden name="PatientVisitFB" property="patGender" />           
<html:hidden name="PatientVisitFB" property="patAge" />
<html:hidden name="PatientVisitFB" property="patPrimaryCatCode" />
<html:hidden name="PatientVisitFB" property="patGuardianName" />
<html:hidden name="PatientVisitFB" property="patAmountCollected" />
<html:hidden name="PatientVisitFB" property="isPatReferByList" />
<html:hidden name="PatientVisitFB" property="selectedFromDept" />
<html:hidden name="PatientVisitFB" property="patBillAmountWithoutGrouping" />
<html:hidden name="PatientVisitFB" property="patCrNo" />
<html:hidden name="PatientVisitFB" property="referInternalExternal" />
<html:hidden name="PatientVisitFB" property="referingRowIndex" />
<html:hidden name="PatientVisitFB" property="onlineReferedIndex"/>
<html:hidden name="PatientVisitFB" property="errorMessage"/>
<html:hidden name="PatientVisitFB" property="entryDate"/>
<html:hidden name="PatientVisitFB" property="episodeVisitNo"/>

<html:hidden name="PatientVisitFB" property="captureMandatoryField"/>
<html:hidden name="PatientVisitFB" property="modeCase" />
<html:hidden name="PatientVisitFB" property="selectedCheckBox" />
