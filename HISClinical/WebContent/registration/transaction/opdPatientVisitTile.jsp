				...
				<logic:iterate id="ARR_EPISODE_OLD_PAT_REFER_VO" name="<%=RegistrationConfig.ARR_EPISODE_OLD_PAT_REFER_VO %>" type="hisglobal.vo.EpisodeRefDtlVO" indexId="index">
					<tr>
						<td width="4%" class="tdfont">
							<div align="center">
								<font size="2">
									<html:radio name="PatientVisitFB" property="selectedRefCrNo" value='<%=index.toString()+"#O$"+ARR_EPISODE_OLD_PAT_REFER_VO.getPatCrNo() %>' onclick="showDetail(this)"></html:radio>
									<html:hidden name="PatientVisitFB" property="indexID"/>
								</font>
							</div>	
						</td>
...
<td class="tdfont" width="25%"><b>
				...
				<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
					<logic:equal value="On" name="PatientVisitFB" property="newDepartmentVisit">
					<input type="checkbox" name="newDepartmentVisit" onclick="checkuncheckNewDepartment(this)" checked="checked"/>
					</logic:equal>
					<logic:notEqual value="On" name="PatientVisitFB" property="newDepartmentVisit">
...
<td class="tdfont" width="25%"><b>
				...
				<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
					...
					<logic:equal value="On" name="PatientVisitFB" property="oldDepartmentVisit">
					<input type="checkbox" name="oldDepartmentVisit" onclick="checkuncheckOldDepartment(this)" checked="checked"/>
					</logic:equal>
						<logic:notEqual value="On" name="PatientVisitFB" property="oldDepartmentVisit">
		...
		<his:ContentTag>
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%"
				...
				<tr>
					...
					<html:hidden name="PatientVisitFB" property="departmentUnitCode"/>
					</div>
  			...
  			<% if(EPISODEVO.length!=0) {
  				...
  				<%varStatus="InProcess";%>
					...
					<table  width="100%" border="0" cellspacing="1" cellpadding="0">
									...
									<logic:equal name="episode" property="deptUnitIsOnDuty" value="<%=RegistrationConfig.DEPT_UNIT_IS_ON_DUTY_FALSE%>">
										...
										<logic:equal name="episode" property="isGeneral" value="<%=RegistrationConfig.UNIT_TYPE_GENERAL%>">
											...
											<logic:notEqual name="episode" property="isOtherUnitWorking" value="<%=RegistrationConfig.NO_DEPT_UNIT_WORKING_TRUE%>">
													<html:hidden name="PatientVisitFB" property="hiddenEpisode" />
													<div align="center">
						...
						<html:hidden name="PatientVisitFB" property="hcode" />						
					</table>
...
<div id="isRefferDiv" style="display: none;">
 <his:ContentTag>
	...
	<logic:notEqual name="PatientVisitFB" property="modeCase"  value="1">
	<his:SubTitleTag>
		<his:name>
		...
		<td width="70%"> </td>
			<td width="30%">
			<div align="right">
				<font color="#ffffff" size="2" face="Verdana, Arial, Helvetica, sans-serif">Show </font><img src='<his:path src="/hisglobal/images/arrow_down.gif"/>' onclick="showLegends();" onkeypress="if(event.keyCode==13) showLegends();">		<font color="#ffffff" size="2" face="Verdana, Arial, Helvetica, sans-serif">Hide	</font><img src='<his:path src="/hisglobal/images/arrow_up.gif"/>' onclick="showLegendsNone();" onkeypress="if(event.keyCode==13) showLegendsNone();">
			</div>
			</td>			
		</tr>
		</table>
...
<!------button Toolbar Started---------------------------------- -->
		<table cellpadding="0" cellspacing="0" width="100%">
			<tbody>
				...
				<logic:equal  name="PatientVisitFB"  property="newDepartmentVisit" value="On">
					<logic:equal  name="PatientVisitFB"  property="oldDepartmentVisit" value="">
				...
				<logic:equal  name="PatientVisitFB"  property="oldDepartmentVisit" value="On">
				<logic:equal  name="PatientVisitFB"  property="newDepartmentVisit" value="">
...
<html:hidden name="PatientVisitFB" property="onRequestVisit" />
...
<html:hidden name="PatientVisitFB" property="print" />
<html:hidden name="PatientVisitFB" property="saveSuccessful" />
<html:hidden name="PatientVisitFB" property="isPrintCard" />
<html:hidden name="PatientVisitFB" property="indexID" />
<html:hidden name="PatientVisitFB" property="selectedReferal" />
