...
{   
    if(obj.checked)
	{
		document.getElementsByName("patAmountCollected")[0].value="0";
...
{	
	...
	var toDeptCode=document.getElementsByName("departmentCode")[0].value;
	...
	if( ((toDeptCode!="") && (toDeptCode!="-1") ) && (isrefer==true) && (fromDeptCode!="") && (referInOut==true) )
	{
		...
		document.getElementsByName("entryDate")[0].value=document.getElementsByName("episodeDate")[refIndex].value;
...
{  //  alert("index "+index)
	if(document.getElementsByName("isReferred")[0]){
		...
		//alert("refer="+isRefInternalExternal)
...
// 	alert("fdfdfdfdf "+document.getElementsByName("isPatReferByList")[0].value)
		...
		getRefer();
		/*if(document.getElementsByName("isFree")[0]){
...
function ValidateDepartmentNewDeptVisit(field)
{
	...
	var isValid = true;
	var depCode=document.getElementsByName("departmentCode")[0].value;
...
//		alert("inside IF") 
	...
	if(isSelected(document.getElementsByName("departmentCode")[0],"Department") 
		...
		&& isSelected(document.getElementsByName("roomCode")[0],"Room")
...
//		alert('inside ValidateDepartmentNewDeptVisit....');
 ...
 // alert(isValid);               
	// alert(isValid)
	/*if(!validateOldRegDate(document.forms[0].isFree,document.forms[0].oldRegDate,document.forms[0].sysDate)){
		isValid=false
	}*/
	
	//comment to make the file no field mandatory
	//if(isValid && document.getElementsByName("fileNo")[0].value=="" && document.getElementsByName("isFree")[0].checked){
		//isValid=window.confirm("File No is Left Blank.\nDo you want to generate Automatically ?");
	//}
  	return isValid;
} 
...
%>
<his:TitleTag name="New Department Visit Room Wise">
...
<his:statusNew>
 ...
 <his:InputCrNoTag name="NewDeptVisitRoomWiseFB"></his:InputCrNoTag>
<bean:define id="crNo" name="NewDeptVisitRoomWiseFB" property="patCrNo"
				...
				<logic:iterate id="ARR_EPISODE_REFER_PAT_VO" indexId="index"
					...
					<tr>
						...
						<logic:equal name="ARR_EPISODE_REFER_PAT_VO" property="deptUnitIsClosed" value="<%=RegistrationConfig.DEPT_UNIT_IS_CLOSED_FALSE %>">
							...
							<html:radio
								name="NewDeptVisitRoomWiseFB" property="selectedReffereCrNo"
	...
	<his:ContentTag>
		...
		<table width="100%" colspacing="1" colpadding="0">
			<tr>
				...
				<div align="left"><html:text name="NewDeptVisitRoomWiseFB" property="amount"
...
<his:statusTransactionInProcess>
	...
	<%--<div align="right">
	 		<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
   			...
   			<html:checkbox tabindex="2" name="NewDeptVisitRoomWiseFB" property="isFree" tabindex="1" value="<%=RegistrationConfig.IS_FREE_TRUE%>" onclick="disableAmountCollection(this)"/>
   			</font>
   			</div>--%>
	</his:SubTitleTag>
	...
	<%String labelDepartment2 = "";
						...
						%>
	<logic:equal name="NewDeptVisitRoomWiseFB" property="isPatReferByList"
	...
	<bean:define id="fileId" name="<%=Config.FILE_NO_GENERATION_FLAG_NAME %>" />
		...
		<his:ContentTag>
			...
			<table border="0" cellpadding="0" cellspacing="1" width="100%">
				<bean:define id="isRefer" name="NewDeptVisitRoomWiseFB"
...
<tr>
				...
				<td width="25%" class="tdfont">
					<div id="labelDepartment1" style="<%=labelDepartment12%>"
						align="left">
					<html:select name="NewDeptVisitRoomWiseFB" 	property="departmentCode" onchange="getUnit(this),getBillAmountForGrouping('','')" styleClass="regcbo" tabindex="1"> 
						<html:option value="-1">Select Value</html:option>
					
					<logic:present name="<%=RegistrationConfig.REGISTRATIONDESK_OPTION_DEPARTMENT%>">
					...
					<div id="controlDepartment1" style="<%=controlDepartment12%>" align="left">
						<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
							<bean:write name="NewDeptVisitRoomWiseFB" property="toDepartment" />
						</font>	
					</div>
					<html:hidden name="NewDeptVisitRoomWiseFB" property="toDepartmentCode"/>
					</td>
			...
			<td width="17%" class="tdfont">
				<div align="left">
					<html:select name="NewDeptVisitRoomWiseFB" property="departmentUnitCode" tabindex="1" styleClass="regcbo" onchange="getRoom(this)">
					<html:option value="-1">Select Value</html:option>
		...
		<td width="17%" class="tdfont">
				<div align="left">
					<html:select name="NewDeptVisitRoomWiseFB" property="roomCode" tabindex="1" styleClass="regcbo">
					<html:option value="-1">Select Value</html:option>
		...
		<%--<logic:notEqual  name="confFlagId" value="<%=Config.FILE_NO_GENRATION_FALSE%>">
				...
				<div align="right" id="fileidControl"   ><font color="#000000" size="2"
					face="Verdana, Arial, Helvetica, sans-serif"><font color="#FF0000" size="1"
					face="Verdana, Arial, Helvetica, sans-serif">*</font>
					<bean:message key="fileNo" /> </font></div>
				</td>
				<td class="tdfont" width="17%">
				<div align="left" id="fileid"  ><html:text name="NewDeptVisitRoomWiseFB"
			...
			<logic:equal name="clientFlag" value="<%=Config.CLIENT_PGIMER %>">	
				...
				<div align="right" id="fileidControl"   ><font color="#000000" size="2"
					face="Verdana, Arial, Helvetica, sans-serif"> <bean:message
					key="prevCRNo" /> </font></div>
				</td>
				<td class="tdfont" width="17%">
				<div align="left" id="fileid"  ><html:text name="NewDeptVisitRoomWiseFB"
					property="oldCrNo" tabindex="1" maxlength="30" /></div></td>
			...
			<td width="17%" class="tdfonthead">
				...
				<td width="17%" class="tdfont">
					<div id="oldRegDateDiv" align="left" style="display: none;">
						...
						<bean:define name="NewDeptVisitRoomWiseFB" property="oldRegDate" id="regDate" type="java.lang.String" />
						<script type="text/javascript">DateValidator.setup("oldRegDateDiv","oldRegDate","<%=regDate%>","dd-MM-yyyy","textbox");</script>
					</div>	
				</td>--%>	
				
				<td width="17%" class="tdfonthead" colspan="5">
					<div align="right"><font color="#000000" size="2"
						face="Verdana, Arial, Helvetica, sans-serif"> <bean:message
				...
				<td width="17%" class="tdfont">
					<div align="left">
						...
						<html:text name="NewDeptVisitRoomWiseFB"
						tabindex="1" property="patAmountCollected" maxlength="6"
						styleClass="textbox" readonly="true" />
					</div>	
					</td>	
...
<logic:notEqual name="NewDeptVisitRoomWiseFB" property="isPatReferByList" value="1" >	
...
<his:SubTitleTag name="Refer Details">
	<table width="100%" cellspacing="1" cellpadding="0">
	  <tr>
		...
		<td width="5%">
			<div align="left">
			<html:checkbox name="NewDeptVisitRoomWiseFB" property="isReferred" onclick="checkIsReferred(this)"
			...
			<table width="100%" cellspacing="1" cellpadding="0">
				<tr>
					...
					<div id="checkReferral" style="display:none"><font color="#FF0000"
						...
						color="#000000" size="2"
						face="Verdana, Arial, Helvetica, sans-serif"> <bean:message
						key="referInternal" /> </font> <html:radio name="NewDeptVisitRoomWiseFB"
						property="isRefferInOut" tabindex="1" value="I"
						onclick="showInternal(this)" /> <font color="#000000" size="2"
						face="Verdana, Arial, Helvetica, sans-serif"> <bean:message
						key="referExternal" /> </font> <html:radio name="NewDeptVisitRoomWiseFB"
					...
					<div id="externalRefer" style="display:none"><font color="#FF0000"
						...
						color="#000000" size="2"
						face="Verdana, Arial, Helvetica, sans-serif"> <bean:message
						key="gnctd" /> </font> <html:radio name="NewDeptVisitRoomWiseFB"
						property="referringInstType" tabindex="1" value="G"
						onclick="showAssociated(this)" /> <font color="#000000" size="2"
						face="Verdana, Arial, Helvetica, sans-serif"> <bean:message
						key="other" /> </font> <html:radio name="NewDeptVisitRoomWiseFB"
						property="referringInstType" value="O" tabindex="1"
						onclick="showOthers(this)" /> <html:hidden name="NewDeptVisitRoomWiseFB"
		...
		<div id="commonRefer" style="display:none"><his:ContentTag>
			...
			<table width="100%" cellspacing="1" cellpadding="1">
				<tr>
					...
					<td width="25%" class="tdfont"><html:text name="NewDeptVisitRoomWiseFB"
					...
					<div id="commonReferExternal_associated" style="display:none"><html:select
						name="NewDeptVisitRoomWiseFB" tabindex="1"
					...
					<div id="commonReferExternal_other" style="display:none"><html:text
						name="NewDeptVisitRoomWiseFB" tabindex="1" property="patRefHospitalName"
					...
					<td width="25%" class="tdfont">
						<html:select name="NewDeptVisitRoomWiseFB" property="patRefGnctdHospitalDept" tabindex="1" styleClass="regCbo" onchange="checkReferDepartment(this)">
					...
					<td width="25%" class="tdfont">
					<html:text name="NewDeptVisitRoomWiseFB"  property="patRefHospitalDeptOther" maxlength="20"  tabindex="1" styleClass="textbox" disabled="true" onkeypress="return validateAlphabetsOnly(event,this)"/>
					</td>
				...
				<table width="100%" border="0" cellspacing="1" cellpadding="0">
					...
					<logic:iterate id="ARR_OPD_OPEN_EPISODE_VO"
						...
						<tr>
							...
							<html:hidden name="NewDeptVisitRoomWiseFB"
								property="episodeCode" value="<%=hh%>" />
							
							<td width="30%" class="tdfont">
							<div align="center"><bean:write name="ARR_OPD_OPEN_EPISODE_VO"
								property="fromDepartment" /> <html:hidden name="NewDeptVisitRoomWiseFB"
								property="fromDepartment" value="<%=strFrmDepCode%>" />
								<input type="hidden" name="episodeDate" value="<%=ARR_OPD_OPEN_EPISODE_VO.getEntryDate() %>"> </div>
							</td>
							...
							<div align="center"><bean:write name="ARR_OPD_OPEN_EPISODE_VO"
								...
								name="NewDeptVisitRoomWiseFB" property="fromDepartment"
...
<his:ButtonToolBarTag>
	...
	<div align="center"><img class="button"
		...
		tabindex="1" onclick="submitForm('RENEWAL');"
		onkeypress="if (event.keyCode==13) submitForm'RENEWAL');"> <img
	...
	<div align="center"><img class="button"
		...
		onkeypress="if(event.keyCode==13) submitFormOnValidate(ValidateDepartmentNewDeptVisit(document.getElementsByName('departmentsToVisitStamp')[0]),'CHECKMANDATORY');"
		onclick="submitFormOnValidate(ValidateDepartmentNewDeptVisit(document.getElementsByName('departmentsToVisitStamp')[0]),'CHECKMANDATORY');"
		style=cursor:pointer> <img class="button"
...
<html:hidden name="NewDeptVisitRoomWiseFB" property="departmentdiv" />

<input type="hidden" name="crNo" />
<input type="hidden" name="hmode" value="unspecified" />
<html:hidden name="NewDeptVisitRoomWiseFB" property="patFirstName" />
<html:hidden name="NewDeptVisitRoomWiseFB" property="patMiddleName" />
<html:hidden name="NewDeptVisitRoomWiseFB" property="patLastName" />
<html:hidden name="NewDeptVisitRoomWiseFB" property="patGender" />           
<html:hidden name="NewDeptVisitRoomWiseFB" property="patAge" />
<html:hidden name="NewDeptVisitRoomWiseFB" property="patAgeUnit" />
<html:hidden name="NewDeptVisitRoomWiseFB" property="patPrimaryCatCode" />
<html:hidden name="NewDeptVisitRoomWiseFB" property="patGuardianName" />
<html:hidden name="NewDeptVisitRoomWiseFB" property="isPatReferByList" />
<html:hidden name="NewDeptVisitRoomWiseFB" property="selectedFromDept" />
<html:hidden name="NewDeptVisitRoomWiseFB" property="patBillAmountWithoutGrouping" />
<html:hidden name="NewDeptVisitRoomWiseFB" property="patCrNo" />
<html:hidden name="NewDeptVisitRoomWiseFB" property="referInternalExternal" />
<html:hidden name="NewDeptVisitRoomWiseFB" property="referingRowIndex" />
<html:hidden name="NewDeptVisitRoomWiseFB" property="onlineReferedIndex"/>
<html:hidden name="NewDeptVisitRoomWiseFB" property="amountCollected"/>
<html:hidden name="NewDeptVisitRoomWiseFB" property="patOldRegExpires"/>
<html:hidden name="NewDeptVisitRoomWiseFB" property="errorMessage"/>
<html:hidden name="NewDeptVisitRoomWiseFB" property="entryDate"/>
<html:hidden name="NewDeptVisitRoomWiseFB" property="captureMandatoryField"/>
<html:hidden name="NewDeptVisitRoomWiseFB" property="print"/>
