...
var len;
	...
	if(isValid && isSelected(document.getElementsByName("roomCode")[0],"Room")){
		isValid=true;
	}
	else
		isValid=false
...
/*	alert("check on load");
	var refDtl=document.getElementsByName("isReferred")[0].value;
	alert("ref value"+refDtl);
	if(refDtl=="1"){
		document.getElementById("checkReferral").style.display="block";
	}
	else{
...
<his:TitleTag name="Room Wise Old Patient Visit">
...
<html:form action="oldPatientVisitRoomWise">	
<his:InputCrNoTag name="oldPatientVisitRoomWiseFB">
	
	</his:InputCrNoTag>
<bean:define id="crNo" name="oldPatientVisitRoomWiseFB" property="patCrNo" type="java.lang.String"/>
<his:statusList>
				...
				<logic:iterate id="ARR_EPISODE_OLD_PAT_REFER_VO" name="<%=RegistrationConfig.ARR_EPISODE_OLD_PAT_REFER_VO %>" type="hisglobal.vo.EpisodeRefDtlVO" indexId="index">
					<tr>
						<td width="4%" class="tdfont">
							<div align="center">
								<font size="2">
									<html:radio name="oldPatientVisitRoomWiseFB" property="selectedRefCrNo" 
										value='<%=index.toString()+"$"+ARR_EPISODE_OLD_PAT_REFER_VO.getPatCrNo() %>' onclick="showDetail(this)"></html:radio>
									<html:hidden name="oldPatientVisitRoomWiseFB" property="indexID"/>
								</font>
							</div>	
						</td>
		...
		<%if(Config.RENEWAL_TYPE.equals("1") || Config.RENEWAL_TYPE.equals("2")){ %>
			<table width="100%" colspacing="1" colpadding="0">
				<tr>
					...
					<div align="left"><html:text name="oldPatientVisitRoomWiseFB"
	  ...
	  <his:ContentTag>
  			<% if(EPISODEVO.length!=0) {System.out.println("length in jsp......................"+EPISODEVO.length); %><%varStatus="InProcess";%>
					...
					<table  width="100%" border="0" cellspacing="1" cellpadding="0">
						...
						%>
							<tr <%=backgroundColor %>>
								...
								<logic:equal name="episode"  property="visitedToday" value="<%=RegistrationConfig.DEPT_UNIT_VISITED_TODAY_TRUE %>">
									...
									<div align="center">
									<img src='<his:path src="/hisglobal/images/icn-lock.png"/>' title="Unit not on duty">
									</div>
								</logic:equal>
									...
									<logic:equal name="episode" property="deptUnitIsOnDuty" value="<%=RegistrationConfig.DEPT_UNIT_IS_ON_DUTY_FALSE%>">
										...
										<logic:notEqual name="episode" property="isOtherUnitWorking" value="<%=RegistrationConfig.NO_DEPT_UNIT_WORKING_TRUE%>">
											<logic:equal name="episode" property="renewalRequired" value="<%=RegistrationConfig.RENEWAL_REQUIRED_FALSE%>">
													<%System.out.println("hi..155."); %>
													<html:hidden name="oldPatientVisitRoomWiseFB" property="hiddenEpisode" />
													<div align="center">
														<img src='<his:path src="/hisglobal/images/stop.png"/>' title="Unit not on duty">
													</div>
											</logic:equal>
										...
										<logic:equal name="episode" property="isGeneral" value="<%=RegistrationConfig.UNIT_TYPE_GENERAL%>">
											<logic:equal name="episode" property="renewalRequired" value="<%=RegistrationConfig.RENEWAL_REQUIRED_TRUE%>">
													...
													<html:hidden name="oldPatientVisitRoomWiseFB" property="hiddenEpisode" />
													<div align="center">
														<img src='<his:path src="/hisglobal/images/stop.png"/>' title="Not Allowed" >
													</div>
											</logic:equal>
										</logic:equal>
									</logic:equal>
								...
								<!-- if no general unit of the department is working today -->
								<logic:equal name="episode"  property="visitedToday" value="<%=RegistrationConfig.DEPT_UNIT_VISITED_TODAY_FALSE %>">
									<logic:equal name="episode" property="deptUnitIsOnDuty" value="<%=RegistrationConfig.DEPT_UNIT_IS_ON_DUTY_FALSE%>">
									<logic:notEqual name="episode" property="isGeneral" value="<%=RegistrationConfig.UNIT_TYPE_SPECIALITY%>">
								...
								<logic:equal name="episode"  property="visitedToday" value="<%=RegistrationConfig.DEPT_UNIT_VISITED_TODAY_FALSE %>">
									...
									<% if(x==3 || x==4 || x==5){%>
											<logic:equal name="episode" property="renewalRequired" value="<%=RegistrationConfig.RENEWAL_REQUIRED_FALSE%>">
											<%System.out.println("hi..171... x= "+x); %>
											<div align="center">
											<html:radio tabindex="1" property="departmentsToVisitStamp" 
												value='<%=episode.getEpisodeCode()%>' onclick="checkForRefer(this)">
											</html:radio>
											</div>
											</logic:equal>
											<logic:equal name="episode" property="renewalRequired" value="<%=RegistrationConfig.RENEWAL_REQUIRED_TRUE%>">
											<%System.out.println("hi...175...x= "+x); %>
											<div align="center">
											<img src='<his:path src="/hisglobal/images/stop.png"/>' title="Renewal Required">
											</div>
											</logic:equal>
										<%} else { 
											//System.out.println("hi..219.....  "+x); %>
											<div align="center">
											<html:radio tabindex="1" property="departmentsToVisitStamp" 
												value='<bean:write name="episode" property="episodeCode"/>' onclick="checkForRefer(this)">
											</html:radio>
											</div>
										<%} %>
									</logic:equal>									
						...
						<html:hidden name="oldPatientVisitRoomWiseFB" property="hcode" />						
					</table>
...
<%} %>
			...
			<td class="tdfont" width="50%">
				<div align="left">
					<html:select property="roomCode" styleClass="regcbo" tabindex="1">
...
<%if(! (renewalStatus.equals("renew"))){ %>	
	<logic:notEqual name="oldPatientVisitRoomWiseFB" property="isPatReferByList" value="1" >	
	...
	<table width="100%" cellspacing="1" cellpadding="0">
	  <tr>
		...
		<td width="5%">
			<div align="left">
			<html:checkbox name="oldPatientVisitRoomWiseFB" property="isReferred" value="1"  onclick="getEpisodeRefDtl('EPISODEDTL',this)" onkeypress="if(event.keyCode==13) getEpisodeRefDtl('EPISODEDTL',this);" tabindex="1"/>
			</div>
		</td>
		</tr>
	 </table>	
		 ...
		 <bean:define name="oldPatientVisitRoomWiseFB" property="isReferred" id="isref" type="java.lang.String"/>            
 ...
 <table width="100%" cellspacing="1" cellpadding="0">
		...
		<div id="checkReferral" style="display:<%=divisrefdisplay%>">
			...
			<html:radio name="oldPatientVisitRoomWiseFB" property="isRefferInOut" tabindex="1" value="I" onclick="showInternal(this)" />
		
			<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
			<bean:message key="referExternal" />
			</font>
			<html:radio name="oldPatientVisitRoomWiseFB" property="isRefferInOut" tabindex="1" value="E" onclick="showExternal(this)" />
		</div>
		</td>
		<td width="40%">
			<div id="externalRefer" style="display:<%=externalReferdisplay%>">
				...
				<html:radio name="oldPatientVisitRoomWiseFB" property="referringInstType" tabindex="1" value="G" onclick="showAssociated(this)" />
				<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
				<bean:message key="other" />
				</font>
				<html:radio name="oldPatientVisitRoomWiseFB" property="referringInstType" value="O" tabindex="1" onclick="showOthers(this)" />
				<html:hidden name="oldPatientVisitRoomWiseFB" property="isAssociated" />
				</div>
		</td>
		</tr>
	</table>
	...
	<his:ContentTag>
		...
		<table width="100%" cellspacing="1" cellpadding="1">
			<tr>
				...
				<td width="25%" class="tdfont">
				<html:text name="oldPatientVisitRoomWiseFB" styleClass="textbox" maxlength="100" property="patRefDoctor" onblur="isAlpha(this,'Referred By Doctor')" tabindex="1" onkeypress="return validateAlphabetsOnly(event,this)" />
				</td>
				<td width="25%"  class="tdfonthead">
				...
				<html:select name="oldPatientVisitRoomWiseFB" tabindex="1" property="patRefGnctdHospitalCode" styleClass="regcbo">
				...
				<html:text  name="oldPatientVisitRoomWiseFB" tabindex="1" property="patRefHospitalName" onkeypress="return validateAlphabetsOnly(event)" maxlength="100" styleClass="textbox" size="20"/>
				</div>
				</td>
			</tr>
			 ...
			 <tr>
				...
				<td width="25%" class="tdfont">
					<html:select name="oldPatientVisitRoomWiseFB" property="patRefGnctdHospitalDept" tabindex="1" styleClass="regCbo" onchange="checkReferDepartment(this)">
				...
				<td width="25%" class="tdfonthead" >
					...
					<td width="25%" class="tdfont">
					<html:text name="oldPatientVisitRoomWiseFB"  property="patRefHospitalDeptOther" maxlength="20"  tabindex="1" styleClass="textbox" disabled="true"/>
					</td>
				</tr>
		...
		<table width="100%" cellspacing="1" cellpadding="1">
			<tr>
				...
				<td width="25%" %  class="tdfont">
				<html:text name="oldPatientVisitRoomWiseFB" tabindex="1" property="patRefGnctdHospitalCrno" maxlength="12" tabindex="1" onkeydown="setPrevValue(this, event);" onkeyup="moveToRight(this, event);" onkeypress="return validateNumeric(event)" styleClass="textbox" />
				</td>
			    <td width="25%" class="tdfonthead">
				<div align="right">
				<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
				...
				<td width="25%"  class="tdfont">
				<html:text name="oldPatientVisitRoomWiseFB" property="patRefGnctdHospitalDeptUnit" tabindex="1" maxlength="15" styleClass="textbox" />
				</td>
			</tr>
...
<%String strFrmDepUnitCode=(String)frmDepUnitCode; %>
							<tr>
								...
								<html:hidden
									name="oldPatientVisitRoomWiseFB" property="episodeCode"
									value="<%=hh%>"/>
								...
								<div align="center"><bean:write name="ARR_OPD_OPEN_EPISODE_VO"
									...
									<html:hidden
									name="oldPatientVisitRoomWiseFB" property="fromDepartment"
									value="<%=strFrmDepCode%>"/>
									</div>
								</td>
...
<html:hidden name="oldPatientVisitRoomWiseFB" property="isPatReferByList" />
<html:hidden name="oldPatientVisitRoomWiseFB" property="indexID" />
<html:hidden name="oldPatientVisitRoomWiseFB" property="onRequestVisit" />
<html:hidden name="oldPatientVisitRoomWiseFB" property="saveSuccessful" />
...
<%}catch(Exception e){System.out.println("exception in oldPatientVisitTile... "+e);} %>
