...
function ageWiseReportHandler(){
	       ...
	       if(document.getElementsByName('choice')[0].checked){
             document.getElementsByName('jrxmlName')[0].value="<%=RegistrationConfig.AGE_WISE_TODAY%>";
	          }
	        else{
	         document.getElementsByName('jrxmlName')[0].value="<%=RegistrationConfig.AGE_WISE_DATEWISE%>";         
	         }	   		
	   success=false;
	   if(validateGraphOrText()){ 
	       if(document.getElementsByName('graphOrText')[0].selectedIndex==1){
	          ...
	          if(validateTextual()){ 
	    //      alert("inside validate textual")     
	           	   if(validateTodayOrDate()){
	    //       	   alert("validateTodayOrDate returns true")
	           	  	return true;           	   
	           	   }          	  
                }
...
<his:TitleTag name="Age Wise Registration Report">
  ...
  <%
      ...
      <logic:equal name="ageWiseReportRegistrationFB" property="choice" value="<%=Config.CHOICE_TODAY%>">
      ...
      <logic:equal name="ageWiseReportRegistrationFB" property="choice" value="<%=Config.CHOICE_DATE_WISE%>">
        <% fromDateLabel="" ;
               toDateLabel="" ;
               fromDateControl="" ;
               toDateControl="" ;
	   ...
	   <bean:define name="ageWiseReportRegistrationFB" property="fromDate" id="frDate" type="java.lang.String"/>
	   <bean:define name="ageWiseReportRegistrationFB" property="toDate" id="tDate" type="java.lang.String"/>          
	   <%
...
<tr>            
 <td class="tdfonthead" nowrap width="25%">       	      
		      ...
		      <html:radio name="ageWiseReportRegistrationFB" property="choice" tabindex="1" value="<%=Config.CHOICE_TODAY%>" onclick="showdivtoday()"/> 
		         <font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
		       <bean:message key="dateWise"/></font> 
		        <html:radio name="ageWiseReportRegistrationFB" property="choice" tabindex="1" value="<%=Config.CHOICE_DATE_WISE%>" onclick="showdivdatewise()"/>
 </td>
 ...
 <td class="tdfont" width="25%">
	    <div id='divfromDateControl' style='<%=fromDateControl %>'align="left">	               		 
		 ...
		 <span id='divfromhrcontrol' style='<%=fromControl %>'align="left">	            
		   <html:text name="ageWiseReportRegistrationFB" tabindex="1" property="fromHour"  maxlength="2" size="3"  onkeydown="setPreviosValue(this, event)" onkeyup="moveToRightBox(this, event)" onkeypress="return validateNumeric(event)" />	
		   <b>	<bean:message key="colon"/></b>
		</span>
		 <span id='divfromMinControl' style='<%=fromControl %>' align="left">         
			<html:text name="ageWiseReportRegistrationFB" tabindex="1" property="fromMin"   maxlength="2" size="3" onkeydown="setPreviosValue(this, event)" onkeyup="moveToRightBox(this, event)" onkeypress="return validateNumeric(event)"/>				
 ...
 <td class="tdfont" width="25%">
		 <div id='divtoDateControl' style='<%=toDateControl %>' align="left">    
    	  ...
    	  <span id='divtohrcontrol' style='<%=toControl%>' align="left">	            
		   <html:text name="ageWiseReportRegistrationFB" tabindex="1" property="toHour"  maxlength="2" size="3" onkeydown="setPreviosValue(this, event)" onkeyup="moveToRightBox(this, event)" onkeypress="return validateNumeric(event)"/>	
		   	<b><bean:message key="colon"/>	  </b>
		</span>
		 <span id='divtoMinControl' style='<%=toControl%>' align="left">         
			<html:text name="ageWiseReportRegistrationFB" tabindex="1" property="toMin" maxlength="2" size="3"  onkeydown="setPreviosValue(this, event)" onkeyup="moveToRightBox(this, event)" onkeypress="return validateNumeric(event)"/>				
				<bean:message key="timeFormat"/>	  
    	 </span>
 </td>                 			
</tr>
   ...
   <table width="100%" cellspacing="1" cellpadding="0">
       <tr>       
        ...
        <td width="25%" class="tdfont" > 
	        <html:select name="ageWiseReportRegistrationFB"  property="graphOrText" tabindex="1" styleClass="regcbo" onchange='showpdfrtfdiv()'>
        ...
        <logic:equal name="ageWiseReportRegistrationFB" property="graphOrText" value="<%=Config.TEXT%>">
           <%
             pdfrtflabel="" ;
             pdfrtfcontrol="" ;
        ...
        <logic:equal name="ageWiseReportRegistrationFB" property="graphOrText" value="<%=Config.GRAPH%>">
           <%
	   ...
	   <td class="tdfont" nowrap width="25%">       
		      ...
		      <font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
			     <html:select name="ageWiseReportRegistrationFB"  property="reportType" tabindex="1" styleClass="regcbo">
		        <html:option value="-1">Select Value</html:option>
		      ...
		      <font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
			     <html:select name="ageWiseReportRegistrationFB"  property="chartType" tabindex="1" styleClass="regcbo">
		        <html:option value="-1">Select Value</html:option>
	  ...
	  <tr>
       ...
       <td width="25%" class="tdfont">
	       <html:select name="ageWiseReportRegistrationFB" property="patGenderCode" tabindex="1" styleClass="regcbo">
	       <html:option value="-1">Select Value</html:option>
       ...
       <div id="deptControl" align="left"  style='<%=deptcontrol%>'>
     		 <html:select name="ageWiseReportRegistrationFB"  property="departmentCode"  tabindex="1"  styleClass ="regcbo" >   
					  <html:option value="-1">Select Value</html:option>
	  ...
	  <tr>
        ...
        <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"> 
          <html:select name="ageWiseReportRegistrationFB"  property="patPrimaryCatCode"  tabindex="1"  styleClass ="regcbo" >   
		  <html:option value="-1">Select Value</html:option>
...
<html:hidden name="ageWiseReportRegistrationFB" property="jrxmlPath" value="<%=RegistrationConfig.REGISTRATION_JRXML_PATH %>"/>
<html:hidden name="ageWiseReportRegistrationFB" property="jrxmlName"/>
<html:hidden name="ageWiseReportRegistrationFB" property="sysDate" value="<%=tDate%>"/>
<%
