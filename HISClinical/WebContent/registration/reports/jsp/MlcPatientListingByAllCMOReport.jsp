...
function mlcPatientListingByAllCmoReportHandler()
{
	if(document.getElementsByName('choice')[0].checked)
	{
    	document.getElementsByName('jrxmlName')[0].value="<%=RegistrationConfig.MLC_PATIENT_LISTING_BY_ALL_CMO_REPORT_TODAY%>";
	}
	else 
	{
		document.getElementsByName('jrxmlName')[0].value="<%=RegistrationConfig.MLC_PATIENT_LISTING_BY_ALL_CMO_REPORT_DATEWISE%>";         
	}	
	success=false;
...
<his:TitleTag name="Mlc Patient Listing By All CMO Report">
</his:TitleTag>
	<%
		String pdfrtflabel="" ;
...
<html:hidden name="emergencyFB" property="mode" value="MLCPATIENTLISTINGBYALLCMOREPORT"/>
