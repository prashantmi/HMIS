...
function emergencyReportHandler()
{
	if(document.getElementsByName('choice')[0].checked)
	{
    	document.getElementsByName('jrxmlName')[0].value="<%=RegistrationConfig.EMERGENCY_PATIENT_LIST_TODAY%>";
	}
	else 
	{
		document.getElementsByName('jrxmlName')[0].value="<%=RegistrationConfig.EMERGENCY_PATIENT_LIST_DATEWISE%>";         
	}	
	success=false;
...
<his:TitleTag name="Listing of Emergency Patient">
</his:TitleTag>
	<%
		String pdfrtflabel="" ;
    ...
    <tr>            
 	...
 	<tr>
		<td class="tdfonthead" width="25%">
			<div id="emergencyLabel" align="right" style='<%=emergencylabel%>'>
				<font color="#FF0000" size="1" face="Verdana, Arial, Helvetica, sans-serif">*</font>
	         	<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
	         	<bean:message key="emergencyType"/>
	         	</font>
			</div>
		</td>
		<td class="tdfont" width="25%">
		<div id="emergencyControl" align="left" style='<%=emergencycontrol%>'/>
			<html:select name="emergencyFB"  property="emergencyType"  tabindex="1"  styleClass ="regcbo" >   
		  		<html:option value="%">ALL TYPE</html:option>
...
<html:hidden name="emergencyFB" property="mode" value="EMERGENCYREPORT"/>
