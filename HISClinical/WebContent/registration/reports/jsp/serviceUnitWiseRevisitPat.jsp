...
function serviceUnitWiseRevisitPatReportHandler()
{
	...
	{
    	document.getElementsByName('jrxmlName')[0].value="<%=RegistrationConfig.SERVICE_UNIT_WISE_REVISIT_PATIENT_TODAY%>";
	}
	else
	{
		document.getElementsByName('jrxmlName')[0].value="<%=RegistrationConfig.SERVICE_UNIT_WISE_REVISIT_PATIENT_DATEWISE%>";         
	}
	success=false;
...
<html:hidden name="serviceUnitWiseRevisitPatFB" property="jrxmlPath" value="<%=RegistrationConfig.REGISTRATION_JRXML_PATH %>"/>
