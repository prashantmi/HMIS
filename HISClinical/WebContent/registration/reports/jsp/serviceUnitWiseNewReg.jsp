...
function serviceUnitWiseNewRegReportHandler()
{
	...
	{
    	document.getElementsByName('jrxmlName')[0].value="<%=RegistrationConfig.SERVICE_UNIT_WISE_NEW_REG_TODAY%>";
	}
	else
	{
		document.getElementsByName('jrxmlName')[0].value="<%=RegistrationConfig.SERVICE_UNIT_WISE_NEW_REG_DATEWISE%>";         
	}
	success=false;
...
<html:hidden name="serviceUnitWiseNewRegFB" property="jrxmlPath" value="<%=RegistrationConfig.REGISTRATION_JRXML_PATH %>"/>
