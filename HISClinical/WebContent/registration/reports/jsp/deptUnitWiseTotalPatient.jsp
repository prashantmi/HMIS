...
function deptUnitWiseTotalPatientReportHandler()
{
	if(document.getElementsByName('choice')[0].checked)
	{
    	document.getElementsByName('jrxmlName')[0].value="<%=RegistrationConfig.DEPT_UNIT_WISE_TOTAL_PATIENT_STATISTICS_TODAY%>";
	}
	else
	{
		document.getElementsByName('jrxmlName')[0].value="<%=RegistrationConfig.DEPT_UNIT_WISE_TOTAL_PATIENT_STATISTICS_DATEWISE%>";         
	}
	success=false;
...
<his:TitleTag name="Department Unit Wise Total Patient Statistics">
</his:TitleTag>
...
<logic:equal name="deptUnitWiseTotalPatientFB" property="choice" value="<%=Config.CHOICE_TODAY%>">
             <%
...
<logic:equal name="deptUnitWiseTotalPatientFB" property="choice" value="<%=Config.CHOICE_DATE_WISE%>">
        <%     
        	   fromDateLabel="" ;
               toDateLabel="" ;
               fromDateControl="" ;
      ...
      <bean:define name="deptUnitWiseTotalPatientFB" property="fromDate" id="frDate" type="java.lang.String"/>
	   <bean:define name="deptUnitWiseTotalPatientFB" property="toDate" id="tDate" type="java.lang.String"/>          
	   <%
		...
		<tr>            
 			<td class="tdfonthead" nowrap width="25%">       	      
		    	<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
		      		...
		      		<html:radio name="deptUnitWiseTotalPatientFB" property="choice" tabindex="1" value="<%=Config.CHOICE_TODAY%>" onclick="showdivtoday()"/>
		        <font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
		       		<bean:message key="dateWise"/>
		       	</font> 
		        	<html:radio name="deptUnitWiseTotalPatientFB" property="choice" tabindex="1" value="<%=Config.CHOICE_DATE_WISE%>" onclick="showdivdatewise()"/>
			</td> 
 		</tr>
 		<tr>
			...
			<td class="tdfont" width="25%">
	    		<div id='divfromDateControl' style='<%=fromDateControl %>'align="left">	               		 
		 		...
		 		<span id='divfromhrcontrol' style='<%=fromControl %>'align="left">	            
		   			<html:text name="deptUnitWiseTotalPatientFB" tabindex="1" property="fromHour"  maxlength="2" size="3"  onkeydown="setPreviosValue(this, event)" onkeyup="moveToRightBox(this, event)" onkeypress="return validateNumeric(event)" />	
		  			 <b>	<bean:message key="colon"/></b>
				</span>
		 		<span id='divfromMinControl' style='<%=fromControl %>' align="left">         
					<html:text name="deptUnitWiseTotalPatientFB" tabindex="1" property="fromMin"   maxlength="2" size="3" onkeydown="setPreviosValue(this, event)" onkeyup="moveToRightBox(this, event)" onkeypress="return validateNumeric(event)"/>				
			...
			<td class="tdfont" width="25%">
		 		<div id='divtoDateControl' style='<%=toDateControl %>' align="left">    
    	  		...
    	  		<span id='divtohrcontrol' style='<%=toControl%>' align="left">	            
		   			<html:text name="deptUnitWiseTotalPatientFB" tabindex="1" property="toHour"  maxlength="2" size="3" onkeydown="setPreviosValue(this, event)" onkeyup="moveToRightBox(this, event)" onkeypress="return validateNumeric(event)"/>	
	   				<b><bean:message key="colon"/>	  </b>
				</span>
		 		<span id='divtoMinControl' style='<%=toControl%>' align="left">         
					<html:text name="deptUnitWiseTotalPatientFB" tabindex="1" property="toMin" maxlength="2" size="3"  onkeydown="setPreviosValue(this, event)" onkeyup="moveToRightBox(this, event)" onkeypress="return validateNumeric(event)"/>				
						<bean:message key="timeFormat"/>	  
    	 		</span>
			</td>                 			
 		</tr>
 		<tr>
    		...
    		<td class="tdfont">
       			<div id="deptControl" align="left"  style='<%=deptcontrol%>'>
     		 		<html:select name="deptUnitWiseTotalPatientFB"  property="departmentCode"  tabindex="1"  styleClass ="regcbo" onchange="showUnit()">   
...
<his:statusTransactionInProcess>
    		...
    		<td class="tdfont">
    			<div id="unitControl" align="left" >
    				<html:select name="deptUnitWiseTotalPatientFB"  property="unit"  tabindex="1"  styleClass ="regcbo" >
	...
	<table width="100%" cellspacing="1" cellpadding="0">
    	<tr>       
        	...
        	<td width="25%" class="tdfont" > 
	        	<html:select name="deptUnitWiseTotalPatientFB"  property="graphOrText" tabindex="1" styleClass="regcbo" >
		        	<html:option value="-1">Select Value</html:option>
        	...
        	<td width="25%" class="tdfont">
        		<html:select name="deptUnitWiseTotalPatientFB" property="reportType" tabindex="1" styleClass="regcbo">
					<html:option value="-1">Select Value</html:option>        	
...
<input type="hidden"  name="mode" value="DEPTUNITWISETOTALPATIENTREPORT">
<html:hidden name="deptUnitWiseTotalPatientFB" property="jrxmlPath" value="<%=RegistrationConfig.REGISTRATION_JRXML_PATH %>"/>
<html:hidden name="deptUnitWiseTotalPatientFB" property="jrxmlName"/>
<html:hidden name="deptUnitWiseTotalPatientFB" property="sysDate" value="<%=tDate%>"/>
