...
function serviceUnitWiseRevisitPatReportHandler()
{
	if(document.getElementsByName('choice')[0].checked)
	{
    	document.getElementsByName('jrxmlName')[0].value="<%=RegistrationConfig.SERVICE_UNIT_WISE_REVISIT_PATIENT_TODAY_REPORT1%>";
	}
	else
	{
		document.getElementsByName('jrxmlName')[0].value="<%=RegistrationConfig.SERVICE_UNIT_WISE_REVISIT_PATIENT_DATEWISE_REPORT1%>";         
	}
	success=false;
    ...
    { 
	  ...
	  return success;
}//end of function serviceUnitWiseNewRegReportHandler() 
		
</script>

<his:TitleTag name="Service Unit Wise Revisit Patients" >
</his:TitleTag>
         ...
         <%
              ...
              String toControl="" ; 
         %>
          <logic:equal name="serviceUnitWiseRevisitPatFB" property="choice" value="<%=Config.CHOICE_TODAY%>">
             <%
      ...
      <logic:equal name="serviceUnitWiseRevisitPatFB" property="choice" value="<%=Config.CHOICE_DATE_WISE%>">
        <%     fromDateLabel="" ;
               toDateLabel="" ;
               fromDateControl="" ;
               toDateControl="" ;
       ...
       <bean:define name="serviceUnitWiseRevisitPatFB" property="fromDate" id="frDate" type="java.lang.String"/>
	   <bean:define name="serviceUnitWiseRevisitPatFB" property="toDate" id="tDate" type="java.lang.String"/>          
	   <%
...
<his:ContentTag>	
	<table width="100% cellspacing="1" cellpadding="0">
		<tr>            
 			<td class="tdfonthead" nowrap width="25%">       	      
		    	<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
		      		...
		      		<html:radio name="serviceUnitWiseRevisitPatFB" property="choice" tabindex="1" value="<%=Config.CHOICE_TODAY%>" onclick="showdivtoday()"/> 
		        <font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
		       		<bean:message key="dateWise"/></font> 
		        	<html:radio name="serviceUnitWiseRevisitPatFB" property="choice" tabindex="1" value="<%=Config.CHOICE_DATE_WISE%>" onclick="showdivdatewise()"/>
			</td> 
 			...
 			<td class="tdfont" width="25%">
	    		<div id='divfromDateControl' style='<%=fromDateControl %>'align="left">	               		 
		 		...
		 		<span id='divfromhrcontrol' style='<%=fromControl %>'align="left">	            
		   			<html:text name="serviceUnitWiseRevisitPatFB" tabindex="1" property="fromHour"  maxlength="2" size="3"  onkeydown="setPreviosValue(this, event)" onkeyup="moveToRightBox(this, event)" onkeypress="return validateNumeric(event)" />	
		  			 <b>	<bean:message key="colon"/></b>
				</span>
		 		<span id='divfromMinControl' style='<%=fromControl %>' align="left">         
					<html:text name="serviceUnitWiseRevisitPatFB" tabindex="1" property="fromMin"   maxlength="2" size="3" onkeydown="setPreviosValue(this, event)" onkeyup="moveToRightBox(this, event)" onkeypress="return validateNumeric(event)"/>				
			...
			<td class="tdfont" width="25%">
		 		<div id='divtoDateControl' style='<%=toDateControl %>' align="left">    
    	  		...
    	  		<span id='divtohrcontrol' style='<%=toControl%>' align="left">	            
		   			<html:text name="serviceUnitWiseRevisitPatFB" tabindex="1" property="toHour"  maxlength="2" size="3" onkeydown="setPreviosValue(this, event)" onkeyup="moveToRightBox(this, event)" onkeypress="return validateNumeric(event)"/>	
	   				<b><bean:message key="colon"/>	  </b>
				</span>
		 		<span id='divtoMinControl' style='<%=toControl%>' align="left">         
					<html:text name="serviceUnitWiseRevisitPatFB" tabindex="1" property="toMin" maxlength="2" size="3"  onkeydown="setPreviosValue(this, event)" onkeyup="moveToRightBox(this, event)" onkeypress="return validateNumeric(event)"/>				
						<bean:message key="timeFormat"/>	  
    	 		</span>
			</td>                 			
		</tr>
		<tr>
			...
			<td class="tdfont" width="25%">
				<div align="left">
     		 		<html:select name="serviceUnitWiseRevisitPatFB"  property="unit"  tabindex="1"  styleClass ="regcbo">   
					  <html:option value="%">All Unit</html:option>
					<logic:present name="<%=RegistrationConfig.ESSENTIALBO_OPTION_ALL_UNIT%>">
					  <html:options collection ="<%=RegistrationConfig.ESSENTIALBO_OPTION_ALL_UNIT%>" property = "value" labelProperty = "label"/>
			  		</logic:present>
			  		</html:select> 
	   			</div>   
			</td>
	...
	<table width="100%" cellspacing="1" cellpadding="0">
    	<tr>       
        	...
        	<td width="25%" class="tdfont" > 
	        	<html:select name="serviceUnitWiseRevisitPatFB"  property="graphOrText" tabindex="1" styleClass="regcbo" >
        	...
        	<td width="25%" class="tdfont">
        		<html:select name="serviceUnitWiseRevisitPatFB" property="reportType" tabindex="1" styleClass="regcbo">
					<html:option value="-1">Select Value</html:option>        	
...
<input type="hidden"  name="mode" value="SERVICEUNITWISEREVISITPATREPORT">
<html:hidden name="serviceUnitWiseRevisitPatFB" property="jrxmlPath" value="<%=RegistrationConfig.REGISTRATION_JRXML_PATH_REPORT1 %>"/>
<html:hidden name="serviceUnitWiseRevisitPatFB" property="jrxmlName"/>
<html:hidden name="serviceUnitWiseRevisitPatFB" property="sysDate" value="<%=tDate%>"/>
