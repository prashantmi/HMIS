...
function hospitalWisePatientListingReportHandler()
{
	
	var jrxmlName="";
  
   	jrxmlName="<%=RegistrationConfig.HOSPITAL_WISE_PATIENT_LISTING_REPORT%>";
  	if(document.getElementsByName("hospitalCode")[0].value=="%"){
		jrxmlName="<%=RegistrationConfig.ALL_HOSPITAL_PATIENT_LISTING_REPORT%>";
	}		
	...
	return success;
}//end of function hospitalWisePatListingFB() 
...
<%
		...
		String toControl = "";
%>
<logic:equal name="hospitalWisePatListingFB" property="choice"
...
<bean:define name="hospitalWisePatListingFB" property="fromDate"
	id="frDate" type="java.lang.String" />
<bean:define name="hospitalWisePatListingFB" property="toDate"
...
<his:ContentTag>
	...
	<table width="100%" cellspacing="1" cellpadding="0">
		...
		<tr>
			...
			<html:select name="hospitalWisePatListingFB" property="hospitalCode" tabindex="1" styleClass="regcbo" > 
				<logic:present
	...
	<table width="100%" cellspacing="1" cellpadding="0">
		<tr>
			...
			<td width="25%" class="tdfont"><html:select
				name="hospitalWisePatListingFB" property="graphOrText"
			...
			<td width="25%" class="tdfont"><html:select
				name="hospitalWisePatListingFB" property="reportType"
				tabindex="1" styleClass="regcbo">
				<html:option value="-1">Select Value</html:option>
...
<input type="hidden" name="mode" value="HOSPITALWISEPATLIST">

<html:hidden name="hospitalWisePatListingFB"
	property="jrxmlPath"
	value="<%=RegistrationConfig.REGISTRATION_JRXML_PATH_REPORT1 %>" />
<html:hidden name="hospitalWisePatListingFB"
	property="jrxmlName" />
<html:hidden name="hospitalWisePatListingFB" property="sysDate"	value="<%=tDate%>" />
</body>
<%
		} catch (Exception e) {
		e.printStackTrace();
