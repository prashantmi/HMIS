...
function deptUnitWiseCashCollectionReportHandler()
{
	...
	{
    	document.getElementsByName('jrxmlName')[0].value="<%=RegistrationConfig.FEES_COLLECTED_FOR_OPD_SPECIAL_CLINIC_TODAY%>";
	}
	else
	{
		document.getElementsByName('jrxmlName')[0].value="<%=RegistrationConfig.FEES_COLLECTED_FOR_OPD_SPECIAL_CLINIC_DATEWISE%>";         
	}
	success=false;
...
<logic:equal name="feesCollectedForOpdSpecialClinicFB" property="choice" value="<%=Config.CHOICE_TODAY%>">
             <%
...
<logic:equal name="feesCollectedForOpdSpecialClinicFB" property="choice" value="<%=Config.CHOICE_DATE_WISE%>">
        <%     
        	   fromDateLabel="" ;
               toDateLabel="" ;
               fromDateControl="" ;
      ...
      <bean:define name="feesCollectedForOpdSpecialClinicFB" property="fromDate" id="frDate" type="java.lang.String"/>
	   <bean:define name="feesCollectedForOpdSpecialClinicFB" property="toDate" id="tDate" type="java.lang.String"/>          
	   <%
		...
		<tr>            
 			<td class="tdfonthead" nowrap width="25%">       	      
		    	<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
		      		...
		      		<html:radio name="feesCollectedForOpdSpecialClinicFB" property="choice" tabindex="1" value="<%=Config.CHOICE_TODAY%>" onclick="showdivtoday()"/>
		        <font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
		       		<bean:message key="dateWise"/>
		       	</font> 
		        	<html:radio name="feesCollectedForOpdSpecialClinicFB" property="choice" tabindex="1" value="<%=Config.CHOICE_DATE_WISE%>" onclick="showdivdatewise()"/>
			</td> 
			...
			<td class="tdfont" width="25%">
	    		<div id='divfromDateControl' style='<%=fromDateControl %>'align="left">	               		 
		 		...
		 		<span id='divfromhrcontrol' style='<%=fromControl %>'align="left">	            
		   			<html:text name="feesCollectedForOpdSpecialClinicFB" tabindex="1" property="fromHour"  maxlength="2" size="3"  onkeydown="setPreviosValue(this, event)" onkeyup="moveToRightBox(this, event)" onkeypress="return validateNumeric(event)" />	
		  			 <b>	<bean:message key="colon"/></b>
				</span>
		 		<span id='divfromMinControl' style='<%=fromControl %>' align="left">         
					<html:text name="feesCollectedForOpdSpecialClinicFB" tabindex="1" property="fromMin"   maxlength="2" size="3" onkeydown="setPreviosValue(this, event)" onkeyup="moveToRightBox(this, event)" onkeypress="return validateNumeric(event)"/>				
			...
			<td class="tdfont" width="25%">
		 		<div id='divtoDateControl' style='<%=toDateControl %>' align="left">    
    	  		...
    	  		<span id='divtohrcontrol' style='<%=toControl%>' align="left">	            
		   			<html:text name="feesCollectedForOpdSpecialClinicFB" tabindex="1" property="toHour"  maxlength="2" size="3" onkeydown="setPreviosValue(this, event)" onkeyup="moveToRightBox(this, event)" onkeypress="return validateNumeric(event)"/>	
	   				<b><bean:message key="colon"/>	  </b>
				</span>
		 		<span id='divtoMinControl' style='<%=toControl%>' align="left">         
					<html:text name="feesCollectedForOpdSpecialClinicFB" tabindex="1" property="toMin" maxlength="2" size="3"  onkeydown="setPreviosValue(this, event)" onkeyup="moveToRightBox(this, event)" onkeypress="return validateNumeric(event)"/>				
						<bean:message key="timeFormat"/>	  
    	 		</span>
			</td>                 			
 		</tr>
 		<tr>
    		...
    		<td class="tdfont">
       			<div id="deptControl" align="left"  style='<%=deptcontrol%>'>
     		 		<html:select name="feesCollectedForOpdSpecialClinicFB"  property="departmentCode"  tabindex="1"  styleClass ="regcbo" onchange="showUnit()">   
...
<his:statusTransactionInProcess>
    		...
    		<td class="tdfont">
    			<div id="unitControl" align="left" >
    				<html:select name="feesCollectedForOpdSpecialClinicFB"  property="unit"  tabindex="1"  styleClass ="regcbo" >
	...
	<table width="100%" cellspacing="1" cellpadding="0">
    	<tr>       
        	...
        	<td width="25%" class="tdfont" > 
	        	<html:select name="feesCollectedForOpdSpecialClinicFB"  property="graphOrText" tabindex="1" styleClass="regcbo" >
		        	<html:option value="-1">Select Value</html:option>
        	...
        	<td width="25%" class="tdfont">
        		<html:select name="feesCollectedForOpdSpecialClinicFB" property="reportType" tabindex="1" styleClass="regcbo">
					<html:option value="-1">Select Value</html:option>        	
...
<input type="hidden"  name="mode" value="FEESCOLLECTEDFOROPDSPECIALCLINICREPORT">
<html:hidden name="feesCollectedForOpdSpecialClinicFB" property="jrxmlPath" value="<%=RegistrationConfig.REGISTRATION_JRXML_PATH_REPORT1 %>"/>
<html:hidden name="feesCollectedForOpdSpecialClinicFB" property="jrxmlName"/>
<html:hidden name="feesCollectedForOpdSpecialClinicFB" property="sysDate" value="<%=tDate%>"/>
