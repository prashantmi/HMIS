...
function categoryWiseUserWiseRegistrationReportHandler()
{
	
	
	var jrxmlName="";
	 jrxmlName="<%=RegistrationConfig.CATEGORY_WISE_USER_WISE_REGISTRATION_REPORT%>";	
    ...
    { 
	 ...
	 return success;
}//end of function CategoryWiseUserWiseRegistrationFB() 
...
<his:TitleTag name="User Wise Category Wise Cash Collection">
</his:TitleTag>
...
<bean:define name="CategoryWiseUserWiseRegistrationFB" property="fromDate" id="frDate" type="java.lang.String"/>
<bean:define name="CategoryWiseUserWiseRegistrationFB" property="toDate" id="tDate" type="java.lang.String"/>          
<%
	...
	<table width="100%" cellspacing="1" cellpadding="0">
      ...
      <td width="25%" class="tdfonthead">
		...
		<td class="tdfont" width="25%">
				<div  >
			<html:select
				name="CategoryWiseUserWiseRegistrationFB" property="allHospitalCode" tabindex="1"
				styleClass="regcbo" onchange="userCombo()">
		...
		<td class="tdfonthead" nowrap width="25%">
			...
			<div  >
			<html:select
				name="CategoryWiseUserWiseRegistrationFB" property="userCode" tabindex="1"
				styleClass="regcbo">
      ...
      <TR>
			...
			<div  >
			<html:select
				name="CategoryWiseUserWiseRegistrationFB" property="patRegCatCode" tabindex="1"
				styleClass="regcbo">
	...
	<table width="100%" cellspacing="1" cellpadding="0">
		<tr>
			...
			<td width="25%" class="tdfont"><html:select
				name="CategoryWiseUserWiseRegistrationFB" property="graphOrText"
			...
			<td width="25%" class="tdfont"><html:select
				name="CategoryWiseUserWiseRegistrationFB" property="reportType"
				tabindex="1" styleClass="regcbo">
				<html:option value="-1">Select Value</html:option>
...
<input type="hidden" name="mode" value="CATEGORYWISEUSERWISEREGISTRATION">

<html:hidden name="CategoryWiseUserWiseRegistrationFB"
	property="jrxmlPath"
	value="<%=RegistrationConfig.REGISTRATION_JRXML_PATH_REPORT1 %>" />
<html:hidden name="CategoryWiseUserWiseRegistrationFB"
	property="jrxmlName" />
<html:hidden name="CategoryWiseUserWiseRegistrationFB" property="sysDate"
	value="<%=sysdate%>" />
