		...
		%>
				<tr>
					<th colspan="24" align="center">
						<b><font size="3"> Hospital :<%=objHosEnt.getLabel()%> </font></b>
					</th>
				</tr>
				...
				<tr>
					...
					<logic:iterate indexId="idxAge" id="objAgeGrpEnt" name="<%=RegistrationConfig.DSS_REPORTS_LIST_AGE_GROUPS %>" type="hisglobal.utility.Entry">
						<%	GenderCount genCount = (GenderCount) lstHosTotal.get(idxAge.intValue());
							if(genCount!=null)
							{
						%>
						<td align="center" style="border: 1px solid;"><b><%=genCount.getMale()%></b></td>
					...
					<%	
					GenderCount genCount = (GenderCount) lstHosTotal.get(lstHosTotal.size()-1);
						int nHosTot = 0;
						if(genCount!=null)
						{
							nHosTot += genCount.male;
							nHosTot += genCount.female;
							nHosTot += genCount.other;
						}
					%>
