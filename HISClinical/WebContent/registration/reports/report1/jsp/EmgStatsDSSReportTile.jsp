...
<html:form action="/reports/report1/dssParameterConfigurator">
	...
	%>
		...
		<logic:iterate id="objHosEnt" name="<%=RegistrationConfig.DSS_REPORTS_LIST_SELECTED_HOS %>" type="hisglobal.utility.Entry">
		<%
			if(mpReportData.get(objHosEnt.getValue())!=null)
			{
				Map mpHosData = (Map) mpReportData.get(objHosEnt.getValue());
				GenderCount genCountHosTot = (GenderCount) mpHosData.get("HT"); 
		%>
				<tr>
					<th colspan="7" align="center">
						<b><font size="2"> Hospital :<%=objHosEnt.getLabel()%> </font></b>
					</th>
				</tr>
				...
				<%
					List sortedDates = (List)mpSortedDates.get(objHosEnt.getValue());
				...
				%>
					...
					<tr><td colspan="7" align="center" height="18px"></td></tr>
					<tr>
						<td colspan="2" style="border: 1px solid;"><b>Hospital Total:</b></td>
						<td align="center" style="border: 1px solid;"><b><%=genCountHosTot.getMaleNew()+genCountHosTot.getMaleOld()%></b></td>
						<td align="center" style="border: 1px solid;"><b><%=genCountHosTot.getFemaleNew()+genCountHosTot.getFemaleOld()%></b></td>
						<td align="center" style="border: 1px solid;"><b><%=genCountHosTot.getChildMaleNew()+genCountHosTot.getChildMaleOld()%></b></td>
						<td align="center" style="border: 1px solid;"><b><%=genCountHosTot.getChildFemaleNew()+genCountHosTot.getChildFemaleOld()%></b></td>
						<%	
							nHosTot = 0;
							nHosTot += genCountHosTot.maleNew + genCountHosTot.maleOld;
							nHosTot += genCountHosTot.femaleNew + genCountHosTot.femaleOld;
							nHosTot += genCountHosTot.childMaleNew + genCountHosTot.childMaleOld;
							nHosTot += genCountHosTot.childFemaleNew + genCountHosTot.childFemaleOld;
						%>
						<td align="center" style="border: 1px solid;"><b><%=nHosTot%></b></td>
					</tr>
					<tr><td colspan="7" align="center" height="18px"></td></tr>
