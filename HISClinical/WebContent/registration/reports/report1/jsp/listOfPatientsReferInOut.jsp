...
function listOfPatientsReferInOutReportHandler()
{
	if(document.getElementsByName('choice')[0].checked)
	{
    	document.getElementsByName('jrxmlName')[0].value="<%=RegistrationConfig.LIST_OF_PATIENTS_REFER_INOUT_TODAY%>";
    	
	}
	else
	{
		document.getElementsByName('jrxmlName')[0].value="<%=RegistrationConfig.LIST_OF_PATIENTS_REFER_INOUT_DATEWISE%>";         
	}
...
<his:TitleTag name="List Of Patients Refer In/Out">
</his:TitleTag>
...
<logic:equal name="listOfPatientsReferInOutFB" property="choice" value="<%=Config.CHOICE_TODAY%>">
             <%
       ...
       <logic:equal name="listOfPatientsReferInOutFB" property="choice" value="<%=Config.CHOICE_DATE_WISE%>">
        <%     
        	   fromDateLabel="" ;
               toDateLabel="" ;
               fromDateControl="" ;
       ...
       <bean:define name="listOfPatientsReferInOutFB" property="fromDate" id="frDate" type="java.lang.String"/>
	   <bean:define name="listOfPatientsReferInOutFB" property="toDate" id="tDate" type="java.lang.String"/>          
	   <%
		...
		<tr>            
 			<td class="tdfonthead" nowrap width="25%">       	      
		    	<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
		      		...
		      		<html:radio name="listOfPatientsReferInOutFB" property="choice" tabindex="1" value="<%=Config.CHOICE_TODAY%>" onclick="showdivtoday()"/> 
		        <font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
		       		<bean:message key="dateWise"/></font> 
		        	<html:radio name="listOfPatientsReferInOutFB" property="choice" tabindex="1" value="<%=Config.CHOICE_DATE_WISE%>" onclick="showdivdatewise()"/>
			</td> 
		...
		<tr style="display:none">
    		...
    		<td class="tdfont">
       			<div id="hospControl" align="left"  >
     		 		<html:select name="listOfPatientsReferInOutFB"  property="multipleHospitalCode" multiple="true" size="5" tabindex="1"  >   
 			...
 			<td class="tdfont" width="25%">
	    		<div id='divfromDateControl' style='<%=fromDateControl %>'align="left">	               		 
		 		...
		 		<span id='divfromhrcontrol' style='<%=fromControl %>'align="left">	            
		   			<html:text name="listOfPatientsReferInOutFB" tabindex="1" property="fromHour"  maxlength="2" size="3"  onkeydown="setPreviosValue(this, event)" onkeyup="moveToRightBox(this, event)" onkeypress="return validateNumeric(event)" />	
		  			 <b>	<bean:message key="colon"/></b>
				</span>
		 		<span id='divfromMinControl' style='<%=fromControl %>' align="left">         
					<html:text name="listOfPatientsReferInOutFB" tabindex="1" property="fromMin"   maxlength="2" size="3" onkeydown="setPreviosValue(this, event)" onkeyup="moveToRightBox(this, event)" onkeypress="return validateNumeric(event)"/>				
			...
			<td class="tdfont" width="25%">
		 		<div id='divtoDateControl' style='<%=toDateControl %>' align="left">    
    	  		...
    	  		<span id='divtohrcontrol' style='<%=toControl%>' align="left">	            
		   			<html:text name="listOfPatientsReferInOutFB" tabindex="1" property="toHour"  maxlength="2" size="3" onkeydown="setPreviosValue(this, event)" onkeyup="moveToRightBox(this, event)" onkeypress="return validateNumeric(event)"/>	
	   				<b><bean:message key="colon"/>	  </b>
				</span>
		 		<span id='divtoMinControl' style='<%=toControl%>' align="left">         
					<html:text name="listOfPatientsReferInOutFB" tabindex="1" property="toMin" maxlength="2" size="3"  onkeydown="setPreviosValue(this, event)" onkeyup="moveToRightBox(this, event)" onkeypress="return validateNumeric(event)"/>				
						<bean:message key="timeFormat"/>	  
    	 		</span>
			</td>                 			
		</tr>
		<tr>
    		...
    		<td class="tdfont">
       			<div id="deptControl" align="left"  style='<%=deptcontrol%>'>
     		 		<html:select name="listOfPatientsReferInOutFB"  property="departmentCode"  tabindex="1"  styleClass ="regcbo" >   
    		...
    		<td class="tdfonthead">
    		<div id ="referalTypeLabel"  align="right"  style='<%=deptlabel%>'>
		        	<font color="#FF0000" size="1" face="Verdana, Arial, Helvetica, sans-serif\">*</font>
		            <font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
    		...
    		<td class="tdfont">
    			<div id="deptControl" align="left"  style='<%=deptcontrol%>'>
     		 		<html:select name="listOfPatientsReferInOutFB"  property="type"  tabindex="1"  styleClass ="regcbo" >   
					  <html:option value="%">All</html:option>
					  <html:option value="1">Internal</html:option>
					  <html:option value="2">External</html:option>
			  		</html:select> 
	   			</div>  
    		</td>
...
<!--    		<td class="tdfont">-->
<!--       			<div id="deptControl" align="left"  style='<%=deptcontrol%>'>-->
<!--     		 		<html:select name="listOfPatientsReferInOutFB"  property="patPrimaryCatCode"  tabindex="1"  styleClass ="regcbo" >   -->
	...
	<table width="100%" cellspacing="1" cellpadding="0">
    	<tr>       
        	...
        	<td width="25%" class="tdfont" > 
	        	<html:select name="listOfPatientsReferInOutFB"  property="graphOrText" tabindex="1" styleClass="regcbo" >
        	...
        	<td width="25%" class="tdfont">
        		<html:select name="listOfPatientsReferInOutFB" property="reportType" tabindex="1" styleClass="regcbo">
					<html:option value="-1">Select Value</html:option>        	
...
<input type="hidden"  name="mode" value="LISTOFPATIENTSREFERINOUTREPORT">
<html:hidden name="listOfPatientsReferInOutFB" property="jrxmlPath" value="<%=RegistrationConfig.REGISTRATION_JRXML_PATH_REPORT1 %>"/>
<html:hidden name="listOfPatientsReferInOutFB" property="jrxmlName"/>
<html:hidden name="listOfPatientsReferInOutFB" property="dynamicQuery"/>

<html:hidden name="listOfPatientsReferInOutFB" property="sysDate" value="<%=tDate%>"/>
<%
