...
<body onload="onLoadFunction()">
	<html:form action="/master/IcdIndexLevelMaster" scope="request" >
		...
		<his:TransactionContainer>
			<his:TitleTag name=" ICD Index Level Master >> ADD" >
			</his:TitleTag>
		<his:statusNew>		
			<his:ContentTag>
				...
				<table width="100%" border="0" cellspacing="1" cellpadding="0">
					<tr>
						...
						<td width="50%" class="tdfont">
							<div align="left">
								<html:select name="IcdIndexLevelMasterFB" property="indexCode" style="width:150px" tabindex="1">
					...
					<tr>
						...
						<td width="50%" class="tdfont">
							<div align="left">
								<html:select name="IcdIndexLevelMasterFB" property="modifierLevel" style="width:150px" tabindex="1" onchange="populateParentModifier()">
...
<!--	Check box for Dual Icd Disease Code				-->		
				...
				<table width="100%" border="0" cellspacing="1" cellpadding="0">
					<tr>
						...
						<td width="100%" class="tdfont" colspan="2">
							<div align="left">
							<html:checkbox property="dualDiseaseCodeChk" tabindex="1" onclick="showHideDualICDDis(this);">Dual ICD Disease Code</html:checkbox>
							</div>					
						</td>
					</tr>
				</table>
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="0">
				...
				<his:ButtonToolBarTag>
						<his:statusNew>
							<img class="button" src='<his:path src="/../HIS/hisglobal/images/buttons/btn-sv.png"/>' style="cursor:pointer" tabindex="1" onclick ="validateAddModify('SAVE')" onkeypress="if(event.keyCode==13) validateAddModify('SAVE')">
				    		...
				    		<img class="button" src='<his:path src="/../HIS/hisglobal/images/buttons/btn-clr.png"/>' style="cursor:pointer" tabindex="1" onclick ="submitForm('ADD')" onkeypress="if(event.keyCode==13) submitForm('ADD')">
						</his:statusNew>	
	...
	<his:status />
		...
		<html:hidden name="IcdIndexLevelMasterFB" property="isActive"/>
		...
		<html:hidden name="IcdIndexLevelMasterFB" property="pageFlag" value="ADD_PAGE" />
