...
function submitPage(mode)
{
	...
	<body>
		...
		<logic:equal value="MODIFY" name="DeskTypeMenuMappingMasterFB" property="hmode">
	 	...
	 	<tr>
	 		<td width="35%"  class="tdfonthead">
				<div align="center">
					<html:select name="DeskTypeMenuMappingMasterFB" property="menuIdLst" multiple="true" size="10" style="width: 200px;" >
						<logic:present name="<%=OpdConfig.REMANING_MENU_LIST%>">
					  	<html:options collection="<%=OpdConfig.REMANING_MENU_LIST%>" property="value" labelProperty="label" />
					  	</logic:present>
					 </html:select>
				</div>
			</td>
			...
			<td width="35%"  class="tdfonthead">
				<div align="center">
					...
					<logic:present name="<%=OpdConfig.SELECTED_MENU_LIST%>">
					<html:options collection="<%=OpdConfig.SELECTED_MENU_LIST%>" property="value" labelProperty="label" />
					</logic:present>
					</html:select>
				</div>
			</td>
	...
	<logic:equal value="VIEW" name="DeskTypeMenuMappingMasterFB" property="hmode">
	<table width="100%" border="0" cellspacing="1" cellpadding="0">
			<tr>
				<td width="50%"  class="tdfonthead">
					<div align="right">	           
	...
	<his:ButtonToolBarTag>
	 <logic:equal value="MODIFY" name="DeskTypeMenuMappingMasterFB" property="hmode">
    	...
    	<img class="button" src='<his:path src="/../HIS/hisglobal/images/buttons/btn-clr.png"/>' style="cursor:pointer" tabindex="1" onclick ="submitForm21('MODIFY')" onkeypress="if(event.keyCode==13) submitForm21('MODIFY')">
   	</logic:equal>
   	<logic:equal value="VIEW" name="DeskTypeMenuMappingMasterFB" property="hmode">
   		<img class="button" src='<his:path src="/../HIS/hisglobal/images/buttons/btn-ccl.png"/>' style="cursor:pointer" tabindex="1" onclick ="submitForm21('CANCEL')" onkeypress="if(event.keyCode==13) submitForm21('CANCEL')">
   	</logic:equal>
...
<html:hidden name="DeskTypeMenuMappingMasterFB" property="chk"/>
