...
<html:form action="/master/IcdIndexMaster">
	<his:TransactionContainer>
	 	...
	 	<his:TitleTag name="ICD Index Master">
		</his:TitleTag>
		
	
		<logic:equal value="MODIFY" property="hmode" name="IcdIndexMasterFB">
		<his:ContentTag>
			...
			<td width="50%" class="tdfonthead">
					...
					<td width="50%" class="tdfonthead">
						...
						<td width="50%" class="tdfont">
							<div align="left">
								<html:text name="IcdIndexMasterFB" property="hospitalSynonym" tabindex="1" maxlength="200" size="28" onkeypress="return return validateIndexTerm(event);"/>
							</div>					
						</td>
		...
		<table width="100%" border="0" cellspacing="1" cellpadding="0">
					...
					<tr>
						<td width="100%" class="tdfont" colspan="2">
							<div align="left">
							<html:checkbox property="strDiseaseCodeChk"  onclick="showHideICDDiseaseCode(this)" tabindex="1">ICD Disease Code</html:checkbox>
							</div>					
						</td>
					</tr>
				</table>
		...
		<logic:equal value="VIEW" property="hmode" name="IcdIndexMasterFB">
		...
		<table width="100%" border="0" cellspacing="1" cellpadding="0">
			<tr>
					...
					<td width="50%" class="tdfont">
							<div align="left">
								<bean:write name="IcdIndexMasterFB" property="diagnosticTerm"/>
							</div>					
						</td>
		</tr>
				<tr>
				<td width="50%" class="tdfonthead">
						...
						<td width="50%" class="tdfont">
							<div align="left">
								<bean:write name="IcdIndexMasterFB" property="hospitalSynonym"/>
							</div>					
						</td>
		</tr>
						<tr>
						...
						<td width="50%" class="tdfont">
							<div align="left">
							<bean:write name="IcdIndexMasterFB" property="diseaseCode"/>		
							</div>
						</td>
					</tr>	
					...
					<tr>
						...
						<td width="50%" class="tdfont">
							<div align="left">
							<bean:write name="IcdIndexMasterFB" property="strDualDiseaseCode"/>		
							</div>
						</td>
					</tr>	
						...
						<td width="50%" class="tdfont">
							<div align="left">
							<bean:write name="IcdIndexMasterFB" property="strRemark"/>		
							</div>
						</td>
					</tr>	
		</table>
	...
	<his:ButtonToolBarTag>
						<his:statusNew>
						<logic:notEqual name="IcdIndexMasterFB" property="hmode" value="VIEW">
				    		...
				    		<logic:notEqual name="IcdIndexMasterFB" property="hmode" value="VIEW">
				    		<img class="button" src='<his:path src="/../HIS/hisglobal/images/buttons/btn-clr.png"/>' style="cursor:pointer" tabindex="1" onclick ="submitButton('MODIFY');" onkeypress="if(event.keyCode==13) submitButton('MODIFY')">
							</logic:notEqual>
						</his:statusNew>	
		...
		<center><b><his:status/></b></center>
				...
				<html:hidden name="IcdIndexMasterFB" property="chk"/>
