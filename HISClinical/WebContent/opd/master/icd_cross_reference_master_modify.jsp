...
<html:form action="/master/IcdCrossRefMaster">
	...
	<his:TransactionContainer>
		...
		<his:TitleTag name="ICD Cross Reference Master >> Modify">
		</his:TitleTag>
				...
				<tr>
					<td width="100%" class="tdfonthead">
						<div align="center">
							<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
								<font color="#FF0000">*</font>
								<html:radio name="IcdCrossRefMasterFB" property="seeTermRadio" value="0" onclick="setSeeTermRadioValue();"/>See &nbsp;&nbsp; 
								<html:radio name="IcdCrossRefMasterFB" property="seeTermRadio" value="1" onclick="setSeeAlsoTermRadioValue();" />See Also 
							</font>
						</div>
					</td>
				</tr>
...
<!-- See Also Term	-->		
				...
				<!-- <tr>
					...
					<td width="50%" class="tdfont">
						<div align="left">
							<logic:present name="IcdCrossRefMasterFB" property="seeAlsoTerm">
								<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
	...
	<html:hidden name="IcdCrossRefMasterFB" property="pageFlag" value="MODIFY_PAGE" />
