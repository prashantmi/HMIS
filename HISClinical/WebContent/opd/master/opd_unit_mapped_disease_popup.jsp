...
<html:form action="/master/DeptUnitIcdMapping">
	<html:hidden name="DeptUnitIcdMappingFB" property="deleteIndex"/>
	<html:hidden name="DeptUnitIcdMappingFB" property="hmode"/>
	<body >
		<his:TitleTag name="Selected Disease">
		</his:TitleTag>
		<his:ContentTag>
				
		<table width="100%" border="0" cellspacing="1" cellpadding="0" >
			
			<logic:iterate id="disease" name="<%=OpdConfig.MAPPED_DISEASE_LIST_WITH_UNIT%>" indexId="index">
			<tr>
				<td class="tdfont">
    ...
    <logic:empty name="<%=OpdConfig.MAPPED_DISEASE_LIST_WITH_UNIT%>">
