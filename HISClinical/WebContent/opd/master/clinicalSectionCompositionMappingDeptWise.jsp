...
<his:ButtonToolBarTag>
	<his:statusTransactionInProcess>	
		<logic:equal name="UserDeskMenuTempMapFB" property="isMappingStart" value="<%=OpdConfig.YES%>">
			<img class="button" src='<his:path src="/../HIS/hisglobal/images/buttons/btn-sv.png"/>'  style="cursor:pointer" tabindex="1" onclick ="if(validateSave()) submitPage('SAVEFORUNITWISE')" onkeypress="if(event.keyCode==13)if(validateSave()) submitPage('SAVEFORUNITWISE')">
		</logic:equal>				
	</his:statusTransactionInProcess>
	<his:statusNew>
		<logic:equal name="UserDeskMenuTempMapFB" property="isGoPressed" value="<%=OpdConfig.STEP0%>">
			<img class="button" src='<his:path src="/hisglobal/images/GoNew.png"/>' style="cursor:pointer" onclick="if(validateUnitSelection()) submitPage('GETMENUSFORUNIT')" onkeypress="if(event.keyCode==13) if(validateUnitSelection()) submitPage('GETMENUSFORUNIT')">
		</logic:equal>				
