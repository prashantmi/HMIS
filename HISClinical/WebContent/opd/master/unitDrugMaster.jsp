...
function moveRightSingle()
{
	...
	var target;
		...
		source  = document.forms[0].extTreatCode;
...
function moveLeftSingle()
{
	...
	var target;
		...
		target  = document.forms[0].extTreatCode;
...
<%try{ %>
	<body>
		<html:form action="/master/UnitDrugMaster">
			
			<his:TransactionContainer>
				<logic:equal name="UnitDrugMasterFB" property="hmode" value="ADD">
					<his:TitleTag name="Add Drug Detail To Unit">
					</his:TitleTag>
				</logic:equal>
				<logic:equal name="UnitDrugMasterFB" property="hmode" value="MODIFY">
					<his:TitleTag name="Modify Drug Detail  Unit Wise">
					</his:TitleTag>
				</logic:equal>
				<logic:equal name="UnitDrugMasterFB" property="hmode" value="VIEW">
					<his:TitleTag name="View Drug Detail  Unit Wise">
					</his:TitleTag>
				</logic:equal>
				<his:ContentTag>
				...
				<table width="100%" border="0" cellspacing="1" cellpadding="0">
					...
					<td width="50%" class="tdfonthead">
						...
						<td width="50%" class="tdfont">
							<div align="left">
								&nbsp;<bean:write name="UnitDrugMasterFB" property="deptUnitName" />
							</div>
						</td>
				...
				<tr>
						...
						<td width="50%" class="tdfonthead">
							<div align="left">
								<html:select name="UnitDrugMasterFB" property="deptCode" onkeypress="if(event.keyCOde==13)deptSelected(this);" onchange="deptSelected(this);" styleClass="registrationCmb" >
					...
					<tr>
						<td width="40%"  class="tdfonthead">
							<div align="center" style="display: none;" >
								<html:select name="UnitDrugMasterFB" property="mainUnitsList" multiple="true" size="6" disabled="true" style="width:150px">
							...
							<div align="center">
								<html:select name="UnitDrugMasterFB" property="unitsList" multiple="true" size="6" style="width:150px">
								</html:select>
							</div>
						</td>
						...
						<td width="40%"  class="tdfonthead">
							<div align="center">
								<html:select name="UnitDrugMasterFB" property="selectedUnit" multiple="true" size="6" style="width:150">
								</html:select>
							</div>
						</td>
					</tr>
				...
				<his:ContentTag>
				<logic:notEqual name="UnitDrugMasterFB" property="hmode" value="VIEW">
					<%--<table width="100%" border="0" cellspacing="1" cellpadding="0">
						<tr>
							<td width="50%" class="tdfonthead">
								<div align="right">
							...
							<td width="50%" class="tdfonthead">
								<div align="left">
									<html:select name="UnitDrugMasterFB" property="treatmentType" onkeypress="if(event.keyCOde==13)treatmentTypeSelected(this);" onchange="treatmentTypeSelected(this);" styleClass="registrationCmb" >
										<html:option value="-1">Select Value</html:option>
					...
					<tr>
						<td width="40%"  class="tdfonthead">
							<div align="center">
								<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
									<b>
										<bean:message key="allDrugDetail"/>
									</b>
								</font>
							</div>
						</td>
						...
						<td width="40%"  class="tdfonthead">
							<div align="center">
								<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
									<b>
										<bean:message key="selectedDrugDetail"/>
									</b>
								</font>
							</div>
						</td>
					...
					<tr>
						...
						<logic:equal name="UnitDrugMasterFB" property="hmode" value="ADD">
						<div align="center" >	
							<html:select name="UnitDrugMasterFB" property="extTreatCode" multiple="true" size="6" style="width:150px">
							...
							<!--<div align="center">
								<html:select name="UnitDrugMasterFB" property="teatListByType" multiple="true" size="6" style="width:150px">
								</html:select>
							</div>-->
						</logic:equal>	
						<logic:equal name="UnitDrugMasterFB" property="hmode" value="MODIFY">
					...
					<td width="40%"  class="tdfonthead">
						<div align="center">
						<logic:equal name="UnitDrugMasterFB" property="hmode" value="ADD">
							<html:select name="UnitDrugMasterFB" property="selectedExtTreatCode" multiple="true" size="6" style="width:150px">
							</html:select>
						</logic:equal>	
					...
					<logic:equal name="UnitDrugMasterFB" property="hmode" value="VIEW">
						<table width="100%" border="0" cellspacing="1" cellpadding="0">
							...
							<html:hidden name="UnitDrugMasterFB" property="selectedExtTreatCode" />
						</logic:equal>
				...
				<html:hidden name="UnitDrugMasterFB" property="hmode"/>
				<html:hidden name="UnitDrugMasterFB" property="tempMode"/>
				<html:hidden name="UnitDrugMasterFB" property="deptCode"/>
