...
<script>
	...
	function validateDeptHosDisMaster()
	{
...
<logic:equal name="DeptHosDisMasterFB" property="choice" value="<%=OpdConfig.CHOICE_DEPARTMENT%>">
  			<% deptLabel="display:block";
			 deptControl="display:block";
			 unitLabel="display:none";
			 unitControl="display:none";  %>
  </logic:equal>
  <logic:equal name="DeptHosDisMasterFB" property="choice" value="<%=OpdConfig.CHOICE_UNIT%>">
...
<his:TitleTag name="Department Hospital Disease Master">			
</his:TitleTag> 
  ...
  <tr>
		<td class="tdfonthead"  width="50%">
			...
			<html:radio name="DeptHosDisMasterFB" property="choice" tabindex="1" 
  ...
  <tr>
	  ...
	  <html:select name="DeptHosDisMasterFB" tabindex="1" property="departmentCode" styleClass="registrationCmb" onchange="if(validateDeptHosDisMaster()) submitForm('GETDTL')">
	  ...
	  <html:select name="DeptHosDisMasterFB" tabindex="1" property="departmentUnitCode" styleClass="registrationCmb" onchange="if(validateDeptHosDisMaster()) submitForm('GETDTL')">
			<html:option value="-1">Select Value</html:option>
...
<table width="100%" border="0" cellspacing="1" cellpadding="0">
	...
	<td width="100%" class="addtoolbar" style="border-top:outset black 2px; border-bottom:inset black 2px;"><font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif"><b><bean:message key="hospitaldisease"/></b></font></td>
	</tr>
	</table>
	<logic:notEmpty name="DeptHosDisMasterFB" property="displayVO">
<%int i=0;
...
%>
<logic:iterate id="arrayDisplayVO" name="DeptHosDisMasterFB" property="displayVO" indexId="id" type="hisglobal.vo.DepartmentHosDisMasterVO" >
<%int idx=id.intValue(); %>
...
<%}else{%>
	...
	<tr>
		<td class='tdfonthead' width='33%' colspan='3' ><div align='center'><%=arrayDisplayVO.getDisease() %></div></td>
...
<logic:empty name="DeptHosDisMasterFB" property="displayVO">
<table width='100%'>
<tr>
...
<table width="100%" border="0" cellspacing="1" cellpadding="0">
	<tr>
		<td align="right" class='tdfonthead' >
		<html:select name="DeptHosDisMasterFB" tabindex="1" property="searchType" styleClass="registrationCmb" >
			<html:option value="1">Hospital Disease Name</html:option>
		</html:select>
		<html:text name="DeptHosDisMasterFB" tabindex="1" property="searchKey"  maxlength="10" size="10"  onkeypress="return validateAlphaNumericOnly(event)"/>	
...
<his:ButtonToolBarTag>
	<img class="button" style="cursor:pointer" src='<his:path src="/../HIS/hisglobal/images/buttons/btn-add.png"/>' alt="Add Record" title="Add Record" onclick="if(validateDeptHosDisMaster())openPopup('/HISClinical/opd/master/DeptHosDisMaster.cnt?hmode=ADD&departmentCode='+document.forms[0].departmentCode.value+'&valueChoice='+document.forms[0].valueChoice.value+'&departmentUnitCode='+document.forms[0].departmentUnitCode.value ,event,300,800);">
	<img class='button' style="cursor:pointer" src='<his:path src="/hisglobal/images/btn-del.png"/>'  alt="Delete Record"  title="Delete Record" onclick="if(validateDeptHosDisMaster())openPopup('/HISClinical/opd/master/DeptHosDisMaster.cnt?hmode=REMOVE&departmentCode='+document.forms[0].departmentCode.value+'&valueChoice='+document.forms[0].valueChoice.value+'&departmentUnitCode='+document.forms[0].departmentUnitCode.value ,event,300,800);">
