				...
				<table width="100%" border="0"  cellspacing="1" cellpadding="0">
					<tr>
						...
						<td width="35%" class="tdfonthead">
							<div align="center">
								<html:select name="UserDeskMenuTempMapFB" property="unitCode" tabindex="1" onchange="showWardsInUnitWardSeatWise()">
									<html:option value="-1">Select Value</html:option>
...
<his:ButtonToolBarTag>
	<his:statusTransactionInProcess>	
		<logic:equal name="UserDeskMenuTempMapFB" property="isMappingStart" value="<%=OpdConfig.YES%>">
			<img class="button" src='<his:path src="/../HIS/hisglobal/images/buttons/btn-sv.png"/>'  style="cursor:pointer" tabindex="1" onclick ="if(validateSave()) submitPage('SAVEBYUNITWARDSEATWISE')" onkeypress="if(event.keyCode==13)if(validateSave()) submitPage('SAVEBYUNITWARDWISE')">
		</logic:equal>				
	</his:statusTransactionInProcess>
	<his:statusNew>
		<logic:equal name="UserDeskMenuTempMapFB" property="isGoPressed" value="<%=OpdConfig.STEP0%>">
			<img class="button" src='<his:path src="/hisglobal/images/GoNew.png"/>' style="cursor:pointer" onclick="if(validateWardSelection()) submitPage('SELECTSEATSFORUNITSEATWARD')" onkeypress="if(event.keyCode==13) if(validateWardSelection()) submitPage('SELECTSEATSFORUNITSEATWARD')">
		</logic:equal>				
		<logic:equal name="UserDeskMenuTempMapFB" property="isGoPressed" value="<%=OpdConfig.STEP1 %>">
			<img class="button" src='<his:path src="/hisglobal/images/GoNew.png"/>' style="cursor:pointer" onclick="if(validateSeatSelection()) submitPage('GETMENUSTEMPLATEFORUNITSEATWARD')" onkeypress="if(event.keyCode==13) if(validateSeatSelection()) submitPage('GETMENUSTEMPLATEFORUNITSEATWARD')">
		</logic:equal>
