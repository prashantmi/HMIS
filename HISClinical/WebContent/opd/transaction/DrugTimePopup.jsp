...
<!--					This tr not in use for display purpose (but value of empty stomach going in table)-->
				...
				<tr>
					...
					<div align="left">
						<html:text property="cutOffTimeBefore" name="PatientTreatmentDetailFB" size="10" value="<%=cutOffBefore %>" onkeypress="return validateNumeric(event)"></html:text>
						</div>
					</td>
					<% i=i+1;
					};
				...
				<tr>
					...
					<div align="left">
						<html:text property="cutOffTimeAfter" name="PatientTreatmentDetailFB" size="10" value="<%=cutOffAfter %>" onkeypress="return validateNumeric(event)"></html:text>
						</div>
					</td>
					<% i=i+1;
					};
...
<!--					This tr not in use for display purpose (but value of empty stomach going in table)-->					
				...
				<td class="tdfont" width="25%">
						...
						<html:text name="PatientTreatmentDetailFB"  property="drugRequirmentTimeHrs" value="<%=hrs %>" size="3" tabindex="1" maxlength="2"  onkeypress="return validateNumeric(event)"  disabled="false"/>
							:
							<html:text name="PatientTreatmentDetailFB" property="drugRequirmentTimeMin"  value="<%=mins %>" size="3" tabindex="1" maxlength="2"  onkeypress="return validateNumeric(event)"  disabled="false"/>
