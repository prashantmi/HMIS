...
{	
	...
	var url='/HISClinical/csultyPatCount?UNITCODE='+unitCode+'&ROOMCODE='+roomCode;
...
function handleResponse()
{
	if(request.readyState == 4)
	{
		...
		{
			var todayPatId=document.getElementById("todayPatId");
			...
			if(request.responseText.indexOf("$")!=-1)
			{
				...
				var todayPat=request.responseText.split("\\$")[2];
				var isRefresh=request.responseText.split("\\$")[1];
				
				todayPatId.innerHTML="&nbsp;&nbsp;&nbsp;Total Number of Today Admitted Patients = "+todayPat;	
...
<body>
<form id="csultyDeskHeaderId" >
<his:TitleTag name="CASUALTY DESK">
	<div align="left">
	...
	<table width="100%" cellspacing="0" cellpadding="0">
		<tr>
			<td width="50%" valign="top" class="tdfonthead" nowrap>
				...
				<div id="todayPatId" align="left">
					&nbsp;&nbsp;&nbsp;Total Number of Today Admitted Patients =
				</div>			
				</b></font>
			</td>
