...
<his:javascript src="/hisglobal/js/util.js"/><html>
<head>
	...
	<table width="100%" cellpadding="0" cellspacing="0">
		...
		<tr align="center">
			<td width="100%" align="center">
				...
				<img id="Cancel" class="button" src='<his:path src="/../HIS/hisglobal/images/buttons/btn-ccl.png"/>' tabindex="1" style="cursor: pointer" onclick="cancelImageinJS()" onkeypress="if(event.keyCode==13) cancelImageinJS()">
			</td>
		</tr>
		<tr align="center">
			<td width="100%" align="center">
				* Note : For Editing Image, your browser should support Java. Please ensure if Image is not appearing.
			</td>
		</tr>
	</table>
</body>
