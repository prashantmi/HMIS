			...
			<his:ContentTag>
 				<table width="100%" cellspacing="1" cellpadding="0">
 					<tr>
						...
						<% if(lst.size()>0)	{ %>
							<img class="button" style="cursor:pointer" src='<his:path src="/hisglobal/images/btn-search.png"/>' alt="Search" title="Search" onclick="openPopup(createFHashAjaxQuery('/HISClinical/opd/opdTemplateTab.cnt?hmode=POPUP'),event,700,600);" >
						<%	}	%>
						&nbsp;&nbsp;&nbsp;
						<% if(visit>1)	{%>
