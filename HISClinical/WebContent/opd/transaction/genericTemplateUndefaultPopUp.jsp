...
function validateAddUndefault()
{
	...
	opener.submitFormOnValidate(true,'ADDUNDEFAULT');
...
<his:TitleTag key="seltemp">
	...
	<his:ContentTag>
 		<table width="100%" cellspacing="1" cellpadding="0">
			...
			%>
			<logic:iterate name="<%=GenericTemplateConfig.TEMPLATE_TILE_UNDEFAULT_TEMPLATE_LIST+deskMenuId%>" id="temp" type="hisglobal.utility.Entry">
	 			<tr>
					<td width="30%"  class="tdfonthead">
						<div align="right">
							<input type="checkbox" name="undefTemp" id='<%=temp.getValue()%>' onclick="setSelectedTemp();"/>
						</div>
					</td>
					<td width="70%"  class="tdfont">
						<div align="left">
							<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
								<b>&nbsp;<bean:write name="temp" property="label"/> </b>
							</font>
						</div>
					</td>
				</tr>
