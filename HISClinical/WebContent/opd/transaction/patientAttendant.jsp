...
<logic:equal name="PatientAttendantFB" property="isDirectCall" value="DIRECT">
						...
						<logic:iterate name="<%=OpdConfig.PATIENT_ALL_ATTENDANT_VO_LIST %>" id="patAttendantVO" type="hisglobal.vo.PatientFamilyDtlVO" indexId="idx">
							<tr>
								<td class="tdfont" width="10%" >
									<div align="center">
										<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
											<% if(patAttendantVO.getSlNo().equals("0"))	{ %>
		...
		<his:ButtonToolBarTag>
			...
			<logic:equal name="PatientAttendantFB" property="isDirectCall" value="DIRECT">
				<his:statusTransactionInProcess>
					<img class="button" src='<his:path src="/../HIS/hisglobal/images/buttons/btn-sv.png"/>'  style="cursor:pointer" tabindex="1" onclick ="if(validateSave()) submitForm21('SAVE')" onkeypress="if(event.keyCode==13)if(validateSave()) submitPage('SAVE')">
				</his:statusTransactionInProcess>	
				...
				<his:statusNew>
					<img class="button" src='<his:path src="/../HIS/hisglobal/images/buttons/btn-clr.png"/>'  style="cursor:pointer" tabindex="1" onclick =" submitForm21('GETCRNO')" onkeypress="if(event.keyCode==13) submitForm21('GETCRNO')">
				</his:statusNew>
				<his:statusTransactionInProcess>
					<img class="button" src='<his:path src="/../HIS/hisglobal/images/buttons/btn-clr.png"/>'  style="cursor:pointer" tabindex="1" onclick =" submitPage('NEW')" onkeypress="if(event.keyCode==13) submitPage('NEW')">
				</his:statusTransactionInProcess>
		...
		<html:hidden name="PatientAttendantFB" property="episodeCode"/>
		<html:hidden name="PatientAttendantFB" property="episodeVisitNo"/>
