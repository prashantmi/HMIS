...
<link rel="stylesheet" type="text/css" title="blue" href="/HISClinical/hisglobal/utility/dynamicdesk/css/bootstrap.css" />
...
var arrDeskMenuId = ["100","6","11","10","0","14"];
var arrDeskMenuURL = ["OPDNEXTVISITDETAIL","DESKDIAGNOSIS","REQUISITIONRAISING","DESKTREATMENTDETAIL","PATIENTSUMMARY","UNIPAGEPRESCRIPTION"];
var arrDeskMenuName = ["Visit Summary","Diagnosis","Investigation Order","Treatment Detail","Medical History","Single Page Prescription"];
var arrDeskMenuDetailURL = ["VISIT_DETAIL","DESKDIAGNOSIS_DETAIL","REQUISITIONRAISING_DETAIL","DESKTREATMENTDETAIL_DETAIL","UNI_PAGE_PRESCRIPTION"];

/* var arrDeskMenuId = ["100","6","11","10","0"];
var arrDeskMenuURL = ["OPDNEXTVISITDETAIL","DESKDIAGNOSIS","REQUISITIONRAISING","DESKTREATMENTDETAIL","PATIENTSUMMARY"];
...
function onLoadFun()
{
	...
	//if(_episodeVisitNo == "1")
		//{
		//alert("if");
		open_Tab_New(arrDeskMenuId[5],arrDeskMenuName[5],arrDeskMenuURL[5]);
		//}
	var objPatientInfo = patVisitSummary();
	if(objPatientInfo[0].strShowprocessFlag == "1")
	{
		//alert("second if");
	...
	{
		//alert("else");
	//alert(arrDeskMenuId[0],arrDeskMenuURL[0]);
	open_Tab_New(arrDeskMenuId[5],arrDeskMenuName[5],arrDeskMenuURL[5]); // for tab auto open on dashboard  open prescription  //  auto open SPP
//	open_Tab_New(arrDeskMenuId[1],arrDeskMenuName[1],arrDeskMenuURL[1]);
	}
}
...
//Added by Vasu on 30.Dec.2019
function open_medical_hostory_tab()
{
	var patCrNo=document.getElementsByName("patCrNo")[0].value;
	var episodeCode=document.getElementsByName("episodeCode")[0].value;
	var episodeVisitNo=document.getElementsByName("episodeVisitNo")[0].value;
	...
	parent.addTab('Patient Profile','PATPROFILE','19','1',false,"&patCrNo="+patCrNo+"&episodeCode="+episodeCode+"&episodeVisitNo="+episodeVisitNo+"&departmentUnitCode="+departmentUnitCode+"&roomCode="+roomCode,'1','');
}

//Added by Vasu on 31.Dec.2019
function open_medical_hostory_details(e)
{
				...
				<div class="live-tile roundeddarkgreen" data-mode="slide" data-speed="600" data-stack="true" 
					data-start-now="false" data-delay="0" data-repeat="0" data-direction="vertical" style="width: 100%; height: 100%;" ondblclick="zoomInOutFun('test0');">
						...
						<div id="visitSummaryId">
							...
							<p style="color: black">								
								<a onclick="open_Tab_New(arrDeskMenuId[5],arrDeskMenuName[5],arrDeskMenuURL[5]);" class="metroLargerLower fontBold" href="#" style="font-size: small; font: bold"><font color="#25ba33">Visit Summary</font></a>															
				...
				<div  class="live-tile roundedblue" data-mode="slide" data-speed="600" data-stack="true"
					data-start-now="false" data-delay="0" data-repeat="0" data-direction="vertical" style="width: 100%; height: 100%;" ondblclick="zoomInOutFun('test5');">
						...
						<div>
							...
							<p>								
								<a class="metroLargerLower fontBold"  style="font-size: small; font: bold" href="#" ><font color="#017299">Medical History</font></a>
							</p>
							</div>
					...
					data-start-now="false" data-delay="0" data-repeat="0" data-direction="vertical" style="width: 100%; height: 100%;" margin-top: -17%;" ondblclick="zoomInOutFun('test3');" >
						...
						<div>
							...
							<div class="tile-title" style="background:  url('/HIS/hisglobal/eDesk/transactions/MetroJs/images/trans-black-50.png') repeat scroll 0% 0% transparent">
								...
								<span class="getReport">Detail </span>
							</div>
						</div>						
					</div>
		</div>
				...
				<div class="live-tile roundedgreen" data-mode="slide" data-speed="600" data-stack="true" 
					data-start-now="false" data-delay="0" data-repeat="0" data-direction="vertical" style="width: 100%; height: 100%;" ondblclick="zoomInOutFun('test4');" >
						...
						<div>
							...
							<p>
								<a class="metroLargerLower fontBold" style="font-size: small; font: bold"><font color="#026702">Treatment</font></a>
							</p>
							</div>
