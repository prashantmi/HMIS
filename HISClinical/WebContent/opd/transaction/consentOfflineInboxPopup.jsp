...
<body onload="callOnLoadEvent(event)">
	<form action="/HISClinical/opd/consentOfflineInbox.cnt" method="post">
		...
		<his:statusTransactionInProcess>
			<his:ContentTag>
				<bean:define id="tempId" name="ConsentOfflineInboxFB" property="templateId" type="java.lang.String"></bean:define>
		...
		<html:hidden property="consentId" name="ConsentOfflineInboxFB" />
		<html:hidden property="consentHtmlCode" name="ConsentOfflineInboxFB" />
