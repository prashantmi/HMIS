...
<%@page import="opd.transaction.controller.fb.ICDEntryFormModFB"%>
...
<his:statusNew>
		...
		<table width="100%" cellpadding="0" cellspacing="1">
			...
			<tr>
				<td width="20%" class="tdfont">
					<div align="center">
						<html:text name="ICDEntryFormModFB" property="patCrNo" maxlength="<%=Config.CR_NO_FORMAT_SIZE%>" tabindex="1" size="15" 
				...
				<td width="80%" class="tdfonthead">
					<div align="left">
						...
						<img class="button" src='<his:path src="/hisglobal/images/GO.png"/>' style="cursor:pointer" tabindex="1" onclick ="submitFormOnValidate(validateSearch('<%=Config.CR_NO_FORMAT_SIZE%>'),'SEARCH')" onkeypress="if(event.keyCode==13) submitFormOnValidate(validateSearch('<%=Config.CR_NO_FORMAT_SIZE%>'),'SEARCH')">
						</font>	
					</div>
				</td>
			</tr>
	...
	<%
		...
		fbPage.setCurrentPage(((ICDEntryFormModFB)request.getAttribute("ICDEntryFormModFB")).getCurrentPage());
	...
	<table width="100%" cellpadding="0" cellspacing="0" border="0">
		...
		<table width="100%" cellpadding="0" cellspacing="1" border="0">
			<tr>
				...
				<td width="25%" class="tdfonthead" style="border-top:outset black 2px; border-bottom:inset black 2px;" valign="top" colspan="2">
					<div align="center">
						<b>
					...
					<tr>
						...
						<td width="5%" class="tdfont">
							<div align="center">
								...
								<%--<html:checkbox name="ICDEntryFormModFB" property="selectedPatCrNo" value="<%=voPatient.getPatCrNo() %>" onchange="<%=chkFun%>" ></html:checkbox>--%>
							...
							<div id="divICDHide#<%=voPatient.getPatCrNo()%>#<%=voPatient.getEpisodeCode()%>#<%=voPatient.getEpisodeVisitNo()%>" style="display: none;">
								<html:text name="ICDEntryFormModFB" property="selectedPatICD" value='<%=(voPatient.getPatDiagnosisDtl()!=null && !voPatient.getPatDiagnosisDtl().trim().equals(""))?voPatient.getPatDiagnosisDtl():""%>' disabled="true"/>
...
<his:ButtonToolBarTag>
		<his:statusNew>
			...
			<img class="button" src='<his:path src="/../HIS/hisglobal/images/buttons/btn-clr.png"/>' tabindex="1" style="cursor: pointer" onkeypress="if(event.keyCode==13) submitForm('MOD')" onclick="submitForm('MOD')">
		</his:statusNew>
...
<html:hidden name="ICDEntryFormModFB" property="hmode" value="NEW"/>
<html:hidden name="ICDEntryFormModFB" property="selectedPatLen"/>
<html:hidden name="ICDEntryFormModFB" property="currentPage"/>
<html:hidden name="ICDEntryFormModFB" property="orderBy"/>
<html:hidden name="ICDEntryFormModFB" property="tabMode"/>
