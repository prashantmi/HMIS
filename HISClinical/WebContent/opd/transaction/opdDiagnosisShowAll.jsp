				...
				<td class="tdfontheadExam" >
					<div align="center">
						<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>
							<%String str=((String) arrayPrevDiagnosis.getRemarks()==null?"No Remark":(String) arrayPrevDiagnosis.getRemarks()); %>
							<img class="button" src='<his:path src="/hisglobal/images/icon-vrf.png"/>' style='cursor:pointer' title="View Remark" 
							onclick="showRemarks('<%=str %>')" onkeypress="if(event.keyCode==13) showRemarks('<%=str %>');">								
						</font>	
					</div>
				</td>
			</tr>		
