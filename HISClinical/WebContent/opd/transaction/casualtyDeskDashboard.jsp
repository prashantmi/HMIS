...
function onLoadFun()
{
	...
	{
	//open_Tab(arrDeskMenuId[0],arrDeskMenuURL[0]);
	open_Tab_New(arrDeskMenuId[0],arrDeskMenuName[0],arrDeskMenuURL[0]);
	}
}
				...
				<div class="live-tile roundeddarkgreen" data-mode="slide" data-speed="600" data-stack="true" 
					data-start-now="false" data-delay="0" data-repeat="0" data-direction="vertical" style="width: 100%; height: 100%;" ondblclick="zoomInOutFun('test0');">
						...
						<div id="visitSummaryId">
							...
							<p style="color: black">								
								<a onclick="patientSummaryTab();" class="metroLargerLower fontBold" href="#" style="font-size: small; font: bold"><font color="#25ba33">Visit Summary</font></a>															
