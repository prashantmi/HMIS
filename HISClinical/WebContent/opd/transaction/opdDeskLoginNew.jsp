...
<html>
<form id="opdDeskLoginForm" action="/HISClinical/opd/opdDeskLogin.cnt"
	...
	<his:statusInProcess>
		<table width="100%" cellpadding="0" cellspacing="0">
			<tr>
				...
				<logic:equal name="OpdDeskLoginFb" property="showRommList" value="1">
			...
			<tr>
				...
				<div align="center"><font color="#000000" size="2"
					...
					name="OpdDeskLoginFb" property="departmentUnitCode" tabindex="1"
					styleClass="comboList" onchange="submitOpdLogin('GETDESK');">
				...
				<logic:equal name="OpdDeskLoginFb" property="showRommList" value="1">
					...
					<div align="center"><font color="#000000" size="2"
						face="Verdana, Arial, Helvetica, sans-serif"> <html:select
						name="OpdDeskLoginFb" property="roomCode" tabindex="1"
...
</his:ContentTag> <his:status /> <html:hidden name="OpdDeskLoginFb" property="hmode" /> <html:hidden
	name="OpdDeskLoginFb" property="showRommList" /></form>
</html>
