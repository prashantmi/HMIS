	...
	<his:ContentTag>
		<table width="100%" border="0" cellspacing="1" cellpadding="0">
			...
			<tr>
				...
				<td class="tdfont">
					<div align="center">
						<img class="button" id="addButton" tabindex="1" style="cursor: pointer" src='<his:path src="/hisglobal/images/Pl_Green_Sqr.png"/>' title="Add Belonging Detail"
			...
			<logic:notEmpty name="<%=OpdConfig.PATIENT_BELONGING_MAP %>">
				<logic:iterate id="belongingMap" name="<%=OpdConfig.PATIENT_BELONGING_MAP %>" type="java.util.Map.Entry">
					...
					<tr>
						...
						<td class="tdfont">
							<div align="center">
								<img class="button" id="deleteButton" style="cursor: pointer" src='<his:path src="/hisglobal/images/Mi_Green_Sqr.png"/>'
