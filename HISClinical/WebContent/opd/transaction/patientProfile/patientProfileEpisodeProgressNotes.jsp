...
function validateDiagnosis()
{
	...
	if(!flag)
	{
		alert("Select At least One Progress Notes for Profile .. ");
		chks[i].focus();
		return false;
	} 
	return true;
...
{
		var str=document.getElementsByName("progNotesCheckFlag")[0].value;
...
<logic:notEmpty name="<%=OpdConfig.OPD_PATIENT_PROFILE_PROGRESS_NOTES_ARRAY%>" >
	<his:ContentTag>
		...
		<table width="100%" cellpadding="0" cellspacing="0">
			<logic:iterate id="doctorRoundDtlVO" name="<%=OpdConfig.OPD_PATIENT_PROFILE_PROGRESS_NOTES_ARRAY%>" indexId="id" type="hisglobal.vo.DoctorRoundDtlVO" >
				<tr>
					...
					<td width="75%"  class="tdfont">
						<div align="center"> 
							<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">          
								<bean:write name="doctorRoundDtlVO" property="progressNote" />
							</font>
						</div>
					</td>   
				</tr>
...
<html:hidden name="GenericPatientProfileFB" property="progNotesCheckFlag" />
