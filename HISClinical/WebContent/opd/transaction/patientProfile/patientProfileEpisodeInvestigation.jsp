...
{
		var str=document.getElementsByName("investigationCheckFlag")[0].value;
...
<his:SubTitleTag key="investigationDetail">
</his:SubTitleTag>

<logic:notEmpty name="<%=OpdConfig.OPD_PATIENT_PROFILE_EPISODEINVESTIGATIONVO_ARRAY%>" >
	<his:ContentTag>
					...
					<td width="32%"  class="tdfont">
						<div align="center"> 
							<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">          
								...
								<html:hidden name="GenericPatientProfileFB" property="resultStatus" value="<%=profileInvestigationVOs.getResultStatus()%>"/>
							</font>
						</div>
					</td>   
...
<html:hidden name="GenericPatientProfileFB"	property="investigationCheckFlag" />
