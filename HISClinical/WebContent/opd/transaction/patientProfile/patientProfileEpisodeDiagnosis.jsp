...
<logic:notEmpty name="<%=OpdConfig.OPD_PATIENT_PROFILE_EPISODEDIAGNOSISVO_ARRAY%>" >
	<his:ContentTag>
		...
		<table width="100%" cellpadding="0" cellspacing="0">
			<logic:iterate id="episodeDiagnosisVO" name="<%=OpdConfig.OPD_PATIENT_PROFILE_EPISODEDIAGNOSISVO_ARRAY%>" indexId="id" type="hisglobal.vo.EpisodeDiagnosisVO" >
				<tr>
				...
				<logic:notEqual name="GenericPatientProfileFB" property="deskType" value="<%=DynamicDeskConfig.DESK_TYPE_IPD_DOCTOR_DESK %>">
					<td width="15%"  class="tdfont">
						<div align="center">
							<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
								<bean:write name="episodeDiagnosisVO" property="episodeDate" />
							</font>
						</div>
					</td>   
					</logic:notEqual>
					...
					<td width="20%"  class="tdfont">
						<div align="center">
							<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
								<bean:write name="episodeDiagnosisVO" property="remarks" />
							</font>
						</div>
					</td>   
				</tr>
