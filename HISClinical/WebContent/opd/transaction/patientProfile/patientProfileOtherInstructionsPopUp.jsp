...
{
	var path='/HISClinical/opd/opdPatientProfile.cnt?hmode=ALLINSTRUCTION';
	//alert("path "+path);
...
{
	var path='/HISClinical/opd/opdPatientProfile.cnt?hmode=DEPTWISEINSTRUCTION';
	//alert("path "+path);
	child = window.open(createFHashAjaxQuery(path),'popupWindow','status=yes,scrollbars=yes,height='+200+',width='+500+',left=10,top=10');  
	child.moveTo(250,250);
	child.focus(); 
...
<html:form action="/opdPatientProfile">
	<body >
		...
		<table  width="100%" border="0" cellspacing="1" cellpadding="0" >
			...
			<tr>
				...
				<td width="90%" class="tdfont">
						<div align="left">
							<%=entryObj.getLabel() %>
							<html:hidden name="GenericPatientProfileFB" property="otherInstruction" value="<%=entryObj.getLabel() %>"/>
						</div>
					</td>
		...
		<table  width="100%" border="0" cellspacing="1" cellpadding="0" >
			...
			<tr>
				...
				<td width="90%" class="tdfont">
						<div align="left">
							<%=entryObj.getLabel() %>
							<html:hidden name="GenericPatientProfileFB" property="activityExt" value="<%=entryObj.getLabel() %>"/>
						</div>
					</td>
		...
		<his:ButtonToolBarTag>
			<img class="button" src='<his:path src="/hisglobal/images/btn-ok.png"/>'  style=cursor:pointer tabindex="1" onclick ="submitPage('SAVEOTHERINSTRUCTION')" onkeypress="if(event.keyCode==13) submitPage('SAVEOTHERINSTRUCTION')">
