...
{
		var str=document.getElementsByName("genericCheckFlag")[0].value;
		//alert(">>>>>."+str)
		var arr=str.split("#");
		var chks=document.getElementsByName('selectedRow');
		//alert(chks.length)
...
<logic:notEmpty name="<%=OpdConfig.OPD_PATIENT_PROFILE_ALERTSVO_ARRAY%>" >
	<his:ContentTag>
		...
		<table width="100%" cellpadding="0" cellspacing="0">
			<logic:iterate id="patAlertsDetailVO" name="<%=OpdConfig.OPD_PATIENT_PROFILE_ALERTSVO_ARRAY%>" indexId="id" type="hisglobal.vo.PatientAlertsDetailVO" >
				<tr>
					...
					<td width="15%"  class="tdfont">
						<div align="center">	           
							<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
								<bean:write name="patAlertsDetailVO" property="alertName" />
							</font>
						</div>
					</td>
					<td width="20%"  class="tdfont">
						<div align="center">	           
							<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
								<bean:write name="patAlertsDetailVO" property="durationDays" />
							</font>
						</div>
					</td>
					<td width="20%"  class="tdfont">
						<div align="center">	   
							<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
								<bean:write name="patAlertsDetailVO" property="remarks" />
							</font>
						</div>
					</td>
...
<html:hidden name="GenericPatientProfileFB" property="genericCheckFlag" />
