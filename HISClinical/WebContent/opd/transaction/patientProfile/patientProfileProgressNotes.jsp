...
<logic:notEmpty name="<%=OpdConfig.OPD_PATIENT_PROFILE_PROGRESS_NOTES_ARRAY%>" >
	<his:ContentTag>
		...
		<table width="100%" cellpadding="0" cellspacing="0">
			<logic:iterate id="doctorRoundDtlVO" name="<%=OpdConfig.OPD_PATIENT_PROFILE_PROGRESS_NOTES_ARRAY%>" indexId="i" type="hisglobal.vo.DoctorRoundDtlVO" >
				<tr>
					<td width="5%"  class="tdfont">
						<div align="center">	           
							<html:checkbox name="GenericPatientProfileFB" property="selectedRow" value="<%=doctorRoundDtlVO.getProgressNote()%>" ></html:checkbox>
						</div>
					</td>  
					<td width="20%"  class="tdfont" nowrap="nowrap">
						<div align="center">	           
							<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
								<bean:write name="doctorRoundDtlVO" property="roundTime" />
							</font>
						</div>
					</td>
					<td width="75%"  class="tdfont">
						...
						<div id="divProgNotesId" style="display: none;">
							<html:textarea name="GenericPatientProfileFB" property="hiddenProgNotes" rows="5" cols="130"  value="<%=doctorRoundDtlVO.getProgressNote()%>"></html:textarea>
						</div>
					</td>
