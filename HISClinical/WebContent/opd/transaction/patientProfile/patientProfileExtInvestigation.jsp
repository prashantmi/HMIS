...
function validateDiagnosis()
{
	...
	if(!flag)
	{
		alert("Select At least One External Investigation for Profile .. ");
		chks[i].focus();
		return false;
	} 
	return true;
...
{
		var str=document.getElementsByName("extInvCheckFlag")[0].value;
...
<his:SubTitleTag key="extInvDetail">
</his:SubTitleTag>

<logic:notEmpty name="<%=OpdConfig.OPD_PATIENT_PROFILE_EPISODE_EXT_INVESTIGATION_VO_ARRAY%>" >
	<his:ContentTag>
				...
				<td width="15%"  class="tdfonthead">
					<div align="center">	           
						<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
							<b><bean:message key="recordDate"/></b>
						</font>
					</div>
				</td>
		...
		<table width="100%" cellpadding="0" cellspacing="0">
			<logic:iterate id="extInvVO" name="<%=OpdConfig.OPD_PATIENT_PROFILE_EPISODE_EXT_INVESTIGATION_VO_ARRAY%>" indexId="id" type="hisglobal.vo.EpisodeExtInvDtlVO" >
				<tr>
					...
					<td width="15%"  class="tdfont">
						<div align="center">
							<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
								<bean:write name="extInvVO" property="recordDate" />
							</font>
						</div>
					</td>   
					<td width="20%"  class="tdfont">
						<div align="center"> 
							<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">          
								<bean:write name="extInvVO" property="paraName" />
							</font>
						</div>
					</td>   
					<td width="20%"  class="tdfont">
						<div align="center">
							<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">	           
								<bean:write name="extInvVO" property="paraValue" />
							</font>
						</div>
					</td>   
				</tr>
...
<html:hidden name="GenericPatientProfileFB" property="extInvCheckFlag" />
