			...
			<logic:notEmpty name="<%=OpdConfig.PAT_TREATMENT_DTL_TODAY_REST_DETAIL_LIST%>">
				...
				<tr>
					...
					<td width="10%" class="tdfont">
						<div align="left">
							<html:text name="PatientTreatmentDetailFB" property="restDays" onkeypress="return validateIntegerOnly(this,event)" maxlength="2" size="4" value="<%=restDtlVO.getDays() %>" tabindex="1"></html:text>
						</div>
					</td>
				...
				<tr>
					...
					<td width="25%" class="tdfont" colspan="3">
						...
						<font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif">	
							<html:textarea name="PatientTreatmentDetailFB" property="restReason" rows="3" cols="69" value="<%=restDtlVO.getRestReason() %>" onkeypress="return validateAlphaNumOnly(this,event) && CheckMaxLength(event,this,100,3)" tabindex="1"></html:textarea>
			 ...
			 <logic:empty name="<%=OpdConfig.PAT_TREATMENT_DTL_TODAY_REST_DETAIL_LIST%>">
			 	<tr>
					...
					<td width="10%" class="tdfont">
						<div align="left">
							<html:text name="PatientTreatmentDetailFB" property="restDays" onkeypress="return validateIntegerOnly(this,event)" maxlength="2" size="4" tabindex="1"></html:text>
						</div>
					</td>
					<td width="25%" class="tdfonthead">
						<div align="right">
			 	...
			 	<tr>
					...
					<td class="tdfont" colspan="3">
						<div align="left">
						<font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif">
							<html:textarea name="PatientTreatmentDetailFB" property="restReason" rows="3" cols="69" tabindex="1" onkeypress="return validateAlphaNumOnly(this,event) && CheckMaxLength(event,this,100,3)"></html:textarea>
