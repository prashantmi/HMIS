...
<his:ButtonToolBarTag>
	<img class="button" src='<his:path src="/../HIS/hisglobal/images/buttons/btn-ccl.png"/>' style="cursor:pointer" onclick ="submitForm21('TEMPREPORT');" onkeypress="if(event.keyCode==13) submitForm21('TEMPREPORT');" >
</his:ButtonToolBarTag>
