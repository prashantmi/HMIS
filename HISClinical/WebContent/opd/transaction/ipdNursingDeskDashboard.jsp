...
var arrDeskMenuId = ["0","11"];
var arrDeskMenuURL = ["PATIENTSUMMARY","REQUISITIONRAISING"];
var arrDeskMenuName = ["Patient Summary","Investigation Order"];
...
function zoomIn()
{
	...
	document.getElementById("test0").style.width = "33%";
	
	document.getElementById("test1").style.height = "40%";
	document.getElementById("test1").style.width = "34%";
	
	document.getElementById("test5").style.height = "82%";
	document.getElementById("test5").style.width = "33%";
}

function onLoadFun()
{
	<!-- // added by manisha gangwar for alert on nursing dashboard for zero balance -->
	//alert("hi");
...
<div style="margin-top: 1px; width: 99%; overflow: hidden" class="wrapper rounded">
	...
	<div><jsp:include page="<%=url%>" flush="true"></jsp:include></div>		
		...
		<%-- <% String admissionSummaryUrl = "/opd/ipdNursingDeskDashboard.cnt?hmode="+"ADMISSION_DETAIL"+"&patCrNo="+crno+"&episodeVisitNo="+episodevisitno+"&episodeCode="+episodecode;  %>
		<% String diagnosisUrl = "/opd/ipdNursingDeskDashboard.cnt?hmode="+"DIAGNOSIS_DETAIL"+"&patCrNo="+crno+"&episodeVisitNo="+episodevisitno+"&episodeCode="+episodecode;  %>
		<% String treatmentUrl = "/opd/ipdNursingDeskDashboard.cnt?hmode="+"TREATMENT_DETAIL"+"&patCrNo="+crno+"&episodeVisitNo="+episodevisitno+"&episodeCode="+episodecode;  %>
		<% String medicalHistoryUrl = "/opd/ipdNursingDeskDashboard.cnt?hmode="+"MEDICAL_HISTORY"+"&patCrNo="+crno+"&episodeVisitNo="+episodevisitno+"&episodeCode="+episodecode;  %> --%>
		...
		<% String investigationDetailUrl = "/opd/ipdNursingDeskDashboard.cnt?hmode="+"INVESTIGATION_DETAIL"+"&patCrNo="+crno+"&episodeVisitNo="+episodevisitno+"&episodeCode="+episodecode+"&patAdmNo="+patadmno;  %>

	<div id="mainDeskDiv11" align="center" style="display: block;">	 
		
		<table width="99%" height="80%" border=0>
			<tr>
				<td id="test0"  width="33%" height="80%">
			...
			<td id="test1" width="34%" height="80%">
		<div class="tiles white" align="center" style="width: 100%; height: 100%;">					
			...
			<td id="test5" width="33%" height="80%" rowspan="2">
		<div class="tiles white" align="center" style="width: 100%; height: 100%;">			
				<div  class="live-tile roundedblue" data-mode="slide" data-speed="600" data-stack="true"
					data-start-now="false" data-delay="0" data-repeat="0" data-direction="vertical" style="width: 100%; height: 100%;" ondblclick="zoomInOutFun('test5');">
						...
						<div>
							...
							<p>								
								<a class="metroLargerLower fontBold" style="font-size: small; font: bold"><font color="#017299">Medical History</font></a>
							</p>
							</div>
