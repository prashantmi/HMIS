...
function GUI_CLASS() {
	...
	this.draw_helpers = function () {
		...
		for (var i in DRAW_TOOLS_CONFIG) {
			...
			html += ' style="background: #989890 url(\'/HISClinical/opd/transaction/miniPaint-master/img/' + DRAW_TOOLS_CONFIG[i].icon[0] + '\') no-repeat ' + DRAW_TOOLS_CONFIG[i].icon[1] + 'px ' + DRAW_TOOLS_CONFIG[i].icon[2] + 'px;"';
