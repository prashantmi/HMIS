function moveRightSingle(listNo)
{
	...
	if(listNo=="1")
	{
		source  = document.forms[0].deptUnitCode;
		target = document.forms[0].selectedDeptUnitCode;	
	}
...
function moveLeftSingle(listNo)
{
	...
	if(listNo=="1")
	{
		target  = document.forms[0].deptUnitCode;
		source = document.forms[0].selectedDeptUnitCode;	
	}
...
function MoveToSelected()
{
	...
	if(document.forms[0].selectedDeptUnitCode)
		for(var i=0;i<document.forms[0].selectedDeptUnitCode.length;i++)
			document.forms[0].selectedDeptUnitCode.options[i].selected=true;
	
	// Unselect Remaining 
	if(document.forms[0].deptUnitCode)
	{	
		for(var i=0;i<document.forms[0].deptUnitCode.options.length;i++)
			document.forms[0].deptUnitCode.options[i].selected=false;
	}
}
...
function getFetchedList(){
	...
	var fetchedList=document.forms[0].selectedDeptUnitCode;
