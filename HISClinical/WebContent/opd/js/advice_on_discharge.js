...
function setValues()
{
	if(selectIndexVal!=null && selectIndexVal!=-1 && selectedRowIndex!=null)
	{
		...
		//alert(elemDrugId.value);
		sendDataForDrugRouteList(elemDrugId.value,selectedRowIndex);	
							...
							for (var i = 0; i < obj.length; i++) {
								...
								for(var j=0;j<tr.childNodes.length;j++)
									...
									{	
										...
										if(i==4 && obj[i].msg!='' )  fontcolor="#FF0000";     // for drug pregnancy allergic alert
								
									//	$('#divSummary').html(obj[i].msg);
