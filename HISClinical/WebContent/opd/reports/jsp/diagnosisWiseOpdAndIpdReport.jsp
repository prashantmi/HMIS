...
function diagnosisWiseOpdAndIpdReportHandler()
{
	success=false;
	if(document.getElementsByName('choice')[0].checked){
    	document.getElementsByName('jrxmlName')[0].value="<%=OpdConfig.DIAGNOSIS_WISE_OPD_AND_IPD_TODAY%>";
    }else{
    		document.getElementsByName('jrxmlName')[0].value="<%=OpdConfig.DIAGNOSIS_WISE_OPD_AND_IPD_DATEWISE%>";
    }
	document.getElementsByName('strDiagnosisName')[0].value=document.getElementsByName('strDiagnosisCode')[0].options[document.getElementsByName('strDiagnosisCode')[0].selectedIndex].text;
...
<his:TitleTag name="Diagnosis Wise Opd And Ipd Report">
</his:TitleTag>
		...
		<logic:equal name="diagnosisWiseOpdAndIpdReportFB" property="choice" value="<%=Config.CHOICE_TODAY%>">
             <%
		...
		<logic:equal name="diagnosisWiseOpdAndIpdReportFB" property="choice" value="<%=Config.CHOICE_DATE_WISE%>">
		        <%     
		        	   fromDateLabel="" ;
		               toDateLabel="" ;
		               fromDateControl="" ;
	   ...
	   <bean:define name="diagnosisWiseOpdAndIpdReportFB" property="fromDate" id="frDate" type="java.lang.String"/>
	   <bean:define name="diagnosisWiseOpdAndIpdReportFB" property="toDate" id="tDate" type="java.lang.String"/>          
	   <%
	...
	<table width="100% cellspacing="1" cellpadding="0">
		<tr>            
 			<td class="tdfonthead" nowrap width="25%">       	      
		    	<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
		      		...
		      		<html:radio name="diagnosisWiseOpdAndIpdReportFB" property="choice" tabindex="1" value="<%=Config.CHOICE_TODAY%>" onclick="showdivtoday()"/>
		        <font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
		       		<bean:message key="dateWise"/>
		       	</font> 
		        	<html:radio name="diagnosisWiseOpdAndIpdReportFB" property="choice" tabindex="1" value="<%=Config.CHOICE_DATE_WISE%>" onclick="showdivdatewise()"/>
			</td> 
			<td width="25%" class="tdfonthead" colspan="3"></td>
		</tr>
		...
		<tr>
			...
			<td class="tdfont" width="25%">
	    		<div id='divfromDateControl' style='<%=fromDateControl %>'align="left">	               		 
		 		...
		 		<span id='divfromhrcontrol' style='<%=fromControl %>'align="left">	            
		   			<html:text name="diagnosisWiseOpdAndIpdReportFB" tabindex="1" property="fromHour"  maxlength="2" size="3"  onkeydown="setPreviosValue(this, event)" onkeyup="moveToRightBox(this, event)" onkeypress="return validateNumeric(event)" />	
		  			 <b>	<bean:message key="colon"/></b>
				</span>
		 		<span id='divfromMinControl' style='<%=fromControl %>' align="left">         
					<html:text name="diagnosisWiseOpdAndIpdReportFB" tabindex="1" property="fromMin"   maxlength="2" size="3" onkeydown="setPreviosValue(this, event)" onkeyup="moveToRightBox(this, event)" onkeypress="return validateNumeric(event)"/>				
			...
			<td class="tdfont" width="25%">
		 		<div id='divtoDateControl' style='<%=toDateControl %>' align="left">    
    	  		...
    	  		<span id='divtohrcontrol' style='<%=toControl%>' align="left">	            
		   			<html:text name="diagnosisWiseOpdAndIpdReportFB" tabindex="1" property="toHour"  maxlength="2" size="3" onkeydown="setPreviosValue(this, event)" onkeyup="moveToRightBox(this, event)" onkeypress="return validateNumeric(event)"/>	
	   				<b><bean:message key="colon"/>	  </b>
				</span>
		 		<span id='divtoMinControl' style='<%=toControl%>' align="left">         
					<html:text name="diagnosisWiseOpdAndIpdReportFB" tabindex="1" property="toMin" maxlength="2" size="3"  onkeydown="setPreviosValue(this, event)" onkeyup="moveToRightBox(this, event)" onkeypress="return validateNumeric(event)"/>				
						<bean:message key="timeFormat"/>	  
    	 		</span>
			</td>                 			
 		</tr>
 		...
 		<tr>
 			...
 			<td class="tdfont" width="25%">
					<div >
					<html:select name="diagnosisWiseOpdAndIpdReportFB" property="multipleHospitalCode" tabindex="1"   multiple="true" size="5" style="width: 150px;">
				...
				<td class="tdfonthead">
	      			<div id ="consultantLabel"  align="right"  style='<%=deptlabel%>'>
			        	<font color="#FF0000" size="1" face="Verdana, Arial, Helvetica, sans-serif\">*</font>
			            <font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
					  		Diagnosis
					  </font>
	    		...
	    		<td class="tdfont">
						...
						<div id="divDiseaseNameCodeList" >
							<select name="strDiagnosisCode" tabindex="1" style="width: 100px;">
	...
	<table width="100%" cellspacing="1" cellpadding="0">
    	<tr>       
        	...
        	<td width="25%" class="tdfont" > 
	        	<html:select name="diagnosisWiseOpdAndIpdReportFB"  property="graphOrText" tabindex="1" styleClass="regcbo" >
        	...
        	<td width="25%" class="tdfont">
        		<html:select name="diagnosisWiseOpdAndIpdReportFB" property="reportType" tabindex="1" styleClass="regcbo">
					<html:option value="-1">Select Value</html:option>        	
...
<input type="hidden"  name="mode" value="DIAGNOSISWISEOPDANDIPDREPORT">
<html:hidden name="diagnosisWiseOpdAndIpdReportFB" property="jrxmlPath" value="<%=OpdConfig.OPD_JRXML_PATH%>"/>
<html:hidden name="diagnosisWiseOpdAndIpdReportFB" property="jrxmlName" value="<%=OpdConfig.DIAGNOSIS_WISE_OPD_AND_IPD_TODAY%>"/>
<html:hidden name="diagnosisWiseOpdAndIpdReportFB" property="sysDate" value="<%=tDate%>"/>
<html:hidden name="diagnosisWiseOpdAndIpdReportFB" property="strDiagnosisName" />
