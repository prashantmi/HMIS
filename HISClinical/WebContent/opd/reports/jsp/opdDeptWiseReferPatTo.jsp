...
function OpdDeptWiseRefPatToReportHandler()
{
	if(document.getElementsByName('choice')[0].checked)
	{
    	document.getElementsByName('jrxmlName')[0].value="<%=OpdConfig.OPD_DEPT_WISE_REFER_PAT_TO_TODAY%>";
	}
	else
	{
		document.getElementsByName('jrxmlName')[0].value="<%=OpdConfig.OPD_DEPT_WISE_REFER_PAT_TO_DATEWISE%>";         
	}
	success=false;
    ...
    { 
	  ...
	  return success;
}//end of function OpdDeptWiseRefPatToReportHandler() 
		

</script>

<his:TitleTag name="Department Wise Patient Referral Detail To" >
</his:TitleTag>
         ...
         <%
              ...
              String toControl="" ; 
         %>
          <logic:equal name="opdDeptWiseReferPatToFB" property="choice" value="<%=Config.CHOICE_TODAY%>">
             <%
      ...
      <logic:equal name="opdDeptWiseReferPatToFB" property="choice" value="<%=Config.CHOICE_DATE_WISE%>">
        <%     fromDateLabel="" ;
               toDateLabel="" ;
               fromDateControl="" ;
               toDateControl="" ;
       ...
       <bean:define name="opdDeptWiseReferPatToFB" property="fromDate" id="frDate" type="java.lang.String"/>
	   <bean:define name="opdDeptWiseReferPatToFB" property="toDate" id="tDate" type="java.lang.String"/>          
	   <%
...
<his:ContentTag>	
	<table width="100% cellspacing="1" cellpadding="0">
		<tr>            
 			<td class="tdfonthead" nowrap width="25%">       	      
		    	<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
		      		...
		      		<html:radio name="opdDeptWiseReferPatToFB" property="choice" tabindex="1" value="<%=Config.CHOICE_TODAY%>" onclick="showdivtoday()"/> 
		        <font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
		       		<bean:message key="dateWise"/></font> 
		        	<html:radio name="opdDeptWiseReferPatToFB" property="choice" tabindex="1" value="<%=Config.CHOICE_DATE_WISE%>" onclick="showdivdatewise()"/>
			</td> 
 		</tr>
 		<tr>
 			...
 			<td class="tdfont" width="25%">
	    		<div id='divfromDateControl' style='<%=fromDateControl %>'align="left">	               		 
		 		...
		 		<span id='divfromhrcontrol' style='<%=fromControl %>'align="left">	            
		   			<html:text name="opdDeptWiseReferPatToFB" tabindex="1" property="fromHour"  maxlength="2" size="3"  onkeydown="setPreviosValue(this, event)" onkeyup="moveToRightBox(this, event)" onkeypress="return validateNumeric(event)" />	
		  			 <b>	<bean:message key="colon"/></b>
				</span>
		 		<span id='divfromMinControl' style='<%=fromControl %>' align="left">         
					<html:text name="opdDeptWiseReferPatToFB" tabindex="1" property="fromMin"   maxlength="2" size="3" onkeydown="setPreviosValue(this, event)" onkeyup="moveToRightBox(this, event)" onkeypress="return validateNumeric(event)"/>				
			...
			<td class="tdfont" width="25%">
		 		<div id='divtoDateControl' style='<%=toDateControl %>' align="left">    
    	  		...
    	  		<span id='divtohrcontrol' style='<%=toControl%>' align="left">	            
		   			<html:text name="opdDeptWiseReferPatToFB" tabindex="1" property="toHour"  maxlength="2" size="3" onkeydown="setPreviosValue(this, event)" onkeyup="moveToRightBox(this, event)" onkeypress="return validateNumeric(event)"/>	
	   				<b><bean:message key="colon"/>	  </b>
				</span>
		 		<span id='divtoMinControl' style='<%=toControl%>' align="left">         
					<html:text name="opdDeptWiseReferPatToFB" tabindex="1" property="toMin" maxlength="2" size="3"  onkeydown="setPreviosValue(this, event)" onkeyup="moveToRightBox(this, event)" onkeypress="return validateNumeric(event)"/>				
						<bean:message key="timeFormat"/>	  
    	 		</span>
			</td>                 			
		</tr>
		<tr>
			...
			<td class="tdfont" width="25%">
				<div align="left">
					<html:select name="opdDeptWiseReferPatToFB"  property="departmentCode"  tabindex="1"  styleClass ="regcbo">
	...
	<table width="100%" cellspacing="1" cellpadding="0">
    	<tr>       
        	...
        	<td width="25%" class="tdfont" > 
	        	<html:select name="opdDeptWiseReferPatToFB"  property="graphOrText" tabindex="1" styleClass="regcbo" >
        	...
        	<td width="25%" class="tdfont">
        		<html:select name="opdDeptWiseReferPatToFB" property="reportType" tabindex="1" styleClass="regcbo">
					<html:option value="-1">Select Value</html:option>        	
...
<input type="hidden"  name="mode" value="OPDDEPTWISEREFERPATTOREPORT">
<html:hidden name="opdDeptWiseReferPatToFB"property="jrxmlPath" value="<%=OpdConfig.OPD_JRXML_PATH %>"/>
<html:hidden name="opdDeptWiseReferPatToFB" property="jrxmlName" />
<html:hidden name="opdDeptWiseReferPatToFB" property="sysDate" value="<%=tDate%>"/>
