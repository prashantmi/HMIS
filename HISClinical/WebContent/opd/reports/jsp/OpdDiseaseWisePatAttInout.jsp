...
<script>
	...
	function opdDiseaseWiseNoOfPatAttendedInOutReportHandler()
	{
		
		
		success=false;
		document.getElementsByName('jrxmlName')[0].value="<%=OpdConfig.OPD_DISEASE_WISE_PAT_IN_OUT%>";
		...
		return success;
	}//end of function broughtDeathPatientListingReportHandler()

</script>

<his:TitleTag name="Disease Wise Number of Patients (Indoor and Outdoor) ">
</his:TitleTag>
      ...
      <bean:define name="opdDiseaseWisePatAttnddInOutFB" property="fromDate" id="frDate" type="java.lang.String"/>
	   <bean:define name="opdDiseaseWisePatAttnddInOutFB" property="toDate" id="tDate" type="java.lang.String"/>          
	   <%
			...
			<!-- New Change add Hospital Combo -->
		      <td width="25%" class="tdfonthead">
				...
				<td class="tdfont" width="25%">
					<div >
					<html:select name="opdDiseaseWisePatAttnddInOutFB" property="multipleHospitalCode" tabindex="1" multiple="true" size="4">
	...
	<table width="100%" cellspacing="1" cellpadding="0">
    	<tr>       
        	...
        	<td width="25%" class="tdfont" > 
	        	<html:select name="opdDiseaseWisePatAttnddInOutFB"  property="graphOrText" tabindex="1" styleClass="regcbo" >
        	...
        	<td width="25%" class="tdfont">
        		<html:select name="opdDiseaseWisePatAttnddInOutFB" property="reportType" tabindex="1" styleClass="regcbo">
					<html:option value="-1">Select Value</html:option>        	
...
<html:hidden name="opdDiseaseWisePatAttnddInOutFB" property="reportMode" />
<html:hidden name="opdDiseaseWisePatAttnddInOutFB" property="mode" value="OPDDISEASEWISENOOFPATATTENDINOUTREPORT" />
<html:hidden name="opdDiseaseWisePatAttnddInOutFB" property="jrxmlName"/>
<html:hidden name="opdDiseaseWisePatAttnddInOutFB" property="sysDate" value="<%=tDate%>"/>
<html:hidden name="opdDiseaseWisePatAttnddInOutFB" property="choice" value="<%=Config.CHOICE_DATE_WISE%>" onclick="showdivdatewise()"/>
<html:hidden name="opdDiseaseWisePatAttnddInOutFB" property="jrxmlPath" value="<%=OpdConfig.OPD_JRXML_PATH%>"/>
