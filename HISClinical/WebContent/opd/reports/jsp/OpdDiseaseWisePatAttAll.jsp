...
<%@ page
	import="java.util.*,registration.*,mrd.*,hisglobal.presentation.*"%>
...
<script>
	...
	function opdDiseaseWiseNoOfPatAttendedReportHandler()
	{
		
		
		success=false;
		document.getElementsByName('jrxmlName')[0].value="<%=OpdConfig.OPD_DISEASE_WISE_PAT_ALL%>";
...
<his:TitleTag name="Disease Wise Number of Patients (All) ">
</his:TitleTag>
...
<bean:define name="opdDiseaseWisePatAttnddFB" property="fromDate"
	id="frDate" type="java.lang.String" />
<bean:define name="opdDiseaseWisePatAttnddFB" property="toDate"
	...
	<table width="100% cellspacing=" 1" cellpadding="0">
		<tr>
			...
			<div align="right"><font color="#FF0000" size="1"
				...
				key="hospital" /> </font></div>
			</td>

			<td class="tdfont" width="25%">
			<div><html:select name="opdDiseaseWisePatAttnddFB"
				property="multipleHospitalCode" tabindex="1" multiple="true"
				size="4">
				<html:option value="0">All</html:option>
				<logic:present name="<%=RegistrationConfig.HOSPITAL_COMBO_LIST%>">
					<html:options
						collection="<%=RegistrationConfig.HOSPITAL_COMBO_LIST%>"
	...
	<table width="100%" cellspacing="1" cellpadding="0">
		<tr>
			...
			<td width="25%" class="tdfont"><html:select
				name="opdDiseaseWisePatAttnddFB" property="graphOrText" tabindex="1"
				styleClass="regcbo">
			...
			<td width="25%" class="tdfont"><html:select
				name="opdDiseaseWisePatAttnddFB" property="reportType" tabindex="1"
				styleClass="regcbo">
				<html:option value="-1">Select Value</html:option>
...
<html:hidden name="opdDiseaseWisePatAttnddFB" property="reportMode" />
<html:hidden name="opdDiseaseWisePatAttnddFB" property="mode"
	value="OPDDISEASEWISENOOFPATATTENDALLREPORT" />
<html:hidden name="opdDiseaseWisePatAttnddFB" property="jrxmlName" />
<html:hidden name="opdDiseaseWisePatAttnddFB" property="sysDate"
	value="<%=tDate%>" />
<html:hidden name="opdDiseaseWisePatAttnddFB" property="choice"
	value="<%=Config.CHOICE_DATE_WISE%>" onclick="showdivdatewise()" />
<html:hidden name="opdDiseaseWisePatAttnddFB" property="jrxmlPath"
