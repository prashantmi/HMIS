...
function opdDeptUnitEpisodeStatusPatListReportHandler()
{
	if(document.getElementsByName('choice')[0].checked)
	{
    	document.getElementsByName('jrxmlName')[0].value="<%=OpdConfig.OPD_DEPT_UNIT_EPISODE_STATUS_PAT_LIST_TODAY%>";
	}
	else
	{
		document.getElementsByName('jrxmlName')[0].value="<%=OpdConfig.OPD_DEPT_UNIT_EPISODE_STATUS_PAT_LIST_DATEWISE%>";         
	}
	...
	if(document.getElementsByName('episodeStatus')[0].value==-1 )
	{
		alert("Select the Episode Status");
		document.getElementsByName('episodeStatus')[0].focus();
		return false;
	}
	...
	return success;
}//end of function opdDeptUnitEpisodeStatusPatListReportHandler()

</script>

<his:TitleTag name="Listing of Patient Episode in Departments">
</his:TitleTag>
...
<logic:equal name="opdDeptUnitEpisodeStatusPatListFB" property="choice" value="<%=Config.CHOICE_TODAY%>">
             <%
...
<logic:equal name="opdDeptUnitEpisodeStatusPatListFB" property="choice" value="<%=Config.CHOICE_DATE_WISE%>">
        <%     
        	   fromDateLabel="" ;
               toDateLabel="" ;
               fromDateControl="" ;
      ...
      <bean:define name="opdDeptUnitEpisodeStatusPatListFB" property="fromDate" id="frDate" type="java.lang.String"/>
	   <bean:define name="opdDeptUnitEpisodeStatusPatListFB" property="toDate" id="tDate" type="java.lang.String"/>          
	   <%
		...
		<tr>            
 			<td class="tdfonthead" nowrap width="25%">       	      
		    	<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
		      		...
		      		<html:radio name="opdDeptUnitEpisodeStatusPatListFB" property="choice" tabindex="1" value="<%=Config.CHOICE_TODAY%>" onclick="showdivtoday()"/>
		        <font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
		       		<bean:message key="dateWise"/>
		       	</font> 
		        	<html:radio name="opdDeptUnitEpisodeStatusPatListFB" property="choice" tabindex="1" value="<%=Config.CHOICE_DATE_WISE%>" onclick="showdivdatewise()"/>
			</td> 
 		</tr>
 		<tr>
			...
			<td class="tdfont" width="25%">
	    		<div id='divfromDateControl' style='<%=fromDateControl %>'align="left">	               		 
		 		...
		 		<span id='divfromhrcontrol' style='<%=fromControl %>'align="left">	            
		   			<html:text name="opdDeptUnitEpisodeStatusPatListFB" tabindex="1" property="fromHour"  maxlength="2" size="3"  onkeydown="setPreviosValue(this, event)" onkeyup="moveToRightBox(this, event)" onkeypress="return validateNumeric(event)" />	
		  			 <b>	<bean:message key="colon"/></b>
				</span>
		 		<span id='divfromMinControl' style='<%=fromControl %>' align="left">         
					<html:text name="opdDeptUnitEpisodeStatusPatListFB" tabindex="1" property="fromMin"   maxlength="2" size="3" onkeydown="setPreviosValue(this, event)" onkeyup="moveToRightBox(this, event)" onkeypress="return validateNumeric(event)"/>				
			...
			<td class="tdfont" width="25%">
		 		<div id='divtoDateControl' style='<%=toDateControl %>' align="left">    
    	  		...
    	  		<span id='divtohrcontrol' style='<%=toControl%>' align="left">	            
		   			<html:text name="opdDeptUnitEpisodeStatusPatListFB" tabindex="1" property="toHour"  maxlength="2" size="3" onkeydown="setPreviosValue(this, event)" onkeyup="moveToRightBox(this, event)" onkeypress="return validateNumeric(event)"/>	
	   				<b><bean:message key="colon"/>	  </b>
				</span>
		 		<span id='divtoMinControl' style='<%=toControl%>' align="left">         
					<html:text name="opdDeptUnitEpisodeStatusPatListFB" tabindex="1" property="toMin" maxlength="2" size="3"  onkeydown="setPreviosValue(this, event)" onkeyup="moveToRightBox(this, event)" onkeypress="return validateNumeric(event)"/>				
						<bean:message key="timeFormat"/>	  
    	 		</span>
			</td>                 			
 		</tr>
 		<tr>
    		...
    		<td class="tdfont">
       			<div id="deptControl" align="left"  style='<%=deptcontrol%>'>
     		 		<html:select name="opdDeptUnitEpisodeStatusPatListFB"  property="departmentCode"  tabindex="1"  styleClass ="regcbo" onchange="showUnit()">   
...
<his:statusTransactionInProcess>
    		...
    		<td class="tdfont">
    			<div id="unitControl" align="left" >
    				<html:select name="opdDeptUnitEpisodeStatusPatListFB"  property="unit"  tabindex="1"  styleClass ="regcbo" >
 		...
 		<tr>
 			<td class="tdfonthead" width="25%">
 				<div align="right">
 					<font color="#FF0000" size="1" face="Verdana, Arial, Helvetica, sans-serif\">*</font>
 					<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
 						<bean:message key="episodeStatus"/>
 					</font>
 				</div>
 			</td>
 			<td width="25%" class="tdfont">
        		<html:select name="opdDeptUnitEpisodeStatusPatListFB" property="episodeStatus" tabindex="1" styleClass="regcbo">
					<html:option value="-1">Select Value</html:option>        	
					<html:option value="<%=RegistrationConfig.EPISODE_ISOPEN_TRUE %>">Open</html:option>
					<html:option value="<%=RegistrationConfig.EPISODE_ISOPEN_FALSE %>">Close</html:option>
        		</html:select>
        	</td>
        	<td width="25%"></td>
        	<td width="25%"></td>
...
<his:ContentTag>
	<table width="100%" cellspacing="1" cellpadding="0">
    	<tr>       
        	...
        	<td width="25%" class="tdfont" > 
	        	<html:select name="opdDeptUnitEpisodeStatusPatListFB"  property="graphOrText" tabindex="1" styleClass="regcbo" >
		        	<html:option value="-1">Select Value</html:option>
        	...
        	<td width="25%" class="tdfont">
        		<html:select name="opdDeptUnitEpisodeStatusPatListFB" property="reportType" tabindex="1" styleClass="regcbo">
					<html:option value="-1">Select Value</html:option>        	
...
<html:hidden name="opdDeptUnitEpisodeStatusPatListFB" property="mode" value="OPDDEPTUNITEPISODESTATUSPATLISTREPORT"/>
<html:hidden name="opdDeptUnitEpisodeStatusPatListFB" property="reportMode"/>
<html:hidden name="opdDeptUnitEpisodeStatusPatListFB" property="jrxmlPath" value="<%=OpdConfig.OPD_JRXML_PATH%>"/>
<html:hidden name="opdDeptUnitEpisodeStatusPatListFB" property="jrxmlName"/>
<html:hidden name="opdDeptUnitEpisodeStatusPatListFB" property="sysDate" value="<%=tDate%>"/>
