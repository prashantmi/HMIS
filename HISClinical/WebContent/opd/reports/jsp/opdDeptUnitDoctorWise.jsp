...
function opdDeptUnitDoctorWiseStatReportHandler()
{
	if(document.getElementsByName('choice')[0].checked)
	{
    	document.getElementsByName('jrxmlName')[0].value="<%=OpdConfig.OPD_DEPT_UNIT_DOCTOR_WISE_TODAY%>";
	}
	else
	{
		document.getElementsByName('jrxmlName')[0].value="<%=OpdConfig.OPD_DEPT_UNIT_DOCTOR_WISE_DATEWISE%>";         
	}
	success=false;
    ...
    if(document.getElementsByName("isDoctorFound")[0].value=="No doctor found")
	{
		alert("Select the Doctor Name");
		document.getElementsByName("isDoctorFound")[0].focus();
		return false;
	}
	...
	return success;
}//end of function opdDeptUnitDoctorWiseStatReportHandler()

</script>

<his:TitleTag name="Department Unit Doctor Wise Statistical Report">
</his:TitleTag>
...
<logic:equal name="opdDeptUnitDoctorWiseFB" property="choice" value="<%=Config.CHOICE_TODAY%>">
             <%
...
<logic:equal name="opdDeptUnitDoctorWiseFB" property="choice" value="<%=Config.CHOICE_DATE_WISE%>">
        <%     
        	   fromDateLabel="" ;
               toDateLabel="" ;
               fromDateControl="" ;
      ...
      <bean:define name="opdDeptUnitDoctorWiseFB" property="fromDate" id="frDate" type="java.lang.String"/>
	   <bean:define name="opdDeptUnitDoctorWiseFB" property="toDate" id="tDate" type="java.lang.String"/>          
	   <%
		...
		<tr>            
 			<td class="tdfonthead" nowrap width="25%">       	      
		    	<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
		      		...
		      		<html:radio name="opdDeptUnitDoctorWiseFB" property="choice" tabindex="1" value="<%=Config.CHOICE_TODAY%>" onclick="showdivtoday()"/>
		        <font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
		       		<bean:message key="dateWise"/>
		       	</font> 
		        	<html:radio name="opdDeptUnitDoctorWiseFB" property="choice" tabindex="1" value="<%=Config.CHOICE_DATE_WISE%>" onclick="showdivdatewise()"/>
			</td> 
 		</tr>
 		<tr>
			...
			<td class="tdfont" width="25%">
	    		<div id='divfromDateControl' style='<%=fromDateControl %>'align="left">	               		 
		 		...
		 		<span id='divfromhrcontrol' style='<%=fromControl %>'align="left">	            
		   			<html:text name="opdDeptUnitDoctorWiseFB" tabindex="1" property="fromHour"  maxlength="2" size="3"  onkeydown="setPreviosValue(this, event)" onkeyup="moveToRightBox(this, event)" onkeypress="return validateNumeric(event)" />	
		  			 <b>	<bean:message key="colon"/></b>
				</span>
		 		<span id='divfromMinControl' style='<%=fromControl %>' align="left">         
					<html:text name="opdDeptUnitDoctorWiseFB" tabindex="1" property="fromMin"   maxlength="2" size="3" onkeydown="setPreviosValue(this, event)" onkeyup="moveToRightBox(this, event)" onkeypress="return validateNumeric(event)"/>				
			...
			<td class="tdfont" width="25%">
		 		<div id='divtoDateControl' style='<%=toDateControl %>' align="left">    
    	  		...
    	  		<span id='divtohrcontrol' style='<%=toControl%>' align="left">	            
		   			<html:text name="opdDeptUnitDoctorWiseFB" tabindex="1" property="toHour"  maxlength="2" size="3" onkeydown="setPreviosValue(this, event)" onkeyup="moveToRightBox(this, event)" onkeypress="return validateNumeric(event)"/>	
	   				<b><bean:message key="colon"/>	  </b>
				</span>
		 		<span id='divtoMinControl' style='<%=toControl%>' align="left">         
					<html:text name="opdDeptUnitDoctorWiseFB" tabindex="1" property="toMin" maxlength="2" size="3"  onkeydown="setPreviosValue(this, event)" onkeyup="moveToRightBox(this, event)" onkeypress="return validateNumeric(event)"/>				
						<bean:message key="timeFormat"/>	  
    	 		</span>
			</td>                 			
 		</tr>
 		<tr>
    		...
    		<td class="tdfont">
       			<div id="deptControl" align="left"  style='<%=deptcontrol%>'>
     		 		<html:select name="opdDeptUnitDoctorWiseFB"  property="departmentCode"  tabindex="1"  styleClass ="regcbo" onchange="showUnit()">   
...
<his:statusTransactionInProcess>
    		...
    		<td class="tdfont">
    			<div id="unitControl" align="left" >
    				<html:select name="opdDeptUnitDoctorWiseFB"  property="unit"  tabindex="1"  styleClass ="regcbo" onchange="showDoctorName()">
						<html:option value="-1">Select Value</html:option>
...
<his:statusInProcess>		
 			...
 			<td class="tdfont" width="25%">
 				<div id="divControl" align="left" >
 					<html:select name="opdDeptUnitDoctorWiseFB" property="doctorCode" tabindex="1" styleClass="regcbo">
 						<html:option value="%">All Doctor</html:option>
 						<logic:present name="<%=OpdConfig.ESSENTIAL_BO_OPTION_DOCTOR_NAME_BASED_ON_UNIT%>" >
 						<html:options collection="<%=OpdConfig.ESSENTIAL_BO_OPTION_DOCTOR_NAME_BASED_ON_UNIT%>" property="value" labelProperty = "label"/>
 						</logic:present>
 					</html:select> 
 				</div>
 			</td>
	...
	<table width="100%" cellspacing="1" cellpadding="0">
    	<tr>       
        	...
        	<td width="25%" class="tdfont" > 
	        	<html:select name="opdDeptUnitDoctorWiseFB"  property="graphOrText" tabindex="1" styleClass="regcbo" >
		        	<html:option value="-1">Select Value</html:option>
        	...
        	<td width="25%" class="tdfont">
        		<html:select name="opdDeptUnitDoctorWiseFB" property="reportType" tabindex="1" styleClass="regcbo">
					<html:option value="-1">Select Value</html:option>        	
...
<html:hidden name="opdDeptUnitDoctorWiseFB" property="reportMode"/>
<html:hidden name="opdDeptUnitDoctorWiseFB" property="mode" value="OPDDEPTUNITDOCTORWISEREPORT"/>
<html:hidden name="opdDeptUnitDoctorWiseFB" property="jrxmlPath" value="<%=OpdConfig.OPD_JRXML_PATH%>"/>
<html:hidden name="opdDeptUnitDoctorWiseFB" property="jrxmlName"/>
<html:hidden name="opdDeptUnitDoctorWiseFB" property="sysDate" value="<%=tDate%>"/>
<html:hidden name="opdDeptUnitDoctorWiseFB" property="isDoctorFound"/>
