...
System.out.println(VisitVO.getEhrVisitReason());
...
<table id="tbVisitReason" width="100%">
	</table>
</form>
</body>
...
createAdviceonDischarge('OPDNEXTVISITDETAIL',ehrObj);
...
"patCompositionSelectData":
  {
	      "OPDNEXTVISITDETAIL": {"list_selected":[]},
...
{
	//alert(jobj.patCompositionSelectData.OPDNEXTVISITDETAIL.list_selected);
	var obj=[];
	var temp="<%=VisitVO.getEhrVisitReason()%>";
	if(jobj.patCompositionSelectData.OPDNEXTVISITDETAIL.comp_select == "true")
	{
		obj=jobj.patCompositionSelectData.OPDNEXTVISITDETAIL.list_selected;
	//alert(obj.length);
	//alert(key);
	//  var content = '<div id= div_OPDNEXTVISITDETAIL>';
	  var content = '';
	 // alert(obj[0].drugName);
    //for(var k=0; k < obj.length;k++)
    //{ 
    	
	   //content += '<tr><td width="100%"><div align="left"><font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Visit Reason: </b></font>&nbsp;'+temp+'</div></td></tr>';
...
//	content += '</div>';   
	...
	//alert(content);
	$('#tbVisitReason').append(content);   
	
	window.opener.jsonSelect.patCompositionSelectData.OPDNEXTVISITDETAIL.html = content;
	//alert(window.opener.jsonSelect.patCompositionSelectData.OPDNEXTVISITDETAIL.html);
