...
<%@page import="ehr.investigation.dataentry.EHRSection_InvestigationAdviceFB"%>
...
function doPagination(e,p)
{
	...
	document.getElementsByName('hmode')[0].value='PAGINATION';
	   document.forms[0].action="/HISClinical/emr/ehrSection_REQUISITIONRAISING.cnt"; 
...
function deleteLabTestCodeArray(tmpLabCode,tmpTestCode,tmpLabTestCodeArray)
{
	...
	var objXHR = {url: "/HISClinical/emr/ehrSection_REQUISITIONRAISING.cnt?hmode="+_mode+"&tmpLabCode="+tmpLabCode+"&tmpTestCode="+tmpTestCode+"&labTestCodeArray="+tmpLabTestCodeArray, sync:true, postData: "", handleAs: "text",
		load: function(data) 
		{
			//alert(data);
...
function modifyLabTestCodeArray(tmpSampleCode,tmpLabCode,tmpTestCode,tmpLabTestCodeArray)
{
	...
	var objXHR = {url: "/HISClinical/emr/ehrSection_REQUISITIONRAISING.cnt?hmode="+_mode+"&tmpLabCode="+tmpLabCode+"&tmpTestCode="+tmpTestCode+"&tmpSampleCode="+tmpSampleCode+"&labTestCodeArray="+tmpLabTestCodeArray, sync:true, postData: "", handleAs: "text",
		load: function(data) 
		{
			//alert(data);
			labTestCodeArray = data;
...
function modifyPriorityLabTestCodeArray(tmpPriority,tmpLabCode,tmpTestCode,tmpLabTestCodeArray)
{
	...
	var objXHR = {url: "/HISClinical/emr/ehrSection_REQUISITIONRAISING.cnt?hmode="+_mode+"&tmpLabCode="+tmpLabCode+"&tmpTestCode="+tmpTestCode+"&tmpPriority="+tmpPriority+"&labTestCodeArray="+tmpLabTestCodeArray, sync:true, postData: "", handleAs: "text",
		load: function(data) 
		{
			//alert(data);
			labTestCodeArray = data;
...
function setTestComboUsingAjax(labCode)
{
	...
	var objXHR = {url: "/HISClinical/emr/ehrSection_REQUISITIONRAISING.cnt?hmode="+_mode+"&tmpLabCode="+labCode, sync:true, postData: "", handleAs: "text",
		load: function(data) 
		{
			//alert(data);
			tstValArr = data;
...
function chkRequisitionPending(labCode,testCode,patCrNo)
{
	...
	var objXHR = {url: "/HISClinical/emr/ehrSection_REQUISITIONRAISING.cnt?hmode="+_mode+"&dupLabCode="+labCode+"&dupTestCode="+testCode+"&patCrNo="+patCrNo, sync:true, postData: "", handleAs: "text",
		load: function(data) 
		{
			//alert(data);
...
function modifyLabTestCodeArrayAptNo(appoitmentNo,tmpLabCode,tmpTestCode,tmpLabTestCodeArray)
{
	...
	var objXHR = {url: "/HISClinical/emr/ehrSection_REQUISITIONRAISING.cnt?hmode="+_mode+"&tmpLabCode="+tmpLabCode+"&tmpTestCode="+tmpTestCode+"&appoitmentNo="+appoitmentNo+"&labTestCodeArray="+tmpLabTestCodeArray, sync:true, postData: "", handleAs: "text",
		load: function(data) 
		{
			//alert(data);
			labTestCodeArray = data;
...
document.getElementById("lengendStatus").style.display="";
  ...
  function setPrevTestDtlUsingAjax(CrNo)
  {
	 ...
	 //alert("Inside Ajax"); 
  	...
  	var objXHR = {url: "/HISClinical/emr/ehrSection_REQUISITIONRAISING.cnt?hmode="+_mode+"&tmpCrNo="+CrNo, sync:true, postData: "", handleAs: "text",
  		load: function(data) 
  		{
...
//alert("inside here");
  ...
  function updateReqTable(labCode,testCode)
  {
	//  alert("inside del");
  	...
  	var objXHR = {url: "/HISClinical/emr/ehrSection_REQUISITIONRAISING.cnt?hmode="+_mode+"&delLabCode="+labCode+"&delTestCode="+testCode, sync:true, postData: "", handleAs: "text",
  		load: function(data) 
  		{
  			//alert(data);
  			isRequisitonRaisingPresent = data;
...
<div class="divStyle">
		...
		<his:statusNew>
			...
			<%-- <his:InputCrNoInvestigationTag name="EHRSection_InvestigationAdviceFB">
		...
		<%String deskType = (String)session.getAttribute(DynamicDeskConfig.DYNAMIC_DESK_TYPE);
			...
			<html:hidden name="EHRSection_InvestigationAdviceFB" value="<%=deskType%>" property="deskType" />
			
			
			<logic:equal name="EHRSection_InvestigationAdviceFB" property="aptStatus"
				value="0">
			...
			<logic:present name="<%=InvestigationConfig.PATIENT_VO%>">
               ...
               <%
              EHRSection_InvestigationAdviceVO  lstPatVO=(EHRSection_InvestigationAdviceVO)session.getAttribute(InvestigationConfig.PATIENT_VO);
   ...
   <%-- <his:SubTitleTag name="Patient Details">  
		...
		<td class="tdfonthead" width="15%">
		 	...
		 	<html:hidden name="EHRSection_InvestigationAdviceFB" value="<%=lstPatVO.getPatCategoryCode()%>" property="patCatCode" />		 
		<%-- </tr>
		<tr>
		<td class="tdfonthead" width="15%">
		 				<div align="right">
			...
			<logic:equal name="EHRSection_InvestigationAdviceFB" property="patStatus"
				value="IPD">
			...
			<div id="">
				...
				<div id="popUpDiv" style="display: none;">
					<table id="addMoreValue" width="100%">
						...
						<html:hidden name="EHRSection_InvestigationAdviceFB"
			...
			<logic:notEqual name="EHRSection_InvestigationAdviceFB" property="patStatus"
				value="IPD">
...
<%-- 					
			...
			<%
				String hide="display:none";
							     ...
							     String isBookMark=((EHRSection_InvestigationAdviceFB)request.getAttribute("EHRSection_InvestigationAdviceFB")).getIsBookMark();
					...
					<tr>
						<td class="tdfont" width="100%"><logic:present
								...
								<div id="tabs" align="left"  >
									...
									<div id="tabs-1">
									<!--  commented by manisha for unipage  -->
										...
										<div id="selLabTest" class="subDivStyle">
											<%
												// Logic ofor persisting the selected Lab Test details even after page Submit
																																												 	   String labTestArrayString=(String)((EHRSection_InvestigationAdviceFB)request.getAttribute("EHRSection_InvestigationAdviceFB")).getLabTestCodeArray();
													...
													<td  width="14.5%" class="tdfonthead">
														...
														<%
															if (isMandatoryReq.equals("1")) {
																...
																%>
																<html:hidden name="EHRSection_InvestigationAdviceFB" value="<%=finalMandCode%>"  property="finalMandCodeValuesOnBookmark" />
														<% 
...
<!--         <input type="checkbox" name="hisswitch"  id="myhisswitch" value="myhisswitchTestLab" onclick="getTestWiseList('myhisswitchTestLab');" >
 ...
 --%>
												...
												<table width="100%">
													<tr>
														...
														<td class="tdfonthead" width="20%"><logic:equal
																name="EHRSection_InvestigationAdviceFB" property="isTestGroup"
					 			...
					 			</logic:equal> <logic:notEqual name="EHRSection_InvestigationAdviceFB"
	...
	<logic:present
											...
											<%
												//Pagination Logic
																...
																fbPage.setCurrentPage(((EHRSection_InvestigationAdviceFB) request
																		.getAttribute("EHRSection_InvestigationAdviceFB"))
																		.getCurrentPage());
												...
												<his:ContentTag>
													<div id="showhideOnPagination">
														<table width="100%">
															...
															String alreadyRaisedArray=(String)((EHRSection_InvestigationAdviceFB)request.getAttribute("EHRSection_InvestigationAdviceFB")).getLabTestCodeArray();
															boolean alreadyRaised=false;
																						...
																						String isTestGroup = ((EHRSection_InvestigationAdviceFB) request
																								.getAttribute("EHRSection_InvestigationAdviceFB"))
																								.getIsTestGroup();
					 ...
					 if(firstTimeTravesall)
			 			{
												...
												ChkTestGroupValue+="@";
															...
															%>
																<html:hidden name="EHRSection_InvestigationAdviceFB" value="<%=ChkTestGroupValue%>"  property="labtestGroupValues" />	
														</table>
													</div>
												</his:ContentTag>
											</logic:present>
  ...
  <div class="toggle_radio">
    ...
    <div class="toggle_option_slider">
								...
								*
									...
									<div id="tabs-2" >
										 <div class="subDivStyle">
											...
											<%
												String prvTestArrayString = (String) ((EHRSection_InvestigationAdviceFB) request
																		.getAttribute("EHRSection_InvestigationAdviceFB"))
																		.getPrvTestDtl();
		...
		<html:hidden name="EHRSection_InvestigationAdviceFB" property="hmode" />
		<html:hidden name="EHRSection_InvestigationAdviceFB" property="patCrNo" />
		<html:hidden name="EHRSection_InvestigationAdviceFB" property="currentPage" />
		<html:hidden name="EHRSection_InvestigationAdviceFB" property="numberOfRow" />

		<html:hidden name="EHRSection_InvestigationAdviceFB" property="labCode" />
		<html:hidden name="EHRSection_InvestigationAdviceFB" property="testCode" />
		<html:hidden name="EHRSection_InvestigationAdviceFB" property="admissionDate" />

		<html:hidden name="EHRSection_InvestigationAdviceFB"
			property="labTestCodeArray" />

		<html:hidden name="EHRSection_InvestigationAdviceFB" property="bookMarkCode" />

		<html:hidden name="EHRSection_InvestigationAdviceFB" property="patStatus" />

		<html:hidden name="EHRSection_InvestigationAdviceFB" property="isBookMark" />

		<html:hidden name="EHRSection_InvestigationAdviceFB" property="tmpLabCode" />

		<html:hidden name="EHRSection_InvestigationAdviceFB" property="tmpTestCode" />

		<html:hidden name="EHRSection_InvestigationAdviceFB" property="tmpPriority" />

		<html:hidden name="EHRSection_InvestigationAdviceFB" property="tstValArr" />

		<html:hidden name="EHRSection_InvestigationAdviceFB" property="tstGrpArr" />
		<html:hidden name="EHRSection_InvestigationAdviceFB" property="tmpCrNo" />

		<html:hidden name="EHRSection_InvestigationAdviceFB" property="prvTestDtl" />
		<html:hidden name="EHRSection_InvestigationAdviceFB" property="aptStatus" />
		<html:hidden name="EHRSection_InvestigationAdviceFB" property="aptTestCode" />
		<html:hidden name="EHRSection_InvestigationAdviceFB" property="hideSaveButton" />
		<html:hidden name="EHRSection_InvestigationAdviceFB"
...
<html:hidden name="EHRSection_InvestigationAdviceFB" property="mandComboTextBoxComboNames" />


   <html:hidden name="EHRSection_InvestigationAdviceFB" property="finalMandValues" />
   
   <html:hidden name="EHRSection_InvestigationAdviceFB" property="tstOrTestGroupValue" />
...
<html:hidden name="EHRSection_InvestigationAdviceFB" property="appointmentRefNo" />
<html:hidden name="EHRSection_InvestigationAdviceFB"
...
<html:hidden name="EHRSection_InvestigationAdviceFB" property="testLabTestCodeWise" />


<html:hidden name="EHRSection_InvestigationAdviceFB" property="dupLabCode" />


<html:hidden name="EHRSection_InvestigationAdviceFB" property="dupTestCode" />

<html:hidden name="EHRSection_InvestigationAdviceFB" property="appoitmentNo" />
<html:hidden name="EHRSection_InvestigationAdviceFB" property="hidAptNo" />

<html:hidden name="EHRSection_InvestigationAdviceFB" property="labTestAptDate" />
<html:hidden name="EHRSection_InvestigationAdviceFB" property="labTestAptTime" />
<html:hidden name="EHRSection_InvestigationAdviceFB" property="labTestAptRefNo" />
...
<!-- commented by manisha for unipage -->
	<%-- 	<his:ButtonToolBarTag>
		...
		</his:ButtonToolBarTag> --%>  <!-- end of comment -->
<his:statusTransactionInProcess>
