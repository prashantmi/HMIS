...
<%@page import="ehr.hospitalcourse.vo.EHRSection_HospitalCourseVO"%>
...
EHRSection_HospitalCourseVO dischargeVO= (EHRSection_HospitalCourseVO) session.getAttribute(EHRConfig.STATUS_AT_DISCHARGE);
%>
	<his:ContentTag>
 				...
 				<input type="hidden" name="ehrcomp_DISCHARGESTATUS_dataelem_json_<%=dischargeVO.getSelectedSectionData()%>"   value='<%=dischargeVO.getJSONObj().toString() %>'  />         
					...
					<td width="74%" class="" style="vertical-align: middle;">
						<div align="left">
							  ...
							  <html:hidden name="EHRSection_HospitalCourseFB" property="snomdPTStatusAtDischarge" ></html:hidden>
					          <html:hidden name="EHRSection_HospitalCourseFB" property="snomdCIdStatusAtDischarge" ></html:hidden>
					         <%=(dischargeVO.getStatusAtDischarge()==null)?"":dischargeVO.getStatusAtDischarge() %>
					          <html:hidden name="EHRSection_HospitalCourseFB" property="statusAtDischarge" value="<%=dischargeVO.getStatusAtDischarge() %>"/>
