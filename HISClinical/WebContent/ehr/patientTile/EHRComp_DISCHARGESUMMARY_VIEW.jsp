...
<%System.out.println("hellllllfffffflllll no"); %>


<body >
<form>

<table id="tbDischargeSummary" width="100%"  cellpadding="1px">
	</table>
...
//	alert(ehrObj);
createDiagnosis('DISCHARGESUMMARY',ehrObj);
...
"patCompositionSelectData":
  {
    ...
    "DISCHARGESUMMARY":{"list_selected":[]},
 ...
 function createDiagnosis(key,jobj)
{
	...
	//alert(jobj.patCompositionSelectData.DISCHARGESUMMARY.list_selected);
	var obj=[];
	if(jobj.patCompositionSelectData.DISCHARGESUMMARY.comp_select == "true")
	{
	obj=jobj.patCompositionSelectData.DISCHARGESUMMARY.list_selected;
    ...
    for(var k=0; k < obj.length;k++)
    {
       ...
       content += '<tr><td width="16%"><b><font color="#126295"> Admitted On: </font></td><td width="16%"><div align="left">' + ((obj[k].admittedOn == undefined) ? '' : obj[k].admittedOn)  + '</div></td><td width="16%"><b><font color="#126295"> Discharged On:</font> </td><td width="16%"><div align="left">'  + ((obj[k].dischargedOn == undefined) ? '' : obj[k].dischargedOn) + '</div></td><td width="16%"> <b><font color="#126295"> </font></td><td width="16%"><div align="left"></div></td></tr>';
       content += '<tr><td width="16%"><b><font color="#126295"> Discharge Type: </font></td><td width="16%"><div align="left">' + ((obj[k].dischargeType == undefined) ? '' : obj[k].dischargeType)  + '</div></td><td width="16%"><b><font color="#126295"> Consultant:</font> </td><td width="16%"><div align="left">'  +  ((obj[k].consultantName == undefined) ? '' : obj[k].consultantName) + '</div></td><td width="16%"> <b><font color="#126295"> </font></td><td width="16%"><div align="left"></div></td></tr>';
       	 
      // content += '<tr><td> Admitted On </td><td>'  + obj[k].admittedOn+'</td><td> Discharged On </td><td>' + obj[k].dischargedOn  + '</td></tr><br>';
     //  content += '<tr> <td> DischargeType </td><td>'  + obj[k].dischargeType+'</td><td> ConsultantId </td><td>' + obj[k].consultantID + '</td></tr><br>';	  
	 }

   
	//alert(content);
	$('#tbDischargeSummary').append(content);   
	
	window.opener.jsonSelect.patCompositionSelectData.DISCHARGESUMMARY.html = content;
