...
<table id="tbComplaints" width="70%" >
</table>
</form>
</body>
...
//createAdviceonDischarge('COMPLAINTS',ehrObj);
 ...
 function createAdviceonDischarge(key,jobj)
{
	...
	//alert(jobj.patCompositionSelectData.COMPLAINTS.list_selected);
	var obj=[];
	if(jobj.patCompositionSelectData.COMPLAINTS.comp_select == "true")
	{
		obj=jobj.patCompositionSelectData.COMPLAINTS.list_selected;
	...
	//alert(content);
	$('#tbComplaints').append(content);   
	
	window.opener.jsonSelect.patCompositionSelectData.COMPLAINTS.html = content;
