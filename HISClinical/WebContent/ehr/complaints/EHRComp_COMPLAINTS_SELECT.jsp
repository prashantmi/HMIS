...
<table width="100%" style="margin:1%">
 ...
 --%>
				...
				<%-- <input type="checkbox" name="ehrcomp_COMPLAINTS_chk_select"    checked="checked"  value="<%=visitDate.getValue()%>" onchange="setPatDocSelectJSON('COMPLAINTS')" />
				<input type="hidden" name="ehrcomp_COMPLAINTS_dataelem_json_<%=visitDate.getValue()%>" value='<%=visitDate.getValue() %>'  />   
 --%>
							</div>
					</td> 
			<td width="98%" class="">
		...
		<td width="98%" class="" >
		<!-- <div align="left"> -->
		<%-- <input type="checkbox" name="ehrcomp_COMPLAINTS_chk_select"    checked="checked"  value="<%=evo.getSelectedSectionData()%>" onchange="setPatDocSelectJSON('COMPLAINTS')" /> --%>
			<input type="hidden" name="ehrcomp_COMPLAINTS_dataelem_json_<%=evo.getSelectedSectionData()%>" value='<%=evo.getJSONObj().toString() %>'  />   
			<input type="checkbox" name="ehrcomp_COMPLAINTS_chk_select" value="<%=evo.getSelectedSectionData()%>"  onchange="setPatDocSelectJSON('COMPLAINTS')" checked="checked"/>
	...
	<logic:equal name="EHRSection_ComplaintsFB" property="reportMode" value="<%=GenericTemplateConfig.TEMPLATE_VIEW_REPORT_TYPE_MODE_PARAMETER_WISE %>">
...
<html:hidden name="EHRSection_ComplaintsFB" property="reportMode"/>
