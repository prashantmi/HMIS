...
<%-- <his:SubTitleTag name="">
	<div align="left"><bean:write name="EHRSection_ComplaintsFB"  property="deskMenuName"/></div>
</his:SubTitleTag> --%>

<%-- <his:statusTransactionInProcess> --%>
<% 

String deskMenuId= "1";   //new EHRSection_ComplaintsFB();
...
%>
			...
			<table width="98%" cellspacing="1" cellpadding="0">
				...
				<td width="98%"  class="tdfont">
					&nbsp;&nbsp;&nbsp;<b><font color="#FF0000"> No Template exists for <bean:write name="EHRSection_ComplaintsFB"  property="deskMenuName"/></font></b>
				</td>
			</tr>
		</table>
...
%>
	...
	<bean:define name="EHRSection_ComplaintsFB" property="episodeVisitNo" id="visitNo" type="java.lang.String" />
...
<html:hidden name="EHRSection_ComplaintsFB" property="deskMenuId"/>
<html:hidden name="EHRSection_ComplaintsFB" property="selUndefaultTemp" value=""/>
<html:hidden name="EHRSection_ComplaintsFB" property="reportMode"/>
<html:hidden name="EHRSection_ComplaintsFB" property="isSetCOMPLAINTS"/>


<script type="text/javascript">
COMPLAINTSetDataExist();
</script></body></html>