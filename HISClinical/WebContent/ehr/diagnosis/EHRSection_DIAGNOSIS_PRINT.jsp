...
<div id="diagnosis">	
	<div class="row">
		...
		List<EHRSection_DiagnosisVO> listdrugDtlVO1= patencountervo1.getListSaveAllDiagnosis();

				if(listdrugDtlVO1!=null && listdrugDtlVO1.size() !=0)
				{
			 %>
	...
	<div class="row">
		<div class="col-xs-12">
	 	<%	    //Map mpEssentials = (HashMap) session.getAttribute(EHRConfig.EHR_PAT_ENCOUNTER_DETAILS_VO);
				...
				<%if (prevDiagVO.getDiagnosticTypeName()!=null)
					{
					%>
     ...
     <%--     <%=prevDiagVO.getDignosisName()==null?"":prevDiagVO.getDignosisName()%> <%=prevDiagVO.getDiagnosticTypeName()==null?"":(prevDiagVO.getDiagnosticTypeName())%><br>
				...
				<%}
					...
					%>
					<font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000000">
					<%=prevDiagVO.getDignosisName()==null?"":prevDiagVO.getDignosisName()%><br>
