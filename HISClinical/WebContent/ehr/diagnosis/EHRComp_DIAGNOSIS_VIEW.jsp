 ...
 function createDiagnosis(key,jobj)
{
	...
	var obj=[];
	if(jobj.patCompositionSelectData.ENCDIAGNOSIS.comp_select == "true")
	{
	obj=jobj.patCompositionSelectData.ENCDIAGNOSIS.list_selected;
    ...
    for(var k=0; k < obj.length;k++)
    {
	  ...
	  // content += '<tr><td>' + obj[k].diagnosticCode+'&nbsp;&nbsp;'+ obj[k].dignosisName  + '&nbsp;&nbsp;'  + obj[k].diagnosticTypeName+'&nbsp;&nbsp;' + obj[k].remarks + '</td></tr><br>';
	   content += '<tr><td>' + obj[k].dignosisName  + '&nbsp;('  + obj[k].diagnosticTypeName+')&nbsp;</td></tr><br>';
	  
	 }

 
	//alert(content);
	$('#tbDiagnosis').append(content);   
	
	window.opener.jsonSelect.patCompositionSelectData.ENCDIAGNOSIS.html = content;
