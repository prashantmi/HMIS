			...
			<%countNew++;%><%System.out.print("manisha"+drugDtlVO.getDrugId()); %>
				<td width="20%"> 
					...
					<html:hidden name="EHRSection_TreatmentFB" property="selDrugBrandId" value='<%=drugDtlVO.getDrugBrandId()%>' />
						...
						<html:text name="EHRSection_TreatmentFB" property="selDrugName" maxlength="100" size="25" tabindex="1" styleClass="form-control" 
							...
							onfocus="<%=temp %>"
						></html:text>    	<%-- onblur="callOnBlur()" --%></font>
					</div>
				</td>
				<td width="15%" >
					<div align="center">
						...
						<% if(drugDtlVO.getDoseId().equals("0"+"^"+"0"+"^"+"0")) { %>
							...
							<html:text name="EHRSection_TreatmentFB" property="selDoseName" tabindex="1" 
						...
						<% } else { %>
							<html:select name="EHRSection_TreatmentFB" styleClass="form-control" property="selDoseId" tabindex="1" value="<%=drugDtlVO.getDoseId() %>" style="width: 100px;"  onchange="<%=showqty%>">
				...
				<td width="14%" >
					<div align="center">
						...
						<html:select name="EHRSection_TreatmentFB" property="selFrequencyId" tabindex="1" style="width:100px;"
				...
				<td width="10%" >
					<div align="center">
						<% if(drugDtlVO.getDoseId().equals("0")) { %>
							<html:hidden name="EHRSection_TreatmentFB" property="selDoseId" value="<%=drugDtlVO.getDoseId()%>"></html:hidden>
							<html:text name="EHRSection_TreatmentFB" property="selDoseName" tabindex="1" value="<%=drugDtlVO.getDoseName()%>" maxlength="20" size="8"
				...
				<table id="prevDrugDtlTableId" class="table" style="display:block;">
				...
				<tr id="treatmentRow#<%=idx.intValue()+2%>">
					...
					<button type="button"  id="revokeButton"  class="btn btn-info btn-sm"  onclick="<%-- showRevokeRemarks(this,'<%=idx.toString()%>');  --%> hideTreatmentRow('<%=idx.toString()%>'); ">Delete</button>
