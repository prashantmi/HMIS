...
document.getElementsByName("adviceType")[0].value='<%=Config.TREATMENT_ADVICE_TYPE_DISCHARGE %>';
}
...
<his:statusTransactionInProcess>
	...
	<!-- 		
		<table id="treatmentTable" width="95%" border="0" cellspacing="1" cellpadding="0" style="display:block;"> -->
		<table id="prevDrugDtlTableId" width=100%" border="0" cellspacing="1" cellpadding="1" style="display:block; margin:1%" >
			<tr>
			
			<td width="2%"  class="" nowrap="nowrap">
					<div align="center">	
						<!-- <input type="checkbox" name="selectCheck" onclick="selectAllCheckboxes(this,'selectedRow')">  -->
					</div>
				</td>
				<td width="20%" class="" nowrap="nowrap">
					<div align="center">
				...
				<td class="" width="15%" nowrap="nowrap">
						<div align="center">
							<font color="#126295" size="2" face="Verdana, Arial, Helvetica, sans-serif">
								<b>
		...
		<!-- </table>	 --> 
			<!-- 	<table id="prevDrugDtlTableId" width=95%" border="0" cellspacing="1" cellpadding="0" style="display:block;"> -->
				...
				<td width="2%"  class="" nowrap="nowrap">
						<div align="center" >	   
					<%-- 	<html:checkbox name="EHRSection_TreatmentFB" property="selectedRow" value="<%=idx.toString()%>" ></html:checkbox>
 --%>
						<input type="checkbox" name="ehrcomp_ADVICEONDISCHARGE_chk_select"    checked="checked"  value="<%=drugDtlVO.getSelectedSectionData()%>" onchange="setPatDocSelectJSON('ADVICEONDISCHARGE')" />
						<input type="hidden" name="ehrcomp_ADVICEONDISCHARGE_dataelem_json_<%=drugDtlVO.getSelectedSectionData()%>" value='<%=drugDtlVO.getJSONObj().toString() %>'  />   
				 ...
				 --%>
					...
					<%-- <td width="5%" class="" id="tdButtonPlus">
					<div align="center">
...
</his:statusTransactionInProcess></his:ContentTag>
...
<div id="divDropDown" class="hisStyle.css" style="display: none; position: absolute; z-index: 10; ">
...
<html:hidden name="EHRSection_TreatmentFB" property="adviceType"/>
