...
<%-- <his:SubTitleTag name="">
	<div align="left"><bean:write name="EHRSection_ExaminationFB"  property="deskMenuName"/></div>
</his:SubTitleTag> --%>

<%-- <his:statusTransactionInProcess> --%>
<% 

String deskMenuId= "3";   //new EHRSection_ExaminationFB();
...
%>
			...
			<table width="98%" cellspacing="1" cellpadding="0">
				...
				<td width="98%"  class="tdfont">
					&nbsp;&nbsp;&nbsp;<b><font color="#FF0000"> No Template exists for <bean:write name="EHRSection_ExaminationFB"  property="deskMenuName"/></font></b>
				</td>
			</tr>
		</table>
...
%><logic:present name="EHRSection_ComplaintsFB" property="episodeVisitNo">
	<bean:define name="EHRSection_ExaminationFB" property="episodeVisitNo" id="visitNo" type="java.lang.String" />
	<%
...
<html:hidden name="EHRSection_ExaminationFB" property="deskMenuId"/>
<html:hidden name="EHRSection_ExaminationFB" property="selUndefaultTemp" value=""/>
<html:hidden name="EHRSection_ExaminationFB" property="reportMode"/>
<html:hidden name="EHRSection_ExaminationFB" property="isSetEXAMINATION"/>
