...
if(document.getElementsByName("caseSummary")[0].value!="")
	{
	//alert("notes")
	document.getElementsByName("search_CS")[0].value=document.getElementsByName("caseSummary")[0].value;
	setfreeTextCS();
	}
...
function setfreeTextCS()   //for free text
{
	 ...
	 document.getElementsByName("caseSummary")[0].value=document.getElementsByName("search_CS")[0].value;
...
function validate_ENC_CLN_DTL_CASE()
{
	 ...
	 if(caseSummaryLength>2000)
		 {
            alert("Maximum 2000 characters are allowed in case summary");
            document.getElementsByName("search_CS")[0].focus();
            return false;
		 }
	 else
		 {
				...
				<tr>
					<td  style="vertical-align: middle;">
						<div align="left">
                          ...
                          <textarea class="form-control" id="search_CS" name="search_CS" maxlength="2000" onkeypress="return validateText(event)" onchange="setfreeTextCS()"></textarea>
                          <div style="position: absolute;top: 0;right: 16px;">
							  <button type="button" onclick="$(this).parent().parent().find('#search_CS').val('');" class="btn btn-sm btn-default BtnCleanCaseSummary"><i class="fa fa-times"></i></button>
							</div>
                        </div> 	
