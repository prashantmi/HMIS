		...
		<html:form action="/deceasedEnquiry">
			<his:TransactionContainer>
				...
				<his:ButtonToolBarTag>
					...
					<his:statusTransactionInProcess>
						<img class="button" src='<his:path src="/../HIS/hisglobal/images/buttons/btn-ccl.png"/>'  style=cursor:pointer tabindex="1" onclick =" submitPage('FILTER')" onkeypress="if(event.keyCode==13)submitPage('FILTER')">
					</his:statusTransactionInProcess>
					<his:statusUnsuccessfull>
