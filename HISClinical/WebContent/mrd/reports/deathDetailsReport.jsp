...
function DeathDetailsReportHandler()
{
    	...
    	document.getElementsByName('jrxmlName')[0].value="<%=MrdConfig.DEATH_DETAILS_REPORT%>";
	success=false;
...
<html:hidden name="DeathDetailsReportFB" property="jrxmlPath" value="<%=MrdConfig.MRD_JRXML_PATH%>"/>
