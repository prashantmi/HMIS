...
function DeptWiseMonthlyAbstractOfPatientReportHandler()
{
	document.getElementsByName('jrxmlName')[0].value="<%=MrdConfig.DEPT_WISE_MONTHLY_ABSTRACT_OF_PATIENT_REPORT%>";
...
<body onload="showDept()">
<his:TitleTag name="Department Wise Monthly Abstract of Patient Report">
</his:TitleTag>
      ...
      <bean:define name="DeptWiseMonthlyAbstractOfPatientFB" property="fromDate" id="frDate" type="java.lang.String"/>
	   <bean:define name="DeptWiseMonthlyAbstractOfPatientFB" property="toDate" id="tDate" type="java.lang.String"/>        
	   <%
		...
		<tr>            
 			<td class="tdfonthead" width="25%">
        		<div id='divfromDate' style='<%=fromDateLabel %>' align="right">
	        		...
	        		<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif"><bean:message key="fromDate"/></font>
				</div>
			...
			<td class="tdfont" width="25%">
 			...
 			<td class="tdfonthead" width="25%">
        		<div id='divfromDate' style='<%=toDateLabel %>' align="right">
	        		<font color="#FF0000" size="1" face="Verdana, Arial, Helvetica, sans-serif\">*</font>
	        		<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif"><bean:message key="toDate"/></font>
				</div>
			</td>
			<td class="tdfont" width="25%">
...
<table width="100%" cellspacing="1" cellpadding="0">
		<tr>	
			<td class="tdfonthead" nowrap width="25%" >  
 				<div id="deptLabelDeptWise" style="display:none;" align="right">
      			      	<font color="#FF0000" size="1" face="Verdana, Arial, Helvetica, sans-serif\">*</font>
     	...
     	<td class="tdfont"  width="25%" >
      	<div id="deptControlDeptWise" style="display:none;" align="left">
     		 	 	<html:select name="DeptWiseMonthlyAbstractOfPatientFB"  property="departmentCode"  tabindex="1"  styleClass="regcbo" >   
 ...
 <his:SubTitleTag name="Report Generation Options">
    ...
    <tr>   
        ...
        <td width="25%" class="tdfont" > 
	        <html:select name="DeptWiseMonthlyAbstractOfPatientFB"  property="graphOrText" tabindex="1" styleClass="regcbo" >
        ...
        <td width="25%" class="tdfont">
        		<html:select name="DeptWiseMonthlyAbstractOfPatientFB" property="reportType" tabindex="1" styleClass="regcbo">
					<html:option value="-1">Select Value</html:option>        	
...
<input type="hidden"  name="mode" value="DEPTWISEMONTHLYABSTRACTOFPATIENT">
<html:hidden name="DeptWiseMonthlyAbstractOfPatientFB" property="jrxmlPath" value="<%=MrdConfig.MRD_JRXML_PATH%>"/>
<html:hidden name="DeptWiseMonthlyAbstractOfPatientFB" property="jrxmlName"/>
<html:hidden name="DeptWiseMonthlyAbstractOfPatientFB" property="sysDate" value="<%=tDate%>"/>
<html:hidden name="DeptWiseMonthlyAbstractOfPatientFB" property="combo"/>