...
function CommunicableDisReportHandler()
{
	
	document.getElementsByName('jrxmlName')[0].value="<%=MrdConfig.COMMUNICABLE_DISEASE_REPORT%>";
	if(!validateTodayOrDate())  return false;
	success=false;
	
	if(validateGraphOrText())
    { 
    	//alert("Inside graph/text");
        ...
        if(document.getElementsByName('graphOrText')[0].selectedIndex==2)
		{
	        ...
	        {
	        	//alert("Inside validateGraphForAgeWiseReport");
		    	if(validateTodayOrDate())  
		    	{      
		        	success=true;	    
		        	//alert("Inside Date Validation");
		        }            
	        }
...
<his:TitleTag name="Communicable Disease Report">
</his:TitleTag>
      ...
      <bean:define name="CommunicableDisReportFB" property="fromDate" id="frDate" type="java.lang.String"/>
	  <bean:define name="CommunicableDisReportFB" property="toDate" id="tDate" type="java.lang.String"/>          
	     <%
 ...
 <his:SubTitleTag name="Report Generation Options">
    ...
    <tr>   
        ...
        <td width="25%" class="tdfont" > 
	        <html:select name="CommunicableDisReportFB"  property="graphOrText" tabindex="1" styleClass="regcbo" >
        ...
        <td width="25%" class="tdfont">
        		<html:select name="CommunicableDisReportFB" property="reportType" tabindex="1" styleClass="regcbo">
					<html:option value="-1">Select Value</html:option>        	
...
<input type="hidden"  name="mode" value="COMMUNICABLEDISREPORT">
<html:hidden name="CommunicableDisReportFB" property="jrxmlPath" value="<%=MrdConfig.MRD_JRXML_PATH%>"/>
<html:hidden name="CommunicableDisReportFB" property="jrxmlName"/>
<html:hidden name="CommunicableDisReportFB" property="sysDate" value="<%=tDate%>"/>
