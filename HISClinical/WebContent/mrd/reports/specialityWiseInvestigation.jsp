...
function showTest()
{
document.getElementById("testLabelTestWise").style.display="block";
document.getElementById("testControltestWise").style.display="block";
}
...
function showLabWise()
{
document.getElementById("testLabelTestWise").style.display="none";
document.getElementById("testControltestWise").style.display="none";
}



function SpecialityWiseInvestigationReportHandler()
{
	
    	document.getElementsByName('jrxmlName')[0].value="<%=MrdConfig.SPECIALITY_WISE_INVESTIGATION_REPORT%>";
	success=false;
...
<his:TitleTag name="Speciality Wise Investigations Between Two Dates">
</his:TitleTag>
      ...
      <bean:define name="SpecialityWiseInvestigationFB" property="fromDate" id="frDate" type="java.lang.String"/>
	   <bean:define name="SpecialityWiseInvestigationFB" property="toDate" id="tDate" type="java.lang.String"/>          
	   <%
 			...
 			<td class="tdfonthead"  width="25%">       	      
		    	<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
		      	...
		      	<td class="tdfont" nowrap width="25%">
		      		<html:radio  name="SpecialityWiseInvestigationFB" property="option" tabindex="1"  value="<%=MrdConfig.DEPT_WISE%>"  onclick="showDeptWise()" />
		      		</td>
		      		<td class="tdfonthead"  width="25%">
		        <font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
		       	...
		       	<td class="tdfont" nowrap width="25%">
		        	<html:radio name="SpecialityWiseInvestigationFB" property="option" tabindex="1" value="<%=MrdConfig.UNIT_WISE%>" onclick="showUnit()"/>
			</td> 
	...
	<tr>	
 		...
 		<div id="specLabelUnitWise" style="display:none;">
      	...
      	<div id="deptControlDeptWise" style="display:none;">
     		 		<html:select name="SpecialityWiseInvestigationFB"  property="deptCode"  tabindex="1"  styleClass="regcbo" >   
    	...
    	<div id="specControlUnitWise" style="display:none;">
    	 	<html:select name="SpecialityWiseInvestigationFB"  property="speciality"  tabindex="1" onchange="deptSelected(this);" onkeypress="if(event.keyCOde==13)deptSelected(this);"  styleClass="regcbo" >   
			...
			<td class="tdfonthead" nowrap width="25%" >
    			...
    			<html:select name="SpecialityWiseInvestigationFB"  property="unit"  tabindex="1"  styleClass ="regcbo" >
    			<html:option value="-1">Select Value</html:option>
 		...
 		<td class="tdfont"  width="25%">
       			<html:select name="SpecialityWiseInvestigationFB"  property="labCode"  tabindex="1"  styleClass ="regcbo" >
    			<html:option value="-1">Select Value</html:option>
				<html:option value="%">All</html:option>
				<logic:present name="<%=MrdConfig.EXT_LAB_LIST%>">
				  <html:options collection ="<%=MrdConfig.EXT_LAB_LIST%>" property = "value" labelProperty = "label"/>
				</logic:present>  
				</html:select>
...
<table width="100%" cellspacing="1" cellpadding="0">
    <tr>   
        ...
        <td width="25%" class="tdfont" > 
	        <html:select name="SpecialityWiseInvestigationFB"  property="graphOrText" tabindex="1" styleClass="regcbo" >
		       	<html:option value="-1">Select Value</html:option>
        ...
        <td width="25%" class="tdfont">
        		<html:select name="SpecialityWiseInvestigationFB" property="reportType" tabindex="1" styleClass="regcbo">
					<html:option value="-1">Select Value</html:option>        	
...
<input type="hidden"  name="mode" value="SPECIALITYWISEINVESTIGATION">
<html:hidden name="SpecialityWiseInvestigationFB" property="jrxmlPath" value="<%=MrdConfig.MRD_JRXML_PATH%>"/>
<html:hidden name="SpecialityWiseInvestigationFB" property="jrxmlName"/>
<html:hidden name="SpecialityWiseInvestigationFB" property="sysDate" value="<%=tDate%>"/>
<html:hidden name="SpecialityWiseInvestigationFB" property="combo" />
