...
function SpecicialityWiseSundayClinicPatientReportHandler()
{
	if(document.getElementsByName('unit')[0].value== '%')
		document.getElementsByName('jrxmlName')[0].value="<%=MrdConfig.SPECIALITY_WISE__ALLUNITS_SUNDAYCLINIC_REPORT%>";
	else
    	document.getElementsByName('jrxmlName')[0].value="<%=MrdConfig.SPECIALITY_WISE_SUNDAYCLINIC_REPORT%>";
	success=false;
...
<his:TitleTag name="Speciality Wise OPD Patients in Sunday Clinic">
</his:TitleTag>
      ...
      <bean:define name="SpecialityWiseSundayClinicPatientsFB" property="fromDate" id="frDate" type="java.lang.String"/>
	   <bean:define name="SpecialityWiseSundayClinicPatientsFB" property="toDate" id="tDate" type="java.lang.String"/>          
	     <%
...
<tr>	
      		...
      		<td class="tdfont"  width="25%" >  
      			<html:select name="SpecialityWiseSundayClinicPatientsFB"  property="unit"  tabindex="1"  styleClass="regcbo"  >   
					  
					  <html:option value="%">All Units</html:option>
					  <logic:present name="<%=RegistrationConfig.ESSENTIAL_BO_OPTION_UNIT_BASED_ON_WEEKDAY%>">
					  <html:options collection ="<%=RegistrationConfig.ESSENTIAL_BO_OPTION_UNIT_BASED_ON_WEEKDAY%>" property = "value" labelProperty = "label"/>
					  </logic:present>
			  		</html:select> 
      		</td>
 ...
 <his:SubTitleTag name="Report Generation Options">
    ...
    <tr>   
        ...
        <td width="25%" class="tdfont" > 
	        <html:select name="SpecialityWiseSundayClinicPatientsFB"  property="graphOrText" tabindex="1" styleClass="regcbo" >
        ...
        <td width="25%" class="tdfont">
        		<html:select name="SpecialityWiseSundayClinicPatientsFB" property="reportType" tabindex="1" styleClass="regcbo">
					<html:option value="-1">Select Value</html:option>        	
...
<input type="hidden"  name="mode" value="SPECIALITYWISESUNDAYCLINICPATIENTS">
<html:hidden name="SpecialityWiseSundayClinicPatientsFB" property="jrxmlPath" value="<%=MrdConfig.MRD_JRXML_PATH%>"/>
<html:hidden name="SpecialityWiseSundayClinicPatientsFB" property="jrxmlName"/>
<html:hidden name="SpecialityWiseSundayClinicPatientsFB" property="sysDate" value="<%=tDate%>"/>
