...
<script>
	...
	function issueAndReceiptOfCasePaperInterfaceReportHandler()
	{
		...
		return success;
	}//end of function issueAndReceiptOfCasePaperInterfaceReportHandler()

</script>

<his:TitleTag name="Issue And Receipt Of Case Paper Interface Report Handler">
</his:TitleTag>
      ...
      <bean:define name="issueAndReceiptOfCasePaperInterfaceReportFB" property="fromDate" id="frDate" type="java.lang.String"/>
	   <bean:define name="issueAndReceiptOfCasePaperInterfaceReportFB" property="toDate" id="tDate" type="java.lang.String"/>          
	   <%
			...
			<!-- New Change add Hospital Combo -->
		      <td width="25%" class="tdfonthead">
				...
				<td class="tdfont" width="25%">
					<div >
					<html:select name="issueAndReceiptOfCasePaperInterfaceReportFB" property="multipleHospitalCode" tabindex="1" multiple="true" size="4">
	...
	<table width="100%" cellspacing="1" cellpadding="0">
    	<tr>       
        	...
        	<td width="25%" class="tdfont" > 
	        	<html:select name="issueAndReceiptOfCasePaperInterfaceReportFB"  property="graphOrText" tabindex="1" styleClass="regcbo" >
        	...
        	<td width="25%" class="tdfont">
        		<html:select name="issueAndReceiptOfCasePaperInterfaceReportFB" property="reportType" tabindex="1" styleClass="regcbo">
					<html:option value="-1">Select Value</html:option>        	
...
<html:hidden name="issueAndReceiptOfCasePaperInterfaceReportFB" property="reportMode" />
<html:hidden name="issueAndReceiptOfCasePaperInterfaceReportFB" property="mode" value="ISSUEANDRECEIPTOFCASEPAPERINTERFACEREPORT" />
<html:hidden name="issueAndReceiptOfCasePaperInterfaceReportFB" property="jrxmlName" value="<%=MrdConfig.MRD_ISSUE_AND_RECEIPT_OF_CASE_PAPER_INTERFACE_DATEWISE %>"/>
<html:hidden name="issueAndReceiptOfCasePaperInterfaceReportFB" property="sysDate" value="<%=tDate%>"/>
<html:hidden name="issueAndReceiptOfCasePaperInterfaceReportFB" property="choice" value="<%=Config.CHOICE_DATE_WISE%>" onclick="showdivdatewise()"/>
<html:hidden name="issueAndReceiptOfCasePaperInterfaceReportFB" property="jrxmlPath" value="<%=MrdConfig.MRD_JRXML_PATH%>"/>
