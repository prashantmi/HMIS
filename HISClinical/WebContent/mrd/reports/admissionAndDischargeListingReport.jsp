...
<script>
	...
	function validateFromOrToDate(){
		 //alert("inside validateTodayOrDate");
		     success=false;        	   
		               ...
		               //alert("fromDate:"+document.getElementsByName('fromDate')[0].value);
			           valToDate=document.getElementsByName('toDate')[0];
			           //alert("toDate:"+document.getElementsByName('toDate')[0].value);
			           valSysDate=document.getElementsByName('sysDate')[0];
			           //alert("sysDate:"+document.getElementsByName('sysDate')[0].value);
		      			//alert(compareDateCall(valFromDate,valToDate,2,"From Date","To Date")+"\n"+compareDateCall(valToDate,valSysDate,2,"To Date","System Date"));
	...
	function admissionAndDischargeListingReportHandler()
	{
...
<his:TitleTag name="Admission And Discharge Listing Report">
</his:TitleTag>
      ...
      <bean:define name="admissionAndDischargeListingReportFB" property="fromDate" id="frDate" type="java.lang.String"/>
	   <bean:define name="admissionAndDischargeListingReportFB" property="toDate" id="tDate" type="java.lang.String"/>          
	   <%
			...
			<!-- New Change add Hospital Combo -->
		      <td width="25%" class="tdfonthead">
				...
				<td class="tdfont" width="25%">
					<div >
					<html:select name="admissionAndDischargeListingReportFB" property="multipleHospitalCode" tabindex="1" multiple="true" size="4">
	...
	<table width="100%" cellspacing="1" cellpadding="0">
    	<tr>       
        	...
        	<td width="25%" class="tdfont" > 
	        	<html:select name="admissionAndDischargeListingReportFB"  property="graphOrText" tabindex="1" styleClass="regcbo" >
        	...
        	<td width="25%" class="tdfont">
        		<html:select name="admissionAndDischargeListingReportFB" property="reportType" tabindex="1" styleClass="regcbo">
					<html:option value="-1">Select Value</html:option>        	
...
<html:hidden name="admissionAndDischargeListingReportFB" property="reportMode" />
<html:hidden name="admissionAndDischargeListingReportFB" property="mode" value="ADMISSIONANDDISCHARGELISTINGREPORT" />
<html:hidden name="admissionAndDischargeListingReportFB" property="jrxmlName" value="<%=MrdConfig.MRD_ADMISSION_DISCHARGE_LISTING_DATEWISE %>"/>
<html:hidden name="admissionAndDischargeListingReportFB" property="sysDate" value="<%=tDate%>"/>
<html:hidden name="admissionAndDischargeListingReportFB" property="choice" value="<%=Config.CHOICE_DATE_WISE%>" onclick="showdivdatewise()"/>
<html:hidden name="admissionAndDischargeListingReportFB" property="jrxmlPath" value="<%=MrdConfig.MRD_JRXML_PATH%>"/>
