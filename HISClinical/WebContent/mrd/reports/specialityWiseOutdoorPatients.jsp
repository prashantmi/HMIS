...
function SpecicialityWiseOutdoorPatientReportHandler()
{
	document.getElementsByName('jrxmlName')[0].value="<%=MrdConfig.SPECIALITY_WISE_OUTDOOR_PATIENTS_REPORT_DEPTWISE%>";
...
<his:TitleTag name="Speciality Wise Distribution of Outdoor Patients">
</his:TitleTag>
      ...
      <bean:define name="SpecialityWiseOutdoorPatientsFB" property="fromDate" id="frDate" type="java.lang.String"/>
	   <bean:define name="SpecialityWiseOutdoorPatientsFB" property="toDate" id="tDate" type="java.lang.String"/>          
	   <%
 			...
 			<td class="tdfonthead"  width="25%">       	      
		    	<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
		      	...
		      	<td class="tdfont" nowrap width="25%">
		      		<html:radio  name="SpecialityWiseOutdoorPatientsFB" property="option" tabindex="1"  value="<%=MrdConfig.DEPT_WISE%>"  onclick="showDeptWise()" />
		      		</td>
		      		<td class="tdfonthead"  width="25%">
		        <font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
		       	...
		       	<td class="tdfont" nowrap width="25%">
		        	<html:radio name="SpecialityWiseOutdoorPatientsFB" property="option" tabindex="1" value="<%=MrdConfig.UNIT_WISE%>" onclick="showUnit()"/>
			</td> 
	...
	<tr>	
 		...
 		<div id="specLabelUnitWise" style="display:none;">
      	...
      	<div id="deptControlDeptWise" style="display:none;">
     		 		<html:select name="SpecialityWiseOutdoorPatientsFB"  property="departmentCode"  tabindex="1"  styleClass="regcbo" >   
    	...
    	<div id="specControlUnitWise" style="display:none;">
    	 	<html:select name="SpecialityWiseOutdoorPatientsFB"  property="speciality"  tabindex="1" onchange="deptSelected(this);" onkeypress="if(event.keyCOde==13)deptSelected(this);"  styleClass="regcbo" >   
			...
			<td class="tdfonthead" nowrap width="25%" >
    			...
    			<html:select name="SpecialityWiseOutdoorPatientsFB"  property="unit"  tabindex="1"  styleClass ="regcbo" >
 ...
 <his:SubTitleTag name="Report Generation Options">
    ...
    <tr>   
        ...
        <td width="25%" class="tdfont" > 
	        <html:select name="SpecialityWiseOutdoorPatientsFB"  property="graphOrText" tabindex="1" styleClass="regcbo" >
        ...
        <td width="25%" class="tdfont">
        		<html:select name="SpecialityWiseOutdoorPatientsFB" property="reportType" tabindex="1" styleClass="regcbo">
					<html:option value="-1">Select Value</html:option>        	
...
<input type="hidden"  name="mode" value="SPECIALITYWISEOUTDOORPATIENTS">
<html:hidden name="SpecialityWiseOutdoorPatientsFB" property="jrxmlPath" value="<%=MrdConfig.MRD_JRXML_PATH%>"/>
<html:hidden name="SpecialityWiseOutdoorPatientsFB" property="jrxmlName"/>
<html:hidden name="SpecialityWiseOutdoorPatientsFB" property="sysDate" value="<%=tDate%>"/>
<html:hidden name="SpecialityWiseOutdoorPatientsFB" property="combo" />
