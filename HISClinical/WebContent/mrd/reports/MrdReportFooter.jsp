...
<his:ButtonToolBarTag>        
    <img class="button" src='<his:path src="/../HIS/hisglobal/images/buttons/btn-view.png"/>'style=cursor:pointer onkeypress="if(event.keyCode==13) submitReport();" tabindex="1" onclick = "submitReport();" />         
