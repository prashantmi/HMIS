...
<!--
							...
							JSP: Registration Census Report
...
function RegistrationCensusReportHandler()
{
	
			document.getElementsByName('jrxmlName')[0].value="<%=MrdConfig.REGISTRATION_CENSUS_REPORT%>";
...
<his:TitleTag name="Registration Census Report">
</his:TitleTag>
      ...
      <bean:define name="RegistrationCensusReportFB" property="fromDate" id="frDate" type="java.lang.String"/>
	   <bean:define name="RegistrationCensusReportFB" property="toDate" id="tDate" type="java.lang.String"/>          
	   <%
...
<tr>	
	    <td class="tdfonthead"  width="25%"  align="center">       	      
				...
				<td class="tdfont" width="25%">
	    		 <html:select name="RegistrationCensusReportFB"  property="hospitalCode" tabindex="1" styleClass="regcbo" >
 		...
 		<td class="tdfonthead" nowrap width="25%" >  
      	...
      	<td class="tdfont"  width="25%" >
     		 		...
     		 		<html:select name="RegistrationCensusReportFB"  property="patCatCode"  tabindex="1"  styleClass="regcbo" >   
					  <html:option value="%">All</html:option>
					  	<logic:present name="<%=MrdConfig.MRD_PATIENT_CATEGORY_LIST%>">
					  
					  	<html:options collection ="<%=MrdConfig.MRD_PATIENT_CATEGORY_LIST%>" property = "value" labelProperty = "label"/>
					  </logic:present>
			  		</html:select> 
 ...
 <his:SubTitleTag name="Report Generation Options">
    ...
    <tr>   
        ...
        <td width="25%" class="tdfont" > 
	        <html:select name="RegistrationCensusReportFB"  property="graphOrText" tabindex="1" styleClass="regcbo" >
        ...
        <td width="25%" class="tdfont">
        		<html:select name="RegistrationCensusReportFB" property="reportType" tabindex="1" styleClass="regcbo">
					<html:option value="-1">Select Value</html:option>        	
...
<input type="hidden"  name="mode" value="REGISTRATIONCENSUSREPORT">
<html:hidden name="RegistrationCensusReportFB" property="jrxmlPath" value="<%=MrdConfig.MRD_JRXML_PATH%>"/>
<html:hidden name="RegistrationCensusReportFB" property="jrxmlName"/>
<html:hidden name="RegistrationCensusReportFB" property="sysDate" value="<%=tDate%>"/>
