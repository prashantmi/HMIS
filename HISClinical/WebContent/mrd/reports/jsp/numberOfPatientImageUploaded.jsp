...
function numberOfPatientImageUploadedReportHandler()
{
	document.getElementsByName('jrxmlName')[0].value="<%=OpdConfig.NUMBER_OF_PATIENT_IMAGE_UPLOADED%>";         
	success=false;
...
<his:TitleTag name="Number of Patient Image Uploaded">
</his:TitleTag>
...
<input type="hidden"  name="mode" value="NUMBEROFPATIENTIMAGEUPLOADEDREPORT">
