...
<s:form action="mRDDiagnosticStatisticsReport">
<div class="wrapper rounded">
<div class="div-table">
			<div class="div-table-row ">
				<div class="div-table-col title width60 ">
						<s:text name="Diagnostic Statistics "/>&nbsp;<s:text name="Report"/>
				</div>
...
<!-- 			</div> -->
			...
			<%-- <div >	Order By:	<br>
				...
				<div class="div-table-col control" style="width: 25%;"><s:radio  name="strOrder" list="#{'1':'Disease Name', '2':'ICD Code'}" value="%{strOrder}"></s:radio>		 
				</div>
...
<s:hidden name="title" value="Diagnostic Statistics Report"></s:hidden>
...
var DiagStatsReport={
		/* onchange_strDeptCode:function()
		  ...
		  clearTile:function(){
			  document.forms[0].action="cancelmRDDiagnosticStatisticsReport.action";
		  ...
		  showReport:function(){
			  ...
			  if($('#mRDDiagnosticStatisticsReport').form('validate')){
				  document.forms[0].action="showReportmRDDiagnosticStatisticsReport.action";
			  	  document.forms[0].submit();
			  }
			  else{
				  return true;
