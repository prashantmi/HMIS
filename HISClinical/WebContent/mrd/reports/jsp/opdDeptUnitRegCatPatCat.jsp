...
function opdDeptUnitRegCatPatCatReportHandler()
{
	if(document.getElementsByName('choice')[0].checked)
	{
    	if(document.getElementsByName('view')[0].checked)
    	{
    		document.getElementsByName('jrxmlName')[0].value="<%=OpdConfig.OPD_PAT_LIST_REG_CAT_WISE_TODAY%>";
    	}
    	else
    	{
    		document.getElementsByName('jrxmlName')[0].value="<%=OpdConfig.OPD_PAT_LIST_PAT_CAT_WISE_TODAY%>";
    	}
	}
	if(document.getElementsByName('choice')[1].checked)
	{
		if(document.getElementsByName('view')[0].checked)
		{
			document.getElementsByName('jrxmlName')[0].value="<%=OpdConfig.OPD_PAT_LIST_REG_CAT_WISE_DATEWISE%>";
		}
		else
		{
			document.getElementsByName('jrxmlName')[0].value="<%=OpdConfig.OPD_PAT_LIST_PAT_CAT_WISE_DATEWISE%>";
		}         
	}
	success=false;
	...
	return success;
}//end of function opdDeptUnitRegCatPatCatReportHandler()

</script>

<his:TitleTag name="Department Unit Registration / Patient Category Report">
</his:TitleTag>
...
<logic:equal name="opdDeptUnitRegCatPatCatFB" property="choice" value="<%=Config.CHOICE_TODAY%>">
             <%
...
<logic:equal name="opdDeptUnitRegCatPatCatFB" property="choice" value="<%=Config.CHOICE_DATE_WISE%>">
        <%     
        	   fromDateLabel="" ;
               toDateLabel="" ;
               fromDateControl="" ;
      ...
      <bean:define name="opdDeptUnitRegCatPatCatFB" property="fromDate" id="frDate" type="java.lang.String"/>
	   <bean:define name="opdDeptUnitRegCatPatCatFB" property="toDate" id="tDate" type="java.lang.String"/>          
	   <%
		...
		<tr>            
 			<td class="tdfonthead" nowrap width="25%">       	      
		    	<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
		      		...
		      		<html:radio name="opdDeptUnitRegCatPatCatFB" property="choice" tabindex="1" value="<%=Config.CHOICE_TODAY%>" onclick="showdivtoday()"/>
		        <font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
		       		<bean:message key="dateWise"/>
		       	</font> 
		        	<html:radio name="opdDeptUnitRegCatPatCatFB" property="choice" tabindex="1" value="<%=Config.CHOICE_DATE_WISE%>" onclick="showdivdatewise()"/>
			</td> 
 		</tr>
 		<tr>
			...
			<td class="tdfont" width="25%">
	    		<div id='divfromDateControl' style='<%=fromDateControl %>'align="left">	               		 
		 		...
		 		<span id='divfromhrcontrol' style='<%=fromControl %>'align="left">	            
		   			<html:text name="opdDeptUnitRegCatPatCatFB" tabindex="1" property="fromHour"  maxlength="2" size="3"  onkeydown="setPreviosValue(this, event)" onkeyup="moveToRightBox(this, event)" onkeypress="return validateNumeric(event)" />	
		  			 <b>	<bean:message key="colon"/></b>
				</span>
		 		<span id='divfromMinControl' style='<%=fromControl %>' align="left">         
					<html:text name="opdDeptUnitRegCatPatCatFB" tabindex="1" property="fromMin"   maxlength="2" size="3" onkeydown="setPreviosValue(this, event)" onkeyup="moveToRightBox(this, event)" onkeypress="return validateNumeric(event)"/>				
			...
			<td class="tdfont" width="25%">
		 		<div id='divtoDateControl' style='<%=toDateControl %>' align="left">    
    	  		...
    	  		<span id='divtohrcontrol' style='<%=toControl%>' align="left">	            
		   			<html:text name="opdDeptUnitRegCatPatCatFB" tabindex="1" property="toHour"  maxlength="2" size="3" onkeydown="setPreviosValue(this, event)" onkeyup="moveToRightBox(this, event)" onkeypress="return validateNumeric(event)"/>	
	   				<b><bean:message key="colon"/>	  </b>
				</span>
		 		<span id='divtoMinControl' style='<%=toControl%>' align="left">         
					<html:text name="opdDeptUnitRegCatPatCatFB" tabindex="1" property="toMin" maxlength="2" size="3"  onkeydown="setPreviosValue(this, event)" onkeyup="moveToRightBox(this, event)" onkeypress="return validateNumeric(event)"/>				
						<bean:message key="timeFormat"/>	  
    	 		</span>
			</td>                 			
 		</tr>
 		<tr>
    		...
    		<td class="tdfont">
       			<div id="deptControl" align="left"  style='<%=deptcontrol%>'>
     		 		<html:select name="opdDeptUnitRegCatPatCatFB"  property="departmentCode"  tabindex="1"  styleClass ="regcbo" onchange="showUnit()">   
...
<his:statusTransactionInProcess>
    		...
    		<td class="tdfont">
    			<div id="unitControl" align="left" >
    				<html:select name="opdDeptUnitRegCatPatCatFB"  property="unit"  tabindex="1"  styleClass ="regcbo" >
 		...
 		<tr>
 			...
 			<td class="tdfonthead" width="25%">
 				<div align="right">
 					<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
 						...
 						<html:radio name="opdDeptUnitRegCatPatCatFB" property="view" tabindex="1" value="<%=OpdConfig.VIEW_REGISTRATION_CATEGORY%>" onclick="showRegCat()"/>
 				</div>
 			</td>
 			<td class="tdfonthead" width="25%">
 				<div align="right">
 					<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
 						...
 						<html:radio name="opdDeptUnitRegCatPatCatFB" property="view" tabindex="1" value="<%=OpdConfig.VIEW_PATIENT_CATEGORY%>" onclick="showPatCat()"/>
 				</div>
 			</td>
 			<td class="tdfonthead" width="25%">
 			...
 			<td class="tdfont" width="25%">
 				<div id="divRegControl" align="left">
 					<html:select name="opdDeptUnitRegCatPatCatFB" property="patRegCatCode" tabindex="1"  styleClass ="regcbo">
 						<html:option value="-1">Select Value</html:option>
 				...
 				<div id="divPatControl" style="display: none;" align="left">
 					<html:select name="opdDeptUnitRegCatPatCatFB" property="patPrimaryCatCode" tabindex="1"  styleClass ="regcbo">
 						<html:option value="-1">Select Value</html:option>
	...
	<table width="100%" cellspacing="1" cellpadding="0">
    	<tr>       
        	...
        	<td width="25%" class="tdfont" > 
	        	<html:select name="opdDeptUnitRegCatPatCatFB"  property="graphOrText" tabindex="1" styleClass="regcbo" >
		        	<html:option value="-1">Select Value</html:option>
        	...
        	<td width="25%" class="tdfont">
        		<html:select name="opdDeptUnitRegCatPatCatFB" property="reportType" tabindex="1" styleClass="regcbo">
					<html:option value="-1">Select Value</html:option>        	
...
<html:hidden name="opdDeptUnitRegCatPatCatFB" property="reportMode" />
<html:hidden name="opdDeptUnitRegCatPatCatFB" property="mode" value="OPDDEPTUNITREGCATPATCATREPORT" />
<html:hidden name="opdDeptUnitRegCatPatCatFB" property="jrxmlPath" value="<%=OpdConfig.OPD_JRXML_PATH%>"/>
<html:hidden name="opdDeptUnitRegCatPatCatFB" property="jrxmlName"/>
<html:hidden name="opdDeptUnitRegCatPatCatFB" property="sysDate" value="<%=tDate%>"/>
