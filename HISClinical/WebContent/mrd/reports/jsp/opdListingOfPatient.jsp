...
function opdListingOfPatientReportHandler()
{
	document.getElementsByName('jrxmlName')[0].value="<%=OpdConfig.OPD_LISTING_OF_PATIENT_REPORT%>";         
	success=false;
...
<his:TitleTag name="OPD Patient Listing">
</his:TitleTag>
...
<input type="hidden"  name="mode" value="OPDLISTINGOFPATIENTREPORT">
