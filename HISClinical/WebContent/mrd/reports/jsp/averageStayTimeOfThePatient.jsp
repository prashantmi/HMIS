...
function averageStayTimeOfThePatientReportHandler()
{
...
<his:TitleTag name="Average Stay Time of the Patient">
</his:TitleTag>
...
<input type="hidden"  name="mode" value="AVERAGESTAYTIMEOFTHEPATIENT">
