...
{
		document.getElementsByName('jrxmlName')[0].value="<%=OpdConfig.OPD_ROSTER_DETAIL%>";         
...
<his:TitleTag name="OPD Roster Detail">
</his:TitleTag>
<%
			  String deptlabel="" ;
        	  String deptcontrol="" ;
	   ...
	   <bean:define name="opdRosterFB" property="fromDate" id="frDate" type="java.lang.String"/>
	   <bean:define name="opdRosterFB" property="toDate" id="tDate" type="java.lang.String"/>          
	    <%
	...
	<table width="100%" cellspacing="1" cellpadding="0">
    	<tr>       
        	...
        	<td width="25%" class="tdfont" > 
	        	<html:select name="opdRosterFB"  property="graphOrText" tabindex="1" styleClass="regcbo" >
        	...
        	<td width="25%" class="tdfont">
        		<html:select name="opdRosterFB" property="reportType" tabindex="1" styleClass="regcbo">
					<html:option value="-1">Select Value</html:option>        	
...
<html:hidden name="opdRosterFB" property="reportMode"/>
<html:hidden name="opdRosterFB" property="mode" value="OPDROSTERREPORT"/>
<html:hidden name="opdRosterFB" property="jrxmlPath" value="<%=OpdConfig.OPD_JRXML_PATH%>"/>
<html:hidden name="opdRosterFB" property="jrxmlName"/>
