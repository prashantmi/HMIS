...
function opdMedicalCertificateIssuedReportHandler()
{
	...
	return success;
}//end of function opdMedicalCertificateIssuedReportHandler()

</script>

<his:TitleTag name="Medical Certificate Issued listing">
</his:TitleTag>
...
<logic:equal name="opdMedicalCertificateIssuedFB" property="choice" value="<%=Config.CHOICE_TODAY%>">
             <%
...
<logic:equal name="opdMedicalCertificateIssuedFB" property="choice" value="<%=Config.CHOICE_DATE_WISE%>">
        <%     
        	   fromDateLabel="" ;
               toDateLabel="" ;
               fromDateControl="" ;
      ...
      <bean:define name="opdMedicalCertificateIssuedFB" property="fromDate" id="frDate" type="java.lang.String"/>
	   <bean:define name="opdMedicalCertificateIssuedFB" property="toDate" id="tDate" type="java.lang.String"/>          
	   <%
		...
		<tr>            
 			<td class="tdfonthead" nowrap width="25%">       	      
		    	<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
		      		...
		      		<html:radio name="opdMedicalCertificateIssuedFB" property="choice" tabindex="1" value="<%=Config.CHOICE_TODAY%>" onclick="showdivtoday()"/>
		        <font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
		       		<bean:message key="dateWise"/>
		       	</font> 
		        	<html:radio name="opdMedicalCertificateIssuedFB" property="choice" tabindex="1" value="<%=Config.CHOICE_DATE_WISE%>" onclick="showdivdatewise()"/>
			</td> 
 		</tr>
 		<tr>
			...
			<td class="tdfont" width="25%">
	    		<div id='divfromDateControl' style='<%=fromDateControl %>'align="left">	               		 
		 		...
		 		<span id='divfromhrcontrol' style='<%=fromControl %>'align="left">	            
		   			<html:text name="opdMedicalCertificateIssuedFB" tabindex="1" property="fromHour"  maxlength="2" size="3"  onkeydown="setPreviosValue(this, event)" onkeyup="moveToRightBox(this, event)" onkeypress="return validateNumeric(event)" />	
		  			 <b>	<bean:message key="colon"/></b>
				</span>
		 		<span id='divfromMinControl' style='<%=fromControl %>' align="left">         
					<html:text name="opdMedicalCertificateIssuedFB" tabindex="1" property="fromMin"   maxlength="2" size="3" onkeydown="setPreviosValue(this, event)" onkeyup="moveToRightBox(this, event)" onkeypress="return validateNumeric(event)"/>				
			...
			<td class="tdfont" width="25%">
		 		<div id='divtoDateControl' style='<%=toDateControl %>' align="left">    
    	  		...
    	  		<span id='divtohrcontrol' style='<%=toControl%>' align="left">	            
		   			<html:text name="opdMedicalCertificateIssuedFB" tabindex="1" property="toHour"  maxlength="2" size="3" onkeydown="setPreviosValue(this, event)" onkeyup="moveToRightBox(this, event)" onkeypress="return validateNumeric(event)"/>	
	   				<b><bean:message key="colon"/>	  </b>
				</span>
		 		<span id='divtoMinControl' style='<%=toControl%>' align="left">         
					<html:text name="opdMedicalCertificateIssuedFB" tabindex="1" property="toMin" maxlength="2" size="3"  onkeydown="setPreviosValue(this, event)" onkeyup="moveToRightBox(this, event)" onkeypress="return validateNumeric(event)"/>				
						<bean:message key="timeFormat"/>	  
    	 		</span>
			</td>                 			
 		</tr>
 		<tr>
    		...
    		<td class="tdfont">
       			<div id="deptControl" align="left"  style='<%=deptcontrol%>'>
     		 		<html:select name="opdMedicalCertificateIssuedFB"  property="departmentCode"  tabindex="1"  styleClass ="regcbo" onchange="showUnit()">   
...
<his:statusTransactionInProcess>
    		...
    		<td class="tdfont">
    			<div id="unitControl" align="left" >
    				<html:select name="opdMedicalCertificateIssuedFB"  property="unit"  tabindex="1"  styleClass ="regcbo" >
	...
	<table width="100%" cellspacing="1" cellpadding="0">
    	<tr>       
        	...
        	<td width="25%" class="tdfont" > 
	        	<html:select name="opdMedicalCertificateIssuedFB"  property="graphOrText" tabindex="1" styleClass="regcbo" >
		        	<html:option value="-1">Select Value</html:option>
        	...
        	<td width="25%" class="tdfont">
        		<html:select name="opdMedicalCertificateIssuedFB" property="reportType" tabindex="1" styleClass="regcbo">
					<html:option value="-1">Select Value</html:option>        	
...
<html:hidden name="opdMedicalCertificateIssuedFB" property="reportMode"/>
<html:hidden name="opdMedicalCertificateIssuedFB" property="mode" value="OPDMEDICALCERTIFICATEISSUEDREPORT"/>
<html:hidden name="opdMedicalCertificateIssuedFB" property="jrxmlPath" value="<%=OpdConfig.OPD_JRXML_PATH%>"/>
<html:hidden name="opdMedicalCertificateIssuedFB" property="jrxmlName"/>
<html:hidden name="opdMedicalCertificateIssuedFB" property="sysDate" value="<%=tDate%>"/>
