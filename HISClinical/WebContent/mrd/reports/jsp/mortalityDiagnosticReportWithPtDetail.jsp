...
<s:form action="mortalityDiagnosticReportWithPtDetail">
<div class="wrapper rounded">
<div class="div-table">
			<div class="div-table-row ">
				<div class="div-table-col title width60 ">
						<s:text name="Mortality Diagnostic Report With Patient Detail "/>&nbsp;<s:text name="Report"/>
				</div>
...
<!-- 			</div> -->
			...
			<%-- <div >	Order By:	<br>
				...
				<div class="div-table-col control" style="width: 50%;"><s:radio  name="strOrder" list="#{'1':'Death Date','2':'Addmission Date','3':'Patient Name','4':'CR No.','5':'Disease Name','6':'ICD Code'}" value="%{strOrder}"></s:radio>		 
				</div>
...
<s:hidden name="title" value="Mortality Diagnostic Report With Patient Detail"></s:hidden>
...
var DiagStatsReport={
		/* onchange_strDeptCode:function()
		  ...
		  clearTile:function(){
			  document.forms[0].action="cancelmortalityDiagnosticReportWithPtDetail.action";
		  ...
		  showReport:function(){
			  ...
			  if($('#mortalityDiagnosticReportWithPtDetail').form('validate')){
				  document.forms[0].action="showReportmortalityDiagnosticReportWithPtDetail.action";
			  	  document.forms[0].submit();
			  }
			  else{
				  return true;
