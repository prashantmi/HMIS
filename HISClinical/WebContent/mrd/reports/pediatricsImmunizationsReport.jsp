...
<his:TitleTag name="Immunizations Report">
</his:TitleTag>
	...
	%>
		...
		<bean:define name="PediatricsImmunizationsReportFB" property="fromDate" id="frDate" type="java.lang.String"/>
		<bean:define name="PediatricsImmunizationsReportFB" property="toDate" id="tDate" type="java.lang.String"/>          
	<%
...
<his:ContentTag>
 		...
 		<tr>
			<td width="25%" class="tdfonthead">
				<div align="right">
			        ...
			        <font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
			          	<bean:message key="immuniType"/>      
			        </font>
				</div>
	        </td>                
	        <td width="25%" class="tdfont" > 
				<div align="left">
			        <html:select name="PediatricsImmunizationsReportFB"  property="graphOrText" tabindex="1" styleClass="regcbo" >
				       	<html:option value="%">All</html:option>
				       	<html:option value="BCG">BCG</html:option>
				       	<html:option value="DPT">DPT</html:option>
				       	<html:option value="DT">DT</html:option>
				       	<html:option value="HBV">HBV</html:option>
				       	<html:option value="Measles">Measles</html:option>
				       	<html:option value="MMR">MMR</html:option>
				       	<html:option value="OPV">OPV</html:option>
 ...
 <his:SubTitleTag name="Report Generation Options">
    ...
    <tr>   
        ...
        <td width="25%" class="tdfont">
        		<html:select name="PediatricsImmunizationsReportFB" property="reportType" tabindex="1" styleClass="regcbo">
...
<html:hidden name="PediatricsImmunizationsReportFB" property="sysDate" value="<%=tDate%>"/>
