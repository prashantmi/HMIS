...
function SpecicialityGenderWiseOPDPatientReportHandler()
{
	document.getElementsByName('jrxmlName')[0].value="<%=MrdConfig.SPECIALITYGENDERWISEOPDPATIENTSREPORT_NEW%>";
...
<his:TitleTag name="Speciality and Gender Wise OPD Patients Between Two Dates">
</his:TitleTag>
      ...
      <bean:define name="SpecialityGenderWiseOPDPatientsFB" property="fromDate" id="frDate" type="java.lang.String"/>
	   <bean:define name="SpecialityGenderWiseOPDPatientsFB" property="toDate" id="tDate" type="java.lang.String"/>          
	   <%
	...
	<tr>	
 		...
 		<td class="tdfonthead" nowrap width="25%" >  
      	...
      	<td class="tdfont"  width="25%" >
     		 		...
     		 		<html:select name="SpecialityGenderWiseOPDPatientsFB"  property="departmentCode"  tabindex="1"  styleClass="regcbo" >   
 ...
 <his:SubTitleTag name="Report Generation Options">
    ...
    <tr>   
        ...
        <td width="25%" class="tdfont" > 
	        <html:select name="SpecialityGenderWiseOPDPatientsFB"  property="graphOrText" tabindex="1" styleClass="regcbo" >
        ...
        <td width="25%" class="tdfont">
        		<html:select name="SpecialityGenderWiseOPDPatientsFB" property="reportType" tabindex="1" styleClass="regcbo">
					<html:option value="-1">Select Value</html:option>        	
...
<input type="hidden"  name="mode" value="SPECIALITYGENDERWISEOPDPATIENTS">
<html:hidden name="SpecialityGenderWiseOPDPatientsFB" property="jrxmlPath" value="<%=MrdConfig.MRD_JRXML_PATH%>"/>
<html:hidden name="SpecialityGenderWiseOPDPatientsFB" property="jrxmlName"/>
<html:hidden name="SpecialityGenderWiseOPDPatientsFB" property="sysDate" value="<%=tDate%>"/>
