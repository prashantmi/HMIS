...
<his:TitleTag name="Deliveries And Cu-T Insertion Report">
</his:TitleTag>
	...
	%>
		...
		<bean:define name="DeliveriesAndCUTInsertionReportFB" property="fromDate" id="frDate" type="java.lang.String"/>
		<bean:define name="DeliveriesAndCUTInsertionReportFB" property="toDate" id="tDate" type="java.lang.String"/>          
	<%
...
<his:ContentTag>
		...
		<tr>            
 		...
 		<tr>
 		 ...
 		 <div align="right">
	        ...
	        <font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
	        	<bean:message key="serviceType"/>      
	        </font>
	       </div>
        </td>
        <td width="25%" class="tdfont">
        		<html:select name="DeliveriesAndCUTInsertionReportFB" property="strService" tabindex="1" styleClass="regcbo">
					<html:option value="0">All</html:option>
					<html:option value="1">Delivery</html:option>
					<html:option value="2">Cu-T Insertion</html:option>
        		</html:select>
        	</td>
 ...
 <his:SubTitleTag name="Report Generation Options">
    ...
    <tr>   
        ...
        <td width="25%" class="tdfont" > 
	        <html:select name="DeliveriesAndCUTInsertionReportFB"  property="graphOrText" tabindex="1" styleClass="regcbo" >
        ...
        <td width="25%" class="tdfont">
        		<html:select name="DeliveriesAndCUTInsertionReportFB" property="reportType" tabindex="1" styleClass="regcbo">
...
<html:hidden name="DeliveriesAndCUTInsertionReportFB" property="sysDate" value="<%=tDate%>"/>
