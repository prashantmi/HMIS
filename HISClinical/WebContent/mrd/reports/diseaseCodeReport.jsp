...
function DiseaseCodeReportHandler()
{
    	...
    	document.getElementsByName('jrxmlName')[0].value="<%=MrdConfig.DISEASE_CODE_REPORT%>";
	success=false;
...
<html:hidden name="DiseaseCodeReportFB" property="jrxmlPath" value="<%=MrdConfig.MRD_JRXML_PATH%>"/>
