...
function AgeSexReligionHosRegReportHandler()
{
	if(document.getElementsByName('religionCode')[0].value=='%')
	{
		if(document.getElementsByName('ageRange')[0].value=='%')
			document.getElementsByName('jrxmlName')[0].value="<%=MrdConfig.All_AGE_SEX_ALLRELIGION_HOS_REGISTRATION_REPORT%>";
		else
			document.getElementsByName('jrxmlName')[0].value="<%=MrdConfig.AGE_SEX_ALLRELIGION_HOS_REGISTRATION_REPORT%>";
	}
	else 
	{
		if(document.getElementsByName('ageRange')[0].value=='%')	
		document.getElementsByName('jrxmlName')[0].value="<%=MrdConfig.ALL_AGE_SEX_RELIGION_HOS_REGISTRATION_REPORT%>";
		else
			document.getElementsByName('jrxmlName')[0].value="<%=MrdConfig.AGE_SEX_RELIGION_HOS_REGISTRATION_REPORT%>";
	}
...
<his:TitleTag name="Age Wise/Sex/Religion Hospital Registration Between Two Dates">
</his:TitleTag>
      ...
      <bean:define name="AgeSexReligionHosRegFB" property="fromDate" id="frDate" type="java.lang.String"/>
	   <bean:define name="AgeSexReligionHosRegFB" property="toDate" id="tDate" type="java.lang.String"/>          
	   <%
...
<tr>	
 		...
 		<td class="tdfonthead" nowrap width="25%" >  
      	...
      	<td class="tdfont"  width="25%" >
     		 		...
     		 		<html:select name="AgeSexReligionHosRegFB"  property="ageRange"  tabindex="1"  styleClass="regcbo" >   
			...
			<td class="tdfonthead" nowrap width="25%" >
    			...
    			<html:select name="AgeSexReligionHosRegFB"  property="genderCode"  tabindex="1"  styleClass ="regcbo" >
    			<html:option value="%">All</html:option>
      ...
      <tr>
      		...
      		<td class="tdfonthead" nowrap width="25%" >
    			...
    			<html:select name="AgeSexReligionHosRegFB"  property="religionCode"  tabindex="1"  styleClass ="regcbo" >
    			<html:option value="%">All</html:option>
 ...
 <his:SubTitleTag name="Report Generation Options">
    ...
    <tr>   
        ...
        <td width="25%" class="tdfont" > 
	        <html:select name="AgeSexReligionHosRegFB"  property="graphOrText" tabindex="1" styleClass="regcbo" >
        ...
        <td width="25%" class="tdfont">
        		<html:select name="AgeSexReligionHosRegFB" property="reportType" tabindex="1" styleClass="regcbo">
					<html:option value="-1">Select Value</html:option>        	
...
<input type="hidden"  name="mode" value="AGESEXRELIGIONHOSREGREPORT">
<html:hidden name="AgeSexReligionHosRegFB" property="jrxmlPath" value="<%=MrdConfig.MRD_JRXML_PATH%>"/>
<html:hidden name="AgeSexReligionHosRegFB" property="jrxmlName"/>
<html:hidden name="AgeSexReligionHosRegFB" property="sysDate" value="<%=tDate%>"/>
