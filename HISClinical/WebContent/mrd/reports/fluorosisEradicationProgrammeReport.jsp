...
<!-- 
                  ...
                  Report Name	: Fluorosis Eradication Programme Report
...
function FluorosisEradicationProgrammeReportHandler()
{
	
    	document.getElementsByName('jrxmlName')[0].value="<%=MrdConfig.FLUOROSIS_ERADICATION_PROGRAMME_REPORT%>";
	success=false;
...
<his:TitleTag name="Fluorosis Eradication Programme Report">
</his:TitleTag>
      ...
      <bean:define name="FluorosisEradicationProgrammeReportFB" property="fromDate" id="frDate" type="java.lang.String"/>
	  <bean:define name="FluorosisEradicationProgrammeReportFB" property="toDate" id="tDate" type="java.lang.String"/>          
	   <%
 ...
 <his:SubTitleTag name="Report Generation Options">
    ...
    <tr>   
        ...
        <td width="25%" class="tdfont" > 
	        <html:select name="FluorosisEradicationProgrammeReportFB"  property="graphOrText" tabindex="1" styleClass="regcbo" >
        ...
        <td width="25%" class="tdfont">
        		<html:select name="FluorosisEradicationProgrammeReportFB" property="reportType" tabindex="1" styleClass="regcbo">
					<html:option value="-1">Select Value</html:option>        	
...
<input type="hidden"  name="mode" value="FLUOROSISERADICATIONPROGRAMMEREPORT">
<html:hidden name="FluorosisEradicationProgrammeReportFB" property="jrxmlPath" value="<%=MrdConfig.MRD_JRXML_PATH%>"/>
<html:hidden name="FluorosisEradicationProgrammeReportFB" property="jrxmlName"/>
<html:hidden name="FluorosisEradicationProgrammeReportFB" property="sysDate" value="<%=tDate%>"/>
