...
function showRegCat()
{
	...
	document.getElementById("divRegControl").style.display="";
	document.getElementById("divPat").style.display="none";
	document.getElementById("divPatControl").style.display="none";
	/* document.getElementsByName('label')[0].value=document.getElementsByName('patRegCatCode')[0].options[document.getElementsByName('patRegCatCode')[0].selectedIndex].text;
	alert("label :"+document.getElementsByName('label')[0].value); */
}

function showPatCat()
{
	document.getElementById("divReg").style.display="none";
	document.getElementById("divRegControl").style.display="none";
	document.getElementById("divPat").style.display="";
	document.getElementById("divPatControl").style.display="";
	/* document.getElementsByName('label')[0].value=document.getElementsByName('patPrimaryCatCode')[0].options[document.getElementsByName('patPrimaryCatCode')[0].selectedIndex].text;
	alert("label :"+document.getElementsByName('label')[0].value); */
}
...
function opdStaticReportHandler()
{
	//alert("inside opdDeptUnitRegCatPatCatReportHandler");
	...
	/* alert("strDeptName :"+document.getElementsByName('strDeptName')[0].value);
	alert("strUnitName :"+document.getElementsByName('strUnitName')[0].value);
	alert("label :"+document.getElementsByName('label')[0].value); */
	...
	if(document.getElementsByName('choice')[0].checked)
	{
    	if(document.getElementsByName('view')[0].checked)
    	{
    		document.getElementsByName('jrxmlName')[0].value="<%=MrdConfig.OPD_PAT_STATISTICS_REG_CAT_WISE_TODAY%>";
    	}
    	else
    	{
    		document.getElementsByName('jrxmlName')[0].value="<%=MrdConfig.OPD_PAT_STATISTICS_PAT_CAT_WISE_TODAY%>";
    	}
	}
	if(document.getElementsByName('choice')[1].checked)
	{
		if(document.getElementsByName('view')[0].checked)
		{
			document.getElementsByName('jrxmlName')[0].value="<%=MrdConfig.OPD_PAT_STATISTICS_REG_CAT_WISE_DATEWISE%>";
		}
		else
		{
			document.getElementsByName('jrxmlName')[0].value="<%=MrdConfig.OPD_PAT_STATISTICS_PAT_CAT_WISE_DATEWISE%>";
		}         
	}
	success=false;
	...
	if(document.getElementsByName('patRegCatCode')[0].value==-1 && document.getElementsByName('patPrimaryCatCode')[0].value==-1)
	{
	...
	//alert("lable :"+document.getElementsByName('label')[0].value);
	
	return success;
}//end of function opdStaticReportHandler()

</script>

<his:TitleTag name="Opd Static Report">
</his:TitleTag>
...
<logic:equal name="OpdStaticReportFB" property="choice" value="<%=Config.CHOICE_TODAY%>">
             <%
...
<logic:equal name="OpdStaticReportFB" property="choice" value="<%=Config.CHOICE_DATE_WISE%>">
        <%     
        	   fromDateLabel="" ;
               toDateLabel="" ;
               fromDateControl="" ;
      ...
      <bean:define name="OpdStaticReportFB" property="fromDate" id="frDate" type="java.lang.String"/>
	   <bean:define name="OpdStaticReportFB" property="toDate" id="tDate" type="java.lang.String"/>          
	   <%
		...
		<tr>            
 			<td class="tdfonthead" nowrap width="25%">       	      
		    	<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
		      		...
		      		<html:radio name="OpdStaticReportFB" property="choice" tabindex="1" value="<%=Config.CHOICE_TODAY%>" onclick="showdivtoday()"/>
		        <font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
		       		<bean:message key="dateWise"/>
		       	</font> 
		        	<html:radio name="OpdStaticReportFB" property="choice" tabindex="1" value="<%=Config.CHOICE_DATE_WISE%>" onclick="showdivdatewise()"/>
			</td> 
			 ...
			 <!-- New Change add Hospital Combo -->
		      <td width="25%" class="tdfonthead">
				...
				<td class="tdfont" width="25%">
					<div >
					<html:select name="OpdStaticReportFB" property="hospitalCode" tabindex="1"  >
			...
			<td class="tdfont" width="25%">
	    		<div id='divfromDateControl' style='<%=fromDateControl %>'align="left">	               		 
		 		...
		 		<span id='divfromhrcontrol' style='<%=fromControl %>'align="left">	            
		   			<html:text name="OpdStaticReportFB" tabindex="1" property="fromHour"  maxlength="2" size="3"  onkeydown="setPreviosValue(this, event)" onkeyup="moveToRightBox(this, event)" onkeypress="validateNumeric(event)" />	
		  			 <b>	<bean:message key="colon"/></b>
				</span>
		 		<span id='divfromMinControl' style='<%=fromControl %>' align="left">         
					<html:text name="OpdStaticReportFB" tabindex="1" property="fromMin"   maxlength="2" size="3" onkeydown="setPreviosValue(this, event)" onkeyup="moveToRightBox(this, event)" onkeypress="validateNumeric(event)"/>				
			...
			<td class="tdfont" width="25%">
		 		<div id='divtoDateControl' style='<%=toDateControl %>' align="left">    
    	  		...
    	  		<span id='divtohrcontrol' style='<%=toControl%>' align="left">	            
		   			<html:text name="OpdStaticReportFB" tabindex="1" property="toHour"  maxlength="2" size="3" onkeydown="setPreviosValue(this, event)" onkeyup="moveToRightBox(this, event)" onkeypress="validateNumeric(event);"/>	
	   				<b><bean:message key="colon"/>	  </b>
				</span>
		 		<span id='divtoMinControl' style='<%=toControl%>' align="left">         
					<html:text name="OpdStaticReportFB" tabindex="1" property="toMin" maxlength="2" size="3"  onkeydown="setPreviosValue(this, event)" onkeyup="moveToRightBox(this, event)" onkeypress="validateNumeric(event)"/>				
						<bean:message key="timeFormat"/>	  
    	 		</span>
			</td>                 			
 		</tr>
 		<tr>
    		...
    		<td class="tdfont">
       			<div id="deptControl" align="left"  style='<%=deptcontrol%>'>
     		 		<html:select name="OpdStaticReportFB"  property="departmentCode"  tabindex="1"  styleClass ="regcbo" onchange="showUnit()">   
					  <html:option value="%">All</html:option>
...
<%-- <his:statusTransactionInProcess> --%>
    		...
    		<td class="tdfont">
    			<div id="unitControl" align="left" >
    				<html:select name="OpdStaticReportFB"  property="unit"  tabindex="1"  styleClass ="regcbo" >
						<html:option value="%">All</html:option>
...
<%-- </his:statusTransactionInProcess> --%>	
 		...
 		<tr>
 			...
 			<td class="tdfonthead" width="25%">
 				<div align="right">
 					<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
 						...
 						<html:radio name="OpdStaticReportFB" property="view" tabindex="1" value="<%=MrdConfig.VIEW_REGISTRATION_CATEGORY%>" onclick="showRegCat()"/>
 				</div>
 			</td>
 			<td class="tdfonthead" width="25%">
 				<div align="right">
 					<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
 						...
 						<html:radio name="OpdStaticReportFB" property="view" tabindex="1" value="<%=MrdConfig.VIEW_PATIENT_CATEGORY%>" onclick="showPatCat()"/>
 				</div>
 			</td>
 			<td class="tdfonthead" width="25%">
 				<div id='divReg'  align="right">
					<font color="#FF0000" size="1" face="Verdana, Arial, Helvetica, sans-serif\">*</font>
         			<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
		 				<bean:message key="regCat"/>
		 			</font>
 				</div>
 				<div id="divPat" style="display: none;" align="right">
 					<font color="#FF0000" size="1" face="Verdana, Arial, Helvetica, sans-serif\">*</font>
         			<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
		 				<bean:message key="patCat"/>
		 			</font>
 			...
 			<td class="tdfont" width="25%">
 				<div id="divRegControl" align="left">
 					<html:select name="OpdStaticReportFB" property="patRegCatCode" tabindex="1"  styleClass ="regcbo">
 						<html:option value="%">All</html:option>
 				...
 				<div id="divPatControl" style="display: none;" align="left">
 					<html:select name="OpdStaticReportFB" property="patPrimaryCatCode" tabindex="1"  styleClass ="regcbo">
 						<html:option value="%">All</html:option>
	...
	<table width="100%" cellspacing="1" cellpadding="0">
    	<tr>       
        	...
        	<td width="25%" class="tdfont" > 
	        	<html:select name="OpdStaticReportFB"  property="graphOrText" tabindex="1" styleClass="regcbo" >
        	...
        	<td width="25%" class="tdfont">
        		<html:select name="OpdStaticReportFB" property="reportType" tabindex="1" styleClass="regcbo">
					<html:option value="-1">Select Value</html:option>        	
...
<html:hidden name="OpdStaticReportFB" property="reportMode" />
<html:hidden name="OpdStaticReportFB" property="mode" value="OPDSTATICREPORT" />
<html:hidden name="OpdStaticReportFB" property="jrxmlPath" value="<%=MrdConfig.MRD_JRXML_PATH%>"/>
<html:hidden name="OpdStaticReportFB" property="jrxmlName"/>
<html:hidden name="OpdStaticReportFB" property="sysDate" value="<%=tDate%>"/>
<html:hidden name="OpdStaticReportFB" property="strDeptName" />
<html:hidden name="OpdStaticReportFB" property="strUnitName" />
<html:hidden name="OpdStaticReportFB" property="label" />
