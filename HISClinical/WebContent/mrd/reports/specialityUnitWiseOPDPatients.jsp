...
function SpecicialityUnitWiseOPDPatientReportHandler()
{
	
    	document.getElementsByName('jrxmlName')[0].value="<%=MrdConfig.SPECIALITY_UNITWISE_SPECIALCLINIC_REPORT%>";
	success=false;
...
<his:TitleTag name="Speciality & Unit Wise Special Clinic OPD patients">
</his:TitleTag>
      ...
      <bean:define name="SpecialityUnitWiseOpdPatientsFB" property="fromDate" id="frDate" type="java.lang.String"/>
	   <bean:define name="SpecialityUnitWiseOpdPatientsFB" property="toDate" id="tDate" type="java.lang.String"/>          
	   <%
...
<tr>	
 			<td class="tdfonthead" nowrap width="25%" >
      			...
      			<td class="tdfont" nowrap width="25%">
     		 		...
     		 		<html:select name="SpecialityUnitWiseOpdPatientsFB"  property="departmentCode"  tabindex="1"  styleClass="regcbo" onchange="submitPage('UNIT')" >   
    			...
    			<html:select name="SpecialityUnitWiseOpdPatientsFB"  property="unit"  tabindex="1"  styleClass ="regcbo" >
    ...
    <tr>   
        ...
        <td width="25%" class="tdfont" > 
	        <html:select name="SpecialityUnitWiseOpdPatientsFB"  property="graphOrText" tabindex="1" styleClass="regcbo" >
        ...
        <td width="25%" class="tdfont">
        		<html:select name="SpecialityUnitWiseOpdPatientsFB" property="reportType" tabindex="1" styleClass="regcbo">
					<html:option value="-1">Select Value</html:option>        	
...
<input type="hidden"  name="mode" value="SPECIALITYUNITWISEOPDPATIENTS">
<html:hidden name="SpecialityUnitWiseOpdPatientsFB" property="jrxmlPath" value="<%=MrdConfig.MRD_JRXML_PATH%>"/>
<html:hidden name="SpecialityUnitWiseOpdPatientsFB" property="jrxmlName"/>
<html:hidden name="SpecialityUnitWiseOpdPatientsFB" property="sysDate" value="<%=tDate%>"/>
