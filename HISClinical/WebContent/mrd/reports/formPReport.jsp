...
function FormPReportHandler()
{
	
    	document.getElementsByName('jrxmlName')[0].value="<%=MrdConfig.FORM_P_REPORT%>";
	success=false;
...
<his:TitleTag name="Form P Report">
</his:TitleTag>
      ...
      <bean:define name="FormPReportFB" property="fromDate" id="frDate" type="java.lang.String"/>
	  <bean:define name="FormPReportFB" property="toDate" id="tDate" type="java.lang.String"/>          
	   <%
...
<table width="100%" cellspacing="1" cellpadding="0">
	<tr>	
		...
		<div align="right"> 
      	...
      	<td class="tdfont"  width="25%">
		 		<html:select name="FormPReportFB"  property="departmentCode"  tabindex="1"  styleClass="regcbo" >   
	...
	<div align="right">
	        ...
	        <td width="25%" class="tdfont" > 
		        <html:select name="FormPReportFB"  property="choice" tabindex="1" styleClass="regcbo" >
 ...
 <his:SubTitleTag name="Report Generation Options">
    ...
    <tr>   
        ...
        <td width="25%" class="tdfont" > 
	        <html:select name="FormPReportFB"  property="graphOrText" tabindex="1" styleClass="regcbo" >
        ...
        <td width="25%" class="tdfont">
        		<html:select name="FormPReportFB" property="reportType" tabindex="1" styleClass="regcbo">
					<html:option value="-1">Select Value</html:option>        	
...
<input type="hidden"  name="mode" value="FORMPREPORT">
<html:hidden name="FormPReportFB" property="jrxmlPath" value="<%=MrdConfig.MRD_JRXML_PATH%>"/>
<html:hidden name="FormPReportFB" property="jrxmlName"/>
<html:hidden name="FormPReportFB" property="sysDate" value="<%=tDate%>"/>
