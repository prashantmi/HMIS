...
function IndoorPatientsBetweenTwoDatesReportHandler()
{
	
	document.getElementsByName('jrxmlName')[0].value="<%=MrdConfig.INDOOR_PATIENTS_BETWEEN_TWO_DATES%>";
...
<his:TitleTag name="Indoor Patients Between Two Dates Report">
</his:TitleTag>
      ...
      <bean:define name="IndoorPatientsBetweenTwoDatesFB" property="fromDate" id="frDate" type="java.lang.String"/>
	  <bean:define name="IndoorPatientsBetweenTwoDatesFB" property="toDate" id="tDate" type="java.lang.String"/>          
	     <%
 ...
 <his:SubTitleTag name="Report Generation Options">
    ...
    <tr>   
        ...
        <td width="25%" class="tdfont" > 
	        <html:select name="IndoorPatientsBetweenTwoDatesFB"  property="graphOrText" tabindex="1" styleClass="regcbo" >
        ...
        <td width="25%" class="tdfont">
        		<html:select name="IndoorPatientsBetweenTwoDatesFB" property="reportType" tabindex="1" styleClass="regcbo">
					<html:option value="-1">Select Value</html:option>        	
...
<input type="hidden"  name="mode" value="INDOORPATIENTSBETWEENTWODATESREPORT">
<html:hidden name="IndoorPatientsBetweenTwoDatesFB" property="jrxmlPath" value="<%=MrdConfig.MRD_JRXML_PATH%>"/>
<html:hidden name="IndoorPatientsBetweenTwoDatesFB" property="jrxmlName"/>
<html:hidden name="IndoorPatientsBetweenTwoDatesFB" property="sysDate" value="<%=tDate%>"/>
