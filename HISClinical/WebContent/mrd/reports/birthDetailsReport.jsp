...
function BirthDetailsReportHandler()
{
	
    	document.getElementsByName('jrxmlName')[0].value="<%=MrdConfig.BIRTH_DETAILS_REPORT%>";
	success=false;
  ...
  //   alert("inside validateTodayOrDate");
     success=false;        	   
	           ...
	           valSysDate=document.getElementsByName('sysDate')[0];
      			//alert("In Validate Date Function");
               if(compareDateCall(valFromDate,valSysDate,2,"From Date","System Date"))          //compareDateCall(valFromDate,valToDate,2,"From Date","To Date")) // && compareDateCall(valToDate,valSysDate,2,"To Date","System Date"))
               {
                success=true;
               }             
           return success;        
...
<his:TitleTag name="Birth Details On Date">
</his:TitleTag>
      ...
      <bean:define name="BirthDetailsReportFB" property="fromDate" id="frDate" type="java.lang.String"/>
 ...
 <his:SubTitleTag name="Report Generation Options">
    ...
    <tr>   
        ...
        <td width="25%" class="tdfont" > 
	        <html:select name="BirthDetailsReportFB"  property="graphOrText" tabindex="1" styleClass="regcbo" >
        ...
        <td width="25%" class="tdfont">
        		<html:select name="BirthDetailsReportFB" property="reportType" tabindex="1" styleClass="regcbo">
					<html:option value="-1">Select Value</html:option>        	
...
<input type="hidden"  name="mode" value="BIRTHDETAILSREPORT">
<html:hidden name="BirthDetailsReportFB" property="jrxmlPath" value="<%=MrdConfig.MRD_JRXML_PATH%>"/>
<html:hidden name="BirthDetailsReportFB" property="jrxmlName"/>
<html:hidden name="CommunicableDisReportFB" property="sysDate" value="<%=frDate%>"/>
