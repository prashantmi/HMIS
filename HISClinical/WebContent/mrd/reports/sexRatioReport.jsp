...
function SexRatioReportHandler()
{
	
	document.getElementsByName('jrxmlName')[0].value="<%=MrdConfig.SEX_RATIO_REPORT%>";
...
<his:TitleTag name="Sex Ratio Report">
</his:TitleTag>
      ...
      <bean:define name="SexRatioFB" property="fromDate" id="frDate" type="java.lang.String"/>
	  <bean:define name="SexRatioFB" property="toDate" id="tDate" type="java.lang.String"/>          
	     <%
 ...
 <his:SubTitleTag name="Report Generation Options">
    ...
    <tr>   
        ...
        <td width="25%" class="tdfont" > 
	        <html:select name="SexRatioFB"  property="graphOrText" tabindex="1" styleClass="regcbo" >
        ...
        <td width="25%" class="tdfont">
        		<html:select name="SexRatioFB" property="reportType" tabindex="1" styleClass="regcbo">
					<html:option value="-1">Select Value</html:option>        	
...
<input type="hidden"  name="mode" value="SEXRATIOREPORT">
<html:hidden name="SexRatioFB" property="jrxmlPath" value="<%=MrdConfig.MRD_JRXML_PATH%>"/>
<html:hidden name="SexRatioFB" property="jrxmlName"/>
<html:hidden name="SexRatioFB" property="sysDate" value="<%=tDate%>"/>
