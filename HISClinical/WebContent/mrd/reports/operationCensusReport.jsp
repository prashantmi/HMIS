...
<script>
	...
	function operationCensusReportHandler()
	{
		...
		return success;
	}//end of function operationCensusReportHandler()

</script>

<his:TitleTag name="Operation Census Report">
</his:TitleTag>
      ...
      <bean:define name="operationCensusReportFB" property="fromDate" id="frDate" type="java.lang.String"/>
	   <bean:define name="operationCensusReportFB" property="toDate" id="tDate" type="java.lang.String"/>          
	   <%
			...
			<!-- New Change add Hospital Combo -->
		      <td width="25%" class="tdfonthead">
				...
				<td class="tdfont" width="25%">
					<div >
					<html:select name="operationCensusReportFB" property="multipleHospitalCode" tabindex="1" multiple="true" size="4">
		...
		<tr>
    		...
    		<td class="tdfont">
       			<div id="deptControl" align="left"  style='<%=deptcontrol%>'>
     		 		<html:select name="operationCensusReportFB"  property="departmentCode"  tabindex="1"  styleClass ="regcbo">   
	...
	<table width="100%" cellspacing="1" cellpadding="0">
    	<tr>       
        	...
        	<td width="25%" class="tdfont" > 
	        	<html:select name="operationCensusReportFB"  property="graphOrText" tabindex="1" styleClass="regcbo" >
        	...
        	<td width="25%" class="tdfont">
        		<html:select name="operationCensusReportFB" property="reportType" tabindex="1" styleClass="regcbo">
					<html:option value="-1">Select Value</html:option>        	
...
<html:hidden name="operationCensusReportFB" property="reportMode" />
<html:hidden name="operationCensusReportFB" property="mode" value="OPERATIONCENSUSREPORT" />
<html:hidden name="operationCensusReportFB" property="jrxmlName" value="<%=MrdConfig.MRD_OPERATION_CENSUS_REPORT_DATEWISE %>"/>
<html:hidden name="operationCensusReportFB" property="sysDate" value="<%=tDate%>"/>
<html:hidden name="operationCensusReportFB" property="choice" value="<%=Config.CHOICE_DATE_WISE%>" onclick="showdivdatewise()"/>
<html:hidden name="operationCensusReportFB" property="jrxmlPath" value="<%=MrdConfig.MRD_JRXML_PATH%>"/>
<html:hidden name="operationCensusReportFB" property="strDeptName" />
