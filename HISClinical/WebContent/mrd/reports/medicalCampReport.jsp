...
<script>
	...
	function medicalCampReportHandler()
	{
...
<his:TitleTag name="Medical Camp Report">
</his:TitleTag>
      ...
      <bean:define name="medicalCampReportFB" property="fromDate" id="frDate" type="java.lang.String"/>
	   <bean:define name="medicalCampReportFB" property="toDate" id="tDate" type="java.lang.String"/>          
	   <%
			...
			<!-- New Change add Hospital Combo -->
		      <td width="25%" class="tdfonthead">
				...
				<td class="tdfont" width="25%">
					<div >
					<html:select name="medicalCampReportFB" property="multipleHospitalCode" tabindex="1" multiple="true" size="4">
	...
	<table width="100%" cellspacing="1" cellpadding="0">
    	<tr>       
        	...
        	<td width="25%" class="tdfont" > 
	        	<html:select name="medicalCampReportFB"  property="graphOrText" tabindex="1" styleClass="regcbo" >
        	...
        	<td width="25%" class="tdfont">
        		<html:select name="medicalCampReportFB" property="reportType" tabindex="1" styleClass="regcbo">
					<html:option value="-1">Select Value</html:option>        	
...
<html:hidden name="medicalCampReportFB" property="reportMode" />
<html:hidden name="medicalCampReportFB" property="mode" value="MEDICALCAMPREPORT" />
<html:hidden name="medicalCampReportFB" property="jrxmlName" value="<%=MrdConfig.MRD_MEDICAL_CAMP_DATEWISE %>"/>
<html:hidden name="medicalCampReportFB" property="sysDate" value="<%=tDate%>"/>
<html:hidden name="medicalCampReportFB" property="choice" value="<%=Config.CHOICE_DATE_WISE%>" onclick="showdivdatewise()"/>
<html:hidden name="medicalCampReportFB" property="jrxmlPath" value="<%=MrdConfig.MRD_JRXML_PATH%>"/>
