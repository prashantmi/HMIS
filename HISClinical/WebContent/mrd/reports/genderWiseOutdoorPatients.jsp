...
function GenderWiseOutdoorPatientReportHandler()
{
	if(document.getElementsByName('gender')[0].value=='%')
		document.getElementsByName('jrxmlName')[0].value="<%=MrdConfig.GENDER_WISE_OUTDOOR_PATIENTS_REPORT%>";
	else
		document.getElementsByName('jrxmlName')[0].value="<%=MrdConfig.SPECIFIC_GENDER_WISE_OUTDOOR_PATIENTS_REPORT%>";
		
	success=false;
	if(!validateTodayOrDate())  return false;
	if(document.getElementsByName('patCat')[0].value==-1)
	{
		alert("Please select the Patient Category");
		document.getElementsByName('patCat')[0].focus();
		return false;
	}
...
<his:TitleTag name="Sex Wise Distribution of OPD Patients Between Dates">
</his:TitleTag>
      ...
      <bean:define name="GenderWiseOutdoorPatientsFB" property="fromDate" id="frDate" type="java.lang.String"/>
	   <bean:define name="GenderWiseOutdoorPatientsFB" property="toDate" id="tDate" type="java.lang.String"/>          
	   <%
...
<tr>            
 		 	<td class="tdfonthead" nowrap width="25%" >
    			...
    			<html:select name="GenderWiseOutdoorPatientsFB"  property="gender"  tabindex="1"  styleClass ="regcbo" >
   		...
   		<td class="tdfonthead" nowrap width="25%" >
      			...
      			<td class="tdfont" nowrap width="25%">
     		 		...
     		 		<html:select name="GenderWiseOutdoorPatientsFB"  property="patCat"  tabindex="1"  styleClass="regcbo" >   
 ...
 <his:SubTitleTag name="Report Generation Options">
    ...
    <tr>   
        ...
        <td width="25%" class="tdfont" > 
	        <html:select name="GenderWiseOutdoorPatientsFB"  property="graphOrText" tabindex="1" styleClass="regcbo" >
        ...
        <td width="25%" class="tdfont">
        		<html:select name="GenderWiseOutdoorPatientsFB" property="reportType" tabindex="1" styleClass="regcbo">
					<html:option value="-1">Select Value</html:option>        	
...
<input type="hidden"  name="mode" value="GENDERWISEOUTDOORPATIENTS">
<html:hidden name="GenderWiseOutdoorPatientsFB" property="jrxmlPath" value="<%=MrdConfig.MRD_JRXML_PATH%>"/>
<html:hidden name="GenderWiseOutdoorPatientsFB" property="jrxmlName"/>
<html:hidden name="GenderWiseOutdoorPatientsFB" property="sysDate" value="<%=tDate%>"/>
