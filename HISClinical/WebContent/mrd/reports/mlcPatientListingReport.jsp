...
<script>
	...
	function mlcPatientListingReportHandler()
	{
		...
		return success;
	}//end of function mlcPatientListingReportHandler()

</script>

<his:TitleTag name="MLC Patient Listing Report">
</his:TitleTag>
      ...
      <bean:define name="mlcPatientListingReportFB" property="fromDate" id="frDate" type="java.lang.String"/>
	   <bean:define name="mlcPatientListingReportFB" property="toDate" id="tDate" type="java.lang.String"/>          
	   <%
			...
			<!-- New Change add Hospital Combo -->
		      <td width="25%" class="tdfonthead">
				...
				<td class="tdfont" width="25%">
					<div >
					<html:select name="mlcPatientListingReportFB" property="multipleHospitalCode" tabindex="1" multiple="true" size="4">
	...
	<table width="100%" cellspacing="1" cellpadding="0">
    	<tr>       
        	...
        	<td width="25%" class="tdfont" > 
	        	<html:select name="mlcPatientListingReportFB"  property="graphOrText" tabindex="1" styleClass="regcbo" >
        	...
        	<td width="25%" class="tdfont">
        		<html:select name="mlcPatientListingReportFB" property="reportType" tabindex="1" styleClass="regcbo">
					<html:option value="-1">Select Value</html:option>        	
...
<html:hidden name="mlcPatientListingReportFB" property="reportMode" />
<html:hidden name="mlcPatientListingReportFB" property="mode" value="MLCPATIENTLISTINGREPORT" />
<html:hidden name="mlcPatientListingReportFB" property="jrxmlName" value="<%=MrdConfig.MRD_MLC_PATIENT_LISTING_DATEWISE%>"/>
<html:hidden name="mlcPatientListingReportFB" property="sysDate" value="<%=tDate%>"/>
<html:hidden name="mlcPatientListingReportFB" property="choice" value="<%=Config.CHOICE_DATE_WISE%>" onclick="showdivdatewise()"/>
<html:hidden name="mlcPatientListingReportFB" property="jrxmlPath" value="<%=MrdConfig.MRD_JRXML_PATH%>"/>
