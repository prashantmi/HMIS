...
<script>
	...
	function broughtDeathPatientListingReportHandler()
	{
...
<his:TitleTag name="Brought Death Patient Listing Report ">
</his:TitleTag>
      ...
      <bean:define name="broughtDeathPatientListingReportFB" property="fromDate" id="frDate" type="java.lang.String"/>
	   <bean:define name="broughtDeathPatientListingReportFB" property="toDate" id="tDate" type="java.lang.String"/>          
	   <%
			...
			<!-- New Change add Hospital Combo -->
		      <td width="25%" class="tdfonthead">
				...
				<td class="tdfont" width="25%">
					<div >
					<html:select name="broughtDeathPatientListingReportFB" property="multipleHospitalCode" tabindex="1" multiple="true" size="4">
	...
	<table width="100%" cellspacing="1" cellpadding="0">
    	<tr>       
        	...
        	<td width="25%" class="tdfont" > 
	        	<html:select name="broughtDeathPatientListingReportFB"  property="graphOrText" tabindex="1" styleClass="regcbo" >
        	...
        	<td width="25%" class="tdfont">
        		<html:select name="broughtDeathPatientListingReportFB" property="reportType" tabindex="1" styleClass="regcbo">
					<html:option value="-1">Select Value</html:option>        	
...
<html:hidden name="broughtDeathPatientListingReportFB" property="reportMode" />
<html:hidden name="broughtDeathPatientListingReportFB" property="mode" value="BROUGHTDEATHPATIENTLISTINGREPORT" />
<html:hidden name="broughtDeathPatientListingReportFB" property="jrxmlName" value="<%=MrdConfig.MRD_BROUGHT_DEATH_PATIENT_LISTING_DATEWISE%>"/>
<html:hidden name="broughtDeathPatientListingReportFB" property="sysDate" value="<%=tDate%>"/>
<html:hidden name="broughtDeathPatientListingReportFB" property="choice" value="<%=Config.CHOICE_DATE_WISE%>" onclick="showdivdatewise()"/>
<html:hidden name="broughtDeathPatientListingReportFB" property="jrxmlPath" value="<%=MrdConfig.MRD_JRXML_PATH%>"/>
