...
function TwentyPointReportHandler()
{
	
    	document.getElementsByName('jrxmlName')[0].value="<%=MrdConfig.TWENTY_POINT_REPORT%>";
	success=false;
...
<his:TitleTag name="Twenty Point Report For A Month">
</his:TitleTag>
      ...
      <bean:define name="TwentyPointReportFB" property="fromDate" id="frDate" type="java.lang.String"/>
	  <bean:define name="TwentyPointReportFB" property="toDate" id="tDate" type="java.lang.String"/>          
	   <%
 ...
 <his:SubTitleTag name="Report Generation Options">
    ...
    <tr>   
        ...
        <td width="25%" class="tdfont" > 
	        <html:select name="TwentyPointReportFB"  property="graphOrText" tabindex="1" styleClass="regcbo" >
        ...
        <td width="25%" class="tdfont">
        		<html:select name="TwentyPointReportFB" property="reportType" tabindex="1" styleClass="regcbo">
					<html:option value="-1">Select Value</html:option>        	
...
<input type="hidden"  name="mode" value="TWENTYPOINTREPORT">
<html:hidden name="TwentyPointReportFB" property="jrxmlPath" value="<%=MrdConfig.MRD_JRXML_PATH%>"/>
<html:hidden name="TwentyPointReportFB" property="jrxmlName"/>
<html:hidden name="TwentyPointReportFB" property="sysDate" value="<%=tDate%>"/>
