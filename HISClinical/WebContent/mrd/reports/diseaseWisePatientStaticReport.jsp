...
<script>
	...
	function diseaseWisePatientStaticReportHandler()
	{
...
<his:TitleTag name="Disease Wise Patient Static Report">
</his:TitleTag>
      ...
      <bean:define name="diseaseWisePatientStaticReportFB" property="fromDate" id="frDate" type="java.lang.String"/>
	   <bean:define name="diseaseWisePatientStaticReportFB" property="toDate" id="tDate" type="java.lang.String"/>          
	   <%
			...
			<!-- New Change add Hospital Combo -->
		      <td width="25%" class="tdfonthead">
				...
				<td class="tdfont" width="25%">
					<div >
					<html:select name="diseaseWisePatientStaticReportFB" property="multipleHospitalCode" tabindex="1" multiple="true" size="4">
		...
		<tr>
    		...
    		<td class="tdfont">
       			<div id="deptControl" align="left"  style='<%=deptcontrol%>'>
     		 		<html:select name="diseaseWisePatientStaticReportFB"  property="departmentCode"  tabindex="1"  styleClass ="regcbo">   
	...
	<table width="100%" cellspacing="1" cellpadding="0">
    	<tr>       
        	...
        	<td width="25%" class="tdfont" > 
	        	<html:select name="diseaseWisePatientStaticReportFB"  property="graphOrText" tabindex="1" styleClass="regcbo" >
        	...
        	<td width="25%" class="tdfont">
        		<html:select name="diseaseWisePatientStaticReportFB" property="reportType" tabindex="1" styleClass="regcbo">
					<html:option value="-1">Select Value</html:option>        	
...
<html:hidden name="diseaseWisePatientStaticReportFB" property="reportMode" />
<html:hidden name="diseaseWisePatientStaticReportFB" property="mode" value="DISEASEWISEPATIENTSTATICREPORT" />
<html:hidden name="diseaseWisePatientStaticReportFB" property="jrxmlName" value="<%=MrdConfig.MRD_DISEASE_WISE_PATIENT_STATIC_DATEWISE %>"/>
<html:hidden name="diseaseWisePatientStaticReportFB" property="sysDate" value="<%=tDate%>"/>
<html:hidden name="diseaseWisePatientStaticReportFB" property="choice" value="<%=Config.CHOICE_DATE_WISE%>" onclick="showdivdatewise()"/>
<html:hidden name="diseaseWisePatientStaticReportFB" property="jrxmlPath" value="<%=MrdConfig.MRD_JRXML_PATH%>"/>
<html:hidden name="diseaseWisePatientStaticReportFB" property="strDeptName" />
