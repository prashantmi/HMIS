...
function RegisteredMlcPatientReportHandler()
{
    	...
    	document.getElementsByName('jrxmlName')[0].value="<%=MrdConfig.REGISTERED_MLC_PATIENTS%>";
	success=false;
...
<html:hidden name="RegisteredMlcPatientsFB" property="jrxmlPath" value="<%=MrdConfig.MRD_JRXML_PATH%>"/>
