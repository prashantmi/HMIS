...
function NonCommunicableDisReportHandler()
{
	
	document.getElementsByName('jrxmlName')[0].value="<%=MrdConfig.NON_COMMUNICABLE_DISEASE_REPORT%>";
...
<his:TitleTag name="Non Communicable Disease Report">
</his:TitleTag>
      ...
      <bean:define name="NonCommunicableDisReportFB" property="fromDate" id="frDate" type="java.lang.String"/>
	  <bean:define name="NonCommunicableDisReportFB" property="toDate" id="tDate" type="java.lang.String"/>          
	     <%
 ...
 <his:SubTitleTag name="Report Generation Options">
    ...
    <tr>   
        ...
        <td width="25%" class="tdfont" > 
	        <html:select name="NonCommunicableDisReportFB"  property="graphOrText" tabindex="1" styleClass="regcbo" >
        ...
        <td width="25%" class="tdfont">
        		<html:select name="NonCommunicableDisReportFB" property="reportType" tabindex="1" styleClass="regcbo">
					<html:option value="-1">Select Value</html:option>        	
...
<input type="hidden"  name="mode" value="NONCOMMUNICABLEDISREPORT">
<html:hidden name="NonCommunicableDisReportFB" property="jrxmlPath" value="<%=MrdConfig.MRD_JRXML_PATH%>"/>
<html:hidden name="NonCommunicableDisReportFB" property="jrxmlName"/>
<html:hidden name="NonCommunicableDisReportFB" property="sysDate" value="<%=tDate%>"/>
