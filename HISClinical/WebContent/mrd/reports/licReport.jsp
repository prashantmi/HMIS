...
function LICReportHandler()
{
	
    	document.getElementsByName('jrxmlName')[0].value="<%=MrdConfig.LIC_REPORT%>";
	success=false;
...
<his:TitleTag name="LIC Report Between Two Dates">
</his:TitleTag>
      ...
      <bean:define name="LICReportFB" property="fromDate" id="frDate" type="java.lang.String"/>
	  <bean:define name="LICReportFB" property="toDate" id="tDate" type="java.lang.String"/>          
	   <%
 ...
 <his:SubTitleTag name="Report Generation Options">
    ...
    <tr>   
        ...
        <td width="25%" class="tdfont" > 
	        <html:select name="LICReportFB"  property="graphOrText" tabindex="1" styleClass="regcbo" >
        ...
        <td width="25%" class="tdfont">
        		<html:select name="LICReportFB" property="reportType" tabindex="1" styleClass="regcbo">
					<html:option value="-1">Select Value</html:option>        	
...
<input type="hidden"  name="mode" value="LICREPORT">
<html:hidden name="LICReportFB" property="jrxmlPath" value="<%=MrdConfig.MRD_JRXML_PATH%>"/>
<html:hidden name="LICReportFB" property="jrxmlName"/>
<html:hidden name="LICReportFB" property="sysDate" value="<%=tDate%>"/>
