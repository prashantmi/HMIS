...
%>
	...
	<td width="12%" class="tdfont">
					<div align="center">	           
					<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
					<% String Path="consentOfflineInbox.cnt?hmode=POPUP&patCrNo="+patCrNo+"&templateId="+consentRequestVO.getConsentId();%>
	...
	<td width="12%" class="tdfont">
					<div align="center">	           
					<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
					<% String Path="/HISClinical/opd/consentOfflineInbox.cnt?hmode=POPUP&patCrNo="+patCrNo+"&templateId="+consentRequestVO.getConsentId()+"&i="+idx;%>
					<a style="cursor:pointer" onclick="openPopup('<%=Path%>',event,300,600)" >
					<%=consentRequestVO.getTemplateDesc()%>
					</a>
					</font>
