...
<his:TransactionContainer>
		...
		<logic:present name="<%=MrdConfig.ALL_CID_NO_INFO_LIST_FOR_INSURANCE %>">
		<logic:notEmpty name="<%=MrdConfig.ALL_CID_NO_INFO_LIST_FOR_INSURANCE %>">
		<his:ContentTag>
		<table  width="100%" border="0" cellspacing="1" cellpadding="1">
			...
			<logic:iterate id="DocReceivingFormDtlvo" name="<%=MrdConfig.ALL_CID_NO_INFO_LIST_FOR_INSURANCE %>" indexId="idx" type="hisglobal.vo.DocReceivingFormDtlVO">
			<tr>
				<td class="tdfont" >
				 	<div align="center">
				 		<html:radio property="CIDNoArray" value="<%=DocReceivingFormDtlvo.getCIDNo() %>" onclick="fillCIDNo()"></html:radio>
				 		<html:hidden name="InsuranceClaimReceiveFB" property="recevingDateArray" value="<%=DocReceivingFormDtlvo.getReceivingDate() %>"/>
				 		<html:hidden name="InsuranceClaimReceiveFB" property="recevingTimeHoursArray" value='<%=DocReceivingFormDtlvo.getReceivingTime().split(":")[0] %>'/>
				 		<html:hidden name="InsuranceClaimReceiveFB" property="recevingTimeMinuteArray" value='<%=DocReceivingFormDtlvo.getReceivingTime().split(":")[1] %>'/>
				 	</div>
				 </td>
				<td class="tdfont" >
				 	<div align="center">
		...
		<logic:present name="<%=MrdConfig.ALL_CID_NO_INFO_LIST_FOR_INSURANCE %>">
		<logic:empty name="<%=MrdConfig.ALL_CID_NO_INFO_LIST_FOR_INSURANCE %>">
			<div align="left">	           
