 		...
 		<table width="100%" cellspacing="1" cellpadding="0">
			...
			<tr>
				...
				<td width="75%" class="tdfont">
					<html:radio name="GenericTemplateTileFB" property="reportMode" value="<%=GenericTemplateConfig.TEMPLATE_VIEW_REPORT_TYPE_MODE_TEMPLATE_WISE %>" onchange="submitForm('CHANGEREPORTMODE');"></html:radio>
					<bean:message key="tempWise"/> &nbsp;&nbsp;&nbsp;&nbsp;
					<html:radio name="GenericTemplateTileFB" property="reportMode" value="<%=GenericTemplateConfig.TEMPLATE_VIEW_REPORT_TYPE_MODE_PARAMETER_WISE %>" onchange="submitForm('CHANGEREPORTMODE');"></html:radio>
...
<his:ButtonToolBarTag>
	<img class="button" src='<his:path src="/hisglobal/images/btn-go.png"/>' style="cursor:pointer" onclick ="submitFormOnValidate(validateGoGetTemplate(),'GOGETREPORT');" onkeypress="if(event.keyCode==13) submitFormOnValidate(validateGoGetTemplate(),'GOGETREPORT');" >
