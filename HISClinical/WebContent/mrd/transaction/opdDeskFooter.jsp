...
<table width="100%" cellspacing="0" cellpadding="0" 
	...
	<tr>
		...
		<td id="nextVisitDateControl" width="40%" class="tdfont"nowrap="nowrap"  >   
	    				...
	    				<img class="button"  class="button" src="../hisglobal/images/go blue 2.png" tabindex="1" border="0" style="cursor:pointer" onkeypress="if(event.keyCode==13)saveVisit();" onClick="saveVisit();" >
	    					</div>
	  	 </td>
	  	--%>
</tr>
