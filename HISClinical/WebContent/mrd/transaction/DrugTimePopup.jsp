...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<bean:define id="popupFreId" name="PatientTreatmentDetailFB" property="popupFreqId"></bean:define>	
	<bean:define id="popupRowIndex" name="PatientTreatmentDetailFB" property="popupRowIndex"></bean:define>	
	<bean:define id="popupItemTypeId" name="PatientTreatmentDetailFB" property="popupItemTypeId"></bean:define>	
	<bean:define id="popupIsEmpStomach" name="PatientTreatmentDetailFB" property="popupIsEmptyStomach"></bean:define>
	<bean:define id="popupDoseId" name="PatientTreatmentDetailFB" property="popupDoseId" type="java.lang.String"></bean:define>
	<bean:define id="popupDoseName" name="PatientTreatmentDetailFB" property="popupDoseName" type="java.lang.String"></bean:define>
	<bean:define id="popupDrugId" name="PatientTreatmentDetailFB" property="popupDrugId" type="java.lang.String"></bean:define>
	 ...
	 %>
				...
				<tr>
					...
					<td class="tdfont" width="25%">
						<html:hidden name="PatientTreatmentDetailFB" property="drugFreqShift" value="<%=drugSheduleDtlVO.getDoseShift() %>"/>
						<% String shift="";
					...
					%>
						...
						<%String[] time= drugSheduleDtlVO.getDoseTime().split(":");%>
							<html:text name="PatientTreatmentDetailFB"  property="drugRequirmentTimeHrs" value="<%=time[0] %>" size="3" tabindex="1" maxlength="2"  onkeypress="return validateNumeric(event)"  disabled="false"/>
							:
							<html:text name="PatientTreatmentDetailFB" property="drugRequirmentTimeMin"  value="<%=time[1]%>" size="3" tabindex="1" maxlength="2"  onkeypress="return validateNumeric(event)"  disabled="false"/>
						</div>
...
<!--					This tr not in use for display purpose (but value of empty stomach going in table)-->
					...
					<% if(drugSheduleDtlVO.getDoseId().equals("0")) { %>
						<div align="left">
						<html:text property="popupDoseNameArray" name="PatientTreatmentDetailFB" size="6" value="<%=drugSheduleDtlVO.getDoseName() %>"></html:text>
						</div>
						
					<%}else{ %>	
						<div align="left">
						<html:select name="PatientTreatmentDetailFB" property="popupDoseIdArray" tabindex="1" value="<%=drugSheduleDtlVO.getDoseId()%>" >
				...
				<html:hidden name="PatientTreatmentDetailFB" property="popupFreqCount" value="<%=drugSheduleDtlVO.getFrequency() %>"/>			 
		...
		<his:ContentTag>
			<table width="100%" cellpadding="0" cellspacing="1" >
				...
				<tr>
					...
					<td class="tdfont" width="25%">
						<div align="left">
							<html:text name="PatientTreatmentDetailFB"  property="drugRequirmentTimeHrs" value="<%=morHrs %>" size="3" tabindex="1" maxlength="2"  onkeypress="return validateNumeric(event)"  disabled="false"/>
							:
							<html:text name="PatientTreatmentDetailFB" property="drugRequirmentTimeMin"  value="<%=morMin %>" size="3" tabindex="1" maxlength="2"  onkeypress="return validateNumeric(event)"  disabled="false"/>
						</div>
					...
					<td class="tdfont" width="25%">
						<div align="left">
							<html:text name="PatientTreatmentDetailFB"  property="drugRequirmentTimeHrs" value="<%=aftHrs %>" size="3" tabindex="1" maxlength="2"  onkeypress="return validateNumeric(event)"  disabled="false"/>
							:
							<html:text name="PatientTreatmentDetailFB" property="drugRequirmentTimeMin" value="<%=aftMin %>" size="3" tabindex="1" maxlength="2"  onkeypress="return validateNumeric(event)"  disabled="false"/>
						</div>
					...
					<td class="tdfont" width="25%">
						<div align="left">
							<html:text name="PatientTreatmentDetailFB"  property="drugRequirmentTimeHrs" value="<%=eveHrs %>" size="3" tabindex="1" maxlength="2"  onkeypress="return validateNumeric(event)"  disabled="false"/>
							:
							<html:text name="PatientTreatmentDetailFB" property="drugRequirmentTimeMin" value="<%=eveMin %>" size="3" tabindex="1" maxlength="2"  onkeypress="return validateNumeric(event)"  disabled="false"/>
						</div>
					...
					<td class="tdfont" width="25%">
						<div align="left">
							<html:text name="PatientTreatmentDetailFB"  property="drugRequirmentTimeHrs" value="<%=ngtHrs %>" size="3" tabindex="1" maxlength="2"  onkeypress="return validateNumeric(event)"  disabled="false"/>
							:
							<html:text name="PatientTreatmentDetailFB" property="drugRequirmentTimeMin" value="<%=ngtMin %>" size="3" tabindex="1" maxlength="2"  onkeypress="return validateNumeric(event)"  disabled="false"/>
						</div>
...
<!--					This tr not in use for display purpose (but value of empty stomach going in table)-->					
				...
				<%	if(drugFreqVO.getMorDoseTime()!=null)	{	%>	
					...
					<% if(popupDoseId.equals("0")) { %>
						<div align="left">
						<html:text property="popupDoseNameArray" name="PatientTreatmentDetailFB" size="10" value="<%=popupDoseName %>"></html:text>
						</div>
						
					<%}else{ %>
						<div align="left">
						<html:select name="PatientTreatmentDetailFB" property="popupDoseIdArray" tabindex="1" value="<%=popupDoseId%>"  >
						<html:option value="-1">Select</html:option >
						<html:options collection="<%=OpdConfig.LIST_OF_DRUGDOSE_FOR_POPUP%>" property="value" labelProperty="label"/>
						</html:select>	
						</div>
		...
		<html:hidden name="PatientTreatmentDetailFB" property="popupFreqCount" value="<%=freqCount %>"/>	
...
%>
	...
	%>					
		...
		<his:ButtonToolBarTag>
			<img class="button" src='<his:path src="/hisglobal/images/OK1.jpg"/>'  style=cursor:pointer tabindex="1" onclick ="submitPage(validateHrsTimeSave(),'SAVEDRUGSHEDULE')" onkeypress="if(event.keyCode==13) submitPage('SAVEDRUGSHEDULE')">
        ...
        <html:hidden name="PatientTreatmentDetailFB" property="popupFreqId"/>
        <html:hidden name="PatientTreatmentDetailFB" property="popupItemTypeId"/>
        <html:hidden name="PatientTreatmentDetailFB" property="popupIsEmptyStomach"/>
        <html:hidden name="PatientTreatmentDetailFB" property="popupDoseId"/>
        <html:hidden name="PatientTreatmentDetailFB" property="popupRowIndex"/>
        <html:hidden name="PatientTreatmentDetailFB" property="popupDrugId"/>
        <html:hidden name="PatientTreatmentDetailFB" property="popupCheckIndex"/>
        <html:hidden name="PatientTreatmentDetailFB" property="popupDoseName"/>
