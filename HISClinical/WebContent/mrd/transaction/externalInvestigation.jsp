...
<script type="text/javascript">
	...
	<logic:equal name="ExternalInvestigationFB" property="isDirectCall" value="DIRECT">
		<form action="/HISClinical/opd/externalExamination.cnt" method="post">
	</logic:equal>	
					...
					<table width="100%" border="0"  cellspacing="1" cellpadding="0">
						...
						<tr>
							...
							<td width="3%" class="tdfont">
								<div align="center">
									<img class="button" id="addButton" style="cursor:pointer" src='<his:path src="/hisglobal/images/sign-plus.png"/>' onkeypress="if(event.keyCode==13)if(validateAdd()) submitForm('ADDROW') ;" onclick="if(validateAdd()) submitForm('ADDROW')" tabindex="1">
								</div>	
							</td>
						</tr>
					</table>
					...
					<his:ContentTag>
						<table width="100%" border="0"  cellspacing="1" cellpadding="0">
							<tr>
								...
								<td width="25%" class="tdfont">
									<div align="left">
										<html:text name="ExternalInvestigationFB" property="extLabContactNo" maxlength="30" onkeypress="return validateNumeric(event)"></html:text>
									</div>
								</td>
							</tr>
							<tr>
