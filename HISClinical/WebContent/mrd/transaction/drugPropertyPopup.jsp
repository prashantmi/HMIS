...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<his:ButtonToolBarTag>
			<img class="button" src='<his:path src="/hisglobal/images/OK1.jpg"/>'  style=cursor:pointer tabindex="1" onclick ="validateCode()" onkeypress="if(event.keyCode==13) validateCode()">
