...
<logic:equal name="patientBelongingForDeskFB" property="selectedMode" value="MODIFY">
		...
		<his:ContentTag>
			...
			<logic:iterate id="patBelongingVOs" name="<%=OpdConfig.PATIENT_BELONGING_DETAILS_VOS %>" type="hisglobal.vo.PatientBelongingVO">
				...
				<tr>
			  	<td class="tdfont">
			  	<html:checkbox name="patientBelongingForDeskFB" property="chk" value="<%=patBelongingVOs.getBelongingItemCode() +"^"+ patBelongingVOs.getCollectionDate()%>" tabindex="1"></html:checkbox>
			  	</td>
			  	<td class="tdfont">
			  		<div align="center">
		...
		<tr>
			...
			<td width="32%"  class="tdfonthead">
	  		...
	  		<td  class="tdfont">
	  			<div align="center">
	  			<html:select name="patientBelongingForDeskFB" tabindex="1" property="belongingItemCode" styleClass="regcbo">
	  		...
	  		<td  class="tdfont">
	  			<div align="center">
	  			<html:textarea name="patientBelongingForDeskFB" property="quantity" styleClass="textarea"></html:textarea>
	  			
	  			</div>
	  		</td>
	  		<td class="tdfont">
	  			<div align="center">
	  			<html:text name="patientBelongingForDeskFB" property="remarks" styleClass="textbox"></html:text>
	  			</div>
	  		</td>
...
<logic:equal name="patientBelongingForDeskFB" property="selectedMode" value="HANDOVER">
		...
		<his:ContentTag>
			...
			<logic:iterate id="patBelongingVOs" name="<%=OpdConfig.PATIENT_BELONGING_DETAILS_VOS %>" type="hisglobal.vo.PatientBelongingVO">
				...
				<tr>
			  	<td class="tdfont">
			  	<html:checkbox name="patientBelongingForDeskFB" property="chk" value="<%=patBelongingVOs.getBelongingItemCode() +"^"+ patBelongingVOs.getCollectionDate()%>"></html:checkbox>
			  	</td>
			  	<td class="tdfont">
			  		<div align="center">
			  			<%= patBelongingVOs.getBelongingItemName()%>
		...
		<table width="100%"  border="0" cellspacing="1" cellpadding="0">
			...
			<td  class="tdfont">
	  			<div align="left">
	  			<html:select name="patientBelongingForDeskFB" tabindex="1" property="relation" styleClass="regcbo" onchange="showNameTextBox(this)">
	  				<html:option value="-1">Select Value</html:option>
			...
			<td  class="tdfont">
	  			<div align="left">
	  			<html:text name="patientBelongingForDeskFB" property="handOverTo" styleClass="textbox"></html:text>
...
<logic:equal name="patientBelongingForDeskFB" property="selectedMode" value="HANDOVERLIST">
...
<html:hidden name="patientBelongingForDeskFB" property="hmode"/>
<html:hidden name="patientBelongingForDeskFB" property="patCrNo"/>
<his:status/>
