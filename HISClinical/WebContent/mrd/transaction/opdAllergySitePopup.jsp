...
function isFormClose()
{
	...
	<html:form action="/opdEpisodeAllergies">
		...
		<his:ButtonToolBarTag>
			<img class="button" src='<his:path src="/hisglobal/images/OK1.jpg"/>'  style=cursor:pointer tabindex="1" onclick ="validateAllergySite()" onkeypress="if(event.keyCode==13) validateAllergySite()">
