...
function validateDays()
{
	...
	{
		opener.document.getElementsByName("durationDate")[0].value=document.getElementsByName("calculatedDays")[0].value;
		submitPage('SHOWDAYS');
	}
}
...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<body onload="isFormClose()">
			...
			<table width="100%" cellpadding="0" cellspacing="1">
				<tr>
					...
					<td class="tdfont" width="25%">
						<div align="left">
							<html:text name="GenericPatientAlertFB" property="year" onkeypress="return validateNumeric(event)" maxlength="2" size="5" onkeyup="calculateDays()" tabindex="1"></html:text>
						</div>
					</td>
					<td class="tdfonthead" width="25%">
						<div align="right">
					...
					<td class="tdfont" width="25%">
						<div align="left">
							<html:text name="GenericPatientAlertFB" property="month" onkeypress="return validateNumeric(event)" maxlength="2" size="5" onkeyup="calculateDays()" tabindex="1"></html:text>
						</div>
					</td>
				</tr>
				<tr>
					...
					<td class="tdfont" width="25%">
						<div align="left">
							<html:text name="GenericPatientAlertFB" property="day" onkeypress="return validateNumeric(event)" maxlength="3" size="5" onkeyup="calculateDays()" tabindex="1"></html:text>
						</div>
					</td>
					<td class="tdfonthead" width="25%">
						<div align="right">
					...
					<td class="tdfont" width="25%">
						<div align="left">
							<html:text name="GenericPatientAlertFB" property="calculatedDays" readonly="true" size="5" ></html:text>
						</div>
					</td>
				</tr>
			</table>
		...
		<his:ButtonToolBarTag>
			<img class="button" src='<his:path src="/hisglobal/images/OK1.jpg"/>'  style=cursor:pointer tabindex="1" onclick ="validateDays()" onkeypress="if(event.keyCode==13) validateDays()">
        ...
        <html:hidden name="GenericPatientAlertFB" property="calculatedDays"/>	
        <html:hidden name="GenericPatientAlertFB" property="durationDate"/>
	</body>	
</html:form>