...
<html:form action="/patTreatmentDetailTile">
	...
	<his:ContentTag>
		<table width="100%" cellpadding="0" cellspacing="1">
			...
			<tr>
				...
				<td width="10%" class="tdfonthead">
					<div align="center">
						<img src='<his:path src="/hisglobal/images/forward3.gif"/>' tabindex="1" 
							onClick="if(validateSearch('1')) submitForm('SEARCHDRUG');"
							onkeypress="if(event.keyCode==13) if(validateSearch('1')) submitForm('SEARCHDRUG');">
					</div>
				</td>
				<td width="30%" class="tdfonthead">
					<div align="center">
				...
				<td width="10%" class="tdfonthead">
					<div align="center">
						<img src='<his:path src="/hisglobal/images/forward3.gif"/>' tabindex="1" 
							onClick="if(validateSearch('2')) submitForm('SEARCHDRUG');"
							onkeypress="if(event.keyCode==13) if(validateSearch('2')) submitForm('SEARCHDRUG');">
					</div>
				</td>
			</tr>
		</table>
		<!-- ********************adding drug property*************************** -->
			...
			<div id="userIdDiv" style="display: none; height: 110px;width: 310px;position:relative; top: 5%;left: 5%;z-index: 9100;background-color: #FFEBD5;">
				...
				<table  width="700">
					<tr>
						<td align="center">
							<div align="center">
								<img class="button" src='<his:path src="/hisglobal/images/OK1.jpg"/>'  style=cursor:pointer tabindex="1" onclick ="cancel()">
							</div>
						</td>
					</tr>
				</table>		
				...
				<logic:iterate id="drug" name="<%=OpdConfig.PAT_TREATMENT_DTL_SERACH_DRUG_DETAIL_LIST%>" indexId="idx" type="hisglobal.utility.Entry">
					<tr>
						...
						<td width="90%" class="tdfont">
							<div align="center">
								<a style="cursor:pointer" onclick="getDrugDetail(<%=(String) drug.getValue().split("#")[2]%>,<%=idx.toString()%>)" >
			...
			<table width="100%" cellpadding="0" cellspacing="1">
				...
				<logic:iterate id="drug" name="<%=OpdConfig.DRUGLIST_LIST_FOR_SEARCH%>" indexId="idx" type="hisglobal.utility.Entry">
					<tr>
						...
						<td width="90%" class="tdfont">
							<div align="center">
							<a style="cursor:pointer" onclick="getDrugListDetail(<%=(String) drug.getValue().split("#")[0]%>)" >	
								<%
