 	...
 	<tr>
 		<td width="10%"  class="tdfonthead">
	  		...
	  		<td width="90%"  class="tdfont">
					<div align="left">	           
					<html:select name="ConsultationInboxFB" property="toDoctorCode" tabindex="1" >
	 ...
	 <his:ContentTag>
		...
		<td>
			...
			<td width="20%"  class="tdfont">
				...
				<html:textarea name="ConsultationInboxFB" property="content" tabindex="1" cols="70" rows="10" 				
