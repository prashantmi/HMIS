...
function validateSave(){
	...
	if(validateForm()){
		document.getElementsByName("hmode")[0].value="UPDATE"
		document.forms[0].submit()
	}
	else{	
		return false;
	...
	<his:ContentTag>
						...
						<tr>
							...
							<div>							
								<font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif">
									...
									<html:text name="mrdMedicalCampFB" tabindex="1" property="campStartMin"   maxlength="2" size="3"  onkeypress="return onkeyTimeMin(this,document.getElementsByName('inTimeHr')[0],event)" onblur="onblurTimeMinCheck(this)"/>				
							...
							<div>							
								<font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"> 
									...
									<html:text name="mrdMedicalCampFB" tabindex="1" property="campEndMin"   maxlength="2" size="3"  onkeypress="return onkeyTimeMin(this,document.getElementsByName('outTimeHr')[0],event)" onblur="onblurTimeMinCheck(this)"/>				
									<bean:message key="timeFormat"/>
				    				</span>
								</font>							
							</div>
		...
		<his:SubTitleTag name="Camp Team Member Detail">
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="0" id="tableParamCampId">
				...
				<tr>			
					...
					<td class="tdfont" width="30%">
						<div align="center"><html:text name="mrdMedicalCampFB" maxlength="30" 
							property="strRole" tabindex="1" >
						</html:text></div>
					</td>
					<td class="tdfont" width="30%">
						<div align="center"><html:text name="mrdMedicalCampFB" maxlength="50"
							property="strDutyRemarks" tabindex="1" >
						</html:text>
						</div>
					</td>
				...
				<logic:present name="<%=MrdConfig.MRD_MEDICAL_CAMP_EMP_VO_LIST%>">
				<logic:iterate id="mrdMedicalCampTeamDtlVO" name="<%=MrdConfig.MRD_MEDICAL_CAMP_EMP_VO_LIST%>" indexId="idx" type="hisglobal.vo.MrdMedicalCampTeamDtlVO">
					<tr id="<%=idx %>">
						...
						<td class="tdfont" width="30%">
							<div align="center"><html:text name="mrdMedicalCampFB" maxlength="30" 
								property="strArrRole" tabindex="1" value="<%=mrdMedicalCampTeamDtlVO.getStrArrRole() %>" onkeypress="return validateAlphaNumericOnly(event , this)">
							</html:text></div>
						</td>
						<td class="tdfont" width="30%">
							<div align="center"><html:text name="mrdMedicalCampFB" maxlength="50"
								property="strArrDutyRemarks" tabindex="1" value="<%=mrdMedicalCampTeamDtlVO.getStrArrDutyRemarks() %>" onkeypress="return validateAlphaNumericOnly(event , this)">
							</html:text>
							</div>
						</td>
						<td width="10%" class="tdfont">
							<div align="center">
								<img class="button" id="delButton" style="cursor: pointer" src='<his:path src="/hisglobal/images/minus.gif"/>' tabindex='1' onkeypress="if(event.keyCode==13) deleteRowNoMOd(document.getElementById(<%=idx %>));" onclick="deleteRowNoMOd(document.getElementById(<%=idx %>));">
							</div>
						</td>
					</tr>
				</logic:iterate>
		...
		<his:ButtonToolBarTag>
			<img class="button" src='<his:path src="/../HIS/hisglobal/images/buttons/btn-mo.png"/>'  style="cursor:pointer" tabindex="1" onclick =" validateSave()" onkeypress="if(event.keyCode==13)validateSave()">
