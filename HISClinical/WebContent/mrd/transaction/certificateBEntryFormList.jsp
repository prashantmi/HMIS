...
## Purpose						:	To search a CR no and raise a request for issuing Certificate B by MRD department
...
<html:form action="/certificateBEntryForm">
    <his:TitleTag name="Certificate B Entry Form Request"> 		
   </his:TitleTag> 
		   <table width="100%" border="0"  cellspacing="1" cellpadding="0">
		   	...
		   	<td width="75%" class="tdfont">
							<div align="right">
								...
								<html:radio name="duplicateRecordPrintReqFB" property="reqType"  value="0"  onclick="showDetail(0)" tabindex="1" ></html:radio>
								<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
									<bean:message key="withoutCrNo" />
								</font>
								<html:radio name="duplicateRecordPrintReqFB" property="reqType" value="1" onclick="showDetail(1); submitForm('GETPATDTL');"  tabindex="1" ></html:radio>
							</div>
						</td>
					</tr> --%>
				</table>
 ...
 <tr><td>
 <his:InputCrNoTag name="CertificateBEntryFormFB"></his:InputCrNoTag>
 </td>
