				...
				<tr>
					...
					<logic:empty name="OpdNextVisitAppointmentFB" property="aptReqNo" >
					 ...
					 <logic:notEmpty name="OpdNextVisitAppointmentFB" property="aptReqNo">
						<img class="button" src='<his:path src="/hisglobal/images/OK1.jpg"/>'	style="cursor: pointer"  tabindex="1"   onclick="submitToDesk('NEW','NEW')" onkeypress="if(event.keyCode==13) submitToDesk('NEW','NEW')">	 
					 </logic:notEmpty>
					</div>
					</div>
					</td>
