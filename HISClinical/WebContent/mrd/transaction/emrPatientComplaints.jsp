...
<his:TitleTag name="Complaints">
</his:TitleTag>


	<logic:present name="<%=MrdConfig.PAT_COMPLAINTS_DETAILS_ARRAY%>">
	<logic:notEmpty name="<%=MrdConfig.PAT_COMPLAINTS_DETAILS_ARRAY %>">
	<his:ContentTag>
	...
	<logic:notPresent name="<%=MrdConfig.PAT_COMPLAINTS_DETAILS_ARRAY%>" >
	<logic:empty name="<%=MrdConfig.PAT_COMPLAINTS_DETAILS_ARRAY %>">
		<his:ContentTag>
			<tr>
				<td class="tdfont" width="100%" nowrap>
				<div align="center">
				<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
				<bean:message key="noComplaintsFound" />
				</font>
				</div>
				</td>
			</tr>
