...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<body onload="populateInstruction()">
		...
		<his:ContentTag>
					...
					<td class="tdfonthead" width="25%" >
			  			<div align="right">	           
			 				<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
			 					<b>
			 						<bean:message key="finalInstruction"/>
			 					</b>	
			  				</font>
			  			</div>
		      		</td>
			...
			<img class="button" src='<his:path src="/hisglobal/images/OK1.jpg"/>'  style=cursor:pointer tabindex="1" onclick ="closeForm()" onkeypress="if(event.keyCode==13) closeForm()">
        	</his:ButtonToolBarTag>
        </his:ContentTag>
        <his:ContentTag>
