...
<jsp:include page="/mrd/transaction/emrHeader.jsp" flush="true"></jsp:include>
 <his:TitleTag name="Service Procedures" >
</his:TitleTag>
		...
		<table width="100%" border="0" cellspacing="1" cellpadding="0">
			<tr>
					...
					<td width="80%" class="tdfonthead" style="border-top: outset black 2px;border-bottom: inset black 2px;">
						<div align="center">
							<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
								<bean:message key="procedurename" />
							</font>
						</div>
					</td>
				
	   </tr>
	   	<logic:present name="<%=MrdConfig.PAT_SERVICE_PROCEDURE_ARRAY%>" >
		<logic:notEmpty name="<%=MrdConfig.PAT_SERVICE_PROCEDURE_ARRAY%>" >
	   <%String indexEpisodeOpen="-1"; %>
	   	<logic:iterate id="srvProcVOid" indexId="idx" name="<%=MrdConfig.PAT_SERVICE_PROCEDURE_ARRAY%>" type="hisglobal.vo.Service_Req_dtlVO">
			...
			<%--	<logic:equal name="diagnosisVOid" property="episodeIsOpen" value="1"> --%>
					...
					<tr>
						<td class="tdfontheadExam" width="20%"> 
							...
							<font color="${color}" size="2"face="Verdana, Arial, Helvetica, sans-serif">
								<bean:write  name="srvProcVOid"  property="entryDate" />
							</font>
							</b>
							</div>
						</td>
					...
					<td class="tdfontheadExam" width="80%">
							...
							<b>
							<font color="${color}" size="2"face="Verdana, Arial, Helvetica, sans-serif">
								<bean:write  name="srvProcVOid"  property="procedureName" />
							</font>
							</b>
							</div>
						</td>
			...
			<his:ContentTag>
				<tr>
					<td class="tdfont" width="25%" colspan="5" nowrap>
						<div align="center">
							<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
							<b>	<bean:message key="noSrvProcFound" /></b></font>
						</div>
					</td>
				</tr>
			</his:ContentTag>
    ...
    <logic:notPresent name="<%=MrdConfig.PAT_SERVICE_PROCEDURE_ARRAY%>" >
    	<his:ContentTag>
   			<tr>
