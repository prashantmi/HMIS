	...
	<his:ContentTag>
		...
		<tr>
			...
			<td width="32%"  class="tdfonthead">
	  		...
	  		<td  class="tdfont">
			<div align="center">   
			<img class="button" id="addButton" style="cursor:pointer" src='<his:path src="/hisglobal/images/sign-plus.png"/>' title="Add Belonging Detail" onclick="submitFormOnValidate(validateAddBelongingDetail(),'ADDDETAIL')">
			</div>
			</td> 
	  		</tr>
	  		...
	  		<td  class="tdfont">
			<div align="center">   
			<img class="button" id="deleteButton" style="cursor:pointer" src='<his:path src="/hisglobal/images/sign-minus.png"/>' title="Remove Detail" onclick="submitFormOnValidate(vaidateRemoveDetail('<%=key %>'),'REMOVEDETAIL')">
			</div>
			</td> 
	  	</tr>
