...
{ 
  ...
  this.iconImg = 0; 
  this.nodeImg = 0;
  this.iconSrc = ICONPATH + "/HISClinical/hisglobal/images/nodeOpen.gif";
  this.iconSrcClosed = ICONPATH + "/HISClinical/hisglobal/images/nodeClose.gif";
...
{ 
  ...
  if (this.level>0) 
    if (this.isLastNode) //the last child in the children array 
      ...
      leftSide = leftSide + "<td valign=top background=" + ICONPATH + "/HISClinical/hisglobal/images/ftv2vertline.gif>" + auxEv + "<img name='nodeIcon" + this.id + "' id='nodeIcon" + this.id + "' src='" + nodeName + "' width=16 height=22 border=0></a></td>"
  ...
  {
	  if (this.prependHTML == "")
        docW = docW + "<img src=" + ICONPATH + "/HISClinical/hisglobal/images/ftv2blank.gif height=2 width=2>"
  }
  if (WRAPTEXT)
...
function nodeImageSrc() {
  ...
  { 
    if (this.nChildren == 0)
      srcStr = ICONPATH + "/HISClinical/hisglobal/images/ftv2lastnode.gif"
    else
      if (this.isOpen)
        srcStr = ICONPATH + "/HISClinical/hisglobal/images/ftv2mlastnode.gif"  
      else
        srcStr = ICONPATH + "/HISClinical/hisglobal/images/ftv2plastnode.gif"  
  } 
  else 
  { 
    if (this.nChildren == 0)
      srcStr = ICONPATH + "/HISClinical/hisglobal/images/ftv2node.gif"
    else
      if (this.isOpen)
        srcStr = ICONPATH + "/HISClinical/hisglobal/images/ftv2mnode.gif"
      else
        srcStr = ICONPATH + "/HISClinical/hisglobal/images/ftv2pnode.gif"
  }   
  return srcStr;
}
...
function finalizeCreationOfItem(itemArray)
{
  ...
  itemArray.iconSrc = ICONPATH + "/HISClinical/hisglobal/images/ftv2doc.gif" 
...
{ 
  ...
  if (this.level>0) 
    ...
    { 
      leftSide = leftSide + "<td valign=top><img src='" + ICONPATH + "/HISClinical/hisglobal/images/ftv2lastnode.gif' width=16 height=22></td>"
    } 
    else 
    { 
      leftSide = leftSide + "<td valign=top background=" + ICONPATH + "/HISClinical/hisglobal/images/ftv2vertline.gif><img src='" + ICONPATH + "/HISClinical/hisglobal/images/ftv2node.gif' width=16 height=22></td>"
    } 
  ...
  if (USEICONS)
	  ...
	  if (this.prependHTML == "")
        docW = docW + "<img src=" + ICONPATH + "/HISClinical/hisglobal/images/ftv2blank.gif height=2 width=3>"
...
function leftSideHTML(leftSideCoded) {
	...
	for (i=0; i<leftSideCoded.length; i++)
	{
		...
		{
			retStr = retStr + "<td valign=top background=" + ICONPATH + "/HISClinical/hisglobal/images/ftv2vertline.gif><img src='" + ICONPATH + "/HISClinical/hisglobal/images/ftv2vertline.gif' width=16 height=22></td>"
		}
		if (leftSideCoded.charAt(i) == "0")
		{
			retStr = retStr + "<td valign=top><img src='" + ICONPATH + "/HISClinical/hisglobal/images/ftv2blank.gif' width=16 height=22></td>"
		}
	}
	return retStr
}
...
function clickOnLink(clickedId, target, windowName) {
    ...
    if (isLinked(target)) {
        window.open(createFHashAjaxQuery(target),windowName);
    }
}
...
function preLoadIcons() {
       arImageSrc = new Array (
           "/HISClinical/hisglobal/images/ftv2vertline.gif",
           "/HISClinical/hisglobal/images/ftv2mlastnode.gif",
           "/HISClinical/hisglobal/images/ftv2mnode.gif",
           "/HISClinical/hisglobal/images/ftv2plastnode.gif",
           "/HISClinical/hisglobal/images/ftv2pnode.gif",
           "/HISClinical/hisglobal/images/ftv2blank.gif",
           "/HISClinical/hisglobal/images/ftv2lastnode.gif",
           "/HISClinical/hisglobal/images/ftv2node.gif",
           "/HISClinical/hisglobal/images/ftv2folderclosed.gif",
           "/HISClinical/hisglobal/images/ftv2folderopen.gif",
           "/HISClinical/hisglobal/images/ftv2doc.gif"
           )
