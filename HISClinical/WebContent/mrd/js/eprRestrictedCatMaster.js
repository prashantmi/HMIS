function moveRightSingle(listNo)
{
	...
	if(listNo=="1")
	{
		source  = document.forms[0].patCatCode;
		target = document.forms[0].selectedPatCatCode;	
	}
...
function moveLeftSingle(listNo)
{
	...
	if(listNo=="1")
	{
		target  = document.forms[0].patCatCode;
		source = document.forms[0].selectedPatCatCode;	
	}
...
function MoveToSelected()
{
	...
	if(document.forms[0].selectedPatCatCode)
		for(var i=0;i<document.forms[0].selectedPatCatCode.length;i++)
			document.forms[0].selectedPatCatCode.options[i].selected=true;
	
	// Unselect Remaining 
	if(document.forms[0].patCatCode)
	{	
		for(var i=0;i<document.forms[0].patCatCode.options.length;i++)
			document.forms[0].patCatCode.options[i].selected=false;
	}
}
...
function clearForm(){
	...
	//document.getElementsByName('selectedPatCatCode')[0].length=0;
	//document.getElementsByName('patCatCode')[0].length=0;
}
