...
function BroughtDeadCasesReportHandler()
{
		document.getElementsByName('jrxmlName')[0].value="<%=MortuaryConfig.BROUGHT_DEAD_CASES_DATEWISE%>";         
...
<his:TitleTag name="Report for Brought dead Cases">
</his:TitleTag>
      ...
      <bean:define name="BroughtDeadCasesFB" property="fromDate" id="frDate" type="java.lang.String"/>
	   <bean:define name="BroughtDeadCasesFB" property="toDate" id="tDate" type="java.lang.String"/>          
	   <%
 ...
 <his:SubTitleTag name="Report Generation Options">
    ...
    <tr>   
        ...
        <td width="25%" class="tdfont" > 
	        <html:select name="BroughtDeadCasesFB"  property="graphOrText" tabindex="1" styleClass="regcbo" >
        ...
        <td width="25%" class="tdfont">
        		<html:select name="BroughtDeadCasesFB" property="reportType" tabindex="1" styleClass="regcbo">
					<html:option value="-1">Select Value</html:option>        	
...
<input type="hidden"  name="mode" value="BROUGHTDEADCASES">
<html:hidden name="BroughtDeadCasesFB" property="jrxmlPath" value="<%=MortuaryConfig.MORTUARY_JRXML_PATH%>"/>
<html:hidden name="BroughtDeadCasesFB" property="jrxmlName"/>
<html:hidden name="BroughtDeadCasesFB" property="sysDate" value="<%=tDate%>"/>
