...
function IoAndPSWisePostMortemReportHandler()
{
		if(document.getElementsByName('orderBy')[0].value==1)
		{
			document.getElementsByName('jrxmlName')[0].value="<%=MortuaryConfig.IONAME_AND_PSWISE_POSTMORTEM_DETAIL_IONAMEWISE%>";
		}   
		
		if(document.getElementsByName('orderBy')[0].value==2)
		{
			document.getElementsByName('jrxmlName')[0].value="<%=MortuaryConfig.IONAME_AND_PSWISE_POSTMORTEM_DETAIL_PSNAMEWISE%>";
		}         
...
<his:TitleTag name="Inquest Officer/Police Station Wise PostMortem Listing">
</his:TitleTag>
      ...
      <bean:define name="IoNameAndPSWisePostMortemFB" property="fromDate" id="frDate" type="java.lang.String"/>
	   <bean:define name="IoNameAndPSWisePostMortemFB" property="toDate" id="tDate" type="java.lang.String"/>          
	   <%
...
<tr>            
      			...
      			<td width="25%" class="tdfonthead">
					   ...
					   <td width="25%" class="tdfont" >
							<div align="left">
								<html:select name="IoNameAndPSWisePostMortemFB" property="orderBy" styleClass="regcbo" tabindex="1" >
								<html:option value="1">Officer wise</html:option>
								<html:option value="2">Police Station wise</html:option>
    ...
    <tr>  
        ...
        <td width="25%" class="tdfont" > 
	        <html:select name="IoNameAndPSWisePostMortemFB"  property="graphOrText" tabindex="1" styleClass="regcbo" >
        ...
        <td width="25%" class="tdfont">
        		<html:select name="IoNameAndPSWisePostMortemFB" property="reportType" tabindex="1" styleClass="regcbo">
					<html:option value="-1">Select Value</html:option>        	
...
<input type="hidden"  name="mode" value="IONAMEANDPSWISEPOSTMORTEM">
<html:hidden name="IoNameAndPSWisePostMortemFB" property="jrxmlPath" value="<%=MortuaryConfig.MORTUARY_JRXML_PATH%>"/>
<html:hidden name="IoNameAndPSWisePostMortemFB" property="jrxmlName"/>
<html:hidden name="IoNameAndPSWisePostMortemFB" property="sysDate" value="<%=tDate%>"/>
