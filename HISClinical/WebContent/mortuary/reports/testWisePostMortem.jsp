...
function TestWisePostMortemReportHandler()
{
		document.getElementsByName('jrxmlName')[0].value="<%=MortuaryConfig.TEST_WISE_POSTMORTEM_LISTING%>";         
...
<his:TitleTag name="Test Wise PostMortem Listing">
</his:TitleTag>
      ...
      <bean:define name="TestWisePostMortemFB" property="fromDate" id="frDate" type="java.lang.String"/>
	   <bean:define name="TestWisePostMortemFB" property="toDate" id="tDate" type="java.lang.String"/>          
	   <%
...
<tr>            
 		<td width="25%" class="tdfonthead">
						   ...
						   <td width="25%" class="tdfont" >
							<div align="left">
								<html:select name="TestWisePostMortemFB" property="labTestId" styleClass="regcbo" tabindex="1" >
    ...
    <tr>   
        ...
        <td width="25%" class="tdfont" > 
	        <html:select name="TestWisePostMortemFB"  property="graphOrText" tabindex="1" styleClass="regcbo" >
        ...
        <td width="25%" class="tdfont">
        		<html:select name="TestWisePostMortemFB" property="reportType" tabindex="1" styleClass="regcbo">
					<html:option value="-1">Select Value</html:option>        	
...
<input type="hidden"  name="mode" value="TESTWISEPOSTMORTEM">
<html:hidden name="TestWisePostMortemFB" property="jrxmlPath" value="<%=MortuaryConfig.MORTUARY_JRXML_PATH%>"/>
<html:hidden name="TestWisePostMortemFB" property="jrxmlName"/>
<html:hidden name="TestWisePostMortemFB" property="sysDate" value="<%=tDate%>"/>
