...
function ListOfDeceasedReportHandler()
{
		document.getElementsByName('jrxmlName')[0].value="<%=MortuaryConfig.LIST_OF_DECEASED%>";         
...
<his:TitleTag name="List Of Deceased">
</his:TitleTag>
      ...
      <bean:define name="ListOfDeceasedFB" property="fromDate" id="frDate" type="java.lang.String"/>
	   <bean:define name="ListOfDeceasedFB" property="toDate" id="tDate" type="java.lang.String"/>          
	   <%
...
<his:ContentTag>
 	...
 	<!-- added on 11-10-2014 Anant Patel -->
 	<tr>
			<!-- New Change add Hospital Combo -->
		      <td width="25%" class="tdfonthead">
				...
				<td class="tdfont" width="25%">
					<div >
					<html:select name="ListOfDeceasedFB" property="multipleHospitalCode" tabindex="1" multiple="true" size="4">
...
<tr>            
      			...
      			<td width="25%" class="tdfonthead">
							<div align="right">
								<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
									<bean:message key="entryMode"/>
								</font>
							</div>
						</td>
					   	<td width="25%" class="tdfont">
							<div align="left">
								<html:select name="ListOfDeceasedFB" property="entryMode" styleClass="regcbo" tabindex="1" >
									<html:option value="%">All</html:option>
									<html:option value="<%=MortuaryConfig.ENTRY_MODE_INHOUSE_SEND_ONLINE%>">Online</html:option>
									<html:option value="<%=MortuaryConfig.ENTRY_MODE_INHOUSE_SEND_OFFLINE%>">Offline</html:option>
									<html:option value="<%=MortuaryConfig.ENTRY_MODE_BROUGHT_DEAD_FROM_SPOT_BY_POLICE%>">On the spot</html:option>
									<html:option value="<%=MortuaryConfig.ENTRY_MODE_SEND_FROM_OTHER_HOSPITAL%>">Other Hospital</html:option>
								</html:select>
    ...
    <tr>   
        ...
        <td width="25%" class="tdfont" > 
	        <html:select name="ListOfDeceasedFB"  property="graphOrText" tabindex="1" styleClass="regcbo" >
        ...
        <td width="25%" class="tdfont">
        		<html:select name="ListOfDeceasedFB" property="reportType" tabindex="1" styleClass="regcbo">
					<html:option value="-1">Select Value</html:option>        	
...
<input type="hidden"  name="mode" value="LISTOFDECEASED">
<html:hidden name="ListOfDeceasedFB" property="jrxmlPath" value="<%=MortuaryConfig.MORTUARY_JRXML_PATH%>"/>
<html:hidden name="ListOfDeceasedFB" property="jrxmlName"/>
<html:hidden name="ListOfDeceasedFB" property="sysDate" value="<%=tDate%>"/>
