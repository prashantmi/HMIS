...
function LabAndTestWisePostMortemReportHandler()
{
		document.getElementsByName('jrxmlName')[0].value="<%=MortuaryConfig.LAB_AND_TEST_WISE_POSTMORTEM_LISTING%>";         
...
<his:TitleTag name="Lab and Test Wise PostMortem Listing">
</his:TitleTag>
      ...
      <bean:define name="LabAndTestWisePostMortemFB" property="fromDate" id="frDate" type="java.lang.String"/>
	   <bean:define name="LabAndTestWisePostMortemFB" property="toDate" id="tDate" type="java.lang.String"/>          
	   <%
...
<tr>            
      			...
      			<td width="25%" class="tdfonthead">
					   ...
					   <td width="25%" class="tdfont" >
							<div align="left">
								<html:select name="LabAndTestWisePostMortemFB" property="labId" styleClass="regcbo" tabindex="1" >
						...
						<td width="25%" class="tdfonthead">
						   ...
						   <td width="25%" class="tdfont" >
							<div align="left">
								<html:select name="LabAndTestWisePostMortemFB" property="labTestId" styleClass="regcbo" tabindex="1" >
									<html:option value="%">All</html:option>
    ...
    <tr>   
        ...
        <td width="25%" class="tdfont" > 
	        <html:select name="LabAndTestWisePostMortemFB"  property="graphOrText" tabindex="1" styleClass="regcbo" >
        ...
        <td width="25%" class="tdfont">
        		<html:select name="LabAndTestWisePostMortemFB" property="reportType" tabindex="1" styleClass="regcbo">
					<html:option value="-1">Select Value</html:option>        	
...
<input type="hidden"  name="mode" value="LABANDTESTWISEPOSTMORTEM">
<html:hidden name="LabAndTestWisePostMortemFB" property="jrxmlPath" value="<%=MortuaryConfig.MORTUARY_JRXML_PATH%>"/>
<html:hidden name="LabAndTestWisePostMortemFB" property="jrxmlName"/>
<html:hidden name="LabAndTestWisePostMortemFB" property="sysDate" value="<%=tDate%>"/>
