...
function DeathMannerWisePostMortemCountReportHandler()
{
		document.getElementsByName('jrxmlName')[0].value="<%=MortuaryConfig.DEATHMANNER_WISE_POSTMORTEM_COUNT%>";         
...
<his:TitleTag name="Death Manner Wise PostMortem Count">
</his:TitleTag>
      ...
      <bean:define name="DeathMannerWisePostMortemCountFB" property="fromDate" id="frDate" type="java.lang.String"/>
	   <bean:define name="DeathMannerWisePostMortemCountFB" property="toDate" id="tDate" type="java.lang.String"/>          
	   <%
...
<tr>            
      			...
      			<td width="25%" class="tdfonthead">
						   ...
						   <td width="25%" class="tdfont" >
							<div align="left">
								<html:select name="DeathMannerWisePostMortemCountFB" property="deathManner" styleClass="regcbo" tabindex="1" >
    ...
    <tr>   
        ...
        <td width="25%" class="tdfont" > 
	        <html:select name="DeathMannerWisePostMortemCountFB"  property="graphOrText" tabindex="1" styleClass="regcbo" >
        ...
        <td width="25%" class="tdfont">
        		<html:select name="DeathMannerWisePostMortemCountFB" property="reportType" tabindex="1" styleClass="regcbo">
					<html:option value="-1">Select Value</html:option>        	
...
<input type="hidden"  name="mode" value="DEATHMANNERWISEPOSTMORTEMCOUNT">
<html:hidden name="DeathMannerWisePostMortemCountFB" property="jrxmlPath" value="<%=MortuaryConfig.MORTUARY_JRXML_PATH%>"/>
<html:hidden name="DeathMannerWisePostMortemCountFB" property="jrxmlName"/>
<html:hidden name="DeathMannerWisePostMortemCountFB" property="sysDate" value="<%=tDate%>"/>
