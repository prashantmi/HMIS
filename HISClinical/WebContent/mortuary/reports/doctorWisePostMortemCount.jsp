...
function DoctorWisePostMortemCountReportHandler()
{
		document.getElementsByName('jrxmlName')[0].value="<%=MortuaryConfig.DOCTOR_WISE_POSTMORTEM_COUNT%>";         
...
<his:TitleTag name="Doctor Wise PostMortem Count">
</his:TitleTag>
      ...
      <bean:define name="DoctorWisePostMortemCountFB" property="fromDate" id="frDate" type="java.lang.String"/>
	   <bean:define name="DoctorWisePostMortemCountFB" property="toDate" id="tDate" type="java.lang.String"/>          
	   <%
...
<tr>            
      			...
      			<td width="25%" class="tdfonthead">
					   ...
					   <td width="25%" class="tdfont" >
							<div align="left">
								<html:select name="DoctorWisePostMortemCountFB" property="empNo" styleClass="regcbo" tabindex="1" >
    ...
    <tr>   
        ...
        <td width="25%" class="tdfont" > 
	        <html:select name="DoctorWisePostMortemCountFB"  property="graphOrText" tabindex="1" styleClass="regcbo" >
        ...
        <td width="25%" class="tdfont">
        		<html:select name="DoctorWisePostMortemCountFB" property="reportType" tabindex="1" styleClass="regcbo">
					<html:option value="-1">Select Value</html:option>        	
...
<input type="hidden"  name="mode" value="DOCTORWISEPOSTMORTEMCOUNT">
<html:hidden name="DoctorWisePostMortemCountFB" property="jrxmlPath" value="<%=MortuaryConfig.MORTUARY_JRXML_PATH%>"/>
<html:hidden name="DoctorWisePostMortemCountFB" property="jrxmlName"/>
<html:hidden name="DoctorWisePostMortemCountFB" property="sysDate" value="<%=tDate%>"/>
