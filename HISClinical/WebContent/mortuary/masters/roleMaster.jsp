...
{
	var valid=true;
	if(isEmpty(document.forms[0].roleName,"Role Name"))
	{
		valid=true;
	}
	else
...
{
	var valid=true;
	if(isEmpty(document.forms[0].roleName,"Role Name")&&comboValidation(document.forms[0].isActive,"Is Active"))
	{
		valid=true;
	}
	else
...
<body>
	<html:form action="/master/MorturyRoleMasterMaster">
		<his:TransactionContainer>
	
			<logic:equal name="RoleMasterFB" property="hmode" value="ADD">
				<his:TitleTag name="Role Master >> ADD">
				</his:TitleTag>
			</logic:equal>
			<logic:equal name="RoleMasterFB" property="hmode" value="MODIFY">
				<his:TitleTag name="Role Master >> MODIFY">
				</his:TitleTag>
			</logic:equal>
			<logic:equal name="RoleMasterFB" property="hmode" value="VIEW">
				<his:TitleTag name="Role Master >> VIEW">
				</his:TitleTag>
			</logic:equal>
				...
				<table width="100%" border="0" cellspacing="1" cellpadding="0">
					<tr>
						...
						<td width="50%" class="tdfont">
							<div align="left">
								<html:text name="RoleMasterFB" property="roleName" maxlength="50" size="30" onkeypress="return validateAlphaNumericOnly(event,this)">
								</html:text>
						 ...
						 <logic:notEqual name="RoleMasterFB" property="hmode" value="ADD">
			 			<logic:notEqual name="RoleMasterFB" property="hmode" value="SAVE">
			 			<logic:notEqual name="RoleMasterFB" property="hmode" value="VIEW">
			      <tr>
			        <td width="50%" class="tdfonthead">
			         <div align="right">
			        ...
			        <td width="50%" class="tdfont">
			         <div align="left">
				     &nbsp;<html:select name="RoleMasterFB" property="isActive"  style="width:160;">
			...
			<his:ContentTag>
				<table width="100%" border="0" cellspacing="1" cellpadding="0">
					<tr>
						...
						<td width="50%" class="tdfont">
							<div align="left">
								<html:text name="RoleMasterFB" property="roleName" disabled="true" maxlength="50" size="30"  >
								</html:text>
								<html:hidden name="RoleMasterFB" property="slNo"/>
								<html:hidden name="RoleMasterFB" property="roleID"/>
							</div>
			...
			<html:hidden name="RoleMasterFB" property="tempMode"/>
