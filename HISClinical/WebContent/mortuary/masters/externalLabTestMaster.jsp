...
function validateFinalSubmit(){
  ...
  if(
       isEmpty(document.forms[0].externalLabTestName,"External Lab Test Name") &&       
	   validateIsActive()
	)
	{
		return true;
...
function clearForm()
 {
    ...
    document.getElementsByName('externalLabTestName')[0].value="";
    if( document.getElementsByName('hmode')[0].value=="MODIFY"){
 ...
 <body onload="focusFirstElementOnLoad()">
  ...
  <html:form action="/master/ExternalLabTestMaster" > 
   ...
   <logic:equal name="ExtLabTestMstFB" property="hmode" value="VIEW">
   		<% this.readOnly=true; %>
   </logic:equal>
  
     <his:TransactionContainer>
       <logic:equal name="ExtLabTestMstFB" property="hmode" value="ADD">
	   		<his:TitleTag name="External Lab Test Master >> Add">
			</his:TitleTag>
  	   </logic:equal>
       <logic:equal name="ExtLabTestMstFB" property="hmode" value="MODIFY">
	   		<his:TitleTag name="External Lab Test Master >> Modify">
			</his:TitleTag>
  	   </logic:equal>
       <logic:equal name="ExtLabTestMstFB" property="hmode" value="VIEW">
	   		<his:TitleTag name="External Lab Test Master >> View">
			</his:TitleTag>
  	   </logic:equal>
	 ...
	 <his:ContentTag>
		      ...
		      <td width="50%" class="tdfonthead">
			     <div align="right">
				    ...
				    <font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
								<b><bean:message key="externalLabTestName"/>&nbsp;</b>
					</font>
				  </div>
			    </td>
			    <td width="50%" class="tdfont">
			      <div align="left">
			            <html:text name="ExtLabTestMstFB" property="externalLabTestName" tabindex="1"  maxlength="50" readonly="<%=this.readOnly %>" onkeypress="return validateAlphaNumericOnly(event,this)" />
				   </div>
			     </td>  
		      </tr>
		  	  ...
		  	  <logic:notEqual name="ExtLabTestMstFB" property="hmode" value="ADD">
			        <tr>
			         <td width="50%" class="tdfonthead">
			          <div align="right">
					   <font color="RED" size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
			        ...
			        <td width="50%" class="tdfont">
			         <div align="left">
				    <html:select name="ExtLabTestMstFB" property="isValid" tabindex="1" disabled="<%=this.readOnly %>" >
       ...
       <his:ButtonToolBarTag>
			<span id="saveDiv">
				...
				<logic:notEqual name="ExtLabTestMstFB" property="hmode" value="VIEW">
				<logic:notEqual name="ExtLabTestMstFB" property="hmode" value="ADD">
   	...
   	<html:hidden name="ExtLabTestMstFB" property="hmode"/>
	<html:hidden name="ExtLabTestMstFB" property="externalLabTestId"/>
	<html:hidden name="ExtLabTestMstFB" property="serialNo"/>
    <html:hidden name="ExtLabTestMstFB" property="chk"/>
