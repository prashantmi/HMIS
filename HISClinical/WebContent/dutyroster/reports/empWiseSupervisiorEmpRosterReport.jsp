...
<his:javascript src="/dutyroster/js/empWiseSupervisiorEmpRosterReport.js" />
...
<body onload="focusOnLoad()">
 ...
 String systemDate=hisglobal.presentation.WebUTIL.getCustomisedSysDate((Date)session.getAttribute(Config.SYSDATEOBJECT), "dd-MMM-yyyy HH:mm");
  ...
  <html:form action="/reports/EmpWiseSupervisiorEmpRosterReport" > 
...
<his:css src="/hisglobal/css/Color.css" />
       ...
       <his:TitleTag name="Supervisior Employee Roster Report">
	...
	<html:select property="empId" name="EmpWiseSupervisiorEmpRosterReportFB" tabindex="1" styleClass="textbox" >
			    <html:option value="-1">Select Value</html:option>
			       <logic:present  name="<%=DutyRosterConfig.LIST_OF_SUPERVISIOR_EMPLOYEES%>" >
			          <html:options collection="<%=DutyRosterConfig.LIST_OF_SUPERVISIOR_EMPLOYEES%>" property="value"  labelProperty="label"/>
			       </logic:present>
		   </html:select>    		   
				   </div>
			     </td>  
			     ...
			     <div align="right">
				    ...
				    <font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
								<bean:message key="printingFormat"/>
					</font>
				  </div>
			    </td>
			    ...
			    <td width="25%" class="tdfont">
			      <div align="left">	    	   
		&nbsp;Area Wise<html:radio property="printingFormat" value="A" name="EmpWiseSupervisiorEmpRosterReportFB" />&nbsp;&nbsp;Date Wise<html:radio property="printingFormat" value="D" name="EmpWiseSupervisiorEmpRosterReportFB"/>   
		  ...
		  <tr>
		      <td width="25%" class="tdfonthead">
			    ...
			    <td width="25%" class="tdfont">
			      <div align="left">			       		
		   <html:select property="year" name="EmpWiseSupervisiorEmpRosterReportFB" tabindex="1" styleClass="textbox" >
			    <html:option value="-1">Select Value</html:option>
			    ...
			    <td width="25%" class="tdfont">
			      <div align="left">	    	   
		  <html:select property="month" name="EmpWiseSupervisiorEmpRosterReportFB" tabindex="1" styleClass="textbox" >
			    <html:option value="-1">Select Value</html:option>
		      ...
		      <td width="25%" class="tdfonthead">
	    	   ...
	    	   <bean:define id="startDateId" name="EmpWiseSupervisiorEmpRosterReportFB" property="startDate"></bean:define>
			    ...
			    <td width="25%" class="tdfont">
			      <div align="left">		          
	    	     <bean:define id="endDateId" name="EmpWiseSupervisiorEmpRosterReportFB" property="endDate" ></bean:define>
...
<table width="100%">
<tr>
<td class="reportNameHeader" width="100%">

<bean:write name="EmpWiseSupervisiorEmpRosterReportFB" property="headerMsg"/>
...
<logic:equal value="A" name="EmpWiseSupervisiorEmpRosterReportFB" property="printingFormat">
...
<logic:equal value="D" name="EmpWiseSupervisiorEmpRosterReportFB" property="printingFormat">
...
<logic:equal name="EmpWiseSupervisiorEmpRosterReportFB" property="hmode" value="GET_REPORT">
<logic:empty name="<%=DutyRosterConfig.TOTAL_MAP_OF_EMP_ROSTER %>">
...
<logic:empty name="<%=DutyRosterConfig.TOTAL_MAP_OF_EMP_ROSTER %>">  
    ...
    <html:hidden name="EmpWiseSupervisiorEmpRosterReportFB" property="hmode" />
      <html:hidden name="EmpWiseSupervisiorEmpRosterReportFB" property="headerMsg"/>
