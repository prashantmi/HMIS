 ...
 //String systemDate=hisglobal.presentation.WebUTIL.getCustomisedSysDate((Date)session.getAttribute(Config.SYSDATEOBJECT), "dd-MMM-yyyy HH:mm");
  ...
  <html:form action="/transaction/EmpDutyRoster" > 
     ...
     <his:TransactionContainer>
       ...
       <his:TitleTag name="Employee Duty Roster">
	  ...
	  <his:ContentTag>
		<table width="100%" border="0" cellspacing="1" cellpadding="0">
		  ...
		  <tr>
		      <td width="25%" class="tdfonthead" >
			    ...
			    <td width="25%" class="tdfont">
			      <div align="left">			       		
		   <html:select property="year" name="EmpDutyRosterFB" tabindex="1" styleClass="textbox" onchange="submitFormData()">
			    ...
			    <td width="25%" class="tdfont">
			      <div align="left">	    	   
		  <html:select property="month" name="EmpDutyRosterFB" tabindex="1" styleClass="textbox" onchange="submitFormData()">
		  ...
		  <html:select property="rosterCategory" name="EmpDutyRosterFB" tabindex="1" styleClass="textbox" onchange="submitPage('GET_ROSTERS')">
		  ...
		  <html:select property="rosterId" name="EmpDutyRosterFB" tabindex="1" styleClass="textbox" onchange="submitPage('GET_DUTY_AREA')">
		  ...
		  <tr>     
		   ...
		   <html:select property="areaCode" name="EmpDutyRosterFB" tabindex="1" styleClass="textbox" onchange="submitPage('GET_EMPLOYEES_CALENDAR')">
			    <html:option value="-1">Select Value</html:option>
		  ...
		  <html:select property="designationId" name="EmpDutyRosterFB" tabindex="1" styleClass="textbox" onchange="submitPage('GET_EMPLOYEES_CALENDAR')" disabled="true">
			    <html:option value="-1">Select Value</html:option>
      ...
      <his:ContentTag>
      <bean:write name="EmpDutyRosterFB" property="calendar" filter="false"/>
      </his:ContentTag>
...
<td class="tdfonthead"><input type="button" style="background-color: <%=DutyRosterConfig.MULTIPLE_SHIFT_TYPE_COLOR %>;" value="" >&nbsp;Multiple Shifts</td>
       ...
       <his:ButtonToolBarTag>
			<span id="saveDiv">
				...
				<!--  <img class="button" src='<his:path src="/hisglobal/images/Repeat.png"/>' tabindex="1" style="cursor: pointer" onclick="enableBlanket(event)" onkeypress="if(event.keyCode==13)enableBlanket(event)"> --> 
    ...
    <his:status/>
		...
		<div id="blanket" style="height: 580;width: 1024;display: none;"></div>
			...
			<div id="patternDivId" style="display: none; height: 110px;width: 310px;position:absolute; top: 20%;left: 30%;z-index: 9100;background-color: #FFEBD5;">
				<div align="right">
					<img class="button" tabindex="1" src="/HISClinical/hisglobal/images/popUp_cancel.JPG" style="cursor: pointer; " onkeypress="disableBlanket(event)" onclick="disableBlanket(event)">
				</div>	
				<table width="100%">
					<tr>
						...
						<td width="20%" class="tdfonthead">
							<div align="left">
								<input type="text" name="patternRepeatAfter" maxlength="2" size="3">
							</div>
						</td>
					</tr>
					...
					<tr>
						...
						<td width="50%" class="tdfonthead">
							<div align="left">
								<img class="button" tabindex="1" src="/HIS/hisglobal/images/GoNew.png" style="cursor: pointer; position: absolute;" onkeypress="repeatPattern(event)" onclick="repeatPattern(event)">		
							</div> 
						</td>
					</tr>
			...
			<div id="newPatternDivId" style="display: none; height: 125px;width: 310px;position:absolute; top: 20%;left: 30%;z-index: 9100;background-color: #FFEBD5;">
				...
				<table width="100%">
					...
					<tr>
						...
						<td width="50%" class="tdfonthead">
							<div align="left">
								<img class="button" tabindex="1" src="/HIS/hisglobal/images/GoNew.png" style="cursor: pointer; position: absolute;" onkeypress="repeatNewPattern(event)" onclick="repeatNewPattern(event)">		
							</div> 
						</td>
					</tr>
	...
	<html:hidden name="EmpDutyRosterFB"   property="hmode" />
	<html:hidden name="EmpDutyRosterFB"   property="serialNo"/>
    <html:hidden name="EmpDutyRosterFB"   property="concatedValueToBeSaved"/>
	<html:hidden name="EmpDutyRosterFB"   property="dutyType"/>
	<html:hidden name="EmpDutyRosterFB"   property="currentYear"/>
	<html:hidden name="EmpDutyRosterFB"   property="currentMonth"/>
	<html:hidden name="EmpDutyRosterFB"   property="currentDate"/>
	<html:hidden name="EmpDutyRosterFB"   property="empListToBeUpdated"/>
	<html:hidden name="EmpDutyRosterFB"   property="generatedRosterId"/>
	<html:hidden name="EmpDutyRosterFB"   property="reliverEmpList"/>
