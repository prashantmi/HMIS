...
{
	if(comboValidation(document.forms[0].rosterTypeId,"Roster Name") && validateDesignation())
	{
		return true;
	}
	else{
...
function validateDesignation(){
	if(document.forms[0].selectedDesignationId.options.length==0)
	{
		alert("Select Designation");
		document.forms[0].selectedDesignationId.focus();
		return false;
	}
	return true;
}
