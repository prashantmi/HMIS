...
/*	//alert("flag 123456 "+flag+" mode 123456 "+mode);
	...
	{
//	 alert("inside if")
//Commented by Shriyansh for security to call submit function only once from registration.js
	//	submitForm(mode);
	}
	else{
 	// alert("elesee")
...
{
	alert("1");
	document.getElementsByName("hiddenTemplateId")[0].value = idx;
...
function submitForm(mode)
{
	//alert("inside submit form method"+typeof clearFormOnSubmit);
	if(typeof clearFormOnSubmit != 'undefined')
		{
		clearFormOnSubmit();
		}
    // alert("submitform....");
...
/* Not in use function dateDifference(fromDate,toDate) should not be opened again Please ensure
{
	var days=0;
...
function onclickShowHideImg(imgObj)
{
	...
	if(divObj.style.display=="none")
	{
		...
		imgObj.src = "/HIS/hisglobal/images/avai/plus.png";
	}
	else if(divObj.style.display=="block")
	{
		divObj.style.display="none";
		imgObj.src = "/HIS/hisglobal/images/avai/Minus.png";
	}
}
