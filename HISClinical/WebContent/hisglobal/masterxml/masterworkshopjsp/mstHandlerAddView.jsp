			...
			<tr>
				<td>
					<his:ButtonToolBarTag>
						<img style="cursor: pointer" src='<his:path src="/../HIS/hisglobal/images/buttons/btn-sv.png"/>' onKeyPress="if(event.keyCode==13) validateOnSave('ADDSAVE')" onClick="validateOnSave('ADDSAVE');" tabindex="1" />
