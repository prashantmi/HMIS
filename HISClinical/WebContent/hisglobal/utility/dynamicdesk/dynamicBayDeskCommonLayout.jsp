...
<frameset id="frmsetRows" rows="<%=rowsSpan%>" border="0" bordercolor="#FFFFFF" framespacing="0" topmargin="0" leftmargin="0" marginheight="0" marginwidth="0">
	...
	<frame id="frmDynamicDeskHeader" name="frmDynamicDeskHeader" src="/HISClinical/hisglobal/utility/dynamicdesk/header.cnt" 
		scrolling="no" noresize="noresize" frameborder="0" marginwidth="0" marginheight="0" border="0" topmargin="0" leftmargin="0">

	<frame id="frmDynamicDeskTopMenus" name="frmDynamicDeskTopMenus" src="/HISClinical/hisglobal/utility/dynamicdesk/menus.cnt?deskMode=TOP" 
	...
	<frameset id="frmsetCols" cols="15%,70%,15%" border="0" bordercolor="#FFFFFF" framespacing="0" topmargin="0" leftmargin="0" marginheight="0" marginwidth="0">
		...
		<frame id="frmDynamicDeskLeftMenus" name="frmDynamicDeskLeftMenus" src="/HISClinical/hisglobal/utility/dynamicdesk/menus.cnt?deskMode=LEFT" 
			scrolling="auto" frameborder="0" marginwidth="0" marginheight="0" border="0" topmargin="0" leftmargin="0">

		<frame id="frmDynamicDeskCenter" name="frmDynamicDeskCenter" src="/HISClinical/hisglobal/utility/dynamicdesk/centerBayDesk.cnt" 
			scrolling="auto" frameborder="0" marginwidth="0" marginheight="0" border="0" topmargin="0" leftmargin="0">

		<frame id="frmDynamicDeskRightMenus" name="frmDynamicDeskRightMenus" src="/HISClinical/hisglobal/utility/dynamicdesk/menus.cnt?deskMode=RIGHT" 
			scrolling="auto" frameborder="0" marginwidth="0" marginheight="0" border="0" topmargin="0" leftmargin="0">

	</frameset>
	
	<frame id="frmDynamicDeskBottomMenus" name="frmDynamicDeskBottomMenus" src="/HISClinical/hisglobal/utility/dynamicdesk/menus.cnt?deskMode=BOTTOM" 
		scrolling="auto" noresize="noresize" marginwidth="0" marginheight="0" border="0" topmargin="0" leftmargin="0">

	<frame id="frmDynamicDeskFooter" name="frmDynamicDeskFooter" src="/HISClinical/hisglobal/utility/dynamicdesk/footer.cnt" 
