...
<link rel="stylesheet" href="/HISClinical/investigation/js/dojotoolkit/dojo/resources/dojo.css"/>
<link rel="stylesheet" href="/HISClinical/investigation/js/dojotoolkit/dijit/themes/tundra/tundra.css"/>
...
{
	//alert("Open Dialog");
	var url = "/HISClinical/hisglobal/utility/dynamicdesk/centerNew.cnt?mode="+deskMenuURL+"&deskMenuId="+deskMenuId+"&hmode=NEW";
...
function getTabSummary(deskMenuId, deskMenuURL)
{
	...
	var urlNew = "/HISClinical/hisglobal/utility/dynamicdesk/centerNew.cnt?mode="+deskMenuURL+"&deskMenuId="+deskMenuId+"&hmode=AJX_G_SUMMARY";
