	...
	<table width="100%" height="100%" cellpadding="0" cellspacing="0">
		...
		<tr height="1%">
			<td width="100%" align="center" valign="middle" class="applicationBackgroundColor">
				<img class="button" src="/HISClinical/hisglobal/images/triup.gif" tabindex="1" style="cursor:pointer;" tabindex="1" title="Hide Top Menu" onclick="hideTopMenu()" >
			</td>
		</tr>
	</table>
</div>
	...
	<table width="100%" height="100%" cellpadding="0" cellspacing="0">
		<tr>
			<td width="100%" height="100%" align="center" valign="middle" class="applicationBackgroundColor">
				<img class="button" src="/HISClinical/hisglobal/images/tridown.gif" tabindex="1" style="cursor:pointer;" tabindex="1" title="Show Top Menu" onclick="showTopMenu()" >
			</td>
		</tr>
	</table>
</div>
