	...
	<table width="100%" cellpadding="0" cellspacing="0">
		<tr>
			<td width="1%" valign="top" align="center" class="applicationBackgroundColor">
				<img class="button" src="/HISClinical/hisglobal/images/tri.gif" tabindex="1" style="cursor:pointer;" tabindex="1" title="Hide Right Menu" onclick="hideRightMenu()" >
			</td>
	...
	<table width="100%" height="100%" cellpadding="0" cellspacing="0">
		<tr>
			<td width="100%" height="100%" valign="top" align="center" class="applicationBackgroundColor">
				<img class="button" src="/HISClinical/hisglobal/images/trileft.gif" tabindex="1" style="cursor:pointer;" tabindex="1" title="Show Right Menu" onclick="showRightMenu()" >
			</td>
		</tr>
	</table>
</div>
