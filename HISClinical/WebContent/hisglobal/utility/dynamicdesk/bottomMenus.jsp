	...
	<table width="100%" height="100%" cellpadding="0" cellspacing="0">
		<tr height="1%">
			<td width="100%" align="center" valign="middle" class="applicationBackgroundColor">
				<img class="button" src="/HISClinical/hisglobal/images/tridown.gif" tabindex="1" style="cursor:pointer;" tabindex="1" title="Hide Left Menu" onclick="hideBottomMenu()" >
			</td>
		</tr>
		<tr height="99%">
	...
	<table width="100%" height="100%" cellpadding="0" cellspacing="0">
		<tr>
			<td width="100%" height="100%" align="center" valign="middle" class="applicationBackgroundColor">
				<img class="button" src="/HISClinical/hisglobal/images/triup.gif" tabindex="1" style="cursor:pointer;" tabindex="1" title="Show Left Menu" onclick="showBottomMenu()" >
			</td>
		</tr>
	</table>
</div>
