...
function getData(){
  ...
  // alert("orderBy.length "+orderBy.length)
   ...
   //popup=window.open("/HISClinical/utility/masterVerification.cnt?hmode=GETDATA&orderByString=" + orderByString +"&criteria=" + criteria +"&criteriaColumn=" + criteriaColumn, 
...
window.onload=function(){
	...
	if(document.getElementsByName("hmode")[0].value=='GETDATA'){
		...
		popup=window.open(createFHashAjaxQuery("/HISClinical/utility/masterVerification.cnt?hmode=POPUP&columnName="+ columnName +"&criteriaLabel=" + criteriaLabel
...
<his:statusNew>
		...
		<tr id="orderByDiv">
		 ...
		 <td width="25%" class="tdfont" colspan="4">
			...
			<html:select name="masterVerificationMstFB" property="orderBy" tabindex="1" size="5" multiple="true" style="width:200px">
			 ...
			 <td width="20%" class="tdfont">
			  	<div align="left">
			  	<img src="/HIS/hisglobal/images/avai/arr-up.png" class="link" onClick='moveUP(document.forms[0].orderBy);'/>
						<br>
				<img src="/HIS/hisglobal/images/avai/arr-dwn.png" class="link" onClick='moveDOWN(document.forms[0].orderBy);'/>
		 		</div>
		 	</td>
		 	</tr>
		 	</table>	
	...
	<his:ButtonToolBarTag>
         <div align="center">	
			<his:statusNew>
				<img class="button" src="/../HIS/hisglobal/images/buttons/btn-sv.png" style="cursor: pointer;" onkeypress="if(event.keyCode==13) submitForm('SAVE');" tabindex="1" onclick="submitForm('SAVE')">
	        	<img class="button" src='<his:path src="/../HIS/hisglobal/images/buttons/btn-clr.png"/>' style="cursor:pointer" onkeypress="if(event.keyCode==13) submitForm('NEW');" tabindex="1" onclick ="submitForm('NEW');">
