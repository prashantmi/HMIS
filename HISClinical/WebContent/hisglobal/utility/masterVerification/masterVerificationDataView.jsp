...
<his:statusList>
   ...
   <br>
	<%//HospitalMstVO hospitalVO =(HospitalMstVO)session.getAttribute(HISConfig.HOSPITAL_VO);%>
	<bean:define id="hospitalVO" name="<%=HISConfig.HOSPITAL_VO %>" type="hisglobal.vo.HospitalMstVO"></bean:define>
	<table  width="100%" cellspacing="1" cellpadding="0">
		<tr >
		 <td width="50%" colspan="2">
