		 ...
		 <td width="50%" class="tdfont">
			...
			<html:select name="masterVerificationFB" property="orderBy" tabindex="1" size="5" multiple="true" style="width:200px">
			 ...
			 <td width="40%" class="tdfont">
			  	<div align="left">
			  	<!-- <img src="/HIS/hisglobal/images/arr-up.png" class="link" onClick='moveUP(document.forms[0].orderBy);'/>
						<br>
				<img src="/HIS/hisglobal/images/arr-dwn.png" class="link" onClick='moveDOWN(document.forms[0].orderBy);'/> -->
				 	<img src="/HIS/hisglobal/images/avai/plus.png" class="link" onClick='moveUP(document.forms[0].orderBy);'/>
						<br>
				<img src="/HIS/hisglobal/images/avai/Minus.png" class="link" onClick='moveDOWN(document.forms[0].orderBy);'/>
		 		</div>
		 	</td>
		 	</tr>
		 	</table>	
