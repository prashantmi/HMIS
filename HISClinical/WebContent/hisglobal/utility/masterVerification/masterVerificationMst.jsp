...
<script src="/HISClinical/hisglobal/utility/masterVerification/masterVerificationMst.js" language="javascript"/>
<script>
		 	 ...
		 	 <table width="100%" id="columnTable">
		 	 	 <tr>
					...
					<td width="20%" class="tdfont">	
						<div align="left">
						<logic:notEqual value="VIEW" name="masterVerificationMstFB" property="hmode">
						<img class="button" src='<his:path src="/hisglobal/images/plus.png"/>'
	...
	<his:ButtonToolBarTag>
         <div align="center">	
			<his:statusNew>
				<logic:notEqual value="VIEW" name="masterVerificationMstFB" property="hmode">
				<logic:notEqual value="MODIFY" name="masterVerificationMstFB" property="hmode">
				<img class="button" src="/../HIS/hisglobal/images/buttons/btn-sv.png" style="cursor: pointer;" onkeypress="if(event.keyCode==13) validateSave('SAVE');" tabindex="1" onclick="validateSave('SAVE')">
				</logic:notEqual>
				<logic:equal value="MODIFY" name="masterVerificationMstFB" property="hmode">
				<img class="button" src="/HIS/hisglobal/images/buttons/btn-mo.png" style="cursor: pointer;" onkeypress="if(event.keyCode==13) validateSave('MODIFYSAVE');" tabindex="1" onclick="validateSave('MODIFYSAVE')">
				</logic:equal>
