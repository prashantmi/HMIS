...
<script>
//Added by Prachi on 29-march-2019//
				...
				<!-- 	<img  class="button" src='/HIS/hisglobal/images/snomedct.png' style="cursor:pointer;vertical-align: middle;"
				 ...
				 -->
					...
					<tr>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       
						...
						<td width="25%"  class="tdfont">
							<html:text name="ParameterMasterFB" property="paraName" maxlength="50" onkeypress="return validateAlphabetswithspecialchacters(event,this)" >
							</html:text>
						</td>
					</tr>
