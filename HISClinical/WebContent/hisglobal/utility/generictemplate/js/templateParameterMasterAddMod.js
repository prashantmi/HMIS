...
function validateNext()
{
	...
	//alert("save");
	 var ageid=document.getElementsByName('ageRangeId')[0].value;
     var x = document.getElementsByName('ageRangeId')[0].selectedIndex;
     var y = document.getElementsByName('ageRangeId')[0].options;
     var agename = y[x].text;
    // alert("agename"+agename);
     document.getElementsByName('ageRangeName')[0].value=agename;
    // alert("agename"+document.getElementsByName('ageRangeName')[0].value);
     
   //alert("save");
	 var gendercode=document.getElementsByName('genderCode')[0].value;
     var x = document.getElementsByName('genderCode')[0].selectedIndex;
     var y = document.getElementsByName('genderCode')[0].options;
     var gendername = y[x].text;
    // alert("agename"+agename);
     document.getElementsByName('strGenderName')[0].value=gendername;
...
function tempDisplayName(){
	
	//alert("hello");
	if(document.getElementsByName('strTemplateDispName')[0].value==""){
	var tempname=document.getElementsByName('templateName')[0].value;
	document.getElementsByName('strTemplateDispName')[0].value=tempname;
	}
	//alert(document.getElementsByName('strTemplateDispName')[0].value);
	
	
	
}

function stopNormalType(){
	
	//alert("gggg.."+document.getElementsByName("hmode")[0].value);
//	alert("gggg.."+document.getElementsByName("hmode")[0].value);
	//if(document.getElementsByName("hmode")[0].value=="ADD"){
	if(document.getElementsByName('templateType')[0].value==1){
		
		alert("Invalid Template Type For New Template" );
		document.getElementsByName('templateType')[0].value='-1';
		//alert(document.getElementsByName('templateType')[0].value);
	   }
	//}
}
