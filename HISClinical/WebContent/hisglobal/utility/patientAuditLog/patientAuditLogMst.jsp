...
<html:form action="/patientAuditLogMst">
	...
	<his:statusTransactionInProcess>
		...
		<his:SubTitleTag name="Audit Log Option">
			<td>
				<div align="right">
					...
					<html:radio property="isDateWise" value="1" tabindex="1"
						onclick="showDateDiv(this)" />
					<b><bean:message key="yes" /></b>
					<html:radio property="isDateWise" value="0" tabindex="1"
						onclick="showDateDiv(this)" />
		...
		<his:ContentTag>
			<table width="100%" cellspacing="1" cellpadding="0">
				...
				<tr>
					<td width="50%" class="tdfont">
						<div align="center">
							&nbsp;
							<html:select name="patientAuditLogMstFB" property="moduleId"
								tabindex="1" onchange="getAuditLogHeader(this)"
								styleClass="regcbo" style="width:170px">
								<html:option value="-1">Select Value</html:option>
								<logic:present
									name="<%=Config.MASTER_VERIFICATION_MODULE_LIST%>">
									<html:options
										collection="<%=Config.MASTER_VERIFICATION_MODULE_LIST%>"
					...
					<td width="45%" class="tdfont">
						<div align="center">
							&nbsp;
							<html:select name="patientAuditLogMstFB" property="auditLogId"
								tabindex="1" styleClass="regcbo" style="width:170px">
								<html:option value="-1">Select Value</html:option>
								<logic:present name="<%=Config.PATIENT_AUDIT_LOG_OPTIONS%>">
									<html:options
										collection="<%=Config.PATIENT_AUDIT_LOG_OPTIONS%>"
										labelProperty="label" property="value" />
								</logic:present>
							</html:select>
						</div>
					...
					<td width="5%" class="tdfont">
						<div align="center">
							<img class="button" id="addButton" style="cursor: pointer;"
								src="/HIS/hisglobal/images/avai/plus.png" tabindex="1"
								title="Add to List" onclick="addAuditHeader()"
								onkeypress="if(event.keyCode==13) addAuditHeader()">
						</div>
					</td>
				</tr>
				<logic:present name="<%=Config.AUDIT_HEADER_LIST%>">
					<logic:iterate id="auditLogMstVO"
						name="<%=Config.AUDIT_HEADER_LIST%>" indexId="idx"
						type="hisglobal.vo.PatientAuditLogMstVO">
						<tr>
							<td width="50%" class="tdfont">
								<div align="center">
							...
							<td width="5%" class="tdfont">
								<div align="center">
									<img class="button" id="addButton" style="cursor: pointer;"
										src="/HIS/hisglobal/images/avai/Minus.png" tabindex="1"
										title="Add to List"
										onclick="removeAuditHeader('<%=auditLogMstVO.getModuleId()+'#'+auditLogMstVO.getAuditLogId()%>');"
			...
			<div id="dateWiseDiv" style="display: none">
				<table width="100%" cellspacing="1" cellpadding="0">
					<tr>
						<td width="25%" class="tdfonthead"><font color="#ff0000"
							size="1" face="Verdana, Arial, Helvetica, sans-serif">*</font> <font
							color="#000000" size="2"
							face="Verdana, Arial, Helvetica, sans-serif"> <bean:message
									key="fromDate" />
						</font></td>
						<td width="25%" class="tdfont">&nbsp;<his:date
								name="fromDate" value="<%=sysdate%>"></his:date>
						</td>
						<td width="25%" class="tdfonthead"><font color="#ff0000"
							size="1" face="Verdana, Arial, Helvetica, sans-serif">*</font> <font
							color="#000000" size="2"
						...
						<td width="25%" class="tdfont">&nbsp;<his:date name="toDate"
								value="<%=sysdate%>"></his:date>
						</td>
					</tr>
				</table>
			</div>
	...
	<his:statusList>
		...
		hisglobal.vo.PatientAuditLogMstVO auditHeader = (hisglobal.vo.PatientAuditLogMstVO) pageContext.getAttribute("auditHeader");%>
	...
	--%>
					<table width="100%">
						<tr>
							<td width="50%" colspan="2">
								<div align="center"
									style="font-size: 18px; font: Arial; font: bold;">
									<%
										//=fb.getAuditHeader()
									%>
					...
					<table width="100%">
						<tr>
							<td><b><bean:message key="currentRecord" /> </b></td>
						</tr>
					</table>
					<%
					...
					%>
					<bean:define id="columnNameList"
						name="<%=Config.AUDIT_LOG_COLUMN_NAME_LIST%>"
						type="java.util.List" />
					<%
		 ...
		 --%>
							...
							<font color="red"><b><c:out
										value="No Current Record Found"></c:out></b></font>
							<%
								}
							%>
						</tr>
			 ...
			 --%>
								...
								<logic:equal name="auditHeader" property="displayLogic"
									value="<%=Config.AUDIT_LOG_DISPLAY_LOGIC_NEEDED%>">
									<c:set var="index" value="2"></c:set>
								</logic:equal>

								<c:forEach var="columnValue" items="${columValueList}"
									begin="${index}">
									<td>
										<div align="center">
											<font color="#000000" size="2"
												face="Verdana, Arial, Helvetica, sans-serif"> <c:if
													test="${columnValue==null}">
													<c:out value="-"></c:out>
												</c:if> <c:if test="${columnValue!=null}">
 ...
 %>
										...
										%> <font color="blue"> <%=(columnList.get(j)==null?"-":(String)columnList.get(j))%>
									</font> <%
 	}
 %>
									</font>
 ...
 %> <%=(newValue.equals("")?"-":newValue)%>
			...
			<table>
				<tr>
					<td><font color="red"> <b><%=errorMessage%></b>
					</font></td>
				</tr>
				<tr>
					<td></td>
		...
		<div id="legendId" style="display: none;">
			<table width="100%" cellpadding="0" cellspacing="1">
				<tr>
					<td style="background-color: #F1ECE2;" width="10%"><font
						color="blue" size="2" face="Verdana, Arial, Helvetica, sans-serif">
							Blue Color </font></td>
					<td class="tdfonthead">
						<div align="left">
							<font color="#000000" size="2"
								face="Verdana, Arial, Helvetica, sans-serif"> Base/First
								Record </font>
						</div>
					</td>
				</tr>
				<tr>
					<td style="background-color: #F1ECE2;" width="10%"><font
						color="red" size="2" face="Verdana, Arial, Helvetica, sans-serif">
							Red Color </font></td>
					<td class="tdfonthead">
						<div align="left">
							<font color="#000000" size="2"
								face="Verdana, Arial, Helvetica, sans-serif"> Modified
								Records </font>
						</div>
					</td>
				</tr>
	...
	<his:ButtonToolBarTag>
		<div align="center">
			...
			<!--				<img class="button" src="/HIS/hisglobal/images/buttons/btn-view.png" style="cursor: pointer;" onkeypress="if(event.keyCode==13) getData();" tabindex="1" onclick="getData();">-->
			<his:statusNew>
				<img class="button"
			...
			<his:statusTransactionInProcess>
				<img class="button"
					...
					style="cursor: pointer"
					onkeypress="if(event.keyCode==13) getData();" tabindex="1"
					onclick="getData();">
				<img class="button"
					src='<his:path src="/../HIS/hisglobal/images/buttons/btn-ccl.png"/>'
					style="cursor: pointer"
			...
			<his:statusList>
				<img class="button"
					src='<his:path src="/hisglobal/images/Cancel.png"/>'
					style="cursor: pointer"
					onkeypress="if(event.keyCode==13) submitForm('GETPATDTL');"
					tabindex="1" onclick=" submitForm('GETPATDTL');">
			</his:statusList>
		</div>
	</his:ButtonToolBarTag>
