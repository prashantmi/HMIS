...
/*
	if(document.getElementsByName("hmode")[0].value=='GETPATDTL'){
		...
		popup=window.open("/HISClinical/utility/patientAuditLogMst.cnt?hmode=POPUP&auditHeader=" + auditHeader,
...
function validateDate(){
	...
	//alert(sysdate.value+"  "+registerDate.value+"  "+fromDate.value+"  "+toDate.value);
