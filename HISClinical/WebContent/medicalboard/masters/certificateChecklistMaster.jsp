...
<his:TransactionContainer>
	...
	<his:TitleTag name="Certificate Checklist Master">	</his:TitleTag>
	 ...
	 <his:ContentTag>
		<table width="100%" border="0" cellspacing="1" cellpadding="0">
		  ...
		  <his:SubTitleTag name="Added Checklist">
		  </his:SubTitleTag>
		  <his:ContentTag>
		  <table width="100%" border="0" cellspacing="1" cellpadding="0">
				    <tr>
				...
				<logic:iterate id="certificateChecklistVO" name="<%=MedicalBoardConfig.CHECKLIST_ADDED_TO_CERTIFICATE_TYPE%>" type="hisglobal.vo.MBCertificateChecklistVO">
			  	<tr>
		 ...
		 <logic:notEqual name="certificateChecklistMasterFB" property="hmode" value="VIEW">
