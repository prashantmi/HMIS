			 ...
			 <table width="100%" border="0" cellspacing="1" cellpadding="0">
				<tr>
			 	...
			 	<tr>
					...
					<td class="tdfont">
						<div align="center">
							<img class="button" id="addButton" style="cursor:pointer" src='<his:path src="/hisglobal/images/plus.png"/>' alt="Add Value" title="Add Value" onclick="validateAddForm('ADDLIST');" tabindex="1"/>
						</div>
					</td>
				</tr>		
			 </table>
				...
				<logic:iterate indexId="idx" id="investMappingVO" name="<%=MedicalBoardConfig.ALL_SELECTED_INVASTIGATION_MAPPING_VO_LIST %>" type="hisglobal.vo.MbInvestigationMappingMstVO">
					...
					<tr>
						...
						<td width="6%" class="tdfont">
							<div align="center">
								<img class="button" id="minusButton"  style="cursor:pointer" src='<his:path src="/hisglobal/images/Minus.png"/>' alt="Remove Value" title="Remove Value" onclick='removeListData(<%=index%>,"REMOVEDATA");' tabindex="1"/>
							</div>
					 	</td>
					</tr>
