...
function addNotes()
{
	...
	opener.document.getElementsByName("doctorRemarks")[0].value=notes;
	submitPage('SHOWNOTES');
}
</script>

<html:form action="/doctorCallBook">
	<body onload="isFormClose()">
		<his:TitleTag name="Add Doctor Remarks">
		</his:TitleTag>
			...
			<table width="100%" cellpadding="0" cellspacing="1">
				...
				%>
					<tr>
						<td class="tdfont">
							<div align="center">
								<html:radio name="DoctorCallBookFB" property="macroHead" value="<%=notes.getLabel() %>" onclick="addNotes()"></html:radio>
							</div>
						</td>	
						<td class="tdfont">
							<div align="left">
        ...
        <html:hidden name="DoctorCallBookFB" property="doctorRemarks"/>
