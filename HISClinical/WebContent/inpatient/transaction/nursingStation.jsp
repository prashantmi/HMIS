...
<his:javascript src="/inpatient/js/nursing_station_desk.js" />
...
<html>
	...
	%>
		<html:form action="/nursingStation">
			...
			<html:hidden name="NursingStationFB" property="mode" />
			<html:hidden name="NursingStationFB" property="deskMenuId" />
			<html:hidden name="NursingStationFB" property="patCrNo" />
			<html:hidden name="NursingStationFB" property="crNoSelected" />
		</html:form>
	</body>
</html>