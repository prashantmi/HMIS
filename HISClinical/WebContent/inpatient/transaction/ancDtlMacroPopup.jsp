...
function addMacro()
{
	...
	if(document.getElementsByName("macroProcessId")[0].value=="<%=OpdConfig.MACRO_PROCESS_ID_VISIT_NOTES%>")
		opener.document.getElementsByName("remarks")[0].value=notes;
	
	closeForm();
}
</script>

<html:form action="/antenatalDetail">
	<body onload="isFormClose()">
		<his:TitleTag name="Add Macros">
		</his:TitleTag>
		<%
			List lstMacro=(List)session.getAttribute(InpatientConfig.ANCDETAIL_ESSENTIAL_MACROS_BY_PROCESS_ID_LIST); 
			if(lstMacro.size()>0)
			{
		%>
		<his:ContentTag>
			<table width="100%" cellpadding="0" cellspacing="1">
				...
				%>
					<tr>
						<td class="tdfont">
							<div align="center">
								<html:radio name="ANCDetailFB" property="macroHead" value="<%=entObj.getLabel() %>" onclick="addMacro()"></html:radio>
							</div>
						</td>	
						<td class="tdfont">
							<div align="left">
        ...
        <html:hidden name="ANCDetailFB" property="macroProcessId"/>
