...
<script>
	...
	function callThisOnload()
    {
		...
		var patGestationWeek=document.getElementsByName("gestationPeriod")[0].value;
		var maxGestationWeek=<%=Config.ANC_DETAIL_MAXIMUM_GESTATION_WEEK_FOR_ANC%>;
		// alert("pat"+patGestationWeek);
		//alert("max"+"<%=Config.ANC_DETAIL_MAXIMUM_GESTATION_WEEK_FOR_ANC%>");
		if(patGestationWeek>maxGestationWeek)
		{
			alert("Gestation Week should be less than"+" "+maxGestationWeek);
		}
...
<div id="divANDtl" style="display: block;">
	<his:ContentTag>
		<table  width="100%" border="0" cellspacing="1" cellpadding="0">
			<tr>
				...
				<td width="25%"  class="tdfont">
					<div align="left">
						<logic:notEmpty name="ANCDetailFB" property="ancNo">
							<html:hidden name="ANCDetailFB" property="ancNo"/>
							<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>							
							&nbsp;<bean:write name="ANCDetailFB" property="ancNo"/>
							</b></font>
						</logic:notEmpty>
						<logic:empty name="ANCDetailFB" property="ancNo">
				...
				<td width="25%"  class="tdfont">
					<div align="left">
						<logic:notEmpty name="ANCDetailFB" property="gravidaNo">
							<html:hidden name="ANCDetailFB" property="gravidaNo"/>
							<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>							
							&nbsp;<bean:write name="ANCDetailFB" property="gravidaNo"/>
							</b></font>
						</logic:notEmpty>
						<logic:empty name="ANCDetailFB" property="gravidaNo">
			...
			<tr>
				...
				<td width="25%"  class="tdfont">
					<div align="left">
						<logic:notEmpty name="ANCDetailFB" property="parityNo">
							<html:hidden name="ANCDetailFB" property="parityNo"/>
							<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>							
							&nbsp;<bean:write name="ANCDetailFB" property="parityNo"/>
							</b></font>
						</logic:notEmpty>
						<logic:empty name="ANCDetailFB" property="parityNo">
				...
				<td width="25%"  class="tdfont">
					<div align="left">
						<logic:notEmpty name="ANCDetailFB" property="abortusNo">
							<html:hidden name="ANCDetailFB" property="abortusNo"/>
							<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>							
							&nbsp;<bean:write name="ANCDetailFB" property="abortusNo"/>
							</b></font>
						</logic:notEmpty>
						<logic:empty name="ANCDetailFB" property="abortusNo">
			...
			<tr>
				...
				<td width="25%"  class="tdfont">
					<div align="left">
						<logic:notEmpty name="ANCDetailFB" property="detectionMethod">
							<html:hidden name="ANCDetailFB" property="detectionMethod"/>
							<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>							
							&nbsp;<bean:write name="ANCDetailFB" property="detectionMethod"/>
							</b></font>
						</logic:notEmpty>
						<logic:empty name="ANCDetailFB" property="detectionMethod">
				...
				<td width="25%"  class="tdfont">
					<div align="left">
						<logic:notEmpty name="ANCDetailFB" property="detectionDate">
							<html:hidden name="ANCDetailFB" property="detectionDate"/>
							<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>							
							&nbsp;<bean:write name="ANCDetailFB" property="detectionDate"/>
							</b></font>
						</logic:notEmpty>
						<logic:empty name="ANCDetailFB" property="detectionDate">
			...
			<tr>
				...
				<td width="25%"  class="tdfont">
					<div align="left">
						<logic:notEmpty name="ANCDetailFB" property="lmpDate">
							<html:hidden name="ANCDetailFB" property="lmpDate"/>
							<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>
							&nbsp;<bean:write name="ANCDetailFB" property="lmpDate"/>
							</b></font>
						</logic:notEmpty>
						<logic:empty name="ANCDetailFB" property="lmpDate">
				...
				<td width="25%"  class="tdfont">
					<div align="left">
						<logic:notEmpty name="ANCDetailFB" property="expectedDeliveryDate">
							<html:hidden name="ANCDetailFB" property="expectedDeliveryDate"/>
							<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>
							&nbsp;<bean:write name="ANCDetailFB" property="expectedDeliveryDate"/>
							</b></font>
						</logic:notEmpty>
						<logic:empty name="ANCDetailFB" property="expectedDeliveryDate">
			...
			<tr>
				...
				<td width="25%"  class="tdfont">
					<div align="left">
						<logic:notEmpty name="ANCDetailFB" property="gestationStartDate">
							<html:hidden name="ANCDetailFB" property="gestationStartDate"/>
							<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>
							&nbsp;<bean:write name="ANCDetailFB" property="gestationStartDate"/>
							</b></font>
						</logic:notEmpty>
						<logic:empty name="ANCDetailFB" property="gestationStartDate">
				...
				<td width="25%"  class="tdfont">
					<div align="left">						
						<logic:notEmpty name="ANCDetailFB" property="gestationPeriod">
							<html:hidden name="ANCDetailFB" property="gestationPeriod"/>
							<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>
							&nbsp;<bean:write name="ANCDetailFB" property="gestationPeriod"/>
							</b></font>
						</logic:notEmpty>
						<logic:empty name="ANCDetailFB" property="gestationPeriod">
			...
			<tr>
				...
				<td width="25%"  class="tdfont">
					<div align="left">
						<logic:notEmpty name="ANCDetailFB" property="ultraSoundEDD">
							<html:hidden name="ANCDetailFB" property="ultraSoundEDD"/>
							<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>
							&nbsp;<bean:write name="ANCDetailFB" property="ultraSoundEDD"/>
							</b></font>
						</logic:notEmpty>
						<logic:empty name="ANCDetailFB" property="ultraSoundEDD">
				...
				<td width="25%"  class="tdfont" valign="middle">
					<div align="left">
						<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>
						<logic:empty name="ANCDetailFB" property="isAntiDGiven">
						...
						<logic:notEmpty name="ANCDetailFB" property="isAntiDGiven">
							<logic:equal name="ANCDetailFB" property="isAntiDGiven" value="<%=OpdConfig.YES%>"><bean:message key="yes"/></logic:equal>
							<logic:equal name="ANCDetailFB" property="isAntiDGiven" value="<%=OpdConfig.NO%>"><bean:message key="no"/></logic:equal>
						</logic:notEmpty>
						</b></font>
					</div>
				</td>
			...
			<tr>
				...
				<td width="25%"  class="tdfont" valign="middle">
					<div align="left">
						<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>
						<logic:empty name="ANCDetailFB" property="isContraceptiveUsed">
						...
						<logic:notEmpty name="ANCDetailFB" property="isContraceptiveUsed">
							<logic:equal name="ANCDetailFB" property="isContraceptiveUsed" value="<%=OpdConfig.YES%>"><bean:message key="yes"/></logic:equal>
							<logic:equal name="ANCDetailFB" property="isContraceptiveUsed" value="<%=OpdConfig.NO%>"><bean:message key="no"/></logic:equal>
						</logic:notEmpty>
						</b></font>
					</div>
				</td>
		...
		<logic:notEmpty name="ANCDetailFB" property="isContraceptiveUsed">
			<logic:equal name="ANCDetailFB" property="isContraceptiveUsed" value="<%=OpdConfig.YES%>">
				<%isContraceptiveUseDisplay="display: block;";%>
			</logic:equal>
		</logic:notEmpty>									
		...
		<table  width="100%" border="0" cellspacing="1" cellpadding="0">
			<tr>			
				...
				<td width="75%" class="tdfont">
					<div align="left">
						<logic:notEmpty name="ANCDetailFB" property="contraceptiveRemarks">
							<html:hidden name="ANCDetailFB" property="contraceptiveRemarks"/>
							<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>
							&nbsp;<bean:write name="ANCDetailFB" property="contraceptiveRemarks"/>
							</b></font>
						</logic:notEmpty>
						<logic:empty name="ANCDetailFB" property="contraceptiveRemarks">
		...
		<table  width="100%" border="0" cellspacing="1" cellpadding="0">
			<tr>
				...
				<td width="25%"  class="tdfont">
					<div align="left">
						<logic:notEmpty name="ANCDetailFB" property="queckeningWeek">
							<html:hidden name="ANCDetailFB" property="queckeningWeek"/>
							<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>
							&nbsp;<bean:write name="ANCDetailFB" property="queckeningWeek"/>
							</b></font>
						</logic:notEmpty>
						<logic:empty name="ANCDetailFB" property="queckeningWeek">
		...
		<logic:notEmpty name="ANCDetailFB" property="queckeningWeek">
			<%queckeningRemarksDisplay="display: block;";%>
		</logic:notEmpty>									
		...
		<table  width="100%" border="0" cellspacing="1" cellpadding="0">
			<tr>			
				...
				<td width="75%"  class="tdfont">
					<div align="left">
						<logic:notEmpty name="ANCDetailFB" property="queckeningRemarks">
							<html:hidden name="ANCDetailFB" property="queckeningRemarks"/>
							<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>
							&nbsp;<bean:write name="ANCDetailFB" property="queckeningRemarks"/>
							</b></font>
						</logic:notEmpty>
						<logic:empty name="ANCDetailFB" property="queckeningRemarks">
		...
		<table  width="100%" border="0" cellspacing="1" cellpadding="0">
			<tr>
				...
				<td width="25%"  class="tdfont">
					<div align="left">
						<html:checkbox name="ANCDetailFB" property="isHighriskPregnancy" value='1' onchange="checkHighRiskPreg(this)"/>						
					</div>
				</td>
				<td width="25%" class="tdfonthead"></td>
				<td width="25%"  class="tdfont"></td>
		...
		<logic:notEmpty name="ANCDetailFB" property="isHighriskPregnancy">
			<% highRiskCompsDisplay="display: block";%>
		</logic:notEmpty>		
...
<his:ButtonToolBarTag>
	<his:statusTransactionInProcess>
		<img class="button" src='<his:path src="/../HIS/hisglobal/images/buttons/btn-sv.png"/>'  style="cursor:pointer"  tabindex='2' onclick =  "submitFormOnValidate(validateAddFollow(),'SAVE');" onkeypress="if(event.keyCode==13)submitFormOnValidate(validateAddFollow(),'SAVE');")>
		...
		<html:button value="End Anc Detail" property="mybutton" onclick="endANCDetail()" style='cursor:pointer'  tabindex='1' onkeypress="if(event.keyCode==13) endANCDetail();" />
	</his:statusTransactionInProcess>
...
<html:hidden name="ANCDetailFB" property="ancEpisodeCode"/>
<html:hidden name="ANCDetailFB" property="ancEpisodeUnitCode"/>
<html:hidden name="ANCDetailFB" property="ancEpisodeUnit"/>

<html:hidden name="ANCDetailFB" property="endANCDetailFlag"/>
