...
<form action="/HISClinical/inpatient/nursingDeskLogin.cnt" method="post" id="nursingDeskLoginForm">
		...
		<his:statusInProcess>
			<table width="100%" cellpadding="0" cellspacing="0">
				<tr>
					<td width="20%" class="tdfonthead" >
						<div align="center">
							<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
								<b>
									<bean:message key="selectUnitForNursingDesk"/>
								</b>
							</font>
						</div>
					</td>
					<logic:equal name="NursingDeskLoginFB" property="unitList" value="1">
					...
					<logic:equal name="NursingDeskLoginFB" property="unitList" value="1">
						<logic:equal name="NursingDeskLoginFB" property="roomList" value="1">
				...
				<tr>
					<td width="20%" class="tdfonthead" >
						<div align="center">
							<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
								<html:select name="NursingDeskLoginFB" property="departmentUnitCode" tabindex="1" styleClass="regCbo"  onchange="submitNursingLogin('GETWARD')">
					...
					<logic:equal name="NursingDeskLoginFB" property="unitList" value="1">
						<logic:equal name="NursingDeskLoginFB" property="roomList" value="1">
							<td width="20%" class="tdfonthead" id="roomControl">
								<div align="center">
									<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
										<html:select name="NursingDeskLoginFB" property="roomCode" tabindex="1" styleClass="regCbo" onchange="submitNursingLogin('SAVE')">
											<html:option value="-1">Select Value</html:option>
	...
	<html:hidden name="NursingDeskLoginFB" property="unitList"/>
</form>
<his:status/>
