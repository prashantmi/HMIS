...
<body>
	<html:form action="/master/intakeOutputParaMstACT">
		<his:TransactionContainer>
				...
				<his:TitleTag name="Intake Output Para Master >> ADD">
				</his:TitleTag>
			...
			<his:ContentTag>
				...
				<tr>
						...
						<div align="left">
						<html:radio name="IntakeOutputParaMasterFB" property="isSnomedConcept" value="0" onclick="showSnomed();" ></html:radio>
							<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
								<b>
									<bean:message key="yes" />
								</b>
							</font>
							<html:radio name="IntakeOutputParaMasterFB" property="isSnomedConcept" value="1" onclick="showSnomed();" ></html:radio>
							<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
								<b>
									<bean:message key="no" />
								</b>
							</font></div>
							<html:hidden name="IntakeOutputParaMasterFB" property="isSnomedFlagValue" />
							</td></tr>
							<tr>
				...
				<!-- 	<img  class="button" src='/HIS/hisglobal/images/snomedct.png' style="cursor:pointer;vertical-align: middle;"
				 ...
				 -->
					...
					<tr>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       
						...
						<td width="25%"  class="tdfont">
							<html:text name="IntakeOutputParaMasterFB" property="paraName" maxlength="50" onkeypress="return validateAlphabetsOnly(event,this)" size="40">
							</html:text>
						</td>
					</tr>
					...
					<tr>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       
						...
						<td width="25%"  class="tdfont">		
						 ...
						 <logic:notEqual name="IntakeOutputParaMasterFB" property="hmode" value="ADD">
			 <logic:notEqual name="IntakeOutputParaMasterFB" property="hmode" value="SAVE">
			 <logic:notEqual name="IntakeOutputParaMasterFB" property="hmode" value="VIEW">
			      <tr>
			        ...
			        <td width="50%" class="tdfont">
			         <div align="left">
				     &nbsp;<html:select name="IntakeOutputParaMasterFB" property="isActive"  style="width:160;">
						    <html:option value="-1">Select Value</html:option>
