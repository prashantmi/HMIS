...
function DiseaseCodeReportHandler()
{
	
    	document.getElementsByName('jrxmlName')[0].value="<%=InpatientConfig.DISEASE_CODE_REPORT%>";
	success=false;
...
<his:TitleTag name="Disease Code Report Between Two Dates">
</his:TitleTag>
      ...
      <bean:define name="diseaseCodeReportFB" property="fromDate" id="frDate" type="java.lang.String"/>
	  <bean:define name="diseaseCodeReportFB" property="toDate" id="tDate" type="java.lang.String"/>          
	   <%
 		...
 		<tr>
			<!-- New Change add Hospital Combo -->
		      <td width="25%" class="tdfonthead">
				...
				<td class="tdfont" width="25%">
					<div >
					<html:select name="diseaseCodeReportFB" property="multipleHospitalCode" tabindex="1" multiple="true" size="4">
 ...
 <his:SubTitleTag name="Report Generation Options">
    ...
    <tr>   
        ...
        <td width="25%" class="tdfont" > 
	        <html:select name="diseaseCodeReportFB"  property="graphOrText" tabindex="1" styleClass="regcbo" >
        ...
        <td width="25%" class="tdfont">
        		<html:select name="diseaseCodeReportFB" property="reportType" tabindex="1" styleClass="regcbo">
					<html:option value="-1">Select Value</html:option>        	
...
<input type="hidden"  name="mode" value="DISEASECODEREPORT">
<html:hidden name="diseaseCodeReportFB" property="jrxmlPath" value="<%=InpatientConfig.INPATIENT_JRXML_PATH%>"/>
<html:hidden name="diseaseCodeReportFB" property="jrxmlName"/>
<html:hidden name="diseaseCodeReportFB" property="sysDate" value="<%=tDate%>"/>
