...
function DeathDetailsReportHandler()
{
	
    	document.getElementsByName('jrxmlName')[0].value="<%=InpatientConfig.DEATH_DETAILS_REPORT%>";
	success=false;
...
<his:TitleTag name="Death Details Between Two Dates">
</his:TitleTag>
      ...
      <bean:define name="deathDetailsReportFB" property="fromDate" id="frDate" type="java.lang.String"/>
	  <bean:define name="deathDetailsReportFB" property="toDate" id="tDate" type="java.lang.String"/>          
	   <%
			...
			<!-- New Change add Hospital Combo -->
		      <td width="25%" class="tdfonthead">
				...
				<td class="tdfont" width="25%">
					<div >
					<html:select name="deathDetailsReportFB" property="multipleHospitalCode" tabindex="1" multiple="true" size="4">
 ...
 <his:SubTitleTag name="Report Generation Options">
    ...
    <tr>   
        ...
        <td width="25%" class="tdfont" > 
	        <html:select name="deathDetailsReportFB"  property="graphOrText" tabindex="1" styleClass="regcbo" >
        ...
        <td width="25%" class="tdfont">
        		<html:select name="deathDetailsReportFB" property="reportType" tabindex="1" styleClass="regcbo">
					<html:option value="-1">Select Value</html:option>        	
...
<input type="hidden"  name="mode" value="DEATHDETAILSREPORT">
<html:hidden name="deathDetailsReportFB" property="jrxmlPath" value="<%=InpatientConfig.INPATIENT_JRXML_PATH%>"/>
<html:hidden name="deathDetailsReportFB" property="jrxmlName"/>
<html:hidden name="deathDetailsReportFB" property="sysDate" value="<%=tDate%>"/>
