	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
	    ...
	    // Added by VASU on 16-Aug-2017
		    ...
		    try{
		        ...
		        //String path = getServletConfig().getServletContext().getRealPath("/hisglobal/ImgForImgEdtr/"+res[1]+"-"+res[2]+"-"+res[0]+".png");
		        ...
		        */
		        ...
		        request.getSession().setAttribute(HisImageEditorConfig.HIS_IMAGE_EDITOR_OUTPUT_IMAGE_DATA_64, image64);
		        out.print("Success");         
		    }catch(IOException e){  
		        e.printStackTrace();
