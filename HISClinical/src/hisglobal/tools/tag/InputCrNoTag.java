	...
	protected String getBodyTop(boolean _isReadOnly, HttpServletRequest _request, int size)
	{
		...
		if (isReadOnly == "")
		{
			strReturn += "\n<img class=\"button\" src='/HISClinical/hisglobal/images/GO.png' tabindex=\"1\" style=cursor:pointer onclick=\" return submitFormOnValidate(validateCRNoCHECK('"
					...
					+ "<td width=\"17%\" class=\"tdfont\"><div align=\"right\"><img class=\"button\" src='/HISClinical/hisglobal/images/btn-search.png' tabindex=\"1\" style=cursor:pointer onclick=\"openPopup('/HISClinical/registration/transactions/PatientSearch.action"
					+ "',event,300,900)\" onkeypress=\"if(event.keyCode==13) openPopup('/HISClinical/registration/transactions/PatientSearch.action',event,300,900)\"></div>";
		}
		//strReturn+= "</td>";
		...
		/*if (isReadOnly == "")
		{
			...
			strReturn +=  "\n<img id='imgGoCrNoId' src='../../hisglobal/images/GO.png' style='cursor:pointer' onclick='return submitFormOnValidate(validateCRNoCHECK(\""+ size+ "\"),\"GETPATDTL\")' />"
					...
					+ "<img id='imgSearchId' src='../../hisglobal/images/search_icon1.gif' style='cursor:pointer' onclick=\"openPopupWithEventHeightWidth('/HISClinical/registration/transactions/PatientSearch.action',event,300,900)\" />";
