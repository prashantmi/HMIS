...
public class DrugReactionVO extends ValueObject
{
	...
	public String getDrugGivenTime() {
		return drugGivenTime;
	}
	public void setDrugGivenTime(String drugGivenTime) {
		this.drugGivenTime = drugGivenTime;
	}
