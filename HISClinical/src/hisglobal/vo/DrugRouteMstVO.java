...
public class DrugRouteMstVO extends ValueObject
{
	...
	private String drugRouteShortName;
	...
	public String getDrugRouteShortName() {
		return drugRouteShortName;
	}
	public void setDrugRouteShortName(String drugRouteShortName) {
		this.drugRouteShortName = drugRouteShortName;
	}
	public String getDrugItemId() {
		return drugItemId;
	}
	public void setDrugItemId(String drugItemId) {
