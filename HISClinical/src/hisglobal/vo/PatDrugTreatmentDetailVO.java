...
public class PatDrugTreatmentDetailVO extends ValueObject
{
	...
	private String inHandStock; //Added by Shruti Shail on 10-Feb-2017
	private String selStock;
	
	//Added by Vasu on 23.April.2019
	...
	public String getInHandStock() {
		return inHandStock;
	}

	public void setInHandStock(String inHandStock) {
		this.inHandStock = inHandStock;
	}
