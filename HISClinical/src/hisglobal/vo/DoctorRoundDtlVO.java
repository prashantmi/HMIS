...
public class DoctorRoundDtlVO extends ValueObject
{
	private String captureArea;//Added By Shweta on 24-04-2019
	...
	public String getCaptureArea() {
		return captureArea;
	}
	public void setCaptureArea(String captureArea) {
