 ...
 * @author AHIS
 */
public class PatientAdhaarDtlVO extends ValueObject
{
	...
	public String getPatAdmittedMsg() {
		return patAdmittedMsg;
	}

	public void setPatAdmittedMsg(String patAdmittedMsg) {
		this.patAdmittedMsg = patAdmittedMsg;
	}
	...
	public String getCatPostFix() {
		return catPostFix;
	}

	public void setCatPostFix(String catPostFix) {
