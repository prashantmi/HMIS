...
public class PatientDetailVO extends DailyPatientVO
{
	...
	private String selectedDischargeSectionData;
	...
	private String addmissionNo;//added by swati on 20-02-2019
	...
	private String patBalance; // added by manisha gangwar for alert on dashboard
	private String isUnitAppointmentBased;  // added by manisha gangwar date: 30.Nov.2015 for Appointment Linkage on Next Visit
	private String admstatuscode;
	private String internalRefer; //added by Shruti Shail for Internal Refer Details
	private String visitDate;
	private String statusAtDischarge;//added by Nilesh Gupta for Status at Discharge date: 25.Oct.2017
	private String snomdPTstatusAtDischarge;
	private String snomdCIdstatusAtDischarge;
	
	//added for discharge tile composition  by manisha gangwar
	private String dischargedOn;
	private String dischargeType;
	private String admittedOn;
	private String consultantId;
	private String patCompleteAddressForDischargeSummary;//Added by Vasu for Discharge Summary Print Dtaed on 08.Jan.2019
	...
	public String getPatBalance() {
		return patBalance;
	}

	public void setPatBalance(String patBalance) {
		this.patBalance = patBalance;
	}
	...
	public String getInternalRefer() {
		return internalRefer;
	}

	public void setInternalRefer(String internalRefer) {
		this.internalRefer = internalRefer;
	}
	...
	public void setSelectedSectionData(String selectedSectionData) {
		this.selectedSectionData = this.patAdmNo;
	}

	public String getSelectedDischargeSectionData() {
		return selectedDischargeSectionData;
	}

	public void setSelectedDischargeSectionData(
			String selectedDischargeSectionData) {
		this.selectedDischargeSectionData = this.consultantID;
	}

	public class JSONPart 
	{
		// added from daily patient vo for Patient summary tile
