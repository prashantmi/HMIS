...
public class RequestRecordDtlVO extends ValueObject
{
	...
	private String mrdRecordStatus;
	...
	private String deptUnit;//added by sandip naik on 20/7/17
	...
	public String getMrdRecordStatus() {
		return mrdRecordStatus;
	}
	public void setMrdRecordStatus(String mrdRecordStatus) {
		this.mrdRecordStatus = mrdRecordStatus;
	}
