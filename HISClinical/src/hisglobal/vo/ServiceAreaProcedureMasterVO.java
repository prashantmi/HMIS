	...
	public class ServiceAreaProcedureMasterVO extends ValueObject
	{
		...
		private String appStatus;  // added by yogender ydaav on 11 july2016 for appointment status.
		private String afterBilling;
		...
		public String getAfterBilling() {
			return afterBilling;
		}
		public void setAfterBilling(String afterBilling) {
