...
public class ConsultationDtlVO extends ValueObject
{
	...
	private String fromDoctName;
	private String toDoctName;
	...
	public String getToDoctName() {
		return toDoctName;
	}

	public void setToDoctName(String toDoctName) {
		this.toDoctName = toDoctName;
	}

	public String getFromDoctName() {
		return fromDoctName;
	}

	public void setFromDoctName(String fromDoctName) {
		this.fromDoctName = fromDoctName;
	}
