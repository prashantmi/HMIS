...
public class GlobalClinicalDAO
{
	...
	/**
	 * Getting List of Patient Detail 
	 * @param hisDAO_p
	 * @param strMode_p 
	 * @param voEpiDiagnosis_p
	 * @param voUser_p
	 * @return
	 * @throws Exception
	 * @author Swati on 20-02-2019
	 */
	
	public List getPatientAddmisionNoWiseDtl(HisDAO hisDAO_p,UserVO userVO,String strMode_p,PatientDetailVO patdtlVO)
	{
		...
		try
		{
			nProcedureIndex = hisDAO_p.setProcedure(GlobalClinicalConfig.PROC_PAT_ADDMISION_NO_WISE_DTL);

			// Setting and Registering In and Out Parameters 
			hisDAO_p.setProcInValue(nProcedureIndex, "p_mode", strMode_p,1);
			hisDAO_p.setProcInValue(nProcedureIndex, "p_hospital_code", userVO.getHospitalCode(),2);
			hisDAO_p.setProcInValue(nProcedureIndex, "p_puk", (patdtlVO.getPatCardNo()==null) ? "":patdtlVO.getPatCardNo(),3);
			hisDAO_p.setProcInValue(nProcedureIndex, "p_episode_code", (patdtlVO.getEpisodeCode()==null) ? "":patdtlVO.getEpisodeCode(),4);
			hisDAO_p.setProcInValue(nProcedureIndex, "p_deptunit_code", (patdtlVO.getDepartmentUnit()==null) ? "":patdtlVO.getDepartmentUnit(),5);
			hisDAO_p.setProcInValue(nProcedureIndex, "p_ward_code", (patdtlVO.getWardCode()==null) ? "":patdtlVO.getWardCode(),6);
			hisDAO_p.setProcInValue(nProcedureIndex, "p_encounter_date", (patdtlVO.getVisitDate()==null) ? "":patdtlVO.getVisitDate(),7);
			hisDAO_p.setProcInValue(nProcedureIndex, "p_admission_no", (patdtlVO.getAddmissionNo()==null) ? "":patdtlVO.getAddmissionNo(),8);
	...
	public List getPatientAddmisionDtl(HisDAO hisDAO_p,UserVO userVO,String strMode_p)
	{
		...
		try
		{
			...
			// Setting and Registering In and Out Parameters 
			hisDAO_p.setProcInValue(nProcedureIndex, "p_mode", strMode_p,1);
			hisDAO_p.setProcInValue(nProcedureIndex, "p_hospital_code", userVO.getHospitalCode());
			hisDAO_p.setProcOutValue(nProcedureIndex, "err", 1,6); // varchar
			hisDAO_p.setProcOutValue(nProcedureIndex, "resultset", 2,7); // Cursor
