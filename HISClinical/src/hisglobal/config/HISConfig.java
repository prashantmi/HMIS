...
//	public static String SYSDATE_OBJECT = "keySystemDateObject";
	...
	public static String HIS_MONGODB_SERVER_URL_DEFAULT_Key = "MONGODB_SERVER_URL";
	public static String HIS_MONGODB_DBNAME_DEFAULT_Key = "MONGODB_DBNAME_PATIENT_DOCUMENTS";
	
	public static String HIS_MONGODB_SERVER_URL_Key = "MONGODB_SERVER_URL";
	public static String HIS_MONGODB_DBNAME_PATIENT_IMAGES_Key = "MONGODB_DBNAME_PATIENT_IMAGES";
	public static String HIS_MONGODB_DBNAME_PATIENT_PROFILES_Key = "MONGODB_DBNAME_PATIENT_PROFILES";
	public static String HIS_MONGODB_DBNAME_PATIENT_DOCUMENTS_Key = "MONGODB_DBNAME_PATIENT_DOCUMENTS";
	public static String HIS_MONGODB_DBNAME_MORTURY_DECEASED_IMAGES_Key = "MONGODB_DBNAME_MORTURY_DECEASED_IMAGES";
	public static String HIS_MONGODB_DBNAME_INVESTIGATION_REPORTS_Key = "MONGODB_DBNAME_INVESTIGATION_REPORTS";
