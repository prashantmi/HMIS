...
public class GenericTemplateEssentialDelegate extends Delegate
{
	...
	{
		GenericTemplateEssentialBOi serviceBO = (GenericTemplateEssentialBOi) super.getServiceProvider();
		return (serviceBO.getAgeRangeList(_userVO));
	}
	
	
	/** Getting Geneder Bound List
	 * @param _userVO UserVO 
	 * @return List of TemplateCategoryVO objects
	 */
	...
	{
		GenericTemplateEssentialBOi serviceBO = (GenericTemplateEssentialBOi) super.getServiceProvider();
		return (serviceBO.getGenderBoundList(_userVO));
	}
	...
	{
		GenericTemplateEssentialBOi serviceBO = (GenericTemplateEssentialBOi)super.getServiceProvider();
		return (serviceBO.getDeskMenuTemplateList(_deskType, _patCrNo, _userDeskTempVO,_userVO));
	}
...
*/
	...
	{
		GenericTemplateEssentialBOi serviceBO = (GenericTemplateEssentialBOi)super.getServiceProvider();
		return serviceBO.getIsDefaultTemp(catCode, userVO);
	}
	
	public String getIsDefaultValueTemp(String catCode,UserVO userVO, String _tempID)
	{
		GenericTemplateEssentialBOi serviceBO = (GenericTemplateEssentialBOi)super.getServiceProvider();
		return serviceBO.getIsDefaultValueTemp(catCode, userVO,_tempID);
	}
}
