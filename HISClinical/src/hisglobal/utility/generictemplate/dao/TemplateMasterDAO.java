...
public class TemplateMasterDAO extends DataAccessObject implements TemplateMasterDAOi
{
	...
	public String create(TemplateMasterVO _templateVO, UserVO _UserVO)
	{
		...
		try
		{
			...
			populateMAP.put(sq.next(),_templateVO.getIsDefault());
			populateMAP.put(sq.next(),_templateVO.getAgeRangeId());
			populateMAP.put(sq.next(),_templateVO.getGenderCode());
			populateMAP.put(sq.next(),_templateVO.getStrTemplateDispName());
		}
		catch (Exception e)
		{
	...
	public TemplateMasterVO getTemplateDataById(TemplateMasterVO _voTemp, UserVO _userVO)
	{
		...
		try
		{
			...
			if (rs.next())
			{
				...
				vo.setAgeRangeId(rs.getString(6));//added by swati on date:28-08-2019
				vo.setGenderCode(rs.getString(7));//added by swati on date:28-08-2019
				vo.setStrTemplateDispName(rs.getString(8));//added by swati on date:28-08-2019
			}
		}
		catch (Exception e)
		{
	...
	public void createNew(TemplateMasterVO _templateVO, UserVO _UserVO)
	{
		...
		try
		{
			...
			populateMAP.put(sq.next(), Config.SUPER_USER_HOSPITAL_CODE);
			populateMAP.put(sq.next(), _templateVO.getIsDefault());
			populateMAP.put(sq.next(),_templateVO.getIsLock());
			populateMAP.put(sq.next(), _templateVO.getAgeRangeId());
			populateMAP.put(sq.next(), _templateVO.getGenderCode());
			populateMAP.put(sq.next(),_templateVO.getStrTemplateDispName());
		}
	...
	public String getIsDefaultValueTemp(String _catCode, UserVO _userVO, String _tempID)
	{
		String str = "";
		String query = "";
		ResultSet rs;
		...
		String filename = GenericTemplateConfig.QUERY_FILE_FOR_GENERIC_TEMPLATE;
		String queryKey = "GET_IS_DEFAULT_LOCK_TEMPLATE.HGBT_TEMPLATE_MST";
	...
	public Boolean getIsDefaultTemp(String _catCode, UserVO _userVO)
	{
		...
		String filename = GenericTemplateConfig.QUERY_FILE_FOR_GENERIC_TEMPLATE;
		String queryKey = "GET_IS_DEFAULT_CHECK.HGBT_TEMPLATE_MST";
