...
public class GenericTemplateDATA 
{
	...
	//added by swati on date:23-08-2019
	// Getting Age Range List
		public static List<Entry> getAgeRangeList(UserVO _userVO)
		{
			GenericTemplateEssentialDelegate delegate=new GenericTemplateEssentialDelegate();
			return delegate.getAgeRangeList(_userVO);
		}
		//added by swati on date:23-08-2019
		// Getting Gender List
		public static List<Entry> getGenderBoundList(UserVO _userVO)
		{
			GenericTemplateEssentialDelegate delegate=new GenericTemplateEssentialDelegate();
			return delegate.getGenderBoundList(_userVO);
		}
	
	//By Mukund on 10.08.2017
	// Getting Template List Category Wise
	public static List<Entry> getTemplateList(String templateId, UserVO _userVO)
	{
		GenericTemplateEssentialBO bo=new GenericTemplateEssentialBO();
		return bo.getTemplateList(templateId, _userVO);
	}//End On 10.08.2017
	...
	public static Boolean getIsDefaultTemp(String catCode,UserVO userVO )
	{
		GenericTemplateEssentialDelegate delegate=new GenericTemplateEssentialDelegate();
		return delegate.getIsDefaultTemp(catCode, userVO);
	}
	
	public static String getIsDefaultValueTemp(String catCode,UserVO userVO,String _tempID )
	{
		GenericTemplateEssentialDelegate delegate=new GenericTemplateEssentialDelegate();
		return delegate.getIsDefaultValueTemp(catCode, userVO,_tempID);
	}
}
