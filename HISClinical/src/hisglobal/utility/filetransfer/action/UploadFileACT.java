	...
	public String attach()
	{
		...
		try
		{
			...
			if(this.uploadedFile!=null && this.uploadedFile.isFile())
			{
				...
				this.getSession().put(FileTransferConfig.KEY_UPLOADED_FILE_NAME_NEW, this.strFileName);
				temp = this.strFileName.replace('.', '#').split("#");
				...
				else
				{
					...
					HisUtil.validateFileContentType(strFileExt, this.uploadedFile);
					...
					{
					this.getSession().put(FileTransferConfig.KEY_UPLOADED_FILE_CONTENT_DOC, fileInStream);
					this.getSession().put(FileTransferConfig.KEY_UPLOADED_FILE_NAME, this.uploadedFile.getName());
					}
					if(strProcessId.equals(FileTransferConfig.PROCESS_ID_IMAGE_EXAMINAION))
					{
					this.getSession().put(FileTransferConfig.KEY_UPLOADED_IMAGE_INV, fileInStream);
					this.getSession().put(FileTransferConfig.KEY_UPLOADED_FILE_NAME, this.uploadedFile.getName());
					}
