...
public class FileTransferConfig
{
	...
	//Added by Vasu date: 08.08.2018 for documents upload
	public static String KEY_UPLOADED_FILE_CONTENT_DOC = "keyUploadedFileContentDoc";
	public static String KEY_UPLOADED_FILE_NAME_NEW = "keyUploadedFileNameNew";
	public static String KEY_UPLOADED_IMAGE_INV="keyuploadedimageinv";
	// Flags
