...
public interface DynamicDeskConfig
{
	...
	// Desk Menu Ids
	String DYNAMIC_DESK_MENU_ID_COMPLAINTS = "1";
	String DYNAMIC_DESK_MENU_ID_HISTORY = "2";
	String DYNAMIC_DESK_MENU_ID_EXAMINATION = "3";
	String DYNAMIC_DESK_MENU_ID_VITALS = "117";
	String DYNAMIC_DESK_MENU_ID_MEDICATION = "188";
	...
	//Added by Vasu on 29.Oct.2018 for ICD-O Integration
	String DYNAMIC_DESK_ICDO_DIAGNOSIS_SITE_LIST = "dynamicDeskICDODiagnosisSiteList";
	String DYNAMIC_DESK_ICDO_MORPHOLOGY_LIST = "dynamicDeskICDOMorphologyList";
