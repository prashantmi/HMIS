...
public class MonthWiseEmpRosterReportDATA  extends ControllerDATA 
{
	...
	public static Map getMonthWiseEmpRosterReportBasedOnDutyAreaAndDesignation(String _desigId,String _year,String _month,String _areaTypeCode,String _areaCode,String _rosterId,UserVO _userVO,String printFormat)
	{
		DutyRosterDelegate delegateObj = new DutyRosterDelegate();
		return delegateObj.getMonthWiseEmpRosterReportBasedOnDutyAreaAndDesignation(_desigId,_year,_month,_areaTypeCode, _areaCode, _rosterId, _userVO,printFormat);
	}
