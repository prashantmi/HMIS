...
import dutyroster.reports.controller.utl.MonthlyEmpRosterReportDateWiseUTL;

public class MonthlyEmpRosterReportDateWiseACT extends DispatchAction
{
	...
	{
		MonthlyEmpRosterReportDateWiseFB _fb = (MonthlyEmpRosterReportDateWiseFB) form;
		...
		MonthlyEmpRosterReportDateWiseUTL.getDutyRosterCategory(_request,_fb);
	...
	{
		MonthlyEmpRosterReportDateWiseFB _fb = (MonthlyEmpRosterReportDateWiseFB) form;
		MonthlyEmpRosterReportDateWiseUTL.getDutyRostersOnTheBasisOfRosterCategory(_request,_fb);
...
public ActionForward GET_DUTY_AREA(ActionMapping mapping,ActionForm form,HttpServletRequest request,HttpServletResponse response){
	 ...
	 MonthlyEmpRosterReportDateWiseFB _fb = (MonthlyEmpRosterReportDateWiseFB) form;		 
	 MonthlyEmpRosterReportDateWiseUTL.getDutyAreaAndDesignationBasedOnRosterType(request,_fb);
...
public ActionForward GET_REPORT(ActionMapping mapping,ActionForm form,HttpServletRequest request,HttpServletResponse response){
 ...
 MonthlyEmpRosterReportDateWiseFB _fb = (MonthlyEmpRosterReportDateWiseFB) form;		 
 MonthlyEmpRosterReportDateWiseUTL.getMonthlyEmpRosterReportDateWise(request,_fb);
