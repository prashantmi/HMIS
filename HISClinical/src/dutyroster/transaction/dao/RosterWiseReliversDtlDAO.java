...
public class RosterWiseReliversDtlDAO extends DataAccessObject implements RosterWiseReliversDtlDAOi{
	
	Logger log;

	public RosterWiseReliversDtlDAO(JDBCTransactionContext _tx)
	{
		super(_tx);
	...
	public void create(RosterWiseReliversDtlVO _reliverRosterVO,UserVO _userVO) 
	{
		...
		String queryKey = "INSERT.HDRT_ROSTERWISE_RELIEVERS_DTL";
		...
		try  
		{
			...
			populateMAP.put(sq.next(), _reliverRosterVO.getRosterId());
			populateMAP.put(sq.next(), _reliverRosterVO.getGeneratedRosterId());
			populateMAP.put(sq.next(), _reliverRosterVO.getEmpId());
			populateMAP.put(sq.next(), _reliverRosterVO.getReliverType());
			populateMAP.put(sq.next(), _reliverRosterVO.getEntryMode());
