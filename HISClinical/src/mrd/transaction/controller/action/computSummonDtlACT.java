...
public class computSummonDtlACT extends CSRFGardTokenAction
{
	...
	public ActionForward NEW(ActionMapping mapping, ActionForm form, HttpServletRequest request,HttpServletResponse response) throws Exception
	{
		...
		fb.setSummonFlag(MrdConfig.IS_COMPUTERIZED_SUMMON_DTL);
	...
	public ActionForward SEARCHPAT(ActionMapping mapping,ActionForm form,HttpServletRequest request,HttpServletResponse response)
	{
		//SummonDtlFB fb=(SummonDtlFB)form;
		return mapping.findForward("SEARCHPAT");
	}
	
	public ActionForward SEARCH(ActionMapping mapping,ActionForm form,HttpServletRequest request,HttpServletResponse response)
	{
		SummonDtlFB fb=(SummonDtlFB)form;
		SummonDetailUTL.searchPatientDtl(fb,request);
		return mapping.findForward("SEARCHPAT");
	}
