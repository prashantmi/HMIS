...
import mrd.reports.controller.util.AgeSexReligionHosRegUTL;


public class AgeSexReligionHosRegACTION extends DispatchAction
{
	...
	{
		AgeSexReligionHosRegFB fb=(AgeSexReligionHosRegFB)form;
		
		fb.reset(mapping, request);
		WebUTIL.refreshTransState(request);
		AgeSexReligionHosRegUTL.getEssential(fb,request);
	...
	public ActionForward TEXT(ActionMapping mapping,ActionForm form,HttpServletRequest request,HttpServletResponse response) throws HisReportDataNotFoundException
	{
		...
		byte[] byteArray =AgeSexReligionHosRegUTL.generateTextReport(fb,request,getServlet().getServletContext(),response);
		try 
		{	
