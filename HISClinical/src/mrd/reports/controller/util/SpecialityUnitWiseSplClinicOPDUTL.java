...
import mrd.reports.controller.data.SpecialityUnitWiseSplClinicOPDDATA;
import mrd.reports.controller.fb.SpecialityUnitWiseSplClinicOPDFB;


public class SpecialityUnitWiseSplClinicOPDUTL extends ReportUTIL
{
	public static void getEssential(SpecialityUnitWiseSplClinicOPDFB _fb,HttpServletRequest _request)
	{
		...
		try
		{
			...
			Map mp=SpecialityUnitWiseSplClinicOPDDATA.getSpecialityUnitWiseSplClinicOPDReportEssentials(ControllerUTIL.getUserVO(_request));  
	...
	/*
	public static void setUnitBasedOnSpeciality(SpecialityUnitWiseSplClinicOPDFB _fb,HttpServletRequest _request)
	{
		...
		{	
			...
			unitList=SpecialityUnitWiseSplClinicOPDDATA.getUnitBasedOnSpeciality(speciality,getUserVO(_request));
