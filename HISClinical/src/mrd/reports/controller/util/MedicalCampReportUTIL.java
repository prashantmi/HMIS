...
import mrd.reports.controller.data.MedicalCampReportDATA;
import mrd.reports.controller.fb.MedicalCampReportFB;

public class MedicalCampReportUTIL  extends ReportUTIL
{
	public static void getEssential(MedicalCampReportFB _fb,HttpServletRequest _request)
	{
...
//		UserVO userVO=new UserVO();
		...
		{
			setSysdate(_request);
			Map map1=(HashMap)MedicalCampReportDATA.getAllHospitalEssentials(getUserVO(_request));
