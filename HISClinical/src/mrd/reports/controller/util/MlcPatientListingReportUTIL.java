...
import mrd.reports.controller.data.MlcPatientListingReportDATA;
import mrd.reports.controller.fb.MlcPatientListingReportFB;


public class MlcPatientListingReportUTIL extends ReportUTIL
{
	public static void getEssential(MlcPatientListingReportFB _fb,HttpServletRequest _request)
	{
...
//		UserVO userVO=new UserVO();
		...
		{
			setSysdate(_request);
			Map map1=(HashMap)MlcPatientListingReportDATA.getAllHospitalEssentials(getUserVO(_request));
