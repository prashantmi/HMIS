...
import mrd.reports.controller.data.SpecialityWiseIndoorPatientsDATA;
import mrd.reports.controller.fb.SpecialityWiseIndoorPatientsFB;


public class SpecialityWiseIndoorPatientsUTL extends ReportUTIL
{
	public static void getEssential(SpecialityWiseIndoorPatientsFB _fb,HttpServletRequest _request)
	{
		...
		try
		{
			...
			Map mp=SpecialityWiseIndoorPatientsDATA.getSpecialityWiseIndoorPatientReportEssentials(ControllerUTIL.getUserVO(_request));  
	...
	/*
	public static void setUnitBasedOnSpeciality(SpecialityWiseIndoorPatientsFB _fb,HttpServletRequest _request)
	{
		...
		{	
			...
			unitList=SpecialityWiseIndoorPatientsDATA.getUnitBasedOnSpeciality(speciality,getUserVO(_request));
