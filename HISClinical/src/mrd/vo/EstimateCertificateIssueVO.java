...
public class EstimateCertificateIssueVO extends ValueObject {
	...
	public String getBillnoqty() {
		return billnoqty;
	}
	public void setBillnoqty(String billnoqty) {
		this.billnoqty = billnoqty;
	}
