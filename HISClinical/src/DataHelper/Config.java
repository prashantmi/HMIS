...
public class Config {
	...
	public static String disclaimeratreport = "Test results relate only to item received. All reports need clinical correlation. Kindly discuss if necessary. No part of the report can be reproduced without written permission of the laboratory.";
	...
	//dept template xml id
	 ...
	 public static String HEADER_HEIGHT = "255.0";
	 //public static String HEADER_HEIGHT = "245.0";
	 //public static String HEADER_HEIGHT_WITH_HEADER = "210.0";
	 public static String HEADER_HEIGHT_WITH_HEADER = "300.0";
	 //public static String HEADER_HEIGHT_WITHOUT_HEADER = "210.0";
	 public static String HEADER_HEIGHT_WITHOUT_HEADER = "300.0";
