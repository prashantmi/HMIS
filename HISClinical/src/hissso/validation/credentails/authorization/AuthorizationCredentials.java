...
public class AuthorizationCredentials extends ValueObject
{
	...
	public boolean isAuthorizedURL(String strURL)
	{
		...
		try
		{
			...
			{
				//Edited by Dheeraj on 05-Oct-2018 --> Added exception for Jar extension for Digital Sign
				if (strURL == null || strURL.trim().equals("") || strURL.endsWith(".js") || strURL.endsWith(".css") || strURL.endsWith(".png") || strURL.endsWith(".gif") || strURL.endsWith(".jpg") || strURL.endsWith(".bmp") || strURL.endsWith(".jar") || strURL.endsWith(".class")) return true;
