...
public abstract class HISSSOConfig
{
	...
	public static int LOGIN_USER_SESSION_SALT_BYTE_SIZE = 24; // Good Size
		// Ticket Expiration
	//Session timeout change by Garima for Security Changes
	public static int SSO_TICKET_EXPIRY_IN_SECONDS_TGT = 1800; //18000;		// 5 Hours
	public static int SSO_TICKET_EXPIRY_IN_SECONDS_ST = 1200; //7200;		// 2 Hours
