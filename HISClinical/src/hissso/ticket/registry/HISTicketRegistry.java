...
public final class HISTicketRegistry implements TicketRegistry
{
	...
	public void addTicket(final Ticket ticket)
	{
		...
		if(ticket instanceof HISServiceGrantTicket)
		{
			...
			//System.out.println("HIS-SSO:: Ticket Registry: Service Ticket Registered-" + ticket.getTicketId()+ " of Service-"+objServiceTicket.getService().getContext()+" in TGT-"+objServiceTicket.getGrantingTicketId());
		}
	...
	public Ticket getTicketBasedOn(final String grantingTicketId, final HISService objService)
	{
		...
		//else
			//System.out.println("HIS-SSO:: Ticket Registry: Service Ticket Found, TGT-" + grantingTicketId + " ,Service-" + objService.getContext() + " of Id-" + ticket.getTicketId());
