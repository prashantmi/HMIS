...
public class GeneralAppearanceEntryFB extends DeceasedTileFB
{
...
//	private String weight;
	...
	public void reset(ActionMapping mapping,HttpServletRequest request)
	{
		...
		this.setStartDateTimeHr("");
		this.setStartDateTimeMin("");
		this.setEndDateTimeHr("");
		this.setEndDateTimeMin("");
		this.setCynosis("");
		this.setPupilLeft("");
		this.setPupilRight("");
		this.setCorneaLeft("");
