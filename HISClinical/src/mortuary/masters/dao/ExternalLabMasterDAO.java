...
public class ExternalLabMasterDAO extends DataAccessObject implements ExternalLabMasterDAOi {

	Logger log;

	public ExternalLabMasterDAO(JDBCTransactionContext _tx)
	{
		super(_tx);
	...
	public void saveExternalLabDetails(ExternalLabMasterVO _externalLabMstVO, UserVO _userVO){
		...
		String queryKey = "INSERT.HMRT_EXT_LAB_MST";
		...
		try 
		{
			...
			populateMAP.put(sq.next(), Config.SUPER_USER_HOSPITAL_CODE);
			populateMAP.put(sq.next(), _externalLabMstVO.getExternalLabName());			
			populateMAP.put(sq.next(), Config.IS_VALID_ACTIVE);
			populateMAP.put(sq.next(), _userVO.getSeatId());
			populateMAP.put(sq.next(), _externalLabMstVO.getAddress());	
			populateMAP.put(sq.next(), _externalLabMstVO.getContactNo());	
	...
	public ExternalLabMasterVO getExternalLabDetails(ExternalLabMasterVO _externalLabMstVO, UserVO _userVO)
	{
		...
		String filename = MortuaryConfig.QUERY_FILE_FOR_MORTUARY_MASTER_DAO;
		String queryKey = "SELECT.HMRT_EXT_LAB_MST";
		ExternalLabMasterVO externalLabTestMstVO=new ExternalLabMasterVO();
		...
		try
		{									
			populateMAP.put(sq.next(), _externalLabMstVO.getExternalLabId());
			//populateMAP.put(sq.next(), _userVO.getHospitalCode()); 
			populateMAP.put(sq.next(), Config.SUPER_HOSPITAL_CODE); 
			populateMAP.put(sq.next(), _externalLabMstVO.getSerialNo());
	...
	public void modiftExternalLabDetails(ExternalLabMasterVO _externalLabMstVO, UserVO _userVO){
		...
		Sequence sq = new Sequence();
		String filename = MortuaryConfig.QUERY_FILE_FOR_MORTUARY_MASTER_DAO;
		String queryKey = "UPDATE.HMRT_EXT_LAB_MST";
	...
	public void modifyInsertExternalLabDetails(ExternalLabMasterVO _externalLabMstVO, UserVO _userVO){ 
		...
		Sequence sq = new Sequence();
		String filename = MortuaryConfig.QUERY_FILE_FOR_MORTUARY_MASTER_DAO;
		String queryKey = "MODIFY.INSERT.HMRT_EXT_LAB_MST";
		...
		try   
		{
			...
			populateMAP.put(sq.next(), Config.SUPER_HOSPITAL_CODE); 
				populateMAP.put(sq.next(), _externalLabMstVO.getExternalLabName());			
			populateMAP.put(sq.next(), _externalLabMstVO.getIsActive());
			populateMAP.put(sq.next(), _userVO.getSeatId());
			populateMAP.put(sq.next(), _externalLabMstVO.getAddress());
			populateMAP.put(sq.next(), _externalLabMstVO.getContactNo());
	...
	public void checkDuplicateBeforeInsert(String chamberName, UserVO _userVO) {
	    ...
	    Map populateMAP =new HashMap();
	    String filename = MortuaryConfig.QUERY_FILE_FOR_MORTUARY_MASTER_DAO;
	    String queryKey="DUPLICATE_CHECK.INSERT.HMRT_EXT_LAB_MST";
	    ResultSet rs=null;
	    ...
	    try{
			 ...
			 if(rs.next()){
				// record=rs.getString(1); 
				 throw new HisDuplicateRecordException("External Lab Name Already Exists");
			 }	  
	...
	public void checkDuplicateBeforeModify(ExternalLabMasterVO _externalLabMstVO,UserVO _userVO) {
	    ...
	    Map populateMAP =new HashMap();
	    String filename = MortuaryConfig.QUERY_FILE_FOR_MORTUARY_MASTER_DAO;
	    String queryKey="DUPLICATE_CHECK.MODIFY.HMRT_EXT_LAB_MST";
