...
public class ChamberMasterDAO extends DataAccessObject implements ChamberMasterDAOi {

	Logger log;

	public ChamberMasterDAO(JDBCTransactionContext _tx)
	{
		super(_tx);
	...
	public void saveChamber(ChamberMasterVO _chamberMstVO,UserVO _userVO){
		...
		String queryKey = "INSERT.HMRT_CHAMBER_MST";
		...
		try 
		{
			...
			populateMAP.put(sq.next(), _userVO.getHospitalCode());
			populateMAP.put(sq.next(), _chamberMstVO.getChamberName());			
			populateMAP.put(sq.next(), _chamberMstVO.getChamberStatus());
			populateMAP.put(sq.next(), _chamberMstVO.getChamberType());			
			populateMAP.put(sq.next(), _chamberMstVO.getRackNumbers());
			populateMAP.put(sq.next(), _chamberMstVO.getRemarks());
			populateMAP.put(sq.next(), Config.IS_VALID_ACTIVE);
			populateMAP.put(sq.next(), _userVO.getSeatId());
			populateMAP.put(sq.next(), _chamberMstVO.getAreaCode());
			populateMAP.put(sq.next(), _chamberMstVO.getItemId());
	...
	public ChamberMasterVO getChamberDetails(ChamberMasterVO _chamberMstVO,UserVO _userVO)
	{
		...
		String filename = MortuaryConfig.QUERY_FILE_FOR_MORTUARY_MASTER_DAO;
		String queryKey = "SELECT.HMRT_CHAMBER_MST";
		...
		{									
			...
			populateMAP.put(sq.next(), Config.IS_VALID_ACTIVE);
			populateMAP.put(sq.next(), Config.IS_VALID_ACTIVE);
			populateMAP.put(sq.next(), _chamberMstVO.getChamberId());
			populateMAP.put(sq.next(), _userVO.getHospitalCode()); 		
			populateMAP.put(sq.next(), _chamberMstVO.getSerialNo());
	...
	public void modifyChamber(ChamberMasterVO _chamberMstVO,UserVO _userVO){
		...
		Sequence sq = new Sequence();
		String filename = MortuaryConfig.QUERY_FILE_FOR_MORTUARY_MASTER_DAO;
		String queryKey = "UPDATE.HMRT_CHAMBER_MST";
	...
	public void modifyInsertChamber(ChamberMasterVO _chamberMstVO,UserVO _userVO){ 
		...
		Sequence sq = new Sequence();
		String filename = MortuaryConfig.QUERY_FILE_FOR_MORTUARY_MASTER_DAO;
		String queryKey = "MODIFY.INSERT.HMRT_CHAMBER_MST";
		...
		try   
		{
			...
			populateMAP.put(sq.next(), _chamberMstVO.getRackNumbers());
			populateMAP.put(sq.next(), _chamberMstVO.getRemarks());
			populateMAP.put(sq.next(), _chamberMstVO.getIsValid());
			populateMAP.put(sq.next(), _userVO.getSeatId());
			populateMAP.put(sq.next(), _chamberMstVO.getAreaCode());
			populateMAP.put(sq.next(), _chamberMstVO.getItemId());
	...
	public void checkDuplicateBeforeInsert(String chamberName, UserVO _userVO) {
	    ...
	    Map populateMAP =new HashMap();
	    String filename = MortuaryConfig.QUERY_FILE_FOR_MORTUARY_MASTER_DAO;
	    String queryKey="DUPLICATE_CHECK.INSERT.HMRT_CHAMBER_MST";
	    ResultSet rs=null;
	    ...
	    try{
			 ...
			 if(rs.next()){
				// record=rs.getString(1); 
				 throw new HisDuplicateRecordException("Chamber Name Already Exists");
			 }	  
	...
	public void checkDuplicateBeforeModify(ChamberMasterVO _chamberMstVO,UserVO _userVO) {
	    ...
	    Map populateMAP =new HashMap();
	    String filename = MortuaryConfig.QUERY_FILE_FOR_MORTUARY_MASTER_DAO;
	    String queryKey="DUPLICATE_CHECK.MODIFY.HMRT_CHAMBER_MST";
