...
public class PatientDetailDATA extends ControllerDATA {
	...
	public static PatientVO getPatientDtl(PatientVO _patVO, UserVO _userVO, String _constraint)
	{
		PatientDelegate patientDelegate = new PatientDelegate();
		return patientDelegate.searchPatientByCrNo(_patVO, _userVO, _constraint);
	}
