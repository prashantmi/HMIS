...
public interface RegistrationDaoConfig extends RegistrationConfig{
	String QUERY_PROPERTY_FILE = "";

	String HARDCODE_HOSPITAL_CODE="108";
	String HARDCODE_DEPARTMRNT_CODE="101";
	
	String PROCEDURE_GET_CRNO="ahis_reg.generateCRno";
	//String PROCEDURE_GET_CRNO="ahis_util.puk_gen";
	//String PROCEDURE_GET_EPISODENO="ahis_reg.generateEPISODEcode";
	String PROCEDURE_GET_EPISODENO="ahis_reg.puk_episode_gen";
	String PROCEDURE_GET_TOKEN_DTL="ahis_reg.generatequeno";
	String PROCEDURE_GET_TOKEN_DTL_NEW="pkg_reg_view.gen_queno_unitwise";///new method for opd new registration
	String PROCEDURE_GET_TOKEN_DTL_OLD_PATIENT="ahis_reg.gen_queno_old";//new method for old patient visit
	String PROCEDURE_GET_TOKEN_DTL_SPECIAL_CLINIC="ahis_reg.generatequeno_unitwise";
	String PROCEDURE_GET_TOKEN_DTL_SPECIAL_CLINIC_NEW="pkg_reg_view.gen_queno_unitwise";//new method for special and casualty
	String PROCEDURE_GET_TOKEN_DTL_CASUALTY="generatequeno_casuality_mod";
	String PROCEDURE_GET_PATIENT_DTL="pkg_GNCTD_reg.getPatientDtl";	
	String PROCEDURE_GET_PATIENT_DOB="ahis_util.puk_dob";
	String PROCEDURE_GET_PATIENT_AGE_AS_ON="ahis_util.puk_age_on";
	//String PROCEDURE_GET_PATIENT_AGE_BY_DOB="ahis_util.dob_age_on";
	String PROCEDURE_GET_PATIENT_AGE_WHEN_REGISTERED="ahis_util.puk_age";
	String PROCEDURE_UPDATE_PATIENT_DTL="PatientDtlUpdation";
	
	//String PROCEDURE_GET_DOB = "pkg_reg_util.getdob";
	
	//String PROCEDURE_GET_DEPT_COMBO="ahis_reg.ProcDeptCombo";
	String PROCEDURE_GET_UNIT_COMBO="ahis_reg.ProcUnitCombo";
	String PROCEDURE_UPDATE_PATIENT_ADDRESS_DTL="ahis_reg_dml.ADDRESSUPDATION";
	String PROCEDURE_GET_ALERT="hisalert";
	String PROCEDURE_GET_ESSENTIAL_ALERT_USER_MASTER="pkg_alert_view.proc_alert_list";
	String PROCEDURE_AUTOMATIC_ALERT="proc_alert_list";
	String PROCEDURE_AUTOALERT="proc_autoalert_generate";
	String PROCEDURE_GENERATE_FILE_NUMBER="ahis_reg.PROCGenFileno";
	String PROCEDURE_MARQUE_MSG="pkg_usermgmt.proc_marque_msg"; 
	String PROCEDURE_FOR_REGISTRATION_BILLING="BILL_INTERFACE.Dml_Online_Cash_Dtl";
	
	//Offline Registration
	String PROCEDURE_OFFLINE_REGISTRATION_FOR_DEPT_UNIT_ROOM_LIST="AHIS_REG_OFFLINE.ProcDeptUnitRoomcombo";
	String PROCEDURE_OFFLINE_REGISTRATION_GET_TOKEN_DTL="AHIS_REG_OFFLINE.gen_queno_roomwise";
	
	///room wise new department visit
	String PROCEDURE_ROOM_WISE_NEW_REGISTRATION_FOR_DEPT_UNIT_ROOM_LIST="AHIS_REG_OFFLINE.Proc_newvis_DeptUnitRoomcombo";
