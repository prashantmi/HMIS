...
public class DSSEpisodeVO extends ValueObject
{
	...
	private DSSEpisodeStatisticVO arrDaysStats[];
	
	private DSSEpisodeStatisticVO voMonthStat;
	
	
	public DSSEpisodeVO()
	{
		this.arrDaysStats = new DSSEpisodeStatisticVO[31];
		this.voMonthStat = new DSSEpisodeStatisticVO(DSSEpisodeStatisticVO.STAT_MODE_MONTH);
	}
	...
	public DSSEpisodeStatisticVO[] getArrDaysStats()
	{
		return arrDaysStats;
	}

	public void setArrDaysStats(DSSEpisodeStatisticVO[] arrDaysStats)
	{
		this.arrDaysStats = arrDaysStats;
	}

	public DSSEpisodeStatisticVO getVoMonthStat()
	{
		return voMonthStat;
	}

	public void setVoMonthStat(DSSEpisodeStatisticVO voMonthStat)
	{
		...
		try
		{
			...
			if(this.arrDaysStats!=null && this.arrDaysStats.length>=nDay)
			{
				if(this.arrDaysStats[nDay]==null)
					this.arrDaysStats[nDay] = new DSSEpisodeStatisticVO(DSSEpisodeStatisticVO.STAT_MODE_DAY, strDay);
