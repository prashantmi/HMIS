...
import inpatient.transaction.controller.utl.ExtAdministrationUTL;
...
public class ExtAdministrationACT extends CSRFGardTokenAction
{
	...
	public ActionForward NEW(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
	{
		...
		ExtAdministrationFB fb = (ExtAdministrationFB) form;
		fb.reset(mapping, request);
		//WebUTIL.refreshTransState(request); // Commented By Pragya 2014.12.26 as required by New Desk
		ExtAdministrationUTL.setEssentials(fb, request);
	...
	{
		ExtAdministrationFB fb=(ExtAdministrationFB)form;
		ExtAdministrationUTL.addNewActivityRow(fb,request);
		fb.reset(mapping, request);
		return mapping.findForward("NEW");		
	}
	...
	{
		ExtAdministrationFB fb=(ExtAdministrationFB)form;
		ExtAdministrationUTL.deleteActivityRow(fb,request);
		fb.reset(mapping, request);
		return mapping.findForward("NEW");		
	}
	...
	public ActionForward SAVE(ActionMapping mapping,ActionForm form,HttpServletRequest request,HttpServletResponse response) throws Exception
	{
		...
		ExtAdministrationFB fb=(ExtAdministrationFB)form;
		ExtAdministrationUTL.saveExtAdmin(fb,request);
		fb.reset(mapping, request);
		return this.NEW(mapping,form,request,response);
		//return mapping.findForward("NEW");
	}
