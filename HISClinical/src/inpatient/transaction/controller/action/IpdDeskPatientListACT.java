...
public class IpdDeskPatientListACT extends DispatchAction
{
	...
	{
		System.out.println("IpdDeskPatientListACT.AJX_G_WARD()");
		IpdPatDocDeskFB fb=(IpdPatDocDeskFB)form;
	...
	throws HisException, Exception, SQLException
	{
		...
		System.out.println("IpdDeskPatientListACT.AJX_G_PATIENTLIST()");
