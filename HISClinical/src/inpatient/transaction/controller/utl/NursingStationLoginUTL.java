...
import inpatient.transaction.controller.data.NursingStationLoginDATA;
...
public class NursingStationLoginUTL extends ControllerUTIL
{
	/**
	 ...
	 */ 
	public static boolean getWardListBasedOnRole(NursingStationLoginFB fb, HttpServletRequest request)
	{
		...
		try
		{
			...
			listWard=NursingStationLoginDATA.getWardListBasedOnRole(getUserVO(request));
	...
	public static boolean getDeptUnitList(NursingStationLoginFB fb,HttpServletRequest request)
	{
		Status objStatus = new Status();
		boolean flag = true;
		try
		{
			...
			List lstUnit=NursingStationLoginDATA.getDeptUnitList(getUserVO(request));
	...
	public static boolean getWardOnBasisOfUnitCode(NursingStationLoginFB fb,HttpServletRequest request)
	{
		Status objStatus = new Status();
		boolean flag = true;
		List listWard = new ArrayList();
		try
		{
			...
			listWard=NursingStationLoginDATA.getWardOnBasisOfUnitCode(unitCode,getUserVO(request));
	...
	public static boolean getRoomOnBasisOfWardCode(NursingStationLoginFB fb,HttpServletRequest request)
	{
		Status objStatus = new Status();
		boolean flag = true;
		...
		try
		{
			if(InpatientConfig.IPD_NURSING_STATION_ROOM_SELECTION.equals(InpatientConfig.ROOM_SELECTION_NO)
					|| InpatientConfig.IPD_NURSING_STATION_UNIT_SELECTION.equals(InpatientConfig.UNIT_SELECTION_NO))
			{
			...
			else
			{
				...
				fb.setRoomCode("-1");
				listRoom=NursingStationLoginDATA.getRoomOnBasisOfWardCode(unitCode,fb.getWardCode(),getUserVO(request));
	...
	// Going To Nursing Station
	public static void goToNursingStation(NursingStationLoginFB _fb, HttpServletRequest _request)
	{
		Status objStatus = new Status();
		...
		try
		{
			...
			if(InpatientConfig.IPD_NURSING_DESK_UNIT_SELECTION.equals(InpatientConfig.UNIT_SELECTION_NO))
			{
				...
				DynamicDeskUTIL.setAttributeInSession(_request, DynamicDeskConfig.DYNAMIC_DESK_TYPE, DynamicDeskConfig.DESK_TYPE_IPD_NURSING_STATION);
