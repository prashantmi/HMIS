...
public class InpatientDAO extends DataAccessObject implements InpatientDAOi
{
	Logger log;

	public InpatientDAO(JDBCTransactionContext _tx)
	{
		super(_tx);
	...
	public PatientDetailVO getIpdPatientDtlByCrNo(PatientDetailVO patDtlVO,UserVO userVO)
	{
		...
		String queryKey = "SELECT.IPD.RETRIEVE_BY_CRNO.HIPT_PATADMISSION_DTL.HRGT_PATIENT_DTL";
...
*/		populateMap.put(sq.next(), Config.ANC_DETAIL_MAXIMUM_GESTATION_WEEK_FOR_ANC);
	...
	public PatientDetailVO getMRDPatientDtlByCrNo(PatientDetailVO patDtlVO,UserVO userVO)
	{
		...
		Map populateMap= new HashMap();
		String filename = InpatientConfig.QUERY_FILE_FOR_INPATIENT_DAO;
		String queryKey = "SELECT.MRD.RETRIEVE_BY_CRNO.HIPT_PATADMISSION_DTL.HRGT_PATIENT_DTL";
