...
public class AnomalyTypeMstDAO extends DataAccessObject implements AnomalyTypeMstDAOi
{
	public AnomalyTypeMstDAO(TransactionContext _tx)
	{
		super(_tx);
	}
	...
	public void create(AnomalyTypeMasterVO anomalyTypeMasterVO,UserVO userVO)
	{
        ...
        String queryKey="INSERT.HANCT_ANOMALY_TYPE_MST";
		 ...
		 try
	        ...
	        try
	        {
	        	...
	        	populateMAP.put(sq.next(),anomalyTypeMasterVO.getAnomalyType());
	        	populateMAP.put(sq.next(),Config.SUPER_USER_HOSPITAL_CODE);
	...
	public String checkDuplicateAnomalyTypeName(AnomalyTypeMasterVO anomalyTypeMasterVO,UserVO userVO)
	{
        ...
        Sequence sq=new Sequence();
        String filename=InpatientConfig.QUERY_FILE_FOR_INPATIENT_DAO;
        String queryKey="CHECK_DUPLICATE_NAME.HANCT_ANOMALY_TYPE_MST";
		...
		public AnomalyTypeMasterVO getDataForModify(AnomalyTypeMasterVO anomalyTypeMasterVO, UserVO _UserVO)
	{
		...
		String filename=InpatientConfig.QUERY_FILE_FOR_INPATIENT_DAO;
		String queryKey = "SELECT.HANCT_ANOMALY_TYPE_MST";
		try
		{
			query = HelperMethodsDAO.getQuery(filename, queryKey);
		}
		...
		try
		{
			populateMAP.put(sq.next(), anomalyTypeMasterVO.getAnomalyTypeID());
			populateMAP.put(sq.next(), anomalyTypeMasterVO.getSlNo());
	...
	public void updateAnomalyTypeMaster(AnomalyTypeMasterVO anomalyTypeMasterVO,UserVO _UserVO)
	{
		...
		Sequence sq = new Sequence();
		  String filename=InpatientConfig.QUERY_FILE_FOR_INPATIENT_DAO;
		String queryKey = "UPDATE.HANCT_ANOMALY_TYPE_MST";
	...
	public void modifySaveAnomalyTypeMaster(AnomalyTypeMasterVO anomalyTypeMasterVO, UserVO _UserVO)
	{
		...
		Sequence sq = new Sequence();
		  String filename=InpatientConfig.QUERY_FILE_FOR_INPATIENT_DAO;
		String queryKey = "MODIFYINSERT.HANCT_ANOMALY_TYPE_MST";
		...
		try
		{
			...
			populateMAP.put(sq.next(),anomalyTypeMasterVO.getAnomalyType());
           	populateMAP.put(sq.next(), Config.SUPER_USER_HOSPITAL_CODE);
        	populateMAP.put(sq.next(), anomalyTypeMasterVO.getIsActive());
        	populateMAP.put(sq.next(), _UserVO.getSeatId());
		}
		catch (Exception e)
		{
	...
	public String checkDuplicateNameForModify(AnomalyTypeMasterVO anomalyTypeMasterVO,UserVO userVO)
	{
        ...
        Sequence sq=new Sequence();
        String filename=InpatientConfig.QUERY_FILE_FOR_INPATIENT_DAO;
        String queryKey="CHECK_DUPLICATE_NAMEFORMODIFY.HANCT_ANOMALY_TYPE_MST";
