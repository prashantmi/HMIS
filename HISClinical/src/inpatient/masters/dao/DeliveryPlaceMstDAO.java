...
public class DeliveryPlaceMstDAO extends DataAccessObject implements DeliveryPlaceMstDAOi
{
	public DeliveryPlaceMstDAO(TransactionContext _tx)
	{
		super(_tx);
	}
	...
	public void create(DeliveryPlaceMasterVO deliveryPlaceMasterVO,UserVO userVO)
	{
        ...
        String queryKey="INSERT.HANCT_DELIVERY_PLACE_MST";
		 ...
		 try
	        ...
	        try
	        {
	        	...
	        	populateMAP.put(sq.next(),deliveryPlaceMasterVO.getDeliveryPlace());
	        	populateMAP.put(sq.next(),Config.SUPER_USER_HOSPITAL_CODE);
	...
	public String checkDuplicateDeliveryPlaceName(DeliveryPlaceMasterVO deliveryPlaceMasterVO,UserVO userVO)
	{
        ...
        Sequence sq=new Sequence();
        String filename=InpatientConfig.QUERY_FILE_FOR_INPATIENT_DAO;
        String queryKey="CHECK_DUPLICATE_NAME.HANCT_DELIVERY_PLACE_MST";
		...
		public DeliveryPlaceMasterVO getDataForModify(DeliveryPlaceMasterVO deliveryPlaceMasterVO, UserVO _UserVO)
	{
		...
		String filename=InpatientConfig.QUERY_FILE_FOR_INPATIENT_DAO;
		String queryKey = "SELECT.HANCT_DELIVERY_PLACE_MST";
		try
		{
			query = HelperMethodsDAO.getQuery(filename, queryKey);
		}
		...
		try
		{
			populateMAP.put(sq.next(), deliveryPlaceMasterVO.getDeliveryPlaceId());
			populateMAP.put(sq.next(), deliveryPlaceMasterVO.getSlNo());
	...
	public void updateDeliveryPlaceMaster(DeliveryPlaceMasterVO deliveryPlaceMasterVO,UserVO _UserVO)
	{
		...
		Sequence sq = new Sequence();
		  String filename=InpatientConfig.QUERY_FILE_FOR_INPATIENT_DAO;
		String queryKey = "UPDATE.HANCT_DELIVERY_PLACE_MST";
	...
	public void modifySaveDeliveryPlaceMaster(DeliveryPlaceMasterVO deliveryPlaceMasterVO, UserVO _UserVO)
	{
		...
		Sequence sq = new Sequence();
		  String filename=InpatientConfig.QUERY_FILE_FOR_INPATIENT_DAO;
		String queryKey = "MODIFYINSERT.HANCT_DELIVERY_PLACE_MST";
		...
		try
		{
			...
			populateMAP.put(sq.next(),deliveryPlaceMasterVO.getDeliveryPlace());
           	populateMAP.put(sq.next(), Config.SUPER_USER_HOSPITAL_CODE);
        	populateMAP.put(sq.next(), deliveryPlaceMasterVO.getIsValid());
        	populateMAP.put(sq.next(), _UserVO.getSeatId());
		}
		catch (Exception e)
		{
	...
	public String checkDuplicateNameForModify(DeliveryPlaceMasterVO deliveryPlaceMasterVO,UserVO userVO)
	{
        ...
        Sequence sq=new Sequence();
        String filename=InpatientConfig.QUERY_FILE_FOR_INPATIENT_DAO;
        String queryKey="CHECK_DUPLICATE_NAMEFORMODIFY.HANCT_DELIVERY_PLACE_MST";
