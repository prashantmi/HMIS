...
import inpatient.reports.controller.data.DiseaseCodeReportDATA;
import inpatient.reports.controller.fb.DiseaseCodeReportFB;


public class DiseaseCodeReportUTL extends ReportUTIL
{
	public static void getEssential(DiseaseCodeReportFB _fb,HttpServletRequest _request)
	{
		...
		try
		{
			...
			Map map1=(HashMap)DiseaseCodeReportDATA.getAllHospitalEssentials(getUserVO(_request));
