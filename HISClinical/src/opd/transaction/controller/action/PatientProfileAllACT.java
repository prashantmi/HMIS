...
import opd.transaction.controller.util.PatientProfileAllUTIL;
...
public class PatientProfileAllACT extends DispatchAction {
	...
	public ActionForward NEW(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		fb.reset();
		PatientProfileAllUTIL.setEssentials(fb, request);
