...
import opd.transaction.controller.data.OpdAudioVideoUploadDATA;
...
public class OpdAudioVideoUploadUTIL extends ControllerUTIL implements ControllerListener
{
	DataSink sink;
	...
	public static void getAudioVideoEssentials(OpdAudioVideoUploadFB _fb, HttpServletRequest _rq)
	{
		...
		try
		{
			...
			audioVideoMasterVO = OpdAudioVideoUploadDATA.getAudioVideoEssentials(departmentUnitCode, getUserVO(_rq));
	...
	public static void getAudioVideoFile(OpdAudioVideoUploadFB _fb, HttpServletRequest _rq, HttpServletResponse response)
	{
	...
	public void setAudioVideoUpload(OpdAudioVideoUploadFB _fb, HttpServletRequest _rq)
	{
