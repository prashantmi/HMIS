...
public class OpdImageExamTabFB extends CRNoFB
{
	...
	private String patCrNoForImgUpload;
	private String patEpisodeCodeForImgUpload;
	...
	public String getPatCrNoForImgUpload() {
		return patCrNoForImgUpload;
	}

	public void setPatCrNoForImgUpload(String patCrNoForImgUpload) {
		this.patCrNoForImgUpload = patCrNoForImgUpload;
	}

	public String getPatEpisodeCodeForImgUpload() {
		return patEpisodeCodeForImgUpload;
	}

	public void setPatEpisodeCodeForImgUpload(String patEpisodeCodeForImgUpload) {
		this.patEpisodeCodeForImgUpload = patEpisodeCodeForImgUpload;
	}
