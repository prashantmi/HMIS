...
public class OpdPatientDeskDATA extends ControllerDATA
{
	// *
	...
	public static Map<String, Object> getAllPatientList_AJAX(PatientDetailVO patientDetailVO, UserVO _UserVO, int p_page, int p_limit, String p_sidx, String p_sord, String p_where, String deskType)
	{
		OpdEssentialBO opdEssentialBO = new OpdEssentialBO();
		return opdEssentialBO.getAllPatientList_AJAX(patientDetailVO, _UserVO, p_page, p_limit, p_sidx, p_sord, p_where, deskType);
