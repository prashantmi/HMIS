...
// user login password
protected String password = "hisregistration";
// FTP server name
protected String hostString="10.103.0.20";
// file to retrieve
protected String fileString="dir/MOV00254.MPG";
...
typeString = "video.quicktime";
	...
	try
	{
	streams[0] = (PullSourceStream) new FTPSourceStream(dataSocket.getInputStream());
	}
	catch(IOException e)
	{
