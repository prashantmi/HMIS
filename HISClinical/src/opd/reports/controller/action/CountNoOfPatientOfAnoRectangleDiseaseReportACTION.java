...
import opd.reports.controller.util.CountNoOfPatientOfAnoRectangleDiseaseReportUTIL;
...
public class CountNoOfPatientOfAnoRectangleDiseaseReportACTION extends DispatchAction
{
	...
	{
		CountNoOfPatientOfAnoRectangleDiseaseReportFB fb= (CountNoOfPatientOfAnoRectangleDiseaseReportFB)form;
		fb.reset(mapping,request);
		WebUTIL.refreshTransState(request);
		
		CountNoOfPatientOfAnoRectangleDiseaseReportUTIL.getEssential(fb,request);
	...
	public ActionForward TEXT(ActionMapping mapping,ActionForm form,HttpServletRequest request,HttpServletResponse response) throws HisReportDataNotFoundException
	{
		...
		try {	
			byte[] byteArray =CountNoOfPatientOfAnoRectangleDiseaseReportUTIL.generateTextReport(fb,request,getServlet().getServletContext(),response);		
