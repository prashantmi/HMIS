...
import opd.reports.controller.data.OpdPatientsReferralDtlDATA;
import opd.reports.controller.fb.OpdPatientsReferralDtlFB;

import registration.RegistrationConfig;

public class OpdPatientsReferralDtlUTIL extends ReportUTIL
{
	public static void getEssenttial(OpdPatientsReferralDtlFB fb,HttpServletRequest request)
	{
		Status objStatus= new Status();
	try{	
		setSysdate(request);
		Date dt=OpdPatientsReferralDtlDATA.getSysDateAsDate(); 
