/*Copyright Information			: C-DAC, Noida  
	 ...
	 ## Module Name					: MRD
	 ## Process/Database Object Name:Estimate Certificate Request Process
	 ## Purpose						:Estimate Certificate Request Process
...
public class EstimateRequestDAO extends DataAccessObject {
	...
	public List<EstimateCertificateReqVO> getEstimateReqTariffDtl(String deptUnitCode,  UserVO strUserVO)
	{
		...
		String queryKey = "GET.ESTIMATE_TARIFF_DTL_HPMRT_TARIFF_MST";//GET.ESTIMATE_TARIFF_DTL_HBLT_TARIFF_MST";
	...
	public List<EstimateCertificateReqVO> getTariffsList(String deptUnitCode,  UserVO strUserVO)
	{
		EstimateCertificateReqVO estimateCertificateReqDtlVO=null;
		List<EstimateCertificateReqVO> estimateCertificateReqVOlist=new ArrayList<EstimateCertificateReqVO>();
		String query = "";
		...
		Sequence sq = new Sequence();
		String filename = MrdConfig.QUERY_FILE_FOR_MRD_ESSENTIALDAO;
		String queryKey = "GET.TARIFF_LIST_HPMRT_TARIFF_MST";//GET.ESTIMATE_TARIFF_DTL_HBLT_TARIFF_MST";
	...
	public List<EstimateCertificateReqVO> getEstimateReqTariffDtlMst(UserVO strUserVO)
	{
		...
		Sequence sq = new Sequence();
		String filename = MrdConfig.QUERY_FILE_FOR_MRD_ESSENTIALDAO;
		String queryKey = "GET.ESTIMATE_TARIFF_DTL_HPMRT_TARIFF_MST_DTL";//GET.ESTIMATE_TARIFF_DTL_HBLT_TARIFF_MST_DTL";
	...
	public void create(String pmode,String certificateId,String id,EstimateCertificateReqVO estReqVO, UserVO userVO)
	{
		...
		try
		{
					...
					strProc.addInParameter(6, Types.VARCHAR, id);
	...
	//added by manisha gangwar date: 25.5.2016 to save tariffs for estimate certificate request  in new table HPMRT_PAT_ESTIMATE_TARIFF_DTL
	public void addTariffsForEstimateRequest(String pmode,String certificateId,String tariffId,EstimateCertificateReqVO estReqVO, UserVO userVO)
	{
		String errorMsg = null;
		try
		{
					...
					Procedure strProc = new Procedure(MrdConfig.PROCEDURE_ESTIMATE_TARIFF_DTL);
					strProc.addInParameter(1, Types.VARCHAR, pmode);
					strProc.addInParameter(2, Types.VARCHAR, certificateId);
					strProc.addInParameter(3, Types.VARCHAR, userVO.getIpAddress());
				//	strProc.addInParameter(4, Types.VARCHAR, tariffId.substring(0, 3) );
					strProc.addInParameter(4, Types.VARCHAR, tariffId);
					strProc.addInParameter(5, Types.VARCHAR,Config.IS_VALID_ACTIVE );
					strProc.addInParameter(6, Types.VARCHAR, userVO.getSeatId());
					strProc.addInParameter(7, Types.VARCHAR, userVO.getHospitalCode());
