...
public class UserDeskMenuTemplateMappingDATA extends ControllerDATA
{
	// All Desk Type List
	public static Map getAllDeskType(UserVO _UserVO)
	{
		OpdEssentialDelegate essentialDelegate=new OpdEssentialDelegate();
		return essentialDelegate.getAllDeskTypeEssentials(_UserVO);
	}
