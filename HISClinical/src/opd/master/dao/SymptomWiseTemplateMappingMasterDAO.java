...
public class SymptomWiseTemplateMappingMasterDAO extends DataAccessObject
{
	Logger log;
	
	public SymptomWiseTemplateMappingMasterDAO(TransactionContext _tx)
	{
		super(_tx);
...
*/
	...
	public List getTemplateListForSymptom(UserVO _userVO) 
	{
		ResultSet rs = null;
		String query = "";
		Map populateMAP = new HashMap();
		...
		String filename = OpdConfig.QUERY_FILE_FOR_OPD_MASTERSDAO;
		String queryKey = "SELECT_Template_List";
	...
	public void addSymptomWiseTemplateList(SymptomWiseTemplateMappingMasterVO symptomWiseTemplateMappingMasterVO,UserVO _UserVO)
	{
		String query  = "";
		Map populateMAP =new HashMap();
        Sequence sq=new Sequence();
        String filename=OpdConfig.QUERY_FILE_FOR_OPD_MASTERSDAO;
        String queryKey="INSERT_HGBT_SYMPTOM_TEMPLATE_MST";
        ...
        try
        {	        	
        	populateMAP.put(sq.next(),symptomWiseTemplateMappingMasterVO.getSymptomCode());
        	populateMAP.put(sq.next(),symptomWiseTemplateMappingMasterVO.getSymptomterm());
        	populateMAP.put(sq.next(),symptomWiseTemplateMappingMasterVO.getTemplateCode());
        	populateMAP.put(sq.next(),Config.IS_VALID_ACTIVE);
         	populateMAP.put(sq.next(),_UserVO.getSeatId());
        	populateMAP.put(sq.next(),Config.SUPER_USER_HOSPITAL_CODE);
        	populateMAP.put(sq.next(),Config.IS_VALID_ACTIVE);
//        	populateMAP.put(sq.next(),Config.SUPER_USER_HOSPITAL_CODE);
//        	populateMAP.put(sq.next(),symptomWiseTemplateMappingMasterVO.getAllergyTypeCode());
//        	populateMAP.put(sq.next(),symptomWiseTemplateMappingMasterVO.getSymptomCode());
        }
        catch(Exception e)
        {
	...
	public List getSelectedList(SymptomWiseTemplateMappingMasterVO symptomWiseTemplateMappingMasterVO,UserVO _UserVO)
	{
		ResultSet rs = null;
		String query = "";
		Map populateMAP = new HashMap();
		...
		String filename = OpdConfig.QUERY_FILE_FOR_OPD_MASTERSDAO;
		String queryKey = "SELECT_SELECTED_TEMPLATE_LIST";
		...
		{
			throw new HisApplicationExecutionException("SymptomWiseTemplateMappingMasterDAO.populateMAP::" + e);
		}
	...
	public List getRemainingList(SymptomWiseTemplateMappingMasterVO symptomWiseTemplateMappingMasterVO,UserVO _UserVO)
	{
		ResultSet rs = null;
		String query = "";
		Map populateMAP = new HashMap();
		...
		String filename = OpdConfig.QUERY_FILE_FOR_OPD_MASTERSDAO;
		String queryKey = "SELECT_REMAINING_TEMPLATE_LIST";
	...
	public String getsymptomType(SymptomWiseTemplateMappingMasterVO symptomWiseTemplateMappingMasterVO,UserVO _UserVO) 
	{
		ResultSet rs = null;
		String query = "";
		Map populateMAP = new HashMap();
		String filename = OpdConfig.QUERY_FILE_FOR_OPD_MASTERSDAO;
		String queryKey = "SELECT.SYMPTOMTYPE.HGBT_SYMPTOM_TEMPLATE_MST";
	...
	public void updateSymptomwiseMasterDetail(SymptomWiseTemplateMappingMasterVO symptomWiseTemplateMappingMasterVO,UserVO _UserVO) 
	{
		String query = "";
		Map populateMAP = new HashMap();
		Sequence sq = new Sequence();
		String filename = OpdConfig.QUERY_FILE_FOR_OPD_MASTERSDAO;
		String queryKey = "UPDATE.HGBT_SYMPTOM_TEMPLATE_MST";
		try
		{
			query = HelperMethodsDAO.getQuery(filename, queryKey);
		}
