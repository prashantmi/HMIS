 ...
 *
 */
public class DepartmentUnitIcdMappingDAO extends DataAccessObject
{
	public DepartmentUnitIcdMappingDAO(TransactionContext _tx) {
		super(_tx);	
	}
	
	public void create(DepartmentIcdMasterVO _departmentIcdMasterVO,UserVO _userVO) {
		...
		try {
			populateMAP.put(sq.next(), _departmentIcdMasterVO.getDepartmentUnitCode());
			populateMAP.put(sq.next(), _departmentIcdMasterVO.getDepartmentUnitCode());
			populateMAP.put(sq.next(), _departmentIcdMasterVO.getDiseaseCode());
			populateMAP.put(sq.next(), _departmentIcdMasterVO.getDepartmentUnitCode());
			populateMAP.put(sq.next(), _departmentIcdMasterVO.getDiseaseCode());
	...
	public DepartmentIcdMasterVO[] getDeptUnitIcdForModify(String _deptUnitCode, UserVO _userVO)
	{
		...
		Map populateMAP = new HashMap();
		String filename = OpdConfig.QUERY_FILE_FOR_OPD_MASTERSDAO;
		String queryKey = "SELECT.HGBT_DEPT_ICD_MST";
		...
		try
		{
			...
			else
			{
				...
				departmentIcdMasterVO=new DepartmentIcdMasterVO[vo.length];
				for(int i=0;i<vo.length;i++)
				{
					departmentIcdMasterVO[i]=(DepartmentIcdMasterVO)vo[i];
				}
			}
		}
		catch (Exception e)
		...
		return departmentIcdMasterVO;
	}
	public List getNotMappedDisease(String _deptCode,String _subGroupCode,UserVO _userVO)
	{
		ResultSet rs = null;
		String query = "";
		Map populateMAP = new HashMap();
		String filename = OpdConfig.QUERY_FILE_FOR_OPD_MASTERSDAO;
		String queryKey = "SELECT.DISEASE_NOT_ADDED.HGBT_DEPT_ICD_MST";
	...
	public void update(String _unitCode,UserVO _userVO)
	{
		...
		Sequence sq = new Sequence();
		String filename = OpdConfig.QUERY_FILE_FOR_OPD_MASTERSDAO;
		String queryKey = "UPDATE.HGBT_DEPT_ICD_MST";
