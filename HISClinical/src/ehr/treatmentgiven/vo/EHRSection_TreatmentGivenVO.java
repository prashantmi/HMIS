...
public class EHRSection_TreatmentGivenVO extends ValueObject
{
	...
	private String patCrNo;
			...
			private String selStock; //Added by Vasu on 15.Jan.18
			
			/*Added by vasu on 24.Jan.2018*/
			...
			public EHRSection_TreatmentGivenVO()
			{
				this.patCrNo="";
				this.episodeCode="";
				this.serialNo="";
