...
package ehr.investigation.business;
...
public class EHRSection_InvestigationAdviceBO {

	


  /*Added by VASU on 3-Oct-2017 for Investigation Composition*/
	public EHRSection_InvestigationAdviceVO[]  getPatientInvestigationDetail(EHR_AccessPermissionVO _voEHRAccess, EHR_PatientEncounterVO _voEHREncounter, EHRSection_InvestigationAdviceVO _voEHRInvestigation)
	{
		JDBCTransactionContext tx = new JDBCTransactionContext();
		//List<EHRSection_InvestigationAdviceVO> lstPatInvestigation= new ArrayList<EHRSection_InvestigationAdviceVO>();
		EHRSection_InvestigationAdviceVO[] EHRSection_InvestigationAdviceVOs = null;
		try
		{
			EHRSection_InvestigationAdviceDAO daoPatProfile = new EHRSection_InvestigationAdviceDAO(tx);
			tx.begin();

			//lstPatInvestigation = EHRSection_InvestigationAdviceDAO.getPatientInvestigationDetail("0",_voEHRAccess, _voEHREncounter, _voEHRInvestigation);
			...
			{
				EHRSection_InvestigationAdviceVOs = daoPatProfile.getPatientInvestigationDetail("0",_voEHRAccess, _voEHREncounter, _voEHRInvestigation);
			...
			//{
			//	EHRSection_InvestigationAdviceVOs = daoPatProfile.retrieveTestIPDInvestigationForProfile("0",_voEHRAccess, _voEHREncounter, _voEHRInvestigation);
				//EHRSection_InvestigationAdviceVOs = daoPatProfile.retrieveTestOPDInvestigationForProfile(_crNo, _episodeCode, _userVO,age,_reqDno);
			//}
		}
	...
	public EHRSection_InvestigationAdviceVO getPatientRegistration_EpisodeDetailEssentials(EHRSection_InvestigationAdviceVO patVO, UserVO _UserVO) {

		EHRSection_InvestigationAdviceVO voPatient=new EHRSection_InvestigationAdviceVO();
		JDBCTransactionContext tx = new JDBCTransactionContext();
	...
	public  List<Inv_PatientAdmissionDtlVO> getPatientAdmissionDetail(EHRSection_InvestigationAdviceVO patVO,UserVO _userVO)
	{
		JDBCTransactionContext tx = new JDBCTransactionContext();
	...
	public  List<Inv_EpisodeVO> getPatientEpisodeDetail(EHRSection_InvestigationAdviceVO patVO,UserVO _userVO)
	{
		JDBCTransactionContext tx = new JDBCTransactionContext();
	...
	public Map searchLabWiseTestDtls(InvestigationSearchVO searchVO, UserVO _UserVO) {
		...
		try {
			...
			lstUOMCombo=invEssentialDAO.getUOMCombo(_UserVO);										//unit of measurement combo
			lstContainerCombo=invEssentialDAO.getContainerCombo(_UserVO);							//container combo
				...
				else
{
	...
	public  List saveRequisitionDetails(Map<String,Map<String,LabTestVO>> mp,EHRSection_InvestigationAdviceVO patVO,UserVO _userVO)
	{
		JDBCTransactionContext tx = new JDBCTransactionContext();
...
/*	  if(patVO.getPatStatusCode().equals("2"))
			...
			if(InvestigationConfig.BILLING_REQUIRED.equals(InvestigationConfig.BILLING_REQUIRED_YES))
			{
						...
						{
							invEssentialDAO.makeBillingTestWise(voBillingDtl, patVO, simpletariffdetails, simpletariffQty,"1", _userVO);//procedure
						}
						
						if(grouptariffdetails.equals("")==false)
						{
							invEssentialDAO.makeBillingTestWise(voBillingDtl, patVO, grouptariffdetails, grouptariffQty,"4", _userVO);//procedure
						}
			}	
	...
	public Map searchLaboratoryWiseTestGroupOnClickCumColl(InvestigationSearchVO searchVO, UserVO _UserVO) {
		...
		try {
			...
			lstUOMCombo=invEssentialDAO.getUOMCombo(_UserVO);										//unit of measurement combo
			lstContainerCombo=invEssentialDAO.getContainerCombo(_UserVO);			
			//String sampleComboStr="<option value='-1'>Select Value</option>";
...
if(lstLabTest!=null)
{
	...
	public Map getTestsBasedOnGroups(InvestigationSearchVO searchVO, UserVO _UserVO) {
...
//								}
		...
		*/
		...
		/*
			...
			//				.getMandatoryInfoDtlList(resultEntryVO);
					...
					rangeFromToList = new EHRSection_InvestigationAdviceDAO(tx)
							.getRangeFromToList(
	...
	*/
	...
	public  List saveRequisitionCollectionDetails(Map<String,Map<String,List<LabTestVO>>> mp_lab,EHRSection_InvestigationAdviceVO patVO,UserVO _userVO)
	{
		JDBCTransactionContext tx = new JDBCTransactionContext();
		List listReqId=new ArrayList();
		String labName="";
	...
	public  List insertRaisingCumSelectionInReqDtl(Map<String,Map<String,List<LabTestVO>>> mp_lab,EHRSection_InvestigationAdviceVO patVO,UserVO _userVO)
	{
		JDBCTransactionContext tx = new JDBCTransactionContext();
		List listReqId=new ArrayList();
		String labName="";
	...
	//Added by Vasu on 03.May.2019
		public List<EHRSection_InvestigationAdviceVO> getPatientInvestigationDetails(UserVO userVO, PatientDetailVO selectedPatientVO)
		{
			JDBCTransactionContext tx = new JDBCTransactionContext();
			List<EHRSection_InvestigationAdviceVO> lstInvestigations=new ArrayList<EHRSection_InvestigationAdviceVO>();
