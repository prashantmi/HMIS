...
public class EHRSection_InvestigationAdviceFB extends EHRSection_GlobalFB
{
    ...
    private String ftlValueForInvestigation;
	...
	public String getFtlValueForInvestigation() {
		return ftlValueForInvestigation;
	}


	public void setFtlValueForInvestigation(String ftlValueForInvestigation) {
		this.ftlValueForInvestigation = ftlValueForInvestigation;
	}
