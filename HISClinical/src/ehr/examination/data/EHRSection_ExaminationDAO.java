...
public class EHRSection_ExaminationDAO extends DataAccessObject 
{

	
		public EHRSection_ExaminationDAO(JDBCTransactionContext _tx)
		{
			super(_tx);
		}
		...
		public Map<String, Map<String,String>> getPatientClinicalData(EHRSection_ExaminationVO _patClinicalVO, UserVO _userVO)
		{
			ResultSet rs = null;
			String query = "";
		...
		public Map<String, Map<String,String>> getPatientCentricClinicalData(EHRSection_ExaminationVO _patClinicalVO, UserVO _userVO)
		{
			ResultSet rs = null;
			String query = "";
			Map populateMAP = new HashMap();
		...
		public GenericTemplateUtility.TempParameter[] getPatientEpisodeClinicalDataTempWise(EHRSection_ExaminationVO _patClinicalVO, 
		...
		public GenericTemplateUtility.TempParameter[] getPatientClinicalRecordDataTempWise(EHRSection_ExaminationVO _patClinicalVO, 
				List<Entry> _lstTemps, UserVO _userVO)
		{
			ResultSet rs = null;
			String query = "";
