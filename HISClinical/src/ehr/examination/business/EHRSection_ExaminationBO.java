...
package ehr.examination.business;
...
public class EHRSection_ExaminationBO {
	...
	public List<Entry> getDeskMenuTemplateList(String _deskType, UserDeskMenuTemplateMasterVO _userDeskTempVO, UserVO _userVO)
	{
		...
		try
		{
			...
			EHRSection_ExaminationDAO dao =new EHRSection_ExaminationDAO(tx);
	...
	public Map<String, Map<String, String>> getPatientFinalClinicalData(String _deskType, EHRSection_ExaminationVO _patClinicalVO, UserVO _userVO)
	{
	...
	public List<Entry> getReportDateList(String _deskType, EHRSection_ExaminationVO _patCliDtlVO, UserVO _userVO)
	{
	...
	public Map<String, Map<String, Map<String, GenericTemplateUtility.TempParameter>>> getPatientChartClinicalDataTempWiseWithParaDtl(
			String _deskType, EHRSection_ExaminationVO _patClinicalVO, List<Entry> _lstReportDates, List<Entry> _lstTemps, UserVO _userVO)
	{
		...
		try
		{
			...
			if (_deskType.equals(DynamicDeskConfig.DESK_TYPE_OPD_DOCTOR_DESK) || _deskType.equals(DynamicDeskConfig.DESK_TYPE_CASUALITY_DESK))
			{
				...
				{
					EHRSection_ExaminationVO patCliVO = new EHRSection_ExaminationVO();
