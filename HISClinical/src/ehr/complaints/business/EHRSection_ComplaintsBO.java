...
package ehr.complaints.business;

import java.util.HashMap;
import java.util.List;
import java.util.Map;

import ehr.complaints.data.EHRSection_ComplaintsDAO;
...
public class EHRSection_ComplaintsBO {
	...
	public List<Entry> getDeskMenuTemplateList(String _deskType, UserDeskMenuTemplateMasterVO _userDeskTempVO, UserVO _userVO)
	{
		...
		try
		{
			...
			EHRSection_ComplaintsDAO dao =new EHRSection_ComplaintsDAO(tx);
	...
	public Map<String, Map<String, String>> getPatientFinalClinicalData(String _deskType, EHRSection_ComplaintsVO _patClinicalVO, UserVO _userVO)
	{
	...
	public List<Entry> getReportDateList(String _deskType, EHRSection_ComplaintsVO _patCliDtlVO, UserVO _userVO)
	{
	...
	public Map<String, Map<String, Map<String, GenericTemplateUtility.TempParameter>>> getPatientChartClinicalDataTempWiseWithParaDtl(
			String _deskType, EHRSection_ComplaintsVO _patClinicalVO, List<Entry> _lstReportDates, List<Entry> _lstTemps, UserVO _userVO)
	{
		...
		try
		{
			...
			if (_deskType.equals(DynamicDeskConfig.DESK_TYPE_OPD_DOCTOR_DESK) || _deskType.equals(DynamicDeskConfig.DESK_TYPE_CASUALITY_DESK))
			{
				...
				{
					EHRSection_ComplaintsVO patCliVO = new EHRSection_ComplaintsVO();
