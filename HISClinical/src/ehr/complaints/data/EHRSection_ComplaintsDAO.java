...
public class EHRSection_ComplaintsDAO extends DataAccessObject 
{

	
		public EHRSection_ComplaintsDAO(JDBCTransactionContext _tx)
		{
			super(_tx);
		}
		...
		public Map<String, Map<String,String>> getPatientClinicalData(EHRSection_ComplaintsVO _patClinicalVO, UserVO _userVO)
		{
			ResultSet rs = null;
			String query = "";
		...
		public Map<String, Map<String,String>> getPatientCentricClinicalData(EHRSection_ComplaintsVO _patClinicalVO, UserVO _userVO)
		{
			ResultSet rs = null;
			String query = "";
			Map populateMAP = new HashMap();
		...
		public GenericTemplateUtility.TempParameter[] getPatientEpisodeClinicalDataTempWise(EHRSection_ComplaintsVO _patClinicalVO, 
		...
		public GenericTemplateUtility.TempParameter[] getPatientClinicalRecordDataTempWise(EHRSection_ComplaintsVO _patClinicalVO, 
				List<Entry> _lstTemps, UserVO _userVO)
		{
			ResultSet rs = null;
			String query = "";
