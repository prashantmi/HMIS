...
import ehr.global.presentation.EHRSection_GlobalFB;
	...
	public class EHRSection_ComplaintsFB extends EHRSection_GlobalFB
	{
		...
		private String ftlValueForComplaints;
		...
		public EHRSection_ComplaintsFB()
		{
			this.userSeatId="";
			this.wardCode="";
			this.deptUnitCode="";
		...
		public String getFtlValueForComplaints() {
			return ftlValueForComplaints;
		}

		public void setFtlValueForComplaints(String ftlValueForComplaints) {
			this.ftlValueForComplaints = ftlValueForComplaints;
		}
	}
