...
public class InvestigationEssentialDAOxray
  extends DataAccessObject
  implements InvestigationEssentialDAOi
{
  public InvestigationEssentialDAOxray(JDBCTransactionContext _tx) { super(_tx); }
  ...
  public Inv_RequisitionRaisingPatientVO getInvRaisingPatDetails(Inv_RequisitionRaisingPatientVO patVO, UserVO _UserVO) {
    ...
    ResultSet rs = null;
    String filename = "new_investigation.transactions.investigationTransactionQueryxray";
  ...
  public String insertRequisitionHeaderDtl(RequistionHeaderVO voReqHeader, UserVO _userVO) {
    ...
    try {
      ...
      strProc.addInParameter(16, 12, voReqHeader.getAdvisedByDocName());
      ...
      strProc.addInParameter(37, 12, voReqHeader.getAdvisedByDocNo());
      ...
      strProc.addInParameter(48, 12, voReqHeader.getChiefname()==null?"":voReqHeader.getChiefname());
  ...
  public void insertRequisitionDtl(InvestigationRequistionVO voLabTest, UserVO _userVO, String priorityAll, RequistionHeaderVO voReqHeader) {
    ...
    try {
      ...
      Procedure strProc = new Procedure("pkg_inv_dml.proc_insert_hivt_requisition_dtl_new_xray");
      strProc.addInParameter(1, 12, "3");
      ...
      strProc.addInParameter(8, 12, priorityAll);
      ...
      strProc.addInParameter(59, 12, voReqHeader.getAdvisedByDocName());
      ...
      strProc.addInParameter(81, 12, voReqHeader.getAdvisedByDocNo());
      ...
      strProc.addInParameter(90, 12, voReqHeader.getChiefname()==null?"":voReqHeader.getChiefname());
      ...
      strProc.addInParameter(96, 12, voLabTest.getVisitReason());
      strProc.addInParameter(97, 12, voLabTest.getTestwiseinst());
      
      strProc.addInParameter(98, 12, voLabTest.getIs_newborn());
      strProc.addInParameter(99, 12, voLabTest.getIs_pregnant());
      strProc.addInParameter(100, 12, voLabTest.getChiefname());
      strProc.addInParameter(101, 12, voLabTest.getDiagname());

      strProc.addInOutParameter(102, 12, "");
