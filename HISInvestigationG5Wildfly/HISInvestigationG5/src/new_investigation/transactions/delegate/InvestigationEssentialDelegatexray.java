...
import new_investigation.transactions.bo.InvestigationEssentialBOixray;
...
public class InvestigationEssentialDelegatexray extends Delegate
{
	public InvestigationEssentialDelegatexray()
	{
		super(new InvestigationEssentialBOxray());
	}
	...
	{
		InvestigationEssentialBOixray serviceBO = (InvestigationEssentialBOixray)super.getServiceProvider();
