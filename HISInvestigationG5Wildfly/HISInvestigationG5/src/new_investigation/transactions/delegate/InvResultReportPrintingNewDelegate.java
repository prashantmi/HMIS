...
public class InvResultReportPrintingNewDelegate extends Delegate
{
	public InvResultReportPrintingNewDelegate()
	{
	...
	public String setResultReportPrintingEssentialsOnLoad(InvResultReportPrintingVO invresultreportprintingvo, UserVO _UserVO,HttpServletRequest request)
	{
		InvestigationEssentialBOi serviceBO = (InvestigationEssentialBOi) super.getServiceProvider();
		return serviceBO.setResultReportPrintingEssentialsOnLoadNew(invresultreportprintingvo, _UserVO, request);
	}
	...
	{
		InvestigationEssentialBOi serviceBO = (InvestigationEssentialBOi) super.getServiceProvider();
		return serviceBO.getdatacrnowise(invresultreportprintingvo, _UserVO, request);
	}
