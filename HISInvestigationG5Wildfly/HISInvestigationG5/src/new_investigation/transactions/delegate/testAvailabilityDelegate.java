...
public class testAvailabilityDelegate extends Delegate
{
	public testAvailabilityDelegate()
	{
	...
	public Map  LabComboForMachineResultEntry(testAvailabilityVO invResultEntryvo, UserVO _UserVO)
	{
		InvestigationEssentialBOi serviceBO = (InvestigationEssentialBOi) super.getServiceProvider();
		return serviceBO.LabComboForTestAvailability(invResultEntryvo, _UserVO);
	}
	
	 

	
	public Map getPatientMachineResultEntry(testAvailabilityVO invResultEntryvo, UserVO _UserVO)
	{
		InvestigationEssentialBOi serviceBO = (InvestigationEssentialBOi) super.getServiceProvider();
		return serviceBO.getTestDetails(invResultEntryvo, _UserVO);
	}
	
	
	//Save Logic
	 
	public Map  saveMachineResultEntry(List<testAvailabilityVO> mp_resultEntry, UserVO _userVO,HttpServletRequest _request)
	{
		InvestigationEssentialBOi serviceBO = (InvestigationEssentialBOi) super.getServiceProvider();
		 return serviceBO.updateTestDetails(mp_resultEntry, _userVO, _request);
	}
