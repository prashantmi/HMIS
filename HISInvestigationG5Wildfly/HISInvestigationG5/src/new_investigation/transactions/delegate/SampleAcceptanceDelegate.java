...
public class SampleAcceptanceDelegate extends Delegate
{
	public SampleAcceptanceDelegate()
	{
	...
	{
		InvestigationEssentialBOi serviceBO = (InvestigationEssentialBOi) super.getServiceProvider();
		return serviceBO.getSampleAcceptanceDetail(sampleAcceptanceVO, _UserVO);
	}
	...
	{
		InvestigationEssentialBOi serviceBO = (InvestigationEssentialBOi) super.getServiceProvider();
		 return serviceBO.rejectSampleAccDetails(voSampleAcc,  _userVO, _request);
	}
	...
	{
		InvestigationEssentialBOi serviceBO = (InvestigationEssentialBOi) super.getServiceProvider();
		 return serviceBO.getLabTestMachine(labCode,  _userVO);
	}
	 
	public String checkAutoGenFormate(SampleAcceptanceVO voSample,UserVO userVO)
	{
		InvestigationEssentialBOi serviceBO = (InvestigationEssentialBOi)super.getServiceProvider();
		return(serviceBO.checkAutoGenFormateSampleAcceptance(voSample, userVO));
	}
	
	public Map fetchMachime( UserVO _UserVO)
	{
		InvestigationEssentialBOi serviceBO = (InvestigationEssentialBOi) super.getServiceProvider();
		return serviceBO.fetchMachime( _UserVO);
	}
	...
	public Map modifySampleAccDetails(List<SampleAcceptanceVO> voSampleAcceptance, UserVO _userVO, HttpServletRequest _request) {
		InvestigationEssentialBOi serviceBO = (InvestigationEssentialBOi) super.getServiceProvider();
		 return serviceBO.modifySampleAccDetails(voSampleAcceptance,  _userVO, _request);
	}
