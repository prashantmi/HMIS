...
public class externalInvestigationCaptureFB extends ActionForm
{
	...
	public String[] getExternalLabCode() {
		return externalLabCode;
	}


	public void setExternalLabCode(String[] externalLabCode) {
		this.externalLabCode = externalLabCode;
	}
