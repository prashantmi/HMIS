...
public class InvestigationRaisingDtlFB
  extends ActionForm
{
  ...
  private String prev_req_fromwhichcall;
  ...
  public String getPrev_req_fromwhichcall() { return this.prev_req_fromwhichcall; }



  
  public void setPrev_req_fromwhichcall(String prev_req_fromwhichcall) { this.prev_req_fromwhichcall = prev_req_fromwhichcall; }
...
public void setTmpGroupCode(String tmpGroupCode) {
	this.tmpGroupCode = tmpGroupCode;
}
