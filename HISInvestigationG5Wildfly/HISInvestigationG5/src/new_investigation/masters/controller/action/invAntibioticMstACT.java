...
public class invAntibioticMstACT extends GenericController {


		String target = null;
	    String message="";
	    
		public invAntibioticMstACT()
		{

			super(new invAntibioticMstUTL(),"/masters/antibioticprocess");

		}
	 
		public ActionForward ADD(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
		{
			invAntibioticMstFB fb = (invAntibioticMstFB) form;
			WebUTIL.refreshTransState(request);
			ControllerUTIL.setSysdate(request);
			
			//invAntibioticMstUTL.fetchOrgaicName(fb, request);
		...
		public ActionForward SAVE(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
		{
		    ...
		    boolean hasFlag=  invAntibioticMstUTL.saveAntibiotic(fb, request);
		     if(hasFlag){
			...
			public ActionForward MODIFY(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
		{
				invAntibioticMstFB fb = (invAntibioticMstFB) form;
			WebUTIL.refreshTransState(request);
			invAntibioticMstUTL.fetchAntibiotic(fb, request);
			return mapping.findForward("ADD"); 
		}
		...
		{
			invAntibioticMstFB fb = (invAntibioticMstFB) form;
			boolean hasFlag= invAntibioticMstUTL.savemodifyAntibiotic(fb, request);
			if(hasFlag){
...
*/
		...
		{
				invAntibioticMstFB fb = (invAntibioticMstFB) form;
				invAntibioticMstUTL.reFetchAntibiotic(fb, request);
			fb.setHmode("MODIFY");
			return mapping.findForward("ADD"); 
