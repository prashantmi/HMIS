...
public class LabWiseStatisticalReportDAO extends DataAccessObject 
{

	public LabWiseStatisticalReportDAO(TransactionContext _tx)
	{
		super(_tx);
	...
	public List getTest(LabWiseStatisticalReportVO reqVO, UserVO _UserVO)
	{
		String query="";
		Map populateMap= new HashMap();
		ResultSet rs=null;
