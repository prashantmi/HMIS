...
public class MachineTestReportDAO extends DataAccessObject 
{

	public MachineTestReportDAO(TransactionContext _tx)
	{
		super(_tx);
	...
	public List getLabBasedMachine(MachineTestReportVO reqVO, UserVO _UserVO)
	{
		String query="";
		Map populateMap= new HashMap();
		ResultSet rs=null;
		List lstMandName=new ArrayList();
		String filename= InvestigationConfig.QUERY_FILE_FOR_INVESTIGATION_REPORTSDAO;
 		String queryKey="SELECT.LABTEST_MACHINE.HIVT_LABTEST_MST.MACHINE";
