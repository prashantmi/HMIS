...
public class PatientAcceptanceReportDAO extends DataAccessObject 
{

	public PatientAcceptanceReportDAO(TransactionContext _tx)
	{
		super(_tx);
	...
	public List getTest(PatientAcceptanceReportVO reqVO, UserVO _UserVO)
	{
		String query="";
		Map populateMap= new HashMap();
		ResultSet rs=null;
