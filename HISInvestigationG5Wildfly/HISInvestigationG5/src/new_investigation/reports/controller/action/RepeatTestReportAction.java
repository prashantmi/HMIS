...
import new_investigation.reports.controller.utl.RepeatTestReportUTIL;
...
public class RepeatTestReportAction  extends DispatchAction
{
	...
	{
		RepeatTestReportFB formBean = (RepeatTestReportFB) form;
		RepeatTestReportUTIL.fetchLab(formBean, request);
	...
	{
		RepeatTestReportFB formBean = (RepeatTestReportFB) form;
		RepeatTestReportUTIL.fetchTest(formBean, request);
	...
	public void SHOWRPT(ActionMapping mapping, ActionForm form,
		...
		RepeatTestReportDATA.showReport(formBean, request, response);
