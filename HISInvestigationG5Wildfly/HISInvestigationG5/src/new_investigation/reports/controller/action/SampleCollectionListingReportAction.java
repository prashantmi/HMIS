...
import new_investigation.reports.controller.utl.SampleCollectionListingReportUTIL;
...
public class SampleCollectionListingReportAction  extends DispatchAction
{
	...
	{
		SampleCollectionListingReportFB formBean = (SampleCollectionListingReportFB) form;
		SampleCollectionListingReportUTIL.fetchLab(formBean, request);
	...
	{
		SampleCollectionListingReportFB formBean = (SampleCollectionListingReportFB) form;
		SampleCollectionListingReportUTIL.fetchTest(formBean, request);
	...
	public void SHOWRPT(ActionMapping mapping, ActionForm form,
		...
		SampleCollectionListingReportDATA.showReport(formBean, request, response);
