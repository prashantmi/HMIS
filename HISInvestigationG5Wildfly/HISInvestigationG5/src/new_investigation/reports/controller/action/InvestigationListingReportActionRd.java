...
import new_investigation.reports.controller.utl.InvestigationListingReportUTIL;
...
/*Added By Prashant */
public class InvestigationListingReportActionRd  extends DispatchAction
{
	...
	{
		InvestigationListingReportFB formBean = (InvestigationListingReportFB) form;
		InvestigationListingReportUTIL.fetchDept(formBean, request);
	...
	/*public ActionForward CLEAR(ActionMapping mapping,ActionForm form,HttpServletRequest request,HttpServletResponse response)
	{
		InvestigationListingReportFB formBean = (InvestigationListingReportFB) form;
		InvestigationListingReportUTIL.fetchDept(formBean, request);
		//InvestigationListingReportUTIL.fetchLab(formBean, request);
	...
	{
		InvestigationListingReportFB formBean = (InvestigationListingReportFB) form;
		InvestigationListingReportUTIL.fetchRdTest(formBean, request);
		formBean.setHmode("NEW");
		return mapping.findForward("NEW");
	}
	...
	{
		InvestigationListingReportFB formBean = (InvestigationListingReportFB) form;
		InvestigationListingReportUTIL.fetchRdLab(formBean, request);
		formBean.setHmode("NEW");
		return mapping.findForward("NEW");
	}	
	...
	{
		InvestigationListingReportFB formBean = (InvestigationListingReportFB) form;
		InvestigationListingReportUTIL.fetchSample(formBean, request);
		formBean.setHmode("NEW");
		return mapping.findForward("NEW");
	}	
	...
	public void SHOWRPT(ActionMapping mapping, ActionForm form,
		...
		InvestigationListingReportDATA.showReport(formBean, request, response);
