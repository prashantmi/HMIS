...
import new_investigation.reports.bo.LabWiseStatisticalReportBO;
...
public class LabWiseStatisticalReportDelegate extends Delegate
{
	public LabWiseStatisticalReportDelegate()
	{
		super(new LabWiseStatisticalReportBO());
	}  

	public Map fetchLab(LabWiseStatisticalReportVO reqList_VO, UserVO _UserVO)
	{
		LabWiseStatisticalReportBO serviceBO = (LabWiseStatisticalReportBO) super.getServiceProvider();
		return serviceBO.fetchLab(reqList_VO, _UserVO);
	}
	
	public Map fetchTest(LabWiseStatisticalReportVO reqList_VO, UserVO _UserVO)
	{
		LabWiseStatisticalReportBO serviceBO = (LabWiseStatisticalReportBO) super.getServiceProvider();
