...
import new_investigation.reports.bo.SampleCollectionListingReportBO;
...
public class SampleCollectionListingReportDelegate extends Delegate
{
	public SampleCollectionListingReportDelegate()
	{
		super(new SampleCollectionListingReportBO());
	}  

	public Map fetchLab(SampleCollectionListingReportVO reqList_VO, UserVO _UserVO)
	{
		SampleCollectionListingReportBO serviceBO = (SampleCollectionListingReportBO) super.getServiceProvider();
	...
	public Map fetchDept(SampleCollectionListingReportVO reqList_VO, UserVO _UserVO)
	{
		SampleCollectionListingReportBO serviceBO = (SampleCollectionListingReportBO) super.getServiceProvider();
		return serviceBO.fetchTest(reqList_VO, _UserVO);
	}
