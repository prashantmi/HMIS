...
import new_investigation.reports.bo.RepeatTestReportBO;
...
public class RepeatTestReportDelegate extends Delegate
{
	public RepeatTestReportDelegate()
	{
		super(new RepeatTestReportBO());
	}  

	public Map fetchLab(RepeatTestReportVO reqList_VO, UserVO _UserVO)
	{
		RepeatTestReportBO serviceBO = (RepeatTestReportBO) super.getServiceProvider();
		return serviceBO.fetchLab(reqList_VO, _UserVO);
	}
	
	public Map fetchTest(RepeatTestReportVO reqList_VO, UserVO _UserVO)
	{
		RepeatTestReportBO serviceBO = (RepeatTestReportBO) super.getServiceProvider();
		return serviceBO.fetchTest(reqList_VO, _UserVO);
	}
	
	public Map fetchDept(RepeatTestReportVO reqList_VO, UserVO _UserVO)
	{
		RepeatTestReportBO serviceBO = (RepeatTestReportBO) super.getServiceProvider();
		return serviceBO.fetchTest(reqList_VO, _UserVO);
	}
