...
import new_investigation.reports.bo.InvestigationReportBO;
...
public class InvestigationReportDelegate extends Delegate
{
	public InvestigationReportDelegate()
	{
		super(new InvestigationReportBO());
	}  

	public Map fetchLab(RequisitionListingReportVO reqList_VO, UserVO _UserVO)
	{
		InvestigationReportBO serviceBO = (InvestigationReportBO) super.getServiceProvider();
		return serviceBO.fetchLab(reqList_VO, _UserVO);
	}
	
	public Map fetchTest(RequisitionListingReportVO reqList_VO, UserVO _UserVO)
	{
		InvestigationReportBO serviceBO = (InvestigationReportBO) super.getServiceProvider();
