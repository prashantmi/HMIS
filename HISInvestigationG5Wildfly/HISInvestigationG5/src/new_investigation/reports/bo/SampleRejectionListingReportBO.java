...
public class SampleRejectionListingReportBO 
{
	...
	public Map fetchLab(SampleRejectionListingReportVO reqList_VO, UserVO _UserVO)
	{
		...
		{
			tx.begin();
			SampleRejectionListingReportDAO reqlist_DAO = new SampleRejectionListingReportDAO(tx);
	...
	public Map fetchTestOnLoad(SampleRejectionListingReportVO reqList_VO, UserVO _UserVO)
	{
		JDBCTransactionContext tx = new JDBCTransactionContext();
		Map mp=new HashMap();
		List lstTest=new ArrayList();
