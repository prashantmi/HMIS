...
public class Tab
{
	...
	public String generateTabs(LinkedHashMap map, String selectedTab)
	{
		...
		while(it.hasNext())
		{
			...
			str += "<tbody>";
			str += "<tr>";
			str += "<td width=1 height=1><img height=1 src=\"../../images/tp.gif\" width=1 border=0></td>";
			str += "<td width=\"269\" height=1 class=DIVIDER><img height=1 src=\"../../images/tp.gif\" width=1 border=0></td>";
			str += "</tr>";
			str += "<tr>";
			str += "<td class=DIVIDER><img height=1 src=\"../../images/tp.gif\" width=1 border=0></td>";
			...
			if(selectedTab.equals(pagename))
			{
				...
				if(map.size()-i == 1)
				{
					str += "<td class=DIVIDER height=1><img height=1 src=\"../../images/tp.gif\" width=1 border=0></td>";
				}
			}
			else
			{
				...
				str += "<img height=1 src=\"../../images/tp.gif\" width=1 border=0>";
				str += "<a> &nbsp;" + label + "&nbsp; </a><img height=1 src=\"../../images/tp.gif\" width=1 border=0><b></b></td>";
				str += "<td width=\"10\" class=DIVIDER><img height=1 src=\"../../images/tp.gif\" width=1 border=0></td>";
				str += "</tr>";
				str += "<tr>";
				str += "<td class=DIVIDER width=1 height=1><img height=1 src=\"../../images/tp.gif\" width=1 border=0></td>";
				str += "<td class=DIVIDER height=1><img height=1 src=\"../../images/tp.gif\" width=1 border=0></td>";
			}
