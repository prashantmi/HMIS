...
public class RegistrationMadatory extends SimpleTagSupport
{
	...
	public void doTag() throws JspException, IOException
	{
		...
		if (deptList != null && deptList.size() > 0)
		{
			...
			while (iterator.hasNext())
			{
				...
				mandatoryValue = WebUTIL.getDepartmentCodeFromPropertiesFile(Config.PROPERTIES_FILE_FOR_MANDATORY_FIELD, deptCode);
