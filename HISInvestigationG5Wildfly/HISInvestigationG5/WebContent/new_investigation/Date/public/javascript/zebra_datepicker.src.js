...
;(function($) {
    ...
    $.Zebra_DatePicker = function(element, options) {
        ...
        // private properties
        var view, datepicker, icon, header,footer, daypicker, monthpicker, yearpicker, current_system_month, current_system_year,
        ...
        var init = function() {
            ...
            var html = '' +
                '<div class="Zebra_DatePicker">' +
                    ...
                    '<tr>' +
                        '<td class="dp_today">Today</td>' +
                        '<td class="dp_clear">Clear</td>' +
                    '</tr>' +
                '</div>';
            ...
            footer = datepicker.find('table.dp_yearpicker').first();
            ...
            daypicker.delegate('td:not(.dp_disabled, .dp_weekend_disabled, .dp_not_in_month, .dp_week_number)', 'click', function() {
            	...
            	// attach a click event for the cells in the day picker
                footer.delegate('td:not(.dp_disabled, .dp_weekend_disabled, .dp_not_in_month, .dp_week_number)', 'click', function() {
