<!-- 
 ...
 ## Process/Database Object Name	    : Addendum Reason PROCESS
 ## Purpose						        : 
 ## Date of Creation					: 8/09/2016
 ## Modification Log					:				
 ##		Modify Date				        :  
 ##		Reason	(CR/PRS)			    : 
 ##		Modify By				        : 
...
<his:javascript src="/new_investigation/js/invAddendumReasonMst.js" />
...
<body>
<html:form action="/masters/addendumreason">
<his:TransactionContainer>
	<html:hidden name="invAddendumReasonMstFB" property="hmode" />
...
<his:SubTitleTag name="Details"></
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="0">
			    ...
			    <td width="25%" class="tdfont">
			      ...
			      <td width="25%" class="tdfont">
			        <div align="left">
			             <html:text property="reason" name="invAddendumReasonMstFB" onkeypress="return validateAlphaNumericOnly(event,this)"></html:text>
			             <html:hidden property="reasonCode" name="invAddendumReasonMstFB" ></html:hidden>
				     </div>
			      </td>
			      </tr>
				...
				<span id="saveDiv"> <logic:notEqual name="invAddendumReasonMstFB"
						property="hmode" value="MODIFY">
						<logic:notEqual name="invAddendumReasonMstFB" property="hmode" value="VIEW">
							<img class="button"
					...
					</logic:notEqual> <logic:equal name="invAddendumReasonMstFB" property="hmode" value="MODIFY">
						<img class="button"
