...
function getUnit()
{
		...
		var urlNew= "/HISInvestigationG5/new_investigation/masters/UserwiseBookMarkMstACT.cnt?hmode="+_mode+'&dept='+dept;	
		//alert(urlNew);	
...
function getTest()
{
		...
		var urlNew= "/HISInvestigationG5/new_investigation/masters/UserwiseBookMarkMstACT.cnt?hmode="+_mode+'&labCode='+labCode+'&bookMarkCode='+bookmarkCode+'&userId='+userId;;	
		//alert(urlNew);	
		var objXHR = {url: urlNew, sync:true, postData: "", handleAs: "json",
			load: function(data) 
			{
...
<body onload="showHideDiv();">
	<html:form action="/masters/UserwiseBookMarkMstACT">
		...
		<his:ContentTag>
			<table width="100%" border="0" cellspacing="2" cellpadding="1">
				<tr>
					...
					<logic:notEqual name="UserwiseBookMarkMstFB" property="hmode"
						value="MODIFY">
						<td width="50%" class="tdfont">
							<div align="left">
								<html:select name="UserwiseBookMarkMstFB" property="bookmarkCode"
					...
					<logic:equal name="UserwiseBookMarkMstFB" property="hmode"
						value="MODIFY">
						<td width="50%" class="tdfont">
							<div align="left">
								<html:text name="UserwiseBookMarkMstFB" property="bookmarkName"
				...
				<tr>
					...
					<td width="50%" class="tdfont">
						<div align="left">
							<html:radio name="UserwiseBookMarkMstFB" tabindex="1"
				...
				<tr id="div1" style="display: none">
					...
					<td width="50%" class="tdfont">
						<div align="left">
							<html:select name="UserwiseBookMarkMstFB" property="userId"
				...
				<tr id="div2" style="display: none">
					...
					<td width="50%" class="tdfont">
						<div align="left">
							<html:select name="UserwiseBookMarkMstFB" property="deptCode"
				...
				<tr id="div3" style="display: none">
					...
					<td width="50%" class="tdfont">
						<div align="left">
							<html:select name="UserwiseBookMarkMstFB" property="deptUnitCode"
				...
				<tr>
					...
					<td width="50%" class="tdfont">
						<div align="left">
							<html:select name="UserwiseBookMarkMstFB" property="labCode"
				...
				<tr id="div4" style="display: none">
					...
					<td width="45%" class="tdfont">
						<div align="left">
							<html:select name="UserwiseBookMarkMstFB" property="testCode"
								style="width:30%" tabindex="1">
								<html:option value="-1">Select Value</html:option>
				...
				<tr id="div5" style="display: none">
					...
					<td width="45%" class="tdfont">
						<div align="left">
							<html:select name="UserwiseBookMarkMstFB" property="groupCode"
								style="width:30%" tabindex="1">
								<html:option value="-1">Select Value</html:option>
								 <logic:present
			...
			<his:ContentTag>
				<table width="100%" border="0" cellspacing="1" cellpadding="0">
					...
					<logic:iterate id="opinionReqVO"
						...
						type="new_investigation.vo.UserwiseBookMarkMstVO">
							...
							<td class="tdfont" width="5%">
								<div align="center" class="tooltip">
									<img class="button" style="cursor: pointer" tabindex="1"
										...
										tabindex="1">
									<html:hidden name="UserwiseBookMarkMstFB" property="hiddenLabCode" />
									<html:hidden name="UserwiseBookMarkMstFB" property="hiddenTestCode" />
									<html:hidden name="UserwiseBookMarkMstFB" property="hiddenLabName" />
									<html:hidden name="UserwiseBookMarkMstFB" property="hiddenGroupCode" />
									<html:hidden name="UserwiseBookMarkMstFB" property="hiddenIsTestGroup" />
		...
		<his:ButtonToolBarTag>
			...
			<span id="saveDiv"> <logic:notEqual name="UserwiseBookMarkMstFB"
				...
				</logic:notEqual> <logic:equal name="UserwiseBookMarkMstFB" property="hmode"
					value="MODIFY">
					<img class="button"
		...
		<his:status />
		<html:hidden name="UserwiseBookMarkMstFB" property="hmode" />
		<html:hidden name="UserwiseBookMarkMstFB" property="testCode" />
		<html:hidden name="UserwiseBookMarkMstFB" property="labCode" />
		<html:hidden name="UserwiseBookMarkMstFB" property="bookmarkCode" />
		<html:hidden name="UserwiseBookMarkMstFB" property="bookarkType" />
		<html:hidden name="UserwiseBookMarkMstFB" property="deptCode" />
		<html:hidden name="UserwiseBookMarkMstFB" property="deptUnitCode" />
		<html:hidden name="UserwiseBookMarkMstFB" property="groupCode" />
		<html:hidden name="UserwiseBookMarkMstFB" property="seqNo" />
	</html:form>
