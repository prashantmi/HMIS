...
<his:javascript src="/new_investigation/js/LabItemMappingMstAddMod.js" />
<body >
...
function gettest()
{
	...
	{
	document.forms[0].hmode.value = "GETITEMS";
	document.forms[0].submit();
	}
}
...
if(isDynamicTemplate_value=="1")
	...
	document.getElementById("div3").style.display="none";
		...
		<html:form action="/masters/LabItemMappingMstACT">
		<html:hidden name="LabItemMappingMstFB" property="hmode" />
		<html:hidden name="LabItemMappingMstFB" property="selectedChk" />
	...
	%>
		...
		<logic:equal name="LabItemMappingMstFB" property="hmode" value="VIEW">
			<% this.readOnly=true; %>
		</logic:equal>
	...
	<his:TransactionContainer>
			<his:TitleTag name="Lab Item Mapping Master">
				<%-- <his:insertDateTag /> --%>
			</his:TitleTag>
			<his:ContentTag>
...
<logic:notEqual name="LabItemMappingMstFB" property="hmode"
									value="MODIFY">
				<!-- Group Combo -->
					...
					<tr>
						...
						<td width='50%' class="tdfont"><logic:present
								...
								<div align="left">
									...
									<html:select name="LabItemMappingMstFB"
			  	...
			  	<tr id="div2"  style="display:none">
					...
					<logic:equal name="LabItemMappingMstFB" property="hmode"
									value="MODIFY">
									<!-- Group Combo -->
					...
					<tr>
						...
						<td width='50%' class="tdfont"><logic:present
								...
								<div align="left">
									...
									<html:hidden name="LabItemMappingMstFB" property="labCode" />
								...
								<logic:equal name="LabItemMappingMstFB" property="hmode"
									value="GETTEST">
										...
										<html:select name="LabItemMappingMstFB"
											...
											style="width:200px">
											<logic:present name="<%=InvestigationConfig.ITEM_LIST_LEFT_COMBO%>">
											<html:options
												collection="<%=InvestigationConfig.ITEM_LIST_LEFT_COMBO%>"
												property="value" labelProperty="label" />
									</logic:present>
										</html:select>
...
<logic:notEqual name="LabItemMappingMstFB" property="hmode"
								...
								<logic:equal name="LabItemMappingMstFB" property="hmode"
									value="GETTEST">
									<logic:present name="<%=InvestigationConfig.ITEM_LIST_RIGHT_COMBO%>">
										<html:select name="LabItemMappingMstFB"
											property="mappedList" size="5" tabindex="1" multiple="true"
											style="width:200px">
											<html:options
												collection="<%=InvestigationConfig.ITEM_LIST_RIGHT_COMBO%>"
												property="value" labelProperty="label" />
										</html:select>
									</logic:present>
									
											<logic:notPresent name="<%=InvestigationConfig.ITEM_LIST_RIGHT_COMBO%>">
										<html:select name="LabItemMappingMstFB"
											property="mappedList" size="5" tabindex="1" multiple="true"
											style="width:200px">
			...
			<his:ButtonToolBarTag>
				...
				<logic:notEqual
					name="LabItemMappingMstFB" property="hmode" value="MODIFY">
						<logic:notEqual name="LabItemMappingMstFB" property="hmode"
						value="VIEW">
							<img class="button"
			...
			<logic:present name="<%=InvestigationConfig.ITEM_LIST_LEFT_COMBO %>"> 
        <logic:empty name="<%=InvestigationConfig.ITEM_LIST_LEFT_COMBO  %>"> 
