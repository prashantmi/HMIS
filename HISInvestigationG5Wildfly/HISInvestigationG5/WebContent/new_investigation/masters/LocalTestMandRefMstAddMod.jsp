<!-- 
 ...
 ## Project Name						:	LOCAL TEST MANDATORY REFERENCE MASTER
...
<%@page import="new_investigation.vo.LocalTestMandRefMasterVO"%>
...
<his:javascript src="/new_investigation/js/LocalTestMandRefMstAddMod.js" />
...
function finalSubmit23(obj)
{
	
	var ll=document.getElementsByName("lowValueUom")[0].value
	
	var hh=document.getElementsByName("highValueUom")[0].value
  ...
  function getLabSample(ojb)
{
	...
	var testCode=document.getElementsByName("testCode")[0].value;
	var urlNew= "/HISInvestigationG5/new_investigation/masters/LocalTestMandRefMstACTION.cnt?hmode="+_mode+'&labCode='+labCode+'&testCode='+testCode;	
  ...
  function setLabSample(objLabSampleList,ojb)
  {
  	...
  	if(objLabSampleList !=null)
  	{
  		...
  		/* labSampleList.innerHTML="<html:select name='LocalTestMandRefMstFB' property='sampleCode'>"; */
...
//alert("nRow"+nRow);
	...
	if(rangeTyp==1)
		var htmlCommongString="<td class='tdfont'><div align='center'><input type='text'  name ='lowValue' maxlength='50'  size='6'></div></td><td class='tdfont'><div align='center'><input type='text'  name ='lowValueUom' size='16'  maxlength='20' onfocus='assignCurrentElement(this)'></div></td><td class='tdfont'><div align='center'><input type='text'  name ='highValue' maxlength='50' onkeypress='return validateAlphaNumericOnly(event,this)'  size='6'></div></td><td class='tdfont'><div align='center'><input type='text'  name ='highValueUom' size='16' maxlength='20' onfocus='assignCurrentElement(this)'  ></div></td><td class='tdfont'><div align='center'><input type='text'  name ='symbol' size='6' maxlength='50' onfocus='assignCurrentElement(this)' ></div></td><td class='tdfont'><div align='center'><input type='text'  name ='remarks' size='6' maxlength='200' onkeypress='return CheckMaxLength(event,this,50,1)'  ></div></td><td class='tdfont'><img src='/HISInvestigationG5/hisglobal/images/minus.gif' onclick=\"deleteRow(document.getElementById(\'"+(parseInt(nRow)+1)+"\'))\"></td>";
	else
	...
	/* var htmlCommongString="<td class='tdfont'><div align='center'><input type='text'  name ='lowValue' maxlength='50' onkeypress='return validateAlphaNumericOnly(event,this)' size='6'></div></td><td class='tdfont'><div align='center'><input type='text'  name ='lowValueUom' size='16'  maxlength='20' onfocus='assignCurrentElement(this)'></div></td><td class='tdfont'><div align='center'><input type='text'  name ='highValue' maxlength='50' onkeypress='return validateAlphaNumericOnly(event,this)'  size='6'></div></td><td class='tdfont'><div align='center'><input type='text'  name ='highValueUom' size='16' maxlength='20' onfocus='assignCurrentElement(this)'  ></div></td><td class='tdfont'><div align='center'><input type='text'  name ='symbol' size='6' maxlength='50' onfocus='assignCurrentElement(this)' ></div></td><td class='tdfont'><div align='center'><input type='text'  name ='remarks' size='6' maxlength='200' onkeypress='return CheckMaxLength(event,this,50,1)'  ></div></td><td class='tdfont'><img src='/HISInvestigationG5/hisglobal/images/minus.gif' onclick=\"deleteRow(document.getElementById(\'"+(parseInt(nRow)+1)+"\'))\"></td>"; */
...
function getSampleList()
{
	...
	<html:form action="/masters/LocalTestMandRefMstACTION">
		<html:hidden name="LocalTestMandRefMstFB" property="hmode" />
		<html:hidden name="LocalTestMandRefMstFB" property="selectedChk" />
		<html:hidden name="LocalTestMandRefMstFB" property="criteriaCode" />
				<html:hidden name="LocalTestMandRefMstFB" property="fromGlobal" />
		...
		<his:TransactionContainer>
			...
			<his:ContentTag>
				...
				<logic:equal name="LocalTestMandRefMstFB" property="hmode" value="ADD">
						...
						<tr>
							...
							<td width="50%" class="tdfont"><logic:present
									...
									<div align="left">
										...
										<html:select name="LocalTestMandRefMstFB" property="testCode"
...
<!-- /* added by chandan for new range */ -->
							...
							<td width="50%" class="tdfont">
									<div align="left">
										...
										<html:select name="LocalTestMandRefMstFB" property="rangeTyp"
...
<logic:present
							...
							<td width="50%" class="tdfont">
									<div align="left">
										...
										<html:select name="LocalTestMandRefMstFB" property="parameterCode"
...
<logic:notPresent
				...
				<logic:equal name="LocalTestMandRefMstFB" property="hmode" value="MODIFY">
						...
						<tr>
							...
							<td width="50%" class="tdfont"><logic:present
									...
									<div align="left">
										...
										<html:hidden name="LocalTestMandRefMstFB" property="testCode" />
									</div>
								</logic:present></td>
						</tr>
...
<!-- /* added by chandan for new range */ -->
						...
						<logic:equal name="LocalTestMandRefMstFB" property="rangeTyp" value="1">			
							...
							<td width="50%" class="tdfont">
									<div align="left">
										...
										<html:hidden name="LocalTestMandRefMstFB" property="rangeTyp" />
									</div>
								</td>
							
                         </logic:equal>
                         
                         <logic:notEqual name="LocalTestMandRefMstFB" property="rangeTyp" value="1">
                          <td width="50%" class="tdfont">
									<div align="left">
						...
						<tr>
							...
							<td width="50%" class="tdfont"><logic:present
									...
									<div align="left">
										...
										<html:hidden name="LocalTestMandRefMstFB" property="parameterCode" />
									</div>
								</logic:present></td>
				...
				<logic:present name="LocalTestMandRefMstFB" property="parameterCode">
					...
					<table id="refValueTable" width="100%">
						...
						<tr>
							...
							<logic:equal name="LocalTestMandRefMstFB" property="criteriaCode"
								value="12">
							...
							<logic:greaterEqual name="LocalTestMandRefMstFB"
								property="criteriaCode" value="14">


								<logic:lessEqual name="LocalTestMandRefMstFB" property="criteriaCode"
									value="17">
							...
							<logic:notEqual name="LocalTestMandRefMstFB" property="criteriaCode"
								value="10">
								
								<!-- /* added by chandan for new range */ -->
								<logic:equal name="LocalTestMandRefMstFB" property="rangeTyp"
								value="1">
								...
								<logic:notEqual name="LocalTestMandRefMstFB" property="rangeTyp"
								value="1">
  	 ...
  	 List<LocalTestMandRefMasterVO> testmandRefMasterVOLst=(List<LocalTestMandRefMasterVO>)session.getAttribute(InvestigationConfig.LIST_TESTMANDREF_VO);
  ...
  int rowCount=0;
 		...
 		{
 			LocalTestMandRefMasterVO testmandrefmastervo=testmandRefMasterVOLst.get(count);
 			rowCount=count+1;
								...
								<tr id="<%=count+1%>">
									<logic:equal name="LocalTestMandRefMstFB" property="criteriaCode"
										...
										<td class='tdfont' width="10%"><div align="center">
												<html:select name="LocalTestMandRefMstFB" property="gender" value="<%=testmandrefmastervo.getGender()%>">
													<html:option value='-1'>Select Value</html:option>
									...
									<logic:equal name="LocalTestMandRefMstFB" property="criteriaCode"
										...
										<td class='tdfont' width="8%">
											<div align="center">
													<html:text name="LocalTestMandRefMstFB" value="<%=testmandrefmastervo.getLowAge() %>" property="lowAge" size="6"
										...
										<td class='tdfont' width="9%">
											<div align="center">
												<html:select name="LocalTestMandRefMstFB" property="lowAgeUom" value="<%=testmandrefmastervo.getLowAgeUom() %>">
													<html:option value='-1'>Select Value</html:option>
										...
										<td class='tdfont' width="8%">
											<div align="center">
												<html:text name="LocalTestMandRefMstFB" value="<%=testmandrefmastervo.getHighAge() %>" property="highAge" size="6"
													maxlength="6" onkeypress="return validateNumeric(event)"
													tabindex="1"></html:text>
											</div>
										</td>
										<td class='tdfont' width="8%">
											<div align="center">
												<html:select name="LocalTestMandRefMstFB" property="highAgeUom" value="<%=testmandrefmastervo.getHighAgeUom() %>"
													 >
													<html:option value='-1'>Select Value</html:option>
													<html:option value='1'><bean:message key="yearFormat"/></html:option>
													<html:option value='2'><bean:message key="monthFormat"/></html:option>
									...
									<logic:equal name="LocalTestMandRefMstFB" property="criteriaCode"
										...
										<td class='tdfont' width="7%">
											<div align="center">
												<b><html:select name="LocalTestMandRefMstFB" property="gender" value="<%=testmandrefmastervo.getGender() %>"
														 >
														<html:option value='-1'>Select Value</html:option>
														<html:option value='0'><bean:message key="male"/></html:option>
														<html:option value='1'><bean:message key="female"/></html:option>
									...
									<logic:equal name="LocalTestMandRefMstFB" property="criteriaCode"
										...
										<td width="10%" class="tdfont"><logic:present
												...
												<div align="left">
													...
													<html:select name="LocalTestMandRefMstFB" property="mandCode"
									...
									<logic:equal name="LocalTestMandRefMstFB" property="criteriaCode"
										...
										<td width="10%" class="tdfont"><logic:present
												...
												<div align="left">
													...
													<html:select name="LocalTestMandRefMstFB" property="mandCode" value="<%=testmandrefmastervo.getMandCode() %>"
									...
									<logic:equal name="LocalTestMandRefMstFB" property="criteriaCode"
										...
										<td width="10%" class="tdfont"><logic:present
												...
												<div align="left">
													...
													<html:select name="LocalTestMandRefMstFB" property="sampleCode" value="<%=testmandrefmastervo.getSampleCode()%>"
														tabindex="1" style="width:200px;">
														<html:option value="-1">Select Value</html:option>
														<html:options
									...
									<logic:equal name="LocalTestMandRefMstFB" property="criteriaCode"
										...
										<td width="10%" class="tdfont"><logic:present
												...
												<div align="left">
													...
													<html:select name="LocalTestMandRefMstFB" property="labCode" tabindex="1" value="<%=testmandrefmastervo.getLabCode()%>"
														style="width:200px;">
														<html:option value="-1">Select Value</html:option>
														<html:options
...
<%-- 													<html:select name="LocalTestMandRefMstFB" property="labCode" onchange='<%="getLabSample("+rowCount+")"%>' tabindex="1" value="<%=testmandrefmastervo.getLabCode() %>" style="width:200px;" > 
 --%>					<html:select name="LocalTestMandRefMstFB" property="labCode" tabindex="1" value="<%=testmandrefmastervo.getLabCode() %>" style="width:200px;" > 
 												<html:option value="-1">Select Value</html:option>
														<html:options
															collection="<%=InvestigationConfig.LIST_LAB_COMBO%>"
															property="value" labelProperty="label" />
 ...
 --%>						<html:select name="LocalTestMandRefMstFB" property="labCode" tabindex="1" value="<%=testmandrefmastervo.getLabCode() %>" style="width:200px;" > 
		...
		<!-- sample div -->					<td width="10%" class="tdfont"><logic:present
                             ...
                             <logic:equal name="LocalTestMandRefMstFB" property="rangeTyp"
									...
									<td class='tdfont' width="8%">
										<div align="center">
											<html:text name="LocalTestMandRefMstFB" value="<%=testmandrefmastervo.getLowValue() %>" property="lowValue" size="6"
												maxlength="50" 
									tabindex="1"
												 ></html:text>
										</div>
									...
									<td class='tdfont' width="8%">
										<div align="center">
											<html:text name="LocalTestMandRefMstFB" value="<%=testmandrefmastervo.getLowValueUom() %>" property="lowValueUom" size="16"
									...
									<td class='tdfont' width="8%">
										<div align="center">
											<html:text name="LocalTestMandRefMstFB" value="<%=testmandrefmastervo.getHighValue() %>" property="highValue" size="6"
												maxlength="50" 
									tabindex="1"
												 ></html:text>
										</div>
									...
									<td class='tdfont' width="8%">
										<div align="center">
											<html:text name="LocalTestMandRefMstFB" value="<%=testmandrefmastervo.getHighValueUom() %>" property="highValueUom" size="16"
												maxlength="20"   onfocus='assignCurrentElement(this)'
												 ></html:text>
										</div>
									</td>
									...
									<logic:notEqual name="LocalTestMandRefMstFB" property="rangeTyp"
										...
										<td class='tdfont' width="8%">
										<div align="center">
											<html:text name="LocalTestMandRefMstFB" value="<%=testmandrefmastervo.getRange() %>" property="range" size="6"
												maxlength="50" onkeypress=""
									tabindex="1"
												 ></html:text>
										</div>
									</td>
									<td class='tdfont' width="8%">
										<div align="center">
											<html:text name="LocalTestMandRefMstFB" value="<%=testmandrefmastervo.getRangeUom() %>" property="rangeUom" size="16"
												maxlength="20"   onfocus='assignCurrentElement(this)'
												 ></html:text>
										</div>
									</td>
									 ...
									 <td class='tdfont' width="8%">
										<div align="center">
											<html:text name="LocalTestMandRefMstFB" value="<%=testmandrefmastervo.getSymbol() %>" property="symbol" size="6"
												maxlength="50"  onfocus='assignCurrentElement(this)'></html:text>
										</div>
									</td>
									<td class='tdfont' width="8%">
										<div align="center">
											<html:text name="LocalTestMandRefMstFB" value="<%=testmandrefmastervo.getRemarks() %>" property="remarks" size="6"
												maxlength="200" onkeypress="return CheckMaxLength(event,this,50,1)"></html:text>
										</div>
									</td>
									
									<td class='tdfont' width="1%"><%-- <html:hidden name="LocalTestMandRefMstFB"
											property="seqNo" /> --%> <logic:notEqual name="LocalTestMandRefMstFB"
...
<!-- SINGLE ROW 2 WHEN CRITERIA IS 10 -->
			<logic:empty name="<%=InvestigationConfig.LIST_TESTMANDREF_VO %>">
						<logic:equal name="LocalTestMandRefMstFB" property="hmode" value="ADD">
						<logic:equal name="LocalTestMandRefMstFB" property="criteriaCode"
							value="10">
							...
							<td class='tdfont'><div align='center'>
									<input type='text' name='lowValue' size='6' maxlength="50"
										 >
								</div></td>
							<td class='tdfont'><div align='center'>
	...
	<!-- SINGLE ROW ENDS FOR CRITERIA = 10 -->
			...
			<his:ButtonToolBarTag>
				<span id="saveDiv"> <logic:notEqual name="LocalTestMandRefMstFB"
						property="hmode" value="MODIFY">
						<logic:notEqual name="LocalTestMandRefMstFB" property="hmode"
							value="VIEW">
							<img class="button"
					...
					</logic:notEqual> <logic:equal name="LocalTestMandRefMstFB" property="hmode"
						value="MODIFY">
						<img class="button"
