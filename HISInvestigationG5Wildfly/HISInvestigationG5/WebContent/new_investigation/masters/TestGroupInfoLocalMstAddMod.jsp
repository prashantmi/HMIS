...
<%@page import="new_investigation.vo.TestGroupInfoLocalMasterVO"%>
...
<his:javascript src="/new_investigation/js/TestGroupInfoLocalMstAddMod.js" />
<body >
...
if(isDynamicTemplate_value=="1")
	...
	document.getElementById("div3").style.display="none";
		...
		<html:form action="/masters/TestGroupInfoLocalMstACTION">
		<html:hidden name="TestGroupInfoLocalMstFB" property="hmode" />
		<html:hidden name="TestGroupInfoLocalMstFB" property="selectedChk" />
		<html:hidden name="TestGroupInfoLocalMstFB" property="checkLocal" />
			<html:hidden name="TestGroupInfoLocalMstFB" property="numberOfRow" />
	...
	%>
		...
		<logic:equal name="TestGroupInfoLocalMstFB" property="hmode" value="VIEW">
			<% this.readOnly=true; %>
		</logic:equal>
	...
	<his:TransactionContainer>
			<his:TitleTag name="Local Test Group Information Master">
				<%-- <his:insertDateTag /> --%>
			</his:TitleTag>
			<his:ContentTag>
...
<logic:notEqual name="TestGroupInfoLocalMstFB" property="hmode"
									value="MODIFY">
				<!-- Group Combo -->
					...
					<tr>
						...
						<td width='50%' class="tdfont"><logic:present
								...
								<div align="left">
									...
									<html:select name="TestGroupInfoLocalMstFB"
					...
					<tr>
						...
						<td width='50%' class="tdfont"><logic:present
								...
								<div align="left">
									...
									<html:text name="TestGroupInfoLocalMstFB"
										property="userGroupCode" tabindex="1" maxlength="10" onkeypress="return validateAlphaNumericOnly(event,this);"></html:text>
								</div>
							</logic:present>
						</td>
					</tr>
			     ...
			     <td width="50%" class="tdfont">
			  		...
			  		<html:radio name="TestGroupInfoLocalMstFB" tabindex="1" property="isDynamicTemplate" value="1" onclick="showHideDiv();"></html:radio>
			  		<bean:message key="IsDynamicPrintingYes"/>&nbsp;
			  		<html:radio name="TestGroupInfoLocalMstFB" tabindex="1" property="isDynamicTemplate" value="0" onclick="showHideDiv();"></html:radio>
			     ...
			     <td width="50%" class="tdfont">
			  		...
			  		<html:radio name="TestGroupInfoLocalMstFB" tabindex="1" property="isDynamicResult" value="1"></html:radio>
			  		<bean:message key="IsDynamicResultYes"/>&nbsp;
			  		<html:radio name="TestGroupInfoLocalMstFB" tabindex="1" property="isDynamicResult" value="0"></html:radio>
			     ...
			     <td width="50%" class="tdfonthead">
			     	<div align="right">
			     		...
			     		<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
			     				<b><bean:message key="useGlobal"/>&nbsp;</b>
			     		</font>
			     	</div>
			     </td>
			     <td width="50%" class="tdfont">
			  		...
			  		<html:radio name="TestGroupInfoLocalMstFB" tabindex="1" property="globalTemplate" value="1"></html:radio>
			  		<bean:message key="IsDynamicResultYes"/>&nbsp;
			  		<html:radio name="TestGroupInfoLocalMstFB" tabindex="1" property="globalTemplate" value="0"></html:radio>
			  		<bean:message key="IsDynamicResultNo"/>&nbsp;
			  	...
			  	<tr id="div2"  style="display:none">
					...
					<logic:equal name="TestGroupInfoLocalMstFB" property="hmode"
									value="MODIFY">
									<!-- Group Combo -->
					...
					<tr>
						...
						<td width='50%' class="tdfont"><logic:present
								...
								<div align="left">
									...
									<html:hidden name="TestGroupInfoLocalMstFB" property="groupCode" />
								</div>
							</logic:present>
						</td>
					</tr>
					...
					<tr>
						...
						<td width='50%' class="tdfont"><logic:present
								...
								<div align="left">
									...
									<html:hidden name="TestGroupInfoLocalMstFB" property="labCode" />
								...
								<logic:equal name="TestGroupInfoLocalMstFB" property="hmode"
									...
									<logic:present name="<%=InvestigationConfig.LIST_SELECTED_COMBO%>">
										<html:select name="TestGroupInfoLocalMstFB"
											...
											<logic:notPresent name="<%=InvestigationConfig.LIST_SELECTED_COMBO%>">
										<html:select name="TestGroupInfoLocalMstFB"
											property="mappedList" size="5" tabindex="1" multiple="true"
											style="width:200px">
...
<logic:notEqual name="TestGroupInfoLocalMstFB"
						property="hmode" value="SAVE">
				<logic:present
					name="<%=InvestigationConfig.LIST_TEST_SEQ_NO %>">
				
						<%
     
  	 List<TestGroupInfoMasterVO> lstSelectedTests=(List<TestGroupInfoMasterVO>)session.getAttribute(InvestigationConfig.LIST_TEST_SEQ_NO);
 		...
 		int lstSize=lstSelectedTests.size();
					...
					<%
						for(int k=0;k<lstSize;k++)
				 		{
							TestGroupInfoMasterVO volabCanned=lstSelectedTests.get(k);
				 	 	    
				 	 	    %>
				 	 	    
				 	 	    
				 	 	    <tr id='<%=volabCanned.getTestCode()%>'>

							<td class="tdfont" width='50%'>
								<div align="center">
									<%=volabCanned.getTestName()%>
								</div>
							</td>
							...
							<td class="tdfont"  width='50%'>
								...
								<html:text name="TestGroupInfoLocalMstFB" property="testSeqNo"
									maxlength="10" size="60" readonly="<%=this.readOnly %>"
									onkeypress="return validateAlphaNumericWithSpecialCharacterOnly(event,this)"
									tabindex="1" style="width:200px;" value="<%=volabCanned.getTestSeqNo()%>">
								</html:text>
			...
			<his:ButtonToolBarTag>
				...
				<logic:notEqual
					name="TestGroupInfoLocalMstFB" property="hmode" value="MODIFY">
						<logic:notEqual name="TestGroupInfoLocalMstFB" property="hmode"
						value="VIEW">
							<img class="button"
			...
			<logic:notEqual name="TestGroupInfoLocalMstFB" property="checkLocal"
								value="0">
			<logic:present name="<%=InvestigationConfig.LIST_TEST_COMBO %>"> 
