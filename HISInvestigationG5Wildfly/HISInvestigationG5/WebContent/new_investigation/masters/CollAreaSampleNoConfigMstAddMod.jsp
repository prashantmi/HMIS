<!-- 
 ...
 ## Project Name						:	COLLECTION AREA SAMPLE NUMBER CONFIGURATION MASTER
...
<%@page import="new_investigation.vo.CollAreaSampleNoConfigMasterVO"%>
...
<his:javascript src="/new_investigation/js/CollAreaSampleNoConfigMstAddMod.js" />
<his:javascript src="/hisglobal/js/utilityFunctions.js" />
...
<body>
	...
	<%String sysdate=WebUTIL.getCustomisedSysDate((Date)session.getAttribute(Config.SYSDATEOBJECT), "dd-MMM-yyyy");%>
		...
		//IF LAB COMPOLSOURY AND TO FETCH AREA BASED ON LAB
		/* function getArea() {
		...
		//FETCHING LAB ON THE BASIS OF AREA. AS AREA COMPOLSOURY FOR TS
		function getLab() {
	...
	<%-- 		document.getElementsByName('initDate')[0].value = "<%=sysdate%>";
		...
		function cleardownvalues() {
			...
			//if lab was compolsoury
			// getArea();
			
			//as area is compolsoury
			document.getElementsByName('labCode')[0].value="-1";
...
{				document.getElementsByName('sampleNoFormat')[0].value = "";
	...
	<html:form action="/masters/CollAreaSampleNoConfigMstACTION">
		<html:hidden name="CollAreaSampleNoConfigMstFB" property="hmode" />
		<html:hidden name="CollAreaSampleNoConfigMstFB" property="selectedChk" />
		<html:hidden name="CollAreaSampleNoConfigMstFB" property="seqNo" />
		<html:hidden name="CollAreaSampleNoConfigMstFB" property="dateOrder" />
		<html:hidden name="CollAreaSampleNoConfigMstFB" property="monthOrder" />
		<html:hidden name="CollAreaSampleNoConfigMstFB" property="yearOrder" />
		<html:hidden name="CollAreaSampleNoConfigMstFB" property="initDate" />
		<html:hidden name="CollAreaSampleNoConfigMstFB" property="reinitDate" />
		<html:hidden name="CollAreaSampleNoConfigMstFB" property="sampleNoFormat" />
	...
	%>
		...
		<logic:equal name="CollAreaSampleNoConfigMstFB" property="hmode" value="VIEW">
			<% this.readOnly=true; %>
		</logic:equal>
		...
		<his:TransactionContainer>
			<his:TitleTag name="Collection Area Sample Number Configuration Master">
				<%-- <his:insertDateTag /> --%>
			</his:TitleTag>
			<his:ContentTag>
				...
				<table width="100%" border="0" cellspacing="1" cellpadding="0">
					...
					<logic:notEqual name="CollAreaSampleNoConfigMstFB" property="hmode"
						value="MODIFY">
						...
						<tr>
							...
							<td width="50%" class="tdfont"><logic:present
									name="<%=InvestigationConfig.LIST_AREA_COMBO %>">
									<div align="left">

										<html:select name="CollAreaSampleNoConfigMstFB" property="areaCode"
											tabindex="1" style="width:200px;" onchange="cleardownvalues();">
						...
						<tr>
							...
							<td class='tdfont' colspan="2">
								<div align="left">
									<html:select name="CollAreaSampleNoConfigMstFB" property="patientType"
										style="width:200px" onchange="getLab();">
										<html:option value="-1">Select Value</html:option>
						...
						<tr>
							...
							<td width="50%" class="tdfont"><logic:present
									...
									<div align="left">
										...
										<html:select name="CollAreaSampleNoConfigMstFB" property="labCode"
					...
					<tr>
						...
						<td width="50%" class="tdfont">
							<div align="left">
								<html:radio name="CollAreaSampleNoConfigMstFB" tabindex="1"
					...
					<logic:equal name="CollAreaSampleNoConfigMstFB" property="hmode"
						value="MODIFY">
	...
	<!-- Area Combo -->
						...
						<tr>
							...
							<td width="50%" class="tdfont"><logic:present
									...
									<div align="left">
										...
										<html:hidden name="CollAreaSampleNoConfigMstFB" property="areaCode" />
						...
						<tr>
							...
							<td class='tdfont' colspan="2">
								<div align="left">
									<html:select name="CollAreaSampleNoConfigMstFB" property="patientType"
										style="width:200px" onchange="getArea();" disabled="true">
										<html:option value="-1">Select Value</html:option>
										<html:option value="2">IPD</html:option>
										<html:option value="1">OPD</html:option>
										<html:option value="3">Both IPD/OPD</html:option>
									...
									<html:hidden name="CollAreaSampleNoConfigMstFB" property="patientType" />
							...
							<td width="50%" class="tdfont"><logic:present
									...
									<div align="left">
										...
										<html:hidden name="CollAreaSampleNoConfigMstFB" property="labCode" />
				...
				<table width="100%" style="display: ''" id="secondTable" border="0"
					...
					<tr>
						...
						<td width="40%" class="tdfont">
							<div align="left">
								...
								<html:text name="CollAreaSampleNoConfigMstFB" size="30"
					...
					<tr>
						...
						<td width="70%" class="tdfont">
							<div align="left">
								<html:text name="CollAreaSampleNoConfigMstFB" property="seriesFormat"
					...
					<tr>
						...
						<td width="50%" class="tdfont">
							<div align="left">
								<html:text name="CollAreaSampleNoConfigMstFB" property="seqDigit"
				...
				<table width="100%" style="display: ''" id="thirdTable" border="0"
					...
					<tr>
						...
						<td width="50%" class="tdfont">
							<div align="left">
								<html:text name="CollAreaSampleNoConfigMstFB" property="fromSeries"
					...
					<tr>
						...
						<td width="50%" class="tdfont">
							<div align="left">
								<html:text name="CollAreaSampleNoConfigMstFB" property="toSeries" size="30"
	    		...
	    		<logic:equal name="CollAreaSampleNoConfigMstFB" property="hmode" value="ADD">  
					<his:date name='initDate' dateFormate="%d-%b-%Y" value="<%=sysdate%>" onchange="resetReInitializationDate()"/>
					</logic:equal>
	    		<logic:equal name="CollAreaSampleNoConfigMstFB" property="hmode" value="MODIFY">  
	    		<bean:define id="iniDate" name="CollAreaSampleNoConfigMstFB" property="initDate" type="java.lang.String"></bean:define>
	    		...
	    		<logic:equal name="CollAreaSampleNoConfigMstFB" property="hmode" value="MODIFY">  
	    		<bean:define id="reiniDate" name="CollAreaSampleNoConfigMstFB" property="reinitDate" type="java.lang.String"></bean:define>
			...
			<his:ButtonToolBarTag>
				<span id="saveDiv"> <logic:notEqual name="CollAreaSampleNoConfigMstFB"
					...
					</logic:notEqual> <logic:equal name="CollAreaSampleNoConfigMstFB" property="hmode"
						value="MODIFY">
						<img class="button"
