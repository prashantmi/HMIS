...
"pageLength": -1,
		        ...
		        order: [[ 1, 'asc' ]],
		        "language": { "emptyTable": "No Data Is Available " },
		        "order": [[ 13, "desc" ],[ 3, "desc" ]],
				
		        "columnDefs":
					[   { "targets": 12, "visible": false }, { "targets": 6, "visible": false },{ "targets": 4, "visible": false },{ "targets": 13, "visible": false }
    	...
    	//	    	alert("hel");
    		...
    		*/        /*"order": [[ 12, "desc" ],
    				...
    				*/
    		        var currentOrder = "";
    		        currentOrder=table.order()[1];
    		      //  alert(currentOrder);
    		      var flg="1" ;
    		        if (currentOrder[1] === 'desc' && flg=='1') {
//        		 
    		        	flg='0' ;
    		 	table.order([ 13, "desc" ],[ 3, "asc" ]).draw();
			...
			//	alert("asc");
    		        	...
    		        	{
    		        	flg='0' ;
    		        	table.order([ 13, "desc" ],[ 3, "desc" ]).draw();
