...
<%@page import="new_investigation.reports.controller.fb.RepeatTestReportFB"%>
...
<html:form action="/reports/RepeatTestReportAction" >
	   
	   <div class="errMsg" id="errMsg"><bean:write name="RepeatTestReportFB" property="strErrMsg"/></div>
<div class="normalMsg" id="normalMsg"><bean:write name="RepeatTestReportFB" property="strNormalMsg"/></div>
<div class="warningMsg" id="warningMsg"><bean:write name="RepeatTestReportFB" property="strWarningMsg"/></div>
	   
	   <html:hidden name="RepeatTestReportFB" property="hmode" />
	    <html:hidden name="RepeatTestReportFB" property="sysDate" />
	      <html:hidden name="RepeatTestReportFB" property="dateTypeCheck" />
	       <html:hidden name="RepeatTestReportFB" property="frmHr" />
	        <html:hidden name="RepeatTestReportFB" property="frmMin" />
	         <html:hidden name="RepeatTestReportFB" property="toHr" /> 
	         <html:hidden name="RepeatTestReportFB" property="toMin" />
	         
	  	 <his:TransactionContainer>
	 
		<his:TitleTag name="Repeat Test Report">
			<%-- <his:insertDateTag/> --%>
		</his:TitleTag>
		<his:ContentTag>
		  <%
         ...
         %>
      <bean:define name="RepeatTestReportFB" property="fromDate" id="frDate" type="java.lang.String" />
	   <bean:define name="RepeatTestReportFB" property="toDate" id="tDate" type="java.lang.String"/> 
 ...
 <tr>
			    ...
			    <td width="25%" class="tdfonthead">
			      ...
			      <logic:present	name="<%=InvestigationConfig.LIST_LAB_COMBO %>">
							<html:select name="RepeatTestReportFB" property="labCode" onchange="getTest()" tabindex="1" style="max-width:80%;">
			     ...
			     <td width="25%" class="tdfonthead">
			      ...
			      <td width="25%" class="tdfont">
			       <logic:present	name="<%=InvestigationConfig.LIST_TEST_COMBO %>">
							<html:select name="RepeatTestReportFB" property="testCode" tabindex="1" style="max-width:80%;">
