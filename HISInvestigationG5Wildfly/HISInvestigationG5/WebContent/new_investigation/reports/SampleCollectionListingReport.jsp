...
<%@page import="new_investigation.reports.controller.fb.SampleCollectionListingReportFB"%>
...
<html:form action="/reports/SampleCollectionListingReportAction" >
	   
	   <div class="errMsg" id="errMsg"><bean:write name="SampleCollectionListingReportFB" property="strErrMsg"/></div>
<div class="normalMsg" id="normalMsg"><bean:write name="SampleCollectionListingReportFB" property="strNormalMsg"/></div>
<div class="warningMsg" id="warningMsg"><bean:write name="SampleCollectionListingReportFB" property="strWarningMsg"/></div>
	   
	   <html:hidden name="SampleCollectionListingReportFB" property="hmode" />
	    <html:hidden name="SampleCollectionListingReportFB" property="sysDate" />
	      <html:hidden name="SampleCollectionListingReportFB" property="dateTypeCheck" />
	       <html:hidden name="SampleCollectionListingReportFB" property="frmHr" />
	        <html:hidden name="SampleCollectionListingReportFB" property="frmMin" />
	         <html:hidden name="SampleCollectionListingReportFB" property="toHr" /> 
	         <html:hidden name="SampleCollectionListingReportFB" property="toMin" />
	         
	  	 <his:TransactionContainer>
	 
		<his:TitleTag name="Sample Collection Listing Report">
			<%-- <his:insertDateTag/> --%>
		</his:TitleTag>
		<his:ContentTag>
		  <%
         ...
         %>
      <bean:define name="SampleCollectionListingReportFB" property="fromDate" id="frDate" type="java.lang.String"/>
	   <bean:define name="SampleCollectionListingReportFB" property="toDate" id="tDate" type="java.lang.String"/> 
 ...
 <tr>
			    ...
			    <td width="25%" class="tdfonthead">
			      ...
			      <logic:present	name="<%=InvestigationConfig.LIST_LAB_DEPT_COMBO %>">
							<html:select name="SampleCollectionListingReportFB" property="labCode" onchange="getTest()" tabindex="1" style="max-width:80%;">
			     ...
			     <td width="25%" class="tdfonthead">
			      <div align="right">
			       ...
			       <logic:present	name="<%=InvestigationConfig.LIST_TEST_COMBO %>">
							<html:select name="SampleCollectionListingReportFB" property="testCode" tabindex="1" onchange="" style="max-width:80%;">
			...
			<option value="xls">Excel</option>
			 ...
			 <his:ButtonToolBarTag>
				      ...
				      <img class="button" src='<his:path src="/hisglobal/images/btn-clr.png"/>'     onkeypress="if(event.keyCode==13) onSave();"  tabindex="1" onClick="onClearButton();" >
				          <img class="button" src='<his:path src="/hisglobal/images/btn-ccl.png"/>'     onkeypress="if(event.keyCode==13) onSave();"  tabindex="1" onClick="cancelPage();"  >
