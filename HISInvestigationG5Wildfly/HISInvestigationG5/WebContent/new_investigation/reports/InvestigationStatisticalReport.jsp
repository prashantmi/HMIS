...
<%@page import="new_investigation.vo.InvestigationStatisticalReportVO"%>
<%@page import="new_investigation.reports.controller.fb.InvestigationStatisticalReportFB"%>
...
<html:form action="/reports/InvestigationStatisticalReportAction" >
	   
	   <div class="errMsg" id="errMsg"><bean:write name="InvestigationStatisticalReportFB" property="strErrMsg"/></div>
<div class="normalMsg" id="normalMsg"><bean:write name="InvestigationStatisticalReportFB" property="strNormalMsg"/></div>
<div class="warningMsg" id="warningMsg"><bean:write name="InvestigationStatisticalReportFB" property="strWarningMsg"/></div>
	   
	   <html:hidden name="InvestigationStatisticalReportFB" property="hmode" />
	    <html:hidden name="InvestigationStatisticalReportFB" property="sysDate" />
	      <html:hidden name="InvestigationStatisticalReportFB" property="dateTypeCheck" />
	       <html:hidden name="InvestigationStatisticalReportFB" property="frmHr" />
	        <html:hidden name="InvestigationStatisticalReportFB" property="frmMin" />
	         <html:hidden name="InvestigationStatisticalReportFB" property="toHr" /> 
	         <html:hidden name="InvestigationStatisticalReportFB" property="toMin" />
	     
	         
	  	 <his:TransactionContainer>
	 
		<his:TitleTag name="Investigation Statistical Report">
			<%-- <his:insertDateTag/> --%>
		</his:TitleTag>
		<his:ContentTag>
		  <%
         ...
         %>
      <bean:define name="InvestigationStatisticalReportFB" property="fromDate" id="frDate" type="java.lang.String"/>
	   <bean:define name="InvestigationStatisticalReportFB" property="toDate" id="tDate" type="java.lang.String"/> 
 ...
 <tr>
			      ...
			      <td width="25%" class="tdfont">
			       <logic:present	name="<%=InvestigationConfig.DEPART_COMBO %>">
							<html:select name="InvestigationStatisticalReportFB" property="deptCode" tabindex="1" onchange="getLab()" style="max-width:80%;">
			    ...
			    <td width="25%" class="tdfonthead">
			      ...
			      <logic:present	name="<%=InvestigationConfig.LIST_LAB_COMBO %>">
							<html:select name="InvestigationStatisticalReportFB" property="labCode" onchange="getTest()" tabindex="1" style="max-width:80%;">
		...
		<tr>     
			      ...
			      <td width="25%" class="tdfont">
			       <logic:present	name="<%=InvestigationConfig.LIST_TEST_COMBO %>">
							<html:select name="InvestigationStatisticalReportFB" property="testCode" onchange="getSample()" tabindex="1" style="max-width:80%;">
			...
			<td width="25%" class="tdfont">
			     ...
			     <logic:present	name="<%=InvestigationConfig.LIST_SAMPLE_COMBO %>">
							<html:select name="InvestigationStatisticalReportFB" property="sampleCode" tabindex="1" onchange="" style="max-width:80%;">
		 ...
		 <logic:notPresent	name="<%=InvestigationConfig.LIST_SAMPLE_COMBO %>">
							<html:select name="InvestigationStatisticalReportFB" property="sampleCode" onchange="" tabindex="1" style="max-width:80%;">
										<html:option value="-1">Select sample</html:option>
									</html:select>
