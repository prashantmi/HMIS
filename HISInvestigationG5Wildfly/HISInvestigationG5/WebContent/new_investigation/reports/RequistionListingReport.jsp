...
<%@page import="new_investigation.reports.controller.fb.RequistionlistingReportFB"%>
...
<html:form action="/reports/RequistionListingReportAction" >
	   
	   <div class="errMsg" id="errMsg"><bean:write name="RequistionlistingReportFB" property="strErrMsg"/></div>
<div class="normalMsg" id="normalMsg"><bean:write name="RequistionlistingReportFB" property="strNormalMsg"/></div>
<div class="warningMsg" id="warningMsg"><bean:write name="RequistionlistingReportFB" property="strWarningMsg"/></div>
	   
	   <html:hidden name="RequistionlistingReportFB" property="hmode" />
	    <html:hidden name="RequistionlistingReportFB" property="sysDate" />
	      <html:hidden name="RequistionlistingReportFB" property="dateTypeCheck" />
	       <html:hidden name="RequistionlistingReportFB" property="frmHr" />
	        <html:hidden name="RequistionlistingReportFB" property="frmMin" />
	         <html:hidden name="RequistionlistingReportFB" property="toHr" /> 
	         <html:hidden name="RequistionlistingReportFB" property="toMin" />
	         
	  	 <his:TransactionContainer>
	 
		<his:TitleTag name="Requisition Listing Report">
			<%-- <his:insertDateTag/> --%>
		</his:TitleTag>
		<his:ContentTag>
		  <%
         ...
         %>
      <bean:define name="RequistionlistingReportFB" property="fromDate" id="frDate" type="java.lang.String" />
	   <bean:define name="RequistionlistingReportFB" property="toDate" id="tDate" type="java.lang.String"/> 
 ...
 <tr>
			    ...
			    <td width="25%" class="tdfonthead">
			      ...
			      <logic:present	name="<%=InvestigationConfig.LIST_LAB_COMBO %>">
							<html:select name="RequistionlistingReportFB" property="labCode" onchange="getTest()" tabindex="1" style="max-width:80%;">
			     ...
			     <td width="25%" class="tdfonthead">
			      ...
			      <td width="25%" class="tdfont">
			       <logic:present	name="<%=InvestigationConfig.LIST_TEST_COMBO %>">
							<html:select name="RequistionlistingReportFB" property="testCode" tabindex="1" style="max-width:80%;">
