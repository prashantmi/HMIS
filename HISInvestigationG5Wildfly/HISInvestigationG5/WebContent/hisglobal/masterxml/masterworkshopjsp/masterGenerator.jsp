...
<HEAD>
	...
	<link href="/HISInvestigationG5/hisglobal/css/master.css" type=TEXT/CSS rel=STYLESHEET>
	<link href="/HISInvestigationG5/hisglobal/css/Color.css" rel="stylesheet" type="text/css">
	<link href="/HISInvestigationG5/hisglobal/css/hisStyle.css" rel="stylesheet" type="text/css">
...
function increment()
{
	...
	td1.colspan="1";
	td2.innerHTML="<input type='text' name='noOfColumn' ><img src='/HISInvestigationG5/hisglobal/images/PT_PORTAL_IC_MINUS_ENG_1.gif' width='10' height='10' onClick='decrement();'>"
...
function addQuery()
{
	...
	td1.className='tdfonthead';
	td1.colspan='3';
	td2.innerHTML="<input type='text' name='queryFields' ><img src='/HISInvestigationG5/hisglobal/images/PT_PORTAL_IC_MINUS_ENG_1.gif' width='10' height='10' onClick='decrement1();'>";
	td2.className='tdfont';
	td2.colspan='2';
	tabRow.appendChild(td1);
	tabRow.appendChild(td2);
...
function addPrimary()
{
	...
	td1.className='tdfonthead';
	td1.colspan='3';
	td2.innerHTML="<input type='text' name='queryFields' ><img src='/HISInvestigationG5/hisglobal/images/PT_PORTAL_IC_MINUS_ENG_1.gif' width='10' height='10' onClick='decrement2();'>";
	td2.className='tdfont';
	td2.colspan='2';
	tabRow.appendChild(td1);
	tabRow.appendChild(td2);
...
function addTable()
{
	...
	td3.colspan='3';
	td4.innerHTML="<input type='text' name='aliasTable' ><img src='/HISInvestigationG5/hisglobal/images/PT_PORTAL_IC_MINUS_ENG_1.gif' width='10' height='10' onClick='decrement3();'>";
...
function addClause()
{
	...
	td1.className='tdfonthead';
	td1.colspan='2';
	td2.innerHTML="<input type='text' name='clause' ><img src='/HISInvestigationG5/hisglobal/images/PT_PORTAL_IC_MINUS_ENG_1.gif' width='10' height='10' onClick='decrement4();'>";
	td2.className='tdfont';
	td2.colspan='2';
	tabRow.appendChild(td1);
	tabRow.appendChild(td2);	
...
function showCombo(temp)
{
	...
	for(i=0;i<noOfControl;i++)
	{
		...
		td[i].innerHTML='<div align="center">Combo'+i+' Details &nbsp;&nbsp;<img src="/HISInvestigationG5/hisglobal/images/PT_PORTAL_IC_PLUS_ENG_1.gif" width="10" height="10" onClick="showComboDetails('+i+',1);"> '+
                        '  &nbsp;<img src="/HISInvestigationG5/hisglobal/images/PT_PORTAL_IC_MINUS_ENG_1.gif" width="10" height="10" onClick="showComboDetails('+(i)+',2);"></div>'+
                        ...
                        '          &nbsp;<img src="/HISInvestigationG5/hisglobal/images/PT_PORTAL_IC_PLUS_ENG_1.gif" width="10" height="10" onClick="addComboTable(TAB'+i+');"></div></td>'+
						'		</tr>'+
						'		<tr>'+
						'		<td class="tdfont" colspan="4">'+
                        ...
                        '        &nbsp; <img src="/HISInvestigationG5/hisglobal/images/PT_PORTAL_IC_PLUS_ENG_1.gif" width="10" height="10" onClick="addComboClause(CLAUSE'+i+');"> '+
                        '      </td>'+
						'		</tr>'+
						' 		<tr>'+
						'		<td class="tdfont" colspan="4">	'+
                        ...
                        '          &nbsp; <img src="/HISInvestigationG5/hisglobal/images/PT_PORTAL_IC_PLUS_ENG_1.gif" width="10" height="10" onClick="showComboOption(option'+i+');" >	'+
                        '        </div></td>'+
						'	</tr>'+
						'	<tr>'+
						'	<td class="tdfont" colspan="4">'+
...
function showComboOption(temp)
{
	...
	td3.className='tdfonthead';
	td3.colspan='3';
	td4.innerHTML="<input type='text' name='aliasTable' ><img src='/HISInvestigationG5/hisglobal/images/PT_PORTAL_IC_MINUS_ENG_1.gif' width='10' height='10' onClick='decrement7("+temp.id+");'>";
	td4.className='tdfont';
	td4.colspan='2';
	tabRow.appendChild(td3);
	tabRow.appendChild(td4);	
...
{	
	...
	td3.className='tdfonthead';
	td3.colspan='3';
	td4.innerHTML="<input type='text' name='aliasTable' ><img src='/HISInvestigationG5/hisglobal/images/PT_PORTAL_IC_MINUS_ENG_1.gif' width='10' height='10' onClick='decrement5("+temp.id+");'>";
	td4.className='tdfont';
	td4.colspan='2';
	tabRow.appendChild(td3);
	tabRow.appendChild(td4);
...
function addComboClause(temp)
{
	...
	td1.className='tdfonthead';
	td1.colspan='4';
	td2.innerHTML="<input type='text' name='clause' ><img src='/HISInvestigationG5/hisglobal/images/PT_PORTAL_IC_MINUS_ENG_1.gif' width='10' height='10' onClick='decrement6("+temp.id+");'>";
	td2.className='tdfont';
	td2.colspan='4';
	tabRow.appendChild(td1);
	tabRow.appendChild(td2);	
	...
	<table width="100%" border="0">
		<tr>
			<td width="68%" colspan=2>	
				<div align="center">
					<img src="/HISInvestigationG5/hisglobal/images/e_sushrut_header.gif" width="760" height="74">
				</div>
			</td>
		</tr>
		...
		<tr>
			...
			<td height="19" valign="bottom">
				<div align="right">
					<a href="/HISInvestigationG5/startup/cnt_login.jsp?loginMode=LOGOUT&uid=E050000100">
						<strong>
							<font size="2">
								<font color="#9900CC">
									Logout&nbsp;
	...
	<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
		<TR>
			<TD class=DIVIDER height=1>
				<IMG height=1 src="/HISInvestigationG5/hisglobal/images/tp.gif" width=650 border=0>
			</TD>
		</TR>
		<TR>
								...
								<tr>
									<td valign=bottom align="left" colspan=3>
										<table cellspacing=0 cellpadding=0 width="1056%" border=0>
											<tr>
												<td width=1 height=1>
													<img height=1 src="/HISInvestigationG5/hisglobal/images/tp.gif" width=1 border=0>
												</td>
