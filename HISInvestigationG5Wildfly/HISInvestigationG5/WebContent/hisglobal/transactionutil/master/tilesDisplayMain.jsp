...
<body onload="setPersistenceValues();<%=functionname %>;hideMenu();"
	onkeydown="searchData(event);"
...
<html:form action='<%=(String)request.getAttribute("cnt_page")%>'>
	...
	<table align="center" width="90%" border="1" CELLPADDING="0" CELLSPACING="0" bgcolor="#E7EBEF" bordercolor="#004573">
		<tr>
			<td colspan="3">
			<div id="comboId" ></div>
			</td>
		...
		<tr>
			<%String strAlign = (String) request.getAttribute("buttonConfig");
				...
				%>
			<td valign="top" width="15%"><tiles:insert attribute="menu" /></td>
			...
			<td colspan="2" valign="top" width="15%"><tiles:insert attribute="menu" /></td>
			...
			<td valign="top"><tiles:insert attribute="menu1" /></td>
			<%}%>
		</tr>
