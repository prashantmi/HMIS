...
opts.tab.append("<a class=\"tabs-inner\" href=\"javascript:void(0)\" onclick=\"clickfocus()\" onfocus=\"clickfocus()\" onchange=\"clickfocus()\"  onkeypress=\"clickfocus()\" onkeyup=\"clickfocus()\" onkeydown=\"clickfocus()\" >"+"<span class=\"tabs-title\"></span>"+"<span class=\"tabs-icon\"></span>"+"</a>");
...
function clickfocus()
{
	...
	var inerhtml=document.getElementById(tab_id).innerHTML;
	var temp='"';
	var frameid=inerhtml.split(temp)[1];
	if(frameid == 'Ipd Bill Management New_iframe')
		{
		//alert('in');
		document.getElementById(inerhtml.split(temp)[1]).contentDocument.forms[0].strTariffCode.focus();
		}	
}
