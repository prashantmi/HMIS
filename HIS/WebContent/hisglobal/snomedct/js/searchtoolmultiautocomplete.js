...
function selectSNOMEDCTmulti(state_IN, semantictag_IN, acceptability_IN, returnlimit_IN, refsetid_IN,elmtid,callback)
{
	...
	elem.refsetidParam =refsetid_IN;
			...
			.autocomplete(
					{
						...
						source : function(request, response) {
							...
							servURL += "?term="
									...
									+ acceptability_IN + "&returnlimit=10"+"&refsetid="+refsetid_IN;
							console.log(servURL);
						...
						callback(ui.item.concept,elmtid);							
