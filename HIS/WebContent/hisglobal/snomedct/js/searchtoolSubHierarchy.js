...
var enumSERVICES = {
	...
	*/	
		suggestbyacceptability_url :"/AHIMSG5/snomedct/csnoserv/api/explore/alldescendents?id=609328004"
	},
};
...
function selectSNOMEDCTSubHiearchy(FIELD_ID,state_IN, semantictag_IN, acceptability_IN, returnlimit_IN,
		callback) {		
	...
	if (acceptability_IN == null
		...
		acceptability_IN = enumACCEPTABILITY.SYNONYMS;
	} 
									...
									.ajax({
										...
										success : function(data, textStatus,
											...
											response($.map(items, function (item) {
												var val=document.getElementById(FIELD_ID).value.slice(0,-(dataValue.length));
                       								return { value: val+item.term+";", concept: item };
                       							}));
										},
