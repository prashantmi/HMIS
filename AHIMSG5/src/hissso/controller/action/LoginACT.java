...
public class LoginACT extends LoginSUP
{
	...
	public String login() throws Exception
	{
		...
		//if(HISConfig.CAPTCHA_IMPLEMENTATION == "ON")
		...
		String tid=TokenHelper.getToken("token");
		System.out.println("Struts 2 Token"+ tid);
		
		//System.out.println("Condition"+ !(tid != null && tid.trim().length() > 0 && tid.equals(TokenHelper.getToken("token"))));
