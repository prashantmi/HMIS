...
public class UserMasterVO extends ValueObject
{
	...
	private String varUserBoundDefaultGender;
	...
	public String getVarUserBoundDefaultGender() {
		return varUserBoundDefaultGender;
	}

	public void setVarUserBoundDefaultGender(String varUserBoundDefaultGender) {
		this.varUserBoundDefaultGender = varUserBoundDefaultGender;
	}
