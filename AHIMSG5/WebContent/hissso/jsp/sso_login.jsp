...
<input type="password" tabindex="1" class="loginTextBox" placeholder="Enter Password"  value="" name="varPassword" maxlength="15" onkeypress="if(event.keyCode==13) submitFormOnValidate(validate(),'loginLogin');" autocomplete="off"><br>
