...
try
{
	...
	if (action != "")
	{
		query1 = query1 + " WHERE " + action + " AND"+hosCodeQry + " NOT IN("+ "'100')" + " AND "+isValCond;
	...
	{
		query1 = query1 + " WHERE " + hospitalCode + " NOT IN(" +  "100)" + " AND "+isValCond;
		query2 = query2 + " WHERE " + hospitalCode + " NOT IN(" +  "100)" + " AND "+isValCond;
		if (searchQry != "")
		{
			query1 = query1 + " AND " + searchQry;
			query2 = query2 + " AND " + searchQry;
...
<tr><%out.print(his1.HospMsttoolbar(previouspage,dataPage_width));%></tr>  		 
</table>
