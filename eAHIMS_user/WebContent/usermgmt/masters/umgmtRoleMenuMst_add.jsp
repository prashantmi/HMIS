...
<form name="form1" method="post" action="umgmtRoleMenuMst_cnt.jsp">
  ...
  <table width="100%" align="center" cellspacing="0" cellpadding="0">
	...
	<tr>
	<td class="addHeaderNew" colspan=2 align="right">Status</td>
    ...
    <tr> 
      ...
      <td class="adddatavalueNew" nowrap width='50%'> 
		...
		<!--  Code for creating the Root Menu Combo and Level Two Combo and Level three combo -->
		
		
		
 <table width="100%" align="center">  
 <tr> 		
      <td class="adddatalabel" nowrap width='33%'> 
        <div align="right"><font color='red'>*</font>Root Menu&nbsp;&nbsp;
          <select name="rootMenu"    onChange='getRootMenu(this),persist_submit("TEMP_PERSIST")'>
      ...
      <td class="adddatavalue" nowrap width='33%'> 

        <div align="center">&nbsp;&nbsp;&nbsp;&nbsp;Level 2&nbsp;&nbsp;
        <select name='levelTwo2' onChange='getLevelTwo(this),persist_submit("TEMP_PERSIST");'>
            <%=beanObj.getLevelTwoOptions()%> 
        </select>
        </div>
      </td>	
        <!--  Code for creating the Root Menu Combo and Level Three Combo -->
      <td class="adddatavalue" nowrap width='34%'> 

        <div align="left">&nbsp;&nbsp;&nbsp;&nbsp;Level 3&nbsp;&nbsp;
        <select name='levelThree3' onChange='getLevelThree(this),persist_submit("TEMP_PERSIST");'>
