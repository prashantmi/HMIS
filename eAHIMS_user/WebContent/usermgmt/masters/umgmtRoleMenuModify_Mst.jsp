...
title=request.getParameter("tile")==null?"Modify":request.getParameter("tile");
%>	
  ...
  <table width="100%" align="center">
    ...
    <tr> 		
      ...
      <td class="adddatalabel" nowrap width='50%'> 
        <div align="right"><font color='red'>*</font>Module&nbsp;&nbsp;&nbsp;&nbsp;<select name="module" onChange="submitMode('TEMP');" disabled="true" >
		   ...
		   <tr> 		
		      ...
		      <td class="adddatavalue" nowrap width='50%'> 
		       ...
		       <td class="adddatavalue" nowrap width='50%'> 
		        ...
		        <select name='levelFour4' onChange='getLevelFour(this),submitMode("TEMP_MODIFY");'>
		            <%=beanObj.getLevelFourOptionsModify()%> 
		           </select>
