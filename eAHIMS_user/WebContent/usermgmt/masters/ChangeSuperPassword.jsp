				...
				if((e.type=="click" || e.keyCode == 13))
					...
					if (hashedPass!=strLoginPass)
					...
					else
						{
							...
							document.change_pass.action="ChangeSuperPassword_cnt.jsp";
...
<table  width="97%" border="0" align='center' cellspacing="0" cellpadding="0">
	<tr width="100%"><td class="ShadedSubTitleTagImage">
		<div align="left">Change Super User Password</div>
		</td></tr>
	...
	<tr>
		<td colspan=2>
			...
			onClick='changePass(event,change_pass,"SAVE")'> <span class="save"> Save</span></a>
			<a style="cursor:pointer;"
			class="button" tabindex=5 onClick='document.change_pass.reset();'
			onkeyPress='resetForm(event,change_pass,"RESET")'><span class="clear"> Clear</span></a> 
			<a style="cursor:pointer;"	class="button" tabindex=6
