...
<xsl:template name="rangetemplate">
    ...
    <xsl:attribute name="align"><xsl:value-of select="@align"/></xsl:attribute>
        <xsl:element name="font"> 
            ...
            <xsl:for-each select="ancestor::testtemplate/table/rowDetails[@rowNo=$elementRowNo]/columnDetails[@colNo=$elementColNo]/table/tr/td/element[@originalname=$elementName]/rangetag">
