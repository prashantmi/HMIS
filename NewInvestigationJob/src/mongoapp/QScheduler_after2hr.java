...
public class QScheduler_after2hr
{
    public static void main(final String[] args) {
        final String s = null;
        final int calling_freq = 20;
        try {
            ...
            final JobDetail jobSMS = JobBuilder.newJob(QSMSJob_after2hr.class).withIdentity("job1", "group1").build();
