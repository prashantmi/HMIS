    ...
    public static void main(String args[])  {
        ...
        try {
           ...
           // System.out.println(p);
            ...
            int xmlFrequency = 20;
            int pdfFrequency = 30;
            int SMSFrequency = 60;//in sec...... in hr-6
...
// Trigger the job to run now, and then repeat every 40 seconds 
            ...
            JobDetail jobSMS = newJob(QSMSJob.class)
...
// Tell quartz to schedule the job using our trigger
         ...
         //  sched.scheduleJob(jobDeletePdf, triggerJobDeleteDuplicateReportsInMongo);
           ...
           if(PropertiesHelper.get_IS_BILLDATA_MOVE_KOPRANTBL())
			 {
           if(PGDataHelper_kpran.createPostgresConnection() == null)
           {
        	   pgFlag = false;
        	   System.out.println("Cannot connect to Postgres kopran");
           }
			 }
