...
public interface EmailConfig 
{
	...
	/*String email_username = "dispatch.hyd@nims.edu.in";
	//String email_username = "itcell.nims";
    String email_password = "CD@nims123"; 
    //String email_host="smtp.cdac.in";
    String email_host="mail.gov.in";
    String email_fromAddress="dispatch.hyd@nims.edu.in";
    //String email_fromAddress="itcell@nims.edu.in";
