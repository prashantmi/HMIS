        ...
        try {
            ...
            else
            {
                ...
                while (rs.next()) {
                	...
                	String reqdate=rs.getString(8);
                	if(countReportGen.equals(countReqDno))
                		{
                		SMSConfig objSMSConfig=new SMSConfig();
            			String   message  = "Hello "+patName.trim()+",\n"+" Your report for the Lab: "+labName+", request raised on "+reqdate+" has been successfully generated."+"\n"+" Please collect at your convenience."+"\n"+"AIIMS PATNA";
            		
            			if(addendum!=null)
            				 message  = "Hello "+patName.trim()+",\n"+" Your AMENDED-ADDENDED report for the Lab: "+labName+",request raised on "+reqdate+" has been successfully generated."+"\n"+" Please collect at your convenience."+"\n"+" AIIMS PATNA";
            			if(mobileNo!=null)
            				SMSHttpPostClient.sendSMS (mobileNo,message);
