...
public class SMSConfig 
{
   ...
   /*public static final String sms_username = "nims";//"rajmsdg-rmsc";
   public static final String sms_password = "Cd-nims123";//"cdac@2013";
   public static final String sms_senderId = "CDNIMS";//"RAJSMS";
