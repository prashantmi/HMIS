		...
		*/
		...
		var FormattedJson ={
			...
			else 
			{
				...
				$('#printPrescriptionModal .modal-body').prepend('<iframe id="printPrescFrameId" style="width:100%;height:80vh;" src="/HISDRDESK/new_opd/transaction/DoctorDeskAction.cnt?hmode=PRINTPRESCRIPTIONBOOKMARKING"></iframe>');
