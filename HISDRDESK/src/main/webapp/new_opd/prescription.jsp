...
<!-- Buttons and Image tag for Uploaded Prescriptions starts here --> 
  ...
  <img id="prescImgFixed" src=""  style="position:fixed; display:none; right:0; z-index:9998;top:0px; width:27%;height:100vh"/> <!-- /HISDRDESK/new_opd/img/pat_presc.jpg -->
                    ...
                    <div class="row"> 
                     ...
                     <div class="row">    
                        <div class="col-sm-5 col-md-5 prescriptionTileRowFirstCol ">
                        	...
                        	<button type="button" id="treeStructurePrescBtnId" class="btn btn-info treeStructurePrescBtn AddToggleClass" tabindex="0" data-toggle="tooltip" onclick="$('#TreeStructurePrescriptionModal').modal('show');" title="Patient OPD EMR">OPD EMR</button>
           ...
           <!--
              ...
              <button type="button" id="vitalModify" class="btn:hover:focus btn-sm vitalModifyBtn AddToggleClass" onclick="OpenTemplate(this)" value="49#1" tabindex="0" data-toggle="tooltip" style="margin: 5px; float:right;color:#f5f7f9;font-weight: bold;border-radius: 50%;background-color: #ff0a84;" title="" data-original-title="Other Templates">OT</button>
               ...
               <!--     <button type="button" id="vitalModify" class="btn:hover:focus btn-sm vitalModifyBtn AddToggleClass" onclick="OpenTemplate(this)" value="49#1" tabindex="0" data-toggle="tooltip" style="margin: 5px; float:right;color:#f5f7f9;font-weight: bold;background-color: #ff0a84;" title="" data-original-title="Other Templates">OT</button>  -->   
                      ...
                      <button type="button" class="btn:hover:focus btn-sm " value="48#1" onclick="OpenTemplate(this)" style="margin: 5px; float:right;color:#f5f7f9;font-weight: bold;background-color: #0fd508; " data-toggle="tooltip" title="Complaint Template">CT</button>                          
                                                </div>
...
<div class="clearfix visible-xs" style="margin-top:5px;"></div>
                  ...
                  <div class="row">
                      ...
                      <div class="form-group col-xs-12 col-md-11 col-sm-12">
                        <textarea class="form-control" onblur="abortMic(this)" id="treatmentAdviceId" name="treatmentAdvice" maxlength="2000" placeholder="Drugs should not be prescribed in this field. This is for recording general guidelines about the treatment such as Diet restrictions, physical activities, etc."></textarea>
                         <div class="micDiv">
                                 <i  class="start-btn fas fa-microphone-slash" ></i>
                                 <i  style="display:none;" class="stop-btn fas fa-microphone  blink"></i>
						</div> 
                   ...
                   <button id="externalDrugBtn" class="btn btn-info" type="button" onclick="if($('#allergiesModal').is(':visible')){$('#allergiesAddBtn').click();}
                          $('#externalDrugInput').slideToggle();$(this).find('i').toggleClass('fa-plus fa-minus');" data-toggle="tooltip" title="These drugs will not be dispensed by the Pharmacist since these Drugs are not available in the Hospital"><i class="fa fa-plus"></i> External Drug</button>
          ...
          <div id="BrandMonogramResponse"> </div>    
                 ...
                 <!--  <div class="col-xs-1 col-sm-1">
                  ...
                  <div class="prescriptionTile" style="/* padding:1% 3% 3% 3% */">
                    ...
                    <!--   <input type="button" onclick="OpenFileUpload(this)" value="File Upload"> -->
                     <div align="right"> <input type="button" class="btn btn-warning btn-sm" onclick="OpenFileUpload(this)" value="File Upload"></div><br></br>  
                     <div class="row">
                       <div class="col-sm-2">
