		...
		<table width=80%>
			<tr>
				...
				<td class="MasterXMLDataLabel">
					...
					<a style="cursor: hand">
						<img src='<his:path src="/../HIS/hisglobal/images/avai/arrow_up.gif"/>' style="cursor: pointer" width='10' height='10' border=0 alt='Ascending order' onkeypress="if(event.keyCode==13) sortOnColasc('<%=colno%>'); " onClick="sortOnColasc('<%=colno%>')" tabindex="1" >
					</a>
					<a style="cursor: hand">
						<img src='<his:path src="/../HIS/hisglobal/images/avai/arrow_down.gif"/>' style="cursor: pointer" width='10' height='10' border=0 alt='Desccending order' onkeypress="if(event.keyCode==13) sortOnColdsc('<%=colno%>'); " onClick="sortOnColdsc('<%=colno%>')" tabindex="1">
					</a>
				</td>
				<%
					}
				...
				<td>
					<his:ButtonToolBarTag>
						<logic:equal name="mstHandlerListForm" property="isActive" value="1">
							<img src='<his:path src="/../HIS/hisglobal/images/buttons/btn-add.png"/>' style="cursor: pointer;" onKeyPress="if(event.keyCode==13) add(event);" onClick='add(event);' tabindex="1">
						</logic:equal>
						<img src='<his:path src="/../HIS/hisglobal/images/buttons/btn-mo.png"/>' style="cursor: pointer;" onKeyPress="if(event.keyCode==13) edit(event);" onClick='edit(event);' tabindex="1">
						<img src='<his:path src="/../HIS/hisglobal/images/buttons/btn-del.png"/>' style="cursor: pointer;" onKeyPress="if(event.keyCode==13) del(event);" onClick='del(event);' tabindex="1">
						<img src='<his:path src="/../HIS/hisglobal/images/buttons/btn-view.png"/>' style="cursor: pointer;" onKeyPress="if(event.keyCode==13) view(event);" onClick='view(event);' tabindex="1">
						<img src='<his:path src="/../HIS/hisglobal/images/buttons/btn-rpt.png"/>' style="cursor: pointer;" onKeyPress="if(event.keyCode==13) report(event);" onClick='report(event);' tabindex="1">
						<%
