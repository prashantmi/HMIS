			...
			<tr>
				<td>
					<his:ButtonToolBarTag>
						<img style="cursor: pointer" src='<his:path src="/../HIS/hisglobal/images/buttons/btn-sv.png"/>' onKeyPress="if(event.keyCode==13) validateOnSave('MODIFYSAVE')" onClick='validateOnSave("MODIFYSAVE");' tabindex="1" />
						<img style="cursor: pointer" src='<his:path src="/../HIS/hisglobal/images/buttons/btn-ccl.png"/>' onKeyPress="if(event.keyCode==13)submitpage('CANCEL');" onClick='submitpage("CANCEL");' tabindex="1"/>
					</his:ButtonToolBarTag>
				</td>
			</tr>
		</table>
