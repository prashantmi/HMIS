			...
			<%-- <tr>
				<td>
					<div align="right" id="noPrint">
						...
						<a>
							<img src='<his:path src="/../HIS/hisglobal/images/buttons/btn-ccl.png"/>' onKeyPress="if(window.event.keyCode==13)submitpage('CANCEL');" onClick='submitpage("CANCEL");' tabindex="1">
						</a>
					</div>
				</td>
			</tr>
