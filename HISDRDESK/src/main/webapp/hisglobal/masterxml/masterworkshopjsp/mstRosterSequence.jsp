 ...
 %>
  ...
  <tr>
        <td  colspan="5" class="addtoolbar" style="border-top:outset 2px black; border-bottom:inset 2px black">	
          <div align="center">
          <logic:notEmpty name="<%=Config.ROSTER_SEQUENCE_DETAILS_ARR%>"> 
		        <a style=cursor:pointer><img src='<his:path src="/../HIS/hisglobal/images/buttons/btn-sv.png"/>' class="link"  tabindex="1"  onClick="finalSave('SAVE')" /></a>
         </logic:notEmpty>
	            <a style=cursor:pointer><img src='<his:path src="/../HIS/hisglobal/images/buttons/btn-ccl.png"/>' width="60" height="20" tabindex="0" onKeyPress="if(window.event.keyCode==13)submitpage('CANCEL');" onClick='submitpage("CANCEL");'/></a>
             </div>    
	     </td>      
