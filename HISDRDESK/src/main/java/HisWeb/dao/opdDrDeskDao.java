...
public class opdDrDeskDao {
   			...
   			map=new HashMap<String, List>();
		   		...
		   		if(map!=null)
		   		{
					...
					/*	for(int k=0;k<InvesObjArray.length();k++)
						...
						dao.setProcInValue(procIndex4, "visitno", PatCompleteGeneralDtl.split("#")[4],23);
	...
	public static String SaveAllergyData(String JsonData) {
		...
		//System.out.println("episodeCode"+object.get("episodeCode"));
             ...
             dao.setProcInValue(procIndex1, "p_allergy_type", "Patient Allergies",6);
             ...
             dao.setProcInValue(procIndex1, "p_symtom_desc", strAllergySytmptomsCode,16);
             dao.setProcInValue(procIndex1, "p_allergy_site", strAllergysiteCode,17);
