...
public class PatientVO extends ValueObject
{
	...
	//Added by Vasu on 10.Aug.2018 for patient image upload using postgresSql
	...
	public String getImageFileNameNew() {
		return imageFileNameNew;
	}

	public void setImageFileNameNew(String imageFileNameNew) {
		this.imageFileNameNew = imageFileNameNew;
	}
