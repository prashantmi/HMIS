package in.cdac.mhealth.department.business;

import in.cdac.mhealth.department.dao.DepartmentDao;
...
public class DepartmentBO {
	...
	public String getDepartments(){
		DepartmentDao objDepartmentDao = new DepartmentDao();
	 ...
	 * @throws Exception 
	 */
	public static String getDepartmentNameFromDepartmentID(String deptId, String hospId) throws Exception{
		DepartmentDao objDepartmentDao = new DepartmentDao();
