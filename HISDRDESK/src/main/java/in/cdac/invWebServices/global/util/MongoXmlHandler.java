...
public class MongoXmlHandler {
	 ...
	 private static MongoClient mongoClient;
	    ...
	    String dbName = HisUtil.getParameterFromHisPathXML("HIS_MONGOSERVER_INV_DBNAME");//HISConfig.HIS_MONGOSERVER_INV_DBNAME;
	    ...
	    public void createConnection() {
	        ...
	        if (mongoClient == null || database == null) {
	        	String connectionURI = HisUtil.getParameterFromHisPathXML("HIS_MONGOSERVER_INV_CONNECTION");//HISConfig.HIS_MONGOSERVER_INV_CONNECTION;
