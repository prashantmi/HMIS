...
public class TemplateDesignerUtility 
{
	public static class Template
	{
		...
		public static Template getTemplate(String _tempId, String _tempType, List<TemplateParameterMasterVO> _lstTempParaVO, Map<String , ParameterRangeMasterVO> _mapParaRange, InformationControlBean _infoBean, String _genderType, HttpServletRequest _request)
		{
		...
		public static Template getTemplate(String _tempId, String _tempType, List<TemplateParameterMasterVO> _lstTempParaVO, Map<String , ParameterRangeMasterVO> _mapParaRange, InformationControlBean _infoBean, String _genderType, Map<String, String> _mapParaValues, HttpServletRequest _request)
		{
			Template temp =  new Template();
			temp.templateId = _tempId;
			temp.templateType = Integer.parseInt(_tempType);
	...
	public static class Cell
	{
		...
		public void createSubTemplate(TableColumn _parent) throws Exception
		{
			...
			String tempCode= objTag.templateLogic(this.objTemplate.request, this.objTemplate.request.getSession());
			/*String path = ServletsUtilityConfig.SERVLET_DISPLAY_FILE_URL + "?" 
			+ ServletsUtilityConfig.FILE_PATH_WINDOWS + "=" + Config.GENERIC_TEMPLATE_HTML_DOCUMENT_FILE_STORAGE_PATH_WINDOWS + "&" 
			+ ServletsUtilityConfig.FILE_PATH_LINUX + "=" + Config.GENERIC_TEMPLATE_HTML_DOCUMENT_FILE_STORAGE_PATH_WINDOWS + "&" 
			+ ServletsUtilityConfig.FILE_NAME + "=" + Config.GENERIC_TEMPLATE_IMAGE_VIEW_FILE_STORAGE_NAME
