...
public class TemplateParameterMasterFB extends ActionForm
{
	...
	private String lockChk;
	private String oldIsDef;
	...
	public String getLockChk() {
		return lockChk;
	}

	public void setLockChk(String LockChk) {
		this.lockChk = LockChk;
	}

	public String getOldIsDef() {
		return oldIsDef;
	}

	public void setOldIsDef(String oldIsDef) {
		this.oldIsDef = oldIsDef;
	}
}
