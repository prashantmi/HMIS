...
public class InformationControlBean extends ActionForm
{
	...
	private String hospitalLiscenceNo;
	...
	static
	{
		...
		mpInfoDesc.put("patAdmNo", "Patient Admission No");
		...
		mpInfoDesc.put("medicalDate","Medical Date");
		mpInfoDesc.put("fitnessDate","Fitness Date");
		mpInfoDesc.put("fitnessRemarks","Fitness Remarks");
		mpInfoDesc.put("billNo","Bill No");
		mpInfoDesc.put("diagnosis","Diagnosis");
		mpInfoDesc.put("previousMcNo","Previous MC NO");
		mpInfoDesc.put("advisedDays","Advised Days");
		mpInfoDesc.put("empDept","Doctor Department");
		mpInfoDesc.put("emp_desig","Doctor Designation");
		
		// Hospital Detail
		mpInfoDesc.put("hospitalName","Hospital Name");
		mpInfoDesc.put("hospitalShortName","Hospital Short Name");
		mpInfoDesc.put("hospitalAddress1","Hospital Address Line 1");
		mpInfoDesc.put("hospitalAddress2","Hospital Address Line 1");
		mpInfoDesc.put("hospitalFax","Hospital Fax");
		mpInfoDesc.put("hospitalLiscenceNo","Hospital Liscence No");
	}
	...
	public void putDataInInfoBean(ValueObject _vo)
	{
		...
		else if(_vo instanceof PatMedicalDtlVO)
			putFitnessCertDetailValues((PatMedicalDtlVO)_vo);
		else if(_vo instanceof HospitalMstVO)
			putHospitalDetailValues((HospitalMstVO)_vo);
	}
	...
	public void putPatientDetailValues(PatientDetailVO _vo)
	{
		...
		if(_vo.getPatAdmNo()!=null) this.setPatAdmNo(_vo.getPatAdmNo());
		if(_vo.getAdmDateTime()!=null) this.setAdmissionDate(_vo.getAdmDateTime());
		if(_vo.getDisDateTime()!=null) this.setDischargeDate(_vo.getDisDateTime());
	}
	...
	public void putFitnessCertDetailValues(PatMedicalDtlVO _vo)
	{
		if(_vo.getGdt_entry_date()!=null) this.setCertificateDate(_vo.getGdt_entry_date());
		if(_vo.getMedicalCertificateId() != null) this.setCertificateNo(_vo.getMedicalCertificateId() );		
		if(_vo.getPatName() != null) this.setPatientName(_vo.getPatName());
		if(_vo.getPatOrganisation() != null) this.setPatientOrganisation(_vo.getPatOrganisation() );
		if(_vo.getBillNo() != null) this.setBillNo(_vo.getBillNo());
		if(_vo.getCertificateId() != null) this.setCertificateNo(_vo.getCertificateId() );
		if(_vo.getDiagnosis() != null) this.setDiagnosis(_vo.getDiagnosis() );
		if(_vo.getRemarks() != null) this.setFitnessRemarks(_vo.getRemarks() );
		if(_vo.getFromDate() != null) this.setFromDate(_vo.getFromDate() );
		if(_vo.getToDate() != null) this.setToDate(_vo.getToDate() );
		if(_vo.getPreviousMcNo() != null) this.setPreviousMcNo(_vo.getPreviousMcNo() );
		if(_vo.getAdviceDays() != null) this.setAdvisedDays(_vo.getAdviceDays() + " Days" );
		if(_vo.getSurgery() != null) this.setProcedureName(_vo.getSurgery() );
		if(_vo.getFitnessDate()!= null) this.setFitnessDate(_vo.getFitnessDate() );
		if(this.getPreviousMcNo()!=null && (!this.getPreviousMcNo().equals("")))
		{
			if(_vo.getGdt_entry_date()!=null) this.setEntryDate(_vo.getGdt_entry_date());
		}
		
		if(_vo.getEmpDesig()!=null) this.setConsultantDesignation(_vo.getEmpDesig());
		if(_vo.getEmp_dept()!=null) this.setEmp_dept(_vo.getEmp_dept());
		if(_vo.getAdvisedBy()!=null) this.setConsultantName(_vo.getAdvisedBy() + "(" + _vo.getEmp_dept() + ")");
		
				
	}

	public void putHospitalDetailValues(HospitalMstVO _vo)
	{
		if(_vo.getHospitalName()!=null) this.setHospitalName(_vo.getHospitalName());
		if(_vo.getHospitalShortName()!=null) this.setHospitalShortName(_vo.getHospitalShortName());
		if(_vo.getAddress1()!=null) this.setHospitalAddress1(_vo.getAddress1());
		if(_vo.getAddress2()!=null)	this.setHospitalAddress2(_vo.getAddress2());
		if(_vo.getLiscenceNo()!=null)	this.setHospitalLiscenceNo(_vo.getLiscenceNo());
		if(_vo.getFax()!=null)	this.setHospitalFax(_vo.getFax());
	}
	...
	public String getFitnessRemarks() {
		return fitnessRemarks;
	}

	public void setFitnessRemarks(String fitnessRemarks) {
		this.fitnessRemarks = fitnessRemarks;
	}
	...
	public String getHospitalLiscenceNo() {
		return hospitalLiscenceNo;
	}

	public void setHospitalLiscenceNo(String hospitalLiscenceNo) {
		this.hospitalLiscenceNo = hospitalLiscenceNo;
	}
	...
	public String getAdvisedDays() {
		return advisedDays;
	}

	public void setAdvisedDays(String advisedDays) {
		this.advisedDays = advisedDays;
	}
