...
public class DeskDetailVO extends ValueObject
{
	...
	private String deskUrlType;
	private String deskMenuImg;
	private String count; // for changing menu color if count>0 
	private String isToAddCount; // for changing menu count if count>0
	private String menuExtUrl; // for ext URL
	...
	public String getIsToAddCount() {
		return isToAddCount;
	}

	public void setIsToAddCount(String isToAddCount) {
		this.isToAddCount = isToAddCount;
	}

	public String getDeskUrlType() {
		return deskUrlType;
	}

	public void setDeskUrlType(String deskUrlType) {
		this.deskUrlType = deskUrlType;
	}

	public String getMenuExtUrl() {
		return menuExtUrl;
	}

	public void setMenuExtUrl(String menuExtUrl) {
		this.menuExtUrl = menuExtUrl;
	}
}
