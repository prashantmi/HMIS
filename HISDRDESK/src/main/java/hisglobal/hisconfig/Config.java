...
public interface Config {
	...
	// **** Storage Paths ************************************************
	// Registration
	String PATIENT_IMAGE_FILE_STORAGE_PATH = "C:/PHDM/HISDRDESK/PatientImages";
	String PATIENT_IMAGE_FILE_STORAGE_PATH_LINUX = "/PHDM/HISDRDESK/PatientImages";
	String MLC_DOC_IMAGE_FILE_STORAGE_PATH = "c:/PHDM/HISDRDESK/MlcDocImages";
	String MLC_DOC_IMAGE_FILE_STORAGE_PATH_LINUX = "/PHDM/HISDRDESK/MlcDocImages";
	...
	String IMAGE_EDITOR_EXAMINATION_PATIENTS_IMAGES_PATH_WINDOWS = "C:/PHDM/HISDRDESK/PatientExaminationEditorImageDIR";
	...
	String IMAGE_EDITOR_EXAMINATION_PATIENTS_IMAGES_PATH_LINUX = "/PHDM/HISDRDESK/PatientExaminationEditorImageDIR";
	...
	// Document Upload
	String OPD_DOCUMENT_FILE_STORAGE_PATH_WINDOWS = "C:/PHDM/HISDRDESK/PatDocumentUploadFiles";
	String OPD_DOCUMENT_FILE_STORAGE_PATH_LINUX = "/PHDM/HISDRDESK/PatDocumentUploadFiles";
	...
	// Image Editor
	String IMAGE_EXAMINATION_IMAGE_PATH_WINDOWS = "C:/PHDM/HISDRDESK/ImageExaminationFiles";
	String IMAGE_EXAMINATION_IMAGE_PATH_LINUX = "/PHDM/HISDRDESK/ImageExaminationFiles";
	...
	String OPD_AUDIO_VIDEO_STORAGE_PATH_WINDOWS = "C:/PHDM/HISDRDESK/AudioVideoPlayerFiles";
	String OPD_AUDIO_VIDEO_STORAGE_PATH_LINUX = "/PHDM/HISDRDESK/AudioVideoPlayerFiles";

	// Generic Template
	String GENERIC_TEMPLATE_HTML_DOCUMENT_FILE_STORAGE_PATH_WINDOWS = "C:/PHDM/HISDRDESK/GenericTemplateDIR";
	String GENERIC_TEMPLATE_HTML_DOCUMENT_FILE_STORAGE_PATH_LINUX = "/PHDM/HISDRDESK/GenericTemplateDIR";
	...
	String PATIENT_PROFILE_STORAGE_PATH_WINDOWS = "C:/PHDM/HISDRDESK/PatientProfileDIR";
	String PATIENT_PROFILE_STORAGE_PATH_LINUX = "/PHDM/HISDRDESK/PatientProfileDIR";
	String PATIENT_PROFILE_FILE_STORAGE_EXT = ".htm"; // concatenated with
														// Patient Profile Id

	// /Mortuary Patient Image
	String MORTUARY_PATIENT_IMAGE_PATH_WINDOWS = "C:/PHDM/HISDRDESK/Mortuary";
	String MORTUARY_PATIENT_IMAGE_PATH_LINUX = "/PHDM/HISDRDESK/Mortuary";
	...
	String DISASTER_PLAN_STORAGE_PATH_WINDOW = "C:/PHDM/HISDRDESK/DisasterPlan";
	String DISASTER_PLAN_STORAGE_PATH_LINUX = "/PHDM/HISDRDESK/DisasterPlan";
