...
public class GlobalEssentialDelegate extends Delegate
{
	...
	public Map getPatientAuditLogDataList(List<PatientAuditLogMstVO> patientAuditLogVOList,
			String patCrNo, UserVO userVO) {
		GlobalEssentialBOi serviceBO = (GlobalEssentialBOi) super.getServiceProvider();
		return (serviceBO.getPatientAuditLogDataList(patientAuditLogVOList,patCrNo,userVO));
	}
