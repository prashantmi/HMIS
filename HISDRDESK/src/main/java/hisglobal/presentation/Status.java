...
public class Status
{
	...
	public final static String IMAGE_UPLOAD_FAILED = "013"; // Added by Saurabh on sept-6,2017
	...
	public final static Entry IMAGEUPLOADERROR = new Entry("", Status.IMAGE_UPLOAD_FAILED); // Added by Saurabh on sept-6,2017
