...
import appointment.AppointmentConfig;
import appointment.transactions.controller.util.AppointmentProcessUTIL;
import appointment.usefulmethods.StartAppointmentListner;
...
public class AppointmentTag extends TagSupport 
{
	...
	public int doStartTag() throws JspException
	{
		...
		try
		{
			...
			String tempCode=AppointmentProcessUTIL.MakeAppointmentTag(servletContext,request,crno,aptId,paraId1,paraId2,paraId3,paraId4,paraId5,paraId6,paraId7,tagId,cssClassName);
