...
function validate()
{
	var hisValidator = new HISValidator("consolidatedDisDtlRpt");
...
{
	var sdValues = [];
    //document.forms[0].strHospitalCode.multiple=false;
...
{
	var mode = "TARIFFNAME";
	var url = "ConsolidatedDiscountDtlRptCNT.cnt?hmode="+mode+"&groupId="+document.forms[0].strGroupTariffId.value;
	ajaxFunction(url,"1");		
}
...
<html:form action="/reports/ConsolidatedDiscountDtlRptCNT.cnt" method="post">
	<div class="errMsg" id="errMsg"><bean:write name="consolidatedDisDtlRpt" property="strErrMsg"/></div>
<div class="normalMsg" id="normalMsg"></div>

	<tag:tab tabLabel="Consolidated Discount Detail"
                        selectedTab="FIRST" align="center" width="TABLEWIDTH">
                  </tag:tab>

	<table class="TABLEWIDTH" align="center" cellspacing="1px" cellpadding="1px">   
		<tr class="HEADER">
				<td colspan="2">Consolidated Discount Detail</td>
			</tr>
			<tr >
	    <td class="LABEL" colspan="2">
		    <div align="right">
			    <html:radio property="strCase" name="consolidatedDisDtlRpt" value="1" onclick="getCombo(this);" >Patient Category</html:radio>
			    <html:radio property="strCase" name="consolidatedDisDtlRpt" value="2" onclick="getCombo(this);" >Date</html:radio>
			    <html:radio property="strCase" name="consolidatedDisDtlRpt" value="3" onclick="getCombo(this);" >Group Wise</html:radio>
			    <html:radio property="strCase" name="consolidatedDisDtlRpt" value="4" onclick="getCombo(this);" >Tariff Wise</html:radio>		  
		    </div>
	    </td>
	 	 </tr>
	 	 ...
	 	 <tr>
				...
				<div id='selectedResult'>			
					...
					<bean:write name="consolidatedDisDtlRpt" property="strHospNameValues" filter="false"/>
					</select>
				</div>
				</td>			
		</tr>
		<tr> 
		    ...
		    <td width="50%" class="CONTROL"><select name="strHospSerName" class="comboNormal" >
		        <bean:write name="consolidatedDisDtlRpt" property="strHospSerValues" filter="false"/></select> </td>
	  	</tr>
 	</table>	
  ...
  <table class="TABLEWIDTH" align="center" cellspacing="1px" cellpadding="1px" >  
	  <tr> 
	    ...
	    <td width="50%" class="CONTROL"><select name="strTreatCatName" class="comboNormal" >
	        <bean:write name="consolidatedDisDtlRpt" property="strTreatCatValues" filter="false"/></select>        
	         </td>
	  </tr>
  </table>
  </div>
  ...
  <div id="grpWiseDivId" style="display:none">
	<table class="TABLEWIDTH" align="center" cellspacing="1px" cellpadding="1px" >  
 	  <tr> 
	    ...
	    <td width="50%" class="CONTROL"><select name="strGroupId" class="comboNormal" >
	        <bean:write name="consolidatedDisDtlRpt" property="strGroupNameVal" filter="false"/></select> </td>
  	  </tr>
  	</table>
  </div>
   ...
   <div id="trfWiseDivId" style="display:none">
	<table class="TABLEWIDTH" align="center" cellspacing="1px" cellpadding="1px" >  
 	 <tr> 
	    <td width="50%" class="LABEL">Group Name</td>
	    <td width="50%" class="CONTROL"><select name="strGroupTariffId" class="comboNormal" onchange="ajaxTariffName();">
	        <bean:write name="consolidatedDisDtlRpt" property="strGroupTariffVal" filter="false"/></select> </td>
  	 </tr>  
  	 <tr> 
	    <td width="50%" class="LABEL">Tariff Name</td>
	    <td width="50%" class="CONTROL"><div id="tariffId"><select name="strTariffId" class="comboNormal" >
		...
		<table class="TABLEWIDTH" align="center" cellspacing="1px" cellpadding="1px">  
  		<tr>
			...
			<td width="50%" class="CONTROL"><dateTag:date name="strEffectiveFrom"
				value="${consolidatedDisDtlRpt.strCurrentDate}" /></td>
		</tr>
		<tr>
  ...
  <table class="TABLEWIDTH" align="center" cellspacing="1px" cellpadding="1px">   
		...
		<tr>
			...
			<td width="50%" class="CONTROL">
			<html:checkbox property="strIsFooter" name="consolidatedDisDtlRpt" value="1"></html:checkbox>
			</td>			
		</tr>
		<tr>
...
<input type="hidden" name="strCurrentDate" value="${consolidatedDisDtlRpt.strCurrentDate}"/>
<input type="hidden" name="strHospitalCodes" value="${consolidatedDisDtlRpt.strHospitalCodes}"/>
</html:form>
