...
function validate1(){   
      ...
      var hisValidator = new HISValidator("unitvalueBean");
            ...
            hisValidator.addValidation("convertedValue", "amount=7,3", "Converted Value should be less than 10000 and decimal digits can be upto 3,eg: 0000.000" );
...
<body >
<html:form name="unitvalueBean" action="/masters/CNTUnitValueMst" type="billing.masters.VOUnitValueMst">
...
<table CLASS ="TABLEWIDTH" align ="center" cellpadding="1px" cellspacing="1px">
  ...
  <td class ="CONTROL"><date:date name="effectiveFrom" value ="${unitvalueBean.effectiveFrom}"></date:date></td>
   </tr>
