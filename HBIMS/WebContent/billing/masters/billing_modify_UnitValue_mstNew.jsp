   ...
   <div class="row">
				<div class="col-sm-9" align="left">
							<p class="subHeaders" style="margin-bottom: 0;">
								<i class="fas fa-university" style="font-size: 26px;">&nbsp;</i>Unit Value Master&nbsp;&nbsp;<i class="fas fa-angle-double-right"></i>&nbsp;Modify										</p>
				       </div>
							...
							<div class="legendNew" id="nonPrintableLegend2">
									...
									<button type="button" id="savebutton" class="float-right btn btn-outline-success mt-1 btn-circle" tabindex="2" onclick=' return validate2();' style="background-color: #5cb85c;">
		...
		<div class="row">
		<div class="col-sm-2">
		<label><font color="red">*</font>Module  Name</label>
		</div>
		<div class="col-sm-2">
		<input type="text" class="form-control" name="strmoduleName" value ="${unitvalueBean.strmoduleName}" readonly>
		</div>
		<div class="col-sm-2">
		<label><font color="red">*</font>From Unit</label>
		</div>
		<div class="col-sm-2">
		<input type="text" class="form-control" name="strfromUnit" value ="${unitvalueBean.strfromUnit}" readonly>
		</div>
		<div class="col-sm-2">
		<label><font color="red">*</font>To Unit</label>
		</div>
		<div class="col-sm-2">
		<input type="text" class="form-control" name="strtoUnit" value ="${unitvalueBean.strtoUnit}" readonly>
		</div>
		</div>
		
		<div class="row">
		<div class="col-sm-2">
		<label><font color="red">*</font>Converted Value</label>
		</div>
		<div class="col-sm-2">
		<input type="text" class="form-control" name="strconvertedValue" value ="${unitvalueBean.strconvertedValue}" maxlength="10" onKeypress ='return validateData(event,7);'>
		</div>
		<div class="col-sm-2">
		<label><font color="red">*</font>Effective From</label>
		</div>
		<div class="col-sm-2">
		<%-- <date:date name="streffectiveFrom" value ="${unitvalueBean.streffectiveFrom}"></date:date> --%>
		<input  type="text" class="form-control datepicker" name="streffectiveFrom" value ="${unitvalueBean.streffectiveFrom}">
	
		</div>
		<div class="col-sm-2">
		<label><font color="red">*</font>Record Status</label>
		</div>
		<div class="col-sm-2">
    ...
    <html:radio name="unitvalueBean" property="strisValid" value="2" />Inactive
		...
		<div class="col-sm-6">
		<textarea name="strremark" cols="20" rows="2" class="form-control"
				id="remarks"><bean:write name="unitvalueBean" property="strremark"/></textarea>
		</div>
