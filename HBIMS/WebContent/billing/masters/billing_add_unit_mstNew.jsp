...
<script type="text/javascript">
	...
	function myFunc()
	{
		...
		var url = "BSCNTUnitMst.cnt?hmode="+mode+"&modName="+document.forms[0].strModuleVal.value;
		ajaxFunction(url,"1");
	}
   ...
   <div class="row">
				<div class="col-sm-9" align="left">
							<p class="subHeaders" style="margin-bottom: 0;">
								<i class="fas fa-university" style="font-size: 26px;">&nbsp;</i>Unit Master&nbsp;&nbsp;<i class="fas fa-angle-double-right"></i>&nbsp;Add										</p>
				       </div>
							...
							<div class="legendNew" id="nonPrintableLegend2">
									...
									<button type="button" class=" btn btn-secondary btn-circle" onclick="document.forms[0].reset(),document.forms[0].strUnitName.focus();" style="background: #b9b9b9; border-color: #b9b9b9; margin-top: 0.25rem !important;">
	...
	<div class="col-sm-2">
	<input name="strUnitName" class="form-control" type="text"  onkeypress="return validateData(event,17);"
				id="unitName" maxlength="25">
	</div>
	<div class="col-sm-2">
	<label>Whether Base Unit</label>
	</div>
	<div class="col-sm-2" align="right">
	<input name="strIsBaseUnit" type="checkbox" class="form-control"
				id="isBaseUnit" value="0" onclick="unitDisable()">
	</div>
	</div>
	
	<div class="row">
	<div class="col-sm-2">
	<label><font color="red">*</font>Base Unit</label>
	</div>
	<div class="col-sm-2">
	<div id="baseUnitId"><select name="strBaseUnit" id="baseUnit" class="form-control">
	...
	<div class="col-sm-2">
	<%-- <dateTag:date name="strEffectiveDate" id="effDateId" value="${unitBean.strCtDate}"/> --%>
	<input  type="text" class="form-control datepicker" name="strEffectiveDate" id="effDateId" value="${unitBean.strCtDate}">
