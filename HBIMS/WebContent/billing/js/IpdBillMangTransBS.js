	  ...
	  */
	  function getSpecialWardDtls() 
	  {
	 	  	if(document.forms[0].strDepartment!=undefined)
	 	  	{
				...
				var url = "IpdBillManagementTransBSCNT.cnt?hmode="+hmode+"&strDept="+deptId;																
				ajaxFunction(url,"17");
	 	  	}	  	
	  }
...
{	  	
  		...
  		var url = "IpdBillManagementTransBSCNT.cnt?hmode="+hmode+"&strUnit="+deptId;
	  	...
	  	if(e.keyCode == 13 && document.forms[0].strTariffCode.value.length > 0)
	  	{
			var hmode = "TARIFFCODEDTLS"; 
		 	var treatCat = "0";
	  		...
	  		var url = "IpdBillManagementTransBSCNT.cnt?hmode="+hmode+"&groupId="+document.forms[0].strOffLineGroup[document.forms[0].strOffLineGroup.selectedIndex].value+"&hService=2"+"&treatmentCat="+treatCat+"&ward="+wardType+"&tariffCode="+document.forms[0].strTariffCode.value+"&strEndDate="+document.forms[0].strEndDate.value;
	 ...
	 */
	 function setPartPaymentAmount() {
	 	...
	 	var hmode = "PARTPAYMENTAMTDTL"; 
			...
			var url = "IpdBillManagementTransBSCNT.cnt?hmode="+hmode+"&treatmentCat="+treatCat+"&ward="+wardType;
	 ...
	 */
	  ...
	  */
	  function getDefaultTariffList() {
			...
			var url ="IpdBillManagementTransBSCNT.cnt?hmode="+hmode+"&hService=2&treatmentCat="+treatCat+"&ipdCharge="+wardType+"&ward="+splWardType+"&startDate="+document.forms[0].strStartDate.value+"&endDate="+document.forms[0].strEndDate.value+"&wardType="+wardType;
	 ...
	 */
	 function getPreviousDetails(dateObj) {
	 	...
	 	if(dateObj.value != 0){
			...
			var url ="IpdBillManagementTransBSCNT.cnt?hmode="+hmode+"&strAccNo="+accNo+"&strPreviousDates="+dateRang;
	 ...
	 */
	 function deletePreviousDtls() {
	 		...
	 		if(confirm("Are You Sure to Modify the Selected Record(s)?")){
				...
				var url ="IpdBillManagementTransBSCNT.cnt?hmode="+hmode+"&strPreviousVals="+prevValues;
...
/*-------------------Ajax Function For Bill Approval ---------------------*/
 ...
 { 
     ...
     var url="IpdBillManagementTransBSCNT.cnt?hmode="+mode+"&modName="+modeVal;
     ajaxFunction(url,"13");
	...
	if((parseInt(strCatGrp)==4 || parseInt(strCatGrp)==3) && parseInt(strTariffNetAmt) > parseInt(strSancAmt)+(- parseInt(strRecievedAmount)) )
	{
		...
		if(retVal)
		{
			...
			/*	 if(document.forms[0].dosssetstat.value>0) {
					 alert("Bill can't be finalized since DossierSettlement is pending"); 
					 return false;
				 }*/
				...
				{	
					...
					confirmBS("Please Verify Amount As\nRecieved:="+totalDeposit+"\nExpenditure:="+gtExp+"\nDiscount:="+disAmt+"\nBalance:="+bal,"","2")
	...
	// COMMENTED AFTER SINGLE SCREEN SUGGESSTIONS IN NIMS UAT CLOSURE  22092017 BY AMIT ATERIA
	   ...
	   // alert("value="+document.forms[0].serviceFlag.value);
		...
		{						
					...
					/*}*/		
				/*	date logic will be changed as per the date columns are changed	
				...
				var amt = parseFloat(document.getElementsByName("strAccountBalanceAmt")[0].value) + parseFloat(document.forms[0].totalRecAmtDivId1.value);
			...
			if(document.forms[0].strCatGrp.value==4 )
			   {
				...
				confirmBS("Are You Sure to Save it?","","0");
...
{  
	...
	if(temp[17] !='1')
	{
        ...
        if(tempCode == 222){
			...
			var url = "IpdBillManagementTransBSCNT.cnt?hmode="+hmode+"&groupId="+document.forms[0].strOffLineGroup[document.forms[0].strOffLineGroup.selectedIndex].value+"&hService=2"+"&treatmentCat="+treatCat+"&ward="+wardType+"&searchLetter="+obj.value+"&strEndDate="+document.forms[0].strEndDate.value;
	...
	/**
		 ...
		 */
		 function getOffLineTariffUnit(unitId,baseValue,index) 
		 {
		    ...
		    var url="IpdBillManagementTransBSCNT.cnt?hmode="+hmode+"&modName="+modeVal;
			ajaxFunction(url,"10");
			}else{
...
function ftn20(obj)
 ...
 {	
	...
	if(flg == '0')
	{
		...
		var url="IpdBillManagementTransBSCNT.cnt?hmode="+mode+"&accNo="+accNo+"&grpId="+grpId;
		ajaxFunction(url,"11");		
	}
	else
	{		
...
{ 
   var mode="UNITVAL1";
   var url="IpdBillManagementTransBSCNT.cnt?hmode="+mode+"&modName="+document.forms[0].strHospitalServiceCombo.value;
   ajaxFunction(url,"3");
...
function getCombo(mode)
{
  ...
  {
   var mode="UNITVAL";
   var url="IpdBillManagementTransBSCNT.cnt?hmode="+mode+"&modName="+document.forms[0].strGroupNameCombo.value;
...
{ 
 ...
 if(retVal)
  ...
  if(mode=="VIEWGO")
  {
    ...
    var mode="VIEWGO";
    var url="IpdBillManagementTransBSCNT.cnt?hmode="+mode+"&modName="+modeName;
    ajaxFunction(url,"2");
  }
 }
}
function getAjaxResponse(res,mode)
{
    ...
    { 
       ...
       // objVal.innerHTML = rateVal[0];
        document.getElementById("procUnprocDtlBody").innerHTML= rateVal[0];
 ...
 //if(e.keyCode == 13 && document.forms[0].strTariffCode.value.length > 0)
 	...
 	if(e.keyCode == 13 && obj.value.length > 0)
 	{
	    ...
	    //alert(document.forms[0].strSpecialWardType.value);
 		...
 		{
 			url= "IpdBillManagementTransBSCNT.cnt?hmode="+hmode+"&groupId="+document.forms[0].strOffLineGroup[document.forms[0].strOffLineGroup.selectedIndex].value+"&hService=2"+"&treatmentCat="+treatCat+"&ward="+temp1+"&tariffCode="+obj.value+"&strNumRows="+document.forms[0].strNumRows.value+"&strCurrindex="+-1+"&wardCode="+document.forms[0].strSpecialWardType.value;
 		...
 		{
 			url= "IpdBillManagementTransBSCNT.cnt?hmode="+hmode+"&groupId="+document.forms[0].strOffLineGroup[document.forms[0].strOffLineGroup.selectedIndex].value+"&hService=2"+"&treatmentCat="+treatCat+"&ward="+temp1+"&tariffCode="+obj.value+"&strNumRows="+document.forms[0].strNumRows.value+"&strCurrindex="+index+"&wardCode="+document.forms[0].strSpecialWardType.value;
 			document.forms[0].strCurrentRowIndex.value=index;
 			document.forms[0].strCurrentRowTrfCode.value=obj.value;
 			alert(url);
 			ajaxFunction(url,"25");
...
{	
		...
		{	
			...
			confirmBS("Are You Sure to Save it? \n After Save No Modification Allowed","","1");
...
/*	if(document.getElementById("detailsdivid3")!=undefined){
		if(document.getElementById("detailsdivid3").innerHTML!="")
			document.getElementById("detailsdivid3").style.display = "";
		else
...
function checkmore(){
	if(document.getElementById("chkmore").value=="0"){
		document.getElementById("chkmore").value="1"
		document.getElementById("detailsdivid3").style.display="";
	}else{
		document.getElementById("detailsdivid3").style.display="none";
		document.getElementById("chkmore").value="0"
	}
