// Global Vaiables
	...
	function goFunc()
	{
		...
		{
			var hisValidator = new HISValidator("CreditLetterTransBean");  
...
//Reset To Cash
		...
		if(document.forms[0].strOfflinePaymentMode!=undefined)
		{
			...
			for(i=0; i<paymentMode.options.length;i++)
			{
				...
				//	alert("no mode onLoad");
					document.getElementsByName("strOfflinePaymentMode")[0].value="1";
				}
			}			
		}			
	 }
	...
	{		
		...
		alert(document.forms[0].strCatgoryCode.value);
}
...
function showNormalMsg()
{
	 ...
	 */
	 ...
	 {	 		 	
	 		...
	 		{	 			
	 			var hmode = "REPRINT"; 
				var url = "CreditLetterHandlingCNT.cnt?hmode="+hmode;											
	 		...
	 		else
	 		{
				...
				var url = "CreditLetterHandlingCNT.cnt?hmode="+hmode+"&billNo="+billNo+"&recNo="+recNo;
	...
	function getBillService(){
	 ...
	 alert( document.forms[0].strOffLineBillingService[document.forms[0].strOffLineBillingService.selectedIndex].value);	 
	 	...
	 	if(document.forms[0].currentReceiptType.value == '2'){
			...
			var hmode = "BILLDTLS"; 
			var url = "CreditLetterHandlingCNT.cnt?hmode="+hmode+"&hService="+document.forms[0].strOffLineHospitalService[document.forms[0].strOffLineHospitalService.selectedIndex].value+"&requestType="+document.forms[0].strOffLineRequestType[document.forms[0].strOffLineRequestType.selectedIndex].value;
	...
	function getEpisodeList(obj){
			...
			//var url = "CreditLetterHandlingCNT.cnt?hmode="+hmode+"&crNo="+document.forms[0].strCrNo.value+"&deptCode="+obj.value;
			var url = "CreditLetterHandlingCNT.cnt?hmode="+hmode+"&crNo="+document.forms[0].strCrNo.value+"&deptCode="+obj.value;
...
function getPartAccDtls(obj)
{
	...
	if(document.forms[0].strOffLineHospitalService[document.forms[0].strOffLineHospitalService.selectedIndex].value == 2)
	{
		...
		var url = "CreditLetterHandlingCNT.cnt?hmode="+hmode+"&hService="+document.forms[0].strOffLineHospitalService[document.forms[0].strOffLineHospitalService.selectedIndex].value+"&requestType="+document.forms[0].strOffLineRequestType[document.forms[0].strOffLineRequestType.selectedIndex].value+"&billService="+bServiceId+"&treatmentCat="+document.getElementsByName("strOffLineTreatmentCategory")[0].value+"&ward="+wardId+"&strCrNo="+document.forms[0].strCrNo.value+"&strSplWard="+splWardId;
		ajaxFunction(url,"4");
	}
	else
	{
	...
	{
		var hmode = "GROUPDTLS"; 
		var url = "CreditLetterHandlingCNT.cnt?hmode="+hmode+"&hService="+document.forms[0].strOffLineHospitalService[document.forms[0].strOffLineHospitalService.selectedIndex].value+"&withPack=0&catCode="+document.forms[0].strOffLineTreatmentCategory.value+"&strCrNo="+document.forms[0].strCrNo.value;		
		ajaxFunction(url,"5");
	}
	...
	{	
		...
		var url = "CreditLetterHandlingCNT.cnt?hmode="+hmode+"&crNo="+document.forms[0].strCrNo.value+"&hService="+document.forms[0].strOffLineHospitalService[document.forms[0].strOffLineHospitalService.selectedIndex].value;		
		ajaxFunction(url,"6");
	}
...
//alert("val : "+obj.value);
	...
	if(obj.value.length >= 1 && obj.value.length <= 3 && trfPreviousData != previousDate)
	{
		...
		{		
			...
			url = "CreditLetterHandlingCNT.cnt?hmode="+hmode+"&groupId="+document.forms[0].strOffLineGroup.value+"&hService="+document.forms[0].strOffLineHospitalService.value+"&treatmentCat="+treatmentCat+"&ward="+wardIdVal+"&searchLetter="+obj.value+"&bService="+document.forms[0].strOffLineBillingService.value;	 
		}
		else
		{
			var treatmentCat=document.forms[0].strOffLineTreatmentCategory[document.forms[0].strOffLineTreatmentCategory.selectedIndex].value.split('^')[0]; 
			url = "CreditLetterHandlingCNT.cnt?hmode="+hmode+"&groupId="+document.forms[0].strOffLineGroup.value+"&hService="+document.forms[0].strOffLineHospitalService.value+"&treatmentCat="+treatmentCat+"&ward=0"+"&searchLetter="+obj.value;
		}
	...
	function getOffLinePkgsGroupDtls(){
		...
		var hmode = "PKGGROUPDTLS"; 
			var url = "CreditLetterHandlingCNT.cnt?hmode="+hmode+"&hService="+document.forms[0].strOffLineHospitalService[document.forms[0].strOffLineHospitalService.selectedIndex].value+"&withPack=1";
	...
	function getOffLinePkgConfigDetails(index){
		...
		var hmode = "PKGDTLS"; 
			var url = "CreditLetterHandlingCNT.cnt?hmode="+hmode+"&rowIndex="+index;
	...
	/**
		 ...
		 */
		 function getOffLineTariffUnit(unitId,baseValue,index) {
		 	...
		 	var hmode = "TRFUNIT"; 
			var url = "CreditLetterHandlingCNT.cnt?hmode="+hmode+"&unitId="+unitId+"&baseValue="+baseValue+"&rowIndex="+index;
	 ...
	 */
	 function getOffLineRefundBillDetails() {
	 	...
	 	var hmode = "REFUNDBILLDTLS"; 
			var url = "CreditLetterHandlingCNT.cnt?hmode="+hmode+"&crNo="+document.forms[0].strCrNo.value+"&chargeType="+document.forms[0].strOffLineHospitalService[document.forms[0].strOffLineHospitalService.selectedIndex].value+"&accNo="+accNo;
	 ...
	 */
	 function getBillTariffDtls(obj) {
	 	...
	 	var hmode = "REFUNDBILLTARIFFDTLS"; 
			var url = "CreditLetterHandlingCNT.cnt?hmode="+hmode+"&billNo="+tempVal[0]+"&accNo="+tempVal[4]+"&hospService="+document.forms[0].strOffLineHospitalService[document.forms[0].strOffLineHospitalService.selectedIndex].value;
	 ...
	 */
	  ...
	  */
	  function showTariffPopup(obj,hidVal) {
	  	...
	  	var hmode = "REFUNDBILLTARIFFPOPUPDTLS"; 
			var url = "CreditLetterHandlingCNT.cnt?hmode="+hmode+"&hidValue="+hidVal;
	 ...
	 function showReconcilPopup(hidVal,parentPos){
			...
			var url = "CreditLetterHandlingCNT.cnt?hmode="+hmode+"&hidVal="+hidVal;
	 ...
	 */
	  ...
	  */
	  function initOfflineTreatmentCategory() {
	  	 ...
	  	 var chargeTypeId = document.forms[0].strOffLineHospitalService[document.forms[0].strOffLineHospitalService.selectedIndex].value;
			...
			var url = "CreditLetterHandlingCNT.cnt?hmode="+hmode+"&strChargeTypeId="+chargeTypeId+"&strCrNo="+crNo+"&strTreatCat="+treatCat;
	  ...
	  */
	  function initOfflineWard() {
			...
			var url = "CreditLetterHandlingCNT.cnt?hmode="+hmode+"&strChargeTypeId="+chargeTypeId+"&strCrNo="+crNo+"&strWard="+strWard;
	  ...
	  */
	  function getSpecialWardDtls(deptId) {
			...
			var url = "CreditLetterHandlingCNT.cnt?hmode="+hmode+"&strDept="+deptId;
...
function getAjaxResponse(res,mode)
{
	...
	if(mode == '4')
	{
		...
		{				
				var temp = res.split("####");
				document.getElementById("groupDivId").innerHTML = "<table border='0' cellpadding='0' cellspacing='0'><tr><td class='TITLE'>Group </td><td class='TITLE'><select name='strOffLineGroup' class='comboMax' onchange='resetTariffs();'>"+temp[0]+"</select></td></tr></table>";
	  ...
	  */
	  ...
	  {	  
	  	if(e.keyCode == 13 && document.forms[0].strTariffCode.value.length > 0)
	  	{
			...
			{
				var wardIdVal = document.forms[0].strOffLineWard[document.forms[0].strOffLineWard.selectedIndex].value.split('^')[0];	
				 url = "CreditLetterHandlingCNT.cnt?hmode="+hmode+"&groupId="+document.forms[0].strOffLineGroup.value+"&hService="+document.forms[0].strOffLineHospitalService.value+"&treatmentCat="+document.getElementsByName("strOffLineTreatmentCategory")[0].value.split("^")[0]+"&ward="+wardIdVal+"&tariffCode="+document.forms[0].strTariffCode.value+"&bService="+document.forms[0].strOffLineBillingService.value;
		 	}
			else if(document.getElementsByName("strOffLineHospitalService") > 0)
			{
				 url = "CreditLetterHandlingCNT.cnt?hmode="+hmode+"&groupId="+document.forms[0].strOffLineGroup.value+"&hService="+document.forms[0].strOffLineHospitalService.value+"&treatmentCat="+document.forms[0].strOffLineTreatmentCategory.value.split("^")[0]+"&ward=0"+"&tariffCode="+document.forms[0].strTariffCode.value;
			}
			else
			{
					url = "CreditLetterHandlingCNT.cnt?hmode="+hmode+"&groupId="+document.forms[0].strOffLineGroup.value+"&hService="+document.forms[0].strOffLineHospitalService.value+"&treatmentCat="+document.getElementsByName("strOffLineTreatmentCategory")[0].value.split("^")[0]+"&ward=0"+"&tariffCode="+document.forms[0].strTariffCode.value;
			}			
...
function getParticularsDetails(obj,grpId,acctNo,index) 
{
 ...
 function fetchPopUpData(grpId,acctNo,index)
  { 
     ...
     var url="CreditLetterHandlingCNT.cnt?hmode="+mode+"&modName="+modeVal;
	  	...
	  	var val = document.forms[0].strBillNo.value.charAt(0);
	  		...
	  		if(val == '5'){
				...
				hisValidator.clearAllValidations();
					...
					if(retVal){
						var hmode = "GOBILL"; 
						var url = "CreditLetterHandlingCNT.cnt?hmode="+hmode+"&billNo="+document.forms[0].strBillNo.value;
	 ...
	 function validateAndSubmit(hmodeVal) 
	 {
	 	...
	 	if(hmodeVal == "OFFRECPARTPAY" || hmodeVal == "OFFRECADV")
	 	{
	 		...
	 		if(document.getElementsByName("strOffLineTreatmentCategory")[0].value.split("^")[1] == "3" || document.getElementsByName("strOffLineTreatmentCategory")[0].value.split("^")[1] == "4")
            {
				...
				{/*if(letterNo[0].value.split("^")[4]>0)
	 			{*/
					document.forms[0].strPartpayment.value=letterNo[0].value.split("^")[4];
					alert("Credit Letter Limit is "+letterNo[0].value.split("^")[4]+". The Amount is updated to "+letterNo[0].value.split("^")[4]);
			 		setAdvPartAmt();
	 			//}
                 }
             }
	 	...
	 	if(hmodeVal == "OFFRECSER" || hmodeVal == "OFFESTIMATION" )
	 	{
				   ...
				   else
				   {
					...
					if(document.getElementsByName("strOffLineHospitalService")[0].value!= "2" && document.forms[0].strWalletNo.value!=null && document.forms[0].strWalletNo.value!="" && document.getElementsByName("strOfflinePaymentMode")[0].value=="7")//If Not IPD and Wallet No Present and selected as payment mode
					{
...
function openPrintPopUp()
{
	if(document.forms[0].isOpenPopUp.value==1 && document.forms[0].printMode.value==1)//Printing Over Laser Printer
	{
		...
		/*var url='CreditLetterHandlingCNT.cnt?hmode=PRINTSLIP&filePath='+document.forms[0].filePath.value
...
{    
		...
		wardId =  document.getElementsByName("strOffLineWard")[0].value;
		var url = "CreditLetterHandlingCNT.cnt?hmode="+hmode+"&treatmentCat="+document.getElementsByName("strOffLineTreatmentCategory")[0].value+"&ward="+wardId;
		//alert(url);
		ajaxFunction(url,"31");
		//alert("1");
...
function addNewLetter(obj)
{
	var catgrp=document.forms[0].strCatGrp.value;
	//document.forms[0].strNewCreditLetterAddedFlag.value=0;
	//alert(document.forms[0].strOffLineTreatmentCategory.value.split('^')[1]);
	var x=document.forms[0].strOffLineTreatmentCategory.value.split('^')[1];
	if((x==3) || (x==4))
	{
		//alert(document.getElementsByName("useflag").length);
		var letterSeizeStat=document.getElementsByName("useflag");
		//alert(letterSeizeStat[0].value);

		for(var i=0;i<letterSeizeStat.length;i++)
		{							
			if(letterSeizeStat[i].value=="3")
			{
			  alert("A Seized Letter already exists. No New Letter will be Allowed");
			  return false;
			}
			
	    }
		addNewCreditLetter(this,1);				
	}
	else
    {
		alert("Patient Category is not credit");
		return false;
	}
...
function validateSaveLetter()
{
	document.forms[0].strCrNo.disabled= false;
	var addFlg=document.forms[0].strNewCreditLetterAddedFlag.value;
	//var addFlg=document.forms[0].deleteFlg.value;
	var deleteFlg=document.forms[0].deleteFlg.value;
	var expireFlg=document.forms[0].expireFlg.value;
	var modifyFlg=document.forms[0].modifyFlg.value;
	//111^04-Dec-2018^1001^Cm Relief Credit^0.00^^04-DEC-2018^^0.00^Select Value^^02-JAN-2019^0^0^0^161
	//alert(addFlg=="");
	//alert(deleteFlg);
	
	
	/*if((addFlg==1) && (deleteFlg ==1))
		{
			alert("Can Not Add And Delete At The Same Time");
		}
	else if((addFlg==1) && (deleteFlg ==0))
		{
			document.forms[0].hmode.value="SAVECREDITLETTER";	
			document.forms[0].submit();
		}
	else if((addFlg==0 || addFlg=="") && (deleteFlg ==1))
		{
			document.forms[0].hmode.value="REMOVECREDITLETTER";	
			document.forms[0].submit();
		}
	else{
			alert("Can Not Add And Delete At The Same Time");
	...
	if(addFlg==1)
	{
		if(deleteFlg ==1 || expireFlg==1 || modifyFlg==1)
		{
			alert("Can Not Add,Delete/Expire/Modify Letter At The Same Time");
		}
		else
		{
			document.forms[0].hmode.value="SAVECREDITLETTER";	
	...
	else
	{
		...
		if(expireFlg ==1)
		{
			document.forms[0].hmode.value="EXPIRECREDITLETTER";	
			document.forms[0].submit();
		}
		if(modifyFlg==1)
		{
			document.forms[0].hmode.value="MODIFYCREDITLETTER";	
			document.forms[0].submit();
		}
	}
}

function removeCreditLetter(row_no)
{
	var addFlg=document.forms[0].strNewCreditLetterAddedFlag.value
	var ref_no=document.getElementById("RowValue"+row_no).value;
	var sanc=document.getElementById("Sanc"+row_no).value;
	var bal=document.getElementById("bal"+row_no).value;
	var cr_no=document.forms[0].strCrNo.value;
	var useflag=document.getElementById("useflag"+row_no).value;
	//alert(useflag);
	//alert(sanc);
	//alert(bal);
	if(sanc!=bal)
	{
		alert("This Letter cannot be Deleted since it has been used for Availing Billing Service");
		return false;
	}
	if(useflag==2)
	{
		alert("This Letter cannot be Deleted since it has been Partially Consumed in IPD Account");
		return false;
	}
	//if(addFlg !=1)
		//{
			//alert(ref_no);
			//alert(cr_no);
			document.forms[0].strCreditLetterNo.value=ref_no;
		//}
		...
		//removeCreditLetter();
		//alert(document.forms[0].deleteFlg.value);
		//alert(document.forms[0].strCreditLetterNo.value);
		if(confirm("Are you Sure to Delete this Letter?"))
		{
			document.forms[0].deleteFlg.value=1;
			validateSaveLetter();
		}
		
		
}
function expireCreditLetter(row_no)
{
	var addFlg=document.forms[0].strNewCreditLetterAddedFlag.value
	var ref_no=document.getElementById("RowValue"+row_no).value;
	var sanc=document.getElementById("Sanc"+row_no).value;
	...
	if(useflag==0)
	{
		alert("This Letter is already Expired");
		return false;
	}
	if(confirm("Are you Sure to Expire this Letter?"))
	{
		document.forms[0].expireFlg.value=1;
		validateSaveLetter();
	}
}
function modifyLimit(row_no)
{
	var addFlg=document.forms[0].strNewCreditLetterAddedFlag.value
	var ref_no=document.getElementById("RowValue"+row_no).value;
	var sanc=document.getElementById("Sanc"+row_no).value;
	...
	var cr_no=document.forms[0].strCrNo.value;
	var useflag=document.getElementById("useflag"+row_no).value;
	//alert(document.getElementById("clt"+row_no).innerHTML);
	var cons=sanc-bal;
	//alert(cons);
	document.getElementById("clt"+row_no).innerHTML="<input type='text' id='strmodCreditLetterLimitId"+row_no+"' name='strmodCreditLetterLimitId' value="+sanc+" onkeypress='return validateData(event,7);' class='txtFldNormal' maxlength='7'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img onkeypress='onPressingEnter(this,event)' id='modifyLimitsave"+row_no+"' style='cursor: pointer;' onclick='savemodifyLimit("+row_no+","+cons+","+sanc+")' src='../../hisglobal/images/ok.gif'>";
	//popup('modifyLimitDiv' , '250','250');
	/*if(useflag==0)
	{
		alert("This Letter is already Expired");
		return false;
...
function savemodifyLimit(row_no,cons,sanc)
{
	var x=document.getElementById("strmodCreditLetterLimitId"+row_no).value;
	//alert(x);
	if(x==0)
	{
		alert("Please Enter Modified Sanctioned Limit Greater than 0");
		return false;
	}
	if(cons>x)
	{
		alert("The Modified Sanctioned Limit cannot be less than the already Consumed Limit");
		return false;
	}
	var y=x-sanc;
	//alert(y);
	var refno=document.getElementById("RowValue"+row_no).value;
	//alert(refno);
	document.forms[0].strCreditLetterNo.value=x+"^"+y+"^"+refno;
	//alert(document.forms[0].strCreditLetterNo.value);
	if(confirm("Are you Sure you want to Modify the Sanctioned Letter Limit of this Letter?"))
	{
		document.forms[0].modifyFlg.value=1;
		validateSaveLetter();
	}
}
	
$("#checkBoxDP").change(function() {
   if(this.checked) {  
   	$( "#strNewCreditLetterDate" ).focus();
   	  }
});
$("#strNewCreditLetterDate").focusout(function(){
	$('#checkBoxDP').prop('checked', false); 
	});

$( function() {
	    $( "#strNewCreditLetterDate" ).datepicker({dateFormat: 'dd-mm-yy'});
	  } );
