	...
	{	
		...
		if(document.getElementsByName("strVisitType")[0].value != '' && document.getElementsByName("strVisitType")[0].value != null && document.getElementsByName("strOffLineHospitalService")[0].value == "4" )			
		{
		...
		if(document.getElementsByName("strVisitType")[0].value != '' && document.getElementsByName("strVisitType")[0].value != null && document.getElementsByName("strOffLineHospitalService")[0].value == "3" )			
		{
			...
			if(document.forms[0].strCatgoryCode.value != null && document.forms[0].strCatgoryCode.value != "" && document.getElementsByName("strOffLineHospitalService")[0].value != "2")
			{
...
function changeHospServiceBasedOnSelectedEpisodeVisitType()
{
	resetTariffRows();
	changeEpisodeClass(document.forms[0].strOffLineEpisode);
	
	var value=document.forms[0].strOffLineEpisode[document.forms[0].strOffLineEpisode.selectedIndex].value;
	//alert(value);
	if(value!=null && value!='' && value!='0')
	{		
		var visitType=value.split('^')[4];
		//alert(visitType);
		if(visitType!=null || visitType!='')
		{
			if(visitType=='1')//OPD General
			{
				document.forms[0].strOffLineHospitalService.value="1";//OPD Morning
				changeComboClass(document.forms[0].strOffLineHospitalService);
			}
			else if(visitType=='4')//OPD Spl
			{
				document.forms[0].strOffLineHospitalService.value="4";//OPD Spl
				changeComboClass(document.forms[0].strOffLineHospitalService);
			}
			else if(visitType=='2')//Emg-MLC
			{
				document.forms[0].strOffLineHospitalService.value="3";//Emg
				changeComboClass(document.forms[0].strOffLineHospitalService);
			}
			else if(visitType=='3')//Emg-Non MLC
			{
				document.forms[0].strOffLineHospitalService.value="3";//Emg
				changeComboClass(document.forms[0].strOffLineHospitalService);
			}
	...
	//document.forms[0].strOffLineBillingService[document.forms[0].strOffLineBillingService.selectedIndex].value
}
function changeEpsiodeBasedOnSelectedHospService()
{
	resetTariffRows();
	
	
	var value=document.forms[0].strOffLineHospitalService[document.forms[0].strOffLineHospitalService.selectedIndex].value;
	//alert(value);
	if(value!=null && value!='' && value!='0')
	{		
		...
		if(serviceType!=null || serviceType!='')
		{
			if(serviceType=='1')//OPD Morning
			{
			     ...
			     for(var i = 0; i < list.options.length; ++i)
			     {
			    	 ...
			    	 if(values.split('^')[4]=='1')
			    	 {
			    		 document.forms[0].strOffLineEpisode.value=values;//OPD Morning
			    		 changeEpisodeClass(document.forms[0].strOffLineEpisode);			    		 
			    	 }
			...
			else if(serviceType=='4')//OPD Spl
			{
			     ...
			     for(var i = 0; i < list.options.length; ++i)
			     {
			    	 ...
			    	 if(values.split('^')[4]=='4')
			    	 {
			    		 document.forms[0].strOffLineEpisode.value=values;
			    		 changeEpisodeClass(document.forms[0].strOffLineEpisode);			    		 
			    	 }//OPD Spl			    	 
			     }			     
			}
			else if(serviceType=='3')//Emg
			{
				 var list = document.forms[0].strOffLineEpisode;
			     for(var i = 0; i < list.options.length; ++i)
			     {
			    	 var values=list.options[i].value;
			    	 if(values.split('^')[4]=='3' || values.split('^')[4]=='2')
			    	 {
			    		 document.forms[0].strOffLineEpisode.value=values;
			    		 changeEpisodeClass(document.forms[0].strOffLineEpisode);			    		 
			    	 }//Emg		    	 
...
function getAjaxResponse(res,mode)
{
	...
	if(mode == '3')
	{
			...
			episodeObj.innerHTML = "<select class='comboNormal' name='strOffLineEpisode' onchange='changeHospServiceBasedOnSelectedEpisodeVisitType()'>"+temp[0]+"</select>";
			changeHospServiceBasedOnSelectedEpisodeVisitType();
	...
	if(mode == '5')
	{
		...
		if(mode == '6'){
			...
			if( reqType == '1' && ( billSer == '10' || billSer == '11' || billSer == '12' || billSer == '13')){
...
{	 		 	
 ...
 function calClientAmountForCredit()
 {
 	 ...
 	 //alert("his"+document.forms[0].strArogyaTSCatId.value+"::"+document.forms[0].strArogyaTSCatCreditLimit.value);
	 ...
	 function findBillServices() 
	 {
	   ...
	   // Off-line Mode
			...
			// Off-line Receipt Service Mode	 				 		
	 		if((ctBSerId == '10'|| ctBSerId == '11' || ctBSerId == '12' || ctBSerId == '13') && ctReqType == '1')
 		...
 		if(obj.checked)
 	 	{
 			...
 			for(var i=0; i<tariffs.length; i++) 
 			{
 				...
 				if((payType[i].value=="11" || payType[i].value=="13"))//Credit
 	 			{
