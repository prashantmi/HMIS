	...
	function generateRows()
	{
		...
		tempObj.focus();
			...
			{
				if(document.forms[0].strOfflinePaymentMode.value.split("#")[0]!="7")
					chkPaidCredit();
			}
	}
...
//Reset To Cash
		...
		if(document.forms[0].strOffLineRequestType[document.forms[0].strOffLineRequestType.selectedIndex].value=="1")
			{
				...
				var url = "CashCollectionOfflineTransCNT.cnt?hmode="+hmode+"&hService="+document.forms[0].strOffLineHospitalService[document.forms[0].strOffLineHospitalService.selectedIndex].value+"&requestType="+document.forms[0].strOffLineRequestType[document.forms[0].strOffLineRequestType.selectedIndex].value+"&patCategory="+document.forms[0].strOffLineTreatmentCategory[document.forms[0].strOffLineTreatmentCategory.selectedIndex].value;
				ajaxFunction(url,"33");
			}
	...
	function onLoadLogics()
	{
		...
		addRows(new Array('strOfflinePaymentMode','strOfflinePaymentDtls','strOfflineAmount'),new Array('s','t','t'),'3','1','I');
				...
				if(normalMsgVal.search(document.forms[0].strTempBillNo.value) != -1)
				{
						...
						if(!confirmFlag)//Cancel
						{
							...
							else
							{
								...
								var url = "CashCollectionOfflineTransCNT.cnt?hmode="+hmode+"&billNo="+billNo+"&recNo="+recNo;
		...
		var hosp_service=document.forms[0].strOffLineHospitalService;
		var bill_service=document.forms[0].strOffLineBillingService;
		var req_type=document.forms[0].strOffLineRequestType
		
		
				// for IPD patients
			if(hosp_service.value =="2")  
			{     
							
							//IPD Advance
					if(bill_service.value == "19" )
					{
						
						if(req_type.value == "1"){
							document.forms[0].strOffLineTreatmentCategory.disabled=true;
						} 
							// Advance refund
						if(req_type.value == "2")     
							advanceRefund();	
							...
							//partpayment
					if(bill_service.value=="20")    
					{
						document.forms[0].strOffLineRaisingDepartment.disabled=true;
						document.forms[0].strOffLineEpisode.disabled=true;
						document.forms[0].strOffLineTreatmentCategory.disabled=true;
						document.forms[0].strOffLineWard.disabled=true;

						
					}
							//IPD service
					if(bill_service.value=="11")
					{    
						document.forms[0].strOffLineRaisingDepartment.disabled=true;
						document.forms[0].strOffLineEpisode.disabled=true;
						document.forms[0].strOffLineTreatmentCategory.disabled=true;
		...
		if(hosp_service.value =="1" || hosp_service.value =="3")  // FOR OPD & EMERGENCY
			{
				document.forms[0].strOffLineTreatmentCategory.disabled=true;
			}
...
function showNormalMsg()
{
	 ...
	 */
	 ...
	 {	 		 	
	 		...
	 		{	 			
	 			var hmode = "REPRINT"; 
				var url = "CashCollectionOfflineTransCNT.cnt?hmode="+hmode;											
	...
	function getBillService(){
	 ...
	 document.forms[0].currentBserviceId.value = document.forms[0].strOffLineBillingService[document.forms[0].strOffLineBillingService.selectedIndex].value;
	 	...
	 	if(document.forms[0].currentReceiptType.value == '2'){
			...
			var hmode = "BILLDTLS"; 
			var url = "CashCollectionOfflineTransCNT.cnt?hmode="+hmode+"&hService="+document.forms[0].strOffLineHospitalService[document.forms[0].strOffLineHospitalService.selectedIndex].value+"&requestType="+document.forms[0].strOffLineRequestType[document.forms[0].strOffLineRequestType.selectedIndex].value;
	...
	function getEpisodeList(obj){
			...
			var url = "CashCollectionOfflineTransCNT.cnt?hmode="+hmode+"&crNo="+document.forms[0].strCrNo.value+"&deptCode="+obj.value;
			ajaxFunction(url,"3");
...
function getPartAccDtls(obj)
{
	...
	{
		var hmode = "GROUPDTLS"; 
		var url = "CashCollectionOfflineTransCNT.cnt?hmode="+hmode+"&hService="+document.forms[0].strOffLineHospitalService[document.forms[0].strOffLineHospitalService.selectedIndex].value+"&withPack=0&catCode="+document.forms[0].strOffLineTreatmentCategory.value+"&strCrNo="+document.forms[0].strCrNo.value;		
		ajaxFunction(url,"5");
	}
	...
	{	
		...
		var url = "CashCollectionOfflineTransCNT.cnt?hmode="+hmode+"&crNo="+document.forms[0].strCrNo.value+"&hService="+document.forms[0].strOffLineHospitalService[document.forms[0].strOffLineHospitalService.selectedIndex].value;		
		ajaxFunction(url,"6");
	}
...
//alert("val : "+obj.value);
	...
	if(obj.value.length >= 1 && obj.value.length <= 3 && trfPreviousData != previousDate)
	{
		...
		{		
			...
			url = "CashCollectionOfflineTransCNT.cnt?hmode="+hmode+"&groupId="+document.forms[0].strOffLineGroup.value+"&hService="+document.forms[0].strOffLineHospitalService.value+"&treatmentCat="+treatmentCat+"&ward="+wardIdVal+"&searchLetter="+obj.value+"&bService="+document.forms[0].strOffLineBillingService.value;	 
		}
		else
		{
			var treatmentCat=document.forms[0].strOffLineTreatmentCategory[document.forms[0].strOffLineTreatmentCategory.selectedIndex].value.split('^')[0]; 
			url = "CashCollectionOfflineTransCNT.cnt?hmode="+hmode+"&groupId="+document.forms[0].strOffLineGroup.value+"&hService="+document.forms[0].strOffLineHospitalService.value+"&treatmentCat="+treatmentCat+"&ward=0"+"&searchLetter="+obj.value;
		}
	...
	function getOffLinePkgsGroupDtls(){
		...
		var hmode = "PKGGROUPDTLS"; 
			var url = "CashCollectionOfflineTransCNT.cnt?hmode="+hmode+"&hService="+document.forms[0].strOffLineHospitalService[document.forms[0].strOffLineHospitalService.selectedIndex].value+"&withPack=1";
	...
	function getOffLinePkgConfigDetails(index){
		...
		var hmode = "PKGDTLS"; 
			var url = "CashCollectionOfflineTransCNT.cnt?hmode="+hmode+"&rowIndex="+index;
	...
	/**
		 ...
		 */
		 function getOffLineTariffUnit(unitId,baseValue,index) {
		 	...
		 	var hmode = "TRFUNIT"; 
			var url = "CashCollectionOfflineTransCNT.cnt?hmode="+hmode+"&unitId="+unitId+"&baseValue="+baseValue+"&rowIndex="+index;
	 ...
	 */
	 function getOffLineRefundBillDetails() {
	 	...
	 	var hmode = "REFUNDBILLDTLS"; 
			var url = "CashCollectionOfflineTransCNT.cnt?hmode="+hmode+"&crNo="+document.forms[0].strCrNo.value+"&chargeType="+document.forms[0].strOffLineHospitalService[document.forms[0].strOffLineHospitalService.selectedIndex].value+"&accNo="+accNo;
			...
			var flg1 = true;		
				...
				if(reqType == '1' &&  (billSer == '19' || billSer == '20' || billSer == '13')){
					...
					if(billSer == '19'){
						...
						if(document.forms[0].strWalletNo.value.length>0)
							flg1 = false;
						...
						if(flg1){
							...
							amtObj.style.display="none";
							if(document.forms[0].strWalletNo.value.length>0)
								document.getElementById("errMsg").innerHTML = "Wallet Exists/Advance Already Collected.";
							else
						...
						if(flg){
							...
							if(billSer == '20')
							{
								if(document.forms[0].strPatientDtlHidVal.value.split('^')[2]!="2")
								{
									amtObj.innerHTML = "";
	  								amtObj.style.display="none";
	  								document.getElementById("errMsg").innerHTML = "Patient Not Admitted, Part Payment Not Applicable.";
	  								document.getElementById("errMsg").style.display = "block";
	  								document.getElementById("totalRecAmtDivId").innerHTML = '0.00';	
	  								document.getElementById("totalRecAmtLabId").innerHTML = '0.00';	
	  								document.getElementById("totalCltAmtLabId").innerHTML = '0.00';	
								...
								else if(document.forms[0].strPatientDtlHidVal.value.split('^')[2]=="2" && document.forms[0].strPatientDtlHidVal.value.split('^')[14]!="1")
	  							{
	  								amtObj.innerHTML = "";
	  								amtObj.style.display="none";
	  								document.getElementById("errMsg").innerHTML = "Patient Not Accepted in Ward, Part Payment Not Applicable.";
	  								document.getElementById("errMsg").style.display = "block";
	  								document.getElementById("totalRecAmtDivId").innerHTML = '0.00';	
	  								document.getElementById("totalRecAmtLabId").innerHTML = '0.00';	
	  								document.getElementById("totalCltAmtLabId").innerHTML = '0.00';	
							...
							if(billSer == '13')
							{
								if(document.forms[0].strPatientDtlHidVal.value.split('^')[2]!="2")
								{
								...
								else if(document.forms[0].strPatientDtlHidVal.value.split('^')[2]=="2" && document.forms[0].strPatientDtlHidVal.value.split('^')[14]!="1")
	  							{
	  								amtObj.innerHTML = "";
	  								amtObj.style.display="none";
	  								document.getElementById("errMsg").innerHTML = "Patient Not Accepted in Ward, Package Not Applicable.";
	  								document.getElementById("errMsg").style.display = "block";
	  								document.getElementById("totalRecAmtDivId").innerHTML = '0.00';	
	  								document.getElementById("totalRecAmtLabId").innerHTML = '0.00';	
	  								document.getElementById("totalCltAmtLabId").innerHTML = '0.00';	
	 ...
	 */
	 function getBillTariffDtls(obj) {
	 	...
	 	var hmode = "REFUNDBILLTARIFFDTLS"; 
			var url = "CashCollectionOfflineTransCNT.cnt?hmode="+hmode+"&billNo="+tempVal[0]+"&accNo="+tempVal[4]+"&hospService="+document.forms[0].strOffLineHospitalService[document.forms[0].strOffLineHospitalService.selectedIndex].value;
	 ...
	 */
	  ...
	  */
	  function showTariffPopup(obj,hidVal) {
	  	...
	  	var hmode = "REFUNDBILLTARIFFPOPUPDTLS"; 
			var url = "CashCollectionOfflineTransCNT.cnt?hmode="+hmode+"&hidValue="+hidVal;
	 ...
	 function showReconcilPopup(hidVal,parentPos){
			...
			var url = "CashCollectionOfflineTransCNT.cnt?hmode="+hmode+"&hidVal="+hidVal;
	 ...
	 */
	  ...
	  */
	  function initOfflineTreatmentCategory() {
	  	 ...
	  	 var chargeTypeId = document.forms[0].strOffLineHospitalService[document.forms[0].strOffLineHospitalService.selectedIndex].value;
			...
			var url = "CashCollectionOfflineTransCNT.cnt?hmode="+hmode+"&strChargeTypeId="+chargeTypeId+"&strCrNo="+crNo+"&strTreatCat="+treatCat;
	  ...
	  */
	  function initOfflineWard() {
			...
			var url = "CashCollectionOfflineTransCNT.cnt?hmode="+hmode+"&strChargeTypeId="+chargeTypeId+"&strCrNo="+crNo+"&strWard="+strWard;
	  ...
	  */
	  function getSpecialWardDtls(deptId) {
			...
			var url = "CashCollectionOfflineTransCNT.cnt?hmode="+hmode+"&strDept="+deptId;
	...
	if(mode == '4')
	{
		...
		{						
				...
				if( (reqType == '1'|| reqType =='3') && ( billSer == '10' || billSer == '11' || billSer == '12'))
				{
					...
					if (offlineHospitalService == '2' && patientStatus != '2' && accountNo.length < 2 && isAdvanceRequired=='1')
					{					 					
					...
					else if(offlineHospitalService == '2' && patientStatus != '2')
					{					 					
						document.getElementById("offlineTariffDivId").style.display="none";
						document.getElementById("errMsg").innerHTML = "Patient Not Admitted, IPD Services are Not Applicable";
						document.getElementById("errMsg").style.display = "block";							
					}
					else if(offlineHospitalService == '2' && patientStatus == '2' && document.forms[0].strPatientDtlHidVal.value.split('^')[14]!="1")
					{					 					
						document.getElementById("offlineTariffDivId").style.display="none";
						document.getElementById("errMsg").innerHTML = "Patient Not Accepted in Ward, IPD Services are Not Applicable";
						document.getElementById("errMsg").style.display = "block";							
					}
					else
					{
 ...
 function calClientAmountForCredit()
 {
	 ...
	 */
	 function removeTariffRow(index) {
	 	...
	 	//reseting to cash commented on deleteing
/*		resetMultiRow('3');
	addRows(new Array('strOfflinePaymentMode','strOfflinePaymentDtls','strOfflineAmount'),new Array('s','t','t'),'3','1','R');*/
	  ...
	  */
	  ...
	  {	  
	  	if(e.keyCode == 13 && document.forms[0].strTariffCode.value.length > 0)
	  	{
			...
			{
				var wardIdVal = document.forms[0].strOffLineWard[document.forms[0].strOffLineWard.selectedIndex].value.split('^')[0];	
				 url = "CashCollectionOfflineTransCNT.cnt?hmode="+hmode+"&groupId="+document.forms[0].strOffLineGroup.value+"&hService="+document.forms[0].strOffLineHospitalService.value+"&treatmentCat="+document.getElementsByName("strOffLineTreatmentCategory")[0].value.split("^")[0]+"&ward="+wardIdVal+"&tariffCode="+document.forms[0].strTariffCode.value+"&bService="+document.forms[0].strOffLineBillingService.value;
		 	}
			else if(document.getElementsByName("strOffLineHospitalService") > 0)
			{
				 url = "CashCollectionOfflineTransCNT.cnt?hmode="+hmode+"&groupId="+document.forms[0].strOffLineGroup.value+"&hService="+document.forms[0].strOffLineHospitalService.value+"&treatmentCat="+document.forms[0].strOffLineTreatmentCategory.value.split("^")[0]+"&ward=0"+"&tariffCode="+document.forms[0].strTariffCode.value;
			}
			else
			{
					url = "CashCollectionOfflineTransCNT.cnt?hmode="+hmode+"&groupId="+document.forms[0].strOffLineGroup.value+"&hService="+document.forms[0].strOffLineHospitalService.value+"&treatmentCat="+document.getElementsByName("strOffLineTreatmentCategory")[0].value.split("^")[0]+"&ward=0"+"&tariffCode="+document.forms[0].strTariffCode.value;
			}			
...
function getParticularsDetails(obj,grpId,acctNo,index) 
{
 ...
 function fetchPopUpData(grpId,acctNo,index)
  { 
     ...
     var url="CashCollectionOfflineTransCNT.cnt?hmode="+mode+"&modName="+modeVal;
  ...
  */
  function setSelectedCrNo(crNo) {
	  	...
	  	var val = document.forms[0].strBillNo.value.charAt(0);
	  		...
	  		if(val == '5'){
				...
				hisValidator.clearAllValidations();
					...
					if(retVal){
						var hmode = "GOBILL"; 
						var url = "CashCollectionOfflineTransCNT.cnt?hmode="+hmode+"&billNo="+document.forms[0].strBillNo.value;
	 ...
	 function validateAndSubmit(hmodeVal) 
	 {
	 	...
	 	if(hmodeVal == "OFFRECPARTPAY" || hmodeVal == "OFFRECADV")
	 	{
	 		if(hmodeVal == "OFFRECADV")
	 		{
	 			...
	 			if(document.forms[0].strOffLineRaisingDepartment.value=="0")
	 			{
	 				alert("Please Select Raising Department ");
	 				return false;
	 			}

	 		}
 			if(document.forms[0].strOffLineWard.value=="0")
 			{
	 		...
	 		if(document.getElementsByName("strOffLineTreatmentCategory")[0].value.split("^")[1] == "3" || document.getElementsByName("strOffLineTreatmentCategory")[0].value.split("^")[1] == "4")
            {
				...
				if(letterNo[0].value.split("^")[16]=="3")
				{
	...
	// 	hide_popup('billPrintConfirm');
			...
			{  // Enabling all values required   //Enabling Block
				...
				document.forms[0].strOffLineEpisode.disabled=false;
				document.forms[0].strOffLineTreatmentCategory.disabled = false;	
	 			document.forms[0].strOffLineRefundReasonText.disabled = false;
				document.forms[0].strOffLineWard.disabled=false;
...
{    
		...
		wardId =  document.getElementsByName("strOffLineWard")[0].value;
		var url = "CashCollectionOfflineTransCNT.cnt?hmode="+hmode+"&treatmentCat="+document.getElementsByName("strOffLineTreatmentCategory")[0].value+"&ward="+wardId;
		//alert(url);
		ajaxFunction(url,"31");
		//alert("1");
...
function advanceRefund(){
	...
	/*var url = "CashCollectionOfflineTransCNT.cnt?hmode=advanceDtls";
	ajaxFunction(url,"32");*/
	...
	if(obj.checked==true)
		...
		if(obj.value=="1")
			...
			//	obj.disabled = true;
				...
				var url = "CashCollectionOfflineTransCNT.cnt?hmode=accountCategory&catCode="+catCode;
				ajaxFunction(url,"32");
