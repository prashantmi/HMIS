 ...
 */
	...
	if(document.getElementById('flag'+i).value=="0"){	
		 var mode = "GETPOPUP";
		 var url = "BillingCancellationTransCNT.cnt?hmode="+mode+"&billNo="+document.getElementById("billNo"+i).value+"&accNo="+document.getElementById("patAccNo"+i).value+"&index="+i+"&CHK="+document.getElementById("chk"+i).value;
		...
		var url = "BillingCancellationTransCNT.cnt?hmode="+mode+"&popupData="+hidVal+"&CHK="+document.getElementById("chk"+i).value;
 ...
 */
 ...
 function groupCheck(chkObj) {
	 	...
	 	document.forms[0].chkValue.value = chkObj.value;
	 	 ...
	 	 var j;
	     var mode="TrfDtl";
	     var url="BillingCancellationTransCNT.cnt?hmode="+mode+"&modName="+chkObj.value;
	     ajaxFunction(url,"3");
	 }
