	...
	function goFunc()
	{
		if(document.getElementsByName("strCRorWalletwise")[0].checked)
		{
        if(document.forms[0].strCrNo.disabled == false)
		{
			var hisValidator = new HISValidator("PatWalletTransBean");  
		...
		else if(document.getElementsByName("strCRorWalletwise")[1].checked)
		{
	//	alert("in 2");
			if(document.forms[0].strWalletNo.disabled == false)
			{
				var hisValidator = new HISValidator("PatWalletTransBean");  
			hisValidator.addValidation("strWalletNo", "req", "Wallet No. is a Mandatory Field" );
				hisValidator.addValidation("strWalletNo", "minlen=10", "Mobile No. must be "+document.forms[0].strCrNo.maxLength+" Digits" );
				var retVal = hisValidator.validate(); 
				hisValidator.clearAllValidations();
			
					if(retVal)
					{
						if(validateFunc(document.forms[0].strWalletNo,5))
						{
	...
	function clearFunc(cntMode){
		...
		document.forms[0].strCrNo.value = "";
		document.forms[0].strWalletAccountNo = "";
	...
	function onLoadLogics()
	{
		...
		if(cat=="3" || cat=="4")//Category Group Credit
		{
			alert("Credit Patients are not Allowed for Wallet Transactions");
			clearFunc(document.forms[0].strCounterMode.value);
			return false;
		}
		if(document.getElementsByName("strCRorWalletwise")[0].checked)
				...
				{	
						...
						if(!confirmFlag)//Cancel
						{
							...
							else
							{
								...
								var url = "PatWalletTransBSCNT.cnt?hmode="+hmode+"&billNo="+billNo+"&recNo="+recNo;
		...
		else if(document.getElementsByName("strCRorWalletwise")[1].checked)
		{
			var errVal = document.getElementById("errMsg").innerHTML;	
			//alert(errVal);
			if(errVal.length > 1 && document.forms[0].strCrNo.value.length==7)
			{	
				//document.getElementById("errMsg").innerHTML="Wallet No Doesn't Exist OR Closed!"
				document.forms[0].strCrNo.disabled = true;
				document.forms[0].strIsOnline.disabled = true;
				document.forms[0].strPatientMode[0].disabled = true;
				document.forms[0].strPatientMode[1].disabled = true;			 
			}
			else if(errVal.length > 1 && document.forms[0].strCrNo.value.length==15)
			{	
				document.getElementById("errMsg").innerHTML="Wallet No Doesn't Exist OR Closed!"
				document.forms[0].strCrNo.disabled = true;
				document.forms[0].strIsOnline.disabled = true;
			...
			else
			{
				...
				document.forms[0].strOffLineHospitalService.disabled = true;	
				document.forms[0].strOffLineBillingService.disabled = true;
				document.forms[0].strOffLineRequestType.disabled = true;					//WalletAccountStatus();
			}				
		}
		if(document.forms[0].strPatientDtlHidVal!= undefined)
		{
			if(document.getElementsByName("strPatientDtlHidVal")[0].value.split("^")[2]=="3")//Opd
			{
				document.forms[0].strChargeType.value="1";
			}
			else if(document.getElementsByName("strPatientDtlHidVal")[0].value.split("^")[2]=="1")//Emergency
			{
			    document.forms[0].strChargeType.value="3";
			}
			else
			    document.forms[0].strChargeType.value=document.getElementsByName("strPatientDtlHidVal")[0].value.split("^")[2];
			//alert(document.forms[0].strMobileNo.value);
			document.forms[0].strMobileNo.value=document.getElementsByName("strPatientDtlHidVal")[0].value.split("^")[13];
			//alert(document.forms[0].strMobileNo.value);
			//alert(document.getElementsByName("strMobileNo1")[0].value);
			document.getElementsByName("strMobileNo1")[0].value=document.forms[0].strMobileNo.value;
			//alert(document.getElementsByName("strMobileNo1")[0].value);
		}
}
...
function showNormalMsg()
{
	 ...
	 */
	 ...
	 {	 		 	
	 		...
	 		{	 			
	 			var hmode = "REPRINT"; 
				var url = "PatWalletTransBSCNT.cnt?hmode="+hmode;											
	...
	function getBillService(){
	 ...
	 document.forms[0].currentBserviceId.value = document.forms[0].strOffLineBillingService[document.forms[0].strOffLineBillingService.selectedIndex].value;
	 	...
	 	if(document.forms[0].currentReceiptType.value == '2'){
			...
			var hmode = "BILLDTLS"; 
			var url = "PatWalletTransBSCNT.cnt?hmode="+hmode+"&hService="+document.forms[0].strOffLineHospitalService[document.forms[0].strOffLineHospitalService.selectedIndex].value+"&requestType="+document.forms[0].strOffLineRequestType[document.forms[0].strOffLineRequestType.selectedIndex].value;
	...
	function getEpisodeList(obj){
			...
			var url = "PatWalletTransBSCNT.cnt?hmode="+hmode+"&crNo="+document.forms[0].strCrNo.value+"&deptCode="+obj.value;
			ajaxFunction(url,"3");
...
function getPartAccDtls(obj)
{
	...
	if(document.forms[0].strOffLineHospitalService[document.forms[0].strOffLineHospitalService.selectedIndex].value == 2)
	{
		...
		var url = "PatWalletTransBSCNT.cnt?hmode="+hmode+"&hService="+document.forms[0].strOffLineHospitalService[document.forms[0].strOffLineHospitalService.selectedIndex].value+"&requestType="+document.forms[0].strOffLineRequestType[document.forms[0].strOffLineRequestType.selectedIndex].value+"&billService="+bServiceId+"&treatmentCat="+document.getElementsByName("strOffLineTreatmentCategory")[0].value+"&ward="+wardId+"&strCrNo="+document.forms[0].strCrNo.value+"&strSplWard="+splWardId;
		ajaxFunction(url,"4");
	}
	else
	{
	...
	function getOffLineGroupDtls(){
		...
		var hmode = "GROUPDTLS"; 
			var url = "PatWalletTransBSCNT.cnt?hmode="+hmode+"&hService="+document.forms[0].strOffLineHospitalService[document.forms[0].strOffLineHospitalService.selectedIndex].value+"&withPack=0";
	...
	function getOffLineClientDtls(){
		...
		var hmode = "OFFLINECLTDTLS"; 
			var url = "PatWalletTransBSCNT.cnt?hmode="+hmode+"&crNo="+document.forms[0].strCrNo.value+"&hService="+document.forms[0].strOffLineHospitalService[document.forms[0].strOffLineHospitalService.selectedIndex].value;
...
//alert("val : "+obj.value);
	...
	if(obj.value.length >= 1 && obj.value.length <= 3 && trfPreviousData != previousDate)
	{
		...
		{		
			...
			url = "PatWalletTransBSCNT.cnt?hmode="+hmode+"&groupId="+document.forms[0].strOffLineGroup[document.forms[0].strOffLineGroup.selectedIndex].value+"&hService="+document.forms[0].strOffLineHospitalService[document.forms[0].strOffLineHospitalService.selectedIndex].value+"&treatmentCat="+treatmentCat+"&ward="+wardIdVal+"&searchLetter="+obj.value;	 
		}
		else
		{
			var treatmentCat=document.forms[0].strOffLineTreatmentCategory[document.forms[0].strOffLineTreatmentCategory.selectedIndex].value.split('^')[0]; 
			url = "PatWalletTransBSCNT.cnt?hmode="+hmode+"&groupId="+document.forms[0].strOffLineGroup[document.forms[0].strOffLineGroup.selectedIndex].value+"&hService="+document.forms[0].strOffLineHospitalService[document.forms[0].strOffLineHospitalService.selectedIndex].value+"&treatmentCat="+treatmentCat+"&ward=0"+"&searchLetter="+obj.value;
		}
	...
	function getOffLinePkgsGroupDtls(){
		...
		var hmode = "PKGGROUPDTLS"; 
			var url = "PatWalletTransBSCNT.cnt?hmode="+hmode+"&hService="+document.forms[0].strOffLineHospitalService[document.forms[0].strOffLineHospitalService.selectedIndex].value+"&withPack=1";
	...
	function getOffLinePkgConfigDetails(index){
		...
		var hmode = "PKGDTLS"; 
			var url = "PatWalletTransBSCNT.cnt?hmode="+hmode+"&rowIndex="+index;
	...
	/**
		 ...
		 */
		 function getOffLineTariffUnit(unitId,baseValue,index) {
		 	...
		 	var hmode = "TRFUNIT"; 
			var url = "PatWalletTransBSCNT.cnt?hmode="+hmode+"&unitId="+unitId+"&baseValue="+baseValue+"&rowIndex="+index;
	 ...
	 */
	 function getOffLineRefundBillDetails() {
	 	...
	 	var hmode = "REFUNDBILLDTLS"; 
			var url = "PatWalletTransBSCNT.cnt?hmode="+hmode+"&crNo="+document.forms[0].strCrNo.value+"&chargeType="+document.forms[0].strOffLineHospitalService[document.forms[0].strOffLineHospitalService.selectedIndex].value+"&accNo="+accNo;
...
//		var reqType = document.getElementsByName("strAccountStatus")[0].value;
		...
		if(document.getElementsByName("strAccountStatus")[0].checked)							
			{
			var accNoObj = document.getElementsByName("strWalletAccountNo");
			var accNo = '0';
			//alert("in ppp1"+accNoObj.length);
					if(accNoObj.length > 0){
						...
						//alert("2");
					//	document.getElementById("WalletNo").innerHTML=accNo;
							}
					if(accNo.length > 0 ){
						//alert("3");		
						//alert(accNo);
					...
					var accNoObj = document.getElementsByName("strWalletAccountNo")[0].value;
					...
					if(!flg1)
						{
							...
							document.getElementById("errMsg").innerHTML = "Wallet/Ipd Advance Already Collected.";
							document.getElementById("errMsg").style.display = "block";
							document.getElementsByName("strWalletAccountNo")[0].value="";
							document.getElementsByName("strWalletAccountOpenDate")[0].value="";
							document.getElementsByName("strWalletDepositedAmount")[0].value="";
							document.getElementsByName("strWalletBalanceAmount")[0].value="";
					    	document.getElementsByName("strWalletAccountStatus")[0].checked=true;
		...
		if(document.getElementsByName("strAccountStatus")[2].checked || document.getElementsByName("strAccountStatus")[1].checked)		
	    	...
	    	document.getElementsByName("strWalletAccountStatus")[0].checked=true;
	    	//alert("hIi");
	    	document.getElementById("errMsg").innerHTML = "Wallet Account Doesn't Exist OR already closed.";
			document.getElementById("errMsg").style.display = "block";
	 ...
	 */
	 function getBillTariffDtls(obj) {
	 	...
	 	var hmode = "REFUNDBILLTARIFFDTLS"; 
			var url = "PatWalletTransBSCNT.cnt?hmode="+hmode+"&billNo="+tempVal[0]+"&accNo="+tempVal[4]+"&hospService="+document.forms[0].strOffLineHospitalService[document.forms[0].strOffLineHospitalService.selectedIndex].value;
	 ...
	 */
	  ...
	  */
	  function showTariffPopup(obj,hidVal) {
	  	...
	  	var hmode = "REFUNDBILLTARIFFPOPUPDTLS"; 
			var url = "PatWalletTransBSCNT.cnt?hmode="+hmode+"&hidValue="+hidVal;
	 ...
	 function showReconcilPopup(hidVal,parentPos){
			...
			var url = "PatWalletTransBSCNT.cnt?hmode="+hmode+"&hidVal="+hidVal;
	 ...
	 */
	  ...
	  */
	  function initOfflineTreatmentCategory() {
	  	 ...
	  	 var chargeTypeId = document.forms[0].strOffLineHospitalService[document.forms[0].strOffLineHospitalService.selectedIndex].value;
			...
			var url = "PatWalletTransBSCNT.cnt?hmode="+hmode+"&strChargeTypeId="+chargeTypeId+"&strCrNo="+crNo+"&strTreatCat="+treatCat;
	  ...
	  */
	  function initOfflineWard() {
			...
			var url = "PatWalletTransBSCNT.cnt?hmode="+hmode+"&strChargeTypeId="+chargeTypeId+"&strCrNo="+crNo+"&strWard="+strWard;
	  ...
	  */
	  function getSpecialWardDtls(deptId) {
			...
			var url = "PatWalletTransBSCNT.cnt?hmode="+hmode+"&strDept="+deptId;
...
var hisValidator = new HISValidator("PatWalletTransBean");  
	...
	function displayPayDetails(parent,payDtl,payEdit,payAmt , mode){
		...
		//alert("hi2");
		if(optVal == 6 || optVal == 7){
			
			alert("This Mode is Not Applicable for Wallet");
	  ...
	  */
	  ...
	  {	  
	  	if(e.keyCode == 13 && document.forms[0].strTariffCode.value.length > 0)
	  	{
			...
			{
				var wardIdVal = document.forms[0].strOffLineWard[document.forms[0].strOffLineWard.selectedIndex].value.split('^')[0];	
				 url = "PatWalletTransBSCNT.cnt?hmode="+hmode+"&groupId="+document.forms[0].strOffLineGroup[document.forms[0].strOffLineGroup.selectedIndex].value+"&hService="+document.forms[0].strOffLineHospitalService[document.forms[0].strOffLineHospitalService.selectedIndex].value+"&treatmentCat="+document.getElementsByName("strOffLineTreatmentCategory")[0].value.split("^")[0]+"&ward="+wardIdVal+"&tariffCode="+document.forms[0].strTariffCode.value;
		 	}
			else if(document.getElementsByName("strOffLineHospitalService") > 0)
			{
				 url = "PatWalletTransBACNT.cnt?hmode="+hmode+"&groupId="+document.forms[0].strOffLineGroup[document.forms[0].strOffLineGroup.selectedIndex].value+"&hService="+document.forms[0].strOffLineHospitalService[document.forms[0].strOffLineHospitalService.selectedIndex].value+"&treatmentCat="+document.forms[0].strOffLineTreatmentCategory[document.forms[0].strOffLineTreatmentCategory.selectedIndex].value.split("^")[0]+"&ward=0"+"&tariffCode="+document.forms[0].strTariffCode.value;
			}
			else
			{
					url = "PatWalletTransBSCNT.cnt?hmode="+hmode+"&groupId="+document.forms[0].strOffLineGroup[document.forms[0].strOffLineGroup.selectedIndex].value+"&hService=1&treatmentCat="+document.getElementsByName("strOffLineTreatmentCategory")[0].value.split("^")[0]+"&ward=0"+"&tariffCode="+document.forms[0].strTariffCode.value;
			}			
...
function getParticularsDetails(obj,grpId,acctNo,index) 
{
 ...
 function fetchPopUpData(grpId,acctNo,index)
  { 
     ...
     var url="PatWalletTransBSCNT.cnt?hmode="+mode+"&modName="+modeVal;
	  	...
	  	var val = document.forms[0].strBillNo.value.charAt(0);
	  		...
	  		if(val == '5'){
				...
				hisValidator.clearAllValidations();
					...
					if(retVal){
						var hmode = "GOBILL"; 
						var url = "PatWalletTransBSCNT.cnt?hmode="+hmode+"&billNo="+document.forms[0].strBillNo.value;
...
/*function openPrintPopUp()
{
	...
	{
			var url='PatWalletTransCNT.cnt?hmode=PRINTSLIP&filePath='+document.forms[0].filePath.value;
		//	alert(url);
	 ...
	 document.getElementsByName("strCRorWalletwise")[0].checked=true;
	
	 
}*/
function openPrintPopUp()
{
	//alert('chkMobileNoCount'+document.forms[0].chkMobileNoCount.value);
	///alert('printMode'+document.forms[0].printMode.value);
	//alert('isOpenPopUp'+document.forms[0].isOpenPopUp.value);
	if(document.forms[0].isOpenPopUp.value==1 && document.forms[0].printMode.value==1 && document.forms[0].chkMobileNoCount.value==1)//Printing Over Laser Printer
	{
			//alert('inside if');
			window.print();
			//window.close();
...
function WalletAccountServices()
{
   var AccountStatus= document.getElementsByName("strAccountStatus")[0].value;
   if(AccountStatus == "1")
	   {
	     //alert("strAdvacnceAmount"+document.getElementsByName("strAdvacnceAmount")[0].value);
	     var hisValidator = new HISValidator("PatWalletTransBean");  
			...
			hisValidator.addValidation("strAdvacnceAmount", "req", "Amount is a Mandatory Field" );
			//hisValidator.addValidation("strOfflineAmount", "req", "Amount is Mandatory Field" );
			hisValidator.addValidation("strMobileNo1", "req", "Mobile No. is a Mandatory Field" );
			//hisValidator.addValidation("strMobileNo", "maxlen=10","Mobile No Cannot be More than 10 digits");
			hisValidator.addValidation("strMobileNo1", "minlen=10","Mobile No Cannot be Less than 10 digits");
			//hisValidator.addValidation("strOfflineAmount", "numgt=0", "Amount should be Grater than 0.00" );
			...
			if(res)
				...
				//alert(" you are opening Wallet account");
				/*document.getElementById("strCrNoId").disabled= false;
				...
				document.forms[0].hmode.value = "RECWalletADV";
...
function closeFunc()
{
	...
	/*var patstatus=document.getElementsByName("strPatientDtlHidVal")[0].value.split("^")[2];
	if(patstatus==2)
	{
		alert("Here, Account Closure is not allowed for Ipd Patients. This is to be handled at Final Settlement(Cash Collection Online).");
		return false;
	}
...
function IsCrOrWalletWise(val)
{
	if(val == '1')
	{
		document.getElementById("CrNOOrWallet").innerHTML="<font color=\"red\">*</font>CR No.";
		document.getElementById("CRWise").style.display ='block'; 
		document.getElementById("WalletWise").style.display ='none';
		document.getElementById("disBnR").style.display ='none';
		document.getElementById("offlineDetailsDivId").style.display ='none';
		document.getElementById("strCrNoId").disabled =false;
		//document.getElementById("strCrNoId").value="";
		SetCursorToTextEnd('strCrNoId');
		document.getElementById("strCrNoId").value="";
	...
	if(val == '2')
	{
		document.getElementById("CrNOOrWallet").innerHTML="<font color=\"red\">*</font>Mobile No.";
		//alert(document.getElementById("CRWise").innerHTML);
		document.getElementById("CRWise").style.display ='none'; 
		document.getElementById("WalletWise").style.display ='block';
		document.getElementById("disBnR").style.display ='none';
		//document.getElementById("strWalletNo").value="";
		document.getElementById("offlineDetailsDivId").style.display ='none';
		document.getElementById("strWalletNo").value="";
...
function confirmWalletOk()
{
	document.getElementById("strCrNoId").disabled= false;
	document.getElementsByName("strOffLineRaisingDepartment")[0].disabled=false;
	document.getElementsByName("strOffLineTreatmentCategory")[0].disabled=false;
	document.getElementsByName("strOfflinePaymentDtls")[0].disabled=false;
	cardpay();
	document.forms[0].hmode.value = "RECWalletADV";
	document.forms[0].printMode.value="1";
	document.forms[0].isOpenPopUp.value="1";
...
if(payTot[i].value!="")
{
	...
	if(payTot[i].value>0 && parseFloat(payTot[i].value)<=document.forms[0].defsurlim.value)
	{
		if(payModeVal==4)
		{
			...
			alert("Please collect Rs. "+payTot[i].value+" ("+document.getElementsByName("strAdvacnceAmount")[0].value+"+"+document.forms[0].strSurCc.value+"% Surcharge)");
		}
		if(payModeVal==5)
		{
			surval=Math.round(parseFloat((document.forms[0].strSurDc.value/100)*payTot[i].value));
			payTot[i].value=Math.round(parseFloat(payTot[i].value)+surval);
			alert("Please collect Rs. "+payTot[i].value+" ("+document.getElementsByName("strAdvacnceAmount")[0].value+"+"+document.forms[0].strSurDc.value+"% Surcharge)");
		}
		if(payModeVal==8)
		{
			surval=Math.round(parseFloat((document.forms[0].strSurIc.value/100)*payTot[i].value));
			payTot[i].value=Math.round(parseFloat(payTot[i].value)+surval);
			alert("Please collect Rs. "+payTot[i].value+" ("+document.getElementsByName("strAdvacnceAmount")[0].value+"+"+document.forms[0].strSurIc.value+"% Surcharge)");
		}
		if(payModeVal==9)
		{
			surval=Math.round(parseFloat((document.forms[0].strSurId.value/100)*payTot[i].value));
			payTot[i].value=Math.round(parseFloat(payTot[i].value)+surval);
			alert("Please collect Rs. "+payTot[i].value+" ("+document.getElementsByName("strAdvacnceAmount")[0].value+"+"+document.forms[0].strSurId.value+"% Surcharge)");
		}
	}
	else if(parseFloat(payTot[i].value)>document.forms[0].defsurlim.value)
	{
		if(payModeVal==4)
		{
			...
			payTot[i].value=Math.round(parseFloat(payTot[i].value)+surval);
			alert("Please collect Rs. "+payTot[i].value+" ("+document.getElementsByName("strAdvacnceAmount")[0].value+"+"+document.forms[0].strSurCc1.value+"% Surcharge)");
		}
		if(payModeVal==5)
		{
			surval=Math.round(parseFloat((document.forms[0].strSurDc1.value/100)*payTot[i].value));
			payTot[i].value=Math.round(parseFloat(payTot[i].value)+surval);
			alert("Please collect Rs. "+payTot[i].value+" ("+document.getElementsByName("strAdvacnceAmount")[0].value+"+"+document.forms[0].strSurDc1.value+"% Surcharge)");
		}
		if(payModeVal==8)
		{
			surval=Math.round(parseFloat((document.forms[0].strSurIc1.value/100)*payTot[i].value));
			payTot[i].value=Math.round(parseFloat(payTot[i].value)+surval);
			alert("Please collect Rs. "+payTot[i].value+" ("+document.getElementsByName("strAdvacnceAmount")[0].value+"+"+document.forms[0].strSurIc1.value+"% Surcharge)");
		}
		if(payModeVal==9)
		{
			surval=Math.round(parseFloat((document.forms[0].strSurId1.value/100)*payTot[i].value));
			payTot[i].value=Math.round(parseFloat(payTot[i].value)+surval);
			alert("Please collect Rs. "+payTot[i].value+" ("+document.getElementsByName("strAdvacnceAmount")[0].value+"+"+document.forms[0].strSurId1.value+"% Surcharge)");
		}
	}
	if(surval>0)
	{
		//document.getElementsByName("strAdvacnceAmount")[0].value=payTot[i].value;
		document.forms[0].strOfflineTotalRecAmount.value=surval;
...
function cardlogic()
{
	...
	if(payTot[i].value!="")
	{
		...
		document.getElementById("totalBillAmtDivId").innerHTML = "<td class='LABEL'>Billed Amount(<img src='/HBIMS/hisglobal/images/INR.png'>)&nbsp;"+document.forms[0].strAdvacnceAmount.value+"</td>";
