...
var hisValidator = new HISValidator("cashCollectionWithoutCrTransBean");  
	  	...
	  	if(e.keyCode == 13 && document.forms[0].strTariffCode.value.length > 0){
			...
			if(document.getElementById("wardDivId") != null && document.getElementById("wardDivId").style.display == "block"){
				...
				var wardIdVal = document.forms[0].strOffLineWard[document.forms[0].strOffLineWard.selectedIndex].value.split('^')[0];	
				 ...
				 url = "CashCollectionWithoutCrTransCNT.cnt?hmode="+hmode+"&groupId="+document.forms[0].strOffLineGroup[document.forms[0].strOffLineGroup.selectedIndex].value+"&hService="+document.forms[0].strOffLineHospitalService[document.forms[0].strOffLineHospitalService.selectedIndex].value+"&treatmentCat="+treatCat+"&ward="+wardIdVal+"&tariffCode="+document.forms[0].strTariffCode.value;
		 		 
			}else if(document.getElementsByName("strOffLineHospitalService") > 0){
				 url = "CashCollectionWithoutCrTransCNT.cnt?hmode="+hmode+"&groupId="+document.forms[0].strOffLineGroup[document.forms[0].strOffLineGroup.selectedIndex].value+"&hService="+document.forms[0].strOffLineHospitalService[document.forms[0].strOffLineHospitalService.selectedIndex].value+"&treatmentCat="+document.forms[0].strOffLineTreatmentCategory[document.forms[0].strOffLineTreatmentCategory.selectedIndex].value+"&ward=0"+"&tariffCode="+document.forms[0].strTariffCode.value;
			}else{
				
					url = "CashCollectionWithoutCrTransCNT.cnt?hmode="+hmode+"&groupId="+document.forms[0].strOffLineGroup[document.forms[0].strOffLineGroup.selectedIndex].value+"&hService="+document.forms[0].strGeneralChargeTypeId.value+"&treatmentCat="+document.getElementsByName("strOffLineTreatmentCategory")[0].value+"&ward="+document.forms[0].strWardTypeId.value+"&tariffCode="+document.forms[0].strTariffCode.value;
  ...
  */
  function setSelectedCrNo(crNo) {
	...
	document.forms[0].strTempPreviousCrNo.value = document.forms[0].strPreviousCrNo.value;			 
  	...
  	var url = "CashCollectionWithoutCrTransCNT.cnt?hmode="+hmode+"&strPreviousCrNo="+document.forms[0].strPreviousCrNo.value;
