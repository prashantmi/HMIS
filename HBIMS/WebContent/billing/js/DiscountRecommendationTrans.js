...
{  
		var hisValidator = new HISValidator("discountRecommendationTransBean");  
...
{   
          ...
          if(document.forms[0].CrNo.value!="")
          {
		    ...
		    {	
               ...
               if(document.getElementsByName("strChk_values").length > 0){
               
               	 document.forms[0].strTempVal.value= document.getElementsByName("strChk_values")[0].value;
               	
               }else{
               	
               	 document.forms[0].strTempVal.value= "0";
	           ...
	           var mode="BId";
	           var url="DiscountRecommendationTransCNT.cnt?hmode="+mode+"&modName="+document.forms[0].strChk[0].value;
...
{ 
  ...
  // alert("REQ_NO+SBLNUM_BSERVICE_ID+HBLNUM_PATACCOUNT_NO+HiddenValue::"+document.forms[0].strTempVal.value);
   ...
   var url="DiscountRecommendationTransCNT.cnt?hmode="+mode+"&modName="+document.forms[0].strTempVal.value;
...
function myFunc(obj,index)
{
	   ...
	   //    alert("Popup_Id for Tariff Dtl::"+document.forms[0].strPopUpId.value);
	        ...
	        var url="DiscountRecommendationTransCNT.cnt?hmode="+mode+"&modName="+document.forms[0].strTempVal.value+"&popUpId="+document.forms[0].strPopUpId.value;
	    	ajaxFunction(url,"2"); 
}
...
function new_dis_add(obj,index ,discountLimit, rateUnit)
{

  
  document.getElementById("disAmtDivId"+index).innerHTML = "0.00";
     	 
     	  var objDisUnit = document.getElementById("opd_discount"+index);
     var objDisType = document.getElementById("opd_discountType"+ index);
  ...
  if(obj.checked)
  {
      ...
      objDisUnit.disabled = false;
     objDisType.disabled = false;
     
     objDisUnit.value = tempVal[1];
     objDisType.value = tempVal[2];
 ...
 else
 {
  ...
  objDisUnit.value = 0;
    ...
    document.getElementById("disAmt"+index).value = 0;
     document.getElementById("disAmtDivId"+index).innerHTML = "0.00";
        
    objDisUnit.disabled = true;
    objDisType.disabled = true;	
...
///////////////////for selecting a record to cancel/////////////////
	...
	{
	   var mode="Cancel_hlp";
	   var url="DiscountRecommendationTransCNT.cnt?hmode="+mode;
	   ajaxFunction(url,"3");
	}
