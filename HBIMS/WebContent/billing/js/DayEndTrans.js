	 ...
	 */
	 function reprintContents() {
	 		...
	 		if(gblPrintLimitVal != 0){
	 			...
	 			var hmode = "REPRINT"; 
				var url = "DayEndTransCNT.cnt?hmode="+hmode;
...
function getPendingDayEndDetails()
{
        ...
        var url ="DayEndTransCNT.cnt?hmode="+mode+"&billModuleId="+document.forms[0].billModuleId.value+"&counterId="+document.forms[0].strCounterId.value
...
function getDayEndAmount()
{
		...
		if(document.getElementsByName('userMode')[0].value == 1)
		{
        	...
        	var url ="DayEndTransCNT.cnt?hmode="+mode+"&counterId="+document.forms[0].strCounterId.value
...
function getDayEndAmountUserNCounterWise()
{
       ...
       else
       {
        	...
        	var url ="DayEndTransCNT.cnt?hmode="+mode+"&counterId="+document.forms[0].strCountId.value
        			+"&dayEndDate="+document.forms[0].strDayEndDate.value
...
function showBreakupDiv()
{
	...
	else
	{
		...
		document.getElementById("minusign").style.display="";
