	...
	function changeTreatment(){
		...
		if(savedTariff!="" && confirm("All Tariff will be reset")){
			...
			getPartAccDtls(document.forms[0].strOffLineWard[document.forms[0].strOffLineWard.selectedIndex]);
	...
	function generateRows(){
		...
		//alert("ajay");
	//	document.getElementById("strOfflineTariffName2-"+document.multirow.rowIndex2.value).focus();
	 ...
	 */
	 function setOnlineOffLineMode(checkObj) {
	 	...
	 	if(checkObj.checked){
	 		...
	 		document.forms[0].hmode.value="ONLINEMODE";
	 		...
	 		document.forms[0].hmode.value="OFFLINEMODE";
	 		
	 		document.forms[0].strIsOnline.value = "0";
	...
	if(document.forms[0].strCrNo.disabled == false){
		var hisValidator = new HISValidator("cashCollectionTransBean");  
	...
	function onLoadLogics(){
		...
		if(onLineRadioObj.length > 0){
			...
			var url = "CashCollectionTransCNT.cnt?hmode="+hmode+"&crNo="+document.forms[0].strCrNo.value+"&chargeTypeId="+tempVal[3]+"&bServiceId="+tempVal[4]+"&reqNo="+tempVal[0]+"&admNo="+tempVal[10]+"&accNo="+tempVal[11]+"&treatCat="+tempVal[14]+"&reqFor="+tempVal[15]+"&reqType="+tempVal[13]+"&billNo="+tempVal[7]+"&grpId="+tempVal[2];
			ajaxFunction(url,"1");
		}
			
		
			document.getElementById("onLineId").style.display = "block";
			document.getElementById("offLineId").style.display = "none";
			...
			document.getElementById("offLineId").style.display = "block";
	 ...
	 */
	 function getWithoutCrNoOnlineRequests(reqObj) {
	 	...
	 	if(reqObj.value.length > 1){
			...
			var url = "CashCollectionTransCNT.cnt?hmode="+hmode+"&strReqNo="+temp[0]+"&strChargeTypeId=1";
	...
	function getBillService(){
	 ...
	 document.forms[0].currentBserviceId.value = document.forms[0].strOffLineBillingService[document.forms[0].strOffLineBillingService.selectedIndex].value;
	 	...
	 	if(document.forms[0].currentReceiptType.value == '2'){
			...
			var hmode = "BILLDTLS"; 
			var url = "CashCollectionTransCNT.cnt?hmode="+hmode+"&hService="+document.forms[0].strOffLineHospitalService[document.forms[0].strOffLineHospitalService.selectedIndex].value+"&requestType="+document.forms[0].strOffLineRequestType[document.forms[0].strOffLineRequestType.selectedIndex].value;
	...
	function getEpisodeList(obj){
			...
			var url = "CashCollectionTransCNT.cnt?hmode="+hmode+"&crNo="+document.forms[0].strCrNo.value+"&deptCode="+obj.value;
			ajaxFunction(url,"3");
	...
	function getPartAccDtls(obj){
		...
		var hmode = "PARTACCAMT"; 
			var url = "CashCollectionTransCNT.cnt?hmode="+hmode+"&hService="+document.forms[0].strOffLineHospitalService[document.forms[0].strOffLineHospitalService.selectedIndex].value+"&requestType="+document.forms[0].strOffLineRequestType[document.forms[0].strOffLineRequestType.selectedIndex].value+"&billService="+bServiceId+"&treatmentCat="+document.forms[0].strOffLineTreatmentCategory[document.forms[0].strOffLineTreatmentCategory.selectedIndex].value+"&ward="+document.forms[0].strOffLineWard[document.forms[0].strOffLineWard.selectedIndex].value+"&strCrNo="+document.forms[0].strCrNo.value;
	...
	function getOffLineGroupDtls(){
		...
		var hmode = "GROUPDTLS"; 
			var url = "CashCollectionTransCNT.cnt?hmode="+hmode+"&hService="+document.forms[0].strOffLineHospitalService[document.forms[0].strOffLineHospitalService.selectedIndex].value+"&withPack=0";
	...
	function getOffLineClientDtls(){
		...
		var hmode = "OFFLINECLTDTLS"; 
			var url = "CashCollectionTransCNT.cnt?hmode="+hmode+"&crNo="+document.forms[0].strCrNo.value+"&hService="+document.forms[0].strOffLineHospitalService[document.forms[0].strOffLineHospitalService.selectedIndex].value;
	...
	function getTariffDtls(){
			...
			if(document.getElementById("wardDivId").style.display == "block"){
				...
				var wardIdVal = document.forms[0].strOffLineWard[document.forms[0].strOffLineWard.selectedIndex].value.split('^')[0];	
				 ...
				 url = "CashCollectionTransCNT.cnt?hmode="+hmode+"&groupId="+document.forms[0].strOffLineGroup[document.forms[0].strOffLineGroup.selectedIndex].value+"&hService="+document.forms[0].strOffLineHospitalService[document.forms[0].strOffLineHospitalService.selectedIndex].value+"&treatmentCat="+document.forms[0].strOffLineTreatmentCategory[document.forms[0].strOffLineTreatmentCategory.selectedIndex].value+"&ward="+wardIdVal;
		 		 
			}else{
				 url = "CashCollectionTransCNT.cnt?hmode="+hmode+"&groupId="+document.forms[0].strOffLineGroup[document.forms[0].strOffLineGroup.selectedIndex].value+"&hService="+document.forms[0].strOffLineHospitalService[document.forms[0].strOffLineHospitalService.selectedIndex].value+"&treatmentCat="+document.forms[0].strOffLineTreatmentCategory[document.forms[0].strOffLineTreatmentCategory.selectedIndex].value+"&ward=0";
			}
	...
	function getOffLinePkgsGroupDtls(){
		...
		var hmode = "PKGGROUPDTLS"; 
			var url = "CashCollectionTransCNT.cnt?hmode="+hmode+"&hService="+document.forms[0].strOffLineHospitalService[document.forms[0].strOffLineHospitalService.selectedIndex].value+"&withPack=1";
	...
	function getOffLinePkgConfigDetails(index){
		...
		var hmode = "PKGDTLS"; 
			var url = "CashCollectionTransCNT.cnt?hmode="+hmode+"&rowIndex="+index;
	...
	/**
		 ...
		 */
		 function getOffLineTariffUnit(unitId,baseValue,index) {
		 	...
		 	var hmode = "TRFUNIT"; 
			var url = "CashCollectionTransCNT.cnt?hmode="+hmode+"&unitId="+unitId+"&baseValue="+baseValue+"&rowIndex="+index;
	 ...
	 */
	 function getOffLineRefundBillDetails() {
	 	...
	 	var hmode = "REFUNDBILLDTLS"; 
			var url = "CashCollectionTransCNT.cnt?hmode="+hmode+"&crNo="+document.forms[0].strCrNo.value+"&chargeType="+document.forms[0].strOffLineHospitalService[document.forms[0].strOffLineHospitalService.selectedIndex].value+"&accNo="+accNo;
	 ...
	 */
	 function getBillTariffDtls(obj) {
	 	...
	 	var hmode = "REFUNDBILLTARIFFDTLS"; 
			var url = "CashCollectionTransCNT.cnt?hmode="+hmode+"&billNo="+tempVal[0]+"&accNo="+tempVal[4]+"&hospService="+document.forms[0].strOffLineHospitalService[document.forms[0].strOffLineHospitalService.selectedIndex].value;
	  ...
	  */
	  function showTariffPopup(obj,hidVal) {
	  	...
	  	var hmode = "REFUNDBILLTARIFFPOPUPDTLS"; 
			var url = "CashCollectionTransCNT.cnt?hmode="+hmode+"&hidValue="+hidVal;
	   ...
	   */
	   function getwithoutCrNoBillService() {
	   	...
	   	var hmode = "BILLDTLS"; 
			var url = "CashCollectionTransCNT.cnt?hmode="+hmode+"&hService="+document.forms[0].strOffLineHospitalService.value+"&requestType="+document.forms[0].strOffLineRequestType[document.forms[0].strOffLineRequestType.selectedIndex].value;
						
			ajaxFunction(url,"17");
	   	
	   }
	  
	  function getwithoutCrNoTariffDtls(){
			var hmode = "TARIFFDTLS"; 
			var url =  "CashCollectionTransCNT.cnt?hmode="+hmode+"&groupId="+document.forms[0].strOffLineGroup[document.forms[0].strOffLineGroup.selectedIndex].value+"&hService="+document.forms[0].strOffLineHospitalService.value+"&treatmentCat="+document.forms[0].strOffLineTreatmentCategory.value+"&ward=0";
	 ...
	 function showReconcilPopup(hidVal,parentPos){
			...
			var url = "CashCollectionTransCNT.cnt?hmode="+hmode+"&hidVal="+hidVal;
	 ...
	 */
	 function getOnlineThirdPartyAmtView() {
	 	...
	 	var hmode = "ONLINETHIRDPARTYAMTDTL"; 
			var url = "CashCollectionTransCNT.cnt?hmode="+hmode+"&strChargeTypeId="+gblOnLineHService+"&strRequestTypeId="+gblReqType+"&strBServiceId="+gblBServiceId+"&clientStatus="+clientStatus;
	 ...
	 */
	  ...
	  */
	  function initOfflineRaisingDepartment() {
			...
			var url = "CashCollectionTransCNT.cnt?hmode="+hmode+"&strChargeTypeId="+chargeTypeId+"&strCrNo="+crNo;
	...
	function getAjaxResponse(res,mode)
	{
	 ...
	 /*
		...
		/*	if(temp[1] == "0" || temp[1] == ""){
			...
			document.forms[0].strOffLineTreatmentCategory.selectedIndex = temp[1];
			}
				*/
		...
		if(mode == '4'){
			...
			addRows(new Array('strOfflinePackageName','strOfflinePackageRateUnit','strOfflinePackageReqQty','strOfflinePackageUnit','strOfflinePackageServiceTax','strOfflinePackageDiscount','strOfflinePackageNetAmount','flag'),new Array('t','t','t','t','t','t','t','t'),'4','1','I');
			document.getElementById("offlinePkgsDivId").style.display="block";
	 ...
	 if(parseFloat(val) < 0){
			...
			document.forms[0].strOfflineTotalPayAmount.value = val;
				...
				resetMultiRow(4);
				document.getElementById("offlinePkgsDivId").style.display="none";
			}
			...
			var flg1 = true;		
				...
				if(reqType == '1' &&  (billSer == '19' || billSer == '20')){
		...
		if(mode == '5'){
				...
				document.getElementById("groupDivId").innerHTML = "<table border='0' cellpadding='0' cellspacing='0'><tr><td class='TITLE'>Group </td><td class='TITLE'><select name='strOffLineGroup' class='comboMax' onchange='getTariffDtls();'>"+res+"</select></td></tr></table>";
		...
		if(mode == '6'){
			...
			if( reqType == '1' && ( billSer == '10' || billSer == '11' || billSer == '12')){
				...
				if (offlineHospitalService == '2' && patientStatus == '12' && accountNo.length < 2){
	...
	*/
			var otherDtlsDivObj = document.getElementById("partPayAdvanceDivId");
		
		if(otherDtlsDivObj != null)
		if( otherDtlsDivObj.innerHTML.length > 0){
			
			otherDtlsDivObj.style.display = "block";
		...
		document.getElementsByName("strOfflineAmount")[0].focus();	 
			...
			otherDtlsDivObj.style.display = "none";
		       	...
		       	document.getElementById("normalMsg").style.display ="none";
		          	...
		          	return;
		       		...
		       		if(tempVal.length >= 8){
			       		...
			       		document.forms[0].strPreviousCrNo.disabled = true;		       					       
			       		document.forms[0].strGuarantorName.disabled = true;	
			       		document.forms[0].strAge.disabled = true;	
			       		document.forms[0].strAgeUnit.disabled = true;	
			       		document.forms[0].strGender.disabled = true;	
	  ...
	  */
	  ...
	  function calcOnlineTotalRecAmount() {
	 	...
	 	if(clientBalAmtObj.length > 0){
	 		...
	 		document.getElementsByName("strOnlineAmount")[0].value = cltAmtDtls.oPatAmt; 		
	  	...
	  	if(e.keyCode == 13 && document.forms[0].strTariffCode.value.length > 0){
			...
			if(document.getElementById("wardDivId") != null && document.getElementById("wardDivId").style.display == "block"){
				...
				var wardIdVal = document.forms[0].strOffLineWard[document.forms[0].strOffLineWard.selectedIndex].value.split('^')[0];	
				 ...
				 url = "CashCollectionTransCNT.cnt?hmode="+hmode+"&groupId="+document.forms[0].strOffLineGroup[document.forms[0].strOffLineGroup.selectedIndex].value+"&hService="+document.forms[0].strOffLineHospitalService[document.forms[0].strOffLineHospitalService.selectedIndex].value+"&treatmentCat="+document.getElementsByName("strOffLineTreatmentCategory")[0].value+"&ward="+wardIdVal+"&tariffCode="+document.forms[0].strTariffCode.value;
		 		 
			}else if(document.getElementsByName("strOffLineHospitalService") > 0){
				 url = "CashCollectionTransCNT.cnt?hmode="+hmode+"&groupId="+document.forms[0].strOffLineGroup[document.forms[0].strOffLineGroup.selectedIndex].value+"&hService="+document.forms[0].strOffLineHospitalService[document.forms[0].strOffLineHospitalService.selectedIndex].value+"&treatmentCat="+document.forms[0].strOffLineTreatmentCategory[document.forms[0].strOffLineTreatmentCategory.selectedIndex].value+"&ward=0"+"&tariffCode="+document.forms[0].strTariffCode.value;
			}else{
				
					url = "CashCollectionTransCNT.cnt?hmode="+hmode+"&groupId="+document.forms[0].strOffLineGroup[document.forms[0].strOffLineGroup.selectedIndex].value+"&hService=1&treatmentCat="+document.getElementsByName("strOffLineTreatmentCategory")[0].value+"&ward=0"+"&tariffCode="+document.forms[0].strTariffCode.value;
...
function getParticularsDetails(obj,grpId,acctNo,index) 
{
 ...
 function fetchPopUpData(grpId,acctNo,index)
  { 
     ...
     var url="CashCollectionTransCNT.cnt?hmode="+mode+"&modName="+modeVal;
  ...
  function setSelectedCrNo(crNo) {
	  ...
	  */
	  function calcRefundTariffAmount(index) {
	  	...
	  	document.getElementsByName("strOnlineAmount")[0].value = grandTotal; 		
	 			 		
	 			 		  	 			 			 			
	 		document.forms[0].strOnlinePatNetPayAmount.value = grandTotal;
	 		document.getElementById("onlinePatNetPayDivId").innerHTML = grandTotal ;	 		
	  ...
	  function goBillFunc() {
	  	...
	  	var val = document.forms[0].strBillNo.value.charAt(0);
	  		...
	  		if(val == '5'){
				...
				hisValidator.addValidation("strBillNo", "minlen=10", "Bill No. must be 10 Digits" );
				...
				hisValidator.clearAllValidations();
					...
					if(retVal){
						var hmode = "GOBILL"; 
						var url = "CashCollectionTransCNT.cnt?hmode="+hmode+"&billNo="+document.forms[0].strBillNo.value;
	  			...
	  			document.getElementById("errMsg").innerHTML = "Invalid Bill No.";
				document.forms[0].strBillNo.value = "";
				document.forms[0].strBillNo.focus();
	  		}
	  	}
	...
	if(document.forms[0].strPreviousCrNo.disabled == false){
		...
		hisValidator.addValidation("strPreviousCrNo", "maxlen=10", "Previous CR No. must be Maximum 10 Digits" );
  	...
  	var url = "CashCollectionTransCNT.cnt?hmode="+hmode+"&strPreviousCrNo="+document.forms[0].strPreviousCrNo.value;
 ...
 */
 function showBillListingWindow(userJsFuncName) {
 	...
 	if(document.forms[0].strBillNo.value == ""){
				...
				var myWindow = window.open(createFHashAjaxQuery('CashCollectionTransCNT.cnt?hmode='+hmode+"&usrFuncName="+userJsFuncName,'popupWindow',featuresList)); 
  ...
  */
  function fetchBillList(fromRows,blockSet) {
  	...
  	var url = "CashCollectionTransCNT.cnt?hmode="+hmode+"&searchString="+convString+"&fromRow="+fromRows+"&rowPerPage="+gblRowPerPage+"&ctBlockSet="+blockSet;
	 ...
	 function onlineSubmitPart() {
			...
			var cashAmtObj = getCashPayObject('1');
				...
				if( cashAmtObj != null){
		 		...
		 		//	document.forms[0].strOnLineRefundReasonText.disabled = false;	
