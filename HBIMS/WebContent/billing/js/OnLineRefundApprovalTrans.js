...
function showIndentData1()
{
    document.getElementById("indentMinusID1").style.display="block";
	document.getElementById("indentPlusID1").style.display="none";
	document.getElementById("showNewPriceBidDiv").style.display="block";
}

function hideIndentData1()
{
	document.getElementById("indentMinusID1").style.display="none";
	document.getElementById("indentPlusID1").style.display="block";
	document.getElementById("showNewPriceBidDiv").style.display="none";
}
function showIndentData11()
{
    document.getElementById("indentMinusID11").style.display="block";
	document.getElementById("indentPlusID11").style.display="none";
	document.getElementById("showNewPriceBidDiv1").style.display="block";
}

function hideIndentData11()
{
	document.getElementById("indentMinusID11").style.display="none";
	document.getElementById("indentPlusID11").style.display="block";
	document.getElementById("showNewPriceBidDiv1").style.display="none";
}
...
{
 		 var mode = "GO";   
		 var url="OnLineRefundApprovalCNT.cnt?hmode="+mode+"&strSearchMode="+Obj1.value+"&strSearchValue="+Obj2.value; 
		 ajaxFunction(url,"1");
 ...
 */
 function getRefundRequestDtls() {
 	 ...
 	 var mode = "SEARCH";   
				 var url="OnLineRefundApprovalCNT.cnt?hmode="+mode+"&strSearchMode=&strSearchValue="; 
				 ajaxFunction(url,"1");
...
function getAjaxResponse(res,mode){
	 ...
	 var temp1 = res.split("####");
	   if(temp1[0] == "ERROR"){
	    ...
	    if(mode == 1)
	    {
	    	if(res.includes("No Refund Request Found!!!"))
	    	{
...
{   
           	...
           	{
	           	 var mode = "GO";   
				 var url="OnLineRefundApprovalCNT.cnt?hmode="+mode+"&strSearchMode="+document.getElementById("strTariffValue").value; 
				 ajaxFunction(url,"2");
           	}
           	else
           	{
