...
<html>
<head>
<meta charset=utf-8><title>Tariff Search</title>
...
/* $(function() {    
	...
	$('strTariffName').keyup(function(e){
		if(e.keyCode == 13)
	    {
	    	$(this).trigger("enterKey");
	        //getDrugNameSelected(suggestion.data);
	        document.forms[0].strTariffName.value=suggestion.data;
	        searchTariffCodeValidate1();
	    }
	});
	//alert(itemList.length);
	
	$('#strTariffName').autocomplete({
		   lookup: itemList,
		   minChars:1,
...
<body onLoad="document.forms[0].strTariffName.focus(),isTariffCodeSearchRequired();myTariffCodeFunc1('1');" onkeypress="ESCclose(event)">
<html:form action="/transactions/BillingCNT.cnt"
	...
	<table width="100%" align="center">
		...
		<tr style='display:none;'>
			...
			<td colspan="1" class="CONTROL" width="25%">
				<select class="comboNormal" name="strSearchType" tabindex="1" onchange="myTariffCodeFunc1(this.value);">
					<option value="1">Tariff</option>
					<option value="2">Drug</option>
					<!-- <option value="2" selected="selected">Tariff Code</option>  -->
				</select>
			</td>
			<td colspan="1" class="CONTROL" width="25%" style="display: none;">			
				<%--<div id="tariffdivid" style="display: none;">
				 	<select name="strMultiRowItemId1" id="strMultiRowItemId1" class="comboTooMax">
						<bean:write name="billingBean" property="strTariffNameCombo" filter="false" />
					</select> 
				</div>		--%>	
				<input type="text" name="strTariffName" id="strTariffName" class="txtFldMax" maxlength="40" value='${billingBean.searchText}' 
					 onkeyup="getTariffCodeSearchContent1(event);" tabindex="1">
			...
			<td colspan="1" class="multiControl"  width="25%" style="display: none;">
				...
				onClick="return searchTariffCodeValidate1();" onkeypress="return searchTariffCodeValidate1();"></td>
		</tr>
		<tr>
			<div class="preload" id="id1"><img src="/HBIMS//hisglobal/images/load_list.gif"></div><!-- src="http://i.imgur.com/KUJoe.gif" -->
		...
		<tr>
			...
			<td class="multiLabel" width='10%'>
				<div id="plusId">
					<img name="plus" style="cursor: hand; cursor: pointer" src="../../hisglobal/images/plus.gif" onClick="trfCodeshowHelp('helpDivId');"></div>
				<div id="minusId" style="display: none">
					<img name="minus" src="../../hisglobal/images/minus.gif" style="cursor: hand; cursor: pointer" onClick="trfCodehideHelp('helpDivId'); "></div>
			</td>
		</tr>
		<tr>
			<td colspan="4">
				<div id="helpDivId" style="display: none">
					<table width='100%' align="center">
						<tr>
							<td class="CONTROL"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Use <b>%</b> to Find Any Data of Any Length</td>
						</tr>
						<tr>
	...
	<input type="hidden" name="wardId" value="${billingBean.wardId }" />
