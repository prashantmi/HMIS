...
<div class="popUpDiv" id="payDtlCLTMenu" style="display: none;">
	...
	<tag:tab tabLabel="LF Account Close" selectedTab="FIRST" align="center" onlyTabIndexing="1"
		width="TABLEWIDTH">
	</tag:tab></center>
	...
	<table class='TABLEWIDTH' border="0" cellpadding="1px"
	 ...
	 <div id ="disBnR" style="display: block;">
	  <table class="TABLEWIDTH" align="center" cellpadding="0" cellspacing="">
		<tr class="FOOTER">
			<td colspan="4" width='100%' align="left">Close LF Account </label></td>
		</tr>
	  </table>
		...
		<tr>
			...
			<table>
				<tr>
					...
					<td class="CONTROL">
					<div id='totalRecAmtDivId'></div>${LFNoTransBean.strLFBalanceAmount}</div>
					</td>
				</tr>
			</table>
...
<input type="hidden" name="strExpenseamt" value="${LFNoTransBean.strExpenseamt}"/>
<input type="hidden" name="strCRNum" value="${LFNoTransBean.strCrNo}"/>
