...
<script language="Javascript" src="../js/cashcollection_offline_transBS.js"></script>
...
<html:form action="/transactions/CashCollectionOfflineTransBSCNT" method="post" enctype="multipart/form-data">
<fieldset form="form1">
  ...
  <div class="legend2" id='nonPrintableLegend2'>
    ...
    <button  type="button" id="savebutton" class="float-right btn btn-outline-success mt-1 btn-circle savebtn" tabindex='2' onclick='return findBillServices();' style="display: none;background-color: #5cb85c;">					
...
<div class="prescriptionTile">
	...
	<center>
		...
		<tag:tabNew1 tabList="${cashCollectionOfflineTransBean.lhm}" selectedTab="OFFLINE" align="center" width="TABLEWIDTH"></tag:tabNew1>
	</center>
...
<div class="popUpDiv" id="payDtlCLTMenu" style="display: none;">
			             ...
			             (<img src='/HBIMS/hisglobal/images/INR.png'>)
							...
							<img style="cursor: pointer" name="printLastButton" src="../../hisglobal/images/print_on.gif" onclick="printLastBill();" title="Print Last Bill">
								...
								<div class="row roFlex reFlex">
									...
									<div class="col-sm-2">
										Client Amount (<img src='/HBIMS/hisglobal/images/INR.png'>)
										<label id='totalCltAmtLabId'>0.00</label>
									</div>
									<div class="col-sm-2">
										Net Amount (<img src='/HBIMS/hisglobal/images/INR.png'>)
										<label id='totalRecAmtLabId'>0.00</label>
									</div>
								</div>
	...
	<%-- <table class="TABLEWIDTH" align="center" cellpadding="1px" cellspacing="1px">
		<tr>
			...
			<div id='billServiceDivId'><select class="browser-default custom-select" name="strOffLineBillingService" onchange="resetTotalAmount(this);">
		...
		<tr>
			...
			<td width="25%" class="CONTROL" colspan="1">			
				...
				<logic:equal name="cashCollectionOfflineTransBean" property="strIsRefundReq" value="0">
                    ...
                    <div id="goid">
								<div class="row rwFlex reFlex">
									<div class="col-sm-3" align="right">
										<label>Hospital Service<font color="red">*</font></label>
									</div>
									<div class="col-sm-2" >
										<select class="browser-default custom-select"
											name="strOffLineHospitalService"
											onchange="getBillService();changeComboClass(this);">
											<bean:write name="cashCollectionOfflineTransBean"
									...
									<div class="col-sm-3" align="right">
										<label>Billing Services<font color="red">*</font></label>
									</div>
									<div class="col-sm-2" id='billServiceDivId'>
										<select class="browser-default custom-select"
											name="strOffLineBillingService"
											onchange="resetTotalAmount(this);">
											<bean:write name="cashCollectionOfflineTransBean"
								...
								<div class="row rwFlex reFlex">
									<div class="col-sm-3" align="right">
										<label>CR No.<font color="red">*</font></label>
									</div>
									<div class="col-sm-2">
										<crNo:crNo id="strCrNoId" name="strCrNo"
											value="${cashCollectionOfflineTransBean.strCrNo}"
									...
									<div class="col-sm-2">
										<logic:equal name="cashCollectionOfflineTransBean"
											property="strIsRefundReq" value="1">
											<html:select name="cashCollectionOfflineTransBean"
												property="strOffLineRequestType" styleClass="browser-default custom-select"
												onchange="getBillService();">
												<html:option value="1">Receipt</html:option>
												<html:option value="2">Refund</html:option>
												<html:option value="3">Estimation</html:option>
											</html:select>
										...
										<logic:equal name="cashCollectionOfflineTransBean"
											property="strIsRefundReq" value="0">
											<html:select name="cashCollectionOfflineTransBean"
												property="strOffLineRequestType" styleClass="browser-default custom-select"
												onchange="getBillService();">
												<html:option value="1">Receipt</html:option>
	...
	<div id='offlineClientDivId'><bean:write
		...
		<div id="offlineDepEpdTreatWardDivId" style="display: block">
										...
										<div class="row rowFlex reFlex">
											<div class="col-sm-2">
												<label>Raising Department<font color="red">*</font></label>
											</div>
											<div class="col-sm-2">
												<div id='offlineRaisingDepartmentDivId'>
													<select class="browser-default custom-select"
														name="strOffLineRaisingDepartment"
											...
											<div class="col-sm-2">
												<div id='episodeDivId'>
													<select class="browser-default custom-select"
														...
														onchange='changeEpisodeClass(this)'>
														<bean:write name="cashCollectionOfflineTransBean"
											...
											<div class="col-sm-2">
												<label>Patient Category<font color="red">*</font></label>
											</div>
											<div class="col-sm-2">
												<div id='offlineTreatmentCategoryDivId'>
													<select class="browser-default custom-select"
														name="strOffLineTreatmentCategory"
														onchange="poorFreeCheck('strOffLineTreatmentCategory'),getPartAccDtls(document.getElementsByName('strOffLineWard')[0]),chkPaidCredit();resetAmt();getPaymentModeByPatCat();">
														<bean:write name="cashCollectionOfflineTransBean"
					...
					<div id='offlineWardDivId'><select class="comboNormal"
						...
						<bean:write name="cashCollectionOfflineTransBean"
							property="strWardDetails" filter="false" />
									...
									<div class="row rowFlex reFlex">
										<div class="col-sm-4" id='wardDivId' style="display: none">
											<div class="row rowFlex reFlex">
												<div class="col-sm-6">
													<label>Charge Type<font color="red">*</font></label>
												</div>
												<div class="col-sm-6">
													<div id='offlineWardDivId'>
														<select class="browser-default custom-select"
															name="strOffLineWard" onchange="changeWard();">
															<bean:write name="cashCollectionOfflineTransBean"
																property="strWardDetails" filter="false" />
														</select>
													</div>
										...
										<div class="col-sm-4" id='specialWardDivId'>
											<div class="row rowFlex reFlex">
												<div class="col-sm-6">
													<label>Ward Name</label>
												</div>
												<div class="col-sm-6">
													<div id='offlineSpecialWardDivId'>
														<select class="browser-default custom-select"
															name="strOffLineSpecialWard" onchange="changeWard();">
															<bean:write name="cashCollectionOfflineTransBean"
...
<div id="accountCatDiv" style="display: none">
	...
	<div class="col-sm-2" id='trfCodeDivId' align="right"><label class="blink">Enter Tariff Code</label></div>
	<div class="col-sm-2"><input type="text" class="form-control" autocomplete='off' name="strTariffCode" id="strTariffCode" tabindex="1"  maxlength="15"  onkeypress="return validateData(event,8);" onkeyup="getTariffByCode(this , event),showTariffCodeSearchPopup(event,'strTariffCode','0'),chkPaidCredit();">
	</div>
	<div class="col-sm-1"><label class="lablecolor">Group</label></div>
	<div class="col-sm-2" id='groupDivId'>
					
					<select tabindex="2" name="strOffLineGroup" class="browser-default custom-select">
		...
		<thead>
		<tr role="row">
			<th><font color="red">*</font>Tariff	Name</th>
			<th>Rate / Unit</th>
			<th><font color="red">*</font>Qty.</th>
			<th style='display:none;'><font color="red">*</font>Unit</th>			
			<th style="display:none"  >S. Tax (%)<input type="hidden" name="strOfflineTotalServiceTaxAmount" value="0"></th>
			<th>Dis. / Unit<input type="hidden" name="strOfflineTotalDiscountAmount" value="0"></th>
			<th></th>
			<th>Payment Type</th>
			<th>Credit Letter No./Date/Org/Limit</th>
			<th>Upload Letter[<font color='red'>JP(E)G/PDF</font>]</th>
			<th>Net Amt.(<font color='red'>*</font>)<input type="hidden" name="strOfflineTotalActualTariffAmount" value="0"></th>
			<th><img style="cursor: hand; cursor: pointer" tabindex="2" src="/HBIMS/hisglobal/images/plus.gif" onclick="generateRows()"></th>
			<!-- <th colspan="12" width='100%'><div class='lineContinue'>&nbsp;</div></th> -->
			<th></th>
	</tr>
	</thead>
	<tbody id="id2">
...
<!--  		
	...
	<br>
	<p class="subHeaders"><i class="fas fa-money-bill"></i>&nbsp;&nbsp;Payment</p>
				...
				<tr>
					...
					<div id='offlinePatNetPayDivId'>0.00</div>
								...
								<div class="row rowFlex reFlex">
									...
									<div class="col-sm-3">
										<label>Net Payable / Refundable Amount(<img
											src='/HBIMS/hisglobal/images/INR.png'>)
										</label>
									</div>
									<div class="col-sm-1">
										<input type='hidden' name='strOfflineTotalRecAmount'
								...
								<div class="row rowFlex reFlex">
									<div class="col-sm-6"></div>
									<div class="col-sm-3">
										<label>Net Payment / Refund Amount (<img
											src='/HBIMS/hisglobal/images/INR.png'>)
										</label>
									</div>
									<div class="col-sm-1">
										<input type='hidden' name='strOfflineTotalPayAmount'
...
<jsp:include page="multirow_cashcollection_offline_billtransNew.jsp"></jsp:include>
<jsp:include page="dropdown_cashcollection_offline_transNew.jsp"></jsp:include>
...
<jsp:include page="billing_receipt_printing_popup.jsp"></jsp:include>
                                ...
                                <div id="tariffDiscountDtls" style="display: none;">
									<div class="modal-container" id="payDtlCDMenu">
										<!-- style="display: none;"> -->
											...
											<div class="modal-dialog modal-lg">
												...
												<div class="modal-content">
													<div class="modal-header">
														<h5 class="modal-title">Tariff Discount Details</h5>
													...
													<div class="modal-body" id="modalSpaceId">
														...
														<div class="row rowFlex reFlex">
															...
															<div class="col-sm-3">
																<label><font color="red">*</font>Discount Type</label>
															</div>
															<div class="col-sm-3">
																<select title="_div_popup_cntl"
																	name='strOffLineTariffDiscountType' class='browser-default custom-select'>
																	<option value='1'>Fixed</option>
																	<option value='2' selected>Percentage</option>
																</select>
															</div>
														...
														<div class="row rowFlex reFlex">
															...
															<div class="col-sm-3">
																<select title="_div_popup_cntl" class='browser-default custom-select'
																	name="strOffLineTariffDiscountBy">
																	<bean:write name="cashCollectionOfflineTransBean"
																		property="strOfflineDiscountApprovedByDetails"
																		filter="false" />
																</select>
															</div>
															<div class="col-sm-3">
																<label>Discount Reason<font color="red">*</font>
																</label>
															</div>
															<div class="col-sm-3">
																<select title="_div_popup_cntl" class='browser-default custom-select'
																	...
																	onchange="setReasonText();">
																	<bean:write name="cashCollectionOfflineTransBean"
																		property="strOfflineDiscountRemarksDetails"
																		filter="false" />
																</select> <input type="text"
																	name="strOffLineTariffDiscountReasonText"
														...
														<div class="row rowFlex reFlex">
															...
															<div class="col-sm-3">
																<input type="text" placeholder="(dd-Mon-yyyy)"
														...
														<div class="row rowFlex reFlex">
															<div class="col-sm-12" align="center">
																<button type="button" class="btn btn-success"
																	onClick='validateTariffDiscountDetails();'>Save</button>
