...
<meta charset=UTF-8>
<title>Advance Cash Collection Offline</title>
...
<script language="Javascript" src="../js/advance_cashcollection_offline_trans.js"></script>
			...
			<table width='300' border='0' cellpadding='0' cellspacing='0'>
				<tr>
					...
					<center>
						...
						onClick="hidePayDetails('payDtlCDDMenu');">
						 -->
							<a href="#" class="button" id="" onclick=' return validateCheckDD();'><span class="save">Save</span></a>
							<a href="#" class="button"	onclick="hidePayDetails('payDtlCDDMenu');"><span class="cancel">Cancel</span></a> 
			...
			<table width='300' border='0' cellpadding='0' cellspacing='0'>
				<tr>
					...
					<center><!-- <img style="cursor: hand; cursor: pointer"
						...
						style="cursor: hand; cursor: pointer"
						src='../../hisglobal/images/btn-ccl.png' tabindex="1"
						onClick="hidePayDetails('payDtlCDMenu')">-->
							<a href="#" class="button" id="" onclick=' return validateCreditDebit();'><span class="save">Save</span></a>
							<a href="#" class="button"	onclick="hidePayDetails('payDtlCDMenu');"><span class="cancel">Cancel</span></a> 
...
<div class="popUpDiv" id="payDtlCLTMenu" style="display: none;">
			...
			<table width='300' border='0' cellpadding='0' cellspacing='0'>
				<tr>
					...
					<center><!-- <img style="cursor: hand; cursor: pointer"
						...
						style="cursor: hand; cursor: pointer"
						src='../../hisglobal/images/btn-ccl.png' tabindex="1"
						onClick="hidePayDetails('payDtlCLTMenu')">-->
						<a href="#" class="button" id="" onClick=' return validateClientDetails();'><span class="save">Save</span></a>
							<a href="#" class="button"	onClick="hidePayDetails('payDtlCLTMenu');"><span class="cancel">Cancel</span></a> 
			...
			<table width='300' border='0' cellpadding='0' cellspacing='0'>
				<tr>
					...
					<center><!-- <img style="cursor: hand; cursor: pointer"
						...
						onClick="hideOffLinePkgDiscountDetails('pkgDiscountDtls');">
						-->
						<a href="#" class="button" id="" onClick=''><span class="save">Save</span></a>
							<a href="#" class="button"	onClick="hideOffLinePkgDiscountDetails('pkgDiscountDtls');"><span class="cancel">Cancel</span></a> 
						</center>
					</td>
				</tr>
			</table>
			...
			<table width='300' border='0' cellpadding='0' cellspacing='0'>
				<tr>
					...
					<center><!--  <img style="cursor: hand; cursor: pointer"
						...
						style="cursor: hand; cursor: pointer"
						src='../../hisglobal/images/btn-ccl.png'
						onClick="hideOffLineTariffDiscountDetails('tariffDiscountDtls');">
						-->
						<a href="#" class="button" id="" onClick='validateTariffDiscountDetails();'><span class="save">Save</span></a>
						<a href="#" class="button"	onClick="hideOffLineTariffDiscountDetails('tariffDiscountDtls');"><span class="cancel">Cancel</span></a>
						</center>
					</td>
				</tr>
			</table>
	...
	<table class="TABLEWIDTH" align="center" cellpadding="1px" cellspacing="1px">
		<tr>
			...
			<td class="CONTROL" colspan="1" width="25%"><select class="comboNormal" name="strOffLineHospitalService" onchange="getBillService();changeComboClass(this);changeEpsiodeBasedOnSelectedHospService();">
	...
	<div id='offlineClientDivId'><bean:write
		...
		<tr>
			...
			<div id='episodeDivId'><select class="comboNormal"
				name="strOffLineEpisode" onchange='changeHospServiceBasedOnSelectedEpisodeVisitType()'>
				<bean:write name="cashCollectionOfflineTransBean"
		...
		<tr>
			...
			<div id='offlineTreatmentCategoryDivId'>
				<select class="comboNormal" name="strOffLineTreatmentCategory" onchange="poorFreeCheck('strOffLineTreatmentCategory'),getPartAccDtls(document.getElementsByName('strOffLineWard')[0]),getPaymentModeByPatCat();chkPaidCredit();resetAmt();">
		...
		<tr>
			...
			<table cellpadding="0" cellspacing="0" width="100%">
				<tr>
					...
					<div id='trfCodeDivId' align="right"><label class='blink'>Enter Tariff Code</label><input type="text" class="txtFldBig" autocomplete='off' name="strTariffCode" id="strTariffCode" tabindex="1"  maxlength="15"  onkeypress="return validateData(event,8);" onkeyup="getTariffByCode(this , event),showTariffCodeSearchPopup(event,'strTariffCode','0'),chkPaidCredit();" >
					</div>
					</td>
					...
					<img onkeypress='onPressingEnter(this,event)' id='addCreditLetter' style='cursor: pointer; display:none;' onclick='addNewCreditLetter(this,1)' src='../../hisglobal/images/plus.gif' align='middle'>
					...
					<table border='0' cellpadding='0'   cellspacing='0'><tr><td class="TITLE">Group </td><td class="TITLE">
...
<!--  		 	</td>  -->
			...
			<td class="multiLabel" width="1%"><img style="cursor: hand; cursor: pointer" src="/HBIMS/hisglobal/images/plus.gif" onclick="generateRows()"></td>
	...
	<div id="consumableChargeDiv">
	 ...
	 <div id ="creditDtlsDivId" style="display: block;"><bDtl:onlnCltDtl crNo="${cashCollectionOnlineTransBean.strCrNo}" ></bDtl:onlnCltDtl></div>
...
<!-- 		</tr> -->
	...
	<table class='TABLEWIDTH' align='center' cellpadding='1px'
		...
		<tr>
			...
			<table>
				<tr>
					<td><input type='hidden'name='strOfflineMaxClientBenefitAmount' id='strOfflineMaxClientBenefitAmount' value='0.00'></td>
	...
	<table class="TABLEWIDTH" align="center" cellpadding="1px" cellspacing="1px">
		<tr>
			...
			<table width='100%' align="center" cellpadding="1px"
				...
				<tr>
					<td class="CONTROL" colspan="2" ><font size="2" color="red">*Patient Category Combo Rules:</font>Admitted Patient Then Default Selected Category Admitted Treatment Category. 
					OPD Patient Then Episode Treatment Category/Episode Category. If No Episode Treatment Category Then Primary Category. Department/Episode Is Last Visted Department/Episode
					</td>
				</tr>
				<tr>
					<td class="CONTROL" colspan="2" ><font size="2" color="red">*Hospital Service Combo Rules:</font>Admitted Patient -IPD Only. 
					Otherwise All the Service Types where patient has vistited in last 15 Days. If No Visit in Last 15 Days Then OPD Morning Only.					
					</td>
				</tr>
				<tr>
...
<div align="center" id="saveid">					 
							<a href="#" class="button" id="" onClick="return findBillServices();" onkeypress="onKeyPressLogic('1',event);""><span class="save">Save</span></a>
							<a href="#" class="button"	onClick="clearFunc(document.forms[0].strCounterMode.value);"><span class="clear">Clear</span></a> 
							<a href="#" class="button" onClick="cancelFunc();" onClick="cancelFunc();" onkeypress="onKeyPressLogic('3',event);"><span class="cancel">Cancel</span></a>
					</div>
