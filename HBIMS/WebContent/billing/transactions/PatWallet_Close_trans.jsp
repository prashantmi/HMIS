...
<div class="popUpDiv" id="cardAmtDiv" style="display: none;">
    ...
    <td colspan="3" class="CONTROL" style="display:block"><div id="CRWise">
<crNo:crNo id="strCrNoId" name="strCrNo" value="${PatWalletTransBean.strCrNo}" js="onkeypress='return initGoFunc(event);'"></crNo:crNo>
	...
	<table class='TABLEWIDTH' border="0" cellpadding="1px"
	 ...
	 <div id ="disBnR" style="display: block;">
	  <table class="TABLEWIDTH" align="center" cellpadding="0" cellspacing="">
		<tr class="FOOTER">
			<td colspan="4" width='100%' align="left">Close Wallet </label></td>
		</tr>
	  </table>
	...
	<table border="0" class="TABLEWIDTH" align="center" cellpadding="1px"
		...
		<tr>
			...
			<img style="cursor: pointer"  tabindex="1"
				src="../../hisglobal/images/btn-sv.png" onClick="closeFunc();"
				onkeypress="onKeyPressLogic('2',event);"  title="Close Account">
			<img style="cursor: pointer"  tabindex="1"
