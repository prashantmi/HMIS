...
<meta charset=utf-8>
<title>Patient Wallet Recharge </title>
...
<html:form 
	...
	<tag:tab tabList="${PatWalletTransBean.lhm}" selectedTab="PATWALLET" align="center" 
		width="TABLEWIDTH">
	</tag:tab></center>
     ...
     <tr>
		...
		<tr>
			<%--  <td width="50%" colspan="1" class="LABEL"><div align='Left'><font color="red">*</font>CR No.
			 ...
			 <td width="25%" class="LABEL" id="CrNOOrWallet"><font color="red">*</font>CR No.</td>
...
<crNo:crNo id="strCrNoId" name="strCrNo" value="${PatWalletTransBean.strCrNo}" js="onkeypress='return initGoFunc(event);'"></crNo:crNo>
    <input type="image" style="cursor:pointer;cursor:pointer" title="Issue Process" 
		...
		<div id="WalletWise" style="display:none"> 
    <input type="text" name="strWalletNo" value ="${PatWalletTransBean.strWalletNo}" js=" onkeypress='return initGoFunc(event);'"/>
    <input type="image" style="cursor:pointer;cursor:pointer" title="Issue Process" 
	...
	<div id='offlineClientDivId'><bean:write
	 ...
	 <tr>
			<td colspan="4" width='100%'><div class='line'><label class='DIVLABEL'>Wallet Account Details</label></div></td>
		</tr>
	 		<tr>
		<td width="100%" colspan='8'>
			
		<div id='WalletAccounDivId'><bean:write name="PatWalletTransBean" property="strAccountDetailsView"
		filter="false" /></div>
		
		</td></tr>
	 </table>
	    <div id="hidepatdet" style="display: none">
	...
	<table class='TABLEWIDTH' border="0" cellpadding="1px"
	 ...
	 <div id ="disBnR" style="display: block;">
	  ...
	  <table class="TABLEWIDTH" align="center" cellpadding="0" cellspacing="">
		<tr class="FOOTER">
			<td colspan="4" width='100%' align="left">Wallet Details</label></td>
		</tr>
	  </table>
	   ...
	   <table class="TABLEWIDTH" align="center" border="0" cellspacing ="1px">
		<tr> 
			...
			<td width="25%" class='LABEL' colspan='1'><div align="left"><font color="red">*</font>Wallet Amount
		        <input name="strAdvacnceAmount" type="text" maxlength="5" class="txtFldMax" value="" onkeypress="return validateData(event,8);" onblur="getAdvanceAmount();">(<img src='../../hisglobal/images/INR.png'>)</div>
			</td>
