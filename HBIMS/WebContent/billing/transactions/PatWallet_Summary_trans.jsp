...
<title>Patient Wallet Summary </title>
...
<body
	onLoad="onLoadLogics();addRows(new Array('strOfflinePaymentMode','strOfflinePaymentDtls','strOfflineAmount'),new Array('s','t','t'),'3','1','I');WalletAccountStatus();openPrintPopUp();"
...
<div class="popUpDiv" id="cardAmtDiv" style="display: none;">
	...
	<tr>
		...
		<tr>
    	 ...
    	 <td colspan="3" class="CONTROL" style="display:block">
    	 <div id="CRWise">
			<crNo:crNo id="strCrNoId" name="strCrNo" value="${PatWalletTransBean.strCrNo}" js="onkeypress='return initGoFunc(event);'"></crNo:crNo>
    		<input type="image" style="cursor:pointer;cursor:pointer" title="Get CR Details" align="top" src ="../../hisglobal/images/Go.png" name="go" onclick="return goFunc();" align="middle">	
		</div>
		
		<div id="WalletWise" style="display:none"> 
	    	<input type="text" id="strWalletNo" name="strWalletNo" value ="${PatWalletTransBean.strWalletNo}" onkeypress='return initGoFunc(event);'/>
	    	<input type="image" style="cursor:pointer;cursor:pointer" title="Get Wallet Details" align="top" src ="../../hisglobal/images/Go.png" name="go" value="Go" onclick="return goFunc();">  
		</div>   
  </td>
	...
	<table class='TABLEWIDTH' border="0" cellpadding="1px"
	 ...
	 <div id ="disBnR" style="display: block;">
	  <table class="TABLEWIDTH" align="center" cellpadding="0px" cellspacing="0px">
		<tr class="FOOTER">
			<td colspan='3' width='85%'><div align="left">Wallet Summary</label></div></td>
			<td colspan='1' width='15%'>Save PDF<img style='cursor: hand; cursor: pointer'	src='../../hisglobal/images/PDF_Small.png' onClick='forceDownloadPdf()'></td>
		</tr>
	  </table>
...
<input type="hidden" name="strReportingFormat" value="${PatWalletTransBean.strReportingFormat }"/>
