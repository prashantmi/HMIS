...
<div class="popUpDiv" id="payDtlCLTMenu" style="display: none;">
	...
	<table style="display:none;" class="TABLEWIDTH" align="center" cellpadding="1px"
		cellspacing="1px">
		<tr>
		...
		<tr>
			...
			<table cellpadding="0" cellspacing="0" width="100%">
				<tr>
					...
					<input type="text" class="txtFldBig" autocomplete='off' name="strTariffCode" id="strTariffCode" tabindex="1"  maxlength="15"  onkeypress="return validateData(event,8);" onkeyup="getTariffByCode(this , event);showTariffCodeSearchPopup(event,'strTariffCode','0');">
					</div>
					</td>
