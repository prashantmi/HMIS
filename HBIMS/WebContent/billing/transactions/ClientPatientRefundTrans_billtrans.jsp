...
<head>
<meta charset=utf-8>
<title>Client Refund Page</title>
...
<html:form action="billing/transactions/ClientVerificTransCNT.cnt" method="post">
 ...
 <table class="TABLEWIDTH" align="center">
  <tr class="HEADER"> 
    <td colspan="4">Client\Patient&gt;&gt;Refund</td>
  </tr>
  <tr> 
  ...
  <tr> 
    ...
    <td width="25%" class="CONTROL"><input name="strAuthNo"><input type="button" name="OtherDtlBtn" style="color:red" value="Latest" onClick="ftn1()"></td>   
   ...
   <tr> 
    <td width="25%" class="LABEL">Refund Amt:</td>
    <td width="25%" class="CONTROL"><input name="strRefundAmt"></td>   
    <td width="25%" class="LABEL">Payment Mode:</td>
    <td width="25%" class="CONTROL"><select name="strValid"><bean:write name="clientverificTransBean" property="strPaymentMode" filter="false"/></select></td>   
   </tr>
  </table>
