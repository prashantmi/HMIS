...
<html:form action="/transactions/CreditLetterHandlingBSCNT" method="post" enctype="multipart/form-data">

<fieldset form="form1">
	
  <legend style="width:auto; margin-bottom: 0px;font-size: 1.5rem;font-weight: 400;margin-left:10px;color: #666;" id='nonPrintableLegend'>CM Relief Fund</legend>
  <div class="legend2" id='nonPrintableLegend2'>
    ...
    <button  type="button" id="saveid" class="float-right btn btn-outline-success mt-1 btn-circle savebtn" tabindex='2' onClick="return validateSaveLetter();" name="patientAdmissionModiTransBean"  data-toggle="modal" data-target="#validateModal" style="background-color: #5cb85c;">					
    ...
    <div id='packageDivId'><bean:write
		...
		property="strPackageDetails" filter="false" /></div>
									...
									<div id="creditDtlsDivId" style="display: block;">
										<div class="modal" id="creditdetailId">
											<div class="modal-dialog modal-lg">
												<div class="modal-content">
													...
													<div class="modal-body">
														<bDtl:onlnCltDtl crNo="${CreditLetterTransBean.strCrNo}"></bDtl:onlnCltDtl>
													</div>
												</div>
											</div>
										</div>
...
<script src="../js/CreditLetterHandlerBS.js"></script>
