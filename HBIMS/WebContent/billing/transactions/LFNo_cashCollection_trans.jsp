...
<html:form 
	...
	<center>
		<div id="errMsg" class="errMsg"><bean:write name="LFNoTransBean" property="strErrMsg" filter="false" /></div>
		<div id="normalMsg" class="normalMsg"><bean:write name="LFNoTransBean" property="strNormalMsg" filter="false" /></div>
		<div id="warningMsg" class="warningMsg"><bean:write name="LFNoTransBean" property="strWarningMsg" filter="false" /></div>
		<tag:tab tabList="${LFNoTransBean.lhm}" selectedTab="LF" align="center" onlyTabIndexing="1" width="TABLEWIDTH"></tag:tab>
	</center>
	...
	<table class='TABLEWIDTH' border="0" cellpadding="1px"
	 ...
	 <div id ="disBnR" style="display: block;">
	  ...
	  <table class="TABLEWIDTH" align="center" cellpadding="0" cellspacing="">
		<tr class="FOOTER">
			<td colspan="4" width='100%' align="left">Advance Details</td>
		</tr>
	  </table>  
...
<div align="center" id="saveid">					 
	...
	<input type="hidden" name="currentState" value="${LFNoTransBean.currentState}" />
	...
	<input type="hidden" name="strBillNo" value="${LFNoTransBean.strBillNo}"/>
	<input type="hidden" name="strLFNo" value="${LFNoTransBean.strLFNo}"/>
