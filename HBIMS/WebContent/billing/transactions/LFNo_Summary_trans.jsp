...
<title>LF Account Summary </title>
...
<body
	onLoad="onLoadLogics();addRows(new Array('strOfflinePaymentMode','strOfflinePaymentDtls','strOfflineAmount'),new Array('s','t','t'),'3','1','I');LFAccountStatus();openPrintPopUp();"
...
<div class="popUpDiv" id="payDtlCLTMenu" style="display: none;">
	...
	<tag:tab tabLabel="LF Account Summary" selectedTab="FIRST" align="center" onlyTabIndexing="1"
		width="TABLEWIDTH">
	</tag:tab></center>
		...
		<tr class="HEADER">
			...
			<table width="100%" cellpadding="0" cellspacing="0">
				<tr>
					...
					title="Cash Collection Detail"><font color="white" style=""><u>LF Account</u></font></a>
					</td>
					<td>
					<div align="right">
	...
	<tr>
		...
		<div id="LFWise" style="display:none"> 
	    	<input type="text" name="strLFNo" value ="${LFNoTransBean.strLFNo}" onkeypress='return initGoFunc(event);'/>
	    	<input type="image" style="cursor:pointer;cursor:pointer" title="Get LF Details" align="top" src ="../../hisglobal/images/Go.png" name="go" value="Go" onclick="return goFunc();">  
		</div>   
  </td>
	...
	<table class='TABLEWIDTH' border="0" cellpadding="1px"
	 ...
	 <div id ="disBnR" style="display: block;">
	  <table class="TABLEWIDTH" align="center" cellpadding="0" cellspacing="">
		<tr class="FOOTER">
			<td colspan="4" width='100%' align="left">Account Summary</label></td>
		</tr>
	  </table>
	  <div id="strLFAccountSummary">
	<bean:write property="strLFAccountSummary" name="LFNoTransBean" filter="false"/>
	</div>
