...
<script language="Javascript" src="../../billing/js/DiscountRecommendationTrans.js"></script>
...
<html:form action="transactions/DiscountRecommendationTransCNT.cnt" method="post" onsubmit="return goFunc();">
<div id="menu1"></div>

<div id ="errMsg" class="errMsg"><bean:write name="discountRecommendationTransBean" property="strErrMsg"/></div> 
<div id ="warningMsg" class="warningMsg"><bean:write name="discountRecommendationTransBean" property="strWarning"/></div>
<div id ="normalMsg" class="normalMsg"><bean:write  name="discountRecommendationTransBean" property="strMsg"/></div>
...
<div class='popup' id='discountDtl2' style="display:none">
 ...
 <tag:tab tabLabel="Discount Recommendation" selectedTab="FIRST" align="center" width="TABLEWIDTH">
	</tag:tab>
 <table class="TABLEWIDTH" align="center" border="0" cellspacing ="1px">
  <tr class="HEADER"> 
    <td colspan="4">Discount &gt;&gt;Recommendation</td>
  </tr>
  ...
  <tr> 
   ...
   <crNo:crNo
						 id="strCrNoId"
						value="${discountRecommendationTransBean.strCrNo}"
   ...
   <img style="cursor:pointer;cursor:hand" src="../../hisglobal/images/viewDetails.gif" 
  	 ...
  	 onclick="showPatientListingWindow('11',document.forms[0].strCrNo,'setSelectedCrNo');"/>
  ...
  <div id="patdtltld" style="display:none">
       <bean:write name="discountRecommendationTransBean" property="strPatientDetailsView" filter="false"/>
  </div>
   
  <div id="onLinetld">
       <DisDtl:reqDisDtl  crNo="${discountRecommendationTransBean.strCrNo1}" mode="7"></DisDtl:reqDisDtl>
  </div>
   <div id="id1"></div>
   ...
   <table class="TABLEWIDTH" align="center" border="0" cellspacing ="1px" cellpadding="1px">
	...
	<td width="76%" class="CONTROL">
	        <select name="strRmk">
	                 <bean:write name="discountRecommendationTransBean" property="strRmk" filter="false"/>
	        </select>
	        
	</td>
	</tr>
	<tr><td width="24%" class="LABEL"><div align="right"><font color="red">*</font>Discount Reason:</div></td> 
	<td width="76%" class="CONTROL"><select name="strRsn" onChange="groupCombo();"><bean:write name="discountRecommendationTransBean" property="strRsn" filter="false"/>
  ...
  <tr class="FOOTER"> 
  <td colspan="3" align="left"><font color="#ED6782">Excess Limit</font></td>
 ...
 <div id="lastbuttons" style="display: none"> 	
  <table border="0" class="TABLEWIDTH" align="center">
	...
	<input type="hidden" name="strMsgString" value="${discountRecommendationTransBean.strMsgString}">
	<input type="hidden" name="strPopUpId" value="${discountRecommendationTransBean.strPopUpId}">
	<input type="hidden" name="strBId" value="${discountRecommendationTransBean.strBId}">
	<input type="hidden" name="strChk" value="">
	<input type="hidden" name="CrNo" value="${discountRecommendationTransBean.strCrNo}">
	<input type="hidden" name="strCRNoSatus" value="${discountRecommendationTransBean.strCRNoSatus}">
