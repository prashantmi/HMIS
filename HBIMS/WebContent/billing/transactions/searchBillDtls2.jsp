...
<body onload="fetchBillList('1','1');" onUnload="window.opener.closeChild();">
...
<html:form action="transactions/BillDupPrintTransCNT.cnt" 
   ...
   <div id="warningMsg" class="warningMsg"><bean:write
		name="BillDupPrintTransBean" property="strWarningMsg" filter="false" /></div>
...
<table width="100%" cellspacing="1px">
   ...
   <td colspan="3" class="CONTROL"> 
	...
	&nbsp; <input type="text" name="strSearchString" maxlength="100" class="txtFldMax" onkeypress="return validateDataWithSpecialChars(event,9,'%.');">
   </td>   
    	</tr>
		<tr>
  		<td class="LABEL"><b>
 		...
 		<td class="CONTROL">  <date:date name="strToDate" id="toDateId"  value="${BillDupPrintTransBean.strCtDate}"/>   
 		 &nbsp;
 		 <img  src="../../hisglobal/images/Go.png" style="cursor:pointer;cursor:hand"  name="go" onclick="getSearchBillListBySearch('strGuarantorName');"
		...
		<div id="fetchRecordDivId"></div>
			...
			<table width='100%'align='center' cellspacing='1px'>
				...
				<td width='3%'><div id="plusHelpId" align="center"><img
					...
					<div id="minusHelpId" style="display: none" align="center"><img style="cursor:pointer;cursor:hand"
		...
		<table border="0" class='TABLEWIDTH' align="center">
				<tr>
<td align="center"><img title="Go to Main Page" style="cursor:pointer;cursor:hand"
						src="../../hisglobal/images/ok.gif" onClick="validate('document.forms[0].strGuarantorName')"></td>
						
<!-- <td align="center"><img style="cursor:pointer;cursor:hand"	title="To Clear All Fields" src="../../hisglobal/images/btn-clr.png" onClick="clearGrntrNo();"></td>						
					
<td align="center"><img style="cursor:pointer;cursor:hand"	title="To Close Window" src="../../hisglobal/images/btn-ccl.png" onClick="window.opener.closePopUp();"></td>
 -->
					<td align="center"><a href="#" class="button"	onClick="clearGrntrNo();"><span class="clear">Clear</span></a> </td>
					<td align="center">		<a href="#" class="button" onClick="window.opener.closePopUp();"><span class="cancel">Cancel</span></a></<td>
				</tr>
			</table>
