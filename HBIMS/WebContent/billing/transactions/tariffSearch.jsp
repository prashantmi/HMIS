...
<head>
<meta charset=utf-8>
<title>Tariff Name Search</title>
...
<body onLoad="document.forms[0].strTariffName.focus(),isSearchRequired();myFunc('1');" onkeypress="ESCclose(event)">
<html:form action="/transactions/BillingCNT.cnt" method="post">
	...
	<table width="100%" align="center">
		...
		<tr style='display:none;'>
			...
			<select class="comboNormal" name="strSearchType" tabindex="1">
				<option value="1">Tariff</option>
				<%--<option value="2">Tariff Code</option> --%> </select>
			</td>
			<td colspan="1" class="CONTROL" width="25%" style="display: none;">
				 <input type="text" name="strTariffName" class="txtFldMax"
					 maxlength="40" value='${billingBean.searchText}' 
					 onkeypress="return validateData(event,19)" onkeyup="getSearchContent(event);" tabindex="1">
				<input type="text" style="display: none;" name="fake" tabindex="1">
			</td>
			<td colspan="1" class="multiControl"  width="25%" style="display: none;">
				 <img src="../../hisglobal/images/search_icon1.gif" name="go" align="middle" 
				 		style="cursor: hand; cursor: pointer" 
						onClick="return searchValidate();" onkeypress="return searchValidate();">
			</td>
		</tr>
		<tr>
			<td colspan="4">
		...
		<tr>
			...
			<td class="multiLabel" width='10%'>
				<div id="plusId">
					<img name="plus" style="cursor: hand; cursor: pointer" src="../../hisglobal/images/plus.gif" onClick="showHelp('helpDivId');"></div>
				<div id="minusId" style="display: none">
					<img name="minus" src="../../hisglobal/images/minus.gif" style="cursor: hand; cursor: pointer" onClick="hideHelp('helpDivId'); "></div>
			</td>
		</tr>
		<tr>
			<td colspan="4">
