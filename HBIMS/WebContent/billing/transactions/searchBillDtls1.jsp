...
<title>Search Bill Details-1</title>
...
<body onload="fetchBillList2('1','1');" onUnload=""> 
...
<table width='100%'align='center' cellspacing='1px'>
		<tr>
			<!-- <td align="center"><img  style="cursor:pointer;cursor:hand" title="Go to Main Page" src="../../hisglobal/images/ok.gif" onClick="validate('document.forms[0].strCrNo');"></td>
			<td align="center"><img style="cursor:pointer;cursor:hand" title="To Clear Field's" src="../../hisglobal/images/btn-clr.png" onclick="clearCrNo();" ></td>
			<td align="center"><img style="cursor:pointer;cursor:hand" title="Cancel All Opn" src="../../hisglobal/images/btn-ccl.png" onclick="window.opener.closePopUp();" ></td>
			 -->
