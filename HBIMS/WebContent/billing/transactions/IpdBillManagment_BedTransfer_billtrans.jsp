...
var wardcode= document.getElementsByName('strSpecialWardType')[0].value
 ...
 function focusNewDept()
 {
	...
	document.forms[0].strChargeTypeOld.disabled=true;
	document.forms[0].strChargeTypeNew.disabled=true;
...
<tag:tab tabList="${ipdBillManagementTransBean.lhm}" selectedTab="BEDTRANSFER" align="center" width="TABLEWIDTH"></tag:tab>
