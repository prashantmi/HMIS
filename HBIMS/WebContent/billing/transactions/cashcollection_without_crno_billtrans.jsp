...
<body
	onload="withoutCrNoOnLoadLogics(),addRows(new Array('strOfflineTariffName','strOfflineTariffDetailsHidden','strOfflineTariffRateUnit','strOfflineTariffQty','strOfflineTariffUnit','strOfflineTariffServiceTax','strOfflineTariffDiscount','strOfflineTariffNetAmount'),new Array('t','t','t','t','s','t','t','t'),'2','1','I'),addRows(new Array('strOfflinePaymentMode','strOfflinePaymentDtls','strOfflineAmount'),new Array('s','t','t'),'3','1','I');">
...
<div class="popUpDiv" id="payDtlCLTMenu" style="display: none;">
	...
	<table class="TABLEWIDTH" align="center" cellpadding="1px"
		cellspacing="1px">
		<tr class="HEADER">
			<td colspan="4">Cash Collection</td>
		</tr>
	</table>
...
<table class="TABLEWIDTH" align="center" cellpadding="1px"
	...
	<table class="TABLEWIDTH" align="center" cellpadding="1px"
		cellspacing="1px">
		<tr class='TITLE'>
			<td>&nbsp;&nbsp;Bill No.<input type='text' name='strBillNo'
	...
	<table class="TABLEWIDTH" align="center" cellpadding="1px"
		...
		<tr>
		<td class="LABEL"><div id="previousCrNoNonMandatoryDivId" >Previous CR No.</div>
		<div id="previousCrNoMandatoryDivId" style="display: none;" ><font color="red">*</font>Previous CR No.</div>
		<input type="hidden" name="strIsPreviousCrNoReq" value="${cashCollectionTransBean.strIsPreviousCrNoReq}">
		</td>
		<td colspan="3" class="CONTROL" >
		
		<logic:equal name="cashCollectionTransBean" property="strPreviousCrNoSearch" value="1">
			
			<input type="text" name="strPreviousCrNo" maxlength="10" tabindex="${cashCollectionTransBean.strIsPreviousCrNoReq}"  class="txtFldMax"  onkeypress="return validateData(event,8),initWithoutCrNoGoFunc(event);">
		...
		<logic:equal name="cashCollectionTransBean" property="strPreviousCrNoSearch" value="0">
		<input type="text" name="strPreviousCrNo" maxlength="10" tabindex="${cashCollectionTransBean.strIsPreviousCrNoReq}"  class="txtFldMax"  onkeypress="return validateData(event,8);">
		</logic:equal>
		...
		<tr>
			...
			<td width="25%" class="CONTROL"><input type='text'  tabindex="1"
				...
				onkeypress="return validateData(event,4);" class='txtFldMax'>
			</td>

		
			<td width="25%" class="LABEL" >Contact
			No.</td>
			<td width="25%" class="CONTROL" ><input type='text' tabindex="2"
				name="strGuarantorContactNo" maxlength="50"
		...
		<tr>
			...
			Address</td>
			<td width="75%" colspan="3" class="CONTROL"><textarea tabindex="2"
				name="strGuartorAddress" cols="25" rows="2"></textarea></td>
		...
		<input type="hidden" name="strIsRefPhysicanReq" value="${cashCollectionTransBean.strIsRefPhysicanReq}">
			
			<td width="25%"  class="CONTROL"><input type="text" class="txtFldMax" name="strReferringPhysician" tabindex="${cashCollectionTransBean.strIsRefPhysicanReq}"  onkeypress="return validateData(event,4);"> </td>
		...
		<tr>
			...
			<td width="25%" class="CONTROL"><input type='text' tabindex="1"
				name="strAge" maxlength="3"
				onkeypress="return validateData(event,5);" class='txtFldMin' onkeyup="ageValidation();" >
			...
			<bean:write name="cashCollectionTransBean" property="strGenderList" filter="false"/>
			</select>
			</td>
	...
	<table class="TABLEWIDTH" align="center" cellpadding="1px"
		...
		<tr>
			...
			<table cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td class="TITLE" width='50%'>Tariff Detail</td>
		...
		<tr>
			...
			<td class="multiLabel" width="8%">S. Tax (%)<input type="hidden"
			...
			<td class="multiLabel" width="9%">Net Amt. (<img src='/AHIMS/hisglobal/images/INR.png'>)<input
	...
	<table class='TABLEWIDTH' border="0" cellpadding="1px"
		...
		<bean:write   property="strCurrentDate" name="cashCollectionTransBean" />
		
		<input type="hidden" name="strOfflineRefundDate"   value="${cashCollectionTransBean.strCurrentDate}">
	...
	<table class="TABLEWIDTH" align="center" cellpadding="1px"
		...
		<tr>
			...
			<td width="60%" class="LABEL">Total Amount (<img src='/AHIMS/hisglobal/images/INR.png'>)</td>
...
<div id="saveid">
	...
	<input type="hidden" name="strOffLineHospitalService"
		value="${cashCollectionTransBean.strOffLineHospitalService}" />
	<input type="hidden" name="strOffLineTreatmentCategory"
		value="${cashCollectionTransBean.strOffLineTreatmentCategory}" />
