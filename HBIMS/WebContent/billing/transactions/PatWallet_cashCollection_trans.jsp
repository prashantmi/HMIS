...
<meta charset=utf-8>
<title>Patient Wallet Generation</title>
...
<script language="Javascript" src="../js/PatWallet_offline_trans.js"></script>
...
<html:form 
	action="/transactions/PatWalletTransCNT" method="post" enctype="multipart/form-data">
	...
	<center>
		<div id="errMsg" class="errMsg"><bean:write name="PatWalletTransBean" property="strErrMsg" filter="false" /></div>
		<div id="normalMsg" class="normalMsg"><bean:write name="PatWalletTransBean" property="strNormalMsg" filter="false" /></div>
		<div id="warningMsg" class="warningMsg"><bean:write name="PatWalletTransBean" property="strWarningMsg" filter="false" /></div>
		<tag:tab tabList="${PatWalletTransBean.lhm}" selectedTab="PATWALLET" align="center"  width="TABLEWIDTH"></tag:tab>
	</center>
	...
	<table class="TABLEWIDTH" align="center" cellspacing="1px"
		...
		<tr class="HEADER">
			...
			<table width="100%" cellpadding="0" cellspacing="0">
				<tr>
					<td colspan="3">
					<a  id="cashCollection" style="cursor: pointer;display: block;" onclick="" 
					title="Cash Collection Detail"><font color="white" style=""><u>Patient Wallet</u></font></a>
					</td>
					<td>
					<div align="right">
					<logic:equal value="2" name="PatWalletTransBean" property="strCounterMode">
					<html:checkbox
						name="PatWalletTransBean" property="strIsOnline" value="1"
						onclick="setOnlineOffLineMode(this);"></html:checkbox> Online&nbsp;
					</logic:equal>
					
					<logic:notEqual value="2" name="PatWalletTransBean" property="strCounterMode">
...
<div class="popUpDiv" id="payDtlCLTMenu" style="display: none;">
	...
	<table width='400'>
		...
		<tr>
			...
			<td width="50%" class='LABEL'>Penalty Amount (<img src='../../hisglobal/images/INR.png'>)</td>
	...
	<tr>
		 ...
		 <tr>
		<td class="LABEL" colspan="4" style="display:none;">
		<html:radio property="strCRorWalletwise" name="PatWalletTransBean" value="1" onclick="IsCrOrWalletWise('1'); ">CR No. wise</html:radio>
		<html:radio property="strCRorWalletwise" name="PatWalletTransBean" value="2" onclick="IsCrOrWalletWise('2');">Mobile No. wise</html:radio></td>
		</tr>
	...
	<table class='TABLEWIDTH' border="0" cellpadding="1px"
	 ...
	 <div id ="disBnR" style="display: block;">
	  ...
	  <table class="TABLEWIDTH" align="center" cellpadding="0" cellspacing="">
		<tr class="FOOTER">
			<td colspan="4" width='100%' align="left">Wallet Details</td>
		</tr>
	  </table>  
	 
	   <table class="TABLEWIDTH" align="center" border="0" cellspacing ="1px">
		<tr> 
		    <td width="25%" class='LABEL' colspan='1'><div align="left"><font color="red">*</font>Payment Mode
		    <select tabindex="2" name="strOfflinePaymentMode"  class='comboNormal' onChange="displayPayDetails(this,'strOfflinePaymentDtls#delIndex#','offLinePayDtlEdit#delIndex#','strOfflineAmount#delIndex#','1');" id="strOfflinePaymentMode#delIndex#" readonly>
			<bean:write name="PatWalletTransBean" property="strPaymentModeContents" filter="false"/></select></div>
			</td>
			<td width="25%" class='LABEL' colspan='1'><div align="left"><font color="red">*</font>Payment Details
		        <input type="text" tabindex="1" autocomplete='off' name="strOfflinePaymentDtls" id="strOfflinePaymentDtls#delIndex#" class="txtFldBig"   />
		        <input type="button" id="offLinePayDtlEdit#delIndex#" value="Edit" disabled="disabled" onClick="displayPayWithDataDetails(this,'strOfflinePaymentDtls#delIndex#','strOfflinePaymentMode#delIndex#');"></div>
			</td>
			<td width="25%" class='LABEL' colspan='1'><div align="left"><font color="red">*</font>Wallet Amount
		        <input name="strAdvacnceAmount" type="text" maxlength="5" class="txtFldMax" value="" onkeypress="return validateData(event,5);" onblur="getAdvanceAmount();">
		        (<img src='../../hisglobal/images/INR.png'>)</div>
			</td>
			<td width="25%" class='LABEL' colspan='1'><div align="left"><font color="red">*</font>Mobile No.
		        <input name="strMobileNo1" type="text" maxlength="10" class="txtFldMax" value="${PatWalletTransBean.strMobileNo1}" onkeypress="return validateData(event,5);">
		        <img src='../../hisglobal/images/mobile.png' align="top"></div>
			</td>
...
<!-- 		</tr> -->
	...
	<table class="TABLEWIDTH" align="center" cellpadding="1px"
		cellspacing="1px">
		<tr>
			<td class="multiLabel" width="22%"><font color="red">*</font>Payment
			Mode</td>
			<td class="multiLabel" width="45%">Payment
			Details</td>
			<td class="multiLabel" width="30%"><font color="red">*</font>Amount
			(<img src='../../hisglobal/images/INR.png'>)</td>
	...
	<table class='TABLEWIDTH' align='center' cellpadding='1px'
		cellspacing='1px'>
		<tr>
			<td width='60%' class='LABEL'>Grand Total (<img src='../../hisglobal/images/INR.png'>)</td>
			<td width='15%' class='CONTROL'>
			<table>
				<tr>
	...
	<table class='TABLEWIDTH' align='center' cellpadding='1px'
		cellspacing='1px'>
		<tr>
			<td width='60%' class='LABEL'>Max Benefit From Client (<img src='../../hisglobal/images/INR.png'>)</td>
			<td width='15%' class='CONTROL'>
			<table>
				<tr>
	...
	<table border="0" class="TABLEWIDTH" align="center" cellpadding="1px"
		...
		<tr>
			...
			<td align="center"><img style="cursor: pointer" name="saveButton" id= "savedivid" tabindex="1"
				src="../../hisglobal/images/btn-sv.png" 
				onClick="return WalletAccountServices();" onkeypress="onKeyPressLogic('1',event);"   title="Save Record" />
...
<div align="center" id="saveid">					 
							<a href="#" class="button" id="" onClick="return WalletAccountServices();" onkeypress="onKeyPressLogic('1',event);"><span class="save">Save</span></a>
	...
	<input type="hidden" name="currentState" value="${PatWalletTransBean.currentState}" />
	...
	<input type="hidden" name="strWalletAccountSummary" value="${PatWalletTransBean.strWalletAccountSummary}"/>
	<input type="hidden" name="strBillNo" value="${PatWalletTransBean.strBillNo}"/>
	<input type="hidden" name="strWalletNo" value="${PatWalletTransBean.strWalletNo}"/>
	<input type="hidden" name="strChargeType" value="${PatWalletTransBean.strChargeType}"/>
	<input type="hidden" name="strOffLineWard" value="${PatWalletTransBean.strOffLineWard}"/>
    <input type="hidden" name="strOffLineSpecialWard" value="${PatWalletTransBean.strOffLineSpecialWard}"/>
