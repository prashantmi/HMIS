...
<div class="popUpDiv" id="cardAmtDiv" style="display: none;">
	...
	<table class='TABLEWIDTH' border="0" cellpadding="1px"
	 ...
	 <div id ="disBnR" style="display: block;">
	  <div class="row">
	  <div class="col-sm-6" align="left"><p class="subHeaders">
	   <i class="fas fa-wallet" style="font-size: 26px;">&nbsp;</i>Close Wallet</p></div>
	  <div class="col-sm-6" align="right"> <button type="button" class="btn btn-outline-default" title="save pdf" onClick='forceDownloadPdf()'><i class="fas fa-file-pdf"></i></button></div>
	   </div>
