...
<body onLoad="onLoadLogics();addRows(new Array('strOfflinePaymentMode','strOfflinePaymentDtls','strOfflineAmount'),new Array('s','t','t'),'3','1','I');openPrintPopUp();"
	onfocus="checkPopUp();" onUnload="closePopUp();">
<script language="Javascript" src="../../hisglobal/js/wz_tooltip.js"></script>
<html:form action="/transactions/PatWalletTransBSCNT" method="post" enctype="multipart/form-data">
...
<div class="prescriptionTile" >
	...
	<center>
		...
		<tag:tabNew1 tabList="${PatWalletTransBean.lhm}" selectedTab="PATWALLET" align="center"  width="TABLEWIDTH"></tag:tabNew1>
	</center>
...
<div class="popUpDiv" id="payDtlCLTMenu" style="display: none;">
	...
	<table class="TABLEWIDTH" align="center" cellpadding="1px" cellspacing="1px">
		...
		<html:radio property="strCRorWalletwise" name="PatWalletTransBean" value="2" onclick="IsCrOrWalletWise('2');">Mobile No. wise</html:radio></div>
								...
								<div class="row rowFlex reFlex" id="goid">
									...
									<div class="col-sm-2">
										<crNo:crNo id="strCrNoId" name="strCrNo" className="form-control"
		...
		<tr>
			...
			<bean:write name="PatWalletTransBean" property="strCurrentDate" />
									...
									<div id="disBnR" style="display: block;">
										...
										<p class="subHeaders">
											<i class="fas fa-wallet" style="font-size: 26px;">&nbsp;</i>Wallet
											Details
										</p>
										...
										<div class="row rowFlex reFlex">
											...
											<div class="col-sm-2">
												<select tabindex="2" name="strOfflinePaymentMode"
											...
											<div class="col-sm-2">
												<label>Payment Details<font color="red">*</font>Payment
													Details
												</label>
											</div>
											<div class="col-sm-2">
												<input type="text" tabindex="1" autocomplete='off' 
													name="strOfflinePaymentDtls"
													id="strOfflinePaymentDtls#delIndex#" class="form-control" />
											</div>
											<div class="col-sm-2" align="left" style="padding-left: 0;">
												<button type="button" class="btn btn-sm btn-info"
													id="offLinePayDtlEdit#delIndex#" value="Edit"
													disabled="disabled"
													onClick="displayPayWithDataDetails(this,'strOfflinePaymentDtls#delIndex#','strOfflinePaymentMode#delIndex#');">Edit</button>
											</div>
										...
										<div class="row rowFlex reFlex">
											<div class="col-sm-2"></div>
											<div class="col-sm-2">
												<label>Wallet Amount<font color="red">*</font></label>
											</div>
											<div class="col-sm-2">
												<input name="strAdvacnceAmount" type="text" maxlength="5" 
													class="form-control" value=""
													onkeypress="return validateData(event,5);"
													onblur="getAdvanceAmount();">
											</div>
											<div class="col-sm-2">
												<label>Mobile No.<font color="red">*</font></label>
											</div>
											<div class="col-sm-2 input-group sm">
											<div class="input-group-prepend"><span class="input-group-text" id="basic-addon2"><i class="fas fa-mobile-alt"></i></span></div>
												<input name="strMobileNo1" type="text" maxlength="10" aria-describedby="basic-addon2"
													class="form-control"
													value="${PatWalletTransBean.strMobileNo1}"
													onkeypress="return validateData(event,5);">
											</div>
											<div class="col-sm-2"></div>
										</div>
