...
--%>
<link href="/HBIMS/ipd/css/newlayout.css" rel="stylesheet" type="text/css">
...
<script language="Javascript" src="../js/cashcollection_onlineNew_trans.js"></script>
...
<fieldset>
  ...
  <legend class='legendHeader' id='nonPrintableLegend'>Cash Collection</legend>
  <div class="legend2" id='nonPrintableLegend2'>
	<button id="cancelButton" type="button" class="btn btn-outline-danger mt-1 btn-circle cancelbtn" onclick="cancelFunc();" onkeypress="onKeyPressLogic('3',event);">
	...
	<button  id="printbutton" type="button" class="btn btn-outline-primary mt-1 btn-circle printbtn" data-toggle="modal" data-target="#printModal" onclick="" style="display: none;">
		<i class="fa fa-print iround"  title="Print Last Bill"></i>
	</button>	
    <button  type="button" id="savebutton" class="btn btn-outline-success mt-1 btn-circle savebtn"  tabindex='2' onclick="return findBillServices();" onkeypress="onKeyPressLogic('1',event);" data-toggle="modal" data-target="#validateModal" style="display: none;">					
		<i class="fa fa-save iround"  title="Save"></i>
	</button>												                 
  </div>
  
<div id="blanket" style="display: none;"></div>
<div id="nonPrintable" class="viewport vpinside">
<div class="container-fluid">
	...
	<div id="onLinePatId" style="display: block">
				<div style="display: none;"><bean:write name="cashCollectionOnlineTransBean" property="strPatientDetailsView" filter="false"/></div>
				<pDtl:patDtlNew crNo="${cashCollectionOnlineTransBean.strCrNo}" address="false"></pDtl:patDtlNew>
	</div>
	<div class="prescriptionTile">
			...
			<div class="row rowFlex reFlex">				
				...
				<div class="col-sm-2">
					<div id="patientCrEdId" >
						<crNo:crNo id="strCrNoId" name="strCrNo" value="${cashCollectionOnlineTransBean.strCrNo}" js="onkeypress='return initGoFunc(event);'" className='form-control'></crNo:crNo>
					</div>													
				</div>
				<div class="col-sm-1"><span class="fa fa-search" style="cursor: pointer; cursor: hand;" id="searchIconDivId" title="Click here for Patient Search" name='searchPatient' onclick="showPatientListingWindow('1',document.forms[0].strCrNo,'setSelectedCrNo');"></span></div>
				<div class="col-sm-1">					
		...
		<div id="gblDivId" style="display: none">	
			<div class="panel panel-primary" id="onLineId">
			    <div class="panel-heading">
			    <p class="subHeaders"><i class="fas fa-university isubheaders">&nbsp;</i>Online Request(s)</p>	 
			    </div>
			    <div class="panel-body">
			    	<div class="row rowFlex reFlex trfrow">
				    	<div class="col-sm-3" id="collapse1" align="left">					        
					            <bean:write name="cashCollectionOnlineTransBean" property="strOnlineDetailsView" filter="false" />					        
				        </div>
				        </div>
				        
				        <div class="col-sm-9" align="right">
				        	<div class="row detail-cell" align="right">
				        		<div class="col-sm-1" align="center"><input type='checkbox' onclick='selectAllCheckBoxes(this)' name='selectAllChk'>All</div>
				        		<div class="col-sm-2" align="center">Tariff Name</div>
				        		<div class="col-sm-2" align="right">Rate/Unit</div>
				        		<div class="col-sm-2" align="right">Req Qty<input type='hidden' class='txtFldMin' name='strTotalTariffServiceTaxAmount' value='0' ></div>
				        		<div class="col-sm-2" align="right">Billed Qty<input type='hidden' class='txtFldMin' name='strTotalTariffDiscountAmount' value='0' ></div>
				        		<div class="col-sm-2" align="center" style="display: none">Unit<input type='hidden' class='txtFldMin' name='strTotalTariffActualAmount' value='0' ></div>
				        		<div class="col-sm-1" align="center">Discount</div>
				        		<div class="col-sm-2" align="center" style="display: none">Payment Type</div>
				        		<div class="col-sm-3" align="center" style="display: none">Credit Details</div>
				        		<div class="col-sm-2" align="center">Net Tariff Amt</div>
				        	</div>					
				        	<div id='clientDetailsDivId' class='scrollableDiv'><bean:write name="cashCollectionOnlineTransBean" property="strOnlineClientDetailsView" filter="false" /></div>
				        	<div id="id1" style="padding-top: 5px;"></div>				        	
				        	<div id="onlineGrandTotalDivPartId" style="display: none">
								<input type='hidden' name='strOnlineGrandTotalAmount' id='strOnlineGrandTotalAmount' value='0.00'>
								<div id='onlineGrandTotalDivId'>0.00</div>
							</div>
							<div id="onlineMaxClientBenefitDivPartId" style="display: none">
								<input type='hidden' name='strOnlineMaxClientBenefitAmount' id='strOnlineMaxClientBenefitAmount' value='0.00'>
								<div id='onlineMaxClientBenefitDivId'>0.00</div>
							</div>
							<div id="onlinePatientPayableDivPartId" style="display: none">
								<input type='hidden' name='strOnlinePatNetPayAmount' id='strOnlinePatNetPayAmount' value='0.00'>
								<div id='onlinePatNetPayDivId' style='display: none;'>0.00</div>
							</div>
							<input type='hidden' name='strOnlineTotalRecAmount' value='0.00'>
							<div id='onlineTotalRecAmtDivId' style='display: none;'>0.00</div>
							<div id="onlineNetAmountDetailsDivId" style="display: none">
								<img style="cursor: hand; cursor: pointer" src="../../hisglobal/images/plus.gif" onclick="displayOnlineNetAmountDetails(this , 'finalAdjustmentNetAmountDtls');">
							</div>
							<input type='hidden' name='strOnlineTotalPayAmount' id='strOnlineTotalPayAmount' value='0.00'>
							<div id='onlineTotalPayAmtDivId' style='display: none;'>0.00</div>
							<input type='hidden' name='strOnlineRefundAmount' id='strOnlineRefundAmount' value='0.00'>
							<div id='onlineRefundAmtDivId' style='display: none;'>0.00</div>
						</div>
			    	</div>			    	
			</div>
  	...
  	<hr>
		<div class="row rowFlex reFlex">
			<div class="col-sm-10"><div align="left">Help</div></div>
		...
		<div id="HelpId" style="display: none;">
			<div class="row"><div class="col-sm-12" bgcolor="red">Rejected Record(s)</div></div>
			<div class="row"><div class="col-sm-12">IPD Service Requests Are Directly Consumed from Account. If Other Requests not shown please check mapping of Services with Tariffs and charges for those tariffs for patient category. 
				If no charges defined check charge rule master for mapping of charges with General/Paid category.</div></div>
			<div class="row"><div class="col-sm-12">Online Request Types: 1.OPD Services 2. OPD Services Refund 3. IPD Advance 4. IPD Final Adjustment 5. IPD Final Bill Refund</div></div>
			<div class="row"><div class="col-sm-12">Credit Letter Format: Credit Letter Reference No./Credit Letter Date/Company(Client) Name/Balance Credit Limit/Card No./Card Holder Name</div></div>
			<div class="row"><div class="col-sm-12">Credit Letter Format: Credit Letter Reference No./Credit Letter Date/Company(Client) Name/Balance Credit Limit/Card No./Card Holder Name</div></div>						
		</div>
	</div>
	</div>
		...
		<table class="TABLEWIDTH" align="center" cellspacing="1px">
			<tr>
				...
				<td class="multiLabel" width="3%"><img style="cursor: hand; cursor: pointer" src="../../hisglobal/images/plus.gif" onclick="checkForOnLinePaymentLimit('0');"></td>
			</tr>
		</table>
...
<br>
<div align="center" id="saveid" style='display: none;'>					 
...
<jsp:include page="multirow_cashcollection_onlineNew_billtrans.jsp"></jsp:include>
