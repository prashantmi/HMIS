...
<title>Estimation Enquiry</title>
...
<script language="Javascript" src="../js/estEnquiry_trans.js"></script>
...
<body
	onload="openPrintPopUp();estEnquiryOnLoadLogics(),loadIntExtPatLogics(),addRows(new Array('strOfflineTariffName','strOfflineTariffDetailsHidden','strOfflineTariffRateUnit','strOfflineTariffQty','strOfflineTariffUnit','strOfflineTariffServiceTax','strOfflineTariffDiscount','strOfflineTariffNetAmount'),new Array('t','t','t','t','s','t','t','t'),'2','1','I'),addRows(new Array('strOfflinePaymentMode','strOfflinePaymentDtls','strOfflineAmount'),new Array('s','t','t'),'3','1','I');"
	onfocus="checkPopUp();" onUnload="closePopUp();">
	
	<script language="Javascript" src="../../hisglobal/js/wz_tooltip.js"></script>
	
	
<html:form action="/transactions/EstEnquiryTransCNT" method="post">
	...
	<div id="nonPrintable">
		<center>
		<div id="errMsg" class="errMsg"><bean:write name="EstEnquiryTransBean" property="strErrMsg" filter="false" /></div>
		<div id="normalMsg" class="normalMsg"><bean:write name="EstEnquiryTransBean" property="strNormalMsg" filter="false" /></div>
		<div id="warningMsg" class="warningMsg"><bean:write name="EstEnquiryTransBean" property="strWarningMsg" filter="false" /></div>
	...
	<table bgcolor="white">
		<tr>
			...
			<table width='300' border='0' cellpadding='0' cellspacing='0'>
				<tr>
					<td> <input type="hidden" name="strConfirmationType" value="${EstEnquiryTransBean.strConfirmationType}">
					
					<logic:equal name="EstEnquiryTransBean"  property="strConfirmationType" value="0">
					...
					<logic:equal name="EstEnquiryTransBean"  property="strConfirmationType" value="1">
			...
			<table width='400'>
				...
				<tr>
					...
					<td colspan='2' class='CONTROL'><input type="text" tabindex="1"
						...
						value="${EstEnquiryTransBean.strCurrentDate }">
					(dd-Mon-yyyy)</td>
...
<div class="popUpDiv" id="payDtlCLTMenu" style="display: none;">
		...
		<tr>
			...
			<table width='450'>
				...
				<tr>
					...
					<bean:write name="EstEnquiryTransBean" property="strClientNameContents" filter="false"/>
					</select></td>
				</tr>
				<tr>
					<td class='LABEL'><font color="red">*</font>Auth No.</td>
			...
			<table width='400'>
				...
				<tr>
					...
					<td class='CONTROL'><select title="_div_popup_cntl"
						...
						<bean:write name="EstEnquiryTransBean"
	...
	<div style='display:none;'><logic:equal value="1" name="EstEnquiryTransBean" property="strIsWithoutCrNoRequired">
	<table class="TABLEWIDTH" align="center" cellpadding="1px" cellspacing="1px">
		<tr>
			...
			<html:radio
				name="EstEnquiryTransBean" property="strPatientMode" value="1"
				onclick="selectPatientMode(this);">With CR No.</html:radio> <html:radio
				name="EstEnquiryTransBean" property="strPatientMode" value="2"
				onclick="selectPatientMode(this);">Without CR No.</html:radio></td>
		</tr>
	</table>
	</logic:equal>
	
	<logic:notEqual value="1" name="EstEnquiryTransBean" property="strIsWithoutCrNoRequired">
	...
	<table class="TABLEWIDTH" align="center" cellpadding="1px"
		cellspacing="1px">
		<tr>
			<td width="25%" class="LABEL"><font color="red">*</font>Service Type</td>
			<td width="25%" class="CONTROL"><select class="comboNormal"
				name="strOffLineRequestType"
				onchange="getServiceDetails(this);">
				<bean:write name="EstEnquiryTransBean" property="strServiceTypeDetails" filter="false" />
			</select></td>
	...
	<table class="TABLEWIDTH" align="center" cellpadding="1px"
		...
		<input type="hidden" name="strIsPreviousCrNoReq" value="${EstEnquiryTransBean.strIsPreviousCrNoReq}">
		</td>
		<td colspan="3" class="CONTROL" >
		
		<logic:equal name="EstEnquiryTransBean" property="strPreviousCrNoSearch" value="1">
			
			<input type="text" name="strPreviousCrNo" maxlength="10" value="${EstEnquiryTransBean.strPreviousCrNo}"  tabindex="${EstEnquiryTransBean.strIsPreviousCrNoReq}"  class="txtFldMax"  onkeypress="return validateData(event,8),initWithoutCrNoGoFunc(event);">
		...
		<logic:equal name="EstEnquiryTransBean" property="strPreviousCrNoSearch" value="0">
		<input type="text" name="strPreviousCrNo" maxlength="10" value="${EstEnquiryTransBean.strPreviousCrNo}"  tabindex="${EstEnquiryTransBean.strIsPreviousCrNoReq}"  class="txtFldMax"  onkeypress="return validateData(event,8);">
		</logic:equal>
	...
	<tr>
		...
		<div id="referringPhysicianMandatoryDivId" style="display: none;">Referring Physician</div>
		<input type="hidden" name="strIsRefPhysicanReq" value="${EstEnquiryTransBean.strIsRefPhysicanReq}"/>
			
			</td><td width="25%" class="CONTROL"><input type="text" class="txtFldMax" name="strReferringPhysician"  tabindex="${EstEnquiryTransBean.strIsRefPhysicanReq}" onkeypress="return validateData(event,4);"/> </td>
		...
		<tr>
			<td width="25%" class="LABEL"><font color="red">*</font>Age</td>
			...
			<bean:write name="EstEnquiryTransBean" property="strGenderList" filter="false"/>
			</select>
			</td>
	...
	<table class="TABLEWIDTH" align="center" cellpadding="1px"
		...
		<tr>
			...
			<table cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td class="TITLE" width='50%'><font color="white" style="" >Tariff Detail</font></td>
	...
	<table class='TABLEWIDTH' border="0" cellpadding="1px"
		...
		<bean:write   property="strCurrentDate" name="EstEnquiryTransBean" />
		
		<input type="hidden" name="strOfflineRefundDate"   value="${EstEnquiryTransBean.strCurrentDate}">
	...
	<table class="TABLEWIDTH" align="center" cellpadding="1px"
		...
		<tr>
			...
			<td width="87%" class="LABEL"><div align='right'>Total Amount (<img src='../../hisglobal/images/INR.png'>)</div></td>
...
<div align="center" id="saveid">					 
							...
							onClick="clearBillFunc();"><span class="clear">Clear</span></a> 
	...
	<input type="hidden" name="strOffLineHospitalService"
		value="${EstEnquiryTransBean.strOffLineHospitalService}" />
	<input type="hidden" name="strOffLineTreatmentCategory"
		value="${EstEnquiryTransBean.strOffLineTreatmentCategory}" />
	...
	<input type="hidden" name="strTempBillNo" value="${EstEnquiryTransBean.strTempBillNo}" />
	<input type="hidden" name="strTempReceiptNo" value="${EstEnquiryTransBean.strTempReceiptNo}" />

<input type="hidden" name="strIsOpdDiscount" value="${EstEnquiryTransBean.strIsOpdDiscount}" />

<input type="hidden" name="strCounterMode" value="${EstEnquiryTransBean.strCounterMode}" />
<input type="hidden" name="strIsWithoutCrNoRequired" value="${EstEnquiryTransBean.strIsWithoutCrNoRequired}" />

<input type="hidden" name="strIsOnline" value="${EstEnquiryTransBean.strIsOnline}" />
...
<input type="hidden" name="strPrintMessageLimit" value="${EstEnquiryTransBean.strPrintMessageLimit}" />

<input type="hidden" name="strPatTypeBoth" value="${EstEnquiryTransBean.strPatTypeBoth}" />

<input type="hidden" name="strIntExtPat" value="${EstEnquiryTransBean.strIntExtPat}" />

<input type="hidden" name="strGeneralChargeTypeId" value="${EstEnquiryTransBean.strGeneralChargeTypeId}" />
<input type="hidden" name="strWardTypeId" value="${EstEnquiryTransBean.strWardTypeId}" />
<input type="hidden" name="strConsumableCharge" value="${EstEnquiryTransBean.strConsumableCharge}" />
<input type="hidden" name="strOfflineTotalPayAmountWithoutConsumable" value="${EstEnquiryTransBean.strOfflineTotalPayAmountWithoutConsumable}" />
<input type="hidden" name="strGroupIdForConsumableConcatenated" value="${EstEnquiryTransBean.strGroupIdForConsumableConcatenated}" />
<input type="hidden" name="strConsumableChargesGroupId" value="${EstEnquiryTransBean.strConsumableChargesGroupId}" />
<input type="hidden" name="strConsumableChargesTariffCode" value="${EstEnquiryTransBean.strConsumableChargesTariffCode}" />
<input type="hidden" name="isOpenPopUp" value="${EstEnquiryTransBean.isOpenPopUp}"/>
<input type="hidden" name="filePath" value="${EstEnquiryTransBean.filePath}"/>
<input 	type="hidden" name="selectedTab" >
</div>
</html:form>

<jsp:include page="multirow_estEnquiry_billtrans.jsp"></jsp:include>
<jsp:include page="dropdown_estEnquiry_trans.jsp"></jsp:include>

<div id='printableSlip'>
<logic:equal name="EstEnquiryTransBean"  property="isOpenPopUp" value="1">
<logic:equal name="EstEnquiryTransBean"  property="printMode" value="1">
<logic:present name="EstEnquiryTransBean"  property="filePath">
