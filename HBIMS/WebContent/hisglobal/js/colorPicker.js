 ...
 *
		...
		<img src="/AHIMS/hisglobal/images/select_arrow.gif" id="color1"
			style="float: right; padding-right: 1px; padding-top: 1px" title="Color Picker"
			onmouseover="this.src='/AHIMS/hisglobal/images/select_arrow_over.gif'"
			onmouseout="this.src='/AHIMS/hisglobal/images/select_arrow.gif'">
...
/** ColorPicker **/
	...
	// SliderImage URL 
	ColorPicker.urlSliderImage = "/AHIMS/hisglobal/images/slider_handle.gif";
...
{		
	...
	for (var tabTitle in this.tabList) 
	{
		...
		tabImg.src = "/AHIMS/hisglobal/images/tab_right_" + suffix + ".gif";
