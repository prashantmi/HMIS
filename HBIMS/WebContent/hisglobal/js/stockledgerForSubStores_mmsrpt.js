...
function clearPage(){
		...
		document.getElementById("strFromDate").style.display='';
		document.getElementById("strToDate").style.display='';
...
function validate()
{
		...
		if(retVal){
					...
					document.getElementById("strFromDate").style.display='none';
					document.getElementById("strToDate").style.display='none';
...
{	  
	   ...
	   if(hiddenVal.split("^").length > 5){
	   	  progId =	hiddenVal.split("^")[5];	
	   }
	   ...
	   {	   
		...
		window.open(url, "popupWindow",	"width=1200,height=600,top=100,left=50,scrollbars=yes");
	   }
	   else
	   {
...
{	  
	   ...
	   var progId     = 	previousParameters.split("^")[9];
	...
	var url="StockLedgerForSubStoresRptCNT.cnt?hmode="+mode+
			...
			"&batchFlg="+batchFlg+"&progId="+progId;								
