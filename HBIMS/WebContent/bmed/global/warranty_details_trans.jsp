<table class="TABLE_STYLE" align="center" cellspacing="1px"
		cellpadding="1px">
		<thead>
			<tr class="FOOTER_TR" style="text-align: left;">
		...
		<tbody id="tbodyWarrantyDetailsHead" style="display: none;">
			<tr>
				<td class="LABEL_TD" style="text-align: center; width: 5%">&nbsp;</td>
				<td class="LABEL_TD" style="text-align: center; width: 19%">Supplier
				Name</td>
				<td class="LABEL_TD" style="text-align: center; width: 19%;">Warranty
				Start Date/Upto</td>
				<td class="LABEL_TD" style="text-align: center; width: 19%">Extention
				Upto</td>
				<td class="LABEL_TD" style="text-align: center; width: 19%">Term
				&amp; Condition</td>
				<td class="LABEL_TD" style="text-align: center; width: 19%">File</td>
			</tr>
			</tbody>
			...
			--%>
			<tr>
				<td class="LABEL_TD" style="text-align: center;" colspan="6"><font color="red">Data not available.</font> </td>
			</tr>
