<table class="TABLEWIDTH" align="center" cellspacing="1px"
	...
	<thead>
		<tr class="TITLE">
			<td align="center" style="width: 5%"><img
				style="cursor: pointer;" id="imgMaintenanceContractDetails"
				src="../../hisglobal/images/plus.gif"
				onclick="showOrHideMaintenanceContractDetails('SHOW',this);"
				title="Show" /></td>
	...
	--%>
		<tr>
			<td class="LABEL" style="text-align: center;" colspan="6"><font
				color="red">Data not available.</font></td>
		</tr>
	</tbody>
</table>