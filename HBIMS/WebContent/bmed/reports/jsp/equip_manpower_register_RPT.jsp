...
<his:javascript	src="/bmed/reports/js/bmed_equip_manpower_register_rpt.js" />
</head>
<body marginheight="0" marginwidth="0" class="background">

<html:form action="/reports/EquipmentManpowerRegRptCNT" method="post"
	styleClass="formbg">
	...
	<table class="TABLEWIDTH" align="center" cellspacing="1px"
		cellpadding="1px">
		<tr class="HEADER">
			<td colspan="4">Equipment Manpower Assignment Register Report</td>
		</tr>

		<tr>
			<td class="LABEL" colspan="4"><html:radio
				property="strReportType" name="EquipManpowerAssignmentRegReportFB"
				value="1" onclick="">Manpower Assignment Register</html:radio> <html:radio
				property="strReportType" name="EquipManpowerAssignmentRegReportFB"
				value="2" onclick="">Manpower Assignment & Current Status Register</html:radio></td>
		</tr>
		...
		<tr>
			...
			<div id="hospitalNameId"><select name="strDeptCode"
				...
				<bean:write name="EquipManpowerAssignmentRegReportFB"
					property="strHospitalCombo" filter="false" />
			</select></div>
			</td>
		</tr>
		<tr>
			...
			<div id="labNameId"><select name="strLabCode"
				...
				<bean:write name="EquipManpowerAssignmentRegReportFB"
					property="strLabCombo" filter="false" />
			</select></div>
			</td>
		</tr>
...
<img class="button" onkeypress="if(event.keyCode==13) clearReport();" onClick="document.forms[0].reset();" tabindex="1" style="cursor:pointer" src="/AHIMS/hisglobal/images/btn-clr.png">
	...
	<div id="strErrMsg" align="center" class="ERR_DIV"><bean:write
		name="EquipManpowerAssignmentRegReportFB" property="strErrMsg" /></div>
	<div id="strWarningMsg" align="center" class="WARNING_DIV"><bean:write
		name="EquipManpowerAssignmentRegReportFB" property="strWarningMsg" /></div>
	<div id="normalMsg" align="center" class="NORMAL_DIV"><bean:write
		name="EquipManpowerAssignmentRegReportFB" property="strNormalMsg" /></div>
