...
<his:javascript	src="/bmed/reports/js/bmed_equip_checkInOut_security.js" />
</head>
<body marginheight="0" marginwidth="0" onload="onLoadPage();" >
<html:form  action="/reports/EquipmentCheckInOutSecurityReportCNT"  method="post">
	<his:TransactionContainer>
		<his:TitleTag name="Equipment CheckIn\Out Report">
		</his:TitleTag>	
				...
				<td width="50%" colspan="2" class="CONTROL_TD">
					<div id="divDeptCmbId" style="display:block;">
					 <select name="strDeptId"   class="comboNormal" onchange="getStoreName()">
					   <bean:write name="EquipmentCheckInOutSecurityReportFB" property="strDeptCmb" filter="false" />
					 </select>
					 </div>
				</td>
		</tr> 
					...
					<td width="50%" colspan="2" class="CONTROL_TD">	
						<div id="storeNameId">					
							<select name="strStoreId" class='COMBO_NORMAL' onchange="getItemNameOnBasisOfStore();">
								...
								<bean:write name="EquipmentCheckInOutSecurityReportFB" property="strStoreNameCombo" filter="false" />
		...
		<tr>
			...
			<td width="50%" colspan="2" class="CONTROL_TD">
				<dateTag:date name="strFromDate" 
				 value="${EquipmentCheckInOutSecurityReportFB.strCurrentDate}"/>
			</td>
		...
		<tr>
			...
			<td width="50%" colspan="2" class="CONTROL_TD">
			<html:checkbox property="strIsFooter" name="EquipmentCheckInOutSecurityReportFB" value="1"></html:checkbox>
			</td>
		...
		<div id="strErrMsg" align="center" class="ERR_DIV"><bean:write
			name="EquipmentCheckInOutSecurityReportFB" property="strErrMsg" /></div>
		<div id="strWarningMsg" align="center" class="WARNING_DIV"><bean:write
			name="EquipmentCheckInOutSecurityReportFB" property="strWarningMsg" /></div>
		<div id="normalMsg" align="center" class="NORMAL_DIV"><bean:write
			name="EquipmentCheckInOutSecurityReportFB" property="strNormalMsg" /></div>
		<input type="hidden" name="hmode"/>
        <input type="hidden" name="strCurrentDate" value="${EquipmentCheckInOutSecurityReportFB.strCurrentDate}" />
