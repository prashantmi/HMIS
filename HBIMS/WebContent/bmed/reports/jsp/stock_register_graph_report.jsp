...
<html:form  action="/reports/StockRegisterGraphReportCNT"  method="post" styleClass="formbg">
	
		
		<div id="trItemId">
		<table class="TABLEWIDTH" align="center" cellspacing="1px" cellpadding="1px">
		<tr class="HEADER">
			<td colspan="4">Stock Register Graph Report</td>		</tr>
	    	
	    <tr>
			<td class="LABEL" colspan="4">
				
				<html:radio property="strReportType" name="stockRegisterGraphReportFB" value="1" onclick="">Group Wise</html:radio>
		    	<html:radio property="strReportType" name="stockRegisterGraphReportFB" value="2" onclick="">Item Wise</html:radio>
		    	<html:radio property="strReportType" name="stockRegisterGraphReportFB" value="3" onclick="">Program Wise</html:radio>
		...
		<tr>
			...
			<td width="50%" colspan="2" class="CONTROL">
				<div id="hospitalNameId">
					...
					<bean:write name="stockRegisterGraphReportFB" property="strHospitalCombo" filter="false" />
					</select>
				</div>
			</td>
		</tr>
		<tr>
			...
			<td width="50%" colspan="2" class="CONTROL">
				<div id="labNameId">
					...
					<bean:write name="stockRegisterGraphReportFB" property="strLabCombo" filter="false" />
					</select>
				</div>
			</td>
		</tr>
		...
		<tr style="display:none;">
			...
			<td width="50%" colspan="2" class="CONTROL">
				<div id="equipmentStatusId">
					...
					<bean:write name="stockRegisterGraphReportFB" property="strEquipmentStatusCombo" filter="false" />
					</select>
				</div>
			</td>
		</tr>
		...
		<tr>
			...
			<td width="50%" colspan="2" class="CONTROL">
			<html:checkbox property="strIsFooter" name="stockRegisterGraphReportFB" value="1"></html:checkbox>
			</td>
