...
<his:javascript	src="/bmed/reports/js/warrenty_maint_group_wise_chart_report.js" />
...
<html:form  action="/reports/WarrentyMaintGraphReportCNT"  method="post" styleClass="">
	...
	<input type="hidden" id="strInstalPend" value="${warrentyMaintGraphReportFB.strInstalPend}">
	<input type="hidden" id="strNotInUse" value="${warrentyMaintGraphReportFB.strNotInUse}">
	<input type="hidden" id="strNotFuncRepairable" value="${warrentyMaintGraphReportFB.strNotFuncRepairable}">
	<input type="hidden" id="strNotfuncNotRepairable" value="${warrentyMaintGraphReportFB.strNotfubcNotRepairable}">
	<input type="hidden" id="strFunctional" value="${warrentyMaintGraphReportFB.strFunctional}">
	<input type="hidden" id="strNonFunctional" value="${warrentyMaintGraphReportFB.strNonFunctional}">
	<input type="hidden" id="strRate" value="${warrentyMaintGraphReportFB.strRate}">
	<input type="hidden" id="strWarranty" value="${warrentyMaintGraphReportFB.strWarranty}">
	<input type="hidden" id="strMaintenance" value="${warrentyMaintGraphReportFB.strMaintenance}">
	<input type="hidden" id="strGroupName" value="${warrentyMaintGraphReportFB.strGroupName}">
	...
	<div id="barHeader" class="headerCSS">
		<div style="font-family: arial; font-size: 12pt; font-weight: bold;">${warrentyMaintGraphReportFB.strReportHeader}</div>
		<div style="font-family: arial; font-size: 12pt; font-weight: bold;">${warrentyMaintGraphReportFB.strReportSubHeader}</div>
		<div style="font-family: arial; font-size: 10pt; font-weight: bold;">${warrentyMaintGraphReportFB.strReportAddress}</div>
		<div style="font-family: arial; font-size: 10pt; font-weight: bold;">${warrentyMaintGraphReportFB.strReportContact}</div>
		<div style="font-weight: bold; font-size: 16pt; font-family: Times New Roman; text-decoration: underline;">${warrentyMaintGraphReportFB.strReportName}</div>
	</div>
	
	<div style="font-family: Arial; font-size: 8pt;text-align: right;">${warrentyMaintGraphReportFB.strDateNTime}</div>
	<div id="hospitalDiv" class="demo-container" style="height:100px;">
	<p class="left">${warrentyMaintGraphReportFB.strPageHeading}</p>
		<table  style="height:75px;width:100%;margin-top: -18px;">
			<tr>
			 ...
			 <td style="width:38%">${warrentyMaintGraphReportFB.strStoreName}</td>
			 <td class="font1" style="width:14%;text-align: right; font-weight: bold;">Lab Name:</td>
			 <td style="width:38%">${warrentyMaintGraphReportFB.strLabName}</td>
			</tr>
		</table>
	</div>
	<div style="font-weight: bold; position: relative; top: -30px; text-decoration: underline; color: black; font-family: Arial;">${warrentyMaintGraphReportFB.strIsFooter}</div>	
	<div style="color: #FF0000;font-family: Arial;font-weight: bold;">${warrentyMaintGraphReportFB.strNote}</div>	
	...
	<div style="width:100%;height=30px;display:none;">
		...
		<div id="yAxixLabel" class="rotateY axisLabel">${warrentyMaintGraphReportFB.strYAxisLabel}</div>
		<div id="yAxixLabel" class="rotateX axisLabel">${warrentyMaintGraphReportFB.strXAxisLabel}</div>
		...
		<div id="pieDiv" class="demo-container" style="display:none">
			...
			<p class="font">${warrentyMaintGraphReportFB.strNote}</p>	
		</div>			
