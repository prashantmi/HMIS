 ...
 * Modifying Date:- 
 * Used For:-
 * Module:- BMED(HIS Project) Log Register
 * 
 */
 -->
<html>
...
<his:javascript src="/bmed/reports/js/bmed_logRegister_Rpt.js" />
</head>
<body marginheight="0" marginwidth="0" onload="onLoadPage();">
<html:form action="/reports/logRegisterReportACTION" method="post">
	<his:TransactionContainer>
		<his:TitleTag name="Log Register">
		</his:TitleTag>
		...
		<his:ContentTag>
			<table class="TABLE_STYLE">
				...
				<tr id="comboId">
					...
					<div id="id1" style="dispaly: block;"><font color="red">*</font>Department
					Name</div>
					</td>
					<td width="50%" colspan="2" class="CONTROL_TD">
					<div id="divDeptCmbId" style="display: block;"><select
						name="strDeptId" class="comboNormal"
						onchange="getStoreNameCombo()">
						<bean:write name="logRegisterReportFB" property="strDeptCmb"
							filter="false" />
					</select></div>
					</td>
				</tr>
				...
				<tr id="comboId">
					...
					<td width="50%" colspan="2" class="LABEL_TD">
					<div id="id1" style="dispaly: block;"><font color="red">*</font>Store
					Name</div>
					</td>
					<td width="50%" colspan="2" class="CONTROL_TD">
					<div id="divStoreId" style="display: block;"><select
				...
				<tr>
					...
					<td width="50%" colspan="2" class="CONTROL_TD"><dateTag:date
						name="strFromDate" value="${logRegisterReportFB.strCurrentDate}" />
					</td>
				...
				<tr>
					...
					Date</td>
					<td width="50%" colspan="2" class="CONTROL_TD"><dateTag:date
						name="strToDate" value="${logRegisterReportFB.strCurrentDate}" />
					</td>
				...
				<tr>
					...
					<td width="50%" colspan="2" class="CONTROL_TD"><html:checkbox
						property="strIsFooter" name="logRegisterReportFB" value="1"></html:checkbox>
					</td>
		...
		<his:ButtonToolBarTag>
			...
			<img style="cursor: pointer"
				src="/HBIMS/hisglobal/images/btn-generate.png"
				onClick="return validate();" />
			<img style="cursor: pointer"
				src="/HBIMS/hisglobal/images/btn-clr.png"
		...
		<div id="strErrMsg" align="center" class="ERR_DIV"><bean:write
			name="logRegisterReportFB" property="strErrMsg" /></div>
		<div id="strWarningMsg" align="center" class="WARNING_DIV"><bean:write
			name="logRegisterReportFB" property="strWarningMsg" /></div>
		<div id="normalMsg" align="center" class="NORMAL_DIV"><bean:write
			name="logRegisterReportFB" property="strNormalMsg" /></div>
		<input type="hidden" name="hmode" />
		<input type="hidden" name="strCurrentDate"
			value="${logRegisterReportFB.strCurrentDate}" />
