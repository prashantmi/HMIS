...
<his:javascript	src="/bmed/reports/js/bmed_ComplaintCompelete_report.js" />
</head>
<body marginheight="0" marginwidth="0" onload="onLoadPage();" >
<html:form  action="/reports/ListOfCompletedComplaintsACTION"  method="post">
	<his:TransactionContainer>
		<his:TitleTag name="List of Completed Complaint">
		</his:TitleTag>	
		...
		<his:ContentTag>
			...
			<td class="LABEL_TD" colspan="4">
				...
				<html:radio property="issueChkDetail" name="listofCompletedComplaint" value="1" onclick="setValueChk();">Department</html:radio>
		    	<html:radio property="issueChkDetail" name="listofCompletedComplaint" value="2" onclick="setValueChk();">Item</html:radio>
		    	<html:radio property="issueChkDetail" name="listofCompletedComplaint" value="3" onclick="setValueChk();">Date</html:radio>
		...
		<tr	id="comboId">
				...
				<div id="deptCmb" style="display:block;">
				 <select name="strDeptId"   class="comboNormal">
				   <bean:write name="listofCompletedComplaint" property="strDeptCmb" filter="false" />
				 </select>
				 </div>
				 <div id="itemCmb" style="display:none;">
				 <select name="strItemId"   class="comboNormal">
				   <bean:write name="listofCompletedComplaint" property="strItemCmb" filter="false" />
				 </select>
				 </div>
				</td>
		...
		<tr>
			...
			<td width="50%" colspan="2" class="CONTROL_TD">
				<dateTag:date name="strFromDate" 
				 value="${listofCompletedComplaint.strCurrentDate}"/>
			</td>
		...
		<tr>
			...
			<td width="50%" colspan="2" class="CONTROL_TD">
			<html:checkbox property="strIsFooter" name="listofCompletedComplaint" value="1"></html:checkbox>
			</td>
		...
		<div id="strErrMsg" align="center" class="ERR_DIV"><bean:write
			name="listofCompletedComplaint" property="strErrMsg" /></div>
		<div id="strWarningMsg" align="center" class="WARNING_DIV"><bean:write
			name="listofCompletedComplaint" property="strWarningMsg" /></div>
		<div id="normalMsg" align="center" class="NORMAL_DIV"><bean:write
			name="listofCompletedComplaint" property="strNormalMsg" /></div>
		<input type="hidden" name="hmode"/>
        <input type="hidden" name="strCurrentDate" value="${listofCompletedComplaint.strCurrentDate}" />
