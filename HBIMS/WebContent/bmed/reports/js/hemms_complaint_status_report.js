...
{	
   ...
   var url="EquipmentWiseComplaintStatusReportACTION.cnt?hmode=GETITEMNAMECOMBO&strDeptId="+document.forms[0].strDeptId.value;
   ajaxFunction(url,"1");
...
{	
	...
	{	
       ...
       else
       {
       	            ...
       	            //alert(res);
       	            itemParaObj.innerHTML ="<select name = 'strLabCode' onchange='' class='COMBO_NORMAL'>" + res + "</select>";
        }       
    }
	...
	{	
       ...
       else
       {
       	           ...
       	           // alert(res);
       	            itemParaObj.innerHTML ="<select name = 'strComplaintNo' onchange='' class='COMBO_NORMAL'>" + res + "</select>";
        }       
    }
    if(mode=="5")
	{	
...
function getStoreName()
{
	...
	var url = "ComplaintStatusReportCNT.cnt?hmode="+mode+"&deptId="+document.forms[0].strDeptCode.value;
	ajaxFunction(url,"1");
}
function getComplaintNumber()
{
	var mode = "GETCOMPLAINTNUMBER"
	var url = "ComplaintStatusReportCNT.cnt?hmode="+mode+"&deptId="+document.forms[0].strDeptCode.value+"&labId="+document.forms[0].strLabCode.value;
	ajaxFunction(url,"2");
}
...
{
	 var url="EquipmentWiseComplaintStatusReportACTION.cnt?hmode=GETITEMNAME&flag="+0+"&storeId="+document.forms[0].strStoreId.value;
	 ajaxFunction(url,"5");	
}
