...
{	
   ...
   var url="EquipmentCheckInOutSecurityReportACTION.cnt?hmode=GETITEMNAMECOMBO&strDeptId="+document.forms[0].strDeptId.value;
   ajaxFunction(url,"1");
...
function validate()
{
		 ...
		 var hisValidator = new HISValidator("EquipmentCheckInOutSecurityReportFB");
...
function getStoreName()
{
	...
	var url = "EquipmentCheckInOutSecurityReportCNT.cnt?hmode="+mode+"&deptId="+document.forms[0].strDeptId.value;
	ajaxFunction(url,"4");
}
...
{
	 var url="EquipmentCheckInOutSecurityReportCNT.cnt?hmode=GETITEMNAME&flag="+0+"&storeId="+document.forms[0].strStoreId.value;
	 ajaxFunction(url,"5");	
}
