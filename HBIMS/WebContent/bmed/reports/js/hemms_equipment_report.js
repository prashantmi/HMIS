...
function getStoreName()
{
	...
	var url = "EquipmentReportCNT.cnt?hmode="+mode+"&deptId="+document.forms[0].strDeptCode.value;
	ajaxFunction(url,"1");
}
function getComplaintNumber()
{
	var mode = "GETCOMPLAINTNUMBER"
	var url = "EquipmentReportCNT.cnt?hmode="+mode+"&deptId="+document.forms[0].strDeptCode.value+"&labId="+document.forms[0].strLabCode.value;
