...
{	
   ...
   var url="StockRegisterGraphReportCNT.cnt?hmode=GETITEMNAMECOMBO&strDeptId="+document.forms[0].strDeptId.value;
   ajaxFunction(url,"1");
...
function validate()
{
		 ...
		 var hisValidator = new HISValidator("stockRegisterGraphReportFB");
