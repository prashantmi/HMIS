function validate()
{
		 ...
		 var hisValidator = new HISValidator("serviceEngineerWiseJobStatusReportFB");
		 //alert("inside validate1");
		 hisValidator.addValidation("strServiceEngineerId", "dontselect=0", "Please Select Service Engineer Name" );
...
function onLoadPage()
{
	...
	document.forms[0].strServiceEngineerId.value = "0";
