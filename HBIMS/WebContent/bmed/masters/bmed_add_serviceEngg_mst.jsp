...
<html:form action="/masters/ServiceEngineerMstCNT"
	...
	<table class="TABLEWIDTH" align="center">
		<tr class="HEADER">
			<td colspan="4">Service Engineer &gt;&gt; Add</td>
		</tr>
	...
	<table border="0" class="TABLEWIDTH" align="center" border='0'
		...
		<tr class="TITLE">
			...
			<td colspan="6"><font color="red">*</font> Service Engineer List</td>
		...
		<tr>
			...
			<table width='100%' align='center' border='0' cellspacing='1px'
				cellpadding='1px' bgcolor='black'>

				<tr>

					<td width="15%" class="multiLabel"><img
						Src="../../hisglobal/images/plus.gif" style="cursor: pointer;"
						title="Add Service Engineer's"
						OnClick="addRows(new Array('strServiceEnggName'),new Array('t'),'1','1','R');"></td>

					<td width="85%" class="multiLabel">Name</td>
				</tr>
