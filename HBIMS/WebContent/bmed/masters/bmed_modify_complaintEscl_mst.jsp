...
<html:form action="/masters/ComplaintEscalationMstCNT"
	...
	type="bmed.masters.controller.fb.ComplaintEscalationMstFB"
	styleClass="formbg">
	...
	<table class="TABLEWIDTH" align="center">
		<tr class="HEADER">
			<td colspan="4">Complaint Escalation Master&gt;&gt; Modify</td>
		</tr>
	...
	<table border="0" class="TABLEWIDTH" align="center" border='0'
		...
		<tr>
			...
			Type</td>
			<td colspan="1" class="CONTROL"><bean:write
				name="complaintMstBean" property="strLevelType" filter="false" /></td>
			<td colspan="1" class="LABEL"><font color="red">*</font>Employee
			Name</td>
			<td colspan="1" class="CONTROL"><bean:write
				name="complaintMstBean" property="strEmpNameCmb" filter="false" />
		...
		<%-- <tr>
			...
			<div id='contactNoDiv' style='display: block;'><bean:write
				name="complaintMstBean" property="strContactNo" filter="false" /></div>

			</td>
			<td colspan="1" class="LABEL">E-Mail ID</td>
			<td colspan="1" class="CONTROL">
			<div id='emailIdDiv' style='display: block;'><bean:write
				name="complaintMstBean" property="strEmailId" filter="false" /></div>
			</td>
		</tr> --%>
		...
		<tr>
			...
			<td colspan="1" class="CONTROL"><input type="text"
				class="txtFldNormal" name="strPeriod" maxlength="3"
				value="${complaintMstBean.strPeriod}"
		...
		<tr>
			...
			<td width="25%" class="CONTROL"><textarea name="strRemarks"
				...
				name="complaintMstBean" property="strRemarks" /></textarea></td>
		...
		<tr>
			...
			<td width="50%" colspan="2" class="CONTROL"><html:radio
				name="complaintMstBean" property="strIsValid" value="1">Active</html:radio>
			<html:radio name="complaintMstBean" property="strIsValid" value="2">Inactive</html:radio>
	...
	<table border="0" class="TABLEWIDTH" align="center">
		...
		<tr>
			<td align="center"><img src="../../hisglobal/images/btn-sv.png"
				...
				onClick="return validateUpdate();" /> <img
	...
	--><input type="hidden" name="hmode" /> <input type="hidden"
		name="comboValue" value="${complaintMstBean.comboValue}"> <input
		type="hidden" name="strChk" value="${complaintMstBean.strChk}">
	<input type="hidden" name="strContactNo"
		value="${complaintMstBean.strContactNo}"> <input type="hidden"
		name="strEmailId" value="${complaintMstBean.strEmailId}"> <cmbPers:cmbPers />
</html:form>
