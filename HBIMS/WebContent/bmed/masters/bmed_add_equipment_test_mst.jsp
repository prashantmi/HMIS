...
<title>Equipment Test Master Add Page</title>
...
<html:form name="equipmentTestMstFB" action="/masters/EquipmentTestMstCNT"
	...
	<table class="TABLEWIDTH" align="center" cellpadding="1px"
		cellspacing="1px">
		<tr class="HEADER">
			<td colspan="2">Equipment Test Master&gt;&gt;Add</td>
		</tr>
		...
		<tr>
			...
			<td width="50%" class="CONTROL"><input type="text"
				name="strTestName" value="" maxlength="250"
		...
		<tr>
			...
			<td class="CONTROL"><dateTag:date name="strEffectiveFrom"
				value="${equipmentTestMstFB.strCtDate}"></dateTag:date></td>
		</tr>
