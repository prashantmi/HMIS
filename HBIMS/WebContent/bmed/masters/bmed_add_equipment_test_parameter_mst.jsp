...
%>
<title>Equipment Test Parameter Master Add Page</title>
...
<html:form name="equipmentTestParameterMstFB" action="/masters/EquipmentTestParameterMstCNT"
	...
	<table class="TABLEWIDTH" align="center" cellpadding="1px"
		cellspacing="1px">
		<tr class="HEADER">
			<td colspan="3">Equipment Test Parameter Master&gt;&gt;Add</td>
		</tr>
		...
		<tr>
			...
			<div id="testIdDiv" align="left"><select
				class='comboNormal' name="strTestId" onchange="getParamters();">
