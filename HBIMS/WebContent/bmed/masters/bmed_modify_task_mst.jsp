...
%>
<title>Task Master Modify Page</title>
...
<html:form name="taskBean" action="/masters/TaskMstCNT"
	...
	<table class="TABLEWIDTH" align="center" cellpadding="1px"
		cellspacing="1px">
		<tr class="HEADER">
			<td colspan="2">Task Master&gt;&gt;Modify</td>
		</tr>

		<tr>
			<td class="LABEL">Engineering Item
			Type</td>

			<td class="CONTROL" colspan="2">${taskBean.strEngineeringItemTypeName}</td>
		</tr>


		<tr>
			<td class="LABEL">Engineering Item Sub
			Type</td>

			<td class="CONTROL" colspan="2">${taskBean.strEngineeringItemSubTypeName}</td>
		</tr>
		...
		<tr>
			...
			<td width="50%" class="CONTROL"><input type="text"
				name="strTaskName" maxlength="250" value="${taskBean.strTaskName}"
		...
		<tr>
			...
			<td class="CONTROL"><dateTag:date name="strEffectiveFrom"
				value="${taskBean.strEffectiveFrom}"></dateTag:date></td>
		</tr>
		...
		<tr>
			...
			<div align="left"><textarea name="strRemarks" rows="2"><bean:write
				name="taskBean" property="strRemarks" /></textarea></div>
			</td>
		</tr>

		<tr>
			<td class="LABEL"><font color="red">*</font>Record Status</td>
			<td width="45%" class="CONTROL"><html:radio name="taskBean"
				property="strIsValid" value="1">Active</html:radio> <html:radio
				name="taskBean" property="strIsValid" value="2">Inactive</html:radio>
	...
	<input type="hidden" name="chk" value="${taskBean.chk[0] }">
	<input type="hidden" name="comboValue" value="${taskBean.strTaskName}">
	<input type="hidden" name="hmode">
	<html:hidden name="taskBean" property="strEngineeringItemTypeId"/>
	<html:hidden name="taskBean" property="strEngineeringItemSubTypeId"/>
