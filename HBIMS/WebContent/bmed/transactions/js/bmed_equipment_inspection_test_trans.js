...
{	
	...
	var stockStatus = tmp[6];
	 ...
	 var url="EquipmentInspectionTestDtlsACTION.cnt?hmode=PREVIOUSCOMPLAINTDTL&flag=ITEM&strStockInf="+passVal;
 ...
 function showOrHideStockDetails(thisImg)
 {
	...
	if (thisImg.title == "Show") 
	{
		...
		thisImg.src = "/AHIMS/hisglobal/images/minus.gif";
		thisImg.title = "Hide";
	...
	{  
		thisImg.src = "/AHIMS/hisglobal/images/plus.gif";
		thisImg.title = "Show";
...
{   
           ...
           var hisValidator = new HISValidator("equipmentInspectionTestDtlsFB");
           ...
           if(document.forms[0].strItemId!=null)
             {
	        	hisValidator.addValidation("strItemId","dontselect=0","Please Select Item Name");
                   ...
                   hisValidator.addValidation("strTestId","dontselect=0","Please Select Inspection/Test Name");
                   
	        		 hisValidator.addValidation("strTestDate","req", "Test Date is a Mandatory Field!" );
	         		 hisValidator.addValidation("strAttendTime","req", "Test Time is a Mandatory Field!" );
	         ...
	         hisValidator.addValidation("strResult","maxlen=100", "Result should be less than 100 characters" );
	         
	           
	           if(document.getElementsByName('strAttendTime')[0].value.length!=5)
	       	 {
	       	 	alert("Enter Test Time in the format (HH:MM 24Hr) ");
	       	 	document.forms[0].strAttendTime.focus();
	       	 	return false;
	       	 }
	         
	        var obj2 = document.forms[0].strIsExInFlag;
	   		
	   			   			
				 if(obj2.value == "1"){   	
				 
				 						 		
				 		document.forms[0].strVendorServiceEngName.value="-1";
						hisValidator.addValidation("strSpareManufacturerId","dontselect=0","Please Select Supplier/Manufacturer Name");
				 ...
				 { 		
				  ...
				  hisValidator.addValidation("strVendorServiceEngName","dontselect=0","Please Select Confirmed By");
				...
				for(i=0;i<document.getElementsByName("strTestParaId").length-1;i++)
			
				{
				
								
				  if(document.getElementsByName("strTestParaId")[i].value == "0")
				  {
				  
				  	alert("Select the Input");
				   	document.getElementsByName("strTestParaId")[i].focus();
				  	return false;
				  }
				
				
				 if(document.getElementsByName("stroutPut")[i].value == "")
				  {
				  
				  	alert("Select the Output");
				  	document.getElementsByName("stroutPut")[i].focus();
				   	return false;
				  }
...
function getEnggItemSubTypeCombo()
{
        ...
        var url ="EquipmentInspectionTestDtlsACTION.cnt?hmode="+mode+"&enggItemType="+document.forms[0].strEngineeringItemTypeId.value;
 		ajaxFunction(url,"1");		
}
...
function getStoreName()
{
	...
	var url = "EquipmentInspectionTestDtlsACTION.cnt?hmode="+mode+"&deptId="+document.forms[0].strDeptCodeNew.value;
...
function getVenderDetails()
{
	...
	var url = "EquipmentInspectionTestDtlsACTION.cnt?hmode="+mode+"&vendorId="+document.forms[0].strVendorId.value;
	ajaxFunction(url,"13");
}
...
//document.forms[0].strItemOrNonItemMode[0].value=1;
getServiceEngName();
 //alert("internal"+document.forms[0].strItemOrNonItemMode[0].value);
  //alert("external"+document.forms[0].strItemOrNonItemMode[1].value);
 var Obj = document.getElementById("strSpareManufacturerDivId");
      Obj.style.display='none';
      
 var Obj2 = document.getElementById("strVendorServiceEngNameDivId");     
     Obj2.style.display='block';


 var Obj3 = document.getElementById("strVendorServiceEngNameDivId1");     
     Obj3.style.display='block';
     
     
      var Obj4 = document.getElementById("strSpareManufacturerDivId1");     
     Obj4.style.display='none';
     
     document.forms[0].strIsExInFlag.value="0";
...
//document.forms[0].strItemOrNonItemMode[1].value=2;
// alert("external"+document.forms[0].strItemOrNonItemMode[1].value);
 ...
 document.getElementById("otherNameDivId").style.display='none';
     
     document.forms[0].strIsExInFlag.value="1";
}
...
function getOtherName(){
 ...
 var Obj = document.getElementById("otherNameDivId");    
 
 var Obj1 =  document.forms[0].strVendorServiceEngName; 
		if(document.forms[0].strVendorServiceEngName.value == "-1")
		{
		
		    document.forms[0].strOtherName.value="";
     		Obj.style.display='block';
    ...
    Obj.style.display='none';
    document.forms[0].strOtherName.value = getSelectedLabel(Obj1);
    }
...
function getServiceEngName()
{
   var mode ;
	...
	var url = "EquipmentInspectionTestDtlsACTION.cnt?hmode="+mode+"&enggItemType="+document.forms[0].strEngineeringItemTypeId.value+"&enggItemSubType="+document.forms[0].strEngineeringItemSubTypeId.value;
	ajaxFunction(url,"14");
}
...
{	
   	  ...
   	  var url="EquipmentInspectionTestDtlsACTION.cnt?hmode=GETITEMNAME&flag="+1+"&deptId="+document.forms[0].strDeptCode.value;
      ajaxFunction(url,"3");
} 
...
function getEmpCombo()
{
   	  ...
   	  var url="EquipmentInspectionTestDtlsACTION.cnt?hmode=EMPCOMBO&flag="+1+"&deptId="+document.forms[0].strDeptCodeNew.value;
      ajaxFunction(url,"15");
...
function getEmpDesignation()
{
   	  ...
   	  var url="EquipmentInspectionTestDtlsACTION.cnt?hmode=EMPDESIGNATION&flag="+1+"&empId="+document.forms[0].strEmpId[0].value;
...
{
	 var url="EquipmentInspectionTestDtlsACTION.cnt?hmode=GETITEMNAME&flag="+0+"&storeId="+document.forms[0].strStoreId.value;
	 ajaxFunction(url,"5");	
}

function getNonItemName()
{
	var url="EquipmentInspectionTestDtlsACTION.cnt?hmode=GETNONITEMNAME&enggItemType="+document.forms[0].strEngineeringItemTypeId.value+"&enggItemSubType="+document.forms[0].strEngineeringItemSubTypeId.value;
    ajaxFunction(url,"9");
}
...
{	   
   ...
   {
   var url="EquipmentInspectionTestDtlsACTION.cnt?hmode=GETSTOCKDTL&itemNo="+document.forms[0].strItemId.value+"&deptId="+document.forms[0].strDeptCodeNew.value;
   }
   else if(document.getElementsByName("strDeptCode") && document.forms[0].strDeptCode.value!=0)
   {
   var url="EquipmentInspectionTestDtlsACTION.cnt?hmode=GETSTOCKDTL&itemNo="+document.forms[0].strItemId.value+"&deptId="+document.forms[0].strDeptCode.value;
   }
...
{
	  var url="EquipmentInspectionTestDtlsACTION.cnt?hmode=PREVIOUSCOMPLAINTDTL&flag=NON_ITEM"+"&nonItemId="+document.forms[0].strNonItemId.value;
      ajaxFunction(url,"10");
}
...
{	  
   ...
   objVal1.innerHTML ="";
   var url="EquipmentInspectionTestDtlsACTION.cnt?hmode=WARRANTYDTL&flag=ITEM"+"&strStockInf="+passVal ;
   ajaxFunction(url,"6");   
...
function getWarrantyDtlForNonItem(passVal)
{
   ...
   objVal1.innerHTML ="";
	...
	var url="EquipmentInspectionTestDtlsACTION.cnt?hmode=WARRANTYDTL&flag=NON_ITEM"+"&nonItemId="+passVal ;
    ajaxFunction(url,"11"); 
}
...
function getMaintenanceContractDetails(passVal)
{
    ...
    var url="EquipmentInspectionTestDtlsACTION.cnt?hmode=MAINTENANCECONTRACTDTL&flag=ITEM"+"&strStockInf="+passVal ;
    ajaxFunction(url,"8");   
}
...
function getMaintenanceContractDetailsForNonItem(passVal)
{
    ...
    objVal1.innerHTML ="";
  	...
  	var url="EquipmentInspectionTestDtlsACTION.cnt?hmode=MAINTENANCECONTRACTDTL&flag=NON_ITEM"+"&strNonItemId="+passVal ;
    ajaxFunction(url,"12");   
}
...
var url="EquipmentInspectionTestDtlsACTION.cnt?hmode=initializeAttended&flag=1&itemId="+document.forms[0].strItemId.value+"&storeId="+document.forms[0].strStoreId.value+
    ...
    if(mode=="14")
    {
     ...
     var err = document.getElementById("errMsg");
       ...
       else
       {
       	            ...
       	            var itemParaObj = document.getElementById("strServiceEngId");
       	            itemParaObj.innerHTML ="<select name = 'strVendorServiceEngName' onchange='getOtherName();' class='COMBO_NORMAL'>" + res + "</select>";   
