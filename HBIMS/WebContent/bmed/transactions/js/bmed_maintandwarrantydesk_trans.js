...
{  
       ...
       var count = parseInt("0");
   	   ...
   	   if(count > 1)
   	   {
   	     ...
   	     for(var i=0; i<chkObj.length; i++) 
   	     {
   	  	 ...
   	  	 disableButton("Guarantee View");
   	  	 disableButton("Guarantee Archieve");
       ...
       {   
         ...
         enableButton("View");
   	  	 ...
   	  	 enableButton("Guarantee View");
   	  	 enableButton("Guarantee Archieve");
...
{	
	...
	try
	{
		if(checkCount=='1')
		{
			status = document.getElementById("comboid0").value;
			if(status == "1")
		    {
		    	enableButton("MAINT. VIEW");
		    	//enableButton("ARCHIVE");
		    	return;
		    }
		    if(status=="2"){
		    	enableButton("GUARANTY VIEW");
		    	//enableButton("GUARANTY ARCHIVE");
		    	return;
	    	}
		}
		else
		{
		    disableButton("MAINT. VIEW");
		    disableButton("GUARANTY VIEW");
			for(i=0;i<check.length;i++)
			{
...
function buttonLogicsOnClick1(modeNo, mode , display)
{
	...
	try
	{
		if(mode=='MAINTENANCE' || mode=='WARRANTY'){
