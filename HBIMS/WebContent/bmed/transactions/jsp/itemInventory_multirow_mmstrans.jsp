...
<table class="TABLEWIDTH" align="center" border="0" cellpadding="1px" cellspacing="1px">
<tr>
<td class="multiControl" width="15%"><input type="hidden" name="strItemPartDtls" id="strItemPartDtls#delIndex#" value=""><div id="itemOtherTypeDivId#delIndex#"></div>
</td>
<td class="multiControl" width="15%">
<div id="itemOtherNameDivId#delIndex#"></div>
</td>
<td class="multiControl" width="15%"><div id="itemOtherBatchNoDivId#delIndex#"></div>
</td>
<td class="multiControl" width="15%"><div id="itemOtherManufacturerDivId#delIndex#"></div>
</td>
<td class="multiControl" width="15%"><div id="itemOtherExpiryDateDivId#delIndex#"></div>
</td>
<td class="multiControl" width="20%"><div id="itemOtherQtyDivId#delIndex#"></div>
</td>
<td class="multiControl" width="5%"><img src="../../hisglobal/images/minus.gif"
				onClick="deleteRow('#delIndex#','2','0');"
				style="cursor: pointer; " />
</td>
</tr>
</table>
