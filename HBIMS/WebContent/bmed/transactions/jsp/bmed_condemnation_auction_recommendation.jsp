...
<html>
<head>
<title>Equipment Condemnation Committee Recommendation</title>
	...
	//      hisValidator.addValidation("strEffectiveFrom", "dtgtet="+document.forms[0].strCtDate.value, "Formation Date Must be greater than or Equal to Current Date." );
	 //     if(document.forms[0].strValidUpto.value!='')
      ...
      //   }
        ...
        var retVal = true;//hisValidator.validate(); 
             
      if(retVal){
                   document.forms[0].hmode.value = "saveCommitteeRecommendation";
...
<body onload="chkRecordSaved()" class="background">
	<html:form
		...
		<table class="TABLEWIDTH" align="center" border="0" cellpadding="1px"
			cellspacing="1px">
			<tr class="HEADER">
				<td colspan="4">Equipment Committee Recommendation Process</td>
			</tr>
		</table>
		...
		<table class="TABLEWIDTH" align="center" border="0" cellpadding="1px"
			...
			<tr>
				<td colspan="1" class="LABEL">Serial
					No</td>
			...
			<tr>
				<td colspan="1" class="LABEL">Manufacturer
					Name</td>
		...
		<table class="TABLEWIDTH" align="center" border="0" cellpadding="1px"
			cellspacing="1px">
			<tr>
				<td colspan="1" class="LABEL">Request
					No. / Date</td>
		...
		<table class="TABLEWIDTH" align="center" border="0" cellpadding="1px"
			cellspacing="1px">
			<tr>
				<td colspan="1" class="LABEL">Order
					No./ Date</td>
		...
		<table class="TABLEWIDTH" align="center" border="0" cellpadding="1px"
			cellspacing="1px">
			<tr>
				<td colspan="1" class="LABEL">Committee
					Name</td>
				<td colspan="1" class="CONTROL"><a onclick="getDetailsOnBasisOfCommiteeId();" href="#">${EquipmentAuctionAndCondemnationDeskFB.strCommitteeName}</a>
				<input type="hidden" name="strCommitteeId"
			id="strCommitteeId"
			...
			<tr>
				<td colspan="1" class="LABEL">Schedule
					Date</td>
			...
			<tr>
				...
				<td colspan="1" class="LABEL">Remarks
				</td>
		...
		<table class="TABLEWIDTH" align="center" border="0" cellpadding="1px"
			...
			<tr>
				<td colspan="1" class="LABEL" >Recommend for Condemnation
				</td>
				<td colspan="1" class="CONTROL"><select class='comboMin'
					id="strRecommendationStatus" name="strRecommendationStatus">
						<option value="1" title="Yes, Recommended">Yes</option>
						<option value="0" title="No, Not Recommended">No</option>
				</select></td>

<td colspan="1" class="LABEL">Date of Recommendation</td>
				<td colspan="1" class="CONTROL"><dateTag:date
						name="strRecommendationDate"></dateTag:date></td>
			</tr>
			
			<tr>
				<td colspan="1" class="LABEL" >Recommendation</td>
				<td colspan="1" class="CONTROL"><textarea name="strRecommendation" 
				id="strRecommendation" rows="2" cols="30" 
				onKeyPress='return maxLength(this,"100");'></textarea></td>
				<td colspan="1" class="LABEL" >Remarks
				</td>
				<td colspan="1" class="CONTROL"><textarea name="strRecommendationRemarks" 
				id="strRecommendationRemarks" rows="2" cols="30" 
			...
			<tr>
				...
				<td colspan="1" class="CONTROL"><select
					name="strRecommendedById" id="strRecommendedById">
						<bean:write name="EquipmentAuctionAndCondemnationDeskFB"
							property="strRecommendedByCmb" filter="false" />
				</select></td>
			</tr>
		</table>
