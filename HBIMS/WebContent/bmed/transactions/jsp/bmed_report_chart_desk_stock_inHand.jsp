...
<script language="javascript" src="../../bmed/js/jquery.flot.valuelabels.js"></script>
...
<script language="Javascript" src="../..//bmed/transactions/js/bmed_Dynamic_chart_graph.js"></script>
...
<html:form action="/transactions/DynamicReportChartDeskCNT"
	...
	<input type="hidden" id="Stock" value=${DynamicReportChartDeskFB.strStockInHand}>

	<p align="right" class="font">Report Date &amp; Time :<script type="text/javascript">var d = new Date();document.write(d.getUTCDate() + "/" +  + d.getUTCMonth() + "/" +
	...
	<p class="left">${DynamicReportChartDeskFB.strPageHeading}</p>
		<table  style="height:65px;width:100%;margin-top: -18px;">
			<tr>
