 ...
 * Process Name : Complaint Reminder Reply
 * Date : 30/May/2011
 * Modify By/Date : 
 */ 
 --%>
...
<his:javascript	src="/bmed/transactions/js/bmed_complaintReminderReply_trans.js" />
...
<html:form name="complaintMaintenanceStatusBean" action="/transactions/ComplaintMaintenanceStatusTransACTION"
	...
	<his:TransactionContainer>
		...
		<his:TitleTag name="Complaint Reminder Reply">
		</his:TitleTag>
...
<%-- Internal Reminder Form --%>		
		...
		<his:SubTitleTag name="Internal Reminder Form">
		</his:SubTitleTag>
		
				<table class="TABLE_STYLE">	
				 	 <tr align="center" >
						<td width="25%" class="LABEL_TD">
							Reminder against Complaint</td>
						<td width="25%" class="CONTROL_TD">
							<bean:write name="complaintMaintenanceStatusBean" property="strComplaintId" />							
						</td>
					...
					<tr>
						<td width="25%" class="LABEL_TD">Reminder Details</td>
						<td width="25%" class="CONTROL_TD">
							<bean:write name="complaintMaintenanceStatusBean" property="strReminderDetails" />
						</td>
					...
					<tr>
						<td width="25%" class="LABEL_TD"><font color="red">*</font>Reply</td>
						<td width="25%" class="CONTROL_TD">
							<html:textarea name="complaintMaintenanceStatusBean" property="strReplyRemarks" cols="25" rows="2" onkeypress="return validateDataWithSpecialChars(event,9,'.');"
...
<br /><br />
		...
		<input type="hidden" name="strIsHemDesk" value="${complaintMaintenanceStatusBean.strIsHemDesk}" />
		<input type="hidden" name="strHiddenComplaintId" value="${complaintMaintenanceStatusBean.strHiddenComplaintId}"  />
		<input type="hidden" name="strHiddenComplaintId" value="${complaintMaintenanceStatusBean.strUploadFileId }"  />
