...
<!--  Inspection/Test Classification -->			
			...
			<td width="25%" class="LABEL"><font color="red">*</font>Classification</td>
...
<!--  Inspection/Test Name -->			
			...
			<td width="25%" class="LABEL"><font color="red">*</font>Inspection/Test Name</td>
					<td width="25%" class="CONTROL">${equipmentInspectionTestDtlsFB.strTestId }
					</td>
					<td width="25%" class="LABEL"><font color="red">*</font>Test/Inspected By</td>
					<td  width="25%" class="CONTROL">${equipmentInspectionTestDtlsFB.strItemOrNonItemMode }
					</td>
				</tr>
				
					<tr >
						<td width="25%" class="LABEL"><font color="red">*</font>Test/Inspection Date</td>
						<td width="25%" class="CONTROL">${equipmentInspectionTestDtlsFB.strTestDate }
						</td>					
					
						<td width="25%" class="LABEL"><font color="red">*</font>Test/Inspection Time 
						</td>
	...
	<table class="TABLEWIDTH" align="center" cellpadding="1px" cellspacing="1px">
		<tr class="HEADER">
			<td colspan="4">Equipment Test/Inspection Verify Details</td>
		</tr>
	</table>
			...
			<table class="TABLEWIDTH">
				  <tr>
				<td width="25%" class="LABEL">
				<font color="red">*</font>Verify By
				</td>
				<td  class="CONTROL">
				<div class="CONTROL" id="strVerifyByDivId">
				 		<select name="strVerifiedBy" class='COMBO_NORMAL'>
						<bean:write name="equipmentInspectionTestDtlsFB" property="strVerifiedByOptions" filter="false" />
						</select>
				</div>
				</td>
				
					<td width="25%" class="LABEL"><font color="red">*</font>Verify Date	
					</td>	
				<td width="25%"  class="CONTROL">
				<div class="CONTROL" id="strVerifyDateDivId">
				<dateTag:date name="strVerifyDate" value="${equipmentInspectionTestDtlsFB.strVerifyDate}"></dateTag:date>
				...
				<tr>
					...
					<td width="25%" class="CONTROL">
						<html:textarea name="equipmentInspectionTestDtlsFB" property="strRemarks" cols="25" rows="2"  />
					</td>
	...
	<div class="control_button">
		<table class="TABLEWIDTH" align="center">
			<tr>
				<td align="center">
				<div><a href="#" class="button" onClick="return validateVerify();" onkeypress="if(event.keyCode==13) validateVerify();"><span
					class="save">Save</span></a> <a href="#" class="button"
					onClick="clearPage();" onkeypress="if(event.keyCode==13) clearPage();"><span class="clear">Clear</span></a>
		...
		<tr>
			<td align="center"><img src="../../hisglobal/images/btn-sv.png"
				...
				onClick="return validateVerify();" onkeypress="if(event.keyCode==13) validateVerify();"/><img
				src="../../hisglobal/images/btn-clr.png"
				style="cursor: pointer; cursor: hand;" title="Clear Process"
				onClick="clearPage();" onkeypress="if(event.keyCode==13) clearPage();"/>  <img
