...
{   
          ...
          if(true)
          {
                 	   document.forms[0].hmode.value = "SaveRevenueHeadDtl";
...
<html:form action="/transactions/EquipmentAuctionAndCondemnationDeskCNT"
	...
	<tag:tab tabLabel="Revenue Head Desk" selectedTab="FIRST"
	...
	<tr class="HEADER">
		...
		<tr>
		<td colspan="1" class="LABEL" style="text-align: right;">Auction ID:</td><td colspan="1" class="CONTROL" style="text-align:left;">${EquipmentAuctionAndCondemnationDeskFB.strAuctionId}</td>
		
		<td colspan="1" class="LABEL" style="text-align: right;">Date:</td><td colspan="1" class="CONTROL" style="text-align:left;">${EquipmentAuctionAndCondemnationDeskFB.strAuctionDate}</td>
		</tr>
			<tr>
		<td colspan="1" class="LABEL" style="text-align: right;">Auction Amount:</td><td colspan="1" class="CONTROL" style="text-align:left;">${EquipmentAuctionAndCondemnationDeskFB.strAuctionAmount}</td>
				<td colspan="1" class="LABEL" style="text-align: right;">Instrument Type:</td><td colspan="1" class="CONTROL" style="text-align:left;">${EquipmentAuctionAndCondemnationDeskFB.strInstrumentType}</td>
		
		</tr>
		<tr>
	  <td colspan="1" class="LABEL" style="text-align: right;">AuctionBy:</td><td colspan="1" class="CONTROL" style="text-align: left">${EquipmentAuctionAndCondemnationDeskFB.strAuctionUser}</td>
	  <td colspan="1" class="LABEL" style="text-align: right;">Auction To:</td><td colspan="1" class="CONTROL" style="text-align: left">${EquipmentAuctionAndCondemnationDeskFB.strAuctionTo}</td></tr>
	<tr>
	<td colspan="2" class="LABEL" style="text-align: right;">Auction Remarks :</td><td colspan="2" class="CONTROL" style="text-align: left">${EquipmentAuctionAndCondemnationDeskFB.strAuctionRemarks}</td>
	</tr>
	</table>
	<table  class="TABLEWIDTH" align="center" width="100%">
	<tr class="HEADER">
		<td colspan="4">Revenue Head Details &gt;&gt;</td>
		</tr>
		<tr>
		<td colspan="1" class="LABEL" style="text-align: right;">Head of Account:</td>
		<td colspan="1" class="CONTROL" style="text-align: left;""><input type="text" name="strHeadOfAcount" id="strHeadOfAcount" /></td>
		</tr>
		<tr>
		<td colspan="1" class="LABEL" style="text-align: right;">MajorHead:</td><td colspan="1" class="CONTROL" style="text-align:left;"><select name="strMajorHead" id="strMajorHead">
		<bean:write name="EquipmentAuctionAndCondemnationDeskFB" property="strMajorHeadCmb" filter="false"/>
		</select></td>
		</tr>
		<tr>
		<td colspan="1" class="LABEL" style="text-align: right;">Minor Head:</td><td colspan="1" class="CONTROL" style="text-align:left;"><select name="strMinorHead" id="strMinorHead">
		<bean:write name="EquipmentAuctionAndCondemnationDeskFB" property="strMinorHeadCmb" filter="false"/>

		</select></td>
		</tr>
		<tr>
		<td colspan="1" class="LABEL" style="text-align: right;">Sub Head:</td><td colspan="1" class="CONTROL" style="text-align:left;"><select name="strSubHead" id="strSubHead">
			<bean:write name="EquipmentAuctionAndCondemnationDeskFB" property="strSubHeadCmb" filter="false"/>

		
		</select></td>
		</tr>
		<tr>
		<td colspan="1" class="LABEL" style="text-align: right;">Detail Head:</td><td colspan="1" class="CONTROL" style="text-align:left;"><select name="strDetailHead" id="strDetailHead">
		<bean:write name="EquipmentAuctionAndCondemnationDeskFB" property="strDetailHeadCmb" filter="false"/>
