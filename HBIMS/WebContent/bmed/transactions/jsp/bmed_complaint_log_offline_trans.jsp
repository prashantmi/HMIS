 ...
 * Process Name : Complaint Log Offline
 * Date : 14/Aug/2012
 * Modify By/Date : 
 */ 
 --%>
...
<html:form name="complaintLogOfflineBean" action="/transactions/ComplaintLogOfflineACTION"
	...
	<his:TransactionContainer>	
		...
		<his:TitleTag name="Complaint Log">
			</his:TitleTag>
		</logic:equal>	
		...
		<his:ContentTag>
				<div class="ERR_DIV" id="errMsg"><bean:write	name="complaintLogOfflineBean" property="strErrMsg" /></div>
				<div class="WARNING_DIV" id="warningMsg"><bean:write name="complaintLogOfflineBean" property="strWarningMsg" /></div>
				<div class="NORMAL_DIV" id="normalMsg"><bean:write	name="complaintLogOfflineBean" property="strNormalMsg" /></div>
...
<!--										<option value="0">Select Value</option>-->
		...
		<logic:empty name="complaintLogOfflineBean" property="strWarrantyDetailsTable">
				...
				<his:SubTitleTag name="Repaired By Vendor"><html:checkbox name="complaintLogOfflineBean" property="isRepairedByVendor" onclick="enableVendorDetails();"></html:checkbox>
		</his:SubTitleTag>
		<table class="TABLE_STYLE">
		...
		<tr >
					<td width="25%" class="LABEL_TD">Address</td>
						...
						<input type="text" class="TEXT_FIELD_MAX" maxlength="10" name="strInvoiceNo" onkeypress="return validateData(event,2);">
						</td>
...
<!--  Vendor/Service Engineer Name -->			
			...
			<td width="25%" class="LABEL_TD">Vendor/Service Engineer Name</td>
					...
					<div id="strVendorServiceEngId">
						<select name="strVendorServiceEngName" id="strVendorServiceEngName" class='COMBO_NORMAL' onchange="getAttendName();"  >
								...
								<div id="vendorServiceDivId" style="display:none;">
									<input type="text" name="strVendorServiceEngName" id="strVendorServiceEngName"  class="TEXT_FIELD_MAX"/>
								</div>
					</td>
...
<!-- Communicate Id/Contact No -->	
	...
	<!--	Attend Date & Time	-->
			...
			<tr>
					<td width="25%" class="LABEL_TD">
						<font color="red">*</font>Is Spare Part Maintenance Involved
					</td>
...
<!--	Remarks -->
	...
	<!-- Is  Item In working Condition -->
			...
			<tr>
				...
				<tr>
					<td width="25%" class="LABEL_TD">
						<font color="red">*</font>Is Penality
					</td>
...
<!--  Vendor/Service Engineer Name -->			
			...
			<td width="25%" class="LABEL_TD"><font color="red">*</font>VerifiedBy</td>
					<td width="25%" class="CONTROL_TD">
