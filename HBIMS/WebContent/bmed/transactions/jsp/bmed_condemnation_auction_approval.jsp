...
<script type="text/javascript">
	...
	$(document).ready(function() {
		$("#strApprovalUser").select2();
	});
	
	function validate(){   
	     
        var hisValidator = new HISValidator("stEquipCondemnAndAuctionDeskName");  
         hisValidator.addValidation("strApprovalUser", "dontselect=0", "Please Select a Approved By Employee Name.");
         hisValidator.addValidation("strApprovalDate", "date","Approval Date is a mandatory field.");
         hisValidator.addValidation("strApprovalOrderNo", "req", "Please provide Approval Order No." );
         hisValidator.addValidation("strApprovalOrderDate", "date","Approval Order Date is a mandatory field.");
		...
		<table class="TABLEWIDTH" align="center" border="0" cellpadding="1px"
			...
			<tr>
				...
				<td colspan="1" class="CONTROL"><select class='comboMin'
					id="strApprovalStatus" name="strApprovalStatus">
						<option value="1" title="Yes, Approved">Yes</option>
						<option value="0" title="No, Not Approved">No</option>
				</select></td>
			...
			<tr>
				<td colspan="1" class="LABEL" style="text-align: right;">Approved
					By</td>
				<td colspan="1" class="CONTROL"><select name="strApprovalUser"
					id="strApprovalUser">
						<bean:write name="EquipmentAuctionAndCondemnationDeskFB"
				...
				<td colspan="1" class="CONTROL"><dateTag:date
						name="strApprovalDate"></dateTag:date></td>
			</tr>
			<tr>
				<td colspan="1" class="LABEL">Approval Order No.</td>
				<td colspan="1" class="CONTROL"><input type="text"
					name="strApprovalOrderNo"></td>

				<td colspan="1" class="LABEL">Order Date</td>
				<td colspan="1" class="CONTROL"><dateTag:date
						name="strApprovalOrderDate"></dateTag:date></td>
			</tr>

			<tr>
				<td colspan="2" class="LABEL">Remarks</td>
				<td colspan="2" class="CONTROL"><textarea
						name="strApprovalRemarks" id="strApprovalRemarks" rows="2"
