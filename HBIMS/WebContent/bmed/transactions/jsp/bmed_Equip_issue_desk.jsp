...
<html>
<head>
<title>Equipment Issue Desk</title>
...
{   
	var retVal = true;
          if(retVal)
          {
                 	   document.forms[0].hmode.value = "SAVEISSUE";
	...
	<table class="TABLEWIDTH" align="center" border="0" cellspacing='1px'
		...
		<tr>
			...
			<td colspan="2" class="CONTROL" style="text-align: left;"><input
				type="text" name="strIssueRemark" id="strIssueRemark"></td>
		</tr>
		<tr class="FOOTER">
			<td colspan="4"></td>
		</tr>
