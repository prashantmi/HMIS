...
<script language="Javascript" src="../..//bmed/transactions/js/bmed_Dynamic_upndown_chart_graph.js"></script>
...
<html:form action="/transactions/DynamicReportChartDeskCNT"
	...
	<input type="hidden" id="Up" value=${DynamicReportChartDeskFB.strUpTime}>
	<input type="hidden" id="Down" value=${DynamicReportChartDeskFB.strDownTime}>
	...
	<div style="width:100%;height=30px;">
		...
		<div id="pieDiv" class="demo-container" style="display:none">
			...
			<p id="xAxixLbl" class="font" style="width: 110px;margin-left: 500px;margin-top: -35px;margin-bottom: 35px;">DOWN Graph</p>
			<p id="xAxixLbl1" class="font" style="margin-left: -445px;margin-top: -50px;">UP Graph</p>
			<p class="font">${DynamicReportChartDeskFB.strNote}</p>	
		</div>			
