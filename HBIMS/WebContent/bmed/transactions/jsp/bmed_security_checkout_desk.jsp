...
<html>
<head>
<title>Equipment CheckOut Desk</title>
...
{   
	var retVal = true;
          if(retVal)
          {
                 	   document.forms[0].hmode.value = "SAVECHECKOUT";
