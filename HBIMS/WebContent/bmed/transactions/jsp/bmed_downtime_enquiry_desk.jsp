...
<html>
<head>
<title>Equipment DownTime Enquiry Desk</title>
...
<html:form action="/transactions/CentralEquipEnquiryDeskCNT"
	...
	<tag:tab tabLabel="Equipment DownTime Enquiry Desk" selectedTab="FIRST"
	...
	<table class="TABLEWIDTH" align="center" width="100%">
		...
		<table class="TABLEWIDTH" align="center" width="100%">
		<tr class="HEADER">
	    <td colspan="10">Equipment DownTime Detail &gt;&gt;</td></tr>
	    	<tr>	
	    	
		    <td colspan="1" class="LABEL" style="text-align:center;">BreakDownDate</td>
			<td colspan="1" class="LABEL" style="text-align:center;">BreakDownTime</td>
			<td colspan="1" class="LABEL" style="text-align:center;">InformedBy</td>
			<td colspan="1" class="LABEL" style="text-align:center;">Remarks</td>
			<td colspan="1" class="LABEL" style="text-align:center;">InformationDate</td>
			<td colspan="5" class="LABEL" style="text-align:center;">
				${CentralEquipEnquiryDeskFB.strDownTimeValue}</td>	    			
