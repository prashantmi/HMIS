...
<html>
<head>
<title>Equipment Gate Pass Request Approval Desk</title>
...
{   
            ...
            var hisValidator = new HISValidator("stEquipgatepassrequestDeskName");
             ...
             hisValidator.addValidation("strApprovalDate","date","Please Enter Request Date");
              hisValidator.addValidation("strRequestApprovalOrderNo","req","Please Enter Request Time");
	         
	          hisValidator.addValidation("strApprovalOrderDate","req","Please Enter Request for");
	       
              hisValidator.addValidation("strGatePassApprover","dontselect=0","Please Select requester Name");
...
<html:form action="/transactions/EquipInwardOutwardGatePassCNT"
	...
	<table class="TABLEWIDTH" align="center" border="0" cellspacing='1px'
		...
		<tr class="HEADER">
			<td colspan="4">Equipment Gate Pass Verification Details
			&gt;&gt;</td>
		</tr>
		<tr>
			<td colspan="1" class="LABEL" style="text-align: right;">Verified</td>
			<td class="CONTROL">${EquipInwardOutwardGatePassFB.strRequestVerifyStatus}</td>
			<td colspan="1" class="LABEL" style="text-align: right;">Date of
			verification</td>
			<td colspan="1" class="CONTROL" style="text-align: left;">${EquipInwardOutwardGatePassFB.strVeificationDate}</td>
		</tr>
		<tr>
			<td colspan="1" class="LABEL" style="text-align: right;">Remark
			If Any</td>
			<td colspan="1" class="CONTROL" style="text-align: left;">${EquipInwardOutwardGatePassFB.strVerificationRemark}</td>
			<td colspan="1" class="LABEL" style="text-align: right;">verified
			By:</td>
			<td colspan="1" class="CONTROL">
			<div id="SupplierDiv" align="left">${EquipInwardOutwardGatePassFB.strGatePassVerifier}
			</div>
			</td>
		</tr>
		<tr class="HEADER">
			<td colspan="4">Equipment Gate Pass Approval &gt;&gt;</td>
		</tr>
		<tr>
			<td colspan="1" class="LABEL" style="text-align: right;">Approved</td>
			<td class="CONTROL"><input type="radio"
				name="strRequestApprovalStatus" value="1" checked>Yes <input
			...
			<td colspan="1" class="CONTROL" style="text-align: left;"><dateTag:date
				name="strApprovalDate" id="strApprovalDate" /></td>
		</tr>
		<tr>
			<td colspan="1" class="LABEL" style="text-align: right;"><font
				color="red">*</font>Order No</td>
			<td class="CONTROL"><input type="text"
				name="strRequestApprovalOrderNo" id="strRequestApprovalOrderNo"></td>
			<td colspan="1" class="LABEL" style="text-align: right;"
				onkeypress="return validateData(event,21);"><font color="red">*</font>Date
			of Order</td>
			<td colspan="1" class="CONTROL" style="text-align: left;"><dateTag:date
				name="strApprovalOrderDate" id="strApprovalOrderDate" /></td>
		</tr>
		<tr>
			<td colspan="2" class="LABEL" style="text-align: right;">Remark
			(If Any)</td>
			<td colspan="2" class="CONTROL" style="text-align: left;"><input
				type="text" name="strApprovalRemark" id="strApprovalRemark"></td>
		</tr>
		<tr>
			<td colspan="2" class="LABEL" style="text-align: right;"><font
				color="red">*</font>Approved By:</td>
			<td colspan="1" class="CONTROL">
			<div id="SupplierDiv" align="left"><select
				name="strGatePassApprover" id="strGatePassApprover" />
				<bean:write name="EquipInwardOutwardGatePassFB"
					property="strGatePassApprovercmb" filter="false" />
			</select></div>
			</td>
		</tr>
	</table>
