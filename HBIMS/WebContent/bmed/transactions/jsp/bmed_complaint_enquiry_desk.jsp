...
<html>
<head>
<title>Equipment Complaint Enquiry Desk</title>
...
<html:form action="/transactions/CentralEquipEnquiryDeskCNT"
	...
	<tag:tab tabLabel="Equipment Complaint Enquiry Desk" selectedTab="FIRST"
	...
	<table class="TABLEWIDTH" align="center" width="100%">
		...
		<table class="TABLEWIDTH" align="center" width="100%">
		<tr class="HEADER">
	    <td colspan="10">Equipment Complaint Detail &gt;&gt;</td></tr>
	    	<tr>	
	 	    <td colspan="1" class="LABEL" style="text-align:center;">Complaint ID</td>
	 	    <td colspan="1" class="LABEL" style="text-align:center;">Complaint Type</td>
			<td colspan="1" class="LABEL" style="text-align:center;">Raising Date</td>
			<td colspan="1" class="LABEL" style="text-align:center;">Description</td>
			<td colspan="1" class="LABEL" style="text-align:center;">Closed Date</td>
			<td colspan="1" class="LABEL" style="text-align:center;">Raised By</td>
			<td colspan="1" class="LABEL" style="text-align:center;">Status</td>
			<td colspan="7" class="LABEL" style="display:none;text-align:left;">
					${CentralEquipEnquiryDeskFB.strComplaintValue}</td>	    			
