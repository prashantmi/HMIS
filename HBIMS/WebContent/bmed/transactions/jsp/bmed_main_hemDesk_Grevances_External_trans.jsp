...
<html:form name="hemDeskFB"
	...
	<his:TransactionContainer>
		<his:TitleTag name="Complaint Grievances(External)">
		</his:TitleTag>

		<his:SubTitleTag name="External Grievances">
		</his:SubTitleTag>
		...
		<his:ContentTag name="Escalation Form (External)">
			<table class="TABLE_STYLE">
			     <tr>
			<td width="25%" class="LABEL_TD">Request Id</td>
			<td width="25%" class="CONTROL_TD"></td>

			<td width="25%" class="LABEL_TD"><font color="red">*</font>Communication Id</td>
					<td width="25%" class="CONTROL_TD">
					<select name="strCommunicationId" class='COMBO_NORMAL'>
		...
		<tr>
					...
					<td width="25%" class="CONTROL_TD"><div id='vendorNameDiv'></div></td>
				...
				<tr>
					<td width="25%" colspan='1' class="LABEL_TD">Address</td>
					<td width="25%" colspan='3' class="CONTROL_TD">
				...
				<tr>
		           ...
		           <td width ="25%" class ="CONTROL_TD">
		               ...
		               <select name="strModeofEscId" class="COMBO_NORMAL">
		...
		<his:ButtonToolBarTag>
			<img style="cursor: pointer;" src="/AHIMS/hisglobal/images/btn-sv.png"	onClick="return validate1();" />
			<img style="cursor: pointer;" src="/AHIMS/hisglobal/images/btn-clr.png" onClick="clearPage();">
			<img style="cursor: pointer;" src="/AHIMS/hisglobal/images/btn-ccl.png" onClick="cancelPage();">
		</his:ButtonToolBarTag>
		...
		<input type="hidden" name="hmode" />
			...
			<input type="hidden" name="strEscDtl" id="strEscDtl" value="${hemDeskFB.strChk}">
