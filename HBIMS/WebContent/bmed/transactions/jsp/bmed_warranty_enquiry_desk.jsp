...
<html>
<head>
<title>Equipment Warranty Enquiry Desk</title>
...
<html:form action="/transactions/CentralEquipEnquiryDeskCNT"
	...
	<tag:tab tabLabel="Equipment Guaranty Enquiry Desk" selectedTab="FIRST"
	...
	<table class="TABLEWIDTH" align="center" width="100%">
		...
		<table class="TABLEWIDTH" align="center" width="100%">
		<tr class="HEADER">
	    <td colspan="10">Equipment Guaranty Detail &gt;&gt;</td></tr>
	     <tr>	
			<td colspan="1" class="LABEL" style="text-align:center;">Manufacturer Name</td>
			<td colspan="1" class="LABEL" style="text-align:center;">Guaranty Start</td>
			<td colspan="1" class="LABEL" style="text-align:center;">Guaranty Expire</td>
