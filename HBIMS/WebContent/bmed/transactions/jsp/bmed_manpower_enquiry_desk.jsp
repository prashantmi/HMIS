...
<html>
<head>
<title>Equipment Manpower Enquiry Desk</title>
...
<html:form action="/transactions/CentralEquipEnquiryDeskCNT"
	...
	<tag:tab tabLabel="Equipment Manpower Enquiry Desk" selectedTab="FIRST"
	...
	<table class="TABLEWIDTH" align="center" width="100%">
		...
		<table class="TABLEWIDTH" align="center" width="100%">
		<tr class="HEADER">
	    <td colspan="10">Equipment Manpower Detail &gt;&gt;</td></tr>
	    	<tr>	
	    	
		    <td colspan="1" class="LABEL" style="text-align:center;">Employee Name</td>
			<td colspan="1" class="LABEL" style="text-align:center;">User ID</td>
			<td colspan="1" class="LABEL" style="text-align:center;">Designation</td>
			<td colspan="1" class="LABEL" style="text-align:center;">Department</td>
			<td colspan="4" class="LABEL" style="display:none;text-align:center;">
				${CentralEquipEnquiryDeskFB.strManpowerValue}</td>	    			
