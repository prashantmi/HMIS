...
<html>
<head>
<title>Equipment CheckIn Desk</title>
...
{   
	var retVal = true;
          if(retVal)
          {
                 	   document.forms[0].hmode.value = "SAVECHECKIN";
...
<html:form action="/transactions/SecurityDeskCNT"
	...
	<table class="TABLEWIDTH" align="center" width="100%" id="table1">
		<tr>
			...
			Pass ID</td>
			<td colspan="1" class="CONTROL">${SecurityDeskFB.strGatePAssId}</td>
			<td colspan="1" class="LABEL" style="text-align: right;">Complaint
			Id</td>
			<td colspan="1" class="CONTROL" style="text-align: left;">${SecurityDeskFB.strComplaintId}</td>
		</tr>
		<tr>
	...
	<table class="TABLEWIDTH" align="center" width="100%">
		<tr class="HEADER">
			<td colspan="4"><img
				...
				style="cursor: pointer;" />Acknowledge Details &gt;&gt;</td>
		</tr>
	</table>

	<table class="TABLEWIDTH" align="center" width="100%" id="table4">
		<tr>
			<td colspan="1" class="LABEL" style="text-align: right;">Acknowledge
			Gate Pass No:</td>
			<td colspan="1" class="CONTROL" style="text-align: left;">${SecurityDeskFB.strGatePassNo}</td>
			<td colspan="1" class="LABEL" style="text-align: right;">Acknowledged
			By</td>
			<td colspan="1" class="CONTROL" style="text-align: left;">${SecurityDeskFB.strCheckOutBy}</td>
		</tr>
		<tr>
			<td colspan="1" class="LABEL" style="text-align: right;">Date of
			Acknowldge CheckOut:</td>
			<td colspan="1" class="CONTROL" style="text-align: left;">${SecurityDeskFB.strDateOfCheckOut}</td>
			<td colspan="1" class="LABEL" style="text-align: right;">Remark
			(If Any)</td>
			<td colspan="1" class="CONTROL" style="text-align: left;">${SecurityDeskFB.strAckCheckOutRemark}</td>
		</tr>
	</table>

	<table class="TABLEWIDTH" align="center" width="100%">
		<tr class="HEADER">
			<td colspan="4">Checkout Details &gt;&gt;</td>
		<tr>
			<td colspan="1" class="LABEL" style="text-align: right;">Checkout
			By</td>
			<td colspan="1" class="CONTROL" style="text-align: left;">${SecurityDeskFB.strCheckOutByUser}</td>
			<td colspan="1" class="LABEL" style="text-align: right;">Date of
			CheckOut:</td>
			<td colspan="1" class="CONTROL" style="text-align: left;">${SecurityDeskFB.strCheckOutDate}</td>
		</tr>
		<tr>
			<td colspan="1" class="LABEL" style="text-align: right;">Remarks(If
			Any)</td>
			<td colspan="1" class="CONTROL" style="text-align: left;">${SecurityDeskFB.strRemarkCheckOut}</td>
		</tr>
	</table>

	<table class="TABLEWIDTH" align="center" width="100%">
		<tr class="HEADER">
			<td colspan="4">CheckIn &gt;&gt;</td>
		<tr>
			<td colspan="1" class="LABEL" style="text-align: right;">CheckIn
			By</td>
			<td colspan="1" class="CONTROL" style="text-align: left;">${SecurityDeskFB.strCheckInByUser}</td>
			<td colspan="1" class="LABEL" style="text-align: right;">Date of
			CheckIn:</td>
			<td colspan="1" class="CONTROL" style="text-align: left;"><dateTag:date
				name="strCheckInDate" id="strCheckInDate" /></td>
		</tr>
		<tr>
			<td colspan="1" class="LABEL" style="text-align: right;">Remarks(If
			Any)</td>
			<td colspan="1" class="CONTROL" style="text-align: left;"><input
				type="text" name="strRemarkCheckIn" id="strRemarkCheckIn"></td>
		</tr>
		<tr class="FOOTER">
			<td colspan="4"></td>
		</tr>
