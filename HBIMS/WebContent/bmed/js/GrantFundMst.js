...
{   
      ...
      var hisValidator = new HISValidator("GrantFundMstFormBean");
 

	          hisValidator.addValidation("strGrantCode","req", "Grant code is a Mandatory Field" );
   		      hisValidator.addValidation("strGrantName", "req","Grant Name is a mandatory field");
       		  hisValidator.addValidation("strBankName", "req", "Bank Name is manadatory");
			   		      hisValidator.addValidation("strEffectiveFrom", "date","Effective From is a mandatory field");
			
			         hisValidator.addValidation("strBranchName","req", "Branch Name is a Mandatory Field" );
   		      hisValidator.addValidation("strAccountNum", "req","A/C number is a Mandatory Field");
       		  hisValidator.addValidation("strRemarks", "maxlen=100", "Remarks should have less than or equal to 100 Characters");
