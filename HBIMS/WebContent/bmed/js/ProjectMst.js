...
{   
             ...
             var hisValidator = new HISValidator("ProjectMstFormBean");
             
             
	          hisValidator.addValidation("strProjectCode","req", "Scheme Code is a Mandatory Field" );
   		      hisValidator.addValidation("strProjectName", "req","Scheme Name is a mandatory field");
