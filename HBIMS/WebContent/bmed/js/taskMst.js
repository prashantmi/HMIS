...
{   
             ...
             var hisValidator = new HISValidator("taskBean");
	          ...
	          hisValidator.addValidation("strTaskName","req", "Task Name is a Mandatory Field" );
...
function getEnggItemSubTypeCmb()
{
        ...
        var url ="TaskMstCNT.cnt?hmode="+mode+"&enggItemType="+document.forms[0].strEngineeringItemTypeId.value;
 		ajaxFunction(url,"1");		
