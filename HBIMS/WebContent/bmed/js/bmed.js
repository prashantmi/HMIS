...
function modifySupplierMst() {
	if (document.forms[0].combo[0].value == "0") {
		alert("Please Select Equipment Category Name");
		document.forms[0].combo[0].focus();
	} else {
...
function supplierView() {
	...
	var myPopup = window.open("SupplierMstCNT.cnt?hmode=" + mode + "&chk="+ chk, 'popupWindow', heg_width);// +"&cnt_page="+cnt_page+"&masterName="+document.forms[0].masterName.value,'popupWindow',heg_width,
...
function drugView() {
	...
	var myPopup = window.open("DrugMstCNT.cnt?hmode=" + mode + "&chk=" + chk
