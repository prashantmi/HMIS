...
{	   
   var url="HemDeskACTION.cnt?hmode=GROUPNAME&enggItemTypeId="+document.forms[0].strEnggItemTypeId.value+"&enggItemSubTypeId="+document.forms[0].strEnggItemSubTypeId.value;
   ajaxFunction(url,"5");
}
function getEquipNameCmb()
{	   
   var url="HemDeskACTION.cnt?hmode=GETEQUIPNAME&groupId="+document.forms[0].strGroupName.value+"&storeId="+document.forms[0].strWorkshopName.value;
   ajaxFunction(url,"6");
}
function getSparePartCmb()
{	   
   var url="HemDeskACTION.cnt?hmode=GETSPAREPARTNAME&cmbValues="+document.forms[0].strEquipName.value;
   ajaxFunction(url,"7");
}
function getSparePartSrlNoCmb()
{	   
   var url="HemDeskACTION.cnt?hmode=GETSPAREPARTSRLNO&equipId="+document.forms[0].strEquipName.value+"&groupId="+document.forms[0].strGroupName.value
