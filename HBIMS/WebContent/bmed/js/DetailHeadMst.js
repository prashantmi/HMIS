...
{   
             ...
             var hisValidator = new HISValidator("DetailHeadMstFormBean");
             
             
	          hisValidator.addValidation("strDetailHeadCode","req", "Scheme Code is a Mandatory Field" );
   		      hisValidator.addValidation("strDetailHeadName", "req","Scheme Name is a mandatory field");
...
function getEnggItemDetailTypeCmb()
{
        var mode = "ENGGITEMDetailTYPECMB";
...
function getAjaxResponse(res,mode)
{
   ...
   { 
		...
		if(res=="")
		{
			document.getElementById("enggItemDetailTypeCmbDivId").innerHTML="<select name ='strItemCat' class='comboNormal' ><option value='0'>Data N/A</option></select>";
		}
		else
		{
			var objVal= document.getElementById("enggItemDetailTypeCmbDivId");
			objVal.innerHTML = "<select name ='strEngineeringItemDetailTypeId' class='comboNormal' >"+res+"</select>";		
		}
	}	
}
