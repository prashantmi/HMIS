...
{   
             ...
             var hisValidator = new HISValidator("SubHeadMstFormBean");
             
             
	          hisValidator.addValidation("strSubHeadCode","req", "Scheme Code is a Mandatory Field" );
   		      hisValidator.addValidation("strSubHeadName", "req","Scheme Name is a mandatory field");
