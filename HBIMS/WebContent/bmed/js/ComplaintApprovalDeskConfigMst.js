...
function getLabCmb()
{
        ...
        var url ="ComplaintApprovalDeskConfigMstCNT.cnt?hmode="+mode+"&parentcombo="+document.forms[0].strHospital.value;
 		ajaxFunction(url,"1");		
...
function getEmpcmb()
{
        ...
        var url ="ComplaintApprovalDeskConfigMstCNT.cnt?hmode="+mode+"&parentcombo="+document.forms[0].strUserID.value;
 		ajaxFunction(url,"2");		
