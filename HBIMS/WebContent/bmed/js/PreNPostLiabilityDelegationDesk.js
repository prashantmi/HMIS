...
function getLabCmb()
{
        ...
        var url ="PreNPostLiabilityDelegationDeskCNT.cnt?hmode="+mode+"&parentcombo="+document.forms[0].strHospital.value;
 		ajaxFunction(url,"1");		
...
function getEmpcmb()
{
        ...
        var url ="PreNPostLiabilityDelegationDeskCNT.cnt?hmode="+mode+"&parentcombo="+document.forms[0].strUserID.value;
 		ajaxFunction(url,"2");		
