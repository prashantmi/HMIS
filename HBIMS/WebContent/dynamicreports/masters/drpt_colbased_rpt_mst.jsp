...
<script language="Javascript" src="../../dynamicreports/js/drpt_colbased_rptMst.js"></script>
...
<body onload="createMultiRow();" class="background">
	<html:form action="/masters/DynamicReportParamMstCNT"
		...
		<table class="TABLEWIDTH" align="center">
			<tr class="HEADER">
				<td colspan="4">Dynamic Reports Template &gt;&gt; Column Based
					Report</td>
			</tr>
		...
		<table border="0" class="TABLEWIDTH" align="center">
			<tr>
				...
				<td align="center"><img style="cursor: pointer;"
					...
					onkeypress="return validateInsert();" />  <img
					style="cursor: pointer;" src="../../hisglobal/images/btn-ccl.png"
					onkeypress="cancel('INIT');" onClick="cancel('INIT');"></td>
			</tr>
		</table>
