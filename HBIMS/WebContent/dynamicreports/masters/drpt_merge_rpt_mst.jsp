...
<script language="Javascript" src="../../dynamicreports/js/drpt_merge_rptMst.js"></script>


<style type="text/css">


/* to center align control field. It contains font type, font color, font size and background color */
.multiControl1 {
...
<body onload="createMultiRow();" class="background">
	<html:form action="/masters/DynamicReportParamMstCNT"
		...
		<table class="TABLEWIDTH" align="center">
			<tr class="HEADER">
				<td colspan="4">Dynamic Reports Template &gt;&gt; Merge
					Report</td>
			</tr>
...
<logic:equal property="strIsColumnBaseRpt" name="rptparamBean" value="1">

<table border="0" class="TABLEWIDTH" align="center" border='0'
			cellspacing='1px' cellpadding='1px'>
			
				<tr>
				<td class="TITLE" width="100%">Report Display Columns</td>
				</tr>
</table>


<table border="0" class="TABLEWIDTH" align="center" border='0'
			cellspacing='1px' cellpadding='1px' id="multirow1" >			
<tr> 
<td class="multiLabel" width="25%"><font color="red">*</font>Display Column Name </td> 
<td class="multiLabel" width="20%">Prefix</td> 
<td class="multiLabel" width="25%"><font color="red">*</font>Formula</td> 
<td class="multiLabel" width="20%">Suffix</td>
<td class="multiLabel" width="5%">Align</td>
<td class="multiLabel" width="5%">

<img style="cursor: pointer;" src="../../hisglobal/images/plus.gif"
					onkeypress="createMultiRow();" onClick="createMultiRow();">
</td>
</tr> 
</table>
...
<logic:equal value="0" property="strIsMergeIntermediate"  name="rptparamBean">
...
<logic:equal value="1" property="strReportHeaderParamReq"  name="rptparamBean">
	...
	<tr>
		...
		<html:hidden property="strIsColumnBaseRpt" name="rptparamBean" />
