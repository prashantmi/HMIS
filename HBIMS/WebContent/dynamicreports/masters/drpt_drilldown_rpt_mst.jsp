<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>ng="UTF-8"%>
...
<script language="Javascript"
	src="../../dynamicreports/js/drpt_drilldown_rptMst.js"></script>
...
<body onload="checkIsValidDrillDown();" class="background">
	<html:form action="/masters/DynamicReportParamMstCNT"
		name="rptparamBean"
		type="dynamicreports.masters.controller.fb.DynamicReportParamMstFB"
		styleClass="formbg">
		...
		<table class="TABLEWIDTH" align="center">
			<tr class="HEADER">
				<td colspan="4">Dynamic Reports Template &gt;&gt; Drill Down
					Report</td>
			</tr>
		...
		<table border="0" class="TABLEWIDTH" align="center" border='0'
			...
			<tr>
				<td class="LABEL" width="25%">Report Display Name</td>
				<td class="CONTROL" width="25%"><bean:write name="rptparamBean"
						property="strReportLevelDisplayName" /></td>

				<td class="LABEL" width="25%">Is Last</td>
				<td class="CONTROL" width="25%"><logic:equal value="1"
						name="rptparamBean" property="strIsLast">Yes</logic:equal> <logic:equal
						value="0" name="rptparamBean" property="strIsLast">No</logic:equal>
				</td>
		...
		<logic:equal value="0" property="strIsMergeIntermediate"
			name="rptparamBean">

			<logic:equal value="1" property="strReportHeaderParamReq"
				name="rptparamBean">

				<table border="0" class="TABLEWIDTH" align="center" border='0'
					cellspacing='1px' cellpadding='1px'>
					<tr>
						<td class="LABEL" width="50%"><font color="red">*</font>Header
							Parameter Mapping</td>
						<td class="CONTROL" width="50%"><select
							name="strReportHeaderParamId" class="comboNormal">
								<bean:write name="rptparamBean" property="strInParamValues"
									filter="false" />
						</select></td>
		...
		<logic:equal value="1" property="strIsMergeIntermediate"
			name="rptparamBean">
			<logic:equal value="1" property="strReportHeaderParamReq"
				name="rptparamBean">
				...
				<table border="0" class="TABLEWIDTH" align="center" border='0'
					cellspacing='1px' cellpadding='1px'>
					<tr>
						<td class="LABEL" width="25%"><font color="red">*</font>Header
							Parameter Type</td>
						<td class="CONTROL" width="25%"><select
							name="strReportHeaderParamType" class="comboNormal"
							onchange="getHeaderParamDtls(this);">
						...
						<td class="CONTROL" width="25%">
							<div id='strReportHeaderParamDivId'>
								<select name="strReportHeaderParamId" class="comboNormal">
									<option value='0'>Select Value</option>
								</select>
							</div>

							<div id="strInparamValuesContentDivId" style="display: none;">
								<bean:write name="rptparamBean" property="strInParamValues"
									filter="false" />
							</div>

							<div id="strOutparamValuesContentDivId" style="display: none;">
								<bean:write name="rptparamBean" property="strOutParamValues"
									filter="false" />
							</div>
				...
				<td align="center">
					...
					<div class="control_button" align="left">
						...
						<a href="#" class="button" tabindex="1"
							onkeypress="cancel('INIT');" onClick="cancel('INIT');"><span
		...
		<html:hidden property="strIsLast" name="rptparamBean" />
		<html:hidden property="strReportLevelDisplayName" name="rptparamBean" />
		...
		<html:hidden property="strIsMergeIntermediate" name="rptparamBean" />
