...
function getAdvisedBy()
{
	...
	var url="PatientTransferTransCNT.cnt?hmode="+mode+"&curDept="+document.forms[0].strCurrentDeptUnitRoom.value+"&cons="+document.forms[0].strConsultant.value;;
...
<html:form action="/transactions/PatientTransferTransCNT.cnt" method="post">
	...
	<table class="TABLEWIDTH" border="0" align="center" border='0'
		...
		<tr>
			...
			<td width="75%" class="CONTROL">
			<div id="idDisBy"><select tabindex='1' style='cursor: pointer; cursor: hand' title="List of Doctors" name="strRmk" id="strRmk">
