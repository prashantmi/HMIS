...
<head>
<meta charset=utf-8>
<title>Patient Join Success Page IPD</title>
...
<body>
<html:form action="/transactions/PatientLeaveJoinRecordTransCNT" method="post">
	<div class="normalMsg" id="normalMsg" align="center"><bean:write name="patientLeaveJoinRecordTransBean" property="strNormalMsgString" /></div>
</html:form>
</body>
</html>