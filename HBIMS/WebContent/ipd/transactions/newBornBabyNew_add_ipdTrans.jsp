...
<body onload="viewN();checkBedIsSharable();removeSpace();openPrintPopUp();checkMsg();" onUnload="closePopUp();">
...
<fieldset>
  ...
  <div class="legend2" id='nonPrintableLegend2'>
	...
	<button  id="printbutton" type="button" class="btn btn-outline-primary mt-1 btn-circle printbtn" data-toggle="modal" data-target="#printModal" onclick="modalSlipPrint()" style="display: none;">
		<i class="fa fa-print iround"  title="Print Last Admission Slip"></i>
	</button>
	<button  id="savebutton" type="button" class="btn btn-outline-success mt-1 btn-circle savebtn"  onClick="matchWardRoomCriteria();" style="display: none;" >
  ...
  <div class="container-fluid">
			    ...
			    <div class="alert alert-danger alert-dismissible fade show" id="errID" style="display: none;"><bean:write name="newBornTransBean" property="strMsgString" /></div>
				<div class="alert alert-success alert-dismissible fade show" id="normalMsg" style="display: none;"><bean:write name="newBornTransBean" property="strMsg" filter="false" /></div>
				<div class="alert alert-warning alert-dismissible fade show" id="wrnID" style="display: none;"><bean:write name="newBornTransBean" property="strWarningMsg" /></div>
			   ...
			   <div id="id4">                       
					<pDtl:patDtlNew crNo="${newBornTransBean.strCrNo}" address="false"></pDtl:patDtlNew>
					<aDtl:addDtlNew crNo="${newBornTransBean.strCrNo}"></aDtl:addDtlNew>
				</div>
			<div class="viewport" id="viewportDiv">
			   ...
			   <p id="newBabyLink">									           
				   <span class="spanlinkLeft">
				        <a id="motherDelDetUpdate" class="link" onclick="openUpdateMotherDelDet();" href="#"><b>Mother Delivery Details Update</b></a>
				   </span>
				 ...
				 <div id='goBox'>
						...
						<div class="row rowFlex reFlex" >
							...
							<div class="col-sm-2">
								...
								<a href="#" class="btn btn-sm btn-success" onclick="return goFuncNB1();"   style="font-size: 1rem;">
				...
				<div class='row rowFlex reFlex' id="TotalID" >
					...
					<div id="chargesDtlId" class="row rowheight">
<!-- 		<div class="col-sm-10 col-md-10"><p class="subHeaders">Admission Charges Details</p></div>
 -->	</div>
	...
	<div id="registrationId" style="display: none">
			<input type="text" name="strNewBornRegistrationChargeVal"
				value="${newBornTransBean.strNewBornRegistrationChargeVal}" class="form-control">
	</div>
	<div id="TotalID" style="display: none">
			<input type="text" name="strTotalChargeVal" class="form-control"></td>
	</div>	
	<hr>
	<div class="row rowFlex reFlex">
							<div class="col-sm-10">
