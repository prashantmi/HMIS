...
<script type="text/javascript">
	function searchBed()
	{
		...
		var hisValidator = new HISValidator("patientAdmissionModiTransBean_desk");
	...
	{
		var hmode = "GETWARD"; 
		var url = "PatientAdmissionModificationDeskTransCNT.cnt?hmode="+hmode+"&wardTypeCode="+document.forms[0].strwardType.value;
		ajaxFunction(url,"2");
	}
	function getWard()
	{
		var hmode = "GETWARD"; 
		var url = "PatientAdmissionModificationDeskTransCNT.cnt?hmode="+hmode+"&wardTypeCode="+document.forms[0].strwardType.value+"&deptCode="+document.forms[0].strDeptCode.value;
		ajaxFunction(url,"2");
	}
	function getRoomNo()
	{
		var hmode = "GETROOM"; 
		var url = "PatientAdmissionModificationDeskTransCNT.cnt?hmode="+hmode+"&roomTypeCode="+document.forms[0].strRoomType.value+"&wardCode="+
...
<body >
<html:form action="/transactions/PatientAdmissionModificationDeskTransCNT.cnt"	name="patientAdmissionModiTransBean_desk"	type="ipd.transactions.PatientAdmissionModificationDeskTransFB" method="post" onsubmit="">
...
<table class="TABLEWIDTH" align="center" border="0" cellspacing="1px">
  <tr class="HEADER"> 
   ...
   <tr> 
    ...
    <td colspan="2" class="CONTROL">
    	<div align="left">
    		<b>
    			<bean:write property="strDepartmentName" name="patientAdmissionModiTransBean_desk"/>
    		</b>
    	</div>
    </td>   
 </tr>
 <tr>
  ...
  <select name="strwardType" onChange="getWard();" class="comboNormal">
  	<bean:write name="patientAdmissionModiTransBean_desk" property="strwardType" filter="false"/>
  </select></td>
  <td width="25%" class="LABEL"><font color="red">*</font>Ward</td>
    <td width="25%" class="multiControl">
    	<div id="wardId">
    	<select name="strWard" onChange="" class="comboNormal">
    		<bean:write name="patientAdmissionModiTransBean_desk" property="strWard" filter="false"/>
    	</select>
    	</div> 
    </td>
 </tr>
  <tr> 
    ...
    <td width="25%" class="multiControl"><select name="strRoomType" onChange="getRoomNo();" class="comboNormal">
   		 <bean:write name="patientAdmissionModiTransBean_desk" property="strRoomType" filter="false"/>
    </select> </td>   
    <td width="25%" class="LABEL"><font color="red">*</font>Room</td>
    <td width="25%" class="multiControl">
    	<div id="roomId">
    	<select name="strRoom" onChange="" class="comboNormal">
    		 <bean:write name="patientAdmissionModiTransBean_desk" property="strRoom" filter="false"/>
    	</select>
    	</div>
    </td>   
  </tr>
  <tr> 
    ...
    <td colspan="2" class="multiControl"><select name="strBedType" onChange="return getBedStatus();" class="comboNormal">
    	 <bean:write name="patientAdmissionModiTransBean_desk" property="strBedType" filter="false"/>
    </select></td>
   </tr>
