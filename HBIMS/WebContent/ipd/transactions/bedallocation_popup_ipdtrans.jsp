...
<head>
<meta charset=utf-8>
<title>Bed Status Offline Advice</title>
...
function bedStatusCheck_test()
{
			...
			if(document.forms[0].roomType.value=="0")
				window.opener.document.getElementById("roomBedId").innerHTML="/"+document.forms[0].bedType[document.forms[0].bedType.selectedIndex].text;
			else
...
<table align="center" border="0">
 ...
 <tr>
  ...
  <td width="25%" class="multiControl"><select name="wardType" onChange="setWard();" class="comboNormal" tabindex="1"><bean:write name="advanceAdviceTransBean" property="strWardTypeValue" filter="false"/> </select></td>
...
<table  width="100%" align="center" border="0" >	
	...
	<!--  <tr>
		<td align="right" colspan="2">
			<img src="/HBIMS/hisglobal/images/btn-ok.png" onClick="return bedStatusCheck_test();" style="cursor: pointer;" onkeypress="onPressingEnter(this,event)"/>
		</td>
		<td align="left" colspan="2">
			<img src="/HBIMS/hisglobal/images/btn-ccl.png" onClick="window.close();" style="cursor: pointer;" onkeypress="onPressingEnter(this,event)"/>
		</td>
	</tr>
	-->
</table>
