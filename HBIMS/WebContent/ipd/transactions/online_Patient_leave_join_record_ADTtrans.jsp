...
<title>Patient Leave/Join Record</title>
...
<script language="Javascript" src="../../ipd/js/PatientLeaveJoinRecordTrans.js"></script>
...
<body onLoad="CNTIni(),butdis(),document.forms[0].strCrNo.focus(),hlpOnLoad_LJ(),leave_join();" onUnload="closePopUp();">
<html:form action="/transactions/PatientLeaveJoinRecordTransCNT.cnt" method="post">
	<div id="menu1"></div>
	<div class="errMsg" id="errMsg"><bean:write name="patientLeaveJoinRecordTransBean" property="strErrMsgString"/></div>
	<div class="normalMsg" id="normalMsg"><bean:write name="patientLeaveJoinRecordTransBean" property="strNormalMsgString"/></div>
	...
	<table class="TABLEWIDTH" align="center" border='0' cellspacing='0px'>
	  <tr class="HEADER">
		<td width="80%">Patient Leave/Join Record Entry&gt;&gt;</td>
		<td width="10%" align='center'><input type="radio" name="strIs_Leave_Join" onClick="leaveJoin();" checked>Leave</td>
		<td width="10%" align='center'><input type="radio" name="strIs_Leave_Join" onClick="leaveJoin();">Join</td>
	  </tr>
	 </table> 
	...
	<table class="TABLEWIDTH" align="center" border='0' cellspacing='1px'>
		<tr>    
			...
			<td width="75%" class="CONTROL"><crNo:crNo value="${patientLeaveJoinRecordTransBean.strCrNo}"
				js="onkeypress='return validateData(event,5);' onkeyup='enterLeaveJoin(event,'patientLeaveJoinRecordTransBean');'"></crNo:crNo>
				<!-- search field utility -->
				   <img style="cursor:pointer;cursor:hand;" src="../../hisglobal/images/viewDetails.gif" title="Click here for Patient Search" align="middle" name='searchPatient' onclick="callSearchWindow();"/>
			    <!-- search field utility ends -->
			<img src="../../hisglobal/images/Go.png"  onclick="return goFunc_recordEntry('patientLeaveJoinRecordTransBean');">
			</td>
		</tr>
	</table>
	</div>
...
<div id="LeaveId" style="display:none;">
       <table align="center" border="0" cellspacing="1" class="TABLEWIDTH">
        <tr>
            ...
            <tr>
             ...
             <td class="CONTROL" colspan="" width="25%"><font size="2" color="blue"><bean:write name="patientLeaveJoinRecordTransBean" property="strEntryDate"/></font></td>
             <td class="LABEL" width="25%"><div align="right">Leave Sanctioned from Date</div></td>
             <td class="CONTROL" colspan="" width="25%"><bean:write name="patientLeaveJoinRecordTransBean" property="strValidFrom"/></td>
            </tr>
            <tr>
               <td class="LABEL" width="25%"><div align="right"><font size="2" color="red">*</font>Leave Sanctioned till Date</div></td>
               <td colspan="" class="CONTROL" width="25%"><bean:write name="patientLeaveJoinRecordTransBean" property="strValidTo"/></td>
               <td class="LABEL" width="25%"><div align="right">Whether Bed has to be vacant</div></td>
              <td colspan="" class="CONTROL" width="25%"><input type="checkbox" name="strIsBedVacant" value="${patientLeaveJoinRecordTransBean.strIsBedVacant}" disabled></td>
            </tr>
            <tr>
              <td class="LABEL" width="25%"><div align="right">Address During Leave</div></td>
              <td colspan="" class="CONTROL" width="25%"><textarea name="strAddrLeave" cols="20" rows="" readonly ><bean:write name="patientLeaveJoinRecordTransBean" property="strAddrLeave"/></textarea></td>
              <td class="LABEL" width="25%"><div align="right">Phone No.</div></td>
              <td colspan="" class="CONTROL" width="25%"><input type="text" name="strPhoneNo" value="${patientLeaveJoinRecordTransBean.strPhoneNo}" readonly></td>
            </tr>
            <tr>
              <td class="LABEL" width="25%"><div align="right">Patient Condition at the time of Leave</div></td>
              <td colspan="3" class="CONTROL" width="75%"><textarea name="strPatCondL" cols="20" rows="" readonly><bean:write name="patientLeaveJoinRecordTransBean" property="strPatCondL"/></textarea></td>
	...
	<div id="disBnR" style="display: none">
	  <table class="TABLEWIDTH" border="0" align="center" border='0' cellspacing='1px'>
	     <tr>
			...
			<td width="75%" class="CONTROL"><textarea name="strRsn" cols="20" rows="" readonly><bean:write name="patientLeaveJoinRecordTransBean" property="strRsn"/></textarea></td>
		 </tr>
	  </table>
	</div>
 <div id="transChngl" style="display:none">	
	<table class="TABLEWIDTH" align="center" border='0' cellspacing='1px'>
	    <tr>
	        <td width="100%" class="TITLE">Leave Record Entry
		    </td>
	    </tr>
	</table>
 </div>
 <div id="transChngj" style="display:none">	
	<table class="TABLEWIDTH" align="center" border='0' cellspacing='1px'>
	    <tr>
	        <td width="100%" class="TITLE">Joining Record Entry
		    </td>
	    </tr>
	</table>
 </div>	
    <div id="id0" style="display:none">
      <table class="TABLEWIDTH" align="center" border="0" cellspacing="1px">
	    <tr>
	        <td width="25%" class="LABEL" colspan="1">Leaving Date</td>
	        <td width="25%" class="CONTROL" colspan="1"><font color='blue'><bean:write name="patientLeaveJoinRecordTransBean" property="strCtDate"/></font></td>
	    ...
	    <tr>
	      <td width='25%' class='LABEL' colspan="1"><font color='red'>*</font>Advice Given at the time of Leave</td>
