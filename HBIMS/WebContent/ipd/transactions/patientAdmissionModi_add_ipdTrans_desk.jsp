...
function validate1()
{
	...
	hisValidator.addValidation("strCrNo","req","C.R No. is mandatory field");
	...
	/**if(document.forms[0].strMsApprovalStatus.value==0)
		...
		if(document.forms[0].strFlag.value==1)
		{
			...
			document.forms[0].deskmode.value="ADMMODIFY";
...
<body onload="view();"  onUnload="closePopUp();">

	<html:form action="/transactions/AdmissionDeskCNT" method ="post" type="ipd.transactions.AdmissionDeskFB" >

	<div class="errMsg" id="errMsg"><bean:write name="patientAdmissionModiTransBean_desk"
		property="strMsgString" /></div>
	<div class="normalMsg" id="normalMsg"><bean:write name="patientAdmissionModiTransBean_desk" property="strMsg"/>
	<div class="warningMsg"><bean:write name="patientAdmissionModiTransBean_desk" property="strWarningMsg" /></div></div>
	<table class="TABLEWIDTH" align="center" cellspacing="1px">
		<tr class="HEADER">
			<td colspan="4">Patient Admission Modification</td>
		</tr>
	</table>
	<table class="TABLEWIDTH" align="center" cellspacing="1px">
	<tr>
		...
		<td class="CONTROL" nowrap="nowrap">
			<div id="patientCrEdId" style="display: block;">
				<crNo:crNo value="${patientAdmissionModiTransBean_desk.strCrNo}" js="	onkeypress='return validateData(event,5);'  onkeyup='goRetFunc(event);'"></crNo:crNo>
			...
			<div id="patientCrId" style="display: none;">
				<bean:write name="patientAdmissionModiTransBean_desk" property="strCrNo"/>
			</div>
		</td>
		</tr>
	</table>
	<div id="id4" style="display:none;">
		<table class="TABLEWIDTH" align="center" cellspacing="1px">
			<pDtl:patDtl crNo="${patientAdmissionModiTransBean_desk.strCrNo}" address="false"></pDtl:patDtl>
		</table>
		</div>
	...
	<div id="newAddressModiId">
		<bean:write name="patientAdmissionModiTransBean_desk" property="strAddressModi" filter="false"/>
	</div>
		...
		<tr>
				...
				<td width="25%" class="CONTROL">
					<select name="StrDeptNameNewBorn" onchange="getUnitCombo();" class="comboMax">
						<bean:write property="strDeptValue" name="patientAdmissionModiTransBean_desk" filter="false"/>
					</select>
				</td>
				...
				<td width="25%" class="CONTROL">
					<div id="unitDivId">
						<select name="strUnitNewBorn"  class="comboNormal" onchange="funUnit()">
							<bean:write property="strUnitValue" name="patientAdmissionModiTransBean_desk" filter="false"/>
						</select>
					</div>
				</td>
			</tr>
	...
	<table class="TABLEWIDTH" align="center" cellspacing="1px">
		<tr>
				<td width="25%" class="LABEL">Department</td>
				<td width="25%" class="CONTROL">
					<bean:write property="strDeptName" name="patientAdmissionModiTransBean_desk" filter="false"/>
				</td>
				<td width="25%" class="LABEL">Unit</td>
				<td width="25%" class="CONTROL">
					<bean:write property="strUnitName" name="patientAdmissionModiTransBean_desk" filter="false"/>
		...
		<div id="PatientOccId" style="display:none">
			...
			<div id ="PatientOccDtl" style="display:none;">
				<bean:write name="patientAdmissionModiTransBean_desk" property="occupationDetailValues" filter="false"/>
			</div>
			...
			<tr>
				...
				<td width="25%" class="CONTROL">
				<div id="wardNameId"><bean:write name="patientAdmissionModiTransBean_desk" property="strWardName"/></div>
				</td>
				<td width="25%" class="LABEL">Room
					</td>
				<td width="25%" class="CONTROL">
					<div id="roomBedId">
						<bean:write name="patientAdmissionModiTransBean_desk" property="strRoom"/>
					</div>
				</td>
			</tr>
			<tr>
	...
	<table class="TABLEWIDTH" align="center" cellspacing="1px">
		<tr>
			<td  class="LABEL" width="25%">Admission Charges</td>
				<td  class="CONTROL" width="50%"><input type="text" name="strAdmissionCharge" value="" class="txtFldMin"></td>
	...
	<input type="hidden" name="strWardTypeCode" value="${patientAdmissionModiTransBean_desk.strWardTypeCode}"/>
	<input type="hidden" name="strDeptUnitCode" value="${patientAdmissionModiTransBean_desk.strDeptUnitCode}"/>
	<input type="hidden" name="strTreatmentCategoryCode" value="${patientAdmissionModiTransBean_desk.strTreatmentCategoryCode}"/>
	<input type="hidden" name="strWardCode" value="${patientAdmissionModiTransBean_desk.strWardCode}"/>
	<input type="hidden" name="strBedTypeCode" value="${patientAdmissionModiTransBean_desk.strBedTypeCode}"/>
	<input type="hidden" name="strWardName" value="${patientAdmissionModiTransBean_desk.strWardName}"/>
	<input type="hidden" name="strRoomTypeCode" value="${patientAdmissionModiTransBean_desk.strRoomTypeCode}"/>
	<input type="hidden" name="strDeptCode" value="${patientAdmissionModiTransBean_desk.strDeptCode}"/>
	<input type="hidden" name="strConsultantCode" value="${patientAdmissionModiTransBean_desk.strConsultantCode}"/>
	<input type="hidden" name="strEpisodeCode" value="${patientAdmissionModiTransBean_desk.strEpisodeCode}"/>
	<input type="hidden" name="strVisitNo" value="${patientAdmissionModiTransBean_desk.strVisitNo}"/>
	<input type="hidden" name="strMlcNo" value="${patientAdmissionModiTransBean_desk.strMlcNo}"/>
	<input type="hidden" name="strAdviceAdmNo" value="${patientAdmissionModiTransBean_desk.strAdviceAdmNo}"/>
	<input type="hidden" name="strIsUrban" value="${patientAdmissionModiTransBean_desk.strIsUrban}"/>
	<input type="hidden" name="strBedCode" value="${patientAdmissionModiTransBean_desk.strBedCode}"/>
	<input type="hidden" name="strRoomCode" value="${patientAdmissionModiTransBean_desk.strRoomCode}"/>
	<input type="hidden" name="strBookingDate" value="${patientAdmissionModiTransBean_desk.strBookingDate}"/>
	<input type="hidden" name="strFlag" value="1"/>
	<input type="hidden" name="strMsApprovalFlag" value="${patientAdmissionModiTransBean_desk.strMsApprovalFlag}"/>
	<input type="hidden" name="strMsApprovalStatus" value="${patientAdmissionModiTransBean_desk.strMsApprovalStatus}"/>
	<input type="hidden" name="strNewBorn" value="${patientAdmissionModiTransBean_desk.strNewBorn}"/>
	<input type="hidden" name="strDeptName" value="${patientAdmissionModiTransBean_desk.strDeptName}"/>
	<input type="hidden" name="strUnitName" value="${patientAdmissionModiTransBean_desk.strUnitName}"/>
	<input type="hidden" name="strDeptCode" value="${patientAdmissionModiTransBean_desk.strDeptCode}"/>
	<input type="hidden" name="strAdmNo" value="${patientAdmissionModiTransBean_desk.strAdmNo}"/>
	<input type="hidden" name="strBookingDate" value="${patientAdmissionModiTransBean_desk.strBookingDate}"/>
	</html:form>
