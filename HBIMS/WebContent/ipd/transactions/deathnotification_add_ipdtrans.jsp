...
<head>
<meta charset=utf-8>
<title>Death Notification</title>
...
<html:form action="/transactions/DeathNotificationTransCNT.cnt" 
	...
	<tr>
			...
			<input type="text" maxlength="13" name="strCrNo" onkeypress="return validateData(event,5);"
				class="txtFldMax" value="${deathNotificationTransBean.strCrNo}" onkeyup="goFuncOnEnter(event);" ><img style="cursor: hand;cursor: pointer" src="../../hisglobal/images/Go.png"
	...
	<table class="TABLEWIDTH" align="center" cellspacing="1px">
		...
		<tr>
			...
			<td class="LABEL" width="25%"><font color="red">*</font>Onset Date Of Death</td>
			<td class="CONTROL" width="25%">
	...
	<td class="LABEL" width="15%"><font color="red">*</font>Onset Time Of Death</td>
	<td class="CONTROL" width="35%" nowrap="nowrap">
		...
		<tr>
			...
			<td class="LABEL" width="25%"><font color="red">*</font>Manner Of Death</td>
			<td class="CONTROL" width="25%">
				<select name="strDeathManner" class="comboNormal">
...
<table border="0" class="TABLEWIDTH" align="center" cellspacing="1px"> 
		...
		<tr>
			...
			<img style="cursor: hand;cursor: pointer" src="../../hisglobal/images/btn-clr.png"
				onClick="clearRecord();">
