...
<head>
<meta charset=utf-8>
<title>Patient Transfer Success Page IPD</title>
...
<html:form action="/transactions/PatientTransferTransCNT" method="post">
	<div class="normalMsg" id="normalMsg" align="center"><bean:write name="patientMoveTransBean" property="strNormalMsgString" /></div>
</html:form>
</body>
</html>