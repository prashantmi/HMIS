...
function getServiceName(obj)
{
	...
	var url='/HBIMS/ipd/transactions/PatientAttendanceBSCNT.cnt?';
 ...
 for(i=0; i<count;i++)
{
 ...
 url='/HBIMS/ipd/transactions/PatientAttendanceBSCNT.cnt?';
 	 		url+='hmode=ACCEPT';
 	 		url+='&chk=' + chkVaL;
 	 		 url+='&control=' + control;
	 		ajaxFunction(url,"3");	 
...
{ 
	...
	{
		var mode="UNIT";
		var url="/HBIMS/ipd/transactions/PatientAttendanceBSCNT.cnt"+"?hmode="+mode+"&modDept="+document.forms[0].strDepartment.value;
		ajaxFunction(url,"4");
	}
}
...
function funward()
{
	if(document.forms[0].strUnit.value==0)
	{
     ...
     {	
		...
		var url="/HBIMS/ipd/transactions/PatientAttendanceBSCNT.cnt"+"?hmode="+mode+"&modWard="+temp+'&ageCode='+document.forms[0].strAgeCode.value+'&sexCode='+ document.forms[0].strGenderCode.value+'&age='+document.forms[0].strAge.value+'&treatmentCategCode='+document.forms[0].strTreatmentCat.value+'&crNo='+document.forms[0].strCrNo.value;
...
function getBlkHrs(ob,i)
{
	...
	var hmode="GETBLKHRS"
	var url="/HBIMS/ipd/transactions/PatientAttendanceBSCNT.cnt?hmode="+hmode+"&obj="+obj+"&index="+i;
	ajaxFunction(url,"8");
	...
	for(var i=0;i<robj.length;i++)
		{
			if(robj[i].checked)
				{
					url="/HBIMS/ipd/transactions/PatientAttendanceBSCNT.cnt?hmode="+hmode+"&obj="+robj[i].value.split("#")[0]+"&index="+i;
					ajaxFunction(url,"9");
				}			
		}
}
