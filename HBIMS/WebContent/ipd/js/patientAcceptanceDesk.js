/**
 * This function is disable or enable button dynamically
 */
...
/**
 * This function is used to display menu on desk dynamically
 */
function showMenu(){
	
	try{
			document.getElementById("menuTable1").style.display = "block";
			document.getElementById("vaccantRowDiv1").style.display = "block";
	}catch(e){alert(e);}	
}
