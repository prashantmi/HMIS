...
function validate1()
{
	...
	var hisValidator = new HISValidator("jobTrackingTransBean"); 
...
function bedDetails()
{
	...
	/*var deptcode="";
		...
		var url='JobTrackingTransBSCNT.cnt?hmode='+hmode+'&wardTypeCode='+document.forms[0].strWardTypeCode.value+'&roomTypeCode='+document.forms[0].strRoomTypeCode.value+
...
function getCombo(obj)
{
	...
	{
		var hmode = "GETUNIT"; 
		var url = "JobTrackingTransBSCNT.cnt?hmode="+hmode+"&deptCode="+obj.value;
		ajaxFunction(url,"2");
	}
	if(obj.name=='strDeptCode' && document.forms[0].strUnitReq.value=='0')
	{
		var hmode = "GETWARDCATCONSULTANT"; 
		var url = "JobTrackingTransBSCNT.cnt?hmode="+hmode+"&deptCode="+obj.value+"&unitReq="+document.forms[0].strUnitReq.value+"&age="+document.forms[0].strAge.value+"&ageCode="+document.forms[0].strAgeUnit.value+"&sexCode="+document.forms[0].strSexCode.value+"&crNo="+document.forms[0].strCrNo.value+"&treatmentCategCode="+document.forms[0].strTreatmentCategoryCode.value+"&wardTypeCode="+document.forms[0].strWardTypeCode.value;
		ajaxFunction(url,"3");
	}
	if(obj.name=='strDeptUnitCode')
	{
		var hmode = "GETWARDCATCONSULTANT"; 
		var url = "JobTrackingTransBSCNT.cnt?hmode="+hmode+"&deptUnitCode="+obj.value+"&unitReq="+document.forms[0].strUnitReq.value+"&age="+document.forms[0].strAge.value+"&ageCode="+document.forms[0].strAgeUnit.value+"&sexCode="+document.forms[0].strSexCode.value+"&crNo="+document.forms[0].strCrNo.value+"&treatmentCategCode="+document.forms[0].strTreatmentCategoryCode.value+"&wardTypeCode="+document.forms[0].strWardTypeCode.value;
		ajaxFunction(url,"4");
	}
	if(obj.name=='strWardCode' && document.forms[0].strUnitReq.value=='1' && document.forms[0].strRoomReq.value=='1')
	{
		var hmode = "GETROOM"; 
		var url = "JobTrackingTransBSCNT.cnt?hmode="+hmode+"&wardCode="+obj.value+"&deptUnitCode="+document.forms[0].strDeptUnitCode.value+"&unitReq="+document.forms[0].strUnitReq.value+"&age="+document.forms[0].strAge.value+"&ageCode="+document.forms[0].strAgeUnit.value+"&sexCode="+document.forms[0].strSexCode.value+"&crNo="+document.forms[0].strCrNo.value+"&treatmentCategCode="+document.forms[0].strTreatmentCategoryCode.value+"&wardTypeCode="+document.forms[0].strRoomTypeCode.value;
		ajaxFunction(url,"5");
	}
	if(obj.name=='strWardCode' && document.forms[0].strUnitReq.value=='0' && document.forms[0].strRoomReq.value=='1')
	{
		var hmode = "GETROOM"; 
		var url = "JobTrackingTransBSCNT.cnt?hmode="+hmode+"&wardCode="+obj.value+"&deptCode="+document.forms[0].strDeptCode.value+"&unitReq="+document.forms[0].strUnitReq.value+"&age="+document.forms[0].strAge.value+"&ageCode="+document.forms[0].strAgeUnit.value+"&sexCode="+document.forms[0].strSexCode.value+"&crNo="+document.forms[0].strCrNo.value+"&treatmentCategCode="+document.forms[0].strTreatmentCategoryCode.value+"&wardTypeCode="+document.forms[0].strRoomTypeCode.value;
		ajaxFunction(url,"5");
	}
	if(obj.name=='strTreatmentCategoryCode')
	{
		var hmode = "GETWARD"; 
		var url = "JobTrackingTransBSCNT.cnt?hmode="+hmode+"&deptCode="+document.forms[0].strDeptNameNewBorn.value+"$strCrNo="+document.forms[0].strCrNo.value;
		ajaxFunction(url,"6");
	}
	if(obj.name=='strConsultantCode')
	{
		...
		var url = "JobTrackingTransBSCNT.cnt?hmode="+hmode+"&deptCode="+document.forms[0].strDeptCode.value+"&deptUnitCode="+unit+"&age="+document.forms[0].strAge.value+"&ageCode="+document.forms[0].strAgeUnit.value+"&sexCode="+document.forms[0].strSexCode.value+"&crNo="+document.forms[0].strCrNo.value+"&treatmentCategCode="+document.forms[0].strTreatmentCategoryCode.value+"&wardTypeCode="+document.forms[0].strRoomTypeCode.value;
		ajaxFunction(url,"9");
	}
}
function view2()
...
/*function onchangeState()
{
	...
	var url='JobTrackingTransBSCNT.cnt?hmode='+hmode+'&stateCode='+cbo.value;
	ajaxFunction(url,"7");
	...
	if(cbo !=undefined)
		{
			...
			{ 	
				...
				document.getElementById("districtTextBoxDiv").style.display="";
		  		...
		  		/*var hmode = "GETSTATE"; 
		  		var url='JobTrackingTransBSCNT.cnt?hmode='+hmode+'&crno='+cr;
		  		ajaxFunction(url,"8");*/
