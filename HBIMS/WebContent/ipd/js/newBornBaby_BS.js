function validate1NewBorn()
{
	...
	//	hisValidator.addValidation("strMotherTreatmentCateg","dontselect=0","Please select Treatment Category ");
		...
		var ret=compareDate(document.forms[0].strDob.value,document.forms[0].strCtDate.value);
		if(ret.mode==2)
		{
			alert("Date of Birth Can't Be Greater Than Current Date");
			return false;
		}
		var ret1=compareDate(document.forms[0].strDob.value,document.forms[0].strMothAdmDate.value);
		if(ret1.mode==0)
		{
		...
		if(retVal)
		{
			...
			/*if(document.forms[0].strOccRelation.disabled=true)
			{
				...
				if(document.forms[0].strWard !=undefined){
...
function getAjaxResponse(res,mode){
		if(mode==1)
		{
			document.getElementById("unitDivId").innerHTML="<select name='strUnitNewBorn' onchange='getWard_BS();' class='comboMax browser-default custom-select'>"+res+"</select>";
		...
		if(mode==2)
		{
			...
			createTable_BS(temp[0],temp[1],temp[2]);
		...
		if(mode == '4')
		{
			...
			objEle.innerHTML ="<select name='strDistrict' class='comboMax browser-default custom-select' onclick='onchangeDistrict()'>"+res+"</select>";
		...
		if(mode==6)
		{			
			document.getElementById("consDivId").innerHTML="<select name='strConsNewBorn' class='comboMax browser-default custom-select'>"+res+"</select>";
			getChargeValue();		
		}
		if(mode==7)
		{
			...
			objEle.innerHTML='<select name="strWard"  onChange="getRoomNo();" class="comboMax browser-default custom-select">'+res+'</select>';
			getRoomNo();
		}
		if(mode==8)
		{
			...
			objEle.innerHTML='<select name="strRoomCode" onChange=""  class="comboMax browser-default custom-select">'+res+'</select>';
			getWardChargeValue();
		}
		if(mode==9)
		{
...
function viewN_BS()
{
	...
	if(checkCrdef(document.getElementById("strCrNoId"))==false && document.forms[0].strCrNo.value!="")//complete cr enetered
	{
		...
		var o= document.getElementById("admissionId");
		if (document.forms[0].strAdmissionCharge.value=="1" || document.forms[0].strNewBornRegistrationCharge.value=="1" || document.forms[0].strAdmissionAdvance.value=="1")
		{		
			document.getElementById("nonPrintableLegend3").style.display="block";
			/*if (document.forms[0].strAdmissionCharge.value=="1")
			...
			if (document.forms[0].strAdmissionCharge.value=="1")
			{
				...
				tempStr = tempStr + "Admission Fee:<i class='fa fa-rupee-sign'  title='admFee'></i>";
				tempStr = tempStr + "<input type='hidden' name='strAdmissionChargeValue' value='"+document.forms[0].strAdmissionChargeHidden.value+"'>";
				tempStr = tempStr + "<label id='admissionChargeId'>"+document.forms[0].strAdmissionChargeHidden.value+"</label>,&nbsp;";
				flag = 1;
			}
			else
				colspan = "2";
			...
			{
			//alert(tempStr);
				tempStr = tempStr + "Registration Charges:<i class='fa fa-rupee-sign'  title='regFee'></i>";
				tempStr += "<input type='hidden' name='strNewBornRegistrationChargeVal' value='"+document.forms[0].strRegistrationChargeHidden.value+"'>";
				tempStr += "<label id='RegistrationChargeId'>"+document.forms[0].strRegistrationChargeHidden.value+"</label>,&nbsp;";
				flag = 1;
			//	alert(tempStr);
			}
			...
			{
			//alert("4");
				tempStr = tempStr + "Advance Amount:<i class='fa fa-rupee-sign'  title='advAmt'></i>";
				tempStr = tempStr + "<input type='hidden' name='strAdmissionAdvanceChargeValue' value='"+document.forms[0].strAdvanceAmount.value+"'>";
				tempStr = tempStr + "<label id='advanceAdmissionChargeId'>"+document.forms[0].strAdvanceAmount.value+"</label>,&nbsp;";
				flag = 2;
			}
			else
				colspan = "2";
			...
			if(flag > 0)
			{
				tempStr = tempStr + "Total:<i class='fa fa-rupee-sign'  title='total'></i>";
				tempStr += "<label id='TotalID'></label>";
		    ...
		    document.getElementById("TotalID").innerHTML=""+glob;
			document.forms[0].strTotalAmount.value=glob;
		}
		else
			o.innerHTML = "";
...
function createTable_BS(ob1,ob2,ob3)
{
	var total=0;
	if (document.forms[0].strAdmissionCharge.value=="1" || document.forms[0].strNewBornRegistrationCharge.value=="1" ||document.forms[0].strAdmissionAdvance.value=="1")
	{
			if (document.forms[0].strAdmissionCharge.value=="1")
			{
				document.forms[0].strAdmissionChargeValue.value=ob1;
				document.getElementById("admissionChargeId").innerHTML=ob1;
				total=total+parseInt(isNaN(document.forms[0].strAdmissionChargeValue.value)?0:document.forms[0].strAdmissionChargeValue.value);
			}
			if (document.forms[0].strNewBornRegistrationCharge.value=="1")
			{
				document.forms[0].strNewBornRegistrationChargeVal.value=ob3;
				document.getElementById("RegistrationChargeId").innerHTML=ob3;
				total=total+parseInt(isNaN(document.forms[0].strNewBornRegistrationChargeVal.value)?0:document.forms[0].strNewBornRegistrationChargeVal.value);
			}
			if (document.forms[0].strAdmissionAdvance.value=="1")
			{
				document.forms[0].strAdmissionAdvanceChargeValue.value=ob2;
				document.getElementById("advanceAdmissionChargeId").innerHTML=ob2;
				total=total+parseInt(isNaN(document.forms[0].strAdmissionAdvanceChargeValue.value)?0:document.forms[0].strAdmissionAdvanceChargeValue.value);
			}
			
			document.getElementById("TotalID").innerHTML=total;
			document.forms[0].strTotalAmount.value=total;
			document.forms[0].strTotalChargeVal.value=total;			
	}
...
function matchWardRoomCriteria()
{
	...
	else
	{
		...
		var strDob=document.forms[0].strDob.value;
...
*/		hisValidator.addValidation("strDeptNameNewBorn","dontselect=0","Please select Department"); 
		...
		if(retVal)
		{
			...
			var strDobTime=document.forms[0].strDob.value+" "+document.forms[0].strBirthHour.value+":"+document.forms[0].strBirthMin.value+" "+document.forms[0].strAmPm[document.forms[0].strAmPm.selectedIndex].text;
			validate1NewBorn();
			
			/*var hmode = "MATCHCRITERIA"; 
			var url = "NewBornBabyTransBSCNT.cnt?hmode="+hmode+"&wardCode="+wardCode+"&roomNo="+roomNo+"&strTreatment="+strTreatment+"&sexCode="+sexCode+"&dob="+strDobTime;
			ajaxFunction(url,"3");*/
		}
	}
}

function matchWardRoomCriteria_BS()
{
	var hisValidator = new HISValidator("newBornTransBean");
	if(document.forms[0].strCrNo.value=="")
	{
...
*/		hisValidator.addValidation("strDeptNameNewBorn","dontselect=0","Please select Department"); 
		...
		{	
			...
			if(document.forms[0].strRoomCode !=undefined )
			{
				if(document.forms[0].strRoomCode.value=="0" )
				{
					alert("Please Select Room");
...
function openUpdateMotherDelDet_BS()
{
	//alert("called..");
	document.forms[0].hmode.value="UPDATEMOTHERDETAILSBS";
	document.forms[0].submit();
