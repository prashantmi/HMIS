...
function getAjaxResponse(res,mode){
		if(mode==1)
		{
			document.getElementById("unitDivId").innerHTML="<select name='strUnitNewBorn' onchange='getWard();' class='comboMax browser-default custom-select'>"+res+"</select>";
...
function funUnit()
{
	if(document.forms[0].strIsBedSharable.value!=0)
	{
		...
		var url = "NewBornBabyTransCNT.cnt?hmode="+hmode+"&deptCode="+document.forms[0].strDeptNameNewBorn.value+"&unitcode="+document.forms[0].strUnitNewBorn.value+"&wardCode="+document.forms[0].strMotherWardCode.value+"&roomCode="+document.forms[0].strMotherRoomCode.value+"&bedCode="+document.forms[0].strBedCode.value;
		//alert(url);
		ajaxFunction(url,"5");
	}
	else
...
function getChargeValue()
{
	...
	var url = "NewBornBabyTransCNT.cnt?hmode="+hmode+"&wardCode="+0+"&teatmentCategory="+document.forms[0].strMotherTreatmentCateg.value.split("^")[0]+"&unit_code="+document.forms[0].strUnitNewBorn.value;
...
function getWardChargeValue()
{
	...
	var url = "NewBornBabyTransCNT.cnt?hmode="+hmode+"&wardCode="+document.forms[0].strWard.value+"&teatmentCategory="+document.forms[0].strMotherTreatmentCateg.value.split("^")[0]+"&unit_code="+document.forms[0].strUnitNewBorn.value;
...
{   var cboCountry = document.getElementsByName("strCountry")[0];
	...
	var url='NewBornBabyTransCNT.cnt?hmode='+hmode+'&stateCode='+cbo.value;
	ajaxFunction(url,"4");	
...
function getCons()
{
	...
	var url = "NewBornBabyTransCNT.cnt?hmode="+hmode+"&unit_code="+document.forms[0].strUnitNewBorn.value;
