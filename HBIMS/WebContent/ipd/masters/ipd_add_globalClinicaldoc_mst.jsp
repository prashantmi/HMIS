...
<head>
<meta charset=utf-8>
<title>Global Clinical Document Master Add Page</title>
...
<html:form action="/masters/GlobalClinicalDocumentMstACTION">
	...
	<div class="normalMsg" id="normalMsg"><bean:write name="globalDocumentBean" property="strMsg"/></div>
	<div class="warningMsg"><bean:write name="globalDocumentBean" property="strWarning"/></div>
	
<tag:tab tabLabel="Add Global Clinical Document" selectedTab="FIRST" align ="center" width ="TABLEWIDTH"> </tag:tab>
	<table class="TABLEWIDTH" align="center" cellspacing="1px" cellpadding="1px">
		<tr class="HEADER">
			<td colspan="2">Global Clinical Document Master&gt;&gt;Add</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="CONTROL"><date:date name="strEffectiveFrom"
				value="${globalDocumentBean.strEffectiveFrom}"></date:date></td>
		</tr>
		<tr>
			<td class="LABEL">
