...
<head>
<meta charset=utf-8>
<title>Room Type Master Modify Page</title>
...
<html:form action="/masters/CNTRoomTypeMst">
   <div class="normalMsg" id="normalMsg"><bean:write name="roomtypeBean" property="strNormalMsg"/></div>  
     <div  class="errMsg"><bean:write name="roomtypeBean" property="strerrorMsg"/></div>
<tag:tab tabLabel="Modify Room Type" selectedTab="FIRST" align ="center" width ="TABLEWIDTH"> </tag:tab>
<table CLASS ="TABLEWIDTH" align ="center" cellspacing="1px">
 <tr class ="HEADER">
  <td colspan="2">Room Type Master&gt;&gt; Modify</td>
 </tr> 
 <tr> 
	    <td width="50%" class="LABEL"> <font color="red">*</font>Global Room Type</td>
	    <td width="50%" class="CONTROL"> <select name="strGlobalRoomType" id="strGlobalRoomType" class="comboMax" disabled="disabled">
 ...
 <tr >
    ...
    <td width="50%" class ="CONTROL"><input type="text" onkeyup="lTrim(this);" onblur="Trim(this);" name="strRoomType" value ="${roomtypeBean.strRoomType}" onkeypress="return validateData(event,4);" maxlength="40"> </td>
 </tr>
 <tr >
    <td class ="LABEL" width ="50%">Effective Date</td>
    <td class ="CONTROL"><bean:write name="roomtypeBean" property="strEffectiveDate" /></td>
 </tr>
 <tr>
      <td class="LABEL"><div align="right">Remarks</div></td>
      <td class="LABEL">
	  <div align="left">
  <textarea  name="strRemarks" onkeyup="lTrim(this);" onblur="Trim(this);" cols="25" rows="2" ><bean:write name="roomtypeBean" property="strRemarks"/></textarea>
      </div></td>
 </tr>
 <tr >
    <td width ="45%" class ="LABEL">Record Status </td>
    <td width ="45%" class ="CONTROL" >
    <html:radio name="roomtypeBean" property='strIsValid' value='1'></html:radio>
	   Active <span class="LABEL">
    <html:radio name="roomtypeBean" property='strIsValid'  value='2'></html:radio>
	   InActive </span></td>
    </tr>
    <tr class="FOOTER"> 
...
<table CLASS ="TABLEWIDTH" cellspacing="1px">
	<tr> 
	    ...
	    <input type="hidden" name="chk" value="${roomtypeBean.chk[0]}">
	    <input type="hidden" name="strEffectiveDate" value ="${roomtypeBean.strEffectiveDate}" />
