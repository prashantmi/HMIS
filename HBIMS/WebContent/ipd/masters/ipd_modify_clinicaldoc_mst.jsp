...
<head>
<meta charset=utf-8>
<title>Clinical Document Master Modify Page</title>
...
<tag:tab tabLabel="Modify Clinical Document" selectedTab="FIRST" align ="center" width ="TABLEWIDTH"> </tag:tab>
	<table class="TABLEWIDTH" align="center" cellpadding="1px" cellspacing="1px">
		<tr class="HEADER">
			<td colspan="2">Clinical Document Master&gt;&gt;Modify</td>
		</tr>
		<tr> 
	  		<td width="50%" class="LABEL"> <font color="red">*</font>Global Document Name</td>
		    <td width="50%" class="CONTROL"> <select name="strGlobalClinicalDocumentType" id="strGlobalClinicalDocumentType" class="comboMax" disabled="disabled">
		...
		<tr>
			...
			<td width="50%" class="CONTROL"><input onkeyup="lTrim(this);"
				...
				class='txtFldMax' value="${documentBean.strDocumentName}"
		...
		<tr>
			...
			<div align="left"><textarea onkeyup="lTrim(this);"
				...
				name="documentBean" property="strRemarks" /></textarea></div>
			</td>
		</tr>
		<tr>
			<td width="45%" class="LABEL">Record Status</td>
			<td width="45%" class="CONTROL">
			<html:radio name="documentBean" property="strIsValid" value="1">Active</html:radio>
			<html:radio name="documentBean" property="strIsValid" value="2">InActive</html:radio>
			</td>
		</tr>
		<tr class="FOOTER">
	...
	<input type="hidden" name="chk" value="${documentBean.strChk1}">
