...
<head>
<meta charset=utf-8>
<title>Global Discharge Type Master Add Page</title>
...
<div class="errMsg"><bean:write name="globalDischargeTypeBean" property="strErrorMsg"/></div>
	<div class="normalMsg" id="normalMsg"><bean:write name="globalDischargeTypeBean" property="strMsg"/></div>
	<div class="warningMsg"><bean:write name="globalDischargeTypeBean" property="strWarning"/></div>
	 	
<tag:tab tabLabel="Add Global Discharge Type" selectedTab="FIRST" align ="center" width ="TABLEWIDTH"> </tag:tab>
	<table class="TABLEWIDTH" align="center" cellspacing="1px"
		cellpadding="1px">
		<tr class="HEADER">
			<td colspan="2">Global Discharge Type Master&gt;&gt;Add</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="CONTROL"><date:date name="strEffectiveDate"
				value="${globalDischargeTypeBean.strEffectiveDate }"></date:date></td>
		</tr>
		<tr>
			<td class="LABEL">
