...
<head>
<meta charset=utf-8>
<title>Global Bed Type Master Add Page</title>
...
<html:form action="/masters/GlobalBedTypeMstACTION" focusIndex="2">

  	<div class="errMsg"><bean:write name="globalBedtypeBean" property="strErrorMsg"/></div>
	<div class="normalMsg" id="normalMsg"><bean:write name="globalBedtypeBean" property="strMsg"/></div>
	<div class="warningMsg"><bean:write name="globalBedtypeBean" property="strWarning"/></div>

<tag:tab tabLabel="Add Global Bed Type" selectedTab="FIRST" align ="center" width ="TABLEWIDTH"> </tag:tab>
<table class="TABLEWIDTH" align="center" cellspacing="1px" cellpadding="1px">
  <tr class="HEADER"> 
    <td colspan="2">Global Bed Type Master&gt;&gt;Add</td>
  </tr>  
  <tr >
    ...
    <td width="50%" class ="CONTROL"><input onkeyup="lTrim(this);" onblur="Trim(this);" type="text" name="strBedType" class='txtFldMax' value ="" 
                   maxlength="40" onkeypress="return validateData(event,9);"> </td>
  </tr>  
  <tr>
    <td class ="LABEL" width ="50%"><font color="red">*</font>Effective Date</td>
    <td class ="CONTROL"><date:date name="strEffectiveDate" value ="${globalBedtypeBean.strEffectiveDate}"></date:date></td>
  </tr>
  <tr>
