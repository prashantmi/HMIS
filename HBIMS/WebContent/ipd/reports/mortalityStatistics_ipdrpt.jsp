...
<title>Mortality Statistics Report</title>
...
function validate(){
	...
	var hisValidator = new HISValidator("mortalityStatRpt");
	...
	{ 
 		var url;
 		url="MortalityStatisticsRptCNT.cnt?hmode=DEPTCMB&hospCode="+obj.value;
		ajaxFunction(url,"4");
	}	
	function getUnitCombo(obj){ 

 		var url ="MortalityStatisticsRptCNT.cnt?hmode=UNITCMB&deptCode="+obj.value;
		...
		function getWardCombo(obj){ 
 		...
 		var url="MortalityStatisticsRptCNT.cnt?hmode=WARDCMB&deptunitCode="+obj.value+"&deptCode="+document.forms[0].strDeptCode[document.forms[0].strDeptCode.selectedIndex].value;
...
<body >
<html:form action="/reports/MortalityStatisticsRptCNT.cnt" method="post">

	<div class="normalMsg" id="normalMsg"></div>

	
		<tag:tab tabLabel="Mortality Statistics"
                        selectedTab="FIRST" align="center" width="TABLEWIDTH">
                  </tag:tab>

	<table class="TABLEWIDTH" align="center">   
	<tr class="HEADER">
			<td colspan="2">Mortality Statistics</td>
		</tr>
		<tr>
			...
			<bean:write name="mortalityStatRpt" property="strHospNameValues" filter="false"/>
			</select>
			</td>			
		</tr>
		<tr>
			...
			<td width="50%" class="CONTROL">
			<html:checkbox property="strIsWardWise" name="mortalityStatRpt" value="1" ></html:checkbox>
			</td>
    ...
    <tr>
			...
			<td  class="CONTROL"><dateTag:date name="strEffectiveFrom"
				value="${mortalityStatRpt.strCurrentDate}" /></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td width="50%" class="CONTROL">
			<html:checkbox property="strIsTimeRequired" name="mortalityStatRpt" onclick="displayTime(this);"></html:checkbox>
			</td>
		...
		<div id="timeDiv" Style="display:none">
			<table class="TABLEWIDTH" align="center" cellspacing="1px" cellpadding="1px" > 
				<tr>
					...
					<td width="50%" class="CONTROL"><html:text name="mortalityStatRpt" property="strFromTime" style="width:50px"
					value="00:00" />HH24:MM</td>
				</tr>
				<tr>
					<td width="50%" class="LABEL"><font color="red">*</font> To Time</td>
					<td width="50%" class="CONTROL"><html:text name="mortalityStatRpt" property="strToTime" style="width:50px"
					value="${mortalityStatRpt.strCurrentTime}" />HH24:MM</td>
				</tr>
			</table>
		</div>
		<table class="TABLEWIDTH" align="center" cellspacing="1px" cellpadding="1px" > 
   ...
   <tr>
		...
		<tr>
			...
			<td width="50%" class="CONTROL">
			<html:checkbox property="strIsFooter" name="mortalityStatRpt" value="1"></html:checkbox>
			</td>
...
<input type="hidden" name="strCurrentDate" value="${mortalityStatRpt.strCurrentDate}"/>
<input type="hidden" name="strCurrentTime" value="${mortalityStatRpt.strCurrentTime}"/>
</html:form>
