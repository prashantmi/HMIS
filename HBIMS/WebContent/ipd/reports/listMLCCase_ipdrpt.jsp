...
function validate(){
		...
		var hisValidator = new HISValidator("listMLCCaseRpt");
...
function getUnitCombo(obj){ 
 		...
 		var url ="ListMLCCaseRptCNT.cnt?hmode=UNITCMB&deptCode="+obj.value;
 		ajaxFunction(url,"1");
...
function getWardCombo(obj){ 
 		...
 		var url="ListMLCCaseRptCNT.cnt?hmode=WARDCMB&deptunitCode="+obj.value+"&deptCode="+document.forms[0].strDeptCode[document.forms[0].strDeptCode.selectedIndex].value;
 		ajaxFunction(url,"2");
...
<html:form action="/reports/ListMLCCaseRptCNT.cnt" method="post">

	<div class="normalMsg" id="normalMsg"></div>

	<tag:tab tabLabel="List of MLC Cases"
                        selectedTab="FIRST" align="center" width="TABLEWIDTH">
                  </tag:tab>

	<table class="TABLEWIDTH" align="center">   
	<tr class="HEADER">
			<td colspan="2">List of MLC Cases</td>
		</tr>
		<tr >
    <td class="LABEL" colspan="2">
    <div align="right">
    <html:radio property="strCase" name="listMLCCaseRpt" value="1" onclick="getCombo(this);" >Ward Wise</html:radio>
    <html:radio property="strCase" name="listMLCCaseRpt" value="2" onclick="getCombo(this);" >Date Wise</html:radio>
    </div>
    </td>
    </tr>
		...
		<tr> 
        	...
        	<bean:write name="listMLCCaseRpt" property="strDeptValues" filter="false"/> </select> </td>
  		</tr>
  		 <tr>
   ...
   <tr>
			...
			<td  class="CONTROL"><dateTag:date name="strEffectiveFrom"
				value="${listMLCCaseRpt.strCurrentDate}" /></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td width="50%" class="CONTROL">
			<html:checkbox property="strIsTimeRequired" name="listMLCCaseRpt" value="1"  onclick="displayTime(this);"></html:checkbox>
			</td>
		</tr>
		</table>
		<div id="timeDiv" Style="display:none">
			<table class="TABLEWIDTH" align="center" cellspacing="1px" cellpadding="1px" > 
				<tr>
					...
					<td width="50%" class="CONTROL"><html:text name="listMLCCaseRpt" property="strFromTime" style="width:50px"
					value="${listMLCCaseRpt.strCurrentTime}" /></td>
				</tr>
				<tr>
					<td width="50%" class="LABEL"><font color="red">*</font> To Time</td>
					<td width="50%" class="CONTROL"><html:text name="listMLCCaseRpt" property="strToTime" style="width:50px"
					value="${listMLCCaseRpt.strCurrentTime}" /></td>
				</tr>
			</table>
		</div>
		...
		<tr>
			...
			<td width="50%" class="CONTROL">
			<html:checkbox property="strIsFooter" name="listMLCCaseRpt" value="1"></html:checkbox>
			</td>
...
<input type="hidden" name="strCurrentDate" value="${listMLCCaseRpt.strCurrentDate}"/>
<input type="hidden" name="strCurrentTime" value="${listMLCCaseRpt.strCurrentTime}"/>
</html:form>
