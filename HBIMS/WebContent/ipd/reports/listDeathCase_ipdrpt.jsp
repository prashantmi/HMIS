...
<title>List of Death Cases</title>
...
function validate(){
		...
		var hisValidator = new HISValidator("listDeathCaseRpt");
...
function getUnitCombo(obj){ 
 		...
 		var url ="ListDeathCaseRptCNT.cnt?hmode=UNITCMB&deptCode="+obj.value;
 		ajaxFunction(url,"1");
...
function getWardCombo(obj){ 
 		...
 		var url="ListDeathCaseRptCNT.cnt?hmode=WARDCMB&deptunitCode="+obj.value+"&deptCode="+document.forms[0].strDeptCode[document.forms[0].strDeptCode.selectedIndex].value;
 		ajaxFunction(url,"2");
...
{ 
 		var url;
 		url="ListDeathCaseRptCNT.cnt?hmode=DEPTCMB&hospCode="+obj.value;
		ajaxFunction(url,"4");
}
...
<html:form action="/reports/ListDeathCaseRptCNT.cnt" method="post">

	<div class="normalMsg" id="normalMsg"></div>

	<tag:tab tabLabel="List of Death Cases"
                        selectedTab="FIRST" align="center" width="TABLEWIDTH">
                  </tag:tab>

	<table class="TABLEWIDTH" align="center" cellspacing="1px" cellpadding="1px">   
	<tr class="HEADER">
			<td colspan="2">List of Death Cases</td>
		</tr>
		<tr >
    <td class="LABEL" colspan="2">
    <div align="right">
    <html:radio property="strCase" name="listDeathCaseRpt" value="1" onclick="getCombo(this);" >Ward Wise</html:radio>
    <html:radio property="strCase" name="listDeathCaseRpt" value="2" onclick="getCombo(this);" >Date Wise</html:radio>
    </div>
    </td>
    </tr>
		<tr>
			...
			<bean:write name="listDeathCaseRpt" property="strHospNameValues" filter="false"/>
			</select>
			</td>			
		</tr>
		</table>
	...
	<table class="TABLEWIDTH" align="center" cellspacing="1px" cellpadding="1px" >  
 	  <tr>
			...
			<td  class="CONTROL"><dateTag:date name="strEffectiveFrom"
				value="${listDeathCaseRpt.strCurrentDate}" /></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td width="50%" class="CONTROL">
			<html:checkbox property="strIsTimeRequired" name="listDeathCaseRpt" onclick="displayTime(this);"></html:checkbox>
			</td>
		</tr>
	</table>
		<div id="timeDiv" Style="display:none">
			<table class="TABLEWIDTH" align="center" cellspacing="1px" cellpadding="1px" > 
				<tr>
					...
					<td width="50%" class="CONTROL"><html:text name="listDeathCaseRpt" property="strFromTime" style="width:50px"
					value="00:00" />HH24:MM</td>
				</tr>
				<tr>
					<td width="50%" class="LABEL"><font color="red">*</font> To Time</td>
					<td width="50%" class="CONTROL"><html:text name="listDeathCaseRpt" property="strToTime" style="width:50px"
					value="${listDeathCaseRpt.strCurrentTime}" />HH24:MM</td>
				</tr>
			</table>
		</div>
		<table class="TABLEWIDTH" align="center" cellspacing="1px" cellpadding="1px" > 
		...
		<tr>
			...
			<td width="50%" class="CONTROL">
			<html:checkbox property="strIsFooter" name="listDeathCaseRpt" value="1"></html:checkbox>
			</td>
...
<input type="hidden" name="strCurrentDate" value="${listDeathCaseRpt.strCurrentDate}"/>
<input type="hidden" name="strCurrentTime" value="${listDeathCaseRpt.strCurrentTime}"/>
</html:form>
