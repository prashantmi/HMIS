...
<title>Hospital Statistics Report</title>
...
function validate()
{
	var hisValidator = new HISValidator("hospStatRpt");
...
function getUnitCombo(obj)
{
 		...
 		{
 			var url ="HospitalStatisticsRptCNT.cnt?hmode=UNITCMB&deptCode="+obj.value; 		 		
 			ajaxFunction(url,"1");
 		}
}
...
{ 
	 		...
	 		var url="HospitalStatisticsRptCNT.cnt?hmode=WARDCMB&deptunitCode="+obj.value+"&deptCode="+document.forms[0].strDeptCode[document.forms[0].strDeptCode.selectedIndex].value;
			ajaxFunction(url,"2");
...
{ 
 		var url;
 		url="HospitalStatisticsRptCNT.cnt?hmode=DEPTCMB&hospCode="+obj.value;
		ajaxFunction(url,"3");
}
...
<body >
<html:form action="/reports/HospitalStatisticsRptCNT.cnt" method="post">	
<div class="normalMsg" id="normalMsg"></div>
		
<tag:tab tabLabel="Hospital Statistics" selectedTab="FIRST" align="center" width="TABLEWIDTH"></tag:tab>
	<table class="TABLEWIDTH" align="center">   
		<tr class="HEADER">
			<td colspan="2">Hospital Statistics</td>
		</tr>
		...
		<tr>
			...
			<bean:write name="hospStatRpt" property="strHospNameValues" filter="false"/>
			</select>
			</td>			
		</tr>	
		...
		<tr>
			...
			<bean:write name="hospStatRpt" property="strDeptValues" filter="false"/>
  		...
  		<tr>
   		...
   		<tr>
			...
			<td class="CONTROL"><dateTag:date name="strEffectiveFrom"
				value="${hospStatRpt.strCurrentDate}" /></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td width="50%" class="CONTROL">
			<html:checkbox property="strIsFooter" name="hospStatRpt" value="1"></html:checkbox>
			</td>			
		</tr>
		<tr>
...
<input type="hidden" name="strCurrentDate" value="${hospStatRpt.strCurrentDate}"/>
</html:form>
