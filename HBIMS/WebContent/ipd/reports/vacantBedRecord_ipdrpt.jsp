...
{ 
 		...
 		{
	 		var url ="VacantBedRecordRptCNT.cnt?hmode=UNITCMB&deptCode="+obj.value;
	 		ajaxFunction(url,"1");
	 	}
}
function getDeptCombo(obj)
	{ 
 		var url;
 		url="VacantBedRecordRptCNT.cnt?hmode=DEPTCMB&hospCode="+obj.value;
		ajaxFunction(url,"4");
	}
function getWardCombo(obj)
{ 
 		
	 		var url="VacantBedRecordRptCNT.cnt?hmode=WARDCMB&deptunitCode="+obj.value+"&deptCode="+document.forms[0].strDeptCode[document.forms[0].strDeptCode.selectedIndex].value;
	 		ajaxFunction(url,"2");
...
<body >
<html:form action="/reports/VacantBedRecordRptCNT.cnt" method="post">
	<div class="normalMsg" id="normalMsg"></div>
<tag:tab tabLabel="Vacant Bed Record" selectedTab="FIRST" align="center" width="TABLEWIDTH"></tag:tab>

	<table class="TABLEWIDTH" align="center" cellspacing="1px" cellpadding="1px">   
		<tr class="HEADER">
			<td colspan="2">Vacant Bed Record</td>
		</tr>
		<tr>
			...
			<bean:write name="vacantBedRecordRpt" property="strHospNameValues" filter="false"/>
			</select>
			</td>			
		</tr>
		...
		<tr>
			...
			<td width="50%" class="CONTROL">
			<html:checkbox property="strIsFooter" name="vacantBedRecordRpt" value="1"></html:checkbox>
			</td>			
		</tr>
		<tr>
...
<input type="hidden" name="strCurrentDate" value="${vacantBedRecordRpt.strCurrentDate}"/>
<input type="hidden" name="strCurrentTime" value="${vacantBedRecordRpt.strCurrentTime}"/>
