...
<form name="multirow">
<logic:equal value="0" name="requestForContigency" property="strCostRequired">
<div id="rowAdded1" style="display:none">
<table class="TABLEWIDTH" align="center"  bgcolor='#CC9966'  cellpadding="1px" cellspacing="1px" >
<tr>
<td class="multiControl" width="29%">
...
<td class="multiControl" width="21%">
...
<td class="multiControl"  width="15%">
   <input type="text" name="strReqQty" id="strReqQty#delIndex#" class="txtFldMin" maxlength ="5"  onkeypress="return validateData(event,7);">
...
<logic:equal value="1" name="requestForContigency" property="strCostRequired">
<div id="rowAdded1" style="display:none">
<table class="TABLEWIDTH" align="center" bgcolor='#CC9966' cellpadding="1px" cellspacing="1px" >
<tr>
<td class="multiControl" width="29%">
