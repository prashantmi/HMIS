...
<html:form name="transferDemandReqTrans"
	...
	<table class="TABLEWIDTH" align="center" border="0" cellpadding="1px"
		cellspacing="1px">
		<tr class="HEADER">
			<td colspan="4">Item/Drug Transfer &gt;&gt; Demand &gt;&gt; Generation</td>
		</tr>
		...
		<tr>
			...
			<td width="25%" class="CONTROL">
			     <bean:write	name="transferDemandReqTrans" property="strReqDate" filter="false" />
			</td>
		...
		<tr>
			...
			<td class="CONTROL" width="15%">
			   <input type="text"	name="strDemandedQty" maxlength="8" class="txtFldMax"  onkeypress="return validateData(event,5);" /></td>
		...
		<tr>
			...
			<td class="LABEL" width="25%"><font  color="red">*</font>Status</td>
