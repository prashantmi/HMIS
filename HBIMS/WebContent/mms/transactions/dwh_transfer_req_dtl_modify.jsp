...
<html:form name="transferReqTrans"
	...
	<table class="TABLEWIDTH" align="center" border="0" cellpadding="1px"
		cellspacing="1px">
		<tr class="HEADER">
			<td colspan="4">Item/Drug Transfer &gt;&gt; Request &gt;&gt; Modify</td>
		</tr>
		...
		<tr>
			...
			<td class="CONTROL" width="25%">
			   <input type="text"	name="strDemandedQty" maxlength="8" value="${transferReqTrans.strReqQtyView}"  class="txtFldMax"  onkeypress="return validateData(event,5);" />
              	<bean:write	name="transferReqTrans" property="strUnitNameView" filter="false" /></td>
	...
	<input type="hidden" name="strTmpStoreId"	    value="${transferReqTrans.combo[0]}" />
	...
	<input type="hidden" name="strModifyChk"  	value="${transferReqTrans.strChk}">
