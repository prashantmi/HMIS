...
<head>	
<meta charset=UTF-8">
<title>PO Generation Desk</title>
	...
	<table class="TABLEWIDTH" align="center" cellpadding="1px"	cellspacing="1px">
	   ...
	   <tr>
			...
			<td class="CONTROL" width="25%" colspan="1">			
			    <html:select name="PODeskGenerateTransBeanNew" property="strIndentPeriodValue" styleClass="comboNormal" >
	          	   <html:option value="1"> <bean:write name="PODeskGenerateTransBeanNew" property="strCurrentFinancialYear" filter="false"/></html:option>
				   <html:option value="2"> <bean:write name="PODeskGenerateTransBeanNew" property="strNextFinancialYear" filter="false"/></html:option>	          	
	            </html:select>			   
			</td>
		...
		<tr>
			...
			<td width="25%" class="CONTROL"><html:hidden
				name="PODeskGenerateTransBeanNew" property="strStoreId"></html:hidden><bean:write
				name="PODeskGenerateTransBeanNew" property="strStoreName"
				filter="false"></bean:write></td>
				
				
				<td width="25%" class="LABEL"><font color="red">*</font>Supplier(*Marked
			are Rated Supplier)</td>
			<td width="25%" class="CONTROL">
			<div id="divSupplier"><select name="strSupplierId" class="comboMax" onChange="resetCombo();">
							
				<bean:write name="PODeskGenerateTransBeanNew"  property="strSupplierValues" filter="false"></bean:write>
			</select>
			</div>
		...
		<tr>
			...
			<td width="25%" class="CONTROL">
			<html:hidden
				name="PODeskGenerateTransBeanNew" property="strItemCat"></html:hidden><bean:write
			...
			<td width="25%" class="CONTROL">
			<html:hidden
				name="PODeskGenerateTransBeanNew" property="strPOTypeId"></html:hidden><bean:write
				name="PODeskGenerateTransBeanNew" property="strPOType"
				filter="false"></bean:write>
			</td>
		</tr>
   ...
   <div  id="poRateDivId" style="display:none">
	...
	<table class="TABLEWIDTH" align="center" cellpadding="1px"
		...
		<tr>
			...
			<td width="25%" class="CONTROL">
			    <div id="deliveryDaysID"><input type="text"	maxlength="8"  name="strDDeliveryDays"  class="txtFldMin"> </div> 
		...
		<tr>
			...
			Source</div></td>
			<td width="25%" class="CONTROL">
			<div id="divPurchaseSource" style='display:none;'><select name="strDPurchaseSource" class="comboMax">
				<bean:write name="PODeskGenerateTransBeanNew"
					property="strPurchaseSourceValues" filter="false"></bean:write>
			</select></div>
			</td>
			<td colspan="1" class="LABEL"><div style="display:none;">Supplier Contracted Quantity</div></td>
			<td colspan="1" class="CONTROL"><div id="contractedDeliveryDaysId" style="display:none;"></div></td>
		...
		<tr>
				...
				<td width="25%" class="CONTROL"><div style="display:none"><dateTag:date name="strVerifiedDate" value =""></dateTag:date></div></td>
			</tr>
		<tr>
	...
	<input type="hidden" name="strINRCurrencyId"  value="${ PODeskGenerateTransBeanNew.strINRCurrencyId}" />
