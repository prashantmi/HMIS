...
<script language="JavaScript" src="../js/condemnationRequest.js"></script>
...
<html:form action="/transactions/CondemnationRequestForNonConsumTransCNT.cnt"  name="requestCondemnationTransADDBean" type="mms.transactions.controller.fb.CondemnationRequestForNonConsumTransFB" method="post">

    <div class="errMsg"     id="errMsg"><bean:write name="requestCondemnationTransADDBean" property="strErr"/></div>
	<div class="warningMsg" id="warningMsg"><bean:write name="requestCondemnationTransADDBean" property="strWarning"/></div>
	<div class="normalMsg"  id="normalMsg"><bean:write name="requestCondemnationTransADDBean" property="strMsg"/></div>


<center>
<tag:tab tabLabel="Condemnation Request For Non Consumable Item" selectedTab="FIRST" align="center" width="TABLEWIDTH">
	</tag:tab>
</center>
   ...
   <tr> 
    ...
    <td width="25%" class="CONTROL"><bean:write name="requestCondemnationTransADDBean" property="strStoreName" filter="false"/></td>   
    <td width="25%" class="LABEL">Req Date:</td>
    
    <td width="25%" class="CONTROL"><bean:write name="requestCondemnationTransADDBean" property="strReqDate" filter="false"/></td>   
   </tr>
   <tr> 
   
   <td width="25%" class="LABEL">Item Category:</td>
    <td width="25%" class="CONTROL"><bean:write name="requestCondemnationTransADDBean" property="strItemCatName" filter="false"/></td>   
    ...
    <td width="25%" class="CONTROL"><select class='comboNormal' name='strToStoreCombo'> 
		              <bean:write name="requestCondemnationTransADDBean" property="strToStoreCombo" filter="false"/>  
		    </select></td> 
    </tr>
 ...
 onclick='getItemSelectPopup();'></div></td>
	 ...
	 <div id="costDivNotReqId" style=display:none>	
	   <table class="TABLEWIDTH" bgcolor="black" align="center" cellpadding="1px" cellspacing="1px">		
			<tr>
			 ...
			 <td width="13%" class="multiLabel">Avalaible Qty</td>
			 <td width="19%" class="multiLabel">Rate/Unit</td>
			 <td width="20%" class="multiLabel">Condemnation Qty</td>
			 <td width="15%" class="multiLabel"><font size="2" color="red">*</font>Unit</td>
    ...
    <div id="totalCostId" style=display:none>		       
        <table class="TABLEWIDTH" align="center" cellpadding="1" cellspacing="1">  
     <tr> 
         <td width="90%" class="LABEL"><div id="apprate" style="color:blue">Total Approx Cost(Rs):</div></td>
  ...
  <div id="blanket" style="display:none;"></div>
   ...
   <input type="hidden" name="strPath"         value="${requestCondemnationTransADDBean.strPath}">
   <input type="hidden" name="strStoreId"      value="${requestCondemnationTransADDBean.strStoreId}"> 
   <input type="hidden" name="strStoreTypeId"  value="${requestCondemnationTransADDBean.strStoreTypeId}"> 
   <input type="hidden" name="strItemCatNo"    value="${requestCondemnationTransADDBean.strItemCategory}"> 
   <input type="hidden" name="strIndentTypeId" value="${requestCondemnationTransADDBean.strIndentTypeId}">
   <input type="hidden" name="strCostRequired" value="${requestCondemnationTransADDBean.strCostRequired}"> 
   
	<cmbPers:cmbPers/>
</html:form>
<jsp:include page="itemDeskCondemnationNCSearch.jsp"></jsp:include>
