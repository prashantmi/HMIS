...
<table width='150%' align="center" cellpadding="1px" cellspacing="0px" id="td#delIndex#">
  <tr>  
				...
				<input type="text" size="1"  name="strSNo" value=""  readonly="readonly" style="border: 0px; LINE-HEIGHT: 16px; text-align: center; FONT-FAMILY: Geneva, Verdana, 'sans-serif'; HEIGHT: 20px;width:20px;"  >
						...
						<!--  </TD>-->
						<TD WIDTH="5%" CLASS="multiRPTControl" id='td16#delIndex#'><input type="text" maxlength="10"  class="txtFldNormal" 	 name="strMultiRowPurRate"         id="strMultiPurRowRate#delIndex#"            value =""  onkeypress="return validateData(event,7);"  onBlur="checkDecimalValue(this);"></TD>
						<TD WIDTH="5%" CLASS="multiRPTControl" id='td19#delIndex#'><input type="text" maxlength="10"  class="txtFldMin" 	 name="strMultiRowTax"         id="strMultiRowTax#delIndex#" onchange="calSalePrice(this,'#delIndex#');"            value =""  onkeypress="return validateData(event,7);"  onBlur="checkDecimalValue(this);"></TD>
						<TD WIDTH="5%" CLASS="multiRPTControl" id='td6#delIndex#'><input type="text" maxlength="10"  class="txtFldNormal" 	 name="strMultiRowRate"         id="strMultiRowRate#delIndex#"     disabled='disabled'       value =""  onkeypress="return validateData(event,7);"  onBlur="checkDecimalValue(this);"></TD>
						<TD WIDTH="5%" CLASS="multiRPTControl" id='td17#delIndex#'><input type="text" maxlength="10"  class="txtFldNormal" 	 name="strMultiRowHandlingCharges"         id="strMultiRowHandlingCharges#delIndex#"  value =""  onkeypress="return validateData(event,7);" onchange="calCost(this,'#delIndex#');" /></TD>
						<TD WIDTH="5%" CLASS="multiRPTControl" id='td18#delIndex#'><input type="text" maxlength="10"  class="txtFldNormal" 	 name="strMultiRowCosttoPat"         id="strMultiRowCosttoPat#delIndex#"            value =""  onkeypress="return validateData(event,7);"  onBlur="checkDecimalValue(this);" disabled='disabled'></TD>
						...
						<TD WIDTH="5%" CLASS="multiRPTControl"  id='td12#delIndex#'><input type="text" maxlength="25"  class="txtFldNormal"  name="strMultiRowPONo"        id="strMultiRowPONo#delIndex#"      value =""  onkeypress="return validateData(event,17);"></TD>
...
<table width='150%' align="center" cellpadding="1px" cellspacing="0px" id="td#delIndex#">
  <tr>  
						...
						<TD WIDTH="4%" CLASS="multiRPTControl" id='td20#delIndex#'><input type='text' name="strMultiRowPackSizeId" id="strMultiRowPackSizeId#delIndex#" maxlength='3' onChange="calPurRate1(this,'#delIndex#')"  class="txtFldNormal" value="" onkeypress="return validateData(event,5);" ></TD>
						<TD WIDTH="5%" CLASS="multiRPTControl" id='td16#delIndex#'><input type="text" maxlength="10"  class="txtFldNormal" 	 name="strMultiRowPurRatePerPack"         id="strMultiPurRowRatePerPack#delIndex#"    onChange="calPurRate(this,'#delIndex#')"        value =""  onkeypress="return validateData(event,7);"  onBlur="checkDecimalValue(this);"></TD>
						...
						<TD WIDTH="5%" CLASS="multiRPTControl"  id='td12#delIndex#'><input type="text" maxlength="25"  class="txtFldNormal"  name="strMultiRowPONo"        id="strMultiRowPONo#delIndex#"      value =""  onkeypress="return validateData(event,7);"></TD>
