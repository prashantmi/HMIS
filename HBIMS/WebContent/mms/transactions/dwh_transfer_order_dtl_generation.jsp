...
<script language="Javascript" src="../js/transfer_order_dtl_generation.js"></script>
		...
		<table class="TABLEWIDTH" align="center" border="0" cellpadding="1px"
			...
			<tr>
				...
				<td width="25%" class="CONTROL"><bean:write
						name="TransferApprovalTransBean" property="strCtDate" filter="false" /></td>

			</tr>
		</table>

		<table class="TABLEWIDTH" align="center" border="0" cellpadding="0px"
			cellspacing="0px">
				<tr class='TITLE'>
				<td width='75%'>Demand Request Details</td>	 
				<td   width="25%" align="right">Store
					Name <select
					name="strStoreId" class='comboNormal'
					onChange='getDemandRequestDetails(this);'>
						<bean:write name="TransferApprovalTransBean" property="strDwhNames"
							filter="false"></bean:write>
				</select></td>
			</tr>
		</table>

		<div id="demandRequestDtlsDivId">
			<bean:write name="TransferApprovalTransBean"
				property="strDemandRequestDetails" filter="false"></bean:write>
		</div>


		<div id="transferingDtlsDivId" style="display:none;"></div>
		...
		<table class="TABLEWIDTH" align="center" border="0" cellpadding="1px"
			...
			<tr>
				...
				<td align="center"><img style="cursor: pointer;"
					src="../../hisglobal/images/btn-sv.png" onClick="validate_orderGenerate();"
...
<div class='popup' id='itemDtlId' style="display:none">
		<table width='300' border="0" cellspacing ="0px" cellpadding="0px">
			<tr class="HEADER"> 
				<th align='left'><div id="popUpItemId" style='color:blue;'>Balance Qty. Details</div></th>
