...
<form name="multirow">
<logic:equal value="0" name="requestCondemnationTransADDBean" property="strCostRequired">
...
<logic:equal value="1" name="requestCondemnationTransADDBean" property="strCostRequired">
<div id="rowAdded1" style="display:none">
