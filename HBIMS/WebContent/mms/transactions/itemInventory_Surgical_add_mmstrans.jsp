...
<body>
<html:form name="itemInventorySurgicalTransBean"
	action="/transactions/ItemInventorySurgicalTransCNT"
	type="mms.transactions.controller.fb.ItemInventorySurgicalTransFB">


	<div class="errMsg" id="errMsg"><bean:write
		name="itemInventorySurgicalTransBean" property="strErr" /></div>
	<div class="warningMsg" id="warningMsg"><bean:write
		name="itemInventorySurgicalTransBean" property="strWarning" /></div>
	<div class="normalMsg" id="normalMsg"><bean:write
		name="itemInventorySurgicalTransBean" property="strMsg" filter="false" /></div>

	<center><tag:tab tabLabel="Item Inventory for Surgical Items" selectedTab="FIRST" align="center" width="TABLEWIDTH">
	</tag:tab></center>
	...
	<table class="TABLEWIDTH" align="center" border="0" cellpadding="1px" cellspacing="1px">
		...
		<tr>
			...
			<td width="25%" class="CONTROL"><bean:write
				name="itemInventorySurgicalTransBean" property="strStoreName" filter="false" />
			</td>
			<td width="25%" class="LABEL">Item Category</td>
			<td width="25%" class="CONTROL"><bean:write
				name="itemInventorySurgicalTransBean" property="strItemCategoryName"
				filter="false" /></td>
		</tr>
		...
		<tr>
			...
			<td width="25%" class="CONTROL"><bean:write
				name="itemInventorySurgicalTransBean" property="strGroupName" filter="false" />
			</td>
			...
			<td class="CONTROL" width="25%"><select name="strSubGroupId"
				...
				<bean:write name="itemInventorySurgicalTransBean"
		...
		<tr>
			...
			<td class="CONTROL" width="25%"><dateTag:date
				...
				value="${itemInventorySurgicalTransBean.strCtDate}"></dateTag:date></td>
		...
		<tr>
			...
			Date</td>
			<td class="CONTROL" width="25%"><dateTag:date
				name="strReceivedDate" value="${itemInventorySurgicalTransBean.strCtDate}"></dateTag:date></td>
	...
	<logic:equal name="itemInventorySurgicalTransBean" property="strWarrantyFlag"
		value="1">
		...
		<table class="TABLEWIDTH" align="center" border="0" cellpadding="1px"
			...
			<tr>
				...
				<html:checkbox property="strIsWarrantyDetails" name="itemInventorySurgicalTransBean" value="1" onclick="showOrHideDetails(this,'warrantyItemDtlsDivId');">Whether Warranty Details Required</html:checkbox> 
				</td>
			</tr>
		</table>
	...
	<logic:equal name="itemInventorySurgicalTransBean" property="strInstallFlag"
		value="1">
		...
		<table class="TABLEWIDTH" align="center" border="0" cellpadding="1px"
			...
			<tr>
				<td colspan="4" class="TITLE" width="25%">
				<html:checkbox property="strIsInstallDetails" name="itemInventorySurgicalTransBean" value="1" onclick="showOrHideDetails(this,'installItemDtlsDivId');">Whether Install Details Required</html:checkbox> 
				</td>
			</tr>
		</table>
	...
	Changed by: Aritra 
	 --%>
	 <%-- 
<logic:equal name="itemInventorySurgicalTransBean" property="strFreeItemFlag"	value="1">
	<table class="TABLEWIDTH" align="center" border="0" cellpadding="1px"
		cellspacing="1px">
...
<!-- 	<table class="TABLEWIDTH" align="center" border="0" cellpadding="1px" cellspacing="1px">
	...
	<input type="hidden" name="strStoreId"
		value="${itemInventorySurgicalTransBean.combo[0]}" />
	<input type="hidden" name="strStoreName"
		value="${itemInventorySurgicalTransBean.strStoreName}" />
	<input type="hidden" name="strGroupId"
		value="${itemInventorySurgicalTransBean.combo[2]}" />
	<input type="hidden" name="strGroupName"
		value="${itemInventorySurgicalTransBean.strGroupName}" />

	<input type="hidden" name="strItemCategoryNo"
		value="${itemInventorySurgicalTransBean.strItemCategoryNo}" />
	<input type="hidden" name="strItemCategoryName"
		value="${itemInventorySurgicalTransBean.strItemCategoryName}" />

	<input type="hidden" name="strCtDate"
		value="${itemInventorySurgicalTransBean.strCtDate}">

	<input type="hidden" name="strDefaultCurrencyCode"
		value="${itemInventorySurgicalTransBean.strDefaultCurrencyCode}">
		
		<input type="hidden"  name="strConfigIssueRate"  value="${itemInventorySurgicalTransBean.strConfigIssueRate}">
		
        <input type="hidden"  name="strIssueRateConfigFlg"  value="${itemInventorySurgicalTransBean.strIssueRateConfigFlg}">
