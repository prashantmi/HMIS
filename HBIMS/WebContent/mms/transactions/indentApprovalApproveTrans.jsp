...
function itemDetails_Ajax()
{
	...
	url="IndentApprovalApproveTransCNT.cnt?hmode="+mode;//+"&itemId="+document.forms[0].strSetSachetId.value; 
 	ajaxFunction(url,"1");
}
...
<html:form name="indentApprovalApproveTransBean" action="transactions/IndentApprovalApproveTransCNT"
	type="mms.transactions.controller.fb.IndentApprovalApproveTransFB">
	
<center>
	<div id="errMsg" class="errMsg"><bean:write name="indentApprovalApproveTransBean" property="strErr" /></div>
	<div id="warningMsg" class="warningMsg"><bean:write name="indentApprovalApproveTransBean" property="strWarning"/></div>
	<div id="normalMsg" class="normalMsg"><bean:write name="indentApprovalApproveTransBean" property="strMsg"/></div>
	</center>
...
<center>
<tag:tab tabLabel="Indent Approval Details Transaction" selectedTab="FIRST" align="center" width="TABLEWIDTH">
	</tag:tab>
</center>
