...
<table width='150%' align="center" cellpadding="1px" cellspacing="0px" id="td#delIndex#">
  <tr>  
				...
				<input type="text" size="1"  name="strSNo" value=""  readonly="readonly" style="border: 0px; LINE-HEIGHT: 16px; text-align: center; FONT-FAMILY: Geneva, Verdana, 'sans-serif'; HEIGHT: 20px;width:20px;"  >
						...
						<TD WIDTH="6%" CLASS="multiRPTControl" id='td6#delIndex#'><input type="text" maxlength="10"  class="txtFldMin" 	 name="strMultiRowRate"         id="strMultiRowRate#delIndex#"            value =""  onkeypress="return validateData(event,7);"  onBlur="checkDecimalValue(this);"></TD>
						<TD WIDTH="9%" CLASS="multiRPTControl" id='td7#delIndex#'>						
						...
						<TD WIDTH="9%" CLASS="multiRPTControl"  id='td11#delIndex#'><select  name="strMultiRowMfgId"     id="strMultiRowMfgId#delIndex#"         class="comboNormal"  onchange="checkMfgName(this,'#delIndex#');"><bean:write name="itemInventoryProgramSurgicalTransBean" property="strManufactureCombo" filter="false" /></TD>
...
<table width='150%' align="center" cellpadding="1px" cellspacing="0px" id="td#delIndex#">
  <tr>  
						...
						<TD WIDTH="5%" CLASS="multiRPTControl" id='td1#delIndex#'>						
						 <div id="ExistingBatchId"><select name="strMultiRowExistingBatchId"  id="strMultiRowExistingBatchId#delIndex#" class="comboMin" onchange=""><option value="0">Select Value</option></select></div>
						</TD>
						...
						<!--  </TD>-->
						<TD WIDTH="5%" CLASS="multiRPTControl" id='td6#delIndex#'><input type="text" maxlength="10"  class="txtFldMin" 	 name="strMultiRowRate"         id="strMultiRowRate#delIndex#"            value =""  onkeypress="return validateData(event,7);"  onBlur="checkDecimalValue(this);"></TD>
						
						<TD WIDTH="5%" CLASS="multiRPTControl" id='td7#delIndex#'>						
						<div id="RateUnitId"><select name="strMultiRowRateUnitId" id="strMultiRowRateUnitId#delIndex#" class="comboMin" onchange=""><option value="0">Select Value</option></select></div>
						</TD>
						...
						<TD WIDTH="7%" CLASS="multiRPTControl"  id='td11#delIndex#'><select  name="strMultiRowMfgId"     id="strMultiRowMfgId#delIndex#"         class="comboNormal"  onchange="checkMfgName(this,'#delIndex#');"><bean:write name="itemInventoryProgramSurgicalTransBean" property="strManufactureCombo" filter="false" /></TD>
						...
						<TD WIDTH="5%" CLASS="multiRPTControl"  id='td12#delIndex#'><input type="text" maxlength="25"  class="txtFldNormal"  name="strMultiRowPONo"        id="strMultiRowPONo#delIndex#"      value =""  onkeypress="return validateData(event,17);"></TD>
						<TD WIDTH="5%" CLASS="multiRPTControl"  id='td13#delIndex#'><input type="text" maxlength="40"  class="txtFldNormal"  name="strMultiRowTenderNo"    id="strMultiRowTenderNo#delIndex#"  value =""  onkeypress="return validateData(event,17);"></TD>
						<TD WIDTH="5%" CLASS="multiRPTControl"  id='td14#delIndex#'><input type="text" maxlength="25"  class="txtFldNormal"  name="strMultiRowInvoiceNo"        id="strMultiRowInvoiceNo#delIndex#"      value =""  onkeypress="return validateData(event,17);"></TD>
