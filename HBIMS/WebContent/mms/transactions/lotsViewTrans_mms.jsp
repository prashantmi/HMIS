...
<body onload="">
<html:form name="condemnRegisterViewBean" action="/transactions/LotsDetailViewTransCNT"
	type="mms.transactions.controller.fb.LotsDetailViewTransFB">
	
<center>
	<div id="errMsg" class="errMsg"><bean:write name="lotsDetailViewBean" property="strErrMsg" /></div>
	<div id="warningMsg" class="warningMsg"><bean:write name="lotsDetailViewBean" property="strWarningMsg"/></div>
	<div id="normalMsg" class="normalMsg"><bean:write name="lotsDetailViewBean" property="strNormalMsg"/></div>
	
</center>
	
        <tag:tab tabLabel="Lots Detail View"
	...
	<tr class="HEADER">
			<td colspan="4">Lots Details View&gt;&gt;</td>
	</tr>
	
	<tr>
    <td class="LABEL" width="25%" >Store Name</td>
    <td width="25%" class ="CONTROL" >
    <bean:write name="lotsDetailViewBean" property="strStoreName" filter="false" />
     </td>
     <td class="LABEL" width="25%" >Item Category Name</td>
    <td width="25%" class ="CONTROL" >
    <bean:write name="lotsDetailViewBean" property="strItemCategoryName" filter="false" />
     </td>
  </tr>	
    </table>
		...
		<tr>
			...
			<div id="plusItemDetailId" align="left" style="display:none;">
					<img src="../../hisglobal/images/plus.gif" 
									onClick="view1('plusItemDetailId','minusItemDetailId','condemnRequestId');" style="cursor: pointer; "/>
						Item/Drug Details
						
					</div>
					<div id="minusItemDetailId" style="display:block;" align="left">
						<img src="../../hisglobal/images/minus.gif" 
								onClick="view2('plusItemDetailId','minusItemDetailId','condemnRequestId');" style="cursor: pointer; "/>
								Item/Drug Details
					</div>
				</td>
		</tr>
...
<bean:write name="lotsDetailViewBean" property="strItemDtl" filter="false" /> 
</div>
<table class="TABLEWIDTH" align="center" cellpadding="1px" cellspacing="1px">
  <tr>
  	<td class="TITLE" colspan="4">Cancel Details</td>
  </tr>
    <tr>
    <td class="LABEL" width="25%" >Cancel Date</td>
    <td width="25%" class ="CONTROL" >
    <bean:write name="lotsDetailViewBean" property="strCancelDate" filter="false" />
     </td>
     <td class="LABEL" width="25%" >Cancel By</td>
    <td width="25%" class ="CONTROL" >
    	<bean:write name="lotsDetailViewBean" property="strCancelBy" filter="false" />
     </td>
  </tr>	
  <tr>
    <td class="LABEL" width="25%" >Cancel Remarks</td>
    <td width="25%" class ="CONTROL" >
    <bean:write name="lotsDetailViewBean" property="strCancelRemarks" filter="false" />
     </td>
    ...
    <td width="25%" class ="CONTROL" >
    <bean:write name="lotsDetailViewBean" property="strCondemnationType" filter="false" />
     </td>
     <td class="CONTROL" width="25%" colspan="2"></td>
    </tr>
   </table>
...
<input type="hidden" name="strPath" value="${lotsDetailViewBean.strPath}"/>
<cmbPers:cmbPers/>
</html:form>
