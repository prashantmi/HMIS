...
<title>Issue to  Modification</title>
...
<script language="Javascript" src="../js/dwh_main_ThirdPartyIssueDtl_trans.js"></script> 
...
<html:form action="/transactions/ThirdPartyIssueDtlModificationTransCNT.cnt"  name="thirdPartyIssueDtlModificationTransFB" type="mms.transactions.controller.fb.ThirdPartyIssueDtlModificationTransFB" method="post">

    <div class="errMsg"     id="errMsg"><bean:write name="thirdPartyIssueDtlModificationTransFB" property="strErr"/></div>
	<div class="warningMsg" id="warningMsg"><bean:write name="thirdPartyIssueDtlModificationTransFB" property="strWarning"/></div>
	<div class="normalMsg"  id="normalMsg"><bean:write name="thirdPartyIssueDtlModificationTransFB" property="strMsg"/></div>


<center>
<tag:tab tabLabel="Third Party Voucher Modification"  align="center" width="TABLEWIDTH">
	</tag:tab>
</center>
		...
		<tr>
			...
			<td width="20%" class="CONTROL">
			     ...
			     <select name="strStoreName" class="comboMax"   onChange="getIndentStoreCombo();">
                        <bean:write name="thirdPartyIssueDtlModificationTransFB" property="strStoreName" filter="false"/>
                 </select>
            </td>
			<td width="20%" class="LABEL"><font color="red">*</font>Third Party Name:</td>

			<td width="20%" class="CONTROL">
			
			<div id="IndentingStore">
			     <select class='comboMax' name='strThirdPartyId' onchange='getVoucherCombo();'> 
		              <bean:write name="thirdPartyIssueDtlModificationTransFB" property="strThirdPartyValues" filter="false"/>
		         </select>
		     </div>    
...
<table class="TABLEWIDTH" align="center" cellspacing="1px">
	...
	<tr>
			...
			<input type="text" name="strReceivedById" value="" size=30>
	            </div>  
	        </td>
	</tr>
  ...
  <table  class="TABLEWIDTH" align="center" cellspacing="1px" cellpadding="1px" bgcolor='black'> 
    ...
    <input type="hidden" name="strCurrentDate" value="${thirdPartyIssueDtlModificationTransFB.strCurrentDate}"/>
    <input type="hidden" name="strModDate" value="${thirdPartyIssueDtlModificationTransFB.strModDate}"/>
    <input type="hidden" name="strPrevBudgetAvl" value="${thirdPartyIssueDtlModificationTransFB.strPrevBudgetAvl}"/>
    <input type="hidden" name="strCurrentBudgetAvl"  value="${thirdPartyIssueDtlModificationTransFB.strCurrentBudgetAvl}"/> 
