...
<table class="TABLEWIDTH" align="center" cellpadding="1px" cellspacing="1px" bgcolor='#6097BC'  id="td#delIndex#" >
 <tr>
    <td class="multiPOControl" width="30%">
	...
	<td class="multiPOControl"  width="5%">
		<div id="itemParaId4#delIndex#"></div>
	</td>
	
	<td class="multiPOControl"  width="10%">
		<input type="text" name="strConsumptionQty" maxlength="7" id="strConsumptionQty#delIndex#" class='txtFldMin' onkeypress="return validateData(event,5);" onkeyup="return checkQtyMiscValidation('#delIndex#','strConsumptionQty','strUnitName');">
	</td>
	...
	<td class="multiPOControl"  width="10%">
		<div id="itemParaId13#delIndex#"></div>
	</td>
	<td class="multiPOControl"  width="10%">
		<div id="itemParaId12#delIndex#"></div>
	</td>
	<td class="multiPOControl"  width="10%">
		<div id="itemParaId64#delIndex#"></div>
	</td>
