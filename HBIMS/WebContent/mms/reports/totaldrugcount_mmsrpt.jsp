...
function getItemCatCmb(){ 
		...
		if(document.forms[0].strStoreId.value!=0){
			var url ="TotalDrugCountRptCNT.cnt?hmode=ITEMCATCMB&storeId="+document.forms[0].strStoreId.value;
	 		ajaxFunction(url,"1");
	 	}else{
...
{ 
	...
	if(document.getElementsByName("whetherConsolidatedStockForAllInstitutseOfDistrictDrugWarehouse")[0].checked==true)
	{
			...
			{
				var url ="TotalDrugCountRptCNT.cnt?hmode=ITEMCATCMB&storeId="+document.forms[0].strDistrictStoreId.value;
		 		ajaxFunction(url,"2");
...
<div class="errMsg" id="errMsg"><bean:write name="totaldrugcountRpt" property="strErrMsg"/></div>
<div class="normalMsg" id="normalMsg"><bean:write name="totaldrugcountRpt" property="strNormalMsg"/></div>
<div class="warningMsg" id="warningMsg"><bean:write name="totaldrugcountRpt" property="strWarningMsg"/></div>


	<tag:tab tabLabel="Total Drug Count Report"
	...
	<tr class="HEADER">
		...
		<tr	id="drugWarehouseDivId">
			...
			<td width="50%" colspan="2" class="CONTROL"><select
				name="strStoreId" class="comboMax" onchange="">
		...
		<tr>
			...
			<td width="50%" colspan="2" class="CONTROL">
				...
				<select name="strDistrictStoreId" class="comboMax" onchange="getItemCatCmb();">
					<bean:write name="totaldrugcountRpt" property="strDistrictStoreValues" filter="false"/>
				</select>
		...
		<tr>
			<td width="50%" colspan="2" class="LABEL"><font color="red">*</font>Category</td>
				<td width="50%" colspan="2" class="CONTROL">
					<div id="itemCatDivId">
					<logic:equal name="totaldrugcountRpt" property="strUserLevel" value="6" >
					...
					<logic:notEqual name="totaldrugcountRpt" property="strUserLevel" value="6" >
					<select	name="strItemCatNo" class="comboNormal">
							<option value="0">Select Value</option>								
							<option value="10">Drug</option>					
						</select>
	    ...
	    <div id="expDateDiv" style="display:none;">
				...
				<tr>
						...
						<td width="50%"  class="CONTROL">
					              <dateTag:date name="strDueDate" value="${totaldrugcountRpt.strCurrentDate}" />
					    </td>
		...
		<tr>
			...
			<td width="50%" colspan="2" class="CONTROL">
			<html:checkbox property="strIsFooter" name="totaldrugcountRpt" value="1"></html:checkbox>
			</td>
...
<input type="hidden" name="strCurrentDate" value="${totaldrugcountRpt.strCurrentDate}"/>
<input type="hidden" name="strUserLevel" value="${totaldrugcountRpt.strUserLevel}"/>
