...
<html>
<head>
<title>List of Slow/Fast Moving Items</title>
...
function validate(){
	...
	var hisValidator = new HISValidator("slowfastitemsRpt");
...
function getItemCatCmb(){ 
		...
		if(document.forms[0].strStoreId.value!=0){
			var url ="ListSlowFastMovingItemsRptCNT.cnt?hmode=ITEMCATCMB&storeId="+document.forms[0].strStoreId.value;
	 		ajaxFunction(url,"1");
	 	}else{
...
<html:form action="/reports/ListSlowFastMovingItemsRptCNT" method="post">
	
<div class="errMsg" id="errMsg"><bean:write name="slowfastitemsRpt" property="strErrMsg"/></div>
<div class="normalMsg" id="normalMsg"><bean:write name="slowfastitemsRpt" property="strNormalMsg"/></div>
<div class="warningMsg" id="warningMsg"><bean:write name="slowfastitemsRpt" property="strWarningMsg"/></div>


	<tag:tab tabLabel="List of Slow/Fast Moving Items"
                        selectedTab="FIRST" align="center" width="TABLEWIDTH">
                  </tag:tab>

	<table class="TABLEWIDTH" align="center" cellspacing="1px" cellpadding="1px" >   
	<tr class="HEADER">
			<td colspan="4">List of Slow/Fast Moving Items</td>
		</tr>
		<tr>
			...
			<td width="50%" colspan="2" class="CONTROL">
				<select name="strStoreId" class="comboNormal" onchange="getItemCatCmb();">
					<bean:write name="slowfastitemsRpt" property="strStoreValues" filter="false" />
				</select>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="CONTROL" colspan="2"><dateTag:date name="strFromDate"
				value="${slowfastitemsRpt.strCurrentDate}" /></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td width="50%" colspan="2" class="CONTROL">
			<html:checkbox property="strIsFooter" name="slowfastitemsRpt" value="1"></html:checkbox>
			</td>
...
<input type="hidden" name="strStoreName" value="${slowfastitemsRpt.strStoreName}" />
<input type="hidden" name="strCurrentDate" value="${slowfastitemsRpt.strCurrentDate}"/>
