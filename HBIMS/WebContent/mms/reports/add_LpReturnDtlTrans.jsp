...
<table class="TABLEWIDTH" align="center" cellpadding="1px" cellspacing="1px">
		...
		<tr class="HEADER">
			<td colspan="4">LP Return&gt;&gt; Add</td>
		</tr>
</table>

<table class='TABLEWIDTH' align='center'cellpadding='1px' cellspacing='1px'>
	<tr>
		<td class='LABEL' width='50%'>Drug Warehouse Name</td>
...
<table class='TABLEWIDTH' align='center'cellpadding='1px' cellspacing='1px'>
					<tr>
						<td class='TITLE' colspan='4'>
							<div id="ii" style="color:blue;">Issue Detail</div>
						</td>
...
<table class='TABLEWIDTH' align='center'cellpadding='1px' cellspacing='1px'>
					...
					<tr>
						<td class='TITLE' colspan='4'>
							<div id="u" style="color:blue;">Issue Detail</div>
						</td>
...
<table class='TABLEWIDTH' align='center'cellpadding='1px' cellspacing='1px'>
					...
					<tr>
						<td class='TITLE' colspan='4'>
							<div id="r" style="color:blue;">Return Detail</div>
						</td>
				...
				<td class='LABEL' width='25%'>Issue Date</td>
					...
					<tr>
					<td class='LABEL' width='25%'>Drug Warehouse Name</td>
					<td class='CONTROL' width='25%' colspan='1'>
						<bean:write property="strStoreName" name="lpIssueDeskTransBean" filter="false"/>
...
<table class="TABLEWIDTH" align="center" cellspacing="1px" cellpadding="1px">
		<tr>
			...
			<div id="plusPatientDetailId" align="left" style="display:block;color:blue;">
					...
					<div id="minusPatientDetailId" style="display:none;color:blue;" align="left">
		...
		<tr>
			<td  colspan="4" class="TITLE">
			<div id="plusRequestItemDtlId" align="left" style="display:none;color:blue;">
					<img src="../../hisglobal/images/plus.gif" 
									onClick="view1('plusRequestItemDtlId','minusRequestItemDtlId','strRequestItemDtlId');" style="cursor: pointer; "/>
						 Drug Detail
						
					</div>
					<div id="minusRequestItemDtlId" style="display:block;color:blue;" align="left">
						<img src="../../hisglobal/images/minus.gif" 
	...
	<div id="strRequestItemDtlId" style="display: block">
		...
		<div id='recommendationId'>
		  ...
		  <tr>
		  <td class="TITLE" colspan="2"><div id="re" style="color:blue;">Recommendation Details</div></td>
	...
	<div id="HelpId" style="display:none">
			...
			<td class="CONTROL" style="background-color:#FFFFFF;"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			 <button style="background-color:#F5786B;height: 20px;width: 20px;" disabled></button>&nbsp;Drug has been expired
			</td>
			</tr>
			</table>
       </div>
