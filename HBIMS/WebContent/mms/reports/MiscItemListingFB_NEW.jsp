...
<div class="errMsg" id="errMsg"><bean:write name="MiscItemListingRPT" property="strErrMsg"/></div>
<div class="normalMsg" id="normalMsg"><bean:write name="MiscItemListingRPT" property="strNormalMsg"/></div>
<div class="warningMsg" id="warningMsg"><bean:write name="MiscItemListingRPT" property="strWarningMsg"/></div>
	...
	<tr class="HEADER">
			<td colspan="4"> Miscellaneous Consumption  Report</td>
		</tr>
		<tr>
			<td width="50%" colspan="2" class="LABEL"><font color="red">*</font>Store</td>
		...
		<tr>
			<td width="50%" colspan="2" class="LABEL"><font color="red">*</font>Category</td>
				<td width="50%" colspan="2" class="CONTROL">
					...
					<bean:write name="MiscItemListingRPT" property="strItemCategCmb"
						filter="false" />
				</select>
				</div>
			</td>			
	...
	<tr>
			...
			<td width="50%" colspan="2" class="CONTROL">
				<dateTag:date name="strFromDate" value="${MiscItemListingRPT.strCurrentDate}"/>
			</td>
			</tr>
			<tr>
			<td width="50%" colspan="2" class="LABEL"><font color="red">*</font>To Date</td>
			<td width="50%" colspan="2" class="CONTROL">
				<dateTag:date name="strToDate" value="${MiscItemListingRPT.strCurrentDate}"/>
			</td>
		...
		<tr>
			...
			<td width="50%" colspan="2" class="CONTROL">
			<html:checkbox property="strIsFooter" name="MiscItemListingRPT" value="1"></html:checkbox>
			</td>
...
<input type="hidden" name="strCurrentDate" value="${MiscItemListingRPT.strCurrentDate}"/>
