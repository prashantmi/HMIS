...
<div class="warningMsg" id="warningMsg"><bean:write name="stockLedgerForSubStoresRptItemNew" property="strWarningMsg"/></div>
		...
		<!-- <tr>
			...
			<td colspan="3" width="75%" class="CONTROL">
				<select name="strItemType" class="comboNormal" onchange="getDrugName();">
						<bean:write name="stockLedgerForSubStoresRptItemNew" property="strItemTypeValues" filter="false" />
				</select>
			...
			<td colspan="3" width="25%" class="CONTROL">
				<div id="itemDivId" style="display: none;">
					<select	id="strItemId" name="strItemId" class="comboNormal" >
						<bean:write name="stockLedgerForSubStoresRptItemNew" property="strItemValues" filter="false" />
					</select>
				</div>
	...
	<div id="itemManageDtlId2" style="display: block">	
		...
		<td class="LABEL" width="25%" colspan="1">Section Name</td>
			...
			<select	name="strSectionId" style= "width:15%;" onchange="getDrugName();">
					<bean:write name="stockLedgerForSubStoresRptItemNew" property="strSectionName" filter="false" />
			</select>
		  </td></tr>	
		 --><tr>
	...
	<tr>	<td class="LABEL" width="25%"></td>
		...
		<tr>
			...
			<td class="LABEL" colspan="2" width="50%" ><font color="red">*</font>Till Date(Entry)</td>
			<td class="CONTROL" colspan="2" width="50%" >
				<dateTag:date name="strToDate" value="${stockLedgerForSubStoresRptItemNew.strCurrentDate}" />
			</td>
		</tr>		
	...
	<div class="legends">Opening balance as on 1st April of Current Financial Year or Stock Ledger Initiation Date whichever is  later</div>
	
	<div id="showButtonID" style="display:none;">
	<div><div class="legends">Opening balance as on 1st April of Current Financial Year or Stock Ledger Initiation Date whichever is  later</div>
