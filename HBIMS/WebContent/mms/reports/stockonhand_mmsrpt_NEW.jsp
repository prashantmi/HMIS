...
<html:form action="/reports/StockOnHandRptCNT_NEW" method="post" styleClass="formbg">
	...
	<%-- <logic:lessThan property="strUserLevel" name="stockOnHandRPT" value="4" >
		...
		<tr id="circleTrId" >
			<td class="LABEL" width="50%" colspan="1"><font color="red">*</font>Circle Name</td>
		...
		<tr id="districtTrId" >
			<td width="50%" colspan="1" class="LABEL"><font color="red">*</font>District Name</td>
	...
	<logic:lessThan property="strUserLevel" name="stockOnHandRPT" value="4" >
		...
		<!-- <tr id="districtDrugWarehouseDivId" >
			<td width="50%" colspan="1" class="LABEL"><font color="red">*</font>District WareHouse Name</td>
			<td width="70%" colspan="3" class="CONTROL">
		...
		<tr id="storeTypeTrId">
			<td width="50%" colspan="1" class="LABEL">Store Type</td>
			<td width="70%" colspan="3" class="CONTROL">
		...
		<tr	id="drugWarehouseDivId">
			<td width="50%" colspan="1" class="LABEL"><font color="red">*</font>Store Name</td>
			<td width="70%" colspan="3" class="CONTROL">
	 ...
	 <tr>
			<td width="50%" colspan="1" class="LABEL"><font color="red">*</font>Item Category</td>
			<td width="70%" colspan="3" class="CONTROL">
			<div id="itemCatDivId">
	...
	<!-- 
	<tr>
			<td width="50%" colspan="1" class="LABEL"><font color="red">*</font>Programme Name</td>
			<td width="70%" colspan="3" class="CONTROL">
		...
		<tr>
			<td width="50%" colspan="1" class="LABEL">Group Name</td>
			<td width="70%" colspan="3" class="CONTROL">
				<div id="groupDivId">
					<select name="strGroupId"  class="comboNormal" onchange=' '>
						<bean:write name="stockOnHandRPT" property="strGroupCombo"	filter="false" />
						<option value="0">All</option>
					</select>
				<input type='checkbox' name='strIsGroupWise' value='1' >Group Wise Report	
				</div>
		...
		<tr>
			<td colspan="1" width="50%" class="LABEL"><font color="red">*</font>Drug Type</td>
			<td colspan="3" width="70%" class="CONTROL">
			<div id="itemDivId">
				<select name="strItemType" class="comboNormal" onchange=" ">
		...
		<tr>
			<td width="50%" colspan="1" class="LABEL">Status</td>
			<td width="70%" colspan="3" class="CONTROL">
			<div id="StatusDivId" >
		...
		<tr>
			<td width="50%" colspan="1" class="LABEL">Search Item Name</td>
			...
			<input type="text" id="strSearchDrug" name="strSearchDrug" size="80%"/>
			</td>			 
		</tr>
	...
	<table class="TABLEWIDTH" align="center" cellspacing="1px" cellpadding="1px">
		<tr class="HEADER">
			<td colspan="4" class='all-four-rounded-corners' align="center">Other Details</td>
		</tr>
		</table>
		<table class="TABLEWIDTH" align="center" cellpadding="1px" cellspacing="1px">	
		<tr>
