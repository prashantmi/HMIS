...
function validate(){
 		...
 		var hisValidator = new HISValidator("dossierRptBean");
...
<html:form action="/reports/DossierReqRptCNT" method="post">
	
<div class="errMsg" id="errMsg"><bean:write name="dossierRptBean" property="strErrMsg"/></div>
<div class="normalMsg" id="normalMsg"><bean:write name="dossierRptBean" property="strNormalMsg"/></div>
<div class="warningMsg" id="warningMsg"><bean:write name="dossierRptBean" property="strWarningMsg"/></div>

	<table class="TABLEWIDTH" align="center" cellspacing="1px" cellpadding="1px" >   
	<tr class="HEADER">
			<td colspan="4"><div align='right'><html:checkbox property="strIfArchival" name="dossierRptBean"  onclick="">Archived Data</html:checkbox></div> </td>
		</tr>
		
		<tr style="display: none;">
			<td class="LABEL" colspan="4">
			
				<html:radio property="strCase" name="dossierRptBean" value="1" onclick="setValueChk();">Issuing Store</html:radio>
		 ...
		 <tr style="display: none;">
			...
			<bean:write name="dossierRptBean" property="strHospNameValues" filter="false"/>
			</select>
			</td>			
		</tr>	
		...
		<tr>
			...
			<bean:write name="dossierRptBean" property="strStoreVal" filter="false" /></select>
			</td>
		...
		<tr>
			...
			<td width="50%" colspan="2" class="CONTROL">
				<dateTag:date name="strFromDate" value="${dossierRptBean.strCurrentDate}"/>
			</td>
		...
		<tr>
			...
			<td width="50%" colspan="2" class="CONTROL">
				<dateTag:date name="strToDate" value="${dossierRptBean.strCurrentDate}"/>
			</td>
		...
		<tr>
			...
			<td width="50%" colspan="2" class="CONTROL">
				<html:checkbox property="strIsFooter" name="dossierRptBean" value="1"></html:checkbox>
			</td>
		</tr>
...
<input type="hidden" name="strCurrentDate" value="${dossierRptBean.strCurrentDate}" />
