...
<html>
<head>
<title>Summary List of Indent Purchase</title>
...
function validate(){
	...
	var hisValidator = new HISValidator("summlistindentpurchaseRpt");
	hisValidator.addValidation("strHospitalCode", "dontselect=0","Please Select Hospital Name");
	hisValidator.addValidation("strPurchaseTypeId", "dontselect=0","Select Purchase Type from Purchase Type Combo ");
...
function onLoadPage(){
	...
	document.forms[0].strPurchaseTypeId.value="0";
...
<html:form action="/reports/SummaryListIndentPurchaseRptCNT" method="post">
	
<div class="errMsg" id="errMsg"><bean:write name="summlistindentpurchaseRpt" property="strErrMsg"/></div>
<div class="normalMsg" id="normalMsg"><bean:write name="summlistindentpurchaseRpt" property="strNormalMsg"/></div>
<div class="warningMsg" id="warningMsg"><bean:write name="summlistindentpurchaseRpt" property="strWarningMsg"/></div>


	<tag:tab tabLabel="Summary List of Indent Purchase"
                        selectedTab="FIRST" align="center" width="TABLEWIDTH">
                  </tag:tab>

	<table class="TABLEWIDTH" align="center" cellspacing="1px" cellpadding="1px" >   
	<tr class="HEADER">
			<td colspan="4">Summary List of Indent Purchase</td>
		</tr>
		  <tr>
			...
			<bean:write name="summlistindentpurchaseRpt" property="strHospNameValues" filter="false"/>
			</select>
			</td>			
		</tr>	
		...
		<tr>
			<td width="50%" colspan="2" class="LABEL">Category</td>
			<td width="50%" colspan="2" class="CONTROL">
				<select name="strItemCatNo" class="comboNormal" >
					<bean:write name="summlistindentpurchaseRpt" property="strItemCatValues"
						filter="false" />
		...
		<tr>
			<td width="50%" colspan="2" class="LABEL"><font color="red">*</font>Purchase Type</td>
			<td width="50%" colspan="2" class="CONTROL">
				<select name="strPurchaseTypeId" class="comboNormal" >
					<bean:write name="summlistindentpurchaseRpt" property="strPurchaseTypeValues"
						filter="false" />
		...
		<tr>
			...
			<td class="CONTROL" colspan="2"><dateTag:date name="strFromDate"
				value="${summlistindentpurchaseRpt.strCurrentDate}" /></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td width="50%" colspan="2" class="CONTROL">
			<html:checkbox property="strIsFooter" name="summlistindentpurchaseRpt" value="1"></html:checkbox>
			</td>
...
<input type="hidden" name="strCurrentDate" value="${summlistindentpurchaseRpt.strCurrentDate}"/>
