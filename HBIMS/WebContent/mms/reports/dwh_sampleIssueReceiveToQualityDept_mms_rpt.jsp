...
<html>
<head>
<title>Sample Issue Receive/Detail to Quality Dept</title>
...
<body >
<html:form name="sampleIssueDetailRptBean" action="/reports/SampleIssueReceiveToQualityDeptRptCNT" type="mms.reports.controller.fb.SampleIssueReceiveToQualityDeptRptFB">
	<div id="errMsg" class="errMsg"><bean:write name="sampleIssueReceiveToQualityDeptRptBean" property="strErr" /></div>
	<div id="warningMsg" class="warningMsg"><bean:write name="sampleIssueReceiveToQualityDeptRptBean" property="strWarning" /></div>
	<div id="normalMsg" class="normalMsg"><bean:write name="sampleIssueReceiveToQualityDeptRptBean" property="strMsg" /></div>
	...
	<table class="TABLEWIDTH" align="center" cellpadding="1px" cellspacing="1px">   
		...
		<%-- Drug warehouse Name	 --%>	
			...
			<div id="strStoreDivId" >
				<select name="strStoreId" class="comboNormal" >
					<bean:write name="sampleIssueReceiveToQualityDeptRptBean" property="strStoreNameCombo" filter="false"/>
				</select>
			</div>				
			</td>	
	    ...
	    <tr>
			...
			<td class="CONTROL" width="25%" colspan="1"><dateTag:date name="strFromDate" value="${sampleIssueReceiveToQualityDeptRptBean.strCtDate}" /></td>
			<td class="LABEL" width="25%" colspan="1"><font color="red">*</font>To Date</td>
			<td class="CONTROL" width="25%" colspan="1"><dateTag:date name="strToDate" value="${sampleIssueReceiveToQualityDeptRptBean.strCtDate}" /></td>
		</tr>	 
	   </table>
		...
		<tr>
			...
			<td width="50%" colspan="2" class="CONTROL">
			<html:checkbox property="strIsFooter" name="sampleIssueReceiveToQualityDeptRptBean" value="1"></html:checkbox>
			</td>
...
<input type="hidden" name="strCurrentDate" value="${sampleIssueReceiveToQualityDeptRptBean.strCtDate}"/>
</html:form>
