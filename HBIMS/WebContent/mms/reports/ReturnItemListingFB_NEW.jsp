...
<div class="errMsg" id="errMsg"><bean:write name="ReturnItemListingRPT" property="strErrMsg"/></div>
<div class="normalMsg" id="normalMsg"><bean:write name="ReturnItemListingRPT" property="strNormalMsg"/></div>
<div class="warningMsg" id="warningMsg"><bean:write name="ReturnItemListingRPT" property="strWarningMsg"/></div>
	...
	<tr class="HEADER">
			<td colspan="4"> Return Request  Report</td>
		</tr>
		<tr>
			<td width="50%" colspan="2" class="LABEL"><font color="red">*</font>From Store</td>
				<td width="50%" colspan="2" class="CONTROL">
					<div id="storeDivId">
						<select	name="strStoreId" class="comboNormal">
					<bean:write name="ReturnItemListingRPT" property="strStoreCmb"
						filter="false" />
				</select>
				</div>
			</td>			
		...
		<tr>
			<td width="50%" colspan="2" class="LABEL"><font color="red">*</font>Category</td>
				<td width="50%" colspan="2" class="CONTROL">
					...
					<bean:write name="ReturnItemListingRPT" property="strItemCategCmb"
						filter="false" />
				</select>
				</div>
			</td>			
	...
	<tr>
			...
			<td width="50%" colspan="2" class="CONTROL">
				<dateTag:date name="strFromDate" value="${ReturnItemListingRPT.strCurrentDate}"/>
			</td>
			</tr>
			<tr>
			<td width="50%" colspan="2" class="LABEL"><font color="red">*</font>To Date</td>
			<td width="50%" colspan="2" class="CONTROL">
				<dateTag:date name="strToDate" value="${ReturnItemListingRPT.strCurrentDate}"/>
			</td>
		...
		<tr>
			...
			<td width="50%" colspan="2" class="CONTROL">
			<html:checkbox property="strIsFooter" name="ReturnItemListingRPT" value="1"></html:checkbox>
			</td>
