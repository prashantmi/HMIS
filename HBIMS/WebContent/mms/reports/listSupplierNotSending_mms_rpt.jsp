...
<html>
<head>
<title>List of Item wise Supplier</title>
...
function validate(){
	...
	var hisValidator = new HISValidator("listSupplierNotSendingRpt");
...
<html:form action="/reports/ListSupplierNotSendingRptCNT" method="post">
	
<div class="errMsg" id="errMsg"><bean:write name="listSupplierNotSendingRpt" property="strErrMsg"/></div>
<div class="normalMsg" id="normalMsg"><bean:write name="listSupplierNotSendingRpt" property="strNormalMsg"/></div>
<div class="warningMsg" id="warningMsg"><bean:write name="listSupplierNotSendingRpt" property="strWarningMsg"/></div>


	<tag:tab tabLabel="List of Supplier not sending Supplies as per Schedule"
                        selectedTab="FIRST" align="center" width="TABLEWIDTH">
                  </tag:tab>

	<table class="TABLEWIDTH" align="center" cellspacing="1px" cellpadding="1px" >   
	<tr class="HEADER">
			<td colspan="4">List of Supplier not sending Supplies as per Schedule</td>
		</tr>
		...
		<td colspan="3" class="CONTROL">
			<select name="strItemCategoryNo" class='comboNormal'>
					<bean:write name="listSupplierNotSendingRpt" property="strItemCategoryCombo"filter="false" />
			</select>
		</td>
	</tr>
	...
	<tr>
			...
			<td class="CONTROL" colspan="2"><dateTag:date name="strFromDate"
				value="${listSupplierNotSendingRpt.strCurrentDate}" /></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td width="50%" colspan="2" class="CONTROL">
			<html:checkbox property="strIsFooter" name="listSupplierNotSendingRpt" value="1"></html:checkbox>
			</td>
...
<input type="hidden" name="strCurrentDate" value="${listSupplierNotSendingRpt.strCurrentDate}"/>
