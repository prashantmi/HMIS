...
<html>
<head>
<title>Supplier Performance List</title>
...
function validate(){
	...
	var hisValidator = new HISValidator("listSupplierPerformanceRpt");
...
<html:form action="/reports/ListSuppPerformanceRptCNT" method="post">
	
<div class="errMsg" id="errMsg"><bean:write name="listSupplierPerformanceRpt" property="strErrMsg"/></div>
<div class="normalMsg" id="normalMsg"><bean:write name="listSupplierPerformanceRpt" property="strNormalMsg"/></div>
<div class="warningMsg" id="warningMsg"><bean:write name="listSupplierPerformanceRpt" property="strWarningMsg"/></div>


	<tag:tab tabLabel="Supplier Performance List"
                        selectedTab="FIRST" align="center" width="TABLEWIDTH">
                  </tag:tab>

	<table class="TABLEWIDTH" align="center" cellspacing="1px" cellpadding="1px" >   
	<tr class="HEADER">
			<td colspan="4">Supplier Performance List</td>
		</tr>
		...
		<td colspan="3" class="CONTROL">
			<select name="strItemCategoryNo" class='comboNormal'>
					<bean:write name="listSupplierPerformanceRpt" property="strItemCategoryCombo"filter="false" />
			</select>
		</td>
	</tr>
	<tr>
			...
			<select name="strStatus"  onchange="" class="comboNormal">
			<option value="0">All</option>
			<option value="1">Partial Supply</option>
			<option value="2">Delayed Supply</option>
			<option value="3">Breakage/Rejected Supply</option></select>
			</td>
	...
	<tr>
			...
			<td class="CONTROL" colspan="2"><dateTag:date name="strFromDate"
				value="${listSupplierPerformanceRpt.strCurrentDate}" /></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td width="50%" colspan="2" class="CONTROL">
			<html:checkbox property="strIsFooter" name="listSupplierPerformanceRpt" value="1"></html:checkbox>
			</td>
...
<input type="hidden" name="strCurrentDate" value="${listSupplierPerformanceRpt.strCurrentDate}"/>
