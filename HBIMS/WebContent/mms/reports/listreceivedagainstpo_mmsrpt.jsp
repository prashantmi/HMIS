...
<html>
<head>
<title>List of Item Received Against PO</title>
...
function validate(){
		...
		var hisValidator = new HISValidator("listItemReceivedRpt");
...
<html:form action="/reports/ListReceivedAgainstPORptCNT" method="post">
	
<div class="errMsg" id="errMsg"><bean:write name="listItemReceivedRpt" property="strErrMsg"/></div>
<div class="normalMsg" id="normalMsg"><bean:write name="listItemReceivedRpt" property="strNormalMsg"/></div>
<div class="warningMsg" id="warningMsg"><bean:write name="listItemReceivedRpt" property="strWarningMsg"/></div>


	<tag:tab tabLabel="List of Item Received Against PO"
                        selectedTab="FIRST" align="center" width="TABLEWIDTH">
                  </tag:tab>

	<table class="TABLEWIDTH" align="center" cellspacing="1px" cellpadding="1px" >   
	<tr class="HEADER">
			<td colspan="4">List of Item Received Against PO</td>
		</tr>
		...
		<tr>
			...
			<td width="50%" colspan="2" class="CONTROL">
				<select name="strItemCatNo" class="comboNormal" onchange="getItemCatCmb();">
					<bean:write name="listItemReceivedRpt" property="strItemCatValues"
						filter="false" />
				</select>
			</td>
		</tr>
		<tr>
			...
			<td class="CONTROL" colspan="2"><dateTag:date name="strFromDate"
				value="${listItemReceivedRpt.strCurrentDate}" /></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td width="50%" colspan="2" class="CONTROL">
			<html:checkbox property="strIsFooter" name="listItemReceivedRpt" value="1"></html:checkbox>
			</td>
...
<input type="hidden" name="strCurrentDate" value="${listItemReceivedRpt.strCurrentDate}"/>
