...
function validate(){
	...
	var hisValidator = new HISValidator("stockStatusRpt");
...
//alert(document.forms[0].strStoreVal.value);
	if(document.forms[0].strStoreVal.value!="0"){	
	   ...
	   var url="StockStatusRptCNT.cnt?hmode=ITEMCATEGORY&storeid="+document.forms[0].strStoreVal.value;
	   ajaxFunction(url,"1");
	   }else{
...
if(document.forms[0].strItemCategoryNo.value!="0"){
   var mode ="GROUPNAME";  
   var url="StockStatusRptCNT.cnt?hmode=GROUPNAME&itemCatNo="+document.forms[0].strItemCategoryNo.value;
   ajaxFunction(url,"2");
   }else{
	   		document.getElementById('itemCatId').innerHTML = "<select name='strItemCategoryNo' class='comboNormal' onchange='groupNameCombo();'><option value='0'>Select Value</option></select>";  
	   		document.getElementById('groupId').innerHTML = "<select name='strGroupId' class='comboNormal'><option value='0'>All</option></select>";
...
function getStoreCmb(){
   ...
   var url="StockStatusRptCNT.cnt?hmode="+mode+"&HOSPITAL_CODE="+document.forms[0].strHospitalCode.value;
   ajaxFunction(url,"3");
}
</script>
</head>
<body onload="onLoadPage();">
<html:form action="/reports/StockStatusRptCNT" method="post">
	
<div class="errMsg" id="errMsg"><bean:write name="stockStatusRpt" property="strErrMsg"/></div>
<div class="normalMsg" id="normalMsg"><bean:write name="stockStatusRpt" property="strNormalMsg"/></div>
<div class="warningMsg" id="warningMsg"><bean:write name="stockStatusRpt" property="strWarningMsg"/></div>
	...
	<tr class="HEADER">
     ...
     <tr>
			...
			<bean:write name="stockStatusRpt" property="strHospNameValues" filter="false"/>
			</select>
			</td>			
		</tr>	
		<tr>
		...
		<td colspan="2" width="50%" class="CONTROL">
			<div id="itemCatId"><select name="strItemCategoryNo" class='comboNormal' onchange="groupNameCombo();">
					<bean:write name="stockStatusRpt" property="strItemCategoryCombo" filter="false" />
					<option value="0">Select Value</option>
			</select></div>
		</td>
	</tr>
	...
	<tr >
    		...
    		<td class ="CONTROL" width ="50%"><dateTag:date name="strDate" value ="${stockStatusRpt.strCtDate}"></dateTag:date></td>
  		</tr>
	...
	<table class="TABLEWIDTH" align="center" cellspacing="1px" cellpadding="1px" >  	
		...
		<tr>
			...
			<td width="50%" colspan="2" class="CONTROL">
			<html:checkbox property="strIsFooter" name="stockStatusRpt" value="1"></html:checkbox>
			</td>
...
<input type="hidden" name="strCtDate" value="${stockStatusRpt.strCtDate}"/>
