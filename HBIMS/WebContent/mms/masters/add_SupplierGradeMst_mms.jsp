...
function validate1(){   
            ...
            hisValidator.addValidation("strGradeCriteria", "req", "Supplier Grade Criteria is a Mandatory Field" );
...
<html:form name="SupplierGradeMstBean" action="/masters/SupplierGradeMstCNT" type="mms.masters.controller.fb.SupplierGradeMstFB">
	...
	<tr class="HEADER">
			<td colspan="2">Supplier Grade Master&gt;&gt; Add</td>
		</tr>
		<tr>
			...
			<input type="text" class='txtFldBig' name="strGradeName" value ="" maxlength="50" onkeypress="return validateData(event,4);">
			</td>
		</tr>
		<tr>
			<td width="50%" class="LABEL">
			...
			<td width="50%" class="CONTROL">
			  <div align="left">
        		<textarea name="strGradeCriteria" rows="2"></textarea>
              </div>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class ="CONTROL"><date:date name="strEffectiveFrom" value="${SupplierGradeMstBean.strCtDate}"></date:date></td>
		</tr>
	...
	<input type="hidden" name="strCtDate" value="${SupplierGradeMstBean.strCtDate}"/>
