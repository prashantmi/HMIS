   ...
   <div class="row">
				<div class="col-sm-9" align="left">
							...
							<div class="legendNew" id="nonPrintableLegend2">
									...
									<button type="button" class=" btn btn-secondary btn-circle" onclick="clearScreen();" style="background: #b9b9b9; border-color: #b9b9b9; margin-top: 0.25rem !important;">
										<img src="/HIS/hisglobal/images/clear3.png" title="Clear" style="width: 23px; color: #fff;">
									</button>
									<button type="button" id="savebutton" class="float-right btn btn-outline-success mt-1 btn-circle" tabindex="2" onclick="validate1();" style="background-color: #5cb85c;">
...
<html:hidden name="genericdrugBean" 
...
<div class="col-sm-3">
<html:select 
				property="strConsumableType" name="genericdrugBean" style="display: block;
    width: 100%;
    height: 34px;
    padding: 6px 12px;
    font-size: 14px;
...
<div class="col-sm-3">
<input type="text"
				name="strDrugName" maxlength="100" class="form-control" onkeyup="lTrim(this);"
...
<html:checkbox
				...
				name="genericdrugBean"></html:checkbox>
</div>
...
<html:checkbox
				...
				onclick="setIsItemNarcotic();" ></html:checkbox>
</div>
<div class="col-sm-2"></div>
</div>
...
<div class="col-sm-2">
<html:select
				property="strTimeFormat" style="display: block;
    width: 100%;
    height: 34px;
    padding: 6px 12px;
    font-size: 14px;
...
<div class="col-sm-2">
<select
				name="strStockMaintain" class="form-control">
	...
	<div class="col-sm-2">
	<html:select
				property="strShelfTimeFormat" style="display: block;
    width: 100%;
    height: 34px;
    padding: 6px 12px;
    font-size: 14px;
	...
	<textarea rows="2" class="form-control"
				cols="20" name="strRemarks" id="strRemarks" onkeyup="lTrim(this);"></textarea>
	</div>
	</div>
</div>
<hr>
