...
<html:form name="LetterTypeMstBean" action="/masters/LetterTypeMstCNT" type="mms.masters.controller.fb.LetterTypeMstFB">
	...
	<tr class="HEADER">
		...
		<tr>
			...
			<td width="50%" class="CONTROL">
			<input type="text" class='txtFldBig' name="strLetterTypeName" value ="" maxlength="100" onkeypress="return validateData(event,4);">
			</td>
		</tr>
		<tr>
			<td width="50%" class="LABEL">
		...
		<tr>
			...
			<td class ="CONTROL"><date:date name="strEffectiveFrom" value="${LetterTypeMstBean.strCtDate}"></date:date></td>
		</tr>
...
<input type="hidden" name="strCtDate" value="${LetterTypeMstBean.strCtDate}"/>
