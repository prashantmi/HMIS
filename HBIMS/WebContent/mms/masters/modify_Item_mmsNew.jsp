...
<div class="col-sm-6" style="font-weight: 400" align="left">
...
<div class="col-sm-8" style="font-weight: 400" align="left">
...
<div class="row">
   <logic:equal value="1" name="itemBean" property="strIsItemCodeRequired">
				...
				<input type="text" name="strNewCPACode" maxlength="3" value="${itemBean.strNewCPACode}" onkeypress="return validateData(event,9);" class="form-control">
				</logic:equal>
...
<div class="col-sm-2">
<label><font color="red">*</font>Item Type:</label>
</div>
<div class="col-sm-2" style="font-weight: 400" align="left">
...
<div class="col-sm-2" style="font-weight: 400" align="left">
<input type="text" name="strItemName" class='form-control'	value="${itemBean.strItemName}" maxlength="250"
onkeypress="return validateDataWithSpecialChars(event,18,'%.:;+-/*,½');">
</div>
<div class="col-sm-2">
<div id="manfMandatoryDivId" style="display: block;">
<label><font color="red">*</font>Manufacturer</label></div>
...
<div class="col-sm-2" style="font-weight: 400" align="left">
<input type="text" value="${itemBean.strHSNCode}"	name="strHSNCode" maxlength="10"
...
value="${itemBean.strDefaultRate}" maxlength="9"	onkeypress="return validateData(event,7);"></td>
</div>
<div class="col-sm-2">
...
<div class="col-sm-2">
<html:select property="strIssueType" styleClass="form-control" value="${itemBean.strIssueType }">
...
<div class="col-sm-2">
<html:select property="strItemMake" styleClass="form-control" value="${itemBean.strItemMake }">
...
<input type="text" name="strSterilizationLife" class='form-control' 
value="${itemBean.strSterilizationLife}" maxlength="14" onkeypress="return validateData(event,7);">
<input class="form-control" placeholder="Day/s" readonly>
</div>
</div>
</div>
<div class="col-sm-2">
...
<div class="col-sm-2">
<textarea class="form-control" name="strSpecification" rows="1" cols="16" >
<bean:write	name="itemBean" property="strSpecification" /></textarea>
</div>
</div>
<div class="row" style="margin-top: 10px">
<div class="col-sm-2">
<label>Item is Set-Sachet</label>
</div>
<div class="col-sm-2" align="right">
...
<div class="col-sm-3">
<label>Whether Item is Quantified</label>
</div>
<div class="col-sm-1" align="right">
...
<div class="col-sm-2" style="font-weight: 400" align="left">
<bean:write name="itemBean" property="strEffectiveFrom" />
</div>
<div class="col-sm-2">
...
<div class="col-sm-2" style="font-weight: 400" align="left">
<label>
<html:radio name="itemBean"	property="strIsValid" value="1">Active</html:radio>
<html:radio	name="itemBean" property="strIsValid" value="2">Inactive</html:radio>
</label>
</div>
</div>
<hr>
...
<!-- 
	...
	<%-- <table class="TABLEWIDTH" align="center" cellspacing="1px" cellpadding="1px">
		...
		<tr>
			...
			Type</td>
			<td class="CONTROL" width="25%">
			<html:select property="strIssueType" styleClass="comboNormal"
