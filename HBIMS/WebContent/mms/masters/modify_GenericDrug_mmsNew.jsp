   ...
   <div class="row">
				<div class="col-sm-9" align="left">
							...
							<div class="legendNew" id="nonPrintableLegend2">
									...
									<button type="button" id="savebutton" class="float-right btn btn-outline-success mt-1 btn-circle" tabindex="2" onclick="validate();" style="background-color: #5cb85c;">
    ...
    transition: border-color ease-in-out .15s, box-shadow ease-in-out .15s;">
		...
		<div class="col-sm-1">
		<input
				type="checkbox" name="strConsentReq" class="form-control"
		...
		<div class="col-sm-1">
		<input
				type="checkbox" name="strIsItemNarcotic" class="form-control"
				value="${genericdrugBean.strIsItemNarcotic}"
				onclick="setIsItemNarcotic();">
		</div>
		<div class="col-sm-2"></div>
		</div>			
	...
	<div class="col-sm-2">
	<input type="text"
				name="strPurchaseLeadTime" maxlength="3" class="form-control"
				onkeypress="return validateData(event,5);"
				value="${genericdrugBean.strPurchaseLeadTime}" />
	</div>
	<div class="col-sm-2">
	...
	<div class="col-sm-2">
	<html:select
				property="strTimeFormat" name="genericdrugBean" style="display: block;
    width: 100%;
    height: 34px;
    padding: 6px 12px;
    font-size: 14px;
