...
<center>
	...
	<table class="TABLEWIDTH" align="center" cellpadding="1px" cellspacing="1px">
		...
		<tr>
			...
			<td width="50%" class="CONTROL"><bean:write
				name="StoreHierarchyBean" property="strToStoreName" filter="false" />
    ...
    <td class ="CONTROL"><bean:write name="StoreHierarchyBean" property="strEffectiveFrom" filter="false"></bean:write></td>
  </tr>
		...
		<tr>
			...
			<td width="50%" class="CONTROL"><textarea name="strRemarks"
				cols="25" rows="2"><bean:write name="StoreHierarchyBean" property="strRemarks" filter="false"/></textarea></td>
		</tr>
