...
<tag:tab tabLabel="Drug Saftey Alert" selectedTab="FIRST" align="center" width="TABLEWIDTH">
	...
	<table class="TABLEWIDTH" align="center">   
	   <tr class="HEADER">
			<td colspan="2">Drug Saftey Alert &gt;&gt; Add</td>
		</tr>
		<tr>
			...
			<td width="50%" class="CONTROL">
			   <select name="strGroupName" class="comboNormal" onChange="getSubGroupCombo();">
                        <bean:write name="drugSaftyAlertBean" property="strGroupNameCombo" filter="false"/>
               </select>
		    </td>
		</tr>
		<tr>
			...
			<td width="50%" class="CONTROL">
			 <div id="strSubGroupName" >
			     <select name="strSubGroupName"  class='comboNormal'>
			           <bean:write name="drugSaftyAlertBean" property="strSubGroupNameCombo" filter="false"/><option value="0">Select Value</option>
                  </select>
                </div>
			</td>
		</tr>
			...
			<td width="50%" class="CONTROL">
			   <div id="strDrugName" >
			      <select name="strDrugName"  class='comboNormal'>
                         <bean:write name="drugSaftyAlertBean" property="strDrugNameCombo" filter="false"/><option value="0">Select Value</option>
                  </select>
                </div>
			</td>
       ...
       <tr>
		...
		<tr> 
          ...
          <td class="CONTROL"> <dateTag:date name="strEffectiveFrom" id="strEffectiveFrom"
				 value="${drugSaftyAlertBean.strCtDate}"/> </td>
        </tr>
