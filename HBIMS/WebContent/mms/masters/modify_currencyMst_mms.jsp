...
function getAjaxResponse(res,mode)
{
     ...
     {
     	temp=res.split("^");
       	if(temp[0]=="1" && temp[1]!=document.forms[0].strCurrencyName.value){
...
<html:form name="currencyMstBean" action="/masters/CurrencyMstCNT" type="mms.masters.controller.fb.CurrencyMstFB">
	...
	<table class="TABLEWIDTH" align="center" cellpadding="1px"
         cellspacing="1px">   
	<tr class="HEADER">
			<td colspan="2">Currency Master&gt;&gt; Modify</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td width="50%" class="CONTROL">
			<input type="text" class='txtFldBig' name="strCurrencyName" value ="${currencyMstBean.strCurrencyName}" maxlength="50" onkeypress="return validateData(event,4);">
			</td>
		</tr>
		<tr>
			<td width="50%" class="LABEL">
			...
			<td width="50%" class="CONTROL">
			<input type="text" class='txtFldBig' name="strCurrencyShortName" value ="${currencyMstBean.strCurrencyShortName}" maxlength="10" onkeypress="return validateData(event,4);">
			</td>
		</tr>
		<tr>
			<td width="50%" class="LABEL">
			...
			<td width="50%" class="CONTROL">
			<input type="text" class='txtFldBig' name="strCurrencyValue" value ="${currencyMstBean.strCurrencyValue}" maxlength="7" onkeypress="return validateData(event,7);">
			</td>
		</tr>
		<tr>
			<td width="50%" class="LABEL">
			...
			<td class ="CONTROL"><bean:write name="currencyMstBean" property="strEffectiveFrom" /></td>
		</tr>
		<tr>
			<td width="50%" class="LABEL">
			Remarks
			...
			<td width="50%" class="CONTROL">
			  <div align="left">
        		<textarea name="strRemarks" rows="2"><bean:write name="currencyMstBean" property="strRemarks"/></textarea>
              </div>
			</td>
		</tr>
		<tr >
   ...
   <html:radio name="currencyMstBean" property="strIsValid" value="1">Active</html:radio>
    <html:radio name="currencyMstBean" property="strIsValid" value="2">Inactive</html:radio>
	...
	<input type="hidden" name="chk" value="${currencyMstBean.strChk }">
	<input type="hidden" name="hmode"/>
	<input type="hidden" name="strEffectiveFrom" value="${currencyMstBean.strEffectiveFrom}">
<cmbPers:cmbPers/>
</html:form>
