...
<div class="col-sm-2">
<%-- <select name="StoreBean" property="strDeptCode" onchange="WardCombo();" class="form-control">
<bean:write name="StoreBean" property="strDepartmentCombo" filter="false" />
</select> --%> 
<html:select name="StoreBean" property="strDeptCode" onchange="WardCombo();" styleClass="form-control">
					<bean:write name="StoreBean" property="strDepartmentCombo" filter="false" />
				</html:select>
</div>
<div class="col-sm-2">

<label><font color="red">*</font>Ward Name</label>
</div>
<div id="Ward" class="col-sm-2">
<select name="strWardCode" class="form-control">
...
<div class="col-sm-2">
<textarea name="strLocation" Class="form-control" rows="1" cols="20"></textarea>	
</div>
<div class="col-sm-2">
<label><font color="red">*</font>Drug License No.</label>
</div>
<div class="col-sm-2" >
<textarea name="strDLNo" Class="form-control" rows="1" cols="20"></textarea>		
</div>
<div class="col-sm-4" >
...
<td width="15%" ></td>
<td width="10%" style="font-family: Arial, sans-serif; font-size: 14px; font-weight: 501; color: rgba(75, 75, 75, 0.7);">
<font color="red">*</font><label>From Time</label></td>
<td width="15%" >
<input type="text" name="StoreBean" property="strFromTime" 	placeholder="[HH:MM] 24-Hour" maxlength="5" onchange="return validateDataWithSpecialChars(event,5,':');"
onkeypress="return validateDataWithSpecialChars(event,5,':');"	class="form-control" /></td>
<td width="10%" style="font-family: Arial, sans-serif; font-size: 14px; font-weight: 501; color: rgba(75, 75, 75, 0.7);" >
<font color="red">*</font>To Time</td>
<td width="15%" >
<input type="text" name="StoreBean" property="strToTime" maxlength="5" onchange="return validateDataWithSpecialChars(event,5,':');"
onkeypress="return validateDataWithSpecialChars(event,5,':');"	placeholder="[HH:MM] 24-Hour" class="form-control" />
</td>
<td width="15%" ></td>
	</tr>
	</table> -->
...
<div class="row" id="timeBoundRowId" style="display: none">
<div class="col-sm-3">
<label><font color="red">*</font>From Time</label>
</div>
<div class="col-sm-3">
<input type="text" name="StoreBean" property="strFromTime" maxlength="5" onchange="return validateDataWithSpecialChars(event,5,':');" onkeypress="return validateDataWithSpecialChars(event,5,':');"
>&nbsp;[hh:mm] 24-hour
</div>
<div class="col-sm-3">
<label><font color="red">*</font>To Time</label>
</div>
<div class="col-sm-3">
<input type="text" name="StoreBean" property="strToTime" maxlength="5" onchange="return validateDataWithSpecialChars(event,5,':');" onkeypress="return validateDataWithSpecialChars(event,5,':');"
				styleClass="txtFldMin">&nbsp;[hh:mm] 24-hour</div>
	...
	<tr id="timeBoundRowId" style="display: none">
		...
		<td width="25%" class="CONTROL">
			<html:text name="StoreBean" property="strFromTime" maxlength="5" onchange="return validateDataWithSpecialChars(event,5,':');" onkeypress="return validateDataWithSpecialChars(event,5,':');"
				class="form-control"></html:text>&nbsp;[hh:mm] 24-hour</td>
...
--><!-- Code (Change Request) & No Of Beds (Change Request) -->
	...
	<tr id="timeBoundRowId" style="display: none">
	<td width="15%" ></td>
		<td width="10%" ><font color="red">*</font>From Time</td>
		<td width="15%" ><html:text name="StoreBean" property="strFromTime" 
				...
				<td  width="10%" >[hh:mm] 24-hour</td>
		<td width="10%" ><font color="red">*</font>To Time</td>
		<td width="15%" ><html:text name="StoreBean" property="strToTime"
				maxlength="5" onchange="return validateDataWithSpecialChars(event,5,':');"
				onkeypress="return validateDataWithSpecialChars(event,5,':');"
				styleClass="form-control"></html:text></td>
				<td width="10%" >[hh:mm] 24-hour</td>
