...
<head>
<meta charset=utf-8>
<title>Purchase Type Master Add Page</title>
...
function validate1(){   
           ...
           // hisValidator.addValidation("strEffectiveFrom", "dtgtet=${PurchaseTypeBean.strCtDate}" , "Effective From should be Greater than or Equal to Current Date");
...
<tag:tab tabLabel="Purchase Type Master"
  ...
  <tr class="HEADER"> 
    <td colspan="2">Purchase Type Master&gt;&gt;Add</td>
  </tr>   
  <tr>
			<td class="LABEL"><span class="style1"></span>Store Type Name</td>
  ...
  <tr >
    ...
    <td width="50%" class ="CONTROL"><input type="text" class='txtFldMax' name="strPurchaseTypeName" value ="" maxlength="100" onkeypress="return validateData(event,9);"> </td>
  </tr>
  
      <tr >
    <td class="LABEL"><font color="red">*</font>Purchase Type Limit</td>
    <td width="50%" class ="CONTROL"><input type="text" class='txtFldNormal' name="strPurchaseTypeLimit" value ="" maxlength="8" onkeypress="return validateData(event,5);"> </td>
  </tr>
   
    <tr >
    <td class ="LABEL" width ="50%"><font color="red">*</font>Effective From</td>
    <td class ="CONTROL"><dateTag:date name="strEffectiveFrom" value ="${PurchaseTypeBean.strCtDate}"></dateTag:date></td>
    </tr>
   ...
   <tr class="FOOTER"> 
	...
	<td align="center">
			...
			<img src="../../hisglobal/images/btn-clr.png" style="cursor:pointer;cursor:pointer;" title="Reset Content"
				onClick="document.forms[0].reset(),document.forms[0].strPurchaseTypeName.focus();" />
	    ...
	    <input type="hidden" name="strHospitalCode" value ="${storetypeBean.strHospitalCode}" />
	    <input type="hidden"
