...
<div class="col-sm-2">
<textarea name="strLocation" Class="form-control" rows="1" cols="20">
...
<div class="col-sm-2" >
<textarea name="strDLNo" Class="form-control" rows="1" cols="20">
...
<div class="col-sm-3"><textarea name="strRemarks" rows="2" class="form-control" >
