...
<center>
	...
	<table class="TABLEWIDTH" align="center" cellpadding="1px" cellspacing="1px">
		<tr class="HEADER">
			<td colspan="2">Invoice Type Master&gt;&gt; Modify</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td width="50%" class="CONTROL"><input type="text"
				name="strInvoiceTypeName" class="txtFldMax"
				maxlength="50" value="${invoiceTypeBean.strInvoiceTypeName}">
			</td>
		</tr>
		...
		<tr>
			...
			From</td>
			<td class="CONTROL"><bean:write name="invoiceTypeBean" property="strEffectiveFrom"></bean:write></td>
		</tr>
		<tr>
			<td width="50%" class="LABEL">Remarks</td>
			<td width="50%" class="CONTROL">
			<div align="left"><textarea name="strRemarks" rows="2"><bean:write
				name="invoiceTypeBean" property="strRemarks" /></textarea></div>
			</td>
		...
		<tr>
			...
			<td width="45%" class="CONTROL"><html:radio
				name="invoiceTypeBean" property="strIsValid" value="1">Active</html:radio>
			<html:radio name="invoiceTypeBean" property="strIsValid" value="2">Inactive</html:radio>
...
<a href="#" class="button" onclick="cancel('LIST');"><span class="cancel">Cancel</span></a>
	...
	<input type="hidden" name="chk" value="${invoiceTypeBean.chk[0] }">
	<input type="hidden" name="hmode" />
	<input type="hidden" name="strEffectiveFrom" value="${invoiceTypeBean.strEffectiveFrom}">
