...
<html:form name="MaintenanceTypeMstBean" action="/masters/MaintenanceTypeMstCNT" type="mms.masters.controller.fb.MaintenanceTypeMstFB">
	...
	<tr class="HEADER">
			<td colspan="2">Maintenance Type Master&gt;&gt; Add</td>
		</tr>
		<tr>
			...
			<input type="text" class='txtFldBig' name="strMaintenanceTypeName" value ="" maxlength="25" onkeypress="return validateData(event,9);">
			</td>
		</tr>
		...
		<tr>
			...
			<td class ="CONTROL"><date:date name="strEffectiveFrom" value="${MaintenanceTypeMstBean.strCtDate}"></date:date></td>
		</tr>
	...
	<input type="hidden" name="strCtDate" value="${MaintenanceTypeMstBean.strCtDate}"/>
