...
<html:form name="deliveryModeBean" action="/masters/DeliveryModeMstCNT"
	...
	<center><tag:tab tabLabel="DeliveryMode Master"
		selectedTab="FIRST" align="center" width="TABLEWIDTH">
	</tag:tab></center>

	<table class="TABLEWIDTH" align="center" cellpadding="1px" cellspacing="1px">
		<tr class="HEADER">
			<td colspan="2">Delivery Mode Master&gt;&gt; Add</td>
		</tr>
		<tr>
			<td width="50%" class="LABEL"><font color="red">*</font>Delivery
			Mode Name</td>
			<td width="50%" class="CONTROL"><input type="text"
				class="txtFldMax" name="strDeliveryModeName" value="" maxlength="50" onkeypress="return validateData(event,9);" >
			</td>
		</tr>
		...
		<tr>
			...
			<td class="CONTROL"><dateTag:date name="strEffectiveFrom"
				value="${deliveryModeBean.strCtDate}"></dateTag:date></td>
		</tr>
		<tr>
	...
	<input type="hidden" name="strCtDate"
		value="${deliveryModeBean.strCtDate}"> 
