...
<tag:tab tabLabel="Lab Master"
	...
	<table class="TABLEWIDTH" align="center" cellspacing="1px" cellpadding="1px">   
	   <tr class="HEADER">
			<td colspan="2">Lab Master&gt;&gt;Add</td>
		...
		<tr>
			...
			<td width="25%" class="CONTROL" colspan="1" colspan="1">
	  		<div align="left">
      				<textarea name="strAddress" rows="2"></textarea>
  	 		</div></td>
		...
		<tr>
			...
			<td width="25%" class="CONTROL" align="left" colspan="1"><input type="text"
				name="strPhoneNo" value="" maxlength="11"
			...
			<td width="25%" class="CONTROL" align="left" ><input type="text"
				name="strFaxNo" value="" maxlength="11"
				onkeypress="return validateData(event,2);">
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td width="25" class="CONTROL" colspan="1" align="right">
				<input type="radio" name="strIsValid" value="1" checked="checked"/>Active
				<input type="radio" name="strIsValid" value="2" />In-Active
			</td>
