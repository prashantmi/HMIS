...
<title>Employee Detail Master Add Page</title>
...
<html:form name="employeeDetailMstBean" action="/masters/EmployeeDetailMstCNT" type="mms.masters.controller.fb.EmployeeDetailMstFB">
	...
	<table class="TABLEWIDTH" align="center" cellpadding="1px" cellspacing="1px">
		<tr class="HEADER">
			<td colspan="2">Employee Detail Master&gt;&gt;Add</td>
		</tr>
	</table>
...
<!-- Gender Code -->
			...
			<td width="25%" class="CONTROL">
				<select	name="strGenderCode" class="comboNormal" onchange="getSalutationOnBasisOfGender();">
	...
	<table cellspacing="1px" class="TABLEWIDTH" align="center">
		<tr>
			...
			<td id="salutation_Id"	class="CONTROL" width="90%">
				<select name="strSalutationId" class="comboNormal">
...
<!-- Designation -->
			...
			<td width="25%" class="CONTROL">
				<select name="strDesigId" class="comboNormal">
...
<!-- Permanent Address		-->
		<tr>	
			...
			<td class="CONTROL">
				<textarea name="strPermanentAddress" rows="2"></textarea>
			</td>
...
<!-- Local Address -->		
		<tr>	
			...
			<td class="CONTROL">
				<textarea id="localAddressTextAreaId" name="strLocalAddress" rows="2"></textarea>
			</td>		
...
<!-- Phone No &  Mobile No -->		
		<tr>
			<td width="25%" class="LABEL">Office Telephone No.</td>
			<td class="CONTROL">
...
<!--	Fax No	-->
		...
		<td width="25%" class="LABEL">Fax No</td>
			...
			<td width="25%" class="CONTROL">
				<input type="text" name="strEmailId"  onkeypress="return validateData(event,1);">
			</td>
...
<!-- Service Document No  &  Service Document Date  -->		
		<tr>
			...
			<td class="CONTROL">
				<dateTag:date name="strServiceDocDate"	value="${employeeDetailMstBean.strCurrentDate}"></dateTag:date>
			</td>
		</tr>
...
<!-- Remarks		-->
	...
	<table CLASS="TABLEWIDTH" align="center" cellpadding="1px"
		...
		<tr>
			<td align="center">
				<img src="../../hisglobal/images/btn-sv.png" style="cursor: pointer;" title="Save Record" onClick="validate1('Add');" />
				<img src="../../hisglobal/images/btn-clr.png" style="cursor: pointer;" title="Reset Content" onClick="document.forms[0].reset(),clearMsg('ADD')" ;/> 
