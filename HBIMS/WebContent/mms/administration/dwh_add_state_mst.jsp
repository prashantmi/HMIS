...
<title>State Master Add Page</title>
...
<html:form name="stateMstBean" action="/masters/StateMstCNT" type="mms.masters.controller.fb.StateMstFB">
	...
	<table class="TABLEWIDTH" align="center" cellpadding="1px" cellspacing="1px">
		<tr class="HEADER">
			<td colspan="2">State Master&gt;&gt;Add</td>
		</tr>
...
<!-- Country -->
		<tr>
			...
			<td width="50%" class="CONTROL">
				<input type="text" name="strCountryName" disabled="disabled" value="${stateMstBean.strCountryName}"  onkeypress="return validateData(event,18);">
			</td>
		</tr>
...
<!-- State Short Name-->
		<tr>
			...
			<td width="50%" class="CONTROL">
				<input type="text" name="strStateShortName" value="${stateMstBean.strStateShortName}" maxlength="3" onkeypress="return validateData(event,18);">
			</td>	
		</tr>
