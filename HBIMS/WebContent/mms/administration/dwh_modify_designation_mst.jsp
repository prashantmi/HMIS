...
<html:form name="designationMst" action="/masters/DesignationMstCNT" type="mms.masters.controller.fb.DesignationMstFB">
	...
	<tr class="HEADER">
		...
		<tr>
			...
			<input type="text" class='txtFldBig' name="strDesignationName" value ="${designationMst.strDesignationName}" maxlength="100" onkeypress="return validateData(event,4);">
			</td>
		</tr>
		...
		<tr>
			...
			<td width="50%" class="CONTROL">
			  <div align="left">
        		<textarea name="strRemarks" rows="2"><bean:write name="designationMst" property="strRemarks"/></textarea>
              </div>
			</td>
		</tr>
		<tr>
			...
			<td class ="CONTROL">
			<date:date name="strEffectiveFrom" value ="${designationMst.strEffectiveFrom}"></date:date></td>
		</tr>
		<tr >
    <td width ="45%" class ="LABEL">Record Status </td>
    <td width ="45%" class ="CONTROL" >
   <html:radio name="designationMst" property="strIsValid" value="1">Active</html:radio>
    <html:radio name="designationMst" property="strIsValid" value="2">Inactive</html:radio>
	...
	<input type="hidden" name="chk" value="${designationMst.strChk }">
