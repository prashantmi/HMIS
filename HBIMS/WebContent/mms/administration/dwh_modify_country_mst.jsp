...
<html>
<head>
<title>Country Modify Page</title>
...
<tag:tab tabLabel="Country Master"
	...
	<table class="TABLEWIDTH" align="center" cellspacing="1px" cellpadding="1px">   
	   <tr class="HEADER">
			<td colspan="2">Country Master&gt;&gt;Modify</td>
		</tr>
		
		<tr>
			<td width="30%" class="LABEL"><font color="red">*</font>Country Name</td>
			<td width="30%" class="CONTROL" align="left" ><input type="text"
				name="strCountryName" value="${countryBean.strCountryName}" maxlength="30"
				onkeypress="return validateData(event,11);">
			</td>
		</tr>
		<tr>
			<td width="30%" class="LABEL"><font color="red">*</font>Country Short Name</td>
			<td width="30%" class="CONTROL" align="left" ><input type="text"
				name="strCountryShortName" value="${countryBean.strCountryShortName}" maxlength="3"
				onkeypress="return validateData(event,12);">
			</td>
		</tr>
		<tr>
			<td width="30%" class="LABEL"><font color="red">*</font>Nationality</td>
			<td width="30%" class="CONTROL" align="left" ><input type="text"
				name="strNationality" value="${countryBean.strNationality}" maxlength="30"
				onkeypress="return validateData(event,11);">
			</td>
		</tr>	
		...
		<tr>
			...
			<td width="30%" class="CONTROL"><html:radio name="countryBean"
				property="strIsValid" value="1">Active</html:radio> <html:radio
				name="countryBean" property="strIsValid" value="2">In Active</html:radio>
	...
	<table  class="TABLEWIDTH" align="center" cellpadding="1px" cellspacing="1px">
	 <tr>
			...
			<img style="cursor: pointer; " src="../../hisglobal/images/btn-clr.png" onClick="document.forms[0].reset(),clearMsg('MODIFY');"/>
	...
	<input type="hidden" name="strCountryCode" value="${countryBean.strCountryCode}"/>
    <cmbPers:cmbPers />
</html:form>
