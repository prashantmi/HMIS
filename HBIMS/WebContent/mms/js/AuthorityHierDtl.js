...
function getAjaxResponse(res,mode)
{
     ...
     if(mode=="2")
     {
     	...
     	objVal1.innerHTML="<select name='strItemCatCmb' class='comboNormal' onChange='itemCatCmbChng(this);'>"+res+"</select>";
     }
     if(mode=="3")
     {
     	//alert("mode:3::res->"+res);
     	var objVal1 = document.getElementById("reqTypeCmbDIV");
     	objVal1.innerHTML="<select name='strReqTypeCmb' class='comboNormal' onChange='reqTypCmbChng(this)'>"+res+"</select>";
     }
     if(mode=="4")
     {
...
function itemCatCmbChng(obj)
{
    ...
    var mode ="REQTYPCMB";  
    var url="AuthorityHierDtlCNT.cnt?hmode="+mode+"&storeId="+myArr[0]+"&itemCatNo="+obj.value;
    ajaxFunction(url,"3");
    var objVal1 = document.getElementById("raisingId");
    var objVal2 = document.getElementById("adminLevel1Id");
    var objVal3 = document.getElementById("receivingId");
...
function storeCmbChng(obj)
{
    ...
    var mode ="ITEMCATCMB";  
    var url="AuthorityHierDtlCNT.cnt?hmode="+mode+"&storeId="+myArr[0];
    ajaxFunction(url,"2");
    ...
    var remarks = document.getElementById("strRemarks");
	remarks.value="";	
    objRqTy.innerHTML="<select name='strReqTypeCmb' class='comboNormal'><option value='0'>Select Value</option></select>";
    document.forms[0].hlevTypAjax.value="0";
}
...
function setAuthHierDetailsRemarks() {
	...
	*/
	if(storeId!="0" && itemCategory!="0" && requestType!="0") {
		var url="AuthorityHierDtlCNT.cnt?hmode=getRemarks&storeId="+storeId+"&itemCatNo="+itemCategory+"&reqTypeId="+requestType;
    	ajaxFunction(url,"4");
	} else {
		var remarks = document.getElementById("strRemarks");
		remarks.value="";	
