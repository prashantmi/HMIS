...
function getItemCatCmb(){ 
		...
		if(document.forms[0].strStoreId.value!=0){
			var url ="StockLedgerForSubStoresRptItemCNT.cnt?hmode=ITEMCATCMB&storeId="+document.forms[0].strStoreId.value;
	 		ajaxFunction(url,"5");
	 	}else{
...
function getGroupCmb(){ 
	...
	if(document.forms[0].strItemCatId.value!=0){
		var url ="StockLedgerForSubStoresRptItemCNT.cnt?hmode=GROUPCMB&itemCatId="+document.forms[0].strItemCatId.value;
 		ajaxFunction(url,"2");
 		}else{
		document.forms[0].strGroupId.value="0";
		document.forms[0].strItemId.value="0";
...
function getItemCmb(){ 
	...
	if(document.forms[0].strGroupId.value!=0){
		var url ="StockLedgerForSubStoresRptItemCNT.cnt?hmode=ITEMCMB&groupId="+document.forms[0].strGroupId.value+"&storeId="+document.forms[0].strStoreId.value+"&itemCatId="+document.forms[0].strItemCatId.value;
 		ajaxFunction(url,"3");
 		}else{
		document.forms[0].strGroupId.value="0";
	}
...
function validate()
{
	    ...
	    var hisValidator = new HISValidator("stockLedgerForSubStoresRptItem");
...
function getDrugName()
{
	    ...
	    var url ="StockLedgerForSubStoresRptItemCNT.cnt?hmode=DRUGNAME&storeId="+document.forms[0].strStoreId.value+
