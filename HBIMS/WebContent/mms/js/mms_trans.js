 ...
 */
 ...
 function validateNewChallan(form1 , mode) {
		...
		with(form1){
			...
			if(mode=="NEWRECCHL" && document.forms[0].combo[0].value=="0" ){
				alert("Please Select Store Name Name");
				document.forms[0].combo[0].focus();
				return;
			}
			/*if(mode=="NEWRECCHL" && document.forms[0].combo[1].value=="0"){
				alert("Please Select P.O. No.");
				document.forms[0].combo[1].focus();
				return;
			}*/
			...
			if( mode == "NEWRECCHL" && document.forms[0].combo[0].value!="0" && document.forms[0].combo[1].value!="0"){
				cmbVal = combo[0].options[combo[0].selectedIndex].text + "^"+combo[1].options[combo[1].selectedIndex].text+"^"+document.forms[0].combo[0].value+"^"+document.forms[0].combo[1].value;
				comboValue.value = cmbVal;
				add(mode);
			}
			
			
			if(mode=="FINALSAVE" && document.forms[0].combo[0].value=="0" ){
				alert("Please Select Drug Store Name");
				document.forms[0].combo[0].focus();
				return;
			}
			if(mode=="FINALSAVE" && document.forms[0].combo[1].value=="0"){
				alert("Please Select P.O. No.");
				document.forms[0].combo[1].focus();
				return;
			}
			...
			if( mode == "FINALSAVE" && document.forms[0].combo[0].value!="0" && document.forms[0].combo[1].value!="0"){
				cmbVal = combo[0].options[combo[0].selectedIndex].text + "^"+combo[1].options[combo[1].selectedIndex].text;
				comboValue.value = cmbVal;
				add(mode);
			}
			if(mode=="CANCELCHL1" && document.forms[0].combo[0].value=="0" ){
				alert("Please Select Drug Store Name");
				document.forms[0].combo[0].focus();
				return;
			}
			if(mode=="CANCELCHL1" && document.forms[0].combo[1].value=="0"){
				alert("Please Select P.O. No.");
				document.forms[0].combo[1].focus();
				return;
			}
			...
			if( mode == "CANCELCHL1" && document.forms[0].combo[0].value!="0" && document.forms[0].combo[1].value!="0"){
				cmbVal = combo[0].options[combo[0].selectedIndex].text + "^"+combo[1].options[combo[1].selectedIndex].text;
				comboValue.value = cmbVal;
				add(mode);
			}
...
{
	//alert('1');
	//alert(document.forms[0].combo[2].value.split("^")[0].substr(2,2));
	var checkCount=0;
	var check=document.getElementsByName("chk");
	//alert('1');
	for(i=0;i<check.length;i++){
	...
	if(checkCount==1)
	{
		...
		if(document.forms[0].combo[1].value == '1')
		{
			...
			disableButton("Finalize");
			disableButton("Cancel");
		}
		if(document.forms[0].combo[3].value == '4')
			enableButton("Finalize");
			enableButton("Cancel");
	...
	if(document.forms[0].combo[2].value != '0' && document.forms[0].combo[0].value != '0' && document.forms[0].combo[1].value != '0')	
		enableButton("Receive");	
	else
		enableButton("Receive");
	
	if(document.forms[0].combo[0].value != '0' && document.forms[0].combo[1].value != '0' && document.forms[0].combo[2].value.split("^")[0].substr(2,2) == '87' )	
		enableButton("LP (IP) Receive");	
	else
		disableButton("LP (IP) Receive");
}
...
function chkUserDefinedRevisedChallanProcessFunc(these)
{
	...
	{		//alert('2:::'+document.forms[0].combo[3].value);
	...
	if(document.forms[0].combo[3].value == '1' && document.forms[0].combo[0].value != '0' && document.forms[0].combo[1].value != '0' && document.forms[0].combo[2].value != '0')	
		...
		if(document.forms[0].combo[2].value.split("^")[0].substr(2,2) == '87')
		{	
			enableButton("LP (IP) Receive");
		}
