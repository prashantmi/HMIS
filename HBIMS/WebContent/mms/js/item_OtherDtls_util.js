	...
	ajaxFunction2(url, "8", "getItemOtherDtlsAjaxResponse");
	 ...
	 if (mode == '2') {
			...
			itemParaObj.innerHTML = "<select name='strOtherItemGroup' onchange='getSubGroupList(this);' class='comboNormal'>"+res+"</select>";
	  ...
	  if (mode == '3') {
			...
			itemParaObj.innerHTML = "<select name='strOtherItemSubGroup' onchange='getGenItemList();' class='comboNormal'>"+res+"</select>";
	  ...
	  if (mode == '4') {
			...
			itemParaObj.innerHTML = "<select name='strOtherGenericItem' onchange='getItemList();' class='comboNormal'>"+res+"</select>";
	 ...
	 if (mode == '5') {
			...
			itemParaObj.innerHTML = "<select name='strOtherItem' onchange='getUnitList();' class='comboNormal'>"+res+"</select>";
	  ...
	  if (mode == '6') {
			...
			itemParaObj.innerHTML = "<select name='strOtherInHandQuantityUnitID' class='comboNormal'>"+res+"</select>";
	  ...
	  if (mode == '8') {
		...
		if(itemParaObj != null)
			itemParaObj.innerHTML = "<select name='strItemOtherDtlsManufactureId' class='comboNormal'>"+res+"</select>";
...
if (document.forms[0].strOtherExpiryDate != null && document.forms[0].strOtherExpiryDate.length > 0) {
	...
	if (retVal) {
		...
		var otherDtlsChkVal = document.forms[0].strOtherItemCategory[document.forms[0].strOtherItemCategory.selectedIndex].value + "^"
							...
							+ document.forms[0].strOtherInHandQuantityUnitID[document.forms[0].strOtherInHandQuantityUnitID.selectedIndex].value.split('^')[0];
		...
		document.getElementById("itemOtherQtyDivId" + index).innerHTML = document.forms[0].strOtherInHandQuantity.value +" "+ document.forms[0].strOtherInHandQuantityUnitID[document.forms[0].strOtherInHandQuantityUnitID.selectedIndex].text;
