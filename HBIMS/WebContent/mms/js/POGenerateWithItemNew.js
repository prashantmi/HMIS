...
function pageResetMethod(mode)
{
	...
	if(mode=='3')
	{		  
		   var hisValidator = new HISValidator("PODeskGenerateTransBeanNew");
	...
	if(retVal)
	{
			       ...
			       if(len==count)
			       {
		            ...
		            {  
						   ...
						   document.forms[0].strItemCat.disabled = false;
				           document.forms[0].strPOTypeId.disabled = false;
				           document.forms[0].strSupplierId.disabled = false;
				           document.forms[0].strPOItemID.disabled = false; 
				           document.forms[0].strIndentPeriodValue.disabled = false;
...
{
	if(document.forms[0].strPOTypeId.value.replace("^","#").split("#")[0]==22 || document.forms[0].strPOTypeId.value.replace("^","#").split("#")[0]==87)
		return 10;
	if(document.forms[0].strPOTypeId.value.replace("^","#").split("#")[0]==21 ||document.forms[0].strPOTypeId.value.replace("^","#").split("#")[0]==25 ||document.forms[0].strPOTypeId.value.replace("^","#").split("#")[0]==26 ||document.forms[0].strPOTypeId.value.replace("^","#").split("#")[0]==27 || document.forms[0].strPOTypeId.value.replace("^","#").split("#")[0]==23|| document.forms[0].strPOTypeId.value.replace("^","#").split("#")[0]==28)
		return 11;
	else
		return '';
}
...
function getSupplierValues()
{
	...
	{		
		...
		var contractType = 11;
		var          url = "PODeskGenerateTransNewCNT.cnt?hmode="+hmode+"&strContractType="+contractType+"&strItemCat="+document.forms[0].strItemCat.value;		
		ajaxFunction(url,"1");
	}
	else
	{
...
{	
	...
	var url = "PODeskGenerateTransNewCNT.cnt?hmode="+hmode+"&strItemCat="+document.forms[0].strItemCat.value+"&strStoreId="+document.forms[0].strStoreId.value;
	ajaxFunction(url,"6");
}
...
function getComponentDetails()
{
	...
	var url = "PODeskGenerateTransNewCNT.cnt?hmode="+hmode+"&strPOTypeId="+document.forms[0].strPOTypeId.value+"&strItemCat="+document.forms[0].strItemCat.value;
	ajaxFunction(url,"4");
}
function getPOItemList()
{
	...
	if(retVal)
	{
		//alert(document.forms[0].strPOTypeId.value+"^"+document.forms[0].strItemCat.value+"^"+document.forms[0].strStoreId.value+"^"+document.forms[0].strIndentPeriodValue[document.forms[0].strIndentPeriodValue.selectedIndex].text+"^"+document.forms[0].strSupplierId.value.split("^")[0]+"^"+document.forms[0].strPORefrenceDate.value);
	 var hmode = "GETPOITEMLIST";
	 var url = "PODeskGenerateTransNewCNT.cnt?hmode="+hmode+"&strPOTypeId="+document.forms[0].strPOTypeId.value+"&strItemCat="+document.forms[0].strItemCat.value+"&strPOStoreID="+document.forms[0].strStoreId.value+"&strIndentPeriodValue="+document.forms[0].strIndentPeriodValue[document.forms[0].strIndentPeriodValue.selectedIndex].text+"&supplierID="+document.forms[0].strSupplierId.value.split("^")[0]+"&poRefDate="+document.forms[0].strPORefrenceDate.value;
	 ajaxFunction(url,"5");
...
function putDaynamicDiv(mode)
{
 if(mode=='1')
 {
   ...
   {
    if(document.forms[0].strPOTypeId.value!='0')
    {
        ...
        if(document.forms[0].strPOItemID.value!='0')
        {
           ...
           if(document.forms[0].strItemRate.value!='0')
           {
            ...
            var divPOTypeId1 = document.getElementById("generateDynamicDiv");
	            ...
	            document.forms[0].strItemCat.disabled = true;
	            document.forms[0].strPOTypeId.disabled = true;
	            document.forms[0].strSupplierId.disabled = true;
	            document.forms[0].strPOItemID.disabled = true; 
	            document.forms[0].strIndentPeriodValue.disabled = true;
	            document.forms[0].strItemRate.disabled = true;
		      ...
		      //  document.getElementsByName("strItemRateUnitId")[0].disabled = true;
				...
				if(retVal)
				{
			        ...
			        var url = "PODeskGenerateTransNewCNT.cnt?hmode="+hmode+"&strSupplierId="+document.forms[0].strSupplierId.value+"&strPOItemID="+document.forms[0].strPOItemID.value+"&strComboPOTypeId="+document.forms[0].strPOTypeId.value+"&mode="+mode+"&strIndentPeriodValue="+document.forms[0].strIndentPeriodValue[document.forms[0].strIndentPeriodValue.selectedIndex].text+"&strStoreId="+document.forms[0].strStoreId.value;
				    ajaxFunction(url,"8");
				}
				else
				{
  ...
  {   
  	  var divPOTypeId1 = document.getElementById("generateDynamicDiv");
		    ...
		    // alert("strPOHiddenValue"+document.getElementsByName("strPOHiddenValue").value)
		     ...
		     var   url = "PODeskGenerateTransNewCNT.cnt?hmode="+hmode+"&strSupplierId="+0+"&strPOItemID="+document.forms[0].strPOItemID.value+"&strPONo="+document.forms[0].strPONo.value+"&strPOHiddenValue="+document.forms[0].strPOHiddenValue.value+"&mode="+mode+"&strStoreId="+document.forms[0].strStoreId.value;
		     ajaxFunction(url,"88");
...
function getUnitCombo()
{
	...
	var url = "PODeskGenerateTransNewCNT.cnt?hmode="+hmode+"&strPOItemID="+document.forms[0].strPOItemID.value;
	ajaxFunction(url,"9");
