...
function getSuppPerformanceDtlPrint() 
{
    ...
    if(suppId=='-1')
	{
		...
		document.getElementsByName("strSupplierId")[0].focus();
		return false;
	}	
	...
	var myPopup = window.open("SupplierPaymentDtailRptCNT.cnt?hmode="+mode+ "&supplierId="+ suppId+"&fromDate="+document.forms[0].strFromDate.value+"&toDate="+document.forms[0].strToDate.value+"&suppName="+suppName+"&strCheckHidValue="+strCheckHidValue+"&poNumber="+poNumber+"&flag=" + retFlag, 'popupWindow', heg_width);
