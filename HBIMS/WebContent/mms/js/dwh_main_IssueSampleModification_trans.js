...
function validate1()
{
	      var hisValidator = new HISValidator("issueSampleModificationTransFB");  
		  ...
		  {
		  	hisValidator.addValidation("strVoucherDate","dtltet="+document.forms[0].strCurrentDate.value, "Voucher Date Must be Less than Or equal to Current Date." );
		  }
...
function getVoucherCombo() 
{
	...
	else 
	{
		...
		var url = "IssueSampleModificationTransCNT.cnt?hmode=" + mode + "&storeId="
				+ temp + "&itemCatNo="+10;
...
function getVoucherDetail()
{
   if(document.forms[0].strStoreName[document.forms[0].strStoreName.selectedIndex].value!='0' )
   {
    ...
    if(document.forms[0].strVoucherNo.value!='0')
    {
		...
		var url = "IssueSampleModificationTransCNT.cnt?hmode=" + mode + "&voucherNo="+ document.forms[0].strVoucherNo.value+"&strStoreId="+document.forms[0].strStoreName.value;
		ajaxFunction(url, "3");
    }
  }
  else
...
//	alert("strStoreId"+document.getElementsByName("strStoreName")[0].value);
		...
		var url = "IssueSampleModificationTransCNT.cnt?hmode=" + mode 
