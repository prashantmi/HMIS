...
function goFunc()  
{
	var hisValidator = new HISValidator("dupreturnFromTransBean");
...
function itemCategoryCombo()
{
   ...
   var url="DupReturnFromTransCNT.cnt?hmode=ITEMCATEGORY&storeid="+document.forms[0].strStoreId.value
                                  +"&modeVal="+document.forms[0].strMode.value;
   ajaxFunction(url,"1");
   }else{
        objVal= document.getElementById("itemCategoryId");
		  objVal.innerHTML = "<select name ='strItemCategoryNo' id='strItemCategoryNo' class='comboNormal'><option value='0'>Select Value</option></select>";
   }
} 
...
{ 
 	...
 	//alert(issueNo.split('^')[0]);
 	//alert(document.forms[0].itemCategory.value);
    var url="DupReturnFromTransCNT.cnt?hmode=ISSUEDETAILS&issueNo="+issueNo.split('^')[0]+"&strId="+document.forms[0].strId.value+"&itemcat="+document.forms[0].itemCategory.value;
    ajaxFunction(url,"2");
...
function getAjaxResponse(res,mode)
{
	...
	{	
	   ...
	   if(temp1[0] == "ERROR")
	   {
        ...
        {
    	   //alert(res);
          objVal= document.getElementById("strItemCategoryNo");
		  objVal.innerHTML = "<select name ='strItemCategoryNo' id='strItemCategoryNo' class='comboNormal'>" + res + "</select>";
        }
    }
    ...
    if(mode=="2")
	{
        ...
        }else
        {
			...
			var tmpdate=document.forms[0].strIssueNo.value;
			//alert(res);
			//var temp = res.split("^");
			document.getElementById("issueDtDivId").innerHTML = "<input type='hidden' name='strIssueDate' value='"+tmpdate.split('^')[2]+"'/>"+tmpdate.split('^')[2];
...
{
	var url;
	//document.getElementById("returndivId").style.display="block";
	var mode = "unspecified";
	document.forms[0].hmode.value=mode;
	document.forms[0].strCrNo.value="";
	document.forms[0].submit();
...
var issueNo1 = document.forms[0].strIssueNo.value;
var issueNo = issueNo1.split('^')[0];
var storeId =  document.forms[0].strId.value;
if(issueNo1 == '0')
	{
	    alert('Please Select Return No. Combo');
		return false;
	}
//var IndentNo=document.forms[0].strLpRequestNo.value;
//var IndentDate=document.forms[0].strRequestDate.value

//alert("issueNo-"+issueNo1.split('^')[0]);
//alert("storeId-"+storeId);
//alert("IndentNo-"+IndentNo);
//alert("IndentDate-"+IndentDate);
//return false;
...
function getIssueDtlsAjaxResponse(res, mode) {
	...
	if (mode == '1') {
		...
		document.getElementById("returndivId").style.display="none";
		//alert(res);
		popup('popUpDiv', '80', '60');
