...
function initPage()
{
 ...
 function getAjaxResponse(res,mode)
 {
     ...
     if(mode=="1")
     {
        ...
        objVal1.innerHTML = "<select name = 'strGroupIdForItemSearch' class='form-control'>" + res + "</select>";
       
     }
     if(mode=="2")
     {
        var objVal = document.getElementById("ItemCatg");
        objVal.innerHTML = "<select name = 'strItemCatgCombo' class='form-control'>" + res + "</select>";
         getApprovedByCombo();
     }
      ...
      if(mode=="3")
     {
        ...
        objVal.innerHTML = "<select name = 'strItemCatgCombo' class='form-control' onchange='getGroupNameCombo();'>" + res + "</select>";
	 ...
	 if(mode=="5")
	  {	  	    
	 	    document.getElementById("ApprovedBy").innerHTML  = "<select name = 'strApprovedBy' class='form-control' >" + res + "</select>";
