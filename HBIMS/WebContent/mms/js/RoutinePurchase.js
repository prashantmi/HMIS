      ...
      for(var x=0;x<itemParVal.length-1;x++)
      {
        ...
        else
	    {
		  return false;
      		...
      		/*
      		if(document.forms[0].strApproxAmt.value.length >13)
      		{
      			alert("Maximum Value allowed is 9999999999.99");
      			return false;	
      		}*/
										          ...
										          if(conf == true)
										          {
										               ...
										               {	              
													       ...
													       var len=document.getElementsByName("itemUserValue").length;
													       for(var x=0;x<=len-1;x++)
													    	   {
													    	   	document.getElementsByName("itemUserValue")[x].disabled=false;
													    	   }
										            	   document.forms[0].strIndentPeriod.disabled=false;
