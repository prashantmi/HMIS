 ...
 */
 function getSubGroupList(grpObj) {
 	...
 	if(gblStrGroupIdForItemSearch == -1){
 	 	...
 	 	document.getElementById("subGroupdivId").innerHTML = "<select name='strSubGroupIdForItemSearch' class='form-control' ><option value='0'>All</option></select>";
		document.getElementById("itemListDivId").innerHTML =  "<select name='strItemList' class='form-cotrol' ><option value='0'>All</option></select>";
...
function getMyAjaxResponse(res, mode) {
	...
	if (mode == '2') 
	{
		...
		if (gblMode == '1') {
			...
			itemListObj.innerHTML = "<select name='strItemList' class='form-control' onchange='getBrandItemList("+gblMode+");'  >" + res + "</select>";
			 

		} else if (gblMode == '2') {

			itemListObj.innerHTML = "<select name='strItemList'class='form-control' onchange='getBrandItemList("+gblMode+");setItemStockParameters(this);'> "
					+ res + "</select>";
...
if(mode == '6'){
		...
		document.getElementById("subGroupdivId").innerHTML = "<select name='strSubGroupIdForItemSearch' class='form-control' onchange='getItemList(\"" + gblMode + "\" , this);'>"+temp[0]+"</select>"
		
		if (gblMode == '2')
		{
			
			document.getElementById("itemListDivId").innerHTML =  "<select name='strItemList' class='form-control' onchange='getBrandItemList("+gblMode+");setItemStockParameters(this);' >" + temp[1] + "</select>";
			
		}
		else
		{

		document.getElementById("itemListDivId").innerHTML =  "<select name='strItemList' class='form-control' onchange='getBrandItemList("+gblMode+");' >" + temp[1] + "</select>";
...
if (gblMode != '2') {
					...
					if (tempVal.length > 1) {
						...
						if (tempVal.length == 3) {
							...
							obj.innerHTML = "<select class='form-control' onchange='"
									+ tempVal[2]
									+ "("
									+ gblMode
									+ ","
							...
							obj.innerHTML = "<select class='form-control' name='"
						...
						if (selectedItemsListVals[fetchArrayIndex] != null) {
							...
							if (fetchArrayIndex == '0') {
								...
								if (gblMode == '1') {
									...
									popupContent = "<table class='table table-striped text-uppercase' width='500' cellspacing='0px' cellpadding='0px'><tr class=''><th colspan='3' align='left'>" +
										...
										+ "-"
										+ (myrowIndex + 1)
										+ "\");'></th></tr></table><table class='table table-striped text-uppercase' width='500' cellspacing='1px' cellpadding='1px'>"
											+ "<tr>"
											+ "<td class='' width='25%'>Last P.O. No.</td><td class='' width='25%'>"+lastPoNo+"</td>"
											+ "<td class='' width='25%'>Last P.O. Date</td><td class='' width='25%'>"+lastPoDate+"</td>"
											+ "</tr>"
											+ "<tr>"
											+ "<td class='' width='25%'>Last Rate / Unit</td><td class='' width='25%'>"+lastRate+"</td>"
											+ "<td class='' width='25%'>Supplied By</td><td class='' width='25%'>"+suppliedBy+"</td>"
											+ "</tr>"
											+ "<tr>"
											+ "<td class='' width='25%'>Specification</td><td colspan='3' width='75%' class=''>"+specification+"</td>"
											+ "</tr></table><table class='table table-striped text-uppercase' width='500' cellspacing='1px' cellpadding='1px'><tr class=''><td colspan='4'></td></tr></table>";
									...
									popupContent = "<table class='table table-striped text-uppercase' width='500' cellspacing='0px' cellpadding='0px'><tr class=''><th colspan='3' align='left'>" +
										...
										+ "\");'></th></tr></table><table class='table table-striped text-uppercase' width='500' cellspacing='1px' cellpadding='1px'>"
											+ "<tr>"
											+ "<td class='' width='50%'>Last Rate</td><td colspan='3' class='' width='50%'>"+lastRate+"</td>"
											+ "</tr>"
											+ "<tr>"
											+ "<td class='' width='25%'>Specification</td><td colspan='3' class='' width='75%'>"+specification+"</td>"
											+ "</tr></table><table class='table table-striped text-uppercase' width='500' cellspacing='1px' cellpadding='1px'><tr class=''><td colspan='4'></td></tr></table>";
									...
									popupContent = "<table width='500' cellspacing='0px' cellpadding='0px'><tr class='HEADER'><th colspan='3' align='left'>" +
											"&nbsp;"+itemName+" - Details</th><th align='right'><img src='../../hisglobal/images/popUp_cancel.JPG' onClick='hide_popup_menu(\"itemDetailsDivId"
										+ ""
										+ gblLayerIndex
										+ "-"
										+ (myrowIndex + 1)
										+ "\");'></th></tr></table><table class='table text-uppercase' width='500' cellspacing='1px' cellpadding='1px'>"
										
										    + "<tr>"
											+ "<td bgcolor='#6c757d' width='25%'><label>Last Rate / Unit</label></td><td class='' width='25%'>"+lastRate+"</td>"
											+ "<td bgcolor='#6c757d' width='25%'>Last P.O.No / Date</td><td class='' width='25%'>"+lastPoNo+"/"+lastPoDate+"</td>"
											+ "</tr>"	
											+ "<tr>"										
											+ "<td bgcolor='#6c757d' width='25%'>Supplied By</td><td colspan='3' class='' width='75%'>"+suppliedBy+"</td>"
											+ "</tr>"	
											...
											//+ "</tr>"
											+ "<tr>"
											+ "<td bgcolor='#6c757d' width='25%'>Manufacturer</td><td colspan='3' class='' width='75%'>"+manufacturer+"</td>"
											+ "</tr>"
											//+ "<tr>"
											//+ "<td class='LABEL' width='25%'>Specification</td><td colspan='3' class='CONTROL' width='75%'>"+specification+"</td></tr>"
											+ "</table><table class='table text-uppercase' width='500' cellspacing='1px' cellpadding='1px'><tr class='FOOTER'><td bgcolor='#6c757d' colspan='4'></td></tr></table>";
									...
									popupContent = "<table class='table table-striped text-uppercase' width='500' cellspacing='0px' cellpadding='0px'><tr class=''><th colspan='3' align='left'>" +
										...
										+ "\");'></th></tr></table><table width='400' cellspacing='1px' cellpadding='1px'>"
											...
											+ "<tr>"
											+ "<td class='' width='25%'>Last Rate / Unit</td><td class='' width='25%'>"+lastRate+"</td>"
											+ "<td class='' width='25%'>Supplied By</td><td class='CONTROL' width='25%'>"+suppliedBy+"</td>"
											+ "</tr>"
											+ "<tr>"
											+ "<td class='' width='25%'>Specification</td><td colspan='3' class='' width='75%'>"+specification+"</td>"
											+ "</tr></table><table width='500' cellspacing='1px' cellpadding='1px'><tr class=''><td colspan='4'></td></tr></table>";
					...
					if (selectedItemsListVals[fetchArrayIndex] != null) {
						...
						if (fetchArrayIndex == '0') {
							...
							if (gblMode == '1') {
								...
								popupContent = "<table width='500' cellspacing='0px' cellpadding='0px'><tr class='HEADER'><th colspan='3' align='left'>" +
										"&nbsp;"+itemName+" - Details</th><th align='right'><button  type='button' class='btn btn-outline-danger mt-1 btn-circle' style='background-color: #d9534f;' onClick='hide_popup_menu(\"itemDetailsDivId"
									+ ""
									+ gblLayerIndex
									+ "-"
									+ (i + 1)
									+ "\");'></button></th></tr></table><table width='500' cellspacing='1px' cellpadding='1px'>"
										   
										    + "<tr>"
											+ "<td bgcolor='#6c757d' width='25%'>Last Rate / Unit</td><td class='multiPOControl' width='25%'>"+lastRate+"</td>"
											+ "<td bgcolor='#6c757d' width='25%'>Last P.O.No / Date</td><td class='multiPOControl' width='25%'>"+lastPoNo+"/"+lastPoDate+"</td>"
											+ "</tr>"	
											+ "<tr>"										
											+ "<td bgcolor='#6c757d' width='25%'>Supplied By</td><td colspan='3' class='multiPOControl' width='75%'>"+suppliedBy+"</td>"
											+ "</tr>"	
											/* Commented By Amit 28-Feb-2012*/
											//+ "<tr>"  
											//+ "<td class='LABEL' width='25%'>Last Rate / Unit</td><td class='CONTROL' width='25%'>"+lastRate+"</td>"
											...
											//+ "</tr>"
											+ "<tr>"
											+ "<td bgcolor='#6c757d' width='25%'>Manufacturer</td><td colspan='3' class='multiPOControl' width='75%'>"+manufacturer+"</td>"
											+ "</tr>"
											//+ "<tr>"
											//+ "<td class='LABEL' width='25%'>Specification</td><td colspan='3' class='CONTROL' width='75%'>"+specification+"</td></tr>"
