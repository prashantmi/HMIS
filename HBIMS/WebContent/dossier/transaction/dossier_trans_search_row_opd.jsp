...
<form name="multirow">
<logic:equal value="1" name="DossierRequisitionBean" property="strDoseFrqFlg">
	...
	<td width="15%" class="multiControl">
		<select name="strDose"  class='comboMin'
			id="strDose#delIndex#" onchange="onQuantity('#delIndex#');" >
				<bean:write name="DossierRequisitionBean" property="strDosageValues"
						filter="false" />
		</select></td>
	...
	<td width="10%" class="multiControl">
		<select name="strFrequency" 
			id="strFrequency#delIndex#"  onchange="onQuantity('#delIndex#');">
				<bean:write name="DossierRequisitionBean" property="strFrequencyValues"
						filter="false" />
		</select></td>
...
<logic:equal value="0" name="DossierRequisitionBean" property="strDoseFrqFlg">
<div id="rowAdded1" style="display:none">
<table class="TABLEWIDTH" bgcolor='#6097BC'  align="center" cellpadding="1px" cellspacing="1px"  id="td#delIndex#">
 <tr>
	...
	<td class="multiControl" width="8%">
		<div id="itemParaId67#delIndex#"></div>
	</td>
	...
	<td class="multiControl"  width="8%">
			<select name="isBroughtByPatient">
	...
	<td class="multiControl"  width="8%">
		...
		<div id="strQuantityText#delIndex#" style="display: block">
			<input type="text" name="strQtyText1" id="strQtyText1#delIndex#" class='txtFldMin'  onblur="QtyValidationopd('#delIndex#');" maxlength="5" onkeypress="return validateData(event,5);"  tabindex="1"> No.
		</div>
