	...
	*/
		...
		if (true) {
			...
			if(document.getElementById("searchItemsDtlsDivId").innerHTML=="")
				...
				var url = "/HBIMS/dossier/transaction/MmsCNT.cnt?hmode=" + hmode + "&strMode=" + strMode
...
function getLeftItemBrandListOnly(mode) 
{
		...
		var url = "/HBIMS/dossier/transaction/MmsCNT.cnt?hmode=" + hmode + "&strMode=2&strGroupId="
 ...
 */
 function getSubGroupList(grpObj) {
 	...
 	var hmode = "GETSUBGROUPLIST";
			var url = "/HBIMS/dossier/transaction/MmsCNT.cnt?hmode=" + hmode + "&strMode=" + gblMode
...
function getItemList(mode) {
   ...
   document.getElementById("brandItemListDivId").innerHTML = "<select name='strBrandedItemList' multiple='multiple' size='12' style='width :100%'></select>";
	...
	var url = "/HBIMS/dossier/transaction/MmsCNT.cnt?hmode=" + hmode + "&strMode=" + gblMode + "&strGroupId="
...
function getBrandItemList(mode) 
{
		...
		var url = "/HBIMS/dossier/transaction/MmsCNT.cnt?hmode=" + hmode + "&strMode=" + mode + "&strGroupId="
			+ gblStrGroupIdForItemSearch + "&strSubGroupId=" + subGrpId + "&strItemId="
			+ ItemId + "&strRequestType=" + gblRequestType + "&strFrmStoreId="
			+ gblFromStoreId + "&strItemCatId=" + gblItemCategory +"&strUserInfo="+gblUserInfo;
	 //alert(url);
...
if (gblMode != '2') {
					...
					if (tempVal.length > 1) {
						...
						{	
							...
							var url = "/HBIMS/dossier/transaction/MmsCNT.cnt?hmode="
									+ hmode
									+ "&strUnitId="
						...
						else 
						{
							...
							var url = "/HBIMS/dossier/transaction/MmsCNT.cnt?hmode=" + hmode+ "&strUnitId=1&strUnitMode="+gblUnitMode;
						}
		...
		/*		if (gblMode != '2') {		  
				...
				if (tempVal.length > 1) {
					...
					if(unitVal != "" && unitVal != "0"){	
							...
							var url = "/HBIMS/dossier/transaction/MmsCNT.cnt?hmode=" + hmode
 ...
 */
 function getAddNewItemScreen() {
 	 	 ...
 	 	 if(genItem == 0){
			...
			var url = "/HBIMS/dossier/transaction/MmsCNT.cnt?hmode=" + hmode + "&strGenericItemDtls=" + genItem+"&strNewItemFlag="+document.forms[0].strNewItemFlag.value ;
	 ...
	 function saveNewItemDetails() {
    	 ...
    	 var retVal = hisValidator.validate(); 
          ...
          if(retVal){
				...
				var url = "/HBIMS/dossier/transaction/MmsCNT.cnt?hmode=" + hmode + "&strGenericItemDtls=" + document.forms[0].strAddNewItemHiddenVal.value 
 ...
 */
 ...
 function getCIMSData(obj)
 {
	 ...
	 var url = "/HBIMS/dossier/transaction/MmsCNT.cnt?hmode="+hmode+"&strButtonMode="+strButtonMode+"&strCIMSId=" + strCIMSId+"&strItemName="+strItemName+"&strAllCIMSID="+temp;
	 //alert(url);
