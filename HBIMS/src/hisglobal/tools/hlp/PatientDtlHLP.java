...
public class PatientDtlHLP 
{
		...
		try 
		{
			...
			if (ws != null && ws.size() > 0) 
			{
				if (ws.next()) 
				{
					...
					sb.append("<div class='col-md-2' style='font-weight:10;color:rgba(75, 75, 75, 0.7);word-wrap:break-word;'>");sb.append(strPatientName);sb.append("</div>");
					sb.append("<div class='col-md-2'>Patient Category");sb.append("</div>");
					sb.append("<div class='col-md-2' style='font-weight:10;color:rgba(75, 75, 75, 0.7);word-wrap:break-word;'>");sb.append(strCategoryName);					sb.append("<input type='hidden' name='strCatgoryCode' value='"+ strCategoryCode + "'><input type='hidden' name='strCatGrp' value='"+ catGrp + "'><input type='hidden' name='strVisitType' value='"+ visitType + "'><input type='hidden' name='strEpisodeCode' value='"+ episodeCode + "'>");
					sb.append("</div>");
					sb.append("<div class='col-md-2'>Age/Gender");sb.append("</div>");
					sb.append("<div class='col-md-2' style='font-weight:10;color:rgba(75, 75, 75, 0.7);word-wrap:break-word;'>");sb.append(strAgeAndSex);sb.append("</div>");
					sb.append("</div>");
					
					sb.append("<div class='row rowFlex reFlex'>");
					sb.append("<div class='col-md-2 px-4'>Father Name");sb.append("</div>");
					sb.append("<div class='col-md-2' style='font-weight:10;color:rgba(75, 75, 75, 0.7);word-wrap:break-word;'>");sb.append(strFatherOrHusbandName);sb.append("</div>");
					sb.append("<div class='col-md-2'>Spouse Name");sb.append("</div>");
					sb.append("<div class='col-md-2' style='font-weight:10;color:rgba(75, 75, 75, 0.7);word-wrap:break-word;'>");sb.append(strSpouseName);sb.append("</div>");
					...
					if (id[4].equals("1")) 
					{
						...
						sb.append("<div class='col-md-2' style='font-weight:10;color:rgba(75, 75, 75, 0.7);word-wrap:break-word;'>");sb.append(strMlcNo);sb.append("</div>");
						sb.append("</div>");
					...
					if (fAddress) 
					{
						...
						sb.append("<div class='col-md-8' style='font-weight:10;color:rgba(75, 75, 75, 0.7);word-wrap:break-word;'>");
						sb.append(strAddress);
						sb.append("</div>");
						sb.append("</div>");
		...
		try 
		{
			...
			if (ws != null && ws.size() > 0) 
			{
				if (ws.next()) 
				{
					...
					sb.append("<div class='col-md-2' style='font-weight:10;color:rgba(75, 75, 75, 0.7);word-wrap:break-word;'>");sb.append(strAdmissionNo);sb.append("</div>");
					sb.append("<div class='col-md-2'>Adm Date/Time");sb.append("</div>");
					sb.append("<div class='col-md-2' style='font-weight:10;color:rgba(75, 75, 75, 0.7);word-wrap:break-word;'>");sb.append(strAdmissionDate);
					sb.append("</div>");
					sb.append("<div class='col-md-2'>Dept / Unit");sb.append("</div>");
					sb.append("<div class='col-md-2' style='font-weight:10;color:rgba(75, 75, 75, 0.7);word-wrap:break-word;'>");sb.append(strDeptName).append(" / ").append(strUnitName);sb.append("</div>");
					sb.append("</div>");
					
					sb.append("<div class='row rowFlex reFlex'>");
					sb.append("<div class='col-md-2 px-4'>Ward / Room / Bed");sb.append("</div>");
					sb.append("<div class='col-md-2' style='font-weight:10;color:rgba(75, 75, 75, 0.7);word-wrap:break-word;'>");sb.append(strWardName).append(" / ").append(strRoomName).append(" / ").append(strBedName);sb.append("</div>");
					sb.append("<div class='col-md-2'>Treatment Category");sb.append("</div>");
					sb.append("<div class='col-md-2' style='font-weight:10;color:rgba(75, 75, 75, 0.7);word-wrap:break-word;'>");sb.append(strTreatmentCategoryName);
					sb.append("</div>");
					sb.append("<div class='col-md-2'>Consultant Name");sb.append("</div>");
					sb.append("<div class='col-md-2' style='font-weight:10;color:rgba(75, 75, 75, 0.7);word-wrap:break-word;'>");sb.append(strConsultantName);sb.append("</div>");
					sb.append("</div>");
	...
	throws Exception 
	{
		...
		try 
		{
			...
			if (ws != null && ws.size() > 0)
			{
				str.append("<div class='row' align='center'>");
				str.append("<div class='col-sm-4'>Drug Name</div>");
				str.append("<div class='col-sm-2'>Dose Name</div>");
				str.append("<div class='col-sm-2'>Frequency</div>");
				str.append("<div class='col-sm-2'>Start Date</div>");
				str.append("<div class='col-sm-2'>End Date</div>");
				str.append("</div><hr>");
			    ...
			    while (ws.next()) 
			    {
					...
					str.append("</div><div class='col-sm-2'>");
