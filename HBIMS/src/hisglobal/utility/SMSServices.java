...
public class SMSServices {
	...
	/*	private static String username = "pgimsdg-his";
		private static String password = "pG!meR@17#$";
		
		private static String senderid = "PGICHD";
		private static String securityKey="23d282b7-ee4b-4e5a-aba1-893a5da97053";*/
		
				
		sms.sendSingleSMS("pgimsdg-his", "pG!meR@17#$", "test msg", "PGICHD", "9599427299", "23d282b7-ee4b-4e5a-aba1-893a5da97053");
		//sms.sendTextSMSThroughNICSMSGateway("pgimsdg-his", "pG!meR@17#$", "PGICHD","", "9599427299", "23d282b7-ee4b-4e5a-aba1-893a5da97053");
	}
	
	public static void sendTextSMSThroughNICSMSGateway(String username,String password, String senderId,String sms_URL,String mobileNo, String key) 
	{
		try 
		{
			...
			URI.append("https://msdgweb.mgov.gov.in/esms/sendsmsrequest");
			URI.append("?mobileno=" + recipient);
			URI.append("&senderid=" + senderId);
			URI.append("&content=" + messageBody);
			URI.append("&smsservicetype=singlemsg");
			URI.append("&username=" + username);
			URI.append("&password=" + password);
			URI.append("&key=" + key);
