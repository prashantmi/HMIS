		...
		try {
			...
			//{
				if (wb != null && wb.size() > 0) 
				{
					...
					{
						// rowSize = wb.size();
						sb.append("<p class='subHeaders'>OnLine Request<p>");
						sb.append("<table class='table' > ");
						sb.append("<input type='hidden' name='tmpMsg' value="+tmp+">");
						
						sb.append("<thead>");
						sb.append("<tr><th><font style='font-size: 14px;' size='2' face='Helvetica Neue, Helvetica, Arial, sans-serif' color='#000000'>#</font></th>");
						sb.append("<th><font style='font-size: 14px;' size='2' face='Helvetica Neue, Helvetica, Arial, sans-serif' color='#000000'>Req No</font></th>");
						sb.append("<th><font style='font-size: 14px;' size='2' face='Helvetica Neue, Helvetica, Arial, sans-serif' color='#000000'>Req Date</font></th>");
						sb.append("<th><font style='font-size: 14px;' size='2' face='Helvetica Neue, Helvetica, Arial, sans-serif' color='#000000'>Dept/Ward</font></th>");
						sb.append("<th><font style='font-size: 14px;' size='2' face='Helvetica Neue, Helvetica, Arial, sans-serif' color='#000000'>Hospital Service</font></th>");
						sb.append("<th><font style='font-size: 14px;' size='2' face='Helvetica Neue, Helvetica, Arial, sans-serif' color='#000000'>Request Type</font></th></tr>");
						sb.append("</thead>");
						sb.append("<tbody>");
						...
						for (int i = 0; wb.next(); i++) 
						  {
							...
							sb.append("<tr><td><font style='font-size: 14px;' size='2' face='Helvetica Neue, Helvetica, Arial, sans-serif' color='#000000'><input type='radio' style='cursor:pointer;cursor:hand' name='strChk_values' id='strChk_values' value=\""+strChk+"\"  onClick='groupCheck(this,"+i+");'");
							if (i == 0) 
							{
