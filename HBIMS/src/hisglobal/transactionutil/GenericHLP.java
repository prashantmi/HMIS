...
/*			if (rowsetSize <= 0) 
	...
	public String getSearchRowString(GenericVO vo, int minrow, int max_rownum,
		...
		try {
			...
			br.append("&nbsp;&nbsp;&nbsp;<A STYLE='CURSOR:POINTER'><IMG SRC='/HBIMS/hisglobal/transactionutil/images/search_icon1.gif' alt='Click To Search Records' onClick='searchpage();' tabindex='0' onKeyPress='if(event.keyCode==13) searchpage();'></A></DIV></TD></TR>");
	...
	public String getButtonLayOut1(String[] userDefinedButton,String menuOption, String buttonConfig, int minPanelButton,int recPerPage, GenericVO vo, String[] dbButtons,String[] buttonIcons) 
	{
		...
		String imageUrl="/HBIMS/hisglobal/transactionutil/images/icon-default.png";
					...
					for (int i = 0; i < no_of_button; i++) 
					{
						...
						if (buttons[i].split("@")[2].equals("0")) 
						{
							...
							if(buttonIconsFinal[i]!=null)
								imageUrl="/HBIMS/hisglobal/transactionutil/images/"+buttonIconsFinal[i];
							...
							sb.append("<div id=\""+ buttons[i].split("@")[0]+ "disable\" class='btnParentDiv' style='display: none;'>");
