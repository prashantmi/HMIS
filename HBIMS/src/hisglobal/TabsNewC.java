...
public  class TabsNewC extends TagSupport
{
	...
	public int doStartTag()//throws JspTagException
	{
		try
		{
			...
			if(tabList!=null)
			{
				...
				str += "<div class='navbar navbar-expand-sm' style='height: 30px'>\n";
				str += "<div class='row ''>";
				str += "<div class='col-12'>";
				str += "<div class='navbar-nav'>";
				/*str += "<nav>";
				...
				while(it.hasNext())
				{
					...
					{
						str += " <button type=\"button\" class=\"btn btn-info btn-sm collapsed\" style=\"display: block;\"  >";
						str += "<div class='active'>" + label + "</div>";
