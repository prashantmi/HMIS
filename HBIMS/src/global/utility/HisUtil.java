	...
	public static String getParameterFromHisPathXML(String _Param){
		...
		try{
			...
			if(osType.startsWith("Win")){
				...
				_Param += "_LIN";
		    	paramValue = getParameterFromXML("/opt/NIMS/AHIMSG5/hisPath.xml", _Param);
			}
		}catch(Exception e){
			e.printStackTrace();
		}
		...
		try 
		{
			...
			if(hospitalVO!=null)
			{
				...
				{   
					...
					{
						sBuffer.append("<td width='10%'><div align='right'><img src='/HBIMS/hisglobal/images/nims-tr-logo.gif'></div></td>");
		...
		try 
		{
			...
			if(hospitalVO!=null)
			{
				...
				{   
					...
					if(!strReportFormat.equalsIgnoreCase("pdf"))
					{
						sBuffer.append("<td width='5%'><div align='right'><img src='/HBIMS/hisglobal/images/nims-tr-logo.gif'></div></td>");
			...
			try 
			{
				...
				if(hospitalVO!=null)
				{
					...
					{   
						...
						if(!strReportFormat.equalsIgnoreCase("pdf"))
						{
							sBuffer.append("<td width='5%'><div align='right'><img src='/HBIMS/hisglobal/images/nims-tr-logo.gif' width='75%' height='75%'></div></td>");
