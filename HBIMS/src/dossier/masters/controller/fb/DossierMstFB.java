...
/**
* The Class DossierMstFB.
*/
public class DossierMstFB extends GenericFormBean {
	...
	private String strDossierShortName="1";
	...
	private String strDeptDataDiv = "";

	public String getStrDeptDataDiv() {
		return strDeptDataDiv;
	}

	public void setStrDeptDataDiv(String strDeptDataDiv) {
		this.strDeptDataDiv = strDeptDataDiv;
	}

	private String strDossierName="";
	private String strDossierDescription="";
	private String strDepartmentNameValues = "";
	private String strServiceTypeNameValues="";
	private String strBillingMode="";
	private String strServiceTypeID="";
	private String strServiceTypeName="";
	
	public String getStrServiceTypeNameValues() {
		return strServiceTypeNameValues;
	}

	public void setStrServiceTypeNameValues(String strServiceTypeNameValues) {
		this.strServiceTypeNameValues = strServiceTypeNameValues;
	}
	...
	public String getStrDepartmentNameValues() {
		return strDepartmentNameValues;
	}

	public void setStrDepartmentNameValues(String strDepartmentNameValues) {
		this.strDepartmentNameValues = strDepartmentNameValues;
	}
