...
public class DossierDeskTransHLP {
				...
				if (wb.size() != 0) {
					...
					while (wb.next()) {
						...
						if (vo.getUnitComboWs() != null
							...
							strReturnUnitCombo = hisutil.getOptionValue(
									vo.getUnitComboWs(), "", "", true);
						} else {
						...
						if (!(wb.getString(8).equals("-1") || wb.getString(8)
								.equals("0"))) {
							buff.append("<tr>");
							buff.append("<td class='multiControl' >"
									+ wb.getString(2)
	...
	public static String getIssueDtlsInitView(DossierDeskTransFB formBean)
		...
		try {
			...
			HospitalMstVO hospitalVO = hisUtil.getHospitalDetail(formBean
					.getStrHospitalCode());
			System.out.println("hospitalVO.getAddress1()"
			 ...
			 * sb.append("<tr>"); sb.append("<td width='10%'></td>"); sb.append(
			 * "<td width='80%' align='center'> <b><font face='Verdana, Arial, Helvetica, sans-serif' size='2'> "
			 ...
			 * sb.append("<td width='10%'></td>"); sb.append(
			 * "<td width='90%' align='center'> <b><font face='Verdana, Arial, Helvetica, sans-serif' size='3'> "
			 * ); sb.append(res.getString("PAT_ISSUE_TITLE2"));
			 * sb.append("</font></b></td> <td width='10%'>&nbsp;</td> ");
			 * sb.append("</tr> "); sb.append("<tr>");
			 * sb.append("<td width='10%'></td>"); sb.append(
			 * "<td width='90%' align='center'> <b><font face='Verdana, Arial, Helvetica, sans-serif' size='2'> "
			 * ); System.out.println("formBean.getStrHospitalName()"+formBean.
			 * getStrHospitalName()); sb.append(formBean.getStrHospitalName());
			 * sb.append("</font></b></td> <td width='10%'>&nbsp;</td> ");
			 ...
			 * 
			 * sb.append(
			 * "<td width='50%' colspan='2'  align='center' ><font face='Verdana, Arial, Helvetica, sans-serif' >"
			 * ).append(formBean.getStrLocDL().split("@")[1])
			 * .append("</font></td> ");
			 */
			 ...
			 * sb.append(
			 * "<td width='25%' align='right'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>"
			 * ).append("Doctor:</b></font></td> "); sb.append(
			 * "<td width='25%' ><font face='Verdana, Arial, Helvetica, sans-serif' >"
			 * ).append(formBean.getStrPrescribedBy()) .append("</font></td> ");
			 */
			 ...
			 * "<td width='25%' align='right'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>"
			 * ).append("Reg.No:</b></font></td> "); // sb.append(
			 * "<td width='25%' ><font face='Verdana, Arial, Helvetica, sans-serif' ><b>"
			 * ).append(formBean.getStrIssueNo()) //
			 * .append("</b></font></td> "); sb.append(
			 * "<td width='25%' ><font face='Verdana, Arial, Helvetica, sans-serif' >"
			 * +formBean.getStrRegNo()+"</font></td> ");
			 * 
			 * 
			 * sb.append("</tr> ");
			 */
			...
			/*
			 * if(!formBean.getStrLFAccountNo().equals("0")) { sb.append(
			 * "<td width='25%' align='right'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>"
			 * ).append("LF No:</b></font></td> "); sb.append(
			 * "<td width='25%' ><font face='Verdana, Arial, Helvetica, sans-serif' >"
			 * ).append(formBean.getStrLFAccountNo()) .append("</font></td> ");
			 * } else
			 */
			// {
			...
			/*
			 * sb.append(
			 * "<td align='center' width='10%'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>Batch No.</b></font> "
			 * ); sb.append("</td> ");
			 */
			/*
			 * sb.append(
			...
			if (ws != null && ws.size() > 0) {
				...
				while (ws.next()) {
					...
					/*
					 * (Which Call in Case of Off-Line Issue Voucher) 1.Hospital
					 * Name ^ DDC Name ^ Prescribe For ^ Issue No ^ Issued By
					 * Doctor ^ Date ^ Cr No ^ Hindi Text ^ Registration No
					 * 2.Drug Name 3.Batch No 4.Exp Date 5.Issue Qty
					 */
					sb.append("<tr> ");
					...
					/*
					 * sb.append(
					 * "<td align='center' width='10%'><font face='Verdana, Arial, Helvetica, sans-serif' >"
					 * ); sb.append(""); sb.append("</font></td> ");
					 */
					/*
					 * sb.append(
					 * "<td align='center' width='10%'><font face='Verdana, Arial, Helvetica, sans-serif' >"
				...
				// String FinaltotalCost = formatter.format(new
				...
				sb.append("<tr>");
				sb.append("<td colspan='6' align='right'><font face='Verdana, Arial, Helvetica, sans-serif' ><b>TOTAL (Rs.)</b></font></td>");
				...
				// double IssueRatePercentage =
				// Double.parseDouble(configIssueRate);
				//
				...
				// sb.append("<td  colspan='6' style=\"text-align:right;\"><font size='1' face='Verdana, Arial, Helvetica, sans-serif'><strong>(Rs.) In Words :-"
				// + totAmtStr + "</strong></font></td>");
				// sb.append("</tr>");
				//
				// sb.append("<tr> ");
