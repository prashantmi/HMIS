...
public class DossierRequisitionFB extends ActionForm{
	...
	public String getStrFinalFlag() {
		return strFinalFlag;
	}

	public void setStrFinalFlag(String strFinalFlag) {
		this.strFinalFlag = strFinalFlag;
	}
