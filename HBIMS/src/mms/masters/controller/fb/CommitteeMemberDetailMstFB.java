...
/**
 * The Class CommitteeMemberDetailMstFB.
 */
public class CommitteeMemberDetailMstFB extends ActionForm {
	...
	private String strCommitteTypeVals;
	...
	/** The str case1. */
	private String strCase1 = "1";
	
	/** The str case2. */
	private String strCase2 = "";
	...
	/** The str committee type id dummy. */
	private String strCommitteeTypeIDDummy = null;
	...
	/** The str commetie sl no. */
	private String[] strCommetieSlNo = { "0" };
	...
	private String[] strOptionUpdate = { "0" };
	
	/** The str emp no update. */
	private String[] strEmpNoUpdate = null;
	...
	private String[] strIsEmployeeUpdateMR = { "0" };
	...
	private String[] strEmpNoUpdateMR = null;
	...
	public String getStrCtDate() {
		HisUtil util = new HisUtil("Drug Dosege Master",
				"CommitteeMemberDetailMstFB");
		try {
			strCtDate = util.getASDate("dd-MMM-yyyy");
			util = null;
		} catch (Exception e) {
			new HisException("MMS Module", "Drug Safty Alert Master",
					"CommitteeMemberDetailMstFB.getStrCtDate()-->"
							+ e.getMessage());
		}
		return strCtDate;
	...
	/**
	 * Gets the str commetie sl no.
	 * 
	 * @return the str commetie sl no
	 */
	public String[] getStrCommetieSlNo() {
		return strCommetieSlNo;
	}

	/**
	 * Sets the str commetie sl no.
	 * 
	 * @param strCommetieSlNo the new str commetie sl no
	 */
	public void setStrCommetieSlNo(String[] strCommetieSlNo) {
		this.strCommetieSlNo = strCommetieSlNo;
	}
	...
	/**
	 * Gets the str committee type id dummy.
	 * 
	 * @return the str committee type id dummy
	 */
	public String getStrCommitteeTypeIDDummy() {
		return strCommitteeTypeIDDummy;
	}

	/**
	 * Sets the str committee type id dummy.
	 * 
	 * @param strCommitteeTypeIDDummy the new str committee type id dummy
	 */
	public void setStrCommitteeTypeIDDummy(String strCommitteeTypeIDDummy) {
		this.strCommitteeTypeIDDummy = strCommitteeTypeIDDummy;
	}
	 ...
	 * 
	 * @param strCheckBox the new str check box
	 */
	 ...
	 * Gets the str case1.
	 * 
	 * @return the str case1
	 */
	public String getStrCase1() {
		return strCase1;
	}
	 ...
	 * Sets the str case1.
	 * 
	 * @param strCase1 the new str case1
	 */
	public void setStrCase1(String strCase1) {
		this.strCase1 = strCase1;
	}

	/**
	 * Gets the str case2.
	 * 
	 * @return the str case2
	 */
	public String getStrCase2() {
		return strCase2;
	}
	 ...
	 * Sets the str case2.
	 * 
	 * @param strCase2 the new str case2
	 */
	public void setStrCase2(String strCase2) {
		this.strCase2 = strCase2;
	}
	...
	/**
	 * @return the strCommitteTypeVals
	 */
	public String getStrCommitteTypeVals() {
		return strCommitteTypeVals;
	}

	/**
	 * @param strCommitteTypeVals the strCommitteTypeVals to set
	 */
	public void setStrCommitteTypeVals(String strCommitteTypeVals) {
		this.strCommitteTypeVals = strCommitteTypeVals;
	}
