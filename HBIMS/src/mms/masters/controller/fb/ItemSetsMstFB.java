...
/**
 * The Class ItemSetsMstFB.
 */
public class ItemSetsMstFB extends GenericFormBean {
	...
	/** The str gen item name values. */
	private String strGenItemNameValues = "";
	...
	/** The str added item details. */
	private String strAddedItemDetails = null;
	...
	public String getStrUnitValues() {
		/*
		 * try { ItemSetsMstVO vo=new ItemSetsMstVO();
		 * vo.setStrHospitalCode(this.getStrHospitalCode());
		 * vo.setStrModuleId(this.getStrModuleId());
		 * strUnitValues=vo.getStrUnitValues(); } catch(Exception e) {
		 *  }
		 */
	...
	public String getStrUnit() {
		 ...
		 * try { ItemSetsMstVO vo=new ItemSetsMstVO();
		 * vo.setStrHospitalCode(this.getStrHospitalCode());
		 * vo.setStrModuleId(this.getStrModuleId()); strUnit=vo.getStrUnit(); }
		 * catch(Exception e) {
		 *  }
		 */
		return strUnit;
	...
	/**
	 * Gets the str added item details.
	 * 
	 * @return the str added item details
	 */
	public String getStrAddedItemDetails() {
		return strAddedItemDetails;
	}

	/**
	 * Sets the str added item details.
	 * 
	 * @param strAddedItemDetails the new str added item details
	 */
	public void setStrAddedItemDetails(String strAddedItemDetails) {
		this.strAddedItemDetails = strAddedItemDetails;
	}
	...
	/**
	 * Gets the str gen item name values.
	 * 
	 * @return the strGenItemNameValues
	 */
	public String getStrGenItemNameValues() {
		return strGenItemNameValues;
	}

	/**
	 * Sets the str gen item name values.
	 * 
	 * @param strGenItemNameValues the strGenItemNameValues to set
	 */
	public void setStrGenItemNameValues(String strGenItemNameValues) {
		this.strGenItemNameValues = strGenItemNameValues;
	}
