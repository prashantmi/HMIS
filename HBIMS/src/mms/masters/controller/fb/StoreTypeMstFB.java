...
/**
 * The Class StoreTypeMstFB.
 */
public class StoreTypeMstFB extends GenericFormBean {
	...
	/**
	 * Gets the str hospital name.
	 * 
	 * @return the str hospital name
	 */
	...
	/**
	 * Sets the str hospital name.
	 * 
	 * @param strHospitalName the new str hospital name
	 */
