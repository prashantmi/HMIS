...
/**
 * The Class CommitteeTypeMstFB.
 */
public class CommitteeTypeMstFB extends GenericFormBean {
	 ...
	 * 
	 * @return the str committee type id
	 */
	...
	/**
	 * Gets the str committee type name.
	 * 
	 * @return the str committee type name
	 */
	public String getStrCommitteeTypeName() {
		return strCommitteeTypeName;
	}
	 ...
	 * 
	 * @param strProcessName the strProcessName to set
	 */
