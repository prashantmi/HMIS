...
public class LabMstFB extends GenericFormBean{
	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = 02L;

	/** *******************************. */
	/** The str Lab No. */
	private String strLabNo="";
	
	
	/** The str User Lab No. */
	private String strLabUserNo="";
	 ...
	 * Gets the strLabNo.
	 * 
	 * @return the str Lab No
	 */
	public String getStrLabNo() {
		return strLabNo;
	}
	 ...
	 */
	public void setStrLabNo(String strLabNo) {
		this.strLabNo = strLabNo;
	}
	/**
	 * Gets the str Lab User No
	 * 
	 * @return the str Lab User No
	 */
	public String getStrLabUserNo() {
		return strLabUserNo;
	}

	/**
	 * Sets the str str Lab User No.
	 * 
	 * @param strLabUserNo the new str Lab User No
	 */
	public void setStrLabUserNo(String strLabUserNo) {
		this.strLabUserNo = strLabUserNo;
	}
	
	/**
	 * Gets the str Lab Name.
	 * 
	 * @return the str Lab Name
	 */
	...
	/**
	 * Sets the str Lab Name.
	 * 
	 * @param strLabName the new str Lab Name
	 */
	...
	/**
	 * Sets the str str Fax No.
	 * 
	 * @param strFaxNo the new str Fax No
	 */
