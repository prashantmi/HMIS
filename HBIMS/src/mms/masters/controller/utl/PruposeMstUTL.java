...
/**
 * The Class PruposeMstUTL.
 * 
 * @author Baisakhi Roy
 */

public class PruposeMstUTL implements MasterInterface {
	...
	public String getMasterName() {
		...
		String masterName = " Purpose Master ";
		return masterName;
	}
	...
	public String[] getColumnHeader() {
		...
		String[] columnHdr = { "Purpose", "Effective From" };
		return columnHdr;
	...
	public String[] getSearchField() {
		...
		String search_field[] = { "1", "HSTSTR_PURPOSE" };
		return search_field;
	...
	public String getMainQuery(String[] cmb) {
		...
		brMainQuery.append(
				mms.qryHandler_mms.getQuery(1, "select.PurposeMst.0").replace(
						"?", hosCode)).append(
				" AND "
						+ mms.qryHandler_mms.getQuery(1,
								"select.PurposeMst.cond.1").replace("?", "1"));
	...
	public String getViewQuery() {
		...
		return mms.qryHandler_mms.getQuery(1, "select.PurposeMst.1");
		// return null;
	}
	...
	public String[] getOrderBy() {
		...
		String orderBy[] = { "1", "HSTSTR_PURPOSE" };
		return orderBy;
		// return null;
	...
	public String[] getDeleteQuery() {
		...
		deleteQuery[0] = mms.qryHandler_mms.getQuery(1, "delete.PurposeMst.0")
				.replace("?", seatId);
		deleteQuery[0] = deleteQuery[0].concat(" WHERE "
				+ mms.qryHandler_mms.getQuery(1, "delete.PurposeMst.cond.0"));
