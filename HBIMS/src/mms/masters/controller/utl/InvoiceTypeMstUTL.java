...
/**
 * The Class InvoiceTypeMstUTL.
 */
public class InvoiceTypeMstUTL implements MasterInterface {
	...
	public String getButtons() {
		...
		br.append("<a style=cursor:pointer><img style='cursor:pointer' src='../../hisglobal/images/btn-rpt.png' 	title='Report'	tabindex='0' onKeyPress='if(event.keyCode==13) report(\"REPORT\");'  		onClick='report(\"REPORT\");'></a>");
		*/
	...
	public String[] getColumnHeader() {
		String col_header[] = { "Invoice Type", "Invoice Type Name",
				"Effective From" };
		return col_header;
	}
	...
	public String[] getDeleteQuery() {
		...
		deleteQuery[0] = mms.qryHandler_mms.getQuery(1,
				"delete.invoiceTypeMst.0").replace("?", seatId);
		deleteQuery[0] = deleteQuery[0].concat(" WHERE "
				+ mms.qryHandler_mms
						.getQuery(1, "delete.invoiceTypeMst.cond.0"));
	...
	public String getMainQuery(String[] cmb) {
		...
		brMainQuery.append(
				mms.qryHandler_mms.getQuery(1, "select.invoiceTypeMst.0")
						.replace("?", "100")).append(
				" AND "
						+ mms.qryHandler_mms.getQuery(1,
								"select.invoiceTypeMst.cond.1").replace("?",
								"1"));
	...
	public String getMasterName() {
		String masterName = "InvoiceType Master";
		return masterName;
	}
	...
	public String[] getOrderBy() {
		String orderBy[] = { "1", "HSTNUM_INVOICETYPE_NAME" };
		return orderBy;
	}
	...
	public String[] getSearchField() {
		String search_field[] = { "1", "HSTNUM_INVOICETYPE_NAME" };
		return search_field;
	}
	...
	public List<String> getViewHeader() {
		...
		viewHdr.add("Invoice Type");
		viewHdr.add("D");
		viewHdr.add("Invoice Type Name");
		viewHdr.add("D");
		viewHdr.add("Remarks");
		viewHdr.add("D");
