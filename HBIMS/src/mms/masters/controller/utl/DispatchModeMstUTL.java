...
/**
 * The Class DispatchModeMstUTL.
 */
public class DispatchModeMstUTL implements MasterInterface {
	...
	public String[] getColumnHeader() {
		...
		String col_header[] = { "Dispatch Mode Name", "Effective From" };
		return col_header;
	}
	...
	public String getMainQuery(String[] cmb) {
		...
		brMainQuery.append(
				mms.qryHandler_mms.getQuery(1, "select.dispatchModeMst.0")
						.replace("?", hosCode)).append(
				" AND "
						+ mms.qryHandler_mms.getQuery(1,
								"select.dispatchModeMst.cond.1").replace("?",
								"1"));
	...
	public String getMasterName() {
		String masterName = "Dispatch Mode Master";
		return masterName;
	}
	...
	public String[] getOrderBy() {
		String orderBy[] = { "1", "HSTSTR_DISPATCHMODE_NAME" };
		return orderBy;
	}
	...
	public String[] getSearchField() {
		String search_field[] = { "1", "HSTSTR_DISPATCHMODE_NAME" };
		return search_field;
	}
	...
	public List<String> getViewHeader() {
		...
		viewHdr.add("Dispatch Mode Name");
		viewHdr.add("D");
		viewHdr.add("Remarks");
		viewHdr.add("D");
