...
/**
 * The Class CountryMstUTL.
 */
public class CountryMstUTL implements MasterInterface{
	...
	public String getMasterName() {
		...
		String masterName = "Country Master";
		return masterName;
	}
	...
	public String[] getColumnHeader() {
		...
		String[] columnHdr = { "Country Name", "Country Short Name", "Nationality" };
		return columnHdr;
	...
	public String[] getSearchField() {
		...
		String search_field[] = { "1", "GSTR_COUNTRYNAME" };
		return search_field;
	...
	public String[] getComboQuery() {
		...
		strComboQuery[0] = "1^Active#2^In Active";
	...
	public String getMainQuery(String[] cmb) {
		...
		brMainQuery.append(mms.qryHandler_mms.getQuery(1, "countryMst.main").replace("?", strHosCode));
		
		if (cmb != null) 
		{

			brMainQuery.append(" AND "+ mms.qryHandler_mms.getQuery(1, "countryMst.main.cond.1").replace("?",cmb[0]));
		}
		else
		{
			brMainQuery.append(" AND " + mms.qryHandler_mms.getQuery(1, "countryMst.main.cond.1").replace("?","1"));
		}
	...
	public String getViewQuery() {
		...
		return mms.qryHandler_mms.getQuery(1, "countryMst.view");
	}
	...
	public String[] getOrderBy() {
		...
		String orderBy[] = { "1", "GSTR_COUNTRYNAME", "2","GSTR_COUNTRYSHORT", "3", "GSTR_NATIONALITY" };
		return orderBy;
	}
	...
	public String[] getDeleteQuery() {
		...
		deleteQuery[0] = mms.qryHandler_mms
				.getQuery(1, "country.delete.0");
		deleteQuery[0] = deleteQuery[0].concat("  where "
				+ mms.qryHandler_mms.getQuery(1, "country.delete.cond.0"));
	...
	public List<String> getViewHeader() {
		...
		viewHdr.add("Country Name");
		viewHdr.add("D");
		viewHdr.add("Country Short Name");
		viewHdr.add("D");
		viewHdr.add("Nationality");
		viewHdr.add("D");
