...
/**
 * The Class SupplierGradeMstUTL.
 */
public class SupplierGradeMstUTL implements MasterInterface {
	...
	public String[] getColumnHeader() {
		String col_header[] = { "Grade Name", "Grade Criteria",
				"Effective From" };
		return col_header;
	}
	...
	public String[] getDeleteQuery() {
		...
		deleteQuery[0] = mms.qryHandler_mms.getQuery(1,"delete.SupplierGradeMst.0").replace("?", seatId);
		deleteQuery[0] = deleteQuery[0].concat("  where "+ mms.qryHandler_mms.getQuery(1,"delete.SupplierGradeMst.cond.0"));
		// deleteQuery[0] =
		// mms.qryHandler_mms.getQuery(1,"delete.SupplierGradeMst.0");
		return deleteQuery;
	}
	...
	public String getMainQuery(String[] cmb) {
		...
		brMainQuery.append(
				mms.qryHandler_mms.getQuery(1, "select.SupplierGradeMst.0")
						.replace("?", "" + hosCode + "")).append(
				" AND "
						+ mms.qryHandler_mms.getQuery(1,
								"select.SupplierGradeMst.cond.0").replace("?",
								"1"));
		if (cmb != null) {
			if (!cmb[0].equals("0")) {
	...
	public String getMasterName() {
		String masterName = "Supplier Grade Master";
		return masterName;
	}
	...
	public String[] getOrderBy() {
		String orderBy[] = { "1", "HSTSTR_GRADE_NAME", "2",
				"HSTNUM_GRADE_CRITERIA" };
		return orderBy;
	}
	...
	public String[] getSearchField() {
		String search_field[] = { "1", "HSTSTR_GRADE_NAME", "2",
				"HSTNUM_GRADE_CRITERIA" };
		return search_field;
	}
	...
	public List<String> getViewHeader() {
		...
		viewHdr.add("Supplier Grade Name");
		viewHdr.add("D");
		viewHdr.add("Grade Criteria");
		viewHdr.add("D");
		viewHdr.add("Remarks");
		viewHdr.add("D");
