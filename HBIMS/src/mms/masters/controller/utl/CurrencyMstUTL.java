...
/**
 * The Class CurrencyMstUTL.
 */
public class CurrencyMstUTL implements MasterInterface {
	...
	public String[] getColumnHeader() {
		String col_header[] = { "Currency Name", "Currency Short Name",
				"Currency Value", "Effective From" };
		return col_header;
	}
	...
	public String[] getDeleteQuery() 
	{
		...
		deleteQuery[0] = mms.qryHandler_mms.getQuery(1, "delete.CurrencyMst.0")	.replace("?", seatId);
		deleteQuery[0] = deleteQuery[0].concat("  where " + mms.qryHandler_mms.getQuery(1, "delete.CurrencyMst.cond.0"));
		return deleteQuery;
	}
	...
	public String getMainQuery(String[] cmb) {
		...
		brMainQuery.append(
				mms.qryHandler_mms.getQuery(1, "select.CurrencyMst.0").replace(
						"?", "" + hosCode + "")).append(
				" AND "
						+ mms.qryHandler_mms.getQuery(1,
								"select.CurrencyMst.cond.0").replace("?", "1"));
		 ...
		 * ).replace("?","0")); if (cmb != null) { if (!cmb[0].equals("0")) {
	...
	public String getMasterName() {
		String masterName = "Currency Master";
		return masterName;
	}
	...
	public String[] getOrderBy() {
		String orderBy[] = { "1", "HSTSTR_CURRENCY_NAME", "2",
				"HSTSTR_CURRENCY_SHORT_NAME" };
		return orderBy;
	}
	...
	public String[] getSearchField() {
		String search_field[] = { "1", "HSTSTR_CURRENCY_NAME", "2",
				"HSTSTR_CURRENCY_SHORT_NAME" };
		return search_field;
	}
	...
	public List<String> getViewHeader() {
		...
		viewHdr.add("Currency Name");
		viewHdr.add("D");
		viewHdr.add("Currency Short Name");
		viewHdr.add("D");
		viewHdr.add("Currency Value");
		viewHdr.add("D");
