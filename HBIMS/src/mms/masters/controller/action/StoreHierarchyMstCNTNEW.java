 ...
 */
public class StoreHierarchyMstCNTNEW extends GenericController {
	 ...
	 */
	public StoreHierarchyMstCNTNEW() {
		super(new StoreHierarchyMstUTL(), "masters/StoreHierarchyMstCNTNEW");
