...
import mms.masters.controller.utl.SupplierTypeMstBSUTL;
...
public class SupplierTypeMstBSCNT extends GenericController {
	 ...
	 */
	public SupplierTypeMstBSCNT() {
		super(new SupplierTypeMstBSUTL(), "/masters/SupplierTypeMstBSCNT");
	}
