...
/**
 * The Class AuthorityHierDtlBSCNT.
 */
public class AuthorityHierDtlBSCNT extends CSRFGardTokenAction {
	...
	public ActionForward HIERARCHY_DTL(ActionMapping mapping, ActionForm form,
		...
		AuthorityHierDtlDATA.heirdetails_BS(formBean, request, response);
		return null;
	}
