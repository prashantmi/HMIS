...
/**
 * The Class MaintenanceTypeMstVO.
 */
public class MaintenanceTypeMstVO implements TransferObject {
	...
	/**
	 * Gets the str maintenance type code.
	 * 
	 * @return the str maintenance type code
	 */
	public String getStrMaintenanceTypeCode() {
		return strMaintenanceTypeCode;
	}

	/**
	 * Sets the str maintenance type code.
	 * 
	 * @param strMaintenanceTypeCode the new str maintenance type code
	 */
	...
	/**
	 * Gets the str maintenance type name.
	 * 
	 * @return the str maintenance type name
	 */
	public String getStrMaintenanceTypeName() {
		return strMaintenanceTypeName;
	}

	/**
	 * Sets the str maintenance type name.
	 * 
	 * @param strMaintenanceTypeName the new str maintenance type name
	 */
