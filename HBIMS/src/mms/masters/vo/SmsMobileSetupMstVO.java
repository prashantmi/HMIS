...
public class SmsMobileSetupMstVO  implements TransferObject
{
	...
	private WebRowSet phoneNosWrs;
	
	public WebRowSet getPhoneNosWrs() {
		return phoneNosWrs;
	}

	public void setPhoneNosWrs(WebRowSet phoneNosWrs) {
		this.phoneNosWrs = phoneNosWrs;
	}
