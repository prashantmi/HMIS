...
/**
 * The Class ThirdPartyIssueDAO.
 */
public class ThirdPartyIssueDAO {

	/** The str proc name. */
	private final String strProcName = "Pkg_Mms_Dml.dml_third_party_issue";
	
	/** The str file name. */
	private final String strFileName = "mms.dao.ThirdPartyIssueDAO";
	...
	public void insert(HisDAO dao) throws Exception {
		...
		try {
			...
			dao.setProcInValue(nProcIndex, "req_no", strTReqNo);
			...
			dao.setProcInValue(nProcIndex, "institute_code", strInstituteCode);
			...
			dao.setProcInValue(nProcIndex, "issue_date", "");
			dao.setProcInValue(nProcIndex, "institute_slno", "0");
			dao.setProcInValue(nProcIndex, "req_status", "1");
			dao.setProcInValue(nProcIndex, "recieve_by", "");
