...
public class DmlIndentCancelDtlDAO {
	...
	private final String strProcName = "PKG_MMS_DML.DML_INDENT_CANCEL_DTL";
	private final String strFileName = "mms.dao.DmlIndentCancelDtlDAO";
	...
	public int Update(HisDAO dao) throws Exception 
	{
		...
		try 
		{
			...
			dao.setProcInValue(nInsertedIndex,"modval","1",1);                           //1
		   	dao.setProcInValue(nInsertedIndex,"strId",storeId.trim(),2);                 //2
			...
			dao.setProcInValue(nInsertedIndex,"reqNo",reqNo.trim(),5);                   //5
			dao.setProcInValue(nInsertedIndex,"remarks",remarks.trim(),6);               //6
			dao.setProcInValue(nInsertedIndex,"seatId",seatId.trim(),7);                 //7
	    	//output value                        
			
			dao.setProcOutValue(nInsertedIndex,"err",1,8);                               //8
