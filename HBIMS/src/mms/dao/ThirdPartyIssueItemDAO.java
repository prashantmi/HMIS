...
/**
 * The Class ThirdPartyIssueItemDAO.
 */
public class ThirdPartyIssueItemDAO {

	/** The str proc name. */
	private final String strProcName = "Pkg_Mms_Dml.dml_third_party_issue_item";
	
	/** The str file name. */
	private final String strFileName = "mms.dao.ThirdPartyIssueItemDAO";
	...
	private String strSanctionQtyUnitId = "";
	...
	public void insert(HisDAO dao) throws Exception {
		...
		try {
			...
			dao.setProcInValue(nProcIndex, "manufacturer_id",strManufacturerId);
			dao.setProcInValue(nProcIndex, "consumables_flag",strConsumablesFlag);
			
			
			dao.setProcInValue(nProcIndex, "approval_level","0");
			dao.setProcInValue(nProcIndex, "store_id","0");
			dao.setProcInValue(nProcIndex, "stock_status_code","0");
			dao.setProcInValue(nProcIndex, "itemSlNo","0");
			dao.setProcInValue(nProcIndex, "itemcat_no","0");
			dao.setProcInValue(nProcIndex, "sanc_qty","0");
			dao.setProcInValue(nProcIndex, "sanc_qty_unitid","");
			dao.setProcInValue(nProcIndex, "issue_qty","0");
			dao.setProcInValue(nProcIndex, "issue_qty_unitid","");
			dao.setProcInValue(nProcIndex, "institute_code","");
			dao.setProcInValue(nProcIndex, "institute_slno","0");
