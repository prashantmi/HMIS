...
/**
 * The Class EMDRefundDtlDAO.
 */
public class EMDRefundDtlDAO {

	/** The str proc name. */
	private final String strProcName = "pkg_mms_dml.dml_emd_dtl";
	
	/** The str file name. */
	private final String strFileName = "mms.dao.EMDRefundDtlDAO";
	...
	public void update(HisDAO dao) throws Exception {
		...
		try {
			...
			dao.setProcInValue(nProcIndex, "release_seat_id", strReleaseSeatId);
			dao
					.setProcInValue(nProcIndex, "release_remarks",
							strReleaseRemarks);
