...
/**
 * The Class PhysicalStockItemDAO.
 */
public class PhysicalStockItemDAO {

	/** The str file name. */
	private final String strFileName = "mms.dao.PhysicalStockItemDAO";
	...
	public void insert(HisDAO dao) throws Exception {
		...
		try {
			...
			dao.setProcInValue(nprocIndex, "manufDate", strManufactureDate);
