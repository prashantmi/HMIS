...
import mms.reports.controller.data.IssuePatDetailRptData;
 ...
 *  
*/
public class IssuePatDetailRptCNT extends DispatchAction {
	 ...
	 */
		...
		String target="index";
		IssuePatDetailRptFB formBean = (IssuePatDetailRptFB) form;
		IssuePatDetailRptData.setInitDtl(formBean, request);
	...
	public ActionForward ITEMCATEGORYCOMBO(ActionMapping mapping, ActionForm form,
		...
		IssuePatDetailRptFB formBean = (IssuePatDetailRptFB) form;
		IssuePatDetailRptData.setItemCategComboDtl(formBean, request, response);
		return null;
	...
	public void SHOWRPT(ActionMapping mapping, ActionForm form,
		...
		IssuePatDetailRptData.showReport(formBean, request, response);
