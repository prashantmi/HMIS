...
import mms.reports.controller.data.DrugInventoryRptData;
...
public class DrugInventoryRptCNT extends DispatchAction {
	 ...
	 */
		...
		DrugInventoryRptData.setInitDtl(formBean, request);
	...
	{
		IssueDetailRptFB formBean = (IssueDetailRptFB) form;
		DrugInventoryRptData.setStoreCombo(formBean, request, response);
		return null;
	}
		/**
		 * this function is used to transfer control to Item category combo
	...
	public ActionForward ITEMCATEGORYCOMBO(ActionMapping mapping, ActionForm form,
		...
		IssueDetailRptFB formBean = (IssueDetailRptFB) form;
		DrugInventoryRptData.setItemCategComboDtl(formBean, request, response);
		return null;
	...
	public ActionForward DRUGNAMECOMBO(ActionMapping mapping, ActionForm form,
		...
		IssueDetailRptFB formBean = (IssueDetailRptFB) form;
		DrugInventoryRptData.setDrugNameCombo(formBean, request, response);
		return null;
	...
	public ActionForward EXISTINGBATCH(ActionMapping mapping, ActionForm form,
		...
		IssueDetailRptFB formBean = (IssueDetailRptFB) form;
		DrugInventoryRptData.getExistingBatchList(formBean, request, response);
		return null;
	...
	public void SHOWRPT(ActionMapping mapping, ActionForm form,
		...
		DrugInventoryRptData.showReport(formBean, request, response);
