...
import mms.reports.controller.data.ListOfInstitutionsRptDATA;
...
public class ListOfInstitutionsRptCNT extends DispatchAction {
	...
	public ActionForward INITVAL(ActionMapping mapping, ActionForm form,HttpServletRequest request, HttpServletResponse response)
		...
		ListOfInstitutionsRptFB formBean = (ListOfInstitutionsRptFB) form;
...
//		ListOfInstitutionsRptDATA.getInitializedValues(formBean,request, response);
	...
	public void SHOWRPT(ActionMapping mapping, ActionForm form,
		...
		ListOfInstitutionsRptDATA.showReport(formBean, request, response);
