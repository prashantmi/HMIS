...
import mms.reports.controller.data.StockStatusRptDATA;
 ...
 * Module : MMS 
 */
public class StockStatusRptCNT extends DispatchAction {
	...
	public ActionForward unspecified(ActionMapping mapping, ActionForm form,
		...
		StockStatusRptFB formBean = (StockStatusRptFB)form;
		StockStatusRptDATA.initialAdd(formBean,request);
	...
	public ActionForward ITEMCATEGORY(ActionMapping mapping, ActionForm form,
			...
			StockStatusRptFB formBean = (StockStatusRptFB)form;
			StockStatusRptDATA.itemCategory(formBean, request, response);
			return null;
	}
	...
	public ActionForward GROUPNAME(ActionMapping mapping, ActionForm form,
			...
			StockStatusRptFB formBean = (StockStatusRptFB)form;
			StockStatusRptDATA.groupName(formBean, request, response);
			return null;
	}
	...
	public ActionForward ITEMSTORECOMBO(ActionMapping mapping, ActionForm form,
		...
		StockStatusRptFB formBean = (StockStatusRptFB) form;
		StockStatusRptDATA.setStoreComboDtl(formBean, request, response);
	...
	public void SHOWRPT(ActionMapping mapping, ActionForm form,
		...
		StockStatusRptDATA.showReport(formBean, request, response);
