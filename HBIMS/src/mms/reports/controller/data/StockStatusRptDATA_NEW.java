...
import mms.reports.bo.StockStatusRptBO_NEW;
 ...
 * Module : MMS 
 */
public class StockStatusRptDATA_NEW {
	
	/**
	 * This function is used to set initial parameters required to display on main page 
	 * @param formBean
	 */
	public static void initialAdd(StockStatusRptFB_NEW formBean,HttpServletRequest request) {
		StockStatusRptVO_NEW vo=null;
		StockStatusRptBO_NEW bo= null;
		...
		try {
			vo = new StockStatusRptVO_NEW();
			bo = new StockStatusRptBO_NEW();
	...
	public static void setItemCategCombo(StockStatusRptFB_NEW formBean,HttpServletRequest request) 
	{
	...
	public static void setStoreComboDtl(StockStatusRptFB_NEW formBean,HttpServletRequest request,HttpServletResponse response) {
	 ...
	 * @param formBean
	 */
	public static void itemCategory(StockStatusRptFB_NEW formBean,HttpServletRequest request,
	 ...
	 * @param formBean
	 */
	public static void groupName(StockStatusRptFB_NEW formBean,HttpServletRequest request,
			HttpServletResponse response) {
		StockStatusRptVO_NEW vo=null;
		StockStatusRptBO_NEW bo= null;
		HisUtil hisutil = null;
	...
	public static void showReport(StockStatusRptFB_NEW formBean,
		...
		try {
			...
			String reportPath = "/mms/reports/stockStatus_mms_rptNEW1.rptdesign";
