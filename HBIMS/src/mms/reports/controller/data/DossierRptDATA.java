...
import mms.reports.bo.DossierRptBO;
import mms.reports.controller.fb.DossierRptFB;
import mms.reports.vo.DossierRptVO;

public class DossierRptDATA {
	
	
	public static void setInitDtl(DossierRptFB formBean,HttpServletRequest request) 
	{
		DossierRptVO vo=null;
		DossierRptBO bo=null;
	...
	public static void setItemCategCombo(DossierRptFB formBean,HttpServletRequest request) 
	{
		DossierRptVO vo=null;
		DossierRptBO bo=null;
		String strmsgText="";
	...
	public static void setItemCategComboDtl(DossierRptFB formBean,HttpServletRequest request,HttpServletResponse response) 
	{
		DossierRptVO vo=null;
		DossierRptBO bo=null;
		String strmsgText="";
	...
	public static void setStoreCombo(DossierRptFB formBean,HttpServletRequest request,HttpServletResponse response) 
	{
		DossierRptVO vo=null;
		DossierRptBO bo=null;
		String strmsgText="";
	 ...
	 * @param response
	 */
	public static void setDrugNameCombo(DossierRptFB formBean,HttpServletRequest request,HttpServletResponse response) {
	...
	public static void getExistingBatchList(DossierRptFB formBean,HttpServletRequest request, HttpServletResponse response)
	{
	 ...
	 * @param response
	 */
	public static void showReport(DossierRptFB formBean,HttpServletRequest request, HttpServletResponse response) 
	{
		...
		{			
			...
			//{				
				...
				String reportPath = "/mms/reports/dossier_mmsrpt_new.rptdesign";
