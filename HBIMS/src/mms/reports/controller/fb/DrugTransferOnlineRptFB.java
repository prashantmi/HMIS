...
public class DrugTransferOnlineRptFB extends ActionForm {
	...
	private String strInwardOrOutward;
	
	public String getStrInwardOrOutward() {
		return strInwardOrOutward;
	}

	public void setStrInwardOrOutward(String strInwardOrOutward) {
		this.strInwardOrOutward = strInwardOrOutward;
	}
