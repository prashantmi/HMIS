...
public class HelpDeskRptFB extends ActionForm 
{
	...
	private String strMenuCmb;
	private String strDeptcmb;
	private String strStatuscmb;
	

	public String getStrStatuscmb() {
		return strStatuscmb;
	}

	public void setStrStatuscmb(String strStatuscmb) {
		this.strStatuscmb = strStatuscmb;
	}
	...
	public String getStrMenuCmb() {
		return strMenuCmb;
	}

	public void setStrMenuCmb(String strMenuCmb) {
		this.strMenuCmb = strMenuCmb;
	}
