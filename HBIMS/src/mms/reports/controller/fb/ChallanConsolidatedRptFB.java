/**********************************************************
 Project:	   DWH_ANDHRA	
 File:         ChallanConsolidatedRptFB.java
 Created:      Jul 3, 2014
...
/**
 * The Class ChallanConsolidatedRptFB.
 */
public class ChallanConsolidatedRptFB extends ActionForm {
	...
	/** The str item brand filter id. */
	private String strItemBrandFilterId = "0";

	/** The str left supplier ids. */
	private String[] strLeftSupplierIds = null;

	/** The str left supplier list. */
	private String strLeftSupplierList = "";

	/** The str right supplier ids. */
	private String[] strRightSupplierIds = null;

	/** The str right supplier list. */
	private String strRightSupplierList = "";
	...
	public String getDistrictStoreId() {
		return districtStoreId;
	}

	public void setDistrictStoreId(String districtStoreId) {
		this.districtStoreId = districtStoreId;
	}
	...
	public void setPOTypeId(String typeId) {
		POTypeId = typeId;
	}
	...
	public String getSupplierWiseFlag() {
		return supplierWiseFlag;
	}

	public void setSupplierWiseFlag(String supplierWiseFlag) {
		this.supplierWiseFlag = supplierWiseFlag;
	}

	public String getStrConsChallanList() {
		return strConsChallanList;
	}

	public void setStrConsChallanList(String strConsChallanList) {
		this.strConsChallanList = strConsChallanList;
	}
	...
	/**
	 * Gets the str item brand filter id.
	 * 
	 * @return the str item brand filter id
	 */
	public String getStrItemBrandFilterId() {
		return strItemBrandFilterId;
	}

	/**
	 * Sets the str item brand filter id.
	 * 
	 * @param strItemBrandFilterId
	 *            the new str item brand filter id
	 */
	public void setStrItemBrandFilterId(String strItemBrandFilterId) {
		this.strItemBrandFilterId = strItemBrandFilterId;
	}

	/**
	 * Gets the str left supplier ids.
	 * 
	 * @return the str left supplier ids
	 */
	public String[] getStrLeftSupplierIds() {
		return strLeftSupplierIds;
	}

	/**
	 * Sets the str left supplier ids.
	 * 
	 * @param strLeftSupplierIds
	 *            the new str left supplier ids
	 */
	public void setStrLeftSupplierIds(String[] strLeftSupplierIds) {
		this.strLeftSupplierIds = strLeftSupplierIds;
	}

	/**
	 * Gets the str left supplier list.
	 * 
	 * @return the str left supplier list
	 */
	public String getStrLeftSupplierList() {
		return strLeftSupplierList;
	}

	/**
	 * Sets the str left supplier list.
	 * 
	 * @param strLeftSupplierList
	 *            the new str left supplier list
	 */
	public void setStrLeftSupplierList(String strLeftSupplierList) {
		this.strLeftSupplierList = strLeftSupplierList;
	}

	/**
	 * Gets the str right supplier ids.
	 * 
	 * @return the str right supplier ids
	 */
	public String[] getStrRightSupplierIds() {
		return strRightSupplierIds;
	}

	/**
	 * Sets the str right supplier ids.
	 * 
	 * @param strRightSupplierIds
	 *            the new str right supplier ids
	 */
	public void setStrRightSupplierIds(String[] strRightSupplierIds) {
		this.strRightSupplierIds = strRightSupplierIds;
	}

	/**
	 * Gets the str right supplier list.
	 * 
	 * @return the str right supplier list
	 */
	public String getStrRightSupplierList() {
		return strRightSupplierList;
	}

	/**
	 * Sets the str right supplier list.
	 * 
	 * @param strRightSupplierList
	 *            the new str right supplier list
	 */
	public void setStrRightSupplierList(String strRightSupplierList) {
		this.strRightSupplierList = strRightSupplierList;
	}
