...
public class FSNXYZAnalysisRptDAO {
	
	public static void getStoreList(FSNXYZAnalysisRptVO voObj) {
		...
		try {
			...
			daoObj = new HisDAO("MMS Transactions","FSNXYZAnalysisRptDAO");
			...
			voObj
					.setStrMsgString("FSNXYZAnalysisRptDAO.getStoreList() --> "
							+ e.getMessage());
	...
	public static void getItemCatList(FSNXYZAnalysisRptVO voObj) {
		...
		try {
			...
			voObj
					.setStrMsgString("FSNXYZAnalysisRptDAO.getItemCatList() --> "
							+ e.getMessage());
			voObj.setStrMsgType("1");
