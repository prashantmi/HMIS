...
public class ABCAnalysisRptDAO {
	
	public static void getStoreList(ABCAnalysisRptVO voObj) {
		...
		try {
			...
			daoObj = new HisDAO("MMS Transactions","ABCAnalysisRptDAO");
			...
			voObj
					.setStrMsgString("ABCAnalysisRptDAO.getStoreList() --> "
							+ e.getMessage());
	...
	public static void getItemCatList(ABCAnalysisRptVO voObj) {
		...
		try {
			...
			voObj
					.setStrMsgString("ABCAnalysisRptDAO.getItemCatList() --> "
							+ e.getMessage());
			voObj.setStrMsgType("1");
