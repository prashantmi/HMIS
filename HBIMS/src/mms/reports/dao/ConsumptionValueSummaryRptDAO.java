...
public class ConsumptionValueSummaryRptDAO {
	
	public static void getItemCatList(ConsumptionValueSummaryRptVO voObj) {
		...
		try {
			...
			daoObj = new HisDAO("MMS Transactions","ConsumptionValueSummaryRptDAO");
			...
			voObj
					.setStrMsgString("ConsumptionValueSummaryRptDAO.getItemCatList() --> "
							+ e.getMessage());
	...
	public static void getStoreList(ConsumptionValueSummaryRptVO voObj) {
		...
		try {
			...
			voObj
					.setStrMsgString("ConsumptionValueSummaryRptDAO.getStoreList() --> "
							+ e.getMessage());
			voObj.setStrMsgType("1");
