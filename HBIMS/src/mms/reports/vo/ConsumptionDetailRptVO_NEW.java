 ...
 */
public class ConsumptionDetailRptVO_NEW {
	...
	public String getStrFuncValue() {
		return strFuncValue;
	}

	public void setStrFuncValue(String strFuncValue) {
		this.strFuncValue = strFuncValue;
	}
