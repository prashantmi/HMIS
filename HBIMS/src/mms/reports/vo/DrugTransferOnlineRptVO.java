...
public class DrugTransferOnlineRptVO {
	...
	private WebRowSet strToStoreComboWS = null;
	
	private WebRowSet itemIdWS;
	...
	public WebRowSet getStrToStoreComboWS() {
		return strToStoreComboWS;
	}

	public void setStrToStoreComboWS(WebRowSet strToStoreComboWS) {
		this.strToStoreComboWS = strToStoreComboWS;
	}
