 ...
 * 
 */
public class ChallanProcessApprovalTransVO implements TransferObject {
	...
	private String strChallanReceiptNo;
	...
	private WebRowSet wrsChallanDtl = null;
	private WebRowSet wrsVerifiedItemDtl = null;
	
	private String []strHiddenVerifiedChallanValue;
	
	private WebRowSet wsPrintItemDtls=null;
	...
	public WebRowSet getWrsChallanDtl() {
		return wrsChallanDtl;
	}

	public void setWrsChallanDtl(WebRowSet wrsChallanDtl) {
		this.wrsChallanDtl = wrsChallanDtl;
	}

	public String getStrChallanReceiptNo() {
		return strChallanReceiptNo;
	}

	public void setStrChallanReceiptNo(String strChallanReceiptNo) {
		this.strChallanReceiptNo = strChallanReceiptNo;
	}
	...
	public WebRowSet getWrsVerifiedItemDtl() {
		return wrsVerifiedItemDtl;
	}

	public void setWrsVerifiedItemDtl(WebRowSet wrsVerifiedItemDtl) {
		this.wrsVerifiedItemDtl = wrsVerifiedItemDtl;
	}
