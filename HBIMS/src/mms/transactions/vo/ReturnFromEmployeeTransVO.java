 ...
 * 
 */
public class ReturnFromEmployeeTransVO implements TransferObject {
	...
	private WebRowSet employeeWs = null;
	private WebRowSet stockStatusWS = null;
	...
	/**
	 * @return the employeeWs
	 */
	public WebRowSet getEmployeeWs() {
		return employeeWs;
	}
	/**
	 * @param employeeWs the employeeWs to set
	 */
	public void setEmployeeWs(WebRowSet employeeWs) {
		this.employeeWs = employeeWs;
	}
	/**
	 * @return the stockStatusWS
	 */
	public WebRowSet getStockStatusWS() {
		return stockStatusWS;
	}
	/**
	 * @param stockStatusWS the stockStatusWS to set
	 */
	public void setStockStatusWS(WebRowSet stockStatusWS) {
		this.stockStatusWS = stockStatusWS;
	}
