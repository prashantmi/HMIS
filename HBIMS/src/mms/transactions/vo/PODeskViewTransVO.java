 ...
 *
 */
public class PODeskViewTransVO {
	...
	private String strViewdQtyUnitValues="";
	 ...
	 */
	public String getStrViewdQtyUnitValues() {
		return strViewdQtyUnitValues;
	}
	/**
	 * @param strDViewdQtyUnitValues the strDViewdQtyUnitValues to set
	 */
	public void setStrViewdQtyUnitValues(String strViewdQtyUnitValues) {
		this.strViewdQtyUnitValues = strViewdQtyUnitValues;
	}
	/**
