 ...
 * Modif Date : / /2009 
*/
public class RequestForLPDeptVO implements TransferObject 
{
	...
	public String getStrUregentFlg() {
		return strUregentFlg;
	}
	public void setStrUregentFlg(String strUregentFlg) {
		this.strUregentFlg = strUregentFlg;
	}
