 ...
 *
 */
public class PODeskScheduleTransVO {
	...
	private String strScheduledQtyUnitValues="";
	 ...
	 */
	public String getStrScheduledQtyUnitValues() {
		return strScheduledQtyUnitValues;
	}
	/**
	 * @param strDScheduledQtyUnitValues the strDScheduledQtyUnitValues to set
	 */
	public void setStrScheduledQtyUnitValues(String strScheduledQtyUnitValues) {
		this.strScheduledQtyUnitValues = strScheduledQtyUnitValues;
	}
	/**
