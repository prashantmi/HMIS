...
public class SampleRegisterPurTransFB extends GenericFormBean{
	...
	private String strProposalNoValues = "";
	...
	private String strProposalTLDHiddenVal = "";
	...
	/**
	 * @return the strProposalNoValues
	 */
	public String getStrProposalNoValues() {
		return strProposalNoValues;
	}

	/**
	 * @param strProposalNoValues the strProposalNoValues to set
	 */
	public void setStrProposalNoValues(String strProposalNoValues) {
		this.strProposalNoValues = strProposalNoValues;
	}

	/**
	 * @return the strItemValues
	 */
	...
	/**
	 * @param strItemValues the strItemValues to set
	 */
	...
	/**
	 * @return the strProposalTLDHiddenVal
	 */
	public String getStrProposalTLDHiddenVal() {
		return strProposalTLDHiddenVal;
	}

	/**
	 * @param strProposalTLDHiddenVal the strProposalTLDHiddenVal to set
	 */
	public void setStrProposalTLDHiddenVal(String strProposalTLDHiddenVal) {
		this.strProposalTLDHiddenVal = strProposalTLDHiddenVal;
	}

	/**
	 * @return the strReservedQty
	 */
	...
	/**
	 * @param strReservedQty the strReservedQty to set
	 */
