...
public class QcDetailOnlineTransFB extends ActionForm 
{
    ...
    private String strChkFlag="";					//Created by adil
    private String strCheckHiddenValues="";			//Created by adil
	private String strCurrentStockDetail="";		//Created by adil
	...
	private String strTmpPrintValues;
	private String strLabSendNumber="0";
	private String strPrintValues;
	private String strTmpCtrNo;
	...
	public String getStrTmpCtrNo() {
		return strTmpCtrNo;
	}
	public void setStrTmpCtrNo(String strTmpCtrNo) {
		this.strTmpCtrNo = strTmpCtrNo;
	}
	...
	public String getStrReIssueChk() {
		return strReIssueChk;
	}
	public void setStrReIssueChk(String strReIssueChk) {
		this.strReIssueChk = strReIssueChk;
	}
	...
	public String getStrTmpPrintValues() {
		return strTmpPrintValues;
	}
	public void setStrTmpPrintValues(String strTmpPrintValues) {
		this.strTmpPrintValues = strTmpPrintValues;
	}
	public String getStrPrintValues() {
		return strPrintValues;
	}
	public void setStrPrintValues(String strPrintValues) {
		this.strPrintValues = strPrintValues;
	}
