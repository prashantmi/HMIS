...
public class IssueSampleForQcCheckTransFB extends ActionForm 
{
	...
	private String strReIssueFlag;
	
	public String getStrReIssueFlag() {
		return strReIssueFlag;
	}
	public void setStrReIssueFlag(String strReIssueFlag) {
		this.strReIssueFlag = strReIssueFlag;
	}
