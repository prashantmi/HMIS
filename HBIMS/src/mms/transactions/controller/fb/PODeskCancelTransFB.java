 ...
 * 
 */
public class PODeskCancelTransFB extends ActionForm  {
	...
	private String strDNoOfCancel="";
	private String strDCanceldQtyUnitValues="";
	private String strApprovedByValues="";
	private String strCancelByValues="";
	...
	/**
	 * @return the strSysdate
	 */
	public String getStrSysdate() {
		return strSysdate;
	}
	/**
	 * @param strSysdate the strSysdate to set
	 */
	...
	/**
	 * @return the strCancelByValues
	 */
	public String getStrCancelByValues() {
		return strCancelByValues;
	}
	/**
	 * @param strCancelByValues the strCancelByValues to set
	 */
	public void setStrCancelByValues(String strCancelByValues) {
		this.strCancelByValues = strCancelByValues;
	}
	/**
	 ...
	 */
	public String getStrDCanceldQtyUnitValues() {
		return strDCanceldQtyUnitValues;
	}
	/**
	 * @param strDCanceldQtyUnitValues the strDCanceldQtyUnitValues to set
	 */
	public void setStrDCanceldQtyUnitValues(String strDCanceldQtyUnitValues) {
		this.strDCanceldQtyUnitValues = strDCanceldQtyUnitValues;
	}
	/**
	 * @return the strDNoOfCancel
	 */
	public String getStrDNoOfCancel() {
		return strDNoOfCancel;
	}
	/**
	 * @param strDNoOfCancel the strDNoOfCancel to set
	 */
	public void setStrDNoOfCancel(String strDNoOfCancel) {
		this.strDNoOfCancel = strDNoOfCancel;
	}
	/**
