...
public class SolutionDeskTransHLP {
			...
			try {
				...
				{ 
					if (ws.next()) 
					{
						...
						String StrID=ws.getString(12);
						String strFileName=ws.getString(16);
						
						String strHidVal = strStoreName+"^"+strTransNo+"^"+strTransDate+"^"+strMenuName+"^"+strStatus+"^"+strProbSub+"^"+StrID+"^"+strFileName;
						String strHidVal2 = strFileName;
						...
						sb.append("</td>");
						sb.append("<td width='25%' class='LABEL'>Problem No</td>");
						sb.append("<td width='25%' class='CONTROL'>");
						sb.append(strTransNo);
						sb.append("</td></tr>");
						sb.append("<tr><td width='25%' class='LABEL'>Problem Raised Date</td>");
						sb.append("<td width='25%' class='CONTROL'>");
						sb.append(strTransDate);
						sb.append("</td>");
						sb.append("<td width='25%' class='LABEL'>Menu Name</td>");
						sb.append("<td width='25%' class='CONTROL'>");
						...
						sb.append(strStatus);
						sb.append("</td>");
						sb.append("<td width='25%' class='LABEL'>Problem Subject</td>");
						sb.append("<td width='25%' class='CONTROL'>");
						sb.append(strProbSub);
						sb.append("</td></tr>");
						sb.append("<tr><td width='25%' class='LABEL'>Problem Discription</td>");
						sb.append("<td width='25%' class='CONTROL'>");
						sb.append(strProbDesc);
						sb.append("</td>");					
						sb.append("<td width='25%' class='LABEL'>Submitted By</td>");
						sb.append("<td width='25%' class='CONTROL'>");
						sb.append(strSubmitBy);
						sb.append("</td></tr>");
				...
				throw new HisException("SolutionDesk Transaction","SolutionDeskTransHLP.getAcknowledgeDetails()-->",e.getMessage());
			}
		return sb.toString();
		}
	 
	 public static String getSolViewDtl(WebRowSet ws)
	    {
		 int count = 0;
			int start = 1;
			StringBuffer sb = new StringBuffer("");
			...
			try {
				...
				{ 
					if (ws.next()) 
					{
						...
						String strHidVal = strStoreName+"^"+strTransNo+"^"+strTransDate+"^"+strMenuName+"^"+strStatus+"^"+strProbSub+"^"+"^"+strFileName;
