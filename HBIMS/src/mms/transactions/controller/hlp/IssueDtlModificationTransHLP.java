...
public class IssueDtlModificationTransHLP 
{
	
	public static String getVoucherDtlHlp(WebRowSet ws,IssueDtlModificationTransVO vo) throws Exception 
	{
...
//						 * 8. UNIT_NAME
						...
						IssueDtlModificationTransBO.BatchCombo(vo);
...
//		                NVL(HSTSTR_BATCH_NO,'--') AS DISP_NAME
						...
						br.append("<TD WIDTH='12%'  colspan='1' style=\'text-align:right;\' CLASS='multiControl'><input type='hidden' name='strOldCost' value='"+ws.getString(6)+"' ><div id='costDivId"+t+"'  >"+ws.getString(6)+"</div></TD>");
						br.append("</TR>");
...
//	                NVL(HSTSTR_BATCH_NO,'--') AS DISP_NAME
			  ...
			  br.append("</td>");
			  br.append("<input type='hidden' name='strTotalCost' value='"+strTotalCostTemp+"' />");
			  br.append("</tr>");
			  br.append("</table>");
			}
			else
...
/*	
	*//**
	 ...
	 *//*
	public static String getVoucherDtlHlp(WebRowSet ws,IssueDtlModificationTransVO vo) 
	{
		StringBuffer br = new StringBuffer();
		int t=0;
	 ...
	 */
	public static String getModificationDetailsTable(IssueDtlModificationTransVO vo)	throws SQLException 
	{
...
//				System.out.println("vo.getStrDrugDtls()"+vo.getStrDrugDtls());
			 ...
			 */
					...
					sbBody.append("<td colspan='1' WIDTH='25%' class=\"CONTROL\" ><input type='hidden' name='strCost' value='"+strCost+"' >"+"<div id='strCostDivId'  value='"+strCost+"' >"+strCost + "</div></td>");					
					sbBody.append("</tr>");

					sbBody.append("</table>");	
			}
			catch (Exception e) {
				vo.setStrMsgString("IssueDtlModificationTransHLP.getModificationDetailsTable() --> "+ e.getMessage());
				vo.setStrMsgType("1");
			}
