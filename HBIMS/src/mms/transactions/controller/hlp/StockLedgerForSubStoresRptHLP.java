...
public class StockLedgerForSubStoresRptHLP {
		...
		try {
			...
			String strHiddenParameter =
					vo.getStrDWHId() + "^" + vo.getStrItemBrandId() + "^" + vo.getStrFromDate() + "^" + vo.getStrToDate() + "^" + vo.getStrBatchNo()
							+ "^" + vo.getStrOpeningBalance() + "^" + vo.getStrStoreName() + "^" + vo.getStrDrugName() + "^" + vo.getStrBatchFlag()+"^"+vo.getStrProgId();
			...
			if (ws != null && ws.size() > 0) {
				...
				if (!vo.getStrBatchNo().equals("0") && !vo.getStrProgId().equals("0")) {
	...
	public String getConsolidatedStockLedgerRpt(StockLedgerForSubStoresRptVO vo, HttpServletRequest request) throws Exception {
		...
		try {
			...
			br.append(
					"<HTML><HEAD><title>Stock Ledger</title><script language='JavaScript' src='../../hisglobal/js/jquery-1.10.1.min.js'></script><script language='Javascript' src='../../hisglobal/js/innerxhtml.js'></script>"
			...
			try {
				br.append("<td colspan='1' width='100%' align='center'><div  align='center'> <img  align='absmiddle'  src='http://" + request.getServerName() + ":"
						+ request.getServerPort()  + "/DWH_ANDHRA/hisglobal/images/report_header_withAddress.png' /></div></td>");
			} catch (Exception e) {
				e.printStackTrace();
	...
	public String getConsolidatedStockLedgerRptBatch(StockLedgerForSubStoresRptVO vo, HttpServletRequest request) throws Exception {
		...
		try {
			...
			br.append(
					"<HTML><HEAD><title>Stock Ledger</title><script language='JavaScript' src='../../hisglobal/js/jquery-1.10.1.min.js'></script>"
			...
			br.append("<td colspan='1' width='10%' align='center'><div  align='center'> <img src='http://" + request.getServerName() + ":"
						+ request.getServerPort() +  "/DWH_ANDHRA/hisglobal/images/report_header_withAddress.png' /></div></td>");
		...
		try {
			...
			br.append(
					"<HTML><HEAD><title>Stock Ledger</title><script language='JavaScript' src='../../hisglobal/js/jquery-1.10.1.min.js'></script>"
							...
							+ "" + "<table align='center' width='").append(strTableWidth).append("' border='0' cellspacing='0' cellpadding='0''> ");
			try {
				br.append("<tr><td colspan='" + col	+ "' width='100%'  align='center'><div  align='center'> <img src='http://" + request.getServerName() + ":"
						+ request.getServerPort()  + "/DWH_ANDHRA/hisglobal/images/report_header_withAddress.png' /></div></td>");
			} catch (Exception e) {
				e.printStackTrace();
...
//					+ "' align='center'> <b><font size='2' face='Verdana, Arial, Helvetica, sans-serif' size='3'> ");
			...
			if (!vo.getStrBatchNo().equals("0") && !vo.getStrProgId().equals("0")) {
				...
				br.append("Programme Name: " + strProgName + "<br>");
				br.append("Expiry Date: " + strExpiryDate + "<br>");
				br.append("</font></b></td><td width='10%' colspan='1'> ");
				br.append("</td> ");
				br.append("</tr> ");			
