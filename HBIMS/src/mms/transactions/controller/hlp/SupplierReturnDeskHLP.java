 ...
 * 
 */
public class SupplierReturnDeskHLP {
	public static String getItemDetails(SupplierReturnDeskVO voObj)
	 {
		...
		float cost=0;
		 ...
		 {
			 new HisException("SupplierReturnTransaction","SupplierReturnDeskHLP.getItemDetails()-->",e.getMessage());
	     }
