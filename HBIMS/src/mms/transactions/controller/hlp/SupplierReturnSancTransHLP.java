 ...
 *
 */
public class SupplierReturnSancTransHLP {
	
	
	public static String getItemDetails(SupplierReturnSancTransVO voObj)
	 {
			 ...
			 { 
				...
				{		     
					    ...
					    sBuffer.append("<tr>");
	  					...
	  					sBuffer.append("<td width='15%' colspan='1' class='multiControl'>"+wb.getString(15)+"</td>");
	  					...
	  					if(Integer.parseInt(wb.getString(6))>Integer.parseInt(wb.getString(15).replace(' ', '#').split("#")[0].trim()))
	  					{
