...
public class SampleRegisterPurTransHLP {
	public static String getAddedItemDetails(SampleRegisterPurTransFB formbean)
	{ 
	...
	public static String createMemberDetails(SampleRegisterPurTransFB _SampleRegisterPurTransFB)
	{ 
		StringBuffer br = new StringBuffer();
		WebRowSet wb1=null;
		int count=0;
			try{
				wb1=_SampleRegisterPurTransFB.getCommitteMemberWS();
			...
			try{
				...
				throw new Exception("SampleRegisterPurTransHLP.createMemberDetails--->"+e.getMessage());
			}
			catch(Exception e1)
			{}
		}
