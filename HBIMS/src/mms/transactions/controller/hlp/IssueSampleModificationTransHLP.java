...
public class IssueSampleModificationTransHLP 
{
	
	public static String getVoucherDtlHlp(WebRowSet ws,IssueSampleModificationTransVO vo) throws Exception 
	{
...
//						 * 8. UNIT_NAME
						...
						String strRadioTempValue = ws.getString(1) +"^"+ws.getString(2) +"^"+ws.getString(3) +"^0^"+
												   ws.getString(5) +"^"+ws.getString(6) +"^"+ws.getString(7) +"^"+ws.getString(8) + "^" + ws.getString(9);
						...
						vo.setStrResendFlag(ws.getString(9));
						
						IssueSampleModificationTransBO.BatchCombo(vo);
...
/*	
	*//**
	 ...
	 *//*
	public static String getVoucherDtlHlp(WebRowSet ws,IssueSampleModificationTransVO vo) 
	{
		StringBuffer br = new StringBuffer();
		int t=0;
	 ...
	 */
	public static String getModificationDetailsTable(IssueSampleModificationTransVO vo)	throws SQLException 
	{
...
//				System.out.println("vo.getStrDrugDtls()"+vo.getStrDrugDtls());
				 ...
				 */
					...
					String strResendFlag 					=	vo.getStrDrugDtls().split("\\^")[8] ;				
					...
					vo.setStrResendFlag(strResendFlag);
			 ...
			 */
				...
				vo.setStrMsgString("IssueSampleModificationTransHLP.getModificationDetailsTable() --> "+ e.getMessage());
				vo.setStrMsgType("1");
			}
