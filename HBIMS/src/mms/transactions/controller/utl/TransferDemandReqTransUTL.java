...
public class TransferDemandReqTransUTL extends TransInterface 
{
	...
	public String getMasterName() {
		String masterName = "Transfer Demand Request Desk";
		return masterName;
	}
	...
	public String getMainQuery(String cmb[]) {
		...
		brMainQuery.append("NVL(HSTNUM_TRANSFER_QTY,0) || ' ' || MMS_MST.GETUNITNAME(GNUM_HOSPITAL_CODE,HSTNUM_TRANQTY_UNITID) ");
		brMainQuery.append(" AS DATA FROM HSTT_TRANSFER_SHORT_REQ_DTL ");
		...
		{ 			
			...
			//final approved
			else if (cmb[1].equals("45"))
			{
				brMainQuery.append(" AND GNUM_STATUS = 45");               
			} 
			//Partial Processed
	...
	{		
		...
		String[] strColumnHeader = new String[5];			
			...
			strColumnHeader[3] = "Req Qty";
			strColumnHeader[4] = "Transfer Qty";
	...
	public String[] getComboQuery(){
		...
		comboQuery[1] = "0^Active#40^Approval#45^In-Transit#99^Rejected#50^Processed";
		return comboQuery;
	}
