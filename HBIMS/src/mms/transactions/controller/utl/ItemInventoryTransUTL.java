...
public class ItemInventoryTransUTL extends TransInterface {
	...
	public String getMainQuery(String cmb[]) {
		...
		if (cmb != null) 
		{
			...
			strMainQuery = strMainQuery.replaceFirst("\\?", "0");
			...
			strCondition1 = strCondition1.replaceFirst("\\?", "0");
			brMainQuery.append(strCondition1);

		}
		//brMainQuery.append(" GROUP BY HSTNUM_STORE_ID    ,HSTNUM_ITEM_ID,   HSTNUM_ITEMBRAND_ID,GNUM_HOSPITAL_CODE   ,HSTNUM_STOCK_STATUS_CODE,HSTNUM_INHAND_QTY_UNITID");
	...
	public String[] getComboHeader() {
		String[] strComboHeader = { "0^0", "Store Name", "0^1",
