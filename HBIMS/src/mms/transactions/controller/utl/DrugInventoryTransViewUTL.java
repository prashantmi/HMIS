...
public class DrugInventoryTransViewUTL extends TransInterface
{
	...
	{
		String masterName = "Drug Inventory View Desk";
		return masterName;
	}
	...
	public String[] getUserDefinedButtons() 
	{
		   ...
		   String[] strButtons = {"Current Stock@validateAddInventory(document.forms[0],'VIEW')@1@007bb6@glyphicon-fullscreen"};
	       return strButtons;
	}
