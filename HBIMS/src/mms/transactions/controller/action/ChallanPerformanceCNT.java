...
import mms.transactions.controller.data.ChallanPerformanceDATA;
...
public class ChallanPerformanceCNT extends DispatchAction{
	
	public ActionForward unspecified(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response)
			throws HisException, SQLException 
   {
		ChallanPerformanceFB formBean = (ChallanPerformanceFB) form;
			...
			throws HisException, SQLException 
   {
		...
		ChallanPerformanceDATA.getDrugWareHouseNameCombo(formBean, request);
	...
	public ActionForward getPoNoCmb(ActionMapping mapping, ActionForm form,
			...
			throws HisException, SQLException 
	{
		ChallanPerformanceFB fb = (ChallanPerformanceFB) form;
		ChallanPerformanceDATA.getPoNoCmb(fb, request,response);
	   	return null;
	}
	/**
	 * 
	...
	{
		ChallanPerformanceFB fb = (ChallanPerformanceFB) form;
		ChallanPerformanceDATA.getSupplierCmb(fb, request,response);
	   	return null;
	}
	...
	{
		ChallanPerformanceFB fb = (ChallanPerformanceFB) form;
		ChallanPerformanceDATA.getChallanNoCmb(fb, request,response);
	   	return null;
	}
	...
	{
		ChallanPerformanceFB fb = (ChallanPerformanceFB) form;
		ChallanPerformanceDATA.getItemNameCmb(fb, request,response);
	   	return null;
	}
	...
	{
		ChallanPerformanceFB fb = (ChallanPerformanceFB) form;
		ChallanPerformanceDATA.getChallanDtl(fb, request,response);
	   	return null;
	}
...
//		ChallanPerformanceDATA.getPrevBudgetDtls(formBean,request, response);
	...
	public ActionForward SAVE(ActionMapping mapping, ActionForm form,	HttpServletRequest request, HttpServletResponse response) throws Exception, SQLException 
	{
		...
		ChallanPerformanceFB formBean = (ChallanPerformanceFB) form;
		ChallanPerformanceDATA.saveSupplierPerformanceDtls(formBean,request, response);
	...
	public ActionForward SAVECHALLANDTL(ActionMapping mapping, ActionForm form,	HttpServletRequest request, HttpServletResponse response) throws Exception, SQLException 
	{
		...
		ChallanPerformanceFB formBean = (ChallanPerformanceFB) form;
		ChallanPerformanceDATA.saveChallanDtls(formBean,request, response);
	...
	public ActionForward getSupplierPerformancePendingDtlView(ActionMapping mapping, ActionForm form,	HttpServletRequest request, HttpServletResponse response) throws Exception, SQLException 
	{
		...
		ChallanPerformanceFB formBean = (ChallanPerformanceFB) form;
		ChallanPerformanceDATA.getSupplierPerformancePendingDtlView(formBean,request, response);
		return null;
	}
	...
	public ActionForward getSupplierPerformanceCompletedDtlView(ActionMapping mapping, ActionForm form,	HttpServletRequest request, HttpServletResponse response) throws Exception, SQLException 
	{
		...
		ChallanPerformanceFB formBean = (ChallanPerformanceFB) form;
		ChallanPerformanceDATA.getSupplierPerformanceCompletedDtlView(formBean,request, response);
		return null;
	}
	...
	public ActionForward DWHSUBTYPECMB(ActionMapping mapping, ActionForm form,	HttpServletRequest request, HttpServletResponse response) throws Exception, SQLException 
	{
		...
		ChallanPerformanceFB formBean = (ChallanPerformanceFB) form;
		//ChallanPerformanceDATA.getDWHSubStoreCmb(formBean,request, response);
		return null;
	}
