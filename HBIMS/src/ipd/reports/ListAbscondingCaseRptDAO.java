...
public class ListAbscondingCaseRptDAO {

	public static void getDepartmentList(ListAbscondingCaseRptVO voObj) {
	...
	public static void getHospitalName(ListAbscondingCaseRptVO voObj) {
		...
		try {
			...
			daoObj = new HisDAO("IPD Reports","ListAbscondingCaseRptDAO");
			...
			voObj
					.setStrMsgString("ListAbscondingCaseRptDAO.getHospitalName() --> "
							+ e.getMessage());
			voObj.setStrMsgType("1");
	...
	public static void getUnitList(ListAbscondingCaseRptVO voObj) {
		...
		try {
			...
			voObj
					.setStrMsgString("ListAdscondingCaseRptDAO.getUnitList() --> "
							+ e.getMessage());
			voObj.setStrMsgType("1");
	...
	public static void getWardList(ListAbscondingCaseRptVO voObj) {
		...
		try {
			...
			voObj
					.setStrMsgString("ListAdscondingCaseRptDAO.getWardList() --> "
							+ e.getMessage());
			voObj.setStrMsgType("1");
	...
	public static void getWardCombo(ListAbscondingCaseRptVO voObj) {
