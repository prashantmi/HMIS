...
public class DailyWardSummaryRptCNT extends DispatchAction{
	...
	public ActionForward unspecified(ActionMapping mapping, ActionForm form,
		...
		DailyWardSummaryRptFB formBean = (DailyWardSummaryRptFB) form;
		formBean.setStrHospitalCode(request.getSession().getAttribute("HOSPITAL_CODE").toString());
		formBean.setStrSeatId(request.getSession().getAttribute("SEATID").toString());
		
		DailyWardSummaryRptDATA.initReportPage(formBean);
...
/////////////////////This Method is used for showing Report/////////////////////////////
	...
	public ActionForward SHOWRPT(ActionMapping mapping, ActionForm form,
		...
		DailyWardSummaryRptFB formBean = (DailyWardSummaryRptFB) form;
		formBean.setStrHospitalCode(request.getSession().getAttribute("HOSPITAL_CODE").toString());
		DailyWardSummaryRptDATA.showReport(formBean, request, response);
...
/////////////////////This Method is used for Unit Combo Values/////////////////////////////
	...
	public ActionForward UNITCMB(ActionMapping mapping, ActionForm form,
		...
		DailyWardSummaryRptFB formBean = (DailyWardSummaryRptFB) form;
		formBean.setStrHospitalCode(request.getSession().getAttribute("HOSPITAL_CODE").toString());
		DailyWardSummaryRptDATA.getUnitWardDetails(formBean,request, response);
...
/////////////////////This Method is used for Ward Combo Values/////////////////////////////
	...
	public ActionForward WARDCMB(ActionMapping mapping, ActionForm form,
		...
		DailyWardSummaryRptFB formBean = (DailyWardSummaryRptFB) form;
		formBean.setStrHospitalCode(request.getSession().getAttribute("HOSPITAL_CODE").toString());
		DailyWardSummaryRptDATA.getWardDetailsCombo(formBean,request, response);
