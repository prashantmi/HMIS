...
public class BedOccupancyRptDAO {

	
	public static void getDepartmentList(BedOccupancyRptVO voObj) {
		...
		try {
			...
			voObj
					.setStrMsgString("BedOccupancyRptDAO.getDepartmentList() --> "
							+ e.getMessage());
	...
	public static void getWardCombo(BedOccupancyRptVO voObj) {
	...
	public static void getWardList(BedOccupancyRptVO voObj) {
		...
		try {
			...
			voObj
					.setStrMsgString("BedOccupancyRptDAO.getWardList() --> "
							+ e.getMessage());
			voObj.setStrMsgType("1");
	...
	public static void getUnitList(BedOccupancyRptVO voObj) {
		...
		try {
			...
			voObj
					.setStrMsgString("BedOccupancyRptDAO.getUnitList() --> "
							+ e.getMessage());
			voObj.setStrMsgType("1");
