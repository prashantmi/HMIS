...
public class AvgStayDepartmentRptDAO {

	public static void getDepartmentList(AvgStayDepartmentRptVO voObj) {
	...
	public static void getWardList(AvgStayDepartmentRptVO voObj) {
		...
		throw new Exception(strErr);
			...
			//e.printStackTrace();
			voObj
					.setStrMsgString("AvgStayDepartmentRptDAO.getWardList() --> "
							+ e.getMessage());
			voObj.setStrMsgType("1");
	...
	public static void getUnitList(AvgStayDepartmentRptVO voObj) {
		...
		try {
			...
			voObj
					.setStrMsgString("AvgStayDepartmentRptDAO.getUnitList() --> "
							+ e.getMessage());
			voObj.setStrMsgType("1");
	...
	public static void getWardCombo(AvgStayDepartmentRptVO voObj) {
