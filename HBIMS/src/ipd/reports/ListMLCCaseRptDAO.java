...
public class ListMLCCaseRptDAO {


	public static void getDepartmentList(ListMLCCaseRptVO voObj) {
		...
		try {
			...
			voObj
					.setStrMsgString("ListMLCCaseRptDAO.getDepartmentList() --> "
							+ e.getMessage());
	...
	public static void getUnitList(ListMLCCaseRptVO voObj) {
		...
		try {
			...
			voObj
					.setStrMsgString("ListMLCCaseRptDAO.getUnitList() --> "
							+ e.getMessage());
			voObj.setStrMsgType("1");
	...
	public static void getWardList(ListMLCCaseRptVO voObj) {
		...
		try {
			...
			voObj
					.setStrMsgString("ListMLCCaseRptDAO.getWardList() --> "
							+ e.getMessage());
			voObj.setStrMsgType("1");
	...
	public static void getWardCombo(ListMLCCaseRptVO voObj) {
