...
public class ListAdmittedPatientRptDAO {

	public static void getDepartmentList(ListAdmittedPatientRptVO voObj) {
		...
		try {
			...
			voObj
					.setStrMsgString("ListAdmittedPatientRptDAO.getDepartmentList() --> "
							+ e.getMessage());
	...
	public static void getUnitList(ListAdmittedPatientRptVO voObj) {
		...
		try {
			...
			voObj
					.setStrMsgString("ListAdmittedPatientRptDAO.getUnitList() --> "
							+ e.getMessage());
			voObj.setStrMsgType("1");
	...
	public static void getWardCombo(ListAdmittedPatientRptVO voObj) {
	...
	public static void getWardList(ListAdmittedPatientRptVO voObj) {
		...
		try {
			...
			voObj
					.setStrMsgString("ListAdmittedPatientRptDAO.getWardList() --> "
							+ e.getMessage());
			voObj.setStrMsgType("1");
	 ...
	 */
	public static void getHospitalName(ListAdmittedPatientRptVO voObj) {
		...
		try {
			...
			daoObj = new HisDAO("IPD Reports","ListAdmittedPatientRptDAO");
			...
			voObj
					.setStrMsgString("ListAdmittedPatientRptDAO.getHospitalName() --> "
							+ e.getMessage());
			voObj.setStrMsgType("1");
	...
	public static void getdeptComboDetails(ListAdmittedPatientRptVO voObj) {
