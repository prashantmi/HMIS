...
public class IndoorInformationRptCNT extends DispatchAction{
	...
	public ActionForward unspecified(ActionMapping mapping, ActionForm form,
		...
		IndoorInformationRptFB formBean = (IndoorInformationRptFB) form;
		formBean.setStrHospitalCode(request.getSession().getAttribute("HOSPITAL_CODE").toString());
		IndoorInformationRptDATA.initReportPage(formBean,request);
...
/////////////////////This Method is used for showing report/////////////////////////////
	...
	public ActionForward SHOWRPT(ActionMapping mapping, ActionForm form,
		...
		IndoorInformationRptFB formBean = (IndoorInformationRptFB) form;
		formBean.setStrHospitalCode(request.getSession().getAttribute("HOSPITAL_CODE").toString());
		IndoorInformationRptDATA.showReport(formBean, request, response);
	...
	public ActionForward DEPTCMB(ActionMapping mapping, ActionForm form,
		...
		IndoorInformationRptDATA.getdeptComboDetails(formBean,request, response);
		return null;
	}
	/**
	 * @param mapping
...
/////////////////////This Method is used for Unit Combo Values/////////////////////////////
	...
	public ActionForward UNITCMB(ActionMapping mapping, ActionForm form,
		...
		IndoorInformationRptFB formBean = (IndoorInformationRptFB) form;
		formBean.setStrHospitalCode(request.getSession().getAttribute("HOSPITAL_CODE").toString());
		IndoorInformationRptDATA.getUnitWardDetails(formBean,request, response);
...
/////////////////////This Method is used for Ward Combo Values/////////////////////////////
	...
	public ActionForward WARDCMB(ActionMapping mapping, ActionForm form,
		...
		IndoorInformationRptFB formBean = (IndoorInformationRptFB) form;
		formBean.setStrHospitalCode(request.getSession().getAttribute("HOSPITAL_CODE").toString());
		IndoorInformationRptDATA.getWardDetails(formBean,request, response);
