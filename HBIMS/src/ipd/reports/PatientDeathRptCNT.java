...
public class PatientDeathRptCNT extends DispatchAction {
	...
	public ActionForward unspecified(ActionMapping mapping, ActionForm form,
		...
		PatientDeathRptFB formBean = (PatientDeathRptFB) form;
	    //formBean.setStrHospitalCode(request.getSession().getAttribute("HOSPITAL_CODE").toString());
	    formBean.setStrSeatId(request.getSession().getAttribute("SEATID").toString());
		PatientDeathRptDATA.initReportPage(formBean,request);
...
/////////////////////This Method is used for DeptCombo Values/////////////////////////////
	...
	public ActionForward DEPTCMB(ActionMapping mapping, ActionForm form,
		...
		PatientDeathRptDATA.getdeptComboDetails(formBean,request, response);
...
/////////////////////This Method is used for showing report/////////////////////////////
	...
	public void SHOWRPT(ActionMapping mapping, ActionForm form,
		...
		PatientDeathRptFB formBean = (PatientDeathRptFB) form;
		 //formBean.setStrHospitalCode(request.getSession().getAttribute("HOSPITAL_CODE").toString());
		PatientDeathRptDATA.showReport(formBean, request, response);
...
/////////////////////This Method is used for Unit Combo Values/////////////////////////////
	...
	public ActionForward UNITCMB(ActionMapping mapping, ActionForm form,
		...
		PatientDeathRptFB formBean = (PatientDeathRptFB) form;
		// formBean.setStrHospitalCode(request.getSession().getAttribute("HOSPITAL_CODE").toString());
		PatientDeathRptDATA.getUnitWardDetails(formBean,request, response);
...
/////////////////////This Method is used for Ward Combo Values/////////////////////////////
	...
	public ActionForward WARDCMB(ActionMapping mapping, ActionForm form,
		...
		PatientDeathRptFB formBean = (PatientDeathRptFB) form;
		// formBean.setStrHospitalCode(request.getSession().getAttribute("HOSPITAL_CODE").toString());
		PatientDeathRptDATA.getWardDetailsCombo(formBean,request, response);
