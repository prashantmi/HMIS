...
public class PatDischargeDtlRptFB extends ActionForm
{
	...
	public String getStrBedValues() {
		return strBedValues;
	}
	public void setStrBedValues(String strBedValues) {
		this.strBedValues = strBedValues;
	}
