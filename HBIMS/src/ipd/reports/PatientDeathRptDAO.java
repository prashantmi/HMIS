...
public class PatientDeathRptDAO {

	public static void getDepartmentList(PatientDeathRptVO voObj) {
		...
		try {
			...
			voObj
					.setStrMsgString("ListAdscondingCaseRptDAO.getDepartmentList() --> "
							+ e.getMessage());
	...
	public static void getUnitList(PatientDeathRptVO voObj) {
		...
		try {
			...
			voObj
					.setStrMsgString("PatientDeathRptDAO.getUnitList() --> "
							+ e.getMessage());
			voObj.setStrMsgType("1");
	...
	public static void getWardCombo(PatientDeathRptVO voObj) {
	...
	public static void getWardList(PatientDeathRptVO voObj) {
		...
		try {
			...
			voObj
					.setStrMsgString("PatientDeathRptDAO.getWardList() --> "
							+ e.getMessage());
			voObj.setStrMsgType("1");
	...
	public static void getHospitalName(PatientDeathRptVO voObj) {
		...
		try {
			...
			daoObj = new HisDAO("IPD Reports","PatientDeathRptDAO");
			...
			voObj
					.setStrMsgString("PatientDeathRptDAO.getHospitalName() --> "
							+ e.getMessage());
			voObj.setStrMsgType("1");
	...
	public static void getdeptComboDetails(PatientDeathRptVO voObj) {
		...
		try {
			...
			voObj
					.setStrMsgString("PatientDeathRptDAO.getdeptComboDetails() --> "
							+ e.getMessage());
			voObj.setStrMsgType("1");
