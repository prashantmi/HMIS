...
public class PatientLeaveJoinRecordTransFB extends ActionForm
{
	...
	/**
	 * @return the strRemarksOthersOnlineMandatoryFlag
	 */
	public String getStrRemarksOthersOnlineMandatoryFlag() {
		return strRemarksOthersOnlineMandatoryFlag;
	}

	/**
	 * @param strRemarksOthersOnlineMandatoryFlag the strRemarksOthersOnlineMandatoryFlag to set
	 */
	public void setStrRemarksOthersOnlineMandatoryFlag(
			String strRemarksOthersOnlineMandatoryFlag) {
		this.strRemarksOthersOnlineMandatoryFlag = strRemarksOthersOnlineMandatoryFlag;
	}
	...
	/**
	 * @return the strTempLeaveJoinLabel
	 */
	public String getStrTempLeaveJoinLabel() {
		return strTempLeaveJoinLabel;
	}

	/**
	 * @param strTempLeaveJoinLabel the strTempLeaveJoinLabel to set
	 */
	public void setStrTempLeaveJoinLabel(String strTempLeaveJoinLabel) {
		this.strTempLeaveJoinLabel = strTempLeaveJoinLabel;
	}
...
public String getStrCtDateTime() {
	return strCtDateTime;
}

public void setStrCtDateTime(String strCtDateTime) {
	this.strCtDateTime = strCtDateTime;
}
