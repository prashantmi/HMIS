...
public class DischargeCancelTransCNT extends CSRFGardTokenAction {
	/**
	...
	public ActionForward GO(ActionMapping mapping, ActionForm form,
		...
		if(retVal==true){
		 DischargeCancelTransDATA.getAdmDetails(request,formBean);
			...
			throws HisException,Exception
	{
		...
		String sid = DischargeCancelTransDATA.AjaxResponse(formBean,strValmode,request);
