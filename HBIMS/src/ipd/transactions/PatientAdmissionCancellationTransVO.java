...
public class  PatientAdmissionCancellationTransVO implements TransferObject {
	...
	private String strIsAccepted="0";
	private String strIsNotAdmitted="0";
	private String strSpouseName="";
	private String strReligoinName="";
	...
	public String getStrIsNotAdmitted() {
		return strIsNotAdmitted;
	}
	public void setStrIsNotAdmitted(String strIsNotAdmitted) {
		this.strIsNotAdmitted = strIsNotAdmitted;
	}
	...
	public String getStrReligoinName() {
		return strReligoinName;
	}
	public void setStrReligoinName(String strReligoinName) {
		this.strReligoinName = strReligoinName;
	}
