...
public class PatientLeaveFB extends ActionForm
{
   static final long serialVersionUID = 02L;
	...
	private String strTmpLabel="";
	private String chk="";
	private String strRemarksOthersOfflineMandatoryFlag="";
	private String strRemarksOthersJoinMandatoryFlag="";
	private String strLeaveType="0";
	private String strProbJoinDateForExternalInv="0";
	...
	/**
	 * @return the strRemarksOthersJoinMandatoryFlag
	 */
	public String getStrRemarksOthersJoinMandatoryFlag() {
		return strRemarksOthersJoinMandatoryFlag;
	}

	/**
	 * @param strRemarksOthersJoinMandatoryFlag the strRemarksOthersJoinMandatoryFlag to set
	 */
	public void setStrRemarksOthersJoinMandatoryFlag(
			String strRemarksOthersJoinMandatoryFlag) {
		this.strRemarksOthersJoinMandatoryFlag = strRemarksOthersJoinMandatoryFlag;
	}

	/**
	 * @return the strRemarksOthersOfflineMandatoryFlag
	 */
	public String getStrRemarksOthersOfflineMandatoryFlag() {
		return strRemarksOthersOfflineMandatoryFlag;
	}

	/**
	 * @param strRemarksOthersOfflineMandatoryFlag the strRemarksOthersOfflineMandatoryFlag to set
	 */
	public void setStrRemarksOthersOfflineMandatoryFlag(
			String strRemarksOthersOfflineMandatoryFlag) {
		this.strRemarksOthersOfflineMandatoryFlag = strRemarksOthersOfflineMandatoryFlag;
	}
	...
	/**
	 * @return the strTmpLabel
	 */
	public String getStrTmpLabel() {
		return strTmpLabel;
	}

	/**
	 * @param strTmpLabel the strTmpLabel to set
	 */
	public void setStrTmpLabel(String strTmpLabel) {
		this.strTmpLabel = strTmpLabel;
	}
...
public String getStrProbJoinDateForExternalInv()
{
	return strProbJoinDateForExternalInv;
}

public void setStrProbJoinDateForExternalInv(String strProbJoinDateForExternalInv)
{
	this.strProbJoinDateForExternalInv = strProbJoinDateForExternalInv;
}
