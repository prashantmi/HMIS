...
public class  JobTrackingTransDAO {
	 ...
	 * @param vo
	 */
	public static void setWardTypeDtl(JobTrackingTransVO vo) {
		...
		try {
			...
			//e.printStackTrace();
			vo.setStrMsgString("JobTrackingTransDAO.setWardTypeDtl() --> "
					+ e.getMessage());
			vo.setStrMsgType("1");
		} finally {
			if (daoObj != null) {
	 ...
	 * @param vo
	 */
	public static void setRoomTypeDtl(JobTrackingTransVO vo) {
		...
		try {
			...
			//e.printStackTrace();
			vo.setStrMsgString("JobTrackingTransDAO.setRoomTypeDtl() --> "
							+ e.getMessage());
			vo.setStrMsgType("1");
		} finally {
			if (daoObj != null) {
 ...
 * @param vo
 */
	public static void getBedStatusDtl(JobTrackingTransVO vo) {
		...
		try {
			...
			vo.setStrMsgString("JobTrackingTransDAO.getBedStatusDtl() --> "
							+ e.getMessage());
			vo.setStrMsgType("1");
		} 
		finally {
	 ...
	 * @param vo
	 */
	public static void getWardValues(JobTrackingTransVO vo)
	{
		HisDAO daoObj = null;
		WebRowSet ws = null;
		...
		try
		{
			...
			daoObj = new HisDAO("Admission Modification","JobTrackingTransDAO");
			nProcIndex = daoObj.setProcedure(strProcName);
		...
		{
			e.printStackTrace();
			vo.setStrMsgString("JobTrackingTransDAO.getWardValues() --> "
					+ e.getMessage());
			vo.setStrMsgType("1");
		}
		finally {
	 ...
	 * @param vo
	 */
	public static void getRoomValues(JobTrackingTransVO vo)
	{
		HisDAO daoObj = null;
		WebRowSet ws = null;
		...
		{
			e.printStackTrace();
			vo.setStrMsgString("JobTrackingTransDAO.getRoomValues() --> "
					+ e.getMessage());
			vo.setStrMsgType("1");
		}
		finally {
	 ...
	 * @param voObj
	 */
	public static void setBedTypeDtl(JobTrackingTransVO voObj) {
		...
		try {
			...
			//e.printStackTrace();
			voObj.setStrMsgString("JobTrackingTransDAO.setBedTypeDtl() --> "
							+ e.getMessage());
	 ...
	 * @param vo
	 */
	public static void getBedValues(JobTrackingTransVO vo)
	{
		HisDAO daoObj = null;
		WebRowSet ws = null;
		...
		catch(Exception e)
		{
			...
			vo.setStrMsgString("JobTrackingTransDAO.getBedValues() --> "
					+ e.getMessage());
			vo.setStrMsgType("1");
		}
		finally {
	 ...
	 * @param vo
	 */
	public static void countBed_in_ward(JobTrackingTransVO vo)
	{
		HisDAO daoObj = null;
		WebRowSet ws = null;
		...
		{
			vo.setStrMsgString("JobTrackingTransDAO.countBed_in_ward() --> "
					+ e.getMessage());
			vo.setStrMsgType("1");
		}
		finally {
	 ...
	 * @param vo
	 */
	public static void setTreat_CatName(JobTrackingTransVO vo)
	{
		...
		try {
			...
			vo.setStrMsgString("JobTrackingTransDAO.setTreat_CatName() --> "
					+ e.getMessage());
			vo.setStrMsgType("1");
	 ...
	 * @param vo
	 */
	public static void setPatientStatus(JobTrackingTransVO vo)
	{
		...
		try {
			...
			vo.setStrMsgString("JobTrackingTransDAO.setPatientStatus() --> "
					+ e.getMessage());
			vo.setStrMsgType("1");
		} finally {
			if (daoObj != null) {
	 ...
	 * @param vo
	 */
	public static void setConsultantName(JobTrackingTransVO vo)
	{
	...
	//	System.out.println("DEPTUNIT"+strDeptUnitCode);
		try {
			...
			e.printStackTrace();
			vo.setStrMsgString("JobTrackingTransDAO.setConsultantName() --> "
					+ e.getMessage());
			vo.setStrMsgType("1");
	...
	public static void setConsultantNameDtl(JobTrackingTransVO voObj) {
	...
	public static boolean insert(JobTrackingTransVO vo)
	{
		...
		try
		{
			daoObj = new HisDAO("Patient Admission Modification Transaction",
			"JobTrackingTransDAO");
			retVal2=JobTrackingTransDAO.insertPatAdmission(daoObj, vo);
			
		}
		catch(Exception e)
		{
			vo.setStrMsgString("JobTrackingTransDAO.insert() --> "
					+ e.getMessage());
			vo.setStrMsgType("1");
		}
		return retVal2;
	 ...
	 * @return
	 */
	public static boolean insertPatAdmission(HisDAO daoObj,JobTrackingTransVO vo)
	{
		...
		catch(Exception e)
		{
			e.printStackTrace();
			chkFlag=false;
			vo.setStrMsgString("JobTrackingTransDAO.insertPatAdmission() --> "
					+ e.getMessage());
			vo.setStrMsgType("1");
		}
	 ...
	 * @param vo
	 */
	public static void setEpisodeDtl(JobTrackingTransVO vo)
	{
		...
		{
			e.printStackTrace();
			vo.setStrMsgString("JobTrackingTransDAO.setEpisodeDtl() --> "
					+ e.getMessage());
			vo.setStrMsgType("1");
		}
		finally
	 ...
	 * @param vo
	 */
	public static void setAdviceAdmNo(JobTrackingTransVO vo)
	{
		...
		{
			//e.printStackTrace();
			vo.setStrMsgString("JobTrackingTransDAO.setAdviceAdmNo() --> "
					+ e.getMessage());
			vo.setStrMsgType("1");
		}
		finally
	 ...
	 * @param vo
	 */
	public static void getPatientAdd(JobTrackingTransVO vo)
	{
		...
		{
			e.printStackTrace();
			vo.setStrMsgString("JobTrackingTransDAO.insertOccupationDtl() --> "
					+ e.getMessage());
			vo.setStrMsgType("1");
		}
		finally
	 ...
	 * @param vo
	 */
	public static void setReligion(JobTrackingTransVO vo)
	{
		...
		{
			vo.setStrMsgString("JobTrackingTransDAO.setReligion() --> "
					+ e.getMessage());
			vo.setStrMsgType("1");
		}
		finally
	 ...
	 * @param vo
	 */
	public static void setState(JobTrackingTransVO vo)
	{
		...
		{
			vo.setStrMsgString("JobTrackingTransDAO.setState() --> "
					+ e.getMessage());
			vo.setStrMsgType("1");
		}
		finally
	 ...
	 * @param vo
	 */
	public static void getPatDtl_Msapproval(JobTrackingTransVO vo) {
		...
		try {
				...
				vo.setStrMsgString("JobTrackingTransDAO.getPatDtl_Msapproval() --> "
						+ e.getMessage());
				vo.setStrMsgType("1");
		} 
		finally {
	 ...
	 * @param vo
	 */
	public static void setCountry(JobTrackingTransVO vo)
	{
		String strProcName = "{call pkg_ipd_view.Proc_state_dtl(?,?,?,?)}";
		int nProcIndex = 0;
		...
		{
			vo.setStrMsgString("JobTrackingTransDAO.setCountry() --> "
					+ e.getMessage());
			vo.setStrMsgType("1");
		}
		finally
	 ...
	 * @param vo
	 */
	public static void getMsApprovalStatus(JobTrackingTransVO vo)
	{
		HisDAO daoObj = null;
		WebRowSet ws = null;
		String strProcName = "{call pkg_ipd_view.proc_pat_adm_msapproval(?,?,?,?,?,?,?)}";
	 ...
	 * @param vo
	 */
	public static void setNewBornBabyDtl(JobTrackingTransVO vo)
	{
		...
		try {
			...
			vo.setStrMsgString("JobTrackingTransDAO.setUnitName() --> "
					+ e.getMessage());
			vo.setStrMsgType("1");
	...
	public static void department(JobTrackingTransVO vo) {
		...
		dao = new HisDAO("ipd","transactions.JobTrackingTransDAO");
		...
		throw new Exception(strerr);
			...
			e.printStackTrace();
		vo.setStrMsgString("JobTrackingTransDAO.department()--> "+ e.getMessage());
	...
	public static void unit(JobTrackingTransVO vo) {
	...
	dao = new HisDAO("ipd","transactions.JobTrackingTransDAO.unit()");
	...
	throw new Exception(strerr);
		...
		e.printStackTrace();
	vo.setStrMsgString("JobTrackingTransDAO.unit() --> "+ e.getMessage());
	vo.setStrMsgType("1");
	} finally {
	if (dao != null) {
	dao.free();
	 ...
	 * @param voObj
	 */
	public static void setTreatmentCatDtl(JobTrackingTransVO voObj) {
		...
		try {
			daoObj = new HisDAO("ipd","JobTrackingTransDAO");
			...
			e.printStackTrace();
			voObj.setStrMsgString("JobTrackingTransDAO.setTreatmentCatDtl() --> "
							+ e.getMessage());
			voObj.setStrMsgType("1");
		} finally {
			if (daoObj != null) {
	...
	public static void setAdmDtl(JobTrackingTransVO vo)
	{
	...
	public static void getStatusWhetherAdvanceAmountGiven(JobTrackingTransVO vo)
	{
		...
		try {
			...
			e.printStackTrace();
			vo.setStrMsgString("JobTrackingTransDAO.getStatusWhetherAdvanceAmountGiven() --> "
					+ e.getMessage());
			vo.setStrMsgType("1");
	...
	public static void setPatientCaste(JobTrackingTransVO vo) {
	...
	public static void setMaritalStatus(JobTrackingTransVO vo) {
	...
	public static void getAdmissionType(JobTrackingTransVO vo) {
		HisDAO daoObj = null;
		WebRowSet ws = null;
	...
	public static void getReliefFund(JobTrackingTransVO vo) {
		HisDAO daoObj = null;
		WebRowSet ws = null;
	...
	public static  void setRelation(JobTrackingTransVO vo) 
	 {
	...
	public static void setDistrict(JobTrackingTransVO vo)
	{
