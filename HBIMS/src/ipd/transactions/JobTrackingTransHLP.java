 ...
 */
	 ...
	 * @return
	 */
	public static String getPatientDetailModi(JobTrackingTransVO vo)
	{
		...
		{
			e.printStackTrace();
			vo.setStrMsgString("JobTrackingTransHLP.getPatientDetailModi() --> "+e.getMessage());
			vo.setStrMsgType("1");
		}
	...
	public static String getPatientDetailModi_Bootstrap(JobTrackingTransVO vo)
	{
		StringBuffer sBuffer = new StringBuffer("");
		StringBuffer sBufferdDeptUnit = new StringBuffer("");
		StringBuffer sBufferEmgAddress=new StringBuffer("");
	...
	public static String getPatientDetailModi_BootstrapGrouped(JobTrackingTransVO vo)
	{
		StringBuffer sBuffer = new StringBuffer("");
		StringBuffer sBufferdDeptUnit = new StringBuffer("");
		StringBuffer sBufferEmgAddress=new StringBuffer("");
