...
public class PatientAdmissionTransCNT extends CSRFGardTokenAction{
	...
	public ActionForward PRINTBILLSLIP(ActionMapping mapping, ActionForm form,HttpServletRequest request, HttpServletResponse response) throws HisException 
	{	
	...
	{
		ActionForward acFwd = new ActionForward();
		acFwd.setPath("/ipd/transactions/NewBornBabyTransCNT.cnt");
		acFwd.setContextRelative(true);
		return acFwd;
	}
}
