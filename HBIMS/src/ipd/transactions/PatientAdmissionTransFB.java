...
public class PatientAdmissionTransFB extends ActionForm {
	...
	public String getStrStateComboName() {
		return strStateComboName;
	}
	public void setStrStateComboName(String strStateComboName) {
		this.strStateComboName = strStateComboName;
	}
	...
	public String getBillAdvanceReciept() {
		return billAdvanceReciept;
	}
	public void setBillAdvanceReciept(String billAdvanceReciept) {
		this.billAdvanceReciept = billAdvanceReciept;
	}
	public String getStrPayCDBankName() {
		return strPayCDBankName;
	}
	public void setStrPayCDBankName(String strPayCDBankName) {
		this.strPayCDBankName = strPayCDBankName;
	}
	...
	public String getStrPayCDDBankName() {
		return strPayCDDBankName;
	}
	public void setStrPayCDDBankName(String strPayCDDBankName) {
		this.strPayCDDBankName = strPayCDDBankName;
	}
