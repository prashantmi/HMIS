...
public class NewBornBabyTransBSCNT extends DispatchAction{
	...
	public ActionForward GO(ActionMapping mapping, ActionForm form,
		...
		NewBornBabyTransDATA.initPatientAdmission_BS(formBean);
	...
	public ActionForward UPDATEMOTHERDETAILSBS(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response)
			throws HisException {
		NewBornBabyTransFB formBean = (NewBornBabyTransFB)form;
	 	IpdConfigUtil util = new IpdConfigUtil(request.getSession().getAttribute("HOSPITAL_CODE").toString());
	...
	public ActionForward GOUPDATE(ActionMapping mapping, ActionForm form,
		...
		NewBornBabyTransDATA.initPatAdmUpdate_BS(formBean);
	...
	public ActionForward PATADMISSION(ActionMapping mapping, ActionForm form,HttpServletRequest request, HttpServletResponse response) throws HisException 
	{
		ActionForward acFwd = new ActionForward();
		acFwd.setPath("/ipd/transactions/PatientAdmissionTransBSCNT.cnt?hmode=unspecified");
		acFwd.setContextRelative(true);
		return acFwd;
	}
