...
public class PatientFinalDischargeBSCNT extends CSRFGardTokenAction
{

	public PatientFinalDischargeBSCNT()
	{
	}
	...
	{		generateToken(_request);
		...
		if (!formBean.getStrMsgType().equals("100"))
		{
			...
			else
			{
				...
				else formBean.setStrErrMsgString("Patient Intransit/Unknown Status !!");
