...
public class PatientTransferTransVO implements TransferObject
{
	...
	private String strOldDeptUnitCode="";
	...
	private WebRowSet transferedTypeWs=null;
	...
	/**
	 * @return the strOldDeptUnitCode
	 */
	public String getStrOldDeptUnitCode() {
		return strOldDeptUnitCode;
	}

	/**
	 * @param strOldDeptUnitCode the strOldDeptUnitCode to set
	 */
	public void setStrOldDeptUnitCode(String strOldDeptUnitCode) {
		this.strOldDeptUnitCode = strOldDeptUnitCode;
	}
	...
	public WebRowSet getTransferedTypeWs() {
		return transferedTypeWs;
	}

	public void setTransferedTypeWs(WebRowSet transferedTypeWs) {
		this.transferedTypeWs = transferedTypeWs;
	}
