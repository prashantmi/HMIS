...
public class AdmissionReprintTransBSDATA extends Frame{
	...
	public static void admissionList_BS(AdmissionReprintTransFB formBean) 
	{
		AdmissionReprintTransVO vo = null;
		AdmissionReprintTransBO bo= null;
		try 
		{
			...
			{
				bo.admissionList(vo);
				strAdmissionList = AdmissionReprintTransHLP.admissionList_BS(vo);
			} 
			catch (Exception e) 
			{
				throw e;
