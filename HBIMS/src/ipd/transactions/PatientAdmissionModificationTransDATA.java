...
public class  PatientAdmissionModificationTransDATA {
 ...
 */
	...
	public static void initPatientAdmission(PatientAdmissionModificationTransFB formBean) {
		
		IpdConfigUtil icu = null;
		String strOccDtlsview;
		PatientAdmissionModificationTransVO voObj= null;
		PatientAdmissionModificationTransBO bo= null;
		HisUtil util = null;
		String temp="";		
		...
		try 
		 {
			...
			voObj =  new PatientAdmissionModificationTransVO();
			bo    =  new PatientAdmissionModificationTransBO();
			...
			{
				util = new HisUtil("Patient Admission Modification Trans","PatientAdmissionModificationTransDATA");
				...
				voObj.setStrHospCode(formBean.getStrHospCode());
				strAddressDeptUnit=PatientAdmissionModificationTransHLP.getPatientDetailModi(voObj);
	 ...
	 * @param request
	 */
	public static void initBedStatus(PatientAdmissionModificationTransFB formBean,HttpServletRequest request) {
		String temp="";
	
		HisUtil util = null;
		try {
			PatientAdmissionModificationTransVO vo=new PatientAdmissionModificationTransVO();
	 ...
	 * @param response
	 */
	public static void initBedDetails(PatientAdmissionModificationTransFB formBean,HttpServletRequest request,HttpServletResponse response) {
		...
		try {
			...
			vo.setStrDeptUnitCode(request.getParameter("deptUnitCode"));
			bo.setBedDetails(vo);
			String res=PatientAdmissionModificationTransHLP.getBedDetails(vo);
 ...
 * @param response
 */	
public static void initWardDetails(PatientAdmissionModificationTransFB formBean,HttpServletRequest request,HttpServletResponse response) {
 ...
 * @param response
 */	
public static void getWardCatConsultant(PatientAdmissionModificationTransFB formBean,HttpServletRequest request,HttpServletResponse response) {
 ...
 * @param response
 */
public static void initRoomDetails(PatientAdmissionModificationTransFB formBean,HttpServletRequest request,HttpServletResponse response) {
 ...
 * @param formBean
 */
public static void insert(PatientAdmissionModificationTransFB formBean,HttpServletRequest request)
{
		try
		{
			PatientAdmissionModificationTransVO vo=(PatientAdmissionModificationTransVO) TransferObjectFactory.populateData("ipd.transactions.PatientAdmissionModificationTransVO", formBean);
			PatientAdmissionModificationTransBO bo=new PatientAdmissionModificationTransBO();
		...
		{
			String strmsgText = e.getMessage();
			HisException eObj = new HisException("ADT", "PatientAdmissionModificationTransDATA->insert()", strmsgText);
			formBean.setStrMsgString("Application Error [ERROR ID : " + eObj.getErrorID() + "], Contact System Administrator! ");
			eObj = null;
			formBean.setStrCrNo("");
		}
	...
	public static void initUnitDtl(PatientAdmissionModificationTransFB formBean,HttpServletRequest request,HttpServletResponse response)
	{
		PatientAdmissionModificationTransVO vo=null;
		PatientAdmissionModificationTransBO bo=null;
		HisUtil util = null;
		String temp;
		try
		{
			...
			vo=new PatientAdmissionModificationTransVO();
			bo=new PatientAdmissionModificationTransBO();
			vo.setStrDeptCode(request.getParameter("deptCode"));
			vo.setStrHospCode(formBean.getStrHospCode());
			bo.setUnitValue(vo);
	...
	public static void setPatientAdmittedToday(PatientAdmissionModificationTransFB formBean,HttpServletRequest request,HttpServletResponse response)
	{
		PatientAdmissionModificationTransVO vo=null;
		PatientAdmissionModificationTransBO bo=null;
		HisUtil util = null;
	...
	public static void initDistrict(PatientAdmissionModificationTransFB formBean,HttpServletRequest request,HttpServletResponse response) {
		HisUtil util = null;
		try {
			...
			util = new HisUtil("Patient Admission Modification Trans",
				...
				String strmsgText = e.getMessage();
				HisException eObj = new HisException("IPD", "PatientAdmissionModificationTransDATA->initDistrict()", strmsgText);
				String response1 = "ERROR####Application Error [ERROR ID : " + eObj.getErrorID() + "], Contact System Administrator!";
			   try
			    {
			    	response.getWriter().print(response1);
...
public static void initPatientAdmission_BS(PatientAdmissionModificationTransFB formBean) 
{		
		IpdConfigUtil icu = null;
		String strOccDtlsview;
		PatientAdmissionModificationTransVO voObj= null;
		...
		try 
		{
			...
			else
			{
				...
				{				
					...
					formBean.setStrNewBornRegistrationCharge(ipdConfig.getStrNewBornBabyRegistrationCharge());
					voObj.setStrHospCode(formBean.getStrHospCode());
					strAddressDeptUnit=PatientAdmissionModificationTransHLP.getPatientDetailModi_BootstrapGrouped(voObj);
					formBean.setStrAddressModi(strAddressDeptUnit.replace("^","#").split("#")[0]);
					formBean.setStrDeptUnitWardRoomCatConsulatant(strAddressDeptUnit.replace("^","#").split("#")[1]);
					formBean.setStrEmgAddress(strAddressDeptUnit.replace("^", "#").split("#")[2]);
		...
		/*catch (SQLException e) {
			...
			new HisException("Patient Admission",
				...
				e.printStackTrace();
			String strmsgText = e.getMessage();
			   HisException eObj = new HisException("IPD", "PatientAdmissionModificationTransDATA->initPatientAdmission_BS()", strmsgText);
			   formBean.setStrMsgString("Application Error [ERROR ID : " + eObj.getErrorID() + "], Contact System Administrator! ");
			     eObj = null;
			     formBean.setStrCrNo("");
		}
