...
public class PatientLeaveJoinRecordTransHLP{
	...
	public static  String now(String frmt)
    {
    	...
    	try{
    	 a= util.getASDate(frmt);
    		...
    		new HisException("Patient Leave Trans","PatientLeaveJoinRecordTransTransHLP.now()-->",e.getMessage());
    	}
    ...
    public static String jd(PatientLeaveJoinRecordTransVO vo)
	 {
	    vo.setStrCtDate(now(DATE_FORMAT_NOW));
		StringBuffer sBuffer = new StringBuffer("");
	      try{
	    	  
	              sBuffer.append("<table width='95%' border='0' cellspacing='1px' cellpadding='0px' align='center'>");
	              sBuffer.append("<tr><td width='25%' class='LABEL' colspan='1'><div align='right'>Joining Date</div></td>");
	              sBuffer.append("<td width='75%' class='CONTROL' colspan='4' ><div id='joinDatePic'>");
	              sBuffer.append("<font color='blue'>"+now(DATE_FORMAT_NOW)+"</font>");
	              sBuffer.append("</div></td>");
	            /*  sBuffer.append("<div id='joinTime' style='diplay:none'><td width='25%' class='LABEL' colspan='1'><font color='red'>*</font>Joining Time</td>");
	              ...
	              sBuffer.append("<select class='comboSmall' name='strShiftAmPm_J'><option value='1'>AM</option><option value='2'>PM</option></select></div></td></tr>");*/
	              ...
	              sBuffer.append("</td>");
	              sBuffer.append("</tr>");
	         //  System.out.println("bed vacant status->"+vo.getStrIsBedVacant());
	          // vo.setStrIsBedVacant("0");// just for checking..delete
	           if(vo.getStrIsBedVacant().equals("1"))
	           {   
	              sBuffer.append("<tr><td width='25%' class='LABEL' ><div align='right'><font color='red'>*</font>Room Type</div></td>");
	              ...
	              sBuffer.append("<tr><td width='25%' class='LABEL'><div align='right'><font color='red'>*</font>Bed Type</div></td>");
	              sBuffer.append("<td width='25%' class='CONTROL' >");
	              ...
	              sBuffer.append("<select name='strBed' class='comboNormal' dir='' title='Click to view Bed Status' onChange=''><option value='0'>Select Value</option></select>");
    ...
    public static String getBedDetails(PatientLeaveJoinRecordTransVO vo)
	{
		...
		{
			vo.setStrErrMsgString("PatientLeaveJoinRecordTransHLP.getBedDetails() -->"+ e.getMessage());
			vo.setStrMsgType("1");
		}
		sb.append("</table>");
