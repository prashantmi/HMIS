...
public class DeathNotificationTransFB extends ActionForm {
	...
	/**
	 * @return the strFGnctdFlag
	 */
	public String getStrFGnctdFlag() {
		return strFGnctdFlag;
	}
	/**
	 * @param strFGnctdFlag the strFGnctdFlag to set
	 */
	public void setStrFGnctdFlag(String strFGnctdFlag) {
		this.strFGnctdFlag = strFGnctdFlag;
	}
	/**
	 * @return the fFemale
	 */
