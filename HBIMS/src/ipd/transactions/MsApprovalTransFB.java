...
public class MsApprovalTransFB extends GenericFormBean{
	...
	private String strGovermentEmployeeBasicPayLimit = "0";
	private String strPrivateEmployeeMonthlyIncomeLimit = "0";
	...
	private String strOfficeAddres1 ="";
	...
	private String strDeptUnitValues ="";
	...
	private String strApprovedStatus ="1";
	...
	//local variables for occupation detail
	...
	private WebRowSet patientDetailsWs = null;
	//in case of listing
	...
	private String strPatApprovedList="";
	...
	private String strWardAllotChk  ="1";
	...
	private String strAdviceFrmValidity = "";
	private String strAdviceToValidity = "";
	private String strReportId = "";
	private String strListNo = "";
	private String strListValues= "";
	private String appStatus="1";
	
	private String strAdmissionType="";
	private String strSurgeryDate="";
	private String strLengthOfStay="";
	private String strPreviousDiagnosisDetail="";
	private String strPriorityType="";
	private String strUrgentTypeRemarks="";
	private String strUrgentTypeReason="";
	private String strPriorityFlag="";
	private String strPriorityRemarksFlag="";
	...
	public String getStrPriorityRemarksFlag() {
		return strPriorityRemarksFlag;
	}
	public void setStrPriorityRemarksFlag(String strPriorityRemarksFlag) {
		this.strPriorityRemarksFlag = strPriorityRemarksFlag;
	}
	public String getStrPriorityFlag() {
		return strPriorityFlag;
	}
	public void setStrPriorityFlag(String strPriorityFlag) {
		this.strPriorityFlag = strPriorityFlag;
	}
	public String getStrPreviousDiagnosisDetail() {
		return strPreviousDiagnosisDetail;
	}
	public void setStrPreviousDiagnosisDetail(String strPreviousDiagnosisDetail) {
		this.strPreviousDiagnosisDetail = strPreviousDiagnosisDetail;
	}
	public String getStrListNo() {
		return strListNo;
	}
	public void setStrListNo(String strListNo) {
		this.strListNo = strListNo;
	}
	public String getStrListValues() {
		return strListValues;
	}
	public void setStrListValues(String strListValues) {
		this.strListValues = strListValues;
	}
	...
	public String getStrWardAllotChk() {
		return strWardAllotChk;
	}



	public void setStrWardAllotChk(String strWardAllotChk) {
		this.strWardAllotChk = strWardAllotChk;
	}
	...
	/**
	 * @return the strPatApprovedList
	 */
	public String getStrPatApprovedList() {
		return strPatApprovedList;
	}



	/**
	 * @param strPatApprovedList the strPatApprovedList to set
	 */
	public void setStrPatApprovedList(String strPatApprovedList) {
		this.strPatApprovedList = strPatApprovedList;
	}
	...
	public WebRowSet getPatientDetailsWs() {
		return patientDetailsWs;
	}



	public void setPatientDetailsWs(WebRowSet patientDetailsWs) {
		this.patientDetailsWs = patientDetailsWs;
	}
	...
	public String getStrOfficeAddres1() {
		return strOfficeAddres1;
	}
	public void setStrOfficeAddres1(String strOfficeAddres1) {
		this.strOfficeAddres1 = strOfficeAddres1;
	}
	...
	public String getStrDeptUnitValues() {
		return strDeptUnitValues;
	}



	public void setStrDeptUnitValues(String strDeptUnitValues) {
		this.strDeptUnitValues = strDeptUnitValues;
	}
	...
	public String getStrAdviceFrmValidity() {
		return strAdviceFrmValidity;
	}
	public void setStrAdviceFrmValidity(String strAdviceFrmValidity) {
		this.strAdviceFrmValidity = strAdviceFrmValidity;
	}
	public String getStrAdviceToValidity() {
		return strAdviceToValidity;
	}
	public void setStrAdviceToValidity(String strAdviceToValidity) {
		this.strAdviceToValidity = strAdviceToValidity;
	}
	...
	public String getStrGovermentEmployeeBasicPayLimit() {
		return strGovermentEmployeeBasicPayLimit;
	}
	public void setStrGovermentEmployeeBasicPayLimit(
			String strGovermentEmployeeBasicPayLimit) {
		this.strGovermentEmployeeBasicPayLimit = strGovermentEmployeeBasicPayLimit;
	}
	public String getStrPrivateEmployeeMonthlyIncomeLimit() {
		return strPrivateEmployeeMonthlyIncomeLimit;
	}
	public void setStrPrivateEmployeeMonthlyIncomeLimit(
			String strPrivateEmployeeMonthlyIncomeLimit) {
		this.strPrivateEmployeeMonthlyIncomeLimit = strPrivateEmployeeMonthlyIncomeLimit;
	}
