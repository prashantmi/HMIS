...
public class BedTypeMstVO extends GenericFormBean {
	...
	private String strGlobalBedType="";
	private String strGlobalBedTypeCombo="";
	WebRowSet wrsGlobalBedType;
	...
	public String getStrGlobalBedType() {
		return strGlobalBedType;
	}

	public void setStrGlobalBedType(String strGlobalBedType) {
		this.strGlobalBedType = strGlobalBedType;
	}

	public String getStrGlobalBedTypeCombo() {
		return strGlobalBedTypeCombo;
	}

	public void setStrGlobalBedTypeCombo(String strGlobalBedTypeCombo) {
		this.strGlobalBedTypeCombo = strGlobalBedTypeCombo;
	}

	public WebRowSet getWrsGlobalBedType() {
		return wrsGlobalBedType;
	}

	public void setWrsGlobalBedType(WebRowSet wrsGlobalBedType) {
		this.wrsGlobalBedType = wrsGlobalBedType;
	}
