...
public class BedStatusMstVO extends GenericFormBean {
	...
	private String strGlobalBedStatus="";
	private String strGlobalBedStatusCombo="";
	WebRowSet wrsGlobalBedStatus;
 ...
 */
	...
	public String getStrGlobalBedStatus() {
		return strGlobalBedStatus;
	}
	
	public void setStrGlobalBedStatus(String strGlobalBedStatus) {
		this.strGlobalBedStatus = strGlobalBedStatus;
	}
	
	public String getStrGlobalBedStatusCombo() {
		return strGlobalBedStatusCombo;
	}
	
	public void setStrGlobalBedStatusCombo(String strGlobalBedStatusCombo) {
		this.strGlobalBedStatusCombo = strGlobalBedStatusCombo;
	}
	
	public WebRowSet getWrsGlobalBedStatus() {
		return wrsGlobalBedStatus;
	}
	
	public void setWrsGlobalBedStatus(WebRowSet wrsGlobalBedStatus) {
		this.wrsGlobalBedStatus = wrsGlobalBedStatus;
	}
