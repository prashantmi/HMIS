...
public class ClinicalDocumentMstVO extends GenericFormBean {
	...
	private String strGlobalClinicalDocumentType="";
	private String strGlobalClinicalDocumentTypeName="";
	private String strGlobalClinicalDocumentTypeCombo="";
	WebRowSet wrsGlobalClinicalDocumentType;
	...
	public String getStrGlobalClinicalDocumentType() {
		return strGlobalClinicalDocumentType;
	}
	public void setStrGlobalClinicalDocumentType(
			String strGlobalClinicalDocumentType) {
		this.strGlobalClinicalDocumentType = strGlobalClinicalDocumentType;
	}
	
	public String getStrGlobalClinicalDocumentTypeName() {
		return strGlobalClinicalDocumentTypeName;
	}
	public void setStrGlobalClinicalDocumentTypeName(
			String strGlobalClinicalDocumentTypeName) {
		this.strGlobalClinicalDocumentTypeName = strGlobalClinicalDocumentTypeName;
	}
	public String getStrGlobalClinicalDocumentTypeCombo() {
		return strGlobalClinicalDocumentTypeCombo;
	}
	public void setStrGlobalClinicalDocumentTypeCombo(
			String strGlobalClinicalDocumentTypeCombo) {
		this.strGlobalClinicalDocumentTypeCombo = strGlobalClinicalDocumentTypeCombo;
	}
	public WebRowSet getWrsGlobalClinicalDocumentType() {
		return wrsGlobalClinicalDocumentType;
	}
	public void setWrsGlobalClinicalDocumentType(
			WebRowSet wrsGlobalClinicalDocumentType) {
		this.wrsGlobalClinicalDocumentType = wrsGlobalClinicalDocumentType;
	}
