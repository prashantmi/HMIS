...
public class GlobalClinicalDocumentMstUTIL implements MasterInterface {
	...
	*/
	...
	public String[] getDeleteQuery()
	{
			...
			deleteQuery[0] = ipd.qryHandler_ipd.getQuery(1,"delete.globalClinicalDoc.0");
		    return deleteQuery;
	}
	...
	public String getMainQuery(String[] cmb) 
	{
			...
			brMainQuery.append(ipd.qryHandler_ipd.getQuery(1,"select.globalClinicalDoc.0").replace("?", ""+strhcode+""));
			brMainQuery.append(ipd.qryHandler_ipd.getQuery(1,"select.globalClinicalDoc.cond.1").replace("?", "1"));
	...
	{
			String masterName = "Global Clinical Document Master";
			return masterName;
	}
	...
	{
		    String viewQuery = ipd.qryHandler_ipd.getQuery(1, "select.globalClinicalDoc.1");
		    return viewQuery;
	}
