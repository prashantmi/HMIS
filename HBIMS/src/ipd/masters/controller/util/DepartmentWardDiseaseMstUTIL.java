...
public class DepartmentWardDiseaseMstUTIL implements MasterInterface {
	...
	public String getButtons() {
			...
			/*
			br.append("<a style=cursor:hand><img src='../../hisglobal/images/btn-add.png' title='Click To Add A Record' border=0 tabindex='1' onKeyPress='return callMe(document.deptWardDiseaseBean);' onClick='return callMe(document.deptWardDiseaseBean);' style='cursor:pointer'></a>");
		...
		*/
			br.append("<a class='btn btn-sm btn-primary' title='Click To Add A Record' tabindex='1' onKeyPress='return callMe(document.deptWardDiseaseBean);' onClick='return callMe(document.deptWardDiseaseBean);'>Add</a>");
	...
	public String[] getColumnHeader() {
			...
			String strColHeader[] = {"Department", "Unit", "Disease"};
	...
	public String[] getDeleteQuery() {
		...
		strDeleteQuery[0] = ipd.qryHandler_ipd.getQuery(1,"delete.departmentWardDiseaseMst.0");
	...
	public String getMainQuery(String[] strCmb) {
		...
		brMainQuery.append(ipd.qryHandler_ipd.getQuery(1,"select.departmentWardDiseaseMst.0"));
	...
	public String getMasterName() {
			...
			String strMasterName = "Department Ward Disease Master";
		
		return strMasterName;
	}

	public String[] getOrderBy() {
		String strOrderBy[] = {"1", "DEPT_NAME", "2", "UNIT_NAME", "3", "DISEASE_NAME"};
		return strOrderBy;
	}
	...
	public String[] getSearchField() {
		String strSearchField[] = {"1", "DEPT_NAME", "2","UNIT_NAME", "3", "DISEASE_NAME"};
	...
	public String getViewQuery() {
		String strViewQuery = ipd.qryHandler_ipd.getQuery(1,"select.departmentWardDiseaseMst.1");
