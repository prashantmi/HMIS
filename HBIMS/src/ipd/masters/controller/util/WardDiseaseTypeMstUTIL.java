...
public class WardDiseaseTypeMstUTIL implements MasterInterface {
...
*/
	...
	{
		String col_header[] = { "Disease Type", "Effective From" };
		return col_header;
	}
	...
	public String[] getDeleteQuery() 
	{
		...
		deleteQuery[0] = ipd.qryHandler_ipd.getQuery(1,"delete.diseasetype.0");
	...
	public String getMainQuery(String[] cmb) 
	{
		...
		brMainQuery.append(ipd.qryHandler_ipd.getQuery(1,"select.diseasetype.0").replace("?", ""+strhcode+""));
		brMainQuery.append(ipd.qryHandler_ipd.getQuery(1,"select.diseasetype.cond.1").replace("?", "1"));
	...
	{
		String masterName = "Ward Disease Type Master";
		return masterName;
	}

	public String[] getOrderBy()
	{
		String orderBy[] = { "1", "upper(HIPSTR_DISEASETYPE_NAME)" }; 
		return orderBy;
	}
	...
	{
		String search_field[] = { "1","HIPSTR_DISEASETYPE_NAME"};
		return search_field;
	}
	...
	{
		String viewQuery = ipd.qryHandler_ipd.getQuery(1, "select.diseasetype.1");
	    return viewQuery;
	}
