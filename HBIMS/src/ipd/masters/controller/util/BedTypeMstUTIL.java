...
public class BedTypeMstUTIL implements MasterInterface 
{
	...
	public String[] getDeleteQuery()
	{
			...
			deleteQuery[0] = ipd.qryHandler_ipd.getQuery(1,"delete.bedType.0");
	...
	public String getMainQuery(String[] cmb) {
			...
			brMainQuery.append(ipd.qryHandler_ipd.getQuery(1,"select.bedType.0").replace("?", ""+strhcode+""));
			brMainQuery.append(ipd.qryHandler_ipd.getQuery(1,"select.bedType.cond.0").replace("?", "1"));
			//brMainQuery.append(ipd.qryHandler_ipd.getQuery(1,"select.bedType.cond.order"));
	...
	{
			String masterName = "Bed Type Master";
			return masterName;
	}
	...
	{
		    String viewQuery = ipd.qryHandler_ipd.getQuery(1, "select.bedType.1");
	    	return viewQuery;
	}
