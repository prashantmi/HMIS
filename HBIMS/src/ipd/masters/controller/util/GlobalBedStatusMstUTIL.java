...
public class GlobalBedStatusMstUTIL implements MasterInterface 
{
	...
	*/
	...
	public String[] getDeleteQuery()
	{
			...
			deleteQuery[0] = ipd.qryHandler_ipd.getQuery(1,"delete.globalBedStatus.0");
	...
	public String getMainQuery(String[] cmb) 
	{
		String strhcode = IpdConfigUtil.SUPER_HOSPITAL_CODE.toString();  
			...
			brMainQuery.append(ipd.qryHandler_ipd.getQuery(1,"select.globalBedStatus.0").replace("?", ""+strhcode+""));
			brMainQuery.append(ipd.qryHandler_ipd.getQuery(1,"select.globalBedStatus.cond.1").replace("?", "1"));
	...
	{
			String masterName = "Global Bed Status Master";
			return masterName;
	}
	...
	{
		    String viewQuery = ipd.qryHandler_ipd.getQuery(1, "select.globalBedStatus.1");
		    return viewQuery;
	}
