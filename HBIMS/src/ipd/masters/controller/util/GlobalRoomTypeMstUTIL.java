...
public class GlobalRoomTypeMstUTIL implements MasterInterface {
	...
	public String getButtons() {
		...
		br.append("<img src='../../hisglobal/images/btn-del.png' title='Select One Or More CheckBox To Delete Record(s)'  border=0  tabindex='1' onKeyPress='deleteGlobalRecords(\"DELETE\",\"Room Type\");' onClick='deleteGlobalRecords(\"DELETE\",\"Room Type\");'></a>");
		...
		*/
		...
		br.append("<a href='#' class='btn btn-sm btn-primary' id='' onKeyPress='deleteGlobalRecords(\"DELETE\",\"Room Type\");' onClick='deleteGlobalRecords(\"DELETE\",\"Room Type\");'><span class='delete'>Delete</span></a>");
	...
	public String[] getDeleteQuery() {
		...
		deleteQuery[0] = ipd.qryHandler_ipd.getQuery(1, "delete.globalRoomtype.0");
	...
	public String getMainQuery(String[] cmb) {
		...
		brMainQuery.append(ipd.qryHandler_ipd.getQuery(1, "select.globalRoomtype.0")
				.replace("?", ""+strhcode+""));
	
		brMainQuery.append(ipd.qryHandler_ipd.getQuery(1, "select.globalRoomtype.cond.0")
				.replace("?", "1"));
...
*/
	...
	public String getMasterName() {
		String masterName = "Global Room Type Master";
		return masterName;
	}
	...
	public String getViewQuery() {
		String viewQuery = ipd.qryHandler_ipd.getQuery(1, "select.globalRoomtype.1");
		return viewQuery;
	}
