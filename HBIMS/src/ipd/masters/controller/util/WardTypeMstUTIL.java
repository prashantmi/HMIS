...
public class WardTypeMstUTIL implements MasterInterface {
	...
	public String getButtons() {
			...
			*/
			...
			br.append("<a href='#' class='button btn btn-sm btn-primary' id='' onKeyPress='view(\"VIEWDATA\");' onClick='view(\"VIEWDATA\");'><span class='view'>View</span></a>");
	...
	public String[] getColumnHeader() {
			...
			String col_header[] = { "Ward Type","Block Duration " };
	...
	public String[] getDeleteQuery() {
			...
			deleteQuery[0] = ipd.qryHandler_ipd.getQuery(1,"update.wardtype.0");	
		return deleteQuery;
	}
	...
	public String getMainQuery(String[] cmb) {
		  ...
		  String strhcode = httpSession.getAttribute("HOSPITAL_CODE").toString();
			...
			brMainQuery.append(ipd.qryHandler_ipd.getQuery(1,"select.wardtype.0").replace("?", ""+strhcode+""));
			brMainQuery.append(ipd.qryHandler_ipd.getQuery(1,"select.wardtype.cond.0").replace("?", "1"));
	...
	public String getMasterName() {
			...
			String masterName = "Ward Type Master";
	...
	public List<String> getViewHeader() {
			...
			viewHdr.add("D");
			viewHdr.add("Bed Block Duration");
			viewHdr.add("D");
		return viewHdr;
	}
	...
	public String getViewQuery() {
			...
			String viewQuery = ipd.qryHandler_ipd.getQuery(1, "select.wardtype.1");
