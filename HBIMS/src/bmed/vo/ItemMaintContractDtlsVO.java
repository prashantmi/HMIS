...
public class ItemMaintContractDtlsVO implements TransferObject
{
	...
	private String strEquipmentNameCmb;
	...
	private String strIsMaintWarrantyDesk; //Added on 02-Aug-2013 for Equipment Maintenance Desk
	...
	private String strCompanyContactNo;
	private String strCompanyMailId;
	...
	public String getStrEquipmentNameCmb() {
		return strEquipmentNameCmb;
	}
	public void setStrEquipmentNameCmb(String strEquipmentNameCmb) {
		this.strEquipmentNameCmb = strEquipmentNameCmb;
	}
	...
	public String getStrIsMaintWarrantyDesk() {
		return strIsMaintWarrantyDesk;
	}
	public void setStrIsMaintWarrantyDesk(String strIsMaintWarrantyDesk) {
		this.strIsMaintWarrantyDesk = strIsMaintWarrantyDesk;
	}
	/**
	...
	public String getStrCompanyContactNo() {
		return strCompanyContactNo;
	}
	public void setStrCompanyContactNo(String strCompanyContactNo) {
		this.strCompanyContactNo = strCompanyContactNo;
	}
	public String getStrCompanyMailId() {
		return strCompanyMailId;
	}
	public void setStrCompanyMailId(String strCompanyMailId) {
		this.strCompanyMailId = strCompanyMailId;
	}
}
