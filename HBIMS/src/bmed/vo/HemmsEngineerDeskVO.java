...
public class HemmsEngineerDeskVO 
{
	...
	private String strHEMAttendDate;
	private String strHEMAttendTime;
	...
	private String strPenalityRemarks; //Added on 21-Nov-2013 due to client's change request
	...
	private String strReceviedNo []={};
	private String strIsuedQty[]={};
	private String strConsFlag[]={};
	//multi-row fields declaration ends
	
	public String[] getStrReceviedNo() {
		return strReceviedNo;
	}

	public void setStrReceviedNo(String[] strReceviedNo) {
		this.strReceviedNo = strReceviedNo;
	}

	public String[] getStrIsuedQty() {
		return strIsuedQty;
	}

	public void setStrIsuedQty(String[] strIsuedQty) {
		this.strIsuedQty = strIsuedQty;
	}

	public String[] getStrConsFlag() {
		return strConsFlag;
	}

	public void setStrConsFlag(String[] strConsFlag) {
		this.strConsFlag = strConsFlag;
	}
	...
	public String getStrHEMAttendDate() {
		return strHEMAttendDate;
	}

	public void setStrHEMAttendDate(String strHEMAttendDate) {
		this.strHEMAttendDate = strHEMAttendDate;
	}

	public String getStrHEMAttendTime() {
		return strHEMAttendTime;
	}

	public void setStrHEMAttendTime(String strHEMAttendTime) {
		this.strHEMAttendTime = strHEMAttendTime;
	}

	public String getStrPenalityRemarks() {
		return strPenalityRemarks;
	}

	public void setStrPenalityRemarks(String strPenalityRemarks) {
		this.strPenalityRemarks = strPenalityRemarks;
	}
