 ...
 * 
 */
public class EngineeringItemSubTypeMstFB extends GenericFormBean {
	...
	/** the str end item type id */

	private String strEngItemTypeId ="";

	/** the str end item sub type id */
	...
	/** The strengitem type combo */
	private String strEnggItemTypeCmb;

	/** The str Engg item type id */
