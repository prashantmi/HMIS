...
/**
 * @author Creation Date:- 19-Jan-2011 Modifying Date:- 25-Jan-2011 Used For:-
 *         Team Lead By:- Module:- BMED(HIS Project)
 * 
 */
public class MaintenanceMstUTL implements MasterInterface {
	...
	public String getButtons() {
		...
		br
				.append("<img src='../../hisglobal/images/btn-view.png' style='cursor: pointer; ' tabindex='1' title='Select A Record To View' onKeyPress='if(event.keyCode==13) view(\"VIEWDATA\");' onClick='view(\"VIEWDATA\");' />");
		br
	...
	public String[] getColumnHeader() {
		String[] columnHdr = { "Maintenance Name", "Effective From Date" };
		return columnHdr;
	}
	...
	public String[] getComboHeader() {
		String[] strColumnHdr = { "0", "Engineering Item Type", "0",
				"Engineering Item Sub Type", "1", "Is Active" };
		return strColumnHdr;
	}
	...
	public String[] getComboQuery() {
		...
		strComboQuery[0] = bmed.qryHandler_bmed.getQuery(1,
				"maintenanceMst.enggItemtype.combo.0");
		strComboQuery[0] = strComboQuery[0].replace("?", Config.SUPER_USER_HOSPITAL_CODE);

		strComboQuery[1] = bmed.qryHandler_bmed.getQuery(1,
				"maintenanceMst.enggItemSubtype.combo.1");
	...
	public String[] getDeleteQuery() {
		...
		strDeleteQuery[0] = bmed.qryHandler_bmed.getQuery(1,
				"maintenanceMst.delete.0").replace("?", seatId);
		strDeleteQuery[0] = strDeleteQuery[0].concat(" WHERE "
				+ bmed.qryHandler_bmed.getQuery(1,
						"maintenanceMst.delete.cond.0"));
	...
	public String getMainQuery(String[] cmb) {
		...
		brMainQuery.append(
				bmed.qryHandler_bmed.getQuery(1, "maintenanceMst.main")
						.replace("?", strHosCode))
				.append(
						" AND "
								+ bmed.qryHandler_bmed.getQuery(1,
										"maintenanceMst.main.cond.1").replace(
										"?", "1"));
		...
		brMainQuery.append(" AND "
				+ bmed.qryHandler_bmed
						.getQuery(1, "maintenanceMst.main.cond.2").replace("?",
								"0"));
		...
		brMainQuery.append(" AND "
				+ bmed.qryHandler_bmed
						.getQuery(1, "maintenanceMst.main.cond.3").replace("?",
								"0"));
	...
	public String getMasterName() {
		String strMasterName = "Maintenance Master";
	...
	public String[] getOrderBy() {
		String strOrderBy[] = { "1", "UPPER(HEMSTR_MAINTE_NAME)" };
		return strOrderBy;
	}
	...
	public String[] getSearchField() {
		String strSearchField[] = { "1", "HEMSTR_MAINTE_NAME" };
