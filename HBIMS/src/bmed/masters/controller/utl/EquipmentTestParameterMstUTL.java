 ...
 * 
 */
public class EquipmentTestParameterMstUTL  implements MasterInterface
{
	...
	{
		String[] columnHdr = { "Test Name","Parameter Name", "Effective From Date" };
		return columnHdr;
	}
	...
	{
		return "/HBIMS/WebContent/bmed/js/equipmentTestParameterMst.js";
	}
	...
	{
		String strMasterName = "Equipment Test Parameter Master";
	...
	{
		String strOrderBy[] = { "1", " UPPER(BMED_FUNCTION.get_test_name(GNUM_HOSPITAL_CODE,HEMNUM_TEST_ID)) ","2" ,"UPPER(BMED_FUNCTION.get_eqp_para_name(GNUM_HOSPITAL_CODE,HEMNUM_PARAMETER_ID))" };
		return strOrderBy;
	}
	...
	{
		String strSearchField[] = { "1", "UPPER(BMED_FUNCTION.get_test_name(GNUM_HOSPITAL_CODE,HEMNUM_TEST_ID))","2","UPPER(BMED_FUNCTION.get_eqp_para_name(GNUM_HOSPITAL_CODE,HEMNUM_PARAMETER_ID))" };
