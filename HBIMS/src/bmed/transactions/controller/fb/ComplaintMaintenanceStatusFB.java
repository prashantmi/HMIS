...
public class ComplaintMaintenanceStatusFB extends ActionForm {
	...
	private String strWarrantyDuration;
	private String strWarrantyUptoUnitOptions;
	private String strAMCStartDate;
	private String strAMCEndDate;
	private String strWorkingCondition;
	private String strPreviousComplaintDetails;
	...
	private String strNatureOfServiceComboData;
	...
	public String getStrWarrantyDuration() {
		return strWarrantyDuration;
	}

	public void setStrWarrantyDuration(String strWarrantyDuration) {
		this.strWarrantyDuration = strWarrantyDuration;
	}

	public String getStrAMCStartDate() {
		return strAMCStartDate;
	}

	public void setStrAMCStartDate(String strAMCStartDate) {
		this.strAMCStartDate = strAMCStartDate;
	}

	public String getStrAMCEndDate() {
		return strAMCEndDate;
	}

	public void setStrAMCEndDate(String strAMCEndDate) {
		this.strAMCEndDate = strAMCEndDate;
	}

	public String getStrPreviousComplaintDetails() {
		return strPreviousComplaintDetails;
	}

	public void setStrPreviousComplaintDetails(String strPreviousComplaintDetails) {
		this.strPreviousComplaintDetails = strPreviousComplaintDetails;
	}
	...
	public String getStrNatureOfServiceComboData() {
		return strNatureOfServiceComboData;
	}

	public void setStrNatureOfServiceComboData(String strNatureOfServiceComboData) {
		this.strNatureOfServiceComboData = strNatureOfServiceComboData;
	}
