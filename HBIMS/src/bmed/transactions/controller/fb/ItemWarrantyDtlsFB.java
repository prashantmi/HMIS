...
public class ItemWarrantyDtlsFB extends ActionForm {
	...
	private String  strSupplierNameCombo;
	private String  strIsExtendPK;
	private String  strIsExtend;
	...
	private String 	strExtndWarrantyStartDate;

	private String 	strExtndWarrantyUpTo;

	private String 	strExtndWarrantyId;

	private String 	strExtndTermsAndCond;

	private String 	strExtndRemarks;
	...
	public String getStrInstallationDate() {
		return strInstallationDate;
	}

	public void setStrInstallationDate(String strInstallationDate) {
		this.strInstallationDate = strInstallationDate;
	}
	...
	public FormFile getFormFileMultiple( Integer i ) 
	{
	...
	public void setFormFileMultiple( Integer i, FormFile formFileMultiple ) 
	{
 ...
 // Form File End   
	...
	public String getStrSupplierNameCombo() {
		return strSupplierNameCombo;
	}

	public void setStrSupplierNameCombo(String strSupplierNameCombo) {
		this.strSupplierNameCombo = strSupplierNameCombo;
	}

	public String getStrIsExtendPK() {
		return strIsExtendPK;
	}

	public void setStrIsExtendPK(String strIsExtendPK) {
		this.strIsExtendPK = strIsExtendPK;
	}

	public String getStrIsExtend() {
		return strIsExtend;
	}

	public void setStrIsExtend(String strIsExtend) {
		this.strIsExtend = strIsExtend;
	}
	...
	public String getStrExtndWarrantyStartDate() {
		return strExtndWarrantyStartDate;
	}

	public void setStrExtndWarrantyStartDate(String strExtndWarrantyStartDate) {
		this.strExtndWarrantyStartDate = strExtndWarrantyStartDate;
	}

	public String getStrExtndWarrantyUpTo() {
		return strExtndWarrantyUpTo;
	}

	public void setStrExtndWarrantyUpTo(String strExtndWarrantyUpTo) {
		this.strExtndWarrantyUpTo = strExtndWarrantyUpTo;
	}

	public String getStrExtndWarrantyId() {
		return strExtndWarrantyId;
	}

	public void setStrExtndWarrantyId(String strExtndWarrantyId) {
		this.strExtndWarrantyId = strExtndWarrantyId;
	}

	public String getStrExtndTermsAndCond() {
		return strExtndTermsAndCond;
	}

	public void setStrExtndTermsAndCond(String strExtndTermsAndCond) {
		this.strExtndTermsAndCond = strExtndTermsAndCond;
	}

	public String getStrExtndRemarks() {
		return strExtndRemarks;
	}

	public void setStrExtndRemarks(String strExtndRemarks) {
		this.strExtndRemarks = strExtndRemarks;
	}
