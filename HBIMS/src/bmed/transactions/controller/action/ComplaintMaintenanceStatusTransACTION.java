...
public class ComplaintMaintenanceStatusTransACTION extends CSRFGardTokenAction {
	...
	public ActionForward unspecified(ActionMapping mapping, ActionForm form,
		...
		if("1".equals(complaintMaintenanceStatusFB.getStrIsHemDesk())) {
			...
			ComplaintMaintenanceStatusUTIL.initializeMain(complaintMaintenanceStatusFB, request);
			strForwardName = "main";
	...
	public ActionForward getAjaxComplaintRequestData(ActionMapping mapping,
		...
		ComplaintMaintenanceStatusUTIL.getAjaxComplaintRequestData(request,
				response);
	...
	{	
		...
		ComplaintMaintenanceStatusUTIL.initializeItemComplaintRegister(complaintMaintenanceStatusFB,request_p);
	...
	{		
		...
		ComplaintMaintenanceStatusUTIL.getStoreName(formBean,request_p,response_p);
		return null;
	}
	...
	public ActionForward ENGGITEMSUBTYPECMB(ActionMapping mapping_p, ActionForm form_p,
		...
		ComplaintMaintenanceStatusFB fb = (ComplaintMaintenanceStatusFB) form_p;
		ComplaintMaintenanceStatusUTIL.getEnggItemSubTypeCmb(fb, request_p, response_p);
	...
	{		
		ComplaintMaintenanceStatusFB formBean = (ComplaintMaintenanceStatusFB)form_p;
		ComplaintMaintenanceStatusUTIL.getItemName(formBean,request_p,response_p);
	...
	{		
		ComplaintMaintenanceStatusFB formBean = (ComplaintMaintenanceStatusFB)form_p;
		ComplaintMaintenanceStatusUTIL.getNonItemName(formBean,request_p,response_p);
	...
	{		
		ComplaintMaintenanceStatusFB formBean = (ComplaintMaintenanceStatusFB)form_p;
		ComplaintMaintenanceStatusUTIL.getStockDetails(formBean,request_p,response_p);
		return null;
	}
	...
	{		
		ComplaintMaintenanceStatusFB formBean = (ComplaintMaintenanceStatusFB)form_p;
		ComplaintMaintenanceStatusUTIL.getPreviousComplaintDetails(formBean,request_p,response_p);
		return null;
	}
	...
	{		
		ComplaintMaintenanceStatusFB formBean = (ComplaintMaintenanceStatusFB)form_p;
		ComplaintMaintenanceStatusUTIL.getWarrantyDetails(formBean,request_p,response_p);
		return null;
	}
	...
	{		
		ComplaintMaintenanceStatusFB formBean = (ComplaintMaintenanceStatusFB)form_p;
		ComplaintMaintenanceStatusUTIL.getMaintenanceContractDetails(formBean,request_p,response_p);
		return null;
	}
	...
	{		
		...
		ComplaintMaintenanceStatusFB formBean = (ComplaintMaintenanceStatusFB)form_p;
		ComplaintMaintenanceStatusUTIL.saveData(formBean,request_p);
		
		return mapping_p.findForward("item");
		//return this.initializeItemComplaintRegister(mapping_p, form_p, request_p, response_p);
	}
	...
	public ActionForward initializeSchedule(ActionMapping mapping,
		...
		ComplaintMaintenanceStatusUTIL.initializeSchedule(
				complaintMaintenanceStatusFB, request);
		complaintMaintenanceStatusFB.setStrIsHemDesk("1");
	...
	public ActionForward initializeAttended(ActionMapping mapping,
		...
		generateToken(request);
		ComplaintMaintenanceStatusFB complaintMaintenanceStatusFB = (ComplaintMaintenanceStatusFB) form;
		ComplaintMaintenanceStatusUTIL.initializeAttended(
				complaintMaintenanceStatusFB, request);
		complaintMaintenanceStatusFB.setStrIsHemDesk("1");
		strForwardName = "attended";
		return mapping.findForward(strForwardName);
	...
	public ActionForward viewDetails(ActionMapping mapping_p,ActionForm form_p, HttpServletRequest request_p,HttpServletResponse response_p) 
	{
		...
		strForwardName = "view";
		if(request_p.getParameter("strIsHemDesk")!=null)
			complaintMaintenanceStatusFB.setStrIsHemDesk(request_p.getParameter("strIsHemDesk"));
		else
			complaintMaintenanceStatusFB.setStrIsHemDesk("0");
	...
	public ActionForward saveAttended(ActionMapping mapping, ActionForm form,
		...
		validateToken(request,response);
		ComplaintMaintenanceStatusFB complaintMaintenanceStatusFB = (ComplaintMaintenanceStatusFB) form;
		ComplaintMaintenanceStatusUTIL.saveAttended(
				complaintMaintenanceStatusFB, request);
		return unspecified(mapping, form, request, response);
	...
	public ActionForward initializeClose(ActionMapping mapping,
		...
		generateToken(request);
		ComplaintMaintenanceStatusFB complaintMaintenanceStatusFB = (ComplaintMaintenanceStatusFB) form;
		ComplaintMaintenanceStatusUTIL.initializeClose(
				complaintMaintenanceStatusFB, request);
...
//		System.out.println("strChk:::"+strChk);
    ...
    {		
		ComplaintMaintenanceStatusFB complaintMaintenanceStatusFB = (ComplaintMaintenanceStatusFB) form_p;
		ComplaintMaintenanceStatusUTIL.getUploadedFile(complaintMaintenanceStatusFB, request_p, response_p);
		return null;
	}
	
	public ActionForward GETITEMCOMPLAINTVOUCHER(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response)
			throws HisException, SQLException {

		ComplaintMaintenanceStatusFB formBean = (ComplaintMaintenanceStatusFB) form;

		ComplaintMaintenanceStatusDATA.getItemComplaintVoucher(formBean,request, response);
