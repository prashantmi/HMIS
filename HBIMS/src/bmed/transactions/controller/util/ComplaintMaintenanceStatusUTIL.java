...
public class ComplaintMaintenanceStatusUTIL {
	...
	public static void getItemName(ComplaintMaintenanceStatusFB formBean_p,
			HttpServletRequest request_p, HttpServletResponse response_p) {
		ComplaintMaintenanceStatusDATA.getItemName(formBean_p, request_p,
				response_p);

	}

	public static void getNonItemName(ComplaintMaintenanceStatusFB formBean_p,
			HttpServletRequest request_p, HttpServletResponse response_p) {
		ComplaintMaintenanceStatusDATA.getNonItemName(formBean_p, request_p,
				response_p);
	...
	public static void getStockDetails(
			ComplaintMaintenanceStatusFB complaintMaintenanceStatusFB_p,
			HttpServletRequest request_p, HttpServletResponse response_p) {
		ComplaintMaintenanceStatusDATA.getStockDetails(
				complaintMaintenanceStatusFB_p, request_p, response_p);
	...
	public static void getPreviousComplaintDetails(
			ComplaintMaintenanceStatusFB complaintMaintenanceStatusFB_p,
			HttpServletRequest request_p, HttpServletResponse response_p) {
		ComplaintMaintenanceStatusDATA.getPreviousComplaintDetails(
				complaintMaintenanceStatusFB_p, request_p, response_p);
	...
	public static void getWarrantyDetails(
			ComplaintMaintenanceStatusFB complaintMaintenanceStatusFB_p,
			HttpServletRequest request_p, HttpServletResponse response_p) {
		ComplaintMaintenanceStatusDATA.getWarrantyDetails(
				complaintMaintenanceStatusFB_p, request_p, response_p);
	...
	public static void getMaintenanceContractDetails(
			...
			HttpServletRequest request_p, HttpServletResponse response_p) {
		ComplaintMaintenanceStatusDATA.getMaintenanceContractDetails(
				formBean_p, request_p, response_p);

	}

	public static void saveData(ComplaintMaintenanceStatusFB formBean_p,
			HttpServletRequest request_p) {
		ComplaintMaintenanceStatusDATA.saveData(formBean_p, request_p);
	...
	public static void initializeAttended(
			ComplaintMaintenanceStatusFB complaintMaintenanceStatusFB_p,
			HttpServletRequest request_p) {
		ComplaintMaintenanceStatusDATA.initializeAttended(
				complaintMaintenanceStatusFB_p, request_p);
	...
	public static void initializeReminderReply(
			ComplaintMaintenanceStatusFB complaintMaintenanceStatusFB_p,
			HttpServletRequest request_p) {
		 ComplaintMaintenanceStatusDATA.initializeReminder(complaintMaintenanceStatusFB_p,
		 request_p);
	}
	...
	public static void saveReminderReply(
			ComplaintMaintenanceStatusFB formBean_p,
			HttpServletRequest request_p) {
		 ComplaintMaintenanceStatusDATA.saveReminder(formBean_p,
		 request_p);
	}
	...
	public static void saveAttended(
		...
		try {
			 ...
			 * Calling DATA
			 */
			ComplaintMaintenanceStatusDATA.saveAttended(complaintAttendDtlVO,
	 ...
	 * @param response_p
	 */
	public static void getUploadedFile(	ComplaintMaintenanceStatusFB complaintMaintenanceStatusFB_p,HttpServletRequest request_p, HttpServletResponse response_p) {
		ComplaintMaintenanceStatusDATA.getUploadedFile(complaintMaintenanceStatusFB_p, request_p, response_p);
	}
