...
public class ComplaintLogOfflineUTIL {
	...
	public static void getServiceEngName(
			ComplaintLogOfflineFB complaintMaintenanceStatusFB_p,
			HttpServletRequest request_p, HttpServletResponse response_p) {
		ComplaintLogOfflineDATA.getServiceEngName(
				complaintMaintenanceStatusFB_p, request_p, response_p);
	}
	...
	public static void getEnggItemSubTypeCmb(
			ComplaintLogOfflineFB complaintMaintenanceStatusFB_p,
			HttpServletRequest request_p, HttpServletResponse response_p) {
		ComplaintLogOfflineDATA.getEnggItemSubTypeCmb(
				complaintMaintenanceStatusFB_p, request_p, response_p);

	}

	public static void getItemName(ComplaintLogOfflineFB formBean_p,
			HttpServletRequest request_p, HttpServletResponse response_p) {
		ComplaintLogOfflineDATA.getItemName(formBean_p, request_p,
				response_p);

	}

	public static void getNonItemName(ComplaintLogOfflineFB formBean_p,
			HttpServletRequest request_p, HttpServletResponse response_p) {
		ComplaintLogOfflineDATA.getNonItemName(formBean_p, request_p,
				response_p);
	...
	public static void getStockDetails(
			ComplaintLogOfflineFB complaintMaintenanceStatusFB_p,
			HttpServletRequest request_p, HttpServletResponse response_p) {
		ComplaintLogOfflineDATA.getStockDetails(
				complaintMaintenanceStatusFB_p, request_p, response_p);
	...
	public static void getPreviousComplaintDetails(
			ComplaintLogOfflineFB complaintMaintenanceStatusFB_p,
			HttpServletRequest request_p, HttpServletResponse response_p) {
		ComplaintLogOfflineDATA.getPreviousComplaintDetails(
				complaintMaintenanceStatusFB_p, request_p, response_p);
	...
	public static void getWarrantyDetails(
			ComplaintLogOfflineFB complaintMaintenanceStatusFB_p,
			HttpServletRequest request_p, HttpServletResponse response_p) {
		ComplaintLogOfflineDATA.getWarrantyDetails(
				complaintMaintenanceStatusFB_p, request_p, response_p);

	}

	public static void getMaintenanceContractDetails(
			ComplaintLogOfflineFB formBean_p,
			HttpServletRequest request_p, HttpServletResponse response_p) {
		ComplaintLogOfflineDATA.getMaintenanceContractDetails(
				formBean_p, request_p, response_p);

	}

	public static void saveData(ComplaintLogOfflineFB formBean_p,
			HttpServletRequest request_p) {
		ComplaintLogOfflineDATA.saveData(formBean_p, request_p);
	...
	public static void getUploadedFile(	ComplaintLogOfflineFB complaintMaintenanceStatusFB_p,HttpServletRequest request_p, HttpServletResponse response_p) {
		ComplaintLogOfflineDATA.getUploadedFile(complaintMaintenanceStatusFB_p, request_p, response_p);
	}
