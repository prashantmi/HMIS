...
import bmed.reports.controller.util.ListOfPendingComplaintsReportUTIL;
 ...
 *
 */
public class ListOfPendingComplaintsReportACTION extends DispatchAction 
{
	...
	{
	String target="main";
	ListOfPendingComplaintsReportFB formBean = (ListOfPendingComplaintsReportFB) form_p;
	ListOfPendingComplaintsReportUTIL.setInitDtl(formBean, request_p);
	...
	public void SHOWRPT(ActionMapping mapping_p, ActionForm form_p,HttpServletRequest request_p, HttpServletResponse response_p)	throws HisException, SQLException
	{
		...
		ListOfPendingComplaintsReportUTIL.showReport(formBean, request_p, response_p);
	}
