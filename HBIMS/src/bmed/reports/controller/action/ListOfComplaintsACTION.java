 ...
 * 
 */
public class ListOfComplaintsACTION extends DispatchAction 
{
	 /**
	 * Unspecified method
	 * 
	 ...
	 */
		...
		String target="index";
		ListOfComplaintsFB formBean = (ListOfComplaintsFB) form_p;
		ListOfComplaintsUTIL.setInitDtl(formBean, request_p);
	...
	public void SHOWRPT(ActionMapping mapping_p, ActionForm form_p,
		...
		ListOfComplaintsUTIL.showReport(formBean, request_p, response_p);
