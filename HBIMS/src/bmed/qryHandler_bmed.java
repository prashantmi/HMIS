 ...
 */
public class qryHandler_bmed {

	/** The mst query. */
	static String mstQuery = "bmed.bmed_qry_mst";

	/** The trn query. */
	static String trnQuery = "bmed.bmed_qry_trans";

	/** The rpt query. */
	static String rptQuery = "bmed.bmed_qry_rpt";
