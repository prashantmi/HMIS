...
/* Global Remarks Master Form Bean
 * author: Pawan Kumar B N
 * Created on : 26-Aug-2011
 */
...
/**
 * The Class GlobalRemarksMstFB.
 */
public class GlobalRemarksMstFB extends GenericFormBean {
	...
	/** constructor GlobalRemarksMstFB */
	
	public GlobalRemarksMstFB()
	{
		strRemarksDesc="";
		strRemarksType="";
		strEffectiveFrom="";
	...
	public static long getSerialVersionUID() {
 	...
 	public String getStrCtDate() {
			HisUtil util = new HisUtil("Remarks Master", "GlobalRemarksMstFB");
			try {
				strCtDate = util.getASDate("dd-MMM-yyyy");
				util = null;
			 } catch (Exception e) {
				new HisException("Billing Module", "Remarks Master",
						"GlobalRemarksMstFB.getStrCtDate()-->" + e.getMessage());
		     }
		      return strCtDate;
		   }
...
public String getStrCrntDate() throws Exception {
		...
		if (this.strCrntDate == null) {
			HisUtil util = new HisUtil("billing", "GlobalRemarksMstFB");
			try {
