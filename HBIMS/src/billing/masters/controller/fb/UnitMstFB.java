...
public class UnitMstFB extends GenericFormBean {
	...
	public String getStrEffectiveDate() {
		...
		if (this.strEffectiveDate == null) {
			...
			HisUtil util = new HisUtil("Remarks Master", "RemarksMstFB");
			try {
				...
				new HisException("Remarks Master",
						"RemarksMstFB.getEffectiveDate()", e.getMessage());
			}
		}
