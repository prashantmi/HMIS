...
public class ClientChargeMstHLP {

	/*
	 * to get package data.
	 */
	public String getDataFrmPack(ClientChargeMstVO vo, String str) throws Exception 
	{
		WebRowSet wb = null;
		...
		{
			throw new Exception("HLPClientChargeMst.getDataFrmPack() --> "+ e.getMessage());
		}
	 ...
	 */
	public String getMRowData(ClientChargeMstVO vo) throws Exception {
		StringBuffer sb = new StringBuffer();
		try {
			...
			throw new Exception("HLPClientChargeMst.getMRowData --> "
					+ e.getMessage());
		}
	...
	public static String getPreviousData(ClientChargeMstFB fb) throws Exception 
	{
		WebRowSet wb = null;
		StringBuffer sb = new StringBuffer();
		...
		try 
		{
			...
			if (wb.size() != 0) 
			{
				sb.append("<table class='TABLEWIDTH' border='0' align='center' cellspacing='1px'>");
				sb.append("<tr>");
				sb.append("<td class='multiLabel' width='18%'>Patient Category</td>");
				sb.append("<td class='multiLabel' width='16%'>Organization </td>");
				sb.append("<td class='multiLabel' width='12%'>Tariff Cost(<img src='/HBIMS/hisglobal/images/INR.png'>)</td>");
				sb.append("<td class='multiLabel' width='14%'>Validity</td>");
				sb.append("</tr>");
				...
				while (wb.next()) 
				{
					...
					sb.append("<td class='multiControl' width='14%'><input type='hidden' name='strOrgHidden' value='"+ wb.getString(3)+ "'>"+ wb.getString(4) + "</td >");
					sb.append("<td class='multiControl' width='12%'>"+ wb.getString(5) + "</td >");
					sb.append("<td class='multiControl' width='12%'>"+ wb.getString(6) + "</td >");
					sb.append("</tr>");
				}
				sb.append("</table>");
			} 
		...
		{
			throw new Exception("HLPClientChargeMst.getPreviousData() --> "+ e.getMessage());
		}

		return sb.toString();
	}
	
	public static String getModifyData(ClientChargeMstFB fb) 
	{
		WebRowSet wb = null;
		StringBuffer sb = new StringBuffer();
		boolean start=true;
			...
			if (wb.size() != 0) 
			{
				...
				while (wb.next()) 
				{
					if(!strPervService.equals(wb.getString(1)))
					{
						...
						sb.append("<td class='multiLabel' width='"+setWidth+"%'>Organization </td>");
						sb.append("<td class='multiLabel' width='20%' style='display: none'>Procedure Cost(<img src='/HBIMS/hisglobal/images/INR.png'>)</td>");
					...
					sb.append("<input type=hidden disabled name=strUnitIdArr value='"+wb.getString(19)+"'>");
					if("PRIVATE".equalsIgnoreCase(wb.getString(16))){
						sb.append("<input type=hidden disabled name=strWardTypeArr value='1'>");
					} else if("GENERAL".equalsIgnoreCase(wb.getString(16))){
					...
					sb.append(wb.getString(18));
					sb.append("</td>");
					sb.append("<td class='multiControl'>");
					sb.append(wb.getString(22));
					sb.append("</td>");
					...
					sb.append(nTmpI);
					sb.append("'>");
					sb.append(HisUtil.getDatePicker("strFromDateArr", wb.getString(11), true));
					sb.append("</div>");
					sb.append("<div id='divEffDate");
					sb.append(nTmpI++);
					sb.append("'>");
					sb.append(wb.getString(11));
					sb.append("</div>");
					sb.append("</td>");
	...
	public static void getDataFrmPackModify(ClientChargeMstVO vo) throws Exception {
		WebRowSet wb = null;
		StringBuffer sb = new StringBuffer();
		try {
			...
			throw new Exception("HLPClientChargeMst.getDataFrmPack() --> "
					+ e.getMessage());
		}
		vo.setStrPackageDetails(sb.toString());
		ClientChargeMstFB fb = (ClientChargeMstFB) TransferObjectFactory.populateData(
