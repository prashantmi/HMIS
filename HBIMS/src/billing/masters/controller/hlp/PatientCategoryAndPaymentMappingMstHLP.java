...
public class PatientCategoryAndPaymentMappingMstHLP {
	...
	public static String getMappingData(VOPatientCategoryAndPaymentModeMst vo) throws Exception 
	{
		WebRowSet wb = null;
		StringBuffer sb = new StringBuffer();
		String temp ="";
		try 
		{
			...
			/*sb.append("<div class='row' id='mapping-row-0' style='display:none'>");
			sb.append("<div class='col-sm-1'></div>");
			sb.append("<div class='col-md-3' id='recPayMode-row-0'>");
			sb.append("<select class='form-control' name='strRecieptPaymentMode'>");
			sb.append("<bean:write name='PatientCategoryAndPaymentModeBean' property='strRecieptPaymentModeValues' filter='false'/>");
			sb.append("</select></div>");
			sb.append("<div class='col-md-2'>");
			sb.append("<div class='checkbox'>");
			sb.append("<label><input type='checkbox' value='' style='margin-top: 10px;'></label>");
			sb.append("</div> </div>");
			sb.append("<div class='col-md-4' id='refPayMode-row-0'>");
		    sb.append("<div class='row'>");
			sb.append("<div class='col-sm-8'>");
			sb.append("<select class='form-control' name='strRefundPaymentMode'>");
			sb.append("<bean:write name='PatientCategoryAndPaymentModeBean' property='strRefundPaymentModeValues' filter='false'/>");
			sb.append("</select> </div>");
			sb.append("<div class='col-md-2'>");
			sb.append("<div class='checkbox'>");
			sb.append(" <label><input type='checkbox' value='' style='margin-top: 10px;'></label>");
			...
			sb.append("<button type='button' id='displaybtn' class='float-right btn btn-outline-danger mt-1 btn-circle1 cancelbtn remove' style='display: none;'><i class='fas fa-minus ' title='remove'></i> </button>");
			sb.append("</div></div></div>");
			sb.append("<div class='col-md-2' align='left'>");
			sb.append("<button type='button' id='addRefPayMode-row-0' onclick='addRefPayMode(this);' class=' btn btn-outline-success mt-1 btn-circle1' tabindex='2' style='background-color: #5cb85c;' > <i class='fas fa-plus ' title='add'></i>");
			sb.append("	</button></div> </div>"); */
			 
			wb = vo.getStrPayemtnModeMapping();
			if (wb.size() != 0) 
			{			
				...
				{				
				  	...
				  	/*for(int i=0;i<wb.getString(2).length();i++) {
						for(int j=0;j<wb.getString(3).length();j++) {*/
							
							/*if(temp==(wb.getString(2))){*/
								
							/*	sb.append('<div class='row' id='mapping-row-1'>");
								sb.append("<div class='col-sm-1'></div>");
								sb.append("<div class='col-md-3' id='recPayMode-row-1'>");
								sb.append("</div>");
								sb.append("<div class='col-md-2'></div>");
								sb.append("<div class='col-md-4' id='refPayMode-row-1'>");
								sb.append("<div class='row'>");
								sb.append("<div class='col-sm-8'>");
								sb.append("<select class='form-control' name='strRefundPaymentMode'>");
								vo.setStrPaymentModeSelected(wb.getString(3));
								String payModeValues= vo.getStrRecieptPaymentModeValues();
								sb.append(payModeValues);
								sb.append("</select>");
								sb.append("</div>");
								sb.append("<div class='col-md-2'>");
								sb.append("<div class='checkbox'> <label><input type='checkbox' value='' style='margin-top: 10px;'></label></div></div>");
								sb.append("<div class='col-sm-2'>");
								sb.append("<button type='button' class='float-right btn btn-outline-danger mt-1 btn-circle1 cancelbtn remove' style='display: none;'><i class='fas fa-minus ' title='remove'></i> </button>");
								sb.append("</div></div></div>");
											
								sb.append("<div class='col-md-2' align='left'>");
								sb.append("<button type='button' id='addRefPayMode-row-1' onclick='addRefPayMode(this);' class=' btn btn-outline-success mt-1 btn-circle1' tabindex='2' style='background-color: #5cb85c;' > <i class='fas fa-plus' title='add'></i>");
								sb.append("	</button></div></div>");
							}else {
								*/
					int i=1;
								if(!temp.equals(wb.getString(2)))
								{
									temp=wb.getString(2);
									sb.append("<div class='row' id='mapping-row-"+i+"'>");
									sb.append("<div class='col-sm-1'></div>");
									sb.append("<div class='col-md-3' id='recPayMode-row-"+i+"'>");
									sb.append("<select class='form-control' name='strRecieptPaymentMode'>");
									vo.setStrPaymentModeSelected(wb.getString(2));
									String payModeValues= vo.getStrRecieptPaymentModeValues();
									sb.append(payModeValues);
									sb.append("</select>");
									sb.append("</div>");
									sb.append("<div class='col-md-2'><div class='checkbox'><label><input type='checkbox' value='' style='margin-top: 10px;'></label></div></div>");
									sb.append("<div class='col-md-4' id='refPayMode-row-"+i+"'>");
									sb.append("<div class='row'>");
									sb.append("<div class='col-sm-8'>");	
									sb.append("<select class='form-control' name='strRefundPaymentMode'>");
									vo.setStrPaymentModeSelected(wb.getString(3));
									 payModeValues= vo.getStrRecieptPaymentModeValues();
									sb.append(payModeValues);
									sb.append("</select>");
									sb.append("</div>");
									sb.append("<div class='col-md-2'>");
								...
								sb.append("<div class='checkbox'> <label><input type='checkbox' value='' style='margin-top: 10px;'></label></div></div>");
								sb.append("<div class='col-sm-2'>");
								sb.append("<button type='button' class='float-right btn btn-outline-danger mt-1 btn-circle1 cancelbtn remove'><i class='fas fa-minus ' title='remove'></i> </button>");
								sb.append("</div></div></div>");
