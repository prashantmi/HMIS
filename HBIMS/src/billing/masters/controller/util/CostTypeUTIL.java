...
public class CostTypeUTIL implements MasterInterface
{
...
public String[] getOrderBy()
	{
		String orderBy[] = { "1", "SBLSTR_COSTTYPE_NAME" };
		return orderBy;
	}
public String getMainQuery(String[] cmb)
	{
		...
		brMainQuery.append(billing.qryHandler_billing.getQuery(1, "select.costty.1"));
	...
	{
		String search_field[] = { "1", "SBLSTR_COSTTYPE_NAME" };
		return search_field;
	}
	public String[] getColumnHeader()
	{
		String col_header[] = { "Cost Type" };
		return col_header;
	}
	public String getViewQuery()
	{
		return billing.qryHandler_billing.getQuery(1, "select.costty.1");
	}
...
*/
			br.append("<a class='btn btn-sm btn-primary' title='Select A Record To Generate Reports'  border=0  tabindex='1' onKeyPress='report(\"REPORT\");'  onClick='report(\"REPORT\");'>Report</a>");
