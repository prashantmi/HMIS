...
public class PayModeUTIL implements MasterInterface
{
	...
	{
		String masterName = "Payment Mode";
		return masterName;
	}
	...
	{
		String orderBy[] = { "1", "SBLSTR_PAYMENTMODE_NAME" };
		return orderBy;
	}
	public String getMainQuery(String[] cmb)
	{
		...
		brMainQuery.append(billing.qryHandler_billing.getQuery(1, "select.paym.1"));
	...
	{
		String search_field[] = { "1", "SBLSTR_PAYMENTMODE_NAME" };
		return search_field;
	}
	public String[] getColumnHeader()
	{
		String col_header[] = { "Payment Mode Name" };
		return col_header;
	}
	public String getViewQuery()
	{
		return billing.qryHandler_billing.getQuery(1, "select.paym.1");
	}
