...
public class ClientTypeUTIL implements MasterInterface
{
	...
	{
		String orderBy[] = { "1", "SBLSTR_CLIENT_TYPE_NAME" };
		return orderBy;
	}
	public String getMainQuery(String[] cmb)
	{
		...
		brMainQuery.append(billing.qryHandler_billing.getQuery(1, "select.clty.1"));
	...
	{
		String search_field[] = { "1", "SBLSTR_CLIENT_TYPE_NAME" };
		return search_field;
	}
	public String[] getColumnHeader()
	{
		String col_header[] = { "Client Type" };
		return col_header;
	}
	public String getViewQuery()
	{
		return billing.qryHandler_billing.getQuery(1, "select.clty.1");
	}
