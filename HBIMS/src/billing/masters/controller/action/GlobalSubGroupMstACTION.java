...
/* Global Sub Group Master ACTION
...
import billing.masters.controller.data.GlobalSubGroupMstDATA;
...
import billing.masters.controller.util.GlobalSubGroupMstUTIL;

public class GlobalSubGroupMstACTION extends GenericController
{

	String target = null;

	public GlobalSubGroupMstACTION()
	{

		super(new GlobalSubGroupMstUTIL(), "masters/CNTSubGroupMst");
			...
			throws Exception, SQLException
	{
		...
		target = "add";
		GlobalSubGroupMstDATA data = new GlobalSubGroupMstDATA();
		GlobalSubGroupMstFB fb = (GlobalSubGroupMstFB) form;
