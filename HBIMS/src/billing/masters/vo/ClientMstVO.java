...
public class ClientMstVO  {
	...
	private String strIsValid = null;
	...
	private String strMsgType="0";//0 no error..1 error..
	...
	public String getStrEffectiveDate() {
		if (this.strEffectiveDate == null) {
			HisUtil util = new HisUtil("ClientTypeMaster", "VOClientTypeMst");
			try {
