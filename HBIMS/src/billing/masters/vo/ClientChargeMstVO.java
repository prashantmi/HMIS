...
public class ClientChargeMstVO extends GenericFormBean {
	...
	public String getStrTempOrg() {
		return strTempOrg;
	}

	public void setStrTempOrg(String strTempOrg) {
		this.strTempOrg = strTempOrg;
	}
	...
	public String getStrEffectiveFrm() {
		if (this.strEffectiveFrm == null || this.strEffectiveFrm.equals("")) {
			...
			try {
				...
				new HisException("Billing", "VOChargeMst.getEffectiveFrm()-->",
						e.getMessage());
			}
		}
