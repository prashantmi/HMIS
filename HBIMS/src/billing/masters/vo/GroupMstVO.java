...
import hisglobal.utility.HisUtil;
	...
	public class GroupMstVO extends GenericFormBean {
		...
		private WebRowSet hospitalServiceCheckboxwb;
        private int[] hospitalServiceValues=null;
	...
	public int[] gethospitalServiceValues() {
		return hospitalServiceValues;
	}


	public void sethospitalServiceValues(int[] hospitalServiceValues) {
		this.hospitalServiceValues = hospitalServiceValues;
	}

	public WebRowSet getHospitalServiceCheckboxwb() {
		return hospitalServiceCheckboxwb;
	}


	public void setHospitalServiceCheckboxwb(WebRowSet hospitalServiceCheckboxwb) {
		this.hospitalServiceCheckboxwb = hospitalServiceCheckboxwb;
	}
