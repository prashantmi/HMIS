...
public class PackageServiceMstVO extends GenericFormBean {
	...
	private String strUnitCmb = "";
		...
		public String getStrCtDate() {
			HisUtil util = new HisUtil("Package Service Master", "VOpackservMst");
			try {
				strCtDate = util.getASDate("dd-MMM-yyyy");
				util = null;
			} catch (Exception e) {
				new HisException("Billing Module", "Package Service Master",
						"VOpackservMst.getStrCtDate()-->" + e.getMessage());
			}
			return strCtDate;
		}
