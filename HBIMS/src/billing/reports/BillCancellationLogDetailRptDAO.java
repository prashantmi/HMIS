...
public class BillCancellationLogDetailRptDAO {
	
	public static void getHospitalName(BillCancellationLogDetailRptVO voObj) {
	...
	public static void getFeeClerkName(BillCancellationLogDetailRptVO voObj)
	{
		HisDAO daoObj = null;
		WebRowSet ws = null;
