...
public class BillEnquiryRptBSDATA {
	public static void getBillTypeDtls(BillEnquiryRptFB formBean,HttpServletRequest request,
		...
		try {
			...
			util = new HisUtil("Billing Reports","BillEnquiryRptBSDATA");
			...
			e.printStackTrace();
			strmsgText = "billing.reports.BillEnquiryRptBSDATA.getDeptDetails --> "
					+ e.getMessage();
			HisException eObj = new HisException("billing",
					"BillEnquiryRptBSDATA->getDeptDetails()", strmsgText);
	...
	public static void getBillDetails(BillEnquiryRptFB formBean,HttpServletRequest request,
		...
		try {
			...
			String strPatView = PatientDtlHLPNew.compactPatientWithAdmissionDtl(strCrNo,
			...
			strBillDtls = BillEnquiryRptHLPNew.getBillDtls_BS(voObj);
			...
			if (msgStr.contains("CR.")) {
				...
				HisException eObj = new HisException("Billing",
						"BillEnquiryRptBSDATA->getBillDetails()", msgStr);
				formBean.setStrErrMsg("Application Error [ERROR ID : "
						+ eObj.getErrorID()
	...
	public static void showReport(BillEnquiryRptFB formBean,HttpServletRequest request, HttpServletResponse response) 
	{
			...
			{
				e.printStackTrace();
					strmsgText = "billing.reports.BillEnquiryRptBSDATA.showReport --> "+ e.getMessage();
			...
			HttpServletRequest request, HttpServletResponse response) 
	{
			...
			//	voObj.setSerialNo(formBean.getSerialNo());
				...
				reportContent= BillEnquiryRptHLPNew.getBillContent(voObj);
			...
			{
				e.printStackTrace();
					strmsgText = "billing.reports.BillEnquiryRptBSDATA.generateReport --> "+ e.getMessage();
	...
	public static void returnHTML(BillEnquiryRptFB formBean,HttpServletRequest request, HttpServletResponse response) 
	{
				...
				try 
				{
						...
						BillEnquiryRptHLPNew.getBillHTML_BS(voObj);
						
						strBillDtls = BillEnquiryRptHLPNew.getBillHTML_BS(voObj);
				...
				{
					e.printStackTrace();
					strmsgText = "billing.reports.BillEnquiryRptBSDATA.returnHTML --> "+ e.getMessage();
					HisException eObj = new HisException("billing","BillEnquiryRpt->showReport()", strmsgText);
					formBean.setStrErrMsg("Application Error [ERROR ID : "+ eObj.getErrorID() + "],Contact System Administrator! ");
