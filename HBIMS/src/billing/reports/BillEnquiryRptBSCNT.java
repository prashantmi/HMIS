...
public class BillEnquiryRptBSCNT extends CSRFGardTokenAction{
			...
			throws HisException, SQLException 
   {
		...
		BillEnquiryRptBSDATA.getBillTypeDtls(formBean,request,response);
			...
			throws HisException, SQLException 
   {
		...
		BillEnquiryRptFB formBean = (BillEnquiryRptFB) form;
		formBean.setStrHospitalCode(request.getSession().getAttribute("HOSPITAL_CODE").toString());
		BillEnquiryRptBSDATA.getBillDetails(formBean,request,response);
			...
			throws HisException, SQLException 
	{
		BillEnquiryRptFB formBean = (BillEnquiryRptFB) form;
		formBean.setStrHospitalCode(request.getSession().getAttribute("HOSPITAL_CODE").toString());
		BillEnquiryRptBSDATA.showReport(formBean, request, response);
	}
	public ActionForward GENERATEREPORT(ActionMapping mapping, ActionForm form,
		...
		BillEnquiryRptFB formBean = (BillEnquiryRptFB) form;
		formBean.setStrHospitalCode(request.getSession().getAttribute("HOSPITAL_CODE").toString());
		BillEnquiryRptBSDATA.generateReport(formBean, request, response);
			...
			throws HisException, SQLException 
   {
			...
			throws HisException, SQLException 
	{
		BillEnquiryRptFB formBean = (BillEnquiryRptFB) form;
		formBean.setStrHospitalCode(request.getSession().getAttribute("HOSPITAL_CODE").toString());
		BillEnquiryRptBSDATA.returnHTML(formBean, request, response);
	...
	public ActionForward SHOWCONSOLIDATEDCREDITREPORT(ActionMapping mapping, ActionForm form,HttpServletRequest request, HttpServletResponse response) throws HisException, SQLException 
	{
		BillEnquiryRptFB formBean = (BillEnquiryRptFB) form;
		formBean.setStrHospitalCode(request.getSession().getAttribute("HOSPITAL_CODE").toString());
		BillEnquiryRptBSDATA.showConsolidatedCreditReport(formBean, request, response);		
		return null;		
	}
}
