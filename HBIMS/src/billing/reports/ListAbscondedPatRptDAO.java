...
public class ListAbscondedPatRptDAO {

	public static void getDepartmentList(ListAbscondedPatRptVO voObj) {
		...
		try {
			...
			voObj
					.setStrMsgString("ListAbscondedPatRptDAO.getDepartmentList() --> "
							+ e.getMessage());
	...
	public static void getUnitList(ListAbscondedPatRptVO voObj) {
		...
		try {
			...
			voObj
					.setStrMsgString("ListAbscondedPatRptDAO.getUnitList() --> "
							+ e.getMessage());
			voObj.setStrMsgType("1");
	...
	public static void getWardList(ListAbscondedPatRptVO voObj) {
		...
		try {
			...
			voObj
					.setStrMsgString("ListAbscondedPatRptDAO.getWardList() --> "
							+ e.getMessage());
			voObj.setStrMsgType("1");
