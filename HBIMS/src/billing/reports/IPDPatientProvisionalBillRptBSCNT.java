...
import hisglobal.presentation.CSRFGardTokenAction;
	...
	public class IPDPatientProvisionalBillRptBSCNT extends CSRFGardTokenAction {
				...
				throws HisException, SQLException 
	     {
			...
			public ActionForward SHOWRPT(ActionMapping mapping, ActionForm form,
					...
					throws HisException, SQLException 
		     {
				...
				{
					formBean.setStrCrNo("");
					formBean.setStrErrMsg("No Data Found/Account Not Opened/Patient Not Accepted in Ward/Final Bill Already Generated!");
					return mapping.findForward("reportPage");
				}
				else
				{
					if(formBean.getStrPatAcctStatus().equals("0"))
					{
						formBean.setStrCrNo("");
						formBean.setStrErrMsg("Final Bill Already Generated!.Please Refer Final Bill");
						return mapping.findForward("reportPage");
					}
					else
					{
