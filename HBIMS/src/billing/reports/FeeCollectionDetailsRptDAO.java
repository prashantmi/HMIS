...
public class FeeCollectionDetailsRptDAO {
	
	public static void getHospSerList(FeeCollectionDetailsRptVO voObj) {
		...
		try {
			...
			daoObj = new HisDAO("Billing Reports","FeeCollectionDetailsRptDAO");
			...
			voObj
					.setStrMsgString("FeeCollectionDetailsRptDAO.getHospSerList() --> "
							+ e.getMessage());
	...
	public static void getHospitalName(FeeCollectionDetailsRptVO voObj) {
		...
		try {
			...
			voObj
					.setStrMsgString("FeeCollectionDetailsRptDAO.getHospitalName() --> "
							+ e.getMessage());
			voObj.setStrMsgType("1");
	...
	public static void getCounterList(FeeCollectionDetailsRptVO voObj) {
	...
	public static void getClerkList(FeeCollectionDetailsRptVO voObj) {
		...
		try {
			...
			voObj
					.setStrMsgString("FeeCollectionDetailsRptDAO.getClerkList() --> "
							+ e.getMessage());
			voObj.setStrMsgType("1");
	...
	public static void getGroupList(FeeCollectionDetailsRptVO voObj) {
		...
		try {
			...
			voObj
					.setStrMsgString("FeeCollectionDetailsRptDAO.getGroupList() --> "
							+ e.getMessage());
			voObj.setStrMsgType("1");
	...
	public static void getTariffList(FeeCollectionDetailsRptVO voObj) {
		...
		try {
			...
			voObj
					.setStrMsgString("FeeCollectionDetailsRptDAO.getTariffList() --> "
							+ e.getMessage());
			voObj.setStrMsgType("1");
	...
	/******pending because there is no procedure for Tariff list******/
	public static void getTariffDetailsCombo(FeeCollectionDetailsRptVO voObj) {
		...
		try {
			...
			voObj
					.setStrMsgString("FeeCollectionDetailsRptDAO.getTariffDetailsCombo() --> "
							+ e.getMessage());
			voObj.setStrMsgType("1");
	...
	public static void getDeptList(FeeCollectionDetailsRptVO voObj) {
		...
		try {
			...
			voObj
					.setStrMsgString("FeeCollectionDetailsRptDAO.getDeptList() --> "
							+ e.getMessage());
			voObj.setStrMsgType("1");
