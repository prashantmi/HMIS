...
public class HLPParticularDtlBillApprovalNew
{
	 public static String getParticularDtlForBillApproval(String strAcctNo,int j,String strHospCode,String accType) 
	 {
		    ...
		    // boObj.getPartPaymentPendingReq(voObj);  
	           ...
	           sb.append("<thead>");
			   sb.append("<tr><th><font style='font-size: 14px;' size='2' face='Helvetica Neue, Helvetica, Arial, sans-serif' color='#000000'>SNo</font></th>");
			   sb.append("<th><font style='font-size: 14px;' size='2' face='Helvetica Neue, Helvetica, Arial, sans-serif' color='#000000'>Group Name</font></th>");
			   sb.append("<th><font style='font-size: 14px;' size='2' face='Helvetica Neue, Helvetica, Arial, sans-serif' color='#000000'>Calculated Amt(Rs)</font></th>");
			   sb.append("<th><font style='font-size: 14px;' size='2' face='Helvetica Neue, Helvetica, Arial, sans-serif' color='#000000'>Final Amt(Rs)</font></th>");
			   sb.append("<th><font style='font-size: 14px;' size='2' face='Helvetica Neue, Helvetica, Arial, sans-serif' color='#000000'>Details</th></font></tr></thead>");
			   sb.append("<tbody>");
				...
				//	double balanceAmt = Double.parseDouble(strTotalExpAmt) + Double.parseDouble(strTotalRecvdAmt);
					...
					System.out.println("trfamt"+trfamt+"strTotalRecvdAmt"+strTotalRecvdAmt+"strClientSancAmt"+strClientSancAmt+"balanceAmt"+balanceAmt);
						...
						for(int i=0;ws.next();i++)
	                    {
							...
							sb.append("<td><font style='font-size: 14px;' size='2' face='Helvetica Neue, Helvetica, Arial, sans-serif' color='#000000'>");
					 ...
					 /*   sb.append("<table class='TABLEWIDTH' align='center' border='0' cellspacing ='1px'>");
						...
						*/
		            	...
		            	sb4.append("<div class='col-sm-8' align='right'>");
		            	sb4.append("<label>Received Amt<i class='fas fa-rupee-sign'></i>(A):</label>");
		            	sb4.append("</div>");
						...
						sb.append("<input type='hidden' name='IpdThirdPartyBilling'  value='"+j+"'>");
						sb.append("<input type='hidden' name='hiddenString'  value=''>");
						sb.append("<label>Total Exp Amount:</label>");
					    sb.append("</div>");
					    sb.append("<div class='col-sm-3' align='center'>");
					    sb.append("<input name='strFinalCalAmt' id='strFinalCalAmt' type='hidden' class='txtFldNormal' value='"+strTotalExpAmt+"'   disabled='disabled'>");
						sb.append("<div id='strFinalCalAmtDivId'>"+strTotalExpAmt+"</div>");
					    sb.append("</div>");
					    sb.append("<div class='col-sm-3' align='center'>");
						...
						if(new BillConfigUtil(strHospCode).getIpdThirdPartyBilling().equals("1") && Double.parseDouble(strClientSancAmt) > 0)
			            {
						 /* sb4.append("<tr><td width='83%' class='LABEL'>Maximum Benefits from Client (<img src='../../hisglobal/images/INR.png'>)(B):</td>");
						  ...
						  sb4.append("</td></tr>");*/
							...
							sb4.append("<div class='row rowFlex reFlex'>");
							sb4.append("<div class='col-sm-8' align='right'>");
							sb4.append("<label>Maximum Benefits from Client <i class='fas fa-rupee-sign'></i>(B):</label>");
							sb4.append("</div>");
							sb4.append("<div class='col-sm-4' align='left'>");
						    sb4.append("<input name='strMaxBenifitAmt' id='strMaxBenifitAmt' type='hidden' class='txtFldNormal' value='"+strClientSancAmt+"' disabled='disabled'>");
							  sb4.append("<div id='strMaxBenifitAmtDivId'>"+strClientSancAmt+"</div>");
			            ...
			            */
					    ...
					    sb4.append("<div class='col-sm-8' align='right'>");
					    sb4.append("<label>Grand Total Exp Amount <i class='fas fa-rupee-sign'></i>(C):</label>");
					    sb4.append("</div>");
					    sb4.append("<div class='col-sm-4' align='left'>");
			            sb4.append("<div id='totalRecAmtDivId'>"+strTotalExpAmt+"</div><input type='hidden' name='totalRecAmtDivId1' id='totalRecAmtDivId1' value='"+strTotalExpAmt+"' >");
					    sb4.append("</div>");
					    sb4.append("</div>");
					    ...
					    sb4.append("<div class='col-sm-8' align='right'>");
					    sb4.append("<label>Discount Amt <i class='fas fa-rupee-sign'></i>(D):</label>");
					    sb4.append("</div>");
					    sb4.append("<div class='col-sm-4' align='left'>");
					    sb4.append("<input name='strTotalDisAmt' id='strTotalDisAmt' type='hidden' class='txtFldNormal' value='0.00' disabled='disabled'>");
						sb4.append("<div id='strTotalDisAmtDivId'>0.00<button type='button'  class='btn btn-info btninfo'  onClick='getDiscountDtlForBillApproval(this);'style='padding: .0545rem  .35rem;' data-toggle='modal' data-target='#tarffiModal'><i class='fas fa-plus'></i></button></div>");
					    ...
					    sb4.append("<div class='row rowFlex reFlex'>");
					    sb4.append("<div class='col-sm-8' align='right'>");
					    sb4.append("<label>Service Tax<i class='fas fa-rupee-sign'></i>:</label>");
					    sb4.append("</div>");
					    sb4.append("<div class='col-sm-4' align='left'>");
						...
						sb4.append("<div id='strTotalServiceTaxDivId'>"+strSeviceTax+"</div>");sb4.append("</div>");
					    sb4.append("</div>");
						...
						*/
						...
						if(strPrimaryCategory.equals(new BillConfigUtil(strHospCode).getIpdFreeCategory()))
						{
							...
							sb4.append("</td></tr>");*/
							    ...
							    sb4.append("</div>");
							    sb4.append("<div class='col-sm-6' align='right'>");
							    sb4.append("<label>Poor Free Welfare:</label>");
							    sb4.append("</div>");
							    ...
							    sb4.append("</div>");
							    sb4.append("<div class='col-sm-6' align='right'>");
							    sb4.append("<label>Poor Free grant:</label>");
							    sb4.append("</div>");
							    sb4.append("<div class='col-sm-3' align='left'>");
						...
						if(fltRoomLimitDiff>0)//Room Limit Total Difference Defined For Patient. Paid By Patient
						{
						    ...
						    sb4.append("</div>");
						    sb4.append("<div class='col-sm-6' align='right'>");
						    sb4.append("<label>Balance Room Rent Paid By Patient <i class='fas fa-rupee-sign'></i></label>");
						    sb4.append("</div>");
						    sb4.append("<div class='col-sm-3' align='left'>");
						...
						sb4.append("<div class='row rowFlex reFlex'>");
					    sb4.append("<div class='col-sm-8' align='right'>");
					    sb4.append("<label>Balance Amt <i class='fas fa-rupee-sign'></i></label>");
					    sb4.append("</div>");
					    sb4.append("<div class='col-sm-4' align='left'>");
