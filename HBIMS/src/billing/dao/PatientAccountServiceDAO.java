...
*/
public final class PatientAccountServiceDAO {
	...
	private final String strProcName = "pkg_bill_dml.dml_hblt_pataccount_service";
	private final String strFileName = "billing.dao.PatientAccountServiceDAO";
...
//			System.out.println("strRefRecieptNo->"+strRefRecieptNo);
			...
			dao.setProcInValue(nInsertedIndex,"hblnum_is_package",strIsPackage,39);//voObj.getStrPackageId() in Case Of Advance Raising
			...
			dao.setProcInValue(nInsertedIndex, "ip",stripadd,57);
			dao.setProcInValue(nInsertedIndex, "mac",strmacadd,58);
			//keep in batch
