...
public WebRowSet getChargeTypeDtl(ChargeMstVO vo,  boolean orderBy) throws Exception {
	...
	this.qryStr = billing.qryHandler_billing.getQuery(1,"gbl.chargetype.0").replace("?",hospCode);
    ...
    */
public WebRowSet getClientChargeTypeDtl(ClientChargeMstVO vo,  boolean orderBy) throws Exception {
    //System.out.println("in dao billing combo--");
	HisDAO daoObj = null;
	WebRowSet ws = null;
	String tempStr = "";			
