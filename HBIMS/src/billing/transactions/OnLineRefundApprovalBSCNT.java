...
public class OnLineRefundApprovalBSCNT extends CSRFGardTokenAction 
{
	/**
	 * unspecified
	 * @param mapping
...
//		formBean.setStrIpAddr(request.getSession().getAttribute("IP_ADDR").toString());
		...
		OnLineRefundApprovalBSDATA.getOnLineRefundApprovalDtls(formBean,request);     
//		if(retValue)
//		{	
//			return this.init(mapping, form, request, response);
//		}
	...
	{		
		...
		boolean retValue = false;	
	   	retValue = OnLineRefundApprovalBSDATA.SAVE(fb, request);
			...
			throws Exception
	{
		...
		OnLineRefundApprovalFB formBean = (OnLineRefundApprovalFB) form;
		OnLineRefundApprovalBSDATA.SEARCH(request,response,formBean);
		return null;
	}
			...
			throws Exception
	{
		...
		OnLineRefundApprovalFB formBean = (OnLineRefundApprovalFB) form;
		OnLineRefundApprovalBSDATA.GO(request,response,formBean);
		return null;
	}
