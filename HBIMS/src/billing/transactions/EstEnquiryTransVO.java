...
public class EstEnquiryTransVO implements TransferObject {
	...
	private WebRowSet wsServiceTypeList;
	
	private WebRowSet wsBillServiceList;
	

	

	public WebRowSet getWsBillServiceList() {
		return wsBillServiceList;
	}

	public void setWsBillServiceList(WebRowSet wsBillServiceList) {
		this.wsBillServiceList = wsBillServiceList;
	}

	public WebRowSet getWsServiceTypeList() {
		return wsServiceTypeList;
	}

	public void setWsServiceTypeList(WebRowSet wsServiceTypeList) {
		this.wsServiceTypeList = wsServiceTypeList;
	}
