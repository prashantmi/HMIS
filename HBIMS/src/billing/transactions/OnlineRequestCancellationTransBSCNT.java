 ...
 *         to DATA File.
 */
public class OnlineRequestCancellationTransBSCNT extends CSRFGardTokenAction {
	...
	public ActionForward GO(ActionMapping mapping, ActionForm form,
		...
		OnlineRequestCancellationTransBSDATA.onlineRequestDetails(formBean);
		OnlineRequestCancellationTransBSDATA.cancelledByCmb(formBean);
		OnlineRequestCancellationTransBSDATA.cancelReasonCmb(formBean);
	...
	public ActionForward GETPOPUP(ActionMapping mapping, ActionForm form,
			...
			throws Exception, SQLException {
		OnlineRequestCancellationTransFB formBean = (OnlineRequestCancellationTransFB) form;
		OnlineRequestCancellationTransBSDATA
	...
	public ActionForward GETPOPUPDATA(ActionMapping mapping, ActionForm form,
			...
			throws Exception, SQLException {
		OnlineRequestCancellationTransFB formBean = (OnlineRequestCancellationTransFB) form;
		OnlineRequestCancellationTransBSDATA.getPopUpData(request, response,
				formBean);
		return null;
	}
	...
	//	OnlineRequestCancellationTransFB formBean = (OnlineRequestCancellationTransFB) form;
		OnlineRequestCancellationTransBSDATA.insertData(form, request, response);
		//OnlineRequestCancellationTransBSDATA.onlineRequestDetails(formBean);
		//OnlineRequestCancellationTransBSDATA.cancelledByCmb(formBean);
		//OnlineRequestCancellationTransBSDATA.cancelReasonCmb(formBean);
