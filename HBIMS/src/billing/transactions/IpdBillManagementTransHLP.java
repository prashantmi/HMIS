...
public class IpdBillManagementTransHLP {
...
public static String getAllTrfListJSON(IpdBillManagementTransVO voObj)
{
	...
	sb.append("<tr> ");
	sb.append("<td class='multiLabel' width='2%'>#</td> ");
	sb.append("<td class='multiLabel' width='12%'>Group Name</td> ");
	sb.append("<td class='multiLabel' width='3%'>E/N</td> ");		
	sb.append("<td class='multiLabel' width='10%'>Chg Code</td> ");
	sb.append("<td class='multiLabel' width='18%'>Tariff Name</td> ");
	sb.append("<td class='multiLabel' width='10%'>Chg Qty.</td> ");
	sb.append("<td class='multiLabel' width='10%'>Rate(Rs.)</td> ");
	...
	sb.append("<td class='multiLabel' width='7%'>Chg Amt.(Rs)</td> ");
...
public static String getTrfDtlsByCode(IpdBillManagementTransVO voObj) throws Exception 
{
	...
	{	
		while(ws.next())
		{
			...
			if(ws1Arr[1].equals("107"))
				...
				strTrfCode=strTrfNameWithCode[1].replace("(","").replace(")", "").trim() ;
			...
			*/
			...
			sb.append("<td class='trfTd' width='12%'><input type='text' tabindex='1' name='groupName' id='groupName"+idx+"' onkeypress='moveUpDown(event,this,"+idx+")' onkeyup=\"deleteRow(event,this,"+idx+",'"+trId+"')\" onkeydown=\"checkFirstKey(event)\" class='editor-texts' value='"+strGroupName+"' readonly></td> ");
			sb.append("<td class='trfTd' width='3%'><select name='strPriority'   tabindex='1' id='strPriority"+idx+"' onkeyup=\"moveUpDown(event,this,"+idx+");deleteRow(event,this,"+idx+",'"+trId+"')\" onkeydown=\"checkFirstKey(event)\" class='editor-texts' onchange='calcOffLineTariffNetAmountNew(this,"+idx+");'><option value='1'>N</option><option value='2'>E</option></select></td> ");			
			sb.append("<td class='trfTd' width='10%'><input type='text' tabindex='1' name='trfCode'   id='trfCode"+idx+"'   onkeypress='return validateData(event,8);' onkeyup=\"getTariffByCodeNew(this , event,"+idx+");moveUpDown(event,this,"+idx+");deleteRow(event,this,"+idx+",'"+trId+"')\" onkeydown=\"checkFirstKey(event)\" class='editor-texts' value='"+strTrfCode+"'></td> ");
			if(strUndefined.equals("1"))
				sb.append("<td class='trfTd' width='18%'><input type='text' tabindex='1' name='strOfflineTariffName'   id='strOfflineTariffName"+idx+"'   onkeypress='moveUpDown(event,this,"+idx+")' onkeyup=\"deleteRow(event,this,"+idx+",'"+trId+"')\" onkeydown=\"checkFirstKey(event)\" class='editor-texts' value='"+strTrfName+"'></td> ");
			else
				sb.append("<td class='trfTd' width='18%'><input type='text' tabindex='1' name='strOfflineTariffName'   id='strOfflineTariffName"+idx+"'   onkeypress='moveUpDown(event,this,"+idx+")' onkeyup=\"deleteRow(event,this,"+idx+",'"+trId+"')\" onkeydown=\"checkFirstKey(event)\" class='editor-texts' value='"+strTrfName+"' readonly></td> ");
			sb.append("<td class='trfTd' width='10%'><input type='text' tabindex='1' name='strOfflineTariffQty' 	id='strOfflineTariffQty"+idx+"' maxlength='3' onkeypress='return validateData(event,5);'  onkeyup=\"moveUpDown(event,this,"+idx+");deleteRow(event,this,"+idx+",'"+trId+"');calcOffLineTariffNetAmountNew(this,"+idx+");\" onkeydown=\"checkFirstKey(event)\" class='editor-texts' value='1' autocomplete='off'></td> ");
			if(strUndefined.equals("1"))
			sb.append("<td class='trfTd' width='10%'><input type='text' tabindex='1' name='strOfflineTariffRateUnit'  maxlength='7' id='strOfflineTariffRateUnit"+idx+"' onkeypress='return validateData(event,5);'  onkeyup=\"moveUpDown(event,this,"+idx+");deleteRow(event,this,"+idx+",'"+trId+"');calcOffLineTariffNetAmountNew(this,"+idx+");\" onkeydown=\"checkFirstKey(event)\" class='editor-texts' value='"+strRate+"' autocomplete='off' ></td> ");
			else
				sb.append("<td class='trfTd' width='10%'><input type='text' tabindex='1' name='strOfflineTariffRateUnit'  maxlength='7' id='strOfflineTariffRateUnit"+idx+"' onkeypress='return validateData(event,5);'  onkeyup=\"moveUpDown(event,this,"+idx+");deleteRow(event,this,"+idx+",'"+trId+"');calcOffLineTariffNetAmountNew(this,"+idx+");\" onkeydown=\"checkFirstKey(event)\" class='editor-texts' value='"+strRate+"' autocomplete='off' readonly></td> ");	
			sb.append("<td class='trfTd' width='4%'><input type='text' tabindex='1' name='strDiscount' id='strDiscount"+idx+"' maxlength='5' class='editor-texts' value='0.00' onkeypress='return validateData(event,7);' onkeyup=\"moveUpDown(event,this,"+idx+");deleteRow(event,this,"+idx+",'"+trId+"');onEntDiscount("+idx+");\" onblur=\"calActualDisAmt("+idx+");\" onkeydown=\"checkFirstKey(event)\" autocomplete='off'/></td>");
			sb.append("<td class='trfTd' width='4%'><select tabindex='1' name='strDiscountType' id='strDiscountType"+idx+"' onkeyup=\"moveUpDown(event,this,"+idx+");deleteRow(event,this,"+idx+",'"+trId+"')\" onkeydown=\"checkFirstKey(event)\" onchange='onEntDiscount("+idx+");' value='1' class='editor-texts'><option value='1'>Fix</option><option value='2'>%</option></select></td>");
			sb.append("<td class='trfTd' width='3%'><input type='text' tabindex='1' name='strDiscountAmt' id='strDiscountAmt"+idx+"' value='0.00' onkeyup=\"moveUpDown(event,this,"+idx+");deleteRow(event,this,"+idx+",'"+trId+"')\" onkeydown=\"checkFirstKey(event)\" class='editor-texts' readonly/></td>");
				
			sb.append("<td class='trfTd' width='7%'><input type='text' tabindex='1' name='strOfflineTariffNetAmount' id='strOfflineTariffNetAmount"+idx+"'  onkeypress='moveUpDown(event,this,"+idx+")' onkeyup=\"deleteRow(event,this,"+idx+",'"+trId+"')\" onkeydown=\"checkFirstKey(event)\" class='editor-texts' value='"+netAmt+"' readonly></td> ");
			sb.append("<td class='trfTd' width='10%'>");
			sb.append("<input type='text' name='trfDateDD' maxlength='2'  tabindex='1' id='trfDateDD"+idx+"'   onkeypress='return validateData(event,5);' onkeyup=\"moveUpDown(event,this,"+idx+");deleteRow(event,this,"+idx+",'"+trId+"')\" onkeydown=\"checkFirstKey(event)\" class='editor-textsmall' value='"+date[0]+"' autocomplete='off'>-");
			sb.append("<input type='text' name='trfDateMM' maxlength='2'  tabindex='1' id='trfDateMM"+idx+"'   onkeypress='return validateData(event,5);' onkeyup=\"moveUpDown(event,this,"+idx+");deleteRow(event,this,"+idx+",'"+trId+"')\" onkeydown=\"checkFirstKey(event)\" class='editor-textsmall' value='"+date[1]+"' autocomplete='off'>-");
			sb.append("<input type='text' name='trfDateYYYY' maxlength='4' tabindex='1' id='trfDateYYYY"+idx+"' onkeypress='return validateData(event,5);' onkeyup=\"moveUpDown(event,this,"+idx+");deleteRow(event,this,"+idx+",'"+trId+"')\" onkeydown=\"checkFirstKey(event)\" class='editor-textsmallYr' value='"+date[2]+"' autocomplete='off'></td>");
			sb.append("<td class='trfTd' width='5%'><input type='text'  tabindex='1' name='servType'      id='servType"+idx+"'  onkeyup=\"moveUpDown(event,this,"+idx+");deleteRow(event,this,"+idx+",'"+trId+"')\" onkeydown=\"checkFirstKey(event)\" class='editor-texts' value='Offline' readonly></td>");
			sb.append("<td class='trfTd' width='2%'><img style='cursor: hand; cursor: pointer' tabindex='1' src='../../hisglobal/images/minus.gif' name='tariffMinus' onclick=\"deleteRowClick(this,"+idx+",'"+trId+"')\">");
	...
	public static String getPrevBedTransfer(IpdBillManagementTransVO voObj) throws Exception 
	{
		...
		{	
			...
			sb.append("<table width='95%' align='center' cellpadding='0' cellspacing ='0'> ");
			sb.append("<tr> ");
			sb.append("<td class='multiLabel' width='5%'>Mov No</td> ");
			sb.append("<td class='multiLabel' width='15%'>Department</td> ");
			sb.append("<td class='multiLabel' width='12%'>Unit</td> ");		
			sb.append("<td class='multiLabel' width='15%'>Ward</td> ");
			//sb.append("<td class='multiLabel' width='12%'>Room</td> ");
			//sb.append("<td class='multiLabel' width='12%'>Bed</td> ");
			sb.append("<td class='multiLabel' width='12%'>Consultant</td> ");
			sb.append("<td class='multiLabel' width='12%'>In Date</td> ");
			sb.append("<td class='multiLabel' width='12%'>Out date</td> ");		
			sb.append("<td class='multiLabel' width='5%'>Type</td> ");
			sb.append("</tr> ");
			sb.append("</table> ");
			sb.append("<div>");
			sb.append("<table width='95%' align='center' cellpadding='0' cellspacing ='0' id='TABLEBEDTRANSFERHLP'> ");
			sb.append("<tr> ");
			while(ws.next())
			{
					int idx=index++;
					...
					sb.append("<tr id='"+trId+"' clas='style_x'> ");
					sb.append("<td class='trfTd' width='5%'><input type='text'  tabindex='1' name='strMovNo'   id='strMovNo"+idx+"'  onkeypress='moveUpDown(event,this,"+idx+")' onkeyup=\"deleteRow1(event,this,"+idx+",'"+trId+"')\" onkeydown=\"checkFirstKey(event)\" class='editor-texts' value='"+ ++sl +"' readonly></td> ");
					sb.append("<td class='trfTd' width='15%'><input type='text' tabindex='1' name='deptName'   id='deptName"+idx+"'  onkeypress='moveUpDown(event,this,"+idx+")' onkeyup=\"deleteRow1(event,this,"+idx+",'"+trId+"')\" onkeydown=\"checkFirstKey(event)\" class='editor-texts' value='"+ws.getString(3)+"' readonly></td> ");
					sb.append("<td class='trfTd' width='12%'><input type='text' tabindex='1' name='unitName'   id='unitName"+idx+"'  onkeypress='moveUpDown(event,this,"+idx+")' onkeyup=\"deleteRow1(event,this,"+idx+",'"+trId+"')\" onkeydown=\"checkFirstKey(event)\" class='editor-texts' value='"+ws.getString(5)+"' readonly></td>  ");			
					sb.append("<td class='trfTd' width='15%'><input type='text' tabindex='1' name='wardName'   id='wardName"+idx+"'  onkeypress='moveUpDown(event,this,"+idx+")' onkeyup=\"deleteRow1(event,this,"+idx+",'"+trId+"')\" onkeydown=\"checkFirstKey(event)\" class='editor-texts' value='"+ws.getString(7)+"' readonly></td> ");
					...
					sb.append("<td class='trfTd' width='12%'><input type='text' tabindex='1' name='docName'    id='docName"+idx+"'   onkeypress='moveUpDown(event,this,"+idx+")' onkeyup=\"deleteRow1(event,this,"+idx+",'"+trId+"')\" onkeydown=\"checkFirstKey(event)\" class='editor-texts' value='"+ws.getString(18)+"' readonly></td> ");
					sb.append("<td class='trfTd' width='12%'><input type='text' tabindex='1' name='strInDate'  id='strInDate"+idx+"' onkeypress='moveUpDown(event,this,"+idx+")' onkeyup=\"deleteRow1(event,this,"+idx+",'"+trId+"')\" onkeydown=\"checkFirstKey(event)\" class='editor-texts' value='"+ws.getString(12)+"' readonly></td> ");
					sb.append("<td class='trfTd' width='12%'><input type='text' tabindex='1' name='strOutDate' id='strOutDate"+idx+"' onkeypress='moveUpDown(event,this,"+idx+")' onkeyup=\"deleteRow1(event,this,"+idx+",'"+trId+"')\" onkeydown=\"checkFirstKey(event)\" class='editor-texts' value='"+ws.getString(13)+"' readonly></td>");
					sb.append("<td class='trfTd' width='5%'><input type='text'  tabindex='1' name='trfType'    id='trfType"+idx+"' 	 onkeypress='moveUpDown(event,this,"+idx+")' onkeyup=\"deleteRow1(event,this,"+idx+",'"+trId+"')\" onkeydown=\"checkFirstKey(event)\" class='editor-texts' value='"+ws.getString(14)+"' readonly/>");
	...
	public static String admissionList(IpdBillManagementTransVO vo)
	 {
	      ...
	      {       
			 ...
			 {
				 new HisException("Billing","IpdBillManagementTransHLP.admissionList()-->",e.getMessage());
		     }
