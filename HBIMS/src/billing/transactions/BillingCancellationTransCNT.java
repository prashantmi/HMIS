 ...
 * 
 */
public class BillingCancellationTransCNT extends CSRFGardTokenAction {
	...
	public ActionForward init(ActionMapping mapping, ActionForm form,
		...
		BillingCancellationTransDATA.cancelledByCmb(formBean);
		BillingCancellationTransDATA.cancelReasonCmb(formBean);
		return mapping.findForward(strTarget);
	}
	...
	public ActionForward GO(ActionMapping mapping, ActionForm form,
		...
		formBean.setStrHospitalCode(request.getSession().getAttribute("HOSPITAL_CODE").toString());
		 formBean.setStrSeatId(request.getSession().getAttribute("SEATID")
					.toString());
		BillingCancellationTransDATA.billDetails(formBean);
		BillingCancellationTransDATA.cancelledByCmb(formBean);
		BillingCancellationTransDATA.cancelReasonCmb(formBean);
	...
	public ActionForward GOCRBILL(ActionMapping mapping, ActionForm form,
		...
		BillingCancellationTransDATA.CrbillDetails(formBean);
		BillingCancellationTransDATA.cancelledByCmb(formBean);
		BillingCancellationTransDATA.cancelReasonCmb(formBean);
	...
	public ActionForward GETPOPUP(ActionMapping mapping, ActionForm form,
		...
		BillingCancellationTransFB formBean = (BillingCancellationTransFB) form;
		formBean.setStrHospitalCode(request.getSession().getAttribute("HOSPITAL_CODE").toString());
		BillingCancellationTransDATA.getPopUp(request, response, formBean);
		return null;
	}
	...
	public ActionForward GETPOPUPDATA(ActionMapping mapping, ActionForm form,
		...
		BillingCancellationTransFB formBean = (BillingCancellationTransFB) form;
		formBean.setStrHospitalCode(request.getSession().getAttribute("HOSPITAL_CODE").toString());
		BillingCancellationTransDATA.getPopUpData(request, response, formBean);
		return null;
	}
	...
	//	String strTarget = "index";
		...
		BillingCancellationTransDATA.insertData(form, request, response);
	...
	public ActionForward TrfDtl(ActionMapping mapping, ActionForm form,HttpServletRequest request, HttpServletResponse response) 
	{
		...
		String sid = "";
		formBean.setStrHospitalCode(request.getSession().getAttribute("HOSPITAL_CODE").toString());
		sid = BillingCancellationTransDATA.TariffDtl(formBean, request);
		...
		{
			new HisException("Billing","BillingCancellationTransCNT","BillingCancellationTransCNT.TrfDtl()-->" + e.getMessage());
		}
		return null;
	}
}
