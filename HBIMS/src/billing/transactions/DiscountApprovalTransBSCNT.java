...
public class DiscountApprovalTransBSCNT extends CSRFGardTokenAction {
	public String bsid = "";

	public DiscountApprovalTransBSCNT() {
	}
	...
	public ActionForward GO(ActionMapping mapping, ActionForm form,
		...
		if (strChk != null) {
			DiscountApprovalTransBSDATA.initOnlineReq(strChk, formBean);
			DiscountApprovalTransBSDATA.getRsnRmk(formBean);
	...
	public ActionForward BId(ActionMapping mapping, ActionForm form,
		...
		formBean.setStrHospitalCode(request.getSession().getAttribute(
				"HOSPITAL_CODE").toString());
		String sid = DiscountApprovalTransBSDATA.AjaxResponse(formBean, request,
				response);
	...
	public ActionForward PopUp(ActionMapping mapping, ActionForm form,
			...
			throws HisException, Exception, SQLException {
		DiscountApprovalTransFB formbean = (DiscountApprovalTransFB) form;
		DiscountApprovalTransBSDATA.PopUpResponse(formbean, request, response);
		return null;
	}
	...
	public ActionForward INSERT(ActionMapping mapping, ActionForm form,
		...
		DiscountApprovalTransFB formbean = (DiscountApprovalTransFB) form;
		retValue = DiscountApprovalTransBSDATA.getInsertData(formbean, request); // defined
																				// in
																				// DATA
																				// class
