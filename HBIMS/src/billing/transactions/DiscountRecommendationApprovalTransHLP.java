...
public class DiscountRecommendationApprovalTransHLP {

	public static String getTariffDetails(WebRowSet wb,DiscountRecommendationApprovalTransVO vo) throws Exception 
	{
...
//				System.out.println("Net Cost--->"+wb.getString(27));
		...
		*/		
		...
		sBuffer
		.append("<td width='10%' class='multiControl'><a style='color:blue;cursor:pointer;cursor:hand' onclick='showBalanceLimitDtlsPopup(this, \""+discDtls+"\");'>");
sBuffer
		.append(strTemp[4]);
sBuffer
		.append("</a></td>");
	...
	public static String getIPDBillSetlmnt(WebRowSet wb,DiscountRecommendationApprovalTransVO vo) 
	{
     	StringBuffer sBuffer = new StringBuffer("");
...
//			System.out.println("Net Cost--27->"+wb.getString(27));
	 ...
	 catch (Exception e) 
	 {
			...
			new HisException("Discount Approval Trans",
					"DiscountRecommendationApprovalTransHLP.getIPDBillSetlmnt()-->", e
							.getMessage());
	 }
...
///////////////////////////////Hlp for popup///////////////////////////////////	
	...
	public static String getPopUpDtl(WebRowSet ws)
	{
		...
		catch (Exception e) 
		{
			...
			new HisException("Discount Approval Trans",
					"DiscountRecommendationApprovalTrans.getPopUpDtl()-->", e.getMessage());
		}
		ws = null;
		return sb.toString();
		}
