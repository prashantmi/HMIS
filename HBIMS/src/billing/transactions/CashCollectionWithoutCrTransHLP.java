...
public class CashCollectionWithoutCrTransHLP {

	private static final String strColor = "red";
	private static final String defaultColor = "blue";

	public static String getWithoutCrNoOnLineTariffDetailsView(CashCollectionWithoutCrTransVO voObj) {
	 ...
	 * @throws Exception
	 */
	public static String getTariffDetails(CashCollectionWithoutCrTransVO voObj)
			throws Exception {
	 ...
	 */
	public static String getPopUp(CashCollectionWithoutCrTransVO voObj) {
		StringBuffer sb = new StringBuffer("");
	...
	public static String getRefundTariffPopUp(CashCollectionWithoutCrTransVO voObj) {
		StringBuffer sb = new StringBuffer("");
	...
	public static String getGuarantorDetails(CashCollectionWithoutCrTransVO voObj) {
...
sb.append("</tr>");
	...
	public static String getBillListingView(CashCollectionWithoutCrTransVO voObj) {
