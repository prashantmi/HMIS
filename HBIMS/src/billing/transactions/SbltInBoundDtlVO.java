...
public class SbltInBoundDtlVO 
{
	private WebRowSet strSbltInBoundDtlWs = null;
	...
	public String getStrEntryDate() 
     {
		...
		try {
			...
			new HisException("IpdBillManagementTrans",
					"SbltInBoundDtlVO.getStrEntrDate()", e.getMessage());
		}
	   return strEntryDate;
	}
    
    
	public WebRowSet getStrSbltInBoundDtlWs() {
		return strSbltInBoundDtlWs;
	}
	public void setStrSbltInBoundDtlWs(WebRowSet strSbltInBoundDtlWs) {
		this.strSbltInBoundDtlWs = strSbltInBoundDtlWs;
	}
