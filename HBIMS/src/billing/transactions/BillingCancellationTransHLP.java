 ...
 * 
 */
public class BillingCancellationTransHLP {
	...
	public static String billDetails(BillingCancellationTransVO vo) 
	{
		...
		try {
			...
			br.append("<td colspan='7'>Receipt Details </td>");
			...
			br
			.append("<td class='multiLabel' WIDTH='12%' align='CENTER'>User</td>");
			br.append("</tr>");

			if(wb.size()==0)
			{
				br.append("<tr>");
				br.append("<td colspan='7' class='multiControl' >"
...

			{
				...
				String loginUser=vo.getStrSeatId();
				String billingUser=wb.getString(7);
				br.append("<tr>");
				if(loginUser.equals(billingUser)) {
				br.append("<td WIDTH='2%' class='multiLabel' >"
						+ "<input type='checkbox' name='chk' id='chk" + i
						+ "' " + "value='" + wb.getString(6) + "' ></td>");
				...
				br.append(" <input type='hidden' name='flag' id='flag" + i
						+ "' value=" + "0" + " >");
				//added by vipul on 29.05.2021 to fetch seat id
				br.append(" <input type='hidden' name='billSeat' id='billSeat" + i
						+ "' value=" +wb.getString(7) + " >");
				...
				br.append("<TD WIDTH='12%' CLASS='multiControl' >"
					...
					br.append("<td WIDTH='2%' class='multiLabel' >"
						+ "<input type='checkbox' name='chk' id='chk" + i
						+ "' " + "value='" + wb.getString(6) + "' disabled='chk"+i+"'></td>");

				br
						.append("<TD  WIDTH='12%' CLASS='multiControl' > <a STYLE='cursor:pointer;cursor:hand;color:red'  onClick='showPopUp(this,\""
								+ i + "\");'>" + wb.getString(1) + "</a>");
				...
				br.append(" <input type='hidden' name='billSeat' id='billSeat" + i
						+ "' value=" +wb.getString(7) + " >");
				br.append("</TD><TD WIDTH='12%' CLASS='multiControl' style='color:red;'>"
						+ wb.getString(2) + "</TD>");

				br.append("<TD WIDTH='13%' CLASS='multiControl' style='color:red;' >"
						+ wb.getString(3) + "</TD>");

				br.append("<TD WIDTH='12%' CLASS='multiControl' style='color:red;' >"
						+ wb.getString(4) + "</TD>");
			...
			br.append(" <input type='hidden' name='userSeat' id='userSeat' value=" +vo.getStrSeatId() + " >");
			br.append("</table>");
