...
public class CreditLetterHandlingDATA {
	...
	public static boolean init(HttpServletRequest request, CreditLetterHandlingFB formBean)
	{
		...
		//	formBean.setCreditLetterList(CreditLetterHandlingHlp.getCreditLetterList(voObj));
			...
			CreditLetterHandlingDATA.initOffLineDetails(formBean, bo, voObj);
		...
		catch (Exception e)
		{
			...
			{
				HisException eObj = new HisException("Billing", "CreditLetterHandlingDATA->init()", msgStr);
				formBean.setStrErrMsg("Application Error [ERROR ID : " + eObj.getErrorID() + "], Contact System Administrator! ");
				formBean.setStrCrNo("");
				eObj = null;
			}
	...
	public static boolean initAdvancedCash(HttpServletRequest request, CreditLetterHandlingFB formBean)
	{
		...
		try
		{
			...
			CreditLetterHandlingDATA.initAdvancedOffLineDetails(formBean, bo, voObj);
	...
	public static void updatePrintStatus(HttpServletRequest request, HttpServletResponse response)
	{
		...
		} catch (Exception e)
		{
			...
			HisException eObj = new HisException("Billing", "CreditLetterHandlingDATA->updatePrintStatus()", e
					.getMessage());
			String response1 = "ERROR####Application Error [ERROR ID : " + eObj.getErrorID() + "], Contact System Administrator!";
			...
			} catch (IOException e1)
			{
				...
				new HisException("Billing", "CreditLetterHandlingDATA->updatePrintStatus()", e1.getMessage());
			}
	...
	public static void rePrint(HttpServletRequest request, HttpServletResponse response)
	{
		...
		} catch (Exception e)
		{
			...
			HisException eObj = new HisException("Billing", "CreditLetterHandlingDATA->rePrint()", e.getMessage());
			String response1 = "ERROR####Application Error [ERROR ID : " + eObj.getErrorID() + "], Contact System Administrator!";
			...
			} catch (IOException e1)
			{
				...
				new HisException("Billing", "CreditLetterHandlingDATA->rePrint()", e1.getMessage());
			}
	...
	public static boolean insertOfflineEstimation(CreditLetterHandlingFB formBean, HttpServletRequest request)
	{
		...
		{
			String err = e.getMessage();
			HisException eObj = new HisException("Billing Transaction","CreditLetterHandlingDATA.insertOfflineReceiptService()-->", err);
			formBean.setStrErrMsg("Application Error [ERROR ID : " + eObj.getErrorID() + "],Contact System Administrator! ");
			eObj = null;
		} 
		finally
	...
	public static boolean insertOfflineReceiptPackage(CreditLetterHandlingFB formBean,HttpServletRequest request)
	{
		...
		} catch (Exception e)
		{
			...
			HisException eObj = new HisException("Billing Transaction",
					"CreditLetterHandlingDATA.insertOfflineReceiptPackage()-->", e.getMessage());
	...
	public static void setPackageAmountValues( CreditLetterHandlingFB formBean, HttpServletRequest request,
		...
		try {
			...
			String strmsgText = e.getMessage();
			HisException eObj = new HisException("Billing Transaction",
					"CreditLetterHandlingDATA->setPackageAmountValues()", strmsgText);
	...
	/*public static void getCreditList( CreditLetterHandlingFB formBean, HttpServletRequest request)
	{
		...
		try{
			HisUtil util = new HisUtil("BILLING","CreditLetterHandlingDATA");
		...
		//	response.getWriter().print(temp);
			...
			String strmsgText = e.getMessage();
			HisException eObj = new HisException("Billing Transaction",
					"CreditLetterHandlingDATA->getCreditList()", strmsgText);
			formBean.setStrErrMsg("Application Error [ERROR ID : "
					+ eObj.getErrorID() + "], Contact System Administrator! ");
			eObj = null;
		}
	...
	public static void saveCreditLetter(CreditLetterHandlingFB formBean,HttpServletRequest req,HttpServletResponse res)
	{
		...
		catch (Exception e) 
		{
			//e.printStackTrace();
			String strmsgText = e.getMessage();
			HisException eObj = new HisException("Billing Transaction","CreditLetterHandlingDATA->saveCreditLetter()", strmsgText);
			formBean.setStrErrMsg("Application Error [ERROR ID : "+ eObj.getErrorID() + "], Contact System Administrator! ");
			eObj = null;
		}
	}
	public static void removeCreditLetter(CreditLetterHandlingFB formBean,HttpServletRequest req,HttpServletResponse res)
	{
		...
		catch (Exception e) 
		{
			//e.printStackTrace();
			String strmsgText = e.getMessage();
			HisException eObj = new HisException("Billing Transaction","CreditLetterHandlingDATA->removeCreditLetter()", strmsgText);
			formBean.setStrErrMsg("Application Error [ERROR ID : "+ eObj.getErrorID() + "], Contact System Administrator! ");
			eObj = null;
		}
	}
	public static void expireCreditLetter(CreditLetterHandlingFB formBean,HttpServletRequest req,HttpServletResponse res)
	{
		...
		catch (Exception e) 
		{
			//e.printStackTrace();
			String strmsgText = e.getMessage();
			HisException eObj = new HisException("Billing Transaction","CreditLetterHandlingDATA->expireCreditLetter()", strmsgText);
			formBean.setStrErrMsg("Application Error [ERROR ID : "+ eObj.getErrorID() + "], Contact System Administrator! ");
			eObj = null;
		}
	}
	public static void modifyCreditLetter(CreditLetterHandlingFB formBean,HttpServletRequest req,HttpServletResponse res)
	{
		...
		catch (Exception e) 
		{
			//e.printStackTrace();
			String strmsgText = e.getMessage();
			HisException eObj = new HisException("Billing Transaction","CreditLetterHandlingDATA->modifyCreditLetter()", strmsgText);
			formBean.setStrErrMsg("Application Error [ERROR ID : "+ eObj.getErrorID() + "], Contact System Administrator! ");
			eObj = null;
		}
	}
