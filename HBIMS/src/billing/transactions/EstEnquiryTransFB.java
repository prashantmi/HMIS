...
public class EstEnquiryTransFB extends ActionForm {
	...
	private String strServiceTypeDetails;
	...
	{
		lhm.put("Cash Collection Online", "ONLINE");
		lhm.put("Cash Collection Offline", "OFFLINE");
	...
	public String getStrServiceTypeDetails() {
		return strServiceTypeDetails;
	}
	public void setStrServiceTypeDetails(String strServiceTypeDetails) {
		this.strServiceTypeDetails = strServiceTypeDetails;
	}
