...
public class CreditLetterHandlingBSCNT extends CSRFGardTokenAction{
	...
	public ActionForward unspecified(ActionMapping mapping, ActionForm form,HttpServletRequest request, HttpServletResponse response) throws HisException {
		...
		{
			strCounterId =CreditLetterHandlingBSDATA.checkCounterStatus(request, formBean);
	...
	public ActionForward OFFLINEMODE(ActionMapping mapping, ActionForm form,HttpServletRequest request, HttpServletResponse response) throws HisException 
	{
		...
		CreditLetterHandlingBSDATA.preInitOffLineDetails(formBean );//Populates Hospital Service Combo and Request Type Combo Only
	...
	public ActionForward GO(ActionMapping mapping, ActionForm form,HttpServletRequest request, HttpServletResponse response) throws HisException, SQLException 
	{
		...
		boolean bResult = CreditLetterHandlingBSDATA.init(request, formBean);
		if (bResult) 
		{
	...
	public ActionForward BILLDTLS(ActionMapping mapping, ActionForm form,
		...
		CreditLetterHandlingBSDATA.getBillServiceDetails(request, response);
	...
	public ActionForward EPISODEDTLS(ActionMapping mapping, ActionForm form,
		...
		CreditLetterHandlingBSDATA.getEpisodeDetails(request, response);
	...
	public ActionForward PKGGROUPDTLS(ActionMapping mapping, ActionForm form,
		...
		CreditLetterHandlingBSDATA.getGroupDetails(request, response);
	...
	public ActionForward PARTACCAMT(ActionMapping mapping, ActionForm form,
		...
		CreditLetterHandlingBSDATA.getPartPaymentOrAccountDtls(request, response);
	...
	public ActionForward TRFUNIT(ActionMapping mapping, ActionForm form,
		...
		CreditLetterHandlingBSDATA.getOffLineTariffUnitDetails(request, response);
	...
	public ActionForward UNITVAL12(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response)
			throws Exception {
		CreditLetterHandlingBSDATA.UNITVAL12(request, response);
	...
	public ActionForward FETCHBILLLISTING(ActionMapping mapping,
		...
		CreditLetterHandlingFB formBean = (CreditLetterHandlingFB) form;
		CreditLetterHandlingBSDATA.getBillListingDtls(request, response, formBean);
	...
	public ActionForward OFFLINETREATCATDTL(ActionMapping mapping,
		...
		CreditLetterHandlingBSDATA.getOfflineTreatmentCategoryDtls(request, response);
	...
	public ActionForward OFFLINEDEPTDTL(ActionMapping mapping,
		...
		CreditLetterHandlingBSDATA.getOfflineRaisingDetapartmentDtls(request, response);
	...
	public ActionForward OFFLINEWARDDTL(ActionMapping mapping,
		...
		CreditLetterHandlingBSDATA.getOfflineWardDtls(request, response);
	...
	public ActionForward OFFLINESPLWARDDTL(ActionMapping mapping,
		...
		CreditLetterHandlingBSDATA.getOfflineSpecialWardDtls(request, response);
	...
	public ActionForward PACKAGEAMOUNT(ActionMapping _Mapping, ActionForm _Form,
		...
		CreditLetterHandlingBSDATA.setPackageAmountValues(formBean, _Request, _Response);
		return null;
	}
	/*public ActionForward GETCREDITLIST(ActionMapping _Mapping, ActionForm _Form,
			HttpServletRequest _Request, HttpServletResponse _Response){
		CreditLetterHandlingFB formBean = (CreditLetterHandlingFB) _Form;
		CreditLetterHandlingBSDATA.getCreditList(formBean, _Request);
		return null;
	}*/
	...
	{
		CreditLetterHandlingFB formBean = (CreditLetterHandlingFB) form;
		CreditLetterHandlingBSDATA.saveCreditLetter(formBean,request, response);
		String target = "cashcollection";
		return mapping.findForward(target);
	}
	...
	{
		CreditLetterHandlingFB formBean = (CreditLetterHandlingFB) form;
		CreditLetterHandlingBSDATA.removeCreditLetter(formBean,request, response);
		String target = "cashcollection";
		return mapping.findForward(target);
	}
	...
	{
		CreditLetterHandlingFB formBean = (CreditLetterHandlingFB) form;
		CreditLetterHandlingBSDATA.expireCreditLetter(formBean,request, response);
		String target = "cashcollection";
		return mapping.findForward(target);
	}
	...
	{
		CreditLetterHandlingFB formBean = (CreditLetterHandlingFB) form;
		CreditLetterHandlingBSDATA.modifyCreditLetter(formBean,request, response);
		String target = "cashcollection";
		return mapping.findForward(target);
	}
}