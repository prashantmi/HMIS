...
public class CreditLetterHandlingHlp {
...
*/
	...
	public static String getCreditLetterList(CreditHandlingLetterVO vo) throws Exception 
	{
		...
		try 
		{
			...
			sb.append("<h3><font color='#357EC7'>Credit Letter List</font></h3>");
			sb.append("</div>");
			sb.append("<div class='col-md-6'>");
			sb.append("</div>");
			sb.append("<div class='col-md-3'>");
			sb.append("<h3><font color='#357EC7'>Add Letter</font><img onkeypress='onPressingEnter(this,event)' id='addCreditLetter"+j+"' style='cursor: pointer;' onclick='addNewLetter(this)' src='../../hisglobal/images/plus.gif'></h3>");
			sb.append("</div></div>");
			...
			sb.append("<tr>");
			sb.append("<th>Letter No.</th>");
			sb.append("<th>Letter Date</th>");
			sb.append("<th>Organisation/Client</th>");
			sb.append("<th>Sanctioned Limit</th>");
			sb.append("<th>Balance Limit</th>");			
		    sb.append("<th>Remove/Delete Letter</th>");
		    sb.append("<th>Expire Letter</th>");
			sb.append("</tr>");
			sb.append("</thead>");
			...
			while(ws.next())
			{
			    ...
			    sb.append("<tr>");
			    if(useflag.equals("0"))
			    	sb.append("<td class='creditData' id='letterno"+j+"'><font color='red'>"+ref_no+"</font></b></td>");
			    else
			    	sb.append("<td class='creditData' id='letterno"+j+"'>"+ref_no+"</b></td>");
				sb.append("<td class='creditData'>"+date+"</td>");
				sb.append("<td class='creditData'>"+company_name+"</td>");
				if(useflag.equals("0"))
					sb.append("<td class='creditData' id='clt"+j+"'>"+sanctioned_amount+"</td>");
				else
					sb.append("<td class='creditData' id='clt"+j+"'>"+sanctioned_amount+"&nbsp;&nbsp;&nbsp;&nbsp;<img onkeypress='onPressingEnter(this,event)' id='modifyLimit"+j+"' style='cursor: pointer;width:2vw;height:2vw;' onclick='modifyLimit("+j+")' src='../../hisglobal/images/modify.jpeg'></td>");
				sb.append("<td class='creditData'>"+Amount+"</td>");
				sb.append("<td class='creditData'><img onkeypress='onPressingEnter(this,event)' id='removeCreditLetter"+j+"' style='cursor: pointer;' onclick='removeCreditLetter("+j+")' src='../../hisglobal/images/minus.gif'></td>");
				sb.append("<td class='creditData'><img onkeypress='onPressingEnter(this,event)' id='expireCreditLetter"+j+"' style='cursor: pointer;width:2vw;height:2vw;' onclick='expireCreditLetter("+j+")' src='../../hisglobal/images/expire_new.png'></td>");
			...
			//	sb.append("<tr></tr>"); //to maintain strips
				...
				sb.append("<tr style='display:none;'><td><input type='hidden' name='useflag' id='useflag"+j+"' value="+useflag+"></td></tr>");
