...
public class BillDupPrintTransHLP {
...
//  TO DISPLAY BILL DETAILS BY CR No.
	public static String getBillListingView1(BillDupPrintTransVO voObj) 
	{
		...
		try 
		{
			...
			//	System.out.println("bill re print--wb size--"+ws.size());
				...
				/*	sb.append("<table width='100%'align='center' cellspacing='1px'>");
					...
					sb.append(" <input type='hidden' name='noOfRows' id='noOfRows' value="+ ws.size() + " >");
					if (start != 1) 
					{
						sb.append("<a onClick='fetchBillList(\""+ previous + "\",\"" + (actualBlockSet - 1)
								+ "\");'> &lt;&lt; Previous</a> &nbsp;");
					}
					for (int i = 1; i <= totalLayer; i++) 
					{
						sb.append("<a onClick='layerIndexNavigator(\""	+ i + "\",\"" + totalLayer + "\")'>"
								   + (i + start - 1) + "</a> &nbsp;");
					}

					if (next > 0)
						sb.append("<a onClick='fetchBillList(\""
			...
			sb.append("<tr><td class='TITLE'>Receipt Details </td>");
			sb.append("</tr>");
			sb.append("<tr>");
			sb.append("<td class='LABEL'>&nbsp;");
		...
		//	e.printStackTrace();
			new HisException("Global Patient Listing",
					"billing.BillDupPrintTransHLP.getPatientListingView()-->", e
							.getMessage());
		}
	...
	public static String getBillListingView2(BillDupPrintTransVO voObj) {
		...
		try {
			...
			sb.append("</table>");
				...
				sb.append("<td width='15%'class='multiLabel'>Bill No.");
				sb.append("</td>");
				sb.append("<td width='15%'class='multiLabel'>Bill Date");
				sb.append("</td>");
				sb.append("</td>");
				sb
	...
	public static String patientDtlBillDetail(WebRowSet ws,String strBillNo,String hospCode) throws Exception
	{
		 StringBuffer sb = new StringBuffer("");
		 BillConfigUtil billConfig = new BillConfigUtil(hospCode);
	   try
	   {
		
		// WebRowSet ws = voObj.getBillDetails();
		  ...
		  if (ws != null) 
		   {
				...
				if (ws.next())
				{
					...
					String strRePrintChg     = billConfig.getGeneralDuplicatePrintCharge();
					...
					String strAmount 		 = ws.getString(13);
					String[] strUserDetail	 =	 ws.getString(14).split("#");	
					String strUserId		 = strUserDetail[0];
					String strUserName		 = strUserDetail[1];	
					...
					sb.append("</td>");
					sb.append("<td width='25%' class='LABEL'>Duplicate-Print Charges</td>");
					sb.append("<td width='25%' class='CONTROL'>");
					sb.append(strRePrintChg);
					sb.append("</td></tr>");
					sb.append("<tr><td width='25%' class='LABEL'>Bill Generated User ID</td>");
					sb.append("<td width='25%' class='CONTROL'>");
					sb.append(strUserId);
					sb.append("</td>");
					sb.append("<td width='25%' class='LABEL'>Bill Generated User Name</td>");
					sb.append("<td width='25%' class='CONTROL'>");
					sb.append(strUserName);
					sb.append("</td></tr>");
					sb.append("<tr><td width='25%' class='LABEL'>Amount</td>");
	   ...
	   catch(Exception e)
	   {
		   ...
		   new HisException("Global Patient Listing",
					"billing.BillDupPrintTransHLP.patientDtlBillDetail()-->", e
							.getMessage());
	...
	public static String patientDtlBillDetail(WebRowSet ws,String strBillNo,String strRcptNo,String hospCode) throws Exception
	{
		 StringBuffer sb = new StringBuffer("");
    	  ...
    	  if (ws != null) 
		   {
    		  ...
    		  billConfig = new BillConfigUtil(hospCode); 
			...
			if (ws.next())
				{
					...
					String[] strUserDetail	 =	 ws.getString(16).split("#");	
					String temp_wallet 		 = ws.getString(17);
					String strUserId		 = strUserDetail[0];
					String strUserName		 = strUserDetail[1];	
					...
					sb.append("<td   width='25%' class='CONTROL'>");
					sb.append(strRePrintChg);
					sb.append("</td><td width='25%' class='LABEL'>Amount</td>");
					sb.append("<td width='25%' class='CONTROL'>");
					sb.append(HisUtil.getAmountWithDecimal(strAmount, 2));
					sb.append("</td></tr>");
					...
					sb.append("<input type='hidden' name='temp_wallet' value='"+temp_wallet+"'>");
	...
	public static String getTariffDetails(WebRowSet ws)throws Exception
	{
		...
		try
		{
			...
			sb.append("<tr><td colspan='4'  class='TITLE'>Tariff Details</td></tr>");
			sb.append("<tr><td width='55%'class='multiLabel'>Tariff Name</td>");
			sb.append("<td width='15%'class='multiLabel'>Quantity</td>");
			sb.append("<td width='15%'class='multiLabel'>Rate (<img src='/HBIMS/hisglobal/images/INR.png'>)</td>");
			sb.append("<td width='15%'class='multiLabel'>Amount(<img src='/HBIMS/hisglobal/images/INR.png'>)</td>");
			sb.append("</tr>");
			sb.append("</table>");
			...
			if(ws!= null && ws.size() > 0)
			{
				...
				{
					sb.append("<tr>");
					sb.append("<td width='55%'class='multiControl'>").append(ws.getString(1));
					sb.append("</td>");
					sb.append("<td width='15%'class='multiControl'>").append(ws.getString(2));
					sb.append("</td>");
					sb.append("<td width='15%'class='multiControl'>").append(ws.getString(3));
					sb.append("</td>");
					sb.append("<td width='15%'class='multiControl'>").append(HisUtil.getAmountWithDecimal(ws.getString(7), 2));
					sb.append("</td>");
					sb.append("</tr>");
				}
				sb.append("</table>");				
			...
			else
			{
				sb.append("<table class='TABLEWIDTH' align='center' cellspacing='1px'>");
				sb.append("<tr>");
				sb.append("<td width='55%'class='multiControl'><font color='red' weight='bold'>No Tariff(s) Available");
				sb.append("</td>");
				sb.append("</tr>");
				sb.append("</table>");
			}
