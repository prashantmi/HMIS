...
public class IpdBillManagementTransDATA {
	/**
	...
	public static boolean initPatientDtl(HttpServletRequest request,
		...
		try {
			...
			formBean.setFinalBillFlag(vo.getFinalBillFlag());
			...
			strPatView = PatientDtlHLP.compactPatientWithAdmissionDtl(formBean.getStrCrNo(), vo.getStrHospitalCode(), false);
			...
			HisException eObj = new HisException("Billing",
					"IpdBillManagementTransDATA->initPatientDtl()", msgStr);
	...
	public static boolean billApprovalDtl(HttpServletRequest request,
		...
		if(strMode.equals("2")){
			...
			strParticulaDtl = HLPParticularDtlBillApproval.getParticularDtlForBillApproval(strTemp[0], i, vo.getStrHospitalCode(),formBean.getAccType());
			...
			{
				String strPoorFreeDetails=IpdBillManagementTransHLP.getPoorFreeTarrif(formBean);
		...
		catch (Exception e) 
		{
			bretVal = false;
			msgStr = e.getMessage();
			HisException eObj = new HisException("Billing","IpdBillManagementTransDATA->billApprovalDtl()", msgStr);
	...
	public static boolean initPatientDtl1(HttpServletRequest request,
		...
		try {
			...
			formBean.setStrCtDate(hisutil.getASDate("dd-MMM-yyyy"));
			formBean.setStrParticulaDtl(IpdBillManagementTransHLP.getViewBillParticularsList(formBean));
			...
			strClientAcctDtlHlp = HLPAccountDtl.getAccountDetailsHLP1(
			...
			else
			{
				...
				formBean.setStrCtDate(hisutil.getASDate("dd-MMM-yyyy"));
				formBean.setStrParticulaDtl(IpdBillManagementTransHLP
			...
			msgStr = e.getMessage();
			HisException eObj = new HisException("Billing",
					"IpdBillManagementTransDATA->initPatientDtl1()", msgStr);
			formBean.setStrErrMsg("ERROR####Application Error [ERROR ID : "
					+ eObj.getErrorID() + "], Contact System Administrator! ");
			formBean.setStrMsgType("1");
			eObj = null;
	...
	public static boolean initClientApprovalDtl(HttpServletRequest request,
		...
		try {
			...
			// Get Client Detail
			String strPatView = "";
			strPatView = PatientDtlHLP.compactPatientWithAdmissionDtl(formBean
			...
			msgStr = e.getMessage();
			HisException eObj = new HisException("Billing",
					"IpdBillManagementTransDATA->initClientApprovalDtl()",
					msgStr);
	...
	public static void initAddServicesDtl(HttpServletRequest request,HttpServletResponse response, IpdBillManagementTransFB formBean , String strMode) 
	{
		...
		try {
			...
			*/
			...
			formBean.setStrCtDate(hisutil.getASDate("dd-MMM-yyyy"));
			String sb=IpdBillManagementTransHLP.getViewBillParticularsList(formBean);
			
			bo.getAllTrfList(vo);
			String JSONObj=IpdBillManagementTransHLP.getAllTrfListJSON(vo);
		...
		{
			HisException eObj = new HisException("Billing","IpdBillManagementTransDATA->initClientApprovalDtl()",e.getMessage());
	...
	public static boolean PatientDtl(HttpServletRequest request,
		...
		try {
			...
			msgStr = e.getMessage();
			HisException eObj = new HisException("Billing",
					"IpdBillManagementTransDATA->PatientDtl()", msgStr);
			formBean.setStrErrMsg("Application Error [ERROR ID : "
					+ eObj.getErrorID() + "], Contact System Administrator! ");
			formBean.setStrMsgType("1");
			eObj = null;
	...
	public static boolean initDtl(IpdBillManagementTransFB formBean) {
		...
		try {
			...
			msgStr = e.getMessage();
			HisException eObj = new HisException("Billing",
					"IpdBillManagementTransDATA->initDtl()", msgStr);
			formBean.setStrErrMsg("ERROR####Application Error [ERROR ID : "
					+ eObj.getErrorID() + "], Contact System Administrator! ");
			formBean.setStrMsgType("1");
			eObj = null;
	...
	public static void ComboGroup(IpdBillManagementTransFB formBean) {
		...
		try {
			...
			msgStr = e.getMessage();
			HisException eObj = new HisException("Billing",
					"IpdBillManagementTransDATA->ComboGroup()", msgStr);
			formBean.setStrErrMsg("ERROR####Application Error [ERROR ID : "
					+ eObj.getErrorID() + "], Contact System Administrator! ");
			formBean.setStrMsgType("1");
			eObj = null;
	...
	public static void ComboValue(String strChk,
		...
		try {
			...
			msgStr = e.getMessage();
			HisException eObj = new HisException("Billing",
					"IpdBillManagementTransDATA->ComboValue()", msgStr);
			formBean.setStrErrMsg("ERROR####Application Error [ERROR ID : "
					+ eObj.getErrorID() + "], Contact System Administrator! ");
			formBean.setStrMsgType("1");
			eObj = null;
	...
	public static void getSpecialWardDtls(HttpServletRequest request,HttpServletResponse response) 
	{
		...
		catch (Exception e) 
		{
			...
			try 
			{
				HisException eObj = new HisException("Billing","IpdBillManagementTransDATA->getSpecialWardDtls()",strmsgText);
			...
			{
				new HisException("Billing","IpdBillManagementTransDATA->getSpecialWardDtls()", e1.getMessage());
			}
		}
	}	
	...
	{		
		...
		try 
		{
			...
			String temp = IpdBillManagementTransHLP.getPreviousDtlsView(voObj.getStrPreviousDtls());
	...
	public static void deletePreviousDtls(HttpServletRequest request,
		...
		try {
			...
			new HisException("Billing",
					"IpdBillManagementTransDATA->getSpecialWardDtls()",
					e.getMessage());
	...
	public static boolean InsertAddService(HttpServletRequest request,HttpServletResponse response, IpdBillManagementTransFB formBean) 
	{
		...
		{			
			...
			HisException eObj = new HisException("Billing","IpdBillManagementTransDATA->InserAddService()", strmsgText);
	...
	public static void InsertBillApproval(HttpServletRequest request,
		...
		{
			strmsgText = e.getMessage();
			HisException eObj = new HisException("Billing","IpdBillManagementTransDATA->InserBillApproval()",strmsgText);
			formBean.setStrErrMsg("Application Error [ERROR ID : "+ eObj.getErrorID() + "], Contact System Administrator! ");
			formBean.setStrMsgType("1");
			eObj = null;
		} 
	...
	public static boolean InsertRecordPartPayment( HttpServletRequest request , 
		...
		vo.setStrTreatmentCategory(formBean.getStrNewTreatmentCategory());
			...
			HisException eObj = new HisException("Billing",
					"IpdBillManagementTransDATA->InserRecordForPartPayment()",
					strmsgText);
			formBean.setStrErrMsg("ERROR####Application Error [ERROR ID : "
					+ eObj.getErrorID() + "], Contact System Administrator! ");
			formBean.setStrMsgType("1");
	...
	public static void UNITVAL(HttpServletRequest request,
		...
		try {
			...
			if (vo.getStrMsgType().equals("0")) {
				...
				HisException eObj = new HisException("Billing",
						"IpdBillManagementTransDATA->UNITVAL()", vo
								.getStrMsgString());
			...
			strmsgText = e.getMessage();
			HisException eObj = new HisException("Billing",
					"IpdBillManagementTransDATA->UNITVAL()", strmsgText);
			formBean.setStrErrMsg("ERROR####Application Error [ERROR ID : "
					+ eObj.getErrorID() + "], Contact System Administrator! ");
			formBean.setStrMsgType("1");
			eObj = null;
	...
	public static void UNITVAL1(HttpServletRequest request,
		...
		try {
			...
			// HisException eObj = new HisException("Billing",
			// "IpdBillManagementTransDATA->UNITVAL1()", strmsgText);
			// response.setHeader("Cache-Control", "no-cache");
			...
			if (vo.getStrMsgType().equals("0")) {
				...
				HisException eObj = new HisException("Billing",
						"IpdBillManagementTransDATA->UNITVAL1()", vo
								.getStrMsgString());
				String str = "ERROR####Application Error [ERROR ID : "
						+ eObj.getErrorID()
						+ "], Contact System Administrator! ";
	...
	public static void UNITVAL13(HttpServletRequest request,HttpServletResponse response) 
	{
		...
		try 
		{
			...
			data = strData.split("\\^");
			strTariffDtl1 = HLPGrpDtl.getProcessUnProcessDtl(data[0], data[1],data[2], vo.getStrHospitalCode());
			String[] TestData = strTariffDtl1.split("\\####");
			response.setHeader("Cache-Control", "no-cache");
			if (TestData[0].equals("ERROR")) 
			{
		...
		catch (Exception e) 
		{
			...
			try 
			{
				HisException eObj = new HisException("Billing","IpdBillManagementTransDATA->UNITVAL13()", strmsgText);
				String response1 = "ERROR####Application Error [ERROR ID : "+ eObj.getErrorID()+ "], Contact System Administrator!";
				response.getWriter().print(response1);
				eObj = null;
			} 
	...
	public static void FUNCVIEW(HttpServletRequest request,
		...
		try {
			...
			try {
				HisException eObj = new HisException("Billing",
						"IpdBillManagementTransDATA->FUNCVIEW()", strmsgText);
				String response1 = "ERROR####Application Error [ERROR ID : "
						+ eObj.getErrorID()
						+ "], Contact System Administrator!";
				response.getWriter().print(response1);
	...
	public static void TARIFFDTLS(HttpServletRequest request,
		...
		try {
			 ...
			 * HisException("Billing", "IpdBillManagementTransDATA->UNITVAL1()",
			...
			strmsgText = e.getMessage();
			HisException eObj = new HisException("Billing",
					"IpdBillManagementTransDATA->TARIFFDTLS()", strmsgText);
			formBean.setStrErrMsg("ERROR####Application Error [ERROR ID : "
					+ eObj.getErrorID() + "], Contact System Administrator! ");
			formBean.setStrMsgType("1");
			eObj = null;
	...
	public static void getDefaultTariffDetails(HttpServletRequest request,HttpServletResponse response) 
	{
		...
		//	String strWardType = request.getParameter("wardType");
			...
			String temp = IpdBillManagementTransHLP.getCompulsaryChargesView(voObj.getOfflineTariffList() , strStartDate , strEndDate , voObj );
			...
			temp = temp+"@@@@"+IpdBillManagementTransHLP.getSpecialChargesView(voObj.getOfflineTariffList() , strStartDate , strEndDate , voObj );
	...
	//	String strOfflineTarffList1 = "";
		...
		/*	if (vo.getOfflineTariffList() != null) {
			...
			strmsgText = e.getMessage();
			HisException eObj = new HisException("Billing",
					"IpdBillManagementTransDATA->DropTariffCombo()", strmsgText);
			formBean.setStrErrMsg("ERROR####Application Error [ERROR ID : "
					+ eObj.getErrorID() + "], Contact System Administrator! ");
			formBean.setStrMsgType("1");
			eObj = null;
	...
	public static void PartPaymentAmtCombo(HttpServletRequest request,
		...
		try {
			...
			try {
				...
				new HisException("Billing",
						"IpdBillManagementTransDATA->PartPaymentAmtCombo()", e1
								.getMessage());
			} finally {
	...
	public static void getParticularDtlsView(HttpServletRequest request,HttpServletResponse response, IpdBillManagementTransFB formBean) 
	{
		...
		catch (Exception e) 
		{
			...
			{
				new HisException("Billing","IpdBillManagementTransDATA->UNITVAL12()", strMsgText);
			}
		} 
		finally 
		{
	...
	public static void getTariffCodeDetailsNew(HttpServletRequest request,HttpServletResponse response) 
	{
		...
		try 
		{
			...
			String strTrfDtls=IpdBillManagementTransHLP.getTrfDtlsByCode(voObj);
		...
		catch (Exception e) 
		{
			...
			try 
			{
				HisException eObj = new HisException("Billing","IpdBillManagementTransDATA->getTariffCodeDetailsNew()",strmsgText);
				String response1 = "ERROR####Application Error [ERROR ID : "+ eObj.getErrorID()+ "], Contact System Administrator!";
				response.getWriter().print(response1);
				eObj = null;
			} 
			...
			{
				new HisException("Billing","IpdBillManagementTransDATA->getTariffCodeDetailsNew()", e1.getMessage());
			}
		} 
		finally 
		{
	...
	{ 
		...
		try 
		{
			...
			formBean.setStrTreatmentCategoryValues(strTreatmentCat);
			 ...
			 {		
				 ...
				 IpdBillManagementTransHLP.getPrevBedTransfer(vo);
				 if(formBean.getStrTempWardCode().trim().length() > 0)
				 vo.setStrWardType(formBean.getStrTempWardCode().replace("^", "#").split("#")[0]);		
			 ...
			 bo.getPrevBedTransfers(vo);
			 String strPrevBedTransfer=IpdBillManagementTransHLP.getPrevBedTransfer(vo);
		...
		{
			e.printStackTrace();
			HisException eObj = new HisException("Billing","IpdBillManagementTransDATA->initBedTransferDtl()",e.getMessage());
			formBean.setStrErrMsg("Application Error [ERROR ID : "+ eObj.getErrorID() + "], Contact System Administrator! ");
			formBean.setStrMsgType("1");
			eObj = null;
		} 
	...
	public static boolean InsertBedTransfer(HttpServletRequest request,HttpServletResponse response, IpdBillManagementTransFB formBean) 
	{
		...
		try 
		{
			...
			if (vo.getStrMsgType().equals("1")) 
			{
				if(vo.getStrMsgString().contains("Bed Charges Not Found"))
					formBean.setStrMsg("Bed Charges Not Defined!!");
				throw new Exception(vo.getStrMsgString());
			}
			if (fretValue) 
			{
		...
		{	
			if(!vo.getStrMsg().equals(""))
			{
				formBean.setStrErrMsg(vo.getStrMsg());
	...
	public static boolean admissionList(HttpServletRequest request,HttpServletResponse response, IpdBillManagementTransFB formBean) 
	{
		...
		try {
			...
			{
				bo.admissionList(vo);
				strAdmissionList = IpdBillManagementTransHLP.admissionList(vo);
