...
public class PatWalletTransVO implements TransferObject {
	...
	private String strAdvacnceAmount="0";
	...
	private String strCheckMobileNO = "";
	private String strMobileNo1="";
	
	public String getStrCheckMobileNO() {
		return strCheckMobileNO;
	}

	public void setStrCheckMobileNO(String strCheckMobileNO) {
		this.strCheckMobileNO = strCheckMobileNO;
	}
...
//	private String[] strRefundTariffDetails = null;
    ...
    private WebRowSet WsWalletAccountSummary=null;

	
	
	public WebRowSet getWsWalletAccountSummary() {
		return WsWalletAccountSummary;
	}

	public void setWsWalletAccountSummary(WebRowSet wsWalletAccountSummary) {
		WsWalletAccountSummary = wsWalletAccountSummary;
	}
