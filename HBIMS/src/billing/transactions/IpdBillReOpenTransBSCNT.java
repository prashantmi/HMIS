...
import hisglobal.presentation.CSRFGardTokenAction;
	...
	public class IpdBillReOpenTransBSCNT extends CSRFGardTokenAction {
		//public String bsid = "";
		...
		public ActionForward NODUESPRINT(ActionMapping mapping, ActionForm form,
	        ...
	        ActionForward acFwd = new ActionForward();
	          ...
	          acFwd.setPath("/billing/transactions/IpdBillManagementTransBSCNT.cnt?hmode=NODUESPRINT");
		...
		public ActionForward GO(ActionMapping mapping, ActionForm form,
			...
			IpdBillReOpenTransBSDATA.getCrNo(formBean,request);
			...
			return mapping.findForward("billreopen");	
			 ...
			 IpdBillReOpenTransBSDATA.getPatDtls(formBean,request);
			 IpdBillReOpenTransBSDATA.getBillDetails(formBean,request);
				...
				throws Exception, SQLException
		{
			...
			formBean.setStrHospitalCode(request.getSession().getAttribute("HOSPITAL_CODE").toString());
			formBean.setStrSeatId(request.getSession().getAttribute("SEATID").toString());
			retValue = IpdBillReOpenTransBSDATA.saveData(form,request, response);
			if(retValue)
			{	
				formBean.setStrRcptNo("");
				return mapping.findForward("billreopen");		
