...
public class DiscountRecommendationTransHLP {

	public static String getTariffDetails(WebRowSet wb,DiscountRecommendationTransVO vo) throws Exception 
	{
		...
		//	String app_id = "";
			...
			sBuffer
					.append("<td width='16%' class='multiLabel'><div align='center'>Test Name</div></td>");
			
			sBuffer
			.append("<td width='10%' class='multiLabel'><div align='center'>Discount Limit</div></td>");

			
			sBuffer
			.append("<td width='10%' class='multiLabel'><div align='center'>Free Limit</div></td>");
			...
			sBuffer
					.append("<td width='10%' class='multiLabel'><div align='center'>Req. Qty.</div></td>");
				sBuffer
...
//				System.out.println("app_id:::"+ApprovalId);
				...
				String discDtls = wb.getString(31);
				
				String strTemp[] = discDtls.replace("^", "#").split("#");
				
				
				double reqQtyVal = Double.parseDouble(strReqQty);
				double balQty = Double.parseDouble(strTemp[4]);
		...
		*/		
				...
				*/
				...
				sBuffer.append("<tr ><td width='5%' style='cursor:pointer;cursor:hand'  class='multiLabel'>" +
								...
								+ "' value='" + i + "^" +wb.getString(32) + "' onClick='new_dis_add(this,"+i+","+strTemp[5]+","+strTrfAmt+");'></td>");
				sBuffer
						.append("<td width='16%' class='multiControl' ");
				
				if(flag){
					sBuffer.append(" style='background-color: #ED6782' ");
				}
		...
		.append("<td width='10%' class='multiControl' ");
				...
				sBuffer
				.append("><a style='color:blue;cursor:pointer;cursor:hand' onclick='showBalanceLimitDtlsPopup(this, \""+discDtls+"\");'>");
sBuffer
		.append(strTemp[4]);
sBuffer
		.append("</a></td>");
		...
		sBuffer
				...
				sBuffer
						.append("<input type='textbox' class='txtFldMin' name='opd_discount' id='opd_discount"+i+"'value='0' " +
								...
								" onKeyUp='onEnterDiscount("+i+","+strTemp[5]+","+strTrfAmt+");'" + 
				...
				sBuffer.append("<select name='opd_discountType' id ='opd_discountType"+i+"'" +
							//	" onChange='clickCmb("+i+");'" + 
						" onChange='onEnterDiscount("+i+","+strTemp[5]+","+strTrfAmt+");'" + 
								" disabled='disabled'>" +
		...
		{
		    throw new Exception("DiscountRecommendationApprovalTransHLP.getTariffDetails()-->"+ e.getMessage());
		}
		
		return sBuffer.toString();
	}

	public static String getIPDBillSetlmnt(WebRowSet wb,DiscountRecommendationTransVO vo) 
	{
     	StringBuffer sBuffer = new StringBuffer("");
...
//			System.out.println("Net Cost--27->"+wb.getString(27));
     	...
     	/*	if(wb.getString(23)==null||wb.getString(23).equals(""))
			...
			sBuffer.append("<input type='hidden' name='Cost' id='Cost' value='" + wb.getString(13) + "'>");
			...
			sBuffer.append(wb.getString(13));
			sBuffer.append("</td>");
			...
			sBuffer	.append("<input type='hidden' name='strIpdBillFianlDis' id='strIpdBillFianlDis' value='0.00'></td>");
	 ...
	 catch (Exception e) 
	 {
			...
			new HisException("Discount Approval Trans",
					"DiscountRecommendationTransHLP.getIPDBillSetlmnt()-->", e
							.getMessage());
	 }
...
///////////////////////////////Hlp for popup///////////////////////////////////	
	...
	public static String getPopUpDtl(WebRowSet ws)
	{
		...
		catch (Exception e) 
		{
			...
			new HisException("Discount Approval Trans",
					"DiscountRecommendationTrans.getPopUpDtl()-->", e.getMessage());
		}
		ws = null;
		return sb.toString();
		}
