...
public class PatWalletTransFB extends ActionForm {
	...
	private String strPreviousCrNoDtWalletlag = "0";
	...
	private String strWalletDetailsView="";
	private String strWalletNo="";
	
	public String getStrWalletDetailsView() {
		return strWalletDetailsView;
	}

	public void setStrWalletDetailsView(String strWalletDetailsView) {
		this.strWalletDetailsView = strWalletDetailsView;
	}
	...
	private String strAdvacnceAmount="";
 
	private String strCRorWalletwise="";
	...
	private String strReportingFormat="text";//should be pdf or html
	private String RefundAmount= "";
	private String strChargeType = "";
	private String chkMobileNoCount = "";
	...
	public String getChkMobileNoCount() {
		return chkMobileNoCount;
	}

	public void setChkMobileNoCount(String chkMobileNoCount) {
		this.chkMobileNoCount = chkMobileNoCount;
	}
	...
	private String strWalletAccountNo ="";
	private String strWalletAccountOpenDate ="";
	private String strWalletDepositedAmount ="";
	private String strWalletBalanceAmount ="";
	private String strWalletAccountStatus ="";
    private String strWalletAccountSummary="";
	...
	public String getStrWalletAccountSummary() {
		return strWalletAccountSummary;
	}

	public void setStrWalletAccountSummary(String strWalletAccountSummary) {
		this.strWalletAccountSummary = strWalletAccountSummary;
	}

	public String getStrWalletAccountNo() {
		return strWalletAccountNo;
	}

	public void setStrWalletAccountNo(String strWalletAccountNo) {
		this.strWalletAccountNo = strWalletAccountNo;
	}

	public String getStrWalletAccountOpenDate() {
		return strWalletAccountOpenDate;
	}

	public void setStrWalletAccountOpenDate(String strWalletAccountOpenDate) {
		this.strWalletAccountOpenDate = strWalletAccountOpenDate;
	}

	public String getStrWalletDepositedAmount() {
		return strWalletDepositedAmount;
	}

	public void setStrWalletDepositedAmount(String strWalletDepositedAmount) {
		this.strWalletDepositedAmount = strWalletDepositedAmount;
	}

	public String getStrWalletBalanceAmount() {
		return strWalletBalanceAmount;
	}

	public void setStrWalletBalanceAmount(String strWalletBalanceAmount) {
		this.strWalletBalanceAmount = strWalletBalanceAmount;
	}

	public String getStrWalletAccountStatus() {
		return strWalletAccountStatus;
	}

	public void setStrWalletAccountStatus(String strWalletAccountStatus) {
		this.strWalletAccountStatus = strWalletAccountStatus;
	}
...
/*
	...
	public String getStrPreviousCrNoDtWalletlag() {
		return strPreviousCrNoDtWalletlag;
	}

	public void setStrPreviousCrNoDtWalletlag(String strPreviousCrNoDtWalletlag) {
		this.strPreviousCrNoDtWalletlag = strPreviousCrNoDtWalletlag;
	}
	...
	public String getStrCRorWalletwise() {
		return strCRorWalletwise;
	}

	public void setStrCRorWalletwise(String strCRorWalletwise) {
		this.strCRorWalletwise = strCRorWalletwise;
	}

	public String getStrAdvacnceAmount() {
		return strAdvacnceAmount;
	}

	public void setStrAdvacnceAmount(String strAdvacnceAmount) {
		this.strAdvacnceAmount = strAdvacnceAmount;
	}
	...
	public void setStrMobileNo1(String strMobileNo1) {
		this.strMobileNo1 = strMobileNo1;
	}
