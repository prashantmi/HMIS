...
public class CashCollectionOfflineTransDAO
{
	...
	public static void getPaymentModeListByPatCategory(CashCollectionOfflineTransVO voObj)
	{
		HisDAO daoObj = null;
		WebRowSet ws = null;
	...
	public static void getOffLineDiscountApprovalList(CashCollectionOfflineTransVO voObj)
	{
		...
		try
		{
			...
			daoObj = new HisDAO("Cash Collection Transaction", "CashCollectionTransDAO.getOffLineDiscountApprovalList");
	 ...
	 * @param voObj
	 */
	public static void insertOfflineAdvance(CashCollectionOfflineTransVO voObj,HisDAO dao)
	{
		int nAccFlag = 0;
		int nBillFlag = 0;
		int nAppFlag = 0;
...
e1.printStackTrace();
	...
	public static void getAdmEpisodeTreatmentCatDtl(CashCollectionOfflineTransVO voObj)
	{
		HisDAO daoObj = null;
		WebRowSet ws = null;
