...
public class PatWalletTransHLP {
	 ...
	 */
	public static String getOffLineClientDetailsView(PatWalletTransVO voObj) {
	...
	public static String getOffLineOtherDetailsView(PatWalletTransVO voObj) {
	 ...
	 * @throws Exception
	 */
	public static String getBillDetails(PatWalletTransVO voObj)
			throws Exception {
	 ...
	 * @throws Exception
	 */
	public static String getOffLinePartPayRefundBillDetails(PatWalletTransVO voObj)
			throws Exception {
	 ...
	 * @throws Exception
	 */
	public static String getTariffDetails(PatWalletTransVO voObj) throws Exception 
	{
		StringBuffer sBuffer = new StringBuffer("");
		...
		try 
		{
			...
			if (tariffDetails != null && tariffDetails.size() != 0) 
			{
				while (tariffDetails.next()) 
				{
					...
					PatWalletTransDAO.getOffLineTariffUnitList(voObj);
	 ...
	 * @throws Exception
	 */
	public static String getPartPayTariffDetails(PatWalletTransVO voObj)
			throws Exception {
		StringBuffer sBuffer = new StringBuffer("");
		WebRowSet tariffDetails = voObj.getOfflineBillTariffList();
		try {
	 ...
	 */
	public static String getPopUp(PatWalletTransVO voObj) {
		StringBuffer sb = new StringBuffer("");
	...
	public static String getBillListingView(PatWalletTransVO voObj) {
...
*/
	public static String getAdmissionCancellationDetails(
			PatWalletTransVO voObj, String mode) {
		StringBuffer sb = new StringBuffer("");
	...
	public static String getWalletAccountSummary_BS(WebRowSet wb,String status)
			throws SQLException {
		...
		br.append("</table> ");
			...
			br.append("<th><font size=\"2\" face=\"Helvetica Neue, Helvetica, Arial, sans-serif\" color=\"#000000\">Request No</font></th>");
			br.append("<th><font size=\"2\" face=\"Helvetica Neue, Helvetica, Arial, sans-serif\" color=\"#000000\">Request Date</font></th>");
			br.append("<th><font size=\"2\" face=\"Helvetica Neue, Helvetica, Arial, sans-serif\" color=\"#000000\">Group Name</font></th>");
			br.append("<th><font size=\"2\" face=\"Helvetica Neue, Helvetica, Arial, sans-serif\" color=\"#000000\">Tariff Name</font></th>");
			br.append("<th><font size=\"2\" face=\"Helvetica Neue, Helvetica, Arial, sans-serif\" color=\"#000000\">Tariff Rate</font></th>");
			br.append("<th><font size=\"2\" face=\"Helvetica Neue, Helvetica, Arial, sans-serif\" color=\"#000000\">Deposits</font></th>");
			br.append("<th><font size=\"2\" face=\"Helvetica Neue, Helvetica, Arial, sans-serif\" color=\"#000000\">Deductions</font></th>");
			br.append("</tr>");
			br.append("</thead>");
			br.append("<tbody>");
			if (wb.size() != 0) 
			{
				while (wb.next()) 
				{
					strWalletANo  = wb.getString(1);
					System.out.println("strWalletANo>>>>>>>>>>>>>"+strWalletANo);
				}
				
			
			
			br.append("<tr>");	 
			br.append("<td><b><font size=\"2\" face=\"Helvetica Neue, Helvetica, Arial, sans-serif\" color=\"#000000\">Wallet No. -"  + strWalletANo + "</font></b></td>");
			br.append("</tr>");	
			wb.beforeFirst();
			}
			else {
				
				br.append("<div CLASS='multiControl' colspan='5'><font color='red'>" + "No Record Found" + "</font></div>");
			...
			if (wb.size() != 0) 
			{
				...
				while (wb.next()) 
				{
					...
					br.append("<input type='hidden' name='refundAmount' id='refundAmount" +i+ "' value=" +RefundAmount + " />");
					br.append("<tr>");	
					br.append("<td><font size='2' face='Helvetica Neue, Helvetica, Arial, sans-serif' color='#000000'>"  + strIssueNo + "</font></td>");
					br.append("<td>  <font size='2' face='Helvetica Neue, Helvetica, Arial, sans-serif' color='#000000'>"+ strReqDate + "</font></td>");

					br.append("<td><font size='2' face='Helvetica Neue, Helvetica, Arial, sans-serif' color='#000000'>"	+strGroupName+ "</font></td>");
					br.append("<td><font size='2' face='Helvetica Neue, Helvetica, Arial, sans-serif' color='#000000'>"	+ strtrName + "</font></td>");
					br.append("<td><font size='2' face='Helvetica Neue, Helvetica, Arial, sans-serif' color='#000000'>"	+ strtraiffRate + "</font></td>");
                      if(strtrfid.equals("30")||strtrfid.equals("31")||strtrfid.equals("19")||strtrfid.equals("20")||strtrfid.equals("21") )
                      {
					     br.append("<td><font size=\"2\" face=\"Helvetica Neue, Helvetica, Arial, sans-serif\" color=\"#000000\">"	+ strNetAmount + "<font></td>");
					     br.append("<td><font size=\"2\" face=\"Helvetica Neue, Helvetica, Arial, sans-serif\" color=\"#000000\"></font></td>");
                      }
                      else
                      {
                         br.append("<td></td>");
				...
				br.append("<div class='row rowFlex reFlex newrow'>");	 
				br.append("<div class='col-sm-6'><label>Current Balance :: " + GrossAmont + "</label></div>");
				
				if(status.equals("2"))
				{
					br.append("<div class='col-sm-6' style='display: block;'>");
				
				br.append("<label>Net  Refundable Amount(cash)<i class='fas fa-rupee-sign'></i></label>");
				br.append("<td class='CONTROL'  align='Left'><div id='totalRecAmtDivId'>"+RefundAmount+"</div></td></tr></table>");
				}
	...
	public static String getWalletAccountSummary(WebRowSet wb,String status)
			throws SQLException {
		StringBuffer br = new StringBuffer();
		...
		br.append("</table> ");
			...
			br.append("<tr>");
			//br.append("<td class='multiRPTLabel' WIDTH='15%' align='CENTER'>Wallet No.</td>");
			br.append("<td class='multiRPTLabel' WIDTH='20%' align='CENTER'>Request No</td>");
			br.append("<td class='multiRPTLabel' WIDTH='10%' align='CENTER'>Request Date</td>");
			br.append("<td class='multiRPTLabel' WIDTH='15%' align='CENTER'>Group Name</td>");
			br.append("<td class='multiRPTLabel' WIDTH='15%' align='CENTER'>Tariff Name</td>");
			br.append("<td class='multiRPTLabel' WIDTH='10%' align='CENTER'>Tariff Rate</td>");
			//br.append("<td class='multiRPTLabel' WIDTH='10%' align='CENTER'>Bill Qty</td>");
			br.append("<td class='multiRPTLabel' WIDTH='15%' align='CENTER'>Deposits</td>");
			br.append("<td class='multiRPTLabel' WIDTH='15%' align='CENTER'>Deductions</td>");
		//	br.append("<td class='multiRPTLabel' WIDTH='10%' align='CENTER'>#</td>");
			...
			br.append("<tr>");	 
			br.append("<td WIDTH='95%' colspan='7' CLASS=''   align='left'><b><div  align='left'><font color='white'>Wallet No. -"  + strWalletANo + "</font></div></b></td></tr>");
			...
			if (wb.size() != 0) 
			{
				...
				while (wb.next()) 
				{
					...
					strtrfid= wb.getString(9);
					GrossAmont = wb.getString(10);
					System.out.println("wb.getString(10)-->"+wb.getString(10));
					System.out.println("wb.getString(11)-->"+wb.getString(11));
					RefundAmount = wb.getString(11);
					/*System.out.println("strWalletANo"+strWalletANo);
...
//					br.append("<input type='hidden' name='strHlpIndentNo' id='strHlpIndentNo" +i+ "' value=" + strWalletANo + " />");
					br.append("<input type='hidden' name='strHlpIssueNo' id='strHlpIssueNo" +i+ "' value=" +strIssueNo + " />");
					br.append("<input type='hidden' name='strHlpIndentDate' id='strHlpIssueNDate" +i+ "' value=" +strReqDate + " />");
					br.append("<input type='hidden' name='strHlpCrNo' id='strHlpCrNo" +i+ "' value=" +strGroupName + " />");
					br.append("<input type='hidden' name='strHlpPatientName' id='strHlpPatientName" +i+ "' value=" + strtrName + " />");
					...
					br.append("<input type='hidden' name='refundAmount' id='refundAmount" +i+ "' value=" +RefundAmount + " />");
					br.append("<tr>");	
					br.append("<td WIDTH='20%' CLASS='multiPOControl' >"  + strIssueNo + "</td>");
					br.append("<td WIDTH='10%' CLASS='multiPOControl' >"  + strReqDate + "</td>");

					br.append("<td WIDTH='15%' CLASS='multiPOControl' >"	+strGroupName+ "</td>");
					br.append("<td WIDTH='15%' CLASS='multiPOControl' >"	+ strtrName + "</td>");
					br.append("<td WIDTH='10%' CLASS='multiPOControl' >"	+ strtraiffRate + "</td>");
                      if(strtrfid.equals("30")||strtrfid.equals("31")||strtrfid.equals("19")||strtrfid.equals("20")||strtrfid.equals("21") )
                      {
					     br.append("<td WIDTH='15%' CLASS='multiPOControl' >"	+ strNetAmount + "</td>");
				...
				br.append("<tr>");	 
				br.append("<td colspan='7' CLASS=''><b><div  align='right'><font color='white'>Current Balance :: " + GrossAmont + "<font></div></b></td></tr>");
				
				System.out.println("---------------------------------------------------");
				System.out.println(GrossAmont);
	...
	public static String WalletAccountDetail(PatWalletTransVO vo)
			throws Exception {
		WebRowSet ws = null;
		...
		try {
					...
					sb.append("</td> ");
					sb.append("<td colspan='2'> &nbsp;Wallet Account No : ");
					sb.append(vo.getStrWalletAccountNo());
					sb.append(" </td> ");
					sb.append(" <td > <div align='right'>");
					sb.append("Status : " + vo.getStrWalletAccountStatus() + "&nbsp;");
					sb.append(" </div> </td> ");
					sb.append("</tr> ");
					sb.append("</table> ");
					...
					sb
							.append("<table class='TABLEWIDTH' align='center' cellpadding='1px' cellspacing='1px'>");
					sb.append("<tr><td width='25%' class='LABEL'>Wallet No.</td>");
					sb.append("<td width='25%' class='CONTROL'>");
					sb.append(vo.getStrWalletAccountNo());
					sb.append("<td width='25%' class='LABEL'>Wallet Status</td>");
					sb.append("<td width='25%' class='CONTROL'>");
					sb.append(vo.getStrWalletAccountStatus());
					sb.append("</td></tr>");
					
					sb.append("<tr><td width='25%' class='LABEL'>Wallet Open Date</td>");
					sb.append("<td width='25%' class='CONTROL'>");
					sb.append(vo.getStrWalletAccountOpenDate());
					sb.append("<td width='25%' class='LABEL'>Wallet Balance</td>");
					sb.append("<td width='25%' class='CONTROL'>");
					sb.append(vo.getStrWalletBalanceAmount());
					sb.append("</td></tr>");
			...
			throw new Exception("PatWalletTransHLP-->WalletAccountDetail-->"
					+ e.getMessage());
		} 
		return sb.toString();
	}
