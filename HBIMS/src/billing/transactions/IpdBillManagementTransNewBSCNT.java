...
public class IpdBillManagementTransNewBSCNT extends CSRFGardTokenAction{
	...
	public ActionForward GO(ActionMapping mapping, ActionForm form,
		...
		IpdBillManagementTransNewBSDATA.getAdmissionDtls(formBean,request);
	...
	public ActionForward GOADM(ActionMapping mapping, ActionForm form,
		...
		formBean.setStrSeatId(request.getSession().getAttribute("SEATID").toString());
		String strTarget = "ipdBillManagementNew";
		IpdBillManagementTransNewBSDATA.getPatientDtls(formBean,request);
		...
		else
		{
			...
			if(strAccStatus.equals("1"))
			    acFwd.setPath("/billing/transactions/IpdBillManagementTransBSCNT.cnt?hmode=ADDSERVICE");
			...
			else if(strAccStatus.equals("0"))
			{
				...
				return mapping.findForward(strTarget);*/
				acFwd.setPath("/billing/transactions/IpdBillManagementTransBSCNT.cnt?hmode=BILLAPPROVAL");
			}
			else if(strAccStatus.equals("5"))
			{
				...
				acFwd.setPath("/billing/transactions/IpdBillManagementTransBSCNT.cnt?hmode=UPDATEACCOUNTSTATUS");
