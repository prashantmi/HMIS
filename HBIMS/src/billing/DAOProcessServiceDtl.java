...
public class DAOProcessServiceDtl 
{
	public static void getProcessServiceDtl(BillingVO voHdrObj) 
	{
	//	HisDAO daoObj = null;
		HisDAO dao = null;
		int  procIndex1 = 0;
		...
		String strHospCode = voHdrObj.getStrValue3();
	 	String proc_name1 ="";
	...
	if(err == null) err = ""; 
		...
		{
           voHdrObj.setStrMsgString("HLPGrpDtl->BillingBO->DAOUnProcessServiceDtl.getProcessUnProcessDtl() --> " + e.getMessage());
