...
public final class TicketGrantingTicketExpiration implements HISExpiration
{
	// Serialization ID
	...
	public TicketGrantingTicketExpiration(HttpSession objSession)
	{
		timeToExpireInSecond = HISSSOConfig.SSO_TICKET_EXPIRY_IN_SECONDS_TGT;
