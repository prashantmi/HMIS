...
import new_investigation.masters.controller.data.externalLabMstDATA;
...
public class externalLabMstUTL implements MasterInterface
{
	...
	public static boolean saveParameter(externalLabMstFB parameter_fb, HttpServletRequest _request)
	{
		...
		try
		{
			...
			externalLabMasterVO parametermaster_VO = new externalLabMasterVO();
			HelperMethods.populate(parametermaster_VO, parameter_fb);

			externalLabMstDATA.saveParameter(parametermaster_VO, userVO);
	...
	public static boolean fetchCheckListParameter(externalLabMstFB parameter_fb, HttpServletRequest _request)
	{
		Status objStatus = new Status();
		externalLabMasterVO parametermaster_VO = new externalLabMasterVO();
		try
		{
			...
			externalLabMstDATA.fetchParameter(parametermaster_VO, userVO);
	...
	public static boolean fetchParameter(externalLabMstFB parameter_fb, HttpServletRequest _request)
	{
		Status objStatus = new Status();
		externalLabMasterVO parametermaster_VO = new externalLabMasterVO();
		try
	...
	public static boolean savemodifyParameter(externalLabMstFB parameter_fb, HttpServletRequest _request)
	{
		Status objStatus = new Status();
		...
		try
		{
			...
			externalLabMstDATA.savemodifyParameter(parametermaster_VO, userVO);
	...
	public static boolean reFetchCheckListParameter(externalLabMstFB parameter_fb, HttpServletRequest _request)
	{
		Status objStatus = new Status();
		externalLabMasterVO parametermaster_VO = new externalLabMasterVO();
		try
