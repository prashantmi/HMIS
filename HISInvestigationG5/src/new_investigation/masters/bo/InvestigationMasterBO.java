...
public class InvestigationMasterBO implements InvestigationMasterBOi
{
	...
	public Map fetchTest(TestNewMasterVO testNewMasterVO, UserVO _UserVO)
	{
		...
		try
		{
			...
			FastingTime=testMstDAOi.getFastingTimeCombo( _UserVO);
			mp.put(InvestigationConfig.LIST_FASTING_TIME, FastingTime);
			
			FastingType=testMstDAOi.getFastingTypeCombo( _UserVO);
			mp.put(InvestigationConfig.LIST_FASTING_TYPE, FastingType);
