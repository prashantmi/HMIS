...
public class UserwiseBookMarkMstDAO extends DataAccessObject {

	public UserwiseBookMarkMstDAO(TransactionContext _tx) {
		super(_tx);
		
	}

	public List getUserCombo(UserwiseBookMarkMstVO userwiseBookMarkMstVO,UserVO _UserVO)
	{
		String query="";
		...
		String queryKey="SELECT.USER.UserWise_BookMark_Mst";
	...
	public List getDeptCombo(UserwiseBookMarkMstVO userwiseBookMarkMstVO,UserVO _UserVO)
	{
		String query="";
		Map populateMap= new HashMap();
		ResultSet rs=null;
	...
	public List getLabCombo(UserwiseBookMarkMstVO userwiseBookMarkMstVO,UserVO _UserVO)
	{
		String query="";
		Map populateMap= new HashMap();
		ResultSet rs=null;
	...
	//fetch all the test code based on hospital
			public List getTestCombo1(UserwiseBookMarkMstVO userwiseBookMarkMstVO,UserVO _UserVO)
			{
				String query="";
				Map populateMap= new HashMap();
				ResultSet rs=null;
	...
	public List getTestCombo(UserwiseBookMarkMstVO userwiseBookMarkMstVO,UserVO _UserVO)
	{
		String query="";
		Map populateMap= new HashMap();
		ResultSet rs=null;
		...
		populateMap.put(sq.next(), InvestigationConfig.IS_VALID_ACTIVE);
		populateMap.put(sq.next(),_UserVO.getHospitalCode());
		populateMap.put(sq.next(),userwiseBookMarkMstVO.getLabCode());
		populateMap.put(sq.next(),Config.IS_VALID_ACTIVE);
		populateMap.put(sq.next(),userwiseBookMarkMstVO.getBookmarkCode());
		populateMap.put(sq.next(),userwiseBookMarkMstVO.getLabCode());
		populateMap.put(sq.next(),_UserVO.getHospitalCode());
		populateMap.put(sq.next(),userwiseBookMarkMstVO.getUserId());
	...
	public List getTestGroupCombo(UserwiseBookMarkMstVO userwiseBookMarkMstVO,UserVO _UserVO)
	{
		String query="";
		Map populateMap= new HashMap();
		ResultSet rs=null;
	...
	public List getBookMarkCombo(UserwiseBookMarkMstVO userwiseBookMarkMstVO,UserVO _UserVO)
	{
		String query="";
		Map populateMap= new HashMap();
		ResultSet rs=null;
		List testGroupName=new ArrayList();
		String filename= InvestigationConfig.QUERY_FILE_FOR_INVESTIGATION_MASTERSDAO;
		String queryKey="SELECT.BOOKMARK.UserWise_BookMark_Mst";
		Sequence sq= new Sequence();
		Connection conn=super.getTransactionContext().getConnection();
		populateMap.put(sq.next(), InvestigationConfig.IS_VALID_ACTIVE);
		populateMap.put(sq.next(),_UserVO.getHospitalCode());
	...
	public void saveUserBookMark(UserwiseBookMarkMstVO userwiseBookMarkMstVO, UserVO _UserVO)
	{
		String query = "";
		Map populateMAP = new HashMap();
		Sequence sq = new Sequence();
		...
		{	
			...
			populateMAP.put(sq.next(),userwiseBookMarkMstVO.getBookmarkCode());
			populateMAP.put(sq.next(),_UserVO.getHospitalCode());
			populateMAP.put(sq.next(),userwiseBookMarkMstVO.getBookarkType());
			populateMAP.put(sq.next(),userwiseBookMarkMstVO.getIsTestGroup());
			populateMAP.put(sq.next(),Config.IS_VALID_ACTIVE);
			populateMAP.put(sq.next(),userwiseBookMarkMstVO.getDeptUnitCode());
			populateMAP.put(sq.next(),_UserVO.getSeatId());
			populateMAP.put(sq.next(),userwiseBookMarkMstVO.getTestCode());
			populateMAP.put(sq.next(),userwiseBookMarkMstVO.getGroupCode());
			populateMAP.put(sq.next(),Config.IS_VALID_ACTIVE);
			populateMAP.put(sq.next(),userwiseBookMarkMstVO.getBookmarkCode());
			populateMAP.put(sq.next(),_UserVO.getHospitalCode());
	...
	public List fetchModifyUserBookMark(UserwiseBookMarkMstVO userwiseBookMarkMstVO,UserVO _UserVO)
	{
		String query="";
		Map populateMap= new HashMap();
		ResultSet rs=null;
		...
		populateMap.put(sq.next(), Config.IS_VALID_ACTIVE);
		populateMap.put(sq.next(), userwiseBookMarkMstVO.getBookmarkCode());
		populateMap.put(sq.next(), userwiseBookMarkMstVO.getSeqNo());
		populateMap.put(sq.next(),_UserVO.getHospitalCode());
		...
		try
		{
			...
			else
			{
				...
				while(rs.next())
				{
					HelperMethods.populateVOfrmRS(userwiseBookMarkMstVO, rs);
	...
	public List getTestBylabCode(UserwiseBookMarkMstVO userwiseBookMarkMstVO,UserVO _UserVO)
	{
		String query="";
		Map populateMap= new HashMap();
		ResultSet rs=null;
	...
	public void saveModifyUserBookMark(UserwiseBookMarkMstVO userwiseBookMarkMstVO, UserVO _UserVO)
	{
		String query = "";
		Map populateMAP = new HashMap();
		Sequence sq = new Sequence();
	...
	public String getBookMarkType(UserwiseBookMarkMstVO userwiseBookMarkMstVO,UserVO _UserVO)
	{
		String query = "";
		ResultSet rs;
		Map populateMAP = new HashMap();
	...
	public List getTestCombogroup(UserwiseBookMarkMstVO userwiseBookMarkMstVO,UserVO _UserVO)
	{
		String query="";
		Map populateMap= new HashMap();
		ResultSet rs=null;
	...
	public List<UserwiseBookMarkMstVO> getTestByGroup(UserwiseBookMarkMstVO userwiseBookMarkMstVO,UserVO _UserVO)
	{
		...
		Map populateMap= new HashMap();
		ResultSet rs=null;
		List<UserwiseBookMarkMstVO> testName=new ArrayList<UserwiseBookMarkMstVO>();
		String filename= InvestigationConfig.QUERY_FILE_FOR_INVESTIGATION_MASTERSDAO;
		...
		try
		{
			...
			else
			{
				...
				//testName=new ArrayList<UserBookMarkMstVO>();
				  UserwiseBookMarkMstVO voTest=null;
	                while (rs.next()) {
	                	voTest=new UserwiseBookMarkMstVO();
	...
	public List<UserwiseBookMarkMstVO> getDuplicateTestInBookmark(UserwiseBookMarkMstVO userwiseBookMarkMstVO, UserVO _UserVO, StringBuffer strduplicateTest) {
	  List duplicateTest=new ArrayList<UserBookMarkMstVO>();
			...
			String filename = InvestigationConfig.QUERY_FILE_FOR_INVESTIGATION_MASTERSDAO;
			String queryKey = "SELECT.getDuplicateTest.Userwise_BookMark_MST";
