...
public class CollectionAreaMstDAO extends DataAccessObject implements CollectionAreaMstDAOi
{

	public CollectionAreaMstDAO(TransactionContext _tx)
	{
		super(_tx);
	...
	public void createCollectionArea(CollectionAreaMasterVO collectionarea_VO, UserVO _UserVO)
	{
		...
		String queryKey = "INSERT.HIVT_COLLECTION_AREA_MST";
		try
		{
		...
		try
		{	
			populateMAP.put(sq.next(), collectionarea_VO.getLocationCode());

			populateMAP.put(sq.next(), _UserVO.getHospitalCode());
			populateMAP.put(sq.next(), collectionarea_VO.getWardCode());
			populateMAP.put(sq.next(), _UserVO.getHospitalCode());
			populateMAP.put(sq.next(), collectionarea_VO.getCollectionareaName());
			populateMAP.put(sq.next(), collectionarea_VO.getCollectionareaType());
			populateMAP.put(sq.next(), InvestigationConfig.IS_VALID_ACTIVE);
			populateMAP.put(sq.next(), _UserVO.getSeatId());
			populateMAP.put(sq.next(), collectionarea_VO.getRemarks());
			populateMAP.put(sq.next(), collectionarea_VO.getSopbased());
	...
	public void fetchCheckListCollectionArea(CollectionAreaMasterVO collectionarea_VO, UserVO _UserVO)
	{
		...
		ResultSet rs=null;
		String filename= InvestigationConfig.QUERY_FILE_FOR_INVESTIGATION_MASTERSDAO;
		String queryKey="SELECT.HIVT_COLLECTION_AREA_MST";

		Sequence sq= new Sequence();
		Connection conn=super.getTransactionContext().getConnection();

		populateMap.put(sq.next(), collectionarea_VO.getCollectionareaCode());
		populateMap.put(sq.next(), collectionarea_VO.getHospitalCode());
		...
		try
		{
			...
			else
			{
				...
				while(rs.next())
				{
					HelperMethods.populateVOfrmRS(collectionarea_VO ,rs);
				}
			}
		}
		catch(Exception e)
	...
	public void updateCollectionArea(CollectionAreaMasterVO collectionarea_VO, UserVO _UserVO)
	{
		...
		Sequence sq = new Sequence();
		String filename = InvestigationConfig.QUERY_FILE_FOR_INVESTIGATION_MASTERSDAO;
		String queryKey ="UPDATE.HIVT_COLLECTION_AREA_MST";
		try
		{
			query = HelperMethodsDAO.getQuery(filename, queryKey);
		}
	...
	public String checkDuplicateCollectionArea(CollectionAreaMasterVO collectionarea_VO, UserVO _UserVO)
	{
		...
		Sequence sq = new Sequence();
		String filename = InvestigationConfig.QUERY_FILE_FOR_INVESTIGATION_MASTERSDAO;
		String queryKey ="CHECKDUPLICATE.HIVT_COLLECTION_AREA_MST";
		try
		{
			query = HelperMethodsDAO.getQuery(filename, queryKey);
		}
		...
		try
		{
			...
			populateMAP.put(sq.next(), collectionarea_VO.getCollectionareaName().trim());
			populateMAP.put(sq.next(), _UserVO.getHospitalCode());
		}
		catch (Exception e)
		{
	...
	public String checkDuplicateModifyCollectionArea(CollectionAreaMasterVO collectionarea_VO,UserVO _UserVO)
	{
		...
		Sequence sq = new Sequence();
		String filename = InvestigationConfig.QUERY_FILE_FOR_INVESTIGATION_MASTERSDAO;
		String queryKey ="CHECKDUPLICITY_MODIFY.HIVT_COLLECTION_AREA_MST";
		try
		{
			query = HelperMethodsDAO.getQuery(filename, queryKey);
		}
	...
	public List getlocationCombo(UserVO _UserVO)
	{
		...
		String filename= InvestigationConfig.QUERY_FILE_FOR_INVESTIGATION_MASTERSDAO;
		String queryKey="SELECT.LOCATION_COMBO.HIVT_COLLECTION_AREA_MST";
	...
	public List getwardCombo(UserVO _UserVO)
	{
		...
		String filename= InvestigationConfig.QUERY_FILE_FOR_INVESTIGATION_MASTERSDAO;
		String queryKey="SELECT.WARD_COMBO.HIVT_COLLECTION_AREA_MST";
	...
	public List getwardComboOnModify(String areaCode,UserVO _UserVO)
	{
		...
		List lstwardName=new ArrayList();
		String filename= InvestigationConfig.QUERY_FILE_FOR_INVESTIGATION_MASTERSDAO;
		String queryKey="SELECT.WARD_COMBO_ON_MODIFY.HIVT_COLLECTION_AREA_MST";
