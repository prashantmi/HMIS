...
public class LocalLabCannedMstDAO extends DataAccessObject implements LocalLabCannedMstDAOi
{

	public LocalLabCannedMstDAO(TransactionContext _tx)
	{
		super(_tx);
	...
	public void createLocalLabCanned(LabCannedMasterVO labcannedmaster_VO, UserVO _UserVO)
	{
		...
		String queryKey = "INSERT_LOCAL.HIVT_LAB_CANNED_MST";
		try
		{
		...
		{	
			...
			populateMAP.put(sq.next(), labcannedmaster_VO.getUserCannedCode());
	...
	public void fetchCheckListLocalLabCanned(LabCannedMasterVO labcannedmaster_VO, UserVO _UserVO)
	{
		String query="";
		Map populateMap= new HashMap();
		ResultSet rs=null;
		String filename= InvestigationConfig.QUERY_FILE_FOR_INVESTIGATION_MASTERSDAO;
		String queryKey="SELECT_LOCAL.HIVT_LAB_CANNED_MST";
	...
	public void deleteLocalLabCanned(LabCannedMasterVO labcannedmaster_VO, UserVO _UserVO)
	{
		...
		Sequence sq = new Sequence();
		String filename = InvestigationConfig.QUERY_FILE_FOR_INVESTIGATION_MASTERSDAO;
		String queryKey ="DELETE_VALID_LOCAL.HIVT_LAB_CANNED_MST";
		try
		{
			query = HelperMethodsDAO.getQuery(filename, queryKey);
		}
	...
	public String checkPrimaryKeyLocalLabCanned(LabCannedMasterVO labcannedmaster_VO, UserVO _UserVO)
	{
		...
		Sequence sq = new Sequence();
		String filename = InvestigationConfig.QUERY_FILE_FOR_INVESTIGATION_MASTERSDAO;
		String queryKey ="CHECKPRIMARYKEY_LOCAL.HIVT_LAB_CANNED_MST";
		try
		{
			query = HelperMethodsDAO.getQuery(filename, queryKey);
		}
	...
	public void updateValidLocalLabCanned(LabCannedMasterVO labcannedmaster_VO,UserVO _UserVO)
	{
		...
		Sequence sq = new Sequence();
		String filename = InvestigationConfig.QUERY_FILE_FOR_INVESTIGATION_MASTERSDAO;
		String queryKey ="UPDATE_VALID_LOCAL.HIVT_LAB_CANNED_MST";
		try
		{
			query = HelperMethodsDAO.getQuery(filename, queryKey);
		}
	...
	public List getlabCombo(UserVO _UserVO)
	{
		...
		String filename= InvestigationConfig.QUERY_FILE_FOR_INVESTIGATION_MASTERSDAO;
		String queryKey="SELECT_LOCAL.LAB_COMBO.HIVT_LAB_CANNED_MST";
	...
	public List getnewLocalLabCannedComboLeft(LabCannedMasterVO labcannedmaster_VO, UserVO _UserVO)
	{
		...
		Map populateMap= new HashMap();
		ResultSet rs=null;
		List lstcannedName=new ArrayList();
		String filename= InvestigationConfig.QUERY_FILE_FOR_INVESTIGATION_MASTERSDAO;
		String queryKey="SELECT_LOCAL.LAB_UNMAPPED_COMBO.HIVT_LAB_CANNED_MST";
		...
		try
		{
			...
			{
				rs.beforeFirst();
				lstcannedName=HelperMethodsDAO.getAlOfEntryObjects(rs);
			}
		}
		catch(Exception e)
		{
	...
	public List getselectedLocalLabCannedComboRight(LabCannedMasterVO labcannedmaster_VO, UserVO _UserVO,List<LabCannedMasterVO> labcanned_listVO )
	{
		...
		List lstcannedName=new ArrayList();
		String filename= InvestigationConfig.QUERY_FILE_FOR_INVESTIGATION_MASTERSDAO;
		String queryKey="SELECT_LOCAL.LAB_MAPPED_COMBO.HIVT_LAB_CANNED_MST";
	...
	public void fetchdisplaydataLocalLabCanned(LabCannedMasterVO labcannedmaster_VO, UserVO _UserVO)
	{
		...
		ResultSet rs=null;
		String filename= InvestigationConfig.QUERY_FILE_FOR_INVESTIGATION_MASTERSDAO;
		String queryKey="SELECT_LOCAL.LOCAL_LABCANNED_NAME.HIVT_LABORATORY_MST";
	...
	*/	
	...
	public String checkLocallyMapped(LabCannedMasterVO labcannedmasterVO,UserVO _UserVO)
	{
		String query  = "";
		ResultSet rs = null;
        Map populateMAP =new HashMap();
        Sequence sq=new Sequence();
        String filename= InvestigationConfig.QUERY_FILE_FOR_INVESTIGATION_MASTERSDAO;
		String queryKey="CHECK_LOCALLY_MAPPED.Lab_canned_Local_Mst";
	    ...
	    try
	    {
	    	...
	    	populateMAP.put(sq.next(),labcannedmasterVO.getLabCode());
			populateMAP.put(sq.next(),_UserVO.getHospitalCode());
