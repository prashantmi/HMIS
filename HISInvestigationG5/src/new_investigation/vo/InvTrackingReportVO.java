...
public class InvTrackingReportVO extends ValueObject {
	...
	private String patientAccepArea;
	...
	public String getPatientAccepArea() {
		return patientAccepArea;
	}

	public void setPatientAccepArea(String patientAccepArea) {
		this.patientAccepArea = patientAccepArea;
	}
	...
	public String getResultReValBy() {
		return resultReValBy;
	}

	public void setResultReValBy(String resultReValBy) {
		this.resultReValBy = resultReValBy;
	}
