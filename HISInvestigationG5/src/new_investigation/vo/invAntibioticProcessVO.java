...
public class invAntibioticProcessVO extends ValueObject {
	...
	List<invAntibioticProcessVO> organismList;	
	List<invAntibioticProcessVO> AntibioticList;
	...
	public List<invAntibioticProcessVO> getOrganismList() {
		return organismList;
	}
	public void setOrganismList(List<invAntibioticProcessVO> organismList) {
		this.organismList = organismList;
	}
	public List<invAntibioticProcessVO> getAntibioticList() {
		return AntibioticList;
	}
	public void setAntibioticList(List<invAntibioticProcessVO> antibioticList) {
