...
public class InvResultValidationVO extends ValueObject
{
		...
		if(this.getResultEntryVOListValidatedBy()!=null && this.getResultEntryVOListValidatedBy().get(0).getGroupCode()!=null)
		{
		...
		else
			{
				...
				else
				{
					...
					{
					for(ResultEntryVO validationVO: this.getResultEntryVOListValidatedBy())
					{
						if(i==0)
						{
						this.testName=validationVO.getTestName();
						}
						else
						{
							this.testName+=","+validationVO.getTestName();
...
public String getPriorityColor() {
	...
	public String getRequisitionNo() {
		this.requisitionNo=requisitionDNo.substring(0, 18);
	...
	public String getResultValidationValue() {
		return resultValidationValue;
	}
	public void setResultValidationValue(String resultValidationValue) {
		this.resultValidationValue = resultValidationValue;
	}
