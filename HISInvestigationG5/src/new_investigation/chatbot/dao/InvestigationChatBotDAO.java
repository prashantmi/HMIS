...
public class InvestigationChatBotDAO extends DataAccessObject
{
	...
	*/
	...
	public String show_rcmd(String ans, UserVO userVO) throws Exception {
		String flg = "";
		String query="";
		Map populateMap= new HashMap();
		ResultSet rs=null;
		String filename= InvestigationConfig.QUERY_FILE_FOR_INVESTIGATION_CHATBOT;
		String queryKey="SHOW_RCMD";
		Sequence sq= new Sequence();
		Connection conn=super.getTransactionContext().getConnection();				
		try
		{
	...
	public String statecode(String ans, UserVO userVO) throws Exception {
		String flg = "";
		String query="";
		Map populateMap= new HashMap();
		ResultSet rs=null;
		String filename= InvestigationConfig.QUERY_FILE_FOR_INVESTIGATION_CHATBOT;
		String queryKey="STATE_CODE";
		Sequence sq= new Sequence();
		Connection conn=super.getTransactionContext().getConnection();				
		try
		{
	...
	public String ip(String ans, UserVO userVO) throws Exception {
		String flg = "";
		String query="";
		Map populateMap= new HashMap();
		ResultSet rs=null;
		String filename= InvestigationConfig.QUERY_FILE_FOR_INVESTIGATION_CHATBOT;
		String queryKey="RCMD_IP";
		Sequence sq= new Sequence();
		Connection conn=super.getTransactionContext().getConnection();				
		try
		{
	...
	public String key(String ans, UserVO userVO) throws Exception {
		String flg = "";
		String query="";
		Map populateMap= new HashMap();
		ResultSet rs=null;
		String filename= InvestigationConfig.QUERY_FILE_FOR_INVESTIGATION_CHATBOT;
		String queryKey="RCMD_KEY";
		Sequence sq= new Sequence();
		Connection conn=super.getTransactionContext().getConnection();				
		try
		{
	...
	public List<InvestigationChatbotVO> test_codes(String ans, UserVO userVO) throws Exception {
		String query="";
		Map populateMap= new HashMap();
		ResultSet rs=null;
		String filename= InvestigationConfig.QUERY_FILE_FOR_INVESTIGATION_CHATBOT;
		String queryKey="GET_TEST_CODES";
		Sequence sq= new Sequence();
		Connection conn=super.getTransactionContext().getConnection();		
		List<InvestigationChatbotVO> reqLst = new ArrayList<InvestigationChatbotVO>();
		populateMap.put(sq.next(),ans);		
