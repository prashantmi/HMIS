...
//	/*--------------------*/
	...
	public String show_rcmd(String ques,UserVO _UserVO) {
		// TODO Auto-generated method stub
		JDBCTransactionContext tx = new JDBCTransactionContext();
		String quesList = null;
		try {
			tx.begin();
			InvestigationChatBotDAO invChatbotDAO =new InvestigationChatBotDAO(tx);
			quesList=invChatbotDAO.show_rcmd(ques, _UserVO);			
			System.out.println("show_rcmd= "+quesList);
		} catch (HisApplicationExecutionException e) {
			e.printStackTrace();
			//throw new HisApplicationExecutionException();
			tx.close();
	...
	public String statecode(String ques,UserVO _UserVO) {
		// TODO Auto-generated method stub
		JDBCTransactionContext tx = new JDBCTransactionContext();
		String quesList = null;
		try {
			tx.begin();
			InvestigationChatBotDAO invChatbotDAO =new InvestigationChatBotDAO(tx);
			quesList=invChatbotDAO.statecode(ques, _UserVO);			
			System.out.println("show_rcmd= "+quesList);
		} catch (HisApplicationExecutionException e) {
			e.printStackTrace();
			//throw new HisApplicationExecutionException();
	...
	public String ip(String ques,UserVO _UserVO) {
		// TODO Auto-generated method stub
		JDBCTransactionContext tx = new JDBCTransactionContext();
		String quesList = null;
		try {
			tx.begin();
			InvestigationChatBotDAO invChatbotDAO =new InvestigationChatBotDAO(tx);
			quesList=invChatbotDAO.ip(ques, _UserVO);			
			System.out.println("show_ip= "+quesList);
		} catch (HisApplicationExecutionException e) {
			e.printStackTrace();
			//throw new HisApplicationExecutionException();
			tx.close();
	...
	public String key(String ques,UserVO _UserVO) {
		// TODO Auto-generated method stub
		JDBCTransactionContext tx = new JDBCTransactionContext();
		String quesList = null;
		try {
			tx.begin();
			InvestigationChatBotDAO invChatbotDAO =new InvestigationChatBotDAO(tx);
			quesList=invChatbotDAO.key(ques, _UserVO);			
			System.out.println("show_key= "+quesList);
		} catch (HisApplicationExecutionException e) {
			e.printStackTrace();
			//throw new HisApplicationExecutionException();
			tx.close();
	...
	public List<InvestigationChatbotVO> test_codes(String ques,UserVO _UserVO) {
		JDBCTransactionContext tx = new JDBCTransactionContext();
		List<InvestigationChatbotVO> quesList = null;
		try {
			tx.begin();
			InvestigationChatBotDAO invChatbotDAO =new InvestigationChatBotDAO(tx);
			quesList=invChatbotDAO.test_codes(ques, _UserVO);			
			System.out.println("mylist= "+quesList);
		} catch (HisApplicationExecutionException e) {
			e.printStackTrace();
			throw new HisApplicationExecutionException();
