...
public class InvestigationChatBotDelegate extends Delegate
{
	...
	public String show_rcmd(String ques,
			UserVO _UserVO) {
		// TODO Auto-generated method stub
		InvestigationChatBotBO serviceBO = (InvestigationChatBotBO) super.getServiceProvider();
		return serviceBO.show_rcmd(ques, _UserVO);
	}
	public String statecode(String ques,
			UserVO _UserVO) {
		// TODO Auto-generated method stub
		InvestigationChatBotBO serviceBO = (InvestigationChatBotBO) super.getServiceProvider();
		return serviceBO.statecode(ques, _UserVO);
	}
	public String ip(String ques,
			UserVO _UserVO) {
		// TODO Auto-generated method stub
		InvestigationChatBotBO serviceBO = (InvestigationChatBotBO) super.getServiceProvider();
		return serviceBO.ip(ques, _UserVO);
	}
	public String key(String ques,
			UserVO _UserVO) {
		// TODO Auto-generated method stub
		InvestigationChatBotBO serviceBO = (InvestigationChatBotBO) super.getServiceProvider();
		return serviceBO.key(ques, _UserVO);
	}
	...
	public List<InvestigationChatbotVO> test_codes(String ques,
			UserVO _UserVO) {
		// TODO Auto-generated method stub
		InvestigationChatBotBO serviceBO = (InvestigationChatBotBO) super.getServiceProvider();
		return serviceBO.test_codes(ques, _UserVO);
	}
