...
//	}
		...
		public ActionForward show_rcmd(ActionMapping mapping,ActionForm form,
				HttpServletRequest request,HttpServletResponse response)throws Exception {
			investigationChatBotFB fb=(investigationChatBotFB)form;			
			String flg = fb.getShow_rcmd();
			System.out.println("show rcmd" + flg);	
			String result = InvestigationChatBotUTIL.show_rcmd(flg, request);
			response.getWriter().print(result);
			return null;
		}
		public ActionForward statecode(ActionMapping mapping,ActionForm form,
				HttpServletRequest request,HttpServletResponse response)throws Exception {
			investigationChatBotFB fb=(investigationChatBotFB)form;			
			String flg = fb.getstatecode();
			System.out.println("show statecode " + flg);	
			String result = InvestigationChatBotUTIL.statecode(flg, request);
			response.getWriter().print(result);
			return null;
		}
		public ActionForward ip(ActionMapping mapping,ActionForm form,
				HttpServletRequest request,HttpServletResponse response)throws Exception {
			investigationChatBotFB fb=(investigationChatBotFB)form;			
			String flg = fb.getIp();
			System.out.println("show statecode " + flg);	
			String result = InvestigationChatBotUTIL.ip(flg, request);
			response.getWriter().print(result);
			return null;
		}
		public ActionForward key(ActionMapping mapping,ActionForm form,
				HttpServletRequest request,HttpServletResponse response)throws Exception {
			investigationChatBotFB fb=(investigationChatBotFB)form;			
			String flg = fb.getKey();
			System.out.println("show statecode " + flg);	
			String result = InvestigationChatBotUTIL.key(flg, request);
			response.getWriter().print(result);
			return null;
		}
		public ActionForward test_codes(ActionMapping mapping,ActionForm form,
				HttpServletRequest request,HttpServletResponse response)throws Exception {
			investigationChatBotFB fb=(investigationChatBotFB)form;			
			String flg = fb.getTest_codes();
			System.out.println("show test codes " + flg);	
			String result = InvestigationChatBotUTIL.test_codes(flg, request);
			response.getWriter().print(result);
			return null;
		}
