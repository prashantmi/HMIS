...
import new_investigation.reports.controller.utl.SampleRejectionListingReportUTIL;
...
public class SampleRejectionListingReportAction  extends DispatchAction
{
	...
	{
		SampleRejectionListingReportFB formBean = (SampleRejectionListingReportFB) form;
		SampleRejectionListingReportUTIL.fetchLab(formBean, request);
	...
	{
		SampleRejectionListingReportFB formBean = (SampleRejectionListingReportFB) form;
		SampleRejectionListingReportUTIL.fetchTest(formBean, request);
	...
	public void SHOWRPT(ActionMapping mapping, ActionForm form,
		...
		SampleRejectionListingReportDATA.showReport(formBean, request, response);
