...
public class MachineTestReportUTIL {
	

	
	public static boolean fetchlab(MachineTestReportFB reqListReport_fb, HttpServletRequest _request)
	{
		Status objStatus = new Status();
		MachineTestReportVO reqList_VO = new MachineTestReportVO();
		try
		{
			...
			mp=MachineTestReportDATA.fetchlab(reqList_VO, userVO);
	...
	public static boolean getLabBasedMachine(MachineTestReportFB reqListReport_fb, HttpServletRequest _request)
	{
		Status objStatus = new Status();
		MachineTestReportVO reqList_VO = new MachineTestReportVO();
		try
		{
			...
			mp=MachineTestReportDATA.getLabBasedMachine(reqList_VO, userVO);
			WebUTIL.setMapInSession(mp, _request);
	...
	public static void setInitDtl(MachineTestReportFB formBean,HttpServletRequest request) {
