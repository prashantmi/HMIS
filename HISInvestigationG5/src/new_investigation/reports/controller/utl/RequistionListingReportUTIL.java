...
public class RequistionListingReportUTIL {
	

	
	public static boolean fetchLab(RequistionlistingReportFB reqListReport_fb, HttpServletRequest _request)
	{
		Status objStatus = new Status();
		RequisitionListingReportVO reqList_VO = new RequisitionListingReportVO();
		try
		{
			...
			mp=RequistionListingReportDATA.fetchLab(reqList_VO, userVO);
	...
	public static boolean fetchTest(RequistionlistingReportFB reqListReport_fb, HttpServletRequest _request)
	{
		Status objStatus = new Status();
		RequisitionListingReportVO reqList_VO = new RequisitionListingReportVO();
		try
		{
			...
			mp=RequistionListingReportDATA.fetchTest(reqList_VO, userVO);
			WebUTIL.setMapInSession(mp, _request);
	...
	public static void setInitDtl(RequistionlistingReportFB formBean,HttpServletRequest request) {
		
		HisUtil util = null;
		
		try {
					
				util = new HisUtil("Patient Reference Report","RequistionListingReportDATA");
			...
			HisException eObj = new HisException("Transport", "RequistionListingReportData->setInitDtl()", 
					strmsgText);
