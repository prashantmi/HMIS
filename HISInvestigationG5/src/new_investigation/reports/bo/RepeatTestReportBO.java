...
import new_investigation.reports.dao.RepeatTestReportDAO;
...
public class RepeatTestReportBO 
{
	...
	public Map fetchLab(RepeatTestReportVO reqList_VO, UserVO _UserVO)
	{
		...
		{
			tx.begin();
			RepeatTestReportDAO reqlist_DAO = new RepeatTestReportDAO(tx);
	...
	public Map fetchTestOnLoad(RepeatTestReportVO reqList_VO, UserVO _UserVO)
	{
		JDBCTransactionContext tx = new JDBCTransactionContext();
		Map mp=new HashMap();
		List lstTest=new ArrayList();
