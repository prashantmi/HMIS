...
import new_investigation.reports.dao.InvestigationListingReportDAO;
...
public class InvestigationListingReportBO 
{
	...
	public Map fetchDept(InvestigationListingReportVO reqList_VO, UserVO _UserVO)
	{
		...
		{
			tx.begin();
			InvestigationListingReportDAO reqlist_DAO = new InvestigationListingReportDAO(tx);
	...
	public Map fetchLabOnLoad(InvestigationListingReportVO reqList_VO, UserVO _UserVO)
	{
		JDBCTransactionContext tx = new JDBCTransactionContext();
		Map mp=new HashMap();
		List lstLab=new ArrayList();
	...
	public Map fetchTestOnLoad(InvestigationListingReportVO reqList_VO, UserVO _UserVO)
	{
		JDBCTransactionContext tx = new JDBCTransactionContext();
		Map mp=new HashMap();
		List lstTest=new ArrayList();
	...
	public Map fetchSampleOnLoad(InvestigationListingReportVO reqList_VO, UserVO _UserVO)
	{
		JDBCTransactionContext tx = new JDBCTransactionContext();
		Map mp=new HashMap();
		List lstSample=new ArrayList();
	...
	public Map fetchRdLab(InvestigationListingReportVO reqList_VO, UserVO _UserVO)
	{
		...
		try
		{
			tx.begin();
			InvestigationListingReportDAO reqlist_DAO = new InvestigationListingReportDAO(tx);
			lstLab=reqlist_DAO.getRdLab(reqList_VO, _UserVO);
			mp.put(InvestigationConfig.LIST_LAB_COMBO,lstLab);
		}
		catch (HisRecordNotFoundException e)
		{
	...
	public Map fetchRdTest(InvestigationListingReportVO reqList_VO, UserVO _UserVO)
	{
		...
		try
		{
			tx.begin();
			InvestigationListingReportDAO reqlist_DAO = new InvestigationListingReportDAO(tx);
			lstTest=reqlist_DAO.getRdTest(reqList_VO, _UserVO);
			lstSample=reqlist_DAO.getSample(reqList_VO, _UserVO);
			mp.put(InvestigationConfig.LIST_TEST_COMBO,lstTest);
			mp.put(InvestigationConfig.LIST_SAMPLE_COMBO,lstSample);
		}
