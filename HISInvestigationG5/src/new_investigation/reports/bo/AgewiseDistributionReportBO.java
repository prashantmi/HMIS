...
import new_investigation.reports.dao.AgewiseDistributionReportDAO;
...
public class AgewiseDistributionReportBO 
{
	...
	public Map fetchDept(AgewiseDistributionReportVO reqList_VO, UserVO _UserVO)
	{
		...
		{
			tx.begin();
			AgewiseDistributionReportDAO reqlist_DAO = new AgewiseDistributionReportDAO(tx);
	...
	public Map fetchLabOnLoad(AgewiseDistributionReportVO reqList_VO, UserVO _UserVO)
	{
		JDBCTransactionContext tx = new JDBCTransactionContext();
		Map mp=new HashMap();
		List lstLab=new ArrayList();
	...
	public Map fetchTestOnLoad(AgewiseDistributionReportVO reqList_VO, UserVO _UserVO)
	{
		JDBCTransactionContext tx = new JDBCTransactionContext();
		Map mp=new HashMap();
		List lstTest=new ArrayList();
	...
	public Map fetchSampleOnLoad(AgewiseDistributionReportVO reqList_VO, UserVO _UserVO)
	{
		JDBCTransactionContext tx = new JDBCTransactionContext();
		Map mp=new HashMap();
		List lstSample=new ArrayList();
