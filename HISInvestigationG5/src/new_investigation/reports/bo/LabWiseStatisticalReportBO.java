...
import new_investigation.reports.dao.LabWiseStatisticalReportDAO;
...
public class LabWiseStatisticalReportBO 
{
	...
	public Map fetchLab(LabWiseStatisticalReportVO reqList_VO, UserVO _UserVO)
	{
		...
		{
			tx.begin();
			LabWiseStatisticalReportDAO reqlist_DAO = new LabWiseStatisticalReportDAO(tx);
	...
	public Map fetchTestOnLoad(LabWiseStatisticalReportVO reqList_VO, UserVO _UserVO)
	{
		JDBCTransactionContext tx = new JDBCTransactionContext();
		Map mp=new HashMap();
		List lstTest=new ArrayList();
