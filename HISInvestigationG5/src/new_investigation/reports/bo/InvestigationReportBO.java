...
import new_investigation.reports.dao.RequisitionListingReportDAO;
...
public class InvestigationReportBO 
{
	...
	public Map fetchLab(RequisitionListingReportVO reqList_VO, UserVO _UserVO)
	{
		...
		{
			tx.begin();
			RequisitionListingReportDAO reqlist_DAO = new RequisitionListingReportDAO(tx);
	...
	public Map fetchTestOnLoad(RequisitionListingReportVO reqList_VO, UserVO _UserVO)
	{
		JDBCTransactionContext tx = new JDBCTransactionContext();
		Map mp=new HashMap();
		List lstTest=new ArrayList();
