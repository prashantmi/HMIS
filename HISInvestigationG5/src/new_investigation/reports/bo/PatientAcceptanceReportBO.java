...
import new_investigation.reports.dao.PatientAcceptanceReportDAO;
...
public class PatientAcceptanceReportBO 
{
	...
	public Map fetchLab(PatientAcceptanceReportVO reqList_VO, UserVO _UserVO)
	{
		...
		{
			tx.begin();
			PatientAcceptanceReportDAO reqlist_DAO = new PatientAcceptanceReportDAO(tx);
	...
	public Map fetchTestOnLoad(PatientAcceptanceReportVO reqList_VO, UserVO _UserVO)
	{
		JDBCTransactionContext tx = new JDBCTransactionContext();
		Map mp=new HashMap();
		List lstTest=new ArrayList();
