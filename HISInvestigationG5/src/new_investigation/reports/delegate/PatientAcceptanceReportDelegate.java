...
import new_investigation.reports.bo.PatientAcceptanceReportBO;
...
public class PatientAcceptanceReportDelegate extends Delegate
{
	public PatientAcceptanceReportDelegate()
	{
		super(new PatientAcceptanceReportBO());
	}  

	public Map fetchLab(PatientAcceptanceReportVO reqList_VO, UserVO _UserVO)
	{
		PatientAcceptanceReportBO serviceBO = (PatientAcceptanceReportBO) super.getServiceProvider();
		return serviceBO.fetchLab(reqList_VO, _UserVO);
	}
	
	public Map fetchTest(PatientAcceptanceReportVO reqList_VO, UserVO _UserVO)
	{
		PatientAcceptanceReportBO serviceBO = (PatientAcceptanceReportBO) super.getServiceProvider();
		return serviceBO.fetchTest(reqList_VO, _UserVO);
	}
	
	public Map fetchDept(PatientAcceptanceReportVO reqList_VO, UserVO _UserVO)
	{
		PatientAcceptanceReportBO serviceBO = (PatientAcceptanceReportBO) super.getServiceProvider();
		return serviceBO.fetchTest(reqList_VO, _UserVO);
	}
