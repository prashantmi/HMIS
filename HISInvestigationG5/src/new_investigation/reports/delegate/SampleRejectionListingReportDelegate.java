...
import new_investigation.reports.bo.SampleRejectionListingReportBO;
...
public class SampleRejectionListingReportDelegate extends Delegate
{
	public SampleRejectionListingReportDelegate()
	{
		super(new SampleRejectionListingReportBO());
	}  

	public Map fetchLab(SampleRejectionListingReportVO reqList_VO, UserVO _UserVO)
	{
		SampleRejectionListingReportBO serviceBO = (SampleRejectionListingReportBO) super.getServiceProvider();
		return serviceBO.fetchLab(reqList_VO, _UserVO);
	}
	
	public Map fetchTest(SampleRejectionListingReportVO reqList_VO, UserVO _UserVO)
	{
		SampleRejectionListingReportBO serviceBO = (SampleRejectionListingReportBO) super.getServiceProvider();
		return serviceBO.fetchTest(reqList_VO, _UserVO);
	}
	
	public Map fetchDept(SampleRejectionListingReportVO reqList_VO, UserVO _UserVO)
	{
		SampleRejectionListingReportBO serviceBO = (SampleRejectionListingReportBO) super.getServiceProvider();
		return serviceBO.fetchTest(reqList_VO, _UserVO);
	}
