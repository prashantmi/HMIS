...
public class SampleCollectionListingReportDAO extends DataAccessObject 
{

	public SampleCollectionListingReportDAO(TransactionContext _tx)
	{
		super(_tx);
	...
	public List getTest(SampleCollectionListingReportVO reqVO, UserVO _UserVO)
	{
		String query="";
		Map populateMap= new HashMap();
		ResultSet rs=null;
