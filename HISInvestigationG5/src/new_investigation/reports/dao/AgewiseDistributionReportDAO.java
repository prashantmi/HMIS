...
public class AgewiseDistributionReportDAO extends DataAccessObject 
{

	public AgewiseDistributionReportDAO(TransactionContext _tx)
	{
		super(_tx);
	...
	public List getLab(AgewiseDistributionReportVO reqVO, UserVO _UserVO)
	{
		String query="";
	...
	public List getTest(AgewiseDistributionReportVO reqVO, UserVO _UserVO)
	{
		String query="";
		Map populateMap= new HashMap();
		ResultSet rs=null;
	...
	public List getSample(AgewiseDistributionReportVO reqVO, UserVO _UserVO)
	{
		String query="";
		Map populateMap= new HashMap();
		ResultSet rs=null;
