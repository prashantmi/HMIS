...
public class RequisitionListingReportDAO extends DataAccessObject 
{

	public RequisitionListingReportDAO(TransactionContext _tx)
	{
		super(_tx);
	...
	public List getTest(RequisitionListingReportVO reqVO, UserVO _UserVO)
	{
		String query="";
		Map populateMap= new HashMap();
		ResultSet rs=null;
