...
public class RepeatTestReportDAO extends DataAccessObject 
{

	public RepeatTestReportDAO(TransactionContext _tx)
	{
		super(_tx);
	...
	public List getTest(RepeatTestReportVO reqVO, UserVO _UserVO)
	{
		String query="";
		Map populateMap= new HashMap();
		ResultSet rs=null;
