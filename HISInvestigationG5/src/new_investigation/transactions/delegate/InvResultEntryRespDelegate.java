...
import new_investigation.transactions.bo.InvResultEntryRespBO;
import new_investigation.transactions.bo.InvResultEntryRespBOi;
...
public class InvResultEntryRespDelegate extends Delegate
{
	public InvResultEntryRespDelegate()
	{
		super(new InvResultEntryRespBO());
	}

	 
	public Map AjaxGetEntryReqnList(InvResultValidationRespVO invResultValidationRespVO , UserVO _UserVO)
	{
		InvResultEntryRespBOi serviceBO = (InvResultEntryRespBOi) super.getServiceProvider();
		return serviceBO.AjaxGetEntryReqnList(invResultValidationRespVO, _UserVO);
	} 
	...
	//get the loinc code
		...
		public Map  modifyResultEntryDetails(List<ResultEntryVO> invResultEntryvo,List<ResultEntryVO>  invResultEntryForParameterDtlVO,  UserVO _userVO,HttpServletRequest _request,InvResultValidationRespFB fb)
		{
			InvResultEntryRespBOi serviceBO = (InvResultEntryRespBOi) super.getServiceProvider();
			 return serviceBO.modifyResultEntryDetails(invResultEntryvo, invResultEntryForParameterDtlVO, _userVO, _request,fb);
		}
