...
//		saveBtnsAnimations(false, false);
		...
		//	alert("crNo"+crNo);
		 	var globalSearchParam22={ crNo:crNo, billNo:"",searchType:"1"};
    		AjaxGetPatDetails(globalSearchParam22);
...
var globalSearchParam={ labCode:"", labDetails:"" reqtypecode:"",dateTypeSelectInput:"", dateFiltersOrBoth:"", fromDateInput:"",
				...
				globalValidationReqnList = data.Machinenewformlist;
					...
					dataTableValidationReqnList( data.Machinenewformlist);  
                       ...
                       //     alert(dateFiltersOrBothhh);
		  	  		if(dateFiltersOrBothhh=="2" || dateFiltersOrBothhh=="1")
		  	  			{
...
function AjaxGetPatDetails121(globalSearchParam) {
