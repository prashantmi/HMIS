...
import new_investigation.transactions.controller.data.InvResultReportPrintingRespDATA;
...
public class InvResultReportPrintingRespUTIL extends ControllerUTIL
{
	public static Map getEssential(InvResultReportPrintingRespFB fb,HttpServletRequest request)
	{
		Status objStatus= new Status();
		 
		UserVO userVO = ControllerUTIL.getUserVO(request);
		InvResultReportPrintingRespVO invresultReportPrintingvo=new InvResultReportPrintingRespVO();
	...
	try{	
		...
		mp=InvResultReportPrintingRespDATA.LabComboForResultReportPrinting(invresultReportPrintingvo, userVO);
	  ...
	  invresultReportPrintingvo.setLabCode("%");
		...
		mpp=InvResultReportPrintingRespDATA.setResultReportPrintingEssentialsOnLoad(invresultReportPrintingvo, userVO);
	...
	public static boolean setResultReportPrintingEssentials(InvResultReportPrintingRespFB fb, HttpServletRequest _request)
	{
		Status objStatus = new Status();
		InvResultReportPrintingRespVO invresultReportPrintingvo=new InvResultReportPrintingRespVO();
		try
		{
			...
			mp=InvResultReportPrintingRespDATA.setResultReportPrintingEssentials(invresultReportPrintingvo, userVO);
	...
	public static void showResultEntryPatDetails(InvResultReportPrintingRespFB fb,HttpServletRequest request,HttpServletResponse response)
	{
		...
		String filename="";
		try{
			List<InvResultReportPrintingRespVO> InvResultReportPrintingVO=null;
			InvResultReportPrintingRespVO invresultentryv = new InvResultReportPrintingRespVO();
			...
			UserVO userVO = ControllerUTIL.getUserVO(request);
			InvResultReportPrintingVO=(List<InvResultReportPrintingRespVO>)session.getAttribute(InvestigationConfig.LIST_RESULT_REPORT_PRINTING_ESSENTIALS_VO);
			...
			for(int i=0;i<arrSelectedRequisitions.length;i++)
			 {
				for(InvResultReportPrintingRespVO objPatientCollectionVO:InvResultReportPrintingVO)
				{
			...
			/*int i=0;
				...
				mp=InvResultReportPrintingRespDATA.PdfDetails(lstInvResultReportPrintingVO,  userVO);

				
				
				List<InvResultReportPrintingRespVO> lstInvResultEntryTemplateVO=null;
				//System.out.println(lstInvResultEntryTemplateVO.get(0).getResultEntryVOListValidatedBy().get(0).getTemplateDocumentString());
				List<InvResultReportPrintingRespVO> lstSampleAccepted=(List)mp.get(InvestigationConfig.LIST_RESULT_REPORT_PRINTING_PDF_DETAIL);
				WebUTIL.setMapInSession(mp, request);

				List<byte[]> pdfs = new ArrayList<byte[]>();
				 
				
				Map<String,List<InvResultReportPrintingRespVO>> objMapSamAcc= new HashMap<String,List<InvResultReportPrintingRespVO>>();
				...
				{
					InvResultReportPrintingRespVO objResultEntryVO = lstSampleAccepted.get(j);
					List<InvResultReportPrintingRespVO> lstTempResultEntryVO = null;
					...
					{
						lstTempResultEntryVO=new ArrayList<InvResultReportPrintingRespVO>();
				...
				filename=filename+".pdf";
					...
					// response.setHeader("Cache-Control", "no-cache");
					 ...
					 // System.out.println("------------------->"+output); 
						mp=InvResultReportPrintingRespDATA.saveResultReportPrintingDetails(lstInvResultReportPrintingVO,  userVO);
	...
	public static void printReport(InvResultReportPrintingRespFB fb, HttpServletRequest objRequest_p,HttpServletResponse response)
	{
	...
	public static void showResultEntryPatDetails_viewinv(InvResultReportPrintingRespFB fb,HttpServletRequest request,HttpServletResponse response)
	{
		Status status = new Status();
		HttpSession session=request.getSession();
		StringBuffer sbAjaxRes = new StringBuffer();
	...
	public static void showResultEntryPatDetailsFTP(InvResultReportPrintingRespFB fb,HttpServletRequest request,HttpServletResponse response)
	{
		Status status = new Status();
		HttpSession session=request.getSession();
		StringBuffer sbAjaxRes = new StringBuffer();
	...
	public static void showResultEntryPatDetailsFTPnew(InvResultReportPrintingRespFB fb,HttpServletRequest request,HttpServletResponse response)
	{
		Status status = new Status();
		HttpSession session=request.getSession();
		StringBuffer sbAjaxRes = new StringBuffer();
	...
	public static void printReportFTP(InvResultReportPrintingRespFB fb, HttpServletRequest objRequest_p,HttpServletResponse response)
	{
	...
	public static void showResultEntryPatDetails_viewinvFTP(InvResultReportPrintingRespFB fb,HttpServletRequest request,HttpServletResponse response)
	{
		Status status = new Status();
		HttpSession session=request.getSession();
		StringBuffer sbAjaxRes = new StringBuffer();
	...
	public static String isfromFTPorMONGO(HttpServletRequest request,HttpServletResponse response)
	{
		...
		flg=InvResultReportPrintingRespDATA.isfromFTPorMONGO( userVO);
