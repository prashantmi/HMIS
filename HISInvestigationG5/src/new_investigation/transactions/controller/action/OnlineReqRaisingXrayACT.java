  ...
  extends CSRFGardTokenAction
{
  ...
  public ActionForward NEW(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
    ...
    session.setAttribute("loadfromdesk", "0");
    session.setAttribute("loadfromdesk_new", "0");
  ...
  public ActionForward GETPATDTL(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
    ...
    if (session.getAttribute("loadfromdesk_new") != null) {
    	...
    	String  datadesk= (String) (session.getAttribute("loadfromdesk_new"));
    	
    	if(datadesk.equals("1"))
        {
    		fb.setAdivcedbycode(userVO.getUserEmpID());
    		fb.setAdivcedbyname(userVO.getUsrName());
  ...
  public ActionForward SAVEXRAYPROCESS(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
    ...
    if(fb.getAdvisedby()!=null && !fb.getAdvisedby().equals(""))
    fb.setAdivcedbyname(fb.getAdvisedby());
    ...
    if (session.getAttribute("loadfromdesk_new") != null) {
    	...
    	if(datadesk.equals("1"))
        session.setAttribute("loadfromdesk", "1");
  ...
  public ActionForward EXTNEW(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
	    HttpSession session = WebUTIL.getSession(request);
	    ...
	    String strBuff = InvestigationRaisingDtlXrayUTL.getisexistpatcrno(fb, request);

	    session.setAttribute("loadfromdesk_new", "1");
	    session.setAttribute("loadfromdesk", "0");
