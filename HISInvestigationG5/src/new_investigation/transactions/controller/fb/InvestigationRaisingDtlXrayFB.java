  ...
  extends ActionForm
{
  ...
  private String  advicedbyid;

  private String  advicebyname;
...
public void setAdvicedbyid(String advicedbyid) {
	this.advicedbyid = advicedbyid;
}




public String getAdvicebyname() {
	return advicebyname;
}
...
public void setAdvicebyname(String advicebyname) {
	this.advicebyname = advicebyname;
}
