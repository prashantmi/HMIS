...
public class invRaisingCumSamCollectionFB extends ActionForm
{
	...
	private String tmpUomCode;
	private String tmpContainerCode;
	private String tmpContainerVolume;
	...
	public String getTmpUomCode() {
		return tmpUomCode;
	}


	public void setTmpUomCode(String tmpUomCode) {
		this.tmpUomCode = tmpUomCode;
	}


	public String getTmpContainerCode() {
		return tmpContainerCode;
	}


	public void setTmpContainerCode(String tmpContainerCode) {
		this.tmpContainerCode = tmpContainerCode;
	}


	public String getTmpContainerVolume() {
		return tmpContainerVolume;
	}


	public void setTmpContainerVolume(String tmpContainerVolume) {
		this.tmpContainerVolume = tmpContainerVolume;
	}
	...
	public String[] getAllotAppointment() {
		return allotAppointment;
	}


	public void setAllotAppointment(String[] allotAppointment) {
		this.allotAppointment = allotAppointment;
	}


	public String getDupPatCrNo() {
		return dupPatCrNo;
	}


	public void setDupPatCrNo(String dupPatCrNo) {
		this.dupPatCrNo = dupPatCrNo;
	}
