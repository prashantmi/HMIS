...
public class InvResultValidationRespFB extends ActionForm
{
	...
	private String validationOrRevalidationProcess;

	private String isMachineBasedEntry;



	public String getIsMachineBasedEntry() {
		return isMachineBasedEntry;
	}
	public void setIsMachineBasedEntry(String isMachineBasedEntry) {
		this.isMachineBasedEntry = isMachineBasedEntry;
	}
	public String getValidationOrRevalidationProcess() {
		return validationOrRevalidationProcess;
	}
	public void setValidationOrRevalidationProcess(String validationOrRevalidationProcess) {
		this.validationOrRevalidationProcess = validationOrRevalidationProcess;
	}
   ...
   private String empNameWise[];
	...
	public String getIsraisingsave() {
		return israisingsave;
	}

	public void setIsraisingsave(String israisingsave) {
		this.israisingsave = israisingsave;
	}
	...
	private String addendumRemarksValue[];
	...
	private String ispreview="1";

	private String testCodee;

	private String  iscallfromonloaddynamic;
    ...
    private String chkSendToMachine;

    private String ChkSendToMachinetest;


    //added by krishnan nema on 01/02/2019
    public String isSaveToDraft;
    public byte[] fileuploaddata;
    public String fileuploaddatabase64;
	...
	public String getChkSendToMachine() {
		return chkSendToMachine;
	}
	public void setChkSendToMachine(String chkSendToMachine) {
		this.chkSendToMachine = chkSendToMachine;
	}


	public String getChkSendToMachinetest() {
		return ChkSendToMachinetest;
	}
	public void setChkSendToMachinetest(String chkSendToMachinetest) {
		ChkSendToMachinetest = chkSendToMachinetest;
	}
	...
	public String[] getAddendumRemarksValue() {
		return addendumRemarksValue;
	}
	...
	public void setAddendumRemarksValue(String[] addendumRemarksValue) {
		this.addendumRemarksValue = addendumRemarksValue;
	}
	...
	public String getIscallfromonloaddynamic() {
		return iscallfromonloaddynamic;
	}
	public void setIscallfromonloaddynamic(String iscallfromonloaddynamic) {
		this.iscallfromonloaddynamic = iscallfromonloaddynamic;
	}
	...
	public void setFileuploaddata(byte[] fileuploaddata) {
