...
public class InvPatientAcceptanceRespDAO extends DataAccessObject implements InvPatientAcceptanceRespDAOi
{
  public InvPatientAcceptanceRespDAO(JDBCTransactionContext _tx) { super(_tx); }

  public List<InvPatientAcceptanceRespVO> AjaxGetPatAcceptanceReqnList(InvPatientAcceptanceRespVO invPatientAcceptanceRespVO, UserVO _UserVO) {
	    ResultSet rs = null;
	    String query = "";
	    Map populateMAP = new HashMap();
	    String fromAlpha = "";
	    String toAlpha = "";
	    String filename = "new_investigation.transactions.invPatAcceptanceRespQuery";

	    String queryKey = "";
	    queryKey = "SELECT.PAT.ACCEPTANCE.HIVT_REQUISITION_HEADER";
	    ...
	    if (!invPatientAcceptanceRespVO.getCollAreaCode().equals("0")) {
	    ...
	    if (invPatientAcceptanceRespVO.getDateFiltersOrBoth()!=null & (invPatientAcceptanceRespVO.getDateFiltersOrBoth().equals("0") || invPatientAcceptanceRespVO.getDateFiltersOrBoth().equals("1"))) {

	    	if(invPatientAcceptanceRespVO.getDateTypeCode().equals("1")){
	    	...
	    	if(invPatientAcceptanceRespVO.getDateTypeCode().equals("2")){
	    ...
	    if (invPatientAcceptanceRespVO.getDateFiltersOrBoth()!= null && (invPatientAcceptanceRespVO.getDateFiltersOrBoth().equals("1") || invPatientAcceptanceRespVO.getDateFiltersOrBoth().equals("2")) && invPatientAcceptanceRespVO.getCrNo()!= null && !invPatientAcceptanceRespVO.getCrNo().equals(""))
	    {	String crNoClause = " AND a.hrgnum_puk_reqd=" + invPatientAcceptanceRespVO.getCrNo();
	    	query = String.valueOf(query) + crNoClause;
	    }
	    
	    //Condition for filtering by requisitionNo
	    if (invPatientAcceptanceRespVO.getDateFiltersOrBoth()!= null && (invPatientAcceptanceRespVO.getDateFiltersOrBoth().equals("1") || invPatientAcceptanceRespVO.getDateFiltersOrBoth().equals("2")) && invPatientAcceptanceRespVO.getRequisitionNo()!= null && !invPatientAcceptanceRespVO.getRequisitionNo().equals(""))
	     {	String requisitionNoClause = "And a.hivnum_req_no=" + invPatientAcceptanceRespVO.getRequisitionNo();
	    	query = String.valueOf(query) + requisitionNoClause;
	     }
	      
	    //Condition for filtering by Requisition Status
	    String reqnStatusClause = "";
	    if (invPatientAcceptanceRespVO.getPatAcceptanceStatusCode() != null && invPatientAcceptanceRespVO.getPatAcceptanceStatusCode().equals("1")) {
	    	reqnStatusClause = " and hivnum_reqdtl_status in (5,10)";
	    	//reqnStatusClause = " AND EXISTS ( SELECT 1 FROM HIVT_REQUISITION_DTL WHERE HIVNUM_REQDTL_STATUS IN ( 5 ,10 ) AND GNUM_HOSPITAL_CODE = A.GNUM_HOSPITAL_CODE AND HIVNUM_REQ_NO = A.HIVNUM_REQ_NO ) ";
	    } else if (invPatientAcceptanceRespVO.getPatAcceptanceStatusCode() != null && invPatientAcceptanceRespVO.getPatAcceptanceStatusCode().equals("2")) {
	    	reqnStatusClause = " and hivnum_reqdtl_status in (6) and exists(select GNUM_TEST_CODE from HIVT_TEST_MST c where c.GNUM_ISVALID = 1 AND LOWER(c.GSTR_TeST_TYPE) = 'p' and c.GNUM_TEST_CODE=a.GNUM_TEST_CODE)";
	    	//reqnStatusClause = " AND EXISTS ( SELECT 1 FROM HIVT_REQUISITION_DTL b ,HIVT_TEST_MST c WHERE HIVNUM_REQDTL_STATUS IN (6) AND b.GNUM_HOSPITAL_CODE = A.GNUM_HOSPITAL_CODE AND b.HIVNUM_REQ_NO = A.HIVNUM_REQ_NO AND b.GNUM_TEST_CODE = c.GNUM_TEST_CODE AND c.GNUM_ISVALID = 1 AND LOWER(c.GSTR_TeST_TYPE) = 'p' ) ";
	    }
	    query = String.valueOf(query) + reqnStatusClause;

	    //Condition for filtering by Lab Code
	    String labFilterClause = "";
	    if (invPatientAcceptanceRespVO.getLabCode().equals("0")) {
	    	labFilterClause = " and a.gnum_lab_code like '%' ";
	    } else {
	    	labFilterClause = " and a.gnum_lab_code=" + invPatientAcceptanceRespVO.getLabCode();
	    }
	    query = String.valueOf(query) + labFilterClause;

	    //Order by Clause
	    query = String.valueOf(query) + "ORDER BY gbnum_priority_code desc, "+orderByDateClause;
	    ...
	    try {
	      ...
	      if (!invPatientAcceptanceRespVO.getCollAreaCode().equals("0")) {
	      	populateMAP.put(sq.next(), invPatientAcceptanceRespVO.getCollAreaCode());
	        }


	      if (invPatientAcceptanceRespVO.getDateFiltersOrBoth().equals("0") || invPatientAcceptanceRespVO.getDateFiltersOrBoth().equals("1")) {
	        populateMAP.put(sq.next(), invPatientAcceptanceRespVO.getFromDate());
	        populateMAP.put(sq.next(), invPatientAcceptanceRespVO.getToDate());
	      }
	    ...
	    try {
	      ...
	      if (rs.next())
	      {
	        rs.beforeFirst();
	        while (rs.next()) {
	        InvPatientAcceptanceRespVO invPatientAcceptanceRespVO2 = new InvPatientAcceptanceRespVO();
	        HelperMethods.populateVOfrmRS(invPatientAcceptanceRespVO2, rs);
	        lstInvPatientAcceptanceRespVO.add(invPatientAcceptanceRespVO2);
	        }
	      }
		      ...
		      throw new HisDataAccessException("InvPatientAcceptanceRespDao:HelperMethods :: " + e);
	     }
	    return lstInvPatientAcceptanceRespVO;
	  }
  ...
  public List<InvPatientAcceptanceRespVO> setPatientEssentials(InvPatientAcceptanceRespVO onlinePatientvo, UserVO _UserVO) {
    ...
    try {
      ...
      if (rs.next())
      {
        ...
        rs.beforeFirst();
        valueObjects = HelperMethods.populateVOfrmRS(InvPatientAcceptanceRespVO.class, rs);
        
        for (int i = 0; i < valueObjects.length; i++)
        {
          
          lstInvPatientAcceptanceRespVO.add((InvPatientAcceptanceRespVO)valueObjects[i]);
        }
      }
      ...
      e.printStackTrace();
      throw new HisDataAccessException("InvPatientAcceptanceRespDAO:setPatientEssentials:HelperMethods :: " + e);
    } 
  ...
  public List<InvPatientAcceptanceRespVO> patientDetails(String reqNo, String reqType, String acceptedToNotAccepted, UserVO _UserVO) {
    String query = "";
    Map populateMAP = new HashMap();
    ResultSet rs = null;
    String filename = "new_investigation.transactions.investigationTransactionQuery";
    ...
    if(_UserVO.getHospitalCode().equals("10911") || _UserVO.getHospitalCode().equals("961011"))
	{
    	queryKey = "SELECT.PATIENT_HIVT_REQUISITION_HEADER_patna";
	}
	else
	{
		queryKey = "SELECT.PATIENT_HIVT_REQUISITION_HEADER";
	}
    Sequence sq = new Sequence();
    
    InvPatientAcceptanceRespVO voPatientCollection = null;
    
    List<InvPatientAcceptanceRespVO> lstInvPatientCollectionVO = null;
    ...
    try {
      ...
      if (rs.next()) {
        ...
        rs.beforeFirst();
        lstInvPatientCollectionVO = new ArrayList<InvPatientAcceptanceRespVO>();
        while (rs.next()) {
          voPatientCollection = new InvPatientAcceptanceRespVO();
  ...
  public void updateRequisitionHeaderForPatient(InvPatientAcceptanceRespVO voPatient, String patAddress, String reqNo, UserVO _UserVO) {
    String query = "";
    Map populateMAP = new HashMap();
    Sequence sq = new Sequence();
    String filename = "new_investigation.transactions.investigationTransactionQuery";
  ...
  public void updateRequisitionDtlForPatient(InvPatientAcceptanceRespVO voPatient, UserVO _UserVO) {
    String query = "";
    Map populateMAP = new HashMap();
    Sequence sq = new Sequence();
    String filename = "new_investigation.transactions.investigationTransactionQuery";
  ...
  public void updateRequisitionDtlForPatientRescheduled(InvPatientAcceptanceRespVO voPatient, UserVO _UserVO) {
    String query = "";
    Map populateMAP = new HashMap();
    Sequence sq = new Sequence();
    String filename = "new_investigation.transactions.investigationTransactionQuery";
  ...
  public void updateRequisitionDtlForPatientAccepted(InvPatientAcceptanceRespVO voPatient, UserVO _UserVO) {
    String query = "";
    Map populateMAP = new HashMap();
    Sequence sq = new Sequence();
    String filename = "new_investigation.transactions.investigationTransactionQuery";
  ...
  public void insertPatientDtlForPatient(String pataccNo, InvPatientAcceptanceRespVO voPatient, UserVO _userVO) {
    String query = "";
    Map populateMAP = new HashMap();
    Sequence sq = new Sequence();
    String filename = "new_investigation.transactions.investigationTransactionQuery";
  ...
  public void insertPatientNotAcceptedDtlForPatient(String pataccNo, InvPatientAcceptanceRespVO voPatient, UserVO _userVO) {
    String query = "";
    Map populateMAP = new HashMap();
    Sequence sq = new Sequence();
    String filename = "new_investigation.transactions.investigationTransactionQuery";
  ...
  public boolean checkDailyLabNoDuplicacy(InvPatientAcceptanceRespVO voPatient, UserVO _UserVO) {
    String query = "";
    Map populateMap = new HashMap();
    ResultSet rs = null;
  ...
  public List getPatientAcceptanceAutoLabNOConfig(InvPatientAcceptanceRespVO onlineAcceptanceVO, UserVO _UserVO) {
    ResultSet rs = null;
    String query = "";
    Map populateMAP = new HashMap();
    String filename = "new_investigation.transactions.investigationTransactionQuery";
    ...
    List<InvPatientAcceptanceRespVO> listSampleAcceptanceVO = new ArrayList<InvPatientAcceptanceRespVO>();
    ValueObject[] valueObjects = null;
    ...
    try {
      ...
      if (rs.next())
      {
        ...
        listSampleAcceptanceVO.add((InvPatientAcceptanceRespVO)valueObjects[0]);
  ...
  public void updatePatientAccInhivtlabnoconfmst(InvPatientAcceptanceRespVO voSamAcc, String finalEntryDate, UserVO _UserVO) {
    String query = "";
    Map populateMAP = new HashMap();
    Sequence sq = new Sequence();
    String filename = "new_investigation.transactions.investigationTransactionQuery";
  ...
  public void updatePatientAccInhivtlabnoconfmstResetLabNO(InvPatientAcceptanceRespVO voSamAcc, String finalEntryDate, UserVO _UserVO) {
    String query = "";
    Map populateMAP = new HashMap();
    Sequence sq = new Sequence();
    String filename = "new_investigation.transactions.investigationTransactionQuery";
  ...
  public List<InvPatientAcceptanceRespVO> checkAutoGenFormate(InvPatientAcceptanceRespVO online, UserVO _UserVO) {
    String query = "";
    Map populateMap = new HashMap();
    ResultSet rs = null;
    ...
    List<InvPatientAcceptanceRespVO> onlinepatientacceptancevo = new ArrayList<InvPatientAcceptanceRespVO>();
    ValueObject[] valueObjects = null;
    ...
    try {
      ...
      if (rs.next())
      {
        ...
        onlinepatientacceptancevo.add((InvPatientAcceptanceRespVO)valueObjects[0]);
      }
  ...
  public String checkAutoGenFormateRunningLabNo(InvPatientAcceptanceRespVO online, UserVO _UserVO) {
    ResultSet rs = null;
    String query = "";
    Map populateMAP = new HashMap();
    String Formate = "";
  ...
  public List<InvPatientAcceptanceRespVO> checkAutoGenFormateAreawise(InvPatientAcceptanceRespVO online, UserVO _UserVO) {
    String query = "";
    Map populateMap = new HashMap();
    ResultSet rs = null;
    List<String> Formate = new ArrayList<String>();
  ...
  public String checkAutoGenFormateRunningLabNoAreaWise(InvPatientAcceptanceRespVO online, UserVO _UserVO) {
    ResultSet rs = null;
    String query = "";
    Map populateMAP = new HashMap();
    String Formate = "";
  ...
  public String getmaxidreasonmstt(InvPatientAcceptanceRespVO rejectionreasonmaster_VO, UserVO _UserVO) {
    String query = "";
    Map populateMap = new HashMap();
    ResultSet rs = null;
    String Formate = "";
  ...
  public void insertreasonmst(InvPatientAcceptanceRespVO rejectionreasonmaster_VO, UserVO _UserVO, String fromwherecalling, String idd) {
    String query = "";
    Map populateMAP = new HashMap();
    Sequence sq = new Sequence();
    String filename = "new_investigation.transactions.investigationTransactionQuery";
  ...
  public void updatePatientNotAcceptedDtlForPatient(String pataccNo, InvPatientAcceptanceRespVO voPatient, UserVO _userVO) {
    String query = "";
    Map populateMAP = new HashMap();
    Sequence sq = new Sequence();
    String filename = "new_investigation.transactions.investigationTransactionQuery";
  ...
  public void updatePatientAcceptedDtlForPatient(String pataccNo, InvPatientAcceptanceRespVO voPatient, UserVO _userVO) {
    String query = "";
    Map populateMAP = new HashMap();
    Sequence sq = new Sequence();
    String filename = "new_investigation.transactions.investigationTransactionQuery";
  ...
  public String selectPataccNoPatientAcceptedDtl(InvPatientAcceptanceRespVO voPatient, UserVO _userVO) {
    String patAccNo = "";
    String query = "";
    Map populateMap = new HashMap();
    ResultSet rs = null;
  ...
  public Map getUserList(UserVO _UserVO) {
    ...
    ResultSet rs = null;
    String filename = "new_investigation.transactions.invPatAcceptanceRespQuery";
    String queryKey = "SELECT.GNUM_USERID.HIVT_RADIOLOGY_MST";
    Sequence sq = new Sequence();
    Connection conn = getTransactionContext().getConnection();
  ...
  public void updateRequisitionHeaderForPatient_dtl(InvPatientAcceptanceRespVO voPatient, String patAddress, String reqNo, UserVO _UserVO) {
	    String query = "";
	    Map populateMAP = new HashMap();
	    Sequence sq = new Sequence();
	    String filename = "new_investigation.transactions.investigationTransactionQuery";
