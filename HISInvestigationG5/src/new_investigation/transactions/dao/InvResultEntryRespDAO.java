  ...
  extends DataAccessObject
{
  ...
  public List<InvResultValidationRespVO> AjaxGetEntryReqnList(InvResultValidationRespVO invResultValidationRespVO, UserVO _UserVO) {
      ...
      {	//String crNoClause = "And (Select hrgnum_puk from hivt_requisition_header where gnum_hospital_code = a.gnum_hospital_code and hivnum_req_no = a.hivnum_req_no)=" + invResultValidationRespVO.getCrNo();
    	  String crNoClause = "And a.hrgnum_puk_reqd=" + invResultValidationRespVO.getCrNo();
      ...
      if(invResultValidationRespVO.getIsMachineBasedEntry() !=null && invResultValidationRespVO.getIsMachineBasedEntry().equals("0")){
        if (invResultValidationRespVO.getResultEntryStatusCode() != null && invResultValidationRespVO.getResultEntryStatusCode().equals("1")) {
        	...
        	reqnStatusClause = " and hivnum_reqdtl_status in (7,13,26) and a.gnum_machine_code in (NULL, -1)";
        	...
        	reqnStatusClause = " and hivnum_reqdtl_status in (27)  and a.gnum_machine_code in (NULL, -1)";
        }
      } else if (invResultValidationRespVO.getIsMachineBasedEntry() !=null && invResultValidationRespVO.getIsMachineBasedEntry().equals("1")){
        if (invResultValidationRespVO.getResultEntryStatusCode() != null && invResultValidationRespVO.getResultEntryStatusCode().equals("1")) {
        	reqnStatusClause = " and hivnum_reqdtl_status in (17) and a.gnum_machine_code NOT IN (-1) and a.gnum_machine_code IS NOT NULL";
        } else if (invResultValidationRespVO.getResultEntryStatusCode() != null && invResultValidationRespVO.getResultEntryStatusCode().equals("2")) {
        	reqnStatusClause = " and hivnum_reqdtl_status in (7,13,26) and a.gnum_machine_code NOT IN (-1) and a.gnum_machine_code IS NOT NULL";
        } else if (invResultValidationRespVO.getResultEntryStatusCode() != null && invResultValidationRespVO.getResultEntryStatusCode().equals("3")) {
        	reqnStatusClause = " and hivnum_reqdtl_status in (27) and a.gnum_machine_code NOT IN (-1) and a.gnum_machine_code IS NOT NULL";
        }
      }
  ...
  public void updateResultEntryInRequisitionDtl(InvResultValidationRespVO invResultValidationRespVO, UserVO _UserVO) {
    ...
    String queryKey_new = "UPDATE.REQDTLS.RESULT.ENTRY.HIVT_REQUISITION_DTLS_NEW";
  ...
  public void updateModifyResultEntryInRequisitionDtl(ResultEntryVO voResultEntry, UserVO _UserVO) {
    ...
    String queryKey_new = "UPDATE.REQDTLS.RESULT.ENTRY.MODIFY.HIVT_REQUISITION_DTLS_NEW";
    String queryKey_FILEUPLOAD_new = "UPDATE.REQDTLS.RESULT.ENTRY.MODIFY.HIVT_REQUISITION_DTLS_FILEUPLOAD_NEW";
    ...
    try {
      if (voResultEntry.getFileuploaddata() != null && !voResultEntry.getFileuploaddata().equals("")) {
        ...
        query_new = HelperMethodsDAO.getQuery(filename, queryKey_FILEUPLOAD_new);
  ...
  public void modifyResultValidationDtl(ResultEntryVO voResultValidation, UserVO _UserVO) {
    ...
    String queryKey_new = "UPDATE.RESULT.ENTRY.DETAIL.HIVT_PARAMETER_DTL_NEW";
    String queryKey_FILEUPLOAD_new = "UPDATE.RESULT.ENTRY.DETAIL.HIVT_PARAMETER_DTL_FILEUPLOAD_NEW";
    ...
    try {
      ...
      HelperMethodsDAO.excecuteUpdate(getTransactionContext()
              .getConnection(), query_new, populateMAP);
  ...
  public void updateFinalRemarkEmpCodeInRequisitionHeader(String reqNo, String finalRemark, String empCode, UserVO _UserVO) {
    ...
    String queryKey_new = "UPDATE.FINALREMARK.EMPCODE.HIVT_REQUISITION_HEADER_NEW";
