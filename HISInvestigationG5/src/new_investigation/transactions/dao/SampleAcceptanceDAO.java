...
public class SampleAcceptanceDAO extends DataAccessObject implements SampleAcceptanceDAOi
{
	...
	public List getSampleAcceptanceRejectionCombo(UserVO _UserVO)
	{
		...
		public void updateSampleAccInRequisitionDtl(SampleAcceptanceVO voSamAcc,  UserVO _userVO) {
			...
			String queryKey1_new ="UPDATE.SAMPLEACCDETAIL.HIVT_REQUISITION_DTL_NEW";
            String queryKey2_new="UPDATE.SAMPLE_NOTACC_DETAIL.HIVT_REQUISITION_DTL_NEW";
            String queryKey3_new="UPDATE.SAMPLE_RESCHEDULED_ACCDETAIL.HIVT_REQUISITION_DTL_NEW";
            String queryKey_new="UPDATE.SAMPLE_RECIEVE_NO_DETAIL.HIVT_REQUISITION_DTL_NEW";
				 ...
				 if(voSamAcc.getRecieved().equals(InvestigationConfig.RECIEVED_STATUS))//1
			 {
			    ...
			    else
			    {
			    	if(voSamAcc.getRejectionAction().equals(InvestigationConfig.REJECTION_ACTION_CANCELLED_STATUS))//1
			    	{
			    		...
			    		query_new = HelperMethodsDAO.getQuery(filename, queryKey2_new);
			    	...
			    	if(voSamAcc.getRejectionAction().equals(InvestigationConfig.REJECTION_ACTION_RESCHEDULED_STATUS))//2
			    	{
			    		...
			    		query_new = HelperMethodsDAO.getQuery(filename, queryKey3_new);
...
//START Sample Acceptance Through BarCode
		...
		public void updateSampleAccInRequisitionDtlToReject(SampleAcceptanceVO voSamAcc,  UserVO _userVO) {
            ...
            String queryKey2_new="UPDATE.ACCEPTED_SAMPLE_NOTACC_DETAIL.HIVT_REQUISITION_DTL_NEW";
            String queryKey3_new="UPDATE.ACCEPTED_SAMPLE_RESCHEDULED_ACCDETAIL.HIVT_REQUISITION_DTL_NEW";
		...
		public void updateSampleAccInRequisitionDtlModify(SampleAcceptanceVO voSamAcc,  UserVO _userVO) {
            ...
            String queryKey1_new="UPDATE_SAMPLE_ACC_MACHINE_DTL.HIVT_REQUISITION_DTL_NEW";
            String queryKey3_new="UPDATE_SAMPLE_ACC_MACHINE_DTL_NO_MACHINE.HIVT_REQUISITION_DTL_NEW";
            String queryKey4_new="UPDATE_HGSTR_DAILY_LABNO.HIVT_REQUISITION_DTL_NEW";
            ...
            try {
            		...
            		query1_new = HelperMethodsDAO.getQuery(filename, queryKey3_new);
					query3_new = HelperMethodsDAO.getQuery(filename, queryKey4_new);
			...
			try {
				...
				HelperMethodsDAO.excecuteUpdate(super.getTransactionContext().getConnection(), query1_new, populateMAP);
		    		...
		    		if(voSamAcc.getCheckLabConfigForAutoGen().equals("1")){
		    			...
		    			HelperMethodsDAO.excecuteUpdate(super.getTransactionContext().getConnection(), query3_new, populateMAP2);
