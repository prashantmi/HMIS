...
public class InvestigationBillingDAOreq extends DataAccessObject implements InvestigationBillingDAOi
{
	public InvestigationBillingDAOreq(JDBCTransactionContext _tx)
	{
		super(_tx);
	}
	...
	public void insertviewsdetail(String testcode,String viewcode,String viewcount,String reqno, String reqdno, UserVO voo,int toalcountviews,String type) {
		...
		String filename = InvestigationConfig.QUERY_FILE_FOR_INVESTIGATION_TRANSACTIONDAO_REQ;
