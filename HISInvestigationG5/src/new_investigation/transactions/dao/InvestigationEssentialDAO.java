...
public class InvestigationEssentialDAO extends DataAccessObject implements InvestigationEssentialDAOi
{
	...
	public List<LabTestVO> searchBookMark(InvestigationSearchVO searchVO, UserVO _UserVO) {
		...
		String condition2 = "  hivtnum_lab_code=labcode AND hivtnum_test_code=testcode and gnum_hospital_Code=dd)";
...
condition4="AND GNUM_LAB_CODE IN ( SELECT GNUM_LAB_CODE FROM HIVT_LAB_COLLECTION_AREA_MST WHERE GNUM_ISVALID = 1 AND gnum_hospital_Code  = "+userVO.getHospitalCode()+" AND GNUM_AREA_CODE = "+vo.getSampleAreaCode()+" ) order by hivt_entry_date desc";	
				}
				else
				{

		condition4="and  EXISTS ( SELECT 1 FROM HIVT_COLLECTION_AREA_MST z WHERE z.gnum_area_code ="+vo.getSampleAreaCode()+"  and z.hipnum_ward_code=a.hipnum_wardcode_reqd and z.gnum_hospital_code="+userVO.getHospitalCode()+" and gnum_isvalid=1) order by hivt_entry_date desc";
