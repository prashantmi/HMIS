  ...
  extends DataAccessObject
{
  ...
  public  Map AjaxGetLabList(InvResultValidationRespVO invResultValidationRespVO, UserVO _UserVO) {
    ...
    String filename = "new_investigation.transactions.invResultValidationRespQuery";
    String queryKey = "SELECT.LAB.DTLS.HIVT_LABORATORY_MST";
    Sequence sq = new Sequence();
    ...
    try {
      ...
      rs.beforeFirst();
		while(rs.next()) {
			InvResultValidationRespVO VO2 = new InvResultValidationRespVO();
			HelperMethods.populateVOfrmRS(VO2, rs);
			listInvResultValidationRespVO.add(VO2);
		}
		mp.put("labListDetails", listInvResultValidationRespVO);
  ...
  public void updateResultValidationInRequisitionDtl(InvResultValidationRespVO invResultValidationRespVO, UserVO _UserVO) {
    ...
    String queryKey_new = "UPDATE.REQDTLS.RESULT.VALIDATION.HIVT_REQUISITION_DTLS_NEW";
    ...
    try {
      if (invResultValidationRespVO.getIsSendToMachine() != null && invResultValidationRespVO.getIsSendToMachine().equals("1")) {
        ...
        query_new = HelperMethodsDAO.getQuery(filename, queryKeySendToMachine_new);
  ...
  public void updateResultValidationInRequisitionDtlDraftLog(ResultEntryVO voResultEntry, UserVO _UserVO) {
    ...
    String queryKey_new = "UPDATE_HIVT_REQUISITION_DTL_DRAFT_REQ_LOG_NEW";
  ...
  public void updateResultValidationInRequisitionDtlfileupload(ResultEntryVO voResultValidation, UserVO _UserVO) {
    ...
    String queryKey_new = "UPDATE.REQDTLS.RESULT.VALIDATION.HIVT_REQUISITION_DTLS_FILEUPLOAD_NEW";
    String queryKeySendToMachine_new = "UPDATE.REQDTLS.RESULT.VALIDATION.HIVT_REQUISITION_DTLS_SEND_TO_MACHINE_NEW";
