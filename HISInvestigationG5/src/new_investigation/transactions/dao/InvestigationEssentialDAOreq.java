...
public class InvestigationEssentialDAOreq
  extends DataAccessObject
  implements InvestigationEssentialDAOi
{
  public InvestigationEssentialDAOreq(JDBCTransactionContext _tx) { super(_tx); }
  ...
  public void insertRequisitionDtl(InvestigationRequistionVO voLabTest, UserVO _userVO, String priorityAll, RequistionHeaderVO voReqHeader) {
    ...
    try {
      ...
      strProc.addInParameter(100, 12, voReqHeader.getIs_vip()==null?"":voReqHeader.getIs_vip());
      ...
      strProc.addInParameter(105, 12, voReqHeader.getRequisitionwiseno()==null?"":voReqHeader.getRequisitionwiseno());
      strProc.addInParameter(106, 12, voReqHeader.getInstruction_testwise()==null?"":voReqHeader.getInstruction_testwise());
      strProc.addInParameter(107, 12, voReqHeader.getIs_unknown()==null?"":voReqHeader.getIs_unknown());

      
      strProc.addInOutParameter(108, 12, "");
  ...
  public void deleteReqDtl(InvestigationSearchVO searchVO, UserVO _UserVO) {
    ...
    String queryKey_new = "UPDATE.REQUISITIONSTATUS.HIVT_REQUISITION_DTL_NEW";
    String queryKey1_new = "DELETE_GROUP_WISE_RAISING_NEW";
    ...
    try {
      ...
      if (searchVO.getGroupcode() != null && !searchVO.getGroupcode().equals("0"))
      {
        ...
        query_new = HelperMethodsDAO.getQuery(filename, queryKey1_new);
  ...
  public void saveAppointmentDetail(InvestigationRequistionVO searchVO, UserVO _UserVO) {
    ...
    String queryKey_new = "UPDATE.SAVE_APPOINTMENT.HIVT_REQUISITION_DTL_NEW";
  ...
  public void updateinheaderfordifflabaddendum(String newreqno, String oldreqno, UserVO _UserVO) {
    ...
    String queryKey_new = "UPDATE.HIVT_REQ_HEADER_DIFF_LAB_ADDENDUM_NEW";
    
    try {
      query = HelperMethodsDAO.getQuery(filename, queryKey);
      query = HelperMethodsDAO.getQuery(filename, queryKey_new);
  ...
  public void insertRequisitionDtl_addendum(InvestigationRequistionVO voLabTest, UserVO _userVO) {
    ...
    String queryKey_new = "UPDATE.HIVT_REQ_DTL_ADENDUM_TEST_NEW";
  ...
  public void insertRequisitionDtl_addendumNewTest(InvestigationRequistionVO voLabTest, UserVO _userVO) {
    ...
    String queryKey_new = "UPDATE.HIVT_REQ_DTL_ADENDUM_TEST11_NEW";
  ...
  public void deleteReqDtll(String lab, String test, String requisitionno, UserVO _UserVO) {
    ...
    String queryKey_new = "DELETE_RESULT_ENTRY_TEST_FROM_RAISING_NEW";
    try {
      query = HelperMethodsDAO.getQuery(filename, queryKey);
      query_new = HelperMethodsDAO.getQuery(filename, queryKey_new);
      }
  ...
  public List<LabTestVO> searchLabWiseTestDtlsNEW(InvestigationSearchVO searchVO, UserVO _UserVO) {
    ...
    if (val != null && val.contains("#")) {
      orderBy = " ORDER BY gnum_test_code=" + val.split("#")[0] + " desc ,gnum_labcode=" + val.split("#")[1] + " desc";
    }
  ...
  public String updateappointmentdateinheader(InvestigationRequistionVO voLabTest, UserVO _UserVO) {
    ...
    String queryKey_new = "UPDATE.APPOINTMENT.LAB_BAISED.HEADER_NEW";
 ...
 //   populateMAP.put(sq.next(), _UserVO.getHospitalCode());
  ...
  public List<BookMarkVO> getBookMarkListraisingxray(UserVO _userVO, String iscallingfromdesk) {
    ...
    try {
      ...
      query = String.valueOf(query) + "and exists (select 1 from hivt_laboratory_mst n where n.gnum_lab_code=hivtnum_lab_code and n.gnum_isvalid=1 and n.gnum_hospital_code=" + _userVO.getHospitalCode() + "   )";
     ...
     // query+="   and hivtnum_test_code in (select gnum_test_code from hivt_test_mst where gnum_isvalid=1 and is_show=1) ";
  ...
  public List<LabTestVO> gettestcharges(InvestigationSearchVO searchVO, UserVO _UserVO, Inv_RequisitionRaisingPatientVO patvo, Inv_PatientAdmissionDtlVO patvoadd) {
	...
	public String insertRequisitionHeaderDtl_reqprocess(RequistionHeaderVO voReqHeader, UserVO _userVO) {
	    ...
	    try {
	      ...
	      strProc.addInParameter(49, 12, voReqHeader.getRequisitionwiseno()==null?"": voReqHeader.getRequisitionwiseno());
