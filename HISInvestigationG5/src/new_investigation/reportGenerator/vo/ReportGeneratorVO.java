...
package new_investigation.reportGenerator.vo;

/**
 *
 * @author Prashant Mishra <github.com/prashantmi>
 */
...
//	private String pageSize=InvestigationStaticConfigurator.pagewidthheight;
    ...
    public ReportGeneratorVO(String laboratoryCode, String testCode, String groupCode, String hospitalCode,String sampleCode) throws Exception {
	...
	public void setIslabeldoubleline(int islabeldoubleline) {
	 ...
	 public ReportGeneratorVO(String laboratoryCode, String testCode, String groupCode, String hospitalCode,String sampleCode,String sampleCode1) throws Exception {
	        //LOGGER_INV.log(Level.INFO,"ResultEntryVO:::::::::::::::::::::::::::::laboratoryCode::"+laboratoryCode+" testCode::"+testCode+" groupCode::"+groupCode+" hospitalCode"+hospitalCode);
	        if (testCode != null) {
	            this.testCode = testCode;
	        }
