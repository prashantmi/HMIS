...
public class MasterAddTreeTraverser extends MasterTreeTraverser
{
	public MasterAddTreeTraverser(Node _rootOfTree, MasterDtl _objMasterDtl)
	{
	...
	public void processor(Stack _nodeHierarchyDetail, NamedNodeMap _nodeMap)
	{
		...
		if (((String) _nodeHierarchyDetail.get(0)).equalsIgnoreCase("add-page")) if (((String) _nodeHierarchyDetail.get(1))
				.equalsIgnoreCase("dynamic-page"))
		{
						...
						for (int i = 0; i < _nodeMap.getLength(); i++)
						{
							...
							if (nodename.equalsIgnoreCase("type"))
							{
								...
								if (controlType.equalsIgnoreCase("combo"))
								{
									...
									ArrayList alControls = ((MasterAddDtl) objMasterDtl).getAlControls();
							...
							if (((String) _nodeHierarchyDetail.get(4)).equalsIgnoreCase("constraints"))
							{
								...
								for (int i = 0; i < _nodeMap.getLength(); i++)
								{
									...
									if (nde.getNodeName().equalsIgnoreCase("styleString"))
									{
										...
										((TextDtl) obj).getConstraintMap().put("styleString", nde.getNodeValue());
			...
			if (((String) _nodeHierarchyDetail.get(2)).equalsIgnoreCase("insert-query")) if (((String) _nodeHierarchyDetail
					.get(3)).equalsIgnoreCase("fields"))
			{
				((MasterAddDtl) objMasterDtl).getAlValueMap().add(nd.getNodeValue());
				//System.out.println("MasterAddDtl)objMasterDtl).getAlValueMap"+ ((MasterAddDtl) objMasterDtl).getAlValueMap());
			}
			
			/////////for redendent check///////////////
			if (((String) _nodeHierarchyDetail.get(2)).equalsIgnoreCase("redundent-check")) 
			{
				((MasterAddDtl) objMasterDtl).getAlRedundentQuery().add(nd.getNodeValue());
	...
	public void processor(Stack _nodeHierarchyDetail, Node _textNode)
	{
		...
		if (((String) _nodeHierarchyDetail.get(0)).equalsIgnoreCase("add-page"))
		{
			if (((String) _nodeHierarchyDetail.get(1)).equalsIgnoreCase("static-page"))
			{
				((MasterAddDtl) objMasterDtl).setStaticPage(_textNode.getNodeValue());
			}
			...
			if (((String) _nodeHierarchyDetail.get(1)).equalsIgnoreCase("dynamic-page"))
			{
					...
					if (((String) _nodeHierarchyDetail.get(3)).equalsIgnoreCase("control"))
					{
						...
						if (obj.getClass().getName().equalsIgnoreCase(CLASS_COMBO_DTL))
						{
							...
							if (((String) _nodeHierarchyDetail.get(4)).equalsIgnoreCase("selection-mandatory"))
							{
								...
								//System.out.println("(ComboDtl)obj).getSelectionMandatory"	+ ((ComboDtl) obj).getSelectionMandatory());
							}
								...
								if (((String) _nodeHierarchyDetail.get(5)).equalsIgnoreCase("dynamic"))
								{
									...
									if (((String) _nodeHierarchyDetail.get(6)).equalsIgnoreCase("condition"))
									{
										...
										if (((String) _nodeHierarchyDetail.get(7)).equalsIgnoreCase("hospital-code"))
										{
											...
											//System.out.println("((ComboDtl)obj).getHospitalcode()"+ ((ComboDtl) obj).getHospitalCode());
									...
									if (((String) _nodeHierarchyDetail.get(6)).equalsIgnoreCase("query-detail"))
									{
										...
										if (((String) _nodeHierarchyDetail.get(7)).equalsIgnoreCase("condition"))
										{
											...
											if (((String) _nodeHierarchyDetail.get(8)).equalsIgnoreCase("dependent"))
											{
												...
												////////alphanumeric only for text box
												if (((String) _nodeHierarchyDetail.get(9)).equalsIgnoreCase("clause-alphanumeric"))
												{
													((TextDtl) obj).getAlAlphanumericDepCondition().add(_textNode.getNodeValue());
													//System.out.println("(TextDtl)obj).getAldepcondition"+ ((TextDtl) obj).getAlAlphanumericDepCondition());
												}
											}
											if (((String) _nodeHierarchyDetail.get(8)).equalsIgnoreCase("hospital-code"))
											{
												((TextDtl) obj).setHospitalCode(_textNode.getNodeValue());
												//System.out.println("(TextDtl)obj).setHospitalCOde"+ ((TextDtl) obj).getHospitalCode());
								...
								if (((String) _nodeHierarchyDetail.get(5)).equalsIgnoreCase("dynamic"))
								{
									if (((String) _nodeHierarchyDetail.get(6)).equalsIgnoreCase("query-detail"))
									{
										if (((String) _nodeHierarchyDetail.get(7)).equalsIgnoreCase("fields"))
										{
											if (((String) _nodeHierarchyDetail.get(8)).equalsIgnoreCase("field"))
											{
												...
												//System.out.println("(TextAreaDtl)obj).getAlField"+ ((TextAreaDtl) obj).getAlField());
											}
										...
										if (((String) _nodeHierarchyDetail.get(7)).equalsIgnoreCase("tables"))
										{
											if (((String) _nodeHierarchyDetail.get(8)).equalsIgnoreCase("table"))
											{
												...
												//System.out.println("(TextAreaDtl)obj).getAlTable"+ ((TextAreaDtl) obj).getAlTable());
										...
										if (((String) _nodeHierarchyDetail.get(7)).equalsIgnoreCase("condition"))
										{
											if (((String) _nodeHierarchyDetail.get(8)).equalsIgnoreCase("general"))
											{
												...
												//System.out.println("(TextAreaDtl)obj).setGenCondition"+ ((TextAreaDtl) obj).getGenCondition());
											...
											if (((String) _nodeHierarchyDetail.get(8)).equalsIgnoreCase("dependent"))
											{
												if (((String) _nodeHierarchyDetail.get(9)).equalsIgnoreCase("clause"))
												{
													...
													//System.out.println("(TextAreaDtl)obj).getAldepcondition"+ ((TextAreaDtl) obj).getAlDepCondition());
												}
											}
										}
									...
									if (((String) _nodeHierarchyDetail.get(6)).equalsIgnoreCase("value-detail"))
									{
										if (((String) _nodeHierarchyDetail.get(7)).equalsIgnoreCase("dependent")) ;
										{
											...
											//System.out.println("(TextAreaDtl)obj).getAldepconditionVal"	+ ((TextAreaDtl) obj).getAlDepConditionVal());
				...
				{
					if (((String) _nodeHierarchyDetail.get(3)).equalsIgnoreCase("primary-key"))
					{
						if (((String) _nodeHierarchyDetail.get(4)).equalsIgnoreCase("field"))
						{
							//System.out.println("insidedscsdf::::::::::::::::::");
							((MasterAddDtl) objMasterDtl).getAlpkFields().add(_textNode.getNodeValue());

							//System.out.println("pk fields" + ((MasterAddDtl) objMasterDtl).getAlpkFields());

						}
						if (((String) _nodeHierarchyDetail.get(4)).equalsIgnoreCase("value"))
						{
							((MasterAddDtl) objMasterDtl).getAlpkValue().add(_textNode.getNodeValue());
							//System.out.println("value" + ((MasterAddDtl) objMasterDtl).getAlpkValue());
						}
						if (((String) _nodeHierarchyDetail.get(4)).equalsIgnoreCase("hospital-code"))
						{
							((MasterAddDtl) objMasterDtl).setHospitalCode(_textNode.getNodeValue());
							//System.out.println("value" + ((MasterAddDtl) objMasterDtl).getHospitalCode());
						}
					}
					if (((String) _nodeHierarchyDetail.get(3)).equalsIgnoreCase("fields"))
					{
						((MasterAddDtl) objMasterDtl).getAlFields().add(_textNode.getNodeValue());
						//System.out.println("((MasterAddDtl)objMasterDtl).getAlFields()"	+ ((MasterAddDtl) objMasterDtl).getAlFields());
					}
					if (((String) _nodeHierarchyDetail.get(3)).equalsIgnoreCase("table"))
					{
						((MasterAddDtl) objMasterDtl).setTable(_textNode.getNodeValue());
						//System.out.println("((MasterAddDtl)objMasterDtl).setTable()"+ ((MasterAddDtl) objMasterDtl).getTable());
					}
				}
				if (((String) _nodeHierarchyDetail.get(2)).equalsIgnoreCase("redundent-check"))
				{
					
						((MasterAddDtl) objMasterDtl).setRedundentQuery(_textNode.getNodeValue());
