...
import java.util.*;
public class EpisodeTagClass extends BodyTagSupport{
	
	String name;
	String property;
	public Inv_RequisitionRaisingEpisodeVO patientEpisode=null;
	public int doStartTag( ) throws JspException{
		 if(pageContext.findAttribute(this.getName())==null)
		 {
			 System.out.println("Could not Find the Bean In Any Scope");
		 }
		/* else if((pageContext.findAttribute(this.getName()).getClass()).getName().equals("Inv_RequisitionRaisingEpisodeVO"))
		 {
			patientEpisode=(Inv_RequisitionRaisingEpisodeVO)pageContext.findAttribute(this.getName());
			 ...
			 catch(Exception ex)
			 {
				...
				try
					...
					for(Method methodname:methods)
					{
						...
						{
							checkproperty=true;
							Inv_RequisitionRaisingEpisodeVO patientEpisode=(Inv_RequisitionRaisingEpisodeVO)pageContext.findAttribute(this.getName());
						}
	...
	public String createPatientDetailHTML(Inv_RequisitionRaisingEpisodeVO patientEpisode)
	{
		String html="";
