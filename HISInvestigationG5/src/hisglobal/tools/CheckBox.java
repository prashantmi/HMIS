...
public class CheckBox extends Control
{
	...
	public CheckBox(String _label, String _defaultValue, ArrayList _value, ArrayList _text, boolean _readOnly, Map _constraints)
	{
	...
	public java.util.ArrayList getId()
	{
		return id;
	}

	public void setId(java.util.ArrayList id)
	{
		this.id = id;
	}
