...
public class RescheduleCancelAppointmentSUP extends AppointmentGlobalSUP{
	...
	public String getpatAppointmentNo() {
		return appointmentQueueNo;
	}

	public void setpatAppointmentNo(String appointmentQueueNo) {
		this.appointmentQueueNo = appointmentQueueNo;
	}
	...
	public RescheduleCancelAppointmentSUP()
	{	
