...
//alert("showMenuFrame in reg");
 ...
 function requestByType(obj) {
 	
 	 var requestByTypeValue=obj.value;
 	 if (requestByTypeValue == "Internal") {
	 	document.getElementById("requestByExternal").style.display="none";
		document.getElementById("requestByInternal").style.display="";
		document.getElementsByName("requestByExternalName")[0].value="";
		document.getElementsByName("requestByFlag")[0].value=0;
				
	            
    } else {
       document.getElementsByName("requestByName")[0].value="";
       document.getElementById("requestByExternal").style.display="";
	   document.getElementById("requestByInternal").style.display="none";
	   document.getElementsByName("requestByFlag")[0].value=1;
    }
 }
