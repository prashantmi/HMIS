...
if(!isGlobal.equals("1"))
{
	...
	hospitalState=hospitalVO.getStateName();
}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="69">  
  <tr> 
    <td width="100%" class='SLIPHEADER'><div align="center"><b><%=hospitalName %></b></div></td>
  </tr> 
  <tr>
    <td width="100%" class='SLIPHEADER'><div align="center"><b><%=hospitalAdd %></b></div></td>
  </tr>
   <tr>
		<td class='SLIPCONTROL' colspan="6"><div align="center"><b><%=hospitalAddExt %></b></div></td>
  </tr>
  <tr>
		<td class='SLIPCONTROL' colspan="6"><div align="center"><b><%=hospitalCity %></b></div></td>
  </tr>
  <tr>
		<td class='SLIPCONTROL' colspan="6"><div align="center"><b><%=hospitalState %></b></div></td>
  </tr>
  <%-- <tr>
		<td class='SLIPCONTROL' colspan="6"><div align="center"><b><%=header1 %></b></div></td>
  </tr>
  <tr>
		<td class='SLIPCONTROL' colspan="6"><div align="center"><b><%=header2 %></b></div></td>
  </tr>
  <tr>
		<td class='SLIPCONTROL' colspan="6"><div align="center"><b><%=header3 %></b></div></td>
  </tr>
  <tr>
		<td class='SLIPCONTROL' colspan="6"><div align="center"><b><%=header4 %></b></div></td>
  </tr> --%>
</table>
