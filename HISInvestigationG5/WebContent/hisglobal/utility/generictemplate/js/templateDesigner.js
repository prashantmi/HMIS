...
Resizer.prototype.create = function(_parent)
{
	...
	img.src = "/HISInvestigationG5/hisglobal/images/Pl_Green_Sqr.png";
	...
	img.src = "/HISInvestigationG5/hisglobal/images/Mi_Green_Sqr.png";
...
ColorControl.prototype.create=function(_parent)
{
	...
	var img = TemplateDesigner.createElement("img",td);
	img.src = "/HISInvestigationG5/hisglobal/images/select_arrow.gif";
...
ColorControl.evtColorImageMouseOver = function(evnt)
{
	try
	{
		var objColor = ColorControl.getObject();
		if(objColor)
			objColor.elemPickerImage.src = "/HISInvestigationG5/hisglobal/images/select_arrow_over.gif";
	}
	catch(e)
	{
		alert("Error Message -> "+e.message);
...
ColorControl.evtColorImageMouseOut = function(evnt)
{
	try
	{
		var objColor = ColorControl.getObject();
		if(objColor)
			objColor.elemPickerImage.src = "/HISInvestigationG5/hisglobal/images/select_arrow.gif";
	}
	catch(e)
	{
		alert("Error Message -> "+e.message);
...
ImageUploadControl.prototype.create = function(_parent)
{
	...
	var img = TemplateDesigner.createElement("img",td);
	img.src = "/HISInvestigationG5/hisglobal/images/nodeClose.gif";
	img.border = 0;
...
ImageUploadControl.prototype.setUploadedImageView = function(_ext)
{
	if(!this.imageAttached)
	{
		...
		var objCurrentCell = TemplateDesigner.getCurrentCellObject();
		var url = '/HISInvestigationG5/hisglobal/utility/generictemplate/templateImageViewUpload.cnt?transactionMode=VIEW&row='+objCurrentCell.row+"&col="+objCurrentCell.col;
...
ImageUploadControl.evtUploadImage = function(evnt)
{
	...
	{
		var objCurrentCell = TemplateDesigner.getCurrentCellObject();
		var url = '/HISInvestigationG5/hisglobal/utility/generictemplate/templateImageViewUpload.cnt?row='+objCurrentCell.row+"&col="+objCurrentCell.col;
