...
<fieldset class="m-2 px-1">
 ...
 %>
		...
		<div id="EntryReqnListContr" class="container-fluid px-1 px-sm-3 mb-3 d-none ">
		  <span class="d-flex justify-content-end px-2 bar"><div class="rollingCircle d-none"></div><a class="lodingText d-none text-white pr-md-5 mr-md-5">Loading...</a></span>
			<div id='' class="mx-md-1 mx-md-point5 row  p-2 align-items-center shadow rounded-lg bg-white  hover-shadow ">
        		...
        		<div class="entryReqnListFltr_Man">
		 		 <div class="d-flex justify-content-center">
		 		 	<select class="form-control custom-select departNameFilter_Man d-none" ><option class="text-light bg-dark" value="" selected >Department Filter</option></select>
					<select class="form-control custom-select groupTestFilter_Man ml-1 d-none" ><option class="text-light bg-dark" value="" selected >Test|Group Filter</option></select>
					<select class="form-control custom-select labNameFilter_Man ml-1 d-none" ><option class="text-light bg-dark" value="" selected >Lab Filter</option></select>
					<select class="form-control custom-select patStatusFilter_Man ml-1 d-none" ><option class="text-light bg-dark" value="" selected >Patient Status</option></select>
					<select class="form-control custom-select machineNameFilter_Man ml-1 d-none" ><option class="text-light bg-dark" value="" selected >Machine</option></select>
					<select class="form-control custom-select priorityFilter_Man ml-1 d-none" ><option class="text-light bg-dark" value="" selected >Priority</option></select>
		 		 </div>
				</div>
				
				<div class="entryReqnListFltr_Mchn d-none">
				 <div class="d-flex justify-content-center">
					<select class="form-control custom-select departNameFilter_Mchn d-none" ><option class="text-light bg-dark" value="" selected >Department Filter</option></select>
				  	<select class="form-control custom-select groupTestFilter_Mchn ml-1 d-none" ><option class="text-light bg-dark" value="" selected >Test|Group Filter</option></select>
				  	<select class="form-control custom-select labNameFilter_Mchn ml-1 d-none" ><option class="text-light bg-dark" value="" selected >Lab Filter</option></select>
				  	<select class="form-control custom-select patStatusFilter_Mchn ml-1 d-none" ><option class="text-light bg-dark" value="" selected >Patient Status</option></select>
				  	<select class="form-control custom-select machineNameFilter_Mchn ml-1 d-none" ><option class="text-light bg-dark" value="" selected >Machine</option></select>
				  	<select class="form-control custom-select priorityFilter_Mchn ml-1 d-none" ><option class="text-light bg-dark" value="" selected >Priority</option></select>
        		 </div>
				</div>

		        <div class="col-12 pt-3" >
		          <ul class="nav nav-tabs" id="entryReqnListTabs" role="tablist">
		            <li class="nav-item resultEntry-nav_Man">
		              <a class="nav-link active" id="manEntry-tab" data-toggle="tab" href="#manEntry" role="tab" aria-controls="manEntry" aria-selected="true">Manual Entry
		              	&nbsp;<span class="badge badge-primary testBadgeCount_Man">0</span>
		  					  <span class="sr-only">No of Manual Tests</span>
		              </a>
		            </li>
		            <li class="nav-item resultEntry-nav_Mchn">
		              <a class="nav-link" id="mchnEntry-tab" data-toggle="tab" href="#mchnEntry" role="tab" aria-controls="mchnEntry" aria-selected="false">Machine Entry 
		              	&nbsp;<span class="badge badge-primary testBadgeCount_Mchn">0</span>
		  					  <span class="sr-only">No of Machine Tests</span>
		              </a>
		            </li>
		          </ul>
		          <div class="tab-content" id="entryReqnListTabsContent">
		   						...
		   						<thead>
		   							<tr>
				                        ...
				                        <th class="">RequisitionNoAnDate</th>
		   								...
		   								<th class=""><span class="sampleNAccessionTh">Sample/Accession No.</span></th>
		   								<th class="">Result Entered By</th>
		        				...
		        				<caption class="DataTable12Caption"></caption>
		        					<thead>
		        						<tr>
		        							...
		        							<th class="">
		        								<div class="custom-control custom-checkbox">
		        									<input type="checkbox" class="custom-control-input selectAllDtCheck2" id="selectAllDtCheck2_Man">
		        									<label class="custom-control-label" for="selectAllDtCheck2"></label>
		        								</div>
		        								<div class="custom-control custom-checkbox">
		        									<input type="checkbox" class="custom-control-input selectAllDtCheck2" id="selectAllDtCheck2_Mchn">
		        									<label class="custom-control-label" for="selectAllDtCheck2"></label>
		        								</div>
		        							</th>
		        							<th class="">Department-Unit</th>
		            ...
		            <div class="tab-pane fade" id="mchnEntry" role="tabpanel" aria-labelledby="mchnEntry-tab">
		              <div class="row">
		...
		<html:hidden name="InvResultValidationRespFB" property="jsonResponse" value='{"responseFromProcess":" ","isSuccess":"0","errorMsg":" "}' />
