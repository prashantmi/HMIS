		...
		var fromDate=document.getElementsByName("fromDate")[0].value;
  	   ...
  	   var table = $('#example').DataTable( {
	        ...
	        buttons: [ 'colvis', 'copy', 'excel',		        
	               {
	                extend: 'pdfHtml5',
	                title: 'Investigation Radiology Listing Report',
	                text: 'PDF',
	         ...
	         "bServerSide": true,
	         "sAjaxSource": "/HISInvestigationG5/new_investigation/invListingReportRdNew.cnt?hmode="+_mode+"&fromDate="+fromDate+"&toDate="+toDate, sync:true, postData: "", handleAs: "text",
	         "bProcessing": true,
		 ...
		 $(document).ready(function() {
			...
			var fromDate=document.getElementsByName("fromDate")[0].value;
		     ...
		     var table = $('#example').DataTable( {
		        ...
		        ajax: {
		        	url: "/HISInvestigationG5/new_investigation/invListingReportRdNew.cnt?hmode="+_mode+"&fromDate="+fromDate+"&toDate="+toDate, sync:true, postData: "", handleAs: "text",
		          dataSrc: "aaData"  	  
...
function onClickGO()
{
	if(validateDat()){
		...
		document.getElementsByName('hmode')[0].value='GETDATEWISELISTINGRD';
...
<html:form action="/invListingReportRdNew" enctype="multipart/form-data">
	    ...
	    <td>
	    	<table>
				<tr id="filter_col2" data-column="2">
			        ...
			        <td width="50%" align="left"><select id="statusFltr" style="width: 160px"><option value="">Select Status</option></select></td>
			   </tr>
			</table>   
	    </td>
	    <td>
	    	<table>
				<tr id="filter_col2" data-column="2">
			        ...
			        <td width="50%" align="left"><select id="labNameFltr" style="width: 160px"><option value="">Select Labname</option></select></td>
			   </tr>
			</table>   
	    </td>
	</tr>
