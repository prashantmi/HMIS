 ...
 %>
	...
	<div class="col-lg-3  mb-2 mb-md-0 dateTypeSelectDiv">
					...
					<div class="form-row d-flex"> <!-- align-items-center  -->
							...
							<div class='input-group d-flex flex-nowrap inputFiltersDiv'>
								...
								<select class="form-control" id="inputFilterType" disabled>
									...
									<option value="2">Bill No :</option>
			                     	<option value="3" selected>Sample No :</option>
								...
								<input type="text" class="form-control d-none" id="crNoInput" placeholder="Enter Cr. No." maxlength="15" minlength="15" value="" disabled>
								<input type="text" class="form-control d-none" id="billNoInput" placeholder="Enter Bill No." maxlength="15"  value="" disabled>
								<input type="text" class="form-control " id="sampleNoInput" placeholder="Enter Sample No." maxlength="10"  value="">
								<input type="text" class="form-control d-none" id="labNoInput" placeholder="Enter Lab No." maxlength="10"  value="" disabled>
						...
						<div class="row">
							<div class='col-lg-6 input-group d-flex flex-nowrap inputFiltersDiv'>
								<div class="input-group-append">
								...
								<div class='col-lg-6 input-group d-flex flex-nowrap inputFiltersDiv ml-0 d-none'>
								<div class="input-group-append">
