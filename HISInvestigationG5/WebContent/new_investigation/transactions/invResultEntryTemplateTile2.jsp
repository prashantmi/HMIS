...
var jsonResponse = jQuery.parseJSON('<%= session.getAttribute("resultEntrySessionJson") %>');
'<% session.setAttribute("resultEntrySessionJson", null); %>'
...
<html:hidden name="InvResultValidationRespFB" property="sampleAreaCode" />
					...
					<td width="78%" class="tdfonthead">
						<div align="left">
							...
							<html:textarea style="width: 900px;"
								value='<%=invresultentryvo.getFinalRemarkString()==null?"":invresultentryvo.getFinalRemarkString().replaceAll("&lt;","<").replaceAll("&gt;",">") %>'
 ...
 -->
		...
		<his:ButtonToolBarTag>
			...
			<logic:present
				name="<%=InvestigationConfig.LIST_PATIENT_MCHN_RESULT_ENTRY_ESSENTIALS_VO%>">
				<logic:present
					name="<%=InvestigationConfig.LIST_RESULT_ENTRY_RESP_TEST_TEMPLATE_VO%>">
					<!-- this logic for cancel button hide in list page -->
					<img class="button"
