...
var hospitalcode_new=<%=hospitalCode_new%> ;
 ...
 %>
									...
									<tr>
										...
										<th id="paraEntryColor" width="20%"><font color="#FF0000" size="2" face="Verdana, Arial, Helvetica, sans-serif"> <%=voPat.getFinalRemarkString()==null?"":voPat.getFinalRemarkString().replaceAll("&lt;","<").replaceAll("&gt;",">")%></font></th>
										<th width="20%"></th>
										<!-- 	<th width="20%">ml</th> -->
									</tr>
									<%
						...
						<td width="78%" class="tdfonthead">
							<div align="left">
								<%
									String sp = "/";
								%>
								<html:textarea style="width: 900px;" value='<%=invResultValidationRespVO.getFinalRemarkString()==null?"":invResultValidationRespVO.getFinalRemarkString().replaceAll("&lt;","<").replaceAll("&gt;",">")%>'
