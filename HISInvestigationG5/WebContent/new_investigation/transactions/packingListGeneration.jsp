				   ...
				   <his:statusNew>
				     <logic:equal name="PackingListGenerationFB" property="isSampleAreaSelected" value="1">
				    	...
				    	<logic:notEqual name="PackingListGenerationFB" property="packingListGenerationType" value="1">
				    		<img class="button" src='<his:path src="/hisglobal/images/btn-gen-all.png"/>' id="goButton" style="cursor: pointer;" onkeypress="if(event.keyCode==13) generateAllPackingList();" onclick="generateAllPackingList();" tabindex="1">
				    	</logic:notEqual>
				    	</logic:notEqual>
				    </logic:equal>
				     <logic:notEqual name="PackingListGenerationFB" property="isSampleAreaSelected" value="1">
