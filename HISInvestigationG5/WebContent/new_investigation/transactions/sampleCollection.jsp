...
<%=voSam.getPriorityOfReq()==null?"Normal":voSam.getPriorityOfReq().contains("Confidential")?"Confidential":voSam.getPriorityOfReq().contains("Urgent")?"Urgent":"Normal" %></font>
 ...
 <logic:notEmpty name="<%=InvestigationConfig.LIST_PAT_SAMPLE_UNBILLED %>">
 	...
 	<!-- END -- TO DISPLAY INSTRUCTIONS -->
			...
			<html:hidden name="SampleCollectionFB" property="issearchviacrno" />
...
{ 
	//  alert(document.getElementsByName("issearchviacrno")[0].value);
	  if(document.getElementsByName("issearchviacrno")[0]!=null && document.getElementsByName("issearchviacrno")[0].value!="" && document.getElementsByName("issearchviacrno")[0].value=="1")
		  {}
	  else
		  {
