...
function submitform()
{
		...
		{
		alert("Only File with extension DCM is Allowed");
		return;
		}
		//alert(ext);
		//alert(fileName);
	...
	<his:ContentTag>
 	...
 	<logic:present name='success'>
        <logic:notEmpty name='success'>
            <logic:notEqual name='success' value='null'>
                <font color='red' size=3><%=(String)request.getAttribute("success")%></font>
            </logic:notEqual>
        </logic:notEmpty>
    </logic:present>	
...
<a href="/HealthStandards/DICOMCommunicator.jsp" target="_blank" rel="noopener">View Received Dicom Data</a>		
