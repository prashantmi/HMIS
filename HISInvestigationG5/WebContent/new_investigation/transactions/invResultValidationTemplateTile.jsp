...
<%-- 							<td width="9%" align="left"><b> <font color="#000000"
					...
					String chkVal=voPat.getPatCRNo()+"#"+voPat.getRequisitionNo()+"#"+voPat.getRequisitionDNo()+"#"+voPat.getGroupCode()+"#"+voPat.getTestCode();  
...
<%
					...
					<% if(voPat.getFinalRemarkReqd()!=null && voPat.getFinalRemarkReqd().equals("1")){ %>
					 <tr>
									...
									<th width="20%"></th>
									<th width="20%"></th> <!-- by chankssssssssssss -->
									<!-- 	<th width="20%">ml</th> -->
								</tr>
								<%} %>
									</table>
...
<img src='/HISInvestigationG5/hisglobal/images/ok.gif'  onClick="closeInstructions();"> 		                        
	...
	<%}
	  			...
	  			<logic:equal name="InvResultValidationFB" property="ispreview"
	  				...
	  				<html:textarea  style="width: 900px;" value='<%=invresultentryvo.getFinalRemarkString()==null?"":invresultentryvo.getFinalRemarkString().replaceAll("&lt;","<").replaceAll("&gt;",">")%>' styleId="<%=invresultentryvo.getPatCRNo()+'#'+invresultentryvo.getRequisitionNo()+'#'+invresultentryvo.getTempSampleNo().split(sp)[0]%>" name="InvResultValidationFB" property="finalRemarksValue"
	  				 >
	  				</html:textarea>
...
<div id="container">
		...
		<his:ButtonToolBarTag>
				...
				<logic:present name="<%=InvestigationConfig.LIST_RESULT_ENTRY_PATIENT_TEMPLATE_VO %>">
					...
					<logic:equal name="InvResultValidationFB" property="newEntry" value="3">
						<img class="button"
							src='<his:path src="/hisglobal/images/btn-save-validate-all.png"/>'
							tabindex="1" onclick="setIndication(); selectAll();">
						<img class="button"
                ...
                <logic:equal name="InvResultValidationFB" property="ispreview" value="1">
