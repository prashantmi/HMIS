...
function onSave()
{
	...
	if(document.getElementsByName("diagnosisCheck")[0].value=="1" && document.getElementsByName("addendumCheck")[0].value=="" && document.getElementsByName("amendmentCheck")[0].value=="")
		...
		return false;
		 ...
		 for(var a=0;a<document.getElementsByName('finalRemarksValue').length;a++)
		 {
		        var data=document.getElementsByName('finalRemarksValue')[a].value ;
		 	   data=removeSpecialCharacter(data);
		 //	   alert(data);
		 	   document.getElementsByName('finalRemarksValue')[a].value=data;
		 }
	...
	<%}
				 ...
				 <html:select name="invReportAddendumFB" property="reasonCode"    tabindex="1"  >
	  			...
	  			if(invresultentryvo.getFinalRemarkReqd().equals("1")){ %>
	  				...
	  				<html:textarea  style="width: 900px;" value='<%=invresultentryvo.getFinalRemarkString()==null?"":invresultentryvo.getFinalRemarkString().replaceAll("&lt;","<").replaceAll("&gt;",">")%>' styleId="<%=invresultentryvo.getPatCRNo()+'#'+invresultentryvo.getRequisitionNo()%>" name="invReportAddendumFB" property="finalRemarksValue"
	  				 >
	  				</html:textarea>
	  				<html:hidden name="invReportAddendumFB" property="crNoReqNoString" value="<%=invresultentryvo.getPatCRNo()+'#'+invresultentryvo.getRequisitionNo()%>"/>
													</div>
