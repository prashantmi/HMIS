<!-- 
 ...
 ## Process/Database Object Name	    : ORGANISM PROCESS
 ## Purpose						        : 
 ## Date of Creation					: 29/07/2016
 ## Modification Log					:				
 ##		Modify Date				        :  
 ##		Reason	(CR/PRS)			    : 
 ##		Modify By				        : 
...
<his:javascript src="/new_investigation/js/invOrganicMst.js" />
...
<body>
<html:form action="/masters/organicprocess">
<his:TransactionContainer>
	<html:hidden name="invOrganicMstFB" property="hmode" />
...
<his:SubTitleTag name="Details"></
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="0">
			    ...
			    <td width="25%" class="tdfont">
			      ...
			      <td width="25%" class="tdfont">
			        <div align="left">
			             <html:text property="organicName" name="invOrganicMstFB" onkeypress="return validateAlphaNumericOnly(event,this)"></html:text>
			             <html:hidden property="organicNameCode" name="invOrganicMstFB" ></html:hidden>
				     </div>
			      </td>
			      </tr>
			     <tr>
			    <td width="25%" class="tdfont">
			      ...
			      <td width="25%" class="tdfont">
			        <div align="left">
			             <html:text property="organicNameOrder" name="invOrganicMstFB" onkeypress="return validateNumeric(event)"></html:text>
				     </div>
			      </td>
			      </tr>
				...
				<span id="saveDiv"> <logic:notEqual name="invOrganicMstFB"
						property="hmode" value="MODIFY">
						<logic:notEqual name="invOrganicMstFB" property="hmode" value="VIEW">
							<img class="button"
					...
					</logic:notEqual> <logic:equal name="invOrganicMstFB" property="hmode" value="MODIFY">
						<img class="button"
