...
function setValue()
{
	...
	var uomCode = document.getElementsByName('containerUOM')[0].value;
}
...
function setContainerValuesAJAX()
{
		...
		var urlNew= "/HISInvestigationG5/new_investigation/masters/LabTestSampleGlobalMstACT.cnt?hmode="+_mode+'&containerCode='+containerCode;
...
<body onload="fun();">
<html:form action="/masters/LabTestSampleGlobalMstACT">
 
<his:TitleTag name="Lab Test Sample/System Global Master">
			<%-- <his:insertDateTag/> --%>
		</his:TitleTag>
		<his:ContentTag>
		<table width="100%" border="0" cellspacing="2" cellpadding="1">
			  <tr>
			    <td width="50%" class="tdfonthead">
		         ...
		         <td width="50%" class="tdfont">
			      <div align="left">
				 <html:text name="LabTestSampleGlobalMstFB" property="labName" readonly="true" style="width:35%"  tabindex="1" ></html:text>
				  </div>
			     </td>
			     </tr>
			     <tr>
			     <td width="50%" class="tdfonthead">
			      ...
			      <td width="50%" class="tdfont">
			      <div align="left"> 
				       <html:text name="LabTestSampleGlobalMstFB" property="testName" readonly="true" style="width:35%" tabindex="1" />
				  </div>
			     </td>
			</tr>
			<tr>
			<td width="50%" class="tdfonthead">
		         ...
		         <td width="50%" class="tdfont">
			      <div align="left"> 
				 <html:select name="LabTestSampleGlobalMstFB"  style="width:35%"  property="sampleCode"  tabindex="1" >
			     ...
			     <logic:equal name="LabTestSampleGlobalMstFB" property="hmode" value="MODIFY">
			      <td width="50%" class="tdfont">
			      <div align="left"> 
			     <html:text name="LabTestSampleGlobalMstFB" property="sampleName" readonly="true" style="width:35%" tabindex="1" ></html:text>
			     </div>
			     </td>
			     </logic:equal>
			     </tr>
			 ...
			 <td width="50%" class="tdfonthead">
			      ...
			      <div align="left"> 
				 <html:select name="LabTestSampleGlobalMstFB"  style="width:35%"  property="uomCode"  tabindex="1" >
				       					<html:option value="-1">Select Value</html:option>
