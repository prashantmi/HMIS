...
function getParameterDetails(testGroupCode)
{
	...
	if(document.getElementsByName("paraType")[0].checked)
		paraType=document.getElementsByName("paraType")[0].value;
	else if(document.getElementsByName("paraType")[1].checked)
		paraType=document.getElementsByName("paraType")[1].value;
	else if(document.getElementsByName("paraType")[2].checked)
		paraType=document.getElementsByName("paraType")[2].value;
	else
		;
	var urlStr="/HISInvestigationG5/new_investigation/masters/DynamicReportTemplateACT.cnt?hmode=SHOWMODIFICATIONPARAMETER&labTestCode="+obj+"&paraType="+paraType;
...
function fetchTemplate()
{
	...
	if(obj != null)
		objValue = obj.value;
	var urlStr="/HISInvestigationG5/new_investigation/masters/DynamicReportTemplateACT.cnt?hmode=SHOWMODIFICATIONPROCESS&templateIdRadio="+obj.value+"&paraType="+paraType;
	var xhrArgs = {url:urlStr, postData: "",handleAs: "text",load: function(data) {
		if(data != "") {
		...
		if(str.length > 2) {
			...
			document.getElementById("loadedTestDetails").innerHTML = str[8];
			document.getElementById('addOrModifyMode').value='MODIFYSAVEMODE';
			...
			document.getElementById("footerHeight").value="";
			document.getElementById("footerWidth").value="";
			document.getElementById("loadedTestDetails").innerHTML = str;
...
var voSelectHTML="<select name='voValue'>"+'<%=(String)session.getAttribute("parameterOptionText")%>'+"</select>";
	...
	function createDivForcreatingTable() {
		...
		colElement.width = '50%';
		colElement.colSpan = '1';
		colElement.innerHTML = "<input type='text' name='border' value='1' size='8'/>";
	...
	function showtablewithBorder() {
		...
		colElement.width = '100%';
		colElement.colSpan = '2';
		colElement.innerHTML = "<input type='button' class='sub5' value='SAVE' onClick='showtablewithBorders()'/>";

	}


	function showtablewithoutBorder() {
		var modificationInfoDiv = 'modificationInfoDiv';
		var divElement = document.getElementById(modificationInfoDiv);
		divElement.innerHTML = "";
		var tableElement = document.createElement("table");
		...
		colElement.width = '100%';
		colElement.colSpan = '2';
		colElement.innerHTML = "<input type='button' class='sub5' value='SAVE' onClick='showtablewithoutBorders()'/>";
...
// 				.getElementsByName("templatePageWidth")[0].value;
	...
	function showtablewithBorders() {
		...
		/* var url = "/HISInvestigationG5/new_investigation/masters/DynamicReportTemplateACT.cnt?hmode=SHOWTABLEWITHBORDERS&tableid="
			+ document.getElementsByName("tableId")[0].value;
		window.open(url, "MyWindows", "200", "200"); */
		
	 	var urlAjax = "/HISInvestigationG5/new_investigation/masters/DynamicReportTemplateACT.cnt?hmode=SHOWTABLEWITHBORDERS&tableid="
				+ document.getElementsByName("tableId")[0].value;
		document.getElementById('modificationInfoDiv').innerHTML = "";
		init(urlAjax);
		req.onreadystatechange = getTemplateDocumentAJAX;
	...
	function showtablewithoutBorders() {
		if (document.getElementById("temporaryForm") != null)
			document.getElementById("temporaryForm").innerHTML = "";
		...
		window.open(url, "MyWindows", "200", "200"); */
	 	...
	 	var urlAjax = "/HISInvestigationG5/new_investigation/masters/DynamicReportTemplateACT.cnt?hmode=SHOWTABLEWITHOUTBORDERS&tableid="
				+ document.getElementsByName("tableId")[0].value;
		document.getElementById('modificationInfoDiv').innerHTML = "";
		init(urlAjax);
		req.onreadystatechange = getTemplateDocumentAJAX;
	...
	function saveElementProperties(tableNo, rowNo, colNo, elementNo) {
		...
		var changeTable="";
		if(document.getElementsByName("elementchangeTableId")[0]!=undefined)
		 changeTable=document.getElementsByName("elementchangeTableId")[0].value;
		else
			changeTable="";
		var urlStr = "/HISInvestigationG5/new_investigation/masters/DynamicReportTemplateACT.cnt?hmode=SETELEMENTPROPERTIES&tableNo="
				+ tableNo
				+ "&rowNo="
				+ rowNo
				+ "&colNo="
				+ colNo
				+ "&elementNo=" + elementNo
				+"&elementchangeTableId="+changeTable;
		var formElement = document.getElementById("temporaryForm");
		if (document.getElementById("temporaryForm") == null) {
			formElement = document.createElement("form");
			formElement.id = "temporaryForm";
...
//alert(document.getElementsByName("elementchangeTableId")[0].value);puneet
		if (document.getElementsByName("elementchangeTableId") != null
				&& document.getElementsByName("").length != 0) {
			//url+="&elementValidationString="+document.getElementsByName("elementValidationString")[0].value;
			formElement.innerHTML += "<input type=text name='elementchangeTableId' value='"
					+ document.getElementsByName("elementchangeTableId")[0].value
					+ "'/>";
		}
	...
	function savecolumnProperties(tableNo, rowNo, colNo) {
		var urlStr = "/HISInvestigationG5/new_investigation/masters/DynamicReportTemplateACT.cnt?hmode=SETCOLUMNPROPERTIES&tableNo="
	...
	function submitRedesignPage(hmodeValue) {
        ...
        // alert("hmodeValue"+document.getElementsByName("tableNo")[0].value);		
	...
	/* 	var urlAjax = "/HISInvestigationG5/new_investigation/masters/CreateNewPrintingTemplateSer?hmode="
				...
				var urlAjax = "/HISInvestigationG5/new_investigation/masters/DynamicReportTemplateACT.cnt?hmode="
					+ hmodeValue + "&tableNo=" + document.getElementsByName("tableNo")[0].value;
		...
		if (hmodeValue == 'MERGECELLS')
			...
			urlAjax += '&cell1RowNo=' + document.forms[0].cell1RowNo.value
					...
					+ '&cell2ColNo=' + document.forms[0].cell2ColNo.value;
		else if (hmodeValue == 'DELETEBLANKCELL')// need to see after the work
			urlAjax += '&colNo=' + document.getElementsByName("colNo")[0].value;
		else if (hmodeValue == 'DELETEBLANKROW')//delete blank row
			urlAjax += '&rowNo=' + document.getElementsByName("rowNo")[0].value;
	...
	function getTestnTestGroup() {
		...
		var isGroup = document.getElementsByName('radioValueForTestGroup')[0].value;
		alert(isGroup);
		var formObj = null;
		var formText = null;
		if(isGroup == 2)
		{
			alert("inside group");
			formObj = document.getElementsByName('groupCode')[0].value;
			formText = document.getElementsByName('groupCode')[0].options[document.getElementsByName('groupCode')[0].selectedIndex].text
		}
		else {
		   formObj = document.getElementsByName('testCode')[0].value;//document.forms[0].testCode.options[document.forms[0].testCode.selectedIndex].value;
		   formText = document.getElementsByName('testCode')[0].options[document.getElementsByName('testCode')[0].selectedIndex].text;
		}
		...
		var urlStr = "/HISInvestigationG5/new_investigation/masters/DynamicReportTemplateACT.cnt?hmode=GETLABTESTWITHTESTGROUPDATA&testCode="
				...
				+ "&exsistingTemplate="
				+ objValue
				+ "&testGroupName="+ formText 
				+ "&testOrGroupRadio=" + isGroup ;
		...
		var deferred1 = dojo.xhrGet(xhrArgs);
		//isGroup = document.getElementsByName('radioValueForTestGroup')[0].value;
		//alert(isGroup);
		//fetchTemplate(formObj, isGroup);
	}
	...
	dojo.addOnLoad(function() {
	      dojo.style(dojo.byId('groupCodeList'), "display", "none");
	});
	function selectTemplateType(radioValue){
		document.getElementsByName('radioValueForTestGroup')[0].value = radioValue;
		var strul = "<ul id='tree_menu'>";
		var strulend = "</ul>";		
		
		if( radioValue == 1){//dojo.style(dojo.byId('testCodeList'), "display") == "none"){
		//	alert("calling 1");
		
	        dojo.style(dojo.byId('testCodeList'), "display", "block");
	        dojo.style(dojo.byId('groupCodeList'), "display", "none");
	    } else {
	    //	alert("calling 2");
	        dojo.style(dojo.byId('testCodeList'), "display", "none");
	        dojo.style(dojo.byId('groupCodeList'), "display", "block");
	    }
		
		switch (radioValue) {
		case 1:
			
			/*var urlAjax = "/HISInvestigationG5/new_investigation/masters/DynamicReportTemplateACT.cnt?hmode=INTIALIZEREDESIGNTEMPLATE&radioValue=1";
			var obj=document.getElementsByName("exsistingTemplate")[0];			
			var objValue = null;
			if(obj != null)
				objValue = obj.value;
			var xhrArgs = {url:urlAjax, postData: "",handleAs: "text",load: function(data) {
...
// 			req.send(null);*/
		...
		case 2: 
			//alert("calling 2");
			/*var urlAjax = "/HISInvestigationG5/new_investigation/masters/DynamicReportTemplateACT.cnt?hmode=INTIALIZEREDESIGNTEMPLATE&radioValue=2";
			var obj=document.getElementsByName("exsistingTemplate")[0];			
			var objValue = null;
			if(obj != null)
				objValue = obj.value;
...
<body>
			...
			<table width='100%' align="center" cellspacing="1" cellpadding="0">
				<tr>
			      ...
			      <div align="left">
						...
						<html:radio name="DynamicReportTemplateFB"  tabindex="1" property="paraType" value="0"  ></html:radio>
						<bean:message key="testPara"/>
						<html:radio name="DynamicReportTemplateFB" tabindex="1" property="paraType" value="1" ></html:radio>
						<bean:message key="deptPara"/>
						<html:radio name="DynamicReportTemplateFB" tabindex="1" property="paraType" value="2" ></html:radio>
						<bean:message key="reqPara"/>
	...
	<div dojoType="dijit.layout.BorderContainer" liveSplitters="false"
		...
		<div dojoType="dijit.layout.AccordionContainer" minSize="20"
			...
			<div dojoType="dijit.layout.AccordionPane" title="Add Template"
...
<!-- 				</tr> -->
				...
				<td width="100%" colspan="2" class="tdfont"><input 
				 ...
				 <tr> 
 					...
 					<td width="100%" colspan="2" class="tdfont"><input 
 						type="button" class="sub6" title="Delete Blank Column from Each Row"
						onclick="selectedFunctionality('2')" value="Column[-]" /></td> 
...
<!-- 				</tr> -->
				...
				<tr>
					<td width="100%" colspan="2" class="tdfont"><input
						type="button" class="sub6" title="Add Table Border"
						onclick="selectedFunctionality('25')" value="Add Border" /></td>
				</tr>
				<tr>
					<td width="100%"  class="tdfont"><input
						type="button" class="sub6" title="Remove Table Border"
						onclick="selectedFunctionality('26')" value="Remove border" /></td>
				</tr>
<!-- 				<tr> -->
<!-- 					<td width="100%" colspan="2" class="tdfont"><input -->
...
<!-- 				</tr> -->
	...
	<input type="hidden" name="addOrModifyMode" id='addOrModifyMode'
		value='' />
	<input type="hidden" name="radioValueForTestGroup" id = "radioValueForTestGroup" value='' />
