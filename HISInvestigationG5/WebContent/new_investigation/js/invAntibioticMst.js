...
function clearAddForm()
 {
	     ...
	     document.getElementsByName('antibioticName')[0].value="";
		 document.getElementsByName('antibioticNameOrder')[0].value="";
 ...
 function validatesave() {
	 ...
	 if(document.getElementsByName('antibioticName')[0].value=='')
		 {
		 alert("Please Enter Antibiotic Name");
		 document.getElementsByName("antibioticName")[0].focus();
		 return false;
		 }
	  if(document.getElementsByName('antibioticNameOrder')[0].value=='')
	    {
	    alert("Please Enter Display Order");
	    document.getElementsByName('antibioticNameOrder')[0].focus();
	    return false;
	    }
