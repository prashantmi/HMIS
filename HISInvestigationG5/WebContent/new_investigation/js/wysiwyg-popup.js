 ...
 *
 * $Id: wysiwyg-popup.js,v 1.1 2010/04/27 09:16:56 umesh Exp $
 ********************************************************************/
var WYSIWYG_Popup = {
...
if(window.opener!=null)
	WYSIWYG=window.opener.WYSIWYG;
else
	WYSIWYG=parent.WYSIWYG;
	
var WYSIWYG_Core = null;
if(window.opener!=null)
	WYSIWYG_Core=window.opener.WYSIWYG_Core;
else
	WYSIWYG_Core=parent.WYSIWYG_Core;

var WYSIWYG_Table = null;
if(window.opener!=null)
	WYSIWYG_Table=window.opener.WYSIWYG_Table;
else
	WYSIWYG_Table=parent.WYSIWYG_Table;
