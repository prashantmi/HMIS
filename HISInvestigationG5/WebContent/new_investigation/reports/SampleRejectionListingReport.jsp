...
<%@page import="new_investigation.reports.controller.fb.SampleRejectionListingReportFB"%>
...
<html:form action="/reports/SampleRejectionListingReportAction" >
	   
	   <div class="errMsg" id="errMsg"><bean:write name="SampleRejectionListingReportFB" property="strErrMsg"/></div>
<div class="normalMsg" id="normalMsg"><bean:write name="SampleRejectionListingReportFB" property="strNormalMsg"/></div>
<div class="warningMsg" id="warningMsg"><bean:write name="SampleRejectionListingReportFB" property="strWarningMsg"/></div>
	   
	   <html:hidden name="SampleRejectionListingReportFB" property="hmode" />
	    <html:hidden name="SampleRejectionListingReportFB" property="sysDate" />
	      <html:hidden name="SampleRejectionListingReportFB" property="dateTypeCheck" />
	       <html:hidden name="SampleRejectionListingReportFB" property="frmHr" />
	        <html:hidden name="SampleRejectionListingReportFB" property="frmMin" />
	         <html:hidden name="SampleRejectionListingReportFB" property="toHr" /> 
	         <html:hidden name="SampleRejectionListingReportFB" property="toMin" />
	         
	  	 <his:TransactionContainer>
	 
		<his:TitleTag name="Sample Rejection Listing Report">
			<%-- <his:insertDateTag/> --%>
		</his:TitleTag>
		<his:ContentTag>
		  <%
         ...
         %>
      <bean:define name="SampleRejectionListingReportFB" property="fromDate" id="frDate" type="java.lang.String" />
	   <bean:define name="SampleRejectionListingReportFB" property="toDate" id="tDate" type="java.lang.String"/> 
 ...
 <tr>
			    ...
			    <td width="25%" class="tdfonthead">
			      ...
			      <logic:present	name="<%=InvestigationConfig.LIST_LAB_COMBO %>">
							<html:select name="SampleRejectionListingReportFB" property="labCode" onchange="getTest()" tabindex="1" style="max-width:80%;">
			     ...
			     <td width="25%" class="tdfonthead">
			      ...
			      <td width="25%" class="tdfont">
			       <logic:present	name="<%=InvestigationConfig.LIST_TEST_COMBO %>">
							<html:select name="SampleRejectionListingReportFB" property="testCode" tabindex="1" style="max-width:80%;">
