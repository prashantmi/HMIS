...
<%@page import="new_investigation.reports.controller.fb.PatientAcceptanceReportFB"%>
...
<html:form action="/reports/PatientAcceptanceReportAction" >
	   
	   <div class="errMsg" id="errMsg"><bean:write name="PatientAcceptanceReportFB" property="strErrMsg"/></div>
<div class="normalMsg" id="normalMsg"><bean:write name="PatientAcceptanceReportFB" property="strNormalMsg"/></div>
<div class="warningMsg" id="warningMsg"><bean:write name="PatientAcceptanceReportFB" property="strWarningMsg"/></div>
	   
	   <html:hidden name="PatientAcceptanceReportFB" property="hmode" />
	    <html:hidden name="PatientAcceptanceReportFB" property="sysDate" />
	      <html:hidden name="PatientAcceptanceReportFB" property="dateTypeCheck" />
	       <html:hidden name="PatientAcceptanceReportFB" property="frmHr" />
	        <html:hidden name="PatientAcceptanceReportFB" property="frmMin" />
	         <html:hidden name="PatientAcceptanceReportFB" property="toHr" /> 
	         <html:hidden name="PatientAcceptanceReportFB" property="toMin" />
	         
	  	 <his:TransactionContainer>
	 
		<his:TitleTag name="Patient Acceptance Report">
			<%-- <his:insertDateTag/> --%>
		</his:TitleTag>
		<his:ContentTag>
		  <%
         ...
         %>
      <bean:define name="PatientAcceptanceReportFB" property="fromDate" id="frDate" type="java.lang.String"/>
	   <bean:define name="PatientAcceptanceReportFB" property="toDate" id="tDate" type="java.lang.String"/> 
 ...
 <tr>
			    ...
			    <td width="25%" class="tdfonthead">
			      ...
			      <logic:present	name="<%=InvestigationConfig.LIST_LAB_DEPT_COMBO %>">
							<html:select name="PatientAcceptanceReportFB" property="labCode" onchange="getTest()" tabindex="1" style="max-width:80%;">
			     ...
			     <td width="25%" class="tdfonthead">
			      <div align="right">
			       ...
			       <logic:present	name="<%=InvestigationConfig.LIST_TEST_COMBO %>">
							<html:select name="PatientAcceptanceReportFB" property="testCode" tabindex="1" onchange="" style="max-width:80%;">
