...
<%@page import="new_investigation.reports.controller.fb.AgewiseDistributionReportFB"%>
...
function onLoadPageCheck()
{
	...
	var dt = document.getElementsByName('dateTypeCheck')[0].value;
	document.getElementById("todayCheck").style.display="none";
	document.getElementById("dateCheck1").style.display="none";
...
<html:form action="/reports/AgewiseDistributionReportAction" >
	   
	   <div class="errMsg" id="errMsg"><bean:write name="AgewiseDistributionReportFB" property="strErrMsg"/></div>
<div class="normalMsg" id="normalMsg"><bean:write name="AgewiseDistributionReportFB" property="strNormalMsg"/></div>
<div class="warningMsg" id="warningMsg"><bean:write name="AgewiseDistributionReportFB" property="strWarningMsg"/></div>
	   
	   <html:hidden name="AgewiseDistributionReportFB" property="hmode" />
	    <html:hidden name="AgewiseDistributionReportFB" property="sysDate" />
	      <html:hidden name="AgewiseDistributionReportFB" property="dateTypeCheck" value="datewise"     />
	      
	     
	  	 <his:TransactionContainer>
	 
		<his:TitleTag name="Agewise Distribution Report">
			<%-- <his:insertDateTag/> --%>
		</his:TitleTag>
		<his:ContentTag>
		  <%
         ...
         %>
      <bean:define name="AgewiseDistributionReportFB" property="fromDate" id="frDate" type="java.lang.String"/>
	   <bean:define name="AgewiseDistributionReportFB" property="toDate" id="tDate" type="java.lang.String"/> 
	   ...
	   <%
    	...
    	<his:SubTitleTag name="Details">
    		  <input type="radio" name="datetype" value="today"  onclick="setTimeCheck(this)"   id="todayCheck" > 
			<input type="radio" name="datetype" value="datewise" onclick="setDateTime(this)" id="dateCheck"> 
    	  <input type="radio" name="datetype" value="datewise1" onclick="setDateTime(this)" id="dateCheck1">  
    	</his:SubTitleTag>
 ...
 <tr>
			      ...
			      <td width="25%" class="tdfont">
			       <logic:present	name="<%=InvestigationConfig.DEPART_COMBO %>">
							<html:select name="AgewiseDistributionReportFB" property="deptCode" tabindex="1" onchange="getLab()" style="max-width:80%;">
			    ...
			    <td width="25%" class="tdfonthead">
			      ...
			      <logic:present	name="<%=InvestigationConfig.LIST_LAB_COMBO %>">
							<html:select name="AgewiseDistributionReportFB" property="labCode" onchange="getTest()" tabindex="1" style="max-width:80%;">
		...
		<%-- <tr>     
			      ...
			      <td width="25%" class="tdfont">
			       <logic:present	name="<%=InvestigationConfig.LIST_TEST_COMBO %>">
							<html:select name="AgewiseDistributionReportFB" property="testCode" onchange="getSample()" tabindex="1" style="max-width:80%;">
			...
			<td width="25%" class="tdfont">
			     ...
			     <logic:present	name="<%=InvestigationConfig.LIST_SAMPLE_COMBO %>">
							<html:select name="AgewiseDistributionReportFB" property="sampleCode" tabindex="1" onchange="" style="max-width:80%;">
		 ...
		 <logic:notPresent	name="<%=InvestigationConfig.LIST_SAMPLE_COMBO %>">
							<html:select name="AgewiseDistributionReportFB" property="sampleCode" onchange="" tabindex="1" style="max-width:80%;">
										<html:option value="-1">Select sample</html:option>
									</html:select>
